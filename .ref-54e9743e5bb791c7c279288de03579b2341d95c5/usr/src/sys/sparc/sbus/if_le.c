...
begin_comment
comment|/*-  * Copyright (c) 1982, 1992, 1993  *	The Regents of the University of California.  All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)if_le.c	8.2 (Berkeley) %G%  *  * from: $Header: if_le.c,v 1.25 93/10/31 04:47:50 leres Locked $  */
end_comment
