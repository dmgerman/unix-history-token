...
begin_comment
comment|/*  * Copyright (c) 1980, 1986, 1991, 1993  *	The Regents of the University of California.  All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)route.c	8.2 (Berkeley) %G%  */
end_comment
...
name|printf
argument_list|(
literal|"rtinit: wrong ifa (%x) was (%x)\n"
argument_list|,
name|ifa
argument_list|,
name|rt
