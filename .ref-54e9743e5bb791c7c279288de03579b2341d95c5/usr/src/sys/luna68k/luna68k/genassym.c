...
begin_comment
comment|/*  * Copyright (c) 1992 OMRON Corporation.  * Copyright (c) 1982, 1990, 1992, 1993  *	The Regents of the University of California.  All rights reserved.  *  * %sccs.include.redist.c%  *  * from: hp300/hp300/genassym.c	8.2 (Berkeley) 9/23/93  *  *	@(#)genassym.c	8.3 (Berkeley) %G%  */
end_comment
