...
begin_comment
comment|/*  * Copyright (c) 1982, 1986 Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Excelan Inc.  *  * %sccs.include.redist.c%  *  *	@(#)if_exreg.h	7.3 (Berkeley) %G%  */
end_comment
...
comment|/* read on portb returns status bits */
name|char
name|xd_pad_b
decl_stmt|;
block|}
...
begin_comment
comment|/* per EXOS 101 manual 5.3.7 (maybe 1518 would do) */
end_comment
...
comment|/* 	 * Array above is really a single u_long field. 	 * We kludge its definition to defeat word-alignment. 	 * Access would look like: 	 *     longaddr = *(u_long *)bp->.mb_er.er_blks[0].bb_addr; 	 */
block|}
struct|;
end_struct
