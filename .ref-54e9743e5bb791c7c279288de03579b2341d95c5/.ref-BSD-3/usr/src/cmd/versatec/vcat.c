...
begin_comment
comment|/*  * Cat Simulator for Versatec  */
end_comment
...
begin_comment
comment|/* Accounting assumes roll paper */
end_comment
...
begin_comment
comment|/* versatec output file descriptor */
end_comment
...
name|stderr
argument_list|,
literal|"Can't load inital font\n"
argument_list|)
expr_stmt|;
break|break;
case|case
