...
argument_list|)
expr_stmt|;
comment|/* uses both old and new options of mmail */
comment|/* compatibility problems 	sprintf(cmdstr,"%s %s %s %s -f %s -t %s -h %d", MMAILCMD,snfrom, 		longname(local),snto,addrfrom,addrto,hopcnt); 	*/
name|sprintf
argument_list|(
name|cmdstr
argument_list|,
