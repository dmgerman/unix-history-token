...
begin_comment
comment|/* Variables and functions imported from terminal.c */
end_comment
...
begin_comment
comment|/* Expand the prompt string S and return the number of visible    characters in *LP, if LP is not null.  This is currently more-or-less    a placeholder for expansion.  LIP, if non-null is a place to store the    index of the last invisible character in ther eturned string. */
end_comment
...
expr_stmt|;
block|}
comment|/* should be enough, but then again, this is just for testing. */
name|inv_lbreaks
operator|=
operator|(
name|int
