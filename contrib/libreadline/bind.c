...
begin_comment
comment|/* Functions imported from funmap.c */
end_comment
...
begin_comment
comment|/* Functions imported from util.c */
end_comment
...
expr_stmt|;
block|}
comment|/* For the time being, unknown variable names are simply ignored. */
return|return
literal|0
return|;
block|}
...
block|if (c == ESC)     {       keyseq[0] = '\\';       keyseq[1] = 'e';       keyseq[2] = '\0';       return keyseq;     }
endif|#
directive|endif
...
directive|if
literal|0
block|out = (char *)map[key].function;
else|#
directive|else
name|out
operator|=
...
name|rl_outstream
argument_list|,
literal|"bell-style is set to `%s'\n"
argument_list|,
name|kname
argument_list|)
expr_stmt|;
...
name|rl_outstream
argument_list|,
literal|"comment-begin is set to `%s'\n"
argument_list|,
name|_rl_comment_begin
condition|?
name|_rl_comment_begin
...
argument_list|)
expr_stmt|;
comment|/* completion-query-items */
if|if
condition|(
name|print_readably
condition|)
...
name|rl_outstream
argument_list|,
literal|"set completion-query-items %d\n"
argument_list|,
name|rl_completion_query_items
argument_list|)
expr_stmt|;
...
name|rl_outstream
argument_list|,
literal|"completion-query-items is set to `%d'\n"
argument_list|,
name|rl_completion_query_items
argument_list|)
expr_stmt|;
...
name|rl_outstream
argument_list|,
literal|"editing-mode is set to `%s'\n"
argument_list|,
operator|(
name|rl_editing_mode
operator|==
...
name|rl_outstream
argument_list|,
literal|"set isearch-terminators \"%s\"\n"
argument_list|,
name|disp
argument_list|)
expr_stmt|;
...
name|rl_outstream
argument_list|,
literal|"isearch-terminators is set to \"%s\"\n"
argument_list|,
name|disp
argument_list|)
expr_stmt|;
