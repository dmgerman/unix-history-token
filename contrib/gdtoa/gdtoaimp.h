...
directive|endif
comment|/* NO_STRING_H */
comment|/*  * Paranoia: Protect exported symbols, including ones in files we don't  * compile right now.  The standard strtof and strtod survive.  */
define|#
directive|define
name|dtoa
value|__dtoa
...
name|strtopxL
value|__strtopxL
comment|/* Protect gdtoa-internal symbols */
define|#
directive|define
name|Balloc
value|__Balloc_D2A
...
directive|define
name|nrv_alloc
value|__nrv_alloc_D2A
define|#
directive|define
name|pow5mult
value|__pow5mult_D2A
define|#
directive|define
name|quorem
value|__quorem_D2A
