...
argument_list|)
expr_stmt|;
comment|/** apr_dbd_close: close a connection to a backend  *  *  @param handle - handle to close  *  @param driver - driver struct.  *  @return APR_SUCCESS for success or error status  */
name|APU_DECLARE
argument_list|(
argument|apr_status_t
argument_list|)
