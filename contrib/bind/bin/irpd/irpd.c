...
index|[]
init|=
literal|"$Id: irpd.c,v 1.7 1999/10/13 16:26:23 vixie Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  * static void  * send_netent(struct ctl_sess *sess, struct netent *ne);  *	Sends a NETENT structure over the wire, or "No such  *	Network" error if NE is NULL.  */
end_comment
...
begin_comment
comment|/*  * static void  * irpd_done(struct ctl_sctx *ctx, struct ctl_sess *sess, void *param)  *	Callback for when QUIT respnse is sent out.  */
end_comment
