...
literal|3
argument_list|,
literal|"process_update: record section=%s, dname=%s, \ class=%s, type=%s, ttl=%d, dp=%p"
argument_list|,
name|p_section
argument_list|(
name|section
...
literal|3
argument_list|,
literal|"process_updates: added databuf %p"
argument_list|,
name|dp
argument_list|)
expr_stmt|;
...
literal|3
argument_list|,
literal|"free_rrecp: deleted databuf %p"
argument_list|,
name|dp
argument_list|)
expr_stmt|;
...
literal|3
argument_list|,
literal|"free_rrecp: added back databuf %p"
argument_list|,
name|tmpdp
argument_list|)
expr_stmt|;
...
literal|4
argument_list|,
literal|"findzone(dname=%s, class=%d, depth=%d, \ zonelist=%p, maxzones=%d)"
argument_list|,
name|dname
argument_list|,
name|class
