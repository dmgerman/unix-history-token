...
directive|ifdef
name|FORWARD_ALLOWS
literal|"'allow-query' option for hint zone '%s'"
argument_list|,
else|#
directive|else
...
argument_list|)
expr_stmt|;
comment|/* Fail if allow-query acl already set for this zone */
if|if
condition|(
name|zp
operator|->
...
argument_list|)
expr_stmt|;
comment|/* Fail if allow-transfer acl already set for this zone */
if|if
condition|(
name|zp
operator|->
...
argument_list|)
expr_stmt|;
comment|/* Fail if max-transfer-time-in already set for this zone */
if|if
condition|(
name|zp
operator|->
