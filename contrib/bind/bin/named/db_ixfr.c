...
index|[]
init|=
literal|"$Id: db_ixfr.c,v 8.18 1999/10/15 19:48:57 vixie Exp $"
decl_stmt|;
end_decl_stmt
...
name|ns_log_db
argument_list|,
literal|"Logical error in %s line %d"
argument_list|,
name|zp
operator|->
name|z_ixfr_base
...
begin_comment
comment|/*  * int  * ixfr_getrr(struct zoneinfo *zp, FILE *fp,  *            const char *filename, char *origin, struct namebuf **np,  *            u_int32_t *old_serial, u_int32_t *new_serial)  *   * read a line from the historic of a zone.  *   * returns:  *   *         DBIXFR_ERROR = an error occured   *         DBIXFR_FOUND_RR = a rr encountered   *         DBIXFR_END = end of file  */
end_comment
