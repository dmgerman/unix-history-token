...
begin_comment
comment|/* ia64-gen.c -- Generate a shrunk set of opcode tables    Copyright 1999, 2000, 2001, 2002, 2004, 2005, 2006    Free Software Foundation, Inc.    Written by Bob Manson, Cygnus Solutions,<manson@cygnus.com>     This file is part of GDB, GAS, and the GNU binutils.     GDB, GAS, and the GNU binutils are free software; you can redistribute    them and/or modify them under the terms of the GNU General Public    License as published by the Free Software Foundation; either version    2, or (at your option) any later version.     GDB, GAS, and the GNU binutils are distributed in the hope that they    will be useful, but WITHOUT ANY WARRANTY; without even the implied    warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See    the GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with this file; see the file COPYING.  If not, write to the    Free Software Foundation, 51 Franklin Street - Fifth Floor, Boston, MA    02110-1301, USA.  */
end_comment
...
begin_comment
comment|/* This is a copy of fprintf_vma from bfd/bfd-in2.h.  We have to use this    always, because we might be compiled without BFD64 defined, if configured    for a 32-bit target and --enable-targets=all is used.  This will work for    both 32-bit and 64-bit hosts.  */
end_comment

begin_define
define|#
directive|define
name|_opcode_int64_low
parameter_list|(
name|x
parameter_list|)
...
parameter_list|)
define|\
value|fprintf ((s), "%08lx%08lx", _opcode_int64_high (x), _opcode_int64_low (x))
end_define
...
name|printf
argument_list|(
literal|"static const unsigned short dep%d[] = {\n  "
argument_list|,
name|i
argument_list|)
expr_stmt|;
