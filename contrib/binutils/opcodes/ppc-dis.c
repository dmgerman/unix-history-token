...
begin_comment
comment|/* Extract the operand value from the PowerPC or POWER instruction.  */
end_comment

begin_function
specifier|static
name|long
name|operand_value_powerpc
parameter_list|(
specifier|const
name|struct
...
condition|)
block|{
comment|/* BITM is always some number of zeros followed by some 	     number of ones, followed by some numer of zeros.  */
name|unsigned
name|long
name|top
init|=
...
name|bitm
decl_stmt|;
comment|/* top& -top gives the rightmost 1 bit, so this 	     fills in any trailing zeros.  */
name|top
operator||=
operator|(
name|top
...
begin_comment
comment|/* Determine whether the optional operand(s) should be printed.  */
end_comment

begin_function
specifier|static
name|int
name|skip_optional_operands
parameter_list|(
specifier|const
name|unsigned
name|char
...
condition|)
continue|continue;
comment|/* If all of the optional operands have the value zero, 	     then don't print any of them.  */
if|if
condition|(
operator|(
name|operand
...
name|stream
argument_list|,
literal|"  440                      Disassemble the 440 instructions\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
...
name|stream
argument_list|,
literal|"  power6                   Disassemble the Power6 instructions\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
