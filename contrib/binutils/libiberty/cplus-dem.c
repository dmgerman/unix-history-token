...
block|,
literal|"GNU (g++) new-ABI-style demangling"
block|}
block|,
block|{
name|NULL
...
name|DMGL_STYLE_MASK
expr_stmt|;
comment|/* The new-ABI demangling is implemented elsewhere.  */
if|if
condition|(
name|GNU_NEW_ABI_DEMANGLING
condition|)
...
name|char
modifier|*
name|gnu_new_abi_symbol_characters
name|PARAMS
argument_list|(
operator|(
name|void
...
begin_comment
comment|/* Return the string of non-alnum characters that may occur     as a valid symbol component in the GNU standard C++ ABI mangling    scheme.  */
end_comment
