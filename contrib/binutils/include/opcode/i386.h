...
begin_comment
comment|/* The NON_BROKEN_OPCODES cases use the operands in the reverse order    from that documented in the Intel manuals.  The opcode values are    such that they actually generate different instructions.  These    values must not be changed, as they are the values generated by the    UnixWare assembler, and possibly other ix86 assemblers.  */
end_comment
...
block|}
block|,
comment|/* alias for fxch %st, %st(1) */
