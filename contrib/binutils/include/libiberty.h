...
parameter_list|)
define|\
value|(libiberty_concat_ptr = alloca (concat_length ACONCAT_PARAMS + 1), \    concat_copy2 ACONCAT_PARAMS)
...
parameter_list|)
define|\
value|(__extension__ ({ const char *const libiberty_optr = (X); \    const unsigned long libiberty_len = strlen (libiberty_optr) + 1; \    char *const libiberty_nptr = alloca (libiberty_len); \    (char *) memcpy (libiberty_nptr, libiberty_optr, libiberty_len); }))
else|#
directive|else
define|#
directive|define
...
parameter_list|)
define|\
value|(libiberty_optr = (X), \    libiberty_len = strlen (libiberty_optr) + 1, \    libiberty_nptr = alloca (libiberty_len), \    (char *) memcpy (libiberty_nptr, libiberty_optr, libiberty_len))
endif|#
directive|endif
ifdef|#
directive|ifdef
