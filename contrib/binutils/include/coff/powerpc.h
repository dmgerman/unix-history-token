...
begin_comment
comment|/* Basic coff information for the PowerPC  *  * Based on coff/rs6000.h, coff/i386.h and others.  *  * Initial release: Kim Knuttila (krk@cygnus.com)  */
end_comment
...
begin_comment
comment|/* Allow the file name length to be overridden in the including file   */
end_comment
