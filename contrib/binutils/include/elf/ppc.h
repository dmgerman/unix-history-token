...
begin_comment
comment|/* Relocs added to support TLS.  */
end_comment
...
name|RELOC_NUMBER
argument_list|(
argument|R_PPC_GOT_DTPREL16_LO
argument_list|,
literal|92
argument_list|)
end_macro
...
name|RELOC_NUMBER
argument_list|(
argument|R_PPC_GOT_DTPREL16_HI
argument_list|,
literal|93
argument_list|)
end_macro
...
name|RELOC_NUMBER
argument_list|(
argument|R_PPC_GOT_DTPREL16_HA
argument_list|,
literal|94
argument_list|)
end_macro
