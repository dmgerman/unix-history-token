...
begin_comment
comment|/* Note segments for core files on FreeBSD systems.  Note name    must start with "FreeBSD".  */
end_comment
...
begin_comment
comment|/* Values for FreeBSD .note.tag notes.  Note name is "FreeBSD".  */
end_comment
