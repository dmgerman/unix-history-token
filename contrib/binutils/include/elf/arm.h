...
begin_comment
comment|/* Unclear whether meaning is different.  */
end_comment
...
begin_comment
comment|/* Routines for manipulating EABI object attributes.  */
end_comment
