...
value|(1<< 5)
comment|/* Print function return types (when                                            present) after function signature */
define|#
directive|define
name|DMGL_AUTO
value|(1<< 8)
...
block|,
comment|/* A hidden alias.  This has one subtree, the encoding for which it      is providing alternative linkage.  */
