...
begin_comment
comment|/* Defined in bfd/binary.c.  Used to set architecture of input binary files.  */
end_comment
...
name|argv
argument_list|,
literal|"I:O:F:K:N:R:o:sSpdgxXHhVv"
argument_list|,
name|strip_options
argument_list|,
operator|(
...
name|argv
argument_list|,
literal|"b:B:i:I:j:K:N:s:O:d:F:L:G:R:SpgxXHhVvW:"
argument_list|,
name|copy_options
argument_list|,
operator|(
