...
begin_comment
comment|/* List of symbols to strip, keep, localize, and weaken.  */
end_comment
...
name|stderr
argument_list|,
literal|"%s: unrecognized section flag `%s'\n"
argument_list|,
name|program_name
argument_list|,
name|copy
...
name|stderr
argument_list|,
literal|"%s: supported flags: alloc, load, readonly, code, data, rom, contents\n"
argument_list|,
name|program_name
argument_list|)
expr_stmt|;
...
name|argv
argument_list|,
literal|"b:i:I:K:N:s:O:d:F:L:R:SpgxXVvW:"
argument_list|,
name|copy_options
argument_list|,
operator|(
