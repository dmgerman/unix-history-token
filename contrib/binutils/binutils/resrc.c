...
begin_comment
comment|/* resrc.c -- read and write Windows rc files.    Copyright 1997, 1998, 1999, 2000, 2001, 2002, 2003, 2005, 2007    Free Software Foundation, Inc.    Written by Ian Lance Taylor, Cygnus Support.    Rewritten by Kai Tietz, Onevision.     This file is part of GNU Binutils.     This program is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2 of the License, or    (at your option) any later version.     This program is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with this program; if not, write to the Free Software    Foundation, Inc., 51 Franklin Street - Fifth Floor, Boston, MA    02110-1301, USA.  */
end_comment
...
begin_comment
comment|/* The windres target bfd .  */
end_comment
...
begin_comment
comment|/* Local functions for rcdata based resource definitions.  */
end_comment

begin_function_decl
specifier|static
name|void
name|define_font_rcdata
parameter_list|(
name|rc_res_id
parameter_list|,
specifier|const
...
specifier|static
name|void
name|define_messagetable_rcdata
parameter_list|(
name|rc_res_id
parameter_list|,
specifier|const
...
begin_comment
comment|/* Determine if FILENAME contains special characters that    can cause problems unless the entire filename is quoted.  */
end_comment

begin_function
specifier|static
name|int
name|filename_need_quotes
parameter_list|(
specifier|const
name|char
modifier|*
...
name|_
argument_list|(
literal|"stat failed on font file `%s': %s"
argument_list|)
argument_list|,
name|real_filename
argument_list|,
...
name|fatal
argument_list|(
literal|"too small group icon rcdata"
argument_list|)
expr_stmt|;
name|cg
operator|=
...
specifier|static
name|void
name|define_group_cursor_rcdata
parameter_list|(
name|rc_res_id
name|id
parameter_list|,
...
begin_comment
comment|/* Create an rcdata item holding a unicode string.  */
end_comment
...
name|len_data
decl_stmt|;
comment|/* We have to check if the binary data is parsed specially.  */
if|if
condition|(
name|type
operator|.
...
return|return;
default|default:
comment|/* Treat as normal user-data.  */
break|break;
block|}
block|}
name|ids
...
name|_
argument_list|(
literal|"stat failed on file `%s': %s"
argument_list|)
argument_list|,
name|real_filename
argument_list|,
...
begin_comment
comment|/* Dump the resources we have read in the format of an rc file.     Reasoned by the fact, that some resources need to be stored into file and    refer to that file, we use the user-data model for that to express it binary    without the need to store it somewhere externally.  */
end_comment
...
name|e
argument_list|,
literal|"COFF information not part of RC"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|e
argument_list|,
literal|"Version major:%d minor:%d"
argument_list|,
name|rd
operator|->
name|major
...
name|NAME
parameter_list|)
value|case NAME: \ 	fprintf (e, "%u /* %s */", (unsigned int) NAME, #NAME); \ 	break
switch|switch
condition|(
name|type
operator|->
...
name|e
argument_list|,
literal|" 0x%x, 0x%x,\t/* Hotspot x: %d, y: %d.  */\n"
argument_list|,
operator|(
name|unsigned
name|int
...
name|e
argument_list|,
literal|"0, 2, %d%s\t /* Having %d items.  */\n"
argument_list|,
name|c
argument_list|,
operator|(
...
name|e
argument_list|,
literal|"/* width, height, planes, bits, bytes, index.  */\n"
argument_list|)
expr_stmt|;
for|for
control|(
...
name|e
argument_list|,
literal|"%d, %d, %d, %d, 0x%xL, %d%s /* Element %d. */\n"
argument_list|,
operator|(
name|int
operator|)
...
name|e
argument_list|,
literal|"%d,\t/* Font no %d with index %d.  */\n"
argument_list|,
operator|(
name|int
operator|)
...
name|e
argument_list|,
literal|" 0, 1, %d%s\t /* Has %d elements.  */\n"
argument_list|,
name|c
argument_list|,
operator|(
...
name|e
argument_list|,
literal|"/* \"width height colors pad\", planes, bits, bytes, index.  */\n"
argument_list|)
expr_stmt|;
for|for
control|(
...
name|e
argument_list|,
literal|"\"\\%03o\\%03o\\%03o\\%03o\", %d, %d, 0x%xL, %d%s\t/* Element no %d.  */\n"
argument_list|,
name|gi
operator|->
name|width
...
specifier|static
name|int
name|test_rc_datablock_unicode
parameter_list|(
name|rc_uint_type
name|length
parameter_list|,
...
name|e
argument_list|,
literal|" PRODUCTVERSION %u, %u, %u, %u\n"
argument_list|,
call|(
name|unsigned
name|int
