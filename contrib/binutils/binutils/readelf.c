...
begin_comment
comment|/* readelf.c -- display contents of an ELF format file    Copyright (C) 1998, 99, 2000, 2001 Free Software Foundation, Inc.     Originally developed by Eric Youngdale<eric@andante.jic.com>    Modifications by Nick Clifton<nickc@cygnus.com>     This file is part of GNU Binutils.     This program is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2 of the License, or    (at your option) any later version.     This program is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with this program; if not, write to the Free Software    Foundation, Inc., 59 Temple Place - Suite 330, Boston, MA    02111-1307, USA.  */
end_comment
...
name|printf
argument_list|(
literal|"skipping %d extra bytes\n"
argument_list|,
name|xtra
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Invalid CIE pointer %08x in FDE at %08x\n"
argument_list|,
name|cie_id
argument_list|,
name|saved_start
...
name|printf
argument_list|(
literal|"FDE cie=%08x pc=%08lx..%08lx\n"
argument_list|,
name|cie
operator|->
name|chunk_start
...
comment|/* This exists for readelf maintainers.  */
define|#
directive|define
name|FDEBUG
value|0
...
name|printf
argument_list|(
literal|"  DW_CFA_advance_loc: %08x = %08x + %d*%d\n"
argument_list|,
name|fc
operator|->
name|pc_begin
...
name|printf
argument_list|(
literal|"  DW_CFA_offset: r%d = cfa[%d*%d]\n"
argument_list|,
name|opa
argument_list|,
name|roffs
...
name|printf
argument_list|(
literal|"  DW_CFA_advance_loc1: %08x = %08x + %d*%d\n"
argument_list|,
name|fc
operator|->
name|pc_begin
...
name|printf
argument_list|(
literal|"  DW_CFA_advance_loc2: %08x = %08x + %d*%d\n"
argument_list|,
name|fc
operator|->
name|pc_begin
...
name|printf
argument_list|(
literal|"  DW_CFA_advance_loc4: %08x = %08x + %d*%d\n"
argument_list|,
name|fc
operator|->
name|pc_begin
...
name|printf
argument_list|(
literal|"  DW_CFA_offset_extended: r%d = cfa[%d*%d]\n"
argument_list|,
name|reg
argument_list|,
name|roffs
...
name|printf
argument_list|(
literal|"  DW_CFA_restore_extended: r%d\n"
argument_list|,
name|reg
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"  DW_CFA_def_cfa: reg %d ofs %d\n"
argument_list|,
name|fc
operator|->
name|cfa_reg
...
name|printf
argument_list|(
literal|"  DW_CFA_GNU_args_size: %d\n"
argument_list|,
name|ul
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"  DW_CFA_GNU_negative_offset_extended: r%d = cfa[%d*%d]\n"
argument_list|,
name|reg
argument_list|,
name|l
