...
begin_comment
comment|/* readelf.c -- display contents of an ELF format file    Copyright 1998, 1999, 2000, 2001, 2002 Free Software Foundation, Inc.     Originally developed by Eric Youngdale<eric@andante.jic.com>    Modifications by Nick Clifton<nickc@redhat.com>     This file is part of GNU Binutils.     This program is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2 of the License, or    (at your option) any later version.     This program is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with this program; if not, write to the Free Software    Foundation, Inc., 59 Temple Place - Suite 330, Boston, MA    02111-1307, USA.  */
end_comment
...
name|_
argument_list|(
literal|"Unable to seek to %x for %s\n"
argument_list|)
argument_list|,
name|offset
argument_list|,
...
name|_
argument_list|(
literal|"Out of memory allocating %d bytes for %s\n"
argument_list|)
argument_list|,
name|size
argument_list|,
...
name|_
argument_list|(
literal|"Unable to read in %d bytes of %s\n"
argument_list|)
argument_list|,
name|size
argument_list|,
...
begin_comment
comment|/* Display a symbol on stdout.  If do_wide is not true then    format the symbol to be at most WIDTH characters,    truhncating as necessary.  If WIDTH is negative then    format the string to be exactly - WIDTH characters,    truncating or padding as necessary.  */
end_comment
...
name|argv
argument_list|,
literal|"ersuahnldSDAIw::x:i:vVW"
argument_list|,
name|options
argument_list|,
name|NULL
...
name|_
argument_list|(
literal|"64-bit DWARF line info is not supported yet.\n"
argument_list|)
argument_list|)
expr_stmt|;
break|break;
...
name|_
argument_list|(
literal|"64-bit DWARF pubnames are not supported yet.\n"
argument_list|)
argument_list|)
expr_stmt|;
break|break;
...
name|_
argument_list|(
literal|" (indirect string, offset: 0x%lx): "
argument_list|)
argument_list|,
name|uvalue
argument_list|)
...
name|_
argument_list|(
literal|"64-bit DWARF debug info is not supported yet.\n"
argument_list|)
argument_list|)
expr_stmt|;
break|break;
block|}
comment|/* Check for RELA relocations in the abbrev_offset address, and          apply them.  */
for|for
control|(
name|relsec
operator|=
...
name|_
argument_list|(
literal|"64-bit DWARF aranges are not supported yet.\n"
argument_list|)
argument_list|)
expr_stmt|;
break|break;
...
name|_
argument_list|(
literal|"64-bit DWARF format frames are not supported yet.\n"
argument_list|)
argument_list|)
expr_stmt|;
break|break;
