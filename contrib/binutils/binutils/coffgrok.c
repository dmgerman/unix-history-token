...
condition|)
block|{
comment|/* Referring to a struct defined elsewhere */
name|res
operator|->
name|type
operator|=
...
block|{
comment|/* No auxents - it's anonymous */
name|res
operator|->
name|type
operator|=
...
condition|)
block|{
comment|/* Referring to a enum defined elsewhere */
name|res
operator|->
name|type
operator|=
