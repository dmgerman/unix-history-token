...
begin_endif
unit|static void dump_iat (FILE *, export_type *);
endif|#
directive|endif
end_endif
...
begin_comment
unit|static void dump_iat (FILE *f, export_type *exp) {   if (exp->noname&& !show_allnames )     {       fprintf (f, "\t%s\t0x%08x\n", 	       ASM_LONG, 	       exp->ordinal | 0x80000000);
