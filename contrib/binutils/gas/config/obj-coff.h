...
begin_comment
comment|/* PE weak symbols need USE_UNIQUE.  */
end_comment
...
define|#
directive|define
name|obj_set_weak_hook
value|pecoff_obj_set_weak_hook
end_define

begin_define
define|#
directive|define
name|obj_clear_weak_hook
value|pecoff_obj_clear_weak_hook
end_define
...
define|#
directive|define
name|obj_symbol_clone_hook
value|coff_obj_symbol_clone_hook
end_define
...
name|app
parameter_list|)
value|c_dot_file_symbol (name, app)
end_define
