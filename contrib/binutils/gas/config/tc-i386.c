...
name|q
decl_stmt|;
comment|/* All opcodes on i386 have either 1 or 2 bytes, PadLock instructions 	 have 3 bytes.  We may use one more higher byte to specify a prefix 	 the instruction requires.  */
if|if
condition|(
operator|(
name|i
