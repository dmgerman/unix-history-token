...
begin_comment
comment|/* i386.c -- Assemble code for the Intel 80386    Copyright (C) 1989, 91, 92, 93, 94, 95, 96, 97, 98, 99, 2000, 2001    Free Software Foundation, Inc.     This file is part of GAS, the GNU Assembler.     GAS is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2, or (at your option)    any later version.     GAS is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with GAS; see the file COPYING.  If not, write to the Free    Software Foundation, 59 Temple Place - Suite 330, Boston, MA    02111-1307, USA.  */
end_comment
...
name|_
argument_list|(
literal|"Extended register `%%%s' available only in 64bit mode."
argument_list|)
argument_list|,
name|i
operator|.
...
name|base_opcode
expr_stmt|;
comment|/* 1 possible extra opcode + displacement go in var part. 	   Pass reloc in fr_var.  */
name|frag_var
argument_list|(
...
name|as_bad
argument_list|(
literal|"GOTOFF relocations are unsupported in 64bit mode."
argument_list|)
expr_stmt|;
name|i
operator|.
...
name|as_bad
argument_list|(
literal|"GOTPCREL relocations are supported only in 64bit mode."
argument_list|)
expr_stmt|;
name|len
operator|=
...
name|as_bad
argument_list|(
literal|"GOTOFF relocation is not supported in 64bit mode."
argument_list|)
expr_stmt|;
name|i
operator|.
...
name|as_bad
argument_list|(
literal|"GOTPCREL relocation is supported only in 64bit mode."
argument_list|)
expr_stmt|;
name|i
operator|.
...
block|{
comment|/* Local symbols which have already been resolved have a NULL frags.  */
name|fragS
modifier|*
name|sym_frag
init|=
