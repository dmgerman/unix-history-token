...
begin_comment
comment|/* i386.c -- Assemble code for the Intel 80386    Copyright 1989, 1991, 1992, 1993, 1994, 1995, 1996, 1997, 1998, 1999,    2000, 2001, 2002, 2003, 2004, 2005, 2006    Free Software Foundation, Inc.     This file is part of GAS, the GNU Assembler.     GAS is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2, or (at your option)    any later version.     GAS is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with GAS; see the file COPYING.  If not, write to the Free    Software Foundation, 51 Franklin Street - Fifth Floor, Boston, MA    02110-1301, USA.  */
end_comment
...
condition|)
block|{
comment|/* These Intel Prescott New Instructions have the fixed 	     operands with an opcode suffix which is coded in the same 	     place as an 8-bit immediate field would be. Here we check 	     those operands and remove them afterwards.  */
name|unsigned
name|int
name|x
decl_stmt|;
...
name|_
argument_list|(
literal|"can't use register '%%%s' as operand %d in '%s'."
argument_list|)
argument_list|,
name|i
operator|.
...
name|_
argument_list|(
literal|"can't encode register '%%%s' in an instruction requiring REX prefix."
argument_list|)
argument_list|,
name|i
operator|.
...
index|]
argument_list|)
comment|/* monitor in SSE3 is a very special case.  The first 		 register and the second register may have differnet 		 sizes.  */
operator|||
operator|!
operator|(
operator|(
...
name|prefix
decl_stmt|;
comment|/* All opcodes on i386 have either 1 or 2 bytes.  Merom New 	 Instructions have 3 bytes.  We may use one more higher byte 	 to specify a prefix the instruction requires.  */
if|if
condition|(
operator|(
name|i
...
name|Reg16
condition|)
comment|/* Disallow things like [1*si]. */
name|reg
operator|=
name|i386_regtab
operator|+
