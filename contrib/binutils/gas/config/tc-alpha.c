...
begin_comment
comment|/* Note, the alpha_reloc_op table below depends on the ordering    of O_literal .. O_gpre16.  */
end_comment
...
argument|samegp
argument_list|,
argument|BFD_RELOC_ALPHA_BRSGP
argument_list|,
literal|0
argument_list|,
literal|0
