...
begin_comment
comment|/* Note, the alpha_reloc_op table below depends on the ordering    of O_literal .. O_gprelow.  */
end_comment
...
name|R
parameter_list|)
value|((R)>= O_literal&& (R)<= O_gprellow)
end_define
...
name|lituse
decl_stmt|;
comment|/* addened to specify lituse */
block|}
name|alpha_reloc_op
index|[]
init|=
...
begin_comment
comment|/* Whether a sequence number is valid.  */
end_comment

begin_define
define|#
directive|define
name|ALPHA_RELOC_SEQUENCE_OK
parameter_list|(
name|X
parameter_list|)
...
name|lituse
decl_stmt|;
comment|/* head of linked list of !literals */
name|segT
name|segment
decl_stmt|;
...
name|stderr
argument_list|,
literal|"alpha_adjust_symtab called\n"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
begin_comment
comment|/* Inner function to move LITUSE's next to the LITERAL.  */
end_comment
...
condition|)
return|return;
comment|/* First rebuild the fixup chain without the expicit lituse's.  */
name|prevP
operator|=
operator|&
operator|(
...
name|stderr
argument_list|,
literal|"alpha_adjust_symtab_relocs: 0x%lx, other relocation %s\n"
argument_list|,
operator|(
name|long
operator|)
...
operator|)
expr_stmt|;
comment|/* prevent assembler from trying to adjust the offset */
ifdef|#
directive|ifdef
name|DEBUG2_ALPHA
name|n_literals
...
name|stderr
argument_list|,
literal|"alpha_adjust_symtab_relocs: 0x%lx, !literal!%.6d, # literals = %2d\n"
argument_list|,
operator|(
name|long
operator|)
...
directive|endif
break|break;
comment|/* do not link in lituse's */
case|case
name|BFD_RELOC_ALPHA_USER_LITUSE_BASE
case|:
case|case
...
name|_
argument_list|(
literal|"No !literal!%d was found"
argument_list|)
argument_list|,
name|fixp
operator|->
...
name|stderr
argument_list|,
literal|"alpha_adjust_symtab_relocs: 0x%lx, !lituse !%.6d, # lituses  = %2d, next_lituse = 0x%lx\n"
argument_list|,
operator|(
name|long
operator|)
...
name|stderr
argument_list|,
literal|"alpha_adjust_symtab_relocs: %s, %d literal%s, %d duplicate literal%s, %d lituse%s\n\n"
argument_list|,
name|sec
operator|->
name|name
...
expr_stmt|;
break|break;
comment|/* optional !literal!<number> */
case|case
name|MACRO_LITERAL
case|:
ifdef|#
...
directive|endif
break|break;
comment|/* optional !lituse_base!<number> */
case|case
name|MACRO_BASE
case|:
ifdef|#
...
directive|endif
break|break;
comment|/* optional !lituse_bytoff!<number> */
case|case
name|MACRO_BYTOFF
case|:
ifdef|#
...
directive|endif
break|break;
comment|/* optional !lituse_jsr!<number> */
case|case
name|MACRO_JSR
case|:
ifdef|#
...
directive|ifdef
name|RELOC_OP_P
comment|/* and these also are internal only relocations */
case|case
name|BFD_RELOC_ALPHA_USER_LITERAL
case|:
case|case
...
expr_stmt|;
break|break;
comment|/* For lda $x,0($x)!lituse_base!y, don't use load_expression, since 	     it is really too general for our needs.  Instead just generate the 	     lda directly.  */
case|case
name|O_lituse_base
case|:
if|if
