...
begin_comment
comment|/* !lituse_jsrdirect relocation.  */
end_comment
...
define|#
directive|define
name|DUMMY_RELOC_LITUSE_JSRDIRECT
value|(BFD_RELOC_UNUSED + 7)
end_define
