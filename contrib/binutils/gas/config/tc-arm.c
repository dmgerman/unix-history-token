...
begin_comment
comment|/* tc-arm.c -- Assemble for the ARM    Copyright 1994, 1995, 1996, 1997, 1998, 1999, 2000, 2001    Free Software Foundation, Inc.    Contributed by Richard Earnshaw (rwe@pegasus.esprit.ec.org) 	Modified by David Taylor (dtaylor@armltd.co.uk)     This file is part of GAS, the GNU Assembler.     GAS is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2, or (at your option)    any later version.     GAS is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with GAS; see the file COPYING.  If not, write to the Free    Software Foundation, 59 Temple Place - Suite 330, Boston, MA    02111-1307, USA.  */
end_comment
...
directive|define
name|ARM_ARCH_V4
value|(ARM_ARCH_V3M | ARM_EXT_HALFWORD)
end_define
...
directive|define
name|ARM_ARCH_V4T
value|(ARM_ARCH_V4 | ARM_EXT_THUMB)
end_define
...
directive|define
name|ARM_ARCH_V5T
value|(ARM_ARCH_V5 | ARM_EXT_THUMB)
end_define
...
directive|define
name|ARM_ARCH_V5TE
value|(ARM_ARCH_V5T | ARM_EXT_V5E)
end_define
...
value|(ARM_ARCH_V5TE | ARM_EXT_XSCALE)
end_define
...
begin_comment
comment|/* LONGEST_INST is the longest basic instruction name without    conditions or flags.  ARM7M has 4 of length 5.  El Segundo    has one basic instruction name of length 7 (SMLALxy).  */
end_comment
...
operator|=
block|{
comment|/* Intel XScale extensions to ARM V5 ISA.  */
block|{
literal|"mia"
block|,
literal|0x0e200010
...
block|}
block|,
comment|/*  ARM ISA extension 5.  */
comment|/* Note: blx is actually 2 opcodes, so the .value is set dynamically.    And it's sometimes conditional and sometimes not.  */
block|{
literal|"blx"
block|,
literal|0
...
block|}
block|,
comment|/*  ARM ISA extension 5E, El Segundo.  */
block|{
literal|"smlabb"
block|,
literal|0x01000080
...
begin_comment
comment|/* ARM V5 breakpoint instruction (argument parse)      BKPT<16 bit unsigned immediate>      Instruction is not conditional. 	The bit pattern given in insns[] has the COND_ALWAYS condition, 	and it is an error if the caller tried to override that.      Note "flags" is nonzero if a flag was supplied (which is an error).  */
end_comment
...
begin_comment
comment|/* Xscale: Preload-Cache      PLD<addr_mode>    Syntactically, like LDR with B=1, W=0, L=1.  */
end_comment
...
begin_comment
comment|/* Xscale load-consecutive (argument parse)    Mode is like LDRH.       LDRccD R, mode      STRccD R, mode.  */
end_comment
...
condition|)
block|{
comment|/* Change instruction pattern to normal ldr/str.  */
if|if
condition|(
name|inst
operator|.
...
expr_stmt|;
comment|/* ldr */
comment|/* Perform a normal load/store instruction parse.  */
name|do_ldst
argument_list|(
name|str
argument_list|,
...
name|_
argument_list|(
literal|"r12 or r14 not allowed here"
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|_
argument_list|(
literal|"Rn and Rd must be different in %s"
argument_list|)
argument_list|,
operator|(
operator|(
