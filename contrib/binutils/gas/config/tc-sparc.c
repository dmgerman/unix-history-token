...
begin_comment
comment|/* tc-sparc.c -- Assemble for the SPARC    Copyright (C) 1989, 90-96, 97, 1998 Free Software Foundation, Inc.    This file is part of GAS, the GNU Assembler.     GAS is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2, or (at your option)    any later version.     GAS is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public    License along with GAS; see the file COPYING.  If not, write    to the Free Software Foundation, 59 Temple Place - Suite 330,    Boston, MA 02111-1307, USA. */
end_comment
...
begin_comment
comment|/* V9 has big and little endian data, but instructions are always big endian.    The sparclet has bi-endian support but both data and insns have the same    endianness.  Global `target_big_endian' is used for data.  The following    macro is used for instructions.  */
end_comment
...
value|(target_big_endian \ 			 || SPARC_OPCODE_ARCH_V9_P (max_architecture))
end_define
...
begin_comment
comment|/* For communication between md_assemble and sparc_ip.  */
end_comment
...
literal|0
decl_stmt|;
comment|/* "set" is not defined for negative numbers in v9: it doesn't yield 	   what you expect it to.  */
if|if
condition|(
...
name|as_warn
argument_list|(
literal|"set: used with negative number"
argument_list|)
expr_stmt|;
elseif|else
if|if
...
name|as_warn
argument_list|(
literal|"set: number larger than 4294967295"
argument_list|)
expr_stmt|;
block|}
...
operator|!=
literal|0
comment|/* Need lower half if number is zero.  */
operator|||
operator|(
operator|!
name|need_hh22_p
...
expr_stmt|;
block|}
comment|/* We didn't need both regs, but we may have to sign extend lower32.  */
elseif|else
if|if
condition|(
name|need_hi22_p
...
literal|'0'
case|:
comment|/* 64 bit immediate (setx insn) */
name|the_insn
operator|.
name|reloc
operator|=
...
name|as_warn
argument_list|(
literal|"Common alignment too large: %d. assumed"
argument_list|,
name|temp
argument_list|)
expr_stmt|;
