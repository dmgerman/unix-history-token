...
begin_comment
comment|/* ECOFF debugging support.    Copyright (C) 1993, 1994, 1995, 1996 Free Software Foundation, Inc.    Contributed by Cygnus Support.    This file was put together by Ian Lance Taylor<ian@cygnus.com>.  A    good deal of it comes directly from mips-tfile.c, by Michael    Meissner<meissner@osf.org>.     This file is part of GAS.     GAS is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2, or (at your option)    any later version.     GAS is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with GAS; see the file COPYING.  If not, write to the Free    Software Foundation, 59 Temple Place - Suite 330, Boston, MA    02111-1307, USA.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* gas used to have a bug that if the file does not have any 	 symbol, it either will abort or will not build the file, 	 the following is to get around that problem. ---kung*/
if|#
directive|if
literal|0
block|if (generate_asm_lineno) 	{ 	  mark_stabs (0);           (void) add_ecoff_symbol (file_name, st_Nil, sc_Nil, 				   symbol_new ("L0\001", now_seg, 					       (valueT) frag_now_fix (), 					       frag_now), 				   (bfd_vma) 0, 0, ECOFF_MARK_STAB (N_SO));           (void) add_ecoff_symbol ("void:t1=1", st_Nil, sc_Nil, 				   (symbolS *) NULL, (bfd_vma) 0, 0, 				   ECOFF_MARK_STAB (N_LSYM)); 	}
endif|#
directive|endif
block|}
block|}
...
name|list
decl_stmt|;
comment|/* this potential can cause problem, when we start to see stab half the       way thru the file */
comment|/*   if (stabs_seen)     ecoff_generate_asm_line_stab(filename, lineno); */
if|if
condition|(
name|current_stabs_filename
operator|==
...
operator|++
expr_stmt|;
comment|/* generate local label $LMnn */
name|ll
operator|=
name|xmalloc
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* generate stab for the line */
name|generate_ecoff_stab
argument_list|(
literal|'n'
argument_list|,
