...
begin_comment
comment|/* GAS interface for targets using CGEN: Cpu tools GENerator.    Copyright (C) 1996, 1997, 1998 Free Software Foundation, Inc.  This file is part of GAS, the GNU Assembler.  GAS is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GAS is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GAS; see the file COPYING.  If not, write to the Free Software Foundation, 59 Temple Place - Suite 330, Boston, MA 02111-1307, USA. */
end_comment
...
directive|ifdef
name|__STDC__
comment|/* These is volatile to survive the setjmp.  */
name|char
modifier|*
specifier|volatile
name|hold
...
name|strP
expr_stmt|;
comment|/* We rely on md_operand to longjmp back to us.      This is done via cgen_md_operand.  */
if|if
condition|(
name|setjmp
argument_list|(
...
begin_comment
comment|/* Finish assembling instruction INSN.    BUF contains what we've built up so far.    LENGTH is the size of the insn in bits.    Returns the address of the buffer containing the assembled instruction,    in case the caller needs to modify it for some reason. */
end_comment
