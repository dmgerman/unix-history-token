...
begin_comment
comment|/* write.c - emit .o file    Copyright 1986, 1987, 1990, 1991, 1992, 1993, 1994, 1995, 1996, 1997,    1998, 1999, 2000, 2001, 2002    Free Software Foundation, Inc.     This file is part of GAS, the GNU Assembler.     GAS is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2, or (at your option)    any later version.     GAS is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with GAS; see the file COPYING.  If not, write to the Free    Software Foundation, 59 Temple Place - Suite 330, Boston, MA    02111-1307, USA.  */
end_comment
...
directive|ifdef
name|BFD_ASSEMBLER
comment|/* We can never adjust a reloc against a weak symbol.  If we            did, and the weak symbol was overridden by a real symbol            somewhere else, then our relocation would be pointing at            the wrong area of memory.  */
if|if
condition|(
name|S_IS_WEAK
argument_list|(
...
control|)
block|{
comment|/* At this point we have linked all the frags into a single          chain.  However, cvt_frag_to_fill may call md_convert_frag          which may call fix_new.  We need to ensure that fix_new adds          the fixup to the right section.  */
if|if
condition|(
name|fragP
operator|==
...
directive|if
literal|0
block|printf ("symbol `%s'\n\t@%x: value=%d flags=%x seg=%s\n", 		  S_GET_NAME (symp), symp, 		  S_GET_VALUE (symp), 		  symbol_get_bfdsym (symp)->flags, 		  segment_name (S_GET_SEGMENT (symp)));
endif|#
directive|endif
ifdef|#
directive|ifdef
...
name|_
argument_list|(
literal|"attempt to .org backwards"
argument_list|)
argument_list|)
expr_stmt|;
...
name|_
argument_list|(
literal|"callj to difference of two symbols"
argument_list|)
argument_list|)
expr_stmt|;
endif|#
...
name|_
argument_list|(
literal|"subtraction of two symbols in different sections `%s' {%s section} - `%s' {%s section} at file address %s"
argument_list|)
argument_list|,
name|S_GET_NAME
argument_list|(
