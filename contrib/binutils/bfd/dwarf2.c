...
begin_comment
comment|/* VERBATUM     The following function up to the END VERBATUM mark are     copied directly from dwarf2read.c. */
end_comment
...
call|)
argument_list|(
literal|"Dwarf Error: found dwarf version '%hu' in compilation unit '%s', this reader only handles version 2 information."
argument_list|,
name|version
argument_list|,
name|unit
...
call|)
argument_list|(
literal|"Dwarf Error: found address size '%u' in compilation unit '%s', this readers only handles address size '%u'."
argument_list|,
name|addr_size
argument_list|,
name|unit
...
begin_comment
comment|/* The DWARF2 version of find_nearest line.    Return true if the line is found without error. */
end_comment
