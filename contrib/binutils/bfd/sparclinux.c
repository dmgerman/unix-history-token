...
name|mtype
parameter_list|)
value|((mtype) == M_SPARC || (mtype) == M_UNKNOWN)
end_define
...
value|sparclinux_bfd_final_link
end_define
...
value|sparclinux_write_object_contents
end_define
