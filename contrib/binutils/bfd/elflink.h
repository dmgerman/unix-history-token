...
expr_stmt|;
block|}
comment|/* Handle the special case of a weak definition in a regular object      followed by a non-weak definition in a shared object.  In this      case, we prefer the definition in the shared object.  */
if|if
condition|(
name|olddef
operator|&&
...
block|}
block|}
comment|/* Then the global .got and .plt entries.  */
name|elf_link_hash_traverse
argument_list|(
name|elf_hash_table
argument_list|(
