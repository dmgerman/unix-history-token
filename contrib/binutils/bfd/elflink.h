...
name|false
expr_stmt|;
comment|/* It's OK to change the type if either the existing symbol or the      new symbol is weak.  */
if|if
condition|(
name|h
operator|->
