...
begin_comment
comment|/* Support for the generic parts of PE/PEI, for BFD.    Copyright 1995, 1996, 1997, 1998, 1999, 2000, 2001, 2002, 2003, 2004,    2005, 2006 Free Software Foundation, Inc.    Written by Cygnus Solutions.     This file is part of BFD, the Binary File Descriptor library.     This program is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2 of the License, or    (at your option) any later version.     This program is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with this program; if not, write to the Free Software    Foundation, Inc., 51 Franklin Street - Fifth Floor, Boston, MA 02110-1301, USA.  */
end_comment
...
directive|define
name|coff_swap_filehdr_out
value|_bfd_pex64_only_swap_filehdr_out
end_define
...
name|ImageBase
expr_stmt|;
comment|/* Do not cut upper 32-bits for 64-bit vma.  */
ifndef|#
directive|ifndef
name|COFF_WITH_pex64
name|scnhdr_int
...
parameter_list|)
block|{
comment|/* PR binutils/716: Copy the large address aware flag.      XXX: Should we be copying other flags or other fields in the pe_data()      structure ?  */
if|if
condition|(
name|pe_data
argument_list|(
...
begin_comment
comment|/* For PEx64 idata4& 5 have thumb size of 8 bytes.  */
end_comment
...
name|_
argument_list|(
literal|"%B: Unhandled import type; %x"
argument_list|)
argument_list|,
name|abfd
argument_list|,
...
name|_
argument_list|(
literal|"%B: Unrecognised import type; %x"
argument_list|)
argument_list|,
name|abfd
argument_list|,
...
name|_
argument_list|(
literal|"%B: Unrecognised import name type; %x"
argument_list|)
argument_list|,
name|abfd
argument_list|,
...
name|symbol_name
expr_stmt|;
comment|/* As used by MS compiler, '_', '@', and '?' are alternative 	 forms of USER_LABEL_PREFIX, with '?' for c++ mangled names, 	 '@' used for fastcall (in C),  '_' everywhere else.  Only one 	 of these is used for a symbol.  We strip this leading char for 	 IMPORT_NAME_NOPREFIX and IMPORT_NAME_UNDECORATE as per the 	 PE COFF 6.0 spec (section 8.3, Import Name Type).  */
if|if
condition|(
name|import_name_type
operator|!=
...
name|_
argument_list|(
literal|"%B: Unrecognised machine type (0x%x)"
literal|" in Import Library Format archive"
argument_list|)
argument_list|,
name|abfd
argument_list|,
...
name|_
argument_list|(
literal|"%B: Recognised but unhandled machine type (0x%x)"
literal|" in Import Library Format archive"
argument_list|)
argument_list|,
name|abfd
...
name|_
argument_list|(
literal|"%B: size field is zero in Import Library Format header"
argument_list|)
argument_list|,
name|abfd
argument_list|)
...
name|_
argument_list|(
literal|"%B: string not null terminated in ILF object file."
argument_list|)
argument_list|,
name|abfd
argument_list|)
...
name|arch_type
block|{
name|arch_type_unknown
block|,
name|arch_type_i386
block|,
name|arch_type_x86_64
block|}
enum|;
end_enum
...
name|target_ptr
decl_stmt|;
comment|/* Get the machine.  */
if|if
condition|(
name|bfd_target_efi_p
argument_list|(
name|abfd
operator|->
name|xvec
...
condition|)
block|{
comment|/* Skip incompatible arch.  */
if|if
condition|(
name|pe_arch
argument_list|(
...
condition|)
block|{
comment|/* TARGET_PTR is an EFI backend.  Don't match 		       TARGET with a EFI file.  */
name|bfd_set_error
argument_list|(
name|bfd_error_wrong_format
argument_list|)
...
condition|)
block|{
comment|/* TARGET_PTR is a PE backend.  Don't match 		       TARGET with a PE file.  */
name|bfd_set_error
argument_list|(
name|bfd_error_wrong_format
argument_list|)
