...
begin_comment
comment|/* DO NOT EDIT!  -*- buffer-read-only: t -*-  This file is automatically     generated from "libcoff-in.h" and "coffcode.h".    Run "make headers" in your build bfd/ to regenerate.  */
end_comment
...
begin_comment
comment|/* Extracted from coffcode.h.  */
end_comment
...
function_decl|(
modifier|*
name|_bfd_coff_swap_filehdr_in
function_decl|)
parameter_list|(
name|bfd
modifier|*
...
function_decl|(
modifier|*
name|_bfd_coff_swap_aouthdr_in
function_decl|)
parameter_list|(
name|bfd
modifier|*
...
function_decl|(
modifier|*
name|_bfd_coff_bad_format_hook
function_decl|)
parameter_list|(
name|bfd
modifier|*
...
function_decl|(
modifier|*
name|_bfd_coff_set_arch_mach_hook
function_decl|)
parameter_list|(
name|bfd
modifier|*
...
function_decl|(
modifier|*
name|_bfd_styp_to_sec_flags_hook
function_decl|)
parameter_list|(
name|bfd
modifier|*
...
function_decl|(
modifier|*
name|_bfd_coff_slurp_symbol_table
function_decl|)
parameter_list|(
name|bfd
modifier|*
...
function_decl|(
modifier|*
name|_bfd_coff_symname_in_debug
function_decl|)
parameter_list|(
name|bfd
modifier|*
...
function_decl|(
modifier|*
name|_bfd_coff_reloc16_extra_cases
function_decl|)
parameter_list|(
name|bfd
modifier|*
...
function_decl|(
modifier|*
name|_bfd_coff_reloc16_estimate
function_decl|)
parameter_list|(
name|bfd
modifier|*
...
function_decl|(
modifier|*
name|_bfd_coff_compute_section_file_positions
function_decl|)
parameter_list|(
name|bfd
modifier|*
...
function_decl|(
modifier|*
name|_bfd_coff_relocate_section
function_decl|)
parameter_list|(
name|bfd
modifier|*
...
function_decl|(
modifier|*
name|_bfd_coff_link_add_one_symbol
function_decl|)
parameter_list|(
name|struct
name|bfd_link_info
...
function_decl|(
modifier|*
name|_bfd_coff_link_output_has_begun
function_decl|)
parameter_list|(
name|bfd
modifier|*
...
function_decl|(
modifier|*
name|_bfd_coff_final_link_postscript
function_decl|)
parameter_list|(
name|bfd
modifier|*
...
parameter_list|)
define|\
value|((coff_backend_info (abfd)->_bfd_styp_to_sec_flags_hook)\    (abfd, scnhdr, name, section, flags_ptr))
end_define
