...
directive|if
literal|0
block|BFD_ASSERT(src[0].r_offset == src[2].r_offset);
endif|#
directive|endif
name|mirel
operator|.
...
name|relocation
decl_stmt|;
comment|/* If we're relocating, and this is an external symbol with no      addend, we don't want to change anything.  */
if|if
condition|(
name|output_bfd
operator|!=
