...
begin_comment
comment|/* Macro: Returns true if the bfd is a PE executable as opposed to a PE object file.  */
end_comment
...
parameter_list|)
define|\
value|(strncmp ((abfd)->xvec->name, "pei-", 4) == 0		\    || strncmp ((abfd)->xvec->name, "efi-app-", 8) == 0)
end_define
