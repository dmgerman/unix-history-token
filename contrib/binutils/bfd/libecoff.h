...
begin_comment
comment|/* A pointer to this structure is put in the used_by_bfd pointer of    a section to keep track of any per-section data.    The user_by_bfd pointer will be NULL if the information was not    needed.  */
end_comment
...
define|#
directive|define
name|_bfd_ecoff_bfd_copy_private_header_data
define|\
...
define|#
directive|define
name|_bfd_ecoff_bfd_is_target_special_symbol
define|\
...
define|#
directive|define
name|_bfd_ecoff_find_inliner_info
...
define|#
directive|define
name|_bfd_ecoff_bfd_link_hash_table_free
...
define|#
directive|define
name|_bfd_ecoff_bfd_link_just_syms
