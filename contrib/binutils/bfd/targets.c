...
begin_comment
comment|/*    It's okay to see some: #if 0    directives in this source file, as targets.c uses them to exclude    certain BFD vectors.  This comment is specially formatted to catch    users who grep for ^#if 0, so please keep it this way! */
end_comment
...
specifier|const
name|bfd_target
name|bfd_elf32_bigarm_symbian_vec
decl_stmt|;
end_decl_stmt
...
specifier|const
name|bfd_target
name|bfd_elf32_bigarm_vxworks_vec
decl_stmt|;
end_decl_stmt
...
specifier|const
name|bfd_target
name|bfd_elf32_bigmips_vxworks_vec
decl_stmt|;
end_decl_stmt
...
specifier|const
name|bfd_target
name|bfd_elf32_i386_freebsd_vec
decl_stmt|;
end_decl_stmt
...
specifier|const
name|bfd_target
name|bfd_elf32_i386_vxworks_vec
decl_stmt|;
end_decl_stmt
...
specifier|const
name|bfd_target
name|bfd_elf32_littlearm_symbian_vec
decl_stmt|;
end_decl_stmt
...
specifier|const
name|bfd_target
name|bfd_elf32_littlearm_vxworks_vec
decl_stmt|;
end_decl_stmt
...
specifier|const
name|bfd_target
name|bfd_elf32_littlemips_vxworks_vec
decl_stmt|;
end_decl_stmt
...
specifier|const
name|bfd_target
name|bfd_elf32_littlescore_vec
decl_stmt|;
end_decl_stmt
...
specifier|const
name|bfd_target
name|bfd_elf32_shl_symbian_vec
decl_stmt|;
end_decl_stmt
...
specifier|const
name|bfd_target
name|bfd_elf32_sparc_vxworks_vec
decl_stmt|;
end_decl_stmt
...
specifier|const
name|bfd_target
name|bfd_elf64_ia64_hpux_big_vec
decl_stmt|;
end_decl_stmt
...
specifier|const
name|bfd_target
name|bfd_elf64_sparc_freebsd_vec
decl_stmt|;
end_decl_stmt
...
specifier|const
name|bfd_target
name|bfd_elf64_x86_64_freebsd_vec
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* These are always included.  */
end_comment
...
directive|if
literal|0
block|&m68k4knetbsd_vec,&m68kaux_coff_vec,
endif|#
directive|endif
operator|&
name|m68kcoff_vec
...
directive|endif
comment|/* Entry for the OpenRISC family.  */
operator|&
name|or32coff_big_vec
block|,
operator|&
...
block|&cisco_core_big_vec,&cisco_core_little_vec,
endif|#
directive|endif
ifdef|#
directive|ifdef
