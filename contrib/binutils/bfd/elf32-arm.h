...
condition|)
block|{
comment|/* This case can occur if we saw a PLT32 reloc in an input 	     file, but the symbol was not defined by a dynamic object. 	     In such a case, we don't actually need to build a 	     procedure linkage table, and we can just do a PC32 reloc 	     instead.  */
name|BFD_ASSERT
argument_list|(
operator|(
name|h
