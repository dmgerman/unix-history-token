...
name|_
argument_list|(
literal|"\ Error: %s passes floats in %s registers, whereas %s passes them in %s registers"
argument_list|)
argument_list|,
name|bfd_get_filename
argument_list|(
...
name|_
argument_list|(
literal|"\ Error: %s uses %s floating point, whereas %s uses %s floating point"
argument_list|)
argument_list|,
name|bfd_get_filename
argument_list|(
...
name|_
argument_list|(
literal|"\ Warning: %s %s interworking, whereas %s %s"
argument_list|)
argument_list|,
name|bfd_get_filename
argument_list|(
