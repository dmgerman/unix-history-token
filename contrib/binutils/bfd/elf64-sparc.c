...
specifier|static
name|boolean
name|sparc64_elf_copy_private_bfd_data
name|PARAMS
argument_list|(
operator|(
name|bfd
...
name|_
argument_list|(
literal|"Register %%g%d used incompatibly: "
literal|"previously declared in %s to %s, in %s redefined to %s"
argument_list|)
argument_list|,
operator|(
name|int
...
name|_
argument_list|(
literal|"Symbol `%s' has differing types: "
literal|"previously %s, REGISTER in %s"
argument_list|)
argument_list|,
operator|*
name|namep
...
define|\
value|sparc64_elf_copy_private_bfd_data
end_define
