...
specifier|static
name|reloc_howto_type
name|elf32_i386_vtinherit_howto
init|=
name|HOWTO
argument_list|(
...
decl_stmt|;
block|{
comment|/* ??? It would seem that the existing i386 code does no sort      of reference counting or whatnot on its GOT and PLT entries,      so it is not possible to garbage collect them at this time.  */
return|return
name|true
return|;
block|}
