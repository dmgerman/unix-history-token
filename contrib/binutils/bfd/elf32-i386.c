...
name|bfd_hash_entry
modifier|*
name|elf_i386_link_hash_newfunc
name|PARAMS
argument_list|(
operator|(
expr|struct
...
begin_struct
struct|struct
name|elf_i386_pcrel_relocs_copied
block|{
...
begin_comment
comment|/* Traverse an i386 ELF linker hash table.  */
end_comment

begin_define
define|#
directive|define
name|elf_i386_link_hash_traverse
parameter_list|(
name|table
parameter_list|,
name|func
...
name|_
argument_list|(
literal|"%s(%s): bad relocation section name `%s\'"
argument_list|)
argument_list|,
name|bfd_get_filename
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* We must generate a R_386_COPY reloc to tell the dynamic linker to      copy the initial value out of the dynamic object and into the      runtime process image.  We need to remember the offset into the      .rel.bss section we are going to use.  */
if|if
condition|(
operator|(
name|h
