...
value|((unsigned int) R_386_TLS_TPOFF - R_386_standard)
...
value|((unsigned int) R_386_TLS_LDO_32 - R_386_ext)
...
directive|define
name|R_386_tls
value|((unsigned int) R_386_TLS_TPOFF32 + 1 - R_386_tls_offset)
define|#
directive|define
name|R_386_vt_offset
value|((unsigned int) R_386_GNU_VTINHERIT - R_386_tls)
