...
begin_comment
comment|/* Borrowed from<sys/inttypes.h> on recent AIX versions.  */
end_comment
...
begin_comment
comment|/* Define prototypes for certain functions, to avoid a compiler warning    saying that they are missing.  */
end_comment
