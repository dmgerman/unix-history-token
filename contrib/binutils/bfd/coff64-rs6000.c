...
value|xcoff64_reloc_name_lookup
end_define
...
name|reloc_howto_type
modifier|*
name|xcoff64_reloc_name_lookup
parameter_list|(
name|bfd
modifier|*
name|abfd
...
goto|;
comment|/* Already cleared by bfd_zalloc above.      bfd_ardata (abfd)->cache = NULL;      bfd_ardata (abfd)->archive_head = NULL;      bfd_ardata (abfd)->symdefs = NULL;      bfd_ardata (abfd)->extended_names = NULL;      bfd_ardata (abfd)->extended_names_size = 0;  */
name|bfd_ardata
argument_list|(
name|abfd
argument_list|)
...
name|_
argument_list|(
literal|"%B: symbol `%s' has unrecognized smclas %d"
argument_list|)
argument_list|,
name|abfd
argument_list|,
