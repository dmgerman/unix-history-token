...
comment|/* linker_mark, gc_mark, segment_mark, vma, lma, _cooked_size,   */
value|\        0,           1,       0,            0,   0,   0,            	\ 									\
comment|/* _raw_size, output_offset, output_section,    alignment_power, */
value|\        0,         0,           (struct sec *)&SEC, 0,			\ 									\
...
comment|/* comdat, kept_section, moving_line_filepos, target_index,      */
value|\        NULL,   NULL,         0,                   0,			\ 									\
comment|/* used_by_bfd, constructor_chain, owner,                        */
