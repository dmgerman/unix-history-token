...
begin_comment
comment|/* FUNCTION 	bfd_generic_discard_group  SYNOPSIS 	boolean bfd_generic_discard_group (bfd *abfd, asection *group);  DESCRIPTION 	Remove all members of @var{group} from the output. */
end_comment
