...
operator|!=
literal|0
comment|/* DWARF will emit R_SPARC_32 relocations in its 			     sections against symbols defined externally 			     in shared libraries.  We can't do anything 			     with them here.  */
operator|||
operator|(
operator|(
name|input_section
