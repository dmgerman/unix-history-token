...
value|NAME(bfd_elf,discard_info)
end_define
...
value|NAME(_bfd_elf,reloc_symbol_deleted_p)
end_define
...
block|}
block|}
comment|/* It would be nice to be able to free more memory here, eg. old      elf_elfsections, old tdata, but that's not possible since these      blocks are sitting inside obj_alloc'd memory.  */
