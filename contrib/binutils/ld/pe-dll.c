...
argument_list|)
expr_stmt|;
comment|/* Symbol to reference ord/name of imported      symbol, used to implement auto-import.  */
name|quick_symbol
argument_list|(
name|abfd
argument_list|,
