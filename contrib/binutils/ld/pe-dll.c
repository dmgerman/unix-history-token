...
name|_
argument_list|(
literal|"%XCannot export %s: invalid export name\n"
argument_list|)
argument_list|,
name|pe_def_file
operator|->
...
name|name
decl_stmt|;
comment|/* Check for forward exports */
if|if
condition|(
name|strchr
argument_list|(
...
expr_stmt|;
block|}
comment|/* Reserve space for the forward name. */
if|if
condition|(
name|pe_def_file
operator|->
...
name|einfo
argument_list|(
literal|"%Xbfd_set_archive_head: %E\n"
argument_list|)
expr_stmt|;
if|if
condition|(
