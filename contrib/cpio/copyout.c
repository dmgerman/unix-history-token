...
name|stderr
argument_list|,
literal|"Internal overflow, aborting\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
...
name|st_ino
expr_stmt|;
comment|/* Skip files larger than 4GB which will cause problems on 	     64bit platforms (and just not work on 32bit). */
if|if
condition|(
name|file_stat
operator|.
