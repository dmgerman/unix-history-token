...
begin_enum
enum|enum
name|fw_flowc_mnem_uostate
block|{
name|FW_FLOWC_MNEM_UOSTATE_CLOSED
init|=
literal|0
block|,
comment|/* illegal */
name|FW_FLOWC_MNEM_UOSTATE_ESTABLISHED
init|=
literal|1
block|,
comment|/* default */
name|FW_FLOWC_MNEM_UOSTATE_CLOSING
init|=
literal|2
block|,
comment|/* graceful close, after sending 					      * outstanding payload 					      */
name|FW_FLOWC_MNEM_UOSTATE_ABORTING
init|=
literal|3
block|,
...
begin_enum
enum|enum
name|fw_params_phyfw_actions
block|{
name|FW_PARAMS_PARAM_PHYFW_DOWNLOAD
init|=
literal|0x00
block|,
name|FW_PARAMS_PARAM_PHYFW_VERSION
init|=
literal|0x01
block|, }
enum|;
...
define|#
directive|define
name|S_FW_VI_MAC_CMD_HASHVECEN
value|23
end_define
...
define|#
directive|define
name|M_FW_VI_MAC_CMD_HASHVECEN
value|0x1
end_define
...
define|#
directive|define
name|V_FW_VI_MAC_CMD_HASHVECEN
parameter_list|(
name|x
parameter_list|)
value|((x)<< S_FW_VI_MAC_CMD_HASHVECEN)
end_define

begin_define
define|#
directive|define
name|G_FW_VI_MAC_CMD_HASHVECEN
parameter_list|(
name|x
parameter_list|)
define|\
value|(((x)>> S_FW_VI_MAC_CMD_HASHVECEN)& M_FW_VI_MAC_CMD_HASHVECEN)
end_define
...
value|V_FW_VI_MAC_CMD_HASHVECEN(1U)
end_define
...
define|#
directive|define
name|V_FW_PORT_AUXLINFO_MDI
parameter_list|(
name|x
parameter_list|)
value|((x)<< S_FW_PORT_AUXLINFO_MDI)
end_define

begin_define
define|#
directive|define
name|G_FW_PORT_AUXLINFO_MDI
parameter_list|(
name|x
parameter_list|)
define|\
value|(((x)>> S_FW_PORT_AUXLINFO_MDI)& M_FW_PORT_AUXLINFO_MDI)
end_define
...
define|#
directive|define
name|V_FW_PORT_AUXLINFO_FEC
parameter_list|(
name|x
parameter_list|)
value|((x)<< S_FW_PORT_AUXLINFO_FEC)
end_define

begin_define
define|#
directive|define
name|G_FW_PORT_AUXLINFO_FEC
parameter_list|(
name|x
parameter_list|)
define|\
value|(((x)>> S_FW_PORT_AUXLINFO_FEC)& M_FW_PORT_AUXLINFO_FEC)
end_define

begin_define
define|#
directive|define
name|F_FW_PORT_AUXLINFO_FEC
value|V_FW_PORT_AUXLINFO_FEC(1U)
end_define

begin_define
define|#
directive|define
name|S_FW_PORT_RCAP_AUX
value|11
end_define
...
define|#
directive|define
name|V_FW_PORT_RCAP_AUX
parameter_list|(
name|x
parameter_list|)
value|((x)<< S_FW_PORT_RCAP_AUX)
end_define

begin_define
define|#
directive|define
name|G_FW_PORT_RCAP_AUX
parameter_list|(
name|x
parameter_list|)
define|\
value|(((x)>> S_FW_PORT_RCAP_AUX)& M_FW_PORT_RCAP_AUX)
end_define
