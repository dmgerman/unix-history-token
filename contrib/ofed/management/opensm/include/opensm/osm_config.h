...
begin_comment
comment|/* #undef ENABLE_OSM_PERF_MGR */
end_comment
...
value|"/usr/local/etc/opensm/ib-node-name-map"
end_define
...
value|"/usr/local/etc/opensm/opensm.conf"
end_define
...
value|"/usr/local/etc/opensm/partitions.conf"
end_define
...
value|"/usr/local/etc/opensm/prefix-routes.conf"
end_define
...
value|"/usr/local/etc/opensm/qos-policy.conf"
end_define
