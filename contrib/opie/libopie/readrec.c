...
name|LOG_DEBUG
argument_list|,
literal|"__opiereadrec: __opieopen(STD_KEY_FILE..) failed!"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
name|LOG_DEBUG
argument_list|,
literal|"__opiereadrec: __opieopen(EXT_KEY_FILE..) failed!"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
name|LOG_DEBUG
argument_list|,
literal|"__opiereadrec: open(STD_KEY_FILE, O_RDWR) failed: %s"
argument_list|,
name|strerror
argument_list|(
name|errno
...
name|LOG_DEBUG
argument_list|,
literal|"__opiereadrec: can't read ext file, but could before?"
argument_list|)
expr_stmt|;
endif|#
directive|endif
