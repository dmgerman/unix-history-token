...
index|[]
init|=
literal|"$Id: print.c,v 1.53.2.11 2004/06/17 20:54:39 dhankins Exp $ Copyright (c) 2004 Internet Systems Consortium.  All rights reserved.\n"
decl_stmt|;
end_decl_stmt
...
literal|0
expr_stmt|;
comment|/* %Audit% Loop bounds checks to 21 bytes. %2004.06.17,Safe% 	 * The sprintf can't exceed 18 bytes, and since the loop enforces 	 * 21 bytes of space per iteration at no time can we exit the 	 * loop without at least 3 bytes spare. 	 */
do|do
block|{
name|sprintf
argument_list|(
