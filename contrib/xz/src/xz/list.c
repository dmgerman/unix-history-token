...
name|all_have_sizes
decl_stmt|;
comment|/// Oldest XZ Utils version that will decompress the file
name|uint32_t
name|min_version
decl_stmt|;
block|}
...
begin_comment
comment|/// Convert XZ Utils version number to a string.
end_comment
...
name|memusage
expr_stmt|;
comment|// Determine the minimum XZ Utils version that supports this Block.
comment|//
comment|// Currently the only thing that 5.0.0 doesn't support is empty
comment|// LZMA2 Block. This decoder bug was fixed in 5.0.2.
block|{
name|size_t
name|i
init|=
...
name|_
argument_list|(
literal|"  Minimum XZ Utils version: %s\n"
argument_list|)
argument_list|,
name|xz_ver_to_str
argument_list|(
