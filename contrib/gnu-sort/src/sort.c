...
name|skipsblanks
decl_stmt|;
comment|/* Skip leading blanks at start. */
name|bool
name|skipeblanks
decl_stmt|;
comment|/* Skip trailing blanks at finish. */
name|bool
name|numeric
decl_stmt|;
...
begin_comment
comment|/* If TAB has this value, blanks separate fields.  */
end_comment
...
begin_comment
comment|/* Return the number of trailing blanks in FIELD, with LEN bytes.  */
end_comment

begin_function
specifier|static
name|size_t
name|trailing_blanks
parameter_list|(
name|char
specifier|const
modifier|*
