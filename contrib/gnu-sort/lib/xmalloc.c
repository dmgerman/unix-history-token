...
begin_expr_stmt
literal|"you must run the autoconf test for a GNU libc compatible malloc"
endif|#
directive|endif
ifndef|#
directive|ifndef
name|HAVE_REALLOC
literal|"you must run the autoconf test for a GNU libc compatible realloc"
endif|#
directive|endif
...
argument_list|)
expr_stmt|;
comment|/* The `noreturn' cannot be given to error, since it may return if      its first argument is 0.  To help compilers understand the      xalloc_die does terminate, call abort.  */
name|abort
argument_list|()
expr_stmt|;
block|}
