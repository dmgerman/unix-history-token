...
name|tarenas
decl_stmt|;
comment|/* Extend arena stats and arenas arrays. */
name|astats_size
operator|=
operator|(
name|ctl_stats
...
condition|)
block|{
comment|/* ctl_stats.arenas and arenas came from base_alloc(). */
name|astats
operator|=
operator|(
name|ctl_arena_stats_t
...
return|;
block|}
comment|/* Initialize the new astats and arenas elements. */
name|memset
argument_list|(
operator|&
name|astats
