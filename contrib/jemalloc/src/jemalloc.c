...
argument_list|)
operator|)
comment|/* Register fork handlers. */
if|if
condition|(
name|pthread_atfork
argument_list|(
...
name|malloc_write
argument_list|(
literal|"<jemalloc>: Error allocating aligned "
literal|"memory: out of memory\n"
argument_list|)
expr_stmt|;
name|abort
argument_list|()
...
name|malloc_write
argument_list|(
literal|"<jemalloc>: Error in allocm(): "
literal|"out of memory\n"
argument_list|)
expr_stmt|;
name|abort
...
name|cnt
decl_stmt|;
comment|/* 		 * usize isn't knowable before iralloc() returns when extra is 		 * non-zero.  Therefore, compute its maximum possible value and 		 * use that in PROF_ALLOC_PREP() to decide whether to capture a 		 * backtrace.  prof_realloc() will use the actual usize to 		 * decide whether to sample. 		 */
name|size_t
name|max_usize
init|=
operator|(
...
name|malloc_write
argument_list|(
literal|"<jemalloc>: Error in rallocm(): "
literal|"out of memory\n"
argument_list|)
expr_stmt|;
name|abort
