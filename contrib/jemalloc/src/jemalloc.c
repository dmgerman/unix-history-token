...
name|malloc_conf_error
argument_list|(
literal|"Deallocation-time "
literal|"junk filling cannot "
literal|"be enabled while "
literal|"running inside "
literal|"Valgrind"
argument_list|,
name|k
argument_list|,
...
begin_comment
comment|/*  * ialloc_body() is inlined so that fast and slow paths are generated separately  * with statically known slow_path.  *  * This function guarantees that *tsdn is non-NULL on success.  */
end_comment
...
name|malloc_printf
argument_list|(
literal|"<jemalloc>: Error in %s(): out of "
literal|"memory\n"
argument_list|,
name|func
argument_list|)
...
begin_comment
comment|/* This function guarantees that *tsdn is non-NULL on success. */
end_comment
