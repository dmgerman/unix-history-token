...
begin_comment
comment|/* tctx->tdata->lock must be held. */
end_comment
...
begin_comment
comment|/* tctx->tdata->lock is held upon entry, and released before return. */
end_comment
...
begin_comment
comment|/* tctx->tdata->lock is held. */
end_comment
...
directive|define
name|prof_dump_header
value|JEMALLOC_N(prof_dump_header_impl)
end_define
...
begin_comment
comment|/* tdata->lock must be held. */
end_comment
...
begin_comment
comment|/* tdatas_mtx must be held. */
end_comment
