...
directive|define
name|run_quantize_floor
value|JEMALLOC_N(run_quantize_floor_impl)
end_define
...
directive|define
name|run_quantize_ceil
value|JEMALLOC_N(run_quantize_ceil_impl)
end_define
...
argument_list|)
expr_stmt|;
comment|/* Add nadvance decay intervals to epoch. */
name|nstime_copy
argument_list|(
operator|&
name|delta
