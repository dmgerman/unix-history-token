...
define|\
value|a_attr bool								\ a_name##tsd_cleanup_wrapper(void)					\ {									\ 									\ 	if (a_name##tsd_initialized) {					\ 		a_name##tsd_initialized = false;			\ 		a_cleanup(&a_name##tsd_tls);				\ 	}								\ 	return (a_name##tsd_initialized);				\ }									\ a_attr bool								\ a_name##tsd_boot0(void)							\ {									\ 									\ 	if (a_cleanup != malloc_tsd_no_cleanup) {			\ 		malloc_tsd_cleanup_register(				\&a_name##tsd_cleanup_wrapper);			\ 	}								\ 	a_name##tsd_booted = true;					\ 	return (false);							\ }									\ a_attr void								\ a_name##tsd_boot1()							\ {									\ 									\
comment|/* Do nothing. */
...
comment|/* Initialization/cleanup. */
define|\
value|a_attr bool								\ a_name##tsd_boot0(void)							\ {									\ 									\ 	if (a_cleanup != malloc_tsd_no_cleanup) {			\ 		if (pthread_key_create(&a_name##tsd_tsd, a_cleanup) !=	\ 		    0)							\ 			return (true);					\ 	}								\ 	a_name##tsd_booted = true;					\ 	return (false);							\ }									\ a_attr void								\ a_name##tsd_boot1()							\ {									\ 									\
comment|/* Do nothing. */
value|\ }									\ a_attr bool								\ a_name##tsd_boot(void)							\ {									\ 									\ 	return (a_name##tsd_boot0());					\ }									\
comment|/* Get/set. */
