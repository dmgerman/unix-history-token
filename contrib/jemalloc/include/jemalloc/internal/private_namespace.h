...
value|JEMALLOC_N(chunk_dss_mergeable)
end_define
...
value|JEMALLOC_N(extent_size_quantize_ceil)
end_define
...
value|JEMALLOC_N(extent_size_quantize_floor)
end_define
...
value|JEMALLOC_N(pind2sz_compute)
end_define
...
directive|define
name|pind2sz_lookup
value|JEMALLOC_N(pind2sz_lookup)
end_define
...
value|JEMALLOC_N(prng_lg_range_u32)
end_define
...
value|JEMALLOC_N(prng_lg_range_u64)
end_define
...
value|JEMALLOC_N(prng_lg_range_zu)
end_define
...
directive|define
name|prng_range_u32
value|JEMALLOC_N(prng_range_u32)
end_define
...
directive|define
name|prng_range_u64
value|JEMALLOC_N(prng_range_u64)
end_define
...
directive|define
name|prng_range_zu
value|JEMALLOC_N(prng_range_zu)
end_define
...
value|JEMALLOC_N(prng_state_next_u32)
end_define
...
value|JEMALLOC_N(prng_state_next_u64)
end_define
...
value|JEMALLOC_N(prng_state_next_zu)
end_define
...
directive|define
name|tsd_fetch_impl
value|JEMALLOC_N(tsd_fetch_impl)
end_define
...
value|JEMALLOC_N(tsd_get_allocates)
end_define
...
value|JEMALLOC_N(witness_assert_depth)
end_define
...
value|JEMALLOC_N(witness_assert_depth_to_rank)
end_define
...
directive|define
name|witness_owner
value|JEMALLOC_N(witness_owner)
end_define
...
directive|define
name|zone_register
value|JEMALLOC_N(zone_register)
end_define
