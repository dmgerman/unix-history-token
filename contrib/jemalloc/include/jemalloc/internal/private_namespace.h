...
value|JEMALLOC_N(arena_bitselm_get)
end_define
...
directive|define
name|arena_get_hard
value|JEMALLOC_N(arena_get_hard)
end_define
...
value|JEMALLOC_N(arena_miscelm_get)
end_define
...
value|JEMALLOC_N(arenas_cache_bypass_cleanup)
end_define
...
value|JEMALLOC_N(arenas_cache_cleanup)
end_define
...
value|JEMALLOC_N(chunk_dalloc_arena)
end_define
...
value|JEMALLOC_N(chunk_purge_arena)
end_define
...
value|JEMALLOC_N(narenas_cache_cleanup)
end_define
