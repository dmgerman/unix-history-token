...
value|JEMALLOC_N(arenas_bin_i_index)
end_define
...
value|JEMALLOC_N(arenas_lrun_i_index)
end_define
...
value|JEMALLOC_N(chunk_mmap_boot)
end_define
...
value|JEMALLOC_N(mmap_unaligned_tsd_boot)
end_define

begin_define
define|#
directive|define
name|mmap_unaligned_tsd_cleanup_wrapper
value|JEMALLOC_N(mmap_unaligned_tsd_cleanup_wrapper)
end_define
...
value|JEMALLOC_N(mmap_unaligned_tsd_get)
end_define
...
value|JEMALLOC_N(mmap_unaligned_tsd_set)
end_define
...
directive|define
name|pthread_create
value|JEMALLOC_N(pthread_create)
end_define
...
value|JEMALLOC_N(stats_arenas_i_bins_j_index)
end_define
...
value|JEMALLOC_N(stats_arenas_i_index)
end_define
...
value|JEMALLOC_N(stats_arenas_i_lruns_j_index)
end_define
