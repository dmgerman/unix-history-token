...
begin_function_decl
name|void
name|arenas_cache_bypass_cleanup
parameter_list|(
name|tsd_t
modifier|*
name|tsd
...
return|;
block|}
comment|/* Huge size class.  Beware of size_t overflow. */
...
name|arenas_cache
init|=
name|tsd_arenas_cache_get
argument_list|(
name|tsd
argument_list|)
decl_stmt|;
comment|/* init_if_missing requires refresh_if_missing. */
name|assert
argument_list|(
operator|!
name|init_if_missing
...
condition|)
block|{
comment|/* arenas_cache hasn't been initialized yet. */
return|return
operator|(
name|arena_get_hard
argument_list|(
...
condition|)
block|{
comment|/* 		 * ind is invalid, cache is old (too small), or arena to be 		 * initialized. 		 */
return|return
operator|(
name|refresh_if_missing
condition|?
