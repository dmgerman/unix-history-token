...
name|nthreads
decl_stmt|;
comment|/* 	 * There are three classes of arena operations from a locking 	 * perspective: 	 * 1) Thread assignment (modifies nthreads) is protected by arenas_lock. 	 * 2) Bin-related operations are protected by bin locks. 	 * 3) Chunk- and run-related operations are protected by this mutex. 	 */
name|malloc_mutex_t
name|lock
decl_stmt|;
name|arena_stats_t
...
name|lg_dirty_mult
decl_stmt|;
comment|/* True if a thread is currently executing arena_purge(). */
name|bool
name|purging
decl_stmt|;
...
name|ndirty
decl_stmt|;
comment|/* 	 * Size/address-ordered tree of this arena's available runs.  The tree 	 * is used for first-best-fit run allocation. 	 */
name|arena_avail_tree_t
name|runs_avail
decl_stmt|;
