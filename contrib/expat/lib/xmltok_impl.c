...
parameter_list|)
define|\
value|(end - ptr>= count * MINBPC(enc))
end_define
...
parameter_list|)
define|\
value|{ \       if (! HAS_CHARS(enc, ptr, end, count)) { \         return XML_TOK_PARTIAL; \       } \     }
end_define
...
parameter_list|)
define|\
value|REQUIRE_CHARS(enc, ptr, end, 1)
end_define
