...
parameter_list|)
function_decl|;
comment|/* Version 3.18.0 and later */
name|void
function_decl|(
modifier|*
name|set_last_insert_rowid
function_decl|)
parameter_list|(
name|sqlite3
modifier|*
...
parameter_list|)
function_decl|;
comment|/* Version 3.20.0 and later */
name|int
function_decl|(
modifier|*
name|prepare_v3
...
value|sqlite3_api->set_last_insert_rowid
end_define
...
value|sqlite3_api->prepare16_v3
end_define
...
value|sqlite3_api->bind_pointer
end_define
...
value|sqlite3_api->result_pointer
end_define
...
value|sqlite3_api->value_pointer
end_define
