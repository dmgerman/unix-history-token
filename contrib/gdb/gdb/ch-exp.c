...
name|error
argument_list|(
literal|"expect MODENAME here `%s'"
argument_list|,
name|lexptr
argument_list|)
expr_stmt|;
...
begin_comment
comment|/* Returns one or nore TREE_LIST nodes, in reverse order. */
end_comment
...
name|error
argument_list|(
literal|"(*) not implemented in case label list"
argument_list|)
expr_stmt|;
block|}
else|else
