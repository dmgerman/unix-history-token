...
begin_comment
comment|/* GDB-specific functions for operating on agent expressions.     Copyright 1998, 1999, 2000, 2001, 2003 Free Software Foundation,    Inc.     This file is part of GDB.     This program is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2 of the License, or    (at your option) any later version.     This program is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with this program; if not, write to the Free Software    Foundation, Inc., 59 Temple Place - Suite 330,    Boston, MA 02111-1307, USA.  */
end_comment
...
name|__LINE__
argument_list|,
literal|"gen_fetch: strange size"
argument_list|)
expr_stmt|;
block|}
name|gen_sign_extend
...
name|__LINE__
argument_list|,
literal|"gen_fetch: bad type code"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|__LINE__
argument_list|,
literal|"gen_var_ref: LOC_CONST_BYTES symbols are not supported"
argument_list|)
expr_stmt|;
...
name|__LINE__
argument_list|,
literal|"gen_deref: expected a pointer"
argument_list|)
expr_stmt|;
...
name|__LINE__
argument_list|,
literal|"find_field: derived classes supported"
argument_list|)
expr_stmt|;
for|for
control|(
...
name|__LINE__
argument_list|,
literal|"find_field: anonymous unions not supported"
argument_list|)
expr_stmt|;
block|}
name|error
...
name|__LINE__
argument_list|,
literal|"gen_bitfield_ref: bitfield too wide"
argument_list|)
expr_stmt|;
...
name|__LINE__
argument_list|,
literal|"gen_expr: op case sets don't match"
argument_list|)
expr_stmt|;
block|}
break|break;
...
name|__LINE__
argument_list|,
literal|"gen_expr: OP_MEMVAL operand isn't an rvalue???"
argument_list|)
expr_stmt|;
name|value
operator|->
...
name|__LINE__
argument_list|,
literal|"gen_expr: unhandled struct case"
argument_list|)
expr_stmt|;
block|}
break|break;
...
begin_comment
unit|struct agent_expr * expr_to_address_and_size (struct expression *expr) {   struct axs_value value;   struct agent_expr *ax = expr_to_agent (expr,&value);
...
argument_list|)
expr_stmt|;
comment|/* It would be nice to call ax_reqs here to gather some general info      about the expression, and then print out the result.  */
name|do_cleanups
argument_list|(
name|old_chain
argument_list|)
