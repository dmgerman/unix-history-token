...
name|fputs_unfiltered
argument_list|(
literal|"\   --batch            Exit after processing options.\n\   --nx               Do not read .gdbinit file.\n\   --tty=TTY          Use TTY for input/output by the program being debugged.\n\   --cd=DIR           Change current directory to DIR.\n\   --directory=DIR    Search for source files in DIR.\n\ "
argument_list|,
name|gdb_stdout
argument_list|)
expr_stmt|;
name|fputs_unfiltered
argument_list|(
literal|"\   --command=FILE     Execute GDB commands from FILE.\n\   --symbols=SYMFILE  Read symbols from SYMFILE.\n\   --exec=EXECFILE    Use EXECFILE as the executable.\n\   --se=FILE          Use FILE as symbol file and executable file.\n\ "
argument_list|,
name|gdb_stdout
argument_list|)
expr_stmt|;
name|fputs_unfiltered
argument_list|(
literal|"\   --core=COREFILE    Analyze the core dump COREFILE.\n\   -b BAUDRATE        Set serial port baud rate used for remote debugging.\n\   --mapped           Use mapped symbol files if supported on this system.\n\   --readnow          Fully read symbol files on first access.\n\   --nw		     Do not use a window interface.\n\ "
argument_list|,
name|gdb_stdout
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|/* FIXME: I think we should only be doing this for stdout or stderr. 	 Either that or we should be passing stream to the hook so it can 	 deal with it.  If that is cleaned up, this function can go back 	 into utils.c and the fputs_unfiltered_hook can replace the current 	 ability to avoid this function by not linking with main.c.  */
name|fputs_unfiltered_hook
argument_list|(
name|linebuffer
argument_list|,
