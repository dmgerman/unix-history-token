...
begin_endif
unit|static int from_hex PARAMS ((int a)); static unsigned long get_hex_word PARAMS ((void));
endif|#
directive|endif
end_endif
...
condition|)
block|{
comment|/* m32r monitor emits random DC1/DC3 chars */
continue|continue;
block|}
else|else
block|{
