...
name|cie_unit
block|{
comment|/* Offset of this unit in dwarf_frame_buffer.  */
name|ULONGEST
name|offset
decl_stmt|;
...
begin_comment
comment|/*  Build the cie_chunks and fde_chunks tables from informations     in .debug_frame section.  */
end_comment
...
name|warning
argument_list|(
literal|"%s(): unknown augmentation"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"%s(): can't find CIE pointer"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
