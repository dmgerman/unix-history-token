...
name|ill_rpc
argument_list|(
literal|"do_mach_notify_no_senders"
argument_list|)
return|;
block|}
end_function
...
name|ill_rpc
argument_list|(
literal|"do_mach_notify_port_deleted"
argument_list|)
return|;
block|}
end_function
...
name|ill_rpc
argument_list|(
literal|"do_mach_notify_msg_accepted"
argument_list|)
return|;
block|}
end_function
...
name|ill_rpc
argument_list|(
literal|"do_mach_notify_port_destroyed"
argument_list|)
return|;
block|}
end_function
...
name|ill_rpc
argument_list|(
literal|"do_mach_notify_send_once"
argument_list|)
return|;
block|}
end_function
...
name|ill_rpc
argument_list|(
literal|"S_proc_setmsgport_reply"
argument_list|)
return|;
block|}
end_function
...
name|ill_rpc
argument_list|(
literal|"S_proc_getmsgport_reply"
argument_list|)
return|;
block|}
end_function
...
begin_comment
comment|/* Call FUNC on each memory region in the task.  */
end_comment

begin_function
specifier|static
name|int
name|gnu_find_memory_regions
parameter_list|(
name|int
function_decl|(
modifier|*
...
name|region_address
decl_stmt|,
name|last_region_address
decl_stmt|,
name|last_region_end
decl_stmt|;
name|vm_prot_t
name|last_protection
decl_stmt|;
if|if
condition|(
name|current_inferior
...
name|last_region_end
condition|)
comment|/* This region is contiguous with and indistinguishable from 	   the previous one, so we just extend that one.  */
name|last_region_end
operator|=
name|region_address
operator|+=
...
block|{
comment|/* This region is distinct from the last one we saw, so report 	     that previous one.  */
if|if
condition|(
name|last_protection
operator|!=
...
block|}
block|}
comment|/* Report the final region.  */
if|if
condition|(
name|last_region_end
operator|>
