...
comment|/* Just return the bfd section index. */
name|off
operator|=
name|sect
operator|->
...
argument_list|(
operator|(
literal|"The debugging information in `%s' is corrupted.\n"
literal|"The file has a `.stabs' section, but no `.stabstr' "
literal|"section."
operator|)
argument_list|,
name|name
...
expr_stmt|;
block|}
comment|/* Let stabs reader clean up */
name|stabsread_clear_cache
argument_list|()
expr_stmt|;
block|}
...
name|error
argument_list|(
literal|"Bad coff function information\n"
argument_list|)
expr_stmt|;
