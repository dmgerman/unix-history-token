...
name|list
decl_stmt|;
comment|/* Pointer to first partial symbol pointer*/
name|struct
name|partial_symbol
modifier|*
modifier|*
name|next
decl_stmt|;
comment|/* Pointer to next avail storage for pointer */
name|int
name|size
decl_stmt|;
...
begin_comment
comment|/* whether to auto load solibs at startup time:  0/1. */
end_comment
