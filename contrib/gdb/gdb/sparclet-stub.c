...
begin_comment
comment|/* turn on verbose debugging */
end_comment
...
name|ASR22
block|,
comment|/* the following not actually implemented */
name|AWR0
block|,
name|AWR1
block|,
...
directive|if
literal|0
block|int x;   mesg("get_in_break_mode, sp = ");   phex(&x);
endif|#
directive|endif
name|set_hw_breakpoint_trap
argument_list|(
...
argument_list|)
expr_stmt|;
asm|asm("         sethi   %hi(0xff10), %l4         or      %l4, %lo(0xff10), %l4 	sta 	%g0, [%l4]0x1	 	nop 	nop 	nop       ");
name|set_hw_breakpoint_trap
argument_list|(
literal|0
argument_list|)
...
asm|asm(" 	! Ugh.  sparclet has broken save 	!save %sp, -64, %sp 	save 	add %fp,-64,%sp 	!save %sp, -64, %sp 	save 	add %fp,-64,%sp 	!save %sp, -64, %sp 	save 	add %fp,-64,%sp 	!save %sp, -64, %sp 	save 	add %fp,-64,%sp 	!save %sp, -64, %sp 	save 	add %fp,-64,%sp 	!save %sp, -64, %sp 	save 	add %fp,-64,%sp 	!save %sp, -64, %sp 	save 	add %fp,-64,%sp 	!save %sp, -64, %sp 	save 	add %fp,-64,%sp 	restore 	restore 	restore 	restore 	restore 	restore 	restore 	restore ");
if|if
condition|(
name|registers
index|[
...
argument_list|)
expr_stmt|;
comment|/* CCSR, CCPR, CCCRCR, CCOR, CCOBR, CCIBR, CCIR */
name|ptr
operator|=
name|mem2hex
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* ASR1,ASR15,ASR17,ASR18,ASR19,ASR20,ASR21,ASR22 */
if|#
directive|if
literal|0
comment|/* not implemented */
block|ptr = mem2hex((char *)&registers[AWR0],  		    ptr,  		    32 * 4,  		    0);
comment|/* Alternate Window Registers */
endif|#
directive|endif
block|}
break|break;
...
literal|'G'
case|:
comment|/* set value of all the CPU registers - return OK */
case|case
literal|'P'
case|:
comment|/* set value of one CPU register      - return OK */
block|{
name|unsigned
name|long
modifier|*
...
literal|0
comment|/* not implemented */
block|hex2mem(ptr + 88 * 4 * 2, (char *)&registers[AWR0], 			8 * 4, 0);
comment|/* Alternate Window Registers */
endif|#
directive|endif
block|}
