...
argument_list|)
expr_stmt|;
comment|/* Figure out if the register was already flushed or is dirty. 	     If the register was flushed already we can return the address 	     on the backingstore for it.  */
name|regcache_cooked_read_unsigned
argument_list|(
