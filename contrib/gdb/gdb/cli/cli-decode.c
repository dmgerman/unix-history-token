...
begin_comment
comment|/* Note: Doesn't seem to be used anywhere currently. */
end_comment
...
begin_comment
comment|/* Add element named NAME to command list LIST (the list for set    or some sublist thereof).    CLASS is as in add_cmd.    VAR is address of the variable which will contain the value.    DOC is the documentation string.  */
end_comment
