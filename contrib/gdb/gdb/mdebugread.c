...
name|symloc
block|{
comment|/* Our running best guess as to the range of text addresses for        this psymtab.  After we've read everything in, we use this to        build pst->text_addrs.  */
name|CORE_ADDR
name|textlow
decl_stmt|,
name|texthigh
...
argument_list|)
expr_stmt|;
comment|/* Take the text ranges the partial symbol scanner computed for each      of the psymtabs and convert it into the canonical form for      psymtabs.  */
block|{
name|struct
name|partial_symtab
modifier|*
