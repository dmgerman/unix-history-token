...
name|TYPE_CODE_ARRAY
condition|)
comment|/* not an array, stop processing */
return|return;
name|target_type
operator|=
name|TYPE_TARGET_TYPE
...
name|TYPE_CODE_ARRAY
condition|)
comment|/* we've got another array */
name|calculate_array_length
argument_list|(
name|target_type
argument_list|)
...
literal|0
condition|)
comment|/* see comment function calculate_array_length */
name|calculate_array_length
argument_list|(
name|type
argument_list|)
...
name|stream
argument_list|,
literal|"<dynamic length %ld> static length %d>"
argument_list|,
name|length
argument_list|,
name|TYPE_LENGTH
