...
name|error
argument_list|(
literal|"can't find class named `%s', as given by C++ RTTI"
argument_list|,
name|class_name
argument_list|)
expr_stmt|;
comment|/* Make sure the type symbol is sane.  (An earlier version of this      code would find constructor functions, who have the same name as      the class.)  */
if|if
condition|(
name|SYMBOL_CLASS
argument_list|(
...
name|error
argument_list|(
literal|"C++ RTTI gives a class name of `%s', but that isn't a type name"
argument_list|,
name|class_name
argument_list|)
expr_stmt|;
comment|/* This is the object's run-time type!  */
name|run_time_type
operator|=
name|SYMBOL_TYPE
argument_list|(
...
operator|)
expr_stmt|;
comment|/* We're now looking for the cur_base_offset'th entry (negative index)      in the vcall_and_vbase_offsets array.  */
name|orig_object
operator|=
name|value_at_lazy
argument_list|(
