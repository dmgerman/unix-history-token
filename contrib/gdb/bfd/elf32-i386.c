...
condition|)
block|{
comment|/* If we are generating a shared object, we need to                      output a R_386_RELATIVE reloc so that the dynamic                      linker can adjust this GOT entry.  */
name|srelgot
operator|->
name|_raw_size
operator|+=
...
comment|/* Resolve a PLT32 reloc again a local symbol directly,              without using the procedure linkage table.  */
if|if
condition|(
name|h
operator|==
