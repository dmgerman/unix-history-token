...
name|DEFUN
argument_list|(
argument|copy_past_newline
argument_list|,
argument|(ptr, idx, dst)
argument_list|,
argument|string_type *ptr AND       unsigned int idx AND       string_type *dst
argument_list|)
end_macro
...
name|stderr
argument_list|,
literal|"print: illegal print destination `%d'\n"
argument_list|,
operator|*
name|isp
argument_list|)
