...
begin_comment
comment|/*** coff information for 88k bcs */
end_comment
...
name|ext
parameter_list|)
value|bfd_h_get_32(abfd, (bfd_byte *) ext->x_sym.x_misc.x_lnsz.x_size)
end_define
...
name|ext
parameter_list|)
value|bfd_h_get_32(abfd, (bfd_byte *) ext->x_sym.x_misc.x_lnsz.x_lnno)
end_define
...
name|ext
parameter_list|)
value|bfd_h_put_32(abfd, in, (bfd_byte *) ext->x_sym.x_misc.x_lnsz.x_lnno)
end_define
...
name|ext
parameter_list|)
value|bfd_h_put_32(abfd, in, (bfd_byte *) ext->x_sym.x_misc.x_lnsz.x_size)
end_define
...
name|ext
parameter_list|)
value|bfd_h_get_32(abfd, (bfd_byte *) ext->x_scn.x_nreloc)
end_define
...
name|ext
parameter_list|)
value|bfd_h_get_32(abfd, (bfd_byte *) ext->x_scn.x_nlinno)
end_define
...
name|ext
parameter_list|)
value|bfd_h_put_32(abfd, in, (bfd_byte *)ext->x_scn.x_nreloc)
end_define
...
name|ext
parameter_list|)
value|bfd_h_put_32(abfd,in, (bfd_byte *) ext->x_scn.x_nlinno)
end_define
