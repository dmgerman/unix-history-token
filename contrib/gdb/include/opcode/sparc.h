...
name|name
decl_stmt|;
comment|/* Mask of sparc_opcode_arch_val's supported.      EG: For v7 this would be ((1<< v6) | (1<< v7)).  */
comment|/* These are short's because sparc_opcode.architecture is.  */
name|short
name|supported
decl_stmt|;
block|}
