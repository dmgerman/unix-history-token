...
operator|++
control|)
comment|/* just in case lower case */
if|if
condition|(
name|islower
argument_list|(
...
operator|++
control|)
comment|/* let them use `=' between terms */
if|if
condition|(
name|line
index|[
...
expr_stmt|;
block|}
comment|/* sometimes the @@Cj request does not produce any output 		   PERHAPS the ONCORE is still busy from the selftest??? 		   try a 2 second sleep here to see if it makes any difference 		 */
name|sleep
argument_list|(
literal|2
argument_list|)
...
begin_comment
comment|/*  * print init data in ONCORE to clockstats file  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* finally, cable delay  and PPS offset */
name|sprintf
argument_list|(
name|Msg
argument_list|,
