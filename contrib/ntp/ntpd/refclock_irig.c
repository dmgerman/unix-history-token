...
begin_comment
comment|/*  * irig_debug - display audio parameters  *  * This code doesn't really do anything, except satisfy curiousity and  * verify the ioctl's work.  */
end_comment
...
name|printf
argument_list|(
literal|"irig: name %s, version %s, config %s\n"
argument_list|,
name|device
operator|.
name|name
...
name|printf
argument_list|(
literal|"irig: samples %d, channels %d, precision %d, encoding %d\n"
argument_list|,
name|info
operator|.
name|record
...
name|printf
argument_list|(
literal|"irig: gain %d, port %d, buffer %d\n"
argument_list|,
name|info
operator|.
name|record
...
name|printf
argument_list|(
literal|"irig: samples %d, eof %d, pause %d, error %d, waiting %d, balance %d\n"
argument_list|,
name|info
operator|.
name|record
...
name|printf
argument_list|(
literal|"irig: monitor %d, blocksize %d, hiwat %d, lowat %d, mode %d\n"
argument_list|,
name|info
operator|.
name|monitor_gain
...
name|printf
argument_list|(
literal|"irig: monitor %d, muted %d\n"
argument_list|,
name|info
operator|.
name|monitor_gain
