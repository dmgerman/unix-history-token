...
name|LOG_ERR
argument_list|,
literal|"Frequency format error in %s"
argument_list|,
name|stats_drift_file
argument_list|)
expr_stmt|;
...
name|LOG_INFO
argument_list|,
literal|"frequency initialized %.3f PPM from %s"
argument_list|,
name|old_drift
argument_list|,
name|stats_drift_file
...
begin_comment
comment|/*  * record_sys_stats - write system statistics to file  *  * file format  * time (s past midnight)  * time since startup (hr)  * packets recieved  * packets processed  * current version  * previous version  * bad version  * access denied  * bad length or format  * bad authentication  * rate exceeded  */
end_comment
...
name|fp
argument_list|,
literal|"%lu %s %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu\n"
argument_list|,
name|day
argument_list|,
name|ulfptoa
...
begin_comment
comment|/*  * sock_hash - hash an sockaddr_storage structure  */
end_comment
...
literal|128
expr_stmt|;
comment|/* % MON_HASH_SIZE hardcoded */
if|if
condition|(
name|hashVal
operator|<
