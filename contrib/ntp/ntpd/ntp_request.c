...
block|}
block|}
comment|/* 	 * If we need data, check to see if we have some.  If we 	 * don't, check to see that there is none (picky, picky). 	 * 	 * Handle the exception of REQ_CONFIG. It can have two data sizes. 	 */
if|if
condition|(
name|INFO_ITEMSIZE
argument_list|(
