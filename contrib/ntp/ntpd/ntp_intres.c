...
begin_comment
comment|/*  * For special situations define the FORCE_DNSRETRY Macro  * to force retries even if it fails the lookup.  * Use with extreme caution since it will then retry forever.  */
end_comment
