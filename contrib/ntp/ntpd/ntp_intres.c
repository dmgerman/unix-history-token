...
name|LOG_ERR
argument_list|,
literal|"invalid request keyid %lu"
argument_list|,
name|req_keyid
argument_list|)
expr_stmt|;
...
name|LOG_INFO
argument_list|,
literal|"doconfigure:findhostaddr() worked"
argument_list|)
expr_stmt|;
block|}
endif|#
...
name|LOG_INFO
argument_list|,
literal|"doconfigure: calling request()"
argument_list|)
expr_stmt|;
block|}
endif|#
...
name|LOG_INFO
argument_list|,
literal|"doconfigure: request() OK, removing this entry"
argument_list|)
expr_stmt|;
block|}
endif|#
