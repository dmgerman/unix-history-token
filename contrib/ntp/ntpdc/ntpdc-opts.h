...
directive|endif
comment|/**  *  Enumeration of each option type for ntpdc  */
expr|typedef enum
block|{
name|INDEX_OPT_IPV4
operator|=
...
begin_comment
comment|/** count of all options for ntpdc */
end_comment
...
begin_comment
comment|/** Full ntpdc version text */
end_comment
...
begin_comment
comment|/**  *  Enumeration of ntpdc exit codes  */
end_comment
...
literal|1
block|,
name|NTPDC_EXIT_USAGE_ERROR
init|=
literal|64
block|,
name|NTPDC_EXIT_NO_CONFIG_INPUT
init|=
literal|66
block|,
name|NTPDC_EXIT_LIBOPTS_FAILURE
init|=
literal|70
block|}
name|ntpdc_exit_code_t
typedef|;
end_typedef
...
value|STMTS(ntpdcOptions.fOptSet |= \                                     OPTPROC_NXLAT_OPT_CFG;)
end_define
...
value|STMTS(ntpdcOptions.fOptSet |= \                                     OPTPROC_NXLAT_OPT|OPTPROC_NXLAT_OPT_CFG;)
end_define
...
value|STMTS(ntpdcOptions.fOptSet&= \                                   ~OPTPROC_NXLAT_OPT;)
end_define
