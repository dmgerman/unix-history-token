...
begin_comment
comment|/* HAVE_LIBREADLINE || HAVE_LIBEDIT */
end_comment
...
name|stderr
argument_list|,
literal|"usage: %s [-46dilnps] [-c cmd] host ...\n"
argument_list|,
name|progname
argument_list|)
expr_stmt|;
...
directive|else
comment|/* not (HAVE_LIBREADLINE || HAVE_LIBEDIT) */
name|char
name|line
index|[
name|MAXLINE
...
begin_comment
comment|/*  * getarg - interpret an argument token  *  * return:	 0 - failure  *		 1 - success  *		-1 - skip to next token  */
end_comment
...
directive|endif
comment|/* decodenetnum only works with addresses */
if|if
condition|(
name|decodenetnum
argument_list|(
