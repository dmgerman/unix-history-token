...
name|fp
argument_list|,
literal|"bad length or format:   %ld\n"
argument_list|,
operator|(
name|u_long
operator|)
...
name|fp
argument_list|,
literal|"Warning: the \"dynamic\" keyword has been obsoleted and will be removed in the next release\n"
argument_list|)
expr_stmt|;
elseif|else
if|if
...
name|fp
argument_list|,
literal|"remote address          port local address      count m ver code avgint  lstint\n"
argument_list|)
expr_stmt|;
operator|(
name|void
...
name|fp
argument_list|,
literal|"%-22.22s %5d %-15s %8ld %1d %1d %6lx %6lu %7lu\n"
argument_list|,
name|nntohost
argument_list|(
operator|&
...
name|fp
argument_list|,
literal|"     address               port     count mode ver code avgint  lstint\n"
argument_list|)
expr_stmt|;
operator|(
name|void
...
name|fp
argument_list|,
literal|"%-25.25s %5d %9ld %4d %2d %9lx %9lu %9lu\n"
argument_list|,
name|nntohost
argument_list|(
operator|&
...
directive|define
name|IF_LIST_FMT
value|"%2d %c %48s %c %c %12.12s %03x %3d %2d %5d %5d %5d %2d %2d %3d %7d\n"
end_define
...
value|"%2s %c %48s %c %c %12.12s %3s %3s %2s %5s %5s %5s %2s %2s %3s %7s\n"
end_define
...
directive|define
name|IF_LIST_LABELS
value|"#", 'A', "Address/Mask/Broadcast", 'T', 'E', "IF name", "Flg", "TL", "#M", "recv", "sent", "drop", "S", "IX", "PC", "uptime"
end_define
