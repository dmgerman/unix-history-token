...
init|=
comment|/*     0 */
literal|"ntp-keygen (ntp) 4.2.8p8\n"
...
comment|/*  2229 */
literal|"ntp-keygen (ntp) - Create a NTP host key - Ver. 4.2.8p8\n"
