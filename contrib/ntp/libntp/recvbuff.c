...
begin_comment
comment|/*  Return the new full buffer event handle . This handle is   *  signalled when a recv buffer is placed in the full list.  */
end_comment
...
name|LOG_ERR
argument_list|,
literal|"Can't set receive buffer event"
argument_list|)
expr_stmt|;
block|}
endif|#
