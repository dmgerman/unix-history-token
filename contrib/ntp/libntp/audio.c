...
literal|6
decl_stmt|;
comment|/* 16 fragments, each 2^6 bytes */
if|if
condition|(
name|ioctl
argument_list|(
...
name|printf
argument_list|(
literal|"audio_init: SNDCTL_DSP_SETFRAGMENT: %s\n"
argument_list|,
name|strerror
argument_list|(
name|errno
...
directive|endif
comment|/* SNDCTL_DSP_SETFRAGMENT */
ifdef|#
directive|ifdef
name|AIOGFMT
if|if
...
literal|0
expr_stmt|;
comment|/* GCC thinks rval is used uninitialized */
endif|#
directive|endif
name|r
operator|=
...
directive|if
literal|0
comment|/* not a good idea to do this; connector wiring dependency */
