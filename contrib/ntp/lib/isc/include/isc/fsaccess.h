...
begin_comment
comment|/* $Id: fsaccess.h,v 1.16 2009/01/17 23:47:43 tbox Exp $ */
end_comment
...
begin_comment
comment|/*%< Not the owner or the group owner. */
end_comment

begin_define
define|#
directive|define
name|ISC_FSACCESS_WORLD
value|0x7
end_define

begin_comment
comment|/*%< User, Group, Other. */
end_comment

begin_comment
comment|/*  * Types of permission.  */
end_comment
...
begin_comment
comment|/*%  * Adding any permission bits beyond 0x200 would mean typedef'ing  * isc_fsaccess_t as isc_uint64_t, and redefining this value to  * reflect the new range of permission types, Probably to 21 for  * maximum flexibility.  The number of bits has to accommodate all of  * the permission types, and three full sets of them have to fit  * within an isc_fsaccess_t.  */
end_comment

begin_define
define|#
directive|define
name|ISC__FSACCESS_PERMISSIONBITS
value|10
end_define
