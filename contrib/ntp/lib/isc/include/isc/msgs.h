...
begin_comment
comment|/* $Id: msgs.h,v 1.19 2009/10/01 23:48:08 tbox Exp $ */
end_comment
...
begin_comment
comment|/*%< "%s: getting broadcast address: %s" */
end_comment
...
begin_comment
comment|/*%< %s: too many open WSA event handles: %s */
end_comment
