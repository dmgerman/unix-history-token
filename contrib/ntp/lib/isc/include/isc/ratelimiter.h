...
begin_comment
comment|/* $Id: ratelimiter.h,v 1.23 2009/01/18 23:48:14 tbox Exp $ */
end_comment
...
begin_comment
comment|/*! \file isc/ratelimiter.h  * \brief A rate limiter is a mechanism for dispatching events at a limited  * rate.  This is intended to be used when sending zone maintenance  * SOA queries, NOTIFY messages, etc.  */
end_comment
...
begin_comment
comment|/*!<  * Set the minimum interval between event executions.  * The interval value is copied, so the caller need not preserve it.  *  * Requires:  *	'*interval' is a nonzero interval.  */
end_comment
