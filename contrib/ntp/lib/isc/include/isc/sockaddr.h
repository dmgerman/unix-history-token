...
begin_comment
comment|/* $Id: sockaddr.h,v 1.57 2009/01/18 23:48:14 tbox Exp $ */
end_comment
...
begin_comment
comment|/*%<  * Return ISC_TRUE iff the most significant 'prefixlen' bits of the  * socket addresses 'a' and 'b' are equal, ignoring the ports.  * If 'b''s scope is zero then 'a''s scope will be ignored.  */
end_comment
