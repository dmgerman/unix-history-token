...
return|;
block|}
comment|/* 	 * Format for /proc/net/if_inet6: 	 * (see iface_proc_info() in net/ipv6/addrconf.c) 	 *<addr6:32><ifindex:2><prefix:2><scope:2><flags:2><name:8> 	 */
name|res
operator|=
name|sscanf
argument_list|(
...
name|AF_INET6
expr_stmt|;
comment|/* iter->current.ifindex = ifindex; */
name|iter
operator|->
name|current
operator|.
...
directive|endif
comment|/* 	 * enable_multicast_if() requires scopeid for setsockopt, 	 * so associate address with their corresponding ifindex. 	 */
