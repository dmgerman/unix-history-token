...
index|[]
init|=
literal|"$Id: inet_ntop.c,v 1.13 2001/11/27 01:56:00 gson Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* const char *  * isc_inet_ntop6(src, dst, size)  *	convert IPv6 binary address into presentation (printable) format  * author:  *	Paul Vixie, 1996.  */
end_comment
