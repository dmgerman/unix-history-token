...
begin_comment
comment|/**  * The version number as a string  */
end_comment
...
begin_comment
comment|/**  * The version number extra info as a string  */
end_comment
