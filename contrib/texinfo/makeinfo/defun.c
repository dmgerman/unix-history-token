...
begin_comment
comment|/* defun.c -- @defun and friends.    $Id: defun.c,v 1.11 2004/04/11 17:56:46 karl Exp $     Copyright (C) 1998, 1999, 2000, 2001, 2002, 2003, 2004 Free Software    Foundation, Inc.     This program is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2, or (at your option)    any later version.     This program is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with this program; if not, write to the Free Software Foundation,    Inc., 59 Temple Place - Suite 330, Boston, MA 02111-1307, USA.  */
end_comment
...
expr_stmt|;
block|}
comment|/* Make commas separate tokens so to differentiate them from          parameter types in XML output. */
elseif|else
if|if
condition|(
operator|*
...
break|break;
block|}
comment|/* End token if we are looking at a comma, as commas are 		 delimiters too. */
if|if
condition|(
name|c
operator|==
...
expr_stmt|;
block|}
comment|/* else if (defun_arg[0] == '&' || defun_arg[0] == COMMAND_PREFIX) */
comment|/* execute_string ("%s", defun_arg); */
comment|/* else if (auto_var_p) */
comment|/* execute_string ("%s", defun_arg); */
else|else
name|execute_string
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* Basic line continuation.  If a line ends with \s*@\s* concatanate        the next line. */
block|{
name|char
modifier|*
name|next_line
...
name|deftp
case|:
comment|/*<var> is for the following function arguments.  */
name|insert_html_tag
argument_list|(
name|START
argument_list|,
...
argument_list|()
expr_stmt|;
comment|/* Make an entry in the appropriate index.  (XML and      Docbook already got their entries, so skip them.)  */
if|if
condition|(
operator|!
name|xml
...
argument_list|)
expr_stmt|;
comment|/* Indent the definition a bit.  */
...
decl_stmt|;
comment|/* Skip over ifclear and ifset conditionals.  */
while|while
condition|(
name|i
operator|&&
