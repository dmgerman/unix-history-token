...
begin_comment
comment|/* Similarly for next etc. references in a @node command, where we    don't care about most of the entries. */
end_comment
...
argument_list|()
expr_stmt|;
comment|/* Fixme: html: need a navigation bar here. */
name|add_word
argument_list|(
literal|"</body></html>\n"
argument_list|)
...
condition|)
block|{
comment|/* this code not operational, we do not currently split html */
name|char
name|filename
index|[
literal|20
...
argument_list|)
expr_stmt|;
comment|/* FIXME: when this code is operational, we will need to              expand node, next, prev, and up before output.  */
name|add_word_args
argument_list|(
literal|"<html><head><title>%s</title>"
argument_list|,
name|node
argument_list|)
expr_stmt|;
