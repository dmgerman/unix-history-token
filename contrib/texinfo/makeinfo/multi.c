...
begin_comment
comment|/* multi.c -- multiple-column tables (@multitable) for makeinfo.    $Id: multi.c,v 1.8 2004/04/11 17:56:47 karl Exp $     Copyright (C) 1996, 1997, 1998, 1999, 2000, 2001, 2002, 2004 Free Software    Foundation, Inc.     This program is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2, or (at your option)    any later version.     This program is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with this program; if not, write to the Free Software Foundation,    Inc., 59 Temple Place - Suite 330, Boston, MA 02111-1307, USA.        Originally written by phr@gnu.org (Paul Rubin).  */
end_comment
...
specifier|static
name|int
name|current_column_no
decl_stmt|;
end_decl_stmt

begin_comment
comment|/* We need to make a difference between template based widths and    @columnfractions for HTML tables' sake.  Sigh.  */
end_comment

begin_decl_stmt
specifier|static
name|int
name|seen_column_fractions
decl_stmt|;
end_decl_stmt
...
literal|0
expr_stmt|;
comment|/* Assume no @columnfractions per default.  */
name|seen_column_fractions
operator|=
literal|0
expr_stmt|;
...
operator|++
expr_stmt|;
comment|/* Hmm, but what about @columnfractions 3foo.  Oh well,               it's invalid input anyway.  */
while|while
condition|(
operator|*
name|params
...
expr_stmt|;
block|{
comment|/* For html/xml/docbook, translate fractions into integer                percentages, adding .005 to avoid rounding problems.  For                info, we want the character width.  */
name|int
name|width
init|=
name|xml
...
name|add_word_args
argument_list|(
literal|"<tr align=\"left\"><%s valign=\"top\" width=\"%d%%\">"
argument_list|,
name|headitem_flag
condition|?
literal|"th"
...
name|add_word_args
argument_list|(
literal|"<tr align=\"left\"><%s valign=\"top\">"
argument_list|,
name|headitem_flag
condition|?
literal|"th"
...
name|_
argument_list|(
literal|"[unexpected] cannot select column #%d in multitable"
argument_list|)
argument_list|,
name|current_env_no
argument_list|)
...
name|add_word_args
argument_list|(
literal|"</%s><%s valign=\"top\" width=\"%d%%\">"
argument_list|,
name|headitem_row
condition|?
literal|"th"
