...
name|argv
argument_list|,
literal|"D:e:E:f:hI:o:p:P:r:s:U:vV:w"
argument_list|,
name|long_options
argument_list|,
operator|&
...
literal|0
expr_stmt|;
comment|/* too complicated for now */
break|break;
case|case
literal|'?'
case|:
...
condition|)
block|{
comment|/* Change any extension to .html.  */
name|char
modifier|*
name|html_name
decl_stmt|,
...
condition|)
block|{
comment|/* fixxme It would be nice to insert more useful alt text.  */
name|sprintf
argument_list|(
name|fullname
argument_list|,
