...
parameter_list|)
block|{
comment|/* TODO really handle this tag.  */
return|return;
block|}
end_function
...
condition|)
block|{
comment|/* Found new style tag/cookie \0\b[ 		 Read until the closing tag \0\b] */
name|int
name|element_len
init|=
literal|0
...
literal|5
expr_stmt|;
comment|/* Append string terminator.  */
name|element
index|[
name|element_len
index|]
