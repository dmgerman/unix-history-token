...
begin_comment
comment|/* key.c -- Generated array containing function names.     This file was automatically made from various source files with the    command "..//info/makedoc".  DO NOT EDIT THIS FILE, only "..//info/makedoc.c".     Source files groveled to make this file include:  	./session.c 	./echo-area.c 	./infodoc.c 	./m-x.c 	./indices.c 	./nodemenu.c 	./footnotes.c 	./variables.c     An entry in the array FUNCTION_KEY_ARRAY is made for each command    found in the above files; each entry consists of    a string which is the user-visible name of the function.  */
end_comment
