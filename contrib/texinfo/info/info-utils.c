...
begin_comment
comment|/* info-utils.c -- Useful functions for manipulating Info file quirks. */
end_comment
...
begin_comment
comment|/* Get the entry associated with LABEL in MENU.  Return a pointer to the    REFERENCE if found, or NULL. */
end_comment
