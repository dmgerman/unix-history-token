...
comment|/* cf. emacs/src/sysdep.c for being sure output is on. */
if|#
directive|if
name|defined
argument_list|(
name|HAVE_TERMIOS_H
argument_list|)
comment|/* linux kernel 2.2.x needs a TCOFF followed by a TCOON to turn output      back on if the user presses ^S at the very beginning; just a TCOON      doesn't work.  --Kevin Ryde<user42@zip.com.au>, 16jun2000.  */
name|tcsetattr
argument_list|(
name|tty
argument_list|,
