...
name|fp
argument_list|,
literal|"#define YYERROR_DECL() yyerror(const char *s)\n"
argument_list|)
expr_stmt|;
name|putl_code
argument_list|(
...
name|fp
argument_list|,
literal|"#define YYERROR_CALL(msg) yyerror(msg)\n"
argument_list|)
expr_stmt|;
name|putl_code
argument_list|(
