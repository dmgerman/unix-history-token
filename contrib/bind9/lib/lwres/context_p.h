...
name|use_ipv4
decl_stmt|;
comment|/*%< use IPv4 transaction */
name|int
name|use_ipv6
decl_stmt|;
comment|/*%< use IPv6 transaction */
comment|/*@{*/
