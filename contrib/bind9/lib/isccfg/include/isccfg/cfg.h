...
begin_comment
comment|/*! \file isccfg/cfg.h  * \brief  * This is the new, table-driven, YACC-free configuration file parser.  */
end_comment
...
begin_comment
comment|/*%<  * Returns the value of a configuration object of fixed point number.  *  * Requires:  * \li     'obj' points to a valid configuration object of fixed point type.  *  * Returns:  * \li     A 32-bit unsigned integer.  */
end_comment
...
begin_comment
comment|/*%<  * Returns the length of a list of configure objects.  If obj is  * not a list, returns 0.  If recurse is true, add in the length of  * all contained lists.  */
end_comment
...
begin_comment
comment|/* '?' out shared keys. */
end_comment

begin_comment
comment|/*%<  * Print the configuration object 'obj' by repeatedly calling the  * function 'f', passing 'closure' and a region of text starting  * at 'text' and comprising 'textlen' characters.  *  * If CFG_PRINTER_XKEY the contents of shared keys will be obscured  * by replacing them with question marks ('?')  */
end_comment
...
begin_comment
comment|/*%<  * Delete a reference to a configuration object; destroy the object if  * there are no more references.  *  * Require:  * \li     '*obj' is a valid cfg_obj_t.  * \li     'pctx' is a valid cfg_parser_t.  */
end_comment
