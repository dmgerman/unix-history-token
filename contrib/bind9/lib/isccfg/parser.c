...
name|CFG_LOG_NEAR
argument_list|,
literal|"expected fixed point number"
argument_list|)
expr_stmt|;
return|return
operator|(
...
begin_comment
comment|/*  * Any string (quoted or unquoted); printed with quotes.  * If CFG_PRINTER_XKEY is set when printing the string will be '?' out.  */
end_comment
