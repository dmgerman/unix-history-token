...
begin_comment
comment|/*  * Copyright (C) 2004-2015  Internet Systems Consortium, Inc. ("ISC")  * Copyright (C) 2002, 2003  Internet Software Consortium.  *  * Permission to use, copy, modify, and/or distribute this software for any  * purpose with or without fee is hereby granted, provided that the above  * copyright notice and this permission notice appear in all copies.  *  * THE SOFTWARE IS PROVIDED "AS IS" AND ISC DISCLAIMS ALL WARRANTIES WITH  * REGARD TO THIS SOFTWARE INCLUDING ALL IMPLIED WARRANTIES OF MERCHANTABILITY  * AND FITNESS.  IN NO EVENT SHALL ISC BE LIABLE FOR ANY SPECIAL, DIRECT,  * INDIRECT, OR CONSEQUENTIAL DAMAGES OR ANY DAMAGES WHATSOEVER RESULTING FROM  * LOSS OF USE, DATA OR PROFITS, WHETHER IN AN ACTION OF CONTRACT, NEGLIGENCE  * OR OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR  * PERFORMANCE OF THIS SOFTWARE.  */
end_comment
...
begin_comment
comment|/*%  * A list of socket addresses with an optional default port, as used  * in the lwresd 'listen-on' option.  E.g., "{ 10.0.0.1; 1::2 port 69; }"  */
end_comment
...
specifier|static
name|cfg_type_t
name|cfg_type_dnssecupdatemode
init|=
block|{
literal|"dnssecupdatemode"
block|,
name|cfg_parse_enum
block|,
name|cfg_print_ustring
...
specifier|static
name|cfg_type_t
name|cfg_type_updatemethod
init|=
block|{
literal|"updatemethod"
block|,
name|cfg_parse_enum
block|,
name|cfg_print_ustring
...
begin_comment
comment|/*  * zone-statistics: full, terse, or none.  *  * for backward compatibility, we also support boolean values.  * yes represents "full", no represents "terse". in the future we  * may change no to mean "none".  */
end_comment
...
begin_comment
comment|/*%  * fetch-quota-params  */
end_comment

begin_decl_stmt
specifier|static
name|cfg_tuplefielddef_t
name|fetchquota_fields
index|[]
init|=
block|{
block|{
...
begin_comment
comment|/*%  * fetches-per-server or fetches-per-zone  */
end_comment
...
begin_comment
comment|/*%  *  response-policy {  *	zone<string> [ policy (given|disabled|passthru|  *					nxdomain|nodata|cname<domain> ) ]  *		      [ recursive-only yes|no ] [ max-policy-ttl number ] ;  *  } [ recursive-only yes|no ] [ max-policy-ttl number ]  *	 [ break-dnssec yes|no ] [ min-ns-dots number ] ;  */
end_comment
...
name|p
decl_stmt|;
comment|/* 	 * This is cfg_doc_enum() without the trailing " )". 	 */
name|cfg_print_chars
argument_list|(
name|pctx
argument_list|,
...
begin_comment
comment|/*  * Parse  *	given|disabled|passthru|nxdomain|nodata|cname<domain>  */
end_comment

begin_function
specifier|static
name|isc_result_t
name|cfg_parse_rpz_policy
parameter_list|(
name|cfg_parser_t
modifier|*
name|pctx
...
begin_comment
comment|/*  * Parse a tuple consisting of any kind of required field followed  * by 2 or more optional keyvalues that can be in any order.  */
end_comment

begin_function
specifier|static
name|isc_result_t
name|cfg_parse_kv_tuple
parameter_list|(
name|cfg_parser_t
modifier|*
name|pctx
...
argument_list|)
expr_stmt|;
comment|/* 	 * The zone first field is required and always first. 	 */
name|fields
operator|=
name|type
operator|->
...
name|ISC_TRUE
decl_stmt|;
comment|/* 	 * If othertype is cfg_type_void, it means that enumtype is 	 * optional. 	 */
if|if
condition|(
name|othertype
operator|==
