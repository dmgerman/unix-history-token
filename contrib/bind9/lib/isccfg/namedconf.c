...
begin_comment
comment|/*%  *  response-policy {  *	zone<string> [ policy (given|disabled|passthru|  *					nxdomain|nodata|cname<domain> ) ]  *		      [ recursive-only yes|no ]  *		      [ max-policy-ttl number ] ;  *  } [ recursive-only yes|no ] [ break-dnssec yes|no ]  *	[ max-policy-ttl number ] ;  */
end_comment
