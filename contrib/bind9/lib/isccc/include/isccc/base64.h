...
begin_comment
comment|/* $Id: base64.h,v 1.2.206.1 2004/03/06 08:15:21 marka Exp $ */
end_comment
...
begin_comment
comment|/*  * Decode a null-terminated base64 string.  *  * Requires:  *	'cstr' is non-null.  *	'target' is a valid region.  *  * Returns:  *	ISC_R_SUCCESS	-- the entire decoded representation of 'cstring'  *			   fit in 'target'.  *	ISC_R_BADBASE64 -- 'cstr' is not a valid base64 encoding.  *	ISC_R_NOSPACE	-- 'target' is not big enough.  */
end_comment
