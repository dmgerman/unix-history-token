...
begin_comment
comment|/* $Id: base64.h,v 1.10 2007-08-28 07:20:43 tbox Exp $ */
end_comment
...
begin_comment
comment|/*%<  * Decode a null-terminated base64 string.  *  * Requires:  *\li	'cstr' is non-null.  *\li	'target' is a valid region.  *  * Returns:  *\li	#ISC_R_SUCCESS	-- the entire decoded representation of 'cstring'  *			   fit in 'target'.  *\li	#ISC_R_BADBASE64 -- 'cstr' is not a valid base64 encoding.  *\li	#ISC_R_NOSPACE	-- 'target' is not big enough.  */
end_comment
