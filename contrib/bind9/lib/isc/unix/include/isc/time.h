...
begin_comment
comment|/* $Id: time.h,v 1.30.18.2 2005/04/29 00:17:10 marka Exp $ */
end_comment
...
begin_comment
comment|/*%<  * Set 't' to a particular number of seconds + nanoseconds since the epoch.  *  * Notes:  *\li	This call is equivalent to:  *\code  *	isc_time_settoepoch(t);  *	isc_interval_set(i, seconds, nanoseconds);  *	isc_time_add(t, i, t);  *\endcode  * Requires:  *\li	't' is a valid pointer.  *\li	nanoseconds< 1000000000.  */
end_comment
...
begin_comment
comment|/*%<  * Return the number of nanoseconds stored in a time structure.  *  * Notes:  *\li	This is the number of nanoseconds in excess of the the number  *	of seconds since the epoch; it will always be less than one  *	full second.  *  * Requires:  *\li	't' is a valid pointer.  *  * Ensures:  *\li	The returned value is less than 1*10^9.  */
end_comment
