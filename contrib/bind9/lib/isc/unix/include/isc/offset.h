...
begin_comment
comment|/* $Id: offset.h,v 1.15.332.2 2009-02-16 23:47:15 tbox Exp $ */
end_comment
...
begin_comment
comment|/* For Linux Standard Base. */
end_comment
...
define|\
value|(~(((off_t)-1>> (sizeof(off_t) * CHAR_BIT - 1)) \<< (sizeof(off_t) * CHAR_BIT - 1)))
end_define
