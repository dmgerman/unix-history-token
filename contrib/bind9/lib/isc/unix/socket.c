...
name|__LINE__
argument_list|,
literal|"epoll_ctl(ADD/MOD) returned "
literal|"EEXIST for fd %d"
argument_list|,
name|fd
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|/* Should never get this one but it was seen. */
ifdef|#
directive|ifdef
name|ENOPROTOOPT
name|SOFT_OR_HARD
...
directive|endif
comment|/* 	 * Use minimum mtu if possible. 	 */
name|use_min_mtu
argument_list|(
name|sock
argument_list|)
...
name|USE_DEVPOLL
argument_list|)
comment|/* 			 * Re-probe every thousand calls. 			 */
if|if
condition|(
name|manager
operator|->
...
condition|)
block|{
comment|/* 					 * {OPEN_MAX} may have dropped.  Look 					 * up the current value and try again. 					 */
name|result
operator|=
name|isc_resource_getcurlimit
argument_list|(
