...
begin_comment
comment|/* $Id: socket.c,v 1.237.18.29.10.6 2008/07/29 04:47:31 each Exp $ */
end_comment
...
begin_comment
comment|/*%  * Mac OS X needs a special definition to support larger values in select()  */
end_comment
...
begin_comment
comment|/*%  * The size to raise the recieve buffer to (from BIND 8).  */
end_comment
...
begin_comment
comment|/*  * Initialize fdsets in socketmgr structure.  */
end_comment
...
begin_comment
comment|/*  * Clean up fdsets in socketmgr structure.  */
end_comment
...
block|{
comment|/* Prepare duplicates of fd_sets, as select() will modify */
name|memcpy
argument_list|(
name|socketmgr
operator|->
