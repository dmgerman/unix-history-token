...
begin_comment
comment|/* $Id: base32.h,v 1.3 2008/09/25 04:02:39 tbox Exp $ */
end_comment
...
begin_comment
comment|/*  * Routines for manipulating base 32 and base 32 hex encoded data.  * Based on RFC 4648.  *  * Base 32 hex preserves the sort order of data when it is encoded /  * decoded.  */
end_comment
...
begin_comment
comment|/*!<  * \brief Decode a packed (no white space permitted) base32 region.  *  * Requires:  *\li   'source' is a valid region.  *\li   'target' is a valid buffer.  *  * Returns:  *\li   #ISC_R_SUCCESS  -- the entire decoded representation of 'cstring'  *                         fit in 'target'.  *\li   #ISC_R_BADBASE32 -- 'source' is not a valid base32 encoding.  */
end_comment
