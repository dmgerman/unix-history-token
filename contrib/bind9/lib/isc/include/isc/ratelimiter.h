...
begin_comment
comment|/* $Id: ratelimiter.h,v 1.15.18.2 2005/04/29 00:17:01 marka Exp $ */
end_comment
...
begin_comment
comment|/*! \file  * \brief A rate limiter is a mechanism for dispatching events at a limited  * rate.  This is intended to be used when sending zone maintenance  * SOA queries, NOTIFY messages, etc.  */
end_comment
