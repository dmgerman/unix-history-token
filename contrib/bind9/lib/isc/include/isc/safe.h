...
begin_comment
comment|/*%<  * Returns ISC_TRUE iff. two blocks of memory are equal, otherwise  * ISC_FALSE.  *  */
end_comment
...
begin_comment
comment|/*%<  * Clone of libc memcmp() which is safe to differential timing attacks.  */
end_comment
