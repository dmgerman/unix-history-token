...
begin_comment
comment|/* $Id: refcount.h,v 1.6.18.5 2005/07/12 01:22:31 marka Exp $ */
end_comment
...
begin_comment
comment|/*! \file  * \brief Implements a locked reference counter.    *  * These functions may actually be  * implemented using macros, and implementations of these macros are below.  * The isc_refcount_t type should not be accessed directly, as its contents  * depend on the implementation.  */
end_comment
