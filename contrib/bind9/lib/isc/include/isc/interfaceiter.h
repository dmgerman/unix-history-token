...
begin_comment
comment|/* $Id: interfaceiter.h,v 1.17 2007-06-19 23:47:18 tbox Exp $ */
end_comment
...
begin_comment
comment|/*! \file isc/interfaceiter.h  * \brief Iterates over the list of network interfaces.  *  * Interfaces whose address family is not supported are ignored and never  * returned by the iterator.  Interfaces whose netmask, interface flags,  * or similar cannot be obtained are also ignored, and the failure is logged.  *  * Standards:  *	The API for scanning varies greatly among operating systems.  *	This module attempts to hide the differences.  */
end_comment
