...
begin_comment
comment|/* $Id: msgcat.h,v 1.9.18.2 2005/04/29 00:16:59 marka Exp $ */
end_comment
...
begin_comment
comment|/*%<  * Open a message catalog.  *  * Notes:  *  *\li	If memory cannot be allocated or other failures occur, *msgcatp  *	will be set to NULL.  If a NULL msgcat is given to isc_msgcat_get(),  *	the default_text will be returned, ensuring that some message text  *	will be available, no matter what's going wrong.  *  * Requires:  *  *\li	'name' is a valid string.  *  *\li	msgcatp != NULL&& *msgcatp == NULL  */
end_comment
...
begin_comment
comment|/*%<  * Close a message catalog.  *  * Notes:  *  *\li	Any string pointers returned by prior calls to isc_msgcat_get() are  *	invalid after isc_msgcat_close() has been called and must not be  *	used.  *  * Requires:  *  *\li	*msgcatp is a valid message catalog or is NULL.  *  * Ensures:  *  *\li	All resources associated with the message catalog are released.  *  *\li	*msgcatp == NULL  */
end_comment
...
begin_comment
comment|/*%<  * Get message 'message' from message set 'set' in 'msgcat'.  If it  * is not available, use 'default_text'.  *  * Requires:  *  *\li	'msgcat' is a valid message catalog or is NULL.  *  *\li	set> 0  *  *\li	message> 0  *  *\li	'default_text' is a valid string.  */
end_comment
