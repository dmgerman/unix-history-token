...
begin_comment
comment|/* $Id: random.h,v 1.12.18.4 2009/01/19 23:46:16 tbox Exp $ */
end_comment
...
begin_comment
comment|/*! \file  * \brief Implements a random state pool which will let the caller return a  * series of possibly non-reproducible random values.  *  * Note that the  * strength of these numbers is not all that high, and should not be  * used in cryptography functions.  It is useful for jittering values  * a bit here and there, such as timeouts, etc.  */
end_comment
