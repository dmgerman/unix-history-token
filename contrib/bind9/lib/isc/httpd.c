...
begin_comment
comment|/*  * Copyright (C) 2006-2008, 2010-2012, 2014-2016  Internet Systems Consortium, Inc. ("ISC")  *  * Permission to use, copy, modify, and/or distribute this software for any  * purpose with or without fee is hereby granted, provided that the above  * copyright notice and this permission notice appear in all copies.  *  * THE SOFTWARE IS PROVIDED "AS IS" AND ISC DISCLAIMS ALL WARRANTIES WITH  * REGARD TO THIS SOFTWARE INCLUDING ALL IMPLIED WARRANTIES OF MERCHANTABILITY  * AND FITNESS.  IN NO EVENT SHALL ISC BE LIABLE FOR ANY SPECIAL, DIRECT,  * INDIRECT, OR CONSEQUENTIAL DAMAGES OR ANY DAMAGES WHATSOEVER RESULTING FROM  * LOSS OF USE, DATA OR PROFITS, WHETHER IN AN ACTION OF CONTRACT, NEGLIGENCE  * OR OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR  * PERFORMANCE OF THIS SOFTWARE.  */
end_comment
...
begin_comment
comment|/* Got a Connection: Keep-Alive */
end_comment
...
name|headers
decl_stmt|;
comment|/*%< set in process_request() */
name|unsigned
name|int
name|method
decl_stmt|;
...
begin_comment
comment|/*  * Look for the given header in headers.  * If value is specified look for it terminated with a character in eov.  */
end_comment
...
operator|)
return|;
comment|/* 		 * Skip optional leading white space. 		 */
name|h
operator|+=
name|hlen
expr_stmt|;
...
operator|++
expr_stmt|;
comment|/* 		 * Terminate token search on NULL or EOL. 		 */
while|while
condition|(
operator|*
name|h
...
operator|)
return|;
comment|/* 	 * NUL terminate request at the blank line. 	 */
name|s
index|[
name|delim
index|]
...
expr_stmt|;
block|}
comment|/* 	 * Extract the HTTP/1.X protocol.  We will bounce on anything but 	 * HTTP/1.0 or HTTP/1.1 for now. 	 */
while|while
condition|(
name|LENGTHOK
argument_list|(
...
operator|)
return|;
comment|/* 	 * Check that we have the expected eol delimiter. 	 */
if|if
condition|(
name|strncmp
argument_list|(
