...
begin_comment
comment|/*  * Copyright (C) 2004-2016  Internet Systems Consortium, Inc. ("ISC")  * Copyright (C) 2001-2003  Internet Software Consortium.  *  * Permission to use, copy, modify, and/or distribute this software for any  * purpose with or without fee is hereby granted, provided that the above  * copyright notice and this permission notice appear in all copies.  *  * THE SOFTWARE IS PROVIDED "AS IS" AND ISC DISCLAIMS ALL WARRANTIES WITH  * REGARD TO THIS SOFTWARE INCLUDING ALL IMPLIED WARRANTIES OF MERCHANTABILITY  * AND FITNESS.  IN NO EVENT SHALL ISC BE LIABLE FOR ANY SPECIAL, DIRECT,  * INDIRECT, OR CONSEQUENTIAL DAMAGES OR ANY DAMAGES WHATSOEVER RESULTING FROM  * LOSS OF USE, DATA OR PROFITS, WHETHER IN AN ACTION OF CONTRACT, NEGLIGENCE  * OR OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR  * PERFORMANCE OF THIS SOFTWARE.  */
end_comment
...
name|ISC_R_FAILURE
expr_stmt|;
comment|/* 	 * Check that a RFC 1918 / ULA reverse zone is not forward first 	 * unless explictly configured to be so. 	 */
if|if
condition|(
name|ztype
operator|==
...
condition|)
block|{
comment|/* 			 * Forward mode not explicity configured. 			 */
if|if
condition|(
name|voptions
operator|!=
...
name|ISC_LOG_WARNING
argument_list|,
literal|"inherited 'forward first;' for "
literal|"%s zone '%s' - did you want "
...
name|ISC_LOG_ERROR
argument_list|,
literal|"writeable file '%s': already in use: "
literal|"%s:%u"
argument_list|,
name|cfg_obj_asstring
argument_list|(
...
name|ISC_R_FAILURE
expr_stmt|;
comment|/* 	 * Use case insensitve comparision as not all file systems are 	 * case sensitive. This will prevent people using FOO.DB and foo.db 	 * on case sensitive file systems but that shouldn't be a major issue. 	 */
name|tresult
operator|=
name|isc_symtab_create
argument_list|(
