...
begin_comment
comment|/*  * Copyright (C) 2004-2009, 2011-2016  Internet Systems Consortium, Inc. ("ISC")  * Copyright (C) 1999-2003  Internet Software Consortium.  *  * Permission to use, copy, modify, and/or distribute this software for any  * purpose with or without fee is hereby granted, provided that the above  * copyright notice and this permission notice appear in all copies.  *  * THE SOFTWARE IS PROVIDED "AS IS" AND ISC DISCLAIMS ALL WARRANTIES WITH  * REGARD TO THIS SOFTWARE INCLUDING ALL IMPLIED WARRANTIES OF MERCHANTABILITY  * AND FITNESS.  IN NO EVENT SHALL ISC BE LIABLE FOR ANY SPECIAL, DIRECT,  * INDIRECT, OR CONSEQUENTIAL DAMAGES OR ANY DAMAGES WHATSOEVER RESULTING FROM  * LOSS OF USE, DATA OR PROFITS, WHETHER IN AN ACTION OF CONTRACT, NEGLIGENCE  * OR OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR  * PERFORMANCE OF THIS SOFTWARE.  */
end_comment
...
parameter_list|)
define|\
value|GETTOKENERR(lexer, options, token, eol, {} )
end_define
...
argument|lctx->ttl =
literal|0
argument|; 					    lctx->default_ttl_known = ISC_TRUE;
argument_list|)
empty_stmt|;
name|result
operator|=
...
name|callbacks
argument_list|,
literal|"%s:%lu: record with inherited "
literal|"owner (%s) immediately after "
literal|"$ORIGIN (%s)"
argument_list|,
name|source
argument_list|,
...
begin_comment
comment|/*  * Fill/check exists buffer with 'len' bytes.  Track remaining bytes to be  * read when incrementally filling the buffer.  */
end_comment
