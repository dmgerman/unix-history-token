...
begin_comment
comment|/* $Id: db.c,v 1.99.4.1 2011/10/23 20:12:07 vjs Exp $ */
end_comment
...
parameter_list|)
block|{
comment|/* 	 * Find the node with name 'name', passing 'arg' to the database 	 * implementation. 	 */
name|REQUIRE
argument_list|(
name|DNS_DB_VALID
argument_list|(
...
parameter_list|)
block|{
comment|/* 	 * Find the best match for 'name' and 'type' in version 'version' 	 * of 'db', passing in 'arg'. 	 */
name|REQUIRE
argument_list|(
name|DNS_DB_VALID
argument_list|(
