...
name|ip_name
decl_stmt|;
comment|/* RPZ_IP_ZONE.LOCALHOST. */
name|dns_name_t
name|nsip_name
decl_stmt|;
comment|/* RPZ_NSIP_ZONE.LOCALHOST. */
name|dns_name_t
name|nsdname_name
decl_stmt|;
comment|/* RPZ_NSDNAME_ZONE.LOCALHOST */
block|}
struct|;
end_struct
...
return|;
block|}
comment|/* 	 * Get text for the IP address without RPZ_x_ZONE.rpz.LOCALHOST. 	 */
...
name|src_name
argument_list|,
literal|"; bad IPv4 prefix length"
argument_list|)
expr_stmt|;
return|return
operator|(
...
expr_stmt|;
block|}
comment|/* 	 * Convert the IPv6 address back to a canonical policy domain name 	 * to ensure that it is in canonical form. 	 */
if|if
condition|(
name|ISC_R_SUCCESS
operator|!=
