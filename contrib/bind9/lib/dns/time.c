...
name|region
decl_stmt|;
comment|/*  * Warning. Do NOT use arguments with side effects with these macros.  */
define|#
directive|define
name|is_leap
parameter_list|(
...
operator|)
return|;
comment|/* 	 * Confirm the source only consists digits.  sscanf() allows some 	 * minor exceptions. 	 */
for|for
control|(
name|i
operator|=
...
comment|/* 	 * Calculate seconds from epoch. 	 * Note: this uses a idealized calendar. 	 */
name|value
operator|=
name|second
operator|+
