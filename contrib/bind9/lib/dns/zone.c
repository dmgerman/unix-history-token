...
begin_comment
comment|/* $Id: zone.c,v 1.333.2.23.2.55 2005/02/03 23:50:45 marka Exp $ */
end_comment
...
literal|0
expr_stmt|;
comment|/* 	 * If count == 0, don't allocate any space for masters or keynames 	 * so internally, those pointers are NULL if count == 0 	 */
if|if
condition|(
name|count
operator|==
