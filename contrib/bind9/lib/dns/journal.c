...
begin_comment
comment|/*  * Copyright (C) 2004, 2005, 2007-2011, 2013, 2014  Internet Systems Consortium, Inc. ("ISC")  * Copyright (C) 1999-2002  Internet Software Consortium.  *  * Permission to use, copy, modify, and/or distribute this software for any  * purpose with or without fee is hereby granted, provided that the above  * copyright notice and this permission notice appear in all copies.  *  * THE SOFTWARE IS PROVIDED "AS IS" AND ISC DISCLAIMS ALL WARRANTIES WITH  * REGARD TO THIS SOFTWARE INCLUDING ALL IMPLIED WARRANTIES OF MERCHANTABILITY  * AND FITNESS.  IN NO EVENT SHALL ISC BE LIABLE FOR ANY SPECIAL, DIRECT,  * INDIRECT, OR CONSEQUENTIAL DAMAGES OR ANY DAMAGES WHATSOEVER RESULTING FROM  * LOSS OF USE, DATA OR PROFITS, WHETHER IN AN ACTION OF CONTRACT, NEGLIGENCE  * OR OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR  * PERFORMANCE OF THIS SOFTWARE.  */
end_comment

begin_comment
comment|/* $Id: journal.c,v 1.120 2011/12/22 07:32:41 each Exp $ */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* 	 * Just write out a updated header. 	 */
if|if
condition|(
name|j
operator|->
...
argument_list|)
expr_stmt|;
comment|/* 	 * We should now be roughly half target_size provided 	 * we did not reach 'serial'.  If not we will just copy 	 * all uncommitted deltas regardless of the size. 	 */
name|copy_length
operator|=
name|j
operator|->
