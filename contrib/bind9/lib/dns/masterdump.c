...
name|x
parameter_list|)
value|do { \ 	if ((x) != ISC_R_SUCCESS) \ 		goto cleanup; \ 	} while (0)
end_define
...
argument_list|)
expr_stmt|;
comment|/* 			 * Print a summary of the cached records which make 			 * up the negative response. 			 */
name|RETERR
argument_list|(
name|ncache_summary
argument_list|(
...
name|ISC_LOG_ERROR
argument_list|,
literal|"dumping to master file: %s: flush: %s"
argument_list|,
name|temp
argument_list|,
name|isc_result_totext
...
name|ISC_LOG_ERROR
argument_list|,
literal|"dumping to stream: flush: %s"
argument_list|,
name|isc_result_totext
argument_list|(
name|result
...
name|ISC_LOG_ERROR
argument_list|,
literal|"dumping to master file: %s: fsync: %s"
argument_list|,
name|temp
argument_list|,
name|isc_result_totext
...
name|ISC_LOG_ERROR
argument_list|,
literal|"dumping to stream: fsync: %s"
argument_list|,
name|isc_result_totext
argument_list|(
name|result
