...
begin_comment
comment|/* $Id: resolver.c,v 1.284.18.79.2.1 2009/11/19 00:25:17 marka Exp $ */
end_comment
...
name|us
decl_stmt|;
comment|/* 	 * We retry every .5 seconds the first two times through the address 	 * list, and then we do exponential back-off. 	 */
if|if
condition|(
name|fctx
operator|->
...
name|FCTXTRACE
argument_list|(
literal|"too many timeouts, setting EDNS size to 512"
argument_list|)
expr_stmt|;
block|}
if|if
