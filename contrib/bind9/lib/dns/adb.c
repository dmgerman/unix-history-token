...
argument_list|)
expr_stmt|;
comment|/* 		 * Isolate shutdown_names and shutdown_entries calls. 		 */
name|inc_adb_irefcnt
argument_list|(
name|adb
argument_list|)
...
argument_list|)
expr_stmt|;
comment|/* 		 * Don't record a failure unless this is the initial 		 * fetch of a chain. 		 */
if|if
condition|(
name|fetch
operator|->
...
begin_comment
comment|/*  * (10000 / ((10 + n) / 10)^(3/2)) for n in 0..99.  * These will be used to make quota adjustments.  */
end_comment
...
begin_comment
comment|/*  * Caller must hold adbentry lock  */
end_comment

begin_function
specifier|static
name|void
name|maybe_adjust_quota
parameter_list|(
name|dns_adb_t
modifier|*
name|adb
...
condition|)
return|return;
comment|/* 	 * Calculate an exponential rolling average of the timeout ratio 	 * 	 * XXX: Integer arithmetic might be better than floating point 	 */
name|tr
operator|=
operator|(
name|double
...
name|entry
argument_list|,
literal|"atr %0.2f, quota increased to %d"
argument_list|,
name|addr
operator|->
name|entry
...
name|entry
argument_list|,
literal|"atr %0.2f, quota decreased to %d"
argument_list|,
name|addr
operator|->
name|entry
...
expr_stmt|;
block|}
comment|/* Ensure we don't drop to zero */
if|if
condition|(
name|addr
operator|->
