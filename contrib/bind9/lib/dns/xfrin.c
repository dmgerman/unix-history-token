...
name|nrecs
decl_stmt|;
comment|/*%< Number of records recvd */
name|isc_uint64_t
name|nbytes
decl_stmt|;
...
name|start
decl_stmt|;
comment|/*%< Start time of the transfer */
name|isc_time_t
name|end
decl_stmt|;
comment|/*%< End time of the transfer */
name|dns_tsigkey_t
modifier|*
name|tsigkey
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|/* 	 * Reserve 2 bytes for TCP length at the begining of the buffer. 	 */
...
argument_list|)
expr_stmt|;
comment|/* 	 * Record message length and adjust region to include TCP 	 * length field. 	 */
name|xfr
operator|->
name|qbuffer_data
index|[
...
operator|++
expr_stmt|;
comment|/* 	 * Update the number of bytes received. 	 */
name|xfr
operator|->
name|nbytes
operator|+=
...
name|ISC_LOG_INFO
argument_list|,
literal|"Transfer completed: %d messages, %d records, "
literal|"%"
name|ISC_PRINT_QUADFORMAT
literal|"u bytes, "
literal|"%u.%03u secs (%u bytes/sec)"
argument_list|,
name|xfr
operator|->
name|nmsg
