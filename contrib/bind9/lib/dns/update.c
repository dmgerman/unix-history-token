...
begin_comment
comment|/*  * Copyright (C) 2011-2013, 2015  Internet Systems Consortium, Inc. ("ISC")  *  * Permission to use, copy, modify, and/or distribute this software for any  * purpose with or without fee is hereby granted, provided that the above  * copyright notice and this permission notice appear in all copies.  *  * THE SOFTWARE IS PROVIDED "AS IS" AND ISC DISCLAIMS ALL WARRANTIES WITH  * REGARD TO THIS SOFTWARE INCLUDING ALL IMPLIED WARRANTIES OF MERCHANTABILITY  * AND FITNESS.  IN NO EVENT SHALL ISC BE LIABLE FOR ANY SPECIAL, DIRECT,  * INDIRECT, OR CONSEQUENTIAL DAMAGES OR ANY DAMAGES WHATSOEVER RESULTING FROM  * LOSS OF USE, DATA OR PROFITS, WHETHER IN AN ACTION OF CONTRACT, NEGLIGENCE  * OR OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR  * PERFORMANCE OF THIS SOFTWARE.  */
end_comment
...
directive|define
name|STATE_MAGIC
value|ISC_MAGIC('S', 'T', 'T', 'E')
end_define

begin_define
define|#
directive|define
name|DNS_STATE_VALID
parameter_list|(
name|state
parameter_list|)
value|ISC_MAGIC_VALID(state, STATE_MAGIC)
end_define
...
name|ISC_FALSE
expr_stmt|;
comment|/* silence false compiler warning */
break|break;
block|}
return|return
operator|(
...
condition|)
block|{
comment|/* 				 * CDS and CDNSKEY are signed with KSK 				 * (RFC 7344, 4.1). 				*/
if|if
condition|(
name|type
operator|!=
...
name|ISC_LOG_ERROR
argument_list|,
literal|"could not get zone keys for secure "
