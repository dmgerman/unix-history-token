...
parameter_list|)
define|\
value|if (!(cond)) { \ 		fprintf(stderr, "%s:%d: INSIST(%s)\n", \ 			 __FILE__, __LINE__, #cond); \ 		abort(); \ 	}
end_define
...
begin_comment
comment|/* DNS mnemonic size. Must be less than 100. */
end_comment
...
directive|define
name|TYPECLASSFMT
value|"%" STR(TYPECLASSLEN) "[-0-9a-z]_%d"
end_define
...
expr_stmt|;
block|}
comment|/* XXXMUKS: This is redundant due to the INSIST above. */
if|if
condition|(
name|strlen
argument_list|(
