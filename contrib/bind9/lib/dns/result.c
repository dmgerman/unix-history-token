...
literal|"invalid NSEC3 owner name (wildcard)"
block|,
comment|/*%< 104 DNS_R_INVALIDNSEC3 */
literal|"not master"
block|,
comment|/*%< 105 DNS_R_NOTMASTER */
literal|"broken trust chain"
block|,
comment|/*%< 106 DNS_R_BROKENCHAIN */
literal|"expired"
block|,
comment|/*%< 107 DNS_R_EXPIRED */
literal|"not dynamic"
block|,
comment|/*%< 108 DNS_R_NOTDYNAMIC */
literal|"bad EUI"
block|,
comment|/*%< 109 DNS_R_BADEUI */
literal|"covered by negative trust anchor"
block|,
comment|/*%< 110 DNS_R_NTACOVERED */
literal|"bad CDS"
block|,
comment|/*%< 111 DNS_R_BADCSD */
literal|"bad CDNSKEY"
block|,
comment|/*%< 112 DNS_R_BADCDNSKEY */
literal|"malformed OPT option"
comment|/*%< 113 DNS_R_OPTERR */
block|}
decl_stmt|;
end_decl_stmt
