...
begin_comment
comment|/* $Id: cname_5.c,v 1.49 2009-12-04 22:06:37 tbox Exp $ */
end_comment
...
define|#
directive|define
name|RRTYPE_CNAME_ATTRIBUTES
define|\
value|(DNS_RDATATYPEATTR_EXCLUSIVE | DNS_RDATATYPEATTR_SINGLETON)
end_define
...
begin_comment
comment|/* RDATA_GENERIC_CNAME_5_C */
end_comment
