...
begin_comment
comment|/* draft-ietf-dane-protocol-19.txt */
end_comment

begin_ifndef
ifndef|#
directive|ifndef
name|RDATA_GENERIC_TLSA_52_C
end_ifndef
...
argument_list|)
expr_stmt|;
comment|/* 	 * Certificate Association Data. 	 */
return|return
operator|(
...
begin_comment
comment|/* RDATA_GENERIC_TLSA_52_C */
end_comment
