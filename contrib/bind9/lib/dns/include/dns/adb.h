...
begin_comment
comment|/*  * Copyright (C) 2004-2008, 2012  Internet Systems Consortium, Inc. ("ISC")  * Copyright (C) 1999-2003  Internet Software Consortium.  *  * Permission to use, copy, modify, and/or distribute this software for any  * purpose with or without fee is hereby granted, provided that the above  * copyright notice and this permission notice appear in all copies.  *  * THE SOFTWARE IS PROVIDED "AS IS" AND ISC DISCLAIMS ALL WARRANTIES WITH  * REGARD TO THIS SOFTWARE INCLUDING ALL IMPLIED WARRANTIES OF MERCHANTABILITY  * AND FITNESS.  IN NO EVENT SHALL ISC BE LIABLE FOR ANY SPECIAL, DIRECT,  * INDIRECT, OR CONSEQUENTIAL DAMAGES OR ANY DAMAGES WHATSOEVER RESULTING FROM  * LOSS OF USE, DATA OR PROFITS, WHETHER IN AN ACTION OF CONTRACT, NEGLIGENCE  * OR OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR  * PERFORMANCE OF THIS SOFTWARE.  */
end_comment
...
begin_comment
comment|/*!  *\brief  * Represents a lookup for a single name.  *  * On return, the client can safely use "list", and can reorder the list.  * Items may not be _deleted_ from this list, however, or added to it  * other than by using the dns_adb_*() API.  */
end_comment
...
begin_comment
comment|/*% Return addresses of type INET. */
end_comment
...
begin_comment
comment|/*% Return addresses of type INET6. */
end_comment
...
begin_comment
comment|/*%  *      Only schedule an event if no addresses are known.  *      Must set _WANTEVENT for this to be meaningful.  */
end_comment
...
begin_comment
comment|/*%  *	An event is desired.  Check this bit in the returned find to see  *	if one will actually be generated.  */
end_comment
...
begin_comment
comment|/*%  *	If set, fetches will not be generated unless no addresses are  *	available in any of the address families requested.  */
end_comment
...
begin_comment
comment|/*%  *	Fetches will start using the closest zone data or use the root servers.  *	This is useful for reestablishing glue that has expired.  */
end_comment
...
begin_comment
comment|/*%  *	Glue or hints are ok.  These are used when matching names already  *	in the adb, and when dns databases are searched.  */
end_comment
...
begin_comment
comment|/*%  *	Return lame servers in a find, so that all addresses are returned.  */
end_comment
...
begin_comment
comment|/*%  * The answers to queries come back as a list of these.  */
end_comment
...
begin_comment
comment|/*%  * Attach to an 'adb' to 'adbp'.  *  * Requires:  *\li	'adb' to be a valid dns_adb_t, created via dns_adb_create().  *\li	'adbp' to be a valid pointer to a *dns_adb_t which is initialized  *	to NULL.  */
end_comment
...
begin_comment
comment|/*%  * Delete the ADB. Sets *ADB to NULL. Cancels any outstanding requests.  *  * Requires:  *  *\li	'adb' be non-NULL and '*adb' be a valid dns_adb_t, created via  *	dns_adb_create().  */
end_comment
...
begin_comment
comment|/*%  * Send '*eventp' to 'task' when 'adb' has shutdown.  *  * Requires:  *  *\li	'*adb' is a valid dns_adb_t.  *  *\li	eventp != NULL&& *eventp is a valid event.  *  * Ensures:  *  *\li	*eventp == NULL  *  *\li	The event's sender field is set to the value of adb when the event  *	is sent.  */
end_comment
...
begin_comment
comment|/*%<  * Shutdown 'adb'.  *  * Requires:  *  * \li	'*adb' is a valid dns_adb_t.  */
end_comment
...
begin_comment
comment|/*%<  * This function is only used for debugging.  It will dump as much of the  * state of the running system as possible.  *  * Requires:  *  *\li	adb be valid.  *  *\li	f != NULL, and is a file open for writing.  */
end_comment
...
begin_comment
comment|/*%<  * This function is only used for debugging.  Dump the data associated  * with a find.  *  * Requires:  *  *\li	find is valid.  *  * \li	f != NULL, and is a file open for writing.  */
end_comment
...
begin_comment
comment|/*%  * Change Flags.  *  * Set the flags as given by:  *  *\li	newflags = (oldflags& ~mask) | (bits& mask);  *  * Requires:  *  *\li	adb be valid.  *  *\li	addr be valid.  */
end_comment
...
begin_comment
comment|/*%<  * Return a dns_adbaddrinfo_t that is associated with address 'sa'.  *  * Requires:  *  *\li	adb is valid.  *  *\li	sa is valid.  *  *\li	addrp != NULL&& *addrp == NULL  *  * Returns:  *\li	#ISC_R_SUCCESS  *\li	#ISC_R_NOMEMORY  *\li	#ISC_R_SHUTTINGDOWN  */
end_comment
...
begin_comment
comment|/*%<  * Free a dns_adbaddrinfo_t allocated by dns_adb_findaddrinfo().  *  * Requires:  *  *\li	adb is valid.  *  *\li	*addrp is a valid dns_adbaddrinfo_t *.  */
end_comment
...
begin_comment
comment|/*%<  * Flushes all cached data from the adb.  *  * Requires:  *\li 	adb is valid.  */
end_comment
...
begin_comment
comment|/*%<  * Set a target memory size.  If memory usage exceeds the target  * size entries will be removed before they would have expired on  * a random basis.  *  * If 'size' is 0 then memory usage is unlimited.  *  * Requires:  *\li	'adb' is valid.  */
end_comment
