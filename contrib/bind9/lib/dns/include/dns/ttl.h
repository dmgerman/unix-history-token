...
begin_comment
comment|/* $Id: ttl.h,v 1.19 2007-06-19 23:47:17 tbox Exp $ */
end_comment
...
begin_comment
comment|/*%<  * Converts a counter from either a plain number or a BIND 8 style value.  *  * Returns:  *\li	ISC_R_SUCCESS  *\li	DNS_R_SYNTAX  */
end_comment
...
begin_comment
comment|/*%<  * Converts a ttl from either a plain number or a BIND 8 style value.  *  * Returns:  *\li	ISC_R_SUCCESS  *\li	DNS_R_BADTTL  */
end_comment
