...
begin_comment
comment|/*  * Copyright (C) 2004-2009, 2011, 2012, 2014  Internet Systems Consortium, Inc. ("ISC")  * Copyright (C) 1999-2003  Internet Software Consortium.  *  * Permission to use, copy, modify, and/or distribute this software for any  * purpose with or without fee is hereby granted, provided that the above  * copyright notice and this permission notice appear in all copies.  *  * THE SOFTWARE IS PROVIDED "AS IS" AND ISC DISCLAIMS ALL WARRANTIES WITH  * REGARD TO THIS SOFTWARE INCLUDING ALL IMPLIED WARRANTIES OF MERCHANTABILITY  * AND FITNESS.  IN NO EVENT SHALL ISC BE LIABLE FOR ANY SPECIAL, DIRECT,  * INDIRECT, OR CONSEQUENTIAL DAMAGES OR ANY DAMAGES WHATSOEVER RESULTING FROM  * LOSS OF USE, DATA OR PROFITS, WHETHER IN AN ACTION OF CONTRACT, NEGLIGENCE  * OR OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR  * PERFORMANCE OF THIS SOFTWARE.  */
end_comment

begin_comment
comment|/* $Id: dispatch.h,v 1.64 2011/07/28 23:47:58 tbox Exp $ */
end_comment
...
begin_comment
comment|/*%  * This is a set of one or more dispatches which can be retrieved  * round-robin fashion.  */
end_comment
...
begin_comment
comment|/*%<  * Retrieve the next dispatch from dispatch set 'dset', and increment  * the round-robin counter.  *  * Requires:  *\li 	dset != NULL  */
end_comment
...
begin_comment
comment|/*%<  * Given a valid dispatch 'source', create a dispatch set containing  * 'n' UDP dispatches, with the remainder filled out by clones of the  * source.  *  * Requires:  *\li 	source is a valid UDP dispatcher  *\li 	dsetp != NULL, *dsetp == NULL  */
end_comment
...
begin_comment
comment|/*%<  * Cancel socket operations for the dispatches in 'dset'.  */
end_comment
...
begin_comment
comment|/*%<  * Dereference all the dispatches in '*dsetp', free the dispatchset  * memory, and set *dsetp to NULL.  *  * Requires:  *\li 	dset is valid  */
end_comment
