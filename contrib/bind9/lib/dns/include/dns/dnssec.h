...
begin_comment
comment|/* $Id: dnssec.h,v 1.21.12.5 2004/03/08 09:04:35 marka Exp $ */
end_comment
...
begin_comment
comment|/*  *	Creates a DST key from a DNS record.  Basically a wrapper around  *	dst_key_fromdns().  *  *	Requires:  *		'name' is not NULL  *		'rdata' is not NULL  *		'mctx' is not NULL  *		'key' is not NULL  *		'*key' is NULL  *  *	Returns:  *		ISC_R_SUCCESS  *		ISC_R_NOMEMORY  *		DST_R_INVALIDPUBLICKEY  *		various errors from dns_name_totext  */
end_comment
...
begin_comment
comment|/*  *	Signs a message with a SIG(0) record.  This is implicitly called by  *	dns_message_renderend() if msg->sig0key is not NULL.  *  *	Requires:  *		'msg' is a valid message  *		'key' is a valid key that can be used for signing  *  *	Returns:  *		ISC_R_SUCCESS  *		ISC_R_NOMEMORY  *		DST_R_*  */
end_comment
