...
begin_comment
comment|/* $Id: diff.h,v 1.15.120.2.24.2 2010/06/04 23:49:23 tbox Exp $ */
end_comment
...
begin_comment
comment|/*%<  * Create a tuple.  Deep copies are made of the name and rdata, so  * they need not remain valid after the call.  *  * Requires:  *\li	*tp != NULL&& *tp == NULL.  *  * Returns:  *\li	ISC_R_SUCCESS  *  \li    ISC_R_NOMEMORY  */
end_comment
...
begin_comment
comment|/*%<  * Free a tuple.  *  * Requires:  *    \li   **tp is a valid tuple.  *  * Ensures:  *     \li  *tp == NULL  *      \li All memory used by the tuple is freed.  */
end_comment
...
begin_comment
comment|/*%<  * Copy a tuple.  *  * Requires:  * \li	'orig' points to a valid tuple  *\li	copyp != NULL&& *copyp == NULL  */
end_comment
...
begin_comment
comment|/*%<  * Initialize a diff.  *  * Requires:  * \li   'diff' points to an uninitialized dns_diff_t  *  \li  allocated by the caller.  *  * Ensures:  * \li   '*diff' is a valid, empty diff.  */
end_comment
...
begin_comment
comment|/*%<  * Append a single tuple to a diff.  *  *\li	'diff' is a valid diff.  * \li	'*tuple' is a valid tuple.  *  * Ensures:  *\li	*tuple is NULL.  *\li	The tuple has been freed, or will be freed when the diff is cleared.  */
end_comment
...
begin_comment
comment|/*%<  * Append 'tuple' to 'diff', removing any duplicate  * or conflicting updates as needed to create a minimal diff.  *  * Requires:  *\li	'diff' is a minimal diff.  *  * Ensures:  *\li	'diff' is still a minimal diff.  *  \li 	*tuple is NULL.  *   \li	The tuple has been freed, or will be freed when the diff is cleared.  *  */
end_comment
...
begin_comment
comment|/*%<  * Print the differences to 'file' or if 'file' is NULL via the  * logging system.  *  * Require:  *\li	'diff' to be valid.  *\li	'file' to refer to a open file or NULL.  *  * Returns:  *\li	#ISC_R_SUCCESS  *\li	#ISC_R_NOMEMORY  *\li	#ISC_R_UNEXPECTED  *\li	any error from dns_rdataset_totext()  */
end_comment
