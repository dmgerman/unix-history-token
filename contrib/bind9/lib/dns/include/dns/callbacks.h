...
begin_comment
comment|/* $Id: callbacks.h,v 1.26 2011/12/09 23:47:05 tbox Exp $ */
end_comment
...
name|add
decl_stmt|;
comment|/*% 	 * dns_master_load*() call this when loading a raw zonefile, 	 * to pass back information obtained from the file header 	 */
