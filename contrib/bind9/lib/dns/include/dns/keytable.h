...
begin_comment
comment|/* $Id: keytable.h,v 1.10.206.1 2004/03/06 08:13:56 marka Exp $ */
end_comment
...
begin_comment
comment|/*  * Search for a key named 'name', matching 'algorithm' and 'tag' in  * 'keytable'.  *  * Requires:  *  *	'keytable' is a valid keytable.  *  *	'name' is a valid absolute name.  *  *	keynodep != NULL&& *keynodep == NULL  *  * Returns:  *  *	ISC_R_SUCCESS  *	ISC_R_NOTFOUND  *  *	Any other result indicates an error.  */
end_comment
...
begin_comment
comment|/*  * Search for the next key with the same properties as 'keynode' in  * 'keytable'.  *  * Requires:  *  *	'keytable' is a valid keytable.  *  *	'keynode' is a valid keynode.  *  *	nextnodep != NULL&& *nextnodep == NULL  *  * Returns:  *  *	ISC_R_SUCCESS  *	ISC_R_NOTFOUND  *  *	Any other result indicates an error.  */
end_comment
