...
begin_comment
comment|/* $Id: cert.h,v 1.12.206.1 2004/03/06 08:13:51 marka Exp $ */
end_comment
...
begin_comment
comment|/*  * Put a textual representation of certificate type 'cert' into 'target'.  *  * Requires:  *	'cert' is a valid cert.  *  *	'target' is a valid text buffer.  *  * Ensures:  *	If the result is success:  *		The used space in 'target' is updated.  *  * Returns:  *	ISC_R_SUCCESS			on success  *	ISC_R_NOSPACE			target buffer is too small  */
end_comment
