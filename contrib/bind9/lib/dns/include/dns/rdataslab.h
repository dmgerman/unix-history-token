...
begin_comment
comment|/* $Id: rdataslab.h,v 1.33 2008-04-01 23:47:10 tbox Exp $ */
end_comment
...
value|0x01
comment|/* RRSIG is for offline DNSKEY */
define|#
directive|define
name|DNS_RDATASLAB_WARNMASK
value|0x0E
comment|/*%< RRSIG(DNSKEY) expired 					 * warnings number mask. */
define|#
directive|define
name|DNS_RDATASLAB_WARNSHIFT
value|1
comment|/*%< How many bits to shift to find 					 * remaining expired warning number. */
comment|/***  *** Functions  ***/
name|isc_result_t
