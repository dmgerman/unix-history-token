...
begin_comment
comment|/*  *	Set the maximum number of simultanious transfers in allowed by  *	the zone manager.  *  * Requires:  *	'zmgr' to be a valid zone manager.  */
end_comment
...
begin_comment
comment|/*  *	Return the the maximum number of simultanious transfers in allowed.  *  * Requires:  *	'zmgr' to be a valid zone manager.  */
end_comment
