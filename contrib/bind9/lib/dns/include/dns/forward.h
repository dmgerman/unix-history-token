...
begin_comment
comment|/* $Id: forward.h,v 1.2.206.1 2004/03/06 08:13:56 marka Exp $ */
end_comment
...
begin_comment
comment|/*  * Finds a domain in the forwarding table.  The closest matching parent  * domain is returned.  *  * Requires:  * 	fwdtable is a valid forwarding table.  * 	name is a valid name  * 	forwardersp != NULL&& *forwardersp == NULL  *  * Returns:  * 	ISC_R_SUCCESS  * 	ISC_R_NOTFOUND  */
end_comment
