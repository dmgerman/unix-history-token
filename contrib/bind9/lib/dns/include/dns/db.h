...
begin_comment
comment|/* $Id: db.h,v 1.76.18.7 2005/10/13 02:12:25 marka Exp $ */
end_comment
...
begin_comment
comment|/*%<  * Attach *targetp to source.  *  * Requires:  *  * \li	'db' is a valid database.  *  * \li	'source' is a valid node.  *  * \li	'targetp' points to a NULL dns_node_t *.  *  * Ensures:  *  * \li	*targetp is attached to source.  */
end_comment
...
begin_comment
comment|/*%<  * Remove a database implementation from the the list of supported  * implementations.  No databases of this type can be active when this  * is called.  *  * Requires:  * \li 	dbimp != NULL&& *dbimp == NULL  *  * Ensures:  *  * \li	Any memory allocated in *dbimp will be freed.  */
end_comment
