...
begin_comment
comment|/* $Id: dnssec-signzone.c,v 1.177.18.21 2006/08/30 23:01:54 marka Exp $ */
end_comment
...
begin_comment
comment|/*%  * Sign the apex of the zone.  */
end_comment
...
name|argv
argument_list|,
literal|"ac:d:e:f:ghi:I:j:k:l:n:N:o:O:pr:s:Stv:z"
argument_list|)
operator|)
operator|!=
operator|-
