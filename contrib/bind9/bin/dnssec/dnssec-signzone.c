...
begin_comment
comment|/*%  * Verify that certain things are sane:  *  *   The apex has a DNSKEY RRset with at least one KSK, and at least  *   one ZSK if the -x flag was not used.  *  *   The DNSKEY record was signed with at least one of the KSKs in  *   the DNSKEY RRset.  *  *   The rest of the zone was signed with at least one of the ZSKs  *   present in the DNSKEY RRset.  */
end_comment
...
name|fatal
argument_list|(
literal|"cannot find SOA RRSIGs\n"
argument_list|)
expr_stmt|;
name|memset
argument_list|(
