...
begin_comment
comment|/*  * See if the node contains any non RRSIG/NSEC records and report to  * caller.  Clean out extranous RRSIG records for node.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* Clean old rrsigs at apex. */
operator|(
name|void
operator|)
name|active_node
...
name|fatal
argument_list|(
literal|"could not initialize keylist_lock: %s"
argument_list|,
name|isc_result_totext
argument_list|(
name|result
