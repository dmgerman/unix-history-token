...
begin_comment
comment|/* $Id: nsupdate.c,v 1.163.48.3 2009/04/30 07:12:49 marka Exp $ */
end_comment
...
literal|"update delete ....        (remove the given record(s) from the zone)\n"
argument_list|)
expr_stmt|;
return|return
operator|(
...
name|fatal
argument_list|(
literal|"Check your Kerberos ticket, it may have expired."
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|fatal
argument_list|(
literal|"dns_tkey_negotiategss: %s"
argument_list|,
name|isc_result_totext
argument_list|(
name|result
...
name|ddebug
argument_list|(
literal|"Destroying GSS-TSIG keyring"
argument_list|)
expr_stmt|;
name|dns_tsigkeyring_destroy
argument_list|(
