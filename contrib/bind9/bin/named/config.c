...
begin_comment
comment|/*  * Copyright (C) 2004-2015  Internet Systems Consortium, Inc. ("ISC")  * Copyright (C) 2001-2003  Internet Software Consortium.  *  * Permission to use, copy, modify, and/or distribute this software for any  * purpose with or without fee is hereby granted, provided that the above  * copyright notice and this permission notice appear in all copies.  *  * THE SOFTWARE IS PROVIDED "AS IS" AND ISC DISCLAIMS ALL WARRANTIES WITH  * REGARD TO THIS SOFTWARE INCLUDING ALL IMPLIED WARRANTIES OF MERCHANTABILITY  * AND FITNESS.  IN NO EVENT SHALL ISC BE LIABLE FOR ANY SPECIAL, DIRECT,  * INDIRECT, OR CONSEQUENTIAL DAMAGES OR ANY DAMAGES WHATSOEVER RESULTING FROM  * LOSS OF USE, DATA OR PROFITS, WHETHER IN AN ACTION OF CONTRACT, NEGLIGENCE  * OR OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR  * PERFORMANCE OF THIS SOFTWARE.  */
end_comment
...
literal|" 	fetches-per-server 0;\n\ 	fetches-per-zone 0;\n\ 	fetch-quota-params 100 0.1 0.3 0.7;\n\ "
endif|#
directive|endif
comment|/* ENABLE_FETCHLIMIT */
literal|"	clients-per-query 10;\n\ 	max-clients-per-query 100;\n\ 	max-recursion-depth 7;\n\ 	max-recursion-queries 50;\n\ 	zero-no-soa-ttl-cache no;\n\ 	nsec3-test-zone no;\n\ 	allow-new-zones no;\n\ "
ifdef|#
directive|ifdef
...
operator|++
expr_stmt|;
comment|/* Increment here so that cleanup on error works. */
if|if
condition|(
operator|!
name|cfg_obj_isstring
