...
begin_comment
comment|/* $Id: server.c,v 1.419.18.75 2009/07/11 04:30:49 marka Exp $ */
end_comment
...
expr_stmt|;
block|}
comment|/* 	 * Set "allow-query-cache" and "allow-recursion" acls if 	 * configured in named.conf. 	 */
name|CHECK
argument_list|(
name|configure_view_acl
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* 	 * Set default "allow-recursion" and "allow-query-cache" acls. 	 */
if|if
condition|(
name|view
operator|->
