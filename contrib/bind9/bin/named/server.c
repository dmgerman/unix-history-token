...
begin_comment
comment|/* $Id: server.c,v 1.599.8.4 2011-02-16 19:46:12 each Exp $ */
end_comment
...
expr_stmt|;
block|}
comment|/* 	 * Are we allowing zones to be added and deleted dynamically? 	 */
name|obj
operator|=
name|NULL
expr_stmt|;
...
condition|)
block|{
comment|/* 			 * Create a cache with the desired name.  This normally 			 * equals the view name, but may also be a forward 			 * reference to a view that share the cache with this 			 * view but is not yet configured.  If it is not the 			 * view name but not a forward reference either, then it 			 * is simply a named cache that is not shared. 			 */
name|CHECK
argument_list|(
name|isc_mem_create
argument_list|(
