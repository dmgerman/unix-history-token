...
name|__LINE__
argument_list|,
literal|"ns_taskmgr_create() failed: %s"
argument_list|,
...
name|__LINE__
argument_list|,
literal|"ns_timermgr_create() failed: %s"
argument_list|,
name|isc_result_totext
argument_list|(
name|result
...
begin_comment
comment|/*  * Get FMRI for the current named process  */
end_comment
...
name|__LINE__
argument_list|,
literal|"scf_get_ins_named() memory "
...
name|strcmp
argument_list|(
name|SCF_STATE_STRING_DEGRADED
argument_list|,
name|s
argument_list|)
operator|==
...
name|__LINE__
argument_list|,
literal|"smf_disable_instance() failed: %s"
argument_list|,
name|scf_strerror
argument_list|(
name|scf_error
...
name|__LINE__
argument_list|,
literal|"smf_get_state() failed: %s"
argument_list|,
name|scf_strerror
argument_list|(
name|scf_error
