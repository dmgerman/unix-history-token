...
name|printf
argument_list|(
literal|"compiled with OpenSSL version: %s\n"
argument_list|,
...
name|printf
argument_list|(
literal|"compiled with libxml2 version: %s\n"
argument_list|,
