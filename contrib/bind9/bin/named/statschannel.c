...
begin_comment
comment|/* $Id: statschannel.c,v 1.14.64.6 2009/02/17 03:43:07 marka Exp $ */
end_comment
...
name|a
parameter_list|)
value|do { result = (a); INSIST(result == ISC_R_SUCCESS); } while(0);
end_define
...
name|a
parameter_list|)
value|do { xmlrc = (a); INSIST(xmlrc>= 0); } while(0);
end_define
