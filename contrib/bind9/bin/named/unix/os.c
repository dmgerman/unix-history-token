...
begin_comment
comment|/*  * Copyright (C) 2004-2011, 2013, 2014  Internet Systems Consortium, Inc. ("ISC")  * Copyright (C) 1999-2002  Internet Software Consortium.  *  * Permission to use, copy, modify, and/or distribute this software for any  * purpose with or without fee is hereby granted, provided that the above  * copyright notice and this permission notice appear in all copies.  *  * THE SOFTWARE IS PROVIDED "AS IS" AND ISC DISCLAIMS ALL WARRANTIES WITH  * REGARD TO THIS SOFTWARE INCLUDING ALL IMPLIED WARRANTIES OF MERCHANTABILITY  * AND FITNESS.  IN NO EVENT SHALL ISC BE LIABLE FOR ANY SPECIAL, DIRECT,  * INDIRECT, OR CONSEQUENTIAL DAMAGES OR ANY DAMAGES WHATSOEVER RESULTING FROM  * LOSS OF USE, DATA OR PROFITS, WHETHER IN AN ACTION OF CONTRACT, NEGLIGENCE  * OR OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR  * PERFORMANCE OF THIS SOFTWARE.  */
end_comment

begin_comment
comment|/* $Id: os.c,v 1.107 2011/03/02 00:02:54 marka Exp $ */
end_comment
...
parameter_list|)
define|\
value|do { \ 		cap_flag_value_t curval; \ 		capval = (flag); \ 		err = cap_get_flag(curcaps, capval, CAP_PERMITTED,&curval); \ 		if (err != -1&& curval) { \ 			err = cap_set_flag(caps, CAP_EFFECTIVE, 1,&capval, CAP_SET); \ 			if (err == -1) { \ 				isc__strerror(errno, strbuf, sizeof(strbuf)); \ 				ns_main_earlyfatal("cap_set_proc failed: %s", strbuf); \ 			} \ 			\ 			err = cap_set_flag(caps, CAP_PERMITTED, 1,&capval, CAP_SET); \ 			if (err == -1) { \ 				isc__strerror(errno, strbuf, sizeof(strbuf)); \ 				ns_main_earlyfatal("cap_set_proc failed: %s", strbuf); \ 			} \ 		} \ 	} while (0)
define|#
directive|define
name|INIT_CAP
define|\
...
argument_list|)
expr_stmt|;
comment|/* 	 * We need to be able to set the ownership of the containing 	 * directory of the pid file when we create it. 	 */
name|SET_CAP
argument_list|(
name|CAP_CHOWN
argument_list|)
...
name|ns_main_earlywarning
argument_list|(
literal|"unable to set effective gid to %ld: %s"
argument_list|,
operator|(
name|long
operator|)
...
name|ns_main_earlywarning
argument_list|(
literal|"unable to set effective "
literal|"gid to %d: %s"
argument_list|,
name|gid
argument_list|,
...
name|ns_main_earlywarning
argument_list|(
literal|"unable to set effective uid to %ld: %s"
argument_list|,
operator|(
name|long
operator|)
...
directive|ifndef
name|HAVE_LINUXTHREADS
comment|/* Restore UID/GID to root */
name|setperms
argument_list|(
literal|0
argument_list|,
...
name|ns_main_earlywarning
argument_list|(
literal|"Required root "
literal|"permissions to open "
literal|"'%s'."
argument_list|,
name|filename
argument_list|)
...
name|ns_main_earlywarning
argument_list|(
literal|"Please check file and "
literal|"directory permissions "
literal|"or reconfigure the filename."
argument_list|)
expr_stmt|;
else|#
directive|else
...
name|ns_main_earlywarning
argument_list|(
literal|"could not fdopen() file '%s': %s"
argument_list|,
name|filename
argument_list|,
name|strbuf
