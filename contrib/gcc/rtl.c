...
begin_comment
comment|/* RTL utility routines.    Copyright (C) 1987, 1988, 1991, 1994, 1997, 1998, 1999, 2000, 2001, 2002,    2003, 2004, 2005, 2006 Free Software Foundation, Inc.  This file is part of GCC.  GCC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GCC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GCC; see the file COPYING.  If not, write to the Free Software Foundation, 51 Franklin Street, Fifth Floor, Boston, MA 02110-1301, USA.  */
end_comment
...
begin_comment
comment|/* Make sure all NOTE_INSN_* values are negative.  */
end_comment

begin_decl_stmt
specifier|extern
name|char
name|NOTE_INSN_MAX_isnt_negative_adjust_NOTE_INSN_BIAS
index|[
name|NOTE_INSN_MAX
operator|<
literal|0
...
begin_comment
comment|/* Return the number of bytes occupied by rtx value X.  */
end_comment
...
condition|?
operator|(
literal|"RTL check: expected code '%s' and not mode '%s', "
literal|"have code '%s' and mode '%s' in %s, at %s:%d"
operator|)
else|:
operator|(
literal|"RTL check: expected code '%s' and mode '%s', "
literal|"have code '%s' and mode '%s' in %s, at %s:%d"
operator|)
operator|)
argument_list|,
...
begin_comment
comment|/* Report that line LINE of FILE tried to access the block symbol fields    of a non-block symbol.  FUNC is the function that contains the line.  */
end_comment
...
name|internal_error
argument_list|(
literal|"RTL check: attempt to treat non-block symbol as a block symbol "
literal|"in %s, at %s:%d"
argument_list|,
name|func
argument_list|,
