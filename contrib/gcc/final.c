...
begin_comment
comment|/* Convert RTL to assembler code and output it, for GNU compiler.    Copyright (C) 1987, 1988, 1989, 1992, 1993, 1994, 1995, 1996, 1997,    1998, 1999, 2000, 2001, 2002 Free Software Foundation, Inc.  This file is part of GCC.  GCC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GCC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GCC; see the file COPYING.  If not, write to the Free Software Foundation, 59 Temple Place - Suite 330, Boston, MA 02111-1307, USA.  */
end_comment
...
define|#
directive|define
name|HAVE_READONLY_DATA_SECTION
value|1
end_define
...
name|count_edges
decl_stmt|;
comment|/* number of intrumented edges in this function */
block|}
struct|;
end_struct
...
begin_comment
comment|/* Called at end of source file,    to output the arc-profiling table for this entire compilation.  */
end_comment
...
decl_stmt|;
name|tree
name|gcov_type_array_pointer_type
init|=
name|build_pointer_type
argument_list|(
name|gcov_type_array_type
...
expr_stmt|;
block|}
comment|/* Count of the # of instrumented arcs.  */
name|field_decl
operator|=
name|build_decl
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* Pointer to the next bb.  */
name|field_decl
operator|=
name|build_decl
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* sizeof(struct bb).  We'll set this after entire structure 	 is laid out.  */
name|field_decl
operator|=
name|build_decl
argument_list|(
...
decl_stmt|;
name|tree
name|array_value_chain
init|=
name|NULL_TREE
decl_stmt|;
name|tree
name|bb_fn_struct_type
decl_stmt|;
name|tree
name|bb_fn_struct_array_type
decl_stmt|;
name|tree
name|bb_fn_struct_array_pointer_type
decl_stmt|;
name|tree
name|bb_fn_struct_pointer_type
decl_stmt|;
name|tree
name|field_value
decl_stmt|,
name|field_value_chain
decl_stmt|;
name|bb_fn_struct_type
operator|=
name|make_node
...
operator|++
expr_stmt|;
comment|/* Note that the array contains a terminator, hence no - 1.  */
name|domain
operator|=
name|build_index_type
argument_list|(
...
name|name_len
decl_stmt|;
comment|/* create constructor for structure.  */
name|field_value_chain
operator|=
name|build_tree_list
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* Create constructor for array.  */
name|field_decl
operator|=
name|build_decl
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* Range of labels grows monotonically in the function.  Abort here          means that the initialization of array got lost.  */
if|if
condition|(
name|n_old_labels
operator|>
...
expr_stmt|;
block|}
comment|/* Store function names for edge-profiling.  */
comment|/* ??? Probably should re-use the existing struct function.  */
if|if
condition|(
name|cfun
operator|->
...
directive|endif
comment|/* Emit information for vtable gc.  */
name|note
operator|=
name|find_reg_note
argument_list|(
...
control|)
block|{
comment|/* The following test cannot use recog_data.operand when tesing 	 for a SUBREG: the underlying object might have been changed 	 already if we are inside a match_operator expression that 	 matches the else clause.  Instead we test the underlying 	 expression directly.  */
if|if
condition|(
name|GET_CODE
argument_list|(
