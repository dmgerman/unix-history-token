...
name|warning
argument_list|(
literal|"taking dynamic typeid of object without -frtti"
argument_list|)
expr_stmt|;
name|push_obstacks
argument_list|(
...
name|warning
argument_list|(
literal|"requesting typeid of object without -frtti"
argument_list|)
expr_stmt|;
name|push_obstacks
argument_list|(
