...
decl_stmt|,
name|needs_final_overriders
decl_stmt|;
name|tree
name|tu
decl_stmt|;
comment|/* Count how many abstract methods need to be defined.  */
for|for
control|(
name|has_abstract_virtuals
operator|=
...
block|}
block|}
comment|/* Count how many virtual methods need a final overrider.  */
for|for
control|(
name|needs_final_overriders
operator|=
...
name|error
argument_list|(
literal|"  and the following virtual functions need a final overrider:"
argument_list|)
expr_stmt|;
else|else
name|error
argument_list|(
literal|"  since the following virtual functions need a final overrider:"
argument_list|)
expr_stmt|;
block|}
name|tu
...
name|cp_error
argument_list|(
literal|"  since type `%T' has abstract virtual functions and must override virtual functions"
argument_list|,
name|type
argument_list|)
expr_stmt|;
...
name|cp_error
argument_list|(
literal|"  since type `%T' must override virtual functions"
argument_list|,
name|type
argument_list|)
expr_stmt|;
...
begin_comment
comment|/* First used: 0 (reserved), Last used: 369.  Free: */
end_comment
...
name|ack
argument_list|(
literal|"Please submit a full bug report to `egcs-bugs@egcs.cygnus.com'."
argument_list|)
expr_stmt|;
name|ack
argument_list|(
literal|"See<URL:http://egcs.cygnus.com/faq.html#bugreport> for details."
argument_list|)
expr_stmt|;
block|}
else|else
...
name|warning
argument_list|(
literal|"missing initializer for member `%s'"
argument_list|,
name|IDENTIFIER_POINTER
argument_list|(
name|DECL_NAME
