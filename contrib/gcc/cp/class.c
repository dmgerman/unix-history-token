...
begin_comment
comment|/* Called from base_derived_from via dfs_walk.  */
end_comment
...
expr_stmt|;
block|}
comment|/* Add the intiailizer to the vtable.  */
operator|*
name|vid
operator|->
name|last_init
