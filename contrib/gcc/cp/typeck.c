...
begin_comment
comment|/* APPLE LOCAL radar 6087117 */
end_comment
...
begin_comment
comment|/* APPLE LOCAL begin blocks 6040305 (cm) */
end_comment
...
name|result
decl_stmt|;
comment|/* APPLE LOCAL radar 6396238 */
name|bool
...
argument_list|)
decl_stmt|;
comment|/* First convert it to 'void *'. */
name|block_ptr_exp
operator|=
name|convert
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* FIXME: should do more from build_cxx_call */
name|result
operator|=
name|convert_from_reference
argument_list|(
...
begin_comment
comment|/* APPLE LOCAL end blocks 6040305 (cm) */
end_comment
...
comment|/* APPLE LOCAL begin radar 6087117 */
name|coerced_params
operator|=
name|convert_arguments
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* APPLE LOCAL end radar 6087117 */
if|if
condition|(
name|coerced_params
operator|==
...
comment|/* OK */
empty_stmt|;
comment|/* APPLE LOCAL begin blocks 6040305 (ck) */
elseif|else
if|if
condition|(
name|TREE_CODE
...
comment|/* OK */
empty_stmt|;
comment|/* APPLE LOCAL end blocks 6040305 (ck) */
elseif|else
if|if
condition|(
operator|(
...
name|coder
decl_stmt|;
comment|/* APPLE LOCAL radar 4874632 */
name|tree
name|new_rhs
init|=
name|NULL_TREE
...
block|}
block|}
comment|/* APPLE LOCAL file radar 6231433 */
if|if
condition|(
...
argument_list|)
expr_stmt|;
comment|/* APPLE LOCAL begin blocks 6040305 (cn) */
elseif|else
if|if
condition|(
name|TREE_CODE
...
argument_list|)
expr_stmt|;
comment|/* APPLE LOCAL end blocks 6040305 (cn) */
else|else
name|warning
argument_list|(
literal|0
