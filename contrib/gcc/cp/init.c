...
name|pedwarn
argument_list|(
literal|"uninitialized member `%D' with `const' type `%T'"
argument_list|,
name|member
argument_list|,
name|type
...
name|error
argument_list|(
literal|"`%#D' is a static data member; it can only be "
...
name|error
argument_list|(
literal|"`%#D' is not a non-static data member of `%T'"
argument_list|,
name|field
argument_list|,
name|type
...
name|error
argument_list|(
literal|"'%D' is both a direct base and an indirect virtual base"
argument_list|,
name|basetype
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"invalid use of non-static member function `%D'"
argument_list|,
name|TREE_OPERAND
argument_list|(
name|member
...
parameter_list|)
block|{
comment|/* When we build a COND_EXPR, we don't know whether it will be used      as an lvalue or as an rvalue.  If it is an lvalue, it's not safe      to replace the second and third operands with their      initializers.  So, we do that here.  */
if|if
condition|(
name|TREE_CODE
argument_list|(
...
operator|&&
operator|(
comment|/* Enumeration constants are constant.  */
name|TREE_CODE
argument_list|(
name|decl
argument_list|)
...
name|pointer_type
decl_stmt|;
comment|/* The type pointed to by POINTER_TYPE.  */
name|tree
name|type
decl_stmt|;
comment|/* The type being allocated.  For "new T[...]" this will be an      ARRAY_TYPE.  */
name|tree
name|full_type
decl_stmt|;
comment|/* A pointer type pointing to to the FULL_TYPE.  */
name|tree
