...
begin_comment
comment|/* At the end of a destructor, call the destructors for our base classes    and members.     Called from finish_destructor_body.  */
end_comment
...
decl_stmt|;
name|tree
name|member_destructions
init|=
name|NULL
decl_stmt|;
name|tree
name|vbase_destructions
init|=
name|NULL
decl_stmt|;
for|for
