...
expr_stmt|;
block|}
comment|/* APPLE LOCAL begin radar 6275956 */
elseif|else
if|if
condition|(
name|cur_block
...
name|error
argument_list|(
literal|"invalid use of %<this%> in a block"
argument_list|)
expr_stmt|;
name|result
operator|=
...
block|}
block|}
comment|/* APPLE LOCAL end radar 6275956 */
else|else
block|{
if|if
condition|(
...
specifier|static
name|bool
name|block_var_ok_for_context
parameter_list|(
name|tree
name|context
parameter_list|)
block|{
comment|/* FIXME - local classes inside blocks, templates, etc */
name|struct
...
name|current_function_decl
decl_stmt|;
comment|/* If in a block helper, only variables from the context of the helper      are ok.  */
while|while
condition|(
name|b
operator|&&
...
begin_comment
comment|/* APPLE LOCAL begin radar 6545782 */
end_comment

begin_comment
comment|/** This routine does all the work on use of variables in a block. */
end_comment

begin_function
specifier|static
name|tree
name|get_final_block_variable
parameter_list|(
name|tree
name|name
parameter_list|,
...
begin_comment
comment|/* APPLE LOCAL end radar 6545782 */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* APPLE LOCAL begin radar 6169580 */
if|if
condition|(
name|cur_block
condition|)
...
argument_list|)
expr_stmt|;
comment|/* APPLE LOCAL end radar 6169580 */
name|pop_deferring_access_checks
argument_list|()
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/* APPLE LOCAL radar 6545782 */
name|decl
operator|=
name|get_final_block_variable
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* APPLE LOCAL begin blocks 6040305 (cd) */
if|if
condition|(
name|TREE_CODE
argument_list|(
...
expr_stmt|;
block|}
comment|/* APPLE LOCAL end blocks 6040305 (cd) */
return|return
name|decl
return|;
block|}
...
comment|/* Must lower the nested functions which could be, among other 	    things, block helper functions. */
...
directive|if
literal|0
block|block = do_pushlevel (sk_block);
else|#
directive|else
name|block
operator|=
...
directive|if
literal|0
block|if (block)     do_poplevel (block);
else|#
directive|else
name|block
operator|=
