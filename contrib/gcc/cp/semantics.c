...
begin_comment
comment|/* Begin a compound-statement.  If HAS_NO_SCOPE is nonzero, the    compound-statement does not define a scope.  Returns a new    COMPOUND_STMT if appropriate.  */
end_comment
...
begin_comment
comment|/* Finish a compound-statement, which may be given by COMPOUND_STMT.    If HAS_NO_SCOPE is nonzero, the compound statement does not define    a scope.  */
end_comment
...
begin_comment
comment|/* Begin processing a mem-initializer-list.  */
end_comment
...
name|error
argument_list|(
literal|"invalid default template argument"
argument_list|)
expr_stmt|;
return|return
name|error_mark_node
