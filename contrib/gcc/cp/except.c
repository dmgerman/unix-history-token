...
name|LOOKUP_ONLYCONVERTING
decl_stmt|;
comment|/* Under C++0x [12.8/16 class.copy], a thrown lvalue is sometimes 	     treated as an rvalue for the purposes of overload resolution 	     to favor move constructors over copy constructors.  */
if|if
condition|(
comment|/* Must be a local, automatic variable.  */
name|TREE_CODE
argument_list|(
name|exp
argument_list|)
...
name|exp
argument_list|)
comment|/* The variable must not have the `volatile' qualifier.  */
operator|&&
operator|!
operator|(
name|cp_type_quals
