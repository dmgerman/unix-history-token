...
specifier|static
name|void
name|process_start_catch_block_old
name|PROTO
argument_list|(
operator|(
name|tree
...
index|]
decl_stmt|;
comment|/* Declare cp_eh_info * __cp_eh_info (void), 	 as defined in exception.cc. */
...
begin_comment
comment|/* This function performs the expand_start_catch_block functionality for     exceptions implemented in the old style, where catch blocks were all    called, and had to check the runtime information themselves. */
end_comment
...
begin_comment
comment|/* This function performs the expand_start_catch_block functionality for     exceptions implemented in the new style. __throw determines whether    a handler needs to be called or not, so the handler itself has to do    nothing additionaal. */
end_comment
