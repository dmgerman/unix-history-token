...
begin_comment
comment|/* Separate lexical analyzer for GNU C++.    Copyright (C) 1987, 89, 92, 93, 94, 1995 Free Software Foundation, Inc.    Hacked by Michael Tiemann (tiemann@cygnus.com)  This file is part of GNU CC.  GNU CC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GNU CC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU CC; see the file COPYING.  If not, write to the Free Software Foundation, 59 Temple Place - Suite 330, Boston, MA 02111-1307, USA.  */
end_comment
...
directive|if
literal|0
comment|/* When on-the-fly synthesis works properly, remove the second and third      conditions here.  */
block|if (flag_keep_inline_functions
if|#
directive|if
literal|0
block||| ! flag_no_inline       || complex
endif|#
directive|endif
block||| ! DECL_EXTERNAL (fn))     {       struct pending_inline *t;       t = (struct pending_inline *) 	obstack_alloc (&synth_obstack, sizeof (struct pending_inline));       t->lineno = -kind;       t->can_free = 0;       t->interface = (interface_unknown ? 1 : (interface_only ? 0 : 2));       store_pending_inline (fn, t);     }   else
endif|#
directive|endif
...
directive|ifdef
name|HANDLE_PRAGMA
comment|/* FIXME: This will break if we're doing any of the C++ input                  tricks.  */
else|else
block|{
name|ungetc
argument_list|(
...
name|warning
argument_list|(
literal|"namespaces are mostly broken in this version of g++"
argument_list|)
expr_stmt|;
name|warned
operator|=
