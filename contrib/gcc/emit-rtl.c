...
begin_comment
comment|/* Value label_num had when set_new_last_label_num was called.    If label_num has not changed since then, last_label_num is valid.  */
end_comment
...
specifier|static
name|rtx
name|gen_complex_constant_part
parameter_list|(
name|enum
name|machine_mode
parameter_list|,
...
literal|'0'
case|:
comment|/* Field with unknown use.  Zero it.  */
name|X0EXP
argument_list|(
name|rt_val
argument_list|,
...
begin_comment
comment|/* Generate a register with same attributes as REG,    but offsetted by OFFSET.  */
end_comment
...
begin_comment
comment|/* Return the constant real or imaginary part (which has mode MODE)    of a complex value X.  The IMAGPART_P argument determines whether    the real or complex component should be returned.  This function    returns NULL_RTX if the component isn't a constant.  */
end_comment
...
name|part
decl_stmt|;
comment|/* Handle complex constants.  */
name|part
operator|=
name|gen_complex_constant_part
argument_list|(
