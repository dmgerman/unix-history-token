...
name|S2
parameter_list|)
value|((S1) == (S2)		\ 			      ? 0			\ 			      : (strcmp ((S1), (S2))	\ 				 ? 1			\ 				 : (abort (), 0)))
end_define
...
literal|1
decl_stmt|;
comment|/* Make the output function static.  */
block|}
struct|;
end_struct
...
begin_comment
comment|/* Tests whether a bit B belongs to the set represented by S.  */
end_comment
...
name|printf
argument_list|(
literal|"%s_unit_%s (rtx executing_insn, rtx candidate_insn)\n"
argument_list|,
name|unit
operator|->
name|name
