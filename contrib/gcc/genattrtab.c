...
begin_comment
comment|/* varargs must always be included after *config.h, but before stdio.h.  */
end_comment
...
begin_comment
comment|/* Given an attribute value, return the result of ORing together all    CONST_STRING arguments encountered.  It is assumed that they are    all numeric.  */
end_comment
