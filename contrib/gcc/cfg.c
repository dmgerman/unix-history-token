...
argument_list|)
expr_stmt|;
comment|/* Check the consistency of profile information.  We can't do that 	 in verify_flow_info, as the counts may get invalid for incompletely 	 solved graphs, later elliminating of conditionals or roundoff errors. 	 It is still practical to have them reported for debugging of simple 	 testcases.  */
name|sum
operator|=
literal|0
expr_stmt|;
...
name|file
argument_list|,
literal|"Invalid sum of incomming frequencies %i, should be %i\n"
argument_list|,
name|sum
argument_list|,
name|bb
...
name|file
argument_list|,
literal|"Invalid sum of incomming counts %i, should be %i\n"
argument_list|,
operator|(
name|int
operator|)
