...
begin_comment
comment|/* Compute register class preferences for pseudo-registers.    Copyright (C) 1987, 1988, 1991, 1992, 1993, 1994, 1995, 1996    1997, 1998, 1999, 2000, 2001, 2002 Free Software Foundation, Inc.  This file is part of GCC.  GCC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GCC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GCC; see the file COPYING.  If not, write to the Free Software Foundation, 59 Temple Place - Suite 330, Boston, MA 02111-1307, USA.  */
end_comment
...
begin_comment
comment|/* Array containing all of the register names.  Unless    DEBUG_REGISTER_NAMES is defined, use the copy in print-rtl.c.  */
end_comment
...
begin_comment
comment|/* All registers that have been subreged.  Indexed by regno * MAX_MACHINE_MODE    + mode.  */
end_comment
...
begin_comment
comment|/* Structure used to record preferrences of given pseudo.  */
end_comment
...
begin_comment
comment|/* Record preferrences of each pseudo.    This is available after `regclass' is run.  */
end_comment
...
operator|>=
name|min_regno
comment|/* If the destination pseudo is set more than once, then other 	     sets might not be to a pointer value (consider access to a 	     union in two threads of control in the presense of global 	     optimizations).  So only set REG_POINTER on the destination 	     pseudo if this is the only set of that pseudo.  */
operator|&&
name|REG_N_SETS
argument_list|(
name|REGNO
...
literal|1
expr_stmt|;
comment|/* If this is setting a register from a register or from a simple 	 conversion of a register, propagate REG_DECL.  */
if|if
condition|(
name|GET_CODE
argument_list|(
...
argument_list|(
argument|&subregs_of_mode
argument_list|,
argument|start
argument_list|,
argument|n
argument_list|,
argument|if (n>= MAX_MACHINE_MODE + start)       return;     to = n - start;     for (i =
literal|0
argument|; i< FIRST_PSEUDO_REGISTER; i++)       if (! TEST_HARD_REG_BIT (*used, i)&& REG_CANNOT_CHANGE_MODE_P (i, from, to)) 	SET_HARD_REG_BIT (*used, i);
argument_list|)
empty_stmt|;
block|}
end_function
...
argument|n
argument_list|,
argument|if (n>= MAX_MACHINE_MODE + start)       return
literal|0
argument|;     to_mode = n - start;     if (CANNOT_CHANGE_MODE_CLASS (from_mode, to_mode, class))       return
literal|1
argument|;
argument_list|)
empty_stmt|;
