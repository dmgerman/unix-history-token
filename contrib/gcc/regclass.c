...
begin_comment
comment|/* These are the classes containing only registers that can be used in    a SUBREG expression that changes the mode of the register in some    way that is illegal.  */
end_comment

begin_decl_stmt
specifier|static
name|int
name|class_can_change_mode
index|[
name|N_REG_CLASSES
index|]
decl_stmt|;
...
begin_comment
comment|/* Registers, including pseudos, which change modes in some way that    is illegal.  */
end_comment
...
begin_comment
comment|/* CLASS_CANNOT_CHANGE_MODE */
end_comment
...
function|" %s:%i"
operator|,
function|reg_class_names[class]
operator|,
function|costs[i].cost[
parameter_list|(
name|enum
name|reg_class
parameter_list|)
