...
name|printf
argument_list|(
literal|"#ifndef PROTO\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#if defined (USE_PROTOTYPES) ? USE_PROTOTYPES : defined (__STDC__)\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define PROTO(ARGS) ARGS\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
