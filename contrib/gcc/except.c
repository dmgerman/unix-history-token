...
decl_stmt|;
block|{
comment|/* Note that the aka bitmap is freed by regset_release_memory.  But if      we ever replace with a non-obstack implementation, this would be      the place to do it.  */
name|free
argument_list|(
name|r
argument_list|)
