...
begin_comment
comment|/* Add LOOP to the loop hierarchy tree where FATHER is father of the    added loop.  */
end_comment
...
begin_comment
comment|/* Gets basic blocks of a loop.  */
end_comment
...
begin_comment
comment|/* Checks that LOOPS are allright:      -- sizes of loops are allright      -- results of get_loop_body really belong to the loop      -- loop header have just single entry edge and single latch edge      -- loop latches have only single successor that is header of their loop   */
end_comment
