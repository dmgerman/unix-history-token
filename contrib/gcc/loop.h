...
parameter_list|)
define|\
value|(REGNO_FIRST_UID (REGNO)< max_uid_for_loop	\ 	? uid_luid[REGNO_FIRST_UID (REGNO)]	\ 	: 0)
end_define
...
parameter_list|)
define|\
value|(REGNO_LAST_UID (REGNO)< max_uid_for_loop	\ 	? uid_luid[REGNO_LAST_UID (REGNO)]	\ 	: INT_MAX)
end_define
