...
begin_comment
comment|/* Default value of targetm.ms_bitfield_layout_p that always returns    false.  */
end_comment
...
decl_stmt|;
block|{
comment|/* By default, GCC does not use the MS VC++ bitfield layout rules.  */
return|return
name|false
return|;
block|}
...
condition|)
block|{
comment|/* This can happen when preprocessed text is shipped between 	     machines, e.g. with bug reports.  Assume that uniqueness 	     isn't actually an issue.  */
name|value
operator|=
literal|1
expr_stmt|;
