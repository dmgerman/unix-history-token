...
begin_comment
comment|/* Language-independent node constructors for parse phase of GNU compiler.    Copyright (C) 1987, 88, 92, 93, 94, 1995 Free Software Foundation, Inc.  This file is part of GNU CC.  GNU CC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GNU CC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU CC; see the file COPYING.  If not, write to the Free Software Foundation, 59 Temple Place - Suite 330, Boston, MA 02111-1307, USA.  */
end_comment
...
block|}
block|}
comment|/* If it wasn't one of the cases we handle, give up.  */
if|if
condition|(
name|new
operator|==
...
begin_comment
comment|/* Given a type T, a FIELD_DECL F, and a replacement value R,    return a new type with all size expressions that contain F    updated by replacing F with R.  */
end_comment
...
name|LANG_TYPE
case|:
comment|/* Don't know how to do these yet.  */
name|abort
argument_list|()
expr_stmt|;
case|case
...
literal|0
decl_stmt|;
comment|/* Start out with no fields, make new fields, and chain them 	   in.  */
name|TYPE_FIELDS
argument_list|(
name|new
argument_list|)
...
condition|)
block|{
comment|/* Do the substitution inside the qualifier and if we find 		   that this field will not be present, omit it.  */
name|DECL_QUALIFIER
argument_list|(
name|new_field
argument_list|)
...
name|new_field
expr_stmt|;
comment|/* If this is a qualified type and this field will always be 	       present, we are done.  */
if|if
condition|(
name|TREE_CODE
argument_list|(
...
break|break;
block|}
comment|/* If this used to be a qualified union type, but we now know what 	   field will be present, make this a normal union.  */
if|if
condition|(
name|TREE_CODE
argument_list|(
...
begin_comment
comment|/* Give TYPE a new main variant: NEW_MAIN.    This is the right thing to do only when something else    about TYPE is modified in place.  */
end_comment

begin_function
name|void
name|change_main_variant
parameter_list|(
name|type
parameter_list|,
name|new_main
...
argument_list|)
decl_stmt|;
comment|/* Remove TYPE from the TYPE_NEXT_VARIANT chain of its main variant.  */
if|if
condition|(
name|TYPE_NEXT_VARIANT
argument_list|(
...
directive|if
literal|0
comment|/* This led to crashes, because it could put a temporary node 	 on the TYPE_NEXT_VARIANT chain of a permanent one.  */
comment|/* The main variant of an array type should always      be an array whose element type is the main variant.  */
block|if (elt_type != TYPE_MAIN_VARIANT (elt_type))     change_main_variant (t, build_array_type (TYPE_MAIN_VARIANT (elt_type), 					      index_type));
endif|#
directive|endif
if|if
condition|(
