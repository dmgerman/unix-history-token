...
expr_stmt|;
block|}
comment|/* If a permanent object is in the wrong obstack, or the reverse, warn.  */
if|if
condition|(
...
name|fputs
argument_list|(
literal|" !!permanent object in non-permanent obstack!!"
argument_list|,
name|file
argument_list|)
expr_stmt|;
...
name|fputs
argument_list|(
literal|" !!non-permanent object in permanent obstack!!"
argument_list|,
name|file
argument_list|)
expr_stmt|;
