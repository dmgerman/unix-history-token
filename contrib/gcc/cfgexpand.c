...
begin_comment
comment|/* Helper routine to check if a record or union contains an array field. */
end_comment

begin_function
specifier|static
name|int
name|record_or_union_type_has_array_p
parameter_list|(
name|tree
name|tree_type
parameter_list|)
...
argument_list|)
decl_stmt|;
comment|/* Examine local referenced variables that have their addresses 	     * taken, contain an array, or are arrays. */
if|if
condition|(
name|TREE_CODE
argument_list|(
