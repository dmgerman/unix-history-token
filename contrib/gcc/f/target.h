...
parameter_list|)
define|\
value|REAL_VALUE_FROM_INT (resr, (HOST_WIDE_INT) lf,		\                        (HOST_WIDE_INT) ((lf< 0) ? -1 : 0),	\                        mode_for_size (kt == 1 ? 32 : 64, MODE_FLOAT, 0))
end_define
...
define|#
directive|define
name|FFETARGET_REAL_VALUE_FROM_LONGLONG_
parameter_list|(
name|resr
parameter_list|,
name|lf
...
parameter_list|)
define|\
value|REAL_VALUE_FROM_INT (resr, (HOST_WIDE_INT) lf,			\ 		       (HOST_WIDE_INT) (lf>> HOST_BITS_PER_WIDE_INT),	\                        mode_for_size (kt == 1 ? 32 : 64, MODE_FLOAT, 0))
end_define

begin_define
define|#
directive|define
name|FFETARGET_LONGLONG_FROM_INTS_
parameter_list|(
name|hi
parameter_list|,
name|lo
parameter_list|)
define|\
value|(((long long int) hi<< HOST_BITS_PER_WIDE_INT)	\    | (long long int) ((unsigned HOST_WIDE_INT) lo))
end_define
...
parameter_list|)
define|\
value|FFETARGET_REAL_VALUE_FROM_INT_ (resr, lf, kt)
end_define
...
parameter_list|)
define|\
value|({ REAL_VALUE_TYPE resi, resr; \      ffetargetInteger4 lf = (l); \      FFETARGET_REAL_VALUE_FROM_LONGLONG_ (resr, lf, 1); \      resi = dconst0; \      ffetarget_cvt_rv_to_r1_ (resr, (res)->real); \      ffetarget_cvt_rv_to_r1_ (resi, (res)->imaginary); \      FFEBAD; })
end_define
...
parameter_list|)
define|\
value|({ REAL_VALUE_TYPE resi, resr; \      ffetargetInteger4 lf = (l); \      FFETARGET_REAL_VALUE_FROM_LONGLONG_ (resr, lf, 2); \      resi = dconst0; \      ffetarget_cvt_rv_to_r2_ (resr,&((res)->real.v[0])); \      ffetarget_cvt_rv_to_r2_ (resi,&((res)->imaginary.v[0])); \      FFEBAD; })
end_define
...
parameter_list|)
define|\
value|({ REAL_VALUE_TYPE lr; \      lr = ffetarget_cvt_r1_to_rv_ ((l).real); \      REAL_VALUE_TO_INT (&ffetarget_long_val_,&ffetarget_long_junk_, lr); \      *(res) = FFETARGET_LONGLONG_FROM_INTS_ (ffetarget_long_junk_,  \ 					     ffetarget_long_val_); \      FFEBAD; })
end_define
...
parameter_list|)
define|\
value|({ REAL_VALUE_TYPE lr; \      lr = ffetarget_cvt_r2_to_rv_ (&((l).real.v[0])); \      REAL_VALUE_TO_INT (&ffetarget_long_val_,&ffetarget_long_junk_, lr); \      *(res) = FFETARGET_LONGLONG_FROM_INTS_ (ffetarget_long_junk_,  \ 					     ffetarget_long_val_); \      FFEBAD; })
end_define
...
parameter_list|)
define|\
value|({ REAL_VALUE_TYPE lr; \      lr = ffetarget_cvt_r1_to_rv_ (l); \      REAL_VALUE_TO_INT (&ffetarget_long_val_,&ffetarget_long_junk_, lr); \      *(res) = FFETARGET_LONGLONG_FROM_INTS_ (ffetarget_long_junk_, \ 					     ffetarget_long_val_); \      FFEBAD; })
end_define
...
parameter_list|)
define|\
value|({ REAL_VALUE_TYPE lr; \      lr = ffetarget_cvt_r2_to_rv_ (&((l).v[0])); \      REAL_VALUE_TO_INT (&ffetarget_long_val_,&ffetarget_long_junk_, lr); \      *(res) = FFETARGET_LONGLONG_FROM_INTS_ (ffetarget_long_junk_, \ 					     ffetarget_long_val_); \      FFEBAD; })
end_define
...
parameter_list|)
define|\
value|({ REAL_VALUE_TYPE resr; \      ffetargetInteger4 lf = (l); \      FFETARGET_REAL_VALUE_FROM_LONGLONG_ (resr, lf, 1); \      ffetarget_cvt_rv_to_r1_ (resr, *(res)); \      FFEBAD; })
end_define
...
parameter_list|)
define|\
value|({ REAL_VALUE_TYPE resr; \      ffetargetInteger4 lf = (l); \      FFETARGET_REAL_VALUE_FROM_LONGLONG_ (resr, lf, 2); \      ffetarget_cvt_rv_to_r2_ (resr,&((res)->v[0])); \      FFEBAD; })
end_define
