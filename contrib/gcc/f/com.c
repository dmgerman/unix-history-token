...
begin_comment
comment|/* ~~gcc/tree.h *should* declare this, because toplev.c and dwarfout.c    reference it.  */
end_comment
...
begin_comment
comment|/* Wrapper for get_identifier.  pattern is sprintf-like, assumed to contain    one %s if text is not NULL, assumed to contain one %d if number is    not -1.  If both are assumed, the %s is assumed to precede the %d.  */
end_comment
...
begin_comment
comment|/* ~~gcc/tree.h *should* declare this, because toplev.c references it.  */
end_comment
