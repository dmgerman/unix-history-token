...
name|warning
argument_list|(
literal|"%s is overloaded with meanings and likely to be removed;"
argument_list|,
name|opt
argument_list|)
expr_stmt|;
name|warning
argument_list|(
literal|"use only the specific -fugly-* options you need"
argument_list|)
expr_stmt|;
