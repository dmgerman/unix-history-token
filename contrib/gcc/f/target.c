...
directive|ifdef
name|CROSS_COMPILE
comment|/* HOST_WORDS_BIG_ENDIAN corresponds to both WORDS_BIG_ENDIAN and      BYTES_BIG_ENDIAN (i.e. there are no HOST_ macros to represent a      difference in the two latter).  */
name|int
