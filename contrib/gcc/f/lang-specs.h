...
literal|"@ratfor"
operator|,
literal|"%{C:%{!E:%eGNU C does not support -C without using -E}}\     ratfor %{C} %{v} %{E:%W{o*}} %{!E: %{!pipe:-o %g.f} %i |\n\     f771 %{!pipe:%g.f} %(cc1_options) %{I*} %{!fsyntax-only:%(invoke_as)}}"
operator|,
literal|0
block|}
end_block
