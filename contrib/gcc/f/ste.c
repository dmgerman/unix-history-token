...
define|#
directive|define
name|ffeste_f2c_charnolenspec_
parameter_list|(
name|Spec
parameter_list|,
name|Exp
...
parameter_list|)
define|\
value|do									      \     {									      \     if (Spec->kw_or_val_present)					      \ 	Exp = ffecom_arg_ptr_to_expr(Spec->u.expr,&ignore);		 \       else								      \ 	Exp = null_pointer_node;					      \     if (TREE_CONSTANT(Exp))						      \ 	{								      \ 	Init = Exp;							      \ 	Exp = NULL_TREE;						      \ 	}								      \       else								      \ 	{								      \ 	Init = null_pointer_node;					      \ 	constantp = FALSE;						      \ 	}								      \     } while(0)
end_define

begin_define
define|#
directive|define
name|ffeste_f2c_charspec_
parameter_list|(
name|Spec
parameter_list|,
name|Exp
...
parameter_list|)
define|\
value|do									      \     {									      \     if (Spec->kw_or_val_present)					      \ 	Exp = ffecom_arg_ptr_to_expr(Spec->u.expr,&Lenexp);		      \       else								      \ 	{								      \ 	Exp = null_pointer_node;					      \ 	Lenexp = ffecom_f2c_ftnlen_zero_node;				      \ 	}								      \     if (TREE_CONSTANT(Exp))						      \ 	{								      \ 	Init = Exp;							      \ 	Exp = NULL_TREE;						      \ 	}								      \       else								      \ 	{								      \ 	Init = null_pointer_node;					      \ 	constantp = FALSE;						      \ 	}								      \     if ((Lenexp != NULL_TREE)&& TREE_CONSTANT(Lenexp))			      \ 	{								      \ 	Leninit = Lenexp;						      \ 	Lenexp = NULL_TREE;						      \ 	}								      \       else								      \ 	{								      \ 	Leninit = ffecom_f2c_ftnlen_zero_node;				      \ 	constantp = FALSE;						      \ 	}								      \     } while(0)
end_define

begin_define
define|#
directive|define
name|ffeste_f2c_exp_
parameter_list|(
name|Field
parameter_list|,
name|Exp
parameter_list|)
define|\
value|do									      \     {									      \     if (Exp != NULL_TREE)						      \ 	{								      \ 	Exp = ffecom_modify(void_type_node,ffecom_2(COMPONENT_REF,	      \ 	      TREE_TYPE(Field),t,Field),Exp);				      \ 	expand_expr_stmt(Exp);						      \ 	}								      \     } while(0)
end_define

begin_define
define|#
directive|define
name|ffeste_f2c_init_
parameter_list|(
name|Init
parameter_list|)
define|\
...
parameter_list|)
define|\
value|do									      \     {									      \     if (Spec->kw_or_val_present)					      \ 	Exp = ffecom_expr(Spec->u.expr);				      \       else								      \ 	Exp = ffecom_integer_zero_node;					      \     if (TREE_CONSTANT(Exp))						      \ 	{								      \ 	Init = Exp;							      \ 	Exp = NULL_TREE;						      \ 	}								      \       else								      \ 	{								      \ 	Init = ffecom_integer_zero_node;				      \ 	constantp = FALSE;						      \ 	}								      \     } while(0)
end_define

begin_define
define|#
directive|define
name|ffeste_f2c_ptrtointspec_
parameter_list|(
name|Spec
parameter_list|,
name|Exp
...
parameter_list|)
define|\
value|do									      \     {									      \     if (Spec->kw_or_val_present)					      \ 	Exp = ffecom_ptr_to_expr(Spec->u.expr);				 \       else								      \ 	Exp = null_pointer_node;					      \     if (TREE_CONSTANT(Exp))						      \ 	{								      \ 	Init = Exp;							      \ 	Exp = NULL_TREE;						      \ 	}								      \       else								      \ 	{								      \ 	Init = null_pointer_node;					      \ 	constantp = FALSE;						      \ 	}								      \     } while(0)
end_define
...
argument_list|()
expr_stmt|;
comment|/* Want to save these throughout the loop. */
name|tvar
operator|=
name|ffecom_expr_rw
argument_list|(
...
argument_list|()
expr_stmt|;
comment|/* Want to discard the rest after the loop. */
name|tstart
operator|=
name|ffecom_expr
argument_list|(
...
argument_list|()
expr_stmt|;
comment|/* Discard the above now that we're done with 				   DO stmt. */
if|if
condition|(
name|block
operator|==
...
begin_comment
comment|/* ffeste_io_call_ -- Generate call to run-time I/O routine     tree callexpr = build(CALL_EXPR,...);    ffeste_io_call_(callexpr,TRUE);     Sets TREE_SIDE_EFFECTS(callexpr) = 1.  If ffeste_io_iostat_ is not    NULL_TREE, replaces callexpr with "iostat = callexpr;".  Expands the    result.  If ffeste_io_abort_ is not NULL_TREE and the second argument    is TRUE, generates "if (iostat != 0) goto ffeste_io_abort_;".  */
end_comment
...
begin_comment
comment|/* ffeste_io_ialist_ -- Make arglist with ptr to B/E/R control list     tree arglist;    arglist = ffeste_io_ialist_(...);     Returns a tree suitable as an argument list containing a pointer to    a BACKSPACE/ENDFILE/REWIND control list.  First, generates that control    list, if necessary, along with any static and run-time initializations    that are needed as specified by the arguments to this function.  */
end_comment
...
begin_comment
comment|/* ffeste_io_cilist_ -- Make arglist with ptr to external I/O control list     tree arglist;    arglist = ffeste_io_cilist_(...);     Returns a tree suitable as an argument list containing a pointer to    an external-file I/O control list.  First, generates that control    list, if necessary, along with any static and run-time initializations    that are needed as specified by the arguments to this function.  */
end_comment
...
begin_comment
comment|/* ffeste_io_cllist_ -- Make arglist with ptr to CLOSE control list     tree arglist;    arglist = ffeste_io_cllist_(...);     Returns a tree suitable as an argument list containing a pointer to    a CLOSE-statement control list.  First, generates that control    list, if necessary, along with any static and run-time initializations    that are needed as specified by the arguments to this function.  */
end_comment
...
begin_comment
comment|/* ffeste_io_icilist_ -- Make arglist with ptr to internal I/O control list     tree arglist;    arglist = ffeste_io_icilist_(...);     Returns a tree suitable as an argument list containing a pointer to    an internal-file I/O control list.  First, generates that control    list, if necessary, along with any static and run-time initializations    that are needed as specified by the arguments to this function.  */
end_comment
...
begin_comment
comment|/* ffeste_io_impdo_ -- Handle implied-DO in I/O list     ffebld expr;    ffeste_io_impdo_(expr);     Expands code to start up the DO loop.  Then for each item in the    DO loop, handles appropriately (possibly including recursively calling    itself).  Then expands code to end the DO loop.  */
end_comment
...
name|list
decl_stmt|;
comment|/* Used for list of items in left part of 				   impdo. */
name|ffebld
name|item
decl_stmt|;
comment|/* I/O item from head of given list. */
name|tree
name|tvar
decl_stmt|;
name|tree
...
begin_comment
comment|/* ffeste_io_inlist_ -- Make arglist with ptr to INQUIRE control list     tree arglist;    arglist = ffeste_io_inlist_(...);     Returns a tree suitable as an argument list containing a pointer to    an INQUIRE-statement control list.  First, generates that control    list, if necessary, along with any static and run-time initializations    that are needed as specified by the arguments to this function.  */
end_comment
...
begin_comment
comment|/* ffeste_io_olist_ -- Make arglist with ptr to OPEN control list     tree arglist;    arglist = ffeste_io_olist_(...);     Returns a tree suitable as an argument list containing a pointer to    an OPEN-statement control list.  First, generates that control    list, if necessary, along with any static and run-time initializations    that are needed as specified by the arguments to this function.  */
end_comment
...
begin_comment
comment|/* ffeste_subr_file_ -- Display file-statement specifier     ffeste_subr_file_(&specifier);  */
end_comment
...
begin_comment
comment|/* ffeste_subr_beru_ -- Generate code for BACKSPACE/ENDFILE/REWIND     ffeste_subr_beru_(FFECOM_gfrtFBACK);	 */
end_comment
...
expr_stmt|;
block|}
comment|/* If we've got a temp iostat, pop the temp. */
if|if
condition|(
name|ffeste_io_iostat_is_temp_
condition|)
...
begin_comment
comment|/* ffeste_end_R807 -- End of statement following logical IF     ffeste_end_R807(TRUE);     Applies ONLY to logical IF, not to IF-THEN.	For example, does not    ffelex_token_kill the construct name for an IF-THEN block (the name    field is invalid for logical IF).  ok==TRUE iff statement following    logical IF (substatement) is valid; else, statement is invalid or    stack forcibly popped due to ffeste_eof_().	*/
end_comment
...
begin_comment
comment|/* ffeste_labeldef_branch -- Generate "code" for branch label def     ffeste_labeldef_branch(label);  */
end_comment
...
begin_comment
comment|/* ffeste_labeldef_format -- Generate "code" for FORMAT label def     ffeste_labeldef_format(label);  */
end_comment
...
begin_comment
comment|/* ffeste_R737A -- Assignment statement outside of WHERE     ffeste_R737A(dest_expr,source_expr);	 */
end_comment
...
begin_comment
comment|/* ffeste_R803 -- Block IF (IF-THEN) statement     ffeste_R803(construct_name,expr,expr_token);     Make sure statement is valid here; implement.  */
end_comment
...
begin_comment
comment|/* ffeste_R804 -- ELSE IF statement     ffeste_R804(expr,expr_token,name_token);     Make sure ffeste_kind_ identifies an IF block.  If not    NULL, make sure name_token gives the correct name.  Implement the else    of the IF block.  */
end_comment
...
begin_comment
comment|/* ffeste_R805 -- ELSE statement     ffeste_R805(name_token);     Make sure ffeste_kind_ identifies an IF block.  If not    NULL, make sure name_token gives the correct name.  Implement the ELSE    of the IF block.  */
end_comment
...
begin_comment
comment|/* ffeste_R806 -- End an IF-THEN     ffeste_R806(TRUE);  */
end_comment
...
begin_comment
comment|/* ffeste_R807 -- Logical IF statement     ffeste_R807(expr,expr_token);     Make sure statement is valid here; implement.  */
end_comment
...
begin_comment
comment|/* ffeste_R809 -- SELECT CASE statement     ffeste_R809(construct_name,expr,expr_token);     Make sure statement is valid here; implement.  */
end_comment
...
begin_comment
comment|/* ffeste_R810 -- CASE statement     ffeste_R810(case_value_range_list,name);     If casenum is 0, it's CASE DEFAULT.	Else it's the case ranges at    the start of the first_stmt list in the select object at the top of    the stack that match casenum.  */
end_comment
...
expr_stmt|;
block|}
comment|/* ~~~handle character, character*1 */
else|#
directive|else
error|#
directive|error
...
begin_comment
comment|/* ffeste_R811 -- End a SELECT     ffeste_R811(TRUE);  */
end_comment
...
argument_list|()
expr_stmt|;
comment|/* ~~~handle character and character*1 */
else|#
directive|else
error|#
directive|error
...
begin_comment
comment|/* ffeste_R819B -- DO WHILE statement     ffeste_R819B(construct_name,label_token,expr,expr_token);     Make sure statement is valid here; implement.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* Means DO WHILE vs. iter DO. */
if|if
condition|(
name|expr
operator|!=
...
begin_comment
comment|/* ffeste_R825 -- END DO statement     ffeste_R825(name_token);     Make sure ffeste_kind_ identifies a DO block.  If not    NULL, make sure name_token gives the correct name.  Do whatever    is specific to seeing END DO with a DO-target label definition on it,    where the END DO is really treated as a CONTINUE (i.e. generate th    same code you would for CONTINUE).  ffeste_do handles the actual    generation of end-loop code.	 */
end_comment
...
begin_comment
comment|/* ffeste_R834 -- CYCLE statement     ffeste_R834(name_token);     Handle a CYCLE within a loop.  */
end_comment
...
begin_comment
comment|/* ffeste_R835 -- EXIT statement     ffeste_R835(name_token);     Handle a EXIT within a loop.	 */
end_comment
...
begin_comment
comment|/* ffeste_R836 -- GOTO statement     ffeste_R836(label);     Make sure label_token identifies a valid label for a GOTO.  Update    that label's info to indicate it is the target of a GOTO.  */
end_comment
...
begin_comment
comment|/* ffeste_R837 -- Computed GOTO statement     ffeste_R837(labels,count,expr);     Make sure label_list identifies valid labels for a GOTO.  Update    each label's info to indicate it is the target of a GOTO.  */
end_comment
...
argument_list|()
expr_stmt|;
comment|/* In case of lots of labels, keep clearing 				   them out. */
for|for
control|(
name|i
operator|=
...
begin_comment
comment|/* ffeste_R839 -- Assigned GOTO statement     ffeste_R839(target,target_token,label_list);     Make sure label_list identifies valid labels for a GOTO.  Update    each label's info to indicate it is the target of a GOTO.  */
end_comment
...
begin_comment
comment|/* ffeste_R840 -- Arithmetic IF statement     ffeste_R840(expr,expr_token,neg,zero,pos);     Make sure the labels are valid; implement.  */
end_comment
...
begin_comment
comment|/* ffeste_R841 -- CONTINUE statement     ffeste_R841();  */
end_comment
...
begin_comment
comment|/* ffeste_R842 -- STOP statement     ffeste_R842(expr);  */
end_comment
...
begin_comment
comment|/* ffeste_R843 -- PAUSE statement     ffeste_R843(expr,expr_token);     Make sure statement is valid here; implement.  expr and expr_token are    both NULL if there was no expression.  */
end_comment
...
begin_comment
comment|/* ffeste_R904 -- OPEN statement     ffeste_R904();     Make sure an OPEN is valid in the current context, and implement it.	 */
end_comment
...
begin_comment
comment|/* ffeste_R907 -- CLOSE statement     ffeste_R907();     Make sure a CLOSE is valid in the current context, and implement it.	 */
end_comment
...
begin_comment
comment|/* ffeste_R909_start -- READ(...) statement list begin     ffeste_R909_start(FALSE);     Verify that READ is valid here, and begin accepting items in the    list.  */
end_comment
...
name|endl
decl_stmt|;
comment|/* First determine the start, per-item, and end run-time functions to        call.  The per-item function is picked by choosing an ffeste functio        to call to handle a given item; it knows how to generate a call to the        appropriate run-time function, and is called an "io driver".  It        handles the implied-DO construct, for example. */
switch|switch
condition|(
name|format
condition|)
...
condition|)
block|{
comment|/* no IOSTAT= but ERR= or END= or both */
name|ffeste_io_iostat_is_temp_
operator|=
name|TRUE
expr_stmt|;
...
begin_comment
comment|/* ffeste_R909_item -- READ statement i/o item     ffeste_R909_item(expr,expr_token);     Implement output-list expression.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* "READ *,(A)" -- really a bug in the user's 				   code, but I've been told lots of code does 				   this (blech)! */
if|if
condition|(
name|ffebld_op
argument_list|(
...
begin_comment
comment|/* ffeste_R909_finish -- READ statement list complete     ffeste_R909_finish();     Just wrap up any local activities.  */
end_comment
...
begin_comment
comment|/* ffeste_R910_start -- WRITE(...) statement list begin     ffeste_R910_start();     Verify that WRITE is valid here, and begin accepting items in the    list.  */
end_comment
...
begin_comment
comment|/* ffeste_R910_item -- WRITE statement i/o item     ffeste_R910_item(expr,expr_token);     Implement output-list expression.  */
end_comment
...
begin_comment
comment|/* ffeste_R910_finish -- WRITE statement list complete     ffeste_R910_finish();     Just wrap up any local activities.  */
end_comment
...
begin_comment
comment|/* ffeste_R911_start -- PRINT statement list begin     ffeste_R911_start();     Verify that PRINT is valid here, and begin accepting items in the    list.  */
end_comment
...
begin_comment
comment|/* ffeste_R911_item -- PRINT statement i/o item     ffeste_R911_item(expr,expr_token);     Implement output-list expression.  */
end_comment
...
begin_comment
comment|/* ffeste_R911_finish -- PRINT statement list complete     ffeste_R911_finish();     Just wrap up any local activities.  */
end_comment
...
begin_comment
comment|/* ffeste_R919 -- BACKSPACE statement     ffeste_R919();     Make sure a BACKSPACE is valid in the current context, and implement it.  */
end_comment
...
begin_comment
comment|/* ffeste_R920 -- ENDFILE statement     ffeste_R920();     Make sure a ENDFILE is valid in the current context, and implement it.  */
end_comment
...
begin_comment
comment|/* ffeste_R921 -- REWIND statement     ffeste_R921();     Make sure a REWIND is valid in the current context, and implement it.  */
end_comment
...
begin_comment
comment|/* ffeste_R923A -- INQUIRE statement (non-IOLENGTH version)     ffeste_R923A(bool by_file);     Make sure an INQUIRE is valid in the current context, and implement it.  */
end_comment
...
begin_comment
comment|/* ffeste_R923B_start -- INQUIRE(IOLENGTH=expr) statement list begin     ffeste_R923B_start();     Verify that INQUIRE is valid here, and begin accepting items in the    list.  */
end_comment
...
begin_comment
comment|/* ffeste_R923B_item -- INQUIRE statement i/o item     ffeste_R923B_item(expr,expr_token);     Implement output-list expression.  */
end_comment
...
begin_comment
comment|/* ffeste_R923B_finish -- INQUIRE statement list complete     ffeste_R923B_finish();     Just wrap up any local activities.  */
end_comment
...
begin_comment
comment|/* ffeste_R1103 -- End a PROGRAM     ffeste_R1103();  */
end_comment
...
begin_comment
comment|/* ffeste_R1112 -- End a BLOCK DATA     ffeste_R1112(TRUE);	*/
end_comment
...
begin_comment
comment|/* ffeste_R1212 -- CALL statement     ffeste_R1212(expr,expr_token);     Make sure statement is valid here; implement.  */
end_comment
...
argument_list|()
expr_stmt|;
comment|/* In case of many labels, keep 'em cleared 				   out. */
for|for
control|(
name|caseno
operator|=
...
begin_comment
comment|/* ffeste_R1221 -- End a FUNCTION     ffeste_R1221(TRUE);	*/
end_comment
...
begin_comment
comment|/* ffeste_R1225 -- End a SUBROUTINE     ffeste_R1225(TRUE);	*/
end_comment
...
begin_comment
comment|/* ffeste_R1226 -- ENTRY statement     ffeste_R1226(entryname,arglist,ending_token);     Make sure we're in a SUBROUTINE or FUNCTION, register arguments for the    entry point name, and so on.	 */
end_comment
...
begin_comment
comment|/* ffeste_R1227 -- RETURN statement     ffeste_R1227(expr);     Make sure statement is valid here; implement.  expr and expr_token are    both NULL if there was no expression.  */
end_comment
...
begin_comment
comment|/* ffeste_V018_start -- REWRITE(...) statement list begin     ffeste_V018_start();     Verify that REWRITE is valid here, and begin accepting items in the    list.  */
end_comment
...
begin_comment
comment|/* ffeste_V018_item -- REWRITE statement i/o item     ffeste_V018_item(expr,expr_token);     Implement output-list expression.  */
end_comment
...
begin_comment
comment|/* ffeste_V018_finish -- REWRITE statement list complete     ffeste_V018_finish();     Just wrap up any local activities.  */
end_comment
...
begin_comment
comment|/* ffeste_V019_start -- ACCEPT statement list begin     ffeste_V019_start();     Verify that ACCEPT is valid here, and begin accepting items in the    list.  */
end_comment
...
begin_comment
comment|/* ffeste_V019_item -- ACCEPT statement i/o item     ffeste_V019_item(expr,expr_token);     Implement output-list expression.  */
end_comment
...
begin_comment
comment|/* ffeste_V019_finish -- ACCEPT statement list complete     ffeste_V019_finish();     Just wrap up any local activities.  */
end_comment
...
begin_comment
comment|/* ffeste_V020_start -- TYPE statement list begin     ffeste_V020_start();     Verify that TYPE is valid here, and begin accepting items in the    list.  */
end_comment
...
begin_comment
comment|/* ffeste_V020_item -- TYPE statement i/o item     ffeste_V020_item(expr,expr_token);     Implement output-list expression.  */
end_comment
...
begin_comment
comment|/* ffeste_V020_finish -- TYPE statement list complete     ffeste_V020_finish();     Just wrap up any local activities.  */
end_comment
...
begin_comment
comment|/* ffeste_V021 -- DELETE statement     ffeste_V021();     Make sure a DELETE is valid in the current context, and implement it.  */
end_comment
...
begin_comment
comment|/* ffeste_V022 -- UNLOCK statement     ffeste_V022();     Make sure a UNLOCK is valid in the current context, and implement it.  */
end_comment
...
begin_comment
comment|/* ffeste_V023_start -- ENCODE(...) statement list begin     ffeste_V023_start();     Verify that ENCODE is valid here, and begin accepting items in the    list.  */
end_comment
...
begin_comment
comment|/* ffeste_V023_item -- ENCODE statement i/o item     ffeste_V023_item(expr,expr_token);     Implement output-list expression.  */
end_comment
...
begin_comment
comment|/* ffeste_V023_finish -- ENCODE statement list complete     ffeste_V023_finish();     Just wrap up any local activities.  */
end_comment
...
begin_comment
comment|/* ffeste_V024_start -- DECODE(...) statement list begin     ffeste_V024_start();     Verify that DECODE is valid here, and begin accepting items in the    list.  */
end_comment
...
begin_comment
comment|/* ffeste_V024_item -- DECODE statement i/o item     ffeste_V024_item(expr,expr_token);     Implement output-list expression.  */
end_comment
...
begin_comment
comment|/* ffeste_V024_finish -- DECODE statement list complete     ffeste_V024_finish();     Just wrap up any local activities.  */
end_comment
...
begin_comment
comment|/* ffeste_V025_start -- DEFINEFILE statement list begin     ffeste_V025_start();     Verify that DEFINEFILE is valid here, and begin accepting items in the    list.  */
end_comment
...
begin_comment
comment|/* ffeste_V025_item -- DEFINE FILE statement item     ffeste_V025_item(u,ut,m,mt,n,nt,asv,asvt);     Implement item.  */
end_comment
...
begin_comment
comment|/* ffeste_V025_finish -- DEFINE FILE statement list complete     ffeste_V025_finish();     Just wrap up any local activities.  */
end_comment
...
begin_comment
comment|/* ffeste_V026 -- FIND statement     ffeste_V026();     Make sure a FIND is valid in the current context, and implement it.	*/
end_comment
