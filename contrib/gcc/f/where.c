...
begin_comment
comment|/* A somewhat evil way to prevent the garbage collector    from collecting 'file' structures.  */
end_comment

begin_define
define|#
directive|define
name|NUM_FFEWHERE_HEAD_FILES
value|31
end_define
...
return|return;
block|}
comment|/* Called on a file that has already been deallocated... */
name|abort
argument_list|()
expr_stmt|;
block|}
