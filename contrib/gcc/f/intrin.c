...
parameter_list|)
define|\
value|{ NAME, FFECOM_gfrt ## GFRTDIRECT, FFECOM_gfrt ## GFRTF2C, \ 	FFECOM_gfrt ## GFRTGNU, CONTROL },
elif|#
directive|elif
name|FFECOM_targetCURRENT
operator|==
