...
begin_comment
comment|/* Macro to access MEM_OFFSET as an HOST_WIDE_INT.  Evaluates MEM twice.  */
end_comment
...
name|mem
parameter_list|)
value|(MEM_OFFSET (mem) ? INTVAL (MEM_OFFSET (mem)) : 0)
end_define
...
specifier|inline
name|bool
name|offset_valid_for_tracked_p
parameter_list|(
name|HOST_WIDE_INT
name|offset
parameter_list|)
