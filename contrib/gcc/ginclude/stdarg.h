...
begin_comment
comment|/* BSD 4.4 actually spells the name _BSD_VA_LIST_ and requires it to be  * defined and usable in place of va_list when the latter name is not  * allowed (e.g., in stdio.h - see above).  */
end_comment
