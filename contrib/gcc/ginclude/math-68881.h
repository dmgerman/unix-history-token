...
begin_comment
comment|/* This file is NOT a part of GCC, just distributed with it.  */
end_comment

begin_comment
comment|/* If you find this in GCC,    please send bug reports to bug-gcc@prep.ai.mit.edu.  */
end_comment

begin_comment
comment|/* Changed by Richard Stallman:    May 1993, add conditional to prevent multiple inclusion.    % inserted before a #.    New function `hypot' added.    Nans written in hex to avoid 0rnan.    May 1992, use %! for fpcr register.  Break lines before function names.    December 1989, add parens around `&' in pow.    November 1990, added alternate definition of HUGE_VAL for Sun.  */
end_comment

begin_comment
comment|/* Changed by Jim Wilson:    September 1993, Use #undef before HUGE_VAL instead of #ifdef/#endif.  */
end_comment

begin_comment
comment|/* Changed by Ian Lance Taylor:    September 1994, use extern inline instead of static inline.  */
end_comment
