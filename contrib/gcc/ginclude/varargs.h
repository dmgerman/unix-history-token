...
begin_comment
comment|/* ??? It would be nice to get rid of the ellipsis here.  It causes    current_function_varargs to be set in cc1.  */
end_comment
...
begin_comment
comment|/* Define __gnuc_va_list, just as in stdarg.h.  */
end_comment
...
name|v
parameter_list|)
value|__builtin_varargs_start((v))
end_define
