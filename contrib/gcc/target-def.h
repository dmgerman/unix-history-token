...
value|default_ms_bitfield_layout_p
end_define
...
define|\
value|{						\   TARGET_ASM_OUT,				\   TARGET_SCHED,					\   TARGET_MERGE_DECL_ATTRIBUTES,			\   TARGET_MERGE_TYPE_ATTRIBUTES,			\   TARGET_ATTRIBUTE_TABLE,			\   TARGET_COMP_TYPE_ATTRIBUTES,			\   TARGET_SET_DEFAULT_TYPE_ATTRIBUTES,		\   TARGET_INSERT_ATTRIBUTES,			\   TARGET_FUNCTION_ATTRIBUTE_INLINABLE_P,	\   TARGET_MS_BITFIELD_LAYOUT_P,			\   TARGET_INIT_BUILTINS,				\   TARGET_EXPAND_BUILTIN,			\   TARGET_SECTION_TYPE_FLAGS,			\   TARGET_HAVE_NAMED_SECTIONS,			\   TARGET_HAVE_CTORS_DTORS,			\   TARGET_CANNOT_MODIFY_JUMPS_P			\ }
end_define
