...
name|res
decl_stmt|;
comment|/* We can't handle VOIDmodes.  We can get here when generating vector 	 modes since these, unlike integral and floating point modes are not 	 handled earlier.  */
if|if
condition|(
name|GET_MODE
argument_list|(
