...
begin_comment
comment|/* Expand a call to a bswap builtin.  The arguments are in ARGLIST.  MODE    is the mode to expand with.  */
end_comment

begin_function
specifier|static
name|rtx
name|expand_builtin_bswap
parameter_list|(
name|tree
name|arglist
parameter_list|,
...
begin_comment
comment|/* Fold function call to builtin_bswap and the long and long long    variants.  Return NULL_TREE if no simplification can be made.  */
end_comment

begin_function
specifier|static
name|tree
name|fold_builtin_bswap
parameter_list|(
name|tree
name|fndecl
parameter_list|,
...
literal|0
return|;
comment|/* Optimize constant value.  */
name|arg
operator|=
name|TREE_VALUE
argument_list|(
