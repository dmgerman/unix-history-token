...
begin_comment
comment|/* Index by register number, gives the quantity number    of the register's current contents.  */
end_comment
...
begin_comment
comment|/* Index by register number, gives the number of times    that register has been altered in the current basic block.  */
end_comment
...
begin_comment
comment|/* Remove from the ahsh table all expressions that reference memory.  */
end_comment
