...
argument_list|)
expr_stmt|;
comment|/* See comment further down why we must use next_real_insn here, 	     instead of next_active_insn.  */
name|target_label
operator|=
name|prev_label
argument_list|(
