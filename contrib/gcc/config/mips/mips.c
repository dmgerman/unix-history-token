...
begin_comment
comment|/* Classify symbolic expression X, given that it appears in context    CONTEXT.  */
end_comment
...
name|enum
name|mips_symbol_type
name|mips_classify_symbolic_expression
parameter_list|(
name|rtx
name|x
parameter_list|)
