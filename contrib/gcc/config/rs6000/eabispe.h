...
name|SUBSUBTARGET_OVERRIDE_OPTIONS
define|\
value|if (rs6000_select[1].string == NULL) \     rs6000_cpu = PROCESSOR_PPC8540; \   if (rs6000_abi_string == NULL) \     rs6000_spe_abi = 1; \   if (rs6000_float_gprs_string == NULL) \     rs6000_float_gprs = 1; \
