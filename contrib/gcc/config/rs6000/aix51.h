...
directive|define
name|CPP_PREDEFINES
value|"-D_IBMR2 -D_POWER -D_LONG_LONG \ -D_AIX -D_AIX32 -D_AIX41 -D_AIX43 -D_AIX51 -Asystem=unix -Asystem=aix"
end_define
...
directive|define
name|CPP_SPEC
value|"%{posix: -D_POSIX_SOURCE}\   %{ansi: -D_ANSI_C_SOURCE}\   %{!maix64: -D__WCHAR_TYPE__=short\\ unsigned\\ int}\   %{maix64: -D__64BIT__ -D_ARCH_PPC -D__LONG_MAX__=9223372036854775807L \     -D__WCHAR_TYPE__=unsigned\\ int}\   %{mpe: -I/usr/lpp/ppe.poe/include}\   %{pthread: -D_THREAD_SAFE}\   %(cpp_cpu)"
end_define
...
name|CPLUSPLUS_CPP_SPEC
define|\
value|"-D_XOPEN_SOURCE=500                          \    -D_XOPEN_SOURCE_EXTENDED=1                   \    -D_LARGE_FILE_API                            \    -D_ALL_SOURCE                                \    %{!maix64: -D__WCHAR_TYPE__=short\\ unsigned\\ int}\    %{maix64: -D__64BIT__ -D_ARCH_PPC -D__LONG_MAX__=9223372036854775807L \      -D__WCHAR_TYPE__=unsigned\\ int}\    %{mpe: -I/usr/lpp/ppe.poe/include}\    %{pthread: -D_THREAD_SAFE}\    %(cpp_cpu)"
end_define
...
begin_comment
comment|/* __WCHAR_TYPE__ is dynamic, so do not define it statically.  */
end_comment
