...
directive|define
name|SUBTARGET_CPP_SPEC
value|"%{posix:-D_POSIX_SOURCE} %{fPIC|fPIE:-D__PIC__ -D__pic__} %{fpic|fpie:-D__PIC__ -D__pic__}"
end_define
