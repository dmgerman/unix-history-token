...
directive|define
name|TARGET_VERSION
value|fputs (" (ARM/ELF ConiX)", stderr);
end_define
...
directive|define
name|TARGET_DEFAULT
value|(ARM_FLAG_SOFT_FLOAT | ARM_FLAG_APCS_32)
end_define
