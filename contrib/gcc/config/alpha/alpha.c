...
name|i
decl_stmt|;
comment|/* Irritatingly, there are two kinds of thunks -- those created with      ASM_OUTPUT_MI_THUNK and those with DECL_THUNK_P that go through      the regular part of the compiler.  In the ASM_OUTPUT_MI_THUNK case      we don't have valid register life info, but assemble_start_function      wants to output .frame and .mask directives.  */
if|if
condition|(
