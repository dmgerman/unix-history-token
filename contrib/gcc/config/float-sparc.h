...
begin_comment
comment|/* float.h for target with IEEE 32, 64 and 128 bit SPARC floating point formats    (on sparc-linux long double is 64 bit, while on sparc64-linux 128 bit) */
end_comment
