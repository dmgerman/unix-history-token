...
begin_comment
comment|/* float.h for target with IEEE 32 bit and 64 bit and Motorola style 96 bit    floating point formats */
end_comment
...
begin_comment
comment|/* ??? FLT_EVAL_METHOD depends on TARGET_68040_ONLY.  We do not currently    have a preprocessor token that we can use to tell that this is on.  */
end_comment
