...
begin_comment
comment|/* Subroutines for insn-output.c for Windows NT.    Contributed by Douglas Rupp (drupp@cs.washington.edu)    Copyright (C) 1995, 1997, 1998, 1999, 2000, 2001, 2002, 2003    Free Software Foundation, Inc.  This file is part of GCC.  GCC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GCC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GCC; see the file COPYING.  If not, write to the Free Software Foundation, 59 Temple Place - Suite 330, Boston, MA 02111-1307, USA.  */
end_comment
...
name|node
argument_list|,
literal|"function `%s' definition is marked dllimport."
argument_list|)
expr_stmt|;
operator|*
name|no_add_attrs
...
name|node
argument_list|,
literal|"variable `%s' definition is marked dllimport."
argument_list|)
expr_stmt|;
operator|*
name|no_add_attrs
...
name|node
argument_list|,
literal|"external linkage required for symbol '%s' because of '%s' attribute."
argument_list|,
name|IDENTIFIER_POINTER
argument_list|(
name|name
...
name|decl
argument_list|,
literal|"function '%s' is defined after prior declaration as dllimport: attribute ignored."
argument_list|)
expr_stmt|;
return|return
literal|0
return|;
block|}
comment|/* We ignore the dllimport attribute for inline member functions. 	 This differs from MSVC behaviour which treats it like GNUC      	 'extern inline' extension.   */
elseif|else
if|if
condition|(
name|TREE_CODE
...
name|decl
argument_list|,
literal|"inline function '%s' is declared as dllimport: attribute ignored."
argument_list|)
expr_stmt|;
return|return
literal|0
...
name|decl
argument_list|,
literal|"definition of static data member '%s' of dllimport'd class."
argument_list|)
expr_stmt|;
return|return
literal|0
...
name|decl
argument_list|,
literal|"inconsistent dll linkage for '%s': dllexport assumed."
argument_list|)
expr_stmt|;
...
name|decl
argument_list|,
literal|"failure in redeclaration of '%s': dllimport'd symbol lacks external linkage."
argument_list|)
expr_stmt|;
name|abort
argument_list|()
...
name|decl
argument_list|,
literal|"'%s' %s after being referenced with dllimport linkage."
argument_list|,
operator|(
name|DECL_INITIAL
argument_list|(
...
operator|)
condition|?
literal|"defined locally"
else|:
literal|"redeclared without dllimport attribute"
argument_list|)
expr_stmt|;
name|XEXP
argument_list|(
