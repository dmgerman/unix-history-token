...
begin_comment
comment|/* Return nonzero if ATTR is a valid attribute for DECL.    ATTRIBUTES are any existing attributes and ARGS are the arguments    supplied with ATTR.  */
end_comment
...
begin_comment
comment|/* Return nonzero if ATTR is a valid attribute for TYPE.    ATTRIBUTES are any existing attributes and ARGS are the arguments    supplied with ATTR.  */
end_comment
...
begin_comment
comment|/* Merge attributes in decls OLD and NEW.     This handles the following situation:     __declspec (dllimport) int foo;    int foo;     The second instance of `foo' nullifies the dllimport.  */
end_comment
