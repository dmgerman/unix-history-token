...
directive|define
name|CPP_PREDEFINES
value|"-Di386 -D_WIN32 -DWIN32 -D__WIN32__ \   -D__MINGW32__=0.2 -DWINNT  -D_X86_=1 -D__STDC__=1\   -D__stdcall=__attribute__((__stdcall__)) \   -D_stdcall=__attribute__((__stdcall__)) \   -D__cdecl=__attribute__((__cdecl__)) \   -D__declspec(x)=__attribute__((x)) \   -Asystem(winnt) -Acpu(i386) -Amachine(i386)"
end_define
...
directive|define
name|LIBGCC_SPEC
value|"-lmingw32 -lgcc -lmoldname -lcrtdll"
end_define
...
directive|define
name|STARTFILE_SPEC
value|"%{mdll:dllcrt1%O%s} %{!mdll:crt1%O%s}"
end_define
