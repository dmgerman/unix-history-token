...
begin_else
unit|static __inline int _mm_extract_pi16 (__m64 __A, int __N) {   return __builtin_ia32_pextrw ((__v4hi)__A, __N); }  static __inline int _m_pextrw (__m64 __A, int __N) {   return _mm_extract_pi16 (__A, __N); }
else|#
directive|else
end_else
...
begin_else
unit|static __inline __m64 _mm_insert_pi16 (__m64 __A, int __D, int __N) {   return (__m64)__builtin_ia32_pinsrw ((__v4hi)__A, __D, __N); }  static __inline __m64 _m_pinsrw (__m64 __A, int __D, int __N) {   return _mm_insert_pi16 (__A, __D, __N); }
else|#
directive|else
end_else
...
begin_else
unit|static __inline __m64 _mm_shuffle_pi16 (__m64 __A, int __N) {   return (__m64) __builtin_ia32_pshufw ((__v4hi)__A, __N); }  static __inline __m64 _m_pshufw (__m64 __A, int __N) {   return _mm_shuffle_pi16 (__A, __N); }
else|#
directive|else
end_else
