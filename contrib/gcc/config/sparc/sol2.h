...
directive|define
name|ASM_CPU_SPEC
value|"\ %{mcpu=v9:-xarch=v8plus} \ %{mcpu=ultrasparc:-xarch=v8plusa} \ %{mcpu=ultrasparc3:-xarch=v8plusb} \ %{mcpu=niagara:-xarch=v8plusb} \ %{!mcpu*:%(asm_cpu_default)} \ "
end_define
...
directive|define
name|TARGET_DEFAULT
value|(MASK_V8PLUS + MASK_APP_REGS + MASK_FPU \ 			+ MASK_LONG_DOUBLE_128)
end_define
...
parameter_list|)
define|\
value|do								\     {								\       fprintf (FILE, "\tcall\t");				\       print_operand (FILE, XEXP (DECL_RTL (FN), 0), 0);	\       fprintf (FILE, "\n\tnop\n");				\     }								\   while (0)
end_define
