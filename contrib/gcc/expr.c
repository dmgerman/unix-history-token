...
block|{
comment|/* Check to see whether memcpy takes all register arguments.  */
specifier|static
enum|enum
block|{
name|takes_regs_uninit
block|,
name|takes_regs_no
block|,
name|takes_regs_yes
...
condition|)
block|{
comment|/* C++ can generate ?: expressions with a throw expression in one 	 branch and an rvalue in the other. Here, we resolve attempts to 	 store the throw expression's nonexistant result. */
if|if
condition|(
name|want_value
condition|)
