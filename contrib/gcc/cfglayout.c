...
begin_comment
comment|/* Create a duplicate of the basic block BB and redirect edge E into it.    If E is not specified, BB is just copied, but updating the frequencies    etc. is left to the caller.  */
end_comment
