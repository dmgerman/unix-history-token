...
begin_comment
comment|/* The names of the counter tables.  */
end_comment
...
name|warning
argument_list|(
literal|"`%s' is not a gcov data file"
argument_list|,
name|da_file_name
argument_list|)
expr_stmt|;
...
literal|0
condition|?
literal|"`%s' has overflowed"
else|:
literal|"`%s' is corrupted"
argument_list|,
name|da_file_name
argument_list|)
expr_stmt|;
...
name|warning
argument_list|(
literal|"no coverage for function '%s' found."
argument_list|,
...
name|error
argument_list|(
literal|"coverage mismatch for function '%s' while reading counter '%s'."
argument_list|,
name|IDENTIFIER_POINTER
argument_list|(
name|DECL_ASSEMBLER_NAME
...
begin_comment
comment|/* Generate a MEM rtl to access COUNTER NO.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* Build the constructor function to invoke __gcov_init.  */
name|ctor_name
operator|=
name|concat
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* Actually generate the code to call __gcov_init.  */
name|gcov_info_address
operator|=
name|force_reg
argument_list|(
