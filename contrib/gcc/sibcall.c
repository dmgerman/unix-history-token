...
comment|/* Can't if more than one successor or single successor is not 		 exit block.  These two tests prevent tail call optimization 		 in the presence of active exception handlers.  */
operator|||
name|call_block
operator|->
name|succ
