...
begin_comment
comment|/* Return true in case BB can be CPU intensive and should be optimized    for maximal perofmrance.  */
end_comment
...
begin_comment
comment|/* Check whether this is the last basic block of function.  Commonly tehre    is one extra common cleanup block.  */
end_comment
...
name|e
decl_stmt|;
comment|/* Additionaly, we check here for blocks with no successors.  */
name|int
