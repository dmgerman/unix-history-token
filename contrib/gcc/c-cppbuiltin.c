...
literal|1
condition|)
comment|/* Due to an historical accident, this version had the value        "102".  */
name|builtin_define_with_int_value
argument_list|(
literal|"__GXX_ABI_VERSION"
argument_list|,
