...
name|o
decl_stmt|;
comment|/* Don't simply force rerecognition, as combine might left us 	   with some unrecongnizable ones, which later leads to aborts 	   in regclass, if we now destroy the remembered INSN_CODE().  */
