...
name|stream
argument_list|,
literal|"\ Usage: %s [-_] [-n] [-s {gnu,lucid,arm,hp,edg}] [--strip-underscores]\n\        [--no-strip-underscores] [--format={gnu,lucid,arm,hp,edg}]\n\       [--help] [--version] [arg...]\n"
argument_list|,
name|program_name
argument_list|)
expr_stmt|;
