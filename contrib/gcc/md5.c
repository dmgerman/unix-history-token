...
directive|if
operator|!
name|_STRING_ARCH_unaligned
comment|/* To check alignment gcc has an appropriate operator.  Other    compilers don't.  */
if|#
directive|if
name|__GNUC__
operator|>=
...
name|p
parameter_list|)
value|(((md5_uintptr) p) % __alignof__ (md5_uint32) != 0)
else|#
directive|else
define|#
directive|define
...
name|p
parameter_list|)
value|(((md5_uintptr) p) % sizeof (md5_uint32) != 0)
endif|#
directive|endif
if|if
condition|(
