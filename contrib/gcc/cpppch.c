...
begin_comment
comment|/* Save all the existing macros and assertions.      This code assumes that there might be hundreds, but not thousands of    existing definitions.  */
end_comment

begin_struct
struct|struct
name|save_macro_item
block|{
name|struct
name|save_macro_item
modifier|*
...
begin_comment
comment|/* Save the definition of a single macro, so that it will persist across    a PCH restore.  */
end_comment
...
literal|0
expr_stmt|;
comment|/* Read in the identifiers that must be defined.  */
for|for
control|(
init|;
condition|;
