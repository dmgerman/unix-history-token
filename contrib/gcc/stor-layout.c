...
begin_comment
comment|/* C-compiler utilities for types and variables storage layout    Copyright (C) 1987, 1988, 1992, 1993, 1994, 1995, 1996, 1996, 1998,    1999, 2000, 2001, 2002, 2003 Free Software Foundation, Inc.  This file is part of GCC.  GCC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GCC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GCC; see the file COPYING.  If not, write to the Free Software Foundation, 59 Temple Place - Suite 330, Boston, MA 02111-1307, USA.  */
end_comment
...
begin_comment
comment|/* If nonzero, the alignment of a bitstring or (power-)set value, in bits.    May be overridden by front-ends.  */
end_comment
...
begin_comment
comment|/* Return nonzero if EXPR is present on the pending sizes list.  */
end_comment
...
begin_comment
comment|/* FIELD is about to be added to RLI->T.  The alignment (in bits) of    the next available location is given by KNOWN_ALIGN.  Update the    variable alignment fields in RLI, and return the alignment to give    the FIELD.  */
end_comment
...
condition|)
block|{
comment|/* At this point, either the prior or current are bitfields, 	 (possibly both), and we're dealing with MS packing.  */
name|tree
name|prev_saved
init|=
name|rli
...
name|prev_field
decl_stmt|;
comment|/* Is the prior field a bitfield?  If so, handle "runs" of same 	 type size fields.  */
if|if
condition|(
name|rli
operator|->
name|prev_field
comment|/* necessarily a bitfield if it exists.  */
condition|)
block|{
...
literal|8
decl_stmt|;
comment|/* Never below 8 for compatability */
...
argument_list|)
expr_stmt|;
comment|/* Only the MS bitfields use this.  */
if|if
condition|(
name|rli
operator|->
