...
argument_list|)
expr_stmt|;
comment|/* If we created a new MEM based on reg_equiv_mem[REGNO], then 		     LOC above is part of the new MEM, not the MEM in INSN.  		     We must also replace the address of the MEM in INSN.  */
if|if
condition|(
operator|&
name|XEXP
