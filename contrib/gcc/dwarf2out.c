...
begin_comment
comment|/* Output Dwarf2 format symbol table information from the GNU C compiler.    Copyright (C) 1992, 93, 95, 96, 97, 1998 Free Software Foundation, Inc.    Contributed by Gary Funck (gary@intrepid.com).    Derived from DWARF 1 implementation of Ron Guilmette (rfg@monkeys.com).    Extensively modified by Jason Merrill (jason@cygnus.com).  This file is part of GNU CC.  GNU CC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GNU CC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU CC; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* Assume that in a PARALLEL prologue insn, only the first elt is      significant.  Currently this is true.  */
if|if
condition|(
name|GET_CODE
argument_list|(
...
block|,
name|dw_val_class_section_offset
block|,
...
parameter_list|)
define|\
value|do {									      \       if ((NAME)[0] == '*')						      \ 	dyn_string_append (STR, NAME + 1);				      \       else								      \ 	dyn_string_append (STR, NAME);                                        \   }                                                                           \   while (0)
end_define
...
argument_list|)
expr_stmt|;
comment|/* Set the address register to the first location in the text section */
name|ASM_OUTPUT_DWARF_DATA1
argument_list|(
name|asm_out_file
argument_list|,
