...
begin_comment
comment|/* Functions in postreload.c:  */
end_comment
...
begin_comment
comment|/* Compute the actual register we should reload to, in case we're    reloading to/from a register that is wider than a word.  */
end_comment
