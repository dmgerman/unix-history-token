...
operator|==
name|INTEGER_CST
comment|/* ???  We somehow can end up here with 		  (unsigned int)1 == 1 ? 1U : 2U 		 for which we won't make any progress but recurse 		 indefinitely.  Just stop here in this case.  */
operator|&&
name|TREE_CODE
argument_list|(
name|arg1
