...
begin_comment
comment|/* A target can do some update context frobbing.  */
end_comment
...
name|target_cfa
decl_stmt|;
comment|/* If the last frame records a saved stack pointer, use it.  */
if|if
condition|(
name|_Unwind_GetGRPtr
argument_list|(
