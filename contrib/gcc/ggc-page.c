...
begin_comment
comment|/* "Bag-of-pages" garbage collector for the GNU compiler.    Copyright (C) 1999, 2000, 2001, 2002, 2003 Free Software Foundation, Inc.  This file is part of GCC.  GCC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GCC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GCC; see the file COPYING.  If not, write to the Free Software Foundation, 59 Temple Place - Suite 330, Boston, MA 02111-1307, USA.  */
end_comment
...
literal|1
expr_stmt|;
comment|/* The G.depth array is shortened so that the last index is the      context_depth of the top element of by_depth.  */
if|if
condition|(
name|depth
operator|+
...
name|size
decl_stmt|;
comment|/* To speed small writes, we use a nulled-out array that's larger          than most padding requests as the source for our null bytes.  This          permits us to do the padding with fwrite() rather than fseek(), and          limits the chance the the OS may try to flush any outstanding          writes.  */
if|if
condition|(
name|padding
operator|<=
