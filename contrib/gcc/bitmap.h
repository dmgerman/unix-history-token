...
begin_comment
comment|/* Allocate a bitmap with alloca.  */
end_comment
...
parameter_list|()
define|\
value|bitmap_initialize ((bitmap) alloca (sizeof (bitmap_head)))
end_define
