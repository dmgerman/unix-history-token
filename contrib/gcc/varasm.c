...
begin_comment
comment|/* Make a copy of the whole tree structure for a constant.  This    handles the same types of nodes that compare_constant handles.    Writable string constants are never copied.  */
end_comment
...
begin_comment
comment|/* Some targets do not allow a forward or undefined reference in a    ASM_OUTPUT_DEF.  Thus, a mechanism is needed to defer the output    of this assembler code.  The output_def_pair struct holds the    declaration and target for a deferred output define.  */
end_comment

begin_decl_stmt
name|struct
name|output_def_pair
name|GTY
argument_list|(
operator|(
operator|)
...
begin_comment
comment|/* Variable array of deferred output defines.  */
end_comment
...
name|GTY
argument_list|(
argument|(param_is (struct output_def_pair))
argument_list|)
name|varray_type
name|output_defs
expr_stmt|;
...
begin_comment
comment|/* Process the varray of pending assembler defines.  */
end_comment
