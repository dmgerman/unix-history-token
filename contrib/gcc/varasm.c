...
name|di
struct|;
comment|/* The max vector size we have is 8 wide.  This should be enough.  */
name|HOST_WIDE_INT
name|veclo
index|[
literal|16
...
condition|)
block|{
comment|/* Take care not to invoque ENCODE_SECTION_INFO for constants 	 which don't have a TREE_CST_RTL.  */
if|if
condition|(
name|TREE_CODE
argument_list|(
