...
begin_comment
comment|/* Any weak symbol declarations waiting to be emitted.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* Don't warn about an identifier name length clash on this name, since      it can be a user symbol suffixed by a number.  */
name|warn_id_clash
operator|=
literal|0
expr_stmt|;
...
name|warning
argument_list|(
literal|"alias definitions not supported in this configuration"
argument_list|)
expr_stmt|;
endif|#
directive|endif
