...
directive|if
name|USE_CPPLIB
literal|"%{E|M|MM:cpp0 -lang-c %{ansi:-std=c89} %{std*} %{nostdinc*}\ 	%{C} %{v} %{A*} %{I*} %{P} %{$} %I\ 	%{C:%{!E:%eGNU C does not support -C without using -E}}\ 	%{M} %{MM} %{MD:-MD %b.d} %{MMD:-MMD %b.d} %{MG}\         %{!no-gcc:-D__GNUC__=%v1 -D__GNUC_MINOR__=%v2}\ 	%{ansi|std=*:%{!std=gnu*:-trigraphs -D__STRICT_ANSI__}}\ 	%{!undef:%{!ansi:%{!std=*:%p}%{std=gnu*:%p}} %P} %{trigraphs}\         %c %{Os:-D__OPTIMIZE_SIZE__} %{O*:%{!O0:-D__OPTIMIZE__}}\ 	%{ffast-math:-D__FAST_MATH__}\         %{traditional} %{ftraditional:-traditional}\         %{traditional-cpp:-traditional}\ 	%{fleading-underscore} %{fno-leading-underscore}\ 	%{g*} %{W*} %{w} %{pedantic*} %{H} %{d*} %C %{D*} %{U*} %{i*} %Z\         %i %{E:%W{o*}}%{M:%W{o*}}%{MM:%W{o*}}\n}\       %{!E:%{!M:%{!MM:cc1 %i %1 \                   %{std*} %{nostdinc*} %{A*} %{I*} %I\                   %{!Q:-quiet} -dumpbase %b.c %{d*} %{m*} %{a*}\                   %{MD:-MD %b.d} %{MMD:-MMD %b.d} %{MG}\                   %{!no-gcc:-D__GNUC__=%v1 -D__GNUC_MINOR__=%v2}\ 		  %{ansi|std=*:%{!std=gnu*:-trigraphs -D__STRICT_ANSI__}}\ 		  %{!undef:%{!ansi:%{!std=*:%p}%{std=gnu*:%p}} %P} %{trigraphs}\                   %c %{Os:-D__OPTIMIZE_SIZE__} %{O*:%{!O0:-D__OPTIMIZE__}}\ 		  %{ffast-math:-D__FAST_MATH__}\                   %{H} %C %{D*} %{U*} %{i*} %Z\                   %{ftraditional:-traditional}\                   %{traditional-cpp:-traditional}\ 		  %{traditional} %{v:-version} %{pg:-p} %{p} %{f*}\ 		  %{aux-info*} %{Qn:-fno-ident}\ 		  %{--help:--help}\ 		  %{g*} %{O*} %{W*} %{w} %{pedantic*}\ 		  %{pg:%{fomit-frame-pointer:%e-pg and -fomit-frame-pointer are incompatible}}\ 		  %{S:%W{o*}%{!o*:-o %b.s}}%{!S:-o %{|!pipe:%g.s}} |\n\                   %{!S:as %a %Y\ 		     %{c:%W{o*}%{!o*:-o %w%b%O}}%{!c:-o %d%w%u%O}\                      %{!pipe:%g.s} %A\n }}}}"
else|#
directive|else
comment|/* ! USE_CPPLIB */
literal|"cpp0 -lang-c %{ansi:-std=c89} %{std*} %{nostdinc*}\ 	%{C} %{v} %{A*} %{I*} %{P} %{$} %I\ 	%{C:%{!E:%eGNU C does not support -C without using -E}}\ 	%{M} %{MM} %{MD:-MD %b.d} %{MMD:-MMD %b.d} %{MG}\         %{!no-gcc:-D__GNUC__=%v1 -D__GNUC_MINOR__=%v2}\ 	%{ansi|std=*:%{!std=gnu*:-trigraphs -D__STRICT_ANSI__}}\ 	%{!undef:%{!ansi:%{!std=*:%p}%{std=gnu*:%p}} %P} %{trigraphs}\         %c %{Os:-D__OPTIMIZE_SIZE__} %{O*:%{!O0:-D__OPTIMIZE__}}\ 	%{ffast-math:-D__FAST_MATH__}\         %{traditional} %{ftraditional:-traditional}\         %{traditional-cpp:-traditional}\ 	%{fleading-underscore} %{fno-leading-underscore}\ 	%{g*} %{W*} %{w} %{pedantic*} %{H} %{d*} %C %{D*} %{U*} %{i*} %Z\         %i %{!M:%{!MM:%{!E:%{!pipe:%g.i}}}}%{E:%W{o*}}%{M:%W{o*}}%{MM:%W{o*}} |\n"
block|,
literal|"%{!M:%{!MM:%{!E:cc1 %{!pipe:%g.i} %1 \ 		   %{!Q:-quiet} -dumpbase %b.c %{d*} %{m*} %{a*}\ 		   %{g*} %{O*} %{W*} %{w} %{pedantic*} %{std*}\ 		   %{traditional} %{v:-version} %{pg:-p} %{p} %{f*}\ 		   %{aux-info*} %{Qn:-fno-ident}\ 		   %{--help:--help} \ 		   %{pg:%{fomit-frame-pointer:%e-pg and -fomit-frame-pointer are incompatible}}\ 		   %{S:%W{o*}%{!o*:-o %b.s}}%{!S:-o %{|!pipe:%g.s}} |\n\               %{!S:as %a %Y\ 		      %{c:%W{o*}%{!o*:-o %w%b%O}}%{!c:-o %d%w%u%O}\                       %{!pipe:%g.s} %A\n }}}}"
endif|#
directive|endif
comment|/* ! USE_CPPLIB */
block|}
...
block|,
block|{
literal|"%{E:cpp0 -lang-c %{ansi:-std=c89} %{std*} %{nostdinc*}\ 	%{C} %{v} %{A*} %{I*} %{P} %{$} %I\ 	%{C:%{!E:%eGNU C does not support -C without using -E}}\ 	%{M} %{MM} %{MD:-MD %b.d} %{MMD:-MMD %b.d} %{MG}\         %{!no-gcc:-D__GNUC__=%v1 -D__GNUC_MINOR__=%v2}\ 	%{ansi|std=*:%{!std=gnu*:-trigraphs -D__STRICT_ANSI__}}\ 	%{!undef:%{!ansi:%{!std=*:%p}%{std=gnu*:%p}} %P} %{trigraphs}\         %c %{Os:-D__OPTIMIZE_SIZE__} %{O*:%{!O0:-D__OPTIMIZE__}}\ 	%{ffast-math:-D__FAST_MATH__}\         %{traditional} %{ftraditional:-traditional}\         %{traditional-cpp:-traditional}\ 	%{fleading-underscore} %{fno-leading-underscore}\ 	%{g*} %{W*} %{w} %{pedantic*} %{H} %{d*} %C %{D*} %{U*} %{i*} %Z\         %i %W{o*}}\     %{!E:%e-E required when input is from standard input}"
block|}
block|}
block|,
block|{
...
block|,
block|{
literal|"%{!M:%{!MM:%{!E:cc1 %i %1 %{!Q:-quiet} %{d*} %{m*} %{a*}\ 			%{g*} %{O*} %{W*} %{w} %{pedantic*} %{std*}\ 			%{traditional} %{v:-version} %{pg:-p} %{p} %{f*}\ 			%{aux-info*} %{Qn:-fno-ident}\ 			%{pg:%{fomit-frame-pointer:%e-pg and -fomit-frame-pointer are incompatible}}\ 			%{S:%W{o*}%{!o*:-o %b.s}}%{!S:-o %{|!pipe:%g.s}} |\n\ 		     %{!S:as %a %Y\ 			     %{c:%W{o*}%{!o*:-o %w%b%O}}%{!c:-o %d%w%u%O}\ 			     %{!pipe:%g.s} %A\n }}}}"
block|}
block|}
block|,
block|{
...
begin_comment
comment|/* Provide option to override link_command_spec from machine specific    configuration files.  */
end_comment
...
name|link_command_spec
init|=
literal|"\ %{!fsyntax-only: \  %{!c:%{!M:%{!MM:%{!E:%{!S:%(linker) %l %X %{o*} %{A} %{d} %{e*} %{m} %{N} %{n} \ 			%{r} %{s} %{t} %{u*} %{x} %{z} %{Z}\ 			%{!A:%{!nostdlib:%{!nostartfiles:%S}}}\ 			%{static:} %{L*} %o\ 			%{!nostdlib:%{!nodefaultlibs:%G %L %G}}\ 			%{!A:%{!nostdlib:%{!nostartfiles:%E}}}\ 			%{T*}\ 			\n }}}}}}"
decl_stmt|;
end_decl_stmt
...
name|link_command_spec
init|=
literal|"\ %{!fsyntax-only: \  %{!c:%{!M:%{!MM:%{!E:%{!S:%(linker) %l %X %{o*} %{A} %{d} %{e*} %{m} %{N} %{n} \ 			%{r} %{s} %{t} %{u*} %{x} %{z} %{Z}\ 			%{!A:%{!nostdlib:%{!nostartfiles:%S}}}\ 			%{static:} %{L*} %D %o\ 			%{!nostdlib:%{!nodefaultlibs:%G %L %G}}\ 			%{!A:%{!nostdlib:%{!nostartfiles:%E}}}\ 			%{T*}\ 			\n }}}}}}"
decl_stmt|;
end_decl_stmt
...
parameter_list|)
define|\
value|{ NAME, NULL_PTR, PTR, (struct spec_list *)0, sizeof (NAME)-1, 0 }
end_define
...
begin_comment
comment|/* We want this on by default all the time now.  */
end_comment
...
begin_comment
comment|/* This is the list of suffixes and codes (%g/%u/%U) and the associated    temp file.  */
end_comment
...
name|error
argument_list|(
literal|"file path prefix `%s%s' never used"
argument_list|,
name|pl
operator|->
name|prefix
...
begin_comment
comment|/* Convert NAME to a new name if it is the standard suffix.  DO_EXE    is true if we should look for an executable suffix as well.  */
end_comment
...
name|printf
argument_list|(
literal|"                            multiple library search directories\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
...
name|printf
argument_list|(
literal|"  -specs=<file>            Override builtin specs with the contents of<file>\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
...
name|printf
argument_list|(
literal|"                            Permissable languages include: c c++ assembler none\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"                            'none' means revert to the default behaviour of\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"                            guessing the language based on the file's extension\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
...
name|printf
argument_list|(
literal|"the various sub-processes invoked by %s.  In order to pass other options\n"
argument_list|,
name|programname
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"on to these processes the -W<letter> options must be used.\n"
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|/* Create a dummy input file, so that we can pass --help on to 		 the various sub-processes.  */
name|infiles
index|[
name|n_infiles
index|]
...
literal|"help-dummy"
expr_stmt|;
comment|/* Preserve the --help switch so that it can be caught by the 		 cc1 spec string.  */
name|switches
index|[
name|n_switches
index|]
...
name|error
argument_list|(
literal|"Warning: -pipe ignored since -save-temps specified"
argument_list|)
expr_stmt|;
elseif|else
if|if
...
block|add_prefix (&startfile_prefixes, "./", NULL_PTR, 0, 1, NULL_PTR);
endif|#
directive|endif
block|}
else|else
...
expr_stmt|;
block|}
comment|/* We do not exit here.  Instead we have created a fake input file 	 called 'help-dummy' which needs to be compiled, and we pass this 	 on the the various sub-processes, along with the --help switch.  */
block|}
if|if
condition|(
name|verbose_flag
