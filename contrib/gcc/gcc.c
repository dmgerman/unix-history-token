...
begin_comment
comment|/* ??? Need to find a GCC header to put these in.  */
end_comment
...
block|,
literal|"%{!M:%{!MM:%{!E:cc1 %{!pipe:%g.i} %1 \ 		   %{!Q:-quiet} -dumpbase %b.c %{d*} %{m*} %{a*}\ 		   %{g*} %{O*} %{W*} %{w} %{pedantic*} %{ansi} \ 		   %{traditional} %{v:-version} %{pg:-p} %{p} %{f*}\ 		   %{aux-info*}\ 		   %{--help:--help} \ 		   %{pg:%{fomit-frame-pointer:%e-pg and -fomit-frame-pointer are incompatible}}\ 		   %{S:%W{o*}%{!o*:-o %b.s}}%{!S:-o %{|!pipe:%g.s}} |\n\               %{!S:as %a %Y\ 		      %{c:%W{o*}%{!o*:-o %w%b%O}}%{!c:-o %d%w%u%O}\                       %{!pipe:%g.s} %A\n }}}}"
block|}
end_decl_stmt
...
name|fatal
argument_list|(
literal|"specs %%include syntax malformed after %d characters"
argument_list|,
name|p1
operator|-
name|buffer
...
name|fatal
argument_list|(
literal|"specs %%rename syntax malformed after %d characters"
argument_list|,
name|p1
operator|-
name|buffer
...
name|fatal
argument_list|(
literal|"specs unknown %% command after %d characters"
argument_list|,
name|p1
operator|-
name|buffer
...
name|printf
argument_list|(
literal|"Please see the file BUGS (included with the sources) first.\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
...
begin_comment
comment|/* This function is based on the one in libiberty.  */
end_comment
