...
begin_comment
comment|/* Copyright (C) 1997, 1999, 2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007    Free Software Foundation, Inc.  This file is part of GCC.  GCC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GCC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GCC; see the file COPYING.  If not, write to the Free Software Foundation, 51 Franklin Street, Fifth Floor, Boston, MA 02110-1301, USA.  */
end_comment
...
parameter_list|)
define|\
value|static __typeof(type) name __attribute__ ((__weakref__(#name2))); \   __gthrw_pragma(weak type)
end_define
...
begin_comment
comment|/* Typically, __gthrw_foo is a weak reference to symbol foo.  */
end_comment
...
name|name
parameter_list|)
value|__gthrw2(__gthrw_ ## name,name,name)
end_define

begin_comment
comment|/* On Tru64, /usr/include/pthread.h uses #pragma extern_prefix "__" to    map a subset of the POSIX pthread API to mangled versions of their    names.  */
end_comment
...
name|defined
argument_list|(
name|_PTHREAD_USE_MANGLED_NAMES_
argument_list|)
end_if
...
name|name
parameter_list|)
value|__gthrw2(__gthrw_ ## name, __ ## name, name)
end_define
...
begin_comment
comment|/* __osf__&& _PTHREAD_USE_MANGLED_NAMES_ */
end_comment
