...
comment|/* word */
value|\   TK(CPP_AT_NAME,       SPELL_IDENT)
comment|/* @word - Objective-C */
value|\   TK(CPP_NUMBER,	SPELL_LITERAL)
comment|/* 34_be+ta  */
value|\ \   TK(CPP_CHAR,		SPELL_LITERAL)
comment|/* 'char' */
value|\   TK(CPP_WCHAR,		SPELL_LITERAL)
comment|/* L'char' */
value|\   TK(CPP_OTHER,		SPELL_LITERAL)
comment|/* stray punctuation */
value|\ \   TK(CPP_STRING,	SPELL_LITERAL)
comment|/* "string" */
value|\   TK(CPP_WSTRING,	SPELL_LITERAL)
comment|/* L"string" */
value|\   TK(CPP_OBJC_STRING,   SPELL_LITERAL)
comment|/* @"string" - Objective-C */
value|\   TK(CPP_HEADER_NAME,	SPELL_LITERAL)
comment|/*<stdio.h> in #include */
value|\ \   TK(CPP_COMMENT,	SPELL_LITERAL)
