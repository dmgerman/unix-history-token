...
begin_comment
comment|/* Expands front end tree to back end RTL for GNU C-Compiler    Copyright (C) 1987, 88, 89, 91-97, 1998 Free Software Foundation, Inc.  /* $FreeBSD$ */
end_comment
...
begin_for
for|for more details.  You should have received a copy of the GNU General Public License along with GNU CC
empty_stmt|;
end_for
