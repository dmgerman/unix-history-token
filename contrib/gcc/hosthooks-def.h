...
define|\
value|default_gt_pch_alloc_granularity
end_define
...
specifier|extern
name|size_t
name|default_gt_pch_alloc_granularity
parameter_list|(
name|void
parameter_list|)
function_decl|;
...
value|{		\   HOST_HOOKS_EXTRA_SIGNALS,			\   HOST_HOOKS_GT_PCH_GET_ADDRESS,		\   HOST_HOOKS_GT_PCH_USE_ADDRESS,		\   HOST_HOOKS_GT_PCH_ALLOC_GRANULARITY		\ }
end_define
