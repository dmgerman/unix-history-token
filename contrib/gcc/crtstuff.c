...
begin_comment
comment|/* This really belongs in gansidecl.h, but for the egcs-1.1.x branch, the    only code which uses weak attributes is in this file and this file does    not include gansidecl.h.  */
end_comment
