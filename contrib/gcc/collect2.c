...
begin_comment
comment|/* Collect static initialization info into data structures that can be    traversed by C++ initialization and finalization routines.    Copyright (C) 1992, 1993, 1994, 1995, 1996, 1997, 1998,    1999, 2000, 2001, 2002 Free Software Foundation, Inc.    Contributed by Chris Smith (csmith@convex.com).    Heavily modified by Michael Meissner (meissner@cygnus.com),    Per Bothner (bothner@cygnus.com), and John Gilmore (gnu@cygnus.com).  This file is part of GCC.  GCC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GCC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GCC; see the file COPYING.  If not, write to the Free Software Foundation, 59 Temple Place - Suite 330, Boston, MA 02111-1307, USA.  */
end_comment
...
begin_comment
comment|/* possible library extensions */
end_comment
...
begin_endif
unit|static void dump_prefix_list	PARAMS ((FILE *, const char *, struct prefix_list *));
endif|#
directive|endif
end_endif
...
begin_endif
unit|static int is_in_list		PARAMS ((const char *, struct id *));
endif|#
directive|endif
end_endif
...
begin_endif
unit|static int is_in_list (prefix, list)      const char *prefix;      struct id *list; {   while (list)     {       if (!strcmp (prefix, list->name)) return 1;       list = list->next;     }     return 0; }
endif|#
directive|endif
end_endif
...
begin_endif
unit|static void dump_prefix_list (stream, prefix, list)      FILE *stream;      const char *prefix;      struct prefix_list *list; {   while (list)     {       fprintf (stream, "%s%s,\n", prefix, list->prefix);       list = list->next;     } }
endif|#
directive|endif
end_endif
...
literal|1
return|;
comment|/* It has an invalid numeric extension, must prefer the other one.  */
else|else
return|return
operator|-
literal|1
...
directive|ifdef
name|COLLECT_EXPORT_LIST
comment|/* If we are building a shared object on AIX we need 			     to explicitly export all global symbols.  */
if|if
condition|(
name|shared_obj
condition|)
