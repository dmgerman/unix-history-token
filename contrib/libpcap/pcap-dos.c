...
name|errbuf
argument_list|,
literal|"Not enough memory (pcap)"
argument_list|)
expr_stmt|;
return|return
operator|(
...
name|errbuf
argument_list|,
literal|"pcap_open_offline() or pcap_open_live() must be "
...
begin_comment
comment|/*  * Open the pcap device for the first client calling pcap_open_live()  */
end_comment
