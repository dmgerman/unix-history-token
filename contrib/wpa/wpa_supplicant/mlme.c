...
name|MSG_DEBUG
argument_list|,
literal|"MLME: WMM aci=%d acm=%d aifs=%d "
literal|"cWmin=%d cWmax=%d burst=%d"
argument_list|,
name|aci
argument_list|,
name|acm
...
argument_list|)
expr_stmt|;
comment|/* TODO: driver configuration */
block|}
block|}
end_function
...
condition|)
block|{
comment|/* Build simple RIC-Request: RDIE | TSPEC */
comment|/* RIC Data (RDIE) */
name|wpabuf_put_u8
argument_list|(
name|ric
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* Resource Descriptor 							* Count */
...
name|MSG_DEBUG
argument_list|,
literal|"MLME: Send ADDTS Request for Voice TSPEC"
argument_list|)
expr_stmt|;
name|mgmt
operator|=
...
condition|)
block|{
comment|/* Test WMM-AC - send ADDTS for WMM TSPEC */
name|ieee80211_tx_addts
argument_list|(
name|wpa_s
argument_list|)
...
name|MSG_DEBUG
argument_list|,
literal|"WMM: Medium Time: %u (= %u usec/sec)"
argument_list|,
name|val
argument_list|,
literal|32
...
name|MSG_DEBUG
argument_list|,
literal|"WMM: Received ADDTS Response"
argument_list|)
expr_stmt|;
name|wpa_hexdump
argument_list|(
name|MSG_MSGDUMP
argument_list|,
literal|"WMM: ADDTS Response IE(s)"
argument_list|,
name|mgmt
operator|->
name|u
...
specifier|static
name|void
name|ieee80211_rx_mgmt_wmm_action
parameter_list|(
name|struct
name|wpa_supplicant
modifier|*
...
name|MSG_DEBUG
argument_list|,
literal|"WMM: Received Action frame too short"
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|MSG_DEBUG
argument_list|,
literal|"WMM: Received Action frame: Action Code %d, "
literal|"Dialog Token %d, Status Code %d"
argument_list|,
name|mgmt
operator|->
name|u
...
name|MSG_DEBUG
argument_list|,
literal|"WMM: Unsupported Action Code %d"
argument_list|,
name|mgmt
operator|->
name|u
...
begin_endif
unit|for (i = 0; i< local->num_curr_rates; i++) { 		int rate = local->curr_rates[i]; 		if (local->conf.phymode == MODE_ATHEROS_TURBO) 			rate /= 2; 		*pos++ = (u8) (rate / 5); 	}
endif|#
directive|endif
end_endif
