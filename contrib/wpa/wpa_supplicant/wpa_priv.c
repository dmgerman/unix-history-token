...
name|MSG_INFO
argument_list|,
literal|"Failed to initialize driver global context"
argument_list|)
expr_stmt|;
return|return;
block|}
...
specifier|static
name|void
name|wpa_priv_cmd_authenticate
parameter_list|(
name|struct
name|wpa_priv_interface
modifier|*
...
name|MSG_DEBUG
argument_list|,
literal|"Invalid authentication request"
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|MSG_DEBUG
argument_list|,
literal|"Authentication request overflow"
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|MSG_DEBUG
argument_list|,
literal|"drv->authenticate: res=%d"
argument_list|,
name|res
argument_list|)
expr_stmt|;
...
name|fail
goto|;
comment|/* For now, no support for passing extended_capa pointers */
name|capa
operator|.
name|extended_capa
operator|=
...
name|MSG_DEBUG
argument_list|,
literal|"Unsupported driver event %d (%s) - TODO"
argument_list|,
name|event
argument_list|,
...
literal|"\n"
literal|"usage:\n"
literal|"  wpa_priv [-Bdd] [-c<ctrl dir>] [-P<pid file>] "
