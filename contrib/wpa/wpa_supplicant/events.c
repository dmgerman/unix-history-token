...
begin_comment
comment|/*  * WPA Supplicant - Driver event processing  * Copyright (c) 2003-2010, Jouni Malinen<j@w1.fi>  *  * This program is free software; you can redistribute it and/or modify  * it under the terms of the GNU General Public License version 2 as  * published by the Free Software Foundation.  *  * Alternatively, this software may be distributed under the terms of BSD  * license.  *  * See README and COPYING for more details.  */
end_comment
...
name|MSG_DEBUG
argument_list|,
literal|"Already associated with the selected "
literal|"AP"
argument_list|)
expr_stmt|;
block|}
...
name|MSG_DEBUG
argument_list|,
literal|"Allow reassociation - selected BSS has "
literal|"preferred BSSID"
argument_list|)
expr_stmt|;
return|return
literal|1
...
name|MSG_DEBUG
argument_list|,
literal|"Skip roam - too small difference in "
...
name|MSG_DEBUG
argument_list|,
literal|"SME: Allow pending authentication to "
literal|"proceed after disconnection event"
argument_list|)
expr_stmt|;
name|wpa_supplicant_set_state
argument_list|(
