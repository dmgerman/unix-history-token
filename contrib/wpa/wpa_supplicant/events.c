...
name|MACSTR
literal|" ssid='%s' "
literal|"wpa_ie_len=%u rsn_ie_len=%u caps=0x%x level=%d%s%s%s"
argument_list|,
name|i
argument_list|,
name|MAC2STR
...
argument_list|)
expr_stmt|;
comment|/* 	 * Check other interfaces to see if they share the same radio. If 	 * so, they get updated with this same hw mode info. 	 */
name|dl_list_for_each
argument_list|(
argument|ifs
argument_list|,
...
name|MSG_DEBUG
argument_list|,
literal|"P2P GO operating frequency %d MHz in safe range"
argument_list|,
name|freq
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"P2P GO operating in unsafe frequency %d MHz"
argument_list|,
name|freq
argument_list|)
expr_stmt|;
