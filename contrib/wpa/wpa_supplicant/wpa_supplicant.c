...
name|VERSION_STR
literal|"\n"
literal|"Copyright (c) 2003-2010, Jouni Malinen<j@w1.fi> and contributors"
decl_stmt|;
end_decl_stmt
...
name|MSG_ERROR
argument_list|,
literal|"AP mode support not included in the "
literal|"build"
argument_list|)
expr_stmt|;
endif|#
...
literal|"interface - try next driver wrapper"
argument_list|)
expr_stmt|;
name|driver
operator|=
