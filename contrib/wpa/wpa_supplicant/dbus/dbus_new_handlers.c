...
begin_comment
comment|/*  * WPA Supplicant / dbus-based control interface  * Copyright (c) 2006, Dan Williams<dcbw@redhat.com> and Red Hat, Inc.  * Copyright (c) 2009-2010, Witold Sowa<witold.sowa@gmail.com>  * Copyright (c) 2009-2015, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
begin_comment
comment|/**  * wpas_dbus_error_unknown_error - Return a new UnknownError error message  * @message: Pointer to incoming dbus message this error refers to  * @arg: Optional string appended to error message  * Returns: a dbus error message  *  * Convenience function to create and return an UnknownError  */
end_comment
...
name|WPAS_DBUS_ERROR_NETWORK_UNKNOWN
argument_list|,
literal|"There is no such a network in this interface."
argument_list|)
return|;
block|}
end_function
...
begin_comment
comment|/**  * wpas_dbus_error_scan_error - Return a new ScanError error message  * @message: Pointer to incoming dbus message this error refers to  * @error: Optional string to be used as the error message  * Returns: a dbus error message  *  * Convenience function to create and return a scan error  */
end_comment
...
name|DBusMessage
modifier|*
name|wpas_dbus_error_scan_error
parameter_list|(
name|DBusMessage
modifier|*
name|message
...
name|MSG_DEBUG
argument_list|,
literal|"dbus: Failed to allocate memory"
argument_list|)
expr_stmt|;
return|return
name|dbus_message_new_error
...
name|DBUS_ERROR_FAILED
argument_list|,
literal|"%s: failed to construct message"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|DBUS_ERROR_FAILED
argument_list|,
literal|"%s: failed to construct message 2.5"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|DBUS_ERROR_FAILED
argument_list|,
literal|"%s: failed to close message"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"%s[dbus]: Type must be a string"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"%s[dbus]: ssids must be an array of arrays of bytes"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|message
argument_list|,
literal|"Wrong SSIDs value type. Array of arrays of bytes required"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|MSG_DEBUG
argument_list|,
literal|"%s[dbus]: Too many ssids specified on scan dbus call"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|message
argument_list|,
literal|"Too many ssids specified. Specify at most four"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|MSG_DEBUG
argument_list|,
literal|"%s[dbus]: SSID too long (len=%d max_len=%d)"
argument_list|,
name|__func__
argument_list|,
name|len
...
name|MSG_DEBUG
argument_list|,
literal|"%s[dbus]: ies must be an array of arrays of bytes"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|message
argument_list|,
literal|"Wrong IEs value type. Array of arrays of bytes required"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|MSG_DEBUG
argument_list|,
literal|"%s[dbus]: Channels must be an array of structs"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|message
argument_list|,
literal|"Wrong Channels value type. Array of structs required"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|MSG_DEBUG
argument_list|,
literal|"%s[dbus]: Channel must by specified by struct of two UINT32s %c"
argument_list|,
name|__func__
argument_list|,
name|dbus_message_iter_get_arg_type
...
name|MSG_DEBUG
argument_list|,
literal|"%s[dbus]: Channel must by specified by struct of two UINT32s"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
specifier|static
name|int
name|wpas_dbus_get_scan_allow_roam
parameter_list|(
name|DBusMessage
modifier|*
name|message
...
name|MSG_DEBUG
argument_list|,
literal|"%s[dbus]: Type must be a boolean"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|message
argument_list|,
literal|"Wrong Type value type. Boolean required"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|MSG_DEBUG
argument_list|,
literal|"%s[dbus]: Unknown argument %s"
argument_list|,
name|__func__
argument_list|,
name|key
...
name|MSG_DEBUG
argument_list|,
literal|"%s[dbus]: Scan type not specified"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"%s[dbus]: SSIDs or IEs specified for passive scan."
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|message
argument_list|,
literal|"You can specify only Channels in passive scan"
argument_list|)
expr_stmt|;
goto|goto
name|out
...
name|MSG_DEBUG
argument_list|,
literal|"%s[dbus]: Stop ongoing sched_scan to allow requested scan to proceed"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"%s[dbus]: Unknown scan type: %s"
argument_list|,
name|__func__
argument_list|,
name|type
...
begin_comment
comment|/**  * wpas_dbus_handler_signal_poll - Request immediate signal properties  * @message: Pointer to incoming dbus message  * @wpa_s: wpa_supplicant structure for a network interface  * Returns: NULL indicating success or DBus error message on failure  *  * Handler function for "SignalPoll" method call of a network device. Requests  * that wpa_supplicant read signal properties like RSSI, noise, and link  * speed and return them.  */
end_comment

begin_function
name|DBusMessage
modifier|*
name|wpas_dbus_handler_signal_poll
parameter_list|(
name|DBusMessage
modifier|*
name|message
...
name|MSG_ERROR
argument_list|,
literal|"%s[dbus]: can't add new interface."
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"%s[dbus]: control interface couldn't set network properties"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
begin_comment
comment|/**  * wpas_dbus_handler_reassociate - Reassociate  * @message: Pointer to incoming dbus message  * @wpa_s: wpa_supplicant structure for a network interface  * Returns: InterfaceDisabled DBus error message if disabled  * or NULL otherwise.  *  * Handler function for "Reassociate" method call of network interface.  */
end_comment
...
argument_list|,
literal|"This interface is disabled"
argument_list|)
return|;
block|}
end_function
...
begin_comment
comment|/**  * wpas_dbus_handler_reattach - Reattach to current AP  * @message: Pointer to incoming dbus message  * @wpa_s: wpa_supplicant structure for a network interface  * Returns: NotConnected DBus error message if not connected  * or NULL otherwise.  *  * Handler function for "Reattach" method call of network interface.  */
end_comment

begin_function
name|DBusMessage
modifier|*
name|wpas_dbus_handler_reattach
parameter_list|(
name|DBusMessage
modifier|*
name|message
...
begin_comment
comment|/**  * wpas_dbus_handler_reconnect - Reconnect if disconnected  * @message: Pointer to incoming dbus message  * @wpa_s: wpa_supplicant structure for a network interface  * Returns: InterfaceDisabled DBus error message if disabled  * or NULL otherwise.  *  * Handler function for "Reconnect" method call of network interface.  */
end_comment

begin_function
name|DBusMessage
modifier|*
name|wpas_dbus_handler_reconnect
parameter_list|(
name|DBusMessage
modifier|*
name|message
...
name|MSG_DEBUG
argument_list|,
literal|"Stop ongoing sched_scan to remove network from filters"
argument_list|)
expr_stmt|;
name|wpa_supplicant_cancel_sched_scan
argument_list|(
...
name|MSG_ERROR
argument_list|,
literal|"%s[dbus]: error occurred when removing network %d"
argument_list|,
name|__func__
argument_list|,
name|id
...
name|message
argument_list|,
literal|"error removing the specified network on is interface."
argument_list|)
expr_stmt|;
goto|goto
name|out
...
begin_comment
comment|/*  * wpas_dbus_handler_eap_logoff - IEEE 802.1X EAPOL state machine logoff  * @message: Pointer to incoming dbus message  * @wpa_s: wpa_supplicant structure for a network interface  * Returns: NULL  *  * Handler function for "EAPLogoff" method call of network interface.  */
end_comment

begin_function
name|DBusMessage
modifier|*
name|wpas_dbus_handler_eap_logoff
parameter_list|(
name|DBusMessage
modifier|*
name|message
...
begin_comment
comment|/*  * wpas_dbus_handler_eap_logon - IEEE 802.1X EAPOL state machine logon  * @message: Pointer to incoming dbus message  * @wpa_s: wpa_supplicant structure for a network interface  * Returns: NULL  *  * Handler function for "EAPLogin" method call of network interface.  */
end_comment

begin_function
name|DBusMessage
modifier|*
name|wpas_dbus_handler_eap_logon
parameter_list|(
name|DBusMessage
modifier|*
name|message
...
name|message
argument_list|,
literal|"Invalid hardware address format"
argument_list|)
expr_stmt|;
return|return
operator|-
...
begin_comment
comment|/*  * wpas_dbus_handler_tdls_discover - Discover TDLS peer  * @message: Pointer to incoming dbus message  * @wpa_s: wpa_supplicant structure for a network interface  * Returns: NULL indicating success or DBus error message on failure  *  * Handler function for "TDLSDiscover" method call of network interface.  */
end_comment

begin_function
name|DBusMessage
modifier|*
name|wpas_dbus_handler_tdls_discover
parameter_list|(
name|DBusMessage
modifier|*
name|message
...
name|message
argument_list|,
literal|"error performing TDLS discovery"
argument_list|)
return|;
block|}
return|return
...
begin_comment
comment|/*  * wpas_dbus_handler_tdls_setup - Setup TDLS session  * @message: Pointer to incoming dbus message  * @wpa_s: wpa_supplicant structure for a network interface  * Returns: NULL indicating success or DBus error message on failure  *  * Handler function for "TDLSSetup" method call of network interface.  */
end_comment

begin_function
name|DBusMessage
modifier|*
name|wpas_dbus_handler_tdls_setup
parameter_list|(
name|DBusMessage
modifier|*
name|message
...
name|message
argument_list|,
literal|"error performing TDLS setup"
argument_list|)
return|;
block|}
return|return
...
begin_comment
comment|/*  * wpas_dbus_handler_tdls_status - Return TDLS session status  * @message: Pointer to incoming dbus message  * @wpa_s: wpa_supplicant structure for a network interface  * Returns: A string representing the state of the link to this TDLS peer  *  * Handler function for "TDLSStatus" method call of network interface.  */
end_comment

begin_function
name|DBusMessage
modifier|*
name|wpas_dbus_handler_tdls_status
parameter_list|(
name|DBusMessage
modifier|*
name|message
...
begin_comment
comment|/*  * wpas_dbus_handler_tdls_teardown - Teardown TDLS session  * @message: Pointer to incoming dbus message  * @wpa_s: wpa_supplicant structure for a network interface  * Returns: NULL indicating success or DBus error message on failure  *  * Handler function for "TDLSTeardown" method call of network interface.  */
end_comment

begin_function
name|DBusMessage
modifier|*
name|wpas_dbus_handler_tdls_teardown
parameter_list|(
name|DBusMessage
modifier|*
name|message
...
name|message
argument_list|,
literal|"error performing TDLS teardown"
argument_list|)
return|;
block|}
return|return
...
begin_comment
comment|/**  * wpas_dbus_handler_set_pkcs11_engine_and_module_path - Set PKCS #11 engine and module path  * @message: Pointer to incoming dbus message  * @wpa_s: %wpa_supplicant data structure  * Returns: A dbus message containing an error on failure or NULL on success  *  * Sets the PKCS #11 engine and module path.  */
end_comment

begin_function
name|DBusMessage
modifier|*
name|wpas_dbus_handler_set_pkcs11_engine_and_module_path
parameter_list|(
name|DBusMessage
modifier|*
name|message
...
name|DBUS_ERROR_INVALID_ARGS
argument_list|,
literal|"Invalid pkcs11_engine_path argument"
argument_list|)
return|;
block|}
comment|/* Empty path defaults to NULL */
if|if
condition|(
name|os_strlen
argument_list|(
...
name|DBUS_ERROR_INVALID_ARGS
argument_list|,
literal|"Invalid pkcs11_module_path argument"
argument_list|)
return|;
block|}
comment|/* Empty path defaults to NULL */
...
name|DBUS_ERROR_FAILED
argument_list|,
literal|"Reinit of the EAPOL state machine with the new PKCS #11 engine and module path failed."
argument_list|)
return|;
if|if
condition|(
...
name|MSG_DEBUG
argument_list|,
literal|"%s[dbus]: wpa_s has no driver set"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
begin_comment
comment|/**  * wpas_dbus_getter_pkcs11_engine_path - Get PKCS #11 engine path  * @iter: Pointer to incoming dbus message iter  * @error: Location to store error on failure  * @user_data: Function specific data  * Returns: A dbus message containing the PKCS #11 engine path  *  * Getter for "PKCS11EnginePath" property.  */
end_comment

begin_function
name|dbus_bool_t
name|wpas_dbus_getter_pkcs11_engine_path
parameter_list|(
name|DBusMessageIter
modifier|*
name|iter
...
begin_comment
comment|/**  * wpas_dbus_getter_pkcs11_module_path - Get PKCS #11 module path  * @iter: Pointer to incoming dbus message iter  * @error: Location to store error on failure  * @user_data: Function specific data  * Returns: A dbus message containing the PKCS #11 module path  *  * Getter for "PKCS11ModulePath" property.  */
end_comment

begin_function
name|dbus_bool_t
name|wpas_dbus_getter_pkcs11_module_path
parameter_list|(
name|DBusMessageIter
modifier|*
name|iter
...
index|]
decl_stmt|;
comment|/* max 5 pairwise ciphers is supported */
specifier|const
name|char
modifier|*
name|key_mgmt
...
index|]
decl_stmt|;
comment|/* max 9 key managements may be supported */
name|int
name|n
decl_stmt|;
if|if
...
begin_comment
comment|/**  * wpas_dbus_getter_bss_age - Return time in seconds since BSS was last seen  * @iter: Pointer to incoming dbus message iter  * @error: Location to store error on failure  * @user_data: Function specific data  * Returns: TRUE on success, FALSE on failure  *  * Getter for BSS age  */
end_comment

begin_function
name|dbus_bool_t
name|wpas_dbus_getter_bss_age
parameter_list|(
name|DBusMessageIter
modifier|*
name|iter
