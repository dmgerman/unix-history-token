...
argument_list|,
literal|"Did not receive correct message arguments."
argument_list|)
expr_stmt|;
if|if
condition|(
...
argument_list|,
literal|"wpa_supplicant already controls this interface."
argument_list|)
expr_stmt|;
block|}
else|else
...
argument_list|,
literal|"wpa_supplicant couldn't grab this interface."
argument_list|)
expr_stmt|;
block|}
block|}
...
argument_list|,
literal|"wpa_supplicant couldn't remove this interface."
argument_list|)
expr_stmt|;
block|}
name|out
...
argument_list|,
literal|"an internal error occurred returning scan results"
argument_list|)
return|;
block|}
end_function
...
name|WPAS_ERROR_INTERNAL_ERROR
argument_list|,
literal|"an internal error occurred returning BSSID properties."
argument_list|)
expr_stmt|;
block|}
return|return
...
name|WPAS_ERROR_INTERNAL_ERROR
argument_list|,
literal|"an internal error occurred returning interface capabilities."
argument_list|)
return|;
block|}
end_function
...
argument_list|,
literal|"wpa_supplicant could not add a network on this interface."
argument_list|)
expr_stmt|;
goto|goto
name|out
...
argument_list|,
literal|"error removing the specified on this interface."
argument_list|)
expr_stmt|;
goto|goto
name|out
...
name|MSG_ERROR
argument_list|,
literal|"dbus: Not enough memory to return scanning state"
argument_list|)
expr_stmt|;
block|}
return|return
