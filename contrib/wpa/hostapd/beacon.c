...
name|MSG_ERROR
argument_list|,
literal|"Could not set HT capabilities "
...
name|MSG_ERROR
argument_list|,
literal|"Failed to set CTS protect in kernel "
literal|"driver"
argument_list|)
expr_stmt|;
if|if
...
name|MSG_ERROR
argument_list|,
literal|"Failed to set Short Slot Time option "
literal|"in kernel driver"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|MSG_ERROR
argument_list|,
literal|"Could not set preamble for kernel "
literal|"driver"
argument_list|)
expr_stmt|;
block|}
