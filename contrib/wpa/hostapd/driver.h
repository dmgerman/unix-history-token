...
begin_comment
comment|/*  * hostapd - driver interface definition  * Copyright (c) 2002-2007, Jouni Malinen<j@w1.fi>  * Copyright (c) 2007-2008, Intel Corporation  *  * This program is free software; you can redistribute it and/or modify  * it under the terms of the GNU General Public License version 2 as  * published by the Free Software Foundation.  *  * Alternatively, this software may be distributed under the terms of BSD  * license.  *  * See README and COPYING for more details.  */
end_comment
...
parameter_list|)
function_decl|;
comment|/* note: sta_add() is deprecated; use sta_add2() instead */
name|int
function_decl|(
modifier|*
name|sta_add
...
parameter_list|)
function_decl|;
comment|/* note: set_freq() is deprecated; use set_freq2() instead */
name|int
function_decl|(
modifier|*
name|set_freq
...
specifier|inline
name|int
name|hostapd_set_radius_acl_auth
parameter_list|(
name|struct
name|hostapd_data
modifier|*
...
specifier|inline
name|int
name|hostapd_set_radius_acl_expire
parameter_list|(
name|struct
name|hostapd_data
modifier|*
