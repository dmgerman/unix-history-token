...
begin_comment
comment|/*  * hostapd / Configuration file parser  * Copyright (c) 2003-2015, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
name|MSG_ERROR
argument_list|,
literal|"EAP user file in SQLite DB, but CONFIG_SQLITE was not enabled in the build."
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|MSG_ERROR
argument_list|,
literal|"Invalid radius_auth_req_attr: %s"
argument_list|,
name|buf
operator|+
literal|19
...
name|NULL
expr_stmt|;
comment|/* already in the BSS list */
goto|goto
name|failed
goto|;
block|}
...
name|pos
decl_stmt|;
comment|/* for backwards compatibility, translate ' ' in conf str to ',' */
name|pos
operator|=
name|val
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Too many qos_map_set "
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid qos_map_set "
literal|"'%s'"
argument_list|,
name|line
argument_list|,
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid qos_map_set '%s'"
argument_list|,
name|line
argument_list|,
name|buf
...
specifier|static
name|int
name|hs20_parse_osu_server_uri
parameter_list|(
name|struct
name|hostapd_bss_config
modifier|*
...
specifier|static
name|int
name|hs20_parse_osu_friendly_name
parameter_list|(
name|struct
name|hostapd_bss_config
modifier|*
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Unexpected OSU field"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid osu_friendly_name '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
specifier|static
name|int
name|hs20_parse_osu_method_list
parameter_list|(
name|struct
name|hostapd_bss_config
modifier|*
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid osu_method_list"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
specifier|static
name|int
name|hs20_parse_osu_service_desc
parameter_list|(
name|struct
name|hostapd_bss_config
modifier|*
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid osu_service_desc '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
specifier|static
name|int
name|hostapd_config_parse_acs_chan_bias
parameter_list|(
name|struct
name|hostapd_config
modifier|*
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid/unknown driver '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|MSG_DEBUG
argument_list|,
literal|"Line %d: DEPRECATED: 'debug' configuration variable is not used anymore"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_INFO
argument_list|,
literal|"Line %d: DEPRECATED: 'dump_file' configuration variable is not used anymore"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Failed to read accept_mac_file '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Failed to read deny_mac_file '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid EAPOL version (%d): '%s'."
argument_list|,
name|line
argument_list|,
name|bss
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: obsolete eap_authenticator used; this has been renamed to eap_server"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|buf
argument_list|,
literal|"ocsp_stapling_response"
argument_list|)
operator|==
literal|0
condition|)
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: No memory for pac_opaque_encr_key"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid pac_opaque_encr_key"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid eap_fast_a_id"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Failed to parse eap_fast_a_id"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Failed to allocate memory for eap_req_id_text"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid WEP key len %lu (= %lu bits)"
argument_list|,
name|line
argument_list|,
operator|(
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid WEP key len %d (= %d bits)"
argument_list|,
name|line
argument_list|,
name|bss
...
name|buf
argument_list|,
literal|"auth_server_addr_replace"
argument_list|)
operator|==
literal|0
condition|)
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: empty shared secret is not allowed"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|buf
argument_list|,
literal|"acct_server_addr_replace"
argument_list|)
operator|==
literal|0
condition|)
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid radius_auth_req_attr"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid radius_acct_req_attr"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid DAS client"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: no authentication algorithms allowed"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid max_num_sta=%d; allowed range 0..%d"
argument_list|,
name|line
argument_list|,
name|bss
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid WPA passphrase length %d (expected 8..63)"
argument_list|,
name|line
argument_list|,
name|len
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: unknown wpa_psk_radius %d"
argument_list|,
name|line
argument_list|,
name|bss
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: unsupported pairwise cipher suite '%s'"
argument_list|,
name|bss
operator|->
name|wpa_pairwise
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid mobility_domain '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid r1_key_holder '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|MSG_DEBUG
argument_list|,
literal|"ctrl_interface_group=%d (from group name '%s')"
argument_list|,
name|bss
operator|->
name|ctrl_interface_gid
...
name|MSG_DEBUG
argument_list|,
literal|"Line %d: Invalid group '%s'"
argument_list|,
name|line
argument_list|,
name|group
...
name|buf
argument_list|,
literal|"radius_server_acct_port"
argument_list|)
operator|==
literal|0
condition|)
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: unknown wps_rf_band '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: tries to enable ACS but CONFIG_ACS disabled"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid channel list"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid beacon_int %d (expected 15..65535)"
argument_list|,
name|line
argument_list|,
name|val
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid acs_num_scans %d (expected 1..100)"
argument_list|,
name|line
argument_list|,
name|val
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid acs_chan_bias"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|buf
argument_list|,
literal|"bss_load_update_period"
argument_list|)
operator|==
literal|0
condition|)
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid bss_load_update_period %d"
argument_list|,
name|line
argument_list|,
name|bss
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid send_probe_response %d (expected 0 or 1)"
argument_list|,
name|line
argument_list|,
name|val
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: failed to read VLAN file '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid naming scheme %d"
argument_list|,
name|line
argument_list|,
name|bss
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid WMM ac item"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid group_mgmt_cipher: %s"
argument_list|,
name|line
argument_list|,
name|pos
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid assoc_sa_query_max_timeout"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid assoc_sa_query_retry_timeout"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid ht_capab"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid vht_capab"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid wps_state"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Too long manufacturer"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Too long model_name"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Too long model_number"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Too long serial_number"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: could not read Credentials from '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: could not read AP Settings from '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid wps_nfc_dev_pw_id value"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"Line %d: invalid time_zone"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: invalid access_network_type"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid network_auth_type '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid ipaddr_type_availability '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|buf
argument_list|,
literal|"hs20_deauth_req_timeout"
argument_list|)
operator|==
literal|0
condition|)
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid hs20_operating_class '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid hs20_icon '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|buf
argument_list|,
literal|"subscr_remediation_url"
argument_list|)
operator|==
literal|0
condition|)
...
name|buf
argument_list|,
literal|"subscr_remediation_method"
argument_list|)
operator|==
literal|0
condition|)
...
define|#
directive|define
name|PARSE_TEST_PROBABILITY
parameter_list|(
name|_val
parameter_list|)
define|\
value|} else if (os_strcmp(buf, #_val) == 0) {		\ 		char *end;					\ 								\ 		conf->_val = strtod(pos,&end);			\ 		if (*end || conf->_val< 0.0 ||			\ 		    conf->_val> 1.0) {				\ 			wpa_printf(MSG_ERROR,			\ 				   "Line %d: Invalid value '%s'", \ 				   line, pos);			\ 			return 1;				\ 		}
name|PARSE_TEST_PROBABILITY
argument_list|(
argument|ignore_probe_probability
argument_list|)
name|PARSE_TEST_PROBABILITY
argument_list|(
argument|ignore_auth_probability
argument_list|)
name|PARSE_TEST_PROBABILITY
argument_list|(
argument|ignore_assoc_probability
argument_list|)
name|PARSE_TEST_PROBABILITY
argument_list|(
argument|ignore_reassoc_probability
argument_list|)
name|PARSE_TEST_PROBABILITY
argument_list|(
argument|corrupt_gtk_rekey_mic_probability
argument_list|)
block|}
elseif|else
if|if
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid bss_load_test"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid own_ie_override '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid vendor_elements '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|buf
argument_list|,
literal|"sae_anti_clogging_threshold"
argument_list|)
operator|==
literal|0
condition|)
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid sae_groups value '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid local_pwr_constraint %d (expected 0..255)"
argument_list|,
name|line
argument_list|,
name|val
...
name|buf
argument_list|,
literal|"spectrum_mgmt_required"
argument_list|)
operator|==
literal|0
condition|)
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid fst_group_id value '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Duplicate fst_group value '%s'"
argument_list|,
name|line
argument_list|,
name|pos
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: fst_priority value not supplied (expected 1..%u)"
argument_list|,
name|line
argument_list|,
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid fst_priority %ld (%s) (expected 1..%u)"
argument_list|,
name|line
argument_list|,
name|val
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: fst_llt value not supplied (expected 1..%u)"
argument_list|,
name|line
argument_list|,
name|FST_MAX_LLT_MS
...
name|MSG_ERROR
argument_list|,
literal|"Line %d: Invalid fst_llt %ld (%s) (expected 1..%u)"
argument_list|,
name|line
argument_list|,
name|val
...
name|buf
argument_list|,
literal|"no_probe_resp_if_seen_on"
argument_list|)
operator|==
literal|0
condition|)
