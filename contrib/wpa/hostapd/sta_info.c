...
name|MSG_DEBUG
argument_list|,
literal|"Could not get station info "
literal|"from kernel driver for "
name|MACSTR
literal|"."
argument_list|,
name|MAC2STR
...
condition|)
block|{
comment|/* 			 * WLAN_FC_STYPE_NULLFUNC would be more appropriate, 			 * but it is apparently not retried so TX Exc events 			 * are not received for it. 			 */
name|hdr
operator|.
name|frame_control
operator|=
