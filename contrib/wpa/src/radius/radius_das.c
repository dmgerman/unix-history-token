...
begin_comment
comment|/*  * RADIUS Dynamic Authorization Server (DAS) (RFC 5176)  * Copyright (c) 2012-2013, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
name|MSG_INFO
argument_list|,
literal|"DAS: Invalid NAS-IP-Address from %s:%d"
argument_list|,
name|abuf
argument_list|,
name|from_port
...
name|MSG_INFO
argument_list|,
literal|"DAS: Invalid NAS-IPv6-Address from %s:%d"
argument_list|,
name|abuf
argument_list|,
name|from_port
...
name|MSG_INFO
argument_list|,
literal|"DAS: Multiple sessions match for request from %s:%d"
argument_list|,
name|abuf
argument_list|,
name|from_port
