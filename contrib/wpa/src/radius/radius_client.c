...
begin_comment
comment|/*  * RADIUS client  * Copyright (c) 2002-2015, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
specifier|static
name|void
name|radius_client_auth_failover
parameter_list|(
name|struct
name|radius_client_data
modifier|*
...
specifier|static
name|void
name|radius_client_acct_failover
parameter_list|(
name|struct
name|radius_client_data
modifier|*
...
begin_comment
comment|/*  * Returns>0 if message queue was flushed (i.e., the message that triggered  * the error is not available anymore)  */
end_comment
...
name|MSG_INFO
argument_list|,
literal|"RADIUS: No valid socket for retransmission"
argument_list|)
expr_stmt|;
return|return
literal|1
...
name|MSG_INFO
argument_list|,
literal|"RADIUS: Removing un-ACKed message due to too many failed retransmit attempts"
argument_list|)
expr_stmt|;
return|return
literal|1
...
name|MSG_DEBUG
argument_list|,
literal|"RADIUS: Message removed from queue - restart from beginning"
argument_list|)
expr_stmt|;
name|entry
operator|=
...
argument_list|,
literal|"No response from Authentication server %s:%d - failover"
argument_list|,
name|hostapd_ip_txt
argument_list|(
operator|&
...
name|HOSTAPD_LEVEL_NOTICE
argument_list|,
literal|"No response from Accounting server %s:%d - failover"
argument_list|,
name|hostapd_ip_txt
argument_list|(
operator|&
...
name|MSG_INFO
argument_list|,
literal|"RADIUS: Failed to add packet into retransmit list"
argument_list|)
expr_stmt|;
name|radius_msg_free
argument_list|(
...
name|MSG_INFO
argument_list|,
literal|"RADIUS: Removing the oldest un-ACKed packet due to retransmit list limits"
argument_list|)
expr_stmt|;
name|prev
operator|=
...
name|MSG_INFO
argument_list|,
literal|"RADIUS: Possibly too long UDP frame for our buffer - dropping it"
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|MSG_INFO
argument_list|,
literal|"RADIUS: Parsing incoming frame failed"
argument_list|)
expr_stmt|;
name|rconf
operator|->
...
name|MSG_INFO
argument_list|,
literal|"RADIUS: No server socket available (af=%d sock=%d sock6=%d auth=%d"
argument_list|,
name|nserv
operator|->
name|addr
...
name|MSG_DEBUG
argument_list|,
literal|"RADIUS local address: %s:%u"
argument_list|,
name|inet_ntoa
argument_list|(
name|claddr
...
name|MSG_ERROR
argument_list|,
literal|"RADIUS: Failed to set IP_MTU_DISCOVER: %s"
argument_list|,
name|strerror
argument_list|(
name|errno
...
specifier|static
name|void
name|radius_close_auth_sockets
parameter_list|(
name|struct
name|radius_client_data
modifier|*
...
specifier|static
name|void
name|radius_close_acct_sockets
parameter_list|(
name|struct
name|radius_client_data
modifier|*
...
name|MSG_INFO
argument_list|,
literal|"RADIUS: socket[PF_INET,SOCK_DGRAM]: %s"
argument_list|,
name|strerror
argument_list|(
name|errno
...
name|MSG_INFO
argument_list|,
literal|"RADIUS: socket[PF_INET6,SOCK_DGRAM]: %s"
argument_list|,
name|strerror
argument_list|(
name|errno
...
name|MSG_INFO
argument_list|,
literal|"RADIUS: Could not register read socket for authentication server"
argument_list|)
expr_stmt|;
name|radius_close_auth_sockets
argument_list|(
...
name|MSG_INFO
argument_list|,
literal|"RADIUS: Could not register read socket for accounting server"
argument_list|)
expr_stmt|;
name|radius_close_acct_sockets
argument_list|(
