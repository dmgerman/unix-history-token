...
begin_comment
comment|/*  * RADIUS message processing  * Copyright (c) 2002-2009, 2011-2014, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
block|,
literal|"Basic-Location-Policy-Rules"
block|,
name|RADIUS_ATTR_HEXDUMP
block|}
block|,
...
block|,
literal|"Extended-Location-Policy-Rules"
block|,
name|RADIUS_ATTR_HEXDUMP
block|}
block|,
...
block|,
literal|"Requested-Location-Info"
block|,
name|RADIUS_ATTR_INT32
block|}
block|,
...
block|,
literal|"WLAN-Group-Mgmt-Pairwise-Cipher"
block|,
name|RADIUS_ATTR_HEXDUMP
block|}
block|, }
...
name|MSG_INFO
argument_list|,
literal|"Multiple Message-Authenticator attributes in RADIUS message"
argument_list|)
expr_stmt|;
return|return
literal|1
...
name|MSG_DEBUG
argument_list|,
literal|"RADIUS: %s: Len is too small: %d"
argument_list|,
name|__func__
argument_list|,
operator|(
...
name|MSG_INFO
argument_list|,
literal|"RADIUS: Invalid ms key len %lu"
argument_list|,
operator|(
name|unsigned
name|long
...
name|MSG_INFO
argument_list|,
literal|"RADIUS: Failed to decrypt MPPE key"
argument_list|)
expr_stmt|;
name|os_free
argument_list|(
...
name|MSG_DEBUG
argument_list|,
literal|"RADIUS: Failed to decrypt send key"
argument_list|)
expr_stmt|;
block|}
name|os_free
...
name|MSG_DEBUG
argument_list|,
literal|"RADIUS: Failed to decrypt recv key"
argument_list|)
expr_stmt|;
block|}
name|os_free
