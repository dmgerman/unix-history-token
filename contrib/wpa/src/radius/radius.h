...
begin_comment
comment|/*  * hostapd / RADIUS message processing  * Copyright (c) 2002-2007, Jouni Malinen<j@w1.fi>  *  * This program is free software; you can redistribute it and/or modify  * it under the terms of the GNU General Public License version 2 as  * published by the Free Software Foundation.  *  * Alternatively, this software may be distributed under the terms of BSD  * license.  *  * See README and COPYING for more details.  */
end_comment
...
name|attr_pos
decl_stmt|;
comment|/* array of indexes to attributes (number of bytes 			   * from buf to the beginning of 			   * struct radius_attr_hdr). */
name|size_t
name|attr_size
decl_stmt|;
