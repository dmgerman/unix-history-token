...
name|MSG_ERROR
argument_list|,
literal|"wpa_msg_global: Failed to allocate "
literal|"message buffer"
argument_list|)
expr_stmt|;
return|return;
...
name|MSG_ERROR
argument_list|,
literal|"wpa_msg_global_ctrl: Failed to allocate message buffer"
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|MSG_ERROR
argument_list|,
literal|"wpa_msg_no_global: Failed to allocate "
literal|"message buffer"
argument_list|)
expr_stmt|;
return|return;
...
name|MSG_ERROR
argument_list|,
literal|"%s: Failed to allocate message buffer"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
