...
name|MSG_DEBUG
argument_list|,
literal|"SCARD: Invalid AID length %u"
argument_list|,
name|aid_len
argument_list|)
expr_stmt|;
...
begin_comment
comment|/**  * scard_init - Initialize SIM/USIM connection using PC/SC  * @reader: Reader name prefix to search for  * Returns: Pointer to private data structure, or %NULL on failure  *  * This function is used to initialize SIM/USIM connection. PC/SC is used to  * open connection to the SIM/USIM card. In addition, local flag is set if a  * PIN is needed to access some of the card functions. Once the connection is  * not needed anymore, scard_deinit() can be used to close it.  */
end_comment
...
name|MSG_DEBUG
argument_list|,
literal|"SCARD: USIM is not supported. Trying to use GSM SIM"
argument_list|)
expr_stmt|;
name|scard
operator|->
...
name|MSG_DEBUG
argument_list|,
literal|"SCARD: Ignore extra data in end"
argument_list|,
name|pos
argument_list|,
name|end
