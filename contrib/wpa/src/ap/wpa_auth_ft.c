...
begin_comment
comment|/*  * hostapd - IEEE 802.11r - Fast BSS Transition  * Copyright (c) 2004-2015, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
specifier|static
name|int
name|wpa_ft_send_rrb_auth_resp
parameter_list|(
name|struct
...
name|MSG_DEBUG
argument_list|,
literal|"FT: Did not find R0KH-ID"
argument_list|,
name|sm
operator|->
name|r0kh_id
...
name|MSG_DEBUG
argument_list|,
literal|"FT: Callback postponed until response is available"
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|MSG_DEBUG
argument_list|,
literal|"FT: Over-the-DS RX request cb for "
name|MACSTR
argument_list|,
name|MAC2STR
argument_list|(
...
name|MSG_DEBUG
argument_list|,
literal|"FT: No immediate response available - wait for pull response"
argument_list|)
expr_stmt|;
return|return
literal|0
...
name|MSG_DEBUG
argument_list|,
literal|"FT: Postponed auth callback result for "
name|MACSTR
literal|" - status %u"
argument_list|,
name|MAC2STR
...
name|MSG_DEBUG
argument_list|,
literal|"FT: Response to a pending pull request for "
name|MACSTR
literal|" - process from timeout"
argument_list|,
name|MAC2STR
argument_list|(
name|sm
...
name|MSG_DEBUG
argument_list|,
literal|"FT: Look for pending pull request"
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"FT: Ignore extra data in end"
argument_list|,
name|pos
argument_list|,
name|end
