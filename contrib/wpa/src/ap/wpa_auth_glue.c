...
begin_comment
comment|/*  * hostapd / WPA authenticator glue code  * Copyright (c) 2002-2012, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
specifier|static
name|void
name|hostapd_wpa_auth_psk_failure_report
parameter_list|(
name|void
modifier|*
name|ctx
...
argument|MSG_INFO
argument_list|,
argument|AP_STA_POSSIBLE_PSK_MISMATCH MACSTR
argument_list|,
...
name|MSG_DEBUG
argument_list|,
literal|"AUTH_GET_MSK: Cannot find STA"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|MSG_DEBUG
argument_list|,
literal|"AUTH_GET_MSK: Key is null, eapol_sm: %p"
argument_list|,
name|sta
operator|->
name|eapol_sm
