...
begin_comment
comment|/**  * mesh_conf - local MBSS state and settings  */
end_comment
...
name|meshid_len
decl_stmt|;
comment|/* Active Path Selection Protocol Identifier */
name|u8
name|mesh_pp_id
decl_stmt|;
comment|/* Active Path Selection Metric Identifier */
name|u8
name|mesh_pm_id
decl_stmt|;
comment|/* Congestion Control Mode Identifier */
name|u8
name|mesh_cc_id
decl_stmt|;
comment|/* Synchronization Protocol Identifier */
name|u8
name|mesh_sp_id
decl_stmt|;
...
name|eap_server_erp
decl_stmt|;
comment|/* Whether ERP is enabled on internal EAP server */
name|struct
...
decl_stmt|;
comment|/* DFS */
comment|/* 	 * Local power constraint is an octet encoded as an unsigned integer in 	 * units of decibels. Invalid value -1 indicates that Power Constraint 	 * element will not be added. 	 */
name|int
name|local_pwr_constraint
decl_stmt|;
comment|/* Control Spectrum Management bit */
name|int
