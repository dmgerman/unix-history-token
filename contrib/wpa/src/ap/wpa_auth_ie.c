...
begin_comment
comment|/*  * hostapd - WPA/RSN IE and KDE definitions  * Copyright (c) 2004-2015, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
name|MSG_DEBUG
argument_list|,
literal|"Invalid group management cipher (0x%x)"
argument_list|,
name|conf
operator|->
name|group_mgmt_cipher
...
name|MSG_DEBUG
argument_list|,
literal|"WPA: Forced own IE(s) for testing"
argument_list|,
name|wpa_auth
operator|->
name|conf
...
literal|1
return|;
comment|/* TODO: parse OSEN element */
name|sm
operator|->
name|wpa_key_mgmt
operator|=
