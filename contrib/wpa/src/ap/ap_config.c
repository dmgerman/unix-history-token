...
begin_comment
comment|/*  * hostapd / Configuration helper functions  * Copyright (c) 2003-2014, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
literal|1
expr_stmt|;
comment|/* Set to invalid value means do not add Power Constraint IE */
name|conf
operator|->
...
name|NULL
expr_stmt|;
comment|/* Use P2P Device Address for matching */
block|}
else|else
block|{
name|wpa_printf
...
name|MSG_ERROR
argument_list|,
literal|"WEP configuration in a WPA network is not supported"
argument_list|)
expr_stmt|;
return|return
operator|-
...
literal|"WPA2/CCMP/GCMP forced WPS to be disabled"
argument_list|)
expr_stmt|;
name|bss
operator|->
...
name|MSG_ERROR
argument_list|,
literal|"Invalid TX queue cwMin/cwMax values. cwMin(%d) greater than cwMax(%d)"
argument_list|,
name|tx_cwmin
argument_list|,
name|tx_cwmax
...
name|MSG_ERROR
argument_list|,
literal|"Invalid WMM AC cwMin/cwMax values. cwMin(%d) greater than cwMax(%d)"
argument_list|,
name|ac_cwmin
argument_list|,
name|ac_cwmax
...
name|MSG_ERROR
argument_list|,
literal|"Cannot enable IEEE 802.11h without "
literal|"IEEE 802.11d enabled"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|MSG_ERROR
argument_list|,
literal|"Cannot add Power Constraint element without Country element"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|MSG_ERROR
argument_list|,
literal|"Cannot set Spectrum Management bit without Country and Power Constraint elements"
argument_list|)
expr_stmt|;
return|return
operator|-
