...
name|wpabuf
modifier|*
name|p2p_group_encaps_probe_resp
parameter_list|(
name|struct
name|wpabuf
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* P2P Group Info: Only when at least one P2P Client is connected */
if|if
condition|(
name|group
operator|->
...
name|p2p
argument_list|,
literal|"Requested client was not in this group "
name|MACSTR
argument_list|,
name|MAC2STR
argument_list|(
...
name|p2p
argument_list|,
literal|"Requested client does not support client discoverability"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|p2p
argument_list|,
literal|"Schedule GO Discoverability Request to be sent to "
name|MACSTR
argument_list|,
name|MAC2STR
argument_list|(
...
name|p2p
argument_list|,
literal|"Client was not in this group"
argument_list|)
expr_stmt|;
return|return
...
name|p2p
argument_list|,
literal|"Failed to fetch current NoA"
argument_list|)
expr_stmt|;
elseif|else
if|if
...
name|p2p
argument_list|,
literal|"No NoA being advertized"
argument_list|)
expr_stmt|;
else|else
name|wpa_hexdump
...
name|p2p
argument_list|,
literal|"Group common freqs before iterating members"
argument_list|,
operator|&
name|intersect
argument_list|)
