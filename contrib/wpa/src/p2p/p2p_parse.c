...
name|MSG_DEBUG
argument_list|,
literal|"P2P: Too short OOB GO Neg "
literal|"Channel attribute (length %d)"
argument_list|,
name|len
argument_list|)
...
name|MSG_DEBUG
argument_list|,
literal|"P2P: * OOB GO Neg Channel: "
literal|"Country %c%c(0x%02x) Operating Class %d "
literal|"Channel Number %d Role %d"
argument_list|,
name|data
index|[
literal|0
...
name|MSG_DEBUG
argument_list|,
literal|"P2P: Too short Service Hash (length %u)"
argument_list|,
name|len
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"P2P: * Service Instance: %u bytes - %p"
argument_list|,
name|len
argument_list|,
name|data
...
name|MSG_DEBUG
argument_list|,
literal|"P2P: Too short Connection Capability (length %u)"
argument_list|,
name|len
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"P2P: Too short Advertisement ID (length %u)"
argument_list|,
name|len
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"P2P: Too short Service Instance (length %u)"
argument_list|,
name|len
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"P2P: * Service Instance: %x-%s"
argument_list|,
name|WPA_GET_LE32
argument_list|(
name|data
...
name|MSG_DEBUG
argument_list|,
literal|"P2P: * Service Instance: %p"
argument_list|,
name|data
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"P2P: Too short Session ID Info (length %u)"
argument_list|,
name|len
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"P2P: Too short Feature Capability (length %u)"
argument_list|,
name|len
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"P2P: * Feature Cap (length=%u)"
argument_list|,
name|len
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"P2P: Too short Persistent Group Info (length %u)"
argument_list|,
name|len
argument_list|)
expr_stmt|;
