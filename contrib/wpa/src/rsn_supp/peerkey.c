...
name|MSG_DEBUG
argument_list|,
literal|"RSN: Using %s for PeerKey"
argument_list|,
name|wpa_cipher_txt
argument_list|(
name|cipher
...
begin_comment
comment|/**  * rsn_smkid - Derive SMK identifier  * @smk: Station master key (32 bytes)  * @pnonce: Peer Nonce  * @mac_p: Peer MAC address  * @inonce: Initiator Nonce  * @mac_i: Initiator MAC address  * @akmp: Negotiated AKM  *  * 8.5.1.4 Station to station (STK) key hierarchy  * SMKID = HMAC-SHA1-128(SMK, "SMK Name" || PNonce || MAC_P || INonce || MAC_I)  */
end_comment
...
literal|1000000000
expr_stmt|;
comment|/* avoid overflowing eloop time */
name|peerkey
operator|->
name|lifetime
operator|=
