...
name|mdie
decl_stmt|;
comment|/* TODO: verify that full MDIE matches with the one from scan 		 * results, not only mobility domain */
name|mdie
operator|=
operator|(
expr|struct
