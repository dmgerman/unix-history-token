...
begin_comment
comment|/*  * EAP peer method: EAP-FAST (RFC 4851)  * Copyright (c) 2004-2008, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
name|MSG_INFO
argument_list|,
literal|"EAP-FAST: No PAC file configured"
argument_list|)
expr_stmt|;
name|eap_fast_deinit
argument_list|(
...
name|MSG_INFO
argument_list|,
literal|"EAP-FAST: Failed to load PAC file"
argument_list|)
expr_stmt|;
name|eap_fast_deinit
argument_list|(
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-FAST: Derived Session-Id"
argument_list|,
name|data
operator|->
name|session_id
