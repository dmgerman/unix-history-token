...
begin_comment
comment|/*  * EAP peer method: EAP-TLS (RFC 2716)  * Copyright (c) 2004-2008, 2012, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-TLS: Derived Session-Id"
argument_list|,
name|data
operator|->
name|session_id
...
name|MSG_ERROR
argument_list|,
literal|"EAP-TLS: Failed to derive Session-Id"
argument_list|)
expr_stmt|;
block|}
block|}
