...
begin_comment
comment|/*  * EAP peer state machine functions (RFC 4137)  * Copyright (c) 2004-2007, Jouni Malinen<j@w1.fi>  *  * This program is free software; you can redistribute it and/or modify  * it under the terms of the GNU General Public License version 2 as  * published by the Free Software Foundation.  *  * Alternatively, this software may be distributed under the terms of BSD  * license.  *  * See README and COPYING for more details.  */
end_comment
...
parameter_list|)
function_decl|;
comment|/** 	 * eap_param_needed - Notify that EAP parameter is needed 	 * @ctx: eapol_ctx from eap_peer_sm_init() call 	 * @field: Field name (e.g., "IDENTITY") 	 * @txt: User readable text describing the required parameter 	 */
name|void
function_decl|(
modifier|*
