...
name|wpa_scan_res
modifier|*
name|wpa_driver_ndis_add_scan_ssid
parameter_list|(
name|struct
name|wpa_scan_res
modifier|*
...
name|r
return|;
comment|/* SSID IE already present */
if|if
condition|(
name|ssid
operator|->
...
name|r
return|;
comment|/* No valid SSID inside scan data */
name|nr
operator|=
name|os_realloc
argument_list|(
...
name|MSG_DEBUG
argument_list|,
literal|"NDIS: too small IELength=%d"
argument_list|,
operator|(
name|int
operator|)
...
expr_stmt|;
block|}
comment|/* 	 * Some drivers may refuse OID_802_11_PMKID if authMode is not set to 	 * WPA2, so change authMode temporarily, if needed. 	 */
name|prev_authmode
operator|=
name|ndis_get_auth_mode
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* 	 * Disconnect to make sure that driver re-associates if it was 	 * connected. 	 */
name|wpa_driver_ndis_disconnect
argument_list|(
name|drv
argument_list|)
