...
begin_comment
comment|/*  * SSL/TLS interface functions for OpenSSL  * Copyright (c) 2004-2013, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
define|#
directive|define
name|OPENSSL_SUPPORTS_CTX_APP_DATA
end_define
...
directive|ifdef
name|OPENSSL_SUPPORTS_CTX_APP_DATA
comment|/* Newer OpenSSL can store app-data per-SSL */
name|context
operator|=
name|tls_context_new
argument_list|(
...
directive|else
comment|/* OPENSSL_SUPPORTS_CTX_APP_DATA */
name|context
operator|=
name|tls_global
expr_stmt|;
