...
begin_comment
comment|/*  * WPA Supplicant / SSL/TLS interface functions for openssl  * Copyright (c) 2004-2008, Jouni Malinen<j@w1.fi>  *  * This program is free software; you can redistribute it and/or modify  * it under the terms of the GNU General Public License version 2 as  * published by the Free Software Foundation.  *  * Alternatively, this software may be distributed under the terms of BSD  * license.  *  * See README and COPYING for more details.  */
end_comment
...
ifdef|#
directive|ifdef
name|CONFIG_MINGW32_LOAD_CERTENUM
end_ifdef
...
begin_comment
comment|/* CONFIG_MINGW32_LOAD_CERTENUM */
end_comment
...
name|out_data
decl_stmt|;
comment|/* 	 * Give TLS handshake data from the client (if available) to OpenSSL 	 * for processing. 	 */
if|if
condition|(
name|in_data
operator|&&
...
name|MSG_DEBUG
argument_list|,
literal|"SSL: SSL_accept - want to "
literal|"write"
argument_list|)
expr_stmt|;
else|else
...
block|}
block|}
comment|/* Get the TLS handshake data to be sent to the client */
name|res
operator|=
name|BIO_ctrl_pending
argument_list|(
