...
begin_comment
comment|/*  * Wrapper functions for OpenSSL libcrypto  * Copyright (c) 2004-2015, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
ifndef|#
directive|ifndef
name|CONFIG_OPENSSL_INTERNAL_AES_WRAP
end_ifndef
...
begin_comment
comment|/* CONFIG_OPENSSL_INTERNAL_AES_WRAP */
end_comment
...
name|nid
decl_stmt|;
comment|/* Map from IANA registry for IKE D-H groups to OpenSSL NID */
switch|switch
condition|(
name|group
condition|)
