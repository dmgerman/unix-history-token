...
begin_comment
comment|/*  * SSL/TLS interface definition  * Copyright (c) 2004-2013, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
begin_function_decl
name|void
name|tls_connection_set_log_cb
parameter_list|(
name|struct
name|tls_connection
modifier|*
...
begin_function_decl
name|void
name|tls_connection_set_test_flags
parameter_list|(
name|struct
name|tls_connection
modifier|*
