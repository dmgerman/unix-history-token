...
name|MSG_DEBUG
argument_list|,
literal|"EAP-AKA: Reauth data "
literal|"was for different AKA version"
argument_list|)
expr_stmt|;
name|data
operator|->
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-AKA: Permanent user name "
literal|"not known - send AKA-Identity request"
argument_list|)
expr_stmt|;
name|eap_aka_state
argument_list|(
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-AKA: Unknown whether the "
literal|"permanent user name is known; try to use "
literal|"it"
argument_list|)
expr_stmt|;
comment|/* eap_sim_db_get_aka_auth() will report failure, if 			 * this identity is not known. */
block|}
block|}
...
literal|1
expr_stmt|;
comment|/* Try again after resynchronization */
name|eap_aka_determine_identity
argument_list|(
name|sm
argument_list|,
