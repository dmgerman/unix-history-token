...
begin_comment
comment|/**  * eap_sim_db_get_reauth_entry - EAP-SIM DB: Get re-authentication entry  * @priv: Private data pointer from eap_sim_db_init()  * @identity: Identity of the user (may be permanent identity, pseudonym, or  * reauth_id)  * @identity_len: Length of identity  * Returns: Pointer to the re-auth entry, or %NULL if not found  */
end_comment
