...
begin_comment
comment|/* Use faster div at the cost of about 1 kB */
end_comment
...
begin_comment
comment|/* Include faster exptmod (Montgomery) at the cost of about 2.5 kB in code */
end_comment
...
begin_comment
comment|/* Include faster sqr at the cost of about 0.5 kB in code */
end_comment
...
begin_comment
comment|/* Current uses do not require support for negative exponent in exptmod, so we  * can save about 1.5 kB in leaving out invmod. */
end_comment
