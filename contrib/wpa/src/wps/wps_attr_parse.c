...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Invalid Registrar Configuration Methods length %u"
argument_list|,
name|len
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Ignore too long Device Name (len=%u)"
argument_list|,
name|len
argument_list|)
expr_stmt|;
...
case|:
comment|/* 		 * The Public Key attribute is supposed to be exactly 192 bytes 		 * in length. Allow couple of bytes shorter one to try to 		 * interoperate with implementations that do not use proper 		 * zero-padding. 		 */
if|if
condition|(
name|len
operator|<
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Ignore Public Key with unexpected length %u"
argument_list|,
name|len
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Ignore too long SSID (len=%u)"
argument_list|,
name|len
argument_list|)
expr_stmt|;
