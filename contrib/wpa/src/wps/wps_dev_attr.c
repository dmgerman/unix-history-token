...
condition|)
block|{
comment|/* 		 * Some deployed WPS implementations fail to parse zero-length 		 * attributes. As a workaround, send a space character if the 		 * device attribute string is empty. 		 */
name|wpabuf_put_be16
argument_list|(
name|msg
argument_list|,
...
name|MSG_DEBUG
argument_list|,
literal|"WPS:  * Secondary Device Type"
argument_list|)
expr_stmt|;
name|wpabuf_put_be16
argument_list|(
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: * Requested Device Type"
argument_list|,
name|req_dev_types
operator|+
name|i
...
name|MSG_DEBUG
argument_list|,
literal|"WPS:  * Vendor Extension M1"
argument_list|,
name|wpabuf_head_u8
argument_list|(
name|dev
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Primary Device Type: %s"
argument_list|,
