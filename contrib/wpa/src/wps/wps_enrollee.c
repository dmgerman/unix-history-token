...
name|MSG_INFO
argument_list|,
literal|"WPS: Not enough entropy in random pool to proceed - do not allow AP PIN to be used"
argument_list|)
expr_stmt|;
return|return
name|NULL
...
name|ap_auth_type
decl_stmt|;
comment|/* 	 * Work around issues with Windows 7 WPS implementation not liking 	 * multiple Authentication Type bits in M7 AP Settings attribute by 	 * showing only the most secure option from current configuration. 	 */
if|if
condition|(
name|auth_type
operator|&
...
name|ap_encr_type
decl_stmt|;
comment|/* 	 * Work around issues with Windows 7 WPS implementation not liking 	 * multiple Encryption Type bits in M7 AP Settings attribute by 	 * showing only the most secure option from current configuration. 	 */
if|if
condition|(
name|wps
operator|->
...
name|MSG_DEBUG
argument_list|,
literal|"WPS:  * AP Settings based on current configuration"
argument_list|)
expr_stmt|;
name|start
operator|=
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Plaintext AP Settings"
argument_list|,
name|start
argument_list|,
name|end
...
name|MSG_ERROR
argument_list|,
literal|"WPS: Public Key hash mismatch"
argument_list|)
expr_stmt|;
name|wpa_hexdump
argument_list|(
name|MSG_DEBUG
argument_list|,
literal|"WPS: Received public key"
argument_list|,
name|pk
argument_list|,
name|pk_len
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Calculated public key "
literal|"hash"
argument_list|,
name|hash
argument_list|,
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Expected public key hash"
argument_list|,
name|wps
operator|->
name|peer_pubkey_hash
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Device Password ID %u"
argument_list|,
name|id
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|/* 		 * Common P2P use cases indicate whether the PIN is from the 		 * client or GO using Device Password Id in M1/M2 in a way that 		 * does not look fully compliant with WSC specification. Anyway, 		 * this is deployed and needs to be allowed, so ignore changes 		 * between Registrar-Specified and Default PIN. 		 */
name|wpa_printf
argument_list|(
name|MSG_DEBUG
argument_list|,
literal|"WPS: Allow PIN Device Password ID "
literal|"change"
argument_list|)
expr_stmt|;
return|return
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Registrar trying to change Device Password "
literal|"ID from %u to %u"
argument_list|,
name|wps
operator|->
name|dev_pw_id
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Workaround - ignore PBC-to-PIN change"
argument_list|)
expr_stmt|;
return|return
literal|0
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Found a matching Device Password"
argument_list|)
expr_stmt|;
name|bin_clear_free
argument_list|(
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Failed to decrypt "
literal|"Encrypted Settings attribute"
argument_list|)
expr_stmt|;
name|wps
operator|->
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Processing decrypted Encrypted "
