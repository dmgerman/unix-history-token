...
literal|"on credential token generation"
argument_list|)
expr_stmt|;
name|os_memset
argument_list|(
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Generated new DH pubkey"
argument_list|,
name|pub
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Building attributes for NFC connection "
literal|"handover request"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: No NFC OOB Device Password "
literal|"configured"
argument_list|)
expr_stmt|;
return|return
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: SSID in Connection Handover Select"
argument_list|,
name|wps
operator|->
name|ssid
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: No NFC DH Public Key configured"
argument_list|)
expr_stmt|;
return|return
name|NULL
