...
begin_comment
comment|/*  * UPnP SSDP for WPS  * Copyright (c) 2000-2003 Intel Corporation  * Copyright (c) 2006-2007 Sony Corporation  * Copyright (c) 2008-2009 Atheros Communications  * Copyright (c) 2009-2013, Jouni Malinen<j@w1.fi>  *  * See wps_upnp.c for more details on licensing and code history.  */
end_comment
...
name|MSG_INFO
argument_list|,
literal|"WPS UPnP: Failed to bind "
literal|"multicast socket to ifname %s: %s"
argument_list|,
name|forced_ifname
argument_list|,
name|strerror
