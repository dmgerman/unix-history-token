...
begin_comment
comment|/*  * Wi-Fi Protected Setup - External Registrar  * Copyright (c) 2009-2013, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
name|MSG_DEBUG
argument_list|,
literal|"WPS ER: AP entry for %s (%s) still in ap_unsubscribing list - free it"
argument_list|,
name|inet_ntoa
argument_list|(
name|ap
