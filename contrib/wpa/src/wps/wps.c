...
name|MSG_DEBUG
argument_list|,
literal|"WPS: AP PIN dev_password"
argument_list|,
name|data
operator|->
name|dev_password
...
condition|)
block|{
comment|/* Keep AP PIN as alternative Device Password */
name|data
operator|->
name|alt_dev_pw_id
operator|=
