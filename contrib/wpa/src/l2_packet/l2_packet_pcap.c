...
begin_comment
comment|/*  * WPA Supplicant - Layer2 packet handling with libpcap/libdnet and WinPcap  * Copyright (c) 2003-2006, Jouni Malinen<j@w1.fi>  *  * This program is free software; you can redistribute it and/or modify  * it under the terms of the GNU General Public License version 2 as  * published by the Free Software Foundation.  *  * Alternatively, this software may be distributed under the terms of BSD  * license.  *  * See README and COPYING for more details.  */
end_comment
...
name|l2_hdr
decl_stmt|;
comment|/* whether to include layer 2 (Ethernet) header in calls 			* to rx_callback */
block|}
struct|;
end_struct
...
argument_list|)
expr_stmt|;
comment|/* 	 * Use shorter poll interval for 3 seconds to reduce latency during key 	 * handshake. 	 */
name|l2
operator|->
name|num_fast_poll
operator|=
...
specifier|static
name|void
name|l2_packet_receive_timeout
parameter_list|(
name|void
modifier|*
name|eloop_ctx
...
literal|100000
expr_stmt|;
comment|/* Register new timeout before calling l2_packet_receive() since 	 * receive handler may free this l2_packet instance (which will 	 * cancel this timeout). */
