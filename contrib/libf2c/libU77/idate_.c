...
literal|1
expr_stmt|;
comment|/* in range 1-12 in SunOS (experimentally) */
comment|/* The `+1900' is consistent with SunOS and Irix, but they don't say      it's added.  I think I've seen a system where tm_year was since      1970, but can't now verify that, so assume the ANSI definition. */
name|iarray
index|[
literal|2
index|]
