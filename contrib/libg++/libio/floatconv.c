...
name|x
parameter_list|)
value|({ union doubleword _du; _du.d = (x); _du.u[HIWORD]; })
end_define
...
name|x
parameter_list|)
value|({ union doubleword _du; _du.d = (x); _du.u[LOWORD]; })
end_define
...
parameter_list|)
define|\
value|({ union doubleword _du; _du.d = (D); _du.u[HIWORD]=(W); (D)=_du.d; })
end_define
...
parameter_list|)
define|\
value|({ union doubleword _du; _du.d = (D); _du.u[LOWORD]=(W); (D)=_du.d; })
end_define
...
name|W1
parameter_list|)
value|({ union doubleword _du; \   _du.u[HIWORD]=(W0); _du.u[LOWORD]=(W1); (D)=_du.d; })
end_define
...
name|W1
parameter_list|)
value|(setword0(D,W0),setword1(D,W1))
end_define
...
name|rv
block|;
comment|/* Force rv into the stack */
for|for
control|(
name|s
operator|=
