...
begin_comment
unit|_IO_size_t DEFUN(_IO_file_xsgetn, (fp, data, n),       _IO_FILE *fp AND void *data AND _IO_size_t n) {   register _IO_size_t more = n;   register char *s = data;   for (;;)     {       _IO_ssize_t count = fp->_IO_read_end - fp->_IO_read_ptr;
