...
directive|define
name|PAM_ACCESS_CONFIG
value|"/etc/security/access.conf"
end_define
...
begin_comment
comment|/* Parse module config arguments */
end_comment
...
name|_log_err
argument_list|(
literal|"for service [%s] failed to open accessfile=[%s]"
argument_list|,
name|loginfo
operator|->
name|service
...
name|_log_err
argument_list|(
literal|"cannot find the service name"
argument_list|)
expr_stmt|;
return|return
name|PAM_ABORT
...
operator|)
return|;
comment|/*      * Bundle up the arguments to avoid unnecessary clumsiness later on.      */
name|loginfo
operator|.
name|user
operator|=
...
name|_log_err
argument_list|(
literal|"failed to parse the module arguments"
argument_list|)
expr_stmt|;
return|return
name|PAM_ABORT
