...
condition|)
block|{
comment|/* 		* for security parse whole file..  also need to ensure 		* that the buffer is free()'d and the file is closed. 		*/
name|retval
operator|=
