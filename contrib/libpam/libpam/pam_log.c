...
begin_comment
comment|/*  * pam_log.c -- PAM system logging  *  * $Id: pam_log.c,v 1.2 2000/11/19 23:54:02 agmorgan Exp $  * $FreeBSD$  *  */
end_comment
...
begin_comment
comment|/* internal logging function */
end_comment
...
argument_list|(
operator|(
literal|"NULL format to _pam_system_log() call"
operator|)
argument_list|)
expr_stmt|;
return|return;
