...
begin_comment
comment|/*   * tclLoadDl2.c --  *  *	This procedure provides a version of the TclLoadFile that  *	works with the "dlopen" and "dlsym" library procedures for  *	dynamic loading.  It is identical to tclLoadDl.c except that  *	it adds a "_" character to symbol names before looking them  *	up.  *  * Copyright (c) 1995 Sun Microsystems, Inc.  *  * See the file "license.terms" for information on usage and redistribution  * of this file, and for a DISCLAIMER OF ALL WARRANTIES.  *  * SCCS: @(#) tclLoadDl2.c 1.3 96/02/15 11:58:45  */
end_comment
