...
name|m
parameter_list|)
value|{ TclRegError(m); return(NULL); }
end_define
...
begin_comment
comment|/*  * Global work variables for TclRegComp().  */
end_comment
...
begin_comment
comment|/*  * The first byte of the regexp internal "program" is actually this magic  * number; the start node begins in the second byte.  */
end_comment
...
begin_comment
comment|/*  * Forward declarations for TclRegComp()'s friends.  */
end_comment
...
begin_comment
comment|/*  * TclRegExec and friends  */
end_comment

begin_comment
comment|/*  * Global work variables for TclRegExec().  */
end_comment
...
begin_comment
comment|/*  - TclRegExec - match a regexp against a string  */
end_comment
...
begin_comment
comment|/*  *----------------------------------------------------------------------  *  * TclRegError --  *  *	This procedure is invoked by the regexp code when an error  *	occurs.  It saves the error message so it can be seen by the  *	code that called Spencer's code.  *  * Results:  *	None.  *  * Side effects:  *	The value of "string" is saved in "errMsg".  *  *----------------------------------------------------------------------  */
end_comment
