...
name|type
decl_stmt|;
comment|/* Type of number to scan. */
block|{
name|int
name|c
decl_stmt|;
...
literal|'c'
case|:
comment|/* 	     * Characters need special handling.  We want to produce a 	     * signed result, but on some platforms (such as AIX) chars 	     * are unsigned.  To deal with this, check for a value that 	     * should be negative but isn't. 	     */
name|c
operator|=
name|buffer
index|[
