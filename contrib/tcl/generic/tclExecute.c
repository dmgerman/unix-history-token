...
begin_comment
comment|/*   * tclExecute.c --  *  *	This file contains procedures that execute byte-compiled Tcl  *	commands.  *  * Copyright (c) 1996-1997 Sun Microsystems, Inc.  *  * See the file "license.terms" for information on usage and redistribution  * of this file, and for a DISCLAIMER OF ALL WARRANTIES.  *  * SCCS: @(#) tclExecute.c 1.95 97/08/12 17:06:49  */
end_comment
...
literal|""
decl_stmt|;
comment|/* 	     * Print the command in the error message (up to a certain 	     * number of characters, or up to the first newline). 	     */
name|iPtr
operator|->
name|errorLine
operator|=
