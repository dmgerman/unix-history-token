...
block|}
block|}
comment|/*      * Dispatch based on the option.      * THIS FAILS IF THE OPTIONS OBJECT'S STRING REP HAS A NULL BYTE.      */
name|option
operator|=
name|TclGetStringFromObj
argument_list|(
