...
begin_comment
comment|/*   * tclMain.c --  *  *	Main program for Tcl shells and other Tcl-based applications.  *  * Copyright (c) 1988-1994 The Regents of the University of California.  * Copyright (c) 1994-1996 Sun Microsystems, Inc.  *  * See the file "license.terms" for information on usage and redistribution  * of this file, and for a DISCLAIMER OF ALL WARRANTIES.  *  * SCCS: @(#) tclMain.c 1.50 96/04/10 16:40:57  */
end_comment
...
begin_comment
comment|/* Used to buffer incomplete commands being 				 * read from stdin. */
end_comment
...
begin_comment
comment|/* 1 means the "checkmem" command was 				 * invoked, so the application should quit 				 * and dump memory allocation information. */
end_comment
...
goto|;
block|}
comment|/*          * Add the newline removed by Tcl_Gets back to the string.          */
operator|(
name|void
operator|)
