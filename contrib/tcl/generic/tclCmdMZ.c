...
control|)
block|{
comment|/* 		   * Scan forward to find the first character. 		   */
name|p
operator|=
name|memchr
argument_list|(
...
control|)
block|{
comment|/* 		     * Scan backwards to find the first character. 		     */
while|while
condition|(
operator|(
name|p
