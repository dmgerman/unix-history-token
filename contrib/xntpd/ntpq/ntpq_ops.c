...
begin_comment
comment|/*  * fixup - fix up a string so we don't get a hanging decimal after it  */
end_comment
...
literal|1
return|;
comment|/* 	 * Check to see if we got all of them.  If not, return an 	 * error. 	 */
for|for
control|(
name|i
operator|=
...
name|stderr
argument_list|,
literal|"***Remote host didn't return peer.%s for association %d\n"
argument_list|,
name|pvl
index|[
name|i
