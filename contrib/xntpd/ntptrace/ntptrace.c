...
begin_comment
comment|/* ntptrace.c,v 3.1 1993/07/06 01:09:38 jbj Exp  * ntptrace - show the chain from an NTP host leading back to  *	its source of time  *  *	Jeffrey Mogul	DECWRL	13 January 1993  *  *	Inspired by a script written by Glenn Trewitt  *  *	Large portions stolen from ntpdate.c  */
end_comment
...
name|stderr
argument_list|,
literal|"usage: %s [-vnd] [-r retries] [-t timeout] [server]\n"
argument_list|,
name|progname
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|/* End of recursion if we reach stratum 1 */
if|if
condition|(
name|server
operator|->
...
begin_comment
comment|/*  * setup_io - initialize I/O data and open socket  */
end_comment
