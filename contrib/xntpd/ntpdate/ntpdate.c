...
begin_comment
comment|/* ntpdate.c,v 3.1 1993/07/06 01:09:22 jbj Exp  * ntpdate - set the time of day by polling one or more NTP servers  */
end_comment
...
directive|ifdef
name|notdef
comment|/* 		 * Fuzzballs do encryption but still claim 		 * to be version 1. 		 */
if|if
condition|(
name|has_mac
condition|)
...
name|printf
argument_list|(
literal|"receive: rpkt keyid=%d sys_authkey=%d decrypt=%d\n"
argument_list|,
name|ntohl
argument_list|(
name|rpkt
