...
begin_comment
comment|/*  * Adjust time daemon.  * This deamon adjusts the rate of the system clock a la BSD's adjtime().  * The adjtime() routine uses SYSV messages to communicate with this daemon.  *  * Caveat: This emulation uses an undocumented kernel variable.  As such, it  * cannot be guaranteed to work in future HP-UX releases.  Perhaps a real  * adjtime(2) will be supported in the future.  */
end_comment
...
name|tv
parameter_list|)
value|((double)(LONG)tv.tv_sec + \ 			((double)tv.tv_usec / (double)MILLION))
end_define
...
name|fputs
argument_list|(
literal|"adjtimed: percentage must be between 0.0 and 100.0\n"
argument_list|,
name|stderr
argument_list|)
expr_stmt|;
...
name|puts
argument_list|(
literal|"usage: adjtimed -hkrvdf -p rate"
argument_list|)
expr_stmt|;
name|puts
argument_list|(
...
name|puts
argument_list|(
literal|"-p rate\tpercent rate of change"
argument_list|)
expr_stmt|;
name|syslog
argument_list|(
...
name|printf
argument_list|(
literal|"adjtimed: started (rate %.2f%%)\n"
argument_list|,
name|RATE
operator|*
literal|100.0
...
begin_comment
comment|/* #define RATE		0.005 #define PERIOD		(1.0 / RATE) */
end_comment
...
name|printf
argument_list|(
literal|"adjtimed: delta is too small: %dus\n"
argument_list|,
name|dt
argument_list|)
expr_stmt|;
...
name|LOG_INFO
argument_list|,
literal|"delta is too small: %dus"
argument_list|,
name|dt
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/*  * The adjustment will always be a multiple of the minimum adjustment.  * So the period will always be a whole second value.  */
name|period
operator|.
name|it_value
operator|.
...
name|printf
argument_list|(
literal|"adjtimed: will be complete in %ds\n"
argument_list|,
name|period
operator|.
name|it_value
...
name|LOG_INFO
argument_list|,
literal|"will be complete in %ds"
argument_list|,
name|period
operator|.
name|it_value
