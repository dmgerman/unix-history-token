...
begin_comment
comment|/*  * Defines:  *  REFCLOCK&& (PARSE||PARSEPPS)  *                    - enable this mess  *  STREAM            - allow for STREAMS modules  *                      ("parse", "ppsclocd", "ppsclock")  *  PARSEPPS          - provide PPS information to loopfilter (for  *                      backward compatibilty only)  *  PPS		      - supply loopfilter with PPS samples (if configured)  *  PPSPPS            - notify loopfilter of PPS file descriptor  */
end_comment
...
index|[]
operator|=
literal|"refclock_parse.c,v 3.41 1993/11/27 18:44:37 kardel Exp"
expr_stmt|;
end_expr_stmt
