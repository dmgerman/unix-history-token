...
begin_comment
comment|/*  *  Copyright (c) 1999-2007 Proofpoint, Inc. and its suppliers.  *	All rights reserved.  *  * By using this file, you agree to the terms and conditions set  * forth in the LICENSE file which can be found at the top level of  * the sendmail distribution.  *  */
end_comment
...
name|SM_RCSID
argument_list|(
literal|"@(#)$Id: listener.c,v 8.127 2013-11-22 20:51:36 ca Exp $"
argument_list|)
end_macro
...
directive|endif
comment|/* _FFR_DUP_FD */
comment|/* 		**  Need to set close-on-exec for connfd in case a user's 		**  filter starts other applications. 		**  Note: errors will not stop processing (for now). 		*/
if|if
condition|(
operator|(
name|fdflags
