...
begin_comment
comment|/*  *  Copyright (c) 2003-2004, 2007, 2009 Sendmail, Inc. and its suppliers.  *	All rights reserved.  *  * By using this file, you agree to the terms and conditions set  * forth in the LICENSE file which can be found at the top level of  * the sendmail distribution.  *  * Contributed by Jose Marcio Martins da Cruz - Ecole des Mines de Paris  *   Jose-Marcio.Martins@ensmp.fr  */
end_comment
...
name|SM_RCSID
argument_list|(
literal|"@(#)$Id: worker.c,v 8.17 2009/06/15 15:34:54 ca Exp $"
argument_list|)
end_macro
