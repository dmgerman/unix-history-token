...
begin_comment
comment|/* **  MILTER_UNKNOWN -- send any unrecognized or unimplemented command **			string to milter filters ** **	Parameters: **		cmd -- the string itself. **		e -- current envelope. **		state -- return state from response. ** ** **	Returns: **		response string (may be NULL) */
end_comment
