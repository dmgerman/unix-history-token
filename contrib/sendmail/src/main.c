...
condition|)
block|{
comment|/* exit(EX_CONFIG) if different? */
name|sm_dprintf
argument_list|(
literal|"       OpenSSL: compiled 0x%08x\n"
argument_list|,
operator|(
name|uint
operator|)
...
condition|)
block|{
comment|/* copied from getauthinfo() */
if|if
condition|(
name|RealHostName
operator|==
...
expr_stmt|;
block|}
comment|/* HACK! variable used only two times right below */
name|authinfo
operator|=
name|buf
expr_stmt|;
...
name|NOQID
argument_list|,
literal|"main: where=not_calling_getauthinfo, RealHostAddr=%s"
argument_list|,
name|anynet_ntoa
argument_list|(
operator|&
...
comment|/* WARNING: "non-braced" else */
endif|#
directive|endif
comment|/* _FFR_XCNCT */
name|authinfo
...
name|sm_dprintf
argument_list|(
literal|"drop_privileges(%d): Real[UG]id=%ld:%ld, get[ug]id=%ld:%ld, gete[ug]id=%ld:%ld, RunAs[UG]id=%ld:%ld\n"
argument_list|,
operator|(
name|int
operator|)
...
name|syserr
argument_list|(
literal|"drop_privileges: setgid(%ld) failed"
argument_list|,
operator|(
name|long
operator|)
...
name|syserr
argument_list|(
literal|"drop_privileges: Unable to set effective gid=%ld to RunAsGid=%ld"
argument_list|,
operator|(
name|long
operator|)
