...
name|usrerr
argument_list|(
literal|"553 5.1.1 Address too long (%d bytes max)"
argument_list|,
name|MAXNAME
operator|-
literal|1
...
name|usrerr
argument_list|(
literal|"553 5.1.1 Address contained invalid control characters"
argument_list|)
expr_stmt|;
name|failure
label|:
...
name|syserr
argument_list|(
literal|"554 5.3.0 callsubr: expansion too long"
argument_list|)
expr_stmt|;
return|return
name|EX_DATAERR
...
directive|if
name|_FFR_ADDR_TYPE
comment|/* 	**  Note, change the 9 to a 10 before removing #if FFR check 	**  in a future version. 	*/
if|if
condition|(
name|ConfigLevel
operator|>=
