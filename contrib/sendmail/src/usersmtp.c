...
begin_comment
comment|/*  * Copyright (c) 1998-2006, 2008-2010, 2014 Proofpoint, Inc. and its suppliers.  *	All rights reserved.  * Copyright (c) 1983, 1995-1997 Eric P. Allman.  All rights reserved.  * Copyright (c) 1988, 1993  *	The Regents of the University of California.  All rights reserved.  *  * By using this file, you agree to the terms and conditions set  * forth in the LICENSE file which can be found at the top level of  * the sendmail distribution.  *  */
end_comment
...
name|SM_RCSID
argument_list|(
literal|"@(#)$Id: usersmtp.c,v 8.488 2013-11-22 20:51:57 ca Exp $"
argument_list|)
end_macro
...
directive|if
name|PIPELINING
comment|/* 			**  ignore error iff: DATA, 5xy error, but we had 			**  "retryable" recipients. XREF: smtpdata() 			*/
if|if
condition|(
operator|!
operator|(
...
argument_list|)
expr_stmt|;
comment|/* skip SMTP reply code, delimiters */
name|o
operator|+=
literal|5
expr_stmt|;
...
name|sm_dprintf
argument_list|(
literal|"user: offset=%d, bufp=%s, rcode=%d, enhstat=%s, text=%s\n"
argument_list|,
name|o
argument_list|,
name|bufp
