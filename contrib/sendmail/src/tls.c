...
name|SM_RCSID
argument_list|(
literal|"@(#)$Id: tls.c,v 1.1.1.2 2002/04/10 03:04:52 gshapiro Exp $"
argument_list|)
end_macro
...
name|NOQID
argument_list|,
literal|"STARTTLS=%s, cert-subject=%.128s, cert-issuer=%.128s"
argument_list|,
name|who
argument_list|,
name|s1
...
name|NOQID
argument_list|,
literal|"STARTTLS: cert verify: depth=%d %s, state=%d, reason=%s"
argument_list|,
name|depth
argument_list|,
name|buf
