...
begin_comment
comment|/*  * Copyright (c) 1998, 1999 Sendmail, Inc. and its suppliers.  *	All rights reserved.  *  * By using this file, you agree to the terms and conditions set  * forth in the LICENSE file which can be found at the top level of  * the sendmail distribution.  *  */
end_comment
...
index|[]
init|=
literal|"@(#)$Id: control.c,v 8.44.14.7 2000/07/03 21:49:05 geir Exp $"
decl_stmt|;
end_decl_stmt
