...
index|[]
init|=
literal|"@(#)readcf.c	8.235 (Berkeley) 8/18/1998"
decl_stmt|;
end_decl_stmt
...
if|#
directive|if
name|_FFR_MAX_HEADER_LINES
define|#
directive|define
name|O_MAXHDRLINES
value|0xaa
block|{
literal|"MaxHeaderLines"
block|,
name|O_MAXHDRLINES
block|,
name|FALSE
...
name|printf
argument_list|(
literal|"Warning: MaxHeaderLines: header line limit set lower than 50\n"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|printf
argument_list|(
literal|"Warning: MaxHeaderLines: header line length limit set lower than %d\n"
argument_list|,
name|MAXHDRLINELEN
argument_list|)
expr_stmt|;
