...
index|[]
init|=
literal|"@(#)readcf.c	8.230 (Berkeley) 6/5/98"
decl_stmt|;
end_decl_stmt
...
name|syserr
argument_list|(
literal|"readcf: option TrustedFileOwner: unknown user %s"
argument_list|,
name|val
argument_list|)
expr_stmt|;
...
name|syserr
argument_list|(
literal|"readcf: option TrustedFileOwner: uid value (%ld)> UID_MAX (%ld)"
argument_list|,
name|TrustedFileUid
argument_list|,
name|UID_MAX
