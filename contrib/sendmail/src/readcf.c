...
directive|endif
comment|/* !_FFR_DEPRECATE_IPC_MAILER_ARG */
condition|)
block|{
name|printf
argument_list|(
...
name|syserr
argument_list|(
literal|"readcf: option TrustedUser: can not be used on systems which do not support fchown()"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
directive|if
name|_FFR_ALLOW_SASLINFO
comment|/* 		**  Allow users to select their own authinfo file. 		**  However, this is not a "perfect" solution. 		**  If mail is queued, the authentication info 		**  will not be used in subsequent delivery attempts. 		**  If we really want to support this, then it has 		**  to be stored in the queue file. 		*/
if|if
condition|(
operator|!
name|bitset
...
name|syserr
argument_list|(
literal|"Error: %s only allowed with -U\n"
argument_list|,
name|o
operator|->
name|o_name
...
name|syserr
argument_list|(
literal|"ClientPortOptions (O option) set but DAEMON not compiled in"
argument_list|)
expr_stmt|;
endif|#
directive|endif
