...
name|SM_RCSID
argument_list|(
literal|"@(#)$Id: domain.c,v 8.181.2.1 2002/06/27 16:55:04 ca Exp $ (with name server)"
argument_list|)
end_macro
...
name|SM_RCSID
argument_list|(
literal|"@(#)$Id: domain.c,v 8.181.2.1 2002/06/27 16:55:04 ca Exp $ (without name server)"
argument_list|)
end_macro
