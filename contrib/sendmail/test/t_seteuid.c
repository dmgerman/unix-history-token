...
begin_comment
comment|/*  * Copyright (c) 1999-2001 Proofpoint, Inc. and its suppliers.  *	All rights reserved.  *  * By using this file, you agree to the terms and conditions set  * forth in the LICENSE file which can be found at the top level of  * the sendmail distribution.  *  */
end_comment
...
index|[]
init|=
literal|"@(#)$Id: t_seteuid.c,v 8.9 2013-11-22 20:52:01 ca Exp $"
decl_stmt|;
end_decl_stmt
