...
index|[]
init|=
literal|"@(#)$Id: t_setuid.c,v 1.1.1.2 2002/02/17 21:56:43 gshapiro Exp $"
decl_stmt|;
end_decl_stmt
...
name|printf
argument_list|(
literal|"setuid(1) failure\n"
argument_list|)
expr_stmt|;
name|printuids
argument_list|(
literal|"after setuid(1)"
argument_list|,
literal|1
argument_list|,
literal|1
...
name|printf
argument_list|(
literal|"MAYDAY!  setuid(0) succeeded (should have failed)\n"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|printf
argument_list|(
literal|"setuid(0) failed (this is correct)\n"
argument_list|)
expr_stmt|;
block|}
name|printuids
argument_list|(
literal|"after setuid(0)"
argument_list|,
literal|1
argument_list|,
literal|1
