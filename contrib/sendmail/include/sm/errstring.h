...
begin_comment
comment|/*  * Copyright (c) 1998-2001, 2003 Proofpoint, Inc. and its suppliers.  *	All rights reserved.  *  * By using this file, you agree to the terms and conditions set  * forth in the LICENSE file which can be found at the top level of  * the sendmail distribution.  *  *	$Id: errstring.h,v 1.11 2013-11-22 20:51:31 ca Exp $  */
end_comment
