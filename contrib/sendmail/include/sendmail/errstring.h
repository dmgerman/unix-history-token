...
begin_comment
comment|/*  * Copyright (c) 1998-2000 Sendmail, Inc. and its suppliers.  *	All rights reserved.  *  * By using this file, you agree to the terms and conditions set  * forth in the LICENSE file which can be found at the top level of  * the sendmail distribution.  *  *  *	$Id: errstring.h,v 8.6.4.1 2000/05/26 18:24:13 geir Exp $  */
end_comment

begin_comment
comment|/* **  ERRSTRING.H -- Error codes. */
end_comment
