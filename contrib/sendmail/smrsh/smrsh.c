...
begin_comment
comment|/*  * Copyright (c) 1998 Sendmail, Inc.  All rights reserved.  * Copyright (c) 1993 Eric P. Allman.  All rights reserved.  * Copyright (c) 1993  *	The Regents of the University of California.  All rights reserved.  *  * By using this file, you agree to the terms and conditions set  * forth in the LICENSE file which can be found at the top level of  * the sendmail distribution.  *  */
end_comment
...
index|[]
init|=
literal|"@(#)smrsh.c	8.11 (Berkeley) 5/19/1998"
decl_stmt|;
end_decl_stmt
