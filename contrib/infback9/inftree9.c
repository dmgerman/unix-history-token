...
begin_comment
comment|/* inftree9.c -- generate Huffman trees for efficient decoding  * Copyright (C) 1995-2013 Mark Adler  * For conditions of distribution and use, see copyright notice in zlib.h  */
end_comment
...
specifier|const
name|char
name|inflate9_copyright
index|[]
init|=
literal|" inflate9 1.2.8 Copyright 1995-2013 Mark Adler "
decl_stmt|;
end_decl_stmt
...
init|=
block|{
comment|/* Distance codes 0..31 base */
literal|1
block|,
literal|2
block|,
...
init|=
block|{
comment|/* Distance codes 0..31 extra */
literal|128
block|,
literal|128
block|,
