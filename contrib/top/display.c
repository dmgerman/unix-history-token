...
begin_comment
comment|/*  *  *_arc(stats) - print "ARC: " followed by the ARC summary string  *  *  Assumptions:  cursor is on "lastline"  *                for i_arc ONLY: cursor is on the previous line  */
end_comment
...
begin_comment
comment|/*  *  *_carc(stats) - print "Compressed ARC: " followed by the summary string  *  *  Assumptions:  cursor is on "lastline"  *                for i_carc ONLY: cursor is on the previous line  */
end_comment
...
begin_comment
comment|/*  * Trim a header string to the current display width and return a newly  * allocated area with the trimmed header.  */
end_comment
...
expr_stmt|;
block|}
comment|/* is this number a ratio? */
elseif|else
if|if
condition|(
name|thisname
