...
begin_comment
comment|/* parameters for decimal64s */
end_comment

begin_define
define|#
directive|define
name|DECIMAL64_Bytes
value|8
end_define
...
define|#
directive|define
name|DECIMAL64_Ehigh
value|(DECIMAL64_Emax+DECIMAL64_Bias-DECIMAL64_Pmax+1)
end_define
...
begin_comment
comment|/* Decimal 64-bit type, accessible by bytes */
end_comment
...
index|]
decl_stmt|;
comment|/* decimal64: 1, 5, 8, 50 bits */
block|}
name|decimal64
typedef|;
end_typedef
...
begin_comment
comment|/* Macros for accessing decimal64 fields.  These assume the argument      is a reference (pointer) to the decimal64 structure */
end_comment
...
define|#
directive|define
name|decimal64ExpCon
parameter_list|(
name|d
parameter_list|)
value|((((d)->bytes[0]& 0x03)<<6)         \                                | ((unsigned)(d)->bytes[1]>>2))
end_define
...
begin_comment
comment|/* This assumes range has been checked and exponent previously 0; type */
end_comment

begin_comment
comment|/* of exponent must be unsigned */
end_comment

begin_define
define|#
directive|define
name|decimal64SetExpCon
parameter_list|(
name|d
parameter_list|,
name|e
parameter_list|)
value|{                                  \     (d)->bytes[0]|=(uint8_t)((e)>>6);                                 \     (d)->bytes[1]|=(uint8_t)(((e)&0x3F)<<2);}
end_define
...
define|#
directive|define
name|decimal64ToEngString
value|__decimal64ToEngString
end_define
