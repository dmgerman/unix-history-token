...
begin_comment
comment|/* This module comprises the routines for decimal128 format numbers.  */
end_comment
...
begin_comment
comment|/* we need decNumbers with space for 34 */
end_comment
...
begin_comment
comment|/* decimal128FromNumber -- convert decNumber to decimal128            */
end_comment
...
begin_comment
comment|/*   ds is the target decimal128                                      */
end_comment
...
begin_comment
comment|/* rounding mode (used if the coefficient is more than DECIMAL128_Pmax*/
end_comment
...
comment|/* rounding must be done before we generate the decimal128] */
block|}
name|DEC_clear
argument_list|(
name|d128
...
begin_comment
comment|/* decimal128ToNumber -- convert decimal128 to decNumber              */
end_comment

begin_comment
comment|/*   d128 is the source decimal128                                    */
end_comment
...
comment|/* make a copy of the decimal128, with an extra bunch which has */
...
begin_comment
comment|/*   decimal128ToString(d128, string);                                */
end_comment

begin_comment
comment|/*   decimal128ToEngString(d128, string);                             */
end_comment
...
begin_comment
comment|/*  d128 is the decimal128 format number to convert                   */
end_comment
...
begin_comment
comment|/*   decimal128FromString(result, string, set);                       */
end_comment
...
begin_comment
comment|/*  result  is the decimal128 format number which gets the result of  */
end_comment
...
begin_comment
comment|/* If an error occurs, the result will be a valid decimal128 NaN.     */
end_comment
...
begin_comment
comment|/* decimal128Show -- display a single in hexadecimal [debug aid]      */
end_comment

begin_comment
comment|/*   d128 -- the number to show                                       */
end_comment
