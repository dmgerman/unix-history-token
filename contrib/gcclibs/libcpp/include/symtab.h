...
name|entries
decl_stmt|;
comment|/* Call back, allocate a node.  */
name|hashnode
function_decl|(
modifier|*
name|alloc_node
...
parameter_list|)
function_decl|;
comment|/* Call back, allocate something that hangs off a node like a cpp_macro.        NULL means use the usual allocator.  */
name|void
modifier|*
function_decl|(
modifier|*
...
name|collisions
decl_stmt|;
comment|/* Should 'entries' be freed when it is no longer needed?  */
name|bool
name|entries_owned
decl_stmt|;
block|}
