...
begin_comment
comment|/* cygwin has realpath, so it won't get here.  */
end_comment
...
block|{
comment|/* The file system is case-preserving but case-insensitive, 	   Canonicalize to lowercase, using the codepage associated 	   with the process locale.  */
name|CharLowerBuff
argument_list|(
name|buf
argument_list|,
