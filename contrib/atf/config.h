...
begin_comment
comment|/* Define to 1 if getcwd(NULL, 0) works */
end_comment
...
begin_comment
comment|/* Define to 1 if getopt allows a + sign for POSIX behavior */
end_comment
...
begin_comment
comment|/* Define to the copyright string applicable to this package. */
end_comment

begin_define
define|#
directive|define
name|PACKAGE_COPYRIGHT
value|"Copyright (c) 2007-2012 The NetBSD Foundation, Inc."
end_define
...
directive|define
name|PACKAGE_NAME
value|"Automated Testing Framework"
end_define
