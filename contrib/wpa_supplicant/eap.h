...
begin_comment
comment|/*  * EAP peer state machine functions (RFC 4137)  * Copyright (c) 2004-2006, Jouni Malinen<j@w1.fi>  *  * This program is free software; you can redistribute it and/or modify  * it under the terms of the GNU General Public License version 2 as  * published by the Free Software Foundation.  *  * Alternatively, this software may be distributed under the terms of BSD  * license.  *  * See README and COPYING for more details.  */
end_comment
...
parameter_list|)
function_decl|;
comment|/** 	 * notify_pending - Notify that a pending request can be retried 	 * @ctx: eapol_ctx from eap_sm_init() call 	 * 	 * An EAP method can perform a pending operation (e.g., to get a 	 * response from an external process). Once the response is available, 	 * this callback function can be used to request EAPOL state machine to 	 * retry delivering the previously received (and still unanswered) EAP 	 * request to EAP state machine. 	 */
name|void
function_decl|(
modifier|*
name|notify_pending
