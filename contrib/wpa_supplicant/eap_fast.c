...
begin_comment
comment|/* TODO:  * - encrypt PAC-Key in the PAC file  * - test session resumption and enable it if it interoperates  */
end_comment
...
begin_comment
comment|/* draft-cam-winget-eap-fast-00.txt, 6.2 EAP-FAST Authentication Phase 1 */
end_comment
...
comment|/* RC4-128-SHA */
name|u8
name|client_write_MAC_secret
index|[
literal|20
index|]
decl_stmt|;
name|u8
name|server_write_MAC_secret
index|[
literal|20
index|]
decl_stmt|;
...
index|]
decl_stmt|;
comment|/* u8 client_write_IV[0]; */
comment|/* u8 server_write_IV[0]; */
name|u8
...
begin_comment
comment|/* draft-cam-winget-eap-fast-00.txt, 7.3 EAP-FAST Provisioning Exchange */
end_comment
...
decl_stmt|;
name|u8
name|client_write_IV
index|[
literal|16
index|]
decl_stmt|;
name|u8
name|server_write_IV
index|[
literal|16
index|]
decl_stmt|;
...
name|MSG_INFO
argument_list|,
literal|"EAP-FAST: No PAC file '%s' - assume no "
literal|"PAC entries have been provisioned"
argument_list|,
name|pac_file
argument_list|)
expr_stmt|;
...
name|MSG_INFO
argument_list|,
literal|"EAP-FAST: Failed to open PAC file '%s' "
literal|"for writing"
argument_list|,
name|pac_file
argument_list|)
...
name|MSG_INFO
argument_list|,
literal|"EAP-FAST: TLS errors detected"
argument_list|)
expr_stmt|;
name|ret
operator|->
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-FAST: Received packet(len=%lu) - "
...
name|MSG_INFO
argument_list|,
literal|"EAP-FAST: Short frame with TLS "
literal|"length"
argument_list|)
expr_stmt|;
name|ret
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-FAST: TLS Message Length: %d"
argument_list|,
name|tls_msg_len
argument_list|)
expr_stmt|;
