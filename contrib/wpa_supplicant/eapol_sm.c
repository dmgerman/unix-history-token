...
begin_comment
comment|/* IEEE 802.1aa/D6.1 - Supplicant */
end_comment
...
index|]
decl_stmt|;
comment|/* Miscellaneous variables (not defined in IEEE 802.1aa/D6.1) */
name|Boolean
name|changed
decl_stmt|;
name|struct
...
name|MSG_MSGDUMP
argument_list|,
literal|"EAPOL: Port Timers tick - authWhile=%d "
literal|"heldWhile=%d startWhen=%d idleWhile=%d"
argument_list|,
name|sm
operator|->
name|authWhile
...
condition|)
block|{
comment|/* IEEE 802.1X-REV specifies that least significant Key Length 		 * octets from MS-MPPE-Send-Key are used as the key if the key 		 * data is not present. This seems to be meaning the beginning 		 * of the MS-MPPE-Send-Key. In addition, MS-MPPE-Send-Key in 		 * Supplicant corresponds to MS-MPPE-Recv-Key in Authenticator. 		 * Anyway, taking the beginning of the keying material from EAP 		 * seems to interoperate with Authenticators. */
name|key_len
operator|=
name|be_to_host16
argument_list|(
...
name|len
argument_list|,
literal|"heldPeriod=%d\n"
literal|"authPeriod=%d\n"
literal|"startPeriod=%d\n"
literal|"maxStart=%d\n"
...
literal|"dot1xSuppHeldPeriod=%d\n"
literal|"dot1xSuppAuthPeriod=%d\n"
literal|"dot1xSuppStartPeriod=%d\n"
literal|"dot1xSuppMaxStart=%d\n"
literal|"dot1xSuppSuppControlledPortStatus=%s\n"
literal|"dot1xSuppBackendPaeState=%d\n"
literal|"dot1xSuppEapolFramesRx=%d\n"
literal|"dot1xSuppEapolFramesTx=%d\n"
literal|"dot1xSuppEapolStartFramesTx=%d\n"
literal|"dot1xSuppEapolLogoffFramesTx=%d\n"
literal|"dot1xSuppEapolRespFramesTx=%d\n"
literal|"dot1xSuppEapolReqIdFramesRx=%d\n"
literal|"dot1xSuppEapolReqFramesRx=%d\n"
literal|"dot1xSuppInvalidEapolFramesRx=%d\n"
literal|"dot1xSuppEapLengthErrorFramesRx=%d\n"
literal|"dot1xSuppLastEapolFrameVersion=%d\n"
