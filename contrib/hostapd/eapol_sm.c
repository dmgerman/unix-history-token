...
literal|"IEEE 802.1X: "
name|MACSTR
literal|" Port Timers TICK "
literal|"(timers: %d %d %d)\n"
argument_list|,
name|MAC2STR
argument_list|(
name|state
...
name|prev_ctrl_dir
decl_stmt|;
comment|/* FIX: could re-run eapol_sm_step from registered timeout (after 	 * 0 sec) to make sure that other possible timeouts/events are 	 * processed */
name|memcpy
argument_list|(
name|addr
argument_list|,
