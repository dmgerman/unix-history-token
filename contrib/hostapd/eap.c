...
begin_comment
comment|/**  * eap_set_eapRespData - Set EAP response (eapRespData)  * @sm: Pointer to EAP state machine allocated with eap_sm_init()  * @eapRespData: EAP-Response payload from the supplicant  * @eapRespDataLen: Length of eapRespData in bytes  *  * This function is called when an EAP-Response is received from a supplicant.  */
end_comment
...
begin_comment
comment|/**  * eap_sm_notify_cached - Notify EAP state machine of cached PMK  * @sm: Pointer to EAP state machine allocated with eap_sm_init()  *  * This function is called when PMKSA caching is used to skip EAP  * authentication.  */
end_comment
...
begin_comment
comment|/**  * eap_sm_pending_cb - EAP state machine callback for a pending EAP request  * @sm: Pointer to EAP state machine allocated with eap_sm_init()  *  * This function is called when data for a pending EAP-Request is received.  */
end_comment
...
begin_comment
comment|/**  * eap_sm_method_pending - Query whether EAP method is waiting for pending data  * @sm: Pointer to EAP state machine allocated with eap_sm_init()  * Returns: 1 if method is waiting for pending data or 0 if not  */
end_comment
