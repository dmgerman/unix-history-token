...
parameter_list|)
function_decl|;
comment|/** 	 * set_8021x - enable/disable 802.1x support 	 * @priv: driver private data 	 * @enabled: 1 = enable, 0 = disable 	 * 	 * Returns: 0 on success, -1 on failure 	 * 	 * Configure the kernel driver to enable/disable 802.1x support. 	 * This may be an empty function if 802.1x support is always enabled. 	 */
name|int
function_decl|(
modifier|*
name|set_ieee8021x
