...
name|argv
argument_list|,
literal|"+abcdefhilnpstuw0123456789BHNRC:D:F:I:L:U:V:W:k:r:"
argument_list|,
name|longopts
argument_list|,
operator|&
...
name|fname
decl_stmt|;
comment|/* Initialize these solely to avoid warnings from gcc -Wall about        variables that might be used uninitialized.  */
name|tmp
operator|=
name|NULL
expr_stmt|;
