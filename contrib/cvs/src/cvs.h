...
begin_comment
comment|/*  * basic information used in all source files  *  * $FreeBSD$  */
end_comment
...
begin_comment
comment|/* Define CVSROOT_DFLT to a fallback value for CVSROOT.  * #undef	CVSROOT_DFL  */
end_comment
...
begin_comment
comment|/* The only place this is currently used outside of update.c is add.c.  * Restricting its use to update.c seems to be in the best interest of  * modularity, but I can't think of a good way to get an update of a  * resurrected file done and print the fact otherwise.  */
end_comment
...
begin_comment
comment|/* Get a write lock for the history file.  */
end_comment
...
begin_comment
comment|/* Get a write lock for the val-tags file.  */
end_comment
...
begin_comment
comment|/* TODO: can the finfo argument to special_file_mismatch be changed? -twp */
end_comment
