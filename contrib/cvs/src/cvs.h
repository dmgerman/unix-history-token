...
begin_comment
comment|/* Set if CVS does _not_ need to create a CVS/Root file upon    completion of this command.  The name is confusing, both because    the meaning is closer to "does not use working directory" than    "uses working directory" and because the flag isn't really as    general purpose as it seems (cvs release sets it).  */
end_comment
...
begin_comment
comment|/* #define	RCSBIN_DFLT		   Set by options.h */
end_comment
