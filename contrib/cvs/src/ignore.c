...
condition|)
continue|continue;
comment|/* If we have used up all the space, add some more.  Do this before 	   processing `!', since an "empty" list still contains the `CVS' 	   entry.  */
if|if
condition|(
name|ign_count
operator|>=
...
literal|1
expr_stmt|;
comment|/* Always ignore the "CVS" directory.  */
name|ign_list
index|[
literal|0
index|]
...
begin_comment
comment|/* Return true if the given filename should be ignored by update or import,  * else return false.  */
end_comment
