...
begin_comment
comment|/* Set to 1 if ignore file patterns should be matched in a case-insensitive    fashion.  */
end_comment
...
begin_comment
comment|/*  * Process the current directory, looking for files not in ILIST and not on  * the global ignore list for this directory.  If we find one, call PROC  * passing it the name of the file and the update dir.  */
end_comment
