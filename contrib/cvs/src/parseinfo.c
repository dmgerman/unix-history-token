...
begin_comment
comment|/*  * Copyright (C) 1986-2008 The Free Software Foundation, Inc.  *  * Portions Copyright (C) 1998-2005 Derek Price, Ximbiot<http://ximbiot.com>,  *                                  and others.  *  * Portions Copyright (C) 1992, Brian Berliner and Jeff Polk  * Portions Copyright (C) 1989-1992, Brian Berliner  *   * You may distribute under the terms of the GNU General Public License as  * specified in the README file that comes with the CVS source distribution.  *  * $FreeBSD$  */
end_comment
...
decl_stmt|;
name|int
name|ignore_unknown_config_keys
init|=
literal|0
decl_stmt|;
...
name|line
argument_list|,
literal|"IgnoreUnknownConfigKeys"
argument_list|)
operator|==
literal|0
condition|)
...
literal|0
argument_list|,
literal|"%s: unrecognized value '%s' for '%s'"
argument_list|,
name|infopath
argument_list|,
name|p
