...
name|server_active
condition|)
comment|/* FIXME: This should probably be sysloged since it doesn't 		 * have anywhere else to go at this point. 		 */
name|error
argument_list|(
literal|0
argument_list|,
literal|0
argument_list|,
literal|"dying gasps from client unexpected"
argument_list|)
expr_stmt|;
else|else
endif|#
