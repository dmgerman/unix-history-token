...
directive|if
literal|0
comment|/* FIXME: I've fixed this so that the correct arguments are called,         but now this fails because there is code below this point that        uses optarg values extracted from the arg vector. */
block|free_names (&xmodargc, xmodargv);
endif|#
directive|endif
