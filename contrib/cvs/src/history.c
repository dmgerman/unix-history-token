...
literal|"        -x ["
name|ALL_HISTORY_REC_TYPES
literal|"] Extract by record type\n"
block|,
...
name|logoff
condition|)
comment|/* History is turned off by noexec or 				 * readonlyfs. 				 */
return|return;
if|if
condition|(
name|strchr
...
literal|0
argument_list|,
literal|"save_user: too many users"
argument_list|)
expr_stmt|;
return|return;
block|}
...
literal|0
argument_list|,
literal|"save_file: too many files"
argument_list|)
expr_stmt|;
return|return;
block|}
...
literal|0
argument_list|,
literal|"save_module: too many modules"
argument_list|)
expr_stmt|;
return|return;
block|}
