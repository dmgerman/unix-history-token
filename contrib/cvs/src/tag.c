...
init|=
block|{
literal|"Usage: %s %s [-lRF] [-b] [-d] [-r tag|-D date] tag [files...]\n"
block|,
...
block|}
comment|/* We didn't find the tag in val-tags, so look through all the RCS files        to see whether it exists there.  Yes, this is expensive, but there        is no other way to cope with a tag which might have been created        by an old version of CVS, from before val-tags was invented.  */
name|the_val_args
operator|.
name|name
operator|=
