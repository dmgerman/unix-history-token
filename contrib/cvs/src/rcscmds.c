...
begin_comment
comment|/*  * Copyright (C) 1986-2005 The Free Software Foundation, Inc.  *  * Portions Copyright (C) 1998-2005 Derek Price, Ximbiot<http://ximbiot.com>,  *                                  and others.  *  * Portions Copyright (C) 1992, Brian Berliner and Jeff Polk  * Portions Copyright (C) 1989-1992, Brian Berliner  *   * You may distribute under the terms of the GNU General Public License as  * specified in the README file that comes with the CVS source distribution.  *   * The functions in this file provide an interface for performing   * operations directly on RCS files.   *  * $FreeBSD$  */
end_comment
...
label|:
block|{
comment|/* Call CVS_UNLINK() below rather than unlink_file to avoid the check 	 * for noexec. 	 */
if|if
condition|(
name|tmpfile1
operator|!=
...
directive|endif
comment|/* The first arg to call_diff_setup is used only for error reporting. */
name|call_diff_setup
argument_list|(
literal|"diff"
argument_list|,
