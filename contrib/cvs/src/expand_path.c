...
begin_comment
comment|/* This routine will expand the pathname to account for ~ and $     characters as described above.  If an error occurs, an error     message is printed via error() and NULL is returned.  FILE and     LINE are the filename and linenumber to include in the error     message.  */
end_comment
...
literal|0
argument_list|,
literal|"%s:%d: unrecognized varaible syntax %s"
argument_list|,
name|file
argument_list|,
name|line
...
literal|0
argument_list|,
literal|"%s: unrecognized varaible syntax %s"
argument_list|,
name|file
argument_list|,
name|name
