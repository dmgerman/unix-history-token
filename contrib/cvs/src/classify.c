...
operator|||
operator|(
comment|/* ...clearing stickies...  */
name|aflag
comment|/* ...and...  */
operator|&&
operator|(
comment|/* ...there used to be a tag which subs in Name keys...  */
operator|(
name|vers
operator|->
name|entdata
...
argument_list|)
operator|)
comment|/* ...or there used to be a keyword mode which may be 		 * changed by -A... 		 */
operator|||
operator|(
name|strlen
argument_list|(
...
operator|&&
operator|(
comment|/* ...the tag is changing in a way that affects Name keys...  */
operator|(
name|vers
operator|->
name|entdata
