...
condition|)
block|{
comment|/* apparently the string terminator 			 * or a digit has been escaped... 		         */
return|return
literal|0
return|;
block|}
...
argument_list|)
block|{
comment|/* there is no string representation for TSIG rrs */
return|return
name|LDNS_STATUS_NOT_IMPL
return|;
block|}
