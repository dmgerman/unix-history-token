...
operator|==
name|WIN32C
comment|/* 	 * If the Windows console is using UTF-8, we'll use it too. 	 */
if|if
condition|(
name|GetConsoleOutputCP
argument_list|()
...
begin_comment
comment|/*  * Skip bytes until a UTF-8 lead byte (11xxxxxx) or ASCII byte (0xxxxxxx) is found.  */
end_comment
...
condition|)
block|{
comment|/* 		 * Consider it binary if it can't be converted. 		 */
name|BOOL
name|used_default
init|=
name|TRUE
