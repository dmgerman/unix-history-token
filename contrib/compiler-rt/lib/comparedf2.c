...
begin_comment
comment|//===-- lib/comparedf2.c - Double-precision comparisons -----------*- C -*-===//
end_comment
...
begin_comment
comment|// // This file implements the following soft-float comparison routines:
end_comment
...
begin_comment
comment|//   __eqdf2   __gedf2   __unorddf2
end_comment

begin_comment
comment|//   __ledf2   __gtdf2
end_comment
...
begin_comment
comment|//   __ledf2(a,b) returns -1 if a< b
end_comment
...
begin_comment
comment|//   __gedf2(a,b) returns -1 if a< b
end_comment
...
begin_comment
comment|//   __unorddf2(a,b) returns 0 if both a and b are numbers
end_comment
...
begin_comment
comment|// Note that __ledf2( ) and __gedf2( ) are identical except in their handling of
end_comment
...
comment|// a and b as signed integers as we would with a floating-point compare.
if|if
condition|(
operator|(
name|aInt
...
begin_comment
comment|// The following are alternative names for the preceeding routines.
end_comment
