...
begin_comment
comment|// When serviced by the secondary, the chunk comes from a mmap allocation
end_comment

begin_comment
comment|// and will be zero'd out anyway. We only need to clear our the chunk if
end_comment

begin_comment
comment|// it was serviced by the primary, hence using the rounded up 'size'.
end_comment
