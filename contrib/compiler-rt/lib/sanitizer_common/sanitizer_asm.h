...
define|#
directive|define
name|ASM_TYPE_FUNCTION
parameter_list|(
name|symbol
parameter_list|)
value|.type symbol, @function
end_define
...
name|symbol
parameter_list|)
value|.size symbol, .-symbol
end_define

begin_define
define|#
directive|define
name|ASM_TSAN_SYMBOL
parameter_list|(
name|symbol
parameter_list|)
value|symbol
...
define|#
directive|define
name|ASM_TSAN_SYMBOL_INTERCEPTOR
parameter_list|(
name|symbol
parameter_list|)
value|symbol
