...
begin_comment
comment|/* Win32 doesn't have fork() */
end_comment
...
begin_comment
comment|/* MSDOS doesn't have `fork', so we need to simulate the pipe by running    the programs in sequence with standard streams redirected fot and    from temporary files. */
end_comment
