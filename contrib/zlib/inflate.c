...
begin_comment
comment|/* inflate.c -- zlib decompression  * Copyright (C) 1995-2016 Mark Adler  * For conditions of distribution and use, see copyright notice in zlib.h  */
end_comment
...
name|HEAD
expr_stmt|;
comment|/* to pass state test in inflateReset2() */
name|ret
operator|=
name|inflateReset2
argument_list|(
...
name|Z_STREAM_ERROR
return|;
comment|/* check for correct dictionary identifier */
if|if
condition|(
name|state
operator|->
...
return|;
block|}
comment|/* copy dictionary to window using updatewindow(), which will amend the        existing dictionary if appropriate */
name|ret
operator|=
name|updatewindow
argument_list|(
