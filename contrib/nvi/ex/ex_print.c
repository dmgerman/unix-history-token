...
index|[]
init|=
literal|"$Id: ex_print.c,v 10.26 2013/11/02 02:11:07 zy Exp $"
decl_stmt|;
end_decl_stmt
...
argument_list|)
expr_stmt|;
comment|/* 			 * Start a new line if the last character does not fit 			 * into the current line.  The implicit new lines are 			 * not interruptible. 			 */
if|if
condition|(
name|col
operator|+
