...
index|[]
init|=
literal|"$Id: cut.c,v 10.12 2012/02/11 15:52:33 zy Exp $"
decl_stmt|;
end_decl_stmt
...
block|{
comment|/* 		 * Get the first line.  A length of ENTIRE_LINE causes 		 * cut_line to cut from the MARK to the end of the line. 		 */
if|if
condition|(
name|cut_line
argument_list|(
