...
begin_comment
comment|/* fitblk.c contains minimal changes required to be compiled with zlibWrapper:  * - #include "zlib.h" was changed to #include "zstd_zlibwrapper.h"  * - writing block to stdout was disabled                          */
end_comment
...
name|LOG_FITBLK
argument_list|(
literal|"partcompress1 avail_in=%d total_in=%d avail_out=%d total_out=%d\n"
argument_list|,
operator|(
name|int
operator|)
...
name|LOG_FITBLK
argument_list|(
literal|"partcompress2 ret=%d avail_in=%d total_in=%d avail_out=%d total_out=%d\n"
argument_list|,
name|ret
argument_list|,
operator|(
...
name|LOG_FITBLK
argument_list|(
literal|"recompress1inflate avail_in=%d total_in=%d avail_out=%d total_out=%d\n"
argument_list|,
operator|(
name|int
operator|)
...
name|LOG_FITBLK
argument_list|(
literal|"recompress2inflate avail_in=%d total_in=%d avail_out=%d total_out=%d\n"
argument_list|,
operator|(
name|int
operator|)
...
name|LOG_FITBLK
argument_list|(
literal|"recompress1deflate avail_in=%d total_in=%d avail_out=%d total_out=%d\n"
argument_list|,
operator|(
name|int
operator|)
...
name|LOG_FITBLK
argument_list|(
literal|"recompress2deflate ret=%d avail_in=%d total_in=%d avail_out=%d total_out=%d\n"
argument_list|,
name|ret
argument_list|,
operator|(
...
name|LOG_FITBLK
argument_list|(
literal|"partcompress1 total_in=%d total_out=%d\n"
argument_list|,
operator|(
name|int
operator|)
...
name|printf
argument_list|(
literal|"partcompress total_in=%d total_out=%d\n"
argument_list|,
operator|(
name|int
operator|)
...
name|avail_out
expr_stmt|;
comment|//     if (fwrite(blk, 1, have, stdout) != have || ferror(stdout))
comment|//         quit("error writing output");
...
name|LOG_FITBLK
argument_list|(
literal|"recompress1 inf.total_in=%d def.total_out=%d\n"
argument_list|,
operator|(
name|int
operator|)
...
name|LOG_FITBLK
argument_list|(
literal|"recompress2 inf.total_in=%d def.total_out=%d\n"
argument_list|,
operator|(
name|int
operator|)
