...
define|#
directive|define
name|LZ4F_ENABLE_OBSOLETE_ENUMS
end_define
...
begin_comment
comment|/*-************************************ *  Signal (Ctrl-C trapping) **************************************/
end_comment
...
argument_list|)
expr_stmt|;
comment|/* this invocation generates a buggy warning in Visual Studio */
endif|#
directive|endif
if|if
condition|(
...
literal|0
condition|)
comment|/* when src is stdin, fileSize==0, but is effectively unknown */
...
argument_list|)
expr_stmt|;
comment|/* note : fileSize==0 means "empty" */
elif|#
directive|elif
name|defined
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* note : fileSize==0 means "unknown" */
else|#
directive|else
name|CHECK
argument_list|(
...
name|header
decl_stmt|;
comment|/* No special help for these errors */
if|if
condition|(
...
condition|)
return|return;
comment|/* Try to decode the frame header */
name|ret
operator|=
...
literal|1
argument_list|,
literal|"%s : Window size larger than maximum : %llu> %u\n"
argument_list|,
name|srcFileName
argument_list|,
name|header
...
literal|1
argument_list|,
literal|"%s : Use --long=%u or --memory=%uMB\n"
argument_list|,
name|srcFileName
argument_list|,
name|windowLog
...
literal|1
argument_list|,
literal|"%s : Error decoding frame header to read window size : %s\n"
argument_list|,
name|srcFileName
argument_list|,
name|ZSTD_getErrorName
...
literal|1
argument_list|,
literal|"%s : Window log larger than ZSTD_WINDOWLOG_MAX=%u not supported\n"
argument_list|,
name|srcFileName
argument_list|,
name|ZSTD_WINDOWLOG_MAX
...
literal|20
expr_stmt|;
comment|/* display last 20 characters only */
...
argument_list|)
expr_stmt|;
comment|/* Header loading : ensures ZSTD_getFrameHeader() will succeed */
block|{
name|size_t
specifier|const
name|toDecode
...
argument_list|)
expr_stmt|;
comment|/* error should not happen */
return|return
literal|1
return|;
block|}
...
argument_list|)
condition|)
comment|/* special case : don't remove() stdout */
name|remove
argument_list|(
name|dstFileName
argument_list|)
expr_stmt|;
comment|/* remove decompression artefact; note don't do anything special if remove() fails */
else|else
block|{
...
name|stdoutmark
argument_list|)
comment|/* special case : don't chmod stdout */
operator|&&
name|strcmp
argument_list|(
name|dstFileName
...
name|nulmark
argument_list|)
comment|/* special case : don't chmod /dev/null */
operator|&&
name|stat_result
condition|)
comment|/* file permissions correctly extracted from src */
name|UTIL_setFileStat
argument_list|(
name|dstFileName
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* transfer file permissions from src into dst */
block|}
name|signal
argument_list|(
name|SIGINT
...
begin_comment
comment|/* **************************************************************************  *  .zst file info (--list command)  ***************************************************************************/
end_comment
...
begin_comment
comment|/** getFileInfo() :  *  Reads information from file, stores in *info  * @return : 0 if successful  *           1 for frame analysis error  *           2 for file not compressed with zstd  *           3 for cases in which file could not be opened.  */
end_comment
...
name|DISPLAY
argument_list|(
literal|"Error: could not decode frame header\n"
argument_list|)
expr_stmt|;
name|detectError
operator|=
...
name|DISPLAY
argument_list|(
literal|"Error: unsupported block type \n"
argument_list|)
expr_stmt|;
name|detectError
operator|=
...
name|DISPLAYOUT
argument_list|(
literal|"%6d  %5d  %7.2f %2s  %9.2f %2s  %5.3f  %5s  %s\n"
argument_list|,
name|info
operator|->
name|numSkippableFrames
...
name|DISPLAYOUT
argument_list|(
literal|"Window Size: %.2f %2s (%llu B)\n"
argument_list|,
name|windowSizeUnit
argument_list|,
name|unitStr
...
name|DISPLAYOUT
argument_list|(
literal|"Compressed Size: %.2f %2s (%llu B)\n"
argument_list|,
name|compressedSizeUnit
argument_list|,
name|unitStr
...
name|DISPLAYOUT
argument_list|(
literal|"Decompressed Size: %.2f %2s (%llu B)\n"
argument_list|,
name|decompressedSizeUnit
argument_list|,
name|unitStr
...
name|DISPLAY
argument_list|(
literal|"An error occurred while getting file info \n"
argument_list|)
expr_stmt|;
block|}
elseif|else
...
name|DISPLAYOUT
argument_list|(
literal|"File %s not compressed by zstd \n"
argument_list|,
name|inFileName
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|/* error occurred while opening the file */
if|if
condition|(
name|displayLevel
operator|>
...
name|DISPLAYOUT
argument_list|(
literal|"Frames  Skips  Compressed  Uncompressed  Ratio  Check  Filename\n"
argument_list|)
expr_stmt|;
block|}
block|{
...
name|DISPLAYOUT
argument_list|(
literal|"%6d  %5d  %7.2f %2s                       %5s  %u files\n"
argument_list|,
name|total
operator|.
name|numSkippableFrames
...
name|DISPLAYOUT
argument_list|(
literal|"%6d  %5d  %7.2f %2s  %9.2f %2s  %5.3f  %5s  %u files\n"
argument_list|,
name|total
operator|.
name|numSkippableFrames
