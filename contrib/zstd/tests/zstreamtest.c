...
modifier|...
parameter_list|)
value|if (g_displayLevel>=l) {                     \                                   DISPLAY(__VA_ARGS__);                    \                                   if (g_displayLevel>=4) fflush(stderr); }
end_define
...
argument_list|)
expr_stmt|;
comment|/* context size functions */
name|DISPLAYLEVEL
argument_list|(
literal|3
argument_list|,
literal|"test%3i : estimate CStream size : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
name|cParams
argument_list|)
comment|/* uses ZSTD_initCStream_usingDict() */
operator|+
...
literal|3
argument_list|,
literal|"test%3i : check actual CStream size : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
expr_stmt|;
block|}
comment|/* Attempt bad compression parameters */
name|DISPLAYLEVEL
argument_list|(
literal|3
argument_list|,
literal|"test%3i : use bad compression parameters : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
literal|5
argument_list|,
literal|" ( ZSTD_decompressStream => %u ) "
argument_list|,
operator|(
name|U32
operator|)
...
literal|3
argument_list|,
literal|"test%3i : estimate DStream size : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
name|windowSize
argument_list|)
comment|/* uses ZSTD_initDStream_usingDict() */
operator|+
...
literal|3
argument_list|,
literal|"test%3i : check actual DStream size : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
literal|3
argument_list|,
literal|"test%3i : ZSTD_initCStream_usingCDict_advanced with masked dictID : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
literal|3
argument_list|,
literal|"test%3i : try retrieving dictID from frame : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
literal|3
argument_list|,
literal|"test%3i : decompress without dictionary : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
name|_output_error
goto|;
comment|/* must fail : dictionary not used */
name|DISPLAYLEVEL
argument_list|(
literal|3
argument_list|,
...
literal|3
argument_list|,
literal|"test%3i : compress with ZSTD_CCtx_refPrefix : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
literal|3
argument_list|,
literal|"test%3i : decompress with dictionary : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
literal|3
argument_list|,
literal|"test%3i : decompress without dictionary (should fail): "
argument_list|,
name|testNb
operator|++
argument_list|)
...
literal|3
argument_list|,
literal|"test%3i : compress again with ZSTD_compress_generic : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
literal|3
argument_list|,
literal|"test%3i : decompress without dictionary (should work): "
argument_list|,
name|testNb
operator|++
argument_list|)
...
expr_stmt|;
block|}
comment|/* Empty srcSize */
name|DISPLAYLEVEL
argument_list|(
literal|3
argument_list|,
literal|"test%3i : ZSTD_initCStream_advanced with pledgedSrcSize=0 and dict : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
expr_stmt|;
block|}
comment|/* cstream advanced shall write content size = 0 */
name|inBuff
operator|.
name|src
operator|=
...
name|NULL
argument_list|,
literal|"ZSTD_createCStream : allocation error"
argument_list|)
expr_stmt|;
name|resetAllowed
operator|=
...
name|NULL
argument_list|,
literal|"ZSTD_createDStream : allocation error"
argument_list|)
expr_stmt|;
name|CHECK_Z
argument_list|(
...
literal|5
argument_list|,
literal|"Creating new context with %u threads \n"
argument_list|,
name|nbThreads
argument_list|)
expr_stmt|;
...
argument|zc==NULL
argument_list|,
literal|"ZSTDMT_createCCtx allocation error"
argument_list|)
name|resetAllowed
operator|=
literal|0
...
literal|5
argument_list|,
literal|"Init with windowLog = %u and pledgedSrcSize = %u \n"
argument_list|,
name|params
operator|.
name|cParams
...
argument_list|)
argument_list|,
literal|"ZSTDMT_endStream error : %s"
argument_list|,
name|ZSTD_getErrorName
argument_list|(
name|remainingToFlush
...
literal|5
argument_list|,
literal|"Frame completed : %u bytes \n"
argument_list|,
operator|(
name|U32
operator|)
...
literal|5
argument_list|,
literal|"ZSTD_decompressStream input %u bytes \n"
argument_list|,
operator|(
name|U32
operator|)
...
begin_comment
comment|/* Tests for ZSTD_compress_generic() API */
end_comment

begin_function
specifier|static
name|int
name|fuzzerTests_newAPI
parameter_list|(
name|U32
name|seed
parameter_list|,
...
name|NULL
argument_list|,
literal|"ZSTD_createCCtx allocation error"
argument_list|)
expr_stmt|;
name|resetAllowed
operator|=
...
argument_list|)
decl_stmt|;
comment|/* mess with compression parameters */
name|cParams
operator|.
name|windowLog
operator|+=
...
argument_list|)
expr_stmt|;
comment|/* unconditionally set, to be sync with decoder */
if|if
condition|(
name|FUZ_rand
argument_list|(
...
condition|)
block|{
comment|/* test that compression parameters are rejected (correctly) after loading a non-NULL dictionary */
name|size_t
specifier|const
name|setError
init|=
...
argument_list|)
argument_list|,
literal|"ZSTD_CCtx_setParameter should have failed"
argument_list|)
expr_stmt|;
block|}
block|}
...
expr_stmt|;
block|}
comment|/* mess with frame parameters */
if|if
condition|(
name|FUZ_rand
argument_list|(
...
literal|5
argument_list|,
literal|"compress consumed %u bytes (total : %u) \n"
argument_list|,
operator|(
name|U32
operator|)
...
literal|5
argument_list|,
literal|"End-flush into dst buffer of size %u \n"
argument_list|,
operator|(
name|U32
operator|)
...
argument_list|)
argument_list|,
literal|"ZSTD_compress_generic w/ ZSTD_e_end error : %s"
argument_list|,
name|ZSTD_getErrorName
argument_list|(
name|remainingToFlush
...
literal|5
argument_list|,
literal|"resetting DCtx (dict:%08X) \n"
argument_list|,
operator|(
name|U32
operator|)
...
literal|5
argument_list|,
literal|"ZSTD_decompressStream input %u bytes (pos:%u/%u)\n"
argument_list|,
operator|(
name|U32
operator|)
...
break|break;
comment|/* error correctly detected */
comment|/* Good so far, but no more progress possible */
if|if
condition|(
name|outBuff
operator|.
