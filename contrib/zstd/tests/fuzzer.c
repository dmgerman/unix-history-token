...
literal|4
argument_list|,
literal|"test%3i : Loading rawContent starting with dict header w/ ZSTD_dm_auto should fail : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
literal|4
argument_list|,
literal|"test%3i : Loading rawContent starting with dict header w/ ZSTD_dm_rawContent should pass : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
literal|4
argument_list|,
literal|"test%3i : magic-less format test : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
literal|4
argument_list|,
literal|"test%3i : decompress normally (should fail) : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
literal|4
argument_list|,
literal|"test%3i : decompress with magic-less instruction : "
argument_list|,
name|testNb
operator|++
argument_list|)
...
literal|4
argument_list|,
literal|"OK : regenerated %u bytes \n"
argument_list|,
operator|(
name|U32
operator|)
...
comment|/* ensure memory requirement is good enough (should always be true) */
block|{
name|ZSTD_frameHeader
name|zfh
decl_stmt|;
...
argument_list|)
argument_list|,
literal|"ZSTD_getFrameHeader(): error retrieving frame information"
argument_list|)
expr_stmt|;
block|{
name|size_t
...
operator|)
argument_list|,
literal|"ZSTD_decodingBufferSize_min() requires more memory (%u) than necessary (%u)"
argument_list|,
operator|(
name|U32
operator|)
