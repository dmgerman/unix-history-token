...
begin_comment
comment|/*! ZSTD_resetCCtx_internal() :     note : `params` must be validated */
end_comment
...
literal|5
argument_list|,
literal|"ZSTD_resetCCtx_internal : dictIDFlag : %u \n"
argument_list|,
operator|!
name|fParams
operator|.
...
literal|5
argument_list|,
literal|"ZSTD_writeFrameHeader : dictIDFlag : %u \n"
argument_list|,
operator|!
name|params
operator|.
...
literal|5
argument_list|,
literal|"ZSTD_writeFrameHeader : dictID : %u \n"
argument_list|,
name|dictID
argument_list|)
expr_stmt|;
...
literal|5
argument_list|,
literal|"ZSTD_writeFrameHeader : dictIDSizeCode : %u \n"
argument_list|,
name|dictIDSizeCode
argument_list|)
expr_stmt|;
...
argument_list|)
return|;
comment|/* dict as zstd dictionary */
return|return
name|ZSTD_loadZstdDictionary
argument_list|(
name|cctx
...
argument_list|)
return|;
comment|/* does not support NULL cdict */
name|DEBUGLOG
argument_list|(
literal|5
argument_list|,
literal|"ZSTD_compressBegin_usingCDict_advanced : dictIDFlag == %u \n"
argument_list|,
operator|!
name|fParams
operator|.
...
name|CHECK_F
argument_list|(
argument|ZSTD_copyCCtx_internal(cctx, cdict->refContext, fParams, pledgedSrcSize)
argument_list|)
else|else
block|{
name|ZSTD_parameters
...
literal|5
argument_list|,
literal|"ZSTD_resetCStream_internal : dictIDFlag == %u \n"
argument_list|,
operator|!
name|zcs
operator|->
...
name|CHECK_F
argument_list|(
argument|ZSTD_compressBegin_usingCDict_advanced(zcs->cctx, zcs->cdict, zcs->params.fParams, pledgedSrcSize)
argument_list|)
else|else
name|CHECK_F
argument_list|(
...
literal|5
argument_list|,
literal|"ZSTD_resetCStream : dictIDFlag == %u \n"
argument_list|,
operator|!
name|zcs
operator|->
...
begin_comment
comment|/* ZSTD_initCStream_internal() :  * params are supposed validated at this stage  * and zcs->cdict is supposed to be correct */
end_comment

begin_function
specifier|static
name|size_t
name|ZSTD_initCStream_stage2
parameter_list|(
name|ZSTD_CStream
modifier|*
name|zcs
...
literal|5
argument_list|,
literal|"ZSTD_initCStream_stage2 : dictIDFlag == %u \n"
argument_list|,
operator|!
name|params
operator|.
...
literal|5
argument_list|,
literal|"ZSTD_initCStream_internal : dictIDFlag == %u \n"
argument_list|,
operator|!
name|params
operator|.
...
literal|5
argument_list|,
literal|"ZSTD_initCStream_advanced : dictIDFlag == %u \n"
argument_list|,
operator|!
name|params
operator|.
