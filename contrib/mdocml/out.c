...
begin_comment
comment|/*	$Id: out.c,v 1.43 2011/09/20 23:05:49 schwarze Exp $ */
end_comment
...
block|}
block|}
comment|/*  	 * Calculate width of the spanners.  These get one space for a 	 * vertical line, two for a double-vertical line.  	 */
for|for
control|(
init|;
name|hp
