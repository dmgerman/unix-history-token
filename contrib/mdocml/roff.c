...
begin_comment
comment|/*	$Id: roff.c,v 1.324 2017/07/14 17:16:16 schwarze Exp $ */
end_comment
...
begin_comment
comment|/* Types of definitions of macros and strings. */
end_comment
...
begin_comment
comment|/* Renamed standard macro. */
end_comment
...
directive|define
name|ROFFDEF_ANY
value|(ROFFDEF_USER | ROFFDEF_PRE | \ 			 ROFFDEF_REN | ROFFDEF_STD)
end_define
...
name|last_eqn
decl_stmt|;
comment|/* equation parser */
name|struct
name|eqn_node
modifier|*
name|eqn
decl_stmt|;
comment|/* active equation parser */
name|int
name|eqn_inline
decl_stmt|;
...
name|deftype
decl_stmt|;
comment|/* type of definition to paste */
name|int
name|rcsid
decl_stmt|;
comment|/* kind of RCS id seen */
name|char
name|term
decl_stmt|;
...
condition|)
continue|continue;
comment|/* Comment found, look for RCS id. */
name|rcsid
operator|=
literal|0
expr_stmt|;
...
expr_stmt|;
block|}
comment|/* Handle trailing whitespace. */
name|cp
operator|=
name|strchr
argument_list|(
...
condition|)
block|{
comment|/* Before appending, ... */
case|case
name|ROFFDEF_PRE
case|:
comment|/* copy predefined to user-defined. */
name|roff_setstrn
argument_list|(
operator|&
name|r
...
name|ROFFDEF_REN
case|:
comment|/* call original standard macro. */
name|csz
operator|=
name|mandoc_asprintf
argument_list|(
...
name|ROFFDEF_STD
case|:
comment|/* rename and call standard macro. */
name|rsz
operator|=
name|mandoc_asprintf
argument_list|(
