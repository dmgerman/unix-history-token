...
begin_comment
comment|/*	$Id: mdoc_argv.c,v 1.82 2012/03/23 05:50:24 kristaps Exp $ */
end_comment
...
name|ARGV_OPT_SINGLE
comment|/* optional arg (e.g., -offset [xxx]) */
block|}
enum|;
end_enum
...
return|;
block|}
comment|/*  	 * Process a quoted literal.  A quote begins with a double-quote 	 * and ends with a double-quote NOT preceded by a double-quote. 	 * Whitespace is NOT involved in literal termination. 	 */
if|if
condition|(
name|MDOC_PHRASELIT
operator|&
