...
begin_comment
comment|/*	$Id: main.c,v 1.262 2016/01/08 02:53:13 schwarze Exp $ */
end_comment
...
name|warnx
argument_list|(
literal|"outdated mandoc.db lacks %s(%s) entry, run makewhatis %s"
argument_list|,
name|name
argument_list|,
name|sec
...
break|break;
block|}
comment|/* For more(1) and less(1), use the tag file. */
if|if
condition|(
operator|(
name|cmdlen
...
literal|0
case|:
comment|/* Set pgrp in both parent and child to avoid racing exec. */
operator|(
name|void
operator|)
name|setpgid
