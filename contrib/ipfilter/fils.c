...
index|[]
init|=
literal|"@(#)$Id: fils.c,v 2.21.2.17 2001/07/19 12:24:09 darrenr Exp $"
decl_stmt|;
end_decl_stmt
...
name|argv
argument_list|,
literal|"6aACfghIilnoqstvd:D:M:P:S:T:"
argument_list|)
operator|)
operator|!=
operator|-
...
name|argv
argument_list|,
literal|"6aACfghIilnostvd:D:M:P:S:T:"
argument_list|)
operator|)
operator|!=
operator|-
...
name|printf
argument_list|(
literal|"\tName: %-8s Header Length: %2d SAP: %s (%04x)\n"
argument_list|,
name|qif
operator|.
name|qf_name
