...
index|[]
init|=
literal|"@(#)$Id: fils.c,v 2.21.2.45 2004/04/10 11:45:48 darrenr Exp $"
decl_stmt|;
end_decl_stmt
...
name|PRINTF
argument_list|(
literal|"fragment state(in):\tkept %lu\tlost %lu\tnot fragmented %lu\n"
argument_list|,
name|fp
operator|->
name|f_st
...
name|PRINTF
argument_list|(
literal|"fragment state(out):\tkept %lu\tlost %lu\tnot fragmented %lu\n"
argument_list|,
name|fp
operator|->
name|f_st
...
name|PRINTF
argument_list|(
literal|"%s id %d ttl %d pr %d seen0 %d ifp %p tos %#02x = fl %#x\n"
argument_list|,
name|hostname
argument_list|(
literal|4
