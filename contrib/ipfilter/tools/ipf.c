...
begin_comment
comment|/* XXX	The following was added to satisfy a rescue/rescue/ build    XXX	requirement.  */
end_comment
...
name|argv
argument_list|,
literal|"46Ac:dDEf:F:Il:m:noPrRsT:vVyzZ"
argument_list|)
operator|)
operator|!=
operator|-
...
name|stderr
argument_list|,
literal|"IPv6 rules are no longer seperate\n"
argument_list|)
expr_stmt|;
block|}
elseif|else
...
name|printf
argument_list|(
literal|"%d state entries removed\n"
argument_list|,
name|fl
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"%d filter rules removed\n"
argument_list|,
name|fl
argument_list|)
expr_stmt|;
