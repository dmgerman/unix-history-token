...
index|[]
init|=
literal|"@(#)$Id: ipsyncs.c,v 1.5.2.4 2006/08/26 11:21:15 darrenr Exp $"
decl_stmt|;
end_decl_stmt
...
name|stderr
argument_list|,
literal|"Usage: %s<destination IP><destination port> [remote IP]\n"
argument_list|,
name|progname
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|/*  			 * XXX currently we do not check the source address 			 * of a datagram, this can be a security risk 			 */
name|n1
operator|=
name|read
argument_list|(
