...
begin_comment
comment|/*  * XXX need to declare boolean_t for _KERNEL<sys/files.h>  * which ends up including<sys/device.h> for vax.  See PR#32907  * for further details.  */
end_comment
...
name|PAUSE
parameter_list|()
value|ts.tv_sec = 0; ts.tv_nsec = 10000000; \ 		  (void) nanosleep(&ts, NULL)
end_define
