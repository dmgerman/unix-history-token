...
begin_comment
comment|/*    perl.h  *  *    Copyright (c) 1987-1997, Larry Wall  *  *    You may distribute under the terms of either the GNU General Public  *    License or the Artistic License, as specified in the README file.  *  */
end_comment
...
name|s
parameter_list|)
value|if (PL_tainting) { taint_proper(no_security, s); }
end_define
