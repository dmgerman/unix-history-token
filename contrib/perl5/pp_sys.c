...
begin_comment
comment|/*    pp_sys.c  *  *    Copyright (c) 1991-1997, Larry Wall  *  *    You may distribute under the terms of either the GNU General Public  *    License or the Artistic License, as specified in the README file.  *  */
end_comment
...
begin_comment
comment|/* XXX Configure test needed.    h_errno might not be a simple 'int', especially for multi-threaded    applications.  HOST_NOT_FOUND is typically defined in<netdb.h>. */
end_comment
...
begin_endif
unit|PP(pp_indread) {     PL_last_in_gv = gv_fetchpv(SvPVx(GvSV((GV*)(*PL_stack_sp--)), PL_na), TRUE,SVt_PVIO);     return do_readline(); }
endif|#
directive|endif
end_endif
...
block|{
comment|/* Not clear why we don't call perl_call_method here too. 	 * perhaps to get different error message ? 	 */
name|stash
operator|=
name|gv_stashsv
argument_list|(
...
name|warn
argument_list|(
literal|"untie attempted while %lu inner references still exist"
argument_list|,
operator|(
name|unsigned
name|long
...
operator|==
literal|0x12345678
comment|/* XXX Configure test needed. */
if|#
directive|if
name|defined
argument_list|(
...
name|warn
argument_list|(
literal|"printf on closed filehandle %s"
argument_list|,
name|SvPV
argument_list|(
name|sv
...
name|DIE
argument_list|(
literal|"POSIX setpgrp can't take an argument"
argument_list|)
expr_stmt|;
name|SETi
argument_list|(
