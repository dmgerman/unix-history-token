...
begin_comment
comment|/*    op.c  *  *    Copyright (c) 1991-2000, Larry Wall  *  *    You may distribute under the terms of either the GNU General Public  *    License or the Artistic License, as specified in the README file.  *  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* XXXXX share in a pvtable? */
name|Safefree
argument_list|(
name|CopSTASHPV
argument_list|(
...
condition|)
block|{
comment|/* only counting characters */
if|if
condition|(
name|t
operator|==
...
block|{
comment|/* straight latin-1 translation */
if|if
condition|(
name|tlen
operator|==
...
name|yyerror
argument_list|(
literal|"Lvalue subs returning arrays not implemented yet"
argument_list|)
expr_stmt|;
else|else
name|yyerror
argument_list|(
literal|"Lvalue subs returning hashes not implemented yet"
argument_list|)
expr_stmt|;
empty_stmt|;
block|}
