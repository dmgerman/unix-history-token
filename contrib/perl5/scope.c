...
begin_comment
comment|/*    scope.c  *  *    Copyright (c) 1991-1999, Larry Wall  *  *    You may distribute under the terms of either the GNU General Public  *    License or the Artistic License, as specified in the README file.  *  */
end_comment
...
name|croak
argument_list|(
literal|"panic: leave_scope clearsv"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|Perl_debug_log
argument_list|,
literal|"BLK_EVAL.OLD_EVAL_ROOT = 0x%lx\n"
argument_list|,
operator|(
name|long
operator|)
...
name|Perl_debug_log
argument_list|,
literal|"BLK_LOOP.REDO_OP = 0x%lx\n"
argument_list|,
operator|(
name|long
operator|)
...
name|Perl_debug_log
argument_list|,
literal|"BLK_LOOP.NEXT_OP = 0x%lx\n"
argument_list|,
operator|(
name|long
operator|)
...
name|Perl_debug_log
argument_list|,
literal|"BLK_LOOP.LAST_OP = 0x%lx\n"
argument_list|,
operator|(
name|long
operator|)
...
name|Perl_debug_log
argument_list|,
literal|"BLK_LOOP.ITERARY = 0x%lx\n"
argument_list|,
operator|(
name|long
operator|)
...
name|Perl_debug_log
argument_list|,
literal|"BLK_LOOP.ITERVAR = 0x%lx\n"
argument_list|,
operator|(
name|long
operator|)
...
name|Perl_debug_log
argument_list|,
literal|"BLK_LOOP.ITERSAVE = 0x%lx\n"
argument_list|,
operator|(
name|long
operator|)
...
name|Perl_debug_log
argument_list|,
literal|"BLK_LOOP.ITERLVAL = 0x%lx\n"
argument_list|,
operator|(
name|long
operator|)
