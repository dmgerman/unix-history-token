...
begin_comment
comment|/* $RCSfile: str.c,v $$Revision: 4.1 $$Date: 92/08/07 18:29:26 $  *  *    Copyright (c) 1991-2001, Larry Wall  *  *    You may distribute under the terms of either the GNU General Public  *    License or the Artistic License, as specified in the README file.  *  * $Log:	str.c,v $  */
end_comment
