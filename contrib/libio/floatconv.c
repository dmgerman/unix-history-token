...
begin_comment
comment|/* Note that the checking of _DOUBLE_IS_32BITS is for use with the    cross targets that employ the newlib ieeefp.h header.  -- brendan */
end_comment
...
begin_comment
comment|/* Also used for the case when !_DOUBLE_IS_32BITS.  */
end_comment
