...
name|final
block|{
comment|// Temporary state used in processCommands() and assignAddresses()
comment|// that must be reinitialized for each call to the above functions, and must
comment|// not be used outside of the scope of a call to the above functions.
struct|struct
name|AddressState
block|{
name|uint64_t
...
operator|*
operator|>
name|NameToOutputSectionCommand
expr_stmt|;
name|void
name|assignSymbol
parameter_list|(
...
name|OutputSectionCommand
modifier|*
name|createOutputSectionCommand
parameter_list|(
name|StringRef
name|Name
parameter_list|,
...
name|OutputSectionCommand
modifier|*
name|getOrCreateOutputSectionCommand
parameter_list|(
name|StringRef
name|Name
parameter_list|)
