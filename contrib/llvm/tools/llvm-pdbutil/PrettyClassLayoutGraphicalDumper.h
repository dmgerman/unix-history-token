...
begin_comment
comment|//===- PrettyClassLayoutGraphicalDumper.h -----------------------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|LLVM_TOOLS_LLVMPDBDUMP_PRETTYCLASSLAYOUTGRAPHICALDUMPER_H
end_ifndef
...
decl_stmt|;
name|class
name|PrettyClassLayoutGraphicalDumper
range|:
name|public
name|PDBSymDumper
block|{
