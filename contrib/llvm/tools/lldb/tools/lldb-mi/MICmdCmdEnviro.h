...
begin_comment
comment|// Overview:    CMICmdCmdEnvironmentCd          interface.
end_comment
...
begin_comment
comment|//          *this class implements MI command "environment-cd".
end_comment
