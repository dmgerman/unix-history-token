...
block|{
name|eThreadInfoFormat_NoFrames
block|,
name|eThreadInfoFormat_AllFrames
block|}
enum|;
comment|//++ ===================================================================
...
block|{
name|eFrameInfoFormat_NoArguments
block|,
name|eFrameInfoFormat_AllArguments
block|,
name|eFrameInfoFormat_AllArgumentsInSimpleForm
block|}
enum|;
comment|// Typedefs:
name|public
...
specifier|const
name|CMIUtilString
name|m_constStrPrintCharArrayAsString
decl_stmt|;
specifier|const
name|CMIUtilString
name|m_constStrPrintExpandAggregates
decl_stmt|;
specifier|const
name|CMIUtilString
name|m_constStrPrintAggregateFieldNames
decl_stmt|;
comment|// Typedefs:
name|private
label|:
...
function_decl|;
name|bool
name|MIResponseForVariableInfoInternal
argument_list|(
specifier|const
name|VariableInfoFormat_e
name|veVarInfoFormat
