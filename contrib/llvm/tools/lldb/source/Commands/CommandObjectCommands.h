...
ifndef|#
directive|ifndef
name|liblldb_CommandObjectCommands_h_
end_ifndef
...
block|{
comment|//-------------------------------------------------------------------------
comment|// CommandObjectMultiwordCommands
comment|//-------------------------------------------------------------------------
name|class
name|CommandObjectMultiwordCommands
range|:
name|public
...
begin_comment
comment|// liblldb_CommandObjectCommands_h_
end_comment
