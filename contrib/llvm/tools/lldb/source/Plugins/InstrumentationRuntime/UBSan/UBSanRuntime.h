...
begin_comment
comment|//===-- UndefinedBehaviorSanitizerRuntime.h ---------------------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|liblldb_UndefinedBehaviorSanitizerRuntime_h_
end_ifndef
...
block|{
name|class
name|UndefinedBehaviorSanitizerRuntime
range|:
name|public
name|lldb_private
operator|::
...
begin_comment
comment|// liblldb_UndefinedBehaviorSanitizerRuntime_h_
end_comment
