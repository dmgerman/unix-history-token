...
begin_comment
comment|//===-- RegisterContextMach_arm.h -------------------------------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|liblldb_RegisterContextMach_arm_h_
end_ifndef
...
include|#
directive|include
file|"RegisterContextDarwin_arm.h"
end_include

begin_decl_stmt
name|class
name|RegisterContextMach_arm
range|:
name|public
...
begin_comment
comment|// liblldb_RegisterContextMach_arm_h_
end_comment
