...
parameter_list|)
define|\
value|{ #reg, alt, GPR_SIZE(reg), GPR_OFFSET(reg), eEncodingUint, \       eFormatHex, { dwarf_##reg##_powerpc, dwarf_##reg##_powerpc, lldb_kind, LLDB_INVALID_REGNUM, gpr_##reg##_powerpc }, NULL, NULL }
end_define
...
parameter_list|)
define|\
value|{ #reg, NULL, 8, FPR_OFFSET(reg), eEncodingIEEE754, \       eFormatFloat, { dwarf_##reg##_powerpc, dwarf_##reg##_powerpc, lldb_kind, LLDB_INVALID_REGNUM, fpr_##reg##_powerpc }, NULL, NULL }
end_define
...
parameter_list|)
define|\
value|{ #reg, NULL, 16, VMX_OFFSET(reg), eEncodingVector, \       eFormatVectorOfUInt32, { dwarf_##reg##_powerpc, dwarf_##reg##_powerpc, lldb_kind, LLDB_INVALID_REGNUM, vmx_##reg##_powerpc }, NULL, NULL }
end_define
