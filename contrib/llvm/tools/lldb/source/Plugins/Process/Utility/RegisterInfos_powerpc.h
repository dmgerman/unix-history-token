...
parameter_list|)
define|\
value|{ #reg, NULL, 16, VMX_OFFSET(reg), eEncodingVector, \       eFormatVectorOfUInt32, { gcc_dwarf_##reg##_powerpc, gcc_dwarf_##reg##_powerpc, lldb_kind, gdb_##reg##_powerpc, vmx_##reg##_powerpc }, NULL, NULL }
end_define
