...
begin_comment
comment|//===-- RegisterContextPOSIXProcessMonitor_arm64.h --------------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|liblldb_RegisterContextPOSIXProcessMonitor_arm64_H_
end_ifndef
...
begin_decl_stmt
name|class
name|RegisterContextPOSIXProcessMonitor_arm64
range|:
name|public
