...
begin_comment
comment|//===-- RegisterContextPOSIXProcessMonitor_x86.h ----------------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|liblldb_RegisterContextPOSIXProcessMonitor_x86_H_
end_ifndef
...
begin_decl_stmt
name|class
name|RegisterContextPOSIXProcessMonitor_x86_64
range|:
name|public
