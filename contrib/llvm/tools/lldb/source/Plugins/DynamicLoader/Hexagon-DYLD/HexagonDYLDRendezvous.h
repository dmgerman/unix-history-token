...
begin_comment
comment|//===-- HexagonDYLDRendezvous.h ---------------------------------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|liblldb_HexagonDYLDRendezvous_H_
end_ifndef
...
begin_comment
comment|/// @class HexagonDYLDRendezvous
end_comment
...
return|;
block|}
comment|/// Provide the dyld structure address
name|void
name|SetRendezvousAddress
argument_list|(
name|lldb
operator|::
name|addr_t
...
return|;
block|}
comment|/// In hexagon it is possible that we can know the dyld breakpoint without
comment|/// having to find it from the rendezvous structure
comment|///
name|void
name|SetBreakAddress
argument_list|(
name|lldb
operator|::
name|addr_t
...
begin_comment
comment|// liblldb_HexagonDYLDRendezvous_H_
end_comment
