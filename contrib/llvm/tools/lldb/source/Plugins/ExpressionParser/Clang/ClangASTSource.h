...
comment|///     A callback function that returns true given the
...
argument|const clang::DeclContext *DC
argument_list|,
argument|llvm::function_ref<bool(clang::Decl::Kind)> IsKindWeWant
argument_list|,
...
comment|/// type and register it in the right places.
comment|///
comment|/// @param[in] compiler_type
...
begin_comment
comment|// liblldb_ClangASTSource_h_
end_comment
