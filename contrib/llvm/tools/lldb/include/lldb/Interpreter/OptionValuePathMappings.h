...
begin_comment
comment|//===-- OptionValuePathMappings.h -------------------------------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|liblldb_OptionValuePathMappings_h_
end_ifndef
...
name|OptionValuePathMappings
argument_list|(
argument|bool notify_changes
argument_list|)
operator|:
name|OptionValue
argument_list|()
block|,
name|m_path_mappings
argument_list|()
block|,
name|m_notify_changes
argument_list|(
...
begin_comment
comment|// liblldb_OptionValuePathMappings_h_
end_comment
