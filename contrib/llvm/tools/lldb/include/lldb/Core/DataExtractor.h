...
comment|/// @see DataExtractor::Dump()
comment|/// @see DataExtractor::DumpRawHexBytes()
comment|//------------------------------------------------------------------
typedef|typedef
enum|enum
block|{
...
decl_stmt|;
comment|//------------------------------------------------------------------
comment|/// Extract a GNU encoded pointer value from \a *offset_ptr.
comment|///
comment|/// @param[in,out] offset_ptr
comment|///     A pointer to an offset within the data that will be advanced
comment|///     by the appropriate number of bytes if the value is extracted
...
comment|///     unmodified.
comment|///
comment|/// @param[in] eh_ptr_enc
comment|///     The GNU pointer encoding type.
comment|///
comment|/// @param[in] pc_rel_addr
comment|///     The PC relative address to use when the encoding is
comment|///     \c DW_GNU_EH_PE_pcrel.
comment|///
comment|/// @param[in] text_addr
comment|///     The text (code) relative address to use when the encoding is
comment|///     \c DW_GNU_EH_PE_textrel.
comment|///
comment|/// @param[in] data_addr
comment|///     The data relative address to use when the encoding is
comment|///     \c DW_GNU_EH_PE_datarel.
comment|///
comment|/// @return
comment|///     The extracted GNU encoded pointer value.
comment|//------------------------------------------------------------------
name|uint64_t
name|GetGNUEHPointer
argument_list|(
name|lldb
operator|::
name|offset_t
