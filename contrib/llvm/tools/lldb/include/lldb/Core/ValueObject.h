...
argument_list|(
argument|lldb::DynamicValueType dyn = lldb::eNoDynamicValues
argument_list|)
block|{
name|m_use_dynamic
operator|=
...
name|SetSummary
argument_list|(
argument|lldb::TypeSummaryImplSP summary = lldb::TypeSummaryImplSP()
argument_list|)
block|{
name|m_summary_sp
operator|=
...
argument_list|(
argument|bool hide_root_type = false
argument_list|)
block|{
name|m_hide_root_type
operator|=
...
name|SetHideValue
argument_list|(
argument|bool hide_value = false
argument_list|)
block|{
name|m_hide_value
operator|=
