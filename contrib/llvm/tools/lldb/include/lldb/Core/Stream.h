...
block|{
comment|//----------------------------------------------------------------------
comment|/// @class Stream Stream.h "lldb/Core/Stream.h"
...
operator|)
block|,
comment|///< If set, verbose logging is enabled
name|eDebug
init|=
operator|(
literal|1
...
operator|)
block|,
comment|///< If set, debug logging is enabled
name|eAddPrefix
init|=
operator|(
literal|1
...
begin_comment
comment|/// Test if debug logging is enabled.
end_comment
...
begin_comment
comment|//      \b true if the debug flag bit is set in this stream, \b
end_comment
...
begin_comment
comment|/// Test if verbose logging is enabled.
end_comment
...
begin_comment
comment|//      \b true if the verbose flag bit is set in this stream, \b
end_comment
