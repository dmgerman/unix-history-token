...
include|#
directive|include
file|"lldb/Expression/ClangASTSource.h"
end_include
...
block|{
comment|//----------------------------------------------------------------------
comment|/// @class ClangExpressionDeclMap ClangExpressionDeclMap.h "lldb/Expression/ClangExpressionDeclMap.h"
...
comment|/// entities from outside an expression.  The ClangASTSource reports back, listing
comment|/// all possible objects corresponding to a particular name.  But it in turn
comment|/// relies on ClangExpressionDeclMap, which performs several important functions.
comment|///
...
argument_list|,
argument|ClangNamespaceDecl&namespace_decl
argument_list|,
...
block|;
comment|///< True if result persistent variables generated by this expression should stay in memory.
comment|//----------------------------------------------------------------------
...
name|m_sym_ctx
block|;
comment|///< The symbol context to use in finding variables and types.
...
name|m_struct_laid_out
block|;
comment|///< True if the struct has been laid out and the layout is valid (that is, no new fields have been added since).
name|ConstString
name|m_result_name
block|;
...
name|m_object_pointer_type
block|;
comment|///< The type of the "this" variable, if one exists
block|}
block|;
name|std
operator|::
...
argument|NameSearchContext&context
argument_list|,
argument|lldb::ClangExpressionVariableSP&pvar_sp
argument_list|,
argument|unsigned int current_id
argument_list|)
block|;
...
block|;
comment|//------------------------------------------------------------------
comment|/// Copy a C++ class type into the parser's AST context and add a
comment|/// member function declaration to it for the expression.
comment|///
comment|/// @param[in] type
comment|///     The type that needs to be created.
comment|//------------------------------------------------------------------
