...
ifndef|#
directive|ifndef
name|liblldb_FunctionCaller_h_
end_ifndef
...
block|{
comment|//----------------------------------------------------------------------
comment|/// @class FunctionCaller FunctionCaller.h "lldb/Expression/FunctionCaller.h"
comment|/// @brief Encapsulates a function that can be called.
comment|///
comment|/// A given FunctionCaller object can handle a single function signature.
...
comment|///
comment|/// The simplest use of the FunctionCaller is to construct it with a
...
comment|///
comment|/// Any of the methods that take arg_addr_ptr can be passed nullptr, and the
...
comment|///     The address of the structure to write the arguments into.  May
comment|///     be LLDB_INVALID_ADDRESS; if it is, a new structure is allocated
comment|///     and args_addr_ref is pointed at it.
comment|///
...
block|;
comment|//------------------------------------------------------------------
comment|/// Run the function this FunctionCaller was created with.
comment|///
...
comment|///< This will get made in CompileFunction, so it is
comment|///< safe to access it after that.
name|lldb
operator|::
name|ModuleWP
...
begin_comment
comment|// liblldb_FunctionCaller_h_
end_comment
