...
name|protected
label|:
comment|/// The actual logic for handling path diagnostics, as implemented
comment|/// by subclasses of PathDiagnosticConsumer.
name|virtual
name|void
name|HandlePathDiagnosticImpl
parameter_list|(
specifier|const
name|PathDiagnostic
modifier|*
...
operator|*
operator|>
name|LocationOrAnalysisContext
expr_stmt|;
name|class
...
argument_list|,
argument|LocationOrAnalysisContext LAC = (AnalysisContext*)
literal|0
argument_list|)
specifier|const
expr_stmt|;
...
argument|const SourceManager&sm
argument_list|,
argument|LocationOrAnalysisContext lac
argument_list|)
operator|:
name|K
argument_list|(
