...
expr|}
block|;
comment|/// \brief Pseudo-location SVal used by the ExprEngine to simulate a "load" or
comment|/// "store" of an ObjC property for the dot syntax.
name|class
name|ObjCPropRef
operator|:
name|public
