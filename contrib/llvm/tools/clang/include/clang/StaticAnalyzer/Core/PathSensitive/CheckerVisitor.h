...
ifndef|#
directive|ifndef
name|LLVM_CLANG_GR_CHECKERVISITOR
end_ifndef
...
include|#
directive|include
file|"clang/StaticAnalyzer/Core/PathSensitive/Checker.h"
end_include
...
include|#
directive|include
file|"clang/StaticAnalyzer/Core/PathSensitive/CheckerVisitor.def"
block|}
block|}
name|void
name|PostVisit
...
parameter_list|)
define|\
value|void PreVisit ## NAME(CheckerContext&C, const NAME* S) {\   static_cast<ImplClass*>(this)->PreVisit ## FALLBACK(C, S);\ }
define|#
directive|define
name|POSTVISIT
parameter_list|(
...
parameter_list|)
define|\
value|void PostVisit ## NAME(CheckerContext&C, const NAME* S) {\   static_cast<ImplClass*>(this)->PostVisit ## FALLBACK(C, S);\ }
include|#
directive|include
file|"clang/StaticAnalyzer/Core/PathSensitive/CheckerVisitor.def"
block|}
