...
ifndef|#
directive|ifndef
name|LLVM_CLANG_GR_VALUESTATE_H
end_ifndef
...
block|}
empty_stmt|;
comment|/// \class Stores the dynamic type information.
comment|/// Information about type of an object at runtime. This is used by dynamic
comment|/// dispatch implementation.
name|class
