...
block|}
block|;
comment|/// Clang versions with different platform ABI conformance.
block|enum
name|class
name|ClangABI
block|{
comment|/// Attempt to be ABI-compatible with code generated by Clang 3.8.x
comment|/// (SVN r257626). This causes<1 x long long> to be passed in an
comment|/// integer register instead of an SSE register on x64_64.
name|Ver3_8
block|,
comment|/// Attempt to be ABI-compatible with code generated by Clang 4.0.x
comment|/// (SVN r291814). This causes move operations to be ignored when
comment|/// determining whether a class type can be passed or returned directly.
name|Ver4
block|,
comment|/// Conform to the underlying platform's C and C++ ABIs as closely
comment|/// as we can.
name|Latest
block|}
block|;    enum
