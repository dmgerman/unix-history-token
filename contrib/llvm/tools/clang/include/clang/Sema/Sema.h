...
begin_comment
comment|// Sema::FullExpr that needs access to the constructor below.
end_comment
...
begin_comment
comment|/// PushVisibilityAttr - Note that we've entered a context with a
end_comment

begin_comment
comment|/// visibility attribute.
end_comment

begin_function_decl
name|void
name|PushVisibilityAttr
parameter_list|(
specifier|const
name|VisibilityAttr
modifier|*
