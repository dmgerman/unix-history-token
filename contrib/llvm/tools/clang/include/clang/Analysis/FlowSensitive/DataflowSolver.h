...
expr_stmt|;
block|}
comment|// If no edges have been found, it means this is the first time the solver
comment|// has been called on block B, we copy the initialization values (if any)
comment|// as current value for V (which will be used as edge data)
if|if
condition|(
name|noEdges
operator|&&
