...
block|}
empty_stmt|;
comment|/// CGCalleeInfo - Class to encapsulate the information about a callee to be
comment|/// used during the generation of call/invoke instructions.
name|class
name|CGCalleeInfo
block|{
comment|/// \brief The function proto type of the callee.
specifier|const
name|FunctionProtoType
modifier|*
name|CalleeProtoTy
