...
argument|bool
argument_list|,
argument|hasIntegerRepresentation
argument_list|)
end_macro
...
argument|bool
argument_list|,
argument|hasSignedIntegerRepresentation
argument_list|)
end_macro
...
argument|bool
argument_list|,
argument|hasUnsignedIntegerRepresentation
argument_list|)
end_macro
...
argument|bool
argument_list|,
argument|isSignedIntegerOrEnumerationType
argument_list|)
end_macro
...
argument|bool
argument_list|,
argument|isUnsignedIntegerOrEnumerationType
argument_list|)
end_macro
...
begin_comment
comment|// CanProxyAdaptors for arrays are intentionally unimplemented because
end_comment

begin_comment
comment|// they are not safe.
end_comment
...
argument|bool
argument_list|,
argument|hasExtParameterInfos
argument_list|)
name|LLVM_CLANG_CANPROXY_SIMPLE_ACCESSOR
argument_list|(
argument|ArrayRef<FunctionProtoType::ExtParameterInfo>
argument_list|,
argument|getExtParameterInfos
argument_list|)
name|CanQualType
name|getParamType
argument_list|(
...
name|LLVM_CLANG_CANPROXY_SIMPLE_ACCESSOR
argument_list|(
argument|UnaryTransformType::UTTKind
argument_list|,
argument|getUTTKind
argument_list|)
block|}
...
name|LLVM_CLANG_CANPROXY_SIMPLE_ACCESSOR
argument_list|(
argument|const ObjCInterfaceDecl *
argument_list|,
...
argument|bool
argument_list|,
argument|isObjCUnqualifiedId
argument_list|)
name|LLVM_CLANG_CANPROXY_SIMPLE_ACCESSOR
argument_list|(
argument|bool
argument_list|,
argument|isObjCUnqualifiedClass
argument_list|)
name|LLVM_CLANG_CANPROXY_SIMPLE_ACCESSOR
argument_list|(
argument|bool
argument_list|,
argument|isObjCQualifiedId
argument_list|)
name|LLVM_CLANG_CANPROXY_SIMPLE_ACCESSOR
argument_list|(
argument|bool
argument_list|,
argument|isObjCQualifiedClass
argument_list|)
typedef|typedef
