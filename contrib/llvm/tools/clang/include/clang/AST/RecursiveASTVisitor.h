...
parameter_list|)
define|\
value|template<typename Derived>                                                  \   bool RecursiveASTVisitor<Derived>::Traverse##STMT(STMT *S) {                 \     TRY_TO(WalkUpFrom##STMT(S));                                               \     { CODE; }                                                                  \     for (Stmt *SubStmt : S->children()) {                                      \       TRY_TO(TraverseStmt(SubStmt));                                           \     }                                                                          \     return true;                                                               \   }
name|DEF_TRAVERSE_STMT
argument_list|(
argument|GCCAsmStmt
argument_list|,
