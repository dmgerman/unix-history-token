...
name|attr
operator|::
name|FirstInheritableParamAttr
operator|&&
name|A
operator|->
name|getKind
...
name|attr
operator|::
name|LastInheritableParamAttr
return|;
block|}
expr|}
block|;
comment|/// A parameter attribute which changes the argument-passing ABI rule
...
name|llvm_unreachable
argument_list|(
literal|"bad parameter ABI attribute kind"
argument_list|)
expr_stmt|;
block|}
block|}
