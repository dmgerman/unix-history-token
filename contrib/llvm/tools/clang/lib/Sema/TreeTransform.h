...
ifndef|#
directive|ifndef
name|LLVM_CLANG_LIB_SEMA_TREETRANSFORM_H
end_ifndef
...
argument_list|)
block|;
comment|/// \brief Transform the given attribute.
comment|///
comment|/// By default, this routine transforms a statement by delegating to the
comment|/// appropriate TransformXXXAttr function to transform a specific kind
comment|/// of attribute. Subclasses may override this function to transform
comment|/// attributed statements using some other mechanism.
comment|///
comment|/// \returns the transformed attribute
specifier|const
name|Attr
operator|*
name|TransformAttr
...
argument_list|)
block|;
comment|/// \brief Transform the specified attribute.
comment|///
comment|/// Subclasses should override the transformation of attributes with a pragma
comment|/// spelling to transform expressions stored within the attribute.
comment|///
comment|/// \returns the transformed attribute.
define|#
directive|define
...
define|#
directive|define
name|PRAGMA_SPELLING_ATTR
parameter_list|(
name|X
parameter_list|)
define|\
value|const X##Attr *Transform##X##Attr(const X##Attr *R) { return R; }
include|#
directive|include
...
argument_list|,
argument|bool *ArgChanged = nullptr
argument_list|)
block|;
...
return|;
block|}
comment|/// \brief Transform the specified condition.
comment|///
comment|/// By default, this transforms the variable and expression and rebuilds
...
argument|Expr *Expr
argument_list|,
argument|Sema::ConditionKind Kind
argument_list|)
block|;
...
argument_list|,
argument|NamedDecl *FirstQualifierInScope = nullptr
argument_list|)
block|;
...
argument_list|,
argument|Fn TransformExceptionSpec
argument_list|)
block|;
name|bool
name|TransformExceptionSpec
argument_list|(
argument|SourceLocation Loc
argument_list|,
argument|FunctionProtoType::ExceptionSpecInfo&ESI
argument_list|,
argument|SmallVectorImpl<QualType>&Exceptions
argument_list|,
argument|bool&Changed
argument_list|)
block|;
name|StmtResult
...
argument_list|,
argument|const FunctionProtoType::ExtParameterInfo *ParamInfos
argument_list|,
argument|SmallVectorImpl<QualType>&PTypes
argument_list|,
argument|SmallVectorImpl<ParmVarDecl *> *PVars
argument_list|,
argument|Sema::ExtParameterInfoBuilder&PInfos
argument_list|)
block|;
...
argument_list|)
block|;
comment|/// \brief Build an Objective-C object type.
comment|///
comment|/// By default, performs semantic analysis when building the object type.
comment|/// Subclasses may override this routine to provide different behavior.
name|QualType
name|RebuildObjCObjectType
argument_list|(
argument|QualType BaseType
argument_list|,
argument|SourceLocation Loc
argument_list|,
argument|SourceLocation TypeArgsLAngleLoc
argument_list|,
argument|ArrayRef<TypeSourceInfo *> TypeArgs
argument_list|,
argument|SourceLocation TypeArgsRAngleLoc
argument_list|,
argument|SourceLocation ProtocolLAngleLoc
argument_list|,
argument|ArrayRef<ObjCProtocolDecl *> Protocols
argument_list|,
argument|ArrayRef<SourceLocation> ProtocolLocs
argument_list|,
argument|SourceLocation ProtocolRAngleLoc
argument_list|)
block|;
comment|/// \brief Build a new Objective-C object pointer type given the pointee type.
comment|///
comment|/// By default, directly builds the pointer type, with no additional semantic
comment|/// analysis.
name|QualType
...
begin_comment
comment|/// \brief Build a new pipe type given its value type.
end_comment

begin_function_decl
name|QualType
name|RebuildPipeType
parameter_list|(
name|QualType
name|ValueType
parameter_list|,
...
begin_comment
comment|/// \brief Build a new co_return statement.
end_comment
...
begin_comment
comment|/// \brief Build a new co_await expression.
end_comment
...
begin_comment
comment|/// \brief Build a new co_yield expression.
end_comment
...
begin_comment
comment|/// \brief Build a new OpenMP 'simdlen' clause.
end_comment
...
begin_comment
comment|/// \brief Build a new OpenMP 'ordered' clause.
end_comment
...
begin_comment
comment|/// \brief Build a new OpenMP 'depend' pseudo clause.
end_comment
...
begin_comment
comment|/// \brief Build a new OpenMP 'device' clause.
end_comment
...
begin_comment
comment|/// \brief Build a new OpenMP 'map' clause.
end_comment
...
begin_comment
comment|/// \brief Build a new OpenMP 'num_teams' clause.
end_comment
...
begin_comment
comment|/// \brief Build a new OpenMP 'thread_limit' clause.
end_comment
...
name|OMPClause
modifier|*
name|RebuildOMPThreadLimitClause
parameter_list|(
name|Expr
modifier|*
name|ThreadLimit
...
begin_comment
comment|/// \brief Build a new OpenMP 'priority' clause.
end_comment
...
begin_comment
comment|/// \brief Build a new OpenMP 'grainsize' clause.
end_comment
...
name|OMPClause
modifier|*
name|RebuildOMPGrainsizeClause
parameter_list|(
name|Expr
modifier|*
name|Grainsize
...
begin_comment
comment|/// \brief Build a new OpenMP 'num_tasks' clause.
end_comment
...
begin_comment
comment|/// \brief Build a new OpenMP 'hint' clause.
end_comment
...
begin_comment
comment|/// \brief Build a new OpenMP 'dist_schedule' clause.
end_comment
...
name|OMPClause
modifier|*
name|RebuildOMPDistScheduleClause
parameter_list|(
...
begin_comment
comment|/// \brief Build a new OpenMP 'to' clause.
end_comment
...
begin_comment
comment|/// \brief Build a new OpenMP 'from' clause.
end_comment
...
begin_comment
comment|/// Build a new OpenMP 'use_device_ptr' clause.
end_comment
...
name|OMPClause
modifier|*
name|RebuildOMPUseDevicePtrClause
argument_list|(
name|ArrayRef
operator|<
name|Expr
...
begin_comment
comment|/// Build a new OpenMP 'is_device_ptr' clause.
end_comment
...
name|OMPClause
modifier|*
name|RebuildOMPIsDevicePtrClause
argument_list|(
name|ArrayRef
operator|<
name|Expr
...
begin_comment
comment|/// \brief Build a new array section expression.
end_comment
...
begin_function
name|ExprResult
name|RebuildOMPArraySectionExpr
parameter_list|(
name|Expr
modifier|*
name|Base
...
begin_comment
comment|/// \brief Build a new implicit construction via inherited constructor
end_comment
...
begin_function
name|ExprResult
name|RebuildCXXInheritedCtorInitExpr
parameter_list|(
name|QualType
name|T
parameter_list|,
...
begin_comment
comment|// If this is copy-initialization, we only need to reconstruct
end_comment
...
begin_comment
comment|// If the initialization implicitly converted an initializer list to a
end_comment

begin_comment
comment|// std::initializer_list object, unwrap the std::initializer_list too.
end_comment
...
condition|)
block|{
comment|// This was a variable declaration's initialization for which no initializer
...
argument_list|()
operator|&&
literal|"no parens or braces but have direct init with arguments?"
argument_list|)
expr_stmt|;
return|return
name|ExprEmpty
...
operator|>
operator|::
name|TransformAdjustedType
argument_list|(
argument|TypeLocBuilder&TLB
argument_list|,
argument|AdjustedTypeLoc TL
argument_list|)
block|{
comment|// Adjustments applied during transformation are handled elsewhere.
return|return
name|getDerived
argument_list|()
operator|.
...
begin_comment
comment|// If we had to adjust the pointee type when building a member pointer, make
end_comment

begin_comment
comment|// sure to push TypeLoc info for it.
end_comment
...
name|this
block|;
comment|// Work around gcc.gnu.org/PR56135.
return|return
name|getDerived
argument_list|()
operator|.
...
begin_comment
comment|// Handle extended parameter information.
end_comment
...
argument_list|)
block|;
comment|// Instantiate a dynamic noexcept expression, if any.
if|if
condition|(
name|ESI
operator|.
...
name|true
return|;
comment|// FIXME: This is bogus, a noexcept expression is not a condition.
name|NoexceptExpr
operator|=
name|getSema
argument_list|()
...
name|diag
operator|::
name|err_noexcept_needs_constant_expression
argument_list|,
comment|/*AllowFold*/
name|false
argument_list|)
...
begin_comment
comment|// Instantiate a dynamic exception specification's type.
end_comment
...
argument_list|)
expr_stmt|;
comment|// Determine whether the set of unexpanded parameter packs can and
comment|// should
comment|// be expanded.
name|bool
name|Expand
...
argument_list|()
expr_stmt|;
comment|// FIXME: Track the location of the ellipsis (and track source location
comment|// information for the types in the exception specification in general).
if|if
condition|(
name|getDerived
argument_list|()
...
condition|)
block|{
comment|// We can't expand this pack expansion into separate arguments yet;
comment|// just substitute into the pattern and create a new pack expansion
comment|// type.
name|Sema
operator|::
name|ArgumentPackSubstitutionIndexRAII
...
continue|continue;
block|}
comment|// Substitute into the pack expansion pattern for each slice of the
comment|// pack.
for|for
control|(
name|unsigned
...
operator|>
operator|::
name|TransformPipeType
argument_list|(
argument|TypeLocBuilder&TLB
argument_list|,
argument|PipeTypeLoc TL
argument_list|)
block|{
name|QualType
name|ValueType
...
argument_list|()
return|;
comment|// Check whether we can add nullability; it is only represented as
comment|// type sugar, and therefore cannot be diagnosed in any other way.
if|if
condition|(
name|auto
name|nullability
...
name|diag
operator|::
name|err_nullability_nonpointer
argument_list|)
operator|<<
...
begin_comment
comment|// Transform type arguments.
end_comment
...
argument_list|()
return|;
comment|// If nothing changed, just keep the old TypeSourceInfo.
if|if
condition|(
name|NewTypeArg
operator|==
...
condition|)
block|{
comment|// Transform attributes with a pragma spelling by calling TransformXXXAttr.
define|#
directive|define
name|ATTR
parameter_list|(
...
parameter_list|)
define|\
value|case attr::X:                                                                \     return getDerived().Transform##X##Attr(cast<X##Attr>(R));
include|#
directive|include
file|"clang/Basic/AttrList.inc"
default|default:
...
name|Attrs
block|;
comment|// Visit attributes and keep track if any are transformed.
for|for
control|(
specifier|const
specifier|auto
...
begin_comment
comment|// If this is a constexpr if, determine which arm we should instantiate.
end_comment
...
begin_comment
comment|// In OpenMP loop region loop control variable must be captured and be
end_comment

begin_comment
comment|// private. Perform analysis of first part (if any).
end_comment
...
operator|>
operator|::
name|TransformCoroutineBodyStmt
argument_list|(
argument|CoroutineBodyStmt *S
argument_list|)
block|{
comment|// The coroutine body should be re-formed by the caller if necessary.
return|return
name|getDerived
argument_list|()
operator|.
...
operator|>
operator|::
name|TransformCoreturnStmt
argument_list|(
argument|CoreturnStmt *S
argument_list|)
block|{
name|ExprResult
name|Result
...
begin_comment
comment|// Always rebuild; we don't know if this needs to be injected into a new
end_comment

begin_comment
comment|// context or if the promise type has changed.
end_comment
...
operator|>
operator|::
name|TransformCoawaitExpr
argument_list|(
argument|CoawaitExpr *E
argument_list|)
block|{
name|ExprResult
name|Result
...
operator|>
operator|::
name|TransformCoyieldExpr
argument_list|(
argument|CoyieldExpr *E
argument_list|)
block|{
name|ExprResult
name|Result
...
operator|>
operator|::
name|TransformMSPropertySubscriptExpr
argument_list|(
argument|MSPropertySubscriptExpr *E
argument_list|)
block|{
name|auto
name|BaseRes
...
operator|>
operator|::
name|TransformSEHLeaveStmt
argument_list|(
argument|SEHLeaveStmt *S
argument_list|)
block|{
return|return
name|S
...
begin_comment
comment|// OpenMP directive transformation
end_comment
...
name|TransformOMPExecutableDirective
argument_list|(
argument|OMPExecutableDirective *D
argument_list|)
block|{
...
begin_comment
comment|// Transform directive name for 'omp critical' directive.
end_comment
...
operator|>
operator|::
name|TransformOMPSimdDirective
argument_list|(
argument|OMPSimdDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPForDirective
argument_list|(
argument|OMPForDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPForSimdDirective
argument_list|(
argument|OMPForSimdDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPSectionsDirective
argument_list|(
argument|OMPSectionsDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPSectionDirective
argument_list|(
argument|OMPSectionDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPSingleDirective
argument_list|(
argument|OMPSingleDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPMasterDirective
argument_list|(
argument|OMPMasterDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPCriticalDirective
argument_list|(
argument|OMPCriticalDirective *D
argument_list|)
block|{
name|getDerived
argument_list|()
...
operator|>
operator|::
name|TransformOMPParallelForDirective
argument_list|(
argument|OMPParallelForDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPParallelForSimdDirective
argument_list|(
argument|OMPParallelForSimdDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPParallelSectionsDirective
argument_list|(
argument|OMPParallelSectionsDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTaskDirective
argument_list|(
argument|OMPTaskDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTaskyieldDirective
argument_list|(
argument|OMPTaskyieldDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPBarrierDirective
argument_list|(
argument|OMPBarrierDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTaskwaitDirective
argument_list|(
argument|OMPTaskwaitDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTaskgroupDirective
argument_list|(
argument|OMPTaskgroupDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPFlushDirective
argument_list|(
argument|OMPFlushDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPOrderedDirective
argument_list|(
argument|OMPOrderedDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPAtomicDirective
argument_list|(
argument|OMPAtomicDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTargetDirective
argument_list|(
argument|OMPTargetDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTargetDataDirective
argument_list|(
argument|OMPTargetDataDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTargetEnterDataDirective
argument_list|(
argument|OMPTargetEnterDataDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTargetExitDataDirective
argument_list|(
argument|OMPTargetExitDataDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTargetParallelDirective
argument_list|(
argument|OMPTargetParallelDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTargetParallelForDirective
argument_list|(
argument|OMPTargetParallelForDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTargetUpdateDirective
argument_list|(
argument|OMPTargetUpdateDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTeamsDirective
argument_list|(
argument|OMPTeamsDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPCancellationPointDirective
argument_list|(
argument|OMPCancellationPointDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPCancelDirective
argument_list|(
argument|OMPCancelDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTaskLoopDirective
argument_list|(
argument|OMPTaskLoopDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTaskLoopSimdDirective
argument_list|(
argument|OMPTaskLoopSimdDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPDistributeDirective
argument_list|(
argument|OMPDistributeDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPDistributeParallelForDirective
argument_list|(
argument|OMPDistributeParallelForDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
name|StartOpenMPDSABlock
argument_list|(
name|OMPD_distribute_parallel_for
argument_list|,
name|DirName
argument_list|,
name|nullptr
...
operator|>
operator|::
name|TransformOMPDistributeParallelForSimdDirective
argument_list|(
argument|OMPDistributeParallelForSimdDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
name|StartOpenMPDSABlock
argument_list|(
name|OMPD_distribute_parallel_for_simd
argument_list|,
name|DirName
argument_list|,
name|nullptr
...
operator|>
operator|::
name|TransformOMPDistributeSimdDirective
argument_list|(
argument|OMPDistributeSimdDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTargetParallelForSimdDirective
argument_list|(
argument|OMPTargetParallelForSimdDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
name|StartOpenMPDSABlock
argument_list|(
name|OMPD_target_parallel_for_simd
argument_list|,
name|DirName
argument_list|,
name|nullptr
...
begin_comment
comment|// OpenMP clause transformation
end_comment
...
operator|>
operator|::
name|TransformOMPNumThreadsClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPSafelenClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPSimdlenClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPCollapseClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPProcBindClause
argument_list|(
argument|OMPProcBindClause *C
argument_list|)
block|{
return|return
name|getDerived
...
operator|>
operator|::
name|TransformOMPScheduleClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPOrderedClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPNowaitClause
argument_list|(
argument|OMPNowaitClause *C
argument_list|)
block|{
comment|// No need to rebuild this clause, no template-dependent parameters.
return|return
name|C
return|;
block|}
...
operator|>
operator|::
name|TransformOMPUntiedClause
argument_list|(
argument|OMPUntiedClause *C
argument_list|)
block|{
comment|// No need to rebuild this clause, no template-dependent parameters.
return|return
...
operator|>
operator|::
name|TransformOMPMergeableClause
argument_list|(
argument|OMPMergeableClause *C
argument_list|)
block|{
comment|// No need to rebuild this clause, no template-dependent parameters.
return|return
...
operator|>
operator|::
name|TransformOMPReadClause
argument_list|(
argument|OMPReadClause *C
argument_list|)
block|{
comment|// No need to rebuild this clause, no template-dependent parameters.
return|return
...
operator|>
operator|::
name|TransformOMPWriteClause
argument_list|(
argument|OMPWriteClause *C
argument_list|)
block|{
comment|// No need to rebuild this clause, no template-dependent parameters.
return|return
...
operator|>
operator|::
name|TransformOMPUpdateClause
argument_list|(
argument|OMPUpdateClause *C
argument_list|)
block|{
comment|// No need to rebuild this clause, no template-dependent parameters.
return|return
...
operator|>
operator|::
name|TransformOMPCaptureClause
argument_list|(
argument|OMPCaptureClause *C
argument_list|)
block|{
comment|// No need to rebuild this clause, no template-dependent parameters.
return|return
...
operator|>
operator|::
name|TransformOMPSeqCstClause
argument_list|(
argument|OMPSeqCstClause *C
argument_list|)
block|{
comment|// No need to rebuild this clause, no template-dependent parameters.
return|return
...
operator|>
operator|::
name|TransformOMPThreadsClause
argument_list|(
argument|OMPThreadsClause *C
argument_list|)
block|{
comment|// No need to rebuild this clause, no template-dependent parameters.
return|return
...
operator|>
operator|::
name|TransformOMPSIMDClause
argument_list|(
argument|OMPSIMDClause *C
argument_list|)
block|{
comment|// No need to rebuild this clause, no template-dependent parameters.
return|return
...
operator|>
operator|::
name|TransformOMPNogroupClause
argument_list|(
argument|OMPNogroupClause *C
argument_list|)
block|{
comment|// No need to rebuild this clause, no template-dependent parameters.
return|return
...
operator|>
operator|::
name|TransformOMPLastprivateClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPReductionClause
argument_list|(
...
begin_comment
comment|// Build a list of all UDR decls with the same names ranged by the Scopes.
end_comment

begin_comment
comment|// The Scope boundary is a duplication of the previous decl.
end_comment
...
operator|>
operator|::
name|TransformOMPAlignedClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPCopyprivateClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPNumTeamsClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPThreadLimitClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPPriorityClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPGrainsizeClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPNumTasksClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPDistScheduleClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPDefaultmapClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPUseDevicePtrClause
argument_list|(
...
operator|>
operator|::
name|TransformOMPIsDevicePtrClause
argument_list|(
...
begin_comment
comment|// Try to recover if we have something like sizeof(T::X) where X is a type.
end_comment

begin_comment
comment|// Notably, there must be *exactly* one set of parens if X is a type.
end_comment
...
operator|>
operator|::
name|TransformOMPArraySectionExpr
argument_list|(
argument|OMPArraySectionExpr *E
argument_list|)
block|{
name|ExprResult
name|Base
...
begin_comment
unit|}
comment|// Seems that if TransformInitListExpr() only works on the syntactic form of an
end_comment

begin_comment
comment|// InitListExpr, then a DesignatedInitUpdateExpr is not encountered.
end_comment
...
operator|>
operator|::
name|TransformDesignatedInitUpdateExpr
argument_list|(
argument|DesignatedInitUpdateExpr *E
argument_list|)
block|{
name|llvm_unreachable
argument_list|(
literal|"Unexpected DesignatedInitUpdateExpr in syntactic form of "
literal|"initializer"
argument_list|)
block|;
return|return
...
operator|>
operator|::
name|TransformNoInitExpr
argument_list|(
argument|NoInitExpr *E
argument_list|)
block|{
name|llvm_unreachable
argument_list|(
literal|"Unexpected NoInitExpr in syntactic form of initializer"
argument_list|)
block|;
return|return
name|ExprError
...
begin_comment
comment|// it's a normal declaration name or member reference.
end_comment
...
operator|)
decl_stmt|;
comment|// In a C++11 unevaluated context, an UnresolvedLookupExpr might refer to an
comment|// instance member. In other contexts, BuildPossibleImplicitMemberExpr will
comment|// give a good diagnostic.
if|if
condition|(
name|D
operator|&&
...
argument_list|)
block|;
comment|// Propagate both errors and recovered types, which return ExprEmpty.
if|if
condition|(
operator|!
name|NewDRE
...
begin_comment
comment|// We got an expr, wrap it up in parens.
end_comment
...
operator|>
operator|::
name|TransformCXXInheritedCtorInitExpr
argument_list|(
argument|CXXInheritedCtorInitExpr *E
argument_list|)
block|{
name|QualType
name|T
...
expr_stmt|;
block|}
comment|// FIXME: Retain a pack expansion if RetainExpansion is true.
continue|continue;
block|}
name|EllipsisLoc
operator|=
...
begin_comment
comment|// Find the argument list to transform.
end_comment
...
argument_list|()
return|;
comment|// If we need to expand the pack, build a template argument from it and
comment|// expand that.
if|if
condition|(
name|ShouldExpand
...
begin_comment
comment|// If we're not expanding the pack, just transform the decl.
end_comment
...
operator|>
operator|::
name|TransformCXXFoldExpr
argument_list|(
argument|CXXFoldExpr *E
argument_list|)
block|{
name|Expr
operator|*
...
condition|)
block|{
comment|// Do not expand any packs here, just transform and rebuild a fold
comment|// expression.
name|Sema
operator|::
name|ArgumentPackSubstitutionIndexRAII
...
begin_comment
comment|// If we're retaining an expansion for a right fold, it is the innermost
end_comment

begin_comment
comment|// component and takes the init (if any).
end_comment
...
condition|)
block|{
comment|// We still have a pack; retain a pack expansion for this slice.
name|Result
operator|=
name|getDerived
argument_list|()
...
condition|)
block|{
comment|// We've got down to a single element; build a binary operator.
name|Result
operator|=
name|getDerived
argument_list|()
...
begin_comment
comment|// If we're retaining an expansion for a left fold, it is the outermost
end_comment

begin_comment
comment|// component and takes the complete expansion so far as its init (if any).
end_comment
...
begin_comment
comment|// If we had no init and an empty pack, and we're not retaining an expansion,
end_comment

begin_comment
comment|// then produce a fallback value or error.
end_comment
...
operator|>
operator|::
name|TransformObjCAvailabilityCheckExpr
argument_list|(
argument|ObjCAvailabilityCheckExpr *E
argument_list|)
block|{
return|return
name|E
...
name|diag
operator|::
name|err_expected_class_or_namespace
argument_list|)
operator|<<
name|ScopeType
operator|->
...
begin_comment
comment|// LLVM_CLANG_LIB_SEMA_TREETRANSFORM_H
end_comment
