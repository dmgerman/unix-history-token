...
name|true
return|;
comment|// FIXME: Can this happen? We should not try to expand the pack
...
begin_comment
comment|// FIXME: Need to transform ConsumedParameters for variadic template
end_comment
