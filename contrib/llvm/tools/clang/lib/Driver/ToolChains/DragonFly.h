...
begin_comment
comment|//===--- DragonFly.h - DragonFly ToolChain Implementations ------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|LLVM_CLANG_LIB_DRIVER_TOOLCHAINS_DRAGONFLY_H
end_ifndef
...
begin_comment
comment|// LLVM_CLANG_LIB_DRIVER_TOOLCHAINS_DRAGONFLY_H
end_comment
