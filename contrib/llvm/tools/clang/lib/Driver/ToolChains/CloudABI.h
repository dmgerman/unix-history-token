...
begin_comment
comment|//===--- CloudABI.h - CloudABI ToolChain Implementations --------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|LLVM_CLANG_LIB_DRIVER_TOOLCHAINS_CLOUDABI_H
end_ifndef
...
begin_comment
comment|// LLVM_CLANG_LIB_DRIVER_TOOLCHAINS_CLOUDABI_H
end_comment
