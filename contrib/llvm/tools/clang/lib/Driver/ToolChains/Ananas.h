...
begin_comment
comment|//===--- Ananas.h - Ananas ToolChain Implementations --------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|LLVM_CLANG_LIB_DRIVER_TOOLCHAINS_ANANAS_H
end_ifndef
...
name|tools
block|{
comment|/// ananas -- Directly call GNU Binutils assembler and linker
name|namespace
name|ananas
block|{
name|class
...
begin_comment
comment|// LLVM_CLANG_LIB_DRIVER_TOOLCHAINS_ANANAS_H
end_comment
