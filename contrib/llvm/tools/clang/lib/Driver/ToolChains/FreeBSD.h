...
begin_comment
comment|//===--- FreeBSD.h - FreeBSD ToolChain Implementations ----------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|LLVM_CLANG_LIB_DRIVER_TOOLCHAINS_FREEBSD_H
end_ifndef
...
begin_comment
comment|// LLVM_CLANG_LIB_DRIVER_TOOLCHAINS_FREEBSD_H
end_comment
