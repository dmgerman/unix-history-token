...
begin_comment
comment|//===- xray-record-yaml.h - XRay Record YAML Support Definitions ----------===//
end_comment
...
ifndef|#
directive|ifndef
name|LLVM_TOOLS_LLVM_XRAY_XRAY_RECORD_YAML_H
end_ifndef
...
begin_comment
comment|// LLVM_TOOLS_LLVM_XRAY_XRAY_RECORD_YAML_H
end_comment
