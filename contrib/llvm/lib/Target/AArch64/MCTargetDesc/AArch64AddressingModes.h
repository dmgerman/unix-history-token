...
ifndef|#
directive|ifndef
name|LLVM_TARGET_AArch64_AArch64ADDRESSINGMODES_H
end_ifndef
...
condition|)
block|{
comment|// Encode in immr the number of RORs it would take to get *from* this
comment|// element value to our target value, where i+1 is the number of RORs
comment|// to go the opposite direction.
name|unsigned
name|immr
init|=
name|size
