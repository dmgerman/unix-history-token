...
block|}
block|}
comment|/// \brief Return the opcode that set flags when possible.  The caller is
comment|/// responsible for ensuring the opc has a flag setting equivalent.
specifier|static
name|unsigned
name|convertToFlagSettingOpc
argument_list|(
argument|unsigned Opc
argument_list|,
...
argument_list|(
literal|"Opcode has no flag setting equivalent!"
argument_list|)
expr_stmt|;
comment|// 32-bit cases:
case|case
name|AArch64
operator|::
name|ADDWri
