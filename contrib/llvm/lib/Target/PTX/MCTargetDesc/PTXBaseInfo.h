...
name|namespace
name|PTXRegisterType
block|{
comment|// Register type encoded in MCOperands
enum|enum
block|{
name|Pred
init|=
...
enum|;
block|}
comment|// namespace PTXRegisterType
name|namespace
name|PTXRegisterSpace
block|{
comment|// Register space encoded in MCOperands
enum|enum
block|{
name|Reg
init|=
...
argument_list|(
literal|"Unknown register space!"
argument_list|)
expr_stmt|;
case|case
name|PTXRegisterSpace
