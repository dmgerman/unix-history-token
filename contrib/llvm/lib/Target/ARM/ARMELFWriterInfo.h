...
begin_comment
comment|//===-- ARMELFWriterInfo.h - ELF Writer Info for ARM ------------*- C++ -*-===//
end_comment
...
begin_comment
comment|// This file implements ELF writer information for the ARM backend.
end_comment
