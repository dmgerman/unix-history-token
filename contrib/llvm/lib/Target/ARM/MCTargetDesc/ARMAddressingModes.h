...
comment|// operation (add or subtract) in bit 8 and the immediate in bits 0-7.
...
block|}
comment|//===--------------------------------------------------------------------===//
comment|// Addressing Mode #5 FP16
comment|//===--------------------------------------------------------------------===//
comment|//
comment|// This is used for coprocessor instructions, such as 16-bit FP load/stores.
comment|//
comment|// addrmode5fp16 := reg +/- imm8*2
comment|//
comment|// The first operand is always a Reg.  The second operand encodes the
comment|// operation (add or subtract) in bit 8 and the immediate in bits 0-7.
comment|/// getAM5FP16Opc - This function encodes the addrmode5fp16 opc field.
specifier|static
specifier|inline
name|unsigned
name|getAM5FP16Opc
