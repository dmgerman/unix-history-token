...
begin_comment
comment|//===-- MBlazeELFWriterInfo.h - ELF Writer Info for MBlaze ------*- C++ -*-===//
end_comment
...
begin_comment
comment|// This file implements ELF writer information for the MBlaze backend.
end_comment
...
begin_comment
comment|// MBLAZE_ELF_WRITER_INFO_H
end_comment
