...
begin_comment
comment|//===-- MBlazeMCInstLower.h - Lower MachineInstr to MCInst ------*- C++ -*-===//
end_comment
...
name|MachineOperand
decl_stmt|;
comment|/// MBlazeMCInstLower - This class is used to lower an MachineInstr
comment|/// into an MCInst.
name|class
name|LLVM_LIBRARY_VISIBILITY
name|MBlazeMCInstLower
block|{
name|MCContext
modifier|&
name|Ctx
