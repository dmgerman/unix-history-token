...
block|}
struct|;
comment|// Indicates where the opcode modifier (if any) is to be found.  Extended
comment|// opcodes with AddRegFrm have the opcode modifier in the ModR/M byte.
define|#
directive|define
name|MODIFIER_TYPES
define|\
value|ENUM_ENTRY(MODIFIER_NONE)
define|#
directive|define
name|ENUM_ENTRY
parameter_list|(
