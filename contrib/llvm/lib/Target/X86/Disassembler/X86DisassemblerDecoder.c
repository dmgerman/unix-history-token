...
begin_comment
comment|/*  * readVVVV - Consumes an immediate operand from an instruction, given the  *   desired operand size.  *  * @param insn  - The instruction whose operand is to be read.  * @return      - 0 if the immediate was successfully consumed; nonzero  *                otherwise.  */
end_comment
