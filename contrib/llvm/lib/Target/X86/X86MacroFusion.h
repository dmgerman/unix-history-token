...
begin_comment
comment|// \file This file is distributed under the University of Illinois Open Source
end_comment
...
begin_comment
comment|// This file contains the X86 definition of the DAG scheduling mutation to pair
end_comment

begin_comment
comment|// instructions back to back.
end_comment
...
begin_comment
comment|// X86MacroFusion - DAG post-processing to encourage fusion of macro ops.
end_comment
