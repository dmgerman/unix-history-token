...
begin_comment
comment|/// Structure to represent an optional metadata field.
end_comment
...
name|MDUnsignedField
argument_list|(
argument|NumTy Default =
literal|0
argument_list|,
argument|NumTy Max = std::numeric_limits<NumTy>::max()
argument_list|)
end_macro
