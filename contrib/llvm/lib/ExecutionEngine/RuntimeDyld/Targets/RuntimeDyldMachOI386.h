...
ifndef|#
directive|ifndef
name|LLVM_RUNTIMEDYLDMACHOI386_H
end_ifndef
...
argument_list|()
operator|&&
literal|"__pointers section not supported in 64-bit MachO."
argument_list|)
expr_stmt|;
name|MachO
operator|::
...
literal|0
operator|&&
literal|"Pointers section does not contain a whole number of stubs?"
argument_list|)
expr_stmt|;
name|DEBUG
argument_list|(
...
argument_list|()
operator|<<
literal|"Populating __pointers, Section ID "
operator|<<
name|PTSectionID
operator|<<
literal|", "
...
begin_comment
comment|// LLVM_RUNTIMEDYLDMACHOI386_H
end_comment
