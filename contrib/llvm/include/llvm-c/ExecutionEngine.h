...
parameter_list|)
function_decl|;
comment|/** Deprecated: Use LLVMCreateExecutionEngineForModule instead. */
name|LLVMBool
...
parameter_list|)
function_decl|;
comment|/** Deprecated: Use LLVMCreateInterpreterForModule instead. */
name|LLVMBool
...
parameter_list|)
function_decl|;
comment|/** Deprecated: Use LLVMCreateJITCompilerForModule instead. */
name|LLVMBool
...
parameter_list|)
function_decl|;
comment|/** Deprecated: Use LLVMAddModule instead. */
name|void
...
parameter_list|)
function_decl|;
comment|/** Deprecated: Use LLVMRemoveModule instead. */
name|LLVMBool
