...
begin_comment
comment|//===-- llvm/MC/MCTargetAsmLexer.h - Target Assembly Lexer ------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|LLVM_MC_MCTARGETASMLEXER_H
end_ifndef
...
name|Target
decl_stmt|;
comment|/// MCTargetAsmLexer - Generic interface to target specific assembly lexers.
name|class
