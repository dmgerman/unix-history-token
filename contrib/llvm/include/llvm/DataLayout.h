...
return|;
block|}
comment|/// Initialise a DataLayout object with default values, ensure that the
...
comment|/// initialises a DataLayout object if passed a non-null pointer.
specifier|static
name|std
operator|::
name|string
