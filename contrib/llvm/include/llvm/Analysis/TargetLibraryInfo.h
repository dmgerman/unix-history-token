...
return|;
block|}
comment|/// If a callsite does not have the 'nobuiltin' attribute, return if the
comment|/// called function is a known library function and set F to that function.
name|bool
name|getLibFunc
argument_list|(
