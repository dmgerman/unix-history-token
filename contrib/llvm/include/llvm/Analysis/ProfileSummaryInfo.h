...
argument_list|)
expr_stmt|;
comment|/// \brief Returns true if \p F is a cold function.
name|bool
name|isColdFunction
parameter_list|(
specifier|const
...
parameter_list|)
function_decl|;
comment|/// \brief Returns true if count \p C is considered hot.
name|bool
name|isHotCount
parameter_list|(
name|uint64_t
...
name|ProfileSummaryAnalysis
argument_list|(
argument|const ProfileSummaryAnalysis&Arg
argument_list|)
block|{}
name|ProfileSummaryAnalysis
argument_list|(
argument|ProfileSummaryAnalysis&&Arg
argument_list|)
block|{}
name|ProfileSummaryAnalysis
operator|&
