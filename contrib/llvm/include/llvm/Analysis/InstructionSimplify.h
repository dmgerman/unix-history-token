...
parameter_list|)
function_decl|;
comment|// These helper functions return a SimplifyQuery structure that contains as
comment|// many of the optional analysis we use as are currently valid.  This is the
comment|// strongly preferred way of constructing SimplifyQuery in passes.
specifier|const
name|SimplifyQuery
name|getBestSimplifyQuery
parameter_list|(
name|Pass
modifier|&
parameter_list|,
