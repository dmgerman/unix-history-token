...
parameter_list|)
define|\
value|typedef typename ELFDataTypeTypedefHelper<ELFT>::Elf_Addr Elf_Addr; \ typedef typename ELFDataTypeTypedefHelper<ELFT>::Elf_Off Elf_Off; \ typedef typename ELFDataTypeTypedefHelper<ELFT>::Elf_Half Elf_Half; \ typedef typename ELFDataTypeTypedefHelper<ELFT>::Elf_Word Elf_Word; \ typedef typename ELFDataTypeTypedefHelper<ELFT>::Elf_Sword Elf_Sword; \ typedef typename ELFDataTypeTypedefHelper<ELFT>::Elf_Xword Elf_Xword; \ typedef typename ELFDataTypeTypedefHelper<ELFT>::Elf_Sxword Elf_Sxword;
end_define

begin_comment
comment|// This is required to get template types into a macro :(
end_comment
...
name|LLVM_ELF_IMPORT_TYPES
argument_list|(
argument|ELFT<TargetEndianness LLVM_ELF_COMMA                              MaxAlign LLVM_ELF_COMMA false>
argument_list|)
name|Elf_Word
name|sh_name
block|;
...
name|LLVM_ELF_IMPORT_TYPES
argument_list|(
argument|ELFT<TargetEndianness LLVM_ELF_COMMA                              MaxAlign LLVM_ELF_COMMA true>
argument_list|)
name|Elf_Word
name|sh_name
block|;
