...
name|Current
operator|&&
literal|"Attempted to subtract an invalid iterator!"
argument_list|)
block|;
name|Current
operator|-=
...
argument_list|()
block|{
comment|// Build load-address to file-offset map.
typedef|typedef
name|IntervalMap
operator|<
name|uintX_t
...
begin_comment
comment|// Allocate the IntervalMap on the heap to work around MSVC bug where the
end_comment

begin_comment
comment|// stack doesn't get realigned despite LoadMap having alignment 8 (PR24113).
end_comment
