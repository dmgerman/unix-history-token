...
name|ST_External
block|,
comment|// Defined in another object file
name|ST_Other
block|}
expr_stmt|;
name|SymbolRef
...
decl|const
decl_stmt|;
comment|/// Returns true for symbols that can be used in another objects,
comment|/// such as library functions
name|error_code
name|isGlobal
argument_list|(
name|bool
...
name|getSymbolType
argument_list|(
argument|SymbolRef::SymbolType&Result
argument_list|)
specifier|const
block|{
return|return
