...
begin_comment
comment|//===- YAML.h - YAMLIO utilities for object files ---------------*- C++ -*-===//
end_comment
...
begin_comment
comment|// This file declares utility classes for handling the YAML representation of
end_comment
