...
comment|// TODO: It's not clear that SmallVector is an appropriate data structure for
comment|// this usecase.  The sizes were picked to minimize wasted space, but are
comment|// otherwise fairly meaningless.
name|SmallVector
operator|<
name|AnalysisID
operator|,
...
comment|///@}
comment|///@{
comment|/// Add the specified ID to the set of analyses used by this pass if they are
comment|/// available..
name|AnalysisUsage
modifier|&
name|addUsedIfAvailableID
parameter_list|(
specifier|const
name|void
modifier|*
...
return|;
block|}
comment|/// Add the specified Pass class to the set of analyses used by this pass.
name|template
operator|<
name|class
name|PassClass
