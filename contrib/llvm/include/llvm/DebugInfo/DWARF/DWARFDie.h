...
begin_comment
comment|/// \returns the address value of the attribute or FailValue if the
end_comment

begin_comment
comment|/// attribute doesn't exist or if the attribute's form isn't a form that
end_comment
...
begin_comment
comment|/// \returns the signed integer constant value of the attribute or FailValue
end_comment

begin_comment
comment|/// if the attribute doesn't exist or if the attribute's form isn't a form
end_comment

begin_comment
comment|/// that describes a signed integer.
end_comment
...
begin_comment
comment|/// \returns the unsigned integer constant value of the attribute or FailValue
end_comment
...
begin_comment
comment|/// that describes an unsigned integer.
end_comment
...
begin_comment
comment|/// that describes a reference.
end_comment
...
begin_comment
comment|/// that describes a section offset.
end_comment
