...
name|dwarf
operator|::
name|DW_UT_split_compile
operator|||
name|UnitType
operator|==
name|dwarf
operator|::
name|DW_UT_split_type
return|;
block|}
comment|/// \brief Return the number of bytes for the header of a unit of
comment|/// UnitType type.
comment|///
comment|/// This function must be called with a valid unit type which in
comment|/// DWARF5 is defined as one of the following six types.
specifier|static
name|uint32_t
name|getDWARF5HeaderSize
parameter_list|(
name|uint8_t
name|UnitType
parameter_list|)
