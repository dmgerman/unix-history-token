...
return|;
block|}
comment|/// RecordMatchingPHI - For a PHI node that matches, record it and its input
comment|/// PHIs in both the BBMap and the AvailableVals mapping.
name|void
name|RecordMatchingPHI
parameter_list|(
name|PhiT
...
condition|)
continue|continue;
comment|// Record the PHI and add it to the worklist.
operator|(
operator|*
name|AvailableVals
operator|)
