...
name|NamesSize
block|;
comment|// vector of counter load/store pairs to be register promoted.
name|std
operator|::
name|vector
operator|<
...
block|;
name|int64_t
name|TotalCountersPromoted
operator|=
literal|0
block|;
comment|/// Lower instrumentation intrinsics in the function. Returns true if there
comment|/// any lowering.
name|bool
name|lowerIntrinsics
argument_list|(
name|Function
operator|*
name|F
argument_list|)
block|;
comment|/// Register-promote counter loads and stores in loops.
name|void
name|promoteCounterLoadStores
argument_list|(
name|Function
operator|*
name|F
argument_list|)
block|;
comment|/// Returns true if profile counter update register promotion is enabled.
name|bool
name|isCounterPromotionEnabled
argument_list|()
specifier|const
block|;
