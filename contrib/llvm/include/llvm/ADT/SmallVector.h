...
begin_comment
unit|};
comment|/// Specialize SmallVector at N=0.  This specialization guarantees
end_comment

begin_comment
comment|/// that it can be instantiated at an incomplete T if none of its
end_comment

begin_comment
comment|/// members are required.
end_comment
