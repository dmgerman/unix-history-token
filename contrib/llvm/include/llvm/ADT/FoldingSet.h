...
comment|// construction vtable for FoldingSet<T> requires
...
begin_comment
comment|/// equal to the specified node, return it.  Otherwise, insert 'N'
end_comment

begin_comment
comment|/// and return it instead.
end_comment
...
begin_comment
comment|/// FindNodeOrInsertPos - Look up the node specified by ID.  If it
end_comment

begin_comment
comment|/// exists, return it.  If not, return the insertion token that will
end_comment

begin_comment
comment|/// make insertion faster.
end_comment
...
begin_comment
comment|/// FoldingSetVectorIterator - This implements an iterator for
end_comment

begin_comment
comment|/// FoldingSetVector. It is only necessary because FoldingSetIterator provides
end_comment

begin_comment
comment|/// a value_type of T, while the vector in FoldingSetVector exposes
end_comment

begin_comment
comment|/// a value_type of T*. Fortunately, FoldingSetIterator doesn't expose very
end_comment

begin_comment
comment|/// much besides operator* and operator->, so we just wrap the inner vector
end_comment

begin_comment
comment|/// iterator and perform the extra dereference.
end_comment
...
operator|,
name|class
name|VectorIteratorT
operator|>
name|class
name|FoldingSetVectorIterator
block|{
comment|// Provide a typedef to workaround the lack of correct injected class name
comment|// support in older GCCs.
typedef|typedef
name|FoldingSetVectorIterator
operator|<
name|T
