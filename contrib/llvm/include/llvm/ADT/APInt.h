...
return|;
block|}
comment|/// Utility method to change the bit width of this APInt to new bit width,
comment|/// allocating and/or deallocating as necessary. There is no guarantee on the
comment|/// value of any bits upon return. Caller should populate the bits after.
name|void
name|reallocate
parameter_list|(
name|unsigned
...
begin_comment
comment|/// Negate this APInt in place.
end_comment
...
begin_comment
comment|/// operands. No overflow occurs. DST must be disjoint from both operands.
end_comment
