...
expr_stmt|;
block|}
comment|/// getFnAttributes - Return the function attributes for querying.
comment|///
name|Attributes
...
parameter_list|()
function_decl|;
comment|/// getRetAttributes - Return the return attributes for querying.
name|Attributes
...
return|;
block|}
comment|/// getParamAttributes - Return the parameter attributes for querying.
name|Attributes
