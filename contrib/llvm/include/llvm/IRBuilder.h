...
begin_comment
comment|// Provided to resolve 'CreateAlignedLoad(Ptr, Align, "...")' correctly,
end_comment

begin_comment
comment|// instead of converting the string to 'bool' for the isVolatile parameter.
end_comment
...
begin_comment
comment|/// CreateZExtOrTrunc - Create a ZExt or Trunc from the integer value V to
end_comment

begin_comment
comment|/// DestTy. Return the value untouched if the type of V is already DestTy.
end_comment
...
operator|)
operator|&&
literal|"Can only zero extend integers!"
argument_list|)
expr_stmt|;
name|IntegerType
modifier|*
...
begin_comment
comment|/// CreateSExtOrTrunc - Create a SExt or Trunc from the integer value V to
end_comment
...
operator|)
operator|&&
literal|"Can only sign extend integers!"
argument_list|)
expr_stmt|;
name|IntegerType
modifier|*
...
begin_comment
comment|/// CreateIsNull - Return an i1 value testing if \p Arg is null.
end_comment
...
begin_comment
comment|/// CreateIsNotNull - Return an i1 value testing if \p Arg is not null.
end_comment
