...
name|JTableType
argument_list|(
literal|"jump-table-type"
argument_list|,
name|cl
operator|::
name|desc
argument_list|(
literal|"Choose the type of Jump-Instruction Table for jumptable."
argument_list|)
argument_list|,
name|cl
operator|::
...
literal|"single"
argument_list|,
literal|"Create a single table for all jumptable functions"
argument_list|)
argument_list|,
name|clEnumValN
argument_list|(
...
literal|"arity"
argument_list|,
literal|"Create one table per number of parameters."
argument_list|)
argument_list|,
name|clEnumValN
argument_list|(
...
literal|"simplified"
argument_list|,
literal|"Create one table per simplified function type."
argument_list|)
argument_list|,
name|clEnumValN
argument_list|(
...
literal|"full"
argument_list|,
literal|"Create one table per unique function type."
argument_list|)
argument_list|,
name|clEnumValEnd
argument_list|)
...
name|desc
argument_list|(
literal|"Apply forward-edge control-flow integrity"
argument_list|)
argument_list|,
name|cl
operator|::
...
name|desc
argument_list|(
literal|"Choose the type of Control-Flow Integrity check to add"
argument_list|)
argument_list|,
name|cl
operator|::
...
literal|"sub"
argument_list|,
literal|"Subtract the pointer from the table base, then mask."
argument_list|)
argument_list|,
name|clEnumValN
argument_list|(
...
literal|"ror"
argument_list|,
literal|"Use rotate to check the offset from a table base."
argument_list|)
argument_list|,
name|clEnumValN
argument_list|(
...
literal|"add"
argument_list|,
literal|"Mask out the high bits and add to an aligned base."
argument_list|)
argument_list|,
name|clEnumValEnd
argument_list|)
...
name|CFIEnforcing
argument_list|(
literal|"cfi-enforcing"
argument_list|,
name|cl
operator|::
name|desc
argument_list|(
literal|"Enforce CFI or pass the violation to a function."
argument_list|)
argument_list|,
name|cl
operator|::
...
begin_comment
comment|// Note that this option is linked to the cfi-enforcing option above: if
end_comment

begin_comment
comment|// cfi-enforcing is set, then the cfi-func-name option is entirely ignored. If
end_comment

begin_comment
comment|// cfi-enforcing is false and no cfi-func-name is set, then a default function
end_comment

begin_comment
comment|// will be generated that ignores all CFI violations. The expected signature for
end_comment

begin_comment
comment|// functions called with CFI violations is
end_comment
...
begin_comment
comment|// The first pointer is a C string containing the name of the function in which
end_comment

begin_comment
comment|// the violation occurs, and the second pointer is the pointer that violated
end_comment
...
name|CFIFuncName
argument_list|(
literal|"cfi-func-name"
argument_list|,
name|cl
operator|::
name|desc
argument_list|(
literal|"The name of the CFI function to call"
argument_list|)
argument_list|,
name|cl
operator|::
