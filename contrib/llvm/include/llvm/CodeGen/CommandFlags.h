...
name|bool
operator|>
name|DisableFPElimNonLeaf
argument_list|(
literal|"disable-non-leaf-fp-elim"
argument_list|,
name|cl
operator|::
name|desc
argument_list|(
literal|"Disable frame pointer elimination optimization for non-leaf funcs"
argument_list|)
argument_list|,
name|cl
operator|::
...
name|desc
argument_list|(
literal|"Enable aggresive formation of fused FP ops"
argument_list|)
argument_list|,
name|cl
operator|::
...
name|bool
operator|>
name|EnableRealignStack
argument_list|(
literal|"realign-stack"
argument_list|,
name|cl
operator|::
name|desc
argument_list|(
literal|"Realign stack if needed"
argument_list|)
argument_list|,
name|cl
operator|::
...
name|SSPBufferSize
argument_list|(
literal|"stack-protector-buffer-size"
argument_list|,
name|cl
operator|::
name|init
...
name|desc
argument_list|(
literal|"Lower bound for a buffer to be considered for "
literal|"stack protection"
argument_list|)
argument_list|)
expr_stmt|;
end_expr_stmt
