...
name|desc
argument_list|(
literal|"Choose reciprocal operation types and parameters."
argument_list|)
argument_list|,
name|cl
operator|::
name|value_desc
argument_list|(
literal|"all,none,default,divf,!vec-sqrtd,vec-divd:0,sqrt:9..."
argument_list|)
argument_list|)
expr_stmt|;
end_expr_stmt
...
name|desc
argument_list|(
literal|"Run compiler only for one specific pass"
argument_list|)
argument_list|,
name|cl
operator|::
