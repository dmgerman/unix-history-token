...
comment|/// \endverbatim
comment|///
comment|/// Support for an architecture depends on three functions in TargetInstrInfo:
comment|/// getUnconditionalBranch, getTrap, and getJumpInstrTableEntryBound. AsmPrinter
comment|/// uses these to generate the appropriate instructions for the jump statement
comment|/// (an unconditional branch) and for padding to make the table have a size that
comment|/// is a power of two. This padding uses a trap instruction to ensure that calls
comment|/// to this area halt the program. The default implementations of these
comment|/// functions call llvm_unreachable, except for getJumpInstrTableEntryBound,
comment|/// which returns 0 by default.
name|class
