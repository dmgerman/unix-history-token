...
begin_comment
comment|//==-- llvm/CodeGen/SelectionDAGTargetInfo.h - SelectionDAG Info -*- C++ -*-==//
end_comment
...
begin_comment
comment|// This file declares the SelectionDAGTargetInfo class, which targets can
end_comment
...
ifndef|#
directive|ifndef
name|LLVM_CODEGEN_SELECTIONDAGTARGETINFO_H
end_ifndef
...
return|;
block|}
comment|// Return true when the decision to generate FMA's (or FMS, FMLA etc) rather
comment|// than FMUL and ADD is delegated to the machine combiner.
name|virtual
name|bool
