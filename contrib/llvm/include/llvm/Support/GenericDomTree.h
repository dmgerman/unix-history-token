...
name|DomTreeBuilder
block|{
comment|// The routines below are provided in a separate header but referenced here.
name|template
operator|<
name|typename
name|DomTreeT
...
name|static_assert
argument_list|(
argument|std::is_pointer<typename GraphTraits<NodeT *>::NodeRef>::value
argument_list|,
literal|"Currently DominatorTreeBase supports only pointer nodes"
argument_list|)
block|;
name|using
name|NodeType
...
begin_comment
comment|/// Inform the dominator tree about a CFG edge insertion and update the tree.
end_comment
...
begin_comment
comment|/// This function has to be called just before or just after making the update
end_comment

begin_comment
comment|/// on the actual CFG. There cannot be any other updates that the dominator
end_comment

begin_comment
comment|/// tree doesn't know about.
end_comment
...
begin_comment
comment|/// Note that for postdominators it automatically takes care of inserting
end_comment

begin_comment
comment|/// a reverse edge internally (so there's no need to swap the parameters).
end_comment
...
begin_comment
comment|/// Inform the dominator tree about a CFG edge deletion and update the tree.
end_comment
...
begin_comment
comment|/// This function has to be called just after making the update
end_comment
...
begin_comment
comment|/// tree doesn't know about. The only exception is when the deletion that the
end_comment

begin_comment
comment|/// tree is informed about makes some (domominator) subtree unreachable -- in
end_comment

begin_comment
comment|/// this case, it is fine to perform deletions within this subtree.
end_comment
...
begin_comment
comment|/// Note that for postdominators it automatically takes care of deleting
end_comment
