...
name|unsigned
block|{
name|CVL_LineNumberStartBits
init|=
literal|24
block|,
name|CVL_LineNumberEndDeltaBits
init|=
literal|7
block|,
name|CVL_LineNumberEndDeltaMask
init|=
operator|(
literal|1U
operator|<<
...
literal|1
block|,
name|CVL_IsStatement
init|=
literal|1U
operator|<<
literal|31
block|,
name|CVL_MaxColumnNumber
init|=
name|UINT16_MAX
block|,   }
enum|;
...
literal|0x4
block|,
name|DEBUG_SYMBOL_SUBSECTION
init|=
literal|0xF1
block|,
name|DEBUG_LINE_TABLE_SUBSECTION
init|=
literal|0xF2
block|,
name|DEBUG_STRING_TABLE_SUBSECTION
init|=
literal|0xF3
block|,
name|DEBUG_INDEX_SUBSECTION
init|=
literal|0xF4
block|,
comment|// Symbol subsections are split into records of different types.
name|DEBUG_SYMBOL_TYPE_PROC_START
init|=
literal|0x1147
block|,
name|DEBUG_SYMBOL_TYPE_PROC_END
init|=
literal|0x114F
block|}
enum|;
