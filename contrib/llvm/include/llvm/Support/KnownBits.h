...
return|;
block|}
comment|/// Returns the minimum number of trailing zero bits.
name|unsigned
name|countMinTrailingZeros
argument_list|()
specifier|const
block|{
return|return
...
return|;
block|}
comment|/// Returns the minimum number of trailing one bits.
name|unsigned
name|countMinTrailingOnes
argument_list|()
specifier|const
block|{
return|return
...
return|;
block|}
comment|/// Returns the minimum number of leading zero bits.
name|unsigned
name|countMinLeadingZeros
argument_list|()
specifier|const
block|{
return|return
...
return|;
block|}
comment|/// Returns the minimum number of leading one bits.
name|unsigned
name|countMinLeadingOnes
argument_list|()
specifier|const
block|{
return|return
...
return|;
block|}
comment|/// Returns the number of times the sign bit is replicated into the other
comment|/// bits.
name|unsigned
name|countMinSignBits
argument_list|()
specifier|const
block|{
if|if
...
return|;
block|}
comment|/// Returns the maximum number of trailing zero bits possible.
name|unsigned
name|countMaxTrailingZeros
argument_list|()
decl|const
block|{
return|return
...
return|;
block|}
comment|/// Returns the maximum number of trailing one bits possible.
name|unsigned
name|countMaxTrailingOnes
argument_list|()
decl|const
block|{
return|return
...
return|;
block|}
comment|/// Returns the maximum number of leading zero bits possible.
name|unsigned
name|countMaxLeadingZeros
argument_list|()
decl|const
block|{
return|return
...
return|;
block|}
comment|/// Returns the maximum number of leading one bits possible.
name|unsigned
name|countMaxLeadingOnes
argument_list|()
decl|const
block|{
return|return
...
return|;
block|}
comment|/// Returns the number of bits known to be one.
name|unsigned
name|countMinPopulation
argument_list|()
decl|const
block|{
return|return
...
return|;
block|}
comment|/// Returns the maximum number of bits that could be one.
name|unsigned
name|countMaxPopulation
argument_list|()
decl|const
block|{
return|return
