...
begin_comment
comment|// This file forces the JIT to link in on certain operating systems.
end_comment
...
ifndef|#
directive|ifndef
name|LLVM_EXECUTION_ENGINE_JIT_H
end_ifndef
...
block|{
struct|struct
name|ForceJITLinking
block|{
name|ForceJITLinking
argument_list|()
block|{
comment|// We must reference JIT in such a way that compilers will not
