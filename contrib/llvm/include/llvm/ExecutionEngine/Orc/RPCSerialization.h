...
name|Deserializers
block|;
comment|/// Registers a serializer and deserializer for the given error type on the
comment|/// given channel type.
name|template
operator|<
name|typename
name|ChannelT
...
operator|>
name|void
name|registerErrorSerialization
argument_list|(
argument|std::string Name
argument_list|,
argument|SerializeFtor&&Serialize
...
operator|)
block|; }
comment|/// Registers serialization/deserialization for StringError.
name|template
operator|<
name|typename
name|ChannelT
