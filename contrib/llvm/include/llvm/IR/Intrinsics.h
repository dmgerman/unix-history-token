...
return|;
block|}
comment|// VecOfAnyPtrsToElt uses both an overloaded argument (for address space)
comment|// and a reference argument (for matching vector width and element types)
name|unsigned
name|getOverloadArgNumber
argument_list|()
specifier|const
block|{
name|assert
