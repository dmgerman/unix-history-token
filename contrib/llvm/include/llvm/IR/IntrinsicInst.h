...
name|Intrinsic
operator|::
name|experimental_constrained_sqrt
case|:
case|case
name|Intrinsic
operator|::
name|experimental_constrained_pow
case|:
case|case
name|Intrinsic
operator|::
name|experimental_constrained_powi
case|:
case|case
name|Intrinsic
operator|::
name|experimental_constrained_sin
case|:
case|case
name|Intrinsic
operator|::
name|experimental_constrained_cos
case|:
case|case
name|Intrinsic
operator|::
name|experimental_constrained_exp
case|:
case|case
name|Intrinsic
operator|::
name|experimental_constrained_exp2
case|:
case|case
name|Intrinsic
operator|::
name|experimental_constrained_log
case|:
case|case
name|Intrinsic
operator|::
name|experimental_constrained_log10
case|:
case|case
name|Intrinsic
operator|::
name|experimental_constrained_log2
case|:
case|case
name|Intrinsic
operator|::
name|experimental_constrained_rint
case|:
case|case
name|Intrinsic
operator|::
name|experimental_constrained_nearbyint
case|:
return|return
name|true
return|;
...
comment|/// TODO: Integrate this class into MemIntrinsic hierarchy; for now this is
comment|/// C&P of all methods from that hierarchy
name|class
name|ElementUnorderedAtomicMemCpyInst
operator|:
name|public
name|IntrinsicInst
block|{
...
argument_list|)
operator|&&
literal|"setElementSizeInBytes called with value of wrong type!"
argument_list|)
block|;
name|setArgOperand
argument_list|(
...
name|Intrinsic
operator|::
name|memcpy_element_unordered_atomic
return|;
block|}
specifier|static
name|bool
...
block|;
name|class
name|ElementUnorderedAtomicMemMoveInst
operator|:
name|public
name|IntrinsicInst
block|{
...
name|Intrinsic
operator|::
name|memmove_element_unordered_atomic
return|;
block|}
specifier|static
specifier|inline
...
expr|}
block|;
comment|/// This class represents atomic memset intrinsic
comment|/// TODO: Integrate this class into MemIntrinsic hierarchy; for now this is
comment|/// C&P of all methods from that hierarchy
name|class
name|ElementUnorderedAtomicMemSetInst
operator|:
name|public
name|IntrinsicInst
block|{
...
name|Intrinsic
operator|::
name|memset_element_unordered_atomic
return|;
block|}
specifier|static
specifier|inline
