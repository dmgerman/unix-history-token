...
block|}
comment|//===----------------------------------------------------------------------===//
comment|// Class that matches a group of binary opcodes.
comment|//
name|template
operator|<
name|typename
...
expr|}
block|;
comment|/// \brief Matches shift operations.
name|template
operator|<
name|typename
name|LHS
...
return|;
block|}
comment|/// \brief Matches logical shift operations.
name|template
operator|<
name|typename
name|LHS
...
return|;
block|}
comment|/// \brief Matches bitwise logic operations.
name|template
operator|<
name|typename
name|LHS
...
return|;
block|}
comment|/// \brief Matches integer division operations.
name|template
operator|<
name|typename
name|LHS
