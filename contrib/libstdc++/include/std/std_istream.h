...
begin_comment
comment|/** @file istream  *  This is a Standard C++ Library header.  */
end_comment
...
begin_comment
unit|};
comment|// Explicit specialization declarations, defined in src/istream.cc.
end_comment
...
begin_comment
comment|// Explicit specialization declaration, defined in src/istream.cc.
end_comment
