...
begin_comment
comment|// SGI's rope class implementation -*- C++ -*-
end_comment
...
begin_comment
comment|/** @file ropeimpl.h  *  This is an internal header file, included by other library headers.  *  You should not attempt to use it directly.  */
end_comment
...
begin_comment
comment|// For copy_n and lexicographical_compare_3way
end_comment
...
name|_Traits
operator|>
comment|// Here _CharT is both the stream and rope character type.
name|class
...
name|_S_substringfn
case|:
comment|// We don't yet do anything with substring nodes.
...
name|_Rope_iterator
operator|>
comment|// was templated on CharT and Alloc
name|void
comment|// VC++ workaround
name|_Rope_rotate
argument_list|(
argument|_Rope_iterator __first
argument_list|,
argument|_Rope_iterator __middle
argument_list|,
argument|_Rope_iterator __last
argument_list|)
block|{
typedef|typedef
name|typename
