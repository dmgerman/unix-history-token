...
begin_comment
comment|// TR1 reference_wrapper -*- C++ -*-
end_comment
...
begin_comment
comment|/** @file tr1/ref_wrap_iterate.h  *  This is an internal header file, included by other library headers.  *  You should not attempt to use it directly.  */
end_comment
