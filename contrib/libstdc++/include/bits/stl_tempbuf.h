...
ifndef|#
directive|ifndef
name|__GLIBCPP_INTERNAL_TEMPBUF_H
end_ifndef
...
name|_M_buffer
block|;
comment|// this is basically get_temporary_buffer() all over again
name|void
...
begin_comment
comment|/* __GLIBCPP_INTERNAL_TEMPBUF_H */
end_comment
