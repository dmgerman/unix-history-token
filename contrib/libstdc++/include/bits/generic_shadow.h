...
begin_comment
comment|// generic C header shadow file -*- C++ -*-
end_comment
...
begin_comment
comment|// This file is included by all the standard C<foo.h> headers
end_comment

begin_comment
comment|// after defining _SHADOW_NAME.
end_comment
...
directive|else
comment|/* not _IN_C_LEGACY_:  directly included by user program */
include|#
directive|include
include|_SHADOW_NAME
