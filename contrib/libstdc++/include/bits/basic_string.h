...
argument_list|)
return|;
comment|// Todo: optimized in-place replace.
else|else
return|return
name|_M_replace
argument_list|(
argument|_M_ibegin() + __pos
argument_list|,
argument|_M_ibegin() + __pos + __foldn1
argument_list|,
argument|__s
argument_list|,
argument|__s + __n2
argument_list|,
argument|typename iterator_traits<const _CharT*>::iterator_category()
argument_list|)
return|;
block|}
name|basic_string
