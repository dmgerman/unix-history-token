...
begin_comment
comment|// Debugging hash_multimap implementation -*- C++ -*-
end_comment
...
begin_comment
comment|/** @file debug/hash_multimap.h  *  This file is a GNU debug extension to the Standard C++ Library.  */
end_comment

begin_ifndef
ifndef|#
directive|ifndef
name|_GLIBCXX_DEBUG_HASH_MULTIMAP_H
end_ifndef
