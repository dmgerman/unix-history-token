...
begin_comment
comment|// Control various target specific ABI tweaks.  ARM version.
end_comment
...
directive|ifdef
name|__ARM_EABI__
comment|// The ARM EABI uses the least significant bit of a 32-bit
comment|// guard variable.  */
define|#
directive|define
...
name|__guard
typedef|;
comment|// We also want the element size in array cookies.
define|#
directive|define
name|_GLIBCXX_ELTSIZE_IN_COOKIE
value|1
comment|// __cxa_vec_ctor should return a pointer to the array.
typedef|typedef
name|void
modifier|*
...
parameter_list|)
value|return x
comment|// Constructors and destructors return the "this" pointer.
typedef|typedef
name|void
modifier|*
