...
begin_comment
comment|// Low-level functions for atomic operations: PowerPC version  -*- C++ -*-
end_comment
...
asm|__asm__
specifier|__volatile__
asm|( 	"/* Inline always swap */\n" 	"0:\t" 	"lwarx    %0,0,%1 \n\t" 	"stwcx.   %2,0,%1 \n\t" 	"bne-     0b \n\t" 	"/* End always swap */" 	: "=&r"(__res) 	: "r"(__p), "r"(__newval) 	: "cr0", "memory");
return|return
name|__res
return|;
block|}
...
asm|__asm__
specifier|__volatile__
asm|( 	"/* Inline test& set */\n" 	"0:\t" 	"lwarx    %0,0,%1 \n\t" 	"cmpwi    %0,0 \n\t" 	"bne-     1f \n\t" 	"stwcx.   %2,0,%1 \n\t" 	"bne-     0b \n" 	"1:\n\t" 	"/* End test& set */" 	: "=&r"(__res) 	: "r"(__p), "r"(__newval) 	: "cr0", "memory");
return|return
name|__res
return|;
block|}
