...
begin_comment
comment|// Specific definitions for Solaris 2.5  -*- C++ -*-
end_comment
...
begin_comment
comment|// These are typedefs which libio assumes are already in place (because
end_comment

begin_comment
comment|// they really are, under Linux).
end_comment
