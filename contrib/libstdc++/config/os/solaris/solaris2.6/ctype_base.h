...
begin_comment
comment|// Copyright (C) 1997, 1998, 1999, 2000, 2003 Free Software Foundation, Inc.
end_comment
...
begin_comment
comment|// Information as gleaned from /usr/include/ctype.h. Looks like this
end_comment

begin_comment
comment|// only works with solaris2.6.
end_comment
