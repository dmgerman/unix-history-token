...
begin_comment
comment|// Copyright (C) 1997, 1998, 1999, 2000, 2002, 2003, 2004, 2006
end_comment
...
name|ctype_base
block|{
comment|// Note: In uClibc, the following two types depend on configuration.
comment|// Non-standard typedefs.
typedef|typedef
specifier|const
name|__ctype_touplow_t
modifier|*
name|__to_type
typedef|;
