...
begin_comment
comment|// Specific definitions for Darwin -*- C++ -*-
end_comment
...
begin_comment
comment|// On Darwin, in order to enable overriding of operator new and delete,
end_comment

begin_comment
comment|// GCC makes the definition of these functions weak, relies on the
end_comment

begin_comment
comment|// loader to implement weak semantics properly, and uses
end_comment

begin_comment
comment|// -flat_namespace to work around the way that it doesn't.
end_comment

begin_define
define|#
directive|define
name|_GLIBCXX_WEAK_DEFINITION
