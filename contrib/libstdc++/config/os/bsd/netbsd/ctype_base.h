...
begin_comment
comment|// Information as gleaned from /usr/include/ctype.h on NetBSD.
end_comment

begin_comment
comment|// Full details can be found from the CVS files at:
end_comment

begin_comment
comment|//   anoncvs@anoncvs.netbsd.org:/cvsroot/basesrc/include/ctype.h
end_comment

begin_comment
comment|// See www.netbsd.org for details of access.
end_comment
