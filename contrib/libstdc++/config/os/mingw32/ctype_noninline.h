...
begin_comment
comment|// Information as gleaned from /mingw32/include/ctype.h.
end_comment

begin_comment
comment|// This should be in mingw's ctype.h but isn't in older versions
end_comment

begin_comment
comment|// Static classic C-locale table.  _ctype[0] is EOF
end_comment
