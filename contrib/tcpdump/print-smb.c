...
name|_U_
init|=
literal|"@(#) $Header: /tcpdump/master/tcpdump/print-smb.c,v 1.46.2.1 2007-12-09 00:31:35 guy Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  * Print an SMB-over-TCP packet received across tcp on port 445  */
end_comment
