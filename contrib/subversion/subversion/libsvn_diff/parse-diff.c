...
name|svn_error_t
modifier|*
name|parse_mergeinfo
parameter_list|(
name|svn_boolean_t
modifier|*
name|found_mergeinfo
parameter_list|,
name|svn_stringbuf_t
modifier|*
name|line
...
argument_list|)
expr_stmt|;
comment|/* Copy the merge source path + colon */
name|s
operator|=
name|slash
expr_stmt|;
...
expr_stmt|;
block|}
comment|/* skip 'r' after colon */
name|s
operator|++
expr_stmt|;
comment|/* Copy the revision range. */
while|while
condition|(
name|s
operator|<
...
condition|)
continue|continue;
comment|/* Proceed to the next line in the patch. */
block|}
if|if
condition|(
name|in_hunk
...
name|prop_name
expr_stmt|;
comment|/* Skip svn:mergeinfo properties.            * Mergeinfo data cannot be represented as a hunk and            * is therefore stored in PATCH itself. */
if|if
condition|(
name|strcmp
argument_list|(
