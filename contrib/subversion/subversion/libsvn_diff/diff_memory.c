...
name|data
decl_stmt|;
comment|/* const char *data[context_size] */
name|apr_size_t
modifier|*
name|len
decl_stmt|;
comment|/* apr_size_t len[context_size] */
name|apr_size_t
name|next_slot
decl_stmt|;
name|apr_size_t
...
begin_comment
comment|/* A stream which prints LINES_TO_PRINT (based on context_size) lines to    BATON->REAL_OUTPUT_STREAM, and then changes BATON->OUTPUT_STREAM to    a context_saver; used for *trailing* context. */
end_comment
...
name|svn_error_t
modifier|*
name|output_conflict_with_context_marker
parameter_list|(
name|merge_output_baton_t
modifier|*
name|btn
