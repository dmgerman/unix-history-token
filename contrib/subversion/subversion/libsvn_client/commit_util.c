...
name|me_kind
decl_stmt|;
comment|/* Maybe we need to issue an delete (mixed rev/switched) */
name|SVN_ERR
argument_list|(
name|baton
operator|->
...
begin_comment
comment|/* A svn_sort__array()/qsort()-compatible sort routine for sorting    an array of svn_client_commit_item_t *'s by their URL member. */
end_comment

begin_function
specifier|static
name|int
name|sort_commit_item_urls
parameter_list|(
specifier|const
name|void
modifier|*
...
name|pool
expr_stmt|;
comment|/* Subpools are cheap, but memory isn't */
name|file_pool
operator|=
name|svn_pool_create
argument_list|(
