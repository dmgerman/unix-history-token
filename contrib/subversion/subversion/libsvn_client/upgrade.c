...
name|svn_error_t
modifier|*
name|upgrade_externals_from_properties
parameter_list|(
name|svn_client_ctx_t
modifier|*
name|ctx
...
name|hi
decl_stmt|;
comment|/* We are upgrading from>= 1.7. No need to upgrade from          svn:externals properties. And by that avoiding the removal          of recorded externals information (issue #4519)           Only directory externals need an explicit upgrade */
for|for
control|(
name|hi
operator|=
...
block|{
comment|/* Upgrading from<= 1.6, or no svn:properties defined.          (There is no way to detect the difference from libsvn_client :( ) */
name|SVN_ERR
argument_list|(
name|upgrade_externals_from_properties
argument_list|(
