...
name|NULL
expr_stmt|;
comment|/* This must be a 'sync' merge so check branch relationship. */
if|if
condition|(
name|opt_state
operator|->
...
name|_
argument_list|(
literal|"--- Checking branch relationship\n"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
...
name|_
argument_list|(
literal|"Source and target must be different but related branches"
argument_list|)
argument_list|)
expr_stmt|;
block|}
