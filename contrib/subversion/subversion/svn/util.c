...
argument_list|,
argument|APR_EOL_STR APR_EOL_STR
argument_list|)
empty_stmt|;
operator|*
name|tmp_file
...
begin_comment
comment|/* Return a string of the form "PATH_OR_URL@REVISION". */
end_comment
...
name|svn_error_t
modifier|*
name|svn_cl__check_related_source_and_target
parameter_list|(
specifier|const
name|char
modifier|*
...
name|_
argument_list|(
literal|"Source and target have no common ancestor: "
literal|"'%s' and '%s'"
argument_list|)
argument_list|,
name|path_for_display
