...
name|N_
argument_list|(
literal|"Recursively clean up the working copy, removing locks, resuming\n"
...
literal|"     an 'automatic' merge:\n"
literal|"\n"
literal|"       svn merge SOURCE[@REV] [TARGET_WCPATH]\n"
literal|"\n"
literal|"     The automatic merge is used for the 'sync' and 'reintegrate' merges\n"
...
literal|"\n"
literal|"     TARGET_WCPATH is a working copy path; if omitted, '.' is generally\n"
literal|"     assumed. The special cases noted above in the 'automatic' merge form\n"
...
literal|"         that will be used for the next automatic merge;\n"
...
literal|"      'C' Conflicted\n"
literal|"      'M' Modified\n"
literal|"    Third column: Whether the working copy directory is locked\n"
literal|"      ' ' not locked\n"
literal|"      'L' locked\n"
...
literal|"    Sixth column: Repository lock token\n"
literal|"      (without -u)\n"
literal|"      ' ' no lock token\n"
literal|"      'K' lock token present\n"
literal|"      (with -u)\n"
literal|"      ' ' not locked in repository, no lock token\n"
literal|"      'K' locked in repository, lock toKen present\n"
literal|"      'O' locked in repository, lock token in some Other working copy\n"
literal|"      'T' locked in repository, lock token present but sTolen\n"
literal|"      'B' not locked in repository, lock token present but Broken\n"
