...
begin_comment
comment|/* Return a relative URL from information in INFO using POOL for    temporary allocation. */
end_comment
...
begin_comment
comment|/* The kinds of items for print_info_item(). */
end_comment
...
name|info_item_kind
block|,
comment|/* Repository location. */
name|info_item_url
block|,
name|info_item_relative_url
block|,
name|info_item_repos_root_url
block|,
name|info_item_repos_uuid
block|,
comment|/* Working copy revision or repository HEAD revision */
name|info_item_revision
block|,
comment|/* Commit details. */
name|info_item_last_changed_rev
block|,
name|info_item_last_changed_date
block|,
name|info_item_last_changed_author
block|,
comment|/* Working copy information */
name|info_item_wc_root
block|}
name|info_item_t
typedef|;
end_typedef
...
begin_comment
comment|/* Mapping between option keywords and info_item_t. */
end_comment

begin_typedef
typedef|typedef
struct|struct
name|info_item_map_t
block|{
specifier|const
name|svn_string_t
name|keyword
...
begin_comment
comment|/* The baton type used by the info receiver functions. */
end_comment

begin_typedef
typedef|typedef
struct|struct
name|print_info_baton_t
block|{
comment|/* The path prefix that output paths should be normalized to. */
specifier|const
name|char
modifier|*
name|path_prefix
decl_stmt|;
comment|/*    * The following fields are used by print_info_item().    */
comment|/* Which item to print. */
name|info_item_t
name|print_what
decl_stmt|;
comment|/* Do we expect to show info for multiple targets? */
name|svn_boolean_t
name|multiple_targets
decl_stmt|;
comment|/* TRUE iff the current is a local path. */
name|svn_boolean_t
name|target_is_path
decl_stmt|;
comment|/* Did we already print a line of output? */
name|svn_boolean_t
name|start_new_line
decl_stmt|;
block|}
...
begin_comment
comment|/* Find the appropriate info_item_t for KEYWORD and initialize  * RECEIVER_BATON for print_info_item(). Use SCRATCH_POOL for  * temporary allocation.  */
end_comment
...
name|_
argument_list|(
literal|"'%s' is not a valid value for --show-item"
argument_list|)
argument_list|,
name|keyword
argument_list|)
...
begin_comment
comment|/* Helper for print_info_item(): Print the value TEXT for TARGET_PATH,    either of which may be NULL. Use POOL for temporary allocation. */
end_comment
...
begin_comment
comment|/* Helper for print_info_item(): Print the revision number REV, which    may be SVN_INVALID_REVNUM, for TARGET_PATH, which may be NULL. Use    POOL for temporary allocation. */
end_comment
...
name|_
argument_list|(
literal|"--show-item is not valid in --xml mode"
argument_list|)
argument_list|)
return|;
if|if
...
name|_
argument_list|(
literal|"--no-newline is not valid in --xml mode"
argument_list|)
argument_list|)
return|;
...
name|_
argument_list|(
literal|"--incremental is only valid in --xml mode"
argument_list|)
argument_list|)
return|;
name|receiver_baton
...
literal|" non-recursive info operations"
argument_list|)
argument_list|)
return|;
name|SVN_ERR
...
name|_
argument_list|(
literal|"--no-newline' is only valid with --show-item"
argument_list|)
argument_list|)
return|;
block|}
...
argument_list|,
name|TRUE
comment|/* fetch_excluded */
argument_list|,
name|TRUE
comment|/* fetch_actual_only */
argument_list|,
name|opt_state
operator|->
