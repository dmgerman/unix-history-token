...
literal|""
decl_stmt|;
comment|/* An example:    *  relative_to_path = /a/b/c    *  target_path      = /a/x/y/z    *  result           = ../../x/y/z    *    * Another example (Windows specific):    *  relative_to_path = F:/wc    *  target_path      = C:/wc    *  result           = C:/wc    */
...
argument_list|)
expr_stmt|;
comment|/* In above example, we'd now have:    *  relative_to_path = b/c    *  target_path      = x/y/z */
comment|/* Count the elements of relative_to_path and prepend as many '..' elements    * to target_path. */
while|while
condition|(
operator|*
name|relative_to_path
