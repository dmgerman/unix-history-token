...
literal|1
expr_stmt|;
comment|/* This implements the method of finding the socket as described in    * the gpg-agent man page under the --use-standard-socket option.    * The manage page says the standard socket is "named 'S.gpg-agent' located    * in the home directory."  GPG's home directory is either the directory    * specified by $GNUPGHOME or ~/.gnupg. */
name|gpg_agent_info
operator|=
name|getenv
argument_list|(
