...
block|{
comment|/* We don't use APR-level buffering because the comparison function        * will do its own buffering. */
name|apr_file_t
modifier|*
name|file
decl_stmt|;
...
name|TRUE
expr_stmt|;
comment|/* Incomplete, but local modifications */
return|return
name|svn_error_create
argument_list|(
...
condition|)
block|{
comment|/* The delete is obstructed by something unversioned */
name|mb
operator|->
name|found_not_delete
operator|=
