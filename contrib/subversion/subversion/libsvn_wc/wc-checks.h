...
begin_comment
comment|/* This file is automatically generated from wc-checks.sql and .dist_sandbox/subversion-1.9.7/subversion/libsvn_wc/token-map.h.  * Do not edit this file -- edit the source and rerun gen-make.py */
end_comment
...
parameter_list|)
define|\
value|static const char * const varname[] = { \     STMT_0, \     STMT_1, \     NULL \   }
end_define
...
parameter_list|)
define|\
value|static const char * const varname[][2] = { \     STMT_0_INFO, \     STMT_1_INFO, \     {NULL, NULL} \   }
end_define
