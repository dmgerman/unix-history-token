...
begin_comment
comment|/* Set *CHILDREN_ABSPATHS to a new array of the full paths formed by joining  * each name in REL_CHILDREN onto DIR_ABSPATH.  *  * Allocate the output array and its elements in RESULT_POOL. */
end_comment
