...
begin_comment
comment|/* Create a property rejection description for the specified property.    The result will be allocated in RESULT_POOL. */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* Convert deleted or not-yet-added values to empty-string values, for the      purposes of diff generation and binary detection. */
if|if
condition|(
name|mine
operator|==
...
name|FALSE
expr_stmt|;
comment|/* Pass skel member INCOMING_BASE into the formal parameter ORIGINAL.          Ignore the skel member ORIGINAL. */
name|SVN_ERR
argument_list|(
...
name|_
argument_list|(
literal|">>>>>>> (incoming 'changed to' value)"
argument_list|)
decl_stmt|;
specifier|const
name|char
modifier|*
name|incoming_base_marker
init|=
name|_
argument_list|(
literal|"||||||| (incoming 'changed from' value)"
argument_list|)
decl_stmt|;
specifier|const
name|char
