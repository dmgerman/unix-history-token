...
name|local_abspath
parameter_list|,
comment|/*svn_skel_t *conflict_skel,*/
name|apr_pool_t
modifier|*
name|result_pool
parameter_list|,
...
argument_list|)
expr_stmt|;
comment|/* ### In Subversion 1.7 and 1.8 we created a legacy property conflict skel          here:     if (conflict_skel != NULL)       svn_skel__prepend(conflict_skel, *work_item);    */
name|svn_skel__prepend_str
argument_list|(
name|local_relpath
argument_list|,
