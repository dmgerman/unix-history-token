...
parameter_list|)
function_decl|;
comment|/** Set @a *mergeinfo to the mergeinfo for @a path in @a root.  *  * If there is no mergeinfo, set @a *mergeinfo to NULL.  *  * See svn_fs_get_mergeinfo2() but for the meanings of @a inherit and  * @a adjust_inheritable_mergeinfo and other details.  */
name|svn_error_t
modifier|*
