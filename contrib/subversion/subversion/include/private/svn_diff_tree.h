...
name|baton
decl_stmt|;
comment|/* To avoid an additional in some places                 * ### What? */
comment|/* Called before a directory's children are processed.    *    * Set *SKIP_CHILDREN to TRUE, to skip calling callbacks for all    * children.    *    * Set *SKIP to TRUE to skip calling the added, deleted, changed    * or closed callback for this node only.    */
name|svn_error_t
modifier|*
function_decl|(
modifier|*
...
parameter_list|)
function_decl|;
comment|/**  * Create a new svn_diff_tree_processor_t instance with all function setup  * to call into processor with all adds with copyfrom information transformed  * to simple node changes.  *  * @since New in 1.8.  */
