...
directive|endif
comment|/* __cplusplus */
comment|/*** Temporarily private stuff (should move to svn_delta.h when Editor      V2 is made public) ***/
comment|/** Callback to retrieve a node's entire set of properties.  This is  * needed by the various editor shims in order to effect backwards  * compatibility.  *  * Implementations should set @a *props to the hash of properties  * associated with @a path in @a base_revision, allocating that hash  * and its contents in @a result_pool, and should use @a scratch_pool  * for temporary allocations.  *  * @a baton is an implementation-specific closure.  */
typedef|typedef
name|svn_error_t
modifier|*
function_decl|(
...
parameter_list|)
function_decl|;
comment|/** Callback to retrieve a node's kind.  This is needed by the various  * editor shims in order to effect backwards compatibility.  *  * Implementations should set @a *kind to the node kind of @a path in  * @a base_revision, using @a scratch_pool for temporary allocations.  *  * @a baton is an implementation-specific closure.  */
typedef|typedef
name|svn_error_t
modifier|*
function_decl|(
...
parameter_list|)
function_decl|;
comment|/** Callback to fetch the name of a file to use as a delta base.  *  * Implementations should set @a *filename to the name of a file  * suitable for use as a delta base for @a path in @a base_revision  * (allocating @a *filename from @a result_pool), or to @c NULL if the  * base stream is empty.  @a scratch_pool is provided for temporary  * allocations.  *  * @a baton is an implementation-specific closure.  */
typedef|typedef
name|svn_error_t
modifier|*
function_decl|(
...
parameter_list|)
function_decl|;
comment|/** Collection of callbacks used for the shim code.  This structure  * may grow additional fields in the future.  Therefore, always use  * svn_delta_shim_callbacks_default() to allocate new instances of it.  */
typedef|typedef
struct|struct
...
name|svn_delta_shim_callbacks_t
typedef|;
comment|/** Return a collection of default shim functions in @a result_pool.  */
name|svn_delta_shim_callbacks_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** @see svn_editor_add_file(), svn_editor_t.  * @since New in 1.8.  */
typedef|typedef
name|svn_error_t
modifier|*
function_decl|(
...
parameter_list|)
function_decl|;
comment|/** @see svn_editor_add_symlink(), svn_editor_t.  * @since New in 1.8.  */
typedef|typedef
name|svn_error_t
modifier|*
function_decl|(
...
parameter_list|)
function_decl|;
comment|/** @see svn_editor_add_absent(), svn_editor_t.  * @since New in 1.8.  */
typedef|typedef
name|svn_error_t
modifier|*
function_decl|(
...
parameter_list|)
function_decl|;
comment|/** @see svn_editor_alter_directory(), svn_editor_t.  * @since New in 1.8.  */
typedef|typedef
name|svn_error_t
modifier|*
function_decl|(
...
parameter_list|)
function_decl|;
comment|/** @see svn_editor_alter_file(), svn_editor_t.  * @since New in 1.8.  */
typedef|typedef
name|svn_error_t
modifier|*
function_decl|(
...
parameter_list|)
function_decl|;
comment|/** @see svn_editor_alter_symlink(), svn_editor_t.  * @since New in 1.8.  */
typedef|typedef
name|svn_error_t
modifier|*
function_decl|(
...
parameter_list|)
function_decl|;
comment|/** @see svn_editor_delete(), svn_editor_t.  * @since New in 1.8.  */
typedef|typedef
name|svn_error_t
modifier|*
function_decl|(
...
parameter_list|)
function_decl|;
comment|/** @see svn_editor_copy(), svn_editor_t.  * @since New in 1.8.  */
typedef|typedef
name|svn_error_t
modifier|*
function_decl|(
...
parameter_list|)
function_decl|;
comment|/** @see svn_editor_move(), svn_editor_t.  * @since New in 1.8.  */
typedef|typedef
name|svn_error_t
modifier|*
function_decl|(
...
parameter_list|)
function_decl|;
comment|/** @see svn_editor_rotate(), svn_editor_t.  * @since New in 1.8.  */
typedef|typedef
name|svn_error_t
modifier|*
function_decl|(
...
parameter_list|)
function_decl|;
comment|/** @see svn_editor_complete(), svn_editor_t.  * @since New in 1.8.  */
typedef|typedef
name|svn_error_t
modifier|*
function_decl|(
...
parameter_list|)
function_decl|;
comment|/** @see svn_editor_abort(), svn_editor_t.  * @since New in 1.8.  */
typedef|typedef
name|svn_error_t
modifier|*
function_decl|(
...
parameter_list|)
function_decl|;
comment|/** Return an editor's private baton.  *  * In some cases, the baton is required outside of the callbacks. This  * function returns the private baton for use.  *  * @since New in 1.8.  */
name|void
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Sets the #svn_editor_cb_add_directory_t callback in @a editor  * to @a callback.  * @a scratch_pool is used for temporary allocations (if any).  * @see also svn_editor_setcb_many().  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Sets the #svn_editor_cb_add_file_t callback in @a editor  * to @a callback.  * @a scratch_pool is used for temporary allocations (if any).  * @see also svn_editor_setcb_many().  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Sets the #svn_editor_cb_add_symlink_t callback in @a editor  * to @a callback.  * @a scratch_pool is used for temporary allocations (if any).  * @see also svn_editor_setcb_many().  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Sets the #svn_editor_cb_add_absent_t callback in @a editor  * to @a callback.  * @a scratch_pool is used for temporary allocations (if any).  * @see also svn_editor_setcb_many().  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Sets the #svn_editor_cb_alter_directory_t callback in @a editor  * to @a callback.  * @a scratch_pool is used for temporary allocations (if any).  * @see also svn_editor_setcb_many().  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Sets the #svn_editor_cb_alter_file_t callback in @a editor  * to @a callback.  * @a scratch_pool is used for temporary allocations (if any).  * @see also svn_editor_setcb_many().  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Sets the #svn_editor_cb_alter_symlink_t callback in @a editor  * to @a callback.  * @a scratch_pool is used for temporary allocations (if any).  * @see also svn_editor_setcb_many().  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Sets the #svn_editor_cb_delete_t callback in @a editor  * to @a callback.  * @a scratch_pool is used for temporary allocations (if any).  * @see also svn_editor_setcb_many().  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Sets the #svn_editor_cb_copy_t callback in @a editor  * to @a callback.  * @a scratch_pool is used for temporary allocations (if any).  * @see also svn_editor_setcb_many().  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Sets the #svn_editor_cb_move_t callback in @a editor  * to @a callback.  * @a scratch_pool is used for temporary allocations (if any).  * @see also svn_editor_setcb_many().  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Sets the #svn_editor_cb_rotate_t callback in @a editor  * to @a callback.  * @a scratch_pool is used for temporary allocations (if any).  * @see also svn_editor_setcb_many().  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Sets the #svn_editor_cb_complete_t callback in @a editor  * to @a callback.  * @a scratch_pool is used for temporary allocations (if any).  * @see also svn_editor_setcb_many().  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Sets the #svn_editor_cb_abort_t callback in @a editor  * to @a callback.  * @a scratch_pool is used for temporary allocations (if any).  * @see also svn_editor_setcb_many().  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Lists a complete set of editor callbacks.  * This is a convenience structure.  * @see svn_editor_setcb_many(), svn_editor_create(), svn_editor_t.  * @since New in 1.8.  */
typedef|typedef
struct|struct
...
name|svn_editor_cb_many_t
typedef|;
comment|/** Sets all the callback functions in @a editor at once, according to the  * callback functions stored in @a many.  * @a scratch_pool is used for temporary allocations (if any).  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
function_decl|;
comment|/** @} */
comment|/** These functions are called by the tree delta driver to edit the target.  *  * @see svn_editor_t.  *  * @defgroup svn_editor_drive Driving the editor  * @{  */
comment|/** Drive @a editor's #svn_editor_cb_add_directory_t callback.  *  * Create a new directory at @a relpath. The immediate parent of @a relpath  * is expected to exist.  *  * For descriptions of @a props and @a replaces_rev, see  * svn_editor_add_file().  *  * A complete listing of the immediate children of @a relpath that will be  * added subsequently is given in @a children. @a children is an array of  * const char*s, each giving the basename of an immediate child. It is an  * error to pass NULL for @a children; use an empty array to indicate  * the new directory will have no children.  *  * For all restrictions on driving the editor, see #svn_editor_t.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Drive @a editor's #svn_editor_cb_add_file_t callback.  *  * Create a new file at @a relpath. The immediate parent of @a relpath  * is expected to exist.  *  * The file's contents are specified in @a contents which has a checksum  * matching @a checksum. Both values must be non-NULL.  *  * Set the properties of the new file to @a props, which is an  * apr_hash_t holding key-value pairs. Each key is a const char* of a  * property name, each value is a const svn_string_t*. If no properties are  * being set on the new file, @a props must be the empty hash. It is an  * error to pass NULL for @a props.  *  * If this add is expected to replace a previously existing file, symlink or  * directory at @a relpath, the revision number of the node to be replaced  * must be given in @a replaces_rev. Otherwise, @a replaces_rev must be  * #SVN_INVALID_REVNUM.  Note: it is not allowed to call a "delete" followed  * by an "add" on the same path. Instead, an "add" with @a replaces_rev set  * accordingly MUST be used.  *  * For all restrictions on driving the editor, see #svn_editor_t.  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Drive @a editor's #svn_editor_cb_add_symlink_t callback.  *  * Create a new symbolic link at @a relpath, with a link target of @a  * target. The immediate parent of @a relpath is expected to exist.  *  * For descriptions of @a props and @a replaces_rev, see  * svn_editor_add_file().  *  * For all restrictions on driving the editor, see #svn_editor_t.  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Drive @a editor's #svn_editor_cb_add_absent_t callback.  *  * Create an "absent" node of kind @a kind at @a relpath. The immediate  * parent of @a relpath is expected to exist.  * ### TODO @todo explain "absent".  * ### JAF: What are the allowed values of 'kind'?  *  * For a description of @a replaces_rev, see svn_editor_add_file().  *  * For all restrictions on driving the editor, see #svn_editor_t.  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Drive @a editor's #svn_editor_cb_alter_symlink_t callback.  *  * Alter the properties and/or the target of the symlink at @a relpath  * with @a revision as its expected revision. See svn_editor_alter_directory()  * for more information about @a revision.  *  * If @a props is non-NULL, then the properties will be applied.  *  * If @a target is non-NULL, then the symlink's target will be updated.  *  * The properties and/or the target must be changed. It is an error to  * pass NULL for @a props and @a target.  *  * This function allows @a props to be NULL, but the parameter is  * otherwise described by svn_editor_add_file().  *  * For all restrictions on driving the editor, see #svn_editor_t.  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Drive @a editor's #svn_editor_cb_delete_t callback.  *  * Delete the existing node at @a relpath, expected to be identical to  * revision @a revision of that path.  *  * For all restrictions on driving the editor, see #svn_editor_t.  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Drive @a editor's #svn_editor_cb_copy_t callback.  *  * Copy the node at @a src_relpath, expected to be identical to revision @a  * src_revision of that path, to @a dst_relpath.  *  * For a description of @a replaces_rev, see svn_editor_add_file().  *  * @note See the general instructions on paths for this API. Since the  * @a src_relpath argument must generally be able to reference any node  * in the repository, the implication is that the editor's root must be  * the repository root.  *  * For all restrictions on driving the editor, see #svn_editor_t.  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Drive @a editor's #svn_editor_cb_move_t callback.  *  * Move the node at @a src_relpath to @a dst_relpath.  *  * @a src_revision specifies the revision at which the receiver should  * expect to find this node.  That is, @a src_relpath at the start of  * the whole edit and @a src_relpath at @a src_revision must lie within  * the same node-rev (aka history-segment).  This is just like the  * revisions specified to svn_editor_delete() and svn_editor_rotate().  *  * For a description of @a replaces_rev, see svn_editor_add_file().  *  * ### what happens if one side of this move is not "within" the receiver's  * ### set of paths?  *  * For all restrictions on driving the editor, see #svn_editor_t.  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Drive @a editor's #svn_editor_cb_complete_t callback.  *  * Send word that the edit has been completed successfully.  *  * For all restrictions on driving the editor, see #svn_editor_t.  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
parameter_list|)
function_decl|;
comment|/** Drive @a editor's #svn_editor_cb_abort_t callback.  *  * Notify that the edit transmission was not successful.  * ### TODO @todo Shouldn't we add a reason-for-aborting argument?  *  * For all restrictions on driving the editor, see #svn_editor_t.  * @since New in 1.8.  */
name|svn_error_t
modifier|*
...
comment|/** @} */
comment|/** @} */
comment|/** A temporary API which conditionally inserts a double editor shim  * into the chain of delta editors.  Used for testing Editor v2.  *  * Whether or not the shims are inserted is controlled by a compile-time  * option in libsvn_delta/compat.c.  *  * @note The use of these shims and this API will likely cause all kinds  * of performance degredation.  (Which is actually a moot point since they  * don't even work properly yet anyway.)  */
name|svn_error_t
modifier|*
