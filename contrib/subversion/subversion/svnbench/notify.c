...
comment|/* Conflict stats for update and merge. */
name|unsigned
name|int
name|text_conflicts
decl_stmt|;
...
begin_comment
comment|/* Add a conflicted path to the list of conflicted paths stored  * in the notify baton. */
end_comment

begin_function
specifier|static
name|void
name|add_conflicted_path
parameter_list|(
name|struct
name|notify_baton
modifier|*
...
case|:
comment|/* Once all operations invoke the interactive conflict resolution after        * they've completed, we can run svn_cl__print_conflict_stats() here. */
break|break;
case|case
