...
condition|)
block|{
comment|/* The server told us that it doesn't support this report type.              We return the documented error for svn_ra_get_locks(), but              with the original error report */
return|return
...
condition|)
block|{
comment|/* File doesn't exist in HEAD: Not an error */
