...
name|curr_iprop
decl_stmt|;
comment|/* Serf context completion flag for svn_ra_serf__context_run_wait() */
name|svn_boolean_t
name|done
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|/* Clear current propname and propval in the event there are          multiple properties on the current path. */
name|svn_stringbuf_setempty
argument_list|(
name|iprops_ctx
operator|->
