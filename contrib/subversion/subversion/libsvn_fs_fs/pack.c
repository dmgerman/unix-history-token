...
argument_list|)
expr_stmt|;
comment|/* The new temporary files must live at least as long as any other info    * object in CONTEXT. */
name|SVN_ERR
argument_list|(
name|svn_io_temp_dir
argument_list|(
...
name|revdata_size
decl_stmt|;
comment|/* Copy all non-index contents the rev file to the end of the pack file. */
name|SVN_ERR
argument_list|(
name|svn_fs_fs__open_pack_or_rev_file
argument_list|(
