...
parameter_list|)
function_decl|;
comment|/* Add two base-36 alphanumeric keys to get a third, the result. */
name|void
...
begin_comment
comment|/* SVN_LIBSVN_FS_KEY_GEN_H */
end_comment
