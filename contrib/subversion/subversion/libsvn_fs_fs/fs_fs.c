...
name|total_size
decl_stmt|;
comment|/* first revision in the pack */
name|svn_revnum_t
name|start_revision
decl_stmt|;
...
decl_stmt|;
comment|/* content of the manifest.    * Maps long(rev - START_REVISION) to const char* pack file name */
name|apr_array_header_t
modifier|*
name|manifest
decl_stmt|;
...
name|_
argument_list|(
literal|"Packed revprop manifest for rev %ld too "
literal|"small"
argument_list|)
argument_list|,
name|revprops
...
name|_
argument_list|(
literal|"Failed to read revprop pack file for rev %ld"
argument_list|)
argument_list|,
name|rev
argument_list|)
...
name|_
argument_list|(
literal|"Revprop pack file for rev %ld is corrupt"
argument_list|)
argument_list|,
name|rev
argument_list|)
...
begin_comment
comment|/* Allocate a new pack file name for the revisions at index [START,END)  * of REVPROPS->MANIFEST.  Add the name of old file to FILES_TO_DELETE,  * auto-create that array if necessary.  Return an open file stream to  * the new file in *STREAM allocated in POOL.  */
end_comment
