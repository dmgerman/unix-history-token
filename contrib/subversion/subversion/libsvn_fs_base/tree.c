...
name|id_b
decl_stmt|;
comment|/* Paths from different repository are never related. */
if|if
condition|(
name|root_a
operator|->
...
argument_list|)
expr_stmt|;
comment|/* Is there a potential false positive and do we want to correct it? */
if|if
condition|(
operator|!
name|args
...
name|SVN_NO_ERROR
return|;
comment|/* Different representations. They might still have equal contents. */
name|SVN_ERR
argument_list|(
name|svn_fs_base__dag_get_proplist
argument_list|(
...
parameter_list|)
block|{
comment|/* 1:1 copy of entries with no differnce in ordering */
name|apr_hash_index_t
modifier|*
name|hi
decl_stmt|;
...
return|;
comment|/* Different representations. They might still have equal contents. */
comment|/* Compare MD5 checksums.  These should be readily accessible. */
name|SVN_ERR
argument_list|(
name|svn_fs_base__dag_file_checksum
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* Different MD5 checksums -> different contents */
if|if
condition|(
operator|!
name|svn_checksum_match
...
argument_list|)
expr_stmt|;
comment|/* Different SHA1 checksums -> different contents */
if|if
condition|(
name|checksum1
operator|&&
...
return|;
block|}
comment|/* SHA1 checksums are not available for very old reps / repositories. */
name|SVN_ERR
argument_list|(
name|svn_fs_base__dag_get_contents
argument_list|(
