...
ifndef|#
directive|ifndef
name|SVN_LIBSVN_FS_X__REV_FILE_H
end_ifndef
...
begin_comment
comment|/* Wrap the TEMP_FILE, used in the context of FS, into a revision file  * struct, allocated in RESULT_POOL, and return it in *FILE.  */
end_comment
