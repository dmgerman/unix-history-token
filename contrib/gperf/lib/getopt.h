...
directive|ifdef
name|__cplusplus
comment|/* SunOS4 declares getopt with the following prototype:    extern int getopt (int argc, const char *const *argv, const char *shortopts);    We cannot redeclare it when compiling C++ code. */
define|#
directive|define
name|getopt
parameter_list|(
...
name|z
parameter_list|)
value|getopt_long(x, y, z, (const struct option *) 0, (int *) 0)
else|#
directive|else
