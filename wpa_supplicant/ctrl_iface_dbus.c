...
name|perror
argument_list|(
literal|"wpa_supplicant_dbus_notify_scanning[dbus]: interface "
literal|"didn't have a dbus path"
argument_list|)
expr_stmt|;
name|wpa_printf
argument_list|(
name|MSG_ERROR
argument_list|,
literal|"%s[dbus]: interface didn't have a dbus path; "
literal|"can't send scanning signal."
argument_list|,
name|__FUNCTION__
argument_list|)
expr_stmt|;
...
name|perror
argument_list|(
literal|"wpa_supplicant_dbus_notify_scanning[dbus]: couldn't "
literal|"create dbus signal; likely out of memory"
argument_list|)
expr_stmt|;
name|wpa_printf
argument_list|(
name|MSG_ERROR
argument_list|,
literal|"%s[dbus]: dbus control interface: not "
literal|"enough memory to send scan results signal."
argument_list|,
name|__FUNCTION__
argument_list|)
expr_stmt|;
...
name|perror
argument_list|(
literal|"wpa_supplicant_dbus_notify_scanning[dbus]: not enough "
literal|"memory to construct signal."
argument_list|)
expr_stmt|;
name|wpa_printf
argument_list|(
name|MSG_ERROR
argument_list|,
literal|"%s[dbus]: not enough memory to "
literal|"construct signal."
argument_list|,
name|__FUNCTION__
argument_list|)
expr_stmt|;
...
name|perror
argument_list|(
literal|"wpa_supplicant_dbus_notify_wps_cred[dbus]: "
literal|"interface didn't have a dbus path"
argument_list|)
expr_stmt|;
name|wpa_printf
