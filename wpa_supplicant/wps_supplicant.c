...
condition|)
return|return;
comment|/* Could not get scan results for checking advertised 			 * parameters */
for|for
control|(
name|i
operator|=
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: AP found from scan results"
argument_list|)
expr_stmt|;
break|break;
block|}
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: The AP was not found from scan "
literal|"results - use credential as-is"
argument_list|)
expr_stmt|;
return|return;
block|}
