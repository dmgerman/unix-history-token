...
begin_comment
comment|/*  * WPA Supplicant - test code  * Copyright (c) 2003-2012, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  *  * IEEE 802.1X Supplicant test code (to be used in place of wpa_supplicant.c.  * Not used in production version.  */
end_comment
...
name|argv
argument_list|,
literal|"a:A:c:C:M:nN:o:p:r:s:St:W"
argument_list|)
expr_stmt|;
if|if
condition|(
