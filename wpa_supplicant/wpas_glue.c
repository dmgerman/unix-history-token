...
begin_comment
comment|/*  * WPA Supplicant - Glue code to setup EAPOL and RSN modules  * Copyright (c) 2003-2015, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
name|MSG_DEBUG
argument_list|,
literal|"RSN: Timeout on waiting for the AP to initiate 4-way handshake for PMKSA caching or EAP authentication - try to force it to start EAP authentication"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|MSG_DEBUG
argument_list|,
literal|"RSN: PMKSA caching - do not send EAPOL-Start"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|MSG_DEBUG
argument_list|,
literal|"EAPOL authentication completed - result=%s"
argument_list|,
name|result_str
argument_list|(
name|result
...
name|MSG_ERROR
argument_list|,
literal|"Unsupported send_ft_action action %d"
argument_list|,
name|action
argument_list|)
expr_stmt|;
...
expr_stmt|;
comment|/* 	 * Don't rely only on qosinfo for WMM capability. It may be 0 even when 	 * present. Allow the WMM IE to also indicate QoS support. 	 */
if|if
condition|(
name|wmm
operator|||
...
specifier|static
name|int
name|wpa_supplicant_tdls_enable_channel_switch
parameter_list|(
name|void
modifier|*
name|ctx
...
specifier|static
name|int
name|wpa_supplicant_tdls_disable_channel_switch
parameter_list|(
name|void
modifier|*
name|ctx
...
specifier|static
name|void
name|wpa_supplicant_eap_proxy_cb
parameter_list|(
name|void
modifier|*
name|ctx
