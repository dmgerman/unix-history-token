...
name|MSG_ERROR
argument_list|,
literal|"Line %d: key_mgmt for mesh network should be open or SAE"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|f
argument_list|,
literal|"\troaming_partner=\"%s,%d,%u,%s\"\n"
argument_list|,
name|p
operator|->
name|fqdn
...
name|f
argument_list|,
literal|"\tmin_dl_bandwidth_home=%u\n"
argument_list|,
name|cred
operator|->
name|min_dl_bandwidth_home
...
name|f
argument_list|,
literal|"\tmin_ul_bandwidth_home=%u\n"
argument_list|,
name|cred
operator|->
name|min_ul_bandwidth_home
...
name|f
argument_list|,
literal|"\tmin_dl_bandwidth_roaming=%u\n"
argument_list|,
name|cred
operator|->
name|min_dl_bandwidth_roaming
...
name|f
argument_list|,
literal|"\tmin_ul_bandwidth_roaming=%u\n"
argument_list|,
name|cred
operator|->
name|min_ul_bandwidth_roaming
...
name|f
argument_list|,
literal|"p2p_optimize_listen_chan=%d\n"
argument_list|,
name|config
operator|->
name|p2p_optimize_listen_chan
...
name|f
argument_list|,
literal|"p2p_ignore_shared_freq=%u\n"
argument_list|,
name|config
operator|->
name|p2p_ignore_shared_freq
...
name|f
argument_list|,
literal|"tdls_external_control=%d\n"
argument_list|,
name|config
operator|->
name|tdls_external_control
...
name|f
argument_list|,
literal|"reassoc_same_bss_optim=%d\n"
argument_list|,
name|config
operator|->
name|reassoc_same_bss_optim
...
literal|5
decl_stmt|;
comment|/* allow space for .tmp suffix */
name|char
modifier|*
name|tmp_name
init|=
