...
specifier|static
name|int
name|wpa_config_read_global_uuid
parameter_list|(
name|struct
name|wpa_config
modifier|*
...
specifier|static
name|int
name|wpa_config_read_global_os_version
parameter_list|(
name|struct
name|wpa_config
modifier|*
...
name|t
parameter_list|)
value|write_int(netw, #t, ssid->eap.t, 0)
define|#
directive|define
name|INT_DEF
parameter_list|(
...
name|def
parameter_list|)
value|write_int(netw, #t, ssid->eap.t, def)
name|STR
argument_list|(
name|ssid
argument_list|)
