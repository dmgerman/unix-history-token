...
argument_list|)
expr_stmt|;
comment|/* KLS kludge, under VMS if you use regs 2-5, you must save them. */
endif|#
directive|endif
name|reg_use
operator|=
...
operator|)
return|;
comment|/* type not found, must be a pointer type */
return|return
operator|(
literal|"movl"
operator|)
