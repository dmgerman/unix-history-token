...
name|MAXFAULTS
parameter_list|()
value|(MAX(zs->zs_mirrors, 1) * (zopt_raidz_parity + 1) - 1)
end_define
...
name|argv
argument_list|,
literal|"v:s:a:m:r:R:d:t:g:i:k:p:f:VET:P:hF:"
argument_list|)
operator|)
operator|!=
name|EOF
...
literal|0
argument_list|,
literal|"ztest_snapshot_create(%s) = %d"
argument_list|,
name|snapname
argument_list|,
name|error
...
literal|0
argument_list|,
literal|"dmu_objset_destroy(%s, B_TRUE) = %d"
argument_list|,
name|fullname
argument_list|,
name|error
...
literal|0
argument_list|,
literal|"dmu_objset_destroy(%s, B_FALSE) = %d"
argument_list|,
name|fullname
argument_list|,
name|error
...
literal|0
argument_list|,
literal|"dsl_dataset_user_release(%s)"
argument_list|,
name|fullname
argument_list|,
name|tag
