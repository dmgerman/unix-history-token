...
begin_comment
comment|/*  * Copyright (c) 2005, 2010, Oracle and/or its affiliates. All rights reserved.  * Copyright (c) 2011, 2016 by Delphix. All rights reserved.  * Copyright 2012 Milan Jurik. All rights reserved.  * Copyright (c) 2012, Joyent, Inc. All rights reserved.  * Copyright (c) 2011-2012 Pawel Jakub Dawidek. All rights reserved.  * Copyright (c) 2013 Steven Hartland.  All rights reserved.  * Copyright (c) 2014 Integros [integros.com]  * Copyright 2016 Igor Kozhukhov<ikozhukhov@gmail.com>.  * Copyright 2016 Nexenta Systems, Inc.  */
end_comment
...
name|gettext
argument_list|(
literal|"\tsend [-DnPpRvLec] [-[iI] snapshot] "
literal|"<snapshot>\n"
...
name|gettext
argument_list|(
literal|"\tprogram [-t<instruction limit>] "
literal|"[-m<memory limit (b)>]<pool><program file> "
literal|"[lua args...]\n"
argument_list|)
operator|)
return|;
...
name|gettext
argument_list|(
literal|"Could not initialize libshare, %d"
argument_list|)
argument_list|,
name|ret
argument_list|)
...
name|argv
argument_list|,
literal|"t:(instr-limit)m:(memory-limit)"
argument_list|)
operator|)
condition|)
block|{
...
name|gettext
argument_list|(
literal|"Invalid instruction limit: "
literal|"%s\n"
argument_list|)
argument_list|,
name|optarg
...
argument_list|)
expr_stmt|;
comment|/* 	 * Read in the channel program, expanding the program buffer as 	 * necessary. 	 */
name|progread
operator|=
literal|0
expr_stmt|;
...
literal|'\0'
expr_stmt|;
comment|/* 	 * Any remaining arguments are passed as arguments to the lua script as 	 * a string array: 	 * { 	 *	"argv" -> [ "arg 1", ... "arg n" ], 	 * } 	 */
name|nvlist_t
modifier|*
name|argnvl
init|=
...
condition|)
block|{
comment|/* 		 * On error, report the error message handed back by lua if one 		 * exists.  Otherwise, generate an appropriate error message, 		 * falling back on strerror() for an unexpected return code. 		 */
name|char
modifier|*
name|errstring
init|=
...
name|errstring
operator|=
literal|"Invalid instruction or memory limit."
expr_stmt|;
break|break;
case|case
name|ENOMEM
...
name|errstring
operator|=
literal|"Return value too large."
expr_stmt|;
break|break;
case|case
name|ENOSPC
...
name|errstring
operator|=
literal|"Memory limit exhausted."
expr_stmt|;
break|break;
case|case
name|ETIME
...
name|errstring
operator|=
literal|"Permission denied. Channel "
literal|"programs must be run as root."
expr_stmt|;
break|break;
default|default:
name|errstring
...
name|gettext
argument_list|(
literal|"Channel program execution failed:\n%s\n"
argument_list|)
argument_list|,
name|errstring
argument_list|)
...
name|printf
argument_list|(
literal|"Channel program fully executed "
argument_list|)
expr_stmt|;
if|if
condition|(
