...
begin_comment
comment|/*  * Copyright (c) 2005, 2010, Oracle and/or its affiliates. All rights reserved.  * Copyright (c) 2011, 2016 by Delphix. All rights reserved.  * Copyright (c) 2014 Integros [integros.com]  * Copyright 2017 Nexenta Systems, Inc.  */
end_comment
...
literal|"\t%s -E [-A] word0:word1:...:word15\n"
...
name|stderr
argument_list|,
literal|"        -E decode and display block from an "
literal|"embedded block pointer\n"
argument_list|)
expr_stmt|;
operator|(
name|void
...
name|stderr
argument_list|,
literal|"        -O perform object lookups by path\n"
argument_list|)
expr_stmt|;
operator|(
name|void
...
name|stderr
argument_list|,
literal|"        -v verbose (applies to all "
literal|"others)\n\n"
argument_list|)
expr_stmt|;
operator|(
...
name|stderr
argument_list|,
literal|"        -q don't print label contents\n"
argument_list|)
expr_stmt|;
operator|(
name|void
...
index|]
decl_stmt|;
comment|/* make sure the output won't get truncated */
name|CTASSERT
argument_list|(
sizeof|sizeof
argument_list|(
...
name|ms_size
decl_stmt|;
comment|/* max sure nicenum has enough space */
name|CTASSERT
argument_list|(
sizeof|sizeof
argument_list|(
...
index|]
decl_stmt|;
comment|/* make sure nicenum has enough space */
name|CTASSERT
argument_list|(
sizeof|sizeof
argument_list|(
...
parameter_list|)
define|\
value|zdb_nicenum(dd->dd_used_breakdown[DD_USED_ ## which], nice, \ 	    sizeof (nice)); \ 	(void) printf("\t\tused_breakdown[" #which "] = %s\n", nice)
name|DO
argument_list|(
name|HEAD
argument_list|)
...
name|stderr
argument_list|,
literal|"failed to own dataset '%s': %s\n"
argument_list|,
name|path
argument_list|,
name|strerror
...
begin_comment
comment|/*  * Iterate through the path components, recursively passing  * current one's obj and remaining path until we find the obj  * for the last one.  */
end_comment
...
name|stderr
argument_list|,
literal|"failed to get SA dbuf for obj %llu: %s\n"
argument_list|,
operator|(
name|u_longlong_t
operator|)
...
name|stderr
argument_list|,
literal|"invalid bonus type %d for obj %llu\n"
argument_list|,
name|doi
operator|.
name|doi_bonus_type
...
name|printf
argument_list|(
literal|"obj=%llu %s type=%d bonustype=%d\n"
argument_list|,
operator|(
name|u_longlong_t
operator|)
...
name|stderr
argument_list|,
literal|"object %llu has non-file/directory "
literal|"type %d\n"
argument_list|,
operator|(
name|u_longlong_t
...
begin_comment
comment|/*  * Dump the blocks for the object specified by path inside the dataset.  */
end_comment
...
name|stderr
argument_list|,
literal|"can't lookup root znode: %s\n"
argument_list|,
name|strerror
argument_list|(
name|err
...
specifier|static
name|int
name|random_get_pseudo_bytes_cb
parameter_list|(
name|void
modifier|*
name|buf
...
name|argv
argument_list|,
literal|"AbcCdDeEFGhiI:lLmMo:Op:PqRsSt:uU:vVx:X"
argument_list|)
operator|)
operator|!=
operator|-
...
expr_stmt|;
break|break;
comment|/* NB: Sort single match options below. */
case|case
literal|'I'
case|:
name|max_inflight
...
name|stderr
argument_list|,
literal|"cachefile must be an absolute path "
literal|"(i.e. start with a slash)\n"
argument_list|)
expr_stmt|;
name|usage
argument_list|()
