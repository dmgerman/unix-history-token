...
begin_comment
comment|/*  * Copyright (c) 2005, 2010, Oracle and/or its affiliates. All rights reserved.  * Copyright (c) 2011, 2016 by Delphix. All rights reserved.  * Copyright (c) 2014 Integros [integros.com]  * Copyright 2016 Nexenta Systems, Inc.  */
end_comment
...
name|stderr
argument_list|,
literal|"Usage: %s [-CmMdibcsDvhLXFPAG] [-t txg] [-e [-p path...]] "
...
name|argv
argument_list|,
literal|"bcdhilmMI:suCDRSAFLXx:evp:t:U:PGo:q"
argument_list|)
operator|)
operator|!=
operator|-
