...
begin_comment
comment|/* the define geteuid should be deleted if the */
end_comment

begin_comment
comment|/* routine is available in the libc.a library. */
end_comment
