...
comment|/* 	 * make sure there are free buffers when we 	 * wander off to do lengthy paket processing with 	 * any buffer we grab from the full list. 	 *  	 * fixes malloc() interrupted by SIGIO risk 	 * (Bug 889) 	 */
name|rbuf
operator|=
name|ISC_LIST_HEAD
argument_list|(
