...
name|num
expr_stmt|;
comment|/* don't overflow the memcpy to padded_from */
block|}
name|dblen
operator|=
name|num
...
return|;
block|}
comment|/* Always do this zero-padding copy (even when lzero == 0) 	 * to avoid leaking timing info about the value of lzero. */
name|padded_from
operator|=
name|db
operator|+
