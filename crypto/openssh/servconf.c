...
begin_comment
comment|/* $OpenBSD: servconf.c,v 1.165 2006/08/14 12:40:25 dtucker Exp $ */
end_comment
...
name|pw
decl_stmt|;
comment|/* 	 * Even if we do not have a user yet, we still need to check for 	 * valid syntax. 	 */
name|arg
operator|=
name|cp
operator|=
...
name|error
argument_list|(
literal|"line %d: too many groups in Match Group"
argument_list|,
name|line
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"user %.100s does not match group %.100s at line %d"
argument_list|,
name|user
argument_list|,
name|arg
...
name|debug
argument_list|(
literal|"user %.100s matched group %.100s at line %d"
argument_list|,
name|user
argument_list|,
name|arg
...
begin_comment
comment|/* Copy any (supported) values that are set */
end_comment
