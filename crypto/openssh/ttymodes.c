...
begin_comment
comment|/*  * Author: Tatu Ylonen<ylo@cs.hut.fi>  * Copyright (c) 1995 Tatu Ylonen<ylo@cs.hut.fi>, Espoo, Finland  *                    All rights reserved  * Created: Tue Mar 21 15:59:15 1995 ylo  * Encoding and decoding of terminal modes in a portable way.  * Much of the format is defined in ttymodes.h; it is included multiple times  * into this file with the appropriate macro definitions to generate the  * suitable code.  */
end_comment
...
name|RCSID
argument_list|(
literal|"$Id: ttymodes.c,v 1.6 2000/04/14 10:30:34 markus Exp $"
argument_list|)
expr_stmt|;
end_expr_stmt
