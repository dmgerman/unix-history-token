...
begin_comment
comment|/*  * Author: Tatu Ylonen<ylo@cs.hut.fi>  * Copyright (c) 1995 Tatu Ylonen<ylo@cs.hut.fi>, Espoo, Finland  *                    All rights reserved  * Created: Sat Sep  9 01:56:14 1995 ylo  * Code for uid-swapping.  */
end_comment
...
name|RCSID
argument_list|(
literal|"$Id: uidswap.c,v 1.6 2000/04/14 10:30:34 markus Exp $"
argument_list|)
expr_stmt|;
end_expr_stmt
