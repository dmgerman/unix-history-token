...
name|RCSID
argument_list|(
literal|"$OpenBSD: sshd.c,v 1.115 2000/05/03 10:21:49 markus Exp $"
argument_list|)
expr_stmt|;
end_expr_stmt
...
argument_list|)
expr_stmt|;
comment|/* 	 * save raw KEXINIT payload in buffer. this is used during 	 * computation of the session_id and the session keys. 	 */
name|client_kexinit
operator|=
name|xmalloc
argument_list|(
...
argument_list|()
expr_stmt|;
comment|/* save kex init proposal strings */
for|for
control|(
name|i
operator|=
