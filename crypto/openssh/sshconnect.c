...
begin_comment
comment|/* $OpenBSD: sshconnect.c,v 1.234 2011/05/24 07:15:47 djm Exp $ */
end_comment
...
begin_comment
comment|/*  * Set TCP receive buffer if requested.  * Note: tuning needs to happen after the socket is created but before the  * connection happens so winscale is negotiated properly.  */
end_comment

begin_function
specifier|static
name|void
name|ssh_set_socket_recvbuf
parameter_list|(
name|int
name|sock
parameter_list|)
...
name|debug
argument_list|(
literal|"setsockopt attempting to set SO_RCVBUF to %d"
argument_list|,
name|options
operator|.
name|tcp_rcv_buf
...
name|debug
argument_list|(
literal|"setsockopt SO_RCVBUF: %.100s %d"
argument_list|,
name|strerror
argument_list|(
name|errno
...
name|error
argument_list|(
literal|"Couldn't set socket receive buffer to %d: %.100s"
argument_list|,
name|options
operator|.
name|tcp_rcv_buf
