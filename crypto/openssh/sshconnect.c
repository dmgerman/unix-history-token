...
name|RCSID
argument_list|(
literal|"$OpenBSD: sshconnect.c,v 1.162 2005/03/10 22:01:06 deraadt Exp $"
argument_list|)
expr_stmt|;
end_expr_stmt
...
goto|;
block|}
comment|/* 		 * If strict host key checking has not been requested, allow 		 * the connection but without MITM-able authentication or 		 * agent forwarding. 		 */
if|if
condition|(
name|options
operator|.
