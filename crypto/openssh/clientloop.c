...
begin_comment
comment|/*  *  * clientloop.c  *  * Author: Tatu Ylonen<ylo@cs.hut.fi>  *  * Copyright (c) 1995 Tatu Ylonen<ylo@cs.hut.fi>, Espoo, Finland  *                    All rights reserved  *  *  * Created: Sat Sep 23 12:23:57 1995 ylo  *  * The main loop for the interactive session (client side).  *  * SSH2 support added by Markus Friedl.  */
end_comment
...
name|RCSID
argument_list|(
literal|"$Id: clientloop.c,v 1.26 2000/05/08 17:42:24 markus Exp $"
argument_list|)
expr_stmt|;
end_expr_stmt
