...
name|fatal
argument_list|(
literal|"%.200s line %d: Missing yes/no/ask argument."
argument_list|,
name|filename
argument_list|,
name|linenum
...
name|fatal
argument_list|(
literal|"%.200s line %d: Invalid RekeyLimit suffix"
argument_list|,
name|filename
argument_list|,
name|linenum
...
name|scale
expr_stmt|;
comment|/* detect integer wrap and too-large limits */
if|if
condition|(
operator|(
name|val64
...
name|fatal
argument_list|(
literal|"Unsupported AddressFamily \"%s\""
argument_list|,
name|arg
argument_list|)
expr_stmt|;
...
name|fatal
argument_list|(
literal|"%.200s line %d: Missing ControlMaster argument."
argument_list|,
name|filename
argument_list|,
name|linenum
...
name|fatal
argument_list|(
literal|"%.200s line %d: Bad ControlMaster argument."
argument_list|,
name|filename
argument_list|,
name|linenum
...
begin_comment
comment|/*  * parse_forward  * parses a string containing a port forwarding specification of the form:  *	[listenhost:]listenport:connecthost:connectport  * returns number of arguments parsed or zero on error  */
end_comment
...
condition|)
break|break;
comment|/* Check for trailing garbage in 4-arg case*/
if|if
condition|(
name|cp
operator|!=
