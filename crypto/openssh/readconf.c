...
begin_comment
comment|/* Characters considered whitespace in strtok calls. */
end_comment
...
break|break;
block|}
comment|/* Avoid garbage check below, as strtok already returned NULL. */
return|return
literal|0
return|;
case|case
