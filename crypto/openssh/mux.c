...
begin_comment
comment|/* $OpenBSD: mux.c,v 1.21 2010/06/25 23:15:36 djm Exp $ */
end_comment
...
name|ask_permission
argument_list|(
literal|"Allow forward to to %s:%u? "
argument_list|,
name|chost
argument_list|,
name|cport
...
name|debug3
argument_list|(
literal|"%s: channel %d: exit message, evitval %d"
argument_list|,
name|__func__
argument_list|,
name|c
...
specifier|static
name|int
name|mux_client_request_forward
parameter_list|(
name|int
name|fd
parameter_list|,
...
specifier|static
name|int
name|mux_client_request_forwards
parameter_list|(
name|int
name|fd
parameter_list|)
...
name|debug3
argument_list|(
literal|"%s: requesting forwardings: %d local, %d remote"
argument_list|,
name|__func__
argument_list|,
name|options
...
name|fatal
argument_list|(
literal|"%s: exit on unknown session: my id %u theirs %u"
argument_list|,
name|__func__
argument_list|,
name|sid
