...
begin_comment
comment|/*	$OpenBSD: md5.c,v 1.9 2014/01/08 06:14:57 tedu Exp $	*/
end_comment
...
expr_stmt|;
block|}
comment|/* Process data in MD5_BLOCK_LENGTH-byte chunks. */
while|while
condition|(
name|len
operator|>=
...
begin_comment
comment|/*  * Final wrapup--call MD5Pad, fill in digest and zero out ctx.  */
end_comment
