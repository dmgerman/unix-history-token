...
name|RCSID
argument_list|(
literal|"$Id: send_to_kdc.c,v 1.69 1999/06/29 21:18:09 bg Exp $"
argument_list|)
expr_stmt|;
end_expr_stmt
...
name|krb_warning
argument_list|(
literal|"connecting to %s udp, port %d\n"
argument_list|,
name|inet_ntoa
argument_list|(
name|adr
...
name|krb_warning
argument_list|(
literal|"sending %d bytes to %s, udp port %d\n"
argument_list|,
name|pkt
operator|->
name|length
...
name|krb_warning
argument_list|(
literal|"connecting to %s, tcp port %d\n"
argument_list|,
name|inet_ntoa
argument_list|(
name|adr
...
name|krb_warning
argument_list|(
literal|"sending %d bytes to %s, tcp port %d\n"
argument_list|,
name|pkt
operator|->
name|length
...
name|krb_warning
argument_list|(
literal|"sending %d bytes to %s, http port %d\n"
argument_list|,
name|pkt
operator|->
name|length
