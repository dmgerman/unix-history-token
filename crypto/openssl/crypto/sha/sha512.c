...
name|n
parameter_list|)
value|({ SHA_LONG64 ret;              \                                 asm ("rorq %1,%0"       \                                 : "=r"(ret)             \                                 : "J"(n),"0"(a)         \                                 : "cc"); ret;           })
end_define
...
name|n
parameter_list|)
value|({ SHA_LONG64 ret;              \                                 asm ("rotrdi %0,%1,%2"  \                                 : "=r"(ret)             \                                 : "r"(a),"K"(n)); ret;  })
end_define
...
name|n
parameter_list|)
value|({ SHA_LONG64 ret;              \                                 asm ("ror %0,%1,%2"     \                                 : "=r"(ret)             \                                 : "r"(a),"I"(n)); ret;  })
end_define
...
name|x
parameter_list|)
value|({ SHA_LONG64 ret;                      \                                 asm ("rev       %0,%1"          \                                 : "=r"(ret)                     \                                 : "r"(*((const SHA_LONG64 *)(&(x))))); ret;             })
end_define
...
begin_comment
comment|/*  * This code should give better results on 32-bit CPU with less than  * ~24 registers, both size and performance wise...  */
end_comment
...
name|X
parameter_list|)
value|do {    \         s0 = X[(j+1)&0x0f];     s0 = sigma0(s0);        \         s1 = X[(j+14)&0x0f];    s1 = sigma1(s1);        \         T1 = X[(j)&0x0f] += s0 + s1 + X[(j+9)&0x0f];    \         ROUND_00_15(i+j,a,b,c,d,e,f,g,h);               } while (0)
end_define
