...
name|Z
decl_stmt|;
comment|/* We encode infinity as (0,0), which is not on the curve,      * so it is OK. */
name|in1infty
operator|=
operator|(
name|in1_x
...
name|Y
decl_stmt|;
comment|/*      * In affine representation we encode infty as (0,0), which is not on the      * curve, so it is OK      */
name|in1infty
operator|=
operator|(
name|in1_x
