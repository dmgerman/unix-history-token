...
begin_comment
comment|/* A Bison parser, made from itbl-parse.y    by GNU bison 1.35.  */
end_comment
...
name|x
parameter_list|)
value|((unsigned)(x)<= 266 ? yytranslate[x] : 34)
end_define
...
argument_list|(
operator|(
literal|"line %d: entry pnum=%d type=%d name=%s value=x%x\n"
operator|,
name|insntbl_line
operator|,
name|yyvsp
...
argument_list|(
operator|(
literal|"line %d: entry pnum=%d type=INSN name=%s value=x%x"
operator|,
name|insntbl_line
operator|,
name|yyvsp
...
argument_list|(
operator|(
literal|" sbit=%d ebit=%d flags=0x%x\n"
operator|,
name|sbit
operator|,
name|ebit
...
argument_list|(
operator|(
literal|"line %d: field type=%d sbit=%d ebit=%d, flags=0x%x\n"
operator|,
name|insntbl_line
operator|,
name|yyvsp
