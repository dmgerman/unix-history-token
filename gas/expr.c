...
argument_list|)
expr_stmt|;
comment|/* If we have both NUMBERS_WITH_SUFFIX and LOCAL_LABELS_FB, 	     we distinguish between 'B' and 'b'.  This is the case for 	     Z80.  */
if|if
condition|(
operator|(
name|NUMBERS_WITH_SUFFIX
...
condition|)
block|{
comment|/* In MRI mode and on Z80, '$' is also used as the prefix 	     for a hexadecimal constant.  */
name|integer_constant
argument_list|(
literal|16
argument_list|,
...
literal|'='
case|:
comment|/* We accept != as equivalent to<>.  */
operator|*
name|num_chars
operator|=
literal|2
...
begin_comment
comment|/* Resolve an expression without changing any symbols/sub-expressions    used.  */
end_comment
