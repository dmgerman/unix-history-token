...
begin_comment
comment|/* cond.c - conditional assembly pseudo-ops, and .include    Copyright 1990, 1991, 1992, 1993, 1995, 1997, 1998, 2000, 2001, 2002,    2003, 2006 Free Software Foundation, Inc.     This file is part of GAS, the GNU Assembler.     GAS is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2, or (at your option)    any later version.     GAS is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with GAS; see the file COPYING.  If not, write to the Free    Software Foundation, 51 Franklin Street - Fifth Floor, Boston, MA    02110-1301, USA.  */
end_comment
...
begin_comment
comment|/* Performs the .ifdef (test_defined == 1) and    the .ifndef (test_defined == 0) pseudo op.  */
end_comment
...
name|is_defined
decl_stmt|;
comment|/* Use the same definition of 'defined' as .equiv so that a symbol 	 which has been referenced but not yet given a value/address is 	 considered to be undefined.  */
name|is_defined
operator|=
name|symbolP
operator|!=
...
begin_comment
comment|/* Performs the .ifb (test_blank == 1) and    the .ifnb (test_blank == 0) pseudo op.  */
end_comment
