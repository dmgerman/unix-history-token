...
define|#
directive|define
name|cpu32_control_regs
value|m68010_control_regs
end_define
...
name|x
parameter_list|)
value|((x)& (m68020|m68030|m68040|m68060|cpu32|mcf5407|mcfv4e))
end_define
...
block|}
block|,
comment|/* Aliases (effectively, so far as gas is concerned) for the above        cpus.  */
block|{
name|m68020
block|,
literal|"68k"
...
ifdef|#
directive|ifdef
name|NO_PCREL_RELOCS
end_ifdef

begin_function
name|int
name|make_pcrel_absolute
parameter_list|(
name|fixP
parameter_list|,
name|add_number
...
name|fr_opcode
decl_stmt|;
comment|/* Rewrite the PC relative instructions to absolute address ones.      these are rumored to be faster, and the apollo linker refuses      to deal with the PC relative relocations.  */
if|if
condition|(
name|opcode
index|[
...
name|_
argument_list|(
literal|"Unknown PC relative instruction"
argument_list|)
argument_list|)
expr_stmt|;
operator|*
...
name|_
argument_list|(
literal|"fpu (68040, 68060 or 68881/68882)"
argument_list|)
argument_list|)
expr_stmt|;
break|break;
...
begin_comment
comment|/* a.out machine type.  Default to 68020.  */
end_comment
...
parameter_list|()
block|{
comment|/* Note which set of "movec" control registers is available.  */
switch|switch
condition|(
name|cpu_of_arch
argument_list|(
...
name|_
argument_list|(
literal|"architecture not yet selected: defaulting to 68020"
argument_list|)
argument_list|)
expr_stmt|;
name|control_regs
...
comment|/* Toss in some default assumptions about coprocessors.  */
if|if
condition|(
operator|!
name|no_68881
...
name|current_architecture
argument_list|)
comment|/* Can CPU32 have a 68881 coprocessor??  */
operator|&
operator|(
name|m68020
operator||
...
name|_
argument_list|(
literal|"options for 68881 and no-68881 both given"
argument_list|)
argument_list|)
expr_stmt|;
if|if
...
name|_
argument_list|(
literal|"options for 68851 and no-68851 both given"
argument_list|)
argument_list|)
expr_stmt|;
ifdef|#
directive|ifdef
name|OBJ_AOUT
comment|/* Work out the magic number.  This isn't very general.  */
if|if
condition|(
name|current_architecture
operator|&
...
expr_stmt|;
block|}
comment|/* Update info about available control registers.  */
name|select_control_regs
argument_list|()
expr_stmt|;
block|}
...
name|_
argument_list|(
literal|"unrecognized architecture specification `%s'"
argument_list|)
argument_list|,
name|arg
argument_list|)
...
name|_
argument_list|(
literal|"\ --base-size-default-16	base reg without size is 16 bits\n\ --base-size-default-32	base reg without size is 32 bits (default)\n\ --disp-size-default-16	displacement with unknown size is 16 bits\n\ --disp-size-default-32	displacement with unknown size is 32 bits (default)\n"
argument_list|)
argument_list|)
expr_stmt|;
block|}
