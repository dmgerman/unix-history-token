...
begin_comment
comment|/* tc-m68k.c -- Assemble for the m68k family    Copyright 1987, 1991, 1992, 1993, 1994, 1995, 1996, 1997, 1998, 1999,    2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007 Free Software Foundation, Inc.     This file is part of GAS, the GNU Assembler.     GAS is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2, or (at your option)    any later version.     GAS is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with GAS; see the file COPYING.  If not, write to the Free    Software Foundation, 51 Franklin Street - Fifth Floor, Boston, MA    02110-1301, USA.  */
end_comment
...
block|,
name|MPCR
comment|/* Multiprocessor Control register */
block|,
name|EDRAMBAR
comment|/* Embedded DRAM Base Address Register */
block|,
comment|/* Permutation control registers.  */
name|PCR1U0
block|,
name|PCR1L0
block|,
...
name|x
parameter_list|)
value|((x)& (m68000up | mcfisa_a | fido_a))
end_define
...
parameter_list|)
define|\
value|((x)& (m68020|m68030|m68040|m68060|cpu32|fido_a|mcfisa_b|mcfisa_c))
end_define
...
parameter_list|)
define|\
value|((x)& (m68020|m68030|m68040|m68060|cpu32|fido_a|mcfisa_b))
end_define
...
begin_comment
comment|/* PR gas/3041 Weak symbols are not relaxable    because they must be treated as extern.  */
end_comment
...
argument_list|)
condition|)
comment|/* PR gas/3041 Adjust addend in order to force bfd_install_relocation()        to put the symbol offset into frags referencing a weak symbol.  */
name|reloc
operator|->
name|addend
operator|=
...
condition|)
break|break;
comment|/* In most CPUs RAMBAR refers to control reg 	     	 	     c05 (RAMBAR1), but a few CPUs have it 	     	 	     refer to c04 (RAMBAR0).  */
elseif|else
if|if
condition|(
operator|*
...
literal|'s'
case|:
comment|/* Unconditional subroutine */
name|have_disp
operator|=
name|HAVE_LONG_CALL
argument_list|(
...
name|_
argument_list|(
literal|"Can't use long branches on this architecture"
argument_list|)
argument_list|)
expr_stmt|;
goto|goto
...
block|,
comment|/* Data Access Control Register 0.  */
comment|/* Coldfire versions of same.  The ColdFire programmer's reference      manual indicated that the order is 2,3,0,1, but Ken Rose<rose@netcom.com> says that 0,1,2,3 is the correct order.  */
block|{
literal|"acr0"
block|,
name|ACR0
...
index|]
expr_stmt|;
comment|/* We must enter all insns into the table, because .arch and 	     .cpu directives can change things.  */
name|slak
operator|->
name|m_operands
operator|=
...
name|opcode
expr_stmt|;
comment|/* In most cases we can determine the number of opcode words 	     by checking the second word of the mask.  Unfortunately 	     some instructions have 2 opcode words, but no fixed bits 	     in the second word.  A leading dot in the operands 	     string also indicates 2 opcodes.  */
if|if
condition|(
operator|*
name|slak
...
name|OBJ_AOUT
argument_list|)
comment|/* PR gas/3041 Do not fix frags referencing a weak symbol.  */
if|if
condition|(
name|fixP
operator|->
...
name|_
argument_list|(
literal|"Conversion of PC relative BSR to absolute JSR"
argument_list|)
argument_list|)
expr_stmt|;
name|fragP
...
name|_
argument_list|(
literal|"Conversion of PC relative branch to absolute jump"
argument_list|)
argument_list|)
expr_stmt|;
name|fragP
...
name|_
argument_list|(
literal|"Conversion of PC relative conditional branch to absolute jump"
argument_list|)
argument_list|)
expr_stmt|;
...
name|_
argument_list|(
literal|"Conversion of DBcc to absolute jump"
argument_list|)
argument_list|)
expr_stmt|;
operator|*
...
name|_
argument_list|(
literal|"Conversion of PC relative displacement to absolute"
argument_list|)
argument_list|)
expr_stmt|;
