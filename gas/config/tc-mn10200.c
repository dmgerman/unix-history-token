...
begin_comment
comment|/* tc-mn10200.c -- Assembler code for the Matsushita 10200    Copyright 1996, 1997, 1998, 1999, 2000, 2001, 2002, 2003    Free Software Foundation, Inc.     This file is part of GAS, the GNU Assembler.     GAS is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2, or (at your option)    any later version.     GAS is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with GAS; see the file COPYING.  If not, write to    the Free Software Foundation, 59 Temple Place - Suite 330,    Boston, MA 02111-1307, USA.  */
end_comment
...
expr_stmt|;
block|}
comment|/* This is both a simplification (we don't have to write md_apply_fix3)      and support for future optimizations (branch shortening and similar      stuff in the linker.  */
name|linkrelax
operator|=
literal|1
expr_stmt|;
...
condition|)
block|{
comment|/* FIXME: We should resolve difference expressions if possible 	 here.  At least this is better than silently ignoring the 	 subtrahend.  */
name|as_bad_where
argument_list|(
name|fixp
operator|->
...
directive|if
literal|0
block|if (fixp->fx_addsy != (symbolS *) NULL&& !S_IS_DEFINED (fixp->fx_addsy))     {
comment|/* The symbol is undefined.  Let the linker figure it out.  */
block|return 0;     }   return fixp->fx_frag->fr_address + fixp->fx_where;
endif|#
directive|endif
block|}
end_function
