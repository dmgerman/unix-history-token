...
define|#
directive|define
name|to_video_device
parameter_list|(
name|cd
parameter_list|)
value|container_of(cd, struct video_device, class_dev)
end_define
...
begin_comment
comment|/* helper functions to access driver private data. */
end_comment
