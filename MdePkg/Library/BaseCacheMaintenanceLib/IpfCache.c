...
begin_comment
comment|/** @file   Cache Maintenance Functions.    Copyright (c) 2006 - 2009, Intel Corporation. All rights reserved.<BR>   This program and the accompanying materials   are licensed and made available under the terms and conditions of the BSD License   which accompanies this distribution.  The full text of the license may be found at   http://opensource.org/licenses/bsd-license.php.    THE PROGRAM IS DISTRIBUTED UNDER THE BSD LICENSE ON AN "AS IS" BASIS,   WITHOUT WARRANTIES OR REPRESENTATIONS OF ANY KIND, EITHER EXPRESS OR IMPLIED.  **/
end_comment
...
include|#
directive|include
file|<Library/CacheMaintenanceLib.h>
end_include
...
block|{
comment|//
comment|// Invalidation of the entire data cache without writing back is not supported
comment|// on IPF architecture, so a write back and invalidate operation is performed.
comment|//
name|WriteBackInvalidateDataCache
argument_list|()
expr_stmt|;
...
comment|// IPF architecture, so write back and invalidate operation is performed.
comment|//
return|return
name|AsmFlushCacheRange
argument_list|(
