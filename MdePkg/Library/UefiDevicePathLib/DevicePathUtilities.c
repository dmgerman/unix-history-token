...
block|}
comment|//
comment|// Find the end of the device path instance
comment|//
name|DevPath
operator|=
operator|*
...
block|}
comment|//
comment|// Compute the size of the device path instance
comment|//
operator|*
name|Size
operator|=
...
expr_stmt|;
comment|//
comment|// Make a copy and return the device path instance
comment|//
name|Temp
operator|=
name|DevPath
...
expr_stmt|;
comment|//
comment|// If DevPath is the end of an entire device path, then another instance
comment|// does not follow, so *DevicePath is set to NULL.
comment|//
if|if
condition|(
name|DevicePathSubType
