...
modifier|*
name|mDevicePathLibDevicePathUtilities
init|=
name|NULL
decl_stmt|;
end_decl_stmt
...
modifier|*
name|mDevicePathLibDevicePathToText
init|=
name|NULL
decl_stmt|;
end_decl_stmt
...
modifier|*
name|mDevicePathLibDevicePathFromText
init|=
name|NULL
decl_stmt|;
end_decl_stmt
...
name|EFI_STATUS
name|EFIAPI
name|UefiDevicePathLibOptionalDevicePathProtocolConstructor
parameter_list|(
name|IN
name|EFI_HANDLE
name|ImageHandle
...
begin_comment
comment|/**   Locate and return the protocol instance identified by the ProtocolGuid.    @param ProtocolGuid     The GUID of the protocol.    @return A pointer to the protocol instance or NULL when absent. **/
end_comment

begin_function
name|VOID
modifier|*
name|UefiDevicePathLibLocateProtocol
parameter_list|(
name|EFI_GUID
modifier|*
name|ProtocolGuid
