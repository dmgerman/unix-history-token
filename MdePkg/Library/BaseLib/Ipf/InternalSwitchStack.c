...
begin_comment
comment|/** @file   SwitchStack() function for IPF.    Copyright (c) 2007 - 2010, Intel Corporation. All rights reserved.<BR>   This program and the accompanying materials   are licensed and made available under the terms and conditions of the BSD License   which accompanies this distribution.  The full text of the license may be found at   http://opensource.org/licenses/bsd-license.php.    THE PROGRAM IS DISTRIBUTED UNDER THE BSD LICENSE ON AN "AS IS" BASIS,   WITHOUT WARRANTIES OR REPRESENTATIONS OF ANY KIND, EITHER EXPRESS OR IMPLIED.  **/
end_comment
...
decl_stmt|;
comment|//
comment|// Get new backing store pointer from variable list
comment|//
name|NewBsp
operator|=
name|VA_ARG
...
expr_stmt|;
comment|//
comment|// New backing store pointer should be aligned with CPU_STACK_ALIGNMENT
comment|//
name|ASSERT
argument_list|(
operator|(
