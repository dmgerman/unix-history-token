...
begin_comment
comment|/**   Gets the base address of PCI Express.      This internal functions retrieves PCI Express Base Address via a PCD entry   PcdPciExpressBaseAddress.      @return The base address of PCI Express.  **/
end_comment

begin_function
name|VOID
modifier|*
name|GetPciExpressBaseAddress
parameter_list|(
name|VOID
parameter_list|)
block|{
