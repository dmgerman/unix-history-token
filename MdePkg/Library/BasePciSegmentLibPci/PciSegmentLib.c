...
begin_comment
comment|/** @file   PCI Segment Library that layers on top of the PCI Library which only    supports segment 0 PCI configuration access.    Copyright (c) 2016, Intel Corporation. All rights reserved.<BR>   This program and the accompanying materials are   licensed and made available under the terms and conditions of   the BSD License which accompanies this distribution.  The full   text of the license may be found at   http://opensource.org/licenses/bsd-license.php.    THE PROGRAM IS DISTRIBUTED UNDER THE BSD LICENSE ON AN "AS IS" BASIS,   WITHOUT WARRANTIES OR REPRESENTATIONS OF ANY KIND, EITHER EXPRESS OR IMPLIED.  **/
end_comment
...
begin_comment
comment|/**   Assert the validity of a PCI Segment address.   A valid PCI Segment address should not contain 1's in bits 28..31 and 48..63   and the segment should be 0.    @param  A The address to validate.   @param  M Additional bits to assert to be zero.  **/
end_comment
...
parameter_list|)
define|\
value|ASSERT (((A)& (0xfffffffff0000000ULL | (M))) == 0)
end_define

begin_comment
comment|/**   Convert the PCI Segment library address to PCI library address.    @param A The address to convert. **/
end_comment

begin_define
define|#
directive|define
name|PCI_SEGMENT_TO_PCI_ADDRESS
parameter_list|(
name|A
parameter_list|)
value|((UINTN) (UINT32) A)
end_define
