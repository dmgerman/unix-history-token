...
begin_comment
comment|/**   Internal function to compare two GUIDs.    This function compares Guid1 to Guid2.  If the GUIDs are identical then TRUE is returned.   If there are any bit differences in the two GUIDs, then FALSE is returned.    @param  Guid1       A pointer to a 128 bit GUID.   @param  Guid2       A pointer to a 128 bit GUID.    @retval TRUE        Guid1 and Guid2 are identical.   @retval FALSE       Guid1 and Guid2 are not identical.  **/
end_comment

begin_function_decl
name|BOOLEAN
name|EFIAPI
name|InternalMemCompareGuid
parameter_list|(
name|IN
name|CONST
name|GUID
