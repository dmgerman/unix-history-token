...
begin_comment
comment|/** @file   HOB Library implemenation for Dxe Phase.  Copyright (c) 2006 - 2017, Intel Corporation. All rights reserved.<BR> This program and the accompanying materials are licensed and made available under the terms and conditions of the BSD License which accompanies this distribution.  The full text of the license may be found at http://opensource.org/licenses/bsd-license.php  THE PROGRAM IS DISTRIBUTED UNDER THE BSD LICENSE ON AN "AS IS" BASIS, WITHOUT WARRANTIES OR REPRESENTATIONS OF ANY KIND, EITHER EXPRESS OR IMPLIED.  **/
end_comment
...
begin_comment
comment|/**   The constructor function caches the pointer to HOB list by calling GetHobList()   and will always return EFI_SUCCESS.     @param  ImageHandle   The firmware allocated handle for the EFI image.   @param  SystemTable   A pointer to the EFI System Table.    @retval EFI_SUCCESS   The constructor successfully gets HobList.  **/
end_comment

begin_function
name|EFI_STATUS
name|EFIAPI
name|HobLibConstructor
parameter_list|(
name|IN
name|EFI_HANDLE
name|ImageHandle
...
block|{
comment|//
comment|// PEI HOB is read only for DXE phase
comment|//
name|ASSERT
argument_list|(
name|FALSE
