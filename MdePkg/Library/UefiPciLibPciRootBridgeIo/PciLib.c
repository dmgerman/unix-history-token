...
begin_comment
comment|/** @file   PCI Library using PCI Root Bridge I/O Protocol.    Copyright (c) 2007 - 2012, Intel Corporation. All rights reserved.<BR>   This program and the accompanying materials are   licensed and made available under the terms and conditions of   the BSD License which accompanies this distribution.  The full   text of the license may be found at   http://opensource.org/licenses/bsd-license.php.      THE PROGRAM IS DISTRIBUTED UNDER THE BSD LICENSE ON AN "AS IS" BASIS,   WITHOUT WARRANTIES OR REPRESENTATIONS OF ANY KIND, EITHER EXPRESS OR IMPLIED.  **/
end_comment
...
begin_comment
comment|// Global varible to cache pointer to PCI Root Bridge I/O protocol.
end_comment
...
begin_function
name|UINT32
name|DxePciLibPciRootBridgeIoReadWorker
parameter_list|(
name|IN
name|UINTN
name|Address
...
begin_function
name|UINT32
name|DxePciLibPciRootBridgeIoWriteWorker
parameter_list|(
name|IN
name|UINTN
name|Address
