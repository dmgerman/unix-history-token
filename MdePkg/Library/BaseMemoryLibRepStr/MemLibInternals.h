...
begin_comment
comment|/**   Copy Length bytes from Source to Destination.    @param  DestinationBuffer Target of copy   @param  SourceBuffer      Place to copy from   @param  Length            The number of bytes to copy    @return Destination  **/
end_comment
