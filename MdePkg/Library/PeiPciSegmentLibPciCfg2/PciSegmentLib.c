...
begin_comment
comment|/** @file   PCI Segment Library implementation using PCI CFG2 PPI.    Copyright (c) 2007 - 2012, Intel Corporation. All rights reserved.<BR>   This program and the accompanying materials are   licensed and made available under the terms and conditions of   the BSD License which accompanies this distribution.  The full   text of the license may be found at   http://opensource.org/licenses/bsd-license.php.      THE PROGRAM IS DISTRIBUTED UNDER THE BSD LICENSE ON AN "AS IS" BASIS,   WITHOUT WARRANTIES OR REPRESENTATIONS OF ANY KIND, EITHER EXPRESS OR IMPLIED.  **/
end_comment
...
begin_comment
comment|/**   Gets PCI CFG2 PPI.    This internal function retrieves PCI CFG2 PPI from PPI database.    @param  Address       The address that encodes the PCI Segment, Bus, Device,                          Function and Register.    @return The pointer to PCI CFG2 PPI.  **/
end_comment

begin_function
name|EFI_PEI_PCI_CFG2_PPI
modifier|*
name|InternalGetPciCfg2Ppi
parameter_list|(
name|IN
name|UINT64
name|Address
...
expr_stmt|;
comment|//
comment|// Loop through all instances of the PPI and match segment number
comment|//
do|do
block|{
name|Status
...
begin_function
name|UINT32
name|PeiPciSegmentLibPciCfg2ReadWorker
parameter_list|(
name|IN
name|UINT64
name|Address
...
begin_function
name|UINT32
name|PeiPciSegmentLibPciCfg2WriteWorker
parameter_list|(
name|IN
name|UINT64
name|Address
