...
begin_comment
comment|/** @file Implementation of PcdLib class library for DXE phase.  Copyright (c) 2006 - 2016, Intel Corporation. All rights reserved.<BR> This program and the accompanying materials                           are licensed and made available under the terms and conditions of the BSD License          which accompanies this distribution.  The full text of the license may be found at         http://opensource.org/licenses/bsd-license.php                                                                                                                                        THE PROGRAM IS DISTRIBUTED UNDER THE BSD LICENSE ON AN "AS IS" BASIS,                      WITHOUT WARRANTIES OR REPRESENTATIONS OF ANY KIND, EITHER EXPRESS OR IMPLIED.                **/
end_comment
...
include|#
directive|include
file|<Protocol/PiPcd.h>
end_include

begin_include
include|#
directive|include
file|<Protocol/PcdInfo.h>
end_include

begin_include
include|#
directive|include
file|<Protocol/PiPcdInfo.h>
end_include
...
begin_comment
comment|/**   Retrieves the PI PCD protocol from the handle database.    @retval EFI_PCD_PROTOCOL * The pointer to the EFI_PCD_PROTOCOL. **/
end_comment
...
block|{
comment|//
comment|// PI Pcd protocol defined in PI 1.2 vol3 should be installed before the module
comment|// access DynamicEx type PCD.
comment|//
name|Status
operator|=
name|gBS
...
begin_comment
comment|/**   Retrieves the PCD protocol from the handle database.    @retval PCD_PROTOCOL * The pointer to the PCD_PROTOCOL. **/
end_comment
...
block|{
comment|//
comment|// PCD protocol need to be installed before the module access Dynamic type PCD.
comment|// But dynamic type PCD is not required in PI 1.2 specification.
comment|//
name|Status
operator|=
name|gBS
...
begin_comment
comment|/**   Retrieves the PI PCD info protocol from the handle database.    @retval EFI_GET_PCD_INFO_PROTOCOL * The pointer to the EFI_GET_PCD_INFO_PROTOCOL defined in PI 1.2.1 Vol 3. **/
end_comment

begin_function
name|EFI_GET_PCD_INFO_PROTOCOL
modifier|*
name|GetPiPcdInfoProtocolPointer
parameter_list|(
name|VOID
parameter_list|)
block|{
...
begin_comment
comment|/**   Retrieves the PCD info protocol from the handle database.    @retval GET_PCD_INFO_PROTOCOL * The pointer to the GET_PCD_INFO_PROTOCOL. **/
end_comment

begin_function
name|GET_PCD_INFO_PROTOCOL
modifier|*
name|GetPcdInfoProtocolPointer
parameter_list|(
name|VOID
parameter_list|)
block|{
