...
begin_comment
comment|// Global ID for the USB I/O Protocol
end_comment
...
define|#
directive|define
name|EFI_USB_IO_PROTOCOL_GUID
define|\
value|{ \     0x2B2F68D6, 0x0CD2, 0x44cf, {0x8E, 0x8B, 0xBB, 0xA2, 0x0B, 0x1B, 0x5B, 0x75 } \   }
end_define

begin_typedef
typedef|typedef
name|struct
name|_EFI_USB_IO_PROTOCOL
...
begin_comment
comment|// Related Definition for EFI USB I/O protocol
end_comment
...
begin_comment
comment|/// USB data transfer direction
end_comment
...
begin_comment
comment|// Prototype for EFI USB I/O protocol
end_comment
...
name|EFIAPI
modifier|*
name|EFI_USB_IO_CONTROL_TRANSFER
function_decl|)
parameter_list|(
name|IN
name|EFI_USB_IO_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_USB_IO_ASYNC_INTERRUPT_TRANSFER
function_decl|)
parameter_list|(
name|IN
name|EFI_USB_IO_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_USB_IO_SYNC_INTERRUPT_TRANSFER
function_decl|)
parameter_list|(
name|IN
name|EFI_USB_IO_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_USB_IO_ISOCHRONOUS_TRANSFER
function_decl|)
parameter_list|(
name|IN
name|EFI_USB_IO_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_USB_IO_ASYNC_ISOCHRONOUS_TRANSFER
function_decl|)
parameter_list|(
name|IN
name|EFI_USB_IO_PROTOCOL
...
begin_comment
comment|/**   Resets and reconfigures the USB controller. This function will work for all USB devices except   USB Hub Controllers.    @param  This                  A pointer to the EFI_USB_IO_PROTOCOL instance.    @retval EFI_SUCCESS           The USB controller was reset.   @retval EFI_INVALID_PARAMETER If the controller specified by This is a USB hub.   @retval EFI_DEVICE_ERROR      An error occurred during the reconfiguration process.  **/
end_comment
...
name|EFIAPI
modifier|*
name|EFI_USB_IO_GET_DEVICE_DESCRIPTOR
function_decl|)
parameter_list|(
name|IN
name|EFI_USB_IO_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_USB_IO_GET_CONFIG_DESCRIPTOR
function_decl|)
parameter_list|(
name|IN
name|EFI_USB_IO_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_USB_IO_GET_INTERFACE_DESCRIPTOR
function_decl|)
parameter_list|(
name|IN
name|EFI_USB_IO_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_USB_IO_GET_ENDPOINT_DESCRIPTOR
function_decl|)
parameter_list|(
name|IN
name|EFI_USB_IO_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_USB_IO_GET_STRING_DESCRIPTOR
function_decl|)
parameter_list|(
name|IN
name|EFI_USB_IO_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_USB_IO_GET_SUPPORTED_LANGUAGE
function_decl|)
parameter_list|(
name|IN
name|EFI_USB_IO_PROTOCOL
...
begin_comment
comment|/// The EFI_USB_IO_PROTOCOL provides four basic transfers types described
end_comment

begin_comment
comment|/// in the USB 1.1 Specification. These include control transfer, interrupt
end_comment

begin_comment
comment|/// transfer, bulk transfer and isochronous transfer. The EFI_USB_IO_PROTOCOL
end_comment

begin_comment
comment|/// also provides some basic USB device/controller management and configuration
end_comment

begin_comment
comment|/// interfaces. A USB device driver uses the services of this protocol to manage USB devices.
end_comment
...
decl_stmt|;
name|EFI_USB_IO_BULK_TRANSFER
name|UsbBulkTransfer
decl_stmt|;
name|EFI_USB_IO_ASYNC_INTERRUPT_TRANSFER
name|UsbAsyncInterruptTransfer
decl_stmt|;
name|EFI_USB_IO_SYNC_INTERRUPT_TRANSFER
name|UsbSyncInterruptTransfer
decl_stmt|;
name|EFI_USB_IO_ISOCHRONOUS_TRANSFER
name|UsbIsochronousTransfer
decl_stmt|;
name|EFI_USB_IO_ASYNC_ISOCHRONOUS_TRANSFER
name|UsbAsyncIsochronousTransfer
decl_stmt|;
comment|//
comment|// Common device request
comment|//
name|EFI_USB_IO_GET_DEVICE_DESCRIPTOR
name|UsbGetDeviceDescriptor
decl_stmt|;
name|EFI_USB_IO_GET_CONFIG_DESCRIPTOR
name|UsbGetConfigDescriptor
decl_stmt|;
name|EFI_USB_IO_GET_INTERFACE_DESCRIPTOR
...
decl_stmt|;
name|EFI_USB_IO_GET_STRING_DESCRIPTOR
name|UsbGetStringDescriptor
decl_stmt|;
name|EFI_USB_IO_GET_SUPPORTED_LANGUAGE
name|UsbGetSupportedLanguages
decl_stmt|;
comment|//
comment|// Reset controller's parent port
comment|//
name|EFI_USB_IO_PORT_RESET
name|UsbPortReset
decl_stmt|;
