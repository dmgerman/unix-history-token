...
begin_comment
comment|/// Global ID for the Variable Architectural Protocol
end_comment
...
define|#
directive|define
name|EFI_VARIABLE_ARCH_PROTOCOL_GUID
define|\
value|{ 0x1e5668e2, 0x8481, 0x11d4, {0xbc, 0xf1, 0x0, 0x80, 0xc7, 0x3c, 0x88, 0x81 } }
end_define
