...
define|\
value|{ \     0x143b7632, 0xb81b, 0x4cb7, {0xab, 0xd3, 0xb6, 0x25, 0xa5, 0xb9, 0xbf, 0xfe } \   }
end_define

begin_typedef
typedef|typedef
name|struct
name|_EFI_EXT_SCSI_PASS_THRU_PROTOCOL
name|EFI_EXT_SCSI_PASS_THRU_PROTOCOL
typedef|;
end_typedef
...
define|#
directive|define
name|EFI_EXT_SCSI_PASS_THRU_ATTRIBUTES_PHYSICAL
value|0x0001
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_PASS_THRU_ATTRIBUTES_LOGICAL
value|0x0002
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_PASS_THRU_ATTRIBUTES_NONBLOCKIO
value|0x0004
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_DATA_DIRECTION_READ
value|0
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_DATA_DIRECTION_WRITE
value|1
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_DATA_DIRECTION_BIDIRECTIONAL
value|2
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_HOST_ADAPTER_OK
value|0x00
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_HOST_ADAPTER_TIMEOUT_COMMAND
value|0x09
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_HOST_ADAPTER_TIMEOUT
value|0x0b
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_HOST_ADAPTER_MESSAGE_REJECT
value|0x0d
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_HOST_ADAPTER_BUS_RESET
value|0x0e
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_HOST_ADAPTER_PARITY_ERROR
value|0x0f
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_HOST_ADAPTER_REQUEST_SENSE_FAILED
value|0x10
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_HOST_ADAPTER_SELECTION_TIMEOUT
value|0x11
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_HOST_ADAPTER_DATA_OVERRUN_UNDERRUN
value|0x12
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_HOST_ADAPTER_BUS_FREE
value|0x13
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_HOST_ADAPTER_PHASE_ERROR
value|0x14
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_HOST_ADAPTER_OTHER
value|0x7f
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_TARGET_GOOD
value|0x00
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_TARGET_CHECK_CONDITION
value|0x02
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_TARGET_CONDITION_MET
value|0x04
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_TARGET_BUSY
value|0x08
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_TARGET_INTERMEDIATE
value|0x10
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_TARGET_INTERMEDIATE_CONDITION_MET
value|0x14
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_TARGET_RESERVATION_CONFLICT
value|0x18
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_TARGET_TASK_SET_FULL
value|0x28
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_TARGET_ACA_ACTIVE
value|0x30
end_define
...
define|#
directive|define
name|EFI_EXT_SCSI_STATUS_TARGET_TASK_ABORTED
value|0x40
end_define
...
decl_stmt|;
block|}
name|EFI_EXT_SCSI_PASS_THRU_MODE
typedef|;
end_typedef
...
comment|/// EFI_TIMEOUT if the time required to execute the SCSI
comment|/// Request Packet is greater than Timeout.
comment|///
name|UINT64
name|Timeout
decl_stmt|;
...
comment|/// controller and the SCSI device for read and bidirectional commands.
comment|///
name|VOID
modifier|*
name|InDataBuffer
...
comment|///
comment|/// A pointer to the data buffer to transfer between the SCSI
comment|/// controller and the SCSI device for write or bidirectional commands.
comment|///
name|VOID
modifier|*
name|OutDataBuffer
...
comment|/// send to the SCSI device specified by Target and Lun.
comment|///
name|VOID
modifier|*
name|Cdb
...
decl_stmt|;
comment|///
comment|/// The length, in bytes, of the buffer Cdb. The standard values are 6,
comment|/// 10, 12, and 16, but other values are possible if a variable length CDB is used.
comment|///
name|UINT8
name|CdbLength
decl_stmt|;
...
decl_stmt|;
comment|///
comment|/// The status of the host adapter specified by This when the SCSI
comment|/// Request Packet was executed on the target device.
comment|///
name|UINT8
name|HostAdapterStatus
decl_stmt|;
comment|///
comment|/// The status returned by the device specified by Target and Lun
comment|/// when the SCSI Request Packet was executed.
comment|///
name|UINT8
name|TargetStatus
decl_stmt|;
...
decl_stmt|;
block|}
name|EFI_EXT_SCSI_PASS_THRU_SCSI_REQUEST_PACKET
typedef|;
end_typedef
...
name|EFIAPI
modifier|*
name|EFI_EXT_SCSI_PASS_THRU_PASSTHRU
function_decl|)
parameter_list|(
name|IN
name|EFI_EXT_SCSI_PASS_THRU_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_EXT_SCSI_PASS_THRU_GET_NEXT_TARGET_LUN
function_decl|)
parameter_list|(
name|IN
name|EFI_EXT_SCSI_PASS_THRU_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_EXT_SCSI_PASS_THRU_BUILD_DEVICE_PATH
function_decl|)
parameter_list|(
name|IN
name|EFI_EXT_SCSI_PASS_THRU_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_EXT_SCSI_PASS_THRU_GET_TARGET_LUN
function_decl|)
parameter_list|(
name|IN
name|EFI_EXT_SCSI_PASS_THRU_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_EXT_SCSI_PASS_THRU_RESET_CHANNEL
function_decl|)
parameter_list|(
name|IN
name|EFI_EXT_SCSI_PASS_THRU_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_EXT_SCSI_PASS_THRU_RESET_TARGET_LUN
function_decl|)
parameter_list|(
name|IN
name|EFI_EXT_SCSI_PASS_THRU_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_EXT_SCSI_PASS_THRU_GET_NEXT_TARGET
function_decl|)
parameter_list|(
name|IN
name|EFI_EXT_SCSI_PASS_THRU_PROTOCOL
...
begin_comment
comment|/// The EFI_EXT_SCSI_PASS_THRU_PROTOCOL provides information about a SCSI channel
end_comment

begin_comment
comment|/// and the ability to send SCI Request Packets to any SCSI device attached to
end_comment

begin_comment
comment|/// that SCSI channel. The information includes the Target ID of the host controller
end_comment

begin_comment
comment|/// on the SCSI channel and the attributes of the SCSI channel.
end_comment
...
block|{
comment|///
comment|/// A pointer to the EFI_EXT_SCSI_PASS_THRU_MODE data for this SCSI channel.
comment|///
name|EFI_EXT_SCSI_PASS_THRU_MODE
modifier|*
name|Mode
...
specifier|extern
name|EFI_GUID
name|gEfiExtScsiPassThruProtocolGuid
decl_stmt|;
end_decl_stmt
