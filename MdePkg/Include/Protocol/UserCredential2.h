...
begin_comment
comment|/** @file   UEFI 2.3.1 User Credential Protocol definition.    Attached to a device handle, this protocol identifies a single means of identifying the user.    Copyright (c) 2009 - 2011, Intel Corporation. All rights reserved.<BR>   This program and the accompanying materials                             are licensed and made available under the terms and conditions of the BSD License            which accompanies this distribution.  The full text of the license may be found at           http://opensource.org/licenses/bsd-license.php                                                THE PROGRAM IS DISTRIBUTED UNDER THE BSD LICENSE ON AN "AS IS" BASIS,                        WITHOUT WARRANTIES OR REPRESENTATIONS OF ANY KIND, EITHER EXPRESS OR IMPLIED.               **/
end_comment

begin_ifndef
ifndef|#
directive|ifndef
name|__USER_CREDENTIAL2_H__
end_ifndef
...
define|#
directive|define
name|EFI_USER_CREDENTIAL2_PROTOCOL_GUID
define|\
value|{ \     0xe98adb03, 0xb8b9, 0x4af8, { 0xba, 0x20, 0x26, 0xe9, 0x11, 0x4c, 0xbc, 0xe5 } \   }
end_define

begin_typedef
typedef|typedef
name|struct
name|_EFI_USER_CREDENTIAL2_PROTOCOL
name|EFI_USER_CREDENTIAL2_PROTOCOL
typedef|;
end_typedef
...
name|EFIAPI
modifier|*
name|EFI_CREDENTIAL2_GET_NEXT_INFO
function_decl|)
parameter_list|(
name|IN
name|CONST
...
specifier|extern
name|EFI_GUID
name|gEfiUserCredential2ProtocolGuid
decl_stmt|;
end_decl_stmt
