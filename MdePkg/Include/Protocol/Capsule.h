...
begin_comment
comment|// Global ID for the Capsule Architectural Protocol
end_comment
...
define|#
directive|define
name|EFI_CAPSULE_ARCH_PROTOCOL_GUID
define|\
value|{ 0x5053697e, 0x2cbc, 0x4819, {0x90, 0xd9, 0x05, 0x80, 0xde, 0xee, 0x57, 0x54 }}
end_define

begin_decl_stmt
specifier|extern
name|EFI_GUID
name|gEfiCapsuleArchProtocolGuid
decl_stmt|;
end_decl_stmt
