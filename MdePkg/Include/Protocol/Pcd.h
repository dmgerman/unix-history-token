...
define|\
value|{ 0x11b34006, 0xd85b, 0x4d0a, { 0xa2, 0x90, 0xd5, 0xa5, 0x71, 0x31, 0xe, 0xf7 } }
end_define
...
begin_comment
comment|/**   Retrieves a pointer to a value for a given PCD token.    Retrieves the current pointer to the buffer for a PCD token number.     Do not make any assumptions about the alignment of the pointer that    is returned by this function call.  If the TokenNumber is invalid,    the results are unpredictable.    @param[in]  Guid        The token space for the token number.   @param[in]  TokenNumber The PCD token number.     @return The pointer to the buffer to be retrieved.    **/
end_comment
...
name|EFIAPI
modifier|*
name|PCD_PROTOCOL_GET_EX_POINTER
function_decl|)
parameter_list|(
name|IN
name|CONST
...
name|EFIAPI
modifier|*
name|PCD_PROTOCOL_GET_EX_BOOLEAN
function_decl|)
parameter_list|(
name|IN
name|CONST
...
name|EFIAPI
modifier|*
name|PCD_PROTOCOL_SET_EX_POINTER
function_decl|)
parameter_list|(
name|IN
name|CONST
...
name|EFIAPI
modifier|*
name|PCD_PROTOCOL_SET_EX_BOOLEAN
function_decl|)
parameter_list|(
name|IN
name|CONST
...
name|EFIAPI
modifier|*
name|PCD_PROTOCOL_CALLBACK_ONSET
function_decl|)
parameter_list|(
name|IN
name|CONST
...
name|EFIAPI
modifier|*
name|PCD_PROTOCOL_CANCEL_CALLBACK
function_decl|)
parameter_list|(
name|IN
name|CONST
...
name|EFIAPI
modifier|*
name|PCD_PROTOCOL_GET_NEXT_TOKEN
function_decl|)
parameter_list|(
name|IN
name|CONST
...
name|EFIAPI
modifier|*
name|PCD_PROTOCOL_GET_NEXT_TOKENSPACE
function_decl|)
parameter_list|(
name|IN
name|OUT
