...
begin_comment
comment|/** @file   UEFI Driver Configuration2 Protocol    Copyright (c) 2006 - 2008, Intel Corporation. All rights reserved.<BR>   This program and the accompanying materials                             are licensed and made available under the terms and conditions of the BSD License            which accompanies this distribution.  The full text of the license may be found at           http://opensource.org/licenses/bsd-license.php                                                THE PROGRAM IS DISTRIBUTED UNDER THE BSD LICENSE ON AN "AS IS" BASIS,                        WITHOUT WARRANTIES OR REPRESENTATIONS OF ANY KIND, EITHER EXPRESS OR IMPLIED.               **/
end_comment

begin_ifndef
ifndef|#
directive|ifndef
name|__EFI_DRIVER_CONFIGURATION2_H__
end_ifndef
...
begin_comment
comment|/// Global ID for the Driver Configuration Protocol defined in UEFI 2.0
end_comment
...
define|\
value|{ \     0xbfd7dc1d, 0x24f1, 0x40d9, {0x82, 0xe7, 0x2e, 0x09, 0xbb, 0x6b, 0x4e, 0xbe } \   }
end_define

begin_typedef
typedef|typedef
name|struct
name|_EFI_DRIVER_CONFIGURATION2_PROTOCOL
...
block|{
comment|///
comment|/// The controller is still in a usable state. No actions
comment|/// are required before this controller can be used again.
comment|///
name|EfiDriverConfigurationActionNone
init|=
literal|0
block|,
comment|///
comment|/// The driver has detected that the controller is not in a
comment|/// usable state, and it needs to be stopped.
comment|///
name|EfiDriverConfigurationActionStopController
init|=
literal|1
block|,
comment|///
comment|/// This controller needs to be stopped and restarted
comment|/// before it can be used again.
comment|///
name|EfiDriverConfigurationActionRestartController
init|=
literal|2
block|,
comment|///
comment|/// A configuration change has been made that requires the platform to be restarted before
comment|/// the controller can be used again.
comment|///
name|EfiDriverConfigurationActionRestartPlatform
init|=
literal|3
block|,
name|EfiDriverConfigurationActionMaximum
block|}
...
define|#
directive|define
name|EFI_DRIVER_CONFIGURATION_SAFE_DEFAULTS
value|0x00000000
end_define
...
define|#
directive|define
name|EFI_DRIVER_CONFIGURATION_MANUFACTURING_DEFAULTS
value|0x00000001
end_define
...
define|#
directive|define
name|EFI_DRIVER_CONFIGURATION_CUSTOM_DEFAULTS
value|0x00000002
end_define
...
name|EFIAPI
modifier|*
name|EFI_DRIVER_CONFIGURATION2_SET_OPTIONS
function_decl|)
parameter_list|(
name|IN
name|EFI_DRIVER_CONFIGURATION2_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_DRIVER_CONFIGURATION2_OPTIONS_VALID
function_decl|)
parameter_list|(
name|IN
name|EFI_DRIVER_CONFIGURATION2_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_DRIVER_CONFIGURATION2_FORCE_DEFAULTS
function_decl|)
parameter_list|(
name|IN
name|EFI_DRIVER_CONFIGURATION2_PROTOCOL
