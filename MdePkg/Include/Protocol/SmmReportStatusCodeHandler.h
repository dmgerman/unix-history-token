...
ifndef|#
directive|ifndef
name|__SMM_REPORT_STATUS_CODE_HANDLER_PROTOCOL_H__
end_ifndef
...
define|#
directive|define
name|EFI_SMM_RSC_HANDLER_PROTOCOL_GUID
define|\
value|{ \     0x2ff29fa7, 0x5e80, 0x4ed9, {0xb3, 0x80, 0x1, 0x7d, 0x3c, 0x55, 0x4f, 0xf4} \   }
end_define
...
name|EFIAPI
modifier|*
name|EFI_SMM_RSC_HANDLER_CALLBACK
function_decl|)
parameter_list|(
name|IN
...
name|EFIAPI
modifier|*
name|EFI_SMM_RSC_HANDLER_REGISTER
function_decl|)
parameter_list|(
name|IN
name|EFI_SMM_RSC_HANDLER_CALLBACK
...
name|EFIAPI
modifier|*
name|EFI_SMM_RSC_HANDLER_UNREGISTER
function_decl|)
parameter_list|(
name|IN
name|EFI_SMM_RSC_HANDLER_CALLBACK
...
typedef|typedef
struct|struct
name|_EFI_SMM_RSC_HANDLER_PROTOCOL
block|{
name|EFI_SMM_RSC_HANDLER_REGISTER
name|Register
decl_stmt|;
...
decl_stmt|;
block|}
name|EFI_SMM_RSC_HANDLER_PROTOCOL
typedef|;
end_typedef
...
specifier|extern
name|EFI_GUID
name|gEfiSmmRscHandlerProtocolGuid
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|// __SMM_REPORT_STATUS_CODE_HANDLER_PROTOCOL_H__
end_comment
