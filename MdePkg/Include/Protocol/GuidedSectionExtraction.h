...
ifndef|#
directive|ifndef
name|__GUID_SECTION_EXTRACTION_PROTOCOL_H__
end_ifndef
...
begin_comment
comment|// The protocol interface structures are identified by associating
end_comment

begin_comment
comment|// them with a GUID. Each instance of a protocol with a given
end_comment

begin_comment
comment|// GUID must have the same interface structure. While all instances
end_comment

begin_comment
comment|// of the GUIDed Section Extraction Protocol must have the same
end_comment

begin_comment
comment|// interface structure, they do not all have the same GUID. The
end_comment

begin_comment
comment|// GUID that is associated with an instance of the GUIDed Section
end_comment

begin_comment
comment|// Extraction Protocol is used to correlate it with the GUIDed
end_comment

begin_comment
comment|// section type that it is intended to process.
end_comment
...
name|EFIAPI
modifier|*
name|EFI_EXTRACT_GUIDED_SECTION
function_decl|)
parameter_list|(
name|IN
name|CONST
...
begin_comment
comment|/// Typically, protocol interface structures are identified by associating them with a GUID. Each
end_comment

begin_comment
comment|/// instance of a protocol with a given GUID must have the same interface structure. While all instances
end_comment

begin_comment
comment|/// of the GUIDed Section Extraction Protocol must have the same interface structure, they do not all
end_comment

begin_comment
comment|/// have the same GUID. The GUID that is associated with an instance of the GUIDed Section
end_comment

begin_comment
comment|/// Extraction Protocol is used to correlate it with the GUIDed section type that it is intended to process.
end_comment
