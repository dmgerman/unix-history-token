...
begin_comment
comment|/**   Set the current video mode information.    @param  This                 The EFI_UGA_DRAW_PROTOCOL instance.   @param  HorizontalResolution The size of video screen in pixels in the X dimension.   @param  VerticalResolution   The size of video screen in pixels in the Y dimension.   @param  ColorDepth           Number of bits per pixel, currently defined to be 32.   @param  RefreshRate          The refresh rate of the monitor in Hertz.    @retval EFI_SUCCESS          Mode information returned.   @retval EFI_NOT_STARTED      Video display is not initialized. Call SetMode ()  **/
end_comment
...
begin_comment
comment|/// Enumration value for actions of Blt operations.
end_comment
...
block|,
comment|///< Write data from the  BltBuffer pixel (SourceX, SourceY)
...
name|EfiUgaBltMax
comment|///< Maxmimum value for enumration value of Blt operation. If a Blt operation
comment|///< larger or equal to this enumration value, it is invalid.
block|}
...
begin_comment
comment|/// This protocol provides a basic abstraction to set video modes and
end_comment

begin_comment
comment|/// copy pixels to and from the graphics controller's frame buffer.
end_comment
