...
begin_comment
comment|/** @file   I2C Host Protocol as defined in the PI 1.3 specification.    This protocol provides callers with the ability to do I/O transactions    to all of the devices on the I2C bus.    Copyright (c) 2013 - 2015, Intel Corporation. All rights reserved.<BR>   This program and the accompanying materials                             are licensed and made available under the terms and conditions of the BSD License            which accompanies this distribution.  The full text of the license may be found at           http://opensource.org/licenses/bsd-license.php                                                THE PROGRAM IS DISTRIBUTED UNDER THE BSD LICENSE ON AN "AS IS" BASIS,                        WITHOUT WARRANTIES OR REPRESENTATIONS OF ANY KIND, EITHER EXPRESS OR IMPLIED.                 @par Revision Reference:   This protocol is from PI Version 1.3.  **/
end_comment
...
define|#
directive|define
name|EFI_I2C_HOST_PROTOCOL_GUID
value|{ 0xa5aab9e3, 0xc727, 0x48cd, { 0x8b, 0xbf, 0x42, 0x72, 0x33, 0x85, 0x49, 0x48 }}
end_define
...
begin_comment
comment|/// The I2C bus driver uses the services of the EFI_I2C_HOST_PROTOCOL
end_comment

begin_comment
comment|/// to produce an instance of the EFI_I2C_IO_PROTOCOL for each I2C
end_comment

begin_comment
comment|/// device on an I2C bus.
end_comment
...
begin_comment
comment|/// The EFI_I2C_HOST_PROTOCOL exposes an asynchronous interface to
end_comment

begin_comment
comment|/// callers to perform transactions to any device on the I2C bus.
end_comment

begin_comment
comment|/// Internally, the I2C host protocol manages the flow of the I2C
end_comment

begin_comment
comment|/// transactions to the host controller, keeping them in FIFO order.
end_comment

begin_comment
comment|/// Prior to each transaction, the I2C host protocol ensures that the
end_comment

begin_comment
comment|/// switches and multiplexers are properly configured.  The I2C host
end_comment

begin_comment
comment|/// protocol then starts the transaction on the host controller using
end_comment

begin_comment
comment|/// the EFI_I2C_MASTER_PROTOCOL.
end_comment
...
name|EFIAPI
modifier|*
name|EFI_I2C_HOST_PROTOCOL_QUEUE_REQUEST
function_decl|)
parameter_list|(
name|IN
name|CONST
...
block|{
comment|///
comment|/// Queue an I2C transaction for execution on the I2C bus
comment|///
name|EFI_I2C_HOST_PROTOCOL_QUEUE_REQUEST
name|QueueRequest
decl_stmt|;
comment|///
comment|/// Pointer to an EFI_I2C_CONTROLLER_CAPABILITIES data structure
comment|/// containing the capabilities of the I2C host controller.
comment|///
name|CONST
