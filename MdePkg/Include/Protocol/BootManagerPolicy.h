...
begin_comment
comment|/** @file   Boot Manager Policy Protocol as defined in UEFI Specification.    This protocol is used by EFI Applications to request the UEFI Boot Manager   to connect devices using platform policy.    Copyright (c) 2015, Intel Corporation. All rights reserved.<BR>   This program and the accompanying materials                             are licensed and made available under the terms and conditions of the BSD License            which accompanies this distribution.  The full text of the license may be found at           http://opensource.org/licenses/bsd-license.php                                                THE PROGRAM IS DISTRIBUTED UNDER THE BSD LICENSE ON AN "AS IS" BASIS,                        WITHOUT WARRANTIES OR REPRESENTATIONS OF ANY KIND, EITHER EXPRESS OR IMPLIED.              **/
end_comment

begin_ifndef
ifndef|#
directive|ifndef
name|__BOOT_MANAGER_POLICY_H__
end_ifndef
...
define|\
value|{ \     0xFEDF8E0C, 0xE147, 0x11E3, { 0x99, 0x03, 0xB8, 0xE8, 0x56, 0x2C, 0xBA, 0xFA } \   }
end_define
...
define|\
value|{ \     0xCAB0E94C, 0xE15F, 0x11E3, { 0x91, 0x8D, 0xB8, 0xE8, 0x56, 0x2C, 0xBA, 0xFA } \   }
end_define
...
define|\
value|{ \     0xD04159DC, 0xE15F, 0x11E3, { 0xB2, 0x61, 0xB8, 0xE8, 0x56, 0x2C, 0xBA, 0xFA } \   }
end_define
...
define|\
value|{ \     0x113B2126, 0xFC8A, 0x11E3, { 0xBD, 0x6C, 0xB8, 0xE8, 0x56, 0x2C, 0xBA, 0xFA } \   }
end_define

begin_typedef
typedef|typedef
name|struct
name|_EFI_BOOT_MANAGER_POLICY_PROTOCOL
name|EFI_BOOT_MANAGER_POLICY_PROTOCOL
typedef|;
end_typedef
...
name|EFIAPI
modifier|*
name|EFI_BOOT_MANAGER_POLICY_CONNECT_DEVICE_PATH
function_decl|)
parameter_list|(
name|IN
name|EFI_BOOT_MANAGER_POLICY_PROTOCOL
...
name|EFIAPI
modifier|*
name|EFI_BOOT_MANAGER_POLICY_CONNECT_DEVICE_CLASS
function_decl|)
parameter_list|(
name|IN
name|EFI_BOOT_MANAGER_POLICY_PROTOCOL
...
decl_stmt|;
name|EFI_BOOT_MANAGER_POLICY_CONNECT_DEVICE_PATH
name|ConnectDevicePath
decl_stmt|;
name|EFI_BOOT_MANAGER_POLICY_CONNECT_DEVICE_CLASS
name|ConnectDeviceClass
decl_stmt|;
block|}
struct|;
end_struct
...
specifier|extern
name|EFI_GUID
name|gEfiBootManagerPolicyConsoleGuid
decl_stmt|;
end_decl_stmt
...
specifier|extern
name|EFI_GUID
name|gEfiBootManagerPolicyNetworkGuid
decl_stmt|;
end_decl_stmt
