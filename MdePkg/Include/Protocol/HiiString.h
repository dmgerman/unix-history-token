...
name|EFIAPI
modifier|*
name|EFI_HII_GET_2ND_LANGUAGES
function_decl|)
parameter_list|(
name|IN
name|CONST
...
begin_comment
comment|/// Services to manipulate the string.
end_comment
