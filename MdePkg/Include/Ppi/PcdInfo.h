...
define|#
directive|define
name|GET_PCD_INFO_PPI_GUID
define|\
value|{ 0x4d8b155b, 0xc059, 0x4c8f, { 0x89, 0x26,  0x6, 0xfd, 0x43, 0x31, 0xdb, 0x8a } }
end_define
...
begin_comment
comment|/// The forward declaration for GET_PCD_INFO_PPI.
end_comment
...
name|EFIAPI
modifier|*
name|GET_PCD_INFO_PPI_GET_INFO
function_decl|)
parameter_list|(
name|IN
name|UINTN
...
name|EFIAPI
modifier|*
name|GET_PCD_INFO_PPI_GET_INFO_EX
function_decl|)
parameter_list|(
name|IN
name|CONST
