...
define|\
value|{ 0x1f34d25, 0x4de2, 0x23ad, { 0x3f, 0xf3, 0x36, 0x35, 0x3f, 0xf3, 0x23, 0xf1 } }
end_define
...
begin_comment
comment|/**   Retrieves the current 32-bit value for a PCD token number. If the TokenNumber is invalid, the   results are unpredictable.    @param[in]    Guid          The 128-bit unique value that designates which namespace to extract the value from.   @param[in]    TokenNumber   The PCD token number.    @return 32-bit value for a given PCD token. **/
end_comment
...
begin_comment
comment|/**   Retrieves the current 64-bit value for a PCD token number. If the TokenNumber is invalid, the   results are unpredictable.    @param[in]    Guid          The 128-bit unique value that designates which namespace to extract the value from.   @param[in]    TokenNumber   The PCD token number.    @return 64-bit value for a given PCD token. **/
end_comment
...
begin_comment
comment|/**   Retrieves the current pointer to the value for a PCD token number. There should not be any   alignment assumptions about the pointer that is returned by this function call. If the TokenNumber   is invalid, the results are unpredictable.    @param[in]    Guid          The 128-bit unique value that designates which namespace to extract the value from.   @param[in]    TokenNumber   The PCD token number. **/
end_comment
...
name|EFIAPI
modifier|*
name|EFI_PEI_PCD_PPI_GET_POINTER
function_decl|)
parameter_list|(
name|IN
name|CONST
...
name|EFIAPI
modifier|*
name|EFI_PEI_PCD_PPI_GET_BOOLEAN
function_decl|)
parameter_list|(
name|IN
name|CONST
...
name|EFIAPI
modifier|*
name|EFI_PEI_PCD_PPI_SET_POINTER
function_decl|)
parameter_list|(
name|IN
name|CONST
...
name|EFIAPI
modifier|*
name|EFI_PEI_PCD_PPI_SET_BOOLEAN
function_decl|)
parameter_list|(
name|IN
name|CONST
...
name|EFIAPI
modifier|*
name|EFI_PEI_PCD_PPI_CALLBACK_ON_SET
function_decl|)
parameter_list|(
name|IN
name|CONST
...
name|EFIAPI
modifier|*
name|EFI_PEI_PCD_PPI_CANCEL_CALLBACK
function_decl|)
parameter_list|(
name|IN
name|CONST
...
name|EFIAPI
modifier|*
name|EFI_PEI_PCD_PPI_GET_NEXT_TOKEN
function_decl|)
parameter_list|(
name|IN
name|CONST
...
name|EFIAPI
modifier|*
name|EFI_PEI_PCD_PPI_GET_NEXT_TOKEN_SPACE
function_decl|)
parameter_list|(
name|IN
name|OUT
