...
ifndef|#
directive|ifndef
name|__MASTER_BOOT_MODE_PPI_H__
end_ifndef
...
define|#
directive|define
name|EFI_PEI_MASTER_BOOT_MODE_PEIM_PPI
define|\
value|{ \     0x7408d748, 0xfc8c, 0x4ee6, {0x92, 0x88, 0xc4, 0xbe, 0xc0, 0x92, 0xa4, 0x10 } \   }
end_define

begin_decl_stmt
specifier|extern
name|EFI_GUID
name|gEfiPeiMasterBootModePpiGuid
decl_stmt|;
end_decl_stmt
