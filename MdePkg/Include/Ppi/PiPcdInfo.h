...
define|#
directive|define
name|EFI_GET_PCD_INFO_PPI_GUID
define|\
value|{ 0xa60c6b59, 0xe459, 0x425d, { 0x9c, 0x69,  0xb, 0xcc, 0x9c, 0xb2, 0x7d, 0x81 } }
end_define
...
begin_comment
comment|/// The forward declaration for EFI_GET_PCD_INFO_PPI.
end_comment
...
name|EFIAPI
modifier|*
name|EFI_GET_PCD_INFO_PPI_GET_INFO
function_decl|)
parameter_list|(
name|IN
name|CONST
...
name|EFIAPI
modifier|*
name|EFI_GET_PCD_INFO_PPI_GET_SKU
function_decl|)
parameter_list|(
name|VOID
parameter_list|)
