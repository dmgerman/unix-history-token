...
begin_comment
comment|/// Define the maximum number of characters that are required to
end_comment

begin_comment
comment|/// encode with a NULL terminator a decimal, hexadecimal, GUID,
end_comment

begin_comment
comment|/// or TIME value.
end_comment
...
begin_comment
comment|///  Maximum Length Decimal String     = 28
end_comment

begin_comment
comment|///    "-9,223,372,036,854,775,808"
end_comment

begin_comment
comment|///  Maximum Length Hexadecimal String = 17
end_comment
...
begin_comment
comment|///  Maximum Length GUID               = 37
end_comment
...
begin_comment
comment|///  Maximum Length TIME               = 18
end_comment

begin_comment
comment|///    "12/12/2006  12:12"
end_comment
...
begin_comment
comment|/// Flags bitmask values use in UnicodeValueToString() and
end_comment

begin_comment
comment|/// AsciiValueToString()
end_comment
