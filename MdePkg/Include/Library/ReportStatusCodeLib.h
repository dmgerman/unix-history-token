...
ifndef|#
directive|ifndef
name|__REPORT_STATUS_CODE_LIB_H__
end_ifndef
...
begin_comment
comment|// Declare bits for PcdReportStatusCodePropertyMask
end_comment
...
define|#
directive|define
name|REPORT_STATUS_CODE_PROPERTY_PROGRESS_CODE_ENABLED
value|0x00000001
end_define
...
define|#
directive|define
name|REPORT_STATUS_CODE_PROPERTY_ERROR_CODE_ENABLED
value|0x00000002
end_define
...
define|#
directive|define
name|REPORT_STATUS_CODE_PROPERTY_DEBUG_CODE_ENABLED
value|0x00000004
end_define
...
begin_comment
comment|/**   Reports a status code with minimal parameters if the status code type is enabled.    If the status code type specified by Type is enabled in    PcdReportStatusCodeProperyMask, then call ReportStatusCode() passing in Type    and Value.    @param  Type   The status code type.    @param  Value  The status code value.    @retval  EFI_SUCCESS       The status code was reported.   @retval  EFI_DEVICE_ERROR  There status code could not be reported due to a device error.   @retval  EFI_UNSUPPORTED   Report status code is not supported.  **/
end_comment
...
define|#
directive|define
name|REPORT_STATUS_CODE_WITH_DEVICE_PATH
parameter_list|(
name|Type
parameter_list|,
name|Value
parameter_list|,
name|DevicePathParameter
parameter_list|)
define|\
value|(ReportProgressCodeEnabled()&& ((Type)& EFI_STATUS_CODE_TYPE_MASK) == EFI_PROGRESS_CODE) ?  \   ReportStatusCodeWithDevicePath(Type,Value,DevicePathParameter)                             :  \   (ReportErrorCodeEnabled()&& ((Type)& EFI_STATUS_CODE_TYPE_MASK) == EFI_ERROR_CODE)       ?  \   ReportStatusCodeWithDevicePath(Type,Value,DevicePathParameter)                             :  \   (ReportDebugCodeEnabled()&& ((Type)& EFI_STATUS_CODE_TYPE_MASK) == EFI_DEBUG_CODE)       ?  \   ReportStatusCodeWithDevicePath(Type,Value,DevicePathParameter)                             :  \   EFI_UNSUPPORTED
end_define
