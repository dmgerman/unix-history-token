...
begin_comment
comment|/*  * asm code commented out due to optimizer bug calqhat(ujp,v1p) register int *ujp, *v1p; { asm("	movl	$0x3fffffff,r0"); asm("	cmpl	(r10),(r11)"); asm("	beql	on1"); asm("	emul	(r11),$0x40000000,4(r11),r1"); asm("	ediv	(r10),r1,r0,r5"); asm("on1:"); asm("	emul	r0,4(r10),$0,r1"); asm("	emul	r5,$0x40000000,8(r11),r3"); asm("	subl2	r3,r1"); asm("	sbwc	r4,r2"); asm("	bleq	out1"); asm("	decl	r0"); asm("out1:"); } mlsb(utop,ubot,vtop,nqhat) register int *utop, *ubot, *vtop; register int nqhat; { asm("	clrl	r0"); asm("loop2:	addl2	(r11),r0"); asm("	emul	r8,-(r9),r0,r2"); asm("	extzv	$0,$30,r2,(r11)"); asm("	extv	$30,$32,r2,r0"); asm("	acbl	r10,$-4,r11,loop2"); } adback(utop,ubot,vtop) register int *utop, *ubot, *vtop; { asm("	clrl	r0"); asm("loop3:	addl2	-(r9),r0"); asm("	addl2	(r11),r0"); asm("	extzv	$0,$30,r0,(r11)"); asm("	extv	$30,$2,r0,r0"); asm("	acbl	r10,$-4,r11,loop3"); } dsdiv(top,bot,div) register int* bot; { asm("	clrl	r0"); asm("loop4:	emul	r0,$0x40000000,(r11),r1"); asm("	ediv	12(ap),r1,(r11),r0"); asm("	acbl	4(ap),$4,r11,loop4"); } dsmult(top,bot,mult) register int* top; { asm("	clrl	r0"); asm("loop5:	emul	12(ap),(r11),r0,r1"); asm("	extzv	$0,$30,r1,(r11)"); asm("	extv	$30,$32,r1,r0"); asm("	acbl	8(ap),$-4,r11,loop5"); asm("	movl	r1,4(r11)"); } lispval export(top,bot) register lispval bot; { 	register r10, r9, r8, r7, r6; asm("	movl	4(ap),r10"); asm("	movl	$0xC0000000,r4"); asm("	jmp	Bexport"); } */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* leave room for dsmult and dsadd1 */
name|bot
operator|=
name|sp
argument_list|()
expr_stmt|;
comment|/* to spill into, export will prune */
comment|/* any unnecessary leading zeroes   */
if|if
condition|(
name|n
operator|>=
