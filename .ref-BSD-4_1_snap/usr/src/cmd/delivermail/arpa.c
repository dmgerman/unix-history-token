...
begin_comment
comment|/* **  FINIS -- Finish up, remove temp files, etc. ** **	This does basic cleanup on interrupt, error, or **	normal termination.  It uses "State" to tell which **	is happening. ** **	Parameters: **		none ** **	Returns: **		none ** **	Side Effects: **		Exit(State). ** **	Called By: **		interrupt signal. **		main */
end_comment
...
begin_comment
comment|/* ** REXIT -- exit, reporting error code if -T given ** **	Parameters: **		e -- error code to exit with; see sysexits.h ** **	Returns: **		none ** **	Side Effects: **		Exit(e). ** **	Called By: **		main **		finis **		sendmail */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* 	** Output mailer control lines. 	**	These lines are as follows: 	**		/dev/net/<hostname> {target host} 	**		user-name {at target host} 	**		/mnt/eric {pathname of sender; not used} 	**		eric {name of user who is sending} 	*/
name|fputs
argument_list|(
name|buf
argument_list|,
...
begin_comment
comment|/* **  REWRITE -- Output header line with needed commas. ** **	Parameters: **		buf -- header line **		first -- true if this is not a continuation ** **	Returns: **		none ** **	Side effects: **		The contents of buf is copied onto the spool file with **		with the right commas interlaced ** **	Called by: **		sendmail */
end_comment
...
begin_comment
comment|/* **  PEEKC -- peek at next character in input file ** **	Parameters: **		fp -- stdio file buffer ** **	Returns: **		the next character in the input or EOF ** **	Side effects: **		None. ** **	Called by: **		sendmail **		rewrite */
end_comment
...
begin_comment
comment|/* **  GWORD -- get the next liberal word from a string ** **	Parameters: **		buf -- place to put scanned word **		p -- place to start looking for word ** **	Returns: **		updated value of p or 0 if no more left after this ** **	Side effects: **		buf gets the liberal word scanned. **		buf will be length 0 if there is no more input, **		or if p was passed as 0 ** **	Called by: **		rewrite */
end_comment
...
begin_comment
comment|/* **  PUTDATE -- Put the date& from field into the message. ** **	Parameters: **		fp -- file to put them onto. ** **	Returns: **		none ** **	Side Effects: **		output onto fp. ** **	Called By: **		sendmail */
end_comment
