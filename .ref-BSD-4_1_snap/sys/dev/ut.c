...
directive|ifdef
name|notdef
comment|/* 	 * For 6250 bpi take exclusive use of the UNIBUS. 	 * (Try running without this now that we have the 	 *  model with 4Kbyte buffer to soak up possible 	 *  data lates). 	 */
name|ui
operator|->
name|ui_driver
operator|->
