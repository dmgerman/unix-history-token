...
include|#
directive|include
file|<dev/ath/ath_hal/ar5212/ar5212desc.h>
end_include
...
name|printf
argument_list|(
literal|"    RTScnt=%d, FailCnt=%d, VCollCnt=%d\n"
argument_list|,
name|MS
argument_list|(
name|txs
...
name|printf
argument_list|(
literal|"    Done=%d, SeqNum=0x%04x, AckRSSI=%d, FinalTSI=%d\n"
argument_list|,
name|MF
argument_list|(
name|txs
...
name|printf
argument_list|(
literal|"    CompSuccess=%d, XmitAntenna=%d\n"
argument_list|,
name|MF
argument_list|(
name|txs
...
name|printf
argument_list|(
literal|"    TX power0=%d, RtsEna=%d, Veol=%d, ClrDstMask=%d AntModeXmit=0x%02x\n"
argument_list|,
name|MS
argument_list|(
name|txc
...
name|printf
argument_list|(
literal|"    NoAck=%d, CompProc=%d, CompIVLen=%d, CompICVLen=%d\n"
argument_list|,
name|MF
argument_list|(
name|txc
...
name|printf
argument_list|(
literal|"  DataLen=%d, ArMore=%d, DecompCrcError=%d, RcvRate=0x%02x\n"
argument_list|,
name|rxs
operator|.
name|ds_rxstatus0
...
name|printf
argument_list|(
literal|"  RSSI=%d, RcvAntenna=0x%x\n"
argument_list|,
name|MS
argument_list|(
name|rxs
...
name|printf
argument_list|(
literal|"  PhyErr=%d, MichaelErr=%d, KeyIdxValid=%d\n"
argument_list|,
name|MF
argument_list|(
name|rxs
