...
name|printf
argument_list|(
literal|"[%u.%06u] [%llu] TXPUSH txq=%d, nframes=%d, fifodepth=%d, frmcount=%d\n"
argument_list|,
operator|(
name|unsigned
name|int
...
name|printf
argument_list|(
literal|"[%u.%06u] [%llu] TXD DescId=0x%04x\n"
argument_list|,
operator|(
name|unsigned
name|int
...
name|printf
argument_list|(
literal|"    RSSI %d/%d/%d / %d/%d/%d; combined: %d; rate=0x%02x\n"
argument_list|,
name|MS
argument_list|(
name|rxs
...
name|printf
argument_list|(
literal|"    Len: %d; more=%d, delim=%d, upload=%d\n"
argument_list|,
name|MS
argument_list|(
name|rxs
...
name|printf
argument_list|(
literal|"    GI: %d, 2040: %d, parallel40: %d, stbc=%d\n"
argument_list|,
name|MF
argument_list|(
name|rxs
...
name|printf
argument_list|(
literal|"    Not sounding: %d, ness: %d, upload_valid: %d\n"
argument_list|,
name|MF
argument_list|(
name|rxs
...
name|printf
argument_list|(
literal|"    EVM: 0x%08x; 0x%08x; 0x%08x; 0x%08x\n"
argument_list|,
name|rxs
operator|.
name|status6
...
name|printf
argument_list|(
literal|"    RX done: %d, RX frame ok: %d, CRC error: %d\n"
argument_list|,
name|MF
argument_list|(
name|rxs
...
name|printf
argument_list|(
literal|"    Decrypt CRC err: %d, PHY err: %d, MIC err: %d\n"
argument_list|,
name|MF
argument_list|(
name|rxs
...
name|printf
argument_list|(
literal|"    Pre delim CRC err: %d, uAPSD Trig: %d\n"
argument_list|,
name|MF
argument_list|(
name|rxs
...
name|printf
argument_list|(
literal|"    RXKeyIdxValid: %d, KeyIdx: %d, PHY error: %d\n"
argument_list|,
name|MF
argument_list|(
name|rxs
...
name|printf
argument_list|(
literal|"    RX more Aggr: %d, RX aggr %d, post delim CRC err: %d\n"
argument_list|,
name|MF
argument_list|(
name|rxs
...
name|printf
argument_list|(
literal|"    hw upload data type: %d; position bit: %d\n"
argument_list|,
name|MS
argument_list|(
name|rxs
...
name|printf
argument_list|(
literal|"    Hi RX chain: %d, RxFirstAggr: %d, DecryptBusy: %d, KeyMiss: %d\n"
argument_list|,
name|MF
argument_list|(
name|rxs
