...
begin_comment
comment|/// Return keyed value as bool
end_comment
...
begin_comment
comment|/// @param[in] key
end_comment

begin_comment
comment|///     The value of the key to lookup
end_comment
...
begin_comment
comment|///     The value of the key as a bool.  Undefined if the key doesn't
end_comment

begin_comment
comment|///     exist or if the key is not either true or false.
end_comment
...
begin_comment
comment|///     true if the key existed as was a bool value; false otherwise.
end_comment

begin_comment
comment|///     Note the return value is *not* the value of the bool, use
end_comment

begin_comment
comment|///     \b value for that.
end_comment
