...
function_decl|;
name|bool
name|HasMallocLoggingEnabled
parameter_list|()
function_decl|;
comment|// enumerate the malloc records for a given address (starting with Mac OS X 10.6 Snow Leopard it should include
comment|// all allocations that *include* address, rather than just those *starting* at address)
name|bool
name|EnumerateMallocRecords
parameter_list|(
name|mach_vm_address_t
name|address
parameter_list|,
...
parameter_list|)
function_decl|;
comment|// enumerate every malloc record generated by this task, no matter what the address
name|bool
name|EnumerateMallocRecords
parameter_list|(
name|MachMallocEvent
...
parameter_list|)
function_decl|;
comment|// given a malloc event, report every stack frame that led to this event
name|bool
name|EnumerateMallocFrames
parameter_list|(
name|MachMallocEventId
name|event_id
parameter_list|,
name|mach_vm_address_t
modifier|*
name|function_addresses_buffer
parameter_list|,
name|uint32_t
name|buffer_size
parameter_list|,
