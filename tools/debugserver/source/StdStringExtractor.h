...
begin_comment
comment|//===-- StdStringExtractor.h ------------------------------------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|utility_StdStringExtractor_h_
end_ifndef
...
begin_comment
comment|// Based on StringExtractor, with the added limitation that this file should not
end_comment

begin_comment
comment|// take a dependency on LLVM, as it is used from debugserver.
end_comment

begin_decl_stmt
name|class
name|StdStringExtractor
block|{
name|public
label|:
enum|enum
...
label|:
comment|//------------------------------------------------------------------
comment|// For StdStringExtractor only
comment|//------------------------------------------------------------------
name|std
operator|::
name|string
