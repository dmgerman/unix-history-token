...
operator|:
name|CMICmnMIValueTuple
name|m_miValueTupleThread
decl_stmt|;
end_decl_stmt

begin_decl_stmt
name|bool
name|m_bSingleThread
decl_stmt|;
end_decl_stmt

begin_comment
comment|// True = yes single thread, false = multiple threads
end_comment
...
specifier|const
name|CMIUtilString
name|m_constStrArgNamedThreadId
decl_stmt|;
end_decl_stmt
