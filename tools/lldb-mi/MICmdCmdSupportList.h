...
begin_comment
comment|//===-- MICmdCmdSupportList.h -----------------------------------*- C++ -*-===//
end_comment
...
begin_comment
comment|// Overview:    CMICmdCmdSupportListFeatures            interface.
end_comment
...
begin_comment
comment|//          *this class implements MI command "list-features".
end_comment
...
begin_decl_stmt
name|class
name|CMICmdCmdSupportListFeatures
range|:
name|public
name|CMICmdBase
block|{
