...
begin_comment
comment|//===- CXIndexDataConsumer.h - Index data consumer for libclang--*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|LLVM_CLANG_TOOLS_LIBCLANG_CXINDEXDATACONSUMER_H
end_ifndef
...
include|#
directive|include
file|"clang/Index/IndexDataConsumer.h"
end_include
...
argument|const Decl *D
argument_list|,
argument|index::SymbolRoleSet Roles
argument_list|,
argument|ArrayRef<index::SymbolRelation> Relations
argument_list|,
argument|FileID FID
argument_list|,
argument|unsigned Offset
...
argument_list|(
argument|const ImportDecl *ImportD
argument_list|,
argument|index::SymbolRoleSet Roles
argument_list|,
argument|FileID FID
...
argument_list|,
argument|const DeclContext *SemaDC = nullptr
argument_list|)
block|;
name|bool
