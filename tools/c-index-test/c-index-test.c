...
argument_list|)
decl_stmt|;
comment|/* Ignore diagnostics that should be ignored. */
if|if
condition|(
name|severity
operator|==
...
condition|)
return|return;
comment|/* Print file:line:column. */
name|clang_getInstantiationLocation
argument_list|(
...
expr_stmt|;
block|}
comment|/* Print warning/error/etc. */
switch|switch
condition|(
name|severity
condition|)
