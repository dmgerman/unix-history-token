...
name|terminate
argument_list|(
literal|"failed to get attribute form for type: %s\n"
argument_list|,
name|dwarf_errmsg
argument_list|(
name|dw
...
operator|)
return|;
comment|/* die_attr will terminate for us if necessary */
if|if
condition|(
...
name|terminate
argument_list|(
literal|"die %llu: failed to get ref (form 0x%x)\n"
argument_list|,
name|die_off
argument_list|(
name|dw
...
name|terminate
argument_list|(
literal|"die %llu: failed to get mem offset location list\n"
argument_list|,
name|die_off
argument_list|(
name|dw
...
literal|3
argument_list|,
literal|"die %llu: creating array\n"
argument_list|,
name|off
argument_list|)
expr_stmt|;
...
literal|3
argument_list|,
literal|"die %llu: array nelems %u size %u\n"
argument_list|,
name|off
argument_list|,
name|tdp
...
name|stderr
argument_list|,
literal|"%s %d: failed to size member \"%s\" "
literal|"of type %s (%d)\n"
argument_list|,
name|typename
argument_list|,
...
literal|3
argument_list|,
literal|"die %llu: creating function pointer\n"
argument_list|,
name|off
argument_list|)
expr_stmt|;
...
literal|3
argument_list|,
literal|"die %llu: creating function definition\n"
argument_list|,
name|off
argument_list|)
expr_stmt|;
