...
begin_comment
comment|/* deflate.c -- compress data using the deflation algorithm  * Copyright (C) 1995-2010 Jean-loup Gailly and Mark Adler  * For conditions of distribution and use, see copyright notice in zlib.h  */
end_comment
...
index|[]
init|=
literal|" deflate 1.2.4 Copyright 1995-2010 Jean-loup Gailly and Mark Adler "
decl_stmt|;
end_decl_stmt
