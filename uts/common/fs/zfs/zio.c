...
begin_comment
comment|/*  * Copyright (c) 2005, 2010, Oracle and/or its affiliates. All rights reserved.  * Copyright (c) 2011, 2014 by Delphix. All rights reserved.  * Copyright (c) 2011 Nexenta Systems, Inc. All rights reserved.  */
end_comment
...
block|{
comment|/* 			 * Round up compressed size to MINBLOCKSIZE and 			 * zero the tail. 			 */
name|size_t
name|rounded
init|=
name|P2ROUNDUP
