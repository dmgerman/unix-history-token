...
begin_comment
comment|/*  * Copyright (c) 2005, 2010, Oracle and/or its affiliates. All rights reserved.  * Copyright (c) 2015 by Delphix. All rights reserved.  */
end_comment
...
name|len
decl_stmt|;
comment|/* 		 * If the write would overflow the largest block then split it. 		 */
if|if
condition|(
name|write_state
operator|!=
