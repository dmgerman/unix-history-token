...
begin_comment
comment|/*  * fsname is name of dataset to rollback (to most recent snapshot)  *  * innvl may contain name of expected target snapshot  *  * outnvl: "target" -> name of most recent snapshot  * }  */
end_comment
...
begin_comment
comment|/*  * inputs:  * zc_name	name of filesystem  *  * outputs:  * zc_string	name of conflicting snapshot, if there is one  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* 		 * Some commands can partially execute, modfiy state, and still 		 * return an error.  In these cases, attempt to record what 		 * was modified. 		 */
if|if
condition|(
operator|(
name|error
