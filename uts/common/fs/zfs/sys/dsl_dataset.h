...
decl_stmt|;
comment|/* to protect against multiple concurrent incremental recv */
name|kmutex_t
name|ds_recvlock
decl_stmt|;
...
name|ds_userrefs
decl_stmt|;
comment|/* 	 * ds_owner is protected by the ds_rwlock and the ds_lock 	 */
name|krwlock_t
name|ds_rwlock
decl_stmt|;
name|kcondvar_t
...
name|ds
decl_stmt|;
comment|/* ds to destroy */
name|dsl_dataset_t
modifier|*
name|rm_origin
decl_stmt|;
comment|/* also remove our origin? */
name|boolean_t
name|is_origin_rm
decl_stmt|;
comment|/* set if removing origin snap */
name|boolean_t
name|defer
decl_stmt|;
comment|/* destroy -d requested? */
name|boolean_t
name|releasing
decl_stmt|;
comment|/* destroying due to release? */
name|boolean_t
name|need_prep
decl_stmt|;
comment|/* do we need to retry due to EBUSY? */
block|}
struct|;
