...
begin_comment
comment|/*  * Rename the given network path to use  * the kinds of names that we would right here.  */
end_comment
...
begin_comment
comment|/*  * Turn a network machine name into a unique character  * + give connection-to status.  BN -- connected to Bell Net.  * AN -- connected to ARPA net, SN -- connected to Schmidt net.  * CN -- connected to COCANET.  */
end_comment
