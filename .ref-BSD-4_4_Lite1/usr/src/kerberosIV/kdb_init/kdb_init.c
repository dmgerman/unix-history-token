...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/kdb_init/RCS/kdb_init.c,v $  * $Author: bostic $   *  * Copyright 1987, 1988 by the Massachusetts Institute of Technology.   *  * For copying and distribution information, please see the file  *<mit-copyright.h>.   *  * program to initialize the database,  reports error if database file  * already exists.   */
end_comment
...
specifier|static
name|char
name|rcsid_kdb_init_c
index|[]
init|=
literal|"$Header: /usr/src/kerberosIV/kdb_init/RCS/kdb_init.c,v 4.2 93/05/20 21:40:07 bostic Exp $"
decl_stmt|;
end_decl_stmt
