...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/kerberos/RCS/kerberos.c,v $  * $Author: torek $  *  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
init|=
literal|"$Header: /usr/src/kerberosIV/kerberos/RCS/kerberos.c,v 4.22 93/05/16 00:27:07 torek Exp $"
decl_stmt|;
end_decl_stmt
