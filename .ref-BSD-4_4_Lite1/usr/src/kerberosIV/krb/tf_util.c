...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/tf_util.c,v $  * $Author: bostic $  *  * Copyright 1987, 1988 by the Massachusetts Institute of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
index|[]
init|=
literal|"$Id: tf_util.c,v 4.10 93/05/21 17:45:38 bostic Exp $"
decl_stmt|;
end_decl_stmt
