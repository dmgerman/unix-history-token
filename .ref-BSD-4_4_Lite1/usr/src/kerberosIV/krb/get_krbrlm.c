...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/get_krbrlm.c,v $  * $Author: bostic $  *  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
init|=
literal|"$Header: /usr/src/kerberosIV/krb/RCS/get_krbrlm.c,v 4.11 92/07/19 13:20:13 bostic Exp $"
decl_stmt|;
end_decl_stmt
