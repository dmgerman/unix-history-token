...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/log.c,v $  * $Author: bostic $  *  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
name|rcsid_log_c
init|=
literal|"$Header: /usr/src/kerberosIV/krb/RCS/log.c,v 4.9 93/03/23 05:02:10 bostic Exp $"
decl_stmt|;
end_decl_stmt
