...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/sendauth.c,v $  * $Author: bostic $  *  * Copyright 1987, 1988 by the Massachusetts Institute of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  *  */
end_comment
...
index|[]
init|=
literal|"$Header: /usr/src/kerberosIV/krb/RCS/sendauth.c,v 4.6 92/07/19 13:24:07 bostic Exp $"
decl_stmt|;
end_decl_stmt
