...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/klog.c,v $  * $Author: kfall $  *  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
name|rcsid_klog_c
init|=
literal|"$Header: /usr/src/kerberosIV/krb/RCS/klog.c,v 4.7 90/06/25 20:56:31 kfall Exp $"
decl_stmt|;
end_decl_stmt
