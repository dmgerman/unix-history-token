...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/tkt_string.c,v $  * $Author: kfall $  *  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
name|char
modifier|*
name|rcsid_tkt_string_c
init|=
literal|"$Header: /usr/src/kerberosIV/krb/RCS/tkt_string.c,v 4.7 90/06/25 20:57:33 kfall Exp $"
decl_stmt|;
end_decl_stmt
