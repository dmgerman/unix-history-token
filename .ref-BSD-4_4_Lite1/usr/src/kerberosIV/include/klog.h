...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/include/RCS/klog.h,v $  * $Author: kfall $  * $Header: /usr/src/kerberosIV/include/RCS/klog.h,v 4.8 90/06/25 20:50:01 kfall Exp $  *  * Copyright 1988 by the Massachusetts Institute of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  *  * This file defines the types of log messages logged by klog.  Each  * type of message may be selectively turned on or off.   */
end_comment
