...
begin_comment
comment|/* $XConsortium: XcmsAllCol.c,v 1.5 91/05/13 23:03:17 rws Exp $" */
end_comment
...
begin_comment
comment|/*  *	NAME  *		XcmsAllocColor - Allocate Color  *  *	SYNOPSIS  */
end_comment
