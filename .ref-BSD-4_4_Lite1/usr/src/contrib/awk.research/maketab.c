...
begin_comment
comment|/*  * this program makes the table to link function names  * and type indices that is used by execute() in run.c.  * it finds the indices in y.tab.h, produced by yacc.  */
end_comment
...
name|stderr
argument_list|,
literal|"maketab can't open y.tab.h!\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
...
name|printf
argument_list|(
literal|"static uchar *printname[%d] = {\n"
argument_list|,
name|SIZE
argument_list|)
expr_stmt|;
...
name|stderr
argument_list|,
literal|"maketab funny token %d %s\n"
argument_list|,
name|tok
argument_list|,
name|buf
