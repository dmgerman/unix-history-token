...
index|[]
init|=
literal|"$Header: gaptelnetd.c,v 2.4 86/10/20 12:00:04 root Exp $"
decl_stmt|;
end_decl_stmt
...
continue|continue;
block|}
comment|/* ASSERT(ibits == 0&& obits == 0); */
...
expr_stmt|;
block|}
comment|/* write failed or we timed out on read */
name|shutdown
argument_list|(
name|net
argument_list|,
