...
block|,
literal|" * $Header: /usr/src/contrib/flex-2.4.6/RCS/flex.skl,v 1.3 1994/01/24 05:03:21 vern Exp $"
block|,
literal|" */"
block|,
literal|""
...
literal|""
block|,
literal|"	/* Whether we've seen an EOF on this buffer. */"
block|,
literal|"	int yy_eof_status;"
block|,
literal|"#define EOF_NOT_SEEN 0"
block|,
literal|"	/* \"Pending\" happens when the EOF has been seen but there's still"
block|,
literal|"	 * some text to process.  Note that when we actually see the EOF,"
block|,
literal|"	 * we switch the status back to \"not seen\" (via yyrestart()), so"
block|,
literal|"	 * that the user can continue scanning by just pointing yyin at"
block|,
literal|"	 * a new input file."
block|,
literal|"	 */"
block|,
literal|"#define EOF_PENDING 1"
block|,
literal|"	};"
block|,
literal|""
...
block|,
literal|"static void yy_flex_strcpy YY_PROTO(( char *, const char * ));"
block|,
literal|"#endif"
block|,
literal|""
...
block|,
literal|"static void *yy_flex_realloc YY_PROTO(( void *ptr, unsigned int ));"
block|,
...
literal|""
block|,
literal|"		if ( yy_current_buffer->yy_input_file != yyin )"
block|,
literal|"			{"
block|,
literal|"			/* This can happen if we scan a file, yywrap() returns"
block|,
literal|"			 * 1, and then later the user points yyin at a new"
block|,
literal|"			 * file to resume scanning.  We have to assure"
block|,
...
block|,
literal|"			 * back-up) that will match for the new input file."
block|,
literal|"			 */"
block|,
...
literal|""
block|,
literal|"	if ( yy_current_buffer->yy_eof_status != EOF_NOT_SEEN )"
block|,
...
block|,
literal|"			yy_current_buffer->yy_eof_status = EOF_PENDING;"
block|,
literal|"			}"
block|,
literal|"		}"
...
literal|""
block|,
literal|"	b->yy_eof_status = EOF_NOT_SEEN;"
block|,
literal|"	}"
block|,
literal|""
...
literal|"#ifdef YY_USE_PROTOS"
block|,
literal|"static void yy_flex_strcpy( char *s1, const char *s2 )"
block|,
literal|"#else"
block|,
literal|"static void yy_flex_strcpy( s1, s2 )"
block|,
literal|"char *s1;"
block|,
