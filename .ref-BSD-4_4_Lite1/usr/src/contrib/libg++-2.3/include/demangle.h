...
value|(DMGL_AUTO|DMGL_GNU|DMGL_LUCID|DMGL_CFRONT)
end_define

begin_comment
comment|/* Enumeration of possible demangling styles.     Lucid and cfront styles are still kept logically distinct, even though    they now both behave identically.  The resulting style is actual the    union of both.  I.E. either style recognizes both "__pt__" and "__rf__"    for operator "->", even though the first is lucid style and the second    is cfront/ARM style. (FIXME?) */
end_comment
...
define|#
directive|define
name|CFRONT_DEMANGLING_STYLE_STRING
value|"cfront"
end_define
...
directive|define
name|CFRONT_DEMANGLING
value|(CURRENT_DEMANGLING_STYLE& DMGL_CFRONT)
end_define
