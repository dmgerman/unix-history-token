...
name|name
parameter_list|)
value|((name)&& (strcmp ("_init", name) == 0))
end_define

begin_comment
comment|/* In SVR4 ELF files, the ABI defines (pg. 4-25) that "External C symbols    have the same names in C, assembly code, and object files' symbol    tables."  So... */
end_comment
