...
begin_comment
comment|/* The native AT&T compiler for i386/SVR4 complains about using volatile    to indicate functions that never return.  So shut it up by simply    defining away "NORETURN", which is normally defined to "volatile". */
end_comment
