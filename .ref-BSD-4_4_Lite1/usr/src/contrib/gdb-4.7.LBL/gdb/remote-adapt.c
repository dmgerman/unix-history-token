...
begin_comment
comment|/*   * Processor types. It is assumed that the adapt has the correct   * ROM for the given processor.   */
end_comment
...
directive|define
name|USE_SHADOW_PC
value|((processor_type == TYPE_A29050)&& FREEZE_MODE)
end_define
...
argument_list|()
expr_stmt|;
comment|/* Determine the processor revision level */
name|prl
operator|=
operator|(
name|unsigned
...
name|stderr
argument_list|,
literal|"WARNING: debugging of A29030 not tested.\n"
argument_list|)
expr_stmt|;
block|}
elseif|else
...
name|stderr
argument_list|,
literal|"WARNING: debugging of A29050 not tested.\n"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|stderr
argument_list|,
literal|"WARNING: processor type unknown.\n"
argument_list|)
expr_stmt|;
block|}
...
name|printf_filtered
argument_list|(
literal|"Remote debugging on an %s connect to an Adapt via %s.\n"
argument_list|,
name|processor_name
index|[
name|processor_type
