...
begin_comment
comment|/* Descriptor for I/O to remote machine.  Initialize it to -1 so that    es1800_open knows that we don't have a file open when the program    starts.  */
end_comment
...
begin_comment
comment|/* Called when SIGALRM signal sent due to alarm() timeout.    Rely on global variables: timeout  */
end_comment
...
literal|"19200"
expr_stmt|;
comment|/* default baudrate = 19200 */
name|target_preopen
argument_list|(
name|from_tty
argument_list|)
...
name|perror
argument_list|(
literal|"es1800_open: error in ioctl"
argument_list|)
expr_stmt|;
block|}
endif|#
...
name|perror
argument_list|(
literal|"es1800_open: error in siginterrupt"
argument_list|)
expr_stmt|;
block|}
endif|#
directive|endif
comment|/* NO_SIGINTERRUPT */
...
name|perror
argument_list|(
literal|"es1800_open: error in signal"
argument_list|)
expr_stmt|;
block|}
endif|#
...
begin_comment
comment|/* damn_b()     Translate baud rates from integers to damn B_codes.  Unix should    have outgrown this crap years ago, but even POSIX wouldn't buck it.    rate - the baudrate given as a string    return value: the baudrate as a B_code */
end_comment
