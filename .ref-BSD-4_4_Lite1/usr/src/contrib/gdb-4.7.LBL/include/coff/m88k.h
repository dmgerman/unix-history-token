...
name|ext
parameter_list|)
value|bfd_h_get_32(abfd, (bfd_byte *)ext->x_sym.x_fcn.x_lnnoptr)
end_define
...
name|ext
parameter_list|)
value|bfd_h_get_32(abfd, (bfd_byte *) ext->x_sym.x_fcn.x_endndx)
end_define
...
name|ext
parameter_list|)
value|bfd_h_put_32(abfd,  in, (bfd_byte *) ext->x_sym.x_fcn.x_lnnoptr)
end_define
...
name|ext
parameter_list|)
value|bfd_h_put_32(abfd, in, (bfd_byte *)   ext->x_sym.x_fcn.x_endndx)
end_define
