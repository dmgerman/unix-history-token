...
begin_comment
comment|/*** coff information for 80960.  Origins: Intel corp, natch. */
end_comment
...
begin_comment
comment|/* Relevent values for r_type and i960.  Would someone please document them */
end_comment
