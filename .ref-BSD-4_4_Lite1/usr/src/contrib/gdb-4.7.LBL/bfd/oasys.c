...
name|NULL
return|;
comment|/*     That all worked, lets buy the space for the header and read in     the headers.     */
block|{
...
define|#
directive|define
name|oasys_core_file_failing_command
...
define|#
directive|define
name|oasys_core_file_failing_signal
value|(int (*)())bfd_0
end_define
...
define|#
directive|define
name|oasys_core_file_matches_executable_p
value|0
end_define
...
define|#
directive|define
name|oasys_bfd_debug_info_start
value|bfd_void
end_define
...
define|#
directive|define
name|oasys_bfd_debug_info_accumulate
