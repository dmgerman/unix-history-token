...
begin_comment
comment|/* INTERNAL_FUNCTION 	bfd_cache_init  SYNOPSIS 	void  bfd_cache_init (bfd *);  DESCRIPTION 	Initialize a BFD by putting it on the cache LRU. */
end_comment
...
begin_comment
comment|/* INTERNAL_FUNCTION 	bfd_cache_close  DESCRIPTION 	Remove the BFD from the cache. If the attached file is open, 	then close it too.  SYNOPSIS 	void bfd_cache_close (bfd *); */
end_comment
