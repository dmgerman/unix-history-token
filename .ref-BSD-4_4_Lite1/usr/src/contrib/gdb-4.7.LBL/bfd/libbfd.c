...
begin_comment
comment|/* INTERNAL_FUNCTION 	bfd_write_bigendian_4byte_int  SYNOPSIS 	void bfd_write_bigendian_4byte_int(bfd *abfd,  int i);  DESCRIPTION 	Writes a 4 byte integer to the outputing bfd, in big endian 	mode regardless of what else is going on.  This is usefull in 	archives.  */
end_comment
...
condition|)
block|{
comment|/* This is a set within an archive, so we need to                        add the base of the object within the archive */
return|return
operator|(
name|fseek
argument_list|(
...
begin_comment
comment|/* INTERNAL_FUNCTION 	bfd_log2  DESCRIPTION 	Return the log base 2 of the value supplied, rounded up. eg an 	arg of 1025 would return 11.  SYNOPSIS 	bfd_vma bfd_log2(bfd_vma x); */
end_comment
