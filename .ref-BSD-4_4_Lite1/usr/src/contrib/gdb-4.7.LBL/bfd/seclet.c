...
argument_list|)
block|{
comment|/* Write all the seclets on the bfd out, relocate etc according to the      rules */
name|asection
modifier|*
name|o
init|=
