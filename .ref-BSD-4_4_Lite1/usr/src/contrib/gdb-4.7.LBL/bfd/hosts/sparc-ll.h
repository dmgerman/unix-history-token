...
begin_comment
comment|/* Host definition file for Sun-4 running with gcc, using "long long"    for addresses, to handle 64-bit target systems. */
end_comment
...
begin_comment
comment|/* Make the basic types 64-bit quantities on the host */
end_comment
