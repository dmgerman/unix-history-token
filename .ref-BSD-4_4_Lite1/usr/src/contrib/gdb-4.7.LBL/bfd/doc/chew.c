...
begin_comment
comment|/*  Yet another way of extracting documentation from source.  No, I haven't finished it yet, but I hope you people like it better  that the old way     sac  Basically, this is a sort of string forth, maybe we should call it struth?  You define new words thus: :<newword><oldwords> ; There is  no  */
end_comment
...
begin_comment
comment|/* turn foobar name(stuff); into foobar EXFUN(name,(stuff));   */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* make sure that it's not already exfuned */
if|if
condition|(
name|find
argument_list|(
