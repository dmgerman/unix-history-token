...
name|fputs
argument_list|(
literal|"The monitor was not compiled in.\n"
argument_list|,
name|stderr
argument_list|)
expr_stmt|;
...
name|fputs
argument_list|(
literal|"Need TCP/IP for S, q, w, h, and p options.\n"
argument_list|,
name|stderr
argument_list|)
expr_stmt|;
...
name|fputs
argument_list|(
literal|"The flying code was not compiled in.\n"
argument_list|,
name|stderr
argument_list|)
expr_stmt|;
...
name|fputs
argument_list|(
literal|"usage:\thunt [-qmcsfS] [-n name] [-t team] [-p port] [-w message] [host]\n"
argument_list|,
name|stderr
argument_list|)
expr_stmt|;
...
begin_comment
comment|/* !defined(USE_CURSES)&& defined(SIGTSTP) */
end_comment
