...
name|M_SF
decl_stmt|,
comment|/* Scroll forward with arg */
modifier|*
name|M_SR
decl_stmt|,
comment|/* Scroll back with arg */
modifier|*
name|SP
decl_stmt|,
...
index|[]
init|=
literal|"vsvealdlspcssosecmclcehoupbcicimdceillsfsrvbksketiteALDLICDCpcipblnldoSFSR"
decl_stmt|;
end_decl_stmt
