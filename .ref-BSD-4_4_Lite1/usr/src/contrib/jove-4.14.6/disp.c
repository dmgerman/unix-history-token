...
begin_comment
comment|/* Deleted and killed Lines are about to be recycled: check for dangling refs */
end_comment
...
name|lp
expr_stmt|;
comment|/* ??? what is -(daddr)1?  Would NULL_DADDR work as well? -- DHR */
name|des_p
operator|->
name|s_id
operator|=
...
literal|0
expr_stmt|;
comment|/* ??? The following assignment is very questionable: 	 * - it stores a pointer in an integer variable 	 * - it counts on these values being distinct from 	 *   disk addresses, 0 (NULL_DADDR), and -1. 	 * -- DHR 	 */
name|des_p
operator|->
name|s_id
operator|=
