...
begin_comment
comment|/* Close recfile before execing a child process.  * Since we might be vforking, we must not change any variables  * (in particular rec_fd).  */
end_comment
...
begin_comment
comment|/* Close and remove recfile before exiting. */
end_comment
