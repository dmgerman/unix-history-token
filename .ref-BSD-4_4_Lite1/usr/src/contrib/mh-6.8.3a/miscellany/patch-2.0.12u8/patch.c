...
index|[]
init|=
literal|"$Header: patch.c,v 2.0.2.0 90/05/01 22:17:50 davison Locked $"
decl_stmt|;
end_decl_stmt
...
literal|'.'
condition|)
comment|/* try to preserve difference */
name|s
index|[
literal|12
index|]
...
name|fatal2
argument_list|(
literal|"missing argument after `%s'\n"
argument_list|,
operator|*
name|Argv
argument_list|)
...
name|stderr
argument_list|,
literal|"patch: unrecognized option `%s'\n"
argument_list|,
name|Argv
index|[
literal|0
