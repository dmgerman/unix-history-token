...
condition|)
block|{
comment|/* Maybe `to' is a symlink into a different file system. 	       Copying replaces the symlink with a file; using rename 	       would be better.  */
name|Reg4
name|int
name|tofd
decl_stmt|;
...
name|pfatal2
argument_list|(
literal|"internal error, can't open %s"
argument_list|,
name|to
argument_list|)
expr_stmt|;
