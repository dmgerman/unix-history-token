...
name|file
parameter_list|)
value|"/usr/contrib/mh-6.8/bin/"#file
end_define
...
name|file
parameter_list|)
value|"/usr/contrib/mh-6.8/lib/"#file
end_define
...
name|mhlibdir
init|=
literal|"/usr/contrib/mh-6.8/lib"
decl_stmt|;
end_decl_stmt
