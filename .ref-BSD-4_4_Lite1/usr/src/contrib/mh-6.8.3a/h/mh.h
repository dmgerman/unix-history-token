...
begin_comment
comment|/* @(#)$Id: mh.h,v 2.19 1993/02/26 21:53:29 jromine Exp $ */
end_comment
...
comment|/* Note well: msgstats[] is a int, so we have 16 or 32 bits to work 	with.  The first 5 are for standard MH message flags, 	this leaves us 11 (or 27) for user-defined attributes.  Of 	these, 1 is reserved for future internal use, so this leaves 	users 10 (or 26).					*/
define|#
directive|define
name|NATTRS
value|((sizeof(int)*Nbby)-6)
comment|/*  see above	*/
name|char
modifier|*
name|msgattrs
