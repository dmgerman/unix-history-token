...
index|[]
init|=
literal|"@(#)$Id: burst.c,v 1.7 1992/12/15 00:20:22 jromine Exp $"
decl_stmt|;
end_decl_stmt
...
break|break;
block|}
comment|/* msgp now contains the number of new msgs to be created */
if|if
condition|(
operator|(
name|mp
...
name|hghmsg
expr_stmt|;
comment|/* new hghmsg is hghmsg+msgp */
for|for
control|(
name|j
operator|=
