...
index|[]
init|=
literal|"@(#)$Id: config.c,v 1.11 1993/09/01 22:29:10 jromine Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  * mhl runs this program as a visual-end.  */
end_comment
