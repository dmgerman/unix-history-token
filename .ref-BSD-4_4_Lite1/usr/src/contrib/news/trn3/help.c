...
begin_comment
comment|/* $Id: help.c,v 3.0 1992/02/01 03:09:32 davison Trn $  */
end_comment
...
name|print_lines
argument_list|(
literal|"\ t	Display the entire article tree and all its subjects.\n\ "
argument_list|,
name|NOMARKING
argument_list|)
operator|)
...
name|print_lines
argument_list|(
literal|"\ m	Current mode, first letter of (init,newsgroup,thread,article,pager,\n\ 		unread,Add,Catchup,Delete-bogus,Mailbox,Resubscribe)\n\ "
argument_list|,
name|NOMARKING
argument_list|)
operator|)
