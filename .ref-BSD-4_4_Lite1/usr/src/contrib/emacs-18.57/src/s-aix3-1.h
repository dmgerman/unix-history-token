...
begin_comment
comment|/* Definitions file for GNU Emacs running on IBM AIX version 3.1    Copyright (C) 1985, 1986, 1990 Free Software Foundation, Inc.  This file is part of GNU Emacs.  GNU Emacs is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 1, or (at your option) any later version.  GNU Emacs is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU Emacs; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
begin_comment
comment|/*      Specify IBM AIX version of system */
end_comment
...
begin_comment
comment|/*      This symbol should be defined on AIX Version 3  ??????? */
end_comment
...
begin_comment
comment|/*      Specify "_BSD" to invoke Berkeley compatibility in header files */
end_comment

begin_comment
comment|/*#ifndef _BSD #define _BSD #endif */
end_comment
...
begin_comment
comment|/* Special itemss needed to make Emacs run on this system.  */
end_comment
...
begin_comment
comment|/* #define ADDR_CORRECT(x) (x) */
end_comment
...
begin_comment
comment|/* Prevent -lg from being used for debugging.  Not needed.  */
end_comment
...
begin_comment
comment|/* No need to specify -lc when linking.  */
end_comment
