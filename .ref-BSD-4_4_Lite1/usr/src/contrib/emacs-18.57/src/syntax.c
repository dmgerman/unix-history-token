...
name|table
expr_stmt|;
comment|/* Indicate that this buffer now has a specified syntax table.  */
name|current_buffer
operator|->
...
name|mindepth
decl_stmt|;
comment|/* Minimum depth seen while scanning.  */
block|}
end_block
...
name|mindepth
decl_stmt|;
comment|/* Lowest DEPTH value seen.  */
name|int
name|start_quoted
init|=
literal|0
