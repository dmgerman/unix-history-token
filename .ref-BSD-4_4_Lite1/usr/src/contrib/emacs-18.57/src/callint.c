...
begin_comment
comment|/* Call a Lisp function interactively.    Copyright (C) 1985, 1986 Free Software Foundation, Inc.  This file is part of GNU Emacs.  GNU Emacs is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 1, or (at your option) any later version.  GNU Emacs is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU Emacs; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
literal|0
argument_list|,
literal|"Call FUNCTION, reading args according to its interactive calling specs.\n\ The function contains a specification of how to do the argument reading.\n\ In the case of user-defined functions, this is specified by placing a call\n\ to the function `interactive' at the top level of the function body.\n\ See `interactive'.\n\ \n\ Optional second arg RECORD-FLAG non-nil\n\ means unconditionally put this command in the command-history.\n\ Otherwise, this is done only if an arg is read using the minibuffer."
argument_list|)
end_macro
...
literal|0
expr_stmt|;
comment|/* Fill argstrings with a vector of C strings 	 corresponding to the Lisp strings in visargs.  */
for|for
control|(
name|j
operator|=
...
comment|/* On VMS, treat 'f' like 'F', because 'f' fails to work 	     for multivalued logical names or for explicit versions.  */
ifndef|#
directive|ifndef
name|VMS
name|args
...
literal|'N'
case|:
comment|/* Prefix arg, else number from minibuffer */
if|if
condition|(
operator|!
name|NULL
...
name|error
argument_list|(
literal|"Invalid control letter \"%c\" (%03o) in interactive calling string"
argument_list|,
operator|*
name|tem
argument_list|,
...
literal|0
argument_list|,
literal|"Return numeric meaning of raw prefix argument ARG.\n\ A raw prefix argument is what you get from (interactive \"P\")."
argument_list|)
end_macro
