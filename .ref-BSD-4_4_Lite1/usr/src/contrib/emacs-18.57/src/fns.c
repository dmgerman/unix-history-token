...
begin_comment
comment|/* Random utility Lisp functions.    Copyright (C) 1985, 1986, 1987 Free Software Foundation, Inc.  This file is part of GNU Emacs.  GNU Emacs is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 1, or (at your option) any later version.  GNU Emacs is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU Emacs; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
begin_comment
comment|/* Note on some machines this defines `vector' as a typedef,    so make sure we don't use that name in this file.  */
end_comment
...
ifdef|#
directive|ifdef
name|MASSC_REGISTER_BUG
comment|/* Even removing all "register"s doesn't disable this bug! 		   Nothing simpler than this seems to work. */
name|unsigned
name|char
modifier|*
name|p
...
literal|"copy-alist"
argument_list|,
argument|Fcopy_alist
argument_list|,
argument|Scopy_alist
argument_list|,
literal|1
argument_list|,
literal|1
...
literal|0
argument_list|,
literal|"Return a substring of STRING, starting at index FROM and ending before TO.\n\ TO may be nil or omitted; then the substring runs to the end of STRING.\n\ If FROM or TO is negative, it counts from the end."
argument_list|)
end_macro
...
begin_comment
comment|/* Like Fassq but never report an error and do not allow quits.    Use only on lists known never to be circular.  */
end_comment
...
name|UNGCPRO
expr_stmt|;
comment|/* Broken Xenix/386 compiler can't use a register variable here */
for|for
control|(
name|j
operator|=
...
begin_comment
comment|/* Anything that calls this function must protect from GC!  */
end_comment
...
directive|ifdef
name|VMS
comment|/*    *	VMS specific code -- read from the Load Ave driver    */
