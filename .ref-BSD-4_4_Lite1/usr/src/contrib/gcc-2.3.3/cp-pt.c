...
begin_comment
comment|/* Handle parameterized types (templates) for GNU C++.    Written by Ken Raeburn of Watchmaker Computing.    Copyright (C) 1992 Free Software Foundation, Inc.  This file is part of GNU CC.  GNU CC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GNU CC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU CC; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
name|error
argument_list|(
literal|"incorrect number of parameters (%d, should be %d) in template expansion"
argument_list|,
name|nparms
argument_list|,
name|TREE_VEC_LENGTH
...
name|error
argument_list|(
literal|"type/value mismatch in template parameter list"
argument_list|)
expr_stmt|;
name|lost
operator|++
...
begin_comment
comment|/* Given an IDENTIFIER_NODE (type TEMPLATE_DECL) and a chain of    parameters, find the desired type.     D1 is the PTYPENAME terminal, and ARGLIST is the list of arguments.    Since ARGLIST is build on the decl_obstack, we must copy it here    to keep it from being reclaimed when the decl storage is reclaimed.	*/
end_comment
