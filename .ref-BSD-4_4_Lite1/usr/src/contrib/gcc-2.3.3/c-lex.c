...
begin_comment
comment|/* Command-line: gperf -p -j1 -i 1 -g -o -t -N is_reserved_word -k1,3,$ c-parse.gperf  */
end_comment
...
begin_comment
comment|/* maximum key range = 96, duplicates = 0 */
end_comment
...
name|error
argument_list|(
literal|"invalid Objective C keyword `%s'"
argument_list|,
name|token_buffer
argument_list|)
expr_stmt|;
comment|/* Cause a syntax error--1 is not a valid token type.  */
name|value
operator|=
literal|1
expr_stmt|;
