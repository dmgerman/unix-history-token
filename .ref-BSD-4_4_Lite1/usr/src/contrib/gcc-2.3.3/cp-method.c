...
name|TARGET_EXPR
case|:
comment|/* Note that this only works for G++ target exprs.  If somebody 	 builds a general TARGET_EXPR, there's no way to represent that 	 it initializes anything other that the parameter slot for the 	 default argument.  */
name|dump_init
argument_list|(
name|TREE_OPERAND
argument_list|(
