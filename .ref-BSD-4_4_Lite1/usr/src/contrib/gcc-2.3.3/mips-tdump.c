...
name|printf
argument_list|(
literal|"    Name index  = %-10d Readin      = %s\n"
argument_list|,
operator|(
name|long
operator|)
...
name|printf
argument_list|(
literal|"    %-*s %11llu %11lu %11lu %11lu\n"
argument_list|,
name|width
argument_list|,
literal|"Procedures"
...
literal|0
decl_stmt|;
comment|/* Determine if this is a .T file (which has no file header), or some      sort of object file (which does have a file header) via the magic      number.  */
operator|(
name|void
operator|)
name|read_seek
...
name|stderr
argument_list|,
literal|"\t%0 [-alrs]<object-or-T-file>\n"
argument_list|,
name|argv
index|[
literal|0
