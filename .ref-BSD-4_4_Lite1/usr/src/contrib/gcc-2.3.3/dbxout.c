...
argument_list|)
expr_stmt|;
comment|/* The number is propably incorrect here */
block|}
else|else
name|abort
argument_list|()
expr_stmt|;
comment|/* What to do with CSImode complex? */
break|break;
case|case
name|SET_TYPE
case|:
...
directive|if
literal|0
comment|/* Tiemann says this creates output tha "confuses GDB". 	 Too bad the info is so vague.  Hope this doesn't lose.  */
