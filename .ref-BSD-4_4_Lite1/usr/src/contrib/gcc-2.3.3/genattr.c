...
name|printf
argument_list|(
literal|"extern void shorten_branches ();\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"extern int insn_default_length ();\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"extern int insn_variable_length_p ();\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"extern int insn_current_length ();\n\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
...
name|printf
argument_list|(
literal|"extern int result_ready_cost ();\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"extern int function_units_used ();\n\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
...
name|printf
argument_list|(
literal|"extern int num_delay_slots ();\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"extern int eligible_for_delay ();\n\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"extern int const_num_delay_slots ();\n\n"
argument_list|)
expr_stmt|;
name|have_delay
operator|=
