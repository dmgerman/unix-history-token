...
begin_comment
comment|/* Build expressions with type checking for C++ compiler.    Copyright (C) 1987, 1988, 1989, 1992 Free Software Foundation, Inc.    Hacked by Michael Tiemann (tiemann@cygnus.com)  This file is part of GNU CC.  GNU CC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GNU CC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU CC; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
condition|)
block|{
comment|/* I claim this reads better. (mrs) */
comment|/* the below could still be improved by outputting arguments and consts */
name|error_with_aggr_type
argument_list|(
name|types
index|[
...
index|]
argument_list|,
literal|"undefined %s operator %s ()"
argument_list|,
name|opname_tab
index|[
operator|(
...
literal|1
expr_stmt|;
comment|/* Give warnings for ordered comparisons between signed and 	     unsigned quantities but not if the signed quantity happens 	     to be an unsuffixed integer literal (or some static constant 	     expression involving such literals) which is positive.  */
if|if
condition|(
name|extra_warnings
operator|&&
...
name|warning
argument_list|(
literal|"ordered comparison between signed and unsigned"
argument_list|)
expr_stmt|;
block|}
elseif|else
...
name|pedwarn
argument_list|(
literal|"ANSI C++ forbids %sing this type of pointer value"
argument_list|,
operator|(
operator|(
name|code
