...
begin_comment
comment|/* Use the system's macros with the system's compiler.    This is relevant only when building GCC with some other compiler.  */
end_comment
...
parameter_list|)
define|\
value|(AP = ((__gnuc_va_list) __builtin_next_arg ()))
end_define
