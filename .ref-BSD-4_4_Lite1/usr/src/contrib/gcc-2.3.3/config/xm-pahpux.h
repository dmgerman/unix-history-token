...
begin_comment
comment|/* Place any machine-dependent include files here, in case we    are bootstrapping.  */
end_comment
...
begin_comment
comment|/* HP's compiler has problems with enum bitfields.  */
end_comment
