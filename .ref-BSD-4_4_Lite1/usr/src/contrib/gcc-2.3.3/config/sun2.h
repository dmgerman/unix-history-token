...
name|ASM_SPEC
define|\
value|"%{m68020:-mc68020}%{mc68020:-mc68020}%{!mc68020:%{!m68020:-mc68010}} \   %{fpic:-k} %{fPIC:-k}"
end_define
...
begin_comment
comment|/* Include the support for -a when appropriate.  */
end_comment
...
directive|define
name|LIB_SPEC
value|"%{g:-lg} %{!p:%{!pg:-lc}}%{p:-lc_p}%{pg:-lc_p} \ %{a:/usr/lib/bb_link.o -lc} "
end_define
