...
begin_comment
comment|/* Note that seq386gas.h is a GAS configuration that does not use this    file. */
end_comment
...
begin_comment
comment|/* Define this now, because bsd386.h tests it.  */
end_comment
...
begin_comment
comment|/* these come from bsd386.h, but are specific to sequent */
end_comment
