...
name|CPP_SPEC
define|\
value|"%{mc2:-D__convex_c2__}%{!mc2:-D__convex_c1__} \  -D__NO_INLINE_MATH -D__NO_INLINE_STDLIB \  %{!traditional:-D__stdc__ \    -D_LONGLONG -Ds64_t=long\\ long -Du64_t=unsigned\\ long\\ long} \  %{!ansi:-D_POSIX_SOURCE -D_CONVEX_SOURCE}"
end_define
