...
begin_comment
comment|/* config.h  *  * This file is hand tailored for MS-DOS and MSC 5.1 and 6.00A.  * Tom Dinger, March 1991.  */
end_comment

begin_comment
comment|/*  * BUGGY_MSC5:  *	This symbol is defined if you are the unfortunate owner of the buggy  *	Microsoft C compiler version 5.1.  It is used as a conditional to  *	guard code sections that are known to break this compiler.  * BUGGY_MSC6:  *	This symbol is defined if you are the unfortunate owner of the buggy  *	Microsoft C compiler version 6.0A.  It is used as a conditional to  *	guard code sections that are known to break this compiler.  */
end_comment
...
begin_comment
comment|/* TODO: doesn't work for MSC -- it's more complicated than this */
end_comment
...
begin_comment
comment|/*#undef	HAS_BCOPY		/**/
end_comment

begin_comment
comment|/*#undef	SAFE_BCOPY		/**/
end_comment
...
begin_comment
comment|/*#undef	HAS_HTONS	/**/
end_comment

begin_comment
comment|/*#undef	HAS_HTONL	/**/
end_comment

begin_comment
comment|/*#undef	HAS_NTOHS	/**/
end_comment

begin_comment
comment|/*#undef	HAS_NTOHL	/**/
end_comment
...
begin_comment
comment|/*#undef	STATBLOCKS 	/**/
end_comment

begin_comment
comment|/* STDSTDIO  *	This symbol is defined if this system has a FILE structure declaring  *	_ptr and _cnt in stdio.h.  *  *	NOTE: [Tom Dinger, 23 February 1991] You also need the _filbuf()  *	function, usually referred to by the getc() macro in stdio.h.  */
end_comment
...
begin_comment
comment|/* SIG_NAME  *	This symbol contains an list of signal names in order.  *  *	Note: This list is specific for Microsoft C 5.1 and 6.0, which only  *	support SIGINT, SIGFPE, SIGILL, SIGSEGV, and SIGABRT on  *	DOS 3.x, but in addition defines SIGTERM, SIGBREAK, SIGUSR1,  *	SIGUSR2, and SIGUSR3.  */
end_comment
...
name|SIG_NAME
define|\
value|"ZERO","HUP","INT","QUIT","ILL","TRAP","IOT","EMT","FPE","KILL",\  "BUS","SEGV","SYS","PIPE","ALRM","TERM","USR1","USR2","TSTP","CONT",\  "USR3","BREAK","ABRT"
end_define
...
begin_comment
comment|/* For MSC5.1, toke.c "runs out of heap space" unless CRIPPLED_CC is  * defined.  */
end_comment
...
begin_comment
comment|/* MSC (5.1 and 6.0) doesn't know about S_IFBLK or S_IFIFO -- these are  * normally found in sys/stat.h  */
end_comment
...
begin_comment
comment|/* Define SUFFIX to get special DOS suffix-replacement code */
end_comment
...
begin_comment
comment|/* Add this for the DOS-specific chdir() function */
end_comment
