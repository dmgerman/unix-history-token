...
begin_comment
comment|/* $Header: common.h,v 2.0 86/09/17 15:36:39 lwall Exp $  *  * $Log:	common.h,v $  * Revision 2.0  86/09/17  15:36:39  lwall  * Baseline for netwide release.  *   */
end_comment
...
begin_comment
comment|/* might want /usr/tmp here */
end_comment
