...
name|fatal1
argument_list|(
literal|"patch: out of memory (grow_hunkmax)\n"
argument_list|)
expr_stmt|;
name|out_of_mem
operator|=
...
name|say1
argument_list|(
literal|"\ (Fascinating--this is really a new-style context diff but without the telltale\n\ extra asterisks on the *** line that usually indicate the new style...)\n"
argument_list|)
expr_stmt|;
name|diff_type
operator|=
