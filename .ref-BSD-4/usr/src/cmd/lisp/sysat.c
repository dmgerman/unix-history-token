...
name|sccsid
init|=
literal|"@(#)sysat.c	34.13 11/11/80"
decl_stmt|;
end_decl_stmt
...
comment|/* 	MK("fork",Lfork,lambda); 	MK("wait",Lwait,lambda); 	MK("pipe",Lpipe,lambda); 	MK("fdopen",Lfdopen,lambda); */
name|MK
argument_list|(
literal|"exece"
argument_list|,
