...
modifier|*
name|linker_core_org
decl_stmt|,
comment|/* beginning of linker segment */
modifier|*
name|linker_core_end
decl_stmt|,
...
decl_stmt|;
name|int
name|string_file_org
decl_stmt|,
comment|/* location of string table in file */
name|string_size
decl_stmt|,
...
comment|/* insure that the given file name ends in .o 	   if it doesnt, copy to a new buffer and add a .o 	*/
name|tempfilbf
index|[
literal|0
index|]
...
name|error
argument_list|(
literal|"fasl: bad magic number in fasl file"
argument_list|,
name|FALSE
argument_list|)
expr_stmt|;
