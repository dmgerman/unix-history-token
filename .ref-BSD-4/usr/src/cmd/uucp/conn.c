...
begin_comment
comment|/*  conn 2.1  5/23/79  19:07:44  */
end_comment
...
begin_comment
comment|/***  *	dkcall(flds)	make datakit connection  *  *	return codes:  *>0 - file number - ok  *		FAIL - failed  */
end_comment
...
operator|)
return|;
comment|/* format of fields 	 *	0 name; 	 *	1 time 	 *	2 acu/hardwired/slave 	 *	3 speed 	 *	etc 	 */
if|if
condition|(
name|ifdate
argument_list|(
...
literal|1
argument_list|,
literal|"Slave only, no call to %s tried\n"
argument_list|,
name|sysnam
argument_list|)
expr_stmt|;
