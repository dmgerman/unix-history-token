...
name|fputs
argument_list|(
literal|"Unknown name found on enumerated type read\n"
argument_list|,
name|stderr
argument_list|)
expr_stmt|;
...
name|fputs
argument_list|(
literal|"Enumerated type value out of range on output\n"
argument_list|,
name|stderr
argument_list|)
expr_stmt|;
...
name|fputs
argument_list|(
literal|"Improper number of arguments to formal routine\n"
argument_list|,
name|stderr
argument_list|)
expr_stmt|;
...
name|fputs
argument_list|(
literal|"Improper use of new variables has caused heap integrity check to fail\n"
argument_list|,
name|stderr
argument_list|)
expr_stmt|;
...
name|fputs
argument_list|(
literal|"Range lower bound out of set bounds\n"
argument_list|,
name|stderr
argument_list|)
expr_stmt|;
...
name|fputs
argument_list|(
literal|"Range upper bound out of set bounds\n"
argument_list|,
name|stderr
argument_list|)
expr_stmt|;
...
name|fputs
argument_list|(
literal|"Single value out of set bounds\n"
argument_list|,
name|stderr
argument_list|)
expr_stmt|;
