...
argument_list|)
expr_stmt|;
comment|/*		p2pass(stabline(nounder(XL,progname->extname),N_FNAME,0,0));	*/
block|}
block|}
endif|#
directive|endif
...
return|;
block|}
comment|/*  * if an temporary of appropriate shape is on the templist,  * remove it from the list and return it  */
for|for
control|(
name|oldp
operator|=
