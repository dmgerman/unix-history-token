...
literal|0
expr_stmt|;
comment|/* SHOULD PROBABLY HINDER THE ABILITY OF ONE PROCESS TO CAUSE THIS... */
name|prdev
argument_list|(
literal|"no space"
argument_list|,
...
name|printf
argument_list|(
literal|"found only %d inodes on dev %x/%x, looking from top\n"
argument_list|,
name|fp
operator|->
name|s_ninode
...
name|printf
argument_list|(
literal|"search of %x/%x ended at %d\n"
argument_list|,
name|major
argument_list|(
name|dev
