...
name|raw
parameter_list|()
value|(_tty.sg_flags|=RAW, pfast=_rawmode=TRUE, stty(_tty_ch,&_tty))
end_define
...
name|noraw
parameter_list|()
value|(_tty.sg_flags&=~RAW,pfast=_rawmode=FALSE,stty(_tty_ch,&_tty))
end_define
...
name|nl
parameter_list|()
value|(_tty.sg_flags |= CRMOD, pfast = FALSE, stty(_tty_ch,&_tty))
end_define
...
name|nonl
parameter_list|()
value|(_tty.sg_flags&= ~CRMOD, pfast = TRUE, stty(_tty_ch,&_tty))
end_define
