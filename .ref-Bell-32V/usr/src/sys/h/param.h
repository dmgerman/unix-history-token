...
begin_comment
comment|/* max core in 512-byte clicks */
end_comment

begin_comment
comment|/*    ***********************************************************    * NOTE: For the moment, MAXUMEM must be less than 12*128  *    ***********************************************************    */
end_comment
...
begin_comment
comment|/* max no. clicks per process */
end_comment
...
begin_comment
comment|/* granularity of partial swaps (in clicks) */
end_comment
...
begin_comment
comment|/* max number of real memory pages */
end_comment
...
begin_comment
comment|/* pages of u-area (not including page tables ) */
end_comment
...
directive|define
name|USIZE
value|(UPAGES + u.u_pcb.pcb_szpt)
end_define

begin_comment
comment|/* size of user block (*512) */
end_comment
...
begin_comment
comment|/* number of "cheap" free page frames */
end_comment
