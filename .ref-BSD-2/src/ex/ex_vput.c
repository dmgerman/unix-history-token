...
name|trace
argument_list|,
literal|"inscol %d, inssiz %d, tabstart %d,\ tabend %d, tabslack %d, linend %d\n"
argument_list|,
name|inscol
argument_list|,
name|inssiz
...
name|tabstart
condition|)
comment|/* 			 * The end of the doomed characters sits right at the 			 * start of the tabs, then we don't need to use insert 			 * mode; the tab has already been expanded as 			 * appropriate and we can just overwrite it. 			 */
name|slakused
operator|=
literal|0
expr_stmt|;
