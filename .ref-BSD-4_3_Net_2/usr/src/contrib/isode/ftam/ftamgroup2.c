...
begin_comment
comment|/* ftamgroup2.c - FPM: respond to a grouped transaction */
end_comment
...
name|rcsid
init|=
literal|"$Header: /f/osi/ftam/RCS/ftamgroup2.c,v 7.1 91/02/22 09:22:56 mrose Interim $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*   * $Header: /f/osi/ftam/RCS/ftamgroup2.c,v 7.1 91/02/22 09:22:56 mrose Interim $  *  *  * $Log:	ftamgroup2.c,v $  * Revision 7.1  91/02/22  09:22:56  mrose  * Interim 6.8  *   * Revision 7.0  89/11/23  21:53:39  mrose  * Release 6.0  *   */
end_comment
...
begin_comment
comment|/*
comment|F-{MANAGE,BULK-{BEGIN,END}}.RESPONSE (group) */
end_comment
...
begin_comment
comment|/*
comment|F-GROUP.RESPONSE (group) */
end_comment
...
name|NULLCP
argument_list|,
literal|"group reply mismatch; expecting 0x%x, found 0x%x"
argument_list|,
name|fsb
operator|->
name|fsb_group
...
name|NULLCP
argument_list|,
literal|"bad value for select state parameter"
argument_list|)
return|;
block|}
switch|switch
...
name|NULLCP
argument_list|,
literal|"bad value for select action parameter"
argument_list|)
return|;
block|}
if|if
...
name|NULLCP
argument_list|,
literal|"too many select diagnostics"
argument_list|)
return|;
block|}
if|if
...
name|NULLCP
argument_list|,
literal|"bad value for create state parameter"
argument_list|)
return|;
block|}
switch|switch
...
name|NULLCP
argument_list|,
literal|"bad value for create action parameter"
argument_list|)
return|;
block|}
if|if
...
name|NULLCP
argument_list|,
literal|"too many create diagnostics"
argument_list|)
return|;
block|}
if|if
...
name|NULLCP
argument_list|,
literal|"bad value for read attribute action parameter"
argument_list|)
return|;
block|}
if|if
...
name|NULLCP
argument_list|,
literal|"too many read attribute diagnostics"
argument_list|)
return|;
block|}
if|if
...
name|NULLCP
argument_list|,
literal|"bad value for change attribute action parameter"
argument_list|)
return|;
block|}
if|if
...
name|NULLCP
argument_list|,
literal|"too many change attribute diagnostics"
argument_list|)
return|;
block|}
if|if
...
name|NULLCP
argument_list|,
literal|"bad value for deselect action parameter"
argument_list|)
return|;
block|}
if|if
...
name|NULLCP
argument_list|,
literal|"deselect not permitted to include charges"
argument_list|)
return|;
if|if
condition|(
...
name|NULLCP
argument_list|,
literal|"too many deselect charges"
argument_list|)
return|;
if|if
condition|(
...
name|NULLCP
argument_list|,
literal|"too many deselect diagnostics"
argument_list|)
return|;
block|}
if|if
...
name|NULLCP
argument_list|,
literal|"bad value for delete action parameter"
argument_list|)
return|;
block|}
if|if
...
name|NULLCP
argument_list|,
literal|"too many delete charges"
argument_list|)
return|;
if|if
condition|(
...
name|NULLCP
argument_list|,
literal|"too many delete diagnostics"
argument_list|)
return|;
block|}
if|if
...
name|NULLCP
argument_list|,
literal|"bad value for open state parameter"
argument_list|)
return|;
block|}
switch|switch
...
name|NULLCP
argument_list|,
literal|"bad value for open action parameter"
argument_list|)
return|;
block|}
if|if
...
name|NULLCP
argument_list|,
literal|"missing open contents type parameter"
argument_list|)
return|;
if|if
condition|(
...
name|NULLCP
argument_list|,
literal|"too many open diagnostics"
argument_list|)
return|;
block|}
return|return
...
parameter_list|)
define|\
value|if (s != int_FTAM_State__Result_success) { \ 	if ((req -> state__result = \ 	     		(struct type_FTAM_State__Result *) \ 	     			calloc (1, sizeof *req -> state__result)) \ 	        == NULL) \ 	    goto no_mem; \ 	req -> state__result -> parm = s; \     }
define|#
directive|define
name|new_action
parameter_list|(
...
index|]
operator|=
literal|"F-BEGIN-GROUP-response"
expr_stmt|;
block|}
if|if
condition|(
...
name|new_pdu
argument_list|(
name|type_FTAM_F__CLOSE__response
argument_list|,
name|type_FTAM_PDU_f__close__response
argument_list|,
name|f__close__response
argument_list|,
literal|"F-CLOSE-response"
argument_list|)
expr_stmt|;
name|new_action
argument_list|(
...
argument_list|,
literal|"F-READ-ATTRIB-response"
argument_list|)
expr_stmt|;
name|new_action
argument_list|(
...
argument_list|,
literal|"F-CHANGE-ATTRIB-response"
argument_list|)
expr_stmt|;
name|new_action
argument_list|(
