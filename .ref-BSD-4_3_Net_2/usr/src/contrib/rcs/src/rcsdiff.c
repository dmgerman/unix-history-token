...
index|[]
init|=
literal|"$Header: /usr/.src/devel/CONTRIB/rcs/src/RCS/rcsdiff.c,v 3.12 91/02/22 00:11:20 elan Exp $ Purdue CS"
decl_stmt|;
end_decl_stmt
