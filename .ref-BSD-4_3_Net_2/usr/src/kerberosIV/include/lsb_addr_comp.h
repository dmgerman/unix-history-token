...
begin_comment
comment|/*  * $Source: /mit/kerberos/src/include/RCS/lsb_addr_comp.h,v $  * $Author: jtkohl $  * $Header: lsb_addr_comp.h,v 4.0 89/01/23 15:44:46 jtkohl Exp $  *  * Copyright 1988 by the Massachusetts Institute of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  *  * Comparison macros to emulate LSBFIRST comparison results of network  * byte-order quantities  */
end_comment
