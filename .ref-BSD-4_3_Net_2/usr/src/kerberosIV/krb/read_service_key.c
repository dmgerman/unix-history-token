...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/read_service_key.c,v $  * $Author: kfall $  *  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
name|char
modifier|*
name|rcsid_read_service_key_c
init|=
literal|"$Id: read_service_key.c,v 4.10 90/06/25 20:57:14 kfall Exp $"
decl_stmt|;
end_decl_stmt
