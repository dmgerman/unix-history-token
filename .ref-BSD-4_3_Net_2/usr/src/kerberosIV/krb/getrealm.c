...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/getrealm.c,v $  * $Author: kfall $  *  * Copyright 1988 by the Massachusetts Institute of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  *  * routine to convert hostname into realm name.  */
end_comment
...
specifier|static
name|char
name|rcsid_getrealm_c
index|[]
init|=
literal|"$Id: getrealm.c,v 4.7 90/06/25 20:56:21 kfall Exp Locker: kfall $"
decl_stmt|;
end_decl_stmt
