...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/krb_get_in_tkt.c,v $  * $Author: karels $  *  * Copyright 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
init|=
literal|"$Header: /usr/src/kerberosIV/krb/RCS/krb_get_in_tkt.c,v 4.21 91/06/01 13:54:58 karels Exp $"
decl_stmt|;
end_decl_stmt
