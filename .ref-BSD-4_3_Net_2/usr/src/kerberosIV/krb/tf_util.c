...
begin_comment
comment|/*  * $Source: /afs/athena.mit.edu/astaff/project/kerberos/src/lib/krb/RCS/tf_util.c,v $  * $Author: jon $  *  * Copyright 1987, 1988 by the Massachusetts Institute of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
specifier|static
name|char
name|rcsid_tf_util_c
index|[]
init|=
literal|"$Id: tf_util.c,v 4.8 90/01/02 13:34:27 jtkohl Exp Locker: jtkohl $"
decl_stmt|;
end_decl_stmt
