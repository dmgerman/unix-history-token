...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/klist/RCS/klist.c,v $  * $Author: kfall $   *  * Copyright 1987, 1988 by the Massachusetts Institute of Technology.   *  * For copying and distribution information, please see the file  *<mit-copyright.h>.   *  * Lists your current Kerberos tickets.  * Written by Bill Sommerfeld, MIT Project Athena.  */
end_comment
...
index|[]
init|=
literal|"$Header: /usr/src/kerberosIV/klist/RCS/klist.c,v 4.16 90/06/25 21:01:52 kfall Exp $"
decl_stmt|;
end_decl_stmt
