...
name|rcsid
init|=
literal|"$Header: error.c,v 1.6 87/12/14 14:40:57 sklower Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  * 	error.c				$Locker:  $  * error handler  *  * (c) copyright 1982, Regents of the University of California  */
end_comment
