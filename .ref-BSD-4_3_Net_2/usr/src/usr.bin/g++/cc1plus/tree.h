...
literal|1
decl_stmt|;
comment|/* There is room for three more attributes.  */
block|}
struct|;
end_struct
...
begin_comment
comment|/* Nonzero in a FUNCTION_DECL means this function can be substituted    where it is called.    Nonzero in a VAR_DECL or PARM_DECL means this decl was made by inlining;    suppress any warnings about shadowing some other variable.  */
end_comment
...
begin_comment
comment|/* Nonzero for an expression that might raise an exception.  */
end_comment
...
name|NODE
parameter_list|)
value|((NODE)->function_decl.print_name)
end_define
...
name|NODE
parameter_list|)
value|((NODE)->function_decl.result)
end_define
...
name|NODE
parameter_list|)
value|((NODE)->function_decl.block_symtab_address)
end_define
...
name|NODE
parameter_list|)
value|((NODE)->function_decl.saved_insns)
end_define
...
name|NODE
parameter_list|)
value|((NODE)->function_decl.frame_size)
end_define
...
begin_comment
comment|/* For LABEL_STMT, GOTO_STMT, RETURN_STMT, COMPOUND_STMT, ASM_STMT.  */
end_comment
