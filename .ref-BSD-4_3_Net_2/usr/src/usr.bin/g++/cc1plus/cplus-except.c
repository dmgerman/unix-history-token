...
begin_comment
comment|/* Handle exceptional things in C++.    Copyright (C) 1989 Free Software Foundation, Inc.    Contributed by Michael Tiemann (tiemann@mcc.com)  This file is part of GNU CC.  GNU CC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 1, or (at your option) any later version.  GNU CC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU CC; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
begin_comment
comment|/* Low-level rtl interface.  */
end_comment
...
begin_comment
comment|/* Generate code to raise exception RAISE_ID.    If EXP is NULL_TREE, then PARMS is the list of parameters to use    for constructing this exception.    If EXP is non-NULL, then it is an already constructed object    of the kind that we want.  */
end_comment
...
block|}
comment|/* If we were re-raising, just let this fall through.      At the end of the reraises, the call to `expand_goto'      will take care of everybody.  */
block|}
end_function
