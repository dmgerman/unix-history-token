...
index|[]
init|=
literal|"@(#)sun3-dep.c	6.3 (Berkeley) 5/8/91"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* XXX     Added some bogus code so program will compile.  The problem is that    this module needs to be updated to use the new remote memory interface.    In the meantime, remote debugging is broken.  (mccanne) */
end_comment
...
argument_list|()
block|{}
comment|/* Machine-dependent code which would otherwise be in inflow.c and core.c,    for GDB, the GNU debugger.    Copyright (C) 1986, 1987, 1989 Free Software Foundation, Inc.  This file is part of GDB.  GDB is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 1, or (at your option) any later version.  GDB is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GDB; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
include|#
directive|include
file|<stdio.h>
include|#
