...
begin_comment
comment|/*#define STACK_END_ADDR 0x10000000*/
end_comment
...
begin_comment
comment|/* In the case of the ISI, the frame's nominal address    is the address of a 4-byte word containing the calling frame's address.  */
end_comment
