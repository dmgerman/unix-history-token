...
begin_comment
comment|/* Definitions to make GDB run on a vax under 4.2bsd.    Copyright (C) 1986, 1987, 1989 Free Software Foundation, Inc.  This file is part of GDB.  GDB is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 1, or (at your option) any later version.  GDB is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GDB; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
begin_comment
comment|/* On the VAX, sigtramp is in the u area.  Note that this definition    includes both the subroutine at u_pcb.pcb_sigc[3], and the    routine at u_pcb.pcb_sigc[0] (which does a calls to u_pcb.pcb_sigc[3]).    I think this is what we want.  */
end_comment
...
parameter_list|)
define|\
value|(outside_startup_file ((thisframe)->pc) ? \    read_memory_integer ((thisframe)->frame + 12, 4) :\    0)
end_define
...
begin_comment
comment|/* In most of GDB, getting the args address is too important to    just say "I don't know".  This is sometimes wrong, but c'est    la vie.  */
end_comment
