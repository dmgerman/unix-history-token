...
index|[]
init|=
literal|"@(#)m68k-pinsn.c	6.3 (Berkeley) 5/8/91"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* Print m68k instructions for GDB, the GNU debugger.    Copyright (C) 1986, 1987, 1989 Free Software Foundation, Inc.  This file is part of GDB.  GDB is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 1, or (at your option) any later version.  GDB is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GDB; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
begin_comment
comment|/* Need a function to convert from extended to double 			   precision... */
end_comment
...
begin_comment
comment|/* Nonzero if the host system has a 68881 (or compatible)    floating-point unit.  This does *not* indicate whether the target    system has a co-processor, just whether the host system does.    There might be a difference in the case of remote debugging.  */
end_comment
...
begin_comment
comment|/* This is not part of insn printing, but it is machine-specific,    so this is a convenient place to put it.     Convert a 68881 extended float to a double.    FROM is the address of the extended float.    Store the double in *TO.  */
end_comment

begin_macro
name|convert_from_68881
argument_list|(
argument|from
argument_list|,
argument|to
...
asm|asm ("mov.l 12(%a6),%a1");
asm|asm ("fmove.x (%a0),%fp0");
asm|asm ("fmove.d %fp0,(%a1)");
else|#
directive|else
...
directive|if
literal|0
block|asm ("movl a6@(8),a0");       asm ("movl a6@(12),a1");       asm ("fmovex a0@,fp0");       asm ("fmoved fp0,a1@");
else|#
directive|else
comment|/* Hand-assemble those insns since some assemblers lose 	 and some have different syntax.  */
asm|asm (".word 020156");
asm|asm (".word 8");
asm|asm (".word 021156");
asm|asm (".word 12");
asm|asm (".long 0xf2104800");
asm|asm (".long 0xf2117400");
endif|#
directive|endif
endif|#
directive|endif
...
asm|asm ("mov.l 8(%a6),%a0");
asm|asm ("mov.l 12(%a6),%a1");
asm|asm ("fmove.d (%a0),%fp0");
asm|asm ("fmove.x %fp0,(%a1)");
else|#
directive|else
comment|/* not HPUX_ASM */
if|#
directive|if
literal|0
block|asm ("movl a6@(8),a0");       asm ("movl a6@(12),a1");       asm ("fmoved a0@,fp0");       asm ("fmovex fp0,a1@");
else|#
directive|else
comment|/* Hand-assemble those insns since some assemblers lose.  */
asm|asm (".word 020156");
asm|asm (".word 8");
asm|asm (".word 021156");
asm|asm (".word 12");
asm|asm (".long 0xf2105400");
asm|asm (".long 0xf2116800");
endif|#
directive|endif
endif|#
directive|endif
...
parameter_list|()
block|{
comment|/* Want to figure out if we've got a coprocessor. The idea is to catch the      signal that gets delivered if no coprocessor is around (SIGEMT) then      execute a coprocessor instruction and see what happens. have_fpu is set      to zero if the EMT signal arrives. Else it is left at 1.  */
comment|/* If this turns out not to be portable to all 68k machines, we'll      have to move it to the dep files.  */
name|void
function_decl|(
modifier|*
name|emthandler
...
name|HPUX_ASM
argument_list|)
asm|asm (" long       0xf2000600");
comment|/* fmovel fp0, d0 */
else|#
directive|else
asm|asm(".long	0xf2000600");
comment|/* fmovel fp0, d0 */
