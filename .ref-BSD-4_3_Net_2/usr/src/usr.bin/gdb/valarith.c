...
index|[]
init|=
literal|"@(#)valarith.c	6.3 (Berkeley) 5/8/91"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* Perform arithmetic and other operations on values, for GDB.    Copyright (C) 1986, 1989 Free Software Foundation, Inc.  This file is part of GDB.  GDB is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 1, or (at your option) any later version.  GDB is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GDB; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
begin_comment
comment|/* Return the value of EXPR[IDX], expr an aggregate rvalue    (eg, a vector register) */
end_comment
...
begin_comment
comment|/* We know either arg1 or arg2 is a structure, so try to find the right    user defined function.  Create an argument vector that calls     arg1.operator @ (arg1,arg2) and return that value (where '@' is any    binary operator which is legal for GNU C++).  */
end_comment
...
name|error
argument_list|(
literal|"friend functions not implemented yet"
argument_list|)
expr_stmt|;
name|argvec
operator|=
...
begin_comment
comment|/* Simulate the C operator ! -- return 1 if ARG1 contains zeros.  */
end_comment
