...
directive|if
literal|0
comment|/* not HOST_WORDS_BIG_ENDIAN */
block|latehalf[1] = gen_rtx (CONST_INT, VOIDmode, 				 CONST_DOUBLE_LOW (operands[1])); 	  operands[1] = gen_rtx (CONST_INT, VOIDmode, 				 CONST_DOUBLE_HIGH (operands[1]));
endif|#
directive|endif
comment|/* not HOST_WORDS_BIG_ENDIAN */
block|}
...
begin_comment
comment|/* Test for -0.0.  */
end_comment

begin_function
name|int
name|double_is_minus_zero
parameter_list|(
name|arg
parameter_list|)
name|double
