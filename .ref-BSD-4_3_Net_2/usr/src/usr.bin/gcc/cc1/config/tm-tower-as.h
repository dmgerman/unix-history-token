...
name|STARTFILE_SPEC
define|\
value|"%{p:%{m68881:/usr/lib/fp/mcrt1.o}%{!m68881:/lib/mcrt1.o}}     \  %{!p:%{m68881:/usr/lib/fp/crt1.o}%{!m68881:/lib/crt1.o}}"
end_define
...
begin_comment
comment|/* Override parts of tm-m68k.h to fit the Tower assembler.    This section needs to track changes done to tm-m68k.h in the future.  */
end_comment
...
begin_comment
comment|/* The prologue is identical to the one in tm-m68k.h except that the    assembler syntax is different.  */
end_comment
...
begin_comment
comment|/* The epilogue is identical to the one in tm-m68k.h except that:    a) The assembler syntax is different.    b) Pointers are returned both in %d0 and %a0.    c) FUNCTION_EXTRA_EPILOGUE is not needed.  */
end_comment
