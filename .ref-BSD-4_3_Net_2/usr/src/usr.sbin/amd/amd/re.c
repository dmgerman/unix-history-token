...
begin_comment
comment|/*  * This version is lightly edited to fit in with the Amd build mechanism.  * All patches thru "comp.sources.unix v10i097" have been applied.  *  * $Id: re.c,v 5.2 91/03/03 20:21:16 jsp Alpha $  */
end_comment
...
operator|--
expr_stmt|;
comment|/* Back off clear of ?+* operand. */
operator|*
name|flagp
operator||=
name|HASWIDTH
