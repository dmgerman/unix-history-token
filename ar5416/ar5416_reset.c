...
begin_comment
comment|/*  * Copyright (c) 2002-2008 Sam Leffler, Errno Consulting  * Copyright (c) 2002-2008 Atheros Communications, Inc.  *  * Permission to use, copy, modify, and/or distribute this software for any  * purpose with or without fee is hereby granted, provided that the above  * copyright notice and this permission notice appear in all copies.  *  * THE SOFTWARE IS PROVIDED "AS IS" AND THE AUTHOR DISCLAIMS ALL WARRANTIES  * WITH REGARD TO THIS SOFTWARE INCLUDING ALL IMPLIED WARRANTIES OF  * MERCHANTABILITY AND FITNESS. IN NO EVENT SHALL THE AUTHOR BE LIABLE FOR  * ANY SPECIAL, DIRECT, INDIRECT, OR CONSEQUENTIAL DAMAGES OR ANY DAMAGES  * WHATSOEVER RESULTING FROM LOSS OF USE, DATA OR PROFITS, WHETHER IN AN  * ACTION OF CONTRACT, NEGLIGENCE OR OTHER TORTIOUS ACTION, ARISING OUT OF  * OR IN CONNECTION WITH THE USE OR PERFORMANCE OF THIS SOFTWARE.  *  * $Id: ar5416_reset.c,v 1.20 2008/11/10 04:08:05 sam Exp $  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/*  	 * If the AP starts the calibration before the base band timeout 	 * completes we could get rx_clear false triggering, to avoid this 	 * we add delay an extra BASE_ACTIVATE_DELAY usecs to ensure this 	 * does not happen. 	 */
if|if
condition|(
...
begin_comment
unit|static HAL_BOOL ar5416RunInitCals(struct ath_hal *ah, int init_cal_count) { 	struct ath_hal_5416 *ahp = AH5416(ah); 	HAL_CHANNEL_INTERNAL ichan;
comment|/* XXX bogus */
end_comment
...
begin_comment
unit|ahp->ah_cal_list = ahp->ah_cal_last = 			    ahp->ah_cal_curr = AH_NULL; 			return AH_FALSE; 		}
...
begin_endif
unit|ahp->ah_cal_list = ahp->ah_cal_last = 	    ahp->ah_cal_curr = AH_NULL; 	return AH_TRUE; }
endif|#
directive|endif
end_endif
...
directive|if
literal|0
block|if (ar5416IsCalSupp(ah, chan, ADC_DC_INIT_CAL)) { 			INIT_CAL(&ahp->ah_adcDcCalInitData); 			INSERT_CAL(ahp,&ahp->ah_adcDcCalInitData); 		}
comment|/* Initialize current pointer to first element in list */
block|ahp->ah_cal_curr = ahp->ah_cal_list;  		if (ahp->ah_cal_curr != AH_NULL&& !ar5416RunInitCals(ah, 0)) 			return AH_FALSE;
endif|#
directive|endif
block|}
...
name|CAL_WAITING
expr_stmt|;
comment|/* Indicate to upper layers that we need polling for Howl/Sowl */
operator|*
name|isCalDone
operator|=
name|AH_FALSE
...
directive|if
literal|1
comment|/*          * MRC CCK can interfere with beacon detection and cause deaf/mute.          * Disable MRC CCK          */
name|OS_REG_CLR_BIT
argument_list|(
name|ah
argument_list|,
