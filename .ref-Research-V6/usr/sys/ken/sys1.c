...
expr_stmt|;
block|}
comment|/* 	 * read in first 8 bytes 	 * of file for segment 	 * sizes: 	 * w0 = 407/410/411 (410 implies RO text) (411 implies sep ID) 	 * w1 = text size 	 * w2 = data size 	 * w3 = bss size 	 */
name|u
operator|.
name|u_base
operator|=
...
begin_comment
comment|/*  * exit system call:  * pass back caller's r0  */
end_comment
