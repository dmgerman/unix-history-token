...
begin_comment
comment|/*  * Copyright (C) 2012 by Darren Reed.  *  * Simple PPTP transparent proxy for in-kernel use.  For use with the NAT  * code.  *  * $Id$  *  */
end_comment
...
name|printf
argument_list|(
literal|"ipf_p_pptp_new: GRE session already exists\n"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|printf
argument_list|(
literal|"ipf_p_pptp_new: malloc for aps_data failed\n"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|funcname
init|=
literal|"ipf_p_pptp_nextmessage"
decl_stmt|;
name|pptp_side_t
modifier|*
name|pptps
