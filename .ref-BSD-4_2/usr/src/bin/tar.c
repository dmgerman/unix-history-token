...
name|sccsid
init|=
literal|"@(#)tar.c	4.19 (Berkeley) 9/22/83"
decl_stmt|;
end_decl_stmt
...
name|stderr
argument_list|,
literal|"tar: %s: no such file or directory\n"
argument_list|,
name|longname
argument_list|)
expr_stmt|;
...
name|stderr
argument_list|,
literal|"tar: %s: cannot stat file\n"
argument_list|,
name|longname
argument_list|)
expr_stmt|;
...
name|cp
decl_stmt|;
comment|/* 	 * Quick check for existance of directory. 	 */
if|if
condition|(
operator|(
name|cp
