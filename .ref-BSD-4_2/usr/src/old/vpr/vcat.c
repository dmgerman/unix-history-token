...
define|#
directive|define
name|VP_BYTES_PER_LINE
value|(VP_RASTER_LENGTH/8)
end_define
...
directive|define
name|VP_BUFFER_SIZE
value|(NLINES*VP_BYTES_PER_LINE)
end_define
...
begin_comment
comment|/* lf's from top to bottom of page */
end_comment
...
begin_comment
comment|/* lf's from bottom of banner to bottom of page */
end_comment
...
name|stderr
argument_list|,
literal|"usage: vcat  [ -W ] [ -t ] [ -w ] [ -b banner ] [ file... ]\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
...
expr_stmt|;
block|}
comment|/* * This should be handled by daemon. 		if (vc< 0) { 			fprintf(stderr, varian ? "Varian " : "Versatec "); 			if (errno == EIO) 				fprintf(stderr, "off line\n"); 			else if (errno == ENXIO) 				fprintf(stderr, "in use\n"); 			else 				fprintf(stderr, "not available\n"); 			exit(1); 		} */
block|}
name|ioctl
argument_list|(
name|vc
...
condition|)
block|{
comment|/* Do enough newlines to get exactly to the perforation. */
name|newlines
argument_list|(
name|TOF_TO_BOF
argument_list|)
