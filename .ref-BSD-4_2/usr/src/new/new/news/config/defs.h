...
name|news_version
init|=
literal|"B 2.10 beta	3/9/83"
decl_stmt|;
end_decl_stmt

begin_comment
comment|/* SCCS ID @(#)defs.dist	2.14	3/9/83 */
end_comment
...
begin_comment
comment|/* What followup commmand should use */
end_comment
...
begin_comment
comment|/* #define UUNAME @@	/* omit for uuname, put in LIBDIR	*/
end_comment
...
begin_comment
comment|/* #define BATCH @@	/* Allow batch input: name of unbatcher */
end_comment

begin_comment
comment|/* BATCH: SEE SECURITY WARNING IN	*/
end_comment

begin_comment
comment|/* ifuncs.c BEFORE YOU TURN THIS ON.	*/
end_comment

begin_comment
comment|/* #define BERKNAME @@	/* name of local host on Berknet	*/
end_comment
...
begin_comment
comment|/* #define INTERNET		/* Internet mail works locally		*/
end_comment
...
begin_comment
comment|/* Believe new unrecognized newsgroups	*/
end_comment
...
begin_comment
comment|/* If uname call is available.		*/
end_comment
...
directive|define
name|SYSPATH
value|"/usr/fbin:/usr/lbin:/bin:/usr/bin"
end_define
