...
name|sccsid
init|=
literal|"@(#)newsinput.c	1.3 2/2/83"
decl_stmt|;
end_decl_stmt
...
name|stderr
argument_list|,
literal|"Article not protocol A\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
...
literal|'\0'
expr_stmt|;
comment|/* null terminator there */
comment|/* long title stuff added by RLS */
name|longtitle
index|[
name|i
operator|++
...
argument_list|)
expr_stmt|;
comment|/* use secret decoder ring */
while|while
condition|(
name|getc
argument_list|(
