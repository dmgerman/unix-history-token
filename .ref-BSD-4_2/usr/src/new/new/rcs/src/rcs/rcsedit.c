...
index|[]
init|=
literal|"$Header: /usr/wft/RCS/SRC/RCS/rcsedit.c,v 3.7 83/05/12 13:04:39 wft Exp $ Purdue CS"
decl_stmt|;
end_decl_stmt
...
argument_list|)
expr_stmt|;
comment|/* no need to rewind at beginning of file */
name|editline
operator|=
literal|1
expr_stmt|;
