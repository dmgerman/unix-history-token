...
index|[]
init|=
literal|"$Header: /usr/wft/RCS/SRC/RCS/rcsmerge.c,v 3.3 82/12/24 15:29:00 wft Exp $ Purdue CS"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* $Log:	rcsmerge.c,v $  * Revision 3.3  82/12/24  15:29:00  wft  * Added call to catchsig().  *   * Revision 3.2  82/12/10  21:32:02  wft  * Replaced getdelta() with gettree(); improved error messages.  *  * Revision 3.1  82/11/28  19:27:44  wft  * Initial revision.  *  */
end_comment
