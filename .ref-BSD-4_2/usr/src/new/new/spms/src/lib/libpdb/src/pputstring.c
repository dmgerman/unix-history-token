...
begin_comment
comment|/*  * pputstring() adds id=string to each entry corresponding to key. If id  * already exists, the corresponding string is replaced by string. If  * key not found, a new entry is added to the database.  */
end_comment
