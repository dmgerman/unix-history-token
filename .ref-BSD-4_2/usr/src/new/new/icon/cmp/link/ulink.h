...
name|bentry
block|{
comment|/* built-in function table entry */
name|char
modifier|*
name|b_name
decl_stmt|;
...
begin_comment
comment|/* initial size of identifier table hash area */
end_comment
...
begin_comment
comment|/* initial size of global table hash area */
end_comment
...
begin_comment
comment|/* initial size of field table hash area */
end_comment
