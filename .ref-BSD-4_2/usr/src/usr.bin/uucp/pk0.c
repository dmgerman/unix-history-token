...
index|[]
init|=
literal|"@(#)pk0.c	5.1 (Berkeley) 7/2/83"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  * Here are a couple of strange variables (rti!trt).  * pkactive is only incremented in pkopen.  * perhaps it should be decremented in pkclose?  * And pkdebug is set in gio.c but never used.  */
end_comment
