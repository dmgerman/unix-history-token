...
begin_comment
comment|/* **  CONF.H -- definitions of compilation flags needed everywhere. ** **	This, together with conf.c, should be all the configuration **	information needed.  This stuff could be in a makefile, but **	we prefer to keep this file very small because it is different **	on a number of machines. ** **	@(#)conf.h	4.1	7/25/83 */
end_comment
