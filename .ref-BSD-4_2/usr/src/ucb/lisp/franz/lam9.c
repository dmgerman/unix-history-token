...
name|rcsid
init|=
literal|"$Header: lam9.c 1.4 83/06/24 10:56:30 sklower Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*					-[Thu Mar  3 11:41:27 1983 by jkf]-  * 	lam9.c				$Locker:  $  * lambda functions  *  * (c) copyright 1982, Regents of the University of California  */
end_comment
