...
name|rcsid
init|=
literal|"$Header: data.c,v 1.7 83/09/12 14:17:15 sklower Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*					-[Sun Jun 19 14:41:00 1983 by jkf]-  * 	data.c				$Locker:  $  * static storage declarations  *  * (c) copyright 1982, Regents of the University of California  */
end_comment
...
begin_comment
comment|/* in the case we can't use the C stack for extending automatics */
end_comment
...
begin_comment
comment|/* This avoids an ifdef in dumplisp */
end_comment
...
begin_comment
comment|/* value is the symbol 'print'  */
end_comment
