...
begin_comment
comment|// This file defines structures to encapsulate the machine model as described in
end_comment
...
ifndef|#
directive|ifndef
name|LLVM_UTILS_TABLEGEN_CODEGENSCHEDULE_H
end_ifndef
...
argument|Record *IC
argument_list|,
argument|ArrayRef<unsigned> W
argument_list|,
argument|ArrayRef<unsigned> R
argument_list|)
block|{
return|return
name|ItinClassDef
...
begin_comment
comment|// an itinerary but no machine model. If the processor defines neither a machine
end_comment
...
argument_list|)
expr_stmt|;
comment|// iterator access to the scheduling classes.
typedef|typedef
name|std
operator|::
name|vector
...
name|genRWName
argument_list|(
argument|ArrayRef<unsigned> Seq
argument_list|,
