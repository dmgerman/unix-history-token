...
begin_comment
comment|/*  * ex_cscope --  *	Perform an ex cscope.  *  * PUBLIC: int ex_cscope(SCR *, EXCMD *);  */
end_comment
...
begin_comment
comment|/*  * cscope_end --  *	End all cscope connections.  *  * PUBLIC: int cscope_end(SCR *);  */
end_comment
...
begin_comment
comment|/*  * cscope_display --  *	Display current connections.  *  * PUBLIC: int cscope_display(SCR *);  */
end_comment
...
begin_comment
comment|/*  * cscope_search --  *	Search a file for a cscope entry.  *  * PUBLIC: int cscope_search(SCR *, TAGQ *, TAG *);  */
end_comment
