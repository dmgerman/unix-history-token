...
begin_comment
comment|/* $OpenBSD: mux.c,v 1.14 2010/01/30 02:54:53 djm Exp $ */
end_comment
...
name|debug2
argument_list|(
literal|"%s: channel %d n session channel %d"
argument_list|,
name|__func__
argument_list|,
name|c
...
expr_stmt|;
comment|/* prepare reply */
comment|/* XXX defer until mux_session_confirm() fires */
name|buffer_put_int
argument_list|(
name|r
argument_list|,
...
return|;
block|}
comment|/* XXX support rport0 forwarding with reply of port assigned */
if|if
condition|(
name|fwd
operator|.
...
block|{
comment|/* XXX wait for remote to confirm */
if|if
condition|(
name|options
operator|.
