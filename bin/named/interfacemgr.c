...
begin_comment
comment|/* $Id: interfacemgr.c,v 1.93.70.2 2009-01-18 23:47:34 tbox Exp $ */
end_comment
...
name|address
expr_stmt|;
comment|/* First add localhost address */
name|prefixlen
operator|=
operator|(
name|netaddr
...
operator|)
return|;
comment|/* Then add localnets prefix */
name|result
operator|=
...
argument_list|)
expr_stmt|;
comment|/* Non contiguous netmasks not allowed by IPv6 arch. */
if|if
condition|(
name|result
operator|!=
