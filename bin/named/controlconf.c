...
begin_comment
comment|/* $Id: controlconf.c,v 1.40.18.10.40.3 2008/07/23 23:16:43 marka Exp $ */
end_comment
...
name|ISC_LOG_WARNING
argument_list|,
literal|"couldn't update ownership/permission for "
literal|"command channel %s"
argument_list|,
name|socktext
argument_list|)
...
name|addr
decl_stmt|;
comment|/* 				 * The parser handles BIND 8 configuration file 				 * syntax, so it allows unix phrases as well 				 * inet phrases with no keys{} clause. 				 */
name|control
operator|=
name|cfg_listelt_value
argument_list|(
