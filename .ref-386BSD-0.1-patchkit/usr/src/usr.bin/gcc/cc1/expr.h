...
begin_comment
comment|/* This is the 4th arg to `expand_expr'.    EXPAND_SUM means it is ok to return a PLUS rtx or MULT rtx.    EXPND_CONST_ADDRESS means it is ok to return a MEM whose address     is a constant that is not a legitimate address.  */
end_comment
...
begin_comment
comment|/* Logical and with complement of 2nd arg */
end_comment
