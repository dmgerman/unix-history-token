...
begin_comment
comment|/* We've just printed some files and need to clean up things before    looking for more options and printing the next batch of files.     Free everything we've malloc'ed, except `header'. */
end_comment
