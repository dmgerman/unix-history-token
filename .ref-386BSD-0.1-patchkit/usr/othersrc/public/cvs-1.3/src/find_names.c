...
begin_comment
comment|/*  * Copyright (c) 1992, Brian Berliner and Jeff Polk  * Copyright (c) 1989-1992, Brian Berliner  *   * You may distribute under the terms of the GNU General Public License as  * specified in the README file that comes with the CVS 1.3 kit.  *   * Find Names  *   * Finds all the pertinent file names, both from the administration and from the  * repository  *   * Find Dirs  *   * Finds all pertinent sub-directories of the checked out instantiation and the  * repository (and optionally the attic)  */
end_comment
...
index|[]
init|=
literal|"@(#)find_names.c 1.38 92/04/10"
decl_stmt|;
end_decl_stmt
...
operator|)
return|;
comment|/* set up a regular expression to find the ,v files */
operator|(
name|void
operator|)
name|sprintf
...
name|dirp
decl_stmt|;
comment|/* build a regex to blow off ,v files */
operator|(
name|void
operator|)
name|sprintf
