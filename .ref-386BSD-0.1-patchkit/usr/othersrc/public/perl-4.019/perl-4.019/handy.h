...
name|t
parameter_list|)
value|(v = (t*)safemalloc((MEM_SIZE)((n) * sizeof(t)))), \     bzero((char*)(v), (n) * sizeof(t))
end_define
...
name|t
parameter_list|)
value|(v = (t*)safemalloc(((unsigned long)(n) * sizeof(t)))), \     bzero((char*)(v), (n) * sizeof(t))
end_define
...
name|t
parameter_list|)
value|(v = (t*)safexmalloc(x,(MEM_SIZE)((n) * sizeof(t)))), \     bzero((char*)(v), (n) * sizeof(t))
end_define
...
name|t
parameter_list|)
value|(void)bcopy((char*)(s),(char*)(d), (n) * sizeof(t))
end_define
...
name|t
parameter_list|)
value|(void)bzero((char*)(d), (n) * sizeof(t))
end_define
