...
name|f
parameter_list|)
value|return(yylval.ival = f,expectterm = TRUE,bufptr = s, \ 	(*s == '(' || (s = skipspace(s), *s == '(') ? (int)FUNC1 : (int)UNIOP) )
end_define
