...
directive|define
name|BIN
value|"/usr/src/contrib/perl-4.019/bin"
end_define
...
begin_comment
comment|/* HAS_MSGCTL  *	This symbol, if defined, indicates that the msgctl() routine is  *	available to stat symbolic links.  */
end_comment
...
begin_comment
comment|/* HAS_MSGGET  *	This symbol, if defined, indicates that the msgget() routine is  *	available to stat symbolic links.  */
end_comment
...
begin_comment
comment|/* HAS_MSGRCV  *	This symbol, if defined, indicates that the msgrcv() routine is  *	available to stat symbolic links.  */
end_comment
...
begin_comment
comment|/* HAS_MSGSND  *	This symbol, if defined, indicates that the msgsnd() routine is  *	available to stat symbolic links.  */
end_comment
...
begin_comment
comment|/* HAS_SEMCTL  *	This symbol, if defined, indicates that the semctl() routine is  *	available to stat symbolic links.  */
end_comment
...
begin_comment
comment|/* HAS_SEMGET  *	This symbol, if defined, indicates that the semget() routine is  *	available to stat symbolic links.  */
end_comment
...
begin_comment
comment|/* HAS_SEMOP  *	This symbol, if defined, indicates that the semop() routine is  *	available to stat symbolic links.  */
end_comment
...
begin_comment
comment|/* HAS_SHMAT  *	This symbol, if defined, indicates that the shmat() routine is  *	available to stat symbolic links.  */
end_comment
...
begin_comment
comment|/* HAS_SHMCTL  *	This symbol, if defined, indicates that the shmctl() routine is  *	available to stat symbolic links.  */
end_comment
...
begin_comment
comment|/* HAS_SHMDT  *	This symbol, if defined, indicates that the shmdt() routine is  *	available to stat symbolic links.  */
end_comment
...
begin_comment
comment|/* HAS_SHMGET  *	This symbol, if defined, indicates that the shmget() routine is  *	available to stat symbolic links.  */
end_comment
...
directive|define
name|PRIVLIB
value|"/usr/src/contrib/perl-4.019/lib"
end_define
