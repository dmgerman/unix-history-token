...
name|stayflg
condition|)
comment|/* and, if -S not given on cmd line, */
name|doexit
argument_list|(
name|GOOD_EXIT
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* Then exit with return code */
block|}
block|}
if|if
condition|(
...
directive|ifdef
name|UNIX
comment|/* Perhaps the ifdef can be removed? */
if|if
condition|(
name|zchki
argument_list|(
