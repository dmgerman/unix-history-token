...
begin_comment
comment|/* Should do the same for EXCELAN, INTERLAN, etc... */
end_comment
...
begin_comment
comment|/* Olivetti X/OS */
end_comment

begin_comment
comment|/*   Reportedly this was only necessary because of a bug in X/OS,   which is now fixed.  X/OS users who have trouble compiling ckcnet.c   should uncomment this section. */
end_comment
...
begin_comment
comment|/* Others here -- DECnet, VAX/PSI */
end_comment
