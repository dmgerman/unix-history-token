...
begin_comment
comment|/* EN ASCII, American English */
end_comment
...
begin_comment
comment|/* Designators for 8-bit single-byte ISO and other standard character sets */
end_comment

begin_comment
comment|/* to be used in Kermit's transfer syntax.  Note that symbols must be unique */
end_comment

begin_comment
comment|/* in the first 8 characters, because some C preprocessors have this limit. */
end_comment
...
begin_comment
comment|/* JIS Roman + Katana + Kanji, EUC code */
end_comment
...
begin_comment
comment|/*   Not used yet.  Take out hard-coded numbers.  They are wrong anyway. */
end_comment
