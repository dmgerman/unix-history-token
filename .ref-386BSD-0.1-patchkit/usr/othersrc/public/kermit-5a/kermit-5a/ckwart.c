...
begin_comment
comment|/*  The following "char" should be changed to "short", "int", or "long" if your  wart program will generate more than 127 states.  Since wart is used mainly  with C-Kermit, which has about 50 states, "short" is adequate.  This   keeps the program about 3K-4K smaller. */
end_comment
