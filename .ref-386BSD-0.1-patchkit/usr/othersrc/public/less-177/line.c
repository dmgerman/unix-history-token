...
name|a
parameter_list|)
value|if (storec((c),(a))) return (1); else curr++
if|if
condition|(
name|overstrike
condition|)
...
block|{
comment|/* 			 * Output in the (blinking) ^X format. 			 */
name|s
operator|=
name|prchar
argument_list|(
...
name|binattr
expr_stmt|;
comment|/* 			 * Make sure we can get the entire representation 			 * the character on this line. 			 */
if|if
condition|(
name|column
operator|+
