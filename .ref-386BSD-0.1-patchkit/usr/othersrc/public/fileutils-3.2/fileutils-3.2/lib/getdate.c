...
begin_comment
comment|/* **  If you need to do a tzset() call to set the **  timezone, and don't have ftime(). */
end_comment
...
begin_comment
comment|/* defined(USG) || defined(FTIME_MISSING) */
end_comment
...
index|[]
init|=
literal|"$Header: str2date.y,v 2.1 90/09/06 08:15:06 cronan Exp $"
decl_stmt|;
end_decl_stmt
...
block|,
literal|"date : tUNUMBER tSNUMBER tSNUMBER"
block|,
