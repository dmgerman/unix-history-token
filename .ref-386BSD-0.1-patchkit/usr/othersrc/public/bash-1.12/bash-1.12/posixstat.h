...
begin_comment
comment|/* This text is taken directly from the Cadmus I was trying to    compile on:     the following MACROs are defined for X/OPEN compatibility     however, is the param correct ??    #define S_ISBLK(s) ((s.st_mode& S_IFMT) == S_IFBLK)    Well, the answer is no.  Thus... */
end_comment
