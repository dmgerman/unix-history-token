...
begin_comment
comment|/* Declaring bcopy causes errors on systems whose declarations are different.    If the declaration is omitted, everything works fine.  rms.  */
end_comment
...
begin_comment
comment|/* This character is the one the last call to getopt () processed as an    option. */
end_comment
...
begin_comment
comment|/* Call this function with an argument of 1 to set the default option    ordering to that required by Posix.  The normal default is PERMUTE. */
end_comment
