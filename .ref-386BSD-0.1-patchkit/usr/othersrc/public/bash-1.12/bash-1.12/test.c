...
begin_comment
comment|/* Modified to run with the GNU shell Apr 25, 1988 by bfox. */
end_comment
...
begin_comment
comment|/* STANDALONE&& (USG || STDC_HEADERS) */
end_comment

begin_comment
comment|/* Make gid_t and uid_t mean something for non-posix systems. */
end_comment
