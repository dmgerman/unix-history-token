...
begin_comment
comment|/* ftp_var.h - FTP global variables */
end_comment

begin_comment
comment|/*   * $Header: /f/osi/ftam-ftp/RCS/ftp_var.h,v 7.1 91/02/22 09:23:32 mrose Interim $  *  *  * $Log:	ftp_var.h,v $  * Revision 7.1  91/02/22  09:23:32  mrose  * Interim 6.8  *   * Revision 7.0  89/11/23  21:55:07  mrose  * Release 6.0  *   */
end_comment
...
begin_comment
comment|/* print messages to/from server */
end_comment
...
begin_comment
comment|/* global interface variables */
end_comment
...
begin_comment
comment|/* TRUE if last ftp_exist was a multiple listing */
end_comment
...
begin_comment
comment|/* points to FTP diagnostic string */
end_comment
