...
begin_comment
comment|/*  * hostapd / Driver interface for development testing  * Copyright (c) 2004-2008, Jouni Malinen<j@w1.fi>  *  * This program is free software; you can redistribute it and/or modify  * it under the terms of the GNU General Public License version 2 as  * published by the Free Software Foundation.  *  * Alternatively, this software may be distributed under the terms of BSD  * license.  *  * See README and COPYING for more details.  */
end_comment
...
specifier|static
name|int
name|test_driver_set_wps_beacon_ie
parameter_list|(
specifier|const
name|char
modifier|*
...
specifier|static
name|int
name|test_driver_set_wps_probe_resp_ie
parameter_list|(
specifier|const
name|char
modifier|*
...
name|MSG_DEBUG
argument_list|,
literal|"test_driver: ProbeResp WPS IE"
argument_list|,
name|ie
argument_list|,
name|len
...
name|MACSTR
literal|" aid=%d "
literal|"capability=0x%x flags=0x%x listen_interval=%d)"
argument_list|,
name|__func__
argument_list|,
name|ifname
