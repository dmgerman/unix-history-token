...
begin_comment
comment|/* Maximum supported PEAP version  * 0 = Microsoft's PEAP version 0; draft-kamath-pppext-peapv0-00.txt  * 1 = draft-josefsson-ppext-eap-tls-eap-05.txt  */
end_comment
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-PEAP: try EAP vendor %d type %d"
argument_list|,
name|sm
operator|->
name|user
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-PEAP: try EAP vendor %d type 0x%x"
argument_list|,
name|next_vendor
argument_list|,
name|next_type
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-PEAP: No success data in resumed session - reject attempt"
argument_list|)
expr_stmt|;
name|eap_peap_state
argument_list|(
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-PEAP: Resumed session for another EAP type (%u) - reject attempt"
argument_list|,
operator|*
name|pos
argument_list|)
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-PEAP: Identity from cached session"
argument_list|,
name|pos
argument_list|,
name|id_len
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-PEAP: Phase2 Identity not found in the user database"
argument_list|,
name|sm
operator|->
name|identity
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-PEAP: Resuming previous session - skip Phase2"
argument_list|)
expr_stmt|;
name|eap_peap_state
argument_list|(
...
return|;
return|return
name|eap_server_tls_derive_session_id
argument_list|(
name|sm
argument_list|,
operator|&
