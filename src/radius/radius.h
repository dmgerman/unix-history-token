...
begin_comment
comment|/*  * RADIUS message processing  * Copyright (c) 2002-2009, 2012, 2014, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
literal|102
block|,
name|RADIUS_ATTR_OPERATOR_NAME
init|=
literal|126
block|,
name|RADIUS_ATTR_LOCATION_INFO
init|=
literal|127
block|,
name|RADIUS_ATTR_LOCATION_DATA
init|=
literal|128
block|,
name|RADIUS_ATTR_BASIC_LOCATION_POLICY_RULES
init|=
literal|129
block|,
name|RADIUS_ATTR_EXTENDED_LOCATION_POLICY_RULES
init|=
literal|130
block|,
name|RADIUS_ATTR_LOCATION_CAPABLE
init|=
literal|131
block|,
name|RADIUS_ATTR_REQUESTED_LOCATION_INFO
init|=
literal|132
block|,
...
begin_comment
comment|/* Hotspot 2.0 - WFA Vendor-specific RADIUS Attributes */
end_comment
