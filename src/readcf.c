...
begin_comment
comment|/* **  INITBOUNCEQUEUE -- determine BounceQueue if option is set. ** **	Parameters: **		none. ** **	Returns: **		none. ** **	Side Effects: **		sets BounceQueue */
end_comment
...
argument_list|,
literal|"Warning: option BounceQueue: unknown queue group %s\n"
argument_list|,
name|bouncequeue
argument_list|)
expr_stmt|;
...
begin_comment
comment|/* first character for dynamically created mailers */
end_comment
...
begin_comment
comment|/* list of first characters for cf defined mailers */
end_comment
...
begin_comment
comment|/* **  SETUPDYNMAILERS -- find a char that isn't used as first element of any **		mailer name. ** **	Parameters: **		none ** **	Returns: **		none **	 **	Note: space is not valid in cf defined mailers hence the function **		will always find a char. It's not nice, but this is for **		internal names only. */
end_comment
...
index|[]
init|=
literal|"YXZ0123456789ABCDEFGHIJKLMNOPQRSTUVWyxzabcfghijkmnoqtuvw "
decl_stmt|;
name|frst
index|[
name|MAXMAILERS
...
begin_comment
comment|/* **  NEWMODMAILER -- Create a new mailer with modifications ** **	Parameters: **		rcpt -- current RCPT **		fl -- flag to set ** **	Returns: **		true iff successful. ** **	Note: this creates a copy of the mailer for the rcpt and **		modifies exactly one flag.  It does not work **		for multiple flags! */
end_comment
...
name|sm_dprintf
argument_list|(
literal|"newmodmailer: found idx=%d\n"
argument_list|,
name|idx
argument_list|)
expr_stmt|;
...
name|sm_dprintf
argument_list|(
literal|"newmodmailer: mailer[%d]=%s %p\n"
argument_list|,
name|idx
argument_list|,
name|Mailer
...
value|0xbf
block|{
literal|"CertFingerprintAlgorithm"
block|,
name|O_DIG_ALG
block|,
name|OI_NONE
...
define|#
directive|define
name|O_SRV_SSL_OPTIONS
value|0xe3
block|{
literal|"ServerSSLOptions"
block|,
name|O_SRV_SSL_OPTIONS
block|,
name|OI_NONE
...
define|#
directive|define
name|O_CLT_SSL_OPTIONS
value|0xe4
block|{
literal|"ClientSSLOptions"
block|,
name|O_CLT_SSL_OPTIONS
block|,
name|OI_NONE
...
define|#
directive|define
name|O_RCPTTHROTDELAY
value|0xe6
block|{
literal|"BadRcptThrottleDelay"
block|,
name|O_RCPTTHROTDELAY
block|,
name|OI_SAFE
...
block|{
literal|"SSL_OP_MICROSOFT_SESS_ID_BUG"
block|,
name|SSL_OP_MICROSOFT_SESS_ID_BUG
block|}
block|,
...
block|{
literal|"SSL_OP_NETSCAPE_REUSE_CIPHER_CHANGE_BUG"
block|,
name|SSL_OP_NETSCAPE_REUSE_CIPHER_CHANGE_BUG
block|}
block|,
...
block|{
literal|"SSL_OP_SSLREF2_REUSE_CERT_TYPE_BUG"
block|,
name|SSL_OP_SSLREF2_REUSE_CERT_TYPE_BUG
block|}
block|,
...
block|{
literal|"SSL_OP_MICROSOFT_BIG_SSLV3_BUFFER"
block|,
name|SSL_OP_MICROSOFT_BIG_SSLV3_BUFFER
block|}
block|,
...
block|{
literal|"SSL_OP_MSIE_SSLV2_RSA_PADDING"
block|,
name|SSL_OP_MSIE_SSLV2_RSA_PADDING
block|}
block|,
...
block|{
literal|"SSL_OP_SSLEAY_080_CLIENT_DH_BUG"
block|,
name|SSL_OP_SSLEAY_080_CLIENT_DH_BUG
block|}
block|,
...
block|{
literal|"SSL_OP_TLS_BLOCK_PADDING_BUG"
block|,
name|SSL_OP_TLS_BLOCK_PADDING_BUG
block|}
block|,
...
block|{
literal|"SSL_OP_DONT_INSERT_EMPTY_FRAGMENTS"
block|,
name|SSL_OP_DONT_INSERT_EMPTY_FRAGMENTS
block|}
block|,
...
block|{
literal|"SSL_OP_CIPHER_SERVER_PREFERENCE"
block|,
name|SSL_OP_CIPHER_SERVER_PREFERENCE
block|}
block|,
...
block|{
literal|"SSL_OP_TLS_ROLLBACK_BUG"
block|,
name|SSL_OP_TLS_ROLLBACK_BUG
block|}
block|,
...
block|{
literal|"SSL_OP_NETSCAPE_CA_DN_BUG"
block|,
name|SSL_OP_NETSCAPE_CA_DN_BUG
block|}
block|,
...
name|SM_TIME_DEFAULT
argument_list|,
literal|"WARNING: RunAsUser for MSP ignored, check group ids (egid=%ld, want=%ld)\n"
argument_list|,
operator|(
name|long
operator|)
...
argument_list|)
expr_stmt|;
comment|/* not a complete "syntax" check but good enough */
if|if
condition|(
name|end
operator|==
...
name|syserr
argument_list|(
literal|"readcf: %s option value %s not a number"
argument_list|,
name|o
operator|->
name|o_name
...
name|syserr
argument_list|(
literal|"readcf: %s option value %s unrecognized"
argument_list|,
name|o
operator|->
name|o_name
