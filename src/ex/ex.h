...
begin_comment
comment|/*  * LISP is defined for makeoptions;  ex_vars.h will redefine it  */
end_comment
...
begin_comment
comment|/* We are child, go away on error */
end_comment
...
begin_comment
comment|/* Command line option - was give, hush up! */
end_comment
...
begin_comment
comment|/* In tag file... force nomagic re's */
end_comment
