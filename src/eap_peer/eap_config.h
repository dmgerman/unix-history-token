...
begin_comment
comment|/**  * struct eap_peer_config - EAP peer configuration/credentials  */
end_comment
...
block|{
comment|/** 	 * identity - EAP Identity 	 * 	 * This field is used to set the real user identity or NAI (for 	 * EAP-PSK/PAX/SAKE/GPSK). 	 */
name|u8
modifier|*
name|identity
decl_stmt|;
...
decl_stmt|;
comment|/** 	 * password - Password string for EAP 	 * 	 * This field can include either the plaintext password (default 	 * option) or a NtPasswordHash (16-byte MD4 hash of the unicode 	 * presentation of the password) if flags field has 	 * EAP_CONFIG_FLAGS_PASSWORD_NTHASH bit set to 1. NtPasswordHash can 	 * only be used with authentication mechanism that use this hash as the 	 * starting point for operation: MSCHAP and MSCHAPv2 (EAP-MSCHAPv2, 	 * EAP-TTLS/MSCHAPv2, EAP-TTLS/MSCHAP, LEAP). 	 * 	 * In addition, this field is used to configure a pre-shared key for 	 * EAP-PSK/PAX/SAKE/GPSK. The length of the PSK must be 16 for EAP-PSK 	 * and EAP-PAX and 32 for EAP-SAKE. EAP-GPSK can use a variable length 	 * PSK. 	 */
name|u8
modifier|*
name|password
decl_stmt|;
...
name|ca_path
decl_stmt|;
comment|/** 	 * client_cert - File path to client certificate file (PEM/DER) 	 * 	 * This field is used with EAP method that use TLS authentication. 	 * Usually, this is only configured for EAP-TLS, even though this could 	 * in theory be used with EAP-TTLS and EAP-PEAP, too. Full path to the 	 * file should be used since working directory may change when 	 * wpa_supplicant is run in the background. 	 * 	 * Alternatively, a named configuration blob can be used by setting 	 * this to blob://blob_name. 	 */
name|u8
modifier|*
name|client_cert
decl_stmt|;
...
decl_stmt|;
comment|/** 	 * dh_file - File path to DH/DSA parameters file (in PEM format) 	 * 	 * This is an optional configuration file for setting parameters for an 	 * ephemeral DH key exchange. In most cases, the default RSA 	 * authentication does not use this configuration. However, it is 	 * possible setup RSA to use ephemeral DH key exchange. In addition, 	 * ciphers with DSA keys always use ephemeral DH keys. This can be used 	 * to achieve forward secrecy. If the file is in DSA parameters format, 	 * it will be automatically converted into DH params. Full path to the 	 * file should be used since working directory may change when 	 * wpa_supplicant is run in the background. 	 * 	 * Alternatively, a named configuration blob can be used by setting 	 * this to blob://blob_name. 	 */
name|u8
modifier|*
name|dh_file
decl_stmt|;
...
name|engine_id
decl_stmt|;
comment|/** 	 * engine2 - Enable OpenSSL engine (e.g., for smartcard) (Phase 2) 	 * 	 * This is used if private key operations for EAP-TLS are performed 	 * using a smartcard. 	 * 	 * This field is like engine, but used for phase 2 (inside 	 * EAP-TTLS/PEAP/FAST tunnel) authentication. 	 */
name|int
name|engine2
decl_stmt|;
comment|/** 	 * pin2 - PIN for USIM, GSM SIM, and smartcards (Phase 2) 	 * 	 * This field is used to configure PIN for SIM and smartcards for 	 * EAP-SIM and EAP-AKA. In addition, this is used with EAP-TLS if a 	 * smartcard is used for private key operations. 	 * 	 * This field is like pin2, but used for phase 2 (inside 	 * EAP-TTLS/PEAP/FAST tunnel) authentication. 	 * 	 * If left out, this will be asked through control interface. 	 */
name|char
modifier|*
name|pin2
decl_stmt|;
comment|/** 	 * engine2_id - Engine ID for OpenSSL engine (Phase 2) 	 * 	 * "opensc" to select OpenSC engine or "pkcs11" to select PKCS#11 	 * engine. 	 * 	 * This is used if private key operations for EAP-TLS are performed 	 * using a smartcard. 	 * 	 * This field is like engine_id, but used for phase 2 (inside 	 * EAP-TTLS/PEAP/FAST tunnel) authentication. 	 */
name|char
modifier|*
name|engine2_id
decl_stmt|;
...
name|key_id
decl_stmt|;
comment|/** 	 * cert_id - Cert ID for OpenSSL engine 	 * 	 * This is used if the certificate operations for EAP-TLS are performed 	 * using a smartcard. 	 */
name|char
modifier|*
name|cert_id
decl_stmt|;
comment|/** 	 * ca_cert_id - CA Cert ID for OpenSSL engine 	 * 	 * This is used if the CA certificate for EAP-TLS is on a smartcard. 	 */
name|char
modifier|*
name|ca_cert_id
decl_stmt|;
comment|/** 	 * key2_id - Key ID for OpenSSL engine (phase2) 	 * 	 * This is used if private key operations for EAP-TLS are performed 	 * using a smartcard. 	 */
name|char
modifier|*
name|key2_id
decl_stmt|;
comment|/** 	 * cert2_id - Cert ID for OpenSSL engine (phase2) 	 * 	 * This is used if the certificate operations for EAP-TLS are performed 	 * using a smartcard. 	 */
name|char
modifier|*
name|cert2_id
decl_stmt|;
comment|/** 	 * ca_cert2_id - CA Cert ID for OpenSSL engine (phase2) 	 * 	 * This is used if the CA certificate for EAP-TLS is on a smartcard. 	 */
name|char
modifier|*
name|ca_cert2_id
decl_stmt|;
