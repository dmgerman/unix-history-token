...
name|MSG_DEBUG
argument_list|,
literal|"EAP-AKA: Use external USIM processing"
argument_list|)
expr_stmt|;
name|pos
operator|=
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-AKA: Use result from external USIM processing"
argument_list|)
expr_stmt|;
name|resp
operator|=
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-AKA: Unrecognized external USIM processing response"
argument_list|)
expr_stmt|;
name|os_free
argument_list|(
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-AKA: Invalid external USIM processing UMTS-AUTH response"
argument_list|)
expr_stmt|;
name|os_free
argument_list|(
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-AKA: No UMTS authentication algorithm "
literal|"enabled"
argument_list|)
expr_stmt|;
return|return
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-AKA: Wait for external USIM processing"
argument_list|)
expr_stmt|;
return|return
name|NULL
