...
begin_comment
comment|/*  * wpa_supplicant - WPA/RSN IE and KDE processing  * Copyright (c) 2003-2015, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
begin_comment
comment|/**  * wpa_parse_vendor_specific - Parse Vendor Specific IEs  * @pos: Pointer to the IE header  * @end: Pointer to the end of the Key Data buffer  * @ie: Pointer to parsed IE data  * Returns: 0 on success, 1 if end mark is found, -1 on failure  */
end_comment

begin_function
specifier|static
name|int
name|wpa_parse_vendor_specific
parameter_list|(
specifier|const
name|u8
modifier|*
...
name|MSG_MSGDUMP
argument_list|,
literal|"Too short vendor specific IE ignored (len=%u)"
argument_list|,
name|pos
index|[
literal|1
...
name|MSG_DEBUG
argument_list|,
literal|"WPA: WMM Parameter Element"
argument_list|,
name|ie
operator|->
name|wmm
...
name|MSG_DEBUG
argument_list|,
literal|"WPA: IP Address Request in EAPOL-Key"
argument_list|,
name|ie
operator|->
name|ip_addr_req
...
name|MSG_DEBUG
argument_list|,
literal|"WPA: IP Address Allocation in EAPOL-Key"
argument_list|,
name|ie
operator|->
name|ip_addr_alloc
...
condition|)
block|{
comment|/* 			 * The value of the Length field of the Supported 			 * Operating Classes element is between 2 and 253. 			 * Silently skip invalid elements to avoid interop 			 * issues when trying to use the value. 			 */
if|if
condition|(
name|pos
index|[
