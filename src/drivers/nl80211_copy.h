...
define|#
directive|define
name|NL80211_MULTICAST_GROUP_TESTMODE
value|"testmode"
end_define
...
block|,
name|NL80211_CMD_WIPHY_REG_CHANGE
block|,
...
block|,
name|NL80211_ATTR_WIPHY_SELF_MANAGED_REG
block|,
name|NL80211_ATTR_EXT_FEATURES
block|,
name|NL80211_ATTR_SURVEY_RADIO_STATS
block|,
name|NL80211_ATTR_NETNS_FD
block|,
name|NL80211_ATTR_SCHED_SCAN_DELAY
block|,
name|NL80211_ATTR_REG_INDOOR
block|,
...
block|,
name|NL80211_RATE_INFO_10_MHZ_WIDTH
block|,
name|NL80211_RATE_INFO_5_MHZ_WIDTH
block|,
comment|/* keep last */
...
block|,
name|NL80211_STA_INFO_RX_DROP_MISC
block|,
name|NL80211_STA_INFO_BEACON_RX
block|,
name|NL80211_STA_INFO_BEACON_SIGNAL_AVG
block|,
name|NL80211_STA_INFO_TID_STATS
block|,
comment|/* keep last */
...
begin_comment
comment|/**  * enum nl80211_tid_stats - per TID statistics attributes  * @__NL80211_TID_STATS_INVALID: attribute number 0 is reserved  * @NL80211_TID_STATS_RX_MSDU: number of MSDUs received (u64)  * @NL80211_TID_STATS_TX_MSDU: number of MSDUs transmitted (or  *	attempted to transmit; u64)  * @NL80211_TID_STATS_TX_MSDU_RETRIES: number of retries for  *	transmitted MSDUs (not counting the first attempt; u64)  * @NL80211_TID_STATS_TX_MSDU_FAILED: number of failed transmitted  *	MSDUs (u64)  * @NUM_NL80211_TID_STATS: number of attributes here  * @NL80211_TID_STATS_MAX: highest numbered attribute here  */
end_comment

begin_enum
enum|enum
name|nl80211_tid_stats
block|{
name|__NL80211_TID_STATS_INVALID
block|,
name|NL80211_TID_STATS_RX_MSDU
block|,
name|NL80211_TID_STATS_TX_MSDU
block|,
name|NL80211_TID_STATS_TX_MSDU_RETRIES
block|,
name|NL80211_TID_STATS_TX_MSDU_FAILED
block|,
comment|/* keep last */
name|NUM_NL80211_TID_STATS
block|,
name|NL80211_TID_STATS_MAX
init|=
name|NUM_NL80211_TID_STATS
operator|-
literal|1
...
block|,
name|NL80211_SURVEY_INFO_TIME
block|,
name|NL80211_SURVEY_INFO_TIME_BUSY
block|,
name|NL80211_SURVEY_INFO_TIME_EXT_BUSY
block|,
name|NL80211_SURVEY_INFO_TIME_RX
block|,
name|NL80211_SURVEY_INFO_TIME_TX
block|,
name|NL80211_SURVEY_INFO_TIME_SCAN
block|,
comment|/* keep last */
...
begin_comment
comment|/* keep old names for compatibility */
end_comment
...
value|NL80211_SURVEY_INFO_TIME
end_define
...
value|NL80211_SURVEY_INFO_TIME_BUSY
end_define
...
value|NL80211_SURVEY_INFO_TIME_EXT_BUSY
end_define
...
value|NL80211_SURVEY_INFO_TIME_RX
end_define
...
value|NL80211_SURVEY_INFO_TIME_TX
end_define
...
begin_comment
comment|/**  * enum nl80211_bss_status - BSS "status"  * @NL80211_BSS_STATUS_AUTHENTICATED: Authenticated with this BSS.  *	Note that this is no longer used since cfg80211 no longer  *	keeps track of whether or not authentication was done with  *	a given BSS.  * @NL80211_BSS_STATUS_ASSOCIATED: Associated with this BSS.  * @NL80211_BSS_STATUS_IBSS_JOINED: Joined to this IBSS.  *  * The BSS status is a BSS attribute in scan dumps, which  * indicates the status the interface has wrt. this BSS.  */
end_comment
...
begin_comment
comment|/**  * enum nl80211_ext_feature_index - bit index of extended features.  * @NL80211_EXT_FEATURE_VHT_IBSS: This driver supports IBSS with VHT datarates.  *  * @NUM_NL80211_EXT_FEATURES: number of extended features.  * @MAX_NL80211_EXT_FEATURES: highest extended feature index.  */
end_comment
...
block|,
comment|/* add new features before the definition below */
name|NUM_NL80211_EXT_FEATURES
block|,
name|MAX_NL80211_EXT_FEATURES
init|=
name|NUM_NL80211_EXT_FEATURES
operator|-
literal|1
