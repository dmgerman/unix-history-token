...
argument_list|)
expr_stmt|;
comment|/* linux_set_iface_flags(drv->ioctl_sock, drv->ifname, 0); */
block|}
...
directive|if
literal|0
block|if (ssid_len> IW_ESSID_MAX_SIZE) { 		wpa_printf(MSG_DEBUG, "%s: too long SSID (%lu)", 			   __FUNCTION__, (unsigned long) ssid_len); 		return -1; 	}
...
argument_list|,
literal|"RALINK: Failed to set "
literal|"RT_OID_WPS_PROBE_REQ_IE"
argument_list|)
expr_stmt|;
block|}
name|os_memset
...
specifier|static
name|int
name|wpa_driver_ralink_set_gen_ie
parameter_list|(
name|void
modifier|*
name|priv
...
name|MSG_DEBUG
argument_list|,
literal|"wpa_driver_ralink_set_gen_ie: "
argument_list|,
operator|(
name|u8
operator|*
...
name|MSG_DEBUG
argument_list|,
literal|"ERROR: Failed to set "
literal|"OID_802_11_SET_IEEE8021X_REQUIRE_KEY(%d)"
argument_list|,
operator|(
name|int
operator|)
...
name|MSG_DEBUG
argument_list|,
literal|"ieee8021x_required_key is %s"
argument_list|,
name|ieee8021x_required_key
condition|?
literal|"TRUE"
