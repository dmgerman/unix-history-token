...
name|MSG_DEBUG
argument_list|,
literal|"nl80211: Interface %s is in master %s"
argument_list|,
name|params
operator|->
name|ifname
...
argument_list|)
expr_stmt|;
comment|/* start listening for EAPOL on the master interface */
name|add_ifidx
argument_list|(
name|drv
argument_list|,
...
condition|)
block|{
comment|/* Enforce unique address */
name|u8
name|new_addr
index|[
name|ETH_ALEN
...
literal|"for interface %s type %d"
argument_list|,
name|ifname
argument_list|,
name|type
...
literal|"capa.conc_capab=%u\n"
literal|"capa.max_conc_chan_2_4=%u\n"
literal|"capa.max_conc_chan_5_0=%u\n"
argument_list|,
name|drv
operator|->
name|capa
...
argument_list|)
argument_list|,
literal|"/sys/devices/virtual/net/%s/bridge/multicast_snooping"
argument_list|,
name|bss
operator|->
name|brname
...
name|MSG_DEBUG
argument_list|,
literal|"nl80211: ACS Params: HW_MODE: %d HT: %d HT40: %d VHT: %d BW: %d CH_LIST_LEN: %u"
argument_list|,
name|params
operator|->
name|hw_mode
...
name|MSG_DEBUG
argument_list|,
literal|"nl80211: Driver setband function failed: %s"
argument_list|,
name|strerror
argument_list|(
name|errno
...
specifier|static
name|int
name|preferred_freq_info_handler
parameter_list|(
name|struct
name|nl_msg
modifier|*
...
name|MSG_ERROR
argument_list|,
literal|"nl80211: iface_type couldn't be found"
argument_list|)
expr_stmt|;
name|param
operator|->
...
name|MSG_DEBUG
argument_list|,
literal|"nl80211: Driver returned iface_type=%d"
argument_list|,
name|iface_type
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"nl80211: preferred_freq_list couldn't be found"
argument_list|)
expr_stmt|;
name|param
operator|->
...
return|;
block|}
comment|/* 	 * param->num has the maximum number of entries for which there 	 * is room in the freq_list provided by the caller. 	 */
name|freqs
operator|=
name|nla_data
argument_list|(
...
specifier|static
name|int
name|nl80211_get_pref_freq_list
parameter_list|(
name|void
modifier|*
name|priv
...
name|MSG_ERROR
argument_list|,
literal|"%s: err in adding vendor_cmd and vendor_data"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|MSG_ERROR
argument_list|,
literal|"%s: err in send_and_recv_msgs"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"nl80211: preferred_channel_list[%d]=%d"
argument_list|,
name|i
argument_list|,
name|freq_list
...
specifier|static
name|int
name|nl80211_set_prob_oper_freq
parameter_list|(
name|void
modifier|*
name|priv
...
name|MSG_DEBUG
argument_list|,
literal|"nl80211: Set P2P probable operating freq %u for ifindex %d"
argument_list|,
name|freq
argument_list|,
name|bss
