...
begin_comment
comment|/*  * Driver interaction with Linux Host AP driver  * Copyright (c) 2002-2006, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
