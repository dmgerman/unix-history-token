...
condition|)
block|{
comment|/* 0.9.2342.19200300.100.1.25 - domainComponent */
name|type
operator|=
...
name|MSG_INFO
argument_list|,
literal|"X509: Too many Name attributes"
argument_list|)
expr_stmt|;
name|x509_free_name
argument_list|(
...
name|MSG_INFO
argument_list|,
literal|"X509: Reject certificate with "
literal|"embedded NUL byte in a string (%s[NUL])"
argument_list|,
name|val
argument_list|)
expr_stmt|;
...
specifier|static
name|int
name|x509_parse_alt_name_rfc8222
parameter_list|(
name|struct
name|x509_name
modifier|*
...
parameter_list|)
block|{
comment|/* rfc822Name IA5String */
name|wpa_hexdump_ascii
argument_list|(
name|MSG_MSGDUMP
argument_list|,
literal|"X509: altName - rfc822Name"
argument_list|,
name|pos
argument_list|,
name|len
...
argument_list|,
literal|"X509: Reject certificate with "
literal|"embedded NUL byte in rfc822Name (%s[NUL])"
argument_list|,
name|name
operator|->
name|alt_email
...
parameter_list|)
block|{
comment|/* dNSName IA5String */
name|wpa_hexdump_ascii
argument_list|(
name|MSG_MSGDUMP
argument_list|,
literal|"X509: altName - dNSName"
argument_list|,
name|pos
argument_list|,
name|len
...
argument_list|,
literal|"X509: Reject certificate with "
literal|"embedded NUL byte in dNSName (%s[NUL])"
argument_list|,
name|name
operator|->
name|dns
...
parameter_list|)
block|{
comment|/* uniformResourceIdentifier IA5String */
name|wpa_hexdump_ascii
argument_list|(
name|MSG_MSGDUMP
argument_list|,
literal|"X509: altName - uniformResourceIdentifier"
argument_list|,
name|pos
argument_list|,
name|len
...
argument_list|,
literal|"X509: Reject certificate with "
literal|"embedded NUL byte in uniformResourceIdentifier "
literal|"(%s[NUL])"
argument_list|,
name|name
operator|->
...
parameter_list|)
block|{
comment|/* iPAddress OCTET STRING */
name|wpa_hexdump
argument_list|(
name|MSG_MSGDUMP
argument_list|,
literal|"X509: altName - iPAddress"
argument_list|,
name|pos
argument_list|,
name|len
...
index|]
decl_stmt|;
comment|/* registeredID OBJECT IDENTIFIER */
if|if
condition|(
name|asn1_parse_oid
argument_list|(
...
name|MSG_MSGDUMP
argument_list|,
literal|"X509: altName - registeredID: %s"
argument_list|,
name|buf
argument_list|)
expr_stmt|;
...
literal|0
case|:
comment|/* TODO: otherName */
case|case
literal|3
case|:
comment|/* TODO: x500Address */
case|case
literal|4
case|:
comment|/* TODO: directoryName */
case|case
literal|5
case|:
comment|/* TODO: ediPartyName */
default|default:
name|res
operator|=
literal|0
...
specifier|static
name|int
name|x509_parse_ext_subject_alt_name
parameter_list|(
name|struct
name|x509_certificate
modifier|*
...
name|hdr
decl_stmt|;
comment|/* SubjectAltName ::= GeneralNames */
if|if
condition|(
name|asn1_get_next
argument_list|(
...
argument_list|,
literal|"X509: Expected SEQUENCE in "
literal|"SubjectAltName; found %d tag 0x%x"
argument_list|,
name|hdr
operator|.
name|class
...
specifier|static
name|int
name|x509_parse_ext_issuer_alt_name
parameter_list|(
name|struct
name|x509_certificate
modifier|*
...
name|hdr
decl_stmt|;
comment|/* IssuerAltName ::= GeneralNames */
if|if
condition|(
name|asn1_get_next
argument_list|(
...
argument_list|,
literal|"X509: Expected SEQUENCE in "
literal|"IssuerAltName; found %d tag 0x%x"
argument_list|,
name|hdr
operator|.
name|class
...
literal|1
return|;
comment|/* TODO: add other extensions required by RFC 3280, Ch 4.2: 	 * certificate policies (section 4.2.1.5) 	 * name constraints (section 4.2.1.11) 	 * policy constraints (section 4.2.1.12) 	 * extended key usage (section 4.2.1.13) 	 * inhibit any-policy (section 4.2.1.15) 	 */
switch|switch
condition|(
name|oid
operator|->
...
operator|!=
literal|11
comment|/* sha2561WithRSAEncryption */
condition|)
block|{
name|wpa_printf
argument_list|(
name|MSG_DEBUG
argument_list|,
literal|"X509: digestAlgorithm SHA256 "
literal|"does not match with certificate "
literal|"signatureAlgorithm (%lu)"
argument_list|,
name|cert
...
name|MSG_MSGDUMP
argument_list|,
literal|"X509: Certificate hash (SHA256)"
argument_list|,
name|hash
argument_list|,
name|hash_len
...
name|MSG_INFO
argument_list|,
literal|"X509: Extra data after certificate signature hash"
argument_list|,
name|hdr
operator|.
name|payload
