...
argument_list|)
expr_stmt|;
comment|/* M_i = MAC_Y (i || Z); (MAC = AES-CMAC-128) */
name|addr
index|[
literal|0
index|]
...
name|SHA256_MAC_LEN
expr_stmt|;
comment|/* M_i = MAC_Y (i || Z); (MAC = HMAC-SHA256) */
name|addr
index|[
literal|0
index|]
...
specifier|static
name|int
name|eap_gpsk_derive_keys_helper
parameter_list|(
name|u32
name|csuite_specifier
parameter_list|,
name|u8
modifier|*
name|kdf_out
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-GPSK: Data to MK derivation"
argument_list|,
name|data
argument_list|,
name|data_len
...
index|]
decl_stmt|;
comment|/* 	 * inputString = RAND_Peer || ID_Peer || RAND_Server || ID_Server 	 *            (= seed) 	 * KS = 16, PL = psk_len, CSuite_Sel = 0x00000000 0x0001 	 * MK = GKDF-16 (PSK[0..15], PL || PSK || CSuite_Sel || inputString) 	 * MSK = GKDF-160 (MK, inputString)[0..63] 	 * EMSK = GKDF-160 (MK, inputString)[64..127] 	 * SK = GKDF-160 (MK, inputString)[128..143] 	 * PK = GKDF-160 (MK, inputString)[144..159] 	 * zero = 0x00 || 0x00 || ... || 0x00 (16 times) 	 * Method-ID = GKDF-16 (zero, "Method ID" || EAP_Method_Type || 	 *                      CSuite_Sel || inputString) 	 */
operator|*
name|sk_len
operator|=
name|EAP_GPSK_SK_LEN_AES
...
index|]
decl_stmt|;
comment|/* 	 * inputString = RAND_Peer || ID_Peer || RAND_Server || ID_Server 	 *            (= seed) 	 * KS = 32, PL = psk_len, CSuite_Sel = 0x00000000 0x0002 	 * MK = GKDF-32 (PSK[0..31], PL || PSK || CSuite_Sel || inputString) 	 * MSK = GKDF-160 (MK, inputString)[0..63] 	 * EMSK = GKDF-160 (MK, inputString)[64..127] 	 * SK = GKDF-160 (MK, inputString)[128..159] 	 * zero = 0x00 || 0x00 || ... || 0x00 (32 times) 	 * Method-ID = GKDF-16 (zero, "Method ID" || EAP_Method_Type || 	 *                      CSuite_Sel || inputString) 	 */
operator|*
name|sk_len
operator|=
name|EAP_GPSK_SK_LEN_SHA256
...
begin_comment
comment|/**  * eap_gpsk_derive_keys - Derive EAP-GPSK keys  * @psk: Pre-shared key  * @psk_len: Length of psk in bytes  * @vendor: CSuite/Vendor  * @specifier: CSuite/Specifier  * @rand_peer: 32-byte RAND_Peer  * @rand_server: 32-byte RAND_Server  * @id_peer: ID_Peer  * @id_peer_len: Length of ID_Peer  * @id_server: ID_Server  * @id_server_len: Length of ID_Server  * @msk: Buffer for 64-byte MSK  * @emsk: Buffer for 64-byte EMSK  * @sk: Buffer for SK (at least EAP_GPSK_MAX_SK_LEN bytes)  * @sk_len: Buffer for returning length of SK  * @pk: Buffer for PK (at least EAP_GPSK_MAX_PK_LEN bytes)  * @pk_len: Buffer for returning length of PK  * Returns: 0 on success, -1 on failure  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* Seed = RAND_Peer || ID_Peer || RAND_Server || ID_Server */
name|seed_len
operator|=
literal|2
operator|*
