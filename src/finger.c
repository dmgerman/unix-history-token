...
begin_comment
comment|/* This is<lastlog.h> which login must maintain!  * It should be a file /usr/adm/lastlog of such structures indexed by uid struct lastlog { 	time_t	ll_time; 	char	ll_line[8]; };  */
end_comment
