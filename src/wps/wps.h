...
begin_comment
comment|/*  * Wi-Fi Protected Setup  * Copyright (c) 2007-2013, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
name|pbc_in_m1
decl_stmt|;
comment|/** 	 * peer_pubkey_hash - Peer public key hash or %NULL if not known 	 */
specifier|const
name|u8
modifier|*
...
name|dualband
decl_stmt|;
comment|/** 	 * force_per_enrollee_psk - Force per-Enrollee random PSK 	 * 	 * This forces per-Enrollee random PSK to be generated even if a default 	 * PSK is set for a network. 	 */
name|int
...
block|,
comment|/** 	 * WPS_EV_PBC_ACTIVE - PBC mode was activated 	 */
name|WPS_EV_PBC_ACTIVE
block|,
comment|/** 	 * WPS_EV_PBC_DISABLE - PBC mode was disabled 	 */
...
name|auth_types
decl_stmt|;
comment|/** 	 * encr_types - Current AP encryption type (WPS_ENCR_*) 	 */
name|u16
name|ap_encr_type
decl_stmt|;
comment|/** 	 * ap_auth_type - Current AP authentication types (WPS_AUTH_*) 	 */
name|u16
name|ap_auth_type
decl_stmt|;
...
parameter_list|)
function_decl|;
comment|/** 	 * rf_band_cb - Fetch currently used RF band 	 * @ctx: Higher layer context data (cb_ctx) 	 * Return: Current used RF band or 0 if not known 	 */
name|int
function_decl|(
modifier|*
name|rf_band_cb
