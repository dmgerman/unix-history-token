...
name|MSG_DEBUG
argument_list|,
literal|"WPS: wps->wps->dh_pubkey == NULL"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: wps->wps->ap_nfc_dh_privkey == NULL"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: wps->wps->ap_nfc_dh_pubkey == NULL"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|WPS_AUTH_TYPES
decl_stmt|;
comment|/* WPA/WPA2-Enterprise enrollment not supported through WPS */
name|auth_types
operator|&=
operator|~
name|WPS_AUTH_WPA
...
name|MSG_DEBUG
argument_list|,
literal|"WPS:  * OOB Device Password (dev_pw_id=%u)"
argument_list|,
name|dev_pw_id
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"WPS: Real Public Key Hash"
argument_list|,
name|pubkey_hash
argument_list|,
...
name|MSG_INFO
argument_list|,
literal|"WPS: Testing - corrupt public key hash"
argument_list|)
expr_stmt|;
name|pubkey_hash
index|[
