...
begin_comment
comment|/* This is part of the iostream library.  Written by Per Bothner. */
end_comment
...
begin_comment
comment|/* Magic numbers and bits for the _flags field.    The magic numbers use the high-order bits of _flags;    the remaining bits are abailable for variable flags.    Note: The magic numbers must all be negative if stdio    emulation is desired. */
end_comment
