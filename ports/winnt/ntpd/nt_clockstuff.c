...
directive|define
name|LS_CORR_INTV
value|( (LONGLONG) HECTONANOSECONDS * LS_CORR_INTV_SECS )
end_define
...
directive|define
name|LS_CORR_LIMIT
value|( (LONGLONG) HECTONANOSECONDS / 2 )
end_define
...
condition|)
block|{
comment|/* A leap second insert is scheduled at the end                                  * of the day. Since we have not yet computed the                                  * time stamp, do it now. Signal electric mode                                  * for this insert.                                  */
name|ls_ft
operator|.
name|ull
operator|=
...
block|}
block|}
comment|/* 	 * If the time stamp for the next leap second has been set 	 * then check if the leap second must be handled 	 */
if|if
condition|(
name|ls_ft
operator|.
