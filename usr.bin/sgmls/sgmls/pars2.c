...
index|]
decl_stmt|;
comment|/* Saved lexlms value of delimiter. */
name|int
name|essv
init|=
name|es
...
name|litc
expr_stmt|;
comment|/* Set delimiter to act as literal close. */
do|do
block|{
switch|switch
condition|(
...
begin_comment
comment|/* Handle a data entity in a tokenized attribute value literal. Parmlen is amount of space left.  Return new parmlen. If there's not enough space return -1, and copy up to parmlen + 1 characters. */
end_comment
