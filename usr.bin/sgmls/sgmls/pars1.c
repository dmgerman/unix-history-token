...
directive|if
literal|0
comment|/* This will have been detected by exclude.c. */
block|sgmlerr(E_MEXERR,&pcbstag, NEWGI, tags[mexts].tetd->etdgi+1);
endif|#
directive|endif
case|case
name|RCHIT
...
directive|if
literal|0
comment|/* This will have been detected in exclude.c. */
block|if ((mexts = pexmex(nextetd))>0) 		    sgmlerr(E_MEXERR,&pcbstag, nextetd->etdgi+1, 			    tags[mexts].tetd->etdgi+1);
endif|#
directive|endif
if|if
condition|(
...
condition|)
block|{
comment|/* Map hasn't been defined.  Ignore it. */
name|sgmlerr
argument_list|(
literal|159
argument_list|,
