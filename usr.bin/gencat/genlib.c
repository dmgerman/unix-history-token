...
begin_comment
comment|/* Edit History  02/25/91   5 nazgul	Added flag for MS byteorder 01/14/91   4 nazgul	Off by one on number specified entries */
end_comment
...
name|cptr
argument_list|,
literal|"unexpected quote character, ignoreing"
argument_list|)
expr_stmt|;
operator|*
name|tptr
