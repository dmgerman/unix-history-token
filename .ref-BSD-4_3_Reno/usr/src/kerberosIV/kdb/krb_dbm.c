...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/kdb/RCS/krb_dbm.c,v $  * $Author: kfall $   *  * Copyright 1988 by the Massachusetts Institute of Technology.   *  * For copying and distribution information, please see the file  *<mit-copyright.h>.   */
end_comment
...
index|[]
init|=
literal|"$Header: /usr/src/kerberosIV/kdb/RCS/krb_dbm.c,v 4.10 90/06/25 20:52:39 kfall Exp $"
decl_stmt|;
end_decl_stmt
