...
begin_comment
comment|/*  * $Source: /afs/athena.mit.edu/astaff/project/kerberos/src/lib/kdb/RCS/krb_lib.c,v $  * $Author: jtkohl $   *  * Copyright 1988 by the Massachusetts Institute of Technology.   *  * For copying and distribution information, please see the file  *<mit-copyright.h>.   */
end_comment
...
index|[]
init|=
literal|"$Id: krb_lib.c,v 4.7 89/12/14 16:05:00 jtkohl Exp $"
decl_stmt|;
end_decl_stmt
