...
begin_comment
comment|/*   * $Source: /mit/kerberos/src/lib/krb/RCS/create_ticket.c,v $  * $Author: jtkohl $  *  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
specifier|static
name|char
name|rcsid_create_ticket_c
index|[]
init|=
literal|"$Header: create_ticket.c,v 4.11 89/03/22 14:43:23 jtkohl Exp $"
decl_stmt|;
end_decl_stmt
...
directive|ifndef
name|NOENCRYPTION
comment|/* Encrypt the ticket in the services key */
name|key_sched
argument_list|(
name|key
argument_list|,
