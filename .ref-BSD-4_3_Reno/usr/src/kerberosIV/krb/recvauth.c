...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/src/lib/krb/RCS/recvauth.c,v $  * $Author: kfall $  *  * Copyright 1987, 1988 by the Massachusetts Institute of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
specifier|static
name|char
name|rcsid_recvauth_c
index|[]
init|=
literal|"$Header: /usr/src/kerberosIV/src/lib/krb/RCS/recvauth.c,v 4.4 90/05/12 00:58:56 kfall Exp $"
decl_stmt|;
end_decl_stmt
