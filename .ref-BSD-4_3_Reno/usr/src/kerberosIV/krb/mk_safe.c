...
begin_comment
comment|/*  * $Source: /mit/kerberos/src/lib/krb/RCS/mk_safe.c,v $  * $Author: jtkohl $  *  * Copyright 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  *  * This routine constructs a Kerberos 'safe msg', i.e. authenticated  * using a private session key to seed a checksum. Msg is NOT  * encrypted.  *  *      Note-- bcopy is used to avoid alignment problems on IBM RT  *  *      Returns either<0 ===> error, or resulting size of message  *  * Steve Miller    Project Athena  MIT/DEC  */
end_comment
...
name|char
modifier|*
name|rcsid_mk_safe_c
init|=
literal|"$Header: mk_safe.c,v 4.12 89/03/22 14:50:49 jtkohl Exp $"
decl_stmt|;
end_decl_stmt
...
comment|/* calculate the checksum of length, timestamps, and input data */
name|cksum
operator|=
name|quad_cksum
argument_list|(
