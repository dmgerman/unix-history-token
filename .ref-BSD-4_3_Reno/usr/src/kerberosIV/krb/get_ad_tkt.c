...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/get_ad_tkt.c,v $  * $Author: kfall $  *  * Copyright 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
name|char
modifier|*
name|rcsid_get_ad_tkt_c
init|=
literal|"$Header: /usr/src/kerberosIV/krb/RCS/get_ad_tkt.c,v 4.16 90/06/25 20:55:44 kfall Exp $"
decl_stmt|;
end_decl_stmt
...
name|printf
argument_list|(
literal|"About to do decryption ..."
argument_list|)
expr_stmt|;
name|pcbc_encrypt
argument_list|(
