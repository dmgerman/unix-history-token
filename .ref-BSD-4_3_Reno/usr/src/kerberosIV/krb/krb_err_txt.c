...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/krb_err_txt.c,v $  * $Author: kfall $  *  * Copyright 1988 by the Massachusetts Institute of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
index|[]
init|=
literal|"$Header: /usr/src/kerberosIV/krb/RCS/krb_err_txt.c,v 4.8 90/06/23 01:51:45 kfall Exp $"
decl_stmt|;
end_decl_stmt
...
literal|"(reserved)"
block|,
literal|"Generic kerberos error"
block|,
comment|/* 255 */
block|}
decl_stmt|;
