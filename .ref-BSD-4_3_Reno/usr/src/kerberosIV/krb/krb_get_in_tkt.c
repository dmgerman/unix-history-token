...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/krb_get_in_tkt.c,v $  * $Author: kfall $  *  * Copyright 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
name|char
modifier|*
name|rcsid_krb_get_in_tkt_c
init|=
literal|"$Header: /usr/src/kerberosIV/krb/RCS/krb_get_in_tkt.c,v 4.20 90/06/25 20:56:45 kfall Exp $"
decl_stmt|;
end_decl_stmt
