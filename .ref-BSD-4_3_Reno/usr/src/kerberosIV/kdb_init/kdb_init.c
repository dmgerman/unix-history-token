...
begin_comment
comment|/*  * $Source: /mit/kerberos/src/admin/RCS/kdb_init.c,v $  * $Author: jtkohl $   *  * Copyright 1987, 1988 by the Massachusetts Institute of Technology.   *  * For copying and distribution information, please see the file  *<mit-copyright.h>.   *  * program to initialize the database,  reports error if database file  * already exists.   */
end_comment
...
index|[]
init|=
literal|"$Header: kdb_init.c,v 4.0 89/01/24 21:50:45 jtkohl Exp $"
decl_stmt|;
end_decl_stmt
