...
begin_comment
comment|/*  * Copyright (c) 1983, 1989 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  */
end_comment
...
index|[]
init|=
literal|"@(#)vmstat.c	5.12 (Berkeley) 6/24/90"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* uses 2 rows and 26 cols */
end_comment
