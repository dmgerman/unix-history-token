...
begin_comment
comment|/*  * Copyright (c) 1982, 1986, 1989 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	%W% (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/*  * Determine signal that should be delivered to process,  * 0 if none.  */
end_comment
