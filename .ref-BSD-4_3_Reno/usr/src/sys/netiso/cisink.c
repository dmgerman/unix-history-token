...
begin_comment
comment|/*  * Copyright (c) 1989, 1990 Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  */
end_comment
...
name|dbprintf
argument_list|(
literal|"recvmsg from pid %d got %d ctl %d flags %x\n"
argument_list|,
name|pid
argument_list|,
name|n
