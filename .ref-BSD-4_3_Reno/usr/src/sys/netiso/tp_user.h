...
begin_comment
comment|/*   * ARGO TP  *  * $Header: tp_user.h,v 5.2 88/11/04 15:44:44 nhall Exp $  * $Source: /usr/argo/sys/netiso/RCS/tp_user.h,v $  *	@(#)tp_user.h	7.8 (Berkeley) 6/28/90  *  * These are the values a real-live user ;-) needs.   */
end_comment
