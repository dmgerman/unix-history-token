...
argument_list|)
expr_stmt|;
comment|/*		if(d.dirInfo.ioFlAttrib& 0x10) strcat(buf,"/");*/
if|if
condition|(
name|qualify
operator|!=
...
directive|endif
comment|/*		if(mods& shiftKey) 			c  = sh_keycodes[(((event->message)&(keyCodeMask))>>8)]; 		else 			c  = nsh_keycodes[(((event->message)&(keyCodeMask))>>8)];*/
ifdef|#
directive|ifdef
name|O_META
if|if
