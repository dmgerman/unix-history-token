...
directive|define
name|TIMEID
value|"$Id: time.h,v 1.1 84/01/23 14:50:50 kcs Exp $"
end_define

begin_comment
comment|/* $Log:	time.h,v $  * Revision 1.1  84/01/23  14:50:50  kcs  * Initial revision  *   * Revision 1.1  82/05/06  11:34:29  wft  * Initial revision  *   */
end_comment
