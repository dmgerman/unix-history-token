...
name|f
argument_list|,
literal|"#define FDT_BEGIN_NODE 0x%x\n"
argument_list|,
name|FDT_BEGIN_NODE
argument_list|)
expr_stmt|;
...
name|f
argument_list|,
literal|"#define FDT_END_NODE 0x%x\n"
argument_list|,
name|FDT_END_NODE
argument_list|)
expr_stmt|;
...
name|f
argument_list|,
literal|"\t.long\t_%s_blob_abs_end - _%s_blob_start\t/* totalsize */\n"
argument_list|,
name|symprefix
argument_list|,
name|symprefix
...
name|f
argument_list|,
literal|"\t.long\t_%s_struct_start - _%s_blob_start\t/* off_dt_struct */\n"
argument_list|,
name|symprefix
argument_list|,
name|symprefix
...
name|f
argument_list|,
literal|"\t.long\t_%s_strings_start - _%s_blob_start\t/* off_dt_strings */\n"
argument_list|,
name|symprefix
argument_list|,
name|symprefix
...
name|f
argument_list|,
literal|"\t.long\t_%s_reserve_map - _%s_blob_start\t/* off_dt_strings */\n"
argument_list|,
name|symprefix
argument_list|,
name|symprefix
...
name|f
argument_list|,
literal|"\t.long\t%d\t\t\t\t\t/* last_comp_version */\n"
argument_list|,
name|vi
operator|->
name|last_comp_version
...
name|f
argument_list|,
literal|"\t.long\t%i\t\t\t\t\t/* boot_cpuid_phys */\n"
argument_list|,
name|bi
operator|->
name|boot_cpuid_phys
...
name|f
argument_list|,
literal|"\t.long\t_%s_strings_end - _%s_strings_start\t/* size_dt_strings */\n"
argument_list|,
name|symprefix
argument_list|,
name|symprefix
...
name|f
argument_list|,
literal|"\t.long\t_%s_struct_end - _%s_struct_start\t/* size_dt_struct */\n"
argument_list|,
name|symprefix
argument_list|,
name|symprefix
