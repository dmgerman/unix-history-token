...
begin_comment
comment|/*-  * Copyright (c) 1990 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * William Jolitz.  *  * %sccs.include.noredist.c%  *  *	@(#)tss.h	5.2 (Berkeley) %G%  */
end_comment
...
name|tss_cr3
decl_stmt|;
comment|/* page table directory physical address */
define|#
directive|define
name|tss_ptd
value|tss_cr3
