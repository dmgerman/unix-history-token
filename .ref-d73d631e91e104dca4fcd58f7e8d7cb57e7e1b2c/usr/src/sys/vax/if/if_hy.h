...
begin_comment
comment|/*  * Copyright (c) 1982, 1986 Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Tektronix Inc.  *  * %sccs.include.redist.c%  *  *	@(#)if_hy.h	7.4 (Berkeley) %G%  */
end_comment
