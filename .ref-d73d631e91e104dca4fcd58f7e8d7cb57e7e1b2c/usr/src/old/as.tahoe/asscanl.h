...
parameter_list|)
define|\
value|from = (char *)((int)(from + sizeof(lgtype)-1)&~(sizeof(lgtype)-1)); \ 	*(lgtype *)from = length; \ 	(bytetoktype *)from += sizeof(lgtype) + length
end_define
...
parameter_list|)
define|\
value|from = (char *)((int)(from + sizeof(lgtype)-1)&~(sizeof(lgtype)-1)); \ 	*(lgtype *)from = (bytetoktype *)to - (bytetoktype *)from - sizeof(lgtype); \ 	(bytetoktype *)from += sizeof (lgtype) + (bytetoktype *)to - (bytetoktype *)from
end_define
...
parameter_list|)
define|\
value|from = (char *)((int)(from + sizeof(lgtype)-1)&~(sizeof(lgtype)-1)); \ 	(bytetoktype *)from += sizeof(lgtype) + *(lgtype *)from
end_define
