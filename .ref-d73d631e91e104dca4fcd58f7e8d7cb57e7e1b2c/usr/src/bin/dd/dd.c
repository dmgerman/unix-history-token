...
name|perror
argument_list|(
literal|"dd: skip: tape forward-space-record"
argument_list|)
expr_stmt|;
block|}
break|break;
...
expr_stmt|;
block|}
comment|/* guess actual read size; default still -1 */
for|for
control|(
name|c
operator|=
...
name|stderr
argument_list|,
literal|"dd: unknown input type, can't resynchronize\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
