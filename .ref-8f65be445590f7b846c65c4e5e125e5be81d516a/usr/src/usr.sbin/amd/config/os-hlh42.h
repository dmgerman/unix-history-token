...
begin_comment
comment|/* $Id: os-hlh42.h,v 5.2.1.2 90/11/04 23:17:40 jsp Exp $ */
end_comment

begin_comment
comment|/*  * HLH OTS definitions for Amd (automounter)  *  * Copyright (c) 1989 Jan-Simon Pendry  * Copyright (c) 1989 Imperial College of Science, Technology& Medicine  * Copyright (c) 1989 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Jan-Simon Pendry at Imperial College, London.  *  * %sccs.include.redist.c%  *  *	@(#)os-hlh42.h	5.2 (Berkeley) %G%  */
end_comment
