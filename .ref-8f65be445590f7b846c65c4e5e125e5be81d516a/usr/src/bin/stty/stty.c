...
begin_comment
comment|/*-  * Copyright (c) 1980, 1989, 1991 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.proprietary.c%  */
end_comment
...
index|[]
init|=
literal|"@(#) Copyright (c) 1980, 1989, 1991 The Regents of the University of California.\n\  All rights reserved.\n"
decl_stmt|;
end_decl_stmt
...
index|[]
init|=
literal|"@(#)stty.c	5.20 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* print modes in form suitable to be re-input */
end_comment
...
name|c
parameter_list|)
value|while (*(s)&& *(s) != (c)) (s)++; if (*s) (s)++ ; \ 				else \ 					errexit("bad gfmt operand: %s", saves)
define|#
directive|define
name|chkeq
parameter_list|(
name|string
parameter_list|)
value|if (strncmp(s, (string), strlen(string))) \ 				errexit("bad gfmt operand: %s", saves)
if|if
condition|(
name|s
operator|==
...
name|printf
argument_list|(
literal|"-gfmt:iflag=%x:oflag=%x:cflag=%x:lflag=%x:cc"
argument_list|,
name|i
argument_list|,
name|o
