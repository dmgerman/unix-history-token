...
begin_comment
comment|/*  * Copyright (c) 1988 Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Arthur David Olson of the National Cancer Institute.  *  * %sccs.include.redist.c%  *  *	@(#)tzfile.h	5.10 (Berkeley) %G%  */
end_comment
