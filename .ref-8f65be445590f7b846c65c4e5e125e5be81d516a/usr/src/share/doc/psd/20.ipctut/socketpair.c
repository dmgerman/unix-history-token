...
operator|.
operator|\
literal|" Copyright (c) 1986 The Regents of the University of California. .\" All rights reserved. .\" .\" %sccs.include.redist.roff% .\" .\"	@(#)socketpair.c	6.4 (Berkeley) %G% .\" #include<sys/types.h> #include<sys/socket.h> #include<stdio.h>  #define DATA1 "
name|In
name|Xanadu
operator|,
name|did
