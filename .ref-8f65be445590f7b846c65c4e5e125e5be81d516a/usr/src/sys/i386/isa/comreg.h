...
begin_comment
comment|/*-  * Copyright (c) 1982, 1986, 1990, 1991 The Regents of the University of  * California. All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * the University of Utah and William Jolitz.  *  * %sccs.include.redist.c%  *  *	@(#)comreg.h	7.1 (Berkeley) %G%  */
end_comment
