...
begin_comment
comment|/*-  * Copyright (c) 1990 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Tim L. Tucker  *  * %sccs.include.noredist.c%  *  *	@(#)if_we.c	5.5 (Berkeley) %G%  */
end_comment
...
name|printf
argument_list|(
literal|"we%d: can't handle af%d\n"
argument_list|,
name|ifp
operator|->
name|if_unit
