...
name|u_pcb
decl_stmt|;
comment|/* pcb, save area when exchanging stacks */
name|label_t
name|u_rsav
decl_stmt|;
name|char
...
name|u_cnswap
decl_stmt|;
comment|/* no times children swapped */
name|int
name|u_cmajorflt
decl_stmt|;
comment|/* no major faults in child */
name|int
name|u_averss
decl_stmt|;
comment|/* time average of resident set size */
name|int
name|u_minorflt
decl_stmt|;
...
name|u_ustklim
decl_stmt|;
comment|/* max stack growth */
name|char
name|u_uwantcore
decl_stmt|;
comment|/* dump core even if large */
name|time_t
name|u_outime
decl_stmt|;
