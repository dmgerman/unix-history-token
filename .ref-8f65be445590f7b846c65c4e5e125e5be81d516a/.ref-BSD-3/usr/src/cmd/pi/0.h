...
begin_comment
comment|/*  * pi - Pascal interpreter code translator  *  * Charles Haley, Bill Joy  * University of California, Berkeley (UCB)  * Version 1.2 November 1978  */
end_comment
...
begin_comment
comment|/*  * TABLE_MULITPLIER is for uniformly increasing the sizes of the tables  */
end_comment
...
begin_comment
comment|/*  * Offsets due to the structure of the runtime stack.  * DPOFF1 is the amount of fixed storage in each block allocated  * as local variables for the runtime system.  * DPOFF2 is the size of the block mark.  */
end_comment
...
begin_comment
comment|/* 	 *	the display for this level is saved in 0(fp) 	 *	and there is no block mark 	 */
end_comment
...
begin_comment
comment|/*      *	size of the px_header put on in yymain.c: magic      */
end_comment
...
begin_comment
comment|/*      *	size of the header, including the magic word (a short)      */
end_comment
...
directive|define
name|HEAD_BYTES
value|( PX_HEAD_BYTES + sizeof ( short ) )
end_define
...
begin_comment
comment|/* 	 *	a flag for printing ppc diagnostic stuff 	 */
end_comment
...
begin_comment
comment|/* 	 *	and the stream onto which to print it 	 */
end_comment
