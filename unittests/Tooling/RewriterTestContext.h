...
argument_list|(
argument|new vfs::OverlayFileSystem(vfs::getRealFileSystem())
argument_list|)
operator|,
name|Files
argument_list|(
...
argument_list|)
block|;
comment|// FIXME: To make these tests truly in-memory, we need to overlay the
comment|// builtin headers.
name|OverlayFileSystem
operator|->
name|pushOverlay
argument_list|(
