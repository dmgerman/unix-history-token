...
begin_comment
comment|/*  * Copyright (c) 2002-2008 Sam Leffler, Errno Consulting  * Copyright (c) 2002-2008 Atheros Communications, Inc.  *  * Permission to use, copy, modify, and/or distribute this software for any  * purpose with or without fee is hereby granted, provided that the above  * copyright notice and this permission notice appear in all copies.  *  * THE SOFTWARE IS PROVIDED "AS IS" AND THE AUTHOR DISCLAIMS ALL WARRANTIES  * WITH REGARD TO THIS SOFTWARE INCLUDING ALL IMPLIED WARRANTIES OF  * MERCHANTABILITY AND FITNESS. IN NO EVENT SHALL THE AUTHOR BE LIABLE FOR  * ANY SPECIAL, DIRECT, INDIRECT, OR CONSEQUENTIAL DAMAGES OR ANY DAMAGES  * WHATSOEVER RESULTING FROM LOSS OF USE, DATA OR PROFITS, WHETHER IN AN  * ACTION OF CONTRACT, NEGLIGENCE OR OTHER TORTIOUS ACTION, ARISING OUT OF  * OR IN CONNECTION WITH THE USE OR PERFORMANCE OF THIS SOFTWARE.  *  * $Id: ar2425.c,v 1.7 2008/11/10 04:08:03 sam Exp $  */
end_comment
...
name|N
argument_list|(
name|ar5212Bank6_2425
argument_list|)
index|]
decl_stmt|;
comment|/* 2417 is same size */
name|uint32_t
name|Bank7Data
index|[
name|N
argument_list|(
name|ar5212Bank7_2425
argument_list|)
index|]
decl_stmt|;
block|}
...
name|ah
parameter_list|)
value|((struct ar2425State *) AH5212(ah)->ah_rfHal)
end_define
...
name|_col
parameter_list|)
value|do {				    \ 	int i;								    \ 	for (i = 0; i< N(ar5212Bank##_ix##_2425); i++)			    \ 		(_priv)->Bank##_ix##Data[i] = ar5212Bank##_ix##_2425[i][_col];\ } while (0)
name|struct
name|ath_hal_5212
modifier|*
name|ahp
...
directive|if
literal|0
block|uint16_t ob2GHz = 0, db2GHz = 0;
endif|#
directive|endif
name|struct
name|ar2425State
...
block|switch (chan->channelFlags& CHANNEL_ALL) {         case CHANNEL_B:             ob2GHz = ahp->ah_obFor24;             db2GHz = ahp->ah_dbFor24;             break;         case CHANNEL_G:         case CHANNEL_108G:             ob2GHz = ahp->ah_obFor24g;             db2GHz = ahp->ah_dbFor24g;             break;         default:             HALDEBUG(ah, HAL_DEBUG_ANY, "%s: invalid channel flags 0x%x\n", 		__func__, chan->channelFlags);             return AH_FALSE;         }
endif|#
directive|endif
...
directive|if
literal|0
block|ar5212ModifyRfBuffer(priv->Bank6Data, ob2GHz, 3, 193, 0);         ar5212ModifyRfBuffer(priv->Bank6Data, db2GHz, 3, 190, 0);
endif|#
directive|endif
...
begin_comment
comment|/*  * Uses the data points read from EEPROM to reconstruct the pdadc power table  * Called by ar2425SetPowerTable()  */
end_comment

begin_function
specifier|static
name|void
name|ar2425getGainBoundariesAndPdadcsForPowers
parameter_list|(
name|struct
name|ath_hal
modifier|*
...
parameter_list|)
block|{
comment|/* Note the items statically allocated below are to reduce stack usage */
name|uint32_t
name|ii
decl_stmt|,
name|jj
...
begin_comment
comment|/* Same as 2413 set power table */
end_comment

begin_function
specifier|static
name|HAL_BOOL
name|ar2425SetPowerTable
parameter_list|(
name|struct
name|ath_hal
modifier|*
...
specifier|static
name|HAL_BOOL
name|ar2425GetChannelMaxMinPower
parameter_list|(
name|struct
name|ath_hal
modifier|*
