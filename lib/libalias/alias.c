...
begin_comment
comment|/* Outside World Access          SaveFragmentPtr()         GetNextFragmentPtr()         FragmentAliasIn()         PacketAliasIn()         PacketAliasOut()         PacketAliasIn2()         PacketAliasOut2()  (prototypes in alias.h) */
end_comment
...
name|addr
parameter_list|,
comment|/* Default aliasing address */
name|int
name|maxpacketsize
comment|/* How much the packet data may grow                                        (FTP and IRC inline changes) */
parameter_list|)
