...
directive|endif
comment|/* !_MATH_H_ */
comment|/* separate header for cmath */
ifndef|#
directive|ifndef
name|_MATH_EXTRA_H_
if|#
...
directive|define
name|_MATH_EXTRA_H_
comment|/*  * extra long double versions of math functions for C99 and cmath  */
name|__BEGIN_DECLS
name|long
name|double
name|lgammal
...
begin_comment
comment|/* !_DECLARE_C99_LDBL_MATH */
end_comment
