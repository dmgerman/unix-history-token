...
begin_comment
comment|/* @(#)e_lgamma_r.c 5.1 93/09/24 */
end_comment
...
index|[]
init|=
literal|"$Id: e_lgamma_r.c,v 1.4 1994/03/03 17:04:17 jtc Exp $"
decl_stmt|;
end_decl_stmt
...
directive|else
function|double __ieee754_lgamma_r
parameter_list|(
name|x
parameter_list|,
name|signgamp
