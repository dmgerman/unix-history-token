...
begin_comment
comment|/* alpha and i386 provide arch specific copysign() */
end_comment
...
begin_comment
comment|/* alpha provides arch specific copysignf() */
end_comment
...
begin_comment
comment|/* i386 provides lots of arch specific functions */
end_comment
