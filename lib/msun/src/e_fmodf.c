...
begin_comment
comment|/* e_fmodf.c -- float version of e_fmod.c.  * Conversion to float by Ian Lance Taylor, Cygnus Support, ian@cygnus.com.  */
end_comment
...
index|[]
init|=
literal|"$Id: e_fmodf.c,v 1.1.1.1 1994/08/19 09:39:54 jkh Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  * __ieee754_fmodf(x,y)  * Return x mod y in exact arithmetic  * Method: shift and subtract  */
end_comment
...
directive|else
function|float __ieee754_fmodf
parameter_list|(
name|x
parameter_list|,
name|y
