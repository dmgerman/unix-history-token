...
parameter_list|)
function_decl|;
comment|// Construct a one-line string like
comment|//  SanitizerToolName: error_type file:line function
comment|// and call __sanitizer_report_error_summary on it.
name|void
...
block|; }
expr_stmt|;
comment|// HeapSort for arrays and InternalVector.
name|template
operator|<
name|class
name|Container
