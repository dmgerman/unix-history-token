...
parameter_list|)
define|\
value|do {                                                                   \     if ((uptr)common_flags()->verbosity>= (level)) Report(__VA_ARGS__); \   } while (0)
define|#
directive|define
name|VPrintf
parameter_list|(
...
parameter_list|)
define|\
value|do {                                                                   \     if ((uptr)common_flags()->verbosity>= (level)) Printf(__VA_ARGS__); \   } while (0)
