...
parameter_list|()
function_decl|;
comment|// Caching version of PrintsToTty(). Not thread-safe.
name|bool
name|PrintsToTtyCached
parameter_list|()
function_decl|;
name|void
name|Printf
...
parameter_list|)
function_decl|;
comment|// Strip the directories from the module name, return a new string allocated
comment|// with internal_strdup.
name|char
modifier|*
