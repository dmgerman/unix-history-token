...
block|;
comment|/// An enum describing the kind of diagnostics to use when checking
comment|/// access.
block|enum
name|AccessDiagnosticsKind
block|{
comment|/// Suppress diagnostics.
name|ADK_quiet
block|,
comment|/// Use the normal diagnostics.
name|ADK_normal
block|,
comment|/// Use the diagnostics appropriate for checking a covariant
comment|/// return type.
name|ADK_covariance
block|}
block|;
...
name|Member
block|,
comment|/// A base-to-derived conversion.  The target is the base class.
name|BaseToDerivedConversion
block|,
comment|/// A derived-to-base conversion.  The target is the base class.
name|DerivedToBaseConversion
block|}
block|;
name|bool
name|isMemberAccess
...
name|ObjCIvarDecl
modifier|*
name|SynthesizeNewPropertyIvar
parameter_list|(
name|ObjCInterfaceDecl
modifier|*
name|IDecl
