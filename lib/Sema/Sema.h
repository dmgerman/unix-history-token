...
begin_comment
comment|/// adjustFunctionParamType - Converts the type of a function parameter to a
end_comment

begin_comment
comment|// type that can be passed as an argument type to
end_comment

begin_comment
comment|/// ASTContext::getFunctionType.
end_comment
...
begin_comment
comment|/// C++ [dcl.fct]p3: "...Any cv-qualifier modifying a parameter type is
end_comment

begin_comment
comment|/// deleted. Such cv-qualifiers affect only the definition of the parameter
end_comment

begin_comment
comment|/// within the body of the function; they do not affect the function type.
end_comment

begin_decl_stmt
name|QualType
name|adjustFunctionParamType
argument_list|(
name|QualType
name|T
argument_list|)
