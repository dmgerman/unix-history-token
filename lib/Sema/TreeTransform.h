...
begin_comment
comment|/// namespace alias named in the next step in the nested-name-specifier.
end_comment
...
block|}
block|}
comment|// The qualifier-in-scope only applies to the leftmost entity.
name|FirstQualifierInScope
operator|=
literal|0
expr_stmt|;
...
argument_list|)
block|{
comment|// TODO: in some cases, we might have some verification to do here.
if|if
condition|(
name|ObjectType
operator|.
...
argument_list|)
block|;
comment|// FIXME: Nested-name-specifier source location info!
typedef|typedef
name|TemplateArgumentLocContainerIterator
operator|<
name|DependentTemplateSpecializationTypeLoc
...
argument|SourceRange Range
argument_list|,
argument|NamespaceAliasDecl *Alias
argument_list|)
block|{
return|return
name|NestedNameSpecifier
