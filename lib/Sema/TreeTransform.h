...
return|;
block|}
comment|/// Transform the set of declarations in an OverloadExpr.
name|bool
name|TransformOverloadExprDecls
argument_list|(
argument|OverloadExpr *Old
argument_list|,
...
block|;
name|QualType
name|RebuildObjCTypeParamType
argument_list|(
argument|const ObjCTypeParamDecl *Decl
argument_list|,
...
operator|>
operator|::
name|TransformObjCTypeParamType
argument_list|(
argument|TypeLocBuilder&TLB
argument_list|,
argument|ObjCTypeParamTypeLoc TL
argument_list|)
block|{
specifier|const
...
comment|// FIXME: The coroutine body is always rebuilt by ActOnFinishFunctionBody
return|return
name|getDerived
argument_list|()
operator|.
...
operator|>
operator|::
name|TransformOMPTargetSimdDirective
argument_list|(
argument|OMPTargetSimdDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTeamsDistributeDirective
argument_list|(
argument|OMPTeamsDistributeDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTeamsDistributeSimdDirective
argument_list|(
argument|OMPTeamsDistributeSimdDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
name|StartOpenMPDSABlock
argument_list|(
name|OMPD_teams_distribute_simd
argument_list|,
name|DirName
argument_list|,
name|nullptr
...
operator|>
operator|::
name|TransformOMPTeamsDistributeParallelForSimdDirective
argument_list|(
argument|OMPTeamsDistributeParallelForSimdDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
name|StartOpenMPDSABlock
argument_list|(
name|OMPD_teams_distribute_parallel_for_simd
argument_list|,
name|DirName
argument_list|,
name|nullptr
...
operator|>
operator|::
name|TransformOMPTeamsDistributeParallelForDirective
argument_list|(
argument|OMPTeamsDistributeParallelForDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
name|StartOpenMPDSABlock
argument_list|(
name|OMPD_teams_distribute_parallel_for
argument_list|,
name|DirName
argument_list|,
name|nullptr
...
operator|>
operator|::
name|TransformOMPTargetTeamsDirective
argument_list|(
argument|OMPTargetTeamsDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
operator|>
operator|::
name|TransformOMPTargetTeamsDistributeDirective
argument_list|(
argument|OMPTargetTeamsDistributeDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
name|StartOpenMPDSABlock
argument_list|(
name|OMPD_target_teams_distribute
argument_list|,
name|DirName
argument_list|,
name|nullptr
...
operator|>
operator|::
name|TransformOMPTargetTeamsDistributeParallelForDirective
argument_list|(
argument|OMPTargetTeamsDistributeParallelForDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
name|StartOpenMPDSABlock
argument_list|(
name|OMPD_target_teams_distribute_parallel_for
argument_list|,
name|DirName
argument_list|,
name|nullptr
...
operator|>
operator|::
name|TransformOMPTargetTeamsDistributeParallelForSimdDirective
argument_list|(
argument|OMPTargetTeamsDistributeParallelForSimdDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
name|StartOpenMPDSABlock
argument_list|(
name|OMPD_target_teams_distribute_parallel_for_simd
argument_list|,
name|DirName
argument_list|,
name|nullptr
...
operator|>
operator|::
name|TransformOMPTargetTeamsDistributeSimdDirective
argument_list|(
argument|OMPTargetTeamsDistributeSimdDirective *D
argument_list|)
block|{
name|DeclarationNameInfo
name|DirName
...
name|StartOpenMPDSABlock
argument_list|(
name|OMPD_target_teams_distribute_simd
argument_list|,
name|DirName
argument_list|,
name|nullptr
...
argument_list|()
condition|)
comment|// Rebuild the expression when the transformed FieldDecl is
comment|// different to the already assigned FieldDecl.
name|ExprChanged
operator|=
name|true
expr_stmt|;
...
block|{
comment|// Ensure that the designator expression is rebuilt when there isn't
comment|// a resolved FieldDecl in the designator as we don't want to assign
comment|// a FieldDecl to a pattern designator that will be instantiated again.
name|ExprChanged
operator|=
name|true
expr_stmt|;
...
operator|>
operator|::
name|TransformArrayInitLoopExpr
argument_list|(
argument|ArrayInitLoopExpr *E
argument_list|)
block|{
name|llvm_unreachable
argument_list|(
literal|"Unexpected ArrayInitLoopExpr outside of initializer"
argument_list|)
block|;
return|return
name|ExprError
...
operator|>
operator|::
name|TransformArrayInitIndexExpr
argument_list|(
argument|ArrayInitIndexExpr *E
argument_list|)
block|{
name|llvm_unreachable
argument_list|(
literal|"Unexpected ArrayInitIndexExpr outside of initializer"
argument_list|)
block|;
return|return
name|ExprError
...
begin_comment
unit|}
comment|// Expand using pack declarations.
end_comment
...
begin_comment
unit|};
comment|// C++ [temp.res]/8.4.2:
end_comment

begin_comment
comment|//   The program is ill-formed, no diagnostic required, if [...] lookup for
end_comment

begin_comment
comment|//   a name in the template definition found a using-declaration, but the
end_comment

begin_comment
comment|//   lookup in the corresponding scope in the instantiation odoes not find
end_comment

begin_comment
comment|//   any declarations because the using-declaration was a pack expansion and
end_comment

begin_comment
comment|//   the corresponding pack is empty
end_comment
...
name|diag
operator|::
name|err_using_pack_expansion_empty
argument_list|)
operator|<<
name|isa
operator|<
...
argument_list|)
block|;
comment|// Transform the declaration set.
if|if
condition|(
name|TransformOverloadExprDecls
argument_list|(
...
begin_comment
comment|// Try to compute the result without performing a partial substitution.
end_comment
...
argument_list|)
expr_stmt|;
comment|// Find the pattern of the pack expansion.
name|SourceLocation
name|Ellipsis
decl_stmt|;
name|Optional
...
argument_list|)
decl_stmt|;
comment|// Substitute under the pack expansion. Do not expand the pack (yet).
name|TemplateArgumentLoc
name|OutPattern
decl_stmt|;
name|Sema
...
name|true
return|;
comment|// See if we can determine the number of arguments from the result.
name|Optional
operator|<
name|unsigned
operator|>
...
condition|)
block|{
comment|// No: we must be in an alias template expansion, and we're going to need
comment|// to actually expand the packs.
name|Result
operator|=
name|None
expr_stmt|;
...
begin_comment
comment|// Common case: we could determine the number of expansions without
end_comment
...
begin_comment
comment|// Check whether we managed to fully-expand the pack.
end_comment

begin_comment
comment|// FIXME: Is it possible for us to do so and not hit the early exit path?
end_comment
...
condition|)
block|{
comment|// A valid resolved using typename pack expansion decl can have multiple
comment|// UsingDecls, but they must each have exactly one type, and it must be
comment|// the same type in every case. But we must have at least one expansion!
if|if
condition|(
name|UPD
operator|->
...
return|;
block|}
comment|// We might still have some unresolved types. Try to pick a resolved type
comment|// if we can. The final instantiation will check that the remaining
comment|// unresolved types instantiate to the type we pick.
name|QualType
name|FallbackT
decl_stmt|;
name|QualType
...
argument_list|)
operator|&&
literal|"mismatched resolved types in using pack expansion"
argument_list|)
expr_stmt|;
block|}
return|return
