...
argument_list|()
block|;
comment|// FIXME: should be an inner type, or at least have a DeclaratorInfo.
name|QualType
name|Underlying
operator|=
name|getDerived
