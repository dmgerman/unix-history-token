...
return|;
block|}
comment|// FIXME: Handle elaborated-type-specifiers separately.
return|return
name|SemaRef
operator|.
name|Context
...
name|ETK_None
case|:
comment|// FIXME: Note the lack of the "typename" specifier!
...
break|break;
block|}
comment|// We had a dependent elaborated-type-specifier that as been transformed
...
return|;
block|}
comment|// FIXME: Terrible location information
if|if
condition|(
operator|!
name|SemaRef
