...
begin_comment
comment|//===-- lib/comparetf2.c - Quad-precision comparisons -------------*- C -*-===//
end_comment
...
begin_comment
comment|//   __eqtf2   __getf2   __unordtf2
end_comment

begin_comment
comment|//   __letf2   __gttf2
end_comment
...
begin_comment
comment|//   __letf2(a,b) returns -1 if a< b
end_comment
...
begin_comment
comment|//   __getf2(a,b) returns -1 if a< b
end_comment
...
begin_comment
comment|//   __unordtf2(a,b) returns 0 if both a and b are numbers
end_comment
...
begin_comment
comment|// Note that __letf2( ) and __getf2( ) are identical except in their handling of
end_comment
