...
begin_comment
comment|/// followed by special operands that describe memory references, then an
end_comment

begin_comment
comment|/// optional chain operand, then flag operands.  Compute the number of
end_comment

begin_comment
comment|/// actual operands that will go into the resulting MachineInstr.
end_comment
...
begin_comment
comment|/// ComputeMemOperandsEnd - Find the index one past the last
end_comment

begin_comment
comment|/// MemOperandSDNode operand
end_comment

begin_function_decl
specifier|static
name|unsigned
name|ComputeMemOperandsEnd
parameter_list|(
name|SDNode
modifier|*
name|Node
...
begin_comment
comment|/// VRBaseMap contains, for each already emitted node, the first virtual
end_comment

begin_comment
comment|/// register number for the results of the node.
end_comment
...
begin_comment
comment|/// EmitCopyToRegClassNode - Generate machine code for COPY_TO_REGCLASS
end_comment
