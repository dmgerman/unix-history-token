...
begin_comment
comment|//===-- SelectionDAGBuild.h - Selection-DAG building ----------------------===//
end_comment
...
empty_stmt|;
comment|//===----------------------------------------------------------------------===//
comment|/// SelectionDAGLowering - This is the common target-independent lowering
...
parameter_list|)
function_decl|;
comment|/// CaseBlock - This structure is used to communicate between SDLowering and
comment|/// SDISel for the code generation of additional basic blocks needed by multi-
comment|/// case switch statements.
struct|struct
name|CaseBlock
block|{
name|CaseBlock
...
comment|/// state and prepare this SelectionDAGLowering object to be used
