...
operator|>
name|class
name|JoinPriorityQueue
expr_stmt|;
comment|/// CopyRecSort - Sorting function for coalescer queue.
comment|///
name|struct
name|CopyRecSort
range|:
...
block|}
empty_stmt|;
comment|/// JoinQueue - A priority queue of copy instructions the coalescer is
comment|/// going to process.
name|template
operator|<
name|class
name|SF
...
return|;
block|}
comment|// Callbacks to SimpleRegisterCoalescing.
name|unsigned
name|getRepIntervalSize
parameter_list|(
name|unsigned
name|Reg
parameter_list|)
...
block|}
empty_stmt|;
comment|/// getRepIntervalSize - Called from join priority queue sorting function.
comment|/// It returns the size of the interval that represent the given register.
name|unsigned
name|getRepIntervalSize
parameter_list|(
name|unsigned
...
parameter_list|)
function_decl|;
comment|/// TurnCopyIntoImpDef - If source of the specified copy is an implicit def,
comment|/// turn the copy into an implicit def.
name|bool
name|TurnCopyIntoImpDef
argument_list|(
name|MachineBasicBlock
operator|::
name|iterator
...
parameter_list|)
function_decl|;
comment|/// isBackEdgeCopy - Return true if CopyMI is a back edge copy.
comment|///
name|bool
name|isBackEdgeCopy
argument_list|(
...
parameter_list|)
function_decl|;
comment|/// RemoveDeadImpDef - Remove implicit_def instructions which are
comment|/// "re-defining" registers due to insert_subreg coalescing. e.g.
name|void
name|RemoveDeadImpDef
parameter_list|(
name|unsigned
name|Reg
parameter_list|,
