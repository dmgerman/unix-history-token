...
comment|/// true for that case, and false otherwise.  If false, comments passed in to
comment|/// the emit methods will be ignored.
name|bool
...
argument_list|,
argument|SmallVectorImpl<std::string>&Comments
argument_list|,
