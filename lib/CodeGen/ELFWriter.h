...
comment|// sometimes return a section name prefixed with a "\t" char. This is
comment|// a little bit dirty. FIXME: find a better approach, maybe add more
comment|// methods to TAI to get the clean name?
name|void
name|fixNameForSection
argument_list|(
name|std
operator|::
name|string
...
return|;
block|}
comment|/// Get jump table section on the section name returned by TAI
name|ELFSection
modifier|&
