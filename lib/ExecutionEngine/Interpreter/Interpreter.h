...
ifndef|#
directive|ifndef
name|LLVM_LIB_EXECUTIONENGINE_INTERPRETER_INTERPRETER_H
end_ifndef
...
argument_list|()
block|{}
comment|// Make this type move-only. Define explicit move special members for MSVC.
name|AllocaHolder
argument_list|(
name|AllocaHolder
operator|&&
...
name|Allocations
argument_list|(
argument|std::move(RHS.Allocations)
argument_list|)
block|{}
name|AllocaHolder
operator|&
...
expr_stmt|;
block|}
comment|/// Create an interpreter ExecutionEngine.
comment|///
specifier|static
name|ExecutionEngine
modifier|*
