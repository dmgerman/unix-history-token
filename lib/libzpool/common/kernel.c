...
begin_comment
comment|/*  * Copyright (c) 2005, 2010, Oracle and/or its affiliates. All rights reserved.  * Copyright (c) 2012, 2015 by Delphix. All rights reserved.  * Copyright (c) 2013, Joyent, Inc.  All rights reserved.  */
end_comment
...
begin_comment
comment|/* If set, all blocks read will be copied to the specified directory. */
end_comment
...
begin_comment
comment|/* this only exists to have its address taken */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* fd ignored for now, need if want to simulate nbmand support */
name|ret
operator|=
name|vn_open
argument_list|(
...
begin_comment
comment|/*  * At a minimum we need to update the size since vdev_reopen()  * will no longer call vn_openat().  */
end_comment
...
begin_comment
comment|/*  * Do not change the length of the returned string; it must be freed  * with strfree().  */
end_comment
