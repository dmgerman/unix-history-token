...
argument_list|)
expr_stmt|;
comment|/* 	 * Mark it as a prealloc'd task.  This is important 	 * to ensure that we don't free it later. 	 */
name|t
operator|->
name|tqent_flags
operator||=
...
argument_list|)
expr_stmt|;
comment|/* need at least 1 thread */
block|}
else|else
block|{
name|ASSERT3S
