...
begin_comment
comment|/*static char *sccsid = "from: @(#)authunix_prot.c 1.15 87/08/11 Copyr 1984 Sun Micro";*/
end_comment

begin_comment
comment|/*static char *sccsid = "from: @(#)authunix_prot.c	2.1 88/07/29 4.0 RPCSRC";*/
end_comment
...
name|rcsid
init|=
literal|"$Id: authunix_prot.c,v 1.3 1993/08/26 00:53:13 jtc Exp $"
decl_stmt|;
end_decl_stmt
