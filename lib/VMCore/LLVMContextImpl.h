...
decl_stmt|;
block|}
comment|// Destroy MDNodes.  ~MDNode can move and remove nodes between the MDNodeSet
comment|// and the NonUniquedMDNodes sets, so copy the values out first.
name|SmallVector
operator|<
name|MDNode
operator|*
...
argument_list|()
operator|&&
literal|"Destroying all MDNodes didn't empty the Context's sets."
argument_list|)
expr_stmt|;
comment|// Destroy MDStrings.
for|for
control|(
name|StringMap
operator|<
