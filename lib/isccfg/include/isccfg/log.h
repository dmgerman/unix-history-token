...
begin_comment
comment|/* $Id: log.h,v 1.12.332.2 2009-01-18 23:47:41 tbox Exp $ */
end_comment
...
begin_comment
comment|/*%<  * Make the libisccfg categories and modules available for use with the  * ISC logging library.  *  * Requires:  *\li	lctx is a valid logging context.  *  *\li	cfg_log_init() is called only once.  *  * Ensures:  * \li	The categories and modules defined above are available for  * 	use by isc_log_usechannnel() and isc_log_write().  */
end_comment
