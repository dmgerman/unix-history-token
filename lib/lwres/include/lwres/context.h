...
begin_comment
comment|/* $Id: context.h,v 1.21.332.2 2008-12-30 23:46:49 tbox Exp $ */
end_comment
...
begin_comment
comment|/*!  * _SERVERMODE  *	Don't allocate and connect a socket to the server, since the  *	caller _is_ a server.  *  * _USEIPV4, _USEIPV6  *	Use IPv4 and IPv6 transactions with remote servers, respectively.  *	For backward compatibility, regard both flags as being set when both  *	are cleared.  */
end_comment
...
begin_comment
comment|/**<  * Frees all memory associated with a lwres context.  *  *\pre	contextp != NULL&& contextp == NULL.  */
end_comment
