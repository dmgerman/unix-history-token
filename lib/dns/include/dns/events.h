...
begin_comment
comment|/* $Id: events.h,v 1.42.18.3 2005/04/29 00:16:13 marka Exp $ */
end_comment
...
begin_comment
comment|/*! \file   * \brief  * Registry of DNS event numbers.  */
end_comment
...
define|#
directive|define
name|DNS_EVENT_VIEWACACHESHUTDOWN
value|(ISC_EVENTCLASS_DNS + 37)
end_define
