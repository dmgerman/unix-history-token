...
begin_comment
comment|/* $Id: xfrin.h,v 1.28.332.2 2009-01-18 23:47:41 tbox Exp $ */
end_comment
...
begin_comment
comment|/*! \file dns/xfrin.h  * \brief  * Incoming zone transfers (AXFR + IXFR).  */
end_comment
...
begin_comment
comment|/*%<  * If the zone transfer 'xfr' has already finished,  * do nothing.  Otherwise, abort it and cause it to call  * its done callback with a status of ISC_R_CANCELED.  */
end_comment
