...
begin_comment
comment|/* $Id: result.h,v 1.123 2011/03/21 07:22:14 each Exp $ */
end_comment
...
directive|define
name|DNS_R_EXPIRED
value|(ISC_RESULTCLASS_DNS + 107)
end_define

begin_define
define|#
directive|define
name|DNS_R_NOTDYNAMIC
value|(ISC_RESULTCLASS_DNS + 108)
end_define
