...
begin_comment
comment|/* $Id: rootns.h,v 1.16 2007-06-19 23:47:17 tbox Exp $ */
end_comment
...
begin_comment
comment|/*  * Reports differences between hints and the real roots.  *  * Requires view, hints and (cache) db to be valid.  */
end_comment
