...
begin_comment
comment|/*%< canceled due to a timeout */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* 	 * We could connect the socket when we are using an exclusive dispatch 	 * as we do in resolver.c, but we prefer implementation simplicity 	 * at this moment. 	 */
name|result
operator|=
