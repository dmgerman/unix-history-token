...
begin_comment
comment|/*  * $Id: dnssec.c,v 1.119 2010-01-13 23:48:59 tbox Exp $  */
end_comment
...
name|next
decl_stmt|;
comment|/* 	 * First, look through the existing key list to find keys 	 * supplied from the command line which are not in the zone. 	 * Update the zone to include them. 	 */
for|for
control|(
name|key
operator|=
