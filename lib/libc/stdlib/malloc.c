...
begin_comment
comment|/*  * ----------------------------------------------------------------------------  * "THE BEER-WARE LICENSE" (Revision 42):  *<phk@FreeBSD.ORG> wrote this file.  As long as you retain this notice you  * can do whatever you want with this stuff. If we meet some day, and you think  * this stuff is worth it, you can buy me a beer in return.   Poul-Henning Kamp  * ----------------------------------------------------------------------------  *  * $Id: malloc.c,v 1.18.2.1 1996/12/30 01:35:15 alex Exp $  *  */
end_comment
...
name|page_dir
expr_stmt|;
comment|/* print out all the pages */
for|for
control|(
name|j
operator|=
...
name|fd
argument_list|,
literal|"Free_list loops.\n"
argument_list|)
expr_stmt|;
break|break;
block|}
block|}
comment|/* print out various info */
name|fprintf
argument_list|(
name|fd
argument_list|,
...
name|q
init|=
literal|"malloc() warning: Couldn't dump stats.\n"
decl_stmt|;
if|if
condition|(
name|fd
