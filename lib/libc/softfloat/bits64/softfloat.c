...
begin_comment
comment|/* $NetBSD: softfloat.c,v 1.8 2011/07/10 04:52:23 matt Exp $ */
end_comment
...
begin_comment
comment|/*  * just like above - but do not care for overflow of signed results  */
end_comment
...
begin_comment
comment|/* (SOFTFLOATSPARC64_FOR_GCC || SOFTFLOAT_FOR_GCC)&& SOFTFLOAT_NEED_FIXUNS */
end_comment
