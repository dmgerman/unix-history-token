...
begin_comment
comment|/* $Id: hex.h,v 1.13 2008-09-25 04:02:39 tbox Exp $ */
end_comment
...
begin_comment
comment|/*!<  * \brief Convert hex encoded text from a lexer context into data.  *  * Requires:  *\li	'lex' is a valid lexer context  *\li	'target' is a buffer containing binary data  *\li	'length' is an integer  *  * Ensures:  *\li	target will contain the data represented by the hex encoded  *	string parsed by the lexer.  No more than length bytes will be read,  *	if length is positive.  The 'used' pointer in target will be  *	advanced as necessary.  */
end_comment
