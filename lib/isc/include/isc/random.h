...
begin_comment
comment|/* $Id: random.h,v 1.12.18.2 2005/04/29 00:17:01 marka Exp $ */
end_comment
...
begin_comment
comment|/*! \file  * \brief Implements a random state pool which will let the caller return a  * series of possibly non-reproducable random values.    *  * Note that the  * strength of these numbers is not all that high, and should not be  * used in cryptography functions.  It is useful for jittering values  * a bit here and there, such as timeouts, etc.  */
end_comment
