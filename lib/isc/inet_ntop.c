...
index|[]
init|=
literal|"$Id: inet_ntop.c,v 1.19.332.2 2009-07-18 23:47:25 tbox Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*! const char *  * inet_ntop4(src, dst, size)  *	format an IPv4 address  * \return  *	`dst' (as a const)  * \note  *	(1) uses no statics  * \note  *	(2) takes a unsigned char* not an in_addr as input  * \author  *	Paul Vixie, 1996.  */
end_comment
