...
begin_comment
comment|/* $Id: strerror.h,v 1.8.332.2 2009/02/16 23:47:15 tbox Exp $ */
end_comment
...
comment|/*% String Error Size */
define|#
directive|define
name|ISC_STRERRORSIZE
value|128
comment|/*%  * Provide a thread safe wrapper to strerror().  *  * Requires:  * 	'buf' to be non NULL.  */
name|void
name|isc__strerror
parameter_list|(
name|int
