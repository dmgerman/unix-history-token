...
begin_comment
comment|//===-- AVRFrameLowering.h - Define frame lowering for AVR ------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|LLVM_AVR_FRAME_LOWERING_H
end_ifndef
...
name|llvm
block|{
comment|/// Utilities for creating function call frames.
name|class
...
begin_comment
comment|// LLVM_AVR_FRAME_LOWERING_H
end_comment
