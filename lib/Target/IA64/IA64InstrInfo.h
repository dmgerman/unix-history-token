...
begin_comment
comment|//===- IA64InstrInfo.h - IA64 Instruction Information ----------*- C++ -*- ===//
end_comment
...
begin_comment
comment|// This file contains the IA64 implementation of the TargetInstrInfo class.
end_comment
