...
return|;
block|}
comment|/// getFP16Imm - Return an 8-bit floating-point version of the 16-bit
...
literal|0xffffffffULL
expr_stmt|;
comment|// "lsl #0" takes precedence: in practice this only affects "#0, lsl #0".
if|if
condition|(
name|Value
operator|==
...
parameter_list|)
block|{
comment|// MOVZ takes precedence over MOVN.
if|if
condition|(
name|isAnyMOVZMovAlias
argument_list|(
...
name|true
return|;
comment|// It's not a MOVZ, but it might be a MOVN.
name|Value
operator|=
operator|~
name|Value
