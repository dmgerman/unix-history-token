...
parameter_list|)
define|\
value|RECORD(sname, printField<FLD_T(name)>, parseField<FLD_T(name)>)
end_define
...
parameter_list|)
define|\
value|RECORD(name, PRINTCODEPROP(shift), PARSECODEPROP(shift))
end_define
...
parameter_list|)
define|\
value|RECORD(name, PRINTCOMP(GetMacro, Shift), PARSECOMP(SetMacro, Shift))
end_define
...
parameter_list|)
define|\
value|COMPPGM(compute_pgm_rsrc1_##name, \           G_00B848_##AccMacro, S_00B848_##AccMacro, 0)
end_define
...
parameter_list|)
define|\
value|COMPPGM(compute_pgm_rsrc2_##name, \           G_00B84C_##AccMacro, S_00B84C_##AccMacro, 32)
end_define
...
name|CODEPROP
argument_list|(
argument|is_xnack_enabled
argument_list|,
argument|IS_XNACK_SUPPORTED
argument_list|)
end_expr_stmt
