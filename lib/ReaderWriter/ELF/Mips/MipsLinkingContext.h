...
literal|1026
block|,
comment|/// \brief Setup hi 16 bits using the symbol this reference refers to.
name|LLD_R_MIPS_HI16
init|=
literal|1027
block|,
comment|/// \brief Setup low 16 bits using the symbol this reference refers to.
name|LLD_R_MIPS_LO16
init|=
literal|1028
block|,
...
operator|&
name|getELFFlagsMerger
argument_list|()
block|;
comment|// ELFLinkingContext
name|uint64_t
name|getBaseAddress
argument_list|()
specifier|const
