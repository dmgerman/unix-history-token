...
name|override
block|{
comment|// Common symbols are not allocated in object files,
comment|// so use st_size to tell how many bytes are required.
if|if
condition|(
name|_symbol
operator|&&
...
argument_list|)
return|;
comment|// Obtain proper value of st_value field.
specifier|const
name|auto
name|symValue
operator|=
...
begin_comment
comment|// Unallocated common symbols specify their alignment constraints in
end_comment
...
condition|)
block|{
comment|// sh_addralign of 0 means no alignment
return|return
name|Alignment
argument_list|(
literal|0
...
condition|)
block|{
comment|// permRW_L is for sections modified by the runtime
comment|// loader.
case|case
name|llvm
operator|::
...
name|override
block|{
comment|// The alignment should be 8 byte aligned
return|return
name|Alignment
argument_list|(
literal|3
...
name|override
block|{
comment|// Needs 8 byte alignment
return|return
name|Alignment
argument_list|(
literal|3
