...
begin_comment
comment|//===- lib/ReaderWriter/ELF/HexagonELFReader.h ----------------------------===//
end_comment
...
ifndef|#
directive|ifndef
name|LLD_READER_WRITER_HEXAGON_ELF_READER_H
end_ifndef
...
expr_stmt|;
struct|struct
name|HexagonDynamicFileCreateELFTraits
block|{
typedef|typedef
name|llvm
operator|::
...
struct|;
struct|struct
name|HexagonELFFileCreateELFTraits
block|{
typedef|typedef
name|llvm
operator|::
