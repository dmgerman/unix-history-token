...
begin_comment
comment|//===- lib/ReaderWriter/ELF/X86_64/X86_64RelocationHandler.h --------------===//
end_comment
...
ifndef|#
directive|ifndef
name|X86_64_RELOCATION_HANDLER_H
end_ifndef
...
name|private
operator|:
comment|// Cached size of the TLS segment.
name|mutable
name|uint64_t
name|_tlsSize
block|;
...
begin_comment
comment|// X86_64_RELOCATION_HANDLER_H
end_comment
