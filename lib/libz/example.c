...
begin_comment
comment|/* example.c -- usage example of the zlib compression library  * Copyright (C) 1995-1998 Jean-loup Gailly.  * For conditions of distribution and use, see copyright notice in zlib.h   */
end_comment

begin_comment
comment|/* @(#) $Id: example.c,v 1.1.1.3 1999/01/10 09:46:54 peter Exp $ */
end_comment
