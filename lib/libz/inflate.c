...
begin_comment
comment|/* inflate.c -- zlib decompression  * Copyright (C) 1995-2010 Mark Adler  * For conditions of distribution and use, see copyright notice in zlib.h  */
end_comment
...
name|state
expr_stmt|;
comment|/* extract wrap request from windowBits parameter */
if|if
condition|(
name|windowBits
operator|<
...
directive|endif
block|}
comment|/* set number of window bits, free window if different */
if|if
condition|(
name|windowBits
operator|&&
...
expr_stmt|;
block|}
comment|/* update state and reset the rest of it */
name|state
operator|->
name|wrap
operator|=
