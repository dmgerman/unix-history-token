...
begin_comment
comment|/* deflate.c -- compress data using the deflation algorithm  * Copyright (C) 1995-1998 Jean-loup Gailly.  * For conditions of distribution and use, see copyright notice in zlib.h   */
end_comment
...
begin_comment
comment|/* @(#) $Id: deflate.c,v 1.1.1.3 1999/01/10 09:46:53 peter Exp $ */
end_comment
...
begin_comment
comment|/* ---------------------------------------------------------------------------  * Optimized version for level == 1 only  */
end_comment
