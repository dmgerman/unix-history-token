...
begin_comment
comment|//===--- OpenBSD.h - OpenBSD ToolChain Implementations ----------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|LLVM_CLANG_LIB_DRIVER_TOOLCHAINS_OPENBSD_H
end_ifndef
...
begin_comment
comment|// LLVM_CLANG_LIB_DRIVER_TOOLCHAINS_OPENBSD_H
end_comment
