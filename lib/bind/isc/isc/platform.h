...
begin_comment
comment|/*! \brief  * Define if the system supports epoll multiplexing  */
end_comment
...
begin_comment
comment|/*! \brief  * Define if the system supports /dev/poll multiplexing  */
end_comment
...
begin_comment
comment|/*  * Define if this system needs strcasestr.  */
end_comment

begin_undef
undef|#
directive|undef
name|ISC_PLATFORM_NEEDSTRCASESTR
end_undef
