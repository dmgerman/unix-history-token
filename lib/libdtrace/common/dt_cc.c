...
begin_comment
comment|/*  * Copyright (c) 2003, 2010, Oracle and/or its affiliates. All rights reserved.  * Copyright (c) 2011, 2016 by Delphix. All rights reserved.  * Copyright (c) 2013, Joyent Inc. All rights reserved.  * Copyright 2015 Gary Mills  */
end_comment
...
expr_stmt|;
block|}
comment|/* 	 * Perform sugar transformations (for "if" / "else") and replace the 	 * existing clause chain with the new one. 	 */
if|if
condition|(
name|context
operator|==
...
control|)
block|{
comment|/* remove this node from the list */
name|next_dnp
operator|=
name|dnp
operator|->
...
argument_list|)
expr_stmt|;
comment|/* append node to the new list */
name|new_list
operator|=
name|dt_node_link
argument_list|(
