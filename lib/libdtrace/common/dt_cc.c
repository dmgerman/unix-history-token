...
name|D_TRACE_VOID
argument_list|,
literal|"trace( ) may not be applied to a void expression\n"
argument_list|)
expr_stmt|;
block|}
if|if
...
name|D_TRACE_DYN
argument_list|,
literal|"trace( ) may not be applied to a dynamic expression\n"
argument_list|)
expr_stmt|;
block|}
name|dt_cg
...
name|D_PRINT_VOID
argument_list|,
literal|"print( ) may not be applied to a void expression\n"
argument_list|)
expr_stmt|;
block|}
if|if
...
name|D_PRINT_DYN
argument_list|,
literal|"print( ) may not be applied to a dynamic expression\n"
argument_list|)
expr_stmt|;
block|}
name|dt_cg
