...
function_decl|;
name|size_t
name|RecordBlockCoverage
parameter_list|()
function_decl|;
name|size_t
name|RecordCallerCalleeCoverage
parameter_list|()
function_decl|;
name|void
name|PrepareCoverageBeforeRun
parameter_list|()
function_decl|;
name|bool
name|CheckCoverageAfterRun
parameter_list|()
function_decl|;
...
decl_stmt|;
name|size_t
name|TotalNumberOfExecutedTraceBasedMutations
init|=
literal|0
decl_stmt|;
name|std
...
decl_stmt|;
name|size_t
name|LastRecordedBlockCoverage
init|=
literal|0
decl_stmt|;
name|size_t
...
name|SimpleUserSuppliedFuzzer
argument_list|(
argument|FuzzerRandomBase *Rand
argument_list|,
