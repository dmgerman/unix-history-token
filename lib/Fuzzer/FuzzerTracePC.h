...
function_decl|;
name|void
name|HandleInline8bitCountersInit
parameter_list|(
name|uint8_t
modifier|*
name|Start
...
struct|;
name|size_t
name|NumModulesWithInline8bitCounters
decl_stmt|;
comment|// linker-initialized.
name|size_t
name|NumInline8bitCounters
decl_stmt|;
name|uint8_t
operator|*
name|Counters
...
name|Begin
decl_stmt|;
comment|// Iterate by 1 byte until either the alignment boundary or the end.
for|for
control|(
init|;
...
argument_list|)
expr_stmt|;
comment|// Iterate by Step bytes at a time.
for|for
control|(
init|;
name|P
...
argument_list|)
expr_stmt|;
comment|// Iterate by 1 byte until the end.
for|for
control|(
init|;
name|P
