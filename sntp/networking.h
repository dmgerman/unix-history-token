...
begin_comment
comment|/*   * for 4.2.6 only define AUTOKEY if OPENSSL, so that backported 4.2.7  * references to AUTOKEY work -- in 4.2.7 AUTOKEY is independent of OPENSSL  */
end_comment
