...
name|OPTST_SCALED_NUM_ID
init|=
literal|24
block|,
comment|/* scaled integer value          */
name|OPTST_NO_COMMAND_ID
init|=
literal|25
block|,
comment|/* disable from cmd line         */
name|OPTST_DEPRECATED_ID
init|=
literal|26
...
directive|define
name|OPTST_SET_MASK
value|( \         OPTST_DEFINED | OPTST_PRESET |  OPTST_RESET | \         OPTST_SET \
comment|/* 0x0000000FU */
value|)
end_define
...
value|( \         OPTST_ALLOC_ARG |   OPTST_DEFINED | \         OPTST_DISABLED |    OPTST_EQUIVALENCE | \         OPTST_PRESET |      OPTST_RESET | \         OPTST_SET \
comment|/* 0x0000007FU */
value|)
end_define
...
value|( \         OPTST_DOCUMENT | OPTST_NO_INIT |  OPTST_OMITTED \
comment|/* 0x00280100U */
value|)
end_define
...
value|( \         OPTST_DEPRECATED | OPTST_NO_COMMAND | OPTST_OMITTED \
comment|/* 0x06080000U */
value|)
end_define
...
name|_f
parameter_list|)
value|(((_f)&OPTST_ARG_TYPE_MASK)>>OPTST_ARG_TYPE_1_ID)
end_define
...
name|OPTPROC_MISUSE_ID
init|=
literal|14
block|,
comment|/* no usage on usage error        */
name|OPTPROC_NXLAT_OPT_CFG_ID
init|=
literal|16
block|,
comment|/* suppress for config only       */
name|OPTPROC_NXLAT_OPT_ID
init|=
literal|17
block|,
...
value|(1U<< OPTPROC_NXLAT_OPT_CFG_ID)
end_define
...
value|( \         OPTPROC_NXLAT_OPT |     OPTPROC_NXLAT_OPT_CFG \
comment|/* 0x00030000U */
value|)
end_define
...
begin_comment
comment|/* From: restore.c line 166  *  * optionFree - free allocated option processing memory  *  * Arguments:  *   pOpts        program options descriptor  *  *  AutoOpts sometimes allocates memory and puts pointers to it in the  *  option state structures.  This routine deallocates all such memory.  */
end_comment
...
begin_comment
comment|/* From: nested.c line 551  *  * optionUnloadNested - Deallocate the memory for a nested value  *  * Arguments:  *   pOptVal      the hierarchical value  *  *  A nested value needs to be deallocated.  The pointer passed in should  *  have been gotten from a call to @code{configFileLoad()} (See  *  @pxref{libopts-configFileLoad}).  */
end_comment
...
begin_comment
comment|/* From: version.c line 31  *  * optionVersion - return the compiled AutoOpts version number  *  * Returns: char const* - the version string in constant memory  *  *  Returns the full version string compiled into the library.  *  The returned string cannot be modified.  */
end_comment
