...
begin_comment
comment|/* Return value when a valid duration cannot be parsed.  */
end_comment
...
begin_comment
comment|/* Parses the given string.  If it has the syntax of a valid duration,    this duration is returned.  Otherwise, the return value is BAD_TIME,    and errno is set to either EINVAL (bad syntax) or ERANGE (out of range).  */
end_comment
...
begin_comment
comment|/* GNULIB_PARSE_DURATION_H */
end_comment
