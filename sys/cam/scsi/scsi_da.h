...
index|]
decl_stmt|;
comment|/* Variable length initialization pattern. */
define|#
directive|define
...
value|0x02
comment|/* Types same, last length varies */
define|#
directive|define
...
value|SRDD10_MAX_LENGTH -			     \ 				sizeof(struct scsi_read_defect_data_hdr_10)
block|}
struct|;
end_struct
...
define|#
directive|define
name|SDD_EXT_PHYS_ENTIRE_TRACK
value|0x0fffffff
name|u_int8_t
name|sector
index|[
...
value|SRDD12_MAX_LENGTH -			    \ 				sizeof(struct scsi_read_defect_data_hdr_12)
block|}
struct|;
end_struct
...
begin_comment
comment|/*  * XXX KDM  * Here for CTL compatibility, reconcile this.  */
end_comment
...
decl_stmt|;
name|uint8_t
name|alt_sectors_per_zone
index|[
literal|2
index|]
decl_stmt|;
name|uint8_t
name|alt_tracks_per_zone
index|[
literal|2
index|]
decl_stmt|;
name|uint8_t
name|alt_tracks_per_lun
index|[
literal|2
index|]
decl_stmt|;
...
decl_stmt|;
name|uint8_t
name|start_write_precomp
index|[
literal|3
index|]
decl_stmt|;
name|uint8_t
name|start_reduced_current
index|[
literal|3
index|]
decl_stmt|;
...
define|#
directive|define
name|SRDP_RPL_MASTER
value|0x02
define|#
directive|define
name|SRDP_RPL_MASTER_CONTROL
value|0x03
name|uint8_t
name|rotational_offset
decl_stmt|;
name|uint8_t
name|reserved1
decl_stmt|;
