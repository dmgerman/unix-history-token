...
name|opcode
decl_stmt|;
comment|/* READ_FORMAT_CAPACITIES */
name|uint8_t
name|byte2
decl_stmt|;
define|#
...
index|]
decl_stmt|;
comment|/* number of blocks to write and verify */
name|uint8_t
name|reserved1
index|[
literal|3
...
begin_struct
struct|struct
name|format_capacity_descriptor
block|{
name|uint8_t
name|nblocks
index|[
...
index|]
decl_stmt|;
comment|/* total number of LBAs */
name|uint8_t
name|byte4
decl_stmt|;
comment|/* only present in max/cur descriptor */
define|#
directive|define
name|FCD_CODE_MASK
value|0x03
comment|/* mask for code field above */
define|#
directive|define
name|FCD_UNFORMATTED
value|0x01
comment|/* unformatted media present, 				 * maximum capacity returned */
define|#
directive|define
name|FCD_FORMATTED
value|0x02
comment|/* formatted media present, 				 * current capacity returned */
define|#
directive|define
name|FCD_NOMEDIA
value|0x03
comment|/* no media present, 				 * maximum device capacity returned */
name|uint8_t
name|block_length
index|[
literal|3
index|]
decl_stmt|;
comment|/* length of an LBA in bytes */
block|}
struct|;
end_struct
