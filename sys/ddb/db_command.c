...
name|db_printf
argument_list|(
literal|"No gdb port enabled. Set flag 0x80 on desired port\n"
argument_list|)
expr_stmt|;
name|db_printf
argument_list|(
literal|"in your configuration file (currently sio only).\n"
argument_list|)
expr_stmt|;
return|return;
block|}
