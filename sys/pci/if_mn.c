...
begin_comment
comment|/* XXX: should live in some header somewhere */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* Create the first channel */
name|sc
operator|->
name|ch
index|[
...
name|printf
argument_list|(
literal|"mn%d: WARNING: Controller failed to initialize.\n"
argument_list|,
name|sc
operator|->
name|unit
...
name|printf
argument_list|(
literal|"mn%d: could not map interrupt\n"
argument_list|,
name|sc
operator|->
name|unit
