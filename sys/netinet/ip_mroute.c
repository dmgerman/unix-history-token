...
begin_comment
comment|/*  * De-encapsulate a packet and feed it back through ip input (this  * routine is called whenever IP gets a packet with proto type  * ENCAP_PROTO and a local destination address).  *  * This is similar to mroute_encapcheck() + mroute_encap_input() in -current.  */
end_comment
