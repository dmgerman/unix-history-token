...
name|printf
argument_list|(
literal|"Warning, empty pipe and delay %d (should be %a)d\n"
argument_list|,
name|pipe
operator|->
name|ticks_from_last_insert
...
condition|)
block|{
comment|/* like in the firewall code... */
if|if
condition|(
name|m
condition|)
...
name|m
condition|)
comment|/* need an argument for the following */
return|return
operator|(
name|EINVAL
operator|)
...
name|printf
argument_list|(
literal|"dn_pipe Invalid length, %d instead of %d\n"
argument_list|,
name|m
operator|->
name|m_len
