...
name|port_net
decl_stmt|;
comment|/*    Description of alias_port_param for GetNewPort().  When    this parameter is zero or positive, it precisely specifies    the port number.  GetNewPort() will return this number    without check that it is in use.     When this parameter is -1, it indicates to get a randomly    selected port number. */
if|if
condition|(
name|alias_port_param
operator|==
...
literal|1
expr_stmt|;
comment|/* Build generic part of the two rules */
name|rule
operator|.
name|fw_number
operator|=
...
name|INADDR_BROADCAST
expr_stmt|;
comment|/* Build and apply specific part of the rules */
name|rule
operator|.
name|fw_src
operator|=
...
begin_comment
comment|/* Remove a hole in a firewall associated with a particular alias    link.  Calling this too often is harmless. */
end_comment
