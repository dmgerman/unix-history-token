...
condition|)
block|{
comment|/*  		 * We still had not determined the protocol 		 * of this packet,now the time to do so. 		 */
switch|switch
condition|(
name|ip
operator|->
...
name|IPPROTO_TCP
case|:
comment|/* 			 * First two shorts in TCP are src/dst ports 			 */
name|proto
operator|=
name|IP_FW_F_TCP
expr_stmt|;
...
name|IPPROTO_UDP
case|:
comment|/* 			 * First two shorts in UDP are src/dst ports 			 */
name|proto
operator|=
name|IP_FW_F_UDP
expr_stmt|;
...
expr_stmt|;
block|}
comment|/* 	 * At this moment we surely know the protocol of this 	 * packet and we'll check if it matches,then proceed futher.. 	 */
if|if
condition|(
name|proto
operator|==
