...
name|AF_INET
condition|)
comment|/* 					 * Next interface adress. 					 * This is continue for  					 * local "for" 					 */
continue|continue;
name|ia_i
operator|.
name|s_addr
...
block|{
comment|/* 			 * No special "via" adress set 			 * or interface from which packet 			 * came unknown so match anyway 			 */
goto|goto
name|via_match
goto|;
block|}
comment|/*	 		 * Skip to next firewall entry - via  		 * address did not matched. 		 */
continue|continue;
name|via_match
label|:
name|f_prt
