...
begin_comment
comment|/*  * System call switch table.  *  * DO NOT EDIT-- this file is automatically generated.  * $FreeBSD$  * created from FreeBSD: src/sys/compat/freebsd32/syscalls.master,v 1.24 2003/08/22 22:51:48 peter Exp   */
end_comment
...
name|compat4
argument_list|(
argument|AS(freebsd4_freebsd32_sigaction_args)
argument_list|,
