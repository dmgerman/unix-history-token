...
begin_comment
comment|/*  * System call switch table.  *  * DO NOT EDIT-- this file is automatically generated.  * $FreeBSD$  * created from FreeBSD: src/sys/compat/freebsd32/syscalls.master,v 1.40.2.5 2005/07/14 19:08:22 jhb Exp   */
end_comment
...
name|compat4
argument_list|(
argument|AS(freebsd4_freebsd32_getfsstat_args)
argument_list|,
argument|freebsd32_getfsstat
argument_list|)
block|}
block|,
...
block|}
block|,
comment|/* 52 = obsolete osigpending */
block|{
name|SYF_MPSAFE
operator||
name|AS
...
name|compat4
argument_list|(
argument|AS(freebsd4_freebsd32_statfs_args)
argument_list|,
argument|freebsd32_statfs
argument_list|)
block|}
block|,
...
name|compat4
argument_list|(
argument|AS(freebsd4_freebsd32_fstatfs_args)
argument_list|,
argument|freebsd32_fstatfs
argument_list|)
block|}
block|,
...
name|compat4
argument_list|(
argument|AS(freebsd4_freebsd32_fhstatfs_args)
argument_list|,
argument|freebsd32_fhstatfs
argument_list|)
block|}
block|,
...
name|compat4
argument_list|(
argument|SYF_MPSAFE | AS(freebsd4_freebsd32_sendfile_args)
argument_list|,
argument|freebsd32_sendfile
argument_list|)
block|}
block|,
...
name|compat4
argument_list|(
argument|SYF_MPSAFE | AS(freebsd4_freebsd32_sigaction_args)
argument_list|,
argument|freebsd32_sigaction
argument_list|)
block|}
block|,
...
name|compat4
argument_list|(
argument|SYF_MPSAFE | AS(freebsd4_freebsd32_sigreturn_args)
argument_list|,
argument|freebsd32_sigreturn
argument_list|)
block|}
block|,
