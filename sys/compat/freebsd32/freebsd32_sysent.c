...
begin_comment
comment|/*  * System call switch table.  *  * DO NOT EDIT-- this file is automatically generated.  * $FreeBSD$  * created from FreeBSD: stable/7/sys/compat/freebsd32/syscalls.master 196006 2009-07-31 20:32:55Z jhb   */
end_comment
...
block|}
block|,
comment|/* 220 = freebsd7_freebsd32_semctl */
block|{
name|AS
argument_list|(
name|semget_args
...
block|}
block|,
comment|/* 224 = freebsd7_freebsd32_msgctl */
block|{
name|AS
argument_list|(
name|msgget_args
...
block|}
block|,
comment|/* 229 = freebsd7_freebsd32_shmctl */
block|{
name|AS
argument_list|(
name|shmdt_args
