...
begin_comment
comment|/*  * APM (Advanced Power Management) BIOS Device Driver  *  * Copyright (c) 1994 UKAI, Fumitoshi.  * Copyright (c) 1994-1995 by HOSOKAWA, Tatsumi<hosokawa@mt.cs.keio.ac.jp>  *  * This software may be used, modified, copied, and distributed, in  * both source and binary form provided that the above copyright and  * these terms are retained. Under no circumstances is the author  * responsible for the proper functioning of this software, nor does  * the author assume any responsibility for damages incurred with its  * use.  *  * Sep, 1994	Implemented on FreeBSD 1.1.5.1R (Toshiba AVS001WD)  *  *	$Id: apm.c,v 1.17 1995/11/29 10:47:13 julian Exp $  */
end_comment
...
include|#
directive|include
file|<i386at/apm_bios.h>
end_include

begin_include
include|#
directive|include
file|<i386at/apm_setup.h>
end_include

begin_include
include|#
directive|include
file|<i386at/apm_segments.h>
end_include
