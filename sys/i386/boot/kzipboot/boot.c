...
begin_endif
unit|inline void outb (unsigned short x, unsigned char y) { 	asm volatile ("outb %0, %1" : : "a" (y) , "d" (x)); }  inline unsigned char inb (unsigned short x, unsigned char y) { 	asm volatile ("inb %0, %1" : : "a" (y) , "d" (x)); }
endif|#
directive|endif
end_endif
