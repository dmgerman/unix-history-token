...
begin_comment
comment|/* static inline unsigned short inw(a) 	unsigned short a; { 	unsigned char d; 	asm volatile( "inw %1, %0" : "=a" (d) : "d" (a)); 	return d; }  static inline unsigned char inb(a) 	unsigned short a; { 	unsigned char d; 	asm volatile( "inb %1, %0" : "=a" (d) : "d" (a)); 	return d; }  static inline void outw(a,d) 	unsigned short a; 	unsigned short d; { 	asm volatile( "outw %0, %1" : : "a" (d), "d" (a)); }  static inline void outb(a,d) 	unsigned short a; 	unsigned char d; { 	asm volatile( "outb %0, %1" : : "a" (d), "d" (a)); } */
end_comment
