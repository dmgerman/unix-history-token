...
name|scbp
expr_stmt|;
comment|/* 				 * Initialize the host memory location  				 * of this SCB down on the board and 				 * flag that it should be DMA's before  				 * reference. 				 */
name|scbp
operator|->
name|control
operator|=
