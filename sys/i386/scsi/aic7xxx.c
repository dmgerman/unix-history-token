...
literal|"%sMB/s transfers, but adapter "
literal|"in Ultra mode can only sync at "
literal|"10MB/s or above\n"
argument_list|,
name|unit
argument_list|,
name|target
...
name|printf
argument_list|(
literal|"ahc%d: scb %d bytes; ahc_dma %d bytes\n"
argument_list|,
name|unit
argument_list|,
sizeof|sizeof
...
operator|)
condition|)
comment|/* Treat it like a normal card */
name|ahc
operator|->
name|type
operator|&=
...
name|printf
argument_list|(
literal|"ahc%d: Using Level Sensitive Interrupts\n"
argument_list|,
name|unit
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"ahc%d: Using Edge Triggered Interrupts\n"
argument_list|,
name|unit
argument_list|)
expr_stmt|;
