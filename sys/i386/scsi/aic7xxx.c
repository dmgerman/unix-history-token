...
begin_comment
comment|/*  * Generic driver for the aic7xxx based adaptec SCSI controllers  * Copyright (c) 1994, 1995, 1996 Justin T. Gibbs.  * All rights reserved.  *  * Product specific probe and attach routines can be found in:  * i386/eisa/aic7770.c	27/284X and aic7770 motherboard controllers  * pci/aic7870.c	3940, 2940, aic7870 and aic7850 controllers  *  * Portions of this driver are based on the FreeBSD 1742 Driver:  *  * Written by Julian Elischer (julian@tfs.com)  * for TRW Financial Systems for use under the MACH(2.5) operating system.  *  * TRW Financial Systems, in accordance with their agreement with Carnegie  * Mellon University, makes this software available to CMU to distribute  * or use in any manner that they see fit as long as this message is kept with  * the software. For this reason TFS also grants any other persons or  * organisations permission to use or modify this software.  *  * TFS supplies this software to be publicly redistributed  * on the understanding that TFS is not responsible for the correct  * functioning of this software in any circumstances.  *  * commenced: Sun Sep 27 18:14:01 PDT 1992  *  *      $Id: aic7xxx.c,v 1.59 1996/03/23 11:29:20 phk Exp $  */
end_comment
...
begin_comment
comment|/* Send an SCB down to the card via PIO maintaining the SCB pointer */
end_comment
...
name|printf
argument_list|(
literal|"ahc%d: Someone reset channel %c\n"
argument_list|,
name|channel
argument_list|)
expr_stmt|;
...
break|break;
block|}
comment|/* 		 * Now go backward from i so we can detect odd 		 * SCB configurations (like the aic7850 which 		 * has 3). 		 */
name|j
operator|=
name|i
operator|>>
...
name|panic
argument_list|(
literal|"ahc%d: Timed-out command times out "
literal|"again\n"
argument_list|,
name|ahc
operator|->
...
name|printf
argument_list|(
literal|"asserted ATN - device reset in message buffer\n"
argument_list|)
expr_stmt|;
name|active_scbp
operator|->
...
block|{
comment|/* No active target?  Try reseting the bus */
name|char
name|channel
init|=
operator|(
