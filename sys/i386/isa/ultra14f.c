...
block|,
comment|/* state */
literal|"UltraStore 14F or 34F SCSI host adapter"
block|,
name|DC_CLS_MISC
...
name|printf
argument_list|(
literal|"uha%d: uha_send_mbox, board not responding\n"
argument_list|,
name|unit
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"uha%d: uha_abort, board not responding\n"
argument_list|,
name|unit
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"uha%d: uha_poll, board not responding\n"
argument_list|,
name|unit
argument_list|)
expr_stmt|;
