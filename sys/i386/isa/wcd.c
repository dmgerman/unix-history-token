...
argument_list|)
expr_stmt|;
comment|/* Decrement the total length of the disc. 	 * Some drives (e.g. Sony-55E) have this value too big. */
operator|--
name|t
operator|->
name|toc
