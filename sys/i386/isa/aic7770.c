...
return|;
block|}
comment|/* Number of SCBs that will be used.  Supposedly some newer rev 	 * aic7770s have more than four so maybe we can detect this in 	 * the future. 	 */
name|printf
argument_list|(
literal|"%d SCBs, "
argument_list|,
