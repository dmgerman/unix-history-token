...
begin_comment
comment|/*  * $Id: if_ed.c,v 1.37 1994/04/13 10:15:34 davidg Exp $  */
end_comment
...
directive|else
comment|/* 	 * Tell RCR to do nothing for now. 	 */
name|outb
argument_list|(
name|sc
operator|->
...
condition|)
block|{
comment|/* 			 * Set promiscuous mode. 			 * Also reconfigure the multicast filter. 			 */
name|int
name|j
decl_stmt|;
name|i
