...
begin_comment
comment|/*-  * spkr.c -- device driver for console speaker  *  * v1.4 by Eric S. Raymond (esr@snark.thyrsus.com) Aug 1993  * modified for FreeBSD by Andrew A. Chernov<ache@astral.msk.su>  * modified for PC98 by Kakefuda  */
end_comment
...
begin_comment
comment|/*  * Install placeholder to claim the resources owned by the  * AT tone generator.  */
end_comment
...
operator|)
return|;
comment|/* Not configured by hints. */
if|if
condition|(
name|strncmp
argument_list|(
