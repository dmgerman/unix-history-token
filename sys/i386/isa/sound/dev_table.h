...
begin_comment
comment|/* 	linux/kernel/chr_drv/sound/dev_table.h  	Global definitions for device call tables  	(C) Hannu Savolainen 1992  	 See COPYING for further details. Should be distributed with this file.  */
end_comment
