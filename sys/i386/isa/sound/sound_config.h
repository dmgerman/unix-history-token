...
begin_comment
comment|/* linux/kernel/chr_drv/sound/sound-config.h  A driver for Soundcards, misc configuration parameters.  (C) 1992  Hannu Savolainen (hsavolai@cs.helsinki.fi) */
end_comment
...
begin_comment
comment|/* UWM ... note add new MIDI devices here..    *  Also do not forget to add table midi_supported[]  *  Minor numbers for on-chip midi devices start from 15.. and   *  should be contiguous.. viz. 15,16,17....  *  Also note the max # of midi devices as MAX_MIDI_DEV  */
end_comment
