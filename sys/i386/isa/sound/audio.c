...
begin_comment
comment|/*  * linux/kernel/chr_drv/sound/audio.c  *   * Device file manager for /dev/audio  *   * (C) 1992  Hannu Savolainen (hsavolai@cs.helsinki.fi) See COPYING for further  * details. Should be distributed with this file.  */
end_comment
