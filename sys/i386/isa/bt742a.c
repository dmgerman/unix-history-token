...
name|printf
argument_list|(
literal|"bt%d: **probing for scsi devices**\n"
argument_list|,
name|unit
argument_list|)
expr_stmt|;
...
directive|ifdef
name|HE
comment|/* Get the Target OUT mail Box pointer */
name|wmbx
operator|=
operator|&
name|bt_mbx
...
argument_list|)
expr_stmt|;
comment|/* Set the OUT mail Box pointer for next */
name|bt_nextmbx
argument_list|(
name|wmbo
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/***********************************************\ 	* Set Pointer chain null for just in case       * 	* Link the ccb's into a free-list W/O mbox	* 	* Initilize Mail Box stat to Free               * 	\***********************************************/
if|if
condition|(
name|bt_ccb_free
index|[
...
expr_stmt|;
block|}
comment|/***********************************************\ 	* Set up Initial mail box for round-robin       * 	\***********************************************/
name|bt_mbx
index|[
name|unit
index|]
...
argument_list|)
expr_stmt|;
comment|/*  Enable round-robin scheme - appeared at FirmWare 3.31 */
name|bt_cmd
argument_list|(
name|unit
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/*  Ask setup information to Bt742 */
name|bt_cmd
argument_list|(
name|unit
argument_list|,
