...
begin_comment
comment|/*  * Written by Julian Elischer (julian@tfs.com)  * for TRW Financial Systems for use under the MACH(2.5) operating system.  *  * TRW Financial Systems, in accordance with their agreement with Carnegie  * Mellon University, makes this software available to CMU to distribute  * or use in any manner that they see fit as long as this message is kept with  * the software. For this reason TFS also grants any other persons or  * organisations permission to use or modify this software.  *  * TFS supplies this software to be publicly redistributed  * on the understanding that TFS is not responsible for the correct  * functioning of this software in any circumstances.  *  *      $Id: bt742a.c,v 1.36.4.1 1995/08/31 06:17:11 davidg Exp $  */
end_comment
...
literal|"Buslogic 742-compatible SCSI host adapter"
block|,
name|DC_CLS_MISC
...
literal|0xFFF
condition|)
comment|/*  an EISA card, we have an EISA port */
block|{
name|int
name|i
init|=
...
name|printf
argument_list|(
literal|"bt_iobase disabled or invalid; index %d\n"
argument_list|,
name|i
operator|&
literal|7
...
name|printf
argument_list|(
literal|"btprobe: Trying iobase 0x%x\n"
argument_list|,
name|dev
operator|->
name|dev_addr
