...
begin_comment
comment|/*  * (Mostly) Written by Julian Elischer (julian@tfs.com)  * for TRW Financial Systems for use under the MACH(2.5) operating system.  *  * TRW Financial Systems, in accordance with their agreement with Carnegie  * Mellon University, makes this software available to CMU to distribute  * or use in any manner that they see fit as long as this message is kept with  * the software. For this reason TFS also grants any other persons or  * organisations permission to use or modify this software.  *  * TFS supplies this software to be publicly redistributed  * on the understanding that TFS is not responsible for the correct  * functioning of this software in any circumstances.  *  *      $Id: aha1542.c,v 1.78 1998/06/21 14:53:07 bde Exp $  */
end_comment
...
name|x
parameter_list|)
value|((intptr_t)(((long int)(x)) ^ aha->kv_phys_xor))
end_define
...
argument_list|)
expr_stmt|;
comment|/* 	 * put the test data into the buffer and calculate 	 * its address. Read it onto the board 	 */
name|scsi_uto3b
argument_list|(
name|KVTOPHYS
argument_list|(
