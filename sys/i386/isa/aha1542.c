...
name|printf
argument_list|(
literal|"aha over under: resid %d error %d.\n"
argument_list|,
name|xs
operator|->
name|resid
...
name|cmdlen
expr_stmt|;
comment|/* Some devices (e.g, Microtek ScanMaker II) 	 * fall on the ground if you ask for anything but 	 * an exact number of sense bytes (wiping out the 	 * sense data) 	 */
name|ccb
operator|->
name|req_sense_length
operator|=
