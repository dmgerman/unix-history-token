...
begin_comment
comment|/*  * National Semiconductor DS8390 NIC register definitions   *  * if_edreg.h,v  * Revision 1.1.2.1  1993/07/21  13:50:04  cgd  * from davidg:  *    Added config file override for memory size and added flags to force  * 8bit or 16bit operation, and a flag to disable transmitter double buffering.  *    See the updated "ed.relnotes" file for information about how to set  * the flags.  *    This should be considered the first "production"  release. It still  * needs a manual page, though.  *  * Revision 1.1  1993/07/03  12:21:07  cgd  * add support for David Greenman "ed" driver  *  * Revision 1.2  93/06/23  03:03:05  davidg  * added some additional definitions for the 83C584 bus interface  * chip (SMC/WD boards)  *   * Revision 1.1  93/06/23  03:01:07  davidg  * Initial revision  *   */
end_comment
...
define|#
directive|define
name|ZE_FLAGS_FORCE_16BIT_MODE
value|0x04
end_define
...
define|#
directive|define
name|ZE_FLAGS_NO_DOUBLE_BUFFERING
value|0x08
end_define

begin_comment
comment|/*  * definitions for IBM credit card adapter for ethernet  */
end_comment
