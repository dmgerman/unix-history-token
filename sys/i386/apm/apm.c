...
begin_comment
comment|/*  * LP (Laptop Package)  *   * Copyright (c) 1994 by HOSOKAWA, Tatsumi<hosokawa@mt.cs.keio.ac.jp>  *  * This software may be used, modified, copied, and distributed, in  * both source and binary form provided that the above copyright and  * these terms are retained. Under no circumstances is the author   * responsible for the proper functioning of this software, nor does   * the author assume any responsibility for damages incurred with its   * use.  *  * Sep, 1994	Implemented on FreeBSD 1.1.5.1R (Toshiba AVS001WD)  *  *	$Id: apm.c,v 1.3 1994/10/01 05:12:22 davidg Exp $  */
end_comment
...
directive|if
literal|0
block|int	pl; 	pl = splhigh(); 	sync(curproc, NULL, NULL); 	splx(pl);
endif|#
directive|endif
name|microtime
argument_list|(
...
name|printf
argument_list|(
literal|"Called apm_suspend_resume();\n"
argument_list|)
expr_stmt|;
endif|#
directive|endif
