...
begin_comment
comment|/*  * Written by Paul Popelka (paulp@uts.amdahl.com)  *   * You can do anything you want with this software, just don't say you wrote  * it, and don't remove this notice.  *   * This software is provided "as is".  *   * The author supplies this software to be publicly redistributed on the  * understanding that the author is not responsible for the correct  * functioning of this software in any circumstances and is not liable for  * any damages caused by this software.  *   * October 1992  *   *	from NetBSD:	msdosfs_fat.c,v 1.2 1993/12/18 00:51:02 mycroft Exp  *	$Id: msdosfs_fat.c,v 1.1 1994/01/24 06:04:54 rgrimes Exp $  */
end_comment
...
begin_comment
comment|/*  * Once the first fat is updated the other copies of the fat must also be  * updated.  This function does this. pmp - msdosfsmount structure for  * filesystem to update bp - addr of modified fat block fatbn - block  * number relative to begin of filesystem of the modified fat block.  */
end_comment
...
begin_comment
comment|/*  * Get or Set or 'Get and Set' the cluster'th entry in the fat. function -  * whether to get or set a fat entry pmp - address of the msdosfsmount  * structure for the filesystem whose fat is to be manipulated. cluster -  * which cluster is of interest oldcontents - address of a word that is to  * receive the contents of the cluster'th entry if this is a get function  * newcontents - the new value to be written into the cluster'th element of  * the fat if this is a set function.  *   * This function can also be used to free a cluster by setting the fat entry  * for a cluster to 0.  *   * All copies of the fat are updated if this is a set function. NOTE: If  * fatentry() marks a cluster as free it does not update the inusemap in  * the msdosfsmount structure. This is left to the caller.  */
end_comment
