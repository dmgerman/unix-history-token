...
argument_list|,
operator|(
literal|"Destroying RPC client with pending RPC requests"
operator|)
argument_list|)
expr_stmt|;
if|if
...
condition|)
block|{
comment|/* 						 * This one 						 * matches. We snip it 						 * out of the pending 						 * list and leave the 						 * reply mbuf in 						 * cr->cr_mrep. Set 						 * the XID to zero so 						 * that clnt_vc_call 						 * can know not to 						 * repeat the 						 * TAILQ_REMOVE. 						 */
name|TAILQ_REMOVE
argument_list|(
operator|&
name|ct
