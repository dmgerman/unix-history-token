...
begin_comment
comment|/*  * A cut-down version of the GSS-API for in-kernel use  */
end_comment
...
begin_comment
comment|/*  * On entry, *numgroups is set to the maximum number of groups to return. On exit, *numgroups is set to the actual number of groups returned.  */
end_comment
...
name|gidp
parameter_list|,
comment|/* pointer to GID for result */
name|int
modifier|*
name|numgroups
parameter_list|,
...
modifier|*
name|groups
comment|/* pointer to group list */
parameter_list|)
function_decl|;
end_function_decl

begin_comment
comment|/*  * Mbuf oriented message signing and encryption.  *  * Get_mic allocates an mbuf to hold the message checksum. Verify_mic  * may modify the passed-in mic but will not free it.  *  * Wrap and unwrap  * consume the message and generate a new mbuf chain with the  * result. The original message is freed on error.  */
end_comment
