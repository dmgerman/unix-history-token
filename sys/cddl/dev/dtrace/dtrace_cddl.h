...
begin_comment
comment|/*  * Definitions for fields in struct proc which are named differntly in FreeBSD.  */
end_comment
...
begin_comment
comment|/*  * Definitions for fields in struct thread which are named differntly in FreeBSD.  */
end_comment
