...
value|(0x40d<< AARCH64_BRK_IMM16_SHIFT)
end_define
...
operator|)
expr_stmt|;
comment|/* Look for stp (pre-indexed) operation */
for|for
control|(
init|;
name|instr
