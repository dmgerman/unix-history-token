...
name|ZFS_TYPE_VOLUME
argument_list|,
literal|"standard | always | disabled"
argument_list|,
literal|"SYNC"
argument_list|,
name|sync_table
...
index|]
decl_stmt|;
comment|/* The mlslabel property is never delegatable. */
if|if
condition|(
name|prop
operator|==
...
begin_comment
comment|/*  * Returns true if this is a valid written@ property.  * Note that after the @, any character is valid (eg, another @, for  * written@pool/fs@origin).  */
end_comment
