...
parameter_list|)
function_decl|;
comment|/*  * Return B_TRUE if there are zero nodes in the tree, B_FALSE otherwise.  */
specifier|extern
name|boolean_t
name|avl_is_empty
parameter_list|(
