...
name|dte_needed
decl_stmt|;
comment|/* bytes needed */
name|size_t
name|dte_size
decl_stmt|;
comment|/* total size of payload */
name|dtrace_predicate_t
modifier|*
name|dte_predicate
decl_stmt|;
