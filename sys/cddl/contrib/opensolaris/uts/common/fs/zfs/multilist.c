...
begin_comment
comment|/*  * Allocate a new multilist, using the default number of sublists  * (the number of CPUs, or at least 4, or the tunable  * zfs_multilist_num_sublists).  */
end_comment
...
begin_comment
comment|/* Lock and return the sublist that would be used to store the specified obj */
end_comment
