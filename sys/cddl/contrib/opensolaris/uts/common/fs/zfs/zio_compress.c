...
decl_stmt|;
name|kstat_named_t
name|zcompstat_skipped_minblocksize
decl_stmt|;
name|kstat_named_t
...
return|;
block|}
comment|/* 	 * Cool.  We compressed at least as much as we were hoping to. 	 * For both security and repeatability, pad out the last sector. 	 */
name|r_len
operator|=
name|P2ROUNDUP
argument_list|(
