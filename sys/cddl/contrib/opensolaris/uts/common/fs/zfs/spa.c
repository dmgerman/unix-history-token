...
begin_comment
comment|/*  * Load the slog device state from the config object since it's possible  * that the label does not contain the most up-to-date information.  */
end_comment

begin_function
name|void
name|spa_load_log_state
parameter_list|(
name|spa_t
modifier|*
name|spa
