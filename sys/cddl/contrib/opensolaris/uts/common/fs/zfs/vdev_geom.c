...
begin_struct
struct|struct
name|consumer_vdev_elem
block|{
name|SLIST_ENTRY
argument_list|(
argument|consumer_vdev_elem
argument_list|)
name|elems
expr_stmt|;
name|vdev_t
...
argument_list|)
argument_list|,
literal|"consumer_priv_t* can't be stored in g_consumer.private"
argument_list|)
assert|;
end_assert
...
argument_list|)
expr_stmt|;
comment|/* Set other GEOM characteristics */
name|vdev_geom_set_physpath
argument_list|(
name|vd
argument_list|,
...
break|break;
block|}
comment|/* 	 * We have to split bio freeing into two parts, because the ABD code 	 * cannot be called in this context and vdev_op_io_done is not called 	 * for ZIO_TYPE_IOCTL zio-s. 	 */
if|if
condition|(
name|zio
operator|->
