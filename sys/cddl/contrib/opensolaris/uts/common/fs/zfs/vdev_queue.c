...
name|TUNABLE_INT
argument_list|(
literal|"vfs.zfs.vdev.async_write_active_min_dirty_percent"
argument_list|,
operator|&
name|zfs_vdev_async_write_active_min_dirty_percent
argument_list|)
...
name|TUNABLE_INT
argument_list|(
literal|"vfs.zfs.vdev.async_write_active_max_dirty_percent"
argument_list|,
operator|&
name|zfs_vdev_async_write_active_max_dirty_percent
argument_list|)
...
parameter_list|)
define|\
value|TUNABLE_INT("vfs.zfs.vdev." #name "_min_active",			\&zfs_vdev_ ## name ## _min_active);					\ SYSCTL_UINT(_vfs_zfs_vdev, OID_AUTO, name ## _min_active,		\     CTLFLAG_RWTUN,&zfs_vdev_ ## name ## _min_active, 0,		\     "Initial number of I/O requests of type " #name			\     " active for each device");
end_define
...
parameter_list|)
define|\
value|TUNABLE_INT("vfs.zfs.vdev." #name "_max_active",			\&zfs_vdev_ ## name ## _max_active);					\ SYSCTL_UINT(_vfs_zfs_vdev, OID_AUTO, name ## _max_active,		\     CTLFLAG_RWTUN,&zfs_vdev_ ## name ## _max_active, 0,		\     "Maximum number of I/O requests of type " #name			\     " active for each device");
end_define
