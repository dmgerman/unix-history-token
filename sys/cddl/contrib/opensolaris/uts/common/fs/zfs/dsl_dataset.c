...
operator|)
return|;
comment|/* 	 * If we made changes this txg, traverse_dataset won't find 	 * them.  Try again. 	 */
if|if
condition|(
name|ds
operator|->
...
expr_stmt|;
block|{
comment|/* 		 * Free blkptrs that we gave birth to - this covers 		 * claimed but not played log blocks too. 		 */
name|zio_t
modifier|*
name|zio
decl_stmt|;
