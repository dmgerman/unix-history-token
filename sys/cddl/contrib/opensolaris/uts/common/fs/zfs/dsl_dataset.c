...
begin_comment
comment|/*  * Copyright (c) 2005, 2010, Oracle and/or its affiliates. All rights reserved.  * Portions Copyright (c) 2011 Martin Matuska<mm@FreeBSD.org>  * Copyright (c) 2011, 2014 by Delphix. All rights reserved.  * Copyright (c) 2014, Joyent, Inc. All rights reserved.  * Copyright (c) 2014 RackTop Systems.  * Copyright (c) 2014 Spectra Logic Corporation, All rights reserved.  */
end_comment
...
specifier|static
name|int
name|dsl_dataset_activate_large_blocks_check
parameter_list|(
name|void
modifier|*
name|arg
...
specifier|static
name|void
name|dsl_dataset_activate_large_blocks_sync
parameter_list|(
name|void
modifier|*
name|arg
...
argument_list|)
expr_stmt|;
comment|/* 	 * EALREADY indicates that this dataset already supports large blocks. 	 */
if|if
condition|(
name|error
operator|==
