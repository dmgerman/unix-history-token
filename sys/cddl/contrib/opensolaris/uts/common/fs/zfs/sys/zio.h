...
define|\
value|(ZIO_FLAG_CANFAIL |		\ 	ZIO_FLAG_SPECULATIVE |		\ 	ZIO_FLAG_CONFIG_WRITER |	\ 	ZIO_FLAG_DONT_RETRY |		\ 	ZIO_FLAG_DONT_CACHE |		\ 	ZIO_FLAG_DONT_AGGREGATE |	\ 	ZIO_FLAG_RESILVER |		\ 	ZIO_FLAG_SCRUB |		\ 	ZIO_FLAG_SCRUB_THREAD)
define|#
directive|define
name|ZIO_FLAG_VDEV_INHERIT
define|\
value|(ZIO_FLAG_GANG_INHERIT |	\ 	ZIO_FLAG_IO_REPAIR |		\ 	ZIO_FLAG_IO_RETRY |		\ 	ZIO_FLAG_PROBE)
define|#
directive|define
