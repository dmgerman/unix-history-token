...
begin_comment
comment|/*  * ==========================================================================  * Reexecute, cancel, or suspend/resume failed I/O  * ==========================================================================  */
end_comment
...
parameter_list|)
block|{
comment|/* 	 * Disallow cancellation of a zio that's already been issued. 	 */
name|VERIFY3P
argument_list|(
name|zio
operator|->
...
name|zfs_dbgmsg
argument_list|(
literal|"%s: zil block allocation failure: "
literal|"size %llu, error %d"
argument_list|,
name|spa_name
argument_list|(
