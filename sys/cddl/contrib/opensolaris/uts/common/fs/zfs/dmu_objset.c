...
decl_stmt|;
name|boolean_t
name|saa_needsuspend
decl_stmt|;
name|nvlist_t
modifier|*
name|saa_props
decl_stmt|;
comment|/* the following are used only if 'temporary' is set: */
name|boolean_t
name|saa_temporary
decl_stmt|;
specifier|const
...
name|soa_longname
decl_stmt|;
comment|/* long snap name */
specifier|const
name|char
modifier|*
name|soa_snapname
decl_stmt|;
comment|/* short snap name */
name|snapallarg_t
modifier|*
name|soa_saa
decl_stmt|;
...
operator|)
return|;
comment|/* 	 * If the objset is in an inconsistent state (eg, in the process 	 * of being destroyed), don't snapshot it. 	 */
if|if
condition|(
name|os
operator|->
...
block|}
block|}
comment|/* 	 * If any call to snapshot_one_impl() failed, don't execute the 	 * sync task.  The error handling code below will clean up the 	 * snaponearg_t from any successful calls to 	 * snapshot_one_impl(). 	 */
if|if
condition|(
name|rv
operator|==
