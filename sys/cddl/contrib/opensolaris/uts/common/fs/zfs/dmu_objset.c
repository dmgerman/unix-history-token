...
expr_stmt|;
block|}
comment|/* 		 * If the object was not previously 		 * accounted, pretend that it was free. 		 */
if|if
condition|(
operator|!
operator|(
...
expr_stmt|;
block|}
comment|/* 		 * If the object was freed, use the previous bonustype. 		 */
name|bonustype
operator|=
name|dn
operator|->
...
operator|)
expr_stmt|;
comment|/* 		 * The mutex is needed here for interlock with dnode_allocate. 		 */
name|mutex_enter
argument_list|(
operator|&
name|dn
