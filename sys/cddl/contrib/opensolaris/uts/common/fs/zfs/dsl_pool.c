...
argument_list|)
expr_stmt|;
comment|/* 	 * We need to copy dp_space_towrite() before doing 	 * dsl_sync_task_sync(), because 	 * dsl_dataset_snapshot_reserve_space() will increase 	 * dp_space_towrite but not actually write anything. 	 */
name|data_written
operator|=
name|dp
operator|->
