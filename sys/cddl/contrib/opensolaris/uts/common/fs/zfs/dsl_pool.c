...
begin_endif
unit|TUNABLE_INT("vfs.zfs.no_write_throttle",&zfs_no_write_throttle); SYSCTL_INT(_vfs_zfs, OID_AUTO, no_write_throttle, CTLFLAG_RDTUN,&zfs_no_write_throttle, 0, ""); TUNABLE_INT("vfs.zfs.write_limit_shift",&zfs_write_limit_shift); SYSCTL_INT(_vfs_zfs, OID_AUTO, write_limit_shift, CTLFLAG_RDTUN,&zfs_write_limit_shift, 0, "2^N of physical memory"); SYSCTL_DECL(_vfs_zfs_txg); TUNABLE_INT("vfs.zfs.txg.synctime_ms",&zfs_txg_synctime_ms); SYSCTL_INT(_vfs_zfs_txg, OID_AUTO, synctime_ms, CTLFLAG_RDTUN,&zfs_txg_synctime_ms, 0, "Target milliseconds to sync a txg");  TUNABLE_QUAD("vfs.zfs.write_limit_min",&zfs_write_limit_min); SYSCTL_QUAD(_vfs_zfs, OID_AUTO, write_limit_min, CTLFLAG_RDTUN,&zfs_write_limit_min, 0, "Minimum write limit"); TUNABLE_QUAD("vfs.zfs.write_limit_max",&zfs_write_limit_max); SYSCTL_QUAD(_vfs_zfs, OID_AUTO, write_limit_max, CTLFLAG_RDTUN,&zfs_write_limit_max, 0, "Maximum data payload per txg"); TUNABLE_QUAD("vfs.zfs.write_limit_inflated",&zfs_write_limit_inflated); SYSCTL_QUAD(_vfs_zfs, OID_AUTO, write_limit_inflated, CTLFLAG_RDTUN,&zfs_write_limit_inflated, 0, "Maximum size of the dynamic write limit"); TUNABLE_QUAD("vfs.zfs.write_limit_override",&zfs_write_limit_override); SYSCTL_QUAD(_vfs_zfs, OID_AUTO, write_limit_override, CTLFLAG_RDTUN,&zfs_write_limit_override, 0,     "Force a txg if dirty buffers exceed this value (bytes)");
endif|#
directive|endif
end_endif
