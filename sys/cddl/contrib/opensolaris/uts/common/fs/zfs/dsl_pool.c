...
begin_decl_stmt
name|int
name|zfs_zil_clean_taskq_minalloc
init|=
literal|1024
decl_stmt|;
end_decl_stmt
...
begin_decl_stmt
name|int
name|zfs_zil_clean_taskq_maxalloc
init|=
literal|1024
operator|*
literal|1024
...
specifier|static
name|int
name|sysctl_zfs_dirty_data_max_percent
parameter_list|(
...
specifier|static
name|int
name|sysctl_zfs_delay_min_dirty_percent
parameter_list|(
name|SYSCTL_HANDLER_ARGS
parameter_list|)
function_decl|;
...
begin_comment
comment|/* No zfs_delay_min_dirty_percent tunable due to limit requirements */
end_comment
...
begin_comment
comment|/* No zfs_delay_scale tunable due to limit requirements */
end_comment
...
literal|"QU"
argument_list|,
literal|"Controls how quickly the delay approaches infinity"
argument_list|)
expr_stmt|;
end_expr_stmt
