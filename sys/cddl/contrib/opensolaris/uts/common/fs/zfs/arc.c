...
specifier|static
name|int
name|sysctl_vfs_zfs_arc_no_grow_shift
parameter_list|(
name|SYSCTL_HANDLER_ARGS
parameter_list|)
function_decl|;
...
name|TUNABLE_INT
argument_list|(
literal|"vfs.zfs.arc_grow_retry"
argument_list|,
operator|&
name|zfs_arc_grow_retry
argument_list|)
...
name|TUNABLE_INT
argument_list|(
literal|"vfs.zfs.arc_no_grow_shift"
argument_list|,
operator|&
name|zfs_arc_no_grow_shift
argument_list|)
...
literal|"U"
argument_list|,
literal|"log2(fraction of ARC which must be free to allow growing)"
argument_list|)
expr_stmt|;
end_expr_stmt
...
literal|0
argument_list|,
literal|"Wait in seconds before considering growing ARC"
argument_list|)
expr_stmt|;
end_expr_stmt
