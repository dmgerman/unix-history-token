...
begin_comment
comment|/* default before pagedaemon init only */
end_comment
...
directive|ifdef
name|__i386__
comment|/* i386 has KVA limits that the raw page counts above don't consider */
if|if
condition|(
name|kmem_used
argument_list|()
