...
define|#
directive|define
name|L2ARC_FEED_SECS_SHIFT
value|1
end_define

begin_comment
comment|/* caching interval shift */
end_comment
...
begin_comment
comment|/* interval seconds shift */
end_comment
...
literal|0
argument_list|,
literal|"power of 2 division of feed seconds"
argument_list|)
expr_stmt|;
end_expr_stmt
...
condition|)
block|{
comment|/* 				 * we're draining the ARC, retry 				 */
name|mutex_exit
argument_list|(
name|lock
argument_list|)
