...
decl_stmt|;
block|}
name|dsl_props_arg_t
typedef|;
typedef|typedef
struct|struct
name|dsl_prop_set_arg
block|{
specifier|const
name|char
modifier|*
...
name|psa_value
decl_stmt|;
comment|/* 	 * Used to handle the special requirements of the quota and reservation 	 * properties. 	 */
name|uint64_t
...
parameter_list|)
define|\
value|dsl_prop_check_prediction((dd), (psa))
else|#
directive|else
define|#
directive|define
...
directive|endif
comment|/* flag first receive on or after SPA_VERSION_RECVD_PROPS */
name|boolean_t
