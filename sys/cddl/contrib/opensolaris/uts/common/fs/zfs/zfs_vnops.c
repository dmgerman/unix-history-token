...
argument_list|,
operator|(
literal|"zfs update_pages: NULL page in putpages case"
operator|)
argument_list|)
expr_stmt|;
name|KASSERT
...
argument_list|,
operator|(
literal|"zfs update_pages: unaligned data in putpages case"
operator|)
argument_list|)
expr_stmt|;
name|KASSERT
...
argument_list|,
operator|(
literal|"zfs update_pages: invalid page in putpages case"
operator|)
argument_list|)
expr_stmt|;
name|KASSERT
...
argument_list|,
operator|(
literal|"zfs update_pages: unbusy page in putpages case"
operator|)
argument_list|)
expr_stmt|;
name|KASSERT
