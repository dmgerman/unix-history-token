...
begin_comment
comment|/*  * Copyright (c) 2005, 2010, Oracle and/or its affiliates. All rights reserved.  * Copyright (c) 2012, 2014 by Delphix. All rights reserved.  * Copyright 2013 Nexenta Systems, Inc.  All rights reserved.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* 	 * In case sdzp is not valid, let's be sure to exit from the right 	 * zfsvfs_t. 	 */
if|if
condition|(
name|sdzp
operator|->
