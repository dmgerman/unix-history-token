...
begin_comment
comment|/* We need to provide these but never use them */
end_comment
...
block|{
comment|/* We have a prel31 offset to the unwind table */
name|uint32_t
name|prel31_tbl
init|=
name|db_expand_prel31
...
condition|)
break|break;
comment|/* This is not a kernel address, stop processing */
if|if
condition|(
name|state
operator|->
