...
block|{
comment|/* 			 * If we DID find one then we clobber any routes 			 * dependent on it.. 			 * 			 * XXXRW: While we ref the ifaddr, there are 			 * potential races here still. 			 */
name|ifa_ref
argument_list|(
operator|&
name|aa
