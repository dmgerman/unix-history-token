...
name|sd_arglen
expr_stmt|;
comment|// Program argument data size.
name|MEMBER
argument_list|(
argument|PTR(void)
argument_list|)
...
name|sd_elf_phdrlen
expr_stmt|;
comment|// ELF program header length.
name|MEMBER
argument_list|(
argument|cloudabi_tid_t
argument_list|)
name|sd_thread_id
expr_stmt|;
comment|// Thread ID.
...
name|sd_random_seed
expr_stmt|;
comment|// Random seed, used for SSP.
name|MEMBER
argument_list|(
argument|uint32_t
argument_list|)
