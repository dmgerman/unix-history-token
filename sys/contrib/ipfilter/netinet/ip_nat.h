...
begin_comment
comment|/*  * Copyright (C) 1995-2001 by Darren Reed.  *  * See the IPFILTER.LICENCE file for details on licencing.  *  * @(#)ip_nat.h	1.5 2/4/96  * $Id: ip_nat.h,v 2.17.2.14 2000/11/18 03:58:04 darrenr Exp $  * $FreeBSD$  */
end_comment
...
index|]
decl_stmt|;
comment|/* Aging for NAT entries. Not for TCP */
name|int
name|in_redir
decl_stmt|;
