...
condition|)
block|{
comment|/*              * XXX TODO: this should call ieee80211_mhz2ieee which will              * take care of the up/down conversion and GSM mapping.              * However, the HAL _can't_ call that, so we'll need to              * introduce it in ah_osdep or something.              */
if|#
directive|if
literal|0
...
name|ah
argument_list|,
literal|"%s: unimplemented, implement!\n"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
