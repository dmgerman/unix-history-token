...
name|HAL_DEBUG_BT_COEX
argument_list|,
literal|"%s: called; config=0x%08x\n"
argument_list|,
name|__func__
argument_list|,
name|ah
...
specifier|static
name|void
name|ar9300_mci_set_btcoex_ctrl_9565_1ANT
parameter_list|(
name|struct
name|ath_hal
modifier|*
...
specifier|static
name|void
name|ar9300_mci_set_btcoex_ctrl_9565_2ANT
parameter_list|(
name|struct
name|ath_hal
modifier|*
...
specifier|static
name|void
name|ar9300_mci_set_btcoex_ctrl_9462
parameter_list|(
name|struct
name|ath_hal
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* Set the time out to 3.125ms (5 BT slots) */
name|OS_REG_RMW_FIELD
argument_list|(
name|ah
argument_list|,
...
name|HAL_DEBUG_BT_COEX
argument_list|,
literal|"(MCI) BTCOEX_CTRL = 0xdeadbeef\n"
argument_list|)
expr_stmt|;
name|value
operator|=
...
expr_stmt|;
block|}
comment|//    if (ah->ah_config.ath_hal_mci_config&
comment|//        ATH_MCI_CONFIG_MCI_WEIGHT_DBG)
comment|//    {
name|HALDEBUG
argument_list|(
name|ah
...
name|HAL_DEBUG_BT_COEX
argument_list|,
literal|"(MCI) Write weights: 0x%08x 0x%08x 0x%08x 0x%08x\n"
argument_list|,
name|ahp
operator|->
name|ah_bt_coex_wlan_weight
