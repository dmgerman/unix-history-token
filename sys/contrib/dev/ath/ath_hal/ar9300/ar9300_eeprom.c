...
argument_list|)
expr_stmt|;
comment|/*      * ###### This function always return NO SPUR.      * This is not true for many board designs.      * Does anyone use this?      */
name|AH_PRIVATE
argument_list|(
name|ah
argument_list|)
...
begin_comment
comment|/*  * Return the Rx NF offset for specific channel.  * The values saved in EEPROM/OTP/Flash is converted through the following way:  *     ((_p) - NOISE_PWR_DATA_OFFSET)<< 2  * So we need to convert back to the original values.  */
end_comment

begin_function
name|int
name|ar9300_get_rx_nf_offset
parameter_list|(
name|struct
name|ath_hal
modifier|*
...
block|{
comment|//printk("%s: raw nf_pwr[%d] = %d\n", __func__, i, rx_nf_pwr);
name|nf_pwr
index|[
name|i
index|]
...
block|{
comment|//printk("%s: raw nf_cal[%d] = %d\n", __func__, i, rx_nf_cal);
name|nf_cal
index|[
name|i
index|]
...
begin_comment
comment|/*  * Select the usage of antenna via the RF switch.  * Default values are loaded from eeprom.  */
end_comment

begin_function
name|HAL_BOOL
name|ar9300_ant_swcom_sel
parameter_list|(
name|struct
name|ath_hal
modifier|*
...
enum|enum
block|{
name|ANT_SELECT_OPS_GET
block|,
name|ANT_SELECT_OPS_SET
block|,     }
enum|;
if|if
condition|(
...
argument_list|)
expr_stmt|;
comment|/* XXX TODO: only if rx_gain_idx == 0 */
if|if
condition|(
name|AR_SREV_POSEIDON
argument_list|(
...
define|#
directive|define
name|AR_SWITCH_TABLE_COM_HONEYBEE_ALL
value|(0xffffff)
define|#
directive|define
name|AR_SWITCH_TABLE_COM_HONEYBEE_ALL_S
value|(0)
define|#
directive|define
...
argument_list|)
expr_stmt|;
comment|/* Force WLAN LNA diversity ON */
name|OS_REG_SET_BIT
argument_list|(
name|ah
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* Force WLAN LNA diversity OFF */
name|OS_REG_CLR_BIT
argument_list|(
name|ah
argument_list|,
...
block|{
comment|/*Scorpion and Honeybee has tempSlope register for each chain*/
