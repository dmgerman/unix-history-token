...
begin_comment
comment|/* TODO: convert the 2.0 code to use the new initvals from ath9k */
end_comment
...
include|#
directive|include
file|"ar9300/ar9462_2p0_initvals.h"
end_include

begin_include
include|#
directive|include
file|"ar9300/ar9462_2p1_initvals.h"
end_include
...
condition|)
block|{
comment|/* XXX: AR_SREV register in HoneyBEE reads 0 */
name|AH_PRIVATE
argument_list|(
name|ah
argument_list|)
...
argument_list|)
expr_stmt|;
comment|/* XXX TODO: need to add this for freebsd; it's missing from the current .ini files */
if|#
directive|if
literal|0
comment|/* Japan 2484Mhz CCK settings */
block|INIT_INI_ARRAY(&ahp->ah_ini_japan2484,             ar9340_wasp_1p0_baseband_core_txfir_coeff_japan_2484,             ARRAY_LENGTH(                 ar9340_wasp_1p0_baseband_core_txfir_coeff_japan_2484), 2);
endif|#
directive|endif
...
index|]
argument_list|,
name|qca953x_honeybee_1p0_mac_core
argument_list|,
name|ARRAY_LENGTH
argument_list|(
name|qca953x_honeybee_1p0_mac_core
...
index|]
argument_list|,
name|qca953x_honeybee_1p0_mac_postamble
argument_list|,
name|ARRAY_LENGTH
argument_list|(
name|qca953x_honeybee_1p0_mac_postamble
...
index|]
argument_list|,
name|qca953x_honeybee_1p0_baseband_core
argument_list|,
name|ARRAY_LENGTH
argument_list|(
name|qca953x_honeybee_1p0_baseband_core
...
index|]
argument_list|,
name|qca953x_honeybee_1p0_baseband_postamble
argument_list|,
name|ARRAY_LENGTH
argument_list|(
name|qca953x_honeybee_1p0_baseband_postamble
...
index|]
argument_list|,
name|qca953x_honeybee_1p0_radio_core
argument_list|,
name|ARRAY_LENGTH
argument_list|(
name|qca953x_honeybee_1p0_radio_core
...
index|]
argument_list|,
name|qca953x_honeybee_1p0_radio_postamble
argument_list|,
name|ARRAY_LENGTH
argument_list|(
name|qca953x_honeybee_1p0_radio_postamble
...
index|]
argument_list|,
name|qca953x_honeybee_1p0_soc_preamble
argument_list|,
name|ARRAY_LENGTH
argument_list|(
name|qca953x_honeybee_1p0_soc_preamble
...
index|]
argument_list|,
name|qca953x_honeybee_1p0_soc_postamble
argument_list|,
name|ARRAY_LENGTH
argument_list|(
name|qca953x_honeybee_1p0_soc_postamble
...
name|ah_ini_modes_rxgain
argument_list|,
name|qca953xCommon_wo_xlna_rx_gain_table_honeybee_1p0
argument_list|,
name|ARRAY_LENGTH
argument_list|(
name|qca953xCommon_wo_xlna_rx_gain_table_honeybee_1p0
...
name|ah_ini_modes_rxgain_bounds
argument_list|,
name|qca953xCommon_wo_xlna_rx_gain_bounds_honeybee_1p0
argument_list|,
name|ARRAY_LENGTH
argument_list|(
name|qca953xCommon_wo_xlna_rx_gain_bounds_honeybee_1p0
...
name|ah_ini_modes_txgain
argument_list|,
name|qca953xModes_no_xpa_tx_gain_table_honeybee_1p0
argument_list|,
name|ARRAY_LENGTH
argument_list|(
name|qca953xModes_no_xpa_tx_gain_table_honeybee_1p0
...
name|ah_ini_modes_additional
argument_list|,
name|qca953xModes_fast_clock_honeybee_1p0
argument_list|,
name|ARRAY_LENGTH
argument_list|(
name|qca953xModes_fast_clock_honeybee_1p0
...
comment|/* Additional setttings for 40Mhz */
comment|//INIT_INI_ARRAY(&ahp->ah_ini_modes_additional_40M,
comment|//                qca953x_honeybee_1p0_radio_core_40M,
comment|//                ARRAY_LENGTH(qca953x_honeybee_1p0_radio_core_40M), 2);
block|}
elseif|else
if|if
condition|(
...
block|{
comment|/* Jupiter: new INI format (pre, core, post arrays per subsystem) */
comment|/* FreeBSD: just override the registers for jupiter 2.1 */
comment|/* XXX TODO: refactor this stuff out; reinit all the 2.1 registers */
comment|/* mac */
name|INIT_INI_ARRAY
argument_list|(
operator|&
...
name|ah_ini_modes_rxgain
argument_list|,
name|qca953xCommon_rx_gain_table_honeybee_1p0
argument_list|,
name|ARRAY_LENGTH
argument_list|(
name|qca953xCommon_rx_gain_table_honeybee_1p0
...
name|ah_ini_modes_rxgain_bounds
argument_list|,
name|qca953xCommon_rx_gain_bounds_honeybee_1p0
argument_list|,
name|ARRAY_LENGTH
argument_list|(
name|qca953xCommon_rx_gain_bounds_honeybee_1p0
...
name|ah_ini_modes_txgain
argument_list|,
name|qca953xModes_xpa_tx_gain_table_honeybee_1p0
argument_list|,
name|ARRAY_LENGTH
argument_list|(
name|qca953xModes_xpa_tx_gain_table_honeybee_1p0
...
name|ah_ini_modes_txgain
argument_list|,
name|qca953xModes_no_xpa_tx_gain_table_honeybee_1p1
argument_list|,
name|ARRAY_LENGTH
argument_list|(
name|qca953xModes_no_xpa_tx_gain_table_honeybee_1p1
...
comment|/* Honeybee */
return|return
literal|"Qualcomm Atheros QCA953x"
return|;
case|case
