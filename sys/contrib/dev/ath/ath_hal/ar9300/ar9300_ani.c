...
name|HAL_DEBUG_ANI
argument_list|,
literal|"%s: cyclecount=%d, rfcount=%d, tfcount=%d, rcdelta=%d, extrcdelta=%d, listen_time=%d "
...
expr_stmt|;
comment|//#endif
comment|/* Populate as appropriate */
name|ani_stats
operator|->
name|cyclecnt_diff
operator|=
