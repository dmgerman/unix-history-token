...
begin_comment
comment|/******************************************************************************  *  * Name: actables.h - ACPI table management  *       $Revision: 1.53 $  *  *****************************************************************************/
end_comment
...
begin_comment
comment|/*  * tbgetall - get multiple required tables  */
end_comment
...
begin_comment
comment|/*  * tbxfroot - RSDP, RSDT utilities  */
end_comment
