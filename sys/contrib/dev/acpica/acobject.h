...
begin_comment
comment|/******************************************************************************  *  * Name: acobject.h - Definition of ACPI_OPERAND_OBJECT  (Internal object only)  *       $Revision: 76 $  *  *****************************************************************************/
end_comment
...
typedef|typedef
struct|struct
comment|/* STRING - has length and pointer */
block|{
name|ACPI_OBJECT_COMMON_HEADER
name|UINT32
name|Length
...
typedef|typedef
struct|struct
comment|/* BUFFER - has length, sequence, and pointer */
block|{
name|ACPI_OBJECT_COMMON_HEADER
name|UINT32
name|Length
...
name|Sequence
decl_stmt|;
comment|/* Sequential count of buffers created */
name|UINT8
modifier|*
name|Pointer
decl_stmt|;
