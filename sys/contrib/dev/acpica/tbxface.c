...
begin_comment
comment|/******************************************************************************  *  * Module Name: tbxface - Public interfaces to the ACPI subsystem  *                         ACPI table oriented interfaces  *              $Revision: 43 $  *  *****************************************************************************/
end_comment
...
expr_stmt|;
block|}
comment|/*      * Got a table ptr, assume it's ok and copy it to the user's buffer      */
if|if
condition|(
name|TableType
operator|==
...
expr_stmt|;
block|}
comment|/*      * Verify we have space in the caller's buffer for the table      */
if|if
condition|(
name|RetBuffer
operator|->
