...
begin_comment
comment|/******************************************************************************  *  * Module Name: dsfield - Dispatcher field routines  *              $Revision: 46 $  *  *****************************************************************************/
end_comment
...
name|Node
expr_stmt|;
comment|/* Attach constructed field descriptor to parent node */
name|Status
operator|=
...
case|:
comment|/* Enter a new field name into the namespace */
name|Status
operator|=
name|AcpiNsLookup
argument_list|(
