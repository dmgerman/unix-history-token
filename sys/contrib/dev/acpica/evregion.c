...
begin_comment
comment|/* TBD: [Restructure] Move elsewhere */
end_comment
...
argument_list|)
expr_stmt|;
comment|/*      *  Method requires two parameters.      */
name|Params
index|[
literal|0
index|]
...
argument_list|)
expr_stmt|;
comment|/*      *  Check for an installed handler      */
name|HandlerDesc
operator|=
name|RegionObj
operator|->
...
argument_list|,
operator|(
literal|"EvAddressSpaceDispatch: No init routine for region %p\n"
operator|,
name|RegionObj
operator|)
argument_list|)
...
begin_comment
comment|/******************************************************************************  *  * FUNCTION:    AcpiEvDisassociateRegionFromHandler  *  * PARAMETERS:  HandlerObj      - Handler Object  *              RegionObj       - Region Object  *  * RETURN:      None  *  * DESCRIPTION: Break the association between the handler and the region  *              this is a two way association.  *  ******************************************************************************/
end_comment
...
begin_comment
comment|/******************************************************************************  *  * FUNCTION:    AcpiEvAssociateRegionAndHandler  *  * PARAMETERS:  HandlerObj      - Handler Object  *              RegionObj       - Region Object  *  * RETURN:      None  *  * DESCRIPTION: Create the association between the handler and the region  *              this is a two way association.  *  ******************************************************************************/
end_comment
...
name|HandlerObj
expr_stmt|;
comment|/*      *  Last thing, tell all users that this region is usable      */
if|if
condition|(
name|AcpiNsIsLocked
condition|)
