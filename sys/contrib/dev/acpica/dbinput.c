...
begin_comment
comment|/*  * Globals that are specific to the debugger  */
end_comment
...
name|AcpiOsPrintf
argument_list|(
literal|"Method                              Display list of loaded control methods\n"
argument_list|)
expr_stmt|;
name|AcpiOsPrintf
argument_list|(
literal|"Namespace [<Addr>|<Path>] [Depth]   Display loaded namespace tree/subtree\n"
argument_list|)
expr_stmt|;
name|AcpiOsPrintf
argument_list|(
literal|"Notify<NamePath><Value>           Send a notification\n"
argument_list|)
expr_stmt|;
name|AcpiOsPrintf
argument_list|(
...
begin_comment
comment|/*******************************************************************************  *  * FUNCTION:    AcpiDbGetLine  *  * PARAMETERS:  InputBuffer         - Command line buffer  *  * RETURN:      None  *  * DESCRIPTION: Get the next command line from the user.  Gets entire line  *              up to the next newline  *  ******************************************************************************/
end_comment
...
begin_comment
comment|/*******************************************************************************  *  * FUNCTION:    AcpiDbCommandDispatch  *  * PARAMETERS:  InputBuffer         - Command line buffer  *              WalkState           - Current walk  *              Op                  - Current (executing) parse op  *  * RETURN:      Status  *  * DESCRIPTION: Command dispatcher.  Called from two places:  *  ******************************************************************************/
end_comment
...
name|TRUE
expr_stmt|;
comment|/* TBD: Must get current walk state */
comment|/* AcpiGbl_MethodBreakpoint = 0; */
return|return
operator|(
name|AE_OK
operator|)
