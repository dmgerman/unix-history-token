...
begin_comment
comment|/******************************************************************************  *  * Name: acpi.h - Master include file, Publics and external data.  *       $Revision: 1.61 $  *  *****************************************************************************/
end_comment
...
begin_comment
comment|/*  * Common includes for all ACPI driver files  * We put them here because we don't want to duplicate them  * in the rest of the source code again and again.  */
end_comment

begin_include
include|#
directive|include
file|<contrib/dev/acpica/acnames.h>
end_include

begin_comment
comment|/* Global ACPI names and strings */
end_comment
...
begin_comment
comment|/* Target environment specific items */
end_comment
