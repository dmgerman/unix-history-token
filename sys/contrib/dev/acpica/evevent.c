...
name|ACPI_DB_INFO
operator|,
literal|"GPE Block%d: %X registers at %8.8X%8.8X\n"
operator|,
operator|(
name|INT32
operator|)
...
argument_list|(
operator|(
literal|"AcpiEvGpeDispatch: Unable to clear GPE[%X]\n"
operator|,
name|GpeNumber
operator|)
argument_list|)
...
argument_list|(
operator|(
literal|"AcpiEvGpeDispatch: Unable to disable GPE[%X]\n"
operator|,
name|GpeNumber
operator|)
argument_list|)
...
argument_list|(
operator|(
literal|"AcpiEvGpeDispatch: Unable to queue handler for GPE[%X], event is disabled\n"
operator|,
name|GpeNumber
operator|)
argument_list|)
