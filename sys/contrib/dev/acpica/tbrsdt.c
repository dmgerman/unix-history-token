...
begin_comment
comment|/******************************************************************************  *  * Module Name: tbrsdt - ACPI RSDT table utilities  *              $Revision: 1.20 $  *  *****************************************************************************/
end_comment
...
expr_stmt|;
block|}
comment|/* Verify RSDP signature and checksum */
name|Status
operator|=
...
begin_comment
comment|/*******************************************************************************  *  * FUNCTION:    AcpiTbGetRsdtAddress  *  * PARAMETERS:  OutAddress          - Where the address is returned  *  * RETURN:      None, Address  *  * DESCRIPTION: Extract the address of either the RSDT or XSDT, depending on the  *              version of the RSDP and whether the XSDT pointer is valid  *  ******************************************************************************/
end_comment
...
expr_stmt|;
comment|/* Use XSDT if it is present */
if|if
condition|(
operator|(
name|AcpiGbl_RSDP
...
operator|=
name|ACPI_TABLE_TYPE_XSDT
expr_stmt|;
block|}
else|else
block|{
comment|/* No XSDT, use the RSDT */
name|OutAddress
operator|->
name|Pointer
operator|.
...
argument_list|)
expr_stmt|;
comment|/*      * Search for appropriate signature, RSDT or XSDT      */
if|if
condition|(
name|AcpiGbl_RootTableType
operator|==
