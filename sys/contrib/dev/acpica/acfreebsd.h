...
begin_comment
comment|/******************************************************************************  *  * Name: acfreebsd.h - OS specific defines, etc.  *       $Revision: 11 $  *  *****************************************************************************/
end_comment
...
begin_comment
comment|/* Always use FreeBSD code over our local versions */
end_comment
...
begin_comment
comment|/* FreeBSD doesn't have strupr, should be fixed. (move to libkern) */
end_comment
