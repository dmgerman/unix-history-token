...
begin_comment
comment|/******************************************************************************  *  * Module Name: tbinstal - ACPI table installation and removal  *              $Revision: 47 $  *  *****************************************************************************/
end_comment
...
expr_stmt|;
block|}
comment|/*      * Search for a signature match among the known table types      * Start at index one -> Skip the RSDP      */
name|Status
operator|=
name|AE_SUPPORT
expr_stmt|;
...
condition|)
block|{
comment|/*              * Found a signature match, get the pertinent info from the              * TableData structure              */
name|TableType
operator|=
name|i
expr_stmt|;
...
condition|)
block|{
comment|/* But don't abort if the checksum is wrong */
comment|/* TBD: [Future] make this a configuration option? */
...
expr_stmt|;
block|}
comment|/*      * An AE_SUPPORT means that the table was not recognized.      * We basically ignore this;  just print a debug message      */
if|if
condition|(
name|Status
operator|==
