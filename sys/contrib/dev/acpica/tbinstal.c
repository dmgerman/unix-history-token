...
begin_comment
comment|/******************************************************************************  *  * Module Name: tbinstal - ACPI table installation and removal  *              $Revision: 1.80 $  *  *****************************************************************************/
end_comment
...
begin_comment
comment|/*******************************************************************************  *  * FUNCTION:    AcpiTbMatchSignature  *  * PARAMETERS:  Signature           - Table signature to match  *              TableInfo           - Return data  *              SearchType          - Table type to match (primary/secondary)  *  * RETURN:      Status  *  * DESCRIPTION: Compare signature against the list of "ACPI-subsystem-owned"  *              tables (DSDT/FADT/SSDT, etc.) Returns the TableTypeID on match.  *  ******************************************************************************/
end_comment
...
name|ACPI_DB_INFO
operator|,
literal|"Table [%4.4s] is an ACPI table consumed by the core subsystem\n"
operator|,
operator|(
name|char
operator|*
...
name|ACPI_DB_INFO
operator|,
literal|"Table [%4.4s] is not an ACPI table consumed by the core subsystem - ignored\n"
operator|,
operator|(
name|char
operator|*
...
begin_comment
comment|/*******************************************************************************  *  * FUNCTION:    AcpiTbInstallTable  *  * PARAMETERS:  TableInfo           - Return value from AcpiTbGetTableBody  *  * RETURN:      Status  *  * DESCRIPTION: Install the table into the global data structures.  *  ******************************************************************************/
end_comment
...
argument_list|(
operator|(
literal|"Could not acquire table mutex, %s\n"
operator|,
...
expr_stmt|;
block|}
comment|/*      * Ignore a table that is already installed. For example, some BIOS      * ASL code will repeatedly attempt to load the same SSDT.      */
name|Status
operator|=
...
argument_list|(
operator|(
literal|"Could not install table [%4.4s], %s\n"
operator|,
name|TableInfo
operator|->
name|Pointer
...
expr_stmt|;
block|}
comment|/* Get a new owner ID for the table */
name|Status
operator|=
