...
begin_comment
comment|/******************************************************************************  *  * Module Name: dsmethod - Parser/Interpreter interface - control method parsing  *              $Revision: 65 $  *  *****************************************************************************/
end_comment
...
argument_list|)
expr_stmt|;
comment|/* Install the parsed tree in the method object */
comment|/* TBD: [Restructure] Obsolete field? */
...
name|MethodNode
expr_stmt|;
comment|/* Create a new state for the preempting walk */
name|NextWalkState
operator|=
...
condition|)
block|{
comment|/* TBD: delete parser state */
name|return_ACPI_STATUS
argument_list|(
name|AE_NO_MEMORY
argument_list|)
...
goto|;
block|}
comment|/*      * Initialize the arguments for the method.  The resolved      * arguments were put on the previous walk state's operand      * stack.  Operands on the previous walk state stack always      * start at index 0.      */
name|Status
operator|=
...
argument_list|)
expr_stmt|;
comment|/* The method object should be stored in the walk state */
name|ObjDesc
operator|=
name|WalkState
operator|->
