...
begin_comment
comment|/******************************************************************************  *  * Name: acglobal.h - Declarations for global variables  *       $Revision: 1.168 $  *  *****************************************************************************/
end_comment
...
begin_comment
comment|/* The root table can be either an RSDT or an XSDT */
end_comment
...
begin_comment
comment|/*  * Handle both ACPI 1.0 and ACPI 2.0 Integer widths:  * If we are executing a method that exists in a 32-bit ACPI table,  * use only the lower 32 bits of the (internal) 64-bit Integer.  */
end_comment
