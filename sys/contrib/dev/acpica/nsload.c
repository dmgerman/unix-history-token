...
begin_comment
comment|/******************************************************************************  *  * Module Name: nsload - namespace loading/expanding/contracting procedures  *              $Revision: 1.73 $  *  *****************************************************************************/
end_comment
...
argument_list|)
expr_stmt|;
comment|/* Ignore table if there is no AML contained within */
if|if
condition|(
operator|!
name|TableDesc
...
argument_list|(
operator|(
literal|"Zero-length AML block in table [%4.4s]\n"
operator|,
name|TableDesc
operator|->
name|Pointer
...
name|ACPI_DB_INFO
operator|,
literal|"Namespace load: %d SSDT or PSDTs\n"
operator|,
name|AcpiGbl_TableLists
index|[
name|TableType
...
argument_list|)
expr_stmt|;
comment|/*          * Traverse list of SSDT or PSDT tables          */
name|TableDesc
operator|=
name|AcpiGbl_TableLists
index|[
...
control|)
block|{
comment|/*              * Only attempt to load table into namespace if it is not              * already loaded!              */
if|if
condition|(
operator|!
name|TableDesc
