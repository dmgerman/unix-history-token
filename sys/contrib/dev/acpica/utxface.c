...
argument_list|,
operator|(
literal|"ACPI Subsystem version [%s]\n"
operator|,
...
argument_list|,
operator|(
literal|"Initializing ACPI Subsystem...\n"
operator|)
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/*      * We must initialize the hardware before we can enable ACPI.      */
if|if
condition|(
operator|!
operator|(
...
condition|)
block|{
comment|/*          *  Caller's buffer is too small          */
name|OutBuffer
operator|->
name|Length
operator|=
...
expr_stmt|;
block|}
comment|/*      *  Set return length and get data      */
name|OutBuffer
operator|->
name|Length
operator|=
...
name|Pointer
expr_stmt|;
comment|/* TBD [Future]: need a version number, or use the version string */
name|InfoPtr
operator|->
name|AcpiCaVersion
operator|=
...
begin_comment
comment|/******************************************************************************  *  * FUNCTION:    AcpiFormatException  *  * PARAMETERS:  OutBuffer       - a pointer to a buffer to receive the  *                                exception name  *  * RETURN:      Status          - the status of the call  *  * DESCRIPTION: This function translates an ACPI exception into an ASCII string.  *  ******************************************************************************/
end_comment
...
argument_list|)
expr_stmt|;
comment|/*      * Get length of string and check if it will fit in caller's buffer      */
name|Length
operator|=
name|STRLEN
argument_list|(
...
expr_stmt|;
block|}
comment|/* Copy the string, all done */
name|STRCPY
argument_list|(
name|OutBuffer
operator|->
