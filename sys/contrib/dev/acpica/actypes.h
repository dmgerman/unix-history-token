...
begin_comment
comment|/******************************************************************************  *  * Name: actypes.h - Common data types for the entire ACPI subsystem  *       $Revision: 159 $  *  *****************************************************************************/
end_comment
...
begin_comment
comment|/*  * Types used only in translated source  */
end_comment
...
begin_comment
comment|/*      * There's no bus master event so index 1 is used for IRQ's that are not      * handled by the SCI handler      */
end_comment

begin_define
define|#
directive|define
name|ACPI_EVENT_NOT_USED
value|(ACPI_EVENT_TYPE) 1
end_define
...
directive|define
name|ACPI_EVENT_RTC
value|(ACPI_EVENT_TYPE) 5
end_define

begin_define
define|#
directive|define
name|ACPI_EVENT_GENERAL
value|(ACPI_EVENT_TYPE) 6
end_define
...
directive|define
name|ENTIRE_RANGE
value|(NON_ISA_ONLY_RANGES | ISA_ONLY_RANGES)
end_define
...
begin_comment
comment|/*  * END: Definitions for PCI Routing tables  */
end_comment
