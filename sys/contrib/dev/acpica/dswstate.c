...
begin_comment
comment|/******************************************************************************  *  * Module Name: dswstate - Dispatcher parse tree walk management routines  *              $Revision: 36 $  *  *****************************************************************************/
end_comment
...
begin_comment
comment|/*******************************************************************************  *  * FUNCTION:    AcpiDsResultStackClear  *  * PARAMETERS:  WalkState           - Current Walk state  *  * RETURN:      Status  *  * DESCRIPTION: Reset this walk's result stack pointers to zero, thus setting  *              the stack to zero.  *  ******************************************************************************/
end_comment

begin_function
name|ACPI_STATUS
name|xxxAcpiDsResultStackClear
parameter_list|(
...
parameter_list|)
block|{
comment|/*     WalkState->NumResults = 0;     WalkState->CurrentResult = 0; */
return|return
operator|(
name|AE_OK
operator|)
