...
begin_comment
comment|/******************************************************************************  *  * Module Name: dsinit - Object initialization namespace walk  *              $Revision: 1.17 $  *  *****************************************************************************/
end_comment
...
case|:
comment|/*          * Print a dot for each method unless we are going to print          * the entire pathname          */
if|if
condition|(
operator|!
operator|(
