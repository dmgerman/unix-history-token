...
begin_comment
comment|/*******************************************************************************  *  * Module Name: rsinfo - Dispatch and Info tables  *              $Revision: 1.4 $  *  ******************************************************************************/
end_comment
...
begin_comment
comment|/* Macros used in the tables below */
end_comment
...
begin_comment
comment|/*  * Base sizes of resource descriptors, both the AML stream resource length  * (minus size of header and length fields),and the size of the internal  * struct representation.  */
end_comment
...
name|ACPI_RS_SIZE
argument_list|(
argument|ACPI_RESOURCE_START_DEPENDENT
argument_list|)
block|}
block|,
block|{
...
name|ACPI_RS_SIZE
argument_list|(
argument|ACPI_RESOURCE_FIXED_IO
argument_list|)
block|}
block|,
block|{
...
name|ACPI_RS_SIZE
argument_list|(
argument|ACPI_RESOURCE_MEMORY24
argument_list|)
block|}
block|,
block|{
...
name|ACPI_RS_SIZE
argument_list|(
argument|ACPI_RESOURCE_GENERIC_REGISTER
argument_list|)
block|}
block|,
block|{
...
name|ACPI_RS_SIZE
argument_list|(
argument|ACPI_RESOURCE_MEMORY32
argument_list|)
block|}
block|,
block|{
...
name|ACPI_RS_SIZE
argument_list|(
argument|ACPI_RESOURCE_FIXED_MEMORY32
argument_list|)
block|}
block|,
block|{
...
name|ACPI_RS_SIZE
argument_list|(
argument|ACPI_RESOURCE_ADDRESS32
argument_list|)
block|}
block|,
block|{
...
name|ACPI_RS_SIZE
argument_list|(
argument|ACPI_RESOURCE_ADDRESS16
argument_list|)
block|}
block|,
block|{
...
name|ACPI_RS_SIZE
argument_list|(
argument|ACPI_RESOURCE_EXTENDED_IRQ
argument_list|)
block|}
block|,
block|{
...
name|ACPI_RS_SIZE
argument_list|(
argument|ACPI_RESOURCE_ADDRESS64
argument_list|)
block|}
block|,
block|{
