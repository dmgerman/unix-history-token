...
name|ACPI_TYPE_STRING
case|:
comment|/*          * Allocate and copy the actual string if and only if:          * 1) There is a valid string (length> 0)          * 2) The string is not static (not in an ACPI table) (in this case,          *    the actual pointer was already copied above)          */
if|if
condition|(
operator|(
name|SourceDesc
