...
begin_comment
comment|/******************************************************************************  *  * Module Name: utcopy - Internal to external object translation utilities  *              $Revision: 1.122 $  *  *****************************************************************************/
end_comment
...
argument_list|(
operator|(
literal|"AmlBuildCopyInternalPackageObject: Package allocation failure\n"
operator|)
argument_list|)
expr_stmt|;
name|return_ACPI_STATUS
...
name|ACPI_FUNCTION_TRACE
argument_list|(
literal|"UtCopyIobjectToIobject"
argument_list|)
expr_stmt|;
