...
begin_comment
comment|/******************************************************************************  *  * Module Name: nsinit - namespace initialization  *              $Revision: 55 $  *  *****************************************************************************/
end_comment
...
name|ACPI_DB_INIT
operator|,
literal|"Executing all Device _STA and_INI methods:"
operator|)
argument_list|)
expr_stmt|;
comment|/* Walk namespace for all objects of type Device */
name|Status
operator|=
