...
begin_comment
comment|/******************************************************************************  *  * Module Name: dsopcode - Dispatcher Op Region support and handling of  *                         "control" opcodes  *              $Revision: 74 $  *  *****************************************************************************/
end_comment
...
name|ACPI_DB_ERROR
operator|,
literal|"No pointer back to NS node in buffer %p\n"
operator|,
name|ObjDesc
operator|)
argument_list|)
...
begin_comment
comment|/*****************************************************************************  *  * FUNCTION:    AcpiDsEvalDataObjectOperands  *  * PARAMETERS:  Op              - A valid DataObject Op object  *  * RETURN:      Status  *  * DESCRIPTION: Get the operands and complete the following data objec types:  *              Buffer  *              Package  *  ****************************************************************************/
end_comment
...
name|ACPI_FUNCTION_TRACE
argument_list|(
literal|"DsEvalDataObjectOperands"
argument_list|)
expr_stmt|;
