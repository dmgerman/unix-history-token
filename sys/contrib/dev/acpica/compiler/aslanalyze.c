...
begin_comment
comment|/******************************************************************************  *  * Module Name: aslanalyze.c - check for semantic errors  *              $Revision: 80 $  *  *****************************************************************************/
end_comment
...
argument_list|,
literal|"Null attached Nsnode: [%s] at line %d\n"
argument_list|,
name|Op
operator|->
name|Asl
...
expr_stmt|;
block|}
comment|/*          * Otherwise, this is a reference, check if the local          * has been previously initialized.          */
elseif|else
if|if
condition|(
operator|!
...
expr_stmt|;
block|}
comment|/*          * Otherwise, this is a reference, check if the Arg          * has been previously initialized.          */
elseif|else
if|if
condition|(
operator|!
