...
begin_comment
comment|/******************************************************************************  *  * Module Name: aslcompiler.h - common include file  *              $Revision: 127 $  *  *****************************************************************************/
end_comment
...
directive|define
name|CompilerId
value|"ASL Optimizing Compiler / AML Disassembler"
end_define
...
value|"Copyright (C) 2000 - 2003 Intel Corporation"
end_define
...
name|m
parameter_list|)
value|ACPI_OFFSET (ASL_RESOURCE_DESC, m)
end_define
...
begin_comment
comment|/*  * aslresource - resource template generation  */
end_comment
...
define|#
directive|define
name|NEXT_RESOURCE_DESC
parameter_list|(
name|a
parameter_list|,
name|b
parameter_list|)
value|(ASL_RESOURCE_DESC *) (((char *) (a)) + sizeof(b))
end_define

begin_define
define|#
directive|define
name|DEFAULT_RESOURCE_DESC_SIZE
value|(sizeof (ASL_RESOURCE_DESC) + sizeof (ASL_END_TAG_DESC))
end_define

begin_comment
comment|/*  * Resource utilities  */
end_comment
