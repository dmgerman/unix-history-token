...
begin_comment
comment|/******************************************************************************  *  * Module Name: asloperands - AML operand processing  *  *****************************************************************************/
end_comment
...
condition|)
block|{
comment|/*              * Allow package length to be longer than the initializer              * list -- but if the length of initializer list is nonzero,              * issue a message since this is probably a coding error,              * even though technically legal.              */
if|if
condition|(
name|PackageLength
operator|>
...
condition|)
block|{
comment|/*              * The package length is smaller than the length of the              * initializer list. This is an error as per the ACPI spec.              */
name|AslError
argument_list|(
name|ASL_ERROR
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* Prepend the current directory path */
name|strcpy
argument_list|(
name|Filename
argument_list|,
