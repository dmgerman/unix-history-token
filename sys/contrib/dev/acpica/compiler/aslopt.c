...
begin_comment
comment|/******************************************************************************  *  * Module Name: aslopt- Compiler optimizations  *              $Revision: 1.21 $  *  *****************************************************************************/
end_comment
...
name|ACPI_DB_OPTIMIZATIONS
operator|,
literal|" NOT SHORTER (New %d old %d)"
operator|,
name|ACPI_STRLEN
argument_list|(
name|NewPath
...
argument_list|(
literal|"OptOptimizeNameDeclaration"
argument_list|)
expr_stmt|;
if|if
condition|(
