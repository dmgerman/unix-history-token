...
begin_comment
comment|/******************************************************************************  *  * Module Name: aslopcode - AML opcode generation  *              $Revision: 60 $  *  *****************************************************************************/
end_comment
...
parameter_list|)
block|{
comment|/*     TBD: - we don't want to optimize integers in the block header, but the     code below does not work correctly.      if (Op->Asl.Parent&&         Op->Asl.Parent->Asl.Parent&&         (Op->Asl.Parent->Asl.Parent->Asl.ParseOpcode == PARSEOP_DEFINITIONBLOCK))     {         return 0;     } */
...
name|String
expr_stmt|;
comment|/*      * The EISAID string must be exactly 7 characters and of the form      * "LLLXXXX" -- 3 letters and 4 hex digits (e.g., "PNP0001")      */
if|if
condition|(
name|ACPI_STRLEN
argument_list|(
...
begin_comment
comment|/*******************************************************************************  *  * FUNCTION:    OpcDoUiId  *  * PARAMETERS:  Op        - Parse node  *  * RETURN:      None  *  * DESCRIPTION:   *  ******************************************************************************/
end_comment
...
case|:
comment|/*          * The variable-length package has a different opcode          */
if|if
condition|(
operator|(
name|Op
