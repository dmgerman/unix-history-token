...
goto|;
block|}
comment|/*      * Store the result of the operation (which is now in Operand[0]) into      * the result descriptor, or the location pointed to by the result      * descriptor (Operand[2]).      */
name|Status
operator|=
name|AcpiExStore
argument_list|(
