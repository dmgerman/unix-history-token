...
begin_comment
comment|/******************************************************************************  *  * Module Name: exmisc - ACPI AML (p-code) execution - specific opcodes  *              $Revision: 118 $  *  *****************************************************************************/
end_comment
...
argument_list|(
operator|(
literal|"Unknown Reference subtype in get ref %X\n"
operator|,
name|ObjDesc
operator|->
name|Reference
...
argument_list|(
operator|(
literal|"Invalid descriptor type in get ref: %X\n"
operator|,
name|ACPI_GET_DESCRIPTOR_TYPE
argument_list|(
name|ObjDesc
