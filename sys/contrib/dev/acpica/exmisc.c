...
argument_list|)
expr_stmt|;
comment|/*      * TBD: [Unhandled] call OSD interface to notify OS of fatal error      * requiring shutdown!      */
name|Cleanup
label|:
...
argument_list|)
expr_stmt|;
comment|/* If we get back from the OS call, we might as well keep going. */
name|REPORT_WARNING
argument_list|(
operator|(
literal|"An AML \"Fatal\" Opcode (FatalOp) was executed\n"
operator|)
argument_list|)
expr_stmt|;
