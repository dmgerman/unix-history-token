...
begin_comment
comment|/******************************************************************************  *  * Module Name: exoparg3 - AML execution - opcodes with 3 arguments  *              $Revision: 17 $  *  *****************************************************************************/
end_comment
...
argument_list|(
operator|(
literal|"AcpiExOpcode_3A_0T_0R: Unknown opcode %X\n"
operator|,
name|WalkState
operator|->
name|Opcode
...
expr_stmt|;
block|}
comment|/* Allocate a new buffer for the String/Buffer */
name|Buffer
operator|=
