...
begin_comment
comment|/******************************************************************************  *  * Module Name: psparse - Parser top level AML parse routines  *              $Revision: 129 $  *  *****************************************************************************/
end_comment
...
begin_comment
comment|/*******************************************************************************  *  * FUNCTION:    AcpiPsCompleteThisOp  *  * PARAMETERS:  WalkState       - Current State  *              Op              - Op to complete  *  * RETURN:      None.  *  * DESCRIPTION: Perform any cleanup at the completion of an Op.  *  ******************************************************************************/
end_comment
...
name|ACPI_DB_PARSE
operator|,
literal|"Opcode %4.4hX [%s] Op %p Aml %p AmlOffset %5.5X\n"
operator|,
name|Op
operator|->
name|Common
...
argument_list|(
operator|(
literal|"Could not terminate control method properly\n"
operator|)
argument_list|)
expr_stmt|;
name|Status
...
name|AE_OK
expr_stmt|;
comment|/* Ignore error and continue */
block|}
block|}
