...
condition|)
block|{
comment|/*                  * This method is marked NotSerialized, but it tried to create a named                  * object, causing the second thread entrance to fail.  We will workaround                  * this by marking the method permanently as Serialized.                  */
name|WalkState
operator|->
name|MethodDesc
operator|->
