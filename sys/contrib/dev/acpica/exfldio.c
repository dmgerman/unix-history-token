...
begin_comment
comment|/******************************************************************************  *  * Module Name: exfldio - Aml Field I/O  *              $Revision: 1.116 $  *  *****************************************************************************/
end_comment
...
expr_stmt|;
block|}
comment|/* Merge with previous datum if necessary */
name|MergedDatum
operator||=
name|RawDatum
operator|<<
...
expr_stmt|;
block|}
comment|/* Start new output datum by merging with previous input datum */
name|FieldOffset
operator|+=
name|ObjDesc
operator|->
