...
begin_comment
comment|/******************************************************************************  *  * Name: actbl2.h - ACPI Specification Revision 2.0 Tables  *       $Revision: 1.45 $  *  *****************************************************************************/
end_comment
...
literal|7
expr_stmt|;
comment|/* 01-07: Reserved, must be zero */
name|UINT8
name|Reserved1
index|[
literal|3
index|]
decl_stmt|;
comment|/* 08-31: Reserved, must be zero */
name|UINT64
name|XFirmwareWakingVector
decl_stmt|;
comment|/* 64-bit physical address of the Firmware Waking Vector. */
name|UINT8
name|Version
decl_stmt|;
...
literal|4
expr_stmt|;
comment|/* 20-23: Reserved, must be zero */
name|UINT8
name|Reserved3
decl_stmt|;
comment|/* 24-31: Reserved, must be zero */
name|ACPI_GENERIC_ADDRESS
name|ResetRegister
decl_stmt|;
...
begin_comment
comment|/* "Down-revved" ACPI 2.0 FADT descriptor */
end_comment
...
literal|1
decl_stmt|;
comment|/* 02:    Memory is non-volatile */
name|UINT8_BIT
label|:
literal|5
expr_stmt|;
comment|/* 03-07: Reserved, must be zero */
name|UINT8
name|Reserved5
index|[
literal|3
