...
begin_comment
comment|/******************************************************************************  *  * Module Name: hwgpe - Low level GPE enable/disable/clear functions  *              $Revision: 47 $  *  *****************************************************************************/
end_comment
...
return|;
block|}
comment|/* Write with the new GPE bit enabled */
name|Status
operator|=
...
return|;
block|}
comment|/* Write the byte with this GPE bit cleared */
name|Status
operator|=
name|AcpiHwLowLevelWrite
argument_list|(
...
begin_comment
comment|/******************************************************************************  *  * FUNCTION:    AcpiHwDisableNonWakeupGpes  *  * PARAMETERS:  None  *  * RETURN:      None  *  * DESCRIPTION: Disable all non-wakeup GPEs  *              Call with interrupts disabled. The interrupt handler also  *              modifies GpeRegisterInfo->Enable, so it should not be  *              given the chance to run until after non-wake GPEs are  *              re-enabled.  *  ******************************************************************************/
end_comment
...
condition|)
block|{
comment|/* Get the register info for the entire GPE block */
name|GpeRegisterInfo
operator|=
name|GpeBlock
operator|->
