...
directive|define
name|RSDT_SIZE
value|(sizeof (ACPI_TABLE_RSDT) + ((RSDT_TABLES -1) * sizeof (UINT32)))
end_define
...
begin_comment
comment|/******************************************************************************  *  * FUNCTION:    AeBuildLocalTables  *  * PARAMETERS:  UserTable   - pointer to an input table to be loaded.  *                            a DSDT or SSDT  *  * RETURN:      Status  *  * DESCRIPTION: Build a complete ACPI table chain, with a local RSDP, RSDT,  *              FADT, and several other test tables.  *  *****************************************************************************/
end_comment
