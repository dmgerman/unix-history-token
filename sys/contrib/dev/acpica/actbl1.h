...
begin_comment
comment|/******************************************************************************  *  * Name: actbl1.h - ACPI 1.0 tables  *       $Revision: 1.32 $  *  *****************************************************************************/
end_comment
...
literal|1
decl_stmt|;
comment|/* 08:    tmr_val width is 32 bits (0 = 24 bits) */
name|UINT8_BIT
label|:
literal|7
expr_stmt|;
comment|/* 09-15: Reserved, must be zero */
name|UINT8
name|Reserved5
index|[
literal|2
index|]
decl_stmt|;
comment|/* 16-31: Reserved, must be zero */
block|}
name|FADT_DESCRIPTOR_REV1
typedef|;
end_typedef
