...
begin_comment
comment|/******************************************************************************  *  * Name: achware.h -- hardware specific interfaces  *       $Revision: 49 $  *  *****************************************************************************/
end_comment
...
begin_function_decl
name|ACPI_STATUS
name|AcpiHwInitializeSystemInfo
parameter_list|(
name|void
parameter_list|)
function_decl|;
...
begin_comment
comment|/* Register I/O Prototypes */
end_comment
