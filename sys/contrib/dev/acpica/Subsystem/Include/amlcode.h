...
begin_comment
comment|/* Bogus opcodes (they are actually two separate opcodes) */
end_comment
...
begin_comment
comment|/*  * Argument types for the AML Parser  * Each field in the ArgTypes UINT32 is 5 bits, allowing for a maximum of 6 arguments.  * There can be up to 31 unique argument types  */
end_comment
...
begin_comment
comment|/*  * Resolved argument types for the AML Interpreter  * Each field in the ArgTypes UINT32 is 5 bits, allowing for a maximum of 6 arguments.  * There can be up to 31 unique argument types (0 is end-of-arg-list indicator)  */
end_comment

begin_comment
comment|/* "Standard" ACPI types are 1-15 (0x0F) */
end_comment
...
directive|define
name|ARGI_DDBHANDLE
value|ACPI_TYPE_DDB_HANDLE
end_define

begin_comment
comment|/* Custom types are 0x10 through 0x1F */
end_comment
