...
begin_comment
comment|/******************************************************************************  *  * Name: actbl64.h - ACPI tables specific to IA64  *       $Revision: 12 $  *  *****************************************************************************/
end_comment
...
begin_comment
comment|/* IA64 Root System Description Table */
end_comment
...
begin_comment
comment|/* IA64 Firmware ACPI Control Structure */
end_comment
...
begin_comment
comment|/* IA64 Fixed ACPI Description Table */
end_comment
