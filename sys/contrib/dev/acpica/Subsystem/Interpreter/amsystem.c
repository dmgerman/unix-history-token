...
begin_comment
comment|/******************************************************************************  *  * Module Name: amsystem - Interface to OS services  *              $Revision: 52 $  *  *****************************************************************************/
end_comment
...
expr_stmt|;
block|}
comment|/*      * Support for the _GL_ Mutex object -- go get the global lock      */
if|if
condition|(
name|ObjDesc
operator|->
...
expr_stmt|;
block|}
comment|/*      * Support for the _GL_ Mutex object -- release the global lock      */
if|if
condition|(
name|ObjDesc
operator|->
