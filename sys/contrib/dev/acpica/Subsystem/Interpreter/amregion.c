...
begin_comment
comment|/******************************************************************************  *  * Module Name: amregion - ACPI default OpRegion (address space) handlers  *              $Revision: 42 $  *  *****************************************************************************/
end_comment
...
argument_list|,
operator|(
literal|"R%d S(%04x) B(%04x) DF(%08x) R(%04x)\n"
operator|,
name|BitWidth
operator|,
name|PCIContext
...
argument_list|,
operator|(
literal|"W%d S(%04x) B(%04x) DF(%08x) R(%04x) D(%08x)\n"
operator|,
name|BitWidth
operator|,
name|PCIContext
