...
begin_comment
comment|/******************************************************************************  *  * Module Name: amcreate - Named object creation  *              $Revision: 48 $  *  *****************************************************************************/
end_comment
...
name|Node
expr_stmt|;
comment|/*     Status = AcpiNsAttachObject (Node, ObjDesc,                                 (UINT8) ACPI_TYPE_FIELD_UNIT);      if (ACPI_FAILURE (Status))     {         goto Cleanup;     } */
...
begin_function
name|ACPI_STATUS
name|AcpiAmlExecCreateField_original
parameter_list|(
name|UINT16
name|Opcode
parameter_list|,
...
goto|;
block|}
comment|/* Allocate an object for the field */
name|FieldDesc
operator|=
name|AcpiCmCreateInternalObject
argument_list|(
...
name|SrcDesc
expr_stmt|;
comment|/* An additional reference for SrcDesc */
