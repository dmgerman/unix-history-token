...
begin_comment
comment|/*******************************************************************************  *  * Module Name: cmdelete - object deletion and reference count utilities  *              $Revision: 61 $  *  ******************************************************************************/
end_comment
...
name|Hflags
operator|==
name|ADDR_HANDLER_DEFAULT_INSTALLED
operator|)
condition|)
block|{
name|ObjPointer
...
break|break;
block|}
comment|/*      * Delete any allocated memory found above      */
if|if
condition|(
name|ObjPointer
condition|)
...
expr_stmt|;
block|}
comment|/*      * Make sure that this isn't a namespace handle or an AML pointer      */
if|if
condition|(
