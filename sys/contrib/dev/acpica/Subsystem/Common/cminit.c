...
begin_comment
comment|/******************************************************************************  *  * Module Name: cminit - Common ACPI subsystem initialization  *              $Revision: 84 $  *  *****************************************************************************/
end_comment
...
argument_list|(
operator|(
literal|"Invalid FACP register value, %s = 0x%X (FACP=0x%X)\n"
operator|,
name|RegisterName
operator|,
name|Value
...
begin_comment
comment|/******************************************************************************  *  * FUNCTION:    AcpiCmValidateFacp  *  * PARAMETERS:  None  *  * RETURN:      Status  *  * DESCRIPTION: Validate various ACPI registers in the FACP  *  ******************************************************************************/
end_comment
