...
begin_comment
comment|/*******************************************************************************  *  * Module Name: dbstats - Generation and display of ACPI table statistics  *              $Revision: 36 $  *  ******************************************************************************/
end_comment
...
name|AcpiOsPrintf
argument_list|(
literal|"Parse Tree without Methods:.% 7ld\n"
argument_list|,
name|SizeOfParseTree
argument_list|)
expr_stmt|;
name|AcpiOsPrintf
argument_list|(
literal|"Control Method Parse Trees:.% 7ld (If parsed simultaneously)\n"
argument_list|,
name|SizeOfMethodTrees
argument_list|)
expr_stmt|;
name|AcpiOsPrintf
argument_list|(
literal|"Namespace Nodes:............% 7ld (%d nodes)\n"
argument_list|,
sizeof|sizeof
argument_list|(
name|ACPI_NAMESPACE_NODE
...
name|AcpiOsPrintf
argument_list|(
literal|"Named Internal Objects......% 7ld\n"
argument_list|,
name|SizeOfAcpiObjects
argument_list|)
expr_stmt|;
...
name|AcpiOsPrintf
argument_list|(
literal|"WalkState Cache size........% 7ld\n"
argument_list|,
...
name|AcpiOsPrintf
argument_list|(
literal|"Cache Statistics:\n\n"
argument_list|)
expr_stmt|;
name|AcpiOsPrintf
argument_list|(
literal|"State Cache requests........% 7ld\n"
argument_list|,
...
name|AcpiOsPrintf
argument_list|(
literal|"State Cache depth...........% 7ld (%d remaining entries)\n"
argument_list|,
name|AcpiGbl_GenericStateCacheDepth
argument_list|,
...
name|AcpiOsPrintf
argument_list|(
literal|"Parse Cache requests........% 7ld\n"
argument_list|,
...
name|AcpiOsPrintf
argument_list|(
literal|"Parse Cache depth...........% 7ld (%d remaining entries)\n"
argument_list|,
name|AcpiGbl_ParseCacheDepth
argument_list|,
...
name|AcpiOsPrintf
argument_list|(
literal|"Ext Parse Cache requests....% 7ld\n"
argument_list|,
...
name|AcpiOsPrintf
argument_list|(
literal|"Ext Parse Cache hits........% 7ld\n"
argument_list|,
...
name|AcpiOsPrintf
argument_list|(
literal|"Ext Parse Cache depth.......% 7ld (%d remaining entries)\n"
argument_list|,
...
name|AcpiOsPrintf
argument_list|(
literal|"Object Cache requests.......% 7ld\n"
argument_list|,
...
name|AcpiOsPrintf
argument_list|(
literal|"Object Cache depth..........% 7ld (%d remaining entries)\n"
argument_list|,
name|AcpiGbl_ObjectCacheDepth
argument_list|,
...
name|AcpiOsPrintf
argument_list|(
literal|"WalkState Cache requests....% 7ld\n"
argument_list|,
...
name|AcpiOsPrintf
argument_list|(
literal|"WalkState Cache hits........% 7ld\n"
argument_list|,
...
name|AcpiOsPrintf
argument_list|(
literal|"WalkState Cache depth.......% 7ld (%d remaining entries)\n"
argument_list|,
name|AcpiGbl_WalkStateCacheDepth
argument_list|,
