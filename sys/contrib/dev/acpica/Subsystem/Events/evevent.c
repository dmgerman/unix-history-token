...
begin_comment
comment|/******************************************************************************  *  * Module Name: evevent - Fixed and General Purpose AcpiEvent  *                          handling and dispatch  *              $Revision: 17 $  *  *****************************************************************************/
end_comment
...
expr_stmt|;
comment|/*******************************************************************/
comment|/* Setting up various GPE counts                                   */
comment|/*                                                                 */
comment|/* You may ask,why are the GPE register block lengths divided by 2?*/
comment|/* From the ACPI 2.0 Spec, section, 4.7.1.6 General-Purpose Event  */
comment|/* Registers, we have,                                             */
comment|/*                                                                 */
comment|/* "Each register block contains two registers of equal length:     */
comment|/* GPEx_STS and GPEx_EN (where x is 0 or 1). The length of the     */
comment|/* GPE0_STS and GPE0_EN registers is equal to half the GPE0_LEN.   */
comment|/* The length of the GPE1_STS and GPE1_EN registers is equal to    */
comment|/* half the GPE1_LEN. If a generic register block is not supported */
comment|/* then its respective block pointer and block length values in the*/
comment|/* FADT table contain zeros. The GPE0_LEN and GPE1_LEN do not need */
comment|/* to be the same size."                                           */
comment|/*******************************************************************/
name|Gpe0RegisterCount
operator|=
operator|(
...
argument_list|(
operator|(
literal|"Zero GPEs are defined in the FACP\n"
operator|)
argument_list|)
expr_stmt|;
name|return_ACPI_STATUS
...
argument_list|,
operator|(
literal|"GPE registers: %d@%X (Blk0) %d@%X (Blk1)\n"
operator|,
name|Gpe0RegisterCount
operator|,
name|AcpiGbl_FACP
...
begin_comment
comment|/******************************************************************************  *  * FUNCTION:    AcpiEvGpeCleanup  *  * PARAMETERS:  None  *  * RETURN:      None  *  * DESCRIPTION: Cleanup in preparation for unload.  *  ******************************************************************************/
end_comment

begin_function
name|void
name|AcpiEvGpeCleanup
parameter_list|(
name|void
parameter_list|)
block|{
...
argument_list|)
expr_stmt|;
comment|/*      * Function Handler (e.g. EC):      * ---------------------------      * Execute the installed function handler to handle this event.      */
if|if
condition|(
name|GpeInfo
operator|.
