...
begin_comment
comment|/******************************************************************************  *  * Module Name: psargs - Parse AML opcode arguments  *              $Revision: 35 $  *  *****************************************************************************/
end_comment
...
begin_function
name|UINT32
name|AcpiPsPkgLengthEncodingSize
parameter_list|(
name|UINT32
name|FirstByte
parameter_list|)
block|{
comment|/*      * Bits 6-7 contain the number of bytes      * in the encoded package length (-1)      */
return|return
operator|(
operator|(
name|FirstByte
...
begin_function
name|UINT32
name|xxxAcpiPsGetNextPackageLength
parameter_list|(
