...
begin_comment
comment|/*  * Flags byte: 0-4 (5 bits) = Opcode Type  *             5   (1 bit)  = Has arguments flag  *             6-7 (2 bits) = Reserved  */
end_comment
...
block|,
comment|/*  2C */
comment|/* AML_FIND_SET_LEFT_BIT_OP */
name|OP_INFO_ENTRY
argument_list|(
name|ACPI_OP_TYPE_OPCODE
operator||
...
block|,
comment|/*  2D */
comment|/* AML_FIND_SET_RIGHT_BIT_OP */
name|OP_INFO_ENTRY
argument_list|(
name|ACPI_OP_TYPE_OPCODE
operator||
