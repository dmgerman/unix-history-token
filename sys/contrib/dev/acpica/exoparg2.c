...
begin_comment
comment|/******************************************************************************  *  * Module Name: exoparg2 - AML execution - opcodes with 2 arguments  *              $Revision: 1.134 $  *  *****************************************************************************/
end_comment
...
argument_list|(
operator|(
literal|"AcpiExOpcode_2A_0T_0R: Unknown opcode %X\n"
operator|,
name|WalkState
operator|->
name|Opcode
...
argument_list|(
operator|(
literal|"AcpiExOpcode_2A_2T_1R: Unknown opcode %X\n"
operator|,
name|WalkState
operator|->
name|Opcode
...
name|ACPI_DB_ERROR
operator|,
literal|"Index value (%X%8.8X) beyond package end (%X)\n"
operator|,
...
name|ACPI_DB_ERROR
operator|,
literal|"Index value (%X%8.8X) beyond end of buffer (%X)\n"
operator|,
name|ACPI_FORMAT_UINT64
argument_list|(
name|Index
...
expr_stmt|;
block|}
comment|/*          * Add a reference to the target package/buffer/string for the life          * of the index.          */
...
argument_list|)
expr_stmt|;
comment|/* Complete the Index reference object */
name|ReturnDesc
operator|->
name|Reference
operator|.
...
argument_list|(
operator|(
literal|"AcpiExOpcode_2A_1T_1R: Unknown opcode %X\n"
operator|,
name|WalkState
operator|->
name|Opcode
...
argument_list|(
operator|(
literal|"AcpiExOpcode_2A_0T_1R: Unknown opcode %X\n"
operator|,
name|WalkState
operator|->
name|Opcode
