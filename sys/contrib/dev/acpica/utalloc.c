...
begin_comment
comment|/******************************************************************************  *  * Module Name: utalloc - local memory allocation routines  *              $Revision: 1.149 $  *  *****************************************************************************/
end_comment
...
argument_list|,
operator|(
literal|"UtAllocate: Attempt to allocate zero bytes, allocating 1 byte\n"
operator|)
argument_list|)
expr_stmt|;
name|Size
...
argument_list|,
operator|(
literal|"UtCallocate: Attempt to allocate zero bytes, allocating 1 byte\n"
operator|)
argument_list|)
expr_stmt|;
name|Size
...
name|ACPI_DB_ERROR
operator|,
literal|"Could not free memory, %s\n"
operator|,
