...
begin_comment
comment|/******************************************************************************  *  * Name: acoutput.h -- debug output  *       $Revision: 80 $  *  *****************************************************************************/
end_comment
...
begin_comment
comment|/* Component IDs -- used in the global "DebugLayer" */
end_comment
...
directive|define
name|DEBUG_DEFAULT
value|(ACPI_OK | ACPI_WARN | ACPI_ERROR | ACPI_DEBUG_OBJECT)
end_define
...
directive|define
name|DEBUG_ALL
value|(VERBOSE_AML_DISASSEMBLE | TRACE_ALL | ACPI_ALL)
end_define
...
begin_comment
comment|/* used in DumpBuf function */
end_comment
