...
begin_comment
comment|/*******************************************************************************  *  * FUNCTION:    AcpiTbSystemTablePointer  *  * PARAMETERS:  *Where              - Pointer to be examined  *  * RETURN:      TRUE if Where is within the AML stream (in one of the ACPI  *              system tables such as the DSDT or an SSDT.)  *              FALSE otherwise  *  ******************************************************************************/
end_comment
...
name|Table
decl_stmt|;
comment|/* No function trace, called too often! */
comment|/* Ignore null pointer */
if|if
condition|(
operator|!
name|Where
...
return|;
block|}
comment|/* Check for a pointer within the DSDT */
if|if
condition|(
operator|(
name|AcpiGbl_DSDT
...
return|;
block|}
comment|/* Check each of the loaded SSDTs (if any)*/
name|TableDesc
operator|=
operator|&
name|AcpiGbl_AcpiTables
...
expr_stmt|;
block|}
comment|/* Check each of the loaded PSDTs (if any)*/
name|TableDesc
operator|=
operator|&
name|AcpiGbl_AcpiTables
...
expr_stmt|;
block|}
comment|/* Pointer does not point into any system table */
return|return
operator|(
name|FALSE
operator|)
...
argument_list|(
operator|(
literal|"Invalid table header length found\n"
operator|)
argument_list|)
expr_stmt|;
name|DUMP_BUFFER
