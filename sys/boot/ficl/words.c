...
begin_comment
comment|/*              fload - load a file and interpret it  *  * grabbed out of testmain.c example and frobbed to fit.  *  * Usage:  *    fload test.ficl  */
end_comment
...
name|pVM
argument_list|,
literal|"fload: no filename specified"
argument_list|,
literal|1
argument_list|)
expr_stmt|;
...
name|pVM
argument_list|,
literal|"fload: Unable to open file: "
argument_list|,
literal|0
argument_list|)
expr_stmt|;
...
name|pVM
argument_list|,
literal|"fload: Error in file %s, line %d"
argument_list|,
name|pFilename
operator|->
name|text
...
name|pVM
argument_list|,
literal|"fexists: no filename specified"
argument_list|,
literal|1
argument_list|)
expr_stmt|;
...
begin_comment
comment|/* Get a character from stdin */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* FreeBSD extention words */
name|dictAppendWord
argument_list|(
name|dp
argument_list|,
