...
begin_comment
comment|/* Insert first entry at this TLB slot. */
end_comment
...
name|e_entry
expr_stmt|;
comment|/* align the bootinfo structure on an eight byte boundary */
name|bip
operator|=
operator|(
expr|struct
...
name|printf
argument_list|(
literal|"mmu_mapin(): access to 0x%lx-0x%lx requested\n"
argument_list|,
name|va
argument_list|,
name|va
...
name|printf
argument_list|(
literal|"mmu_mapin(): map pa 0x%lx as va 0x%lx.\n"
argument_list|,
name|curkpg
argument_list|,
name|va
