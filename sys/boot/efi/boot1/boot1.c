...
begin_comment
comment|/*  * This function only returns if it fails to load the kernel. If it  * succeeds, it simply boots the kernel.  */
end_comment
...
block|}
block|}
comment|/* Select a partition to boot by trying each module in order. */
for|for
control|(
name|i
operator|=
