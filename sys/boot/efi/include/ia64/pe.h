...
begin_comment
comment|/*****************************************************************************  * The following stuff comes from winnt.h from the ia64sdk, plus the Plabel for  * loading EM executables.  *****************************************************************************/
end_comment
...
define|#
directive|define
name|IMAGE_REL_BASED_IA64_DIR64
value|10
end_define
...
decl_stmt|;
block|}
name|IMAGE_DEBUG_DIRECTORY_ENTRY
typedef|;
end_typedef
