...
parameter_list|)
block|{
comment|/* 	 * Read of time_status is lock-less, which is fine since 	 * ntp_is_time_error() operates on the consistent read value. 	 */
if|if
condition|(
operator|!
name|ntp_is_time_error
...
argument_list|)
expr_stmt|;
comment|/* Another unlocked read of time_status */
if|if
condition|(
name|resettodr_period
operator|>
