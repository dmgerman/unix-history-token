...
begin_comment
comment|/*-  * ----------------------------------------------------------------------------  * "THE BEER-WARE LICENSE" (Revision 42):  *<phk@FreeBSD.ORG> wrote this file.  As long as you retain this notice you  * can do whatever you want with this stuff. If we meet some day, and you think  * this stuff is worth it, you can buy me a beer in return.   Poul-Henning Kamp  * ----------------------------------------------------------------------------  *  * Copyright (c) 2011, 2015, 2016 The FreeBSD Foundation  * All rights reserved.  *  * Portions of this software were developed by Julien Ridoux at the University  * of Melbourne under sponsorship from the FreeBSD Foundation.  *  * Portions of this software were developed by Konstantin Belousov  * under sponsorship from the FreeBSD Foundation.  */
end_comment
...
begin_comment
comment|/*  * Step our concept of UTC.  This is done by modifying our estimate of  * when we booted.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* Avoid rtc_generation == 0, since td_rtcgen == 0 is special. */
...
begin_comment
comment|/*  *  Return true if the driver is aware of the abi version extensions in the  *  pps_state structure, and it supports at least the given abi version number.  */
end_comment
