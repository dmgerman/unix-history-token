...
name|printf
argument_list|(
literal|"exec_gzip: Error %d in vm)deallocate"
argument_list|,
name|error
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"exec_gzip: Error %d in vm_mmap"
argument_list|,
name|error
argument_list|)
expr_stmt|;
...
directive|if
literal|0
block|int i;     printf("<");     for(i=0;i<siz;i++)  	printf("%02x",slide[i]);     printf(">\n");
endif|#
directive|endif
name|printf
argument_list|(
...
name|printf
argument_list|(
literal|"file_offset=%lx virtual_offset=%lx"
argument_list|,
name|gz
operator|->
name|file_offset
