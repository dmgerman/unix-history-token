...
begin_comment
comment|/*  * System call switch table.  *  * DO NOT EDIT-- this file is automatically generated.  * $FreeBSD$  * created from FreeBSD: src/sys/kern/syscalls.master,v 1.188 2005/04/23 02:36:07 davidxu Exp   */
end_comment
...
name|compat4
argument_list|(
argument|AS(freebsd4_fhstatfs_args)
argument_list|,
argument|fhstatfs
argument_list|)
block|}
