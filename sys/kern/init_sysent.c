...
begin_comment
comment|/*  * System call switch table.  *  * DO NOT EDIT-- this file is automatically generated.  * $FreeBSD$  * created from FreeBSD: src/sys/kern/syscalls.master,v 1.194 2005/05/28 14:35:05 rwatson Exp   */
end_comment
...
name|compat
argument_list|(
argument|SYF_MPSAFE | AS(ocreat_args)
argument_list|,
argument|creat
argument_list|)
block|}
...
name|compat4
argument_list|(
argument|SYF_MPSAFE | AS(freebsd4_getfsstat_args)
argument_list|,
argument|getfsstat
argument_list|)
block|}
...
name|compat
argument_list|(
argument|SYF_MPSAFE | AS(olseek_args)
argument_list|,
argument|lseek
argument_list|)
block|}
...
name|compat
argument_list|(
argument|SYF_MPSAFE | AS(ostat_args)
argument_list|,
argument|stat
argument_list|)
block|}
...
name|compat
argument_list|(
argument|SYF_MPSAFE | AS(olstat_args)
argument_list|,
argument|lstat
argument_list|)
block|}
...
name|compat
argument_list|(
argument|SYF_MPSAFE | AS(otruncate_args)
argument_list|,
argument|truncate
argument_list|)
block|}
...
name|compat
argument_list|(
argument|SYF_MPSAFE | AS(oftruncate_args)
argument_list|,
argument|ftruncate
argument_list|)
block|}
...
name|compat4
argument_list|(
argument|SYF_MPSAFE | AS(freebsd4_statfs_args)
argument_list|,
argument|statfs
argument_list|)
block|}
...
name|compat4
argument_list|(
argument|SYF_MPSAFE | AS(freebsd4_fstatfs_args)
argument_list|,
argument|fstatfs
argument_list|)
block|}
...
name|compat4
argument_list|(
argument|SYF_MPSAFE | AS(freebsd4_fhstatfs_args)
argument_list|,
argument|fhstatfs
argument_list|)
block|}
...
name|compat4
argument_list|(
argument|SYF_MPSAFE | AS(freebsd4_sendfile_args)
argument_list|,
argument|sendfile
argument_list|)
block|}
