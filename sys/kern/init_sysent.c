...
begin_comment
comment|/*  * System call switch table.  *  * DO NOT EDIT-- this file is automatically generated.  * $FreeBSD$  * created from FreeBSD: src/sys/kern/syscalls.master,v 1.191 2005/05/28 13:09:41 rwatson Exp   */
end_comment
...
name|compat4
argument_list|(
argument|AS(freebsd4_getfsstat_args)
argument_list|,
argument|getfsstat
argument_list|)
block|}
...
name|compat4
argument_list|(
argument|AS(freebsd4_statfs_args)
argument_list|,
argument|statfs
argument_list|)
block|}
...
name|compat4
argument_list|(
argument|AS(freebsd4_fstatfs_args)
argument_list|,
argument|fstatfs
argument_list|)
block|}
