...
begin_comment
comment|/*  * msdos common header file  * [obtained from mtools -wfj]  * how to decipher DOS disk structures in coexisting with DOS  *  *	$Id$  *	from: i386/include/pc msdos.h,v 1.4  */
end_comment
