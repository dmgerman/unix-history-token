...
begin_comment
comment|/*  * System call switch table.  *  * DO NOT EDIT-- this file is automatically generated.  * $FreeBSD$  * created from FreeBSD: src/sys/alpha/linux/syscalls.master,v 1.42 2000/12/03 01:28:51 marcel Exp   */
end_comment
...
block|}
block|,
comment|/* 335 = sched_get_priority_max */
block|{
name|AS
argument_list|(
...
block|}
block|,
comment|/* 336 = sched_get_priority_min */
block|{
name|AS
argument_list|(
