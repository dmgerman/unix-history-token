...
begin_comment
comment|/*  * Print all trace entries  */
end_comment
...
name|ts
decl_stmt|;
comment|/* Pick the newest trace entry from all CPU's */
name|kp
operator|=
name|NULL
expr_stmt|;
...
directive|if
literal|0
if|if (kernacc(d, 80, B_READ) == 0) 		d = "*** Corrupt entry ***";
endif|#
directive|endif
elseif|else
if|if
...
name|lastt
expr_stmt|;
comment|/* timespecsub(&ts,&kp->ktr_tv); */
name|db_printf
argument_list|(
literal|"%4d.%06ld: "
argument_list|,
...
directive|if
literal|0
block|if (kdebug_vflag) 		db_printf("   p1=%x p2=%x p3=%x p4=%x p5=%x", (u_int)kp->ktr_parm1, 		    (u_int)kp->ktr_parm2, (u_int)kp->ktr_parm3, 		    (u_int)kp->ktr_parm4, (u_int)kp->ktr_parm5);
endif|#
directive|endif
name|db_printf
argument_list|(
