...
begin_comment
comment|/*  * Resource representing allocated physical address space  * for the grant table metainfo  */
end_comment
...
specifier|static
name|int
name|gnttab_pseudo_phys_res_id
decl_stmt|;
end_decl_stmt
...
name|printf
argument_list|(
literal|"%s: WARNING: g.e. still in use!\n"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"%s: WARNING: leaking g.e. and page still in use!\n"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
block|{
comment|/* 			 * XXX This needs to be fixed so that the ref  			 * is placed on a list to be freed up later. 			 */
name|printf
argument_list|(
literal|"%s: WARNING: leaking g.e. still in use!\n"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
...
argument_list|,
operator|(
literal|"No resume frames and no device provided"
operator|)
argument_list|)
expr_stmt|;
name|gnttab_pseudo_phys_res
...
name|panic
argument_list|(
literal|"Unable to reserve physical memory for gnttab"
argument_list|)
expr_stmt|;
name|resume_frames
operator|=
