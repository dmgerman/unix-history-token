...
begin_comment
comment|/*  * This case is being handled in coda_fbsd.c  * What we want is too hairy for VFS_SET to get right!  * XXX but VFS_KLD does it in VFS_SET..  */
end_comment
