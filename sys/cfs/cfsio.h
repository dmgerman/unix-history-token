...
begin_comment
comment|/* $Header: /afs/cs/project/coda-src/cvs/coda/kernel-src/vfs/freebsd/cfs/cfsio.h,v 1.5 1998/08/18 17:05:23 rvb Exp $ */
end_comment
...
begin_comment
comment|/* sys/ioctl.h puts the quotes on */
end_comment
