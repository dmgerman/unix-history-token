...
begin_comment
comment|/* $Header: /afs/cs/project/coda-src/cvs/coda/kernel-src/vfs/freebsd/cfs/cfs_vfsops.c,v 1.11 1998/08/28 18:12:22 rvb Exp $ */
end_comment
...
begin_comment
comment|/* For sanity check in cfs_mount */
end_comment
...
begin_comment
comment|/* NetBSD interface to statfs */
end_comment
...
name|__FreeBSD__
argument_list|)
comment|/* Seems a bit overkill, since usualy /coda is the only mount point      * for cfs.      */
name|getnewfsid
argument_list|(
name|vfsp
argument_list|,
...
name|printf
argument_list|(
literal|"cfs_unmount: busy\n"
argument_list|)
expr_stmt|;
block|}
else|#
directive|else
comment|/* FreeBSD I guess */
name|active
operator|=
name|cfs_kill
argument_list|(
...
condition|)
block|{
comment|/* 	case FFS_CLUSTERREAD: 		return (sysctl_int(oldp, oldlp, newp, newl,&doclusterread));  */
default|default:
return|return
operator|(
name|EOPNOTSUPP
