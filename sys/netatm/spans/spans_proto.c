...
begin_comment
comment|/*  *  * ===================================  * HARP  |  Host ATM Research Platform  * ===================================  *  *  * This Host ATM Research Platform ("HARP") file (the "Software") is  * made available by Network Computing Services, Inc. ("NetworkCS")  * "AS IS".  NetworkCS does not provide maintenance, improvements or  * support of any kind.  *  * NETWORKCS MAKES NO WARRANTIES OR REPRESENTATIONS, EXPRESS OR IMPLIED,  * INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY  * AND FITNESS FOR A PARTICULAR PURPOSE, AS TO ANY ELEMENT OF THE  * SOFTWARE OR ANY SUPPORT PROVIDED IN CONNECTION WITH THIS SOFTWARE.  * In no event shall NetworkCS be responsible for any damages, including  * but not limited to consequential damages, arising from or relating to  * any use of the Software or related support.  *  * Copyright 1994-1998 Network Computing Services, Inc.  *  * Copies of this Software may be made, however, the above copyright  * notice must be reproduced on all copies.  *  *	@(#) $Id: spans_proto.c,v 1.7 1998/08/26 23:29:10 mks Exp $  *  */
end_comment
...
name|RCSid
init|=
literal|"@(#) $Id: spans_proto.c,v 1.7 1998/08/26 23:29:10 mks Exp $"
decl_stmt|;
end_decl_stmt
...
name|ATM_DEBUG2
argument_list|(
literal|"spans_timer: spp=0x%x,state=%d\n"
argument_list|,
operator|(
name|int
operator|)
...
name|LOG_ERR
argument_list|,
literal|"spans: timer state: spp=0x%x, state=%d\n"
argument_list|,
operator|(
name|int
operator|)
...
name|ATM_DEBUG3
argument_list|(
literal|"spans_vctimer: svp=0x%x, sstate=%d, ustate=%d\n"
argument_list|,
operator|(
name|int
operator|)
...
name|LOG_ERR
argument_list|,
literal|"spans: vctimer state: svp=0x%x, sstate=%d\n"
argument_list|,
operator|(
name|int
operator|)
...
name|ATM_DEBUG2
argument_list|(
literal|"spans_connected: spp=0x%x,state=%d\n"
argument_list|,
operator|(
name|int
operator|)
...
name|LOG_ERR
argument_list|,
literal|"spans: connected function called, tok=0x%x\n"
argument_list|,
operator|(
name|int
operator|)
...
name|ATM_DEBUG3
argument_list|(
literal|"spans_cpcs_data: spp=0x%x,state=%d,m=0x%x,\n"
argument_list|,
operator|(
name|int
operator|)
