...
begin_comment
comment|/*  *  * ===================================  * HARP  |  Host ATM Research Platform  * ===================================  *  *  * This Host ATM Research Platform ("HARP") file (the "Software") is  * made available by Network Computing Services, Inc. ("NetworkCS")  * "AS IS".  NetworkCS does not provide maintenance, improvements or  * support of any kind.  *  * NETWORKCS MAKES NO WARRANTIES OR REPRESENTATIONS, EXPRESS OR IMPLIED,  * INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY  * AND FITNESS FOR A PARTICULAR PURPOSE, AS TO ANY ELEMENT OF THE  * SOFTWARE OR ANY SUPPORT PROVIDED IN CONNECTION WITH THIS SOFTWARE.  * In no event shall NetworkCS be responsible for any damages, including  * but not limited to consequential damages, arising from or relating to  * any use of the Software or related support.  *  * Copyright 1994-1998 Network Computing Services, Inc.  *  * Copies of this Software may be made, however, the above copyright  * notice must be reproduced on all copies.  *  *	@(#) $Id: spans_print.c,v 1.4 1997/05/06 22:17:11 mks Exp $  *  */
end_comment
...
name|RCSid
init|=
literal|"@(#) $Id: spans_print.c,v 1.4 1997/05/06 22:17:11 mks Exp $"
decl_stmt|;
end_decl_stmt
...
name|printf
argument_list|(
literal|"sw_epoch=0x%x, es_addr=%s, sw_addr=0x%s"
argument_list|,
name|stind_p
operator|->
name|stind_sw_epoch
...
name|printf
argument_list|(
literal|"es_epoch=0x%x, es_addr=%s"
argument_list|,
name|strsp_p
operator|->
name|strsp_es_epoch
