...
begin_comment
comment|/*  *  * ===================================  * HARP  |  Host ATM Research Platform  * ===================================  *  *  * This Host ATM Research Platform ("HARP") file (the "Software") is  * made available by Network Computing Services, Inc. ("NetworkCS")  * "AS IS".  NetworkCS does not provide maintenance, improvements or  * support of any kind.  *  * NETWORKCS MAKES NO WARRANTIES OR REPRESENTATIONS, EXPRESS OR IMPLIED,  * INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY  * AND FITNESS FOR A PARTICULAR PURPOSE, AS TO ANY ELEMENT OF THE  * SOFTWARE OR ANY SUPPORT PROVIDED IN CONNECTION WITH THIS SOFTWARE.  * In no event shall NetworkCS be responsible for any damages, including  * but not limited to consequential damages, arising from or relating to  * any use of the Software or related support.  *  * Copyright 1994-1998 Network Computing Services, Inc.  *  * Copies of this Software may be made, however, the above copyright  * notice must be reproduced on all copies.  *  *	@(#) $Id: unisig_vc_state.c,v 1.11 1998/08/06 18:16:29 mks Exp $  *  */
end_comment
...
name|RCSid
init|=
literal|"@(#) $Id: unisig_vc_state.c,v 1.11 1998/08/06 18:16:29 mks Exp $"
decl_stmt|;
end_decl_stmt
...
name|int
argument_list|(
argument|*unisig_vc_act_vec[MAX_ACTION]
argument_list|)
name|__P
argument_list|(
operator|(
...
name|ATM_DEBUG4
argument_list|(
literal|"unisig_vc_state: uvp=0x%x, state=%d, event=%d, action=%d\n"
argument_list|,
operator|(
name|int
operator|)
...
name|ATM_DEBUG3
argument_list|(
literal|"unisig_vc_act08: usp=0x%x, uvp=0x%x, msg=0x%x\n"
argument_list|,
operator|(
name|int
operator|)
...
name|ATM_DEBUG3
argument_list|(
literal|"unisig_vc_perror: usp=0x%x, uvp=0x%x, msg=0x%x\n"
argument_list|,
operator|(
name|int
operator|)
