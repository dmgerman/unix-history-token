...
name|RCSid
init|=
literal|"@(#) $Id: sscf_uni_lower.c,v 1.6 1998/04/07 23:23:26 mks Exp $"
decl_stmt|;
end_decl_stmt
...
name|ATM_DEBUG5
argument_list|(
literal|"sscf_uni_lower: cmd=0x%x, uvp=0x%x, ustate=%d, arg1=0x%x, arg2=0x%x\n"
argument_list|,
name|cmd
argument_list|,
operator|(
...
name|LOG_ERR
argument_list|,
literal|"sscf_uni_lower: unknown cmd 0x%x, uvp=0x%x\n"
argument_list|,
name|cmd
argument_list|,
operator|(
