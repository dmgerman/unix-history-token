...
name|IVF_LLC
expr_stmt|;
comment|/* 	 * Fill out connection attributes 	 * Make a temporary copy of the attributes here so that we 	 * do not change the default attributes for SVCs. Otherwise this 	 * will give trouble in a mixed SVC/PVC case. 	 */
name|ap
operator|=
name|malloc
argument_list|(
...
expr_stmt|;
block|}
comment|/* 	 * Build the ATM attributes 	 */
name|ap
operator|->
name|nif
operator|=
...
name|T_ATM_CBR
case|:
comment|/* 		 * PCR=0 means `use up to the PIF's PCR' 		 */
if|if
condition|(
name|pvp
operator|->
