...
begin_comment
comment|/*  * net.harp.atm.atm_debug  */
end_comment
...
literal|0
argument_list|,
literal|"HARP ATM layer debugging flag"
argument_list|)
expr_stmt|;
end_expr_stmt

begin_comment
comment|/*  * net.harp.atm.atm_dev_print  */
end_comment
...
literal|0
argument_list|,
literal|"display ATM CPCS headers"
argument_list|)
expr_stmt|;
end_expr_stmt

begin_comment
comment|/*  * net.harp.atm.atm_print_data  */
end_comment
...
literal|0
argument_list|,
literal|"display ATM CPCS payloads"
argument_list|)
expr_stmt|;
end_expr_stmt
