...
begin_comment
comment|/*  *  * ===================================  * HARP  |  Host ATM Research Platform  * ===================================  *  *  * This Host ATM Research Platform ("HARP") file (the "Software") is  * made available by Network Computing Services, Inc. ("NetworkCS")  * "AS IS".  NetworkCS does not provide maintenance, improvements or  * support of any kind.  *  * NETWORKCS MAKES NO WARRANTIES OR REPRESENTATIONS, EXPRESS OR IMPLIED,  * INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY  * AND FITNESS FOR A PARTICULAR PURPOSE, AS TO ANY ELEMENT OF THE  * SOFTWARE OR ANY SUPPORT PROVIDED IN CONNECTION WITH THIS SOFTWARE.  * In no event shall NetworkCS be responsible for any damages, including  * but not limited to consequential damages, arising from or relating to  * any use of the Software or related support.  *  * Copyright 1994-1998 Network Computing Services, Inc.  *  * Copies of this Software may be made, however, the above copyright  * notice must be reproduced on all copies.  *  *	@(#) $Id: atm_device.c,v 1.7 1998/03/24 20:42:39 mks Exp $  *  */
end_comment
...
name|RCSid
init|=
literal|"@(#) $Id: atm_device.c,v 1.7 1998/03/24 20:42:39 mks Exp $"
decl_stmt|;
end_decl_stmt
...
name|LOG_ERR
argument_list|,
literal|"atm_dev_lower: INIT: tok=0x%x, state=%d\n"
argument_list|,
operator|(
name|int
operator|)
...
name|LOG_ERR
argument_list|,
literal|"atm_dev_lower: dup SVC (%d,%d) tok=0x%x\n"
argument_list|,
name|vcp
operator|->
name|vc_vpi
...
name|LOG_ERR
argument_list|,
literal|"atm_dev_lower: UNITDATA: tok=0x%x, state=%d\n"
argument_list|,
operator|(
name|int
operator|)
...
name|LOG_ERR
argument_list|,
literal|"atm_dev_lower: unimplemented stack cmd 0x%x, tok=0x%x\n"
argument_list|,
name|cmd
argument_list|,
operator|(
...
name|LOG_ERR
argument_list|,
literal|"atm_dev_lower: unknown stack cmd 0x%x, tok=0x%x\n"
argument_list|,
name|cmd
argument_list|,
operator|(
...
name|ATM_DEBUG4
argument_list|(
literal|"atm_dev_alloc: size=%d, align=%d, flags=%d, uaddr=0x%x\n"
argument_list|,
name|size
argument_list|,
name|align
...
name|ATM_DEBUG1
argument_list|(
literal|"atm_dev_free: uaddr=0x%x\n"
argument_list|,
operator|(
name|int
operator|)
