...
begin_comment
comment|/*  * Written by Julian Elischer (julian@tfs.com)  * for TRW Financial Systems for use under the MACH(2.5) operating system.  *  * TRW Financial Systems, in accordance with their agreement with Carnegie  * Mellon University, makes this software available to CMU to distribute  * or use in any manner that they see fit as long as this message is kept with  * the software. For this reason TFS also grants any other persons or  * organisations permission to use or modify this software.  *  * TFS supplies this software to be publicly redistributed  * on the understanding that TFS is not responsible for the correct  * functioning of this software in any circumstances.  *  * Ported to run under 386BSD by Julian Elischer (julian@tfs.com) Sept 1992  *  * New configuration setup: dufault@hda.com  *  *      $Id: scsiconf.c,v 1.107 1998/07/28 09:03:37 phk Exp $  */
end_comment
...
block|}
block|,
comment|/* IODATA CD-C68E 6 CD changer */
block|{
name|T_READONLY
block|,
name|T_READONLY
...
name|printf
argument_list|(
literal|"%s%lu: malloc failed for scsi_data\n"
argument_list|,
name|sc_link
operator|->
name|device
...
name|printf
argument_list|(
literal|"%s%lu: Can't store link pointer.\n"
argument_list|,
name|sc_link
operator|->
name|device
