...
name|printf
argument_list|(
literal|"%ldMB (%ld total sec), %d cyl, %d head, %d sec, bytes/sec %d\n"
argument_list|,
name|dp
operator|->
name|disksize
...
argument_list|,
operator|(
literal|"sdopen: dev=0x%x (unit %d, partition %d)\n"
operator|,
name|dev
operator|,
name|unit
