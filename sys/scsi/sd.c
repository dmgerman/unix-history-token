...
argument_list|)
expr_stmt|;
comment|/* check if secsiz is zero and set it to something reasonable 	  to prevent a divide fault. */
if|if
condition|(
name|dp
operator|->
