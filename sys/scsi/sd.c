...
comment|/* Hack for some special disk in disk arrays */
if|if
condition|(
name|sd
operator|->
...
name|printf
argument_list|(
literal|"sd%ld:  Forcing sector size to %d\n"
argument_list|,
name|unit
argument_list|,
name|SECSIZE
