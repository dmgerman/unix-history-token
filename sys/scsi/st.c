...
begin_comment
comment|/*  * Written by Julian Elischer (julian@tfs.com)(now julian@DIALix.oz.au)  * for TRW Financial Systems for use under the MACH(2.5) operating system.  *  * TRW Financial Systems, in accordance with their agreement with Carnegie  * Mellon University, makes this software available to CMU to distribute  * or use in any manner that they see fit as long as this message is kept with  * the software. For this reason TFS also grants any other persons or  * organisations permission to use or modify this software.  *  * TFS supplies this software to be publicly redistributed  * on the understanding that TFS is not responsible for the correct  * functioning of this software in any circumstances.  *  * Ported to run under 386BSD by Julian Elischer (julian@tfs.com) Sept 1992  * major changes by Julian Elischer (julian@jules.dialix.oz.au) May 1993  *  *	$Id: st.c,v 1.10 1993/10/11 04:53:23 rgrimes Exp $  */
end_comment
...
begin_comment
comment|/* EOF file mark written  -- */
end_comment

begin_comment
comment|/* used with ~ST_WRITTEN to indicate  */
end_comment

begin_comment
comment|/* that multiple file marks have been */
end_comment
...
directive|define
name|ST_PER_MEDIA
value|(ST_INFO_VALID | ST_BLOCK_SET | ST_WRITTEN | \ 			ST_FIXEDBLOCKS | ST_AT_BOM | ST_READONLY | \ 			ST_FM_WRITTEN | ST_2FM_AT_EOD | ST_PER_ACTION)
end_define
...
block|}
comment|/***************************************************************\ 	* Decide whether or not to write two file marks to signify end-	* 	* of-data.  Make the decision as a function of density.  If	* 	* the decision is not to use a second file mark, the SCSI BLANK	* 	* CHECK condition code will be recognized as end-of-data when	* 	* first read.							* 	\***************************************************************/
switch|switch
condition|(
name|st
operator|->
...
expr_stmt|;
block|}
comment|/***************************************************************\ 	* Make sure that a tape opened in write-only mode will have	* 	* file marks written on it.  This is the only way to write a	* 	* zero-length file on tape.					* 	\***************************************************************/
if|if
condition|(
operator|(
name|flags
...
name|printf
argument_list|(
literal|"st%d: %d-byte block wrong size"
literal|"\n"
argument_list|,
name|unit
argument_list|,
