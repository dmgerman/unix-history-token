...
begin_comment
comment|/*  * Ported to run under 386BSD by Julian Elischer (julian@tfs.com) Sept 1992  * major changes by Julian Elischer (julian@jules.dialix.oz.au) May 1993  *  *	$Id: st.c,v 1.23 93/08/26 21:09:51 julian Exp Locker: julian $  */
end_comment
...
literal|0
condition|)
comment|/* set it back the way it was */
block|{
name|st
operator|->
name|flags
...
directive|endif
comment|/*STDEBUG*/
comment|/***************************************************************\ 	* Second, set the density, and set the quirk flags as a		* 	* function of the density.					* 	\***************************************************************/
name|st
operator|->
name|quirks
operator|=
...
condition|)
block|{
comment|/*******************************************************\ 		* If the user specified the density, believe him.	* 		\*******************************************************/
name|st
operator|->
name|density
operator|=
...
goto|;
block|}
comment|/***************************************************************\ 	* If we're about to read the tape, perhaps we should choose	* 	* fixed or variable-length blocks and block size according to	* 	* what the drive found on the tape.				* 	* ****though it probably hasn't looked yet!****			* 	\***************************************************************/
if|if
condition|(
name|first_read
condition|)
...
goto|;
block|}
comment|/***************************************************************\ 	* If the drive says it can handle variable size blocks		* 	* and nothing has been specified until now, hey let's do it	* 	\***************************************************************/
if|if
condition|(
name|st
operator|->
...
goto|;
block|}
comment|/***************************************************************\ 	* We're getting no hints from any direction.  Choose fixed-	* 	* length blocks arbitrarily.					* 	\***************************************************************/
name|st
operator|->
name|flags
operator||=
...
name|printf
argument_list|(
literal|"Give up and default to fixed mode\n"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
name|ST_Q_FORCE_FIXED_MODE
condition|)
comment|/* Per definition in mtio.h, this is a	*/
comment|/* no-op for a real fixed block device	*/
break|break;
if|if
condition|(
operator|!
...
name|printf
argument_list|(
literal|"st%d: record of %d bytes too big\n"
argument_list|,
name|unit
argument_list|,
name|xs
...
name|printf
argument_list|(
literal|"st%d: tape is write protected\n"
argument_list|,
name|unit
argument_list|)
expr_stmt|;
