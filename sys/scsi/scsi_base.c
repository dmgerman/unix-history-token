...
block|}
comment|/* BUG: This isn't used anywhere. Do you have plans for it, 		 * Julian? (dufault@hda.com). 		 */
if|if
condition|(
name|retval
operator|==
...
name|errcode
decl_stmt|;
comment|/* 	 * If the flags say errs are ok, then always return ok. 	 * BUG: What if it is a deferred error? 	 */
if|if
condition|(
name|xs
operator|->
