...
begin_comment
comment|/*  * Written by Julian Elischer (julian@tfs.com)  * for TRW Financial Systems for use under the MACH(2.5) operating system.  *  * TRW Financial Systems, in accordance with their agreement with Carnegie  * Mellon University, makes this software available to CMU to distribute  * or use in any manner that they see fit as long as this message is kept with  * the software. For this reason TFS also grants any other persons or  * organisations permission to use or modify this software.  *  * TFS supplies this software to be publicly redistributed  * on the understanding that TFS is not responsible for the correct  * functioning of this software in any circumstances.  *  * Ported to run under 386BSD by Julian Elischer (julian@tfs.com) Sept 1992  *  *      $Id: cd.c,v 1.96 1998/07/11 07:45:56 bde Exp $  */
end_comment
...
argument_list|,
operator|(
literal|"cd_open: dev=0x%lx (unit %lu,partition %d)\n"
operator|,
operator|(
name|u_long
operator|)
...
argument_list|)
expr_stmt|;
comment|/* 	 * Build prototype label for whole disk. 	 * Should put manufacturer and model in d_typename and d_packname. 	 * Should take information about different data tracks from the 	 * TOC and put it in the partition table. 	 */
name|bzero
argument_list|(
operator|&
name|label
...
parameter_list|)
block|{
comment|/* 	 * XXX - do something to make cdstrategy() but not this block while 	 * we're doing dsinit() and dsioctl(). 	 */
name|cdstrategy
argument_list|(
name|bp
argument_list|)
...
block|}
comment|/* 	 * We have a buf, now we should make a command 	 */
name|blkno
operator|=
name|bp
operator|->
...
comment|/* XXX this is how sd does it.  How did we work without this? */
block|error = scsi_device_lock(sc_link); 	if (error) 		return error;
endif|#
directive|endif
name|error
operator|=
