...
begin_comment
comment|/*  * Written by Julian Elischer (julian@tfs.com)  * for TRW Financial Systems for use under the MACH(2.5) operating system.  *  * TRW Financial Systems, in accordance with their agreement with Carnegie  * Mellon University, makes this software available to CMU to distribute  * or use in any manner that they see fit as long as this message is kept with  * the software. For this reason TFS also grants any other persons or  * organisations permission to use or modify this software.  *  * TFS supplies this software to be publicly redistributed  * on the understanding that TFS is not responsible for the correct  * functioning of this software in any circumstances.  *  * Ported to run under 386BSD by Julian Elischer (julian@tfs.com) Sept 1992  *  *	$Id: cd.c,v 1.10 1993/09/21 05:30:35 rgrimes Exp $  */
end_comment
...
directive|endif
comment|/*CDDEBUG*/
comment|/*******************************************************\ 	* Check if we have resources allocated yet, if not	* 	* allocate and initialize them				* 	\*******************************************************/
if|if
condition|(
name|next_cd_unit
operator|==
...
name|printf
argument_list|(
literal|"cd%d: malloc failed for cd_driver\n"
argument_list|,
name|unit
argument_list|)
expr_stmt|;
...
block|}
comment|/*******************************************************\ 	* We have a buf, now we should move the data into	* 	* a scsi_xfer definition and try start it		* 	*							* 	*  First, translate the block to absolute		* 	* and put it in terms of the logical blocksize of the	* 	* device..						* 	* really a bit silly until we have real partitions, but.* 	\*******************************************************/
name|blkno
operator|=
name|bp
operator|->
...
operator|==
name|CD_EJECT
comment|/*&& (cd->openparts  == 0)*/
condition|)
comment|/* trouble is WE have it open */
comment|/*XXX*/
block|{
name|cd_prevent_unit
argument_list|(
...
block|{
comment|/* !? how'd we GET here? */
name|panic
argument_list|(
literal|"attempt to run bad cd device"
argument_list|)
expr_stmt|;
block|}
endif|#
...
argument_list|)
expr_stmt|;
comment|/* Fall through to check the result */
case|case
name|HAD_ERROR
case|:
switch|switch
...
name|XS_BUSY
case|:
comment|/* should sleep here 1 sec */
comment|/* fall through */
case|case
name|XS_TIMEOUT
case|:
...
expr_stmt|;
block|}
comment|/*******************************************************\ 	* we have finished doing the  command, free the struct	* 	* and check if anyone else needs it			* 	\*******************************************************/
name|cd_free_xs
argument_list|(
name|unit
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* check if anything is waiting for the xs */
return|return
operator|(
name|retval
operator|)
...
name|printf
argument_list|(
literal|"cd%d: DELAYED ERROR, key = 0x%x\n"
argument_list|,
name|unit
argument_list|,
name|key
