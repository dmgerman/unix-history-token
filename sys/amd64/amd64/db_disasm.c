...
begin_comment
comment|/* quad register, in 'reg' field */
end_comment
...
begin_comment
comment|/* long/quad immediate, unsigned */
end_comment
...
begin_comment
comment|/* address, long/quad size */
end_comment
...
begin_comment
comment|/* address, explicitly long size */
end_comment
...
name|byte
parameter_list|)
value|((((byte)>>3)&0x7) | (rex& REX_R ? 0x8 : 0x0))
end_define
...
name|byte
parameter_list|)
value|(((byte)&0x7) | (rex& REX_B ? 0x8 : 0x0))
end_define
...
name|byte
parameter_list|)
value|((((byte)>>3)&0x7) | (rex& REX_X ? 0x8 : 0x0))
end_define
...
expr_stmt|;
block|}
comment|/* Special cases that don't fit well in the tables. */
if|if
condition|(
name|ip
operator|->
...
expr_stmt|;
block|}
comment|/* Handle instructions identified by mandatory prefixes. */
if|if
condition|(
name|rep
operator|==
