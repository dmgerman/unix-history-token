...
begin_comment
comment|/* This will never be defined by config(8), or for the if_tun module ! */
end_comment
...
argument_list|()
expr_stmt|;
comment|/* spl on queue manipulation */
name|IF_DROP
argument_list|(
operator|&
name|ifp
...
name|TUN_IFHEAD
condition|)
comment|/* 			 * Conveniently, we already have a 4-byte address 			 * family prepended to our packet ! 			 */
name|bpf_mtap
argument_list|(
name|ifp
argument_list|,
