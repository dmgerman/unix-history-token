...
begin_comment
comment|/*  * tunnel open.  We assume that any tun_clone() call is immediately  * followed by a call to tunopen() - otherwise nothing will ever  * destroy_dev() the specinfo.  */
end_comment
