...
name|tun_cv
decl_stmt|;
comment|/* protect against ref'd dev destroy */
block|}
struct|;
end_struct
...
literal|0
argument_list|,
literal|"IP tunnel software network interface."
argument_list|)
expr_stmt|;
end_expr_stmt
...
condition|)
return|return;
comment|/* 	 * If tun cloning is enabled, only the superuser can create an 	 * interface. 	 */
if|if
condition|(
operator|!
name|tundclone
