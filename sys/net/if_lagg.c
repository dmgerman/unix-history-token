...
begin_comment
comment|/*  * Return a 32-bit hash of the given buffer.  * XXX Taken from sys/sys/hash.h. This file can not be included directly due to  * compiler warnings that need an API change to fix.  */
end_comment
