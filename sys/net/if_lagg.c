...
argument_list|)
expr_stmt|;
comment|/* 	 * Set the link layer address on the lagg interface. 	 * sc_lladdr() notifies the MAC change to 	 * the aggregation protocol.  iflladdr_event handler which 	 * may trigger gratuitous ARPs for INET will be handled in 	 * a taskqueue. 	 */
name|bcopy
argument_list|(
name|lladdr
argument_list|,
...
break|break;
block|}
comment|/* Set to LAGG_PROTO_NONE during the attach. */
name|LAGG_WLOCK
argument_list|(
name|sc
argument_list|)
