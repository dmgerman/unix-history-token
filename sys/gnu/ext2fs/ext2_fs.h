...
modifier|...
parameter_list|)
value|{ \ 					printk ("EXT2-fs DEBUG (%s, %d): %s:", \ 						__FILE__, __LINE__, __FUNCTION__); \ 				  	printk (f, ## a); \ 					}
end_define
...
begin_comment
comment|/*  * Ok, these declarations are also in<linux/kernel.h> but none of the  * ext2 source programs needs to include it so they are duplicated here.  */
end_comment
...
begin_comment
comment|/*  * Inodes and files operations  */
end_comment
...
name|ext2_dir_inode_operations
decl_stmt|;
end_decl_stmt
...
name|struct
name|inode_operations
name|ext2_file_inode_operations
decl_stmt|;
end_decl_stmt
...
name|struct
name|inode_operations
name|ext2_symlink_inode_operations
decl_stmt|;
end_decl_stmt
...
name|struct
name|inode_operations
name|ext2_fast_symlink_inode_operations
decl_stmt|;
end_decl_stmt
