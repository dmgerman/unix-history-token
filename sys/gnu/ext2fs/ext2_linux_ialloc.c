...
begin_comment
comment|/*  * This function sets the deletion time for the inode  *  * This may be used one day by an 'undelete' program  */
end_comment

begin_function
specifier|static
name|void
name|set_inode_dtime
parameter_list|(
name|struct
name|inode
modifier|*
...
name|i_sb
argument_list|,
literal|"set_inode_dtime"
argument_list|,
literal|"Cannot load inode table block - "
