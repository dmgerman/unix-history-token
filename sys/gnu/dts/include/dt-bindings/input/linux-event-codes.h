...
ifndef|#
directive|ifndef
name|_UAPI_INPUT_EVENT_CODES_H
end_ifndef
...
begin_comment
comment|/*  * Keys and buttons  *  * Most of the keys/buttons are modeled after USB HUT 1.12  * (see http://www.usb.org/developers/hidpage).  * Abbreviations in the comments:  * AC - Application Control  * AL - Application Launch Button  * SC - System Control  */
end_comment
...
begin_comment
comment|/* Diagonal movement keys */
end_comment
...
begin_comment
comment|/* Show Device's Root Menu */
end_comment

begin_comment
comment|/* Show Top Menu of the Media (e.g. DVD) */
end_comment
...
begin_comment
comment|/*  * Toggle Audio Description: refers to an audio service that helps blind and  * visually impaired consumers understand the action in a program. Note: in  * some countries this is referred to as "Video Description".  */
end_comment
...
begin_comment
comment|/*  * Control a data application associated with the currently viewed channel,  * e.g. teletext or data broadcast application (MHEG, MHP, HbbTV, etc.)  */
end_comment
