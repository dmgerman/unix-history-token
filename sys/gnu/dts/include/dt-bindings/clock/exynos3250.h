...
define|#
directive|define
name|CLK_SCLK_MPWM_ISP
value|47
end_define

begin_comment
comment|/*  * Total number of clocks of CMU_ISP.  * NOTE: Must be equal to last clock ID increased by one.  */
end_comment
