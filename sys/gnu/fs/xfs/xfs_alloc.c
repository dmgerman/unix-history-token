...
begin_comment
comment|/*  * Free space allocation for XFS.  */
end_comment
...
name|mp
parameter_list|,
comment|/* file system mount poing */
name|xfs_agnumber_t
name|agno
parameter_list|,
comment|/* allocation group number */
...
name|NULL
expr_stmt|;
comment|/* If this is a metadata prefered pag and we are user data 	 * then try somewhere else if we are not being asked to 	 * try harder at this point 	 */
if|if
condition|(
name|pag
operator|->
