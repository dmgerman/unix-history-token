...
begin_comment
comment|/*  * xfs_dir2_leaf.c  * XFS directory version 2 implementation - single leaf form  * see xfs_dir2_leaf.h for data structures.  * These directories have multiple XFS_DIR2_DATA blocks and one  * XFS_DIR2_LEAF1 block containing the hash table and freespace map.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* 			 * Copy entries down to copver the stale entry 			 * and make room for the new entry. 			 */
if|if
condition|(
name|highstale
operator|-
