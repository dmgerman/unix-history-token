...
literal|"PRIVATE_BH"
block|,
literal|"ALL_PAGES_MAPPED"
block|,
literal|"ADDR_ALLOCATED"
block|,
comment|/* 20 */
literal|"MEM_ALLOCATED"
block|,
literal|"MEM_SLAB"
block|,
literal|"FORCEIO"
...
name|kdb_printf
argument_list|(
literal|"  pb_target 0x%p pb_hold %d pb_next 0x%p pb_prev 0x%p\n"
argument_list|,
name|pb
operator|->
name|pb_target
...
name|kdb_printf
argument_list|(
literal|"  pb_hash_index %d pb_hash_next 0x%p pb_hash_prev 0x%p\n"
argument_list|,
name|pb
operator|->
name|pb_hash_index
...
name|kdb_printf
argument_list|(
literal|"  pb_file_offset 0x%llx pb_buffer_length 0x%llx pb_addr 0x%p\n"
argument_list|,
operator|(
name|unsigned
name|long
...
name|kdb_printf
argument_list|(
literal|"  pb_bn 0x%Lx pb_count_desired 0x%lx pb_locked %d\n"
argument_list|,
name|pb
operator|->
name|pb_bn
...
name|kdb_printf
argument_list|(
literal|"  pb_flushtime %ld (%ld) pb_io_remaining %d pb_error %u\n"
argument_list|,
name|pb
operator|->
name|pb_flushtime
...
name|kdb_printf
argument_list|(
literal|"  pb_page_count %u pb_offset 0x%x pb_pages 0x%p\n"
argument_list|,
name|pb
operator|->
name|pb_page_count
...
name|kdb_printf
argument_list|(
literal|"  pb_iodonesema (%d,%d) pb_sema (%d,%d) pincount (%d)\n"
argument_list|,
name|pb
operator|->
name|pb_iodonesema
...
name|kdb_printf
argument_list|(
literal|"  pb_fspriv 0x%p pb_fspriv2 0x%p\n"
argument_list|,
name|pb
operator|->
name|pb_fspriv
...
name|kdb_printf
argument_list|(
literal|"index pb       pin   flushtime\n"
argument_list|)
expr_stmt|;
block|}
...
name|kdb_printf
argument_list|(
literal|"pbd_delwrite_queue inaccessible (non-debug)\n"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
name|kdb_printf
argument_list|(
literal|"  iomap_bn 0x%llx iomap_offset 0x%Lx iomap_delta 0x%lx iomap_bsize 0x%llx\n"
argument_list|,
operator|(
name|long
name|long
...
name|kdb_printf
argument_list|(
literal|"pb 0x%p [%s] (hold %lu lock %ld) data 0x%p"
argument_list|,
name|ktep
operator|->
name|val
...
block|,
literal|"Dump XFS to-be-freed extent list"
block|}
block|,
block|{
literal|"xhelp"
...
literal|"<flags>"
block|,
literal|"Display page_buf flags"
block|}
block|,
block|{
literal|"pbdelay"
...
literal|"0|1"
block|,
literal|"Display delwri pagebufs"
block|}
block|,
endif|#
directive|endif
...
name|kdb_printf
argument_list|(
literal|"magic 0x%x level %d numrecs %d leftsib %Lx "
argument_list|,
name|INT_GET
argument_list|(
name|bt
...
name|qprintf
argument_list|(
literal|"toss start 0x%x%x toss finish 0x%x%x cpu id %ld\n"
argument_list|,
operator|(
name|unsigned
name|int
...
name|qprintf
argument_list|(
literal|"ip 0x%p offset 0x%x%x len 0x%x%x first 0x%x%x last 0x%x%x\n"
argument_list|,
name|ktep
operator|->
name|val
...
name|qprintf
argument_list|(
literal|"io offset 0x%x%x ioflags 0x%x new size 0x%x%x\n"
argument_list|,
operator|(
name|unsigned
name|int
...
name|qprintf
argument_list|(
literal|"ip 0x%p inode 0x%p 0x%p page 0x%p\n"
argument_list|,
name|ktep
operator|->
name|val
...
name|qprintf
argument_list|(
literal|"delalloc %d unmapped %d unwritten %d\n"
argument_list|,
operator|(
name|unsigned
name|int
...
begin_comment
comment|/*  * Print xfs extent list for a fork.  */
end_comment
...
name|kdb_printf
argument_list|(
literal|"minleft %d low %d rval %s aeof %d\n"
argument_list|,
name|a
operator|->
name|minleft
...
parameter_list|)
define|\
value|((INT_GET((d)->d_flags, ARCH_CONVERT)& XFS_DQ_USER) ? "USR" : \ 	((INT_GET((d)->d_flags, ARCH_CONVERT)& XFS_DQ_GROUP) ? "GRP" : "???"))
name|kdb_printf
argument_list|(
...
begin_comment
comment|/*  * Print an xfs free-extent list.  */
end_comment
...
name|kdb_printf
argument_list|(
literal|"log: 0x%p  callb: 0x%p  callb_tail: 0x%p  roundoff: %d\n"
argument_list|,
name|iclog
operator|->
name|ic_log
...
name|kdb_printf
argument_list|(
literal|"mp: 0x%p  xbuf: 0x%p  roundoff: %d  l_covered_state: %s \n"
argument_list|,
name|log
operator|->
name|l_mp
...
name|kdb_printf
argument_list|(
literal|"bsize %d agfrotor %d agirotor %d ihash 0x%p ihsize %d\n"
argument_list|,
name|mp
operator|->
name|m_bsize
...
name|kdb_printf
argument_list|(
literal|"m_frozen %d m_active_trans %d\n"
argument_list|,
name|mp
operator|->
name|m_frozen
...
name|kdb_printf
argument_list|(
literal|"nrefs 0x%x, res_bcount %d, "
argument_list|,
name|dqp
operator|->
name|q_nrefs
...
name|kdb_printf
argument_list|(
literal|"nreclaims %d, btmlimit 0x%x, itmlimit 0x%x, RTbtmlim 0x%x\n"
argument_list|,
operator|(
name|int
operator|)
...
name|kdb_printf
argument_list|(
literal|"bwarnlim 0x%x, iwarnlim 0x%x,&qofflock 0x%p, "
literal|"chunklen 0x%x, dqperchunk 0x%x\n"
argument_list|,
operator|(
name|int
operator|)
...
begin_comment
comment|/*  * Print out the read/write trace buffer attached to the given inode.  */
end_comment
