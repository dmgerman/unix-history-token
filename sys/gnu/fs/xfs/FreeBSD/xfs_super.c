...
begin_endif
unit|struct vnode * xfs_get_inode( 	bhv_desc_t	*bdp, 	xfs_ino_t	ino, 	int		flags) { 	return NULL; }
endif|#
directive|endif
end_endif
...
name|printf
argument_list|(
literal|"xfs_mountfs_check_barriers NI\n"
argument_list|)
expr_stmt|;
block|}
end_function
...
name|printf
argument_list|(
literal|"xfs_blkdev_issue_flush NI\n"
argument_list|)
expr_stmt|;
block|}
end_function
