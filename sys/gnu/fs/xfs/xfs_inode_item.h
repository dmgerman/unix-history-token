...
parameter_list|)
define|\
value|((w) == XFS_DATA_FORK ? XFS_ILOG_DDATA : XFS_ILOG_ADATA)
end_define
...
parameter_list|)
define|\
value|((w) == XFS_DATA_FORK ? XFS_ILOG_DBROOT : XFS_ILOG_ABROOT)
end_define
...
parameter_list|)
define|\
value|((w) == XFS_DATA_FORK ? XFS_ILOG_DEXT : XFS_ILOG_AEXT)
end_define
