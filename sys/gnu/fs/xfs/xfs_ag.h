...
name|pagf_metadata
decl_stmt|;
comment|/* the agf is prefered to be metadata */
name|char
name|pagi_inodeok
decl_stmt|;
...
parameter_list|)
define|\
value|XFS_MIN_FREELIST_RAW(	\ 		INT_GET((a)->agf_levels[XFS_BTNUM_BNOi], ARCH_CONVERT), \ 		INT_GET((a)->agf_levels[XFS_BTNUM_CNTi], ARCH_CONVERT), mp)
end_define
...
name|mp
parameter_list|)
value|xfs_min_freelist_pag(pag,mp)
end_define
...
name|mp
parameter_list|)
value|xfs_min_freelist_raw(bl,cl,mp)
end_define
...
name|agbno
parameter_list|)
value|xfs_agb_to_fsb(mp,agno,agbno)
end_define
...
name|fsbno
parameter_list|)
value|xfs_fsb_to_agno(mp,fsbno)
end_define
...
name|fsbno
parameter_list|)
value|xfs_fsb_to_agbno(mp,fsbno)
end_define
...
name|agbno
parameter_list|)
value|xfs_agb_to_daddr(mp,agno,agbno)
end_define
...
begin_comment
comment|/*  * XFS_DADDR_TO_AGNO and XFS_DADDR_TO_AGBNO moved to xfs_mount.h  * to avoid header file ordering change  */
end_comment
...
name|len
parameter_list|)
value|xfs_ag_check_daddr(mp,d,len)
end_define
