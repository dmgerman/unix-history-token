...
parameter_list|)
define|\
value|xfs_attr_sf_entsize_byname(nlen,vlen)
end_define
...
name|sfep
parameter_list|)
value|xfs_attr_sf_entsize(sfep)
end_define
...
name|sfep
parameter_list|)
value|xfs_attr_sf_nextentry(sfep)
end_define
...
define|\
value|(INT_GET(((xfs_attr_shortform_t *)((dp)->i_afp->if_u1.if_data))->hdr.totsize, ARCH_CONVERT))
end_define
