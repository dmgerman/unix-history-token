...
name|l_mp
argument_list|,
literal|"xfs_log_recover: unknown buffer type 0x%x, dev %s"
argument_list|,
name|buf_f
operator|->
name|blf_type
...
argument_list|)
expr_stmt|;
comment|/* 	 * The logitem format's flag tells us if this was user quotaoff, 	 * group quotaoff or both. 	 */
if|if
condition|(
name|qoff_f
operator|->
...
name|CE_NOTE
argument_list|,
literal|"Starting XFS recovery on filesystem: %s (dev: %s)"
argument_list|,
name|log
operator|->
name|l_mp
...
name|CE_NOTE
argument_list|,
literal|"Ending XFS recovery on filesystem: %s (dev: %s)"
argument_list|,
name|log
operator|->
name|l_mp
