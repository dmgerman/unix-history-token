...
argument_list|)
expr_stmt|;
comment|/* Flush the refcache */
name|xfs_refcache_purge_mp
argument_list|(
name|mp
argument_list|)
expr_stmt|;
comment|/* Flush delalloc and delwri data */
name|XVFS_SYNC
argument_list|(
name|vfsp
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* Pause transaction subsystem */
name|xfs_start_freeze
argument_list|(
name|mp
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* Flush any remaining inodes into buffers */
name|XVFS_SYNC
argument_list|(
name|vfsp
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* Push all buffers out to disk */
name|xfs_binval
argument_list|(
name|mp
operator|->
