...
name|arch
decl_stmt|;
comment|/* these are set according to      */
name|__uint16_t
name|di_flags
decl_stmt|;
comment|/* temp */
...
argument_list|)
expr_stmt|;
comment|/* buffer dinode_core is in on-disk arch */
name|arch
operator|=
name|ARCH_CONVERT
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|/* 	 * convert di_flags to bs_xflags. 	 */
name|di_flags
operator|=
name|INT_GET
argument_list|(
...
name|ubufp
decl_stmt|;
comment|/* current pointer into user's buffer */
name|int
name|ubelem
decl_stmt|;
...
name|bstat
decl_stmt|;
comment|/* one bulkstat result structure */
name|int
name|count
decl_stmt|;
