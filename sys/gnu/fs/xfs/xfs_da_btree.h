...
begin_comment
comment|/*  * Macros used by directory code to interface to the filesystem.  */
end_comment
...
begin_comment
comment|/*  * Macros used by directory code to interface to the kernel  */
end_comment

begin_comment
comment|/*  * Macros used to manipulate directory off_t's  */
end_comment
...
parameter_list|)
define|\
value|xfs_da_make_bnoentry(mp,bno,entry)
end_define
...
parameter_list|)
define|\
value|xfs_da_make_cookie(mp,bno,entry,hash)
end_define
...
name|cookie
parameter_list|)
value|xfs_da_cookie_hash(mp,cookie)
end_define
...
name|cookie
parameter_list|)
value|xfs_da_cookie_bno(mp,cookie)
end_define
...
name|cookie
parameter_list|)
value|xfs_da_cookie_entry(mp,cookie)
end_define
