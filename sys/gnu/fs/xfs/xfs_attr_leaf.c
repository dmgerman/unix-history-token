...
begin_comment
comment|/*  * xfs_attr_leaf.c  *  * GROT: figure out how to recover gracefully when bmap returns ENOSPC.  */
end_comment
...
begin_comment
comment|/*========================================================================  * External routines when dirsize< XFS_LITINO(mp).  *========================================================================*/
end_comment
...
begin_comment
comment|/*  * Remove a name from the shortform attribute list structure.  */
end_comment
