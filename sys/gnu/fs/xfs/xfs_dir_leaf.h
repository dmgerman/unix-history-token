...
parameter_list|)
define|\
value|DIRINO_GET_ARCH(&(di),arch)
end_define

begin_define
define|#
directive|define
name|XFS_GET_DIR_INO
parameter_list|(
name|mp
parameter_list|,
name|di
parameter_list|)
define|\
value|XFS_GET_DIR_INO_ARCH(mp,di,ARCH_NOCONVERT)
end_define
...
name|len
parameter_list|)
comment|/* space a name will use */
define|\
value|((uint)sizeof(xfs_dir_leaf_name_t)-1 + len)
end_define
...
name|entry
parameter_list|)
comment|/* space an entry will use */
define|\
value|((uint)sizeof(xfs_dir_leaf_name_t)-1 + (entry)->namelen)
end_define
...
name|offset
parameter_list|)
comment|/* point to name struct */
define|\
value|((xfs_dir_leaf_name_t *)&((char *)(leafp))[offset])
end_define
