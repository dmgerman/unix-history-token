...
begin_comment
comment|/*  * System call switch table.  *  * DO NOT EDIT-- this file is automatically generated.  * $FreeBSD$  * created from FreeBSD: src/sys/ia64/ia32/syscalls.master,v 1.7 2002/10/09 22:27:24 peter Exp   */
end_comment
...
include|#
directive|include
file|<ia64/ia32/ia32.h>
end_include

begin_include
include|#
directive|include
file|<ia64/ia32/ia32_proto.h>
end_include
...
name|compat4
argument_list|(
argument|SYF_MPSAFE | AS(freebsd4_ia32_osendfile_args)
argument_list|,
argument|ia32_osendfile
argument_list|)
block|}
block|,
comment|/* 336 = old ia32_osendfile */
block|{
name|AS
argument_list|(
name|kldsym_args
