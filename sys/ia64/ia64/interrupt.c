...
return|;
comment|/* XXX lock */
comment|/* Get the I/O SAPIC and vector that corresponds to the IRQ. */
name|sa
operator|=
name|sapic_lookup
argument_list|(
...
expr_stmt|;
block|}
comment|/* 	 * If the IRQ has no vector assigned to it yet, assign one based 	 * on the priority. 	 */
if|if
condition|(
name|vector
operator|==
