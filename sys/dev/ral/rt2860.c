...
begin_comment
comment|/*-  * Ralink Technology RT2860/RT3090/RT3390/RT3562/RT5390/RT5392 chipset driver  * http://www.ralinktech.com/  */
end_comment
...
block|if ((sc->sc_ic_flags ^ ic->ic_flags)& IEEE80211_F_USEPROT) { 		rt2860_updateprot(sc); 		sc->sc_ic_flags = ic->ic_flags; 	}
endif|#
directive|endif
block|}
end_function
...
operator|)
expr_stmt|;
comment|/* the valid range of the RF R49 is 0x00~0x27 */
if|if
condition|(
operator|(
name|rf
...
operator|)
expr_stmt|;
comment|/* the valid range of the RF R50 is 0x00~0x27 */
if|if
condition|(
operator|(
name|rf
...
argument_list|)
expr_stmt|;
comment|/* Set led open drain enable. */
name|RAL_WRITE
argument_list|(
name|sc
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* Patch RSSI inaccurate issue. */
name|rt2860_mcu_bbp_write
argument_list|(
name|sc
argument_list|,
