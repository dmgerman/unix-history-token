...
argument_list|)
expr_stmt|;
comment|/* Error happened during RSSI conversion. */
if|if
condition|(
name|rssi
operator|<
...
begin_comment
comment|/*  * Supported rates for 802.11g. XXX should use ic_sup_rates.  */
end_comment
...
condition|)
block|{
comment|/* 		 * No mapping available. 		 * 		 * NB: Since RSSI is relative to noise floor, -1 is 		 *     adequate for caller to know error happened. 		 */
return|return
operator|-
literal|1
return|;
