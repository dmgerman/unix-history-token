...
condition|)
block|{
comment|/* 		 * OFDM TXTIME calculation. 		 * From IEEE Std 802.11a-1999, pp. 37. 		 */
name|dbps
operator|=
name|rate
operator|*
literal|2
expr_stmt|;
comment|/* data bits per OFDM symbol */
name|ceil
operator|=
operator|(
literal|16
...
block|{
comment|/* 		 * High Rate TXTIME calculation. 		 * From IEEE Std 802.11b-1999, pp. 28. 		 */
name|ceil
operator|=
operator|(
literal|8
