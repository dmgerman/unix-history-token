...
begin_comment
comment|/*  * Driver for Realtek RTL8188SU/RTL8191SU/RTL8192SU.  *  * TODO:  *   o tx a-mpdu  *   o monitor / hostap / ibss / mesh  *   o power-save operation  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* Setup multicast filter (must be done after firmware loading). */
name|rsu_set_multi
argument_list|(
name|sc
argument_list|)
