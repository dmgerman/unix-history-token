...
begin_comment
comment|/* Bits for R92S_TXPAUSE. */
end_comment

begin_define
define|#
directive|define
name|R92S_TXPAUSE_VO
value|0x01
end_define
...
define|#
directive|define
name|R92S_TXPAUSE_AC
define|\
value|(R92S_TXPAUSE_VO | R92S_TXPAUSE_VI |	\ 	 R92S_TXPAUSE_BE | R92S_TXPAUSE_BK)
end_define

begin_define
define|#
directive|define
name|R92S_TXPAUSE_ALL
define|\
value|(R92S_TXPAUSE_AC | R92S_TXPAUSE_MGT |	\ 	 R92S_TXPAUSE_HIGH | R92S_TXPAUSE_HCCA | 0x80)
end_define
...
begin_comment
comment|/* Bits for R92S_CAMCMD. */
end_comment

begin_define
define|#
directive|define
name|R92S_CAMCMD_ADDR_M
value|0x000000ff
end_define
...
define|#
directive|define
name|R92S_CAM_ENTRY_BYTES
value|howmany(R92S_CAM_ENTRY_LIMIT, NBBY)
end_define
...
begin_comment
comment|/* Bits for R92S_CAM_CTL0(i). */
end_comment

begin_define
define|#
directive|define
name|R92S_CAM_KEYID_M
value|0x00000003
end_define
...
define|#
directive|define
name|R92S_KEY_ALGO_INVALID
value|0xff
comment|/* for rsu_crypto_mode() only */
name|uint8_t
name|cam_id
decl_stmt|;
name|uint8_t
...
begin_comment
comment|/* Structure for R92S_CMD_SET_STA_KEY. */
end_comment

begin_struct
struct|struct
name|r92s_fw_cmd_set_key_mac
block|{
name|uint8_t
name|macaddr
index|[
...
begin_comment
comment|/* XXX hardcoded somewhere */
end_comment
...
define|#
directive|define
name|R92S_RXDW0_CIPHER_M
value|0x00700000
define|#
directive|define
name|R92S_RXDW0_CIPHER_S
value|20
define|#
directive|define
name|R92S_RXDW0_QOS
...
define|#
directive|define
name|RSU_DELKEY_BMAP_LOCK_INIT
parameter_list|(
name|_sc
parameter_list|)
define|\
value|mtx_init(&(_sc)->free_keys_bmap_mtx, "bmap lock", NULL, MTX_DEF)
end_define

begin_define
define|#
directive|define
name|RSU_DELKEY_BMAP_LOCK
parameter_list|(
name|_sc
parameter_list|)
value|mtx_lock(&(_sc)->free_keys_bmap_mtx)
end_define

begin_define
define|#
directive|define
name|RSU_DELKEY_BMAP_UNLOCK
parameter_list|(
name|_sc
parameter_list|)
value|mtx_unlock(&(_sc)->free_keys_bmap_mtx)
end_define

begin_define
define|#
directive|define
name|RSU_DELKEY_BMAP_LOCK_DESTROY
parameter_list|(
name|_sc
parameter_list|)
define|\
value|mtx_destroy(&(_sc)->free_keys_bmap_mtx)
end_define
