...
directive|if
literal|0
block|if ((ifp->if_flags& IFF_UP)&& 	    (ifp->if_drv_flags&  RUN_RUNNING)){ 		run_init_locked(sc); 	}
endif|#
directive|endif
name|RUN_UNLOCK
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* return whatever, upper layer doesn't care anyway */
return|return
operator|(
literal|0
operator|)
