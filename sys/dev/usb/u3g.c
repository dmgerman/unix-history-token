...
define|#
directive|define
name|U3GFL_CMOTECH_INIT
value|0x08
comment|// Requires init command (CMOTECH cards)
define|#
directive|define
...
name|sc_dev
argument_list|,
literal|"Failed to send CD eject command to "
...
name|DPRINTF
argument_list|(
literal|"failed to start transfer (CSW)\n"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|DPRINTF
argument_list|(
literal|"failed to start transfer (CBW)\n"
argument_list|)
expr_stmt|;
return|return
literal|0
...
parameter_list|)
block|{
comment|/* See definition of umass_bbb_cbw_t in sys/dev/usb/umass.c 	 * in sys/cam/scsi/scsi_all.h .          */
name|unsigned
name|char
name|cmd
index|[
