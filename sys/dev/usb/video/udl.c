...
literal|0
argument_list|,
literal|"Frames Per Second, 1-60"
argument_list|)
expr_stmt|;
end_expr_stmt
...
name|udl_fps
expr_stmt|;
comment|/* figure out number of frames per second */
if|if
condition|(
name|fps
operator|<
...
argument_list|)
decl_stmt|;
comment|/* delete all child devices */
...
argument_list|)
expr_stmt|;
comment|/* put main framebuffer into a recycle list, if any */
name|udl_buffer_free
argument_list|(
name|sc
operator|->
...
argument_list|)
expr_stmt|;
comment|/* free shadow framebuffer memory, if any */
name|free
argument_list|(
name|sc
operator|->
...
name|PAGE_SIZE
expr_stmt|;
comment|/* 	 * It is assumed that allocations above PAGE_SIZE bytes will 	 * be PAGE_SIZE aligned for use with mmap() 	 */
name|sc
operator|->
name|sc_fb_addr
operator|=
