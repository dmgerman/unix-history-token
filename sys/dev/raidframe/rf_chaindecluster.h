...
begin_comment
comment|/*	$NetBSD: rf_chaindecluster.h,v 1.4 2001/01/26 04:14:14 oster Exp $	*/
end_comment
...
begin_comment
comment|/* rf_chaindecluster.h  * header file for Chained Declustering  */
end_comment

begin_ifndef
ifndef|#
directive|ifndef
name|_RF__RF_CHAINDECLUSTER_H_
end_ifndef
...
begin_endif
unit|void    (**createFunc) (RF_Raid_t *,             RF_AccessStripeMap_t *,             RF_DagHeader_t *,             void *,             RF_RaidAccessFlags_t,             RF_AllocListElem_t *);
endif|#
directive|endif
end_endif
...
begin_comment
comment|/* !_RF__RF_CHAINDECLUSTER_H_ */
end_comment
