...
begin_comment
comment|/*  * Cronyx-Sigma adapter driver for FreeBSD.  * Supports PPP/HDLC and Cisco/HDLC protocol in synchronous mode,  * and asyncronous channels with full modem control.  * Keepalive protocol implemented in both Cisco and PPP modes.  *  * Copyright (C) 1994-2002 Cronyx Engineering.  * Author: Serge Vakulenko,<vak@cronyx.ru>  *  * Copyright (C) 1999-2003 Cronyx Engineering.  * Rewritten on DDK, ported to NETGRAPH, rewritten for FreeBSD 3.x-5.x by  * Kurakin Roman,<rik@cronyx.ru>  *  * This software is distributed with NO WARRANTIES, not even the implied  * warranties for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  *  * Authors grant any other persons or organisations a permission to use,  * modify and redistribute this software in source and binary forms,  * as long as this message is kept with the software, all derivative  * works or modified versions.  *  * Cronyx Id: if_cx.c,v 1.1.2.18 2003/11/27 14:30:03 rik Exp $  */
end_comment
...
name|printf
argument_list|(
literal|"cx%d: no synchronous PPP driver configured\n"
argument_list|,
name|id
operator|->
name|id_unit
...
name|printf
argument_list|(
literal|"cx%d: no available drq found\n"
argument_list|,
name|id
operator|->
name|id_unit
...
name|printf
argument_list|(
literal|"cx%d: cannot initialize adapter\n"
argument_list|,
name|id
operator|->
name|id_unit
...
name|printf
argument_list|(
literal|"cx%d: irq %d not functional\n"
argument_list|,
name|id
operator|->
name|id_unit
...
name|printf
argument_list|(
literal|"cx%d: no available irq found\n"
argument_list|,
name|id
operator|->
name|id_unit
...
name|hz
expr_stmt|;
comment|/* Default DTR off timeout is 3 seconds. */
name|d
operator|->
name|open_dev
operator|=
...
begin_comment
comment|/*  * Wake up opens() waiting for DTR ready.  */
end_comment
...
expr_stmt|;
block|}
comment|/* Close all active boards. */
for|for
control|(
name|i
operator|=
...
name|printf
argument_list|(
literal|"Sigma driver is already in system\n"
argument_list|)
expr_stmt|;
return|return
operator|(
...
block|if (ng_newtype (&typestruct)) 		printf ("Failed to register ng_cx\n");
endif|#
directive|endif
endif|#
directive|endif
