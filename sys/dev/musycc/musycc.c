...
literal|0
argument_list|,
literal|"The number of milliseconds a packet is allowed to spend in the output q ueue.  "
...
name|tx_next_md
decl_stmt|;
comment|/* index to the next MD */
name|int
name|tx_last_md
decl_stmt|;
comment|/* index to the last MD */
name|int
name|rx_last_md
decl_stmt|;
...
directive|if
literal|0
block|time_t		last_recv; 	time_t		last_rxerr; 	time_t		last_xmit;  	u_long		rx_error;  	u_long		short_error; 	u_long		crc_error; 	u_long		dribble_error; 	u_long		long_error; 	u_long		abort_error; 	u_long		overflow_error;  	int		last_error; 	int		prev_error;
endif|#
directive|endif
block|}
struct|;
...
name|printf
argument_list|(
literal|"Newhook(\"%s\",\"%s\" chan=%d ts=%08x nbit=%d)\n"
argument_list|,
name|sc
operator|->
name|nodename
