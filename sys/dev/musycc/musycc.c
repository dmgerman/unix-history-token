...
directive|if
literal|0
block|if (error == 8&& (sc->framing == E1U || sc->framing == T1U)) 			error = 0;
endif|#
directive|endif
if|if
condition|(
...
begin_comment
comment|/*  * Handle status and config enquiries.  * Respond with a synchronous response.  * [JRE] -this would be easier to read with the usual 'switch' structure-  */
end_comment
...
name|NULL
expr_stmt|;
comment|/* default answer in case of errors */
if|if
condition|(
name|msg
operator|->
...
argument_list|)
expr_stmt|;
comment|/* eventually 'send' the response */
name|FREE
argument_list|(
name|msg
argument_list|,
