...
argument_list|,
operator|(
literal|"Trying to attach grant-table device on non Xen domain"
operator|)
argument_list|)
expr_stmt|;
...
name|panic
argument_list|(
literal|"unable to attach Xen Grant-table device"
argument_list|)
expr_stmt|;
block|}
end_function
...
begin_comment
comment|/**  * \brief Probe for the existence of the Xen Grant-table device  *  * \param dev  NewBus device_t for this instance.  *  * \return  Always returns 0 indicating success.  */
end_comment

begin_function
specifier|static
name|int
name|granttable_probe
parameter_list|(
name|device_t
name|dev
parameter_list|)
...
name|dev
argument_list|,
literal|"Xen Grant-table Device"
argument_list|)
expr_stmt|;
return|return
operator|(
...
begin_comment
comment|/**  * \brief Attach the Xen Grant-table device.  *  * \param dev  NewBus device_t for this instance.  *  * \return  On success, 0. Otherwise an errno value indicating the  *          type of failure.  */
end_comment

begin_function
specifier|static
name|int
name|granttable_attach
parameter_list|(
name|device_t
name|dev
parameter_list|)
