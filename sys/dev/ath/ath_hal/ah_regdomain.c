...
literal|0x00000020
block|,
comment|/* 4msec limit on frame length*/
name|NO_HOSTAP
init|=
literal|0x00000040
block|,
...
comment|/* 	 * Mapping for 900MHz cards like Ubiquiti SR9 and XR9 	 * and ZComax GZ-901. 	 */
block|{
literal|2422
block|,
literal|2437
...
define|#
directive|define
name|HAL_MODE_11G_ALL
define|\
value|(HAL_MODE_11G | HAL_MODE_11G_TURBO | HAL_MODE_11G_QUARTER_RATE | \ 	 HAL_MODE_11G_HALF_RATE)
define|#
directive|define
...
begin_comment
comment|/*  * Return if device is actually operating in 900 MHz band.  */
end_comment
