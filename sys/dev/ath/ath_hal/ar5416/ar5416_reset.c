...
expr_stmt|;
block|}
comment|/* 	 * The AR5416 initvals have this already set to 0x11; AR9160 has 	 * the register set to 0x0. Figure out whether AR9100/AR9160 needs 	 * this before moving forward with it. 	 */
if|#
directive|if
literal|0
comment|/* Disable BB clock gating for AR5416v2, AR9100, AR9160 */
block|if (AR_SREV_OWL_20_OR_LATER(ah) || AR_SREV_9100(ah) || AR_SREV_SOWL(ah)) {
