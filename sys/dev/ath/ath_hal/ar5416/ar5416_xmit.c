...
name|nseries
expr_stmt|;
comment|/* 	 * XXX since the upper layers doesn't know the current chainmask 	 * XXX setup, just override its decisions here. 	 * XXX The upper layers need to be taught this! 	 */
if|if
condition|(
name|series
index|[
