...
begin_comment
comment|/*  * Parameters for the AR5212 PHY.  *  * TODO: figure out what values were added for the AR5413 and later  * PHY; update these here.  */
end_comment
...
name|AR5212_DFS_INBAND
expr_stmt|;
comment|/* XXX look up what is needed for the AR5413 */
name|pe
operator|->
name|pe_relpwr
operator|=
