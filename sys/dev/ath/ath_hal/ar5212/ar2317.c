...
begin_comment
comment|/*  * Copyright (c) 2002-2008 Sam Leffler, Errno Consulting  * Copyright (c) 2002-2008 Atheros Communications, Inc.  *  * Permission to use, copy, modify, and/or distribute this software for any  * purpose with or without fee is hereby granted, provided that the above  * copyright notice and this permission notice appear in all copies.  *  * THE SOFTWARE IS PROVIDED "AS IS" AND THE AUTHOR DISCLAIMS ALL WARRANTIES  * WITH REGARD TO THIS SOFTWARE INCLUDING ALL IMPLIED WARRANTIES OF  * MERCHANTABILITY AND FITNESS. IN NO EVENT SHALL THE AUTHOR BE LIABLE FOR  * ANY SPECIAL, DIRECT, INDIRECT, OR CONSEQUENTIAL DAMAGES OR ANY DAMAGES  * WHATSOEVER RESULTING FROM LOSS OF USE, DATA OR PROFITS, WHETHER IN AN  * ACTION OF CONTRACT, NEGLIGENCE OR OTHER TORTIOUS ACTION, ARISING OUT OF  * OR IN CONNECTION WITH THE USE OR PERFORMANCE OF THIS SOFTWARE.  *  * $Id: ar2317.c,v 1.8 2008/11/15 22:15:46 sam Exp $  */
end_comment
...
name|RAW_DATA_PER_CHANNEL_2317
typedef|;
end_typedef
...
define|#
directive|define
name|PWR_TABLE_SIZE_2317
value|PWR_TABLE_SIZE_2413
end_define
...
name|ah
parameter_list|)
value|((struct ar2317State *) AH5212(ah)->ah_rfHal)
end_define
...
name|_col
parameter_list|)
value|do {				    \ 	int i;								    \ 	for (i = 0; i< N(ar5212Bank##_ix##_2317); i++)			    \ 		(_priv)->Bank##_ix##Data[i] = ar5212Bank##_ix##_2317[i][_col];\ } while (0)
name|struct
name|ath_hal_5212
modifier|*
name|ahp
...
begin_comment
comment|/*  * Uses the data points read from EEPROM to reconstruct the pdadc power table  * Called by ar2317SetPowerTable()  */
end_comment

begin_function
specifier|static
name|int
name|ar2317getGainBoundariesAndPdadcsForPowers
parameter_list|(
name|struct
name|ath_hal
modifier|*
...
comment|/* XXX excessive stack usage? */
name|uint32_t
name|ii
decl_stmt|,
name|jj
...
specifier|static
name|HAL_BOOL
name|ar2317GetChannelMaxMinPower
parameter_list|(
name|struct
name|ath_hal
modifier|*
