...
begin_comment
comment|/*  * Copyright (c) 2002-2008 Sam Leffler, Errno Consulting  * Copyright (c) 2002-2008 Atheros Communications, Inc.  *  * Permission to use, copy, modify, and/or distribute this software for any  * purpose with or without fee is hereby granted, provided that the above  * copyright notice and this permission notice appear in all copies.  *  * THE SOFTWARE IS PROVIDED "AS IS" AND THE AUTHOR DISCLAIMS ALL WARRANTIES  * WITH REGARD TO THIS SOFTWARE INCLUDING ALL IMPLIED WARRANTIES OF  * MERCHANTABILITY AND FITNESS. IN NO EVENT SHALL THE AUTHOR BE LIABLE FOR  * ANY SPECIAL, DIRECT, INDIRECT, OR CONSEQUENTIAL DAMAGES OR ANY DAMAGES  * WHATSOEVER RESULTING FROM LOSS OF USE, DATA OR PROFITS, WHETHER IN AN  * ACTION OF CONTRACT, NEGLIGENCE OR OTHER TORTIOUS ACTION, ARISING OUT OF  * OR IN CONNECTION WITH THE USE OR PERFORMANCE OF THIS SOFTWARE.  *  * $Id: ar5212_reset.c,v 1.20 2008/11/27 22:30:00 sam Exp $  */
end_comment
...
block|if (bChannelChange&& 		    (AH_PRIVATE(ah)->ah_curchan != AH_NULL)&& 		    (chan->channel != AH_PRIVATE(ah)->ah_curchan->channel)&& 		    ((chan->channelFlags& CHANNEL_ALL) == 		     (AH_PRIVATE(ah)->ah_curchan->channelFlags& CHANNEL_ALL))) { 			if (ar5212ChannelChange(ah, chan)) {
...
name|AH_FALSE
decl_stmt|;
comment|/* NB: need local copy for SAVE/RESTORE 'cuz chan is const */
name|HAL_CHANNEL_INTERNAL
name|ichan
init|=
operator|*
...
name|HAL_DEBUG_ANY
argument_list|,
literal|"%s: unable to find max/min power\n"
argument_list|,
name|__func__
argument_list|)
expr_stmt|;
