...
begin_comment
comment|/* En block OFDM weak sig as radar */
end_comment
...
begin_comment
comment|/* En measuring pwr over 128 cycles */
end_comment
...
begin_comment
comment|/* Max Pulse duration threshold */
end_comment

begin_define
define|#
directive|define
name|AR_PHY_RADAR_2_MAXLEN_S
value|0
end_define
...
begin_comment
comment|/* pulse relative power threshold */
end_comment

begin_define
define|#
directive|define
name|AR_PHY_RADAR_2_RELPWR_S
value|16
end_define
