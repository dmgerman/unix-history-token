...
begin_comment
comment|/*  * Restore/reset the ANI parameters and reset the statistics.  * This routine must be called for every channel change.  */
end_comment
...
name|AH_NULL
decl_stmt|;
comment|/* 	 * We shouldn't see ah_curchan be NULL, but just in case.. 	 */
if|if
condition|(
name|AH_PRIVATE
argument_list|(
...
condition|)
block|{
comment|/* 		 * Only calculate and update the cycle count if we have 		 * an ANI state. 		 */
name|int32_t
name|ccdelta
init|=
name|AH5212
...
expr_stmt|;
block|}
comment|/* 	 * Again, only update ANI state if we have it. 	 */
if|if
condition|(
name|ANI_ENA
argument_list|(
...
name|listenTime
decl_stmt|;
comment|/* Always update from the MIB, for statistics gathering */
name|listenTime
operator|=
name|ar5212AniGetListenTime
argument_list|(
