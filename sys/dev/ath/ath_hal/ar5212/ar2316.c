...
name|RAW_DATA_PER_CHANNEL_2316
typedef|;
end_typedef
...
name|ah
parameter_list|)
value|((struct ar2316State *) AH5212(ah)->ah_rfHal)
end_define
...
name|_col
parameter_list|)
value|do {				    \ 	int i;								    \ 	for (i = 0; i< N(ar5212Bank##_ix##_2316); i++)			    \ 		(_priv)->Bank##_ix##Data[i] = ar5212Bank##_ix##_2316[i][_col];\ } while (0)
name|struct
name|ath_hal_5212
modifier|*
name|ahp
...
begin_comment
comment|/*  * Uses the data points read from EEPROM to reconstruct the pdadc power table  * Called by ar2316SetPowerTable()  */
end_comment

begin_function
specifier|static
name|int
name|ar2316getGainBoundariesAndPdadcsForPowers
parameter_list|(
name|struct
name|ath_hal
modifier|*
...
specifier|static
name|HAL_BOOL
name|ar2316GetChannelMaxMinPower
parameter_list|(
name|struct
name|ath_hal
modifier|*
...
begin_comment
comment|/*  * Allocate memory for private state.  * Scratch Buffer will be reinitialized every reset so no need to zero now  */
end_comment
