...
case|:
comment|/* Delay the auth transition until we can update the firmware */
return|return
name|wpi_queue_cmd
argument_list|(
name|sc
...
name|IEEE80211_S_RUN
condition|)
comment|/* set the association id first */
return|return
name|wpi_queue_cmd
argument_list|(
name|sc
...
argument_list|)
expr_stmt|;
comment|/* reset the led sequence */
switch|switch
condition|(
name|ic
operator|->
...
return|return;
block|}
comment|/* Send the auth frame now */
name|sc
operator|->
name|sc_newstate
argument_list|(
