...
begin_comment
comment|/*  * ChipCommon Power Control.  *   * Provides a bhnd_pmu_if-compatible interface to device clocking and  * power management on non-PMU chipsets.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* TODO: Need further testing on actual PWRCTL hardware */
name|device_printf
argument_list|(
name|dev
argument_list|,
literal|"WARNING: Using untested PWRCTL support\n"
argument_list|)
expr_stmt|;
name|sc
operator|->
...
begin_comment
comment|/**  * Find the clock reservation associated with @p pinfo, if any.  *   * @param sc Driver instance state.  * @param pinfo PMU info for device.  */
end_comment
...
specifier|static
name|int
name|bhnd_pwrctl_core_req_clock
parameter_list|(
name|device_t
name|dev
parameter_list|,
...
specifier|static
name|int
name|bhnd_pwrctl_core_req_ext_rsrc
parameter_list|(
name|device_t
name|dev
parameter_list|,
...
specifier|static
name|int
name|bhnd_pwrctl_core_release_ext_rsrc
parameter_list|(
name|device_t
name|dev
parameter_list|,
...
specifier|static
name|int
name|bhnd_pwrctl_core_en_clocks
parameter_list|(
name|device_t
name|dev
parameter_list|,
