...
begin_comment
comment|/**  * Calculate the clock speed (in Hz) for a given a set of clockcontrol  * values.  *   * @param pll_type PLL type (CHIPC_PLL_TYPE*)  * @param n clock control N register value.  * @param m clock control N register value.  */
end_comment
