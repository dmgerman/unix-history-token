...
directive|if
literal|0
block|if (sc->sc_flags& URAL_FLAG_WAIT_COMMAND) {
...
argument_list|)
expr_stmt|;
comment|/* Stop now if the device has vanished */
if|if
condition|(
name|sc
operator|->
