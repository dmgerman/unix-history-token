...
begin_comment
comment|/*-  * Cronyx-Tau-PCI adapter driver for FreeBSD.  * Supports PPP/HDLC, Cisco/HDLC and FrameRelay protocol in synchronous mode,  * and asynchronous channels with full modem control.  * Keepalive protocol implemented in both Cisco and PPP modes.  *  * Copyright (C) 1999-2004 Cronyx Engineering.  * Author: Kurakin Roman,<rik@cronyx.ru>  *  * Copyright (C) 1999-2002 Cronyx Engineering.  * Author: Serge Vakulenko,<vak@cronyx.ru>  *  * This software is distributed with NO WARRANTIES, not even the implied  * warranties for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  *  * Authors grant any other persons or organisations a permission to use,  * modify and redistribute this software in source and binary forms,  * as long as this message is kept with the software, all derivative  * works or modified versions.  *  * Cronyx Id: if_cp.c,v 1.1.2.41 2004/06/23 17:09:13 rik Exp $  */
end_comment
...
condition|)
block|{
comment|/* Not we are not, just cleanup. */
...
argument_list|,
operator|(
literal|"cp mutex not initialized"
operator|)
argument_list|)
expr_stmt|;
name|s
...
argument_list|)
expr_stmt|;
comment|/* XXXRIK: Don't forget to protect them by LOCK, or kill them. */
...
directive|ifndef
name|NETGRAPH
comment|/* 		 * The debug_shadow is always greater than zero for logic  		 * simplicity.  For switching debug off the IFF_DEBUG is 		 * responsible. 		 */
name|d
operator|->
name|chan
operator|->
