...
begin_endif
unit|static int	iwn_ampdu_tx_start(struct ieee80211com *, 		    struct ieee80211_node *, uint8_t); static void	iwn_ampdu_tx_stop(struct ieee80211com *, 		    struct ieee80211_node *, uint8_t); static void	iwn4965_ampdu_tx_start(struct iwn_softc *, 		    struct ieee80211_node *, uint8_t, uint16_t); static void	iwn4965_ampdu_tx_stop(struct iwn_softc *, 		    uint8_t, uint16_t); static void	iwn5000_ampdu_tx_start(struct iwn_softc *, 		    struct ieee80211_node *, uint8_t, uint16_t); static void	iwn5000_ampdu_tx_stop(struct iwn_softc *, 		    uint8_t, uint16_t);
endif|#
directive|endif
end_endif
...
literal|0
comment|/* HT */
block|ic->ic_ampdu_tx_start = iwn_ampdu_tx_start; 	ic->ic_ampdu_tx_stop = iwn_ampdu_tx_stop;
endif|#
directive|endif
name|ic
operator|->
