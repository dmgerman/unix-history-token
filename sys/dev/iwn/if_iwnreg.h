...
begin_comment
comment|/* Structure for command IWN_CMD_RXON_ASSOC (4965AGN only.) */
end_comment
...
begin_comment
comment|/* Structure for command IWN_CMD_RXON_ASSOC (5000 Series only.) */
end_comment
...
begin_comment
comment|/*  * TX command response is sent after *agn* transmission attempts.  *  * both postpone and abort status are expected behavior from uCode. there is  * no special operation required from driver; except for RFKILL_FLUSH,  * which required tx flush host command to flush all the tx frames in queues  */
end_comment
...
define|#
directive|define
name|IWN_TX_POWER_PA_DETECT_MSK
value|0x7f800000
end_define
...
define|#
directive|define
name|IWN_TX_ABORT_REQUIRED_MSK
value|0x80000000
end_define
...
define|#
directive|define
name|IWN_TX_STATUS_DIRECT_DONE
value|0x02
end_define
...
define|#
directive|define
name|IWN_TX_STATUS_POSTPONE_DELAY
value|0x40
end_define
...
define|#
directive|define
name|IWN_TX_STATUS_POSTPONE_FEW_BYTES
value|0x41
end_define
...
define|#
directive|define
name|IWN_TX_STATUS_POSTPONE_BT_PRIO
value|0x42
end_define
...
define|#
directive|define
name|IWN_TX_STATUS_POSTPONE_QUIET_PERIOD
value|0x43
end_define
...
define|#
directive|define
name|IWN_TX_STATUS_POSTPONE_CALC_TTAK
value|0x44
end_define
...
define|#
directive|define
name|IWN_TX_STATUS_FAIL_INTERNAL_CROSSED_RETRY
value|0x81
end_define
...
define|#
directive|define
name|IWN_TX_STATUS_FAIL_DRAIN_FLOW
value|0x85
end_define
...
define|#
directive|define
name|IWN_TX_STATUS_FAIL_RFKILL_FLUSH
value|0x86
end_define
...
define|#
directive|define
name|IWN_TX_STATUS_FAIL_HOST_ABORTED
value|0x89
end_define
...
define|#
directive|define
name|IWN_TX_STATUS_FAIL_BT_RETRY
value|0x8a
end_define
...
define|#
directive|define
name|IWN_TX_STATUS_FAIL_FRAG_DROPPED
value|0x8c
end_define
...
define|#
directive|define
name|IWN_TX_STATUS_FAIL_TID_DISABLE
value|0x8d
end_define
...
define|#
directive|define
name|IWN_TX_STATUS_FAIL_FIFO_FLUSHED
value|0x8e
end_define
...
define|#
directive|define
name|IWN_TX_STATUS_FAIL_INSUFFICIENT_CF_POLL
value|0x8f
end_define
...
define|#
directive|define
name|IWN_TX_STATUS_FAIL_NO_BEACON_ON_RADAR
value|0x91
end_define

begin_comment
comment|/*  * TX command response for A-MPDU packet responses.  *  * The status response is different to the non A-MPDU responses.  * In addition, the sequence number is treated as the sequence  * number of the TX command, NOT the 802.11 sequence number!  */
end_comment

begin_define
define|#
directive|define
name|IWN_AGG_TX_STATE_TRANSMITTED
value|0x00
end_define
...
define|#
directive|define
name|IWN_AGG_TX_STATE_UNDERRUN_MSK
value|0x01
end_define
...
define|#
directive|define
name|IWN_AGG_TX_STATE_FEW_BYTES_MSK
value|0x04
end_define
...
define|#
directive|define
name|IWN_AGG_TX_STATE_ABORT_MSK
value|0x08
end_define
...
define|#
directive|define
name|IWN_AGG_TX_STATE_LAST_SENT_TTL_MSK
value|0x10
end_define
...
define|#
directive|define
name|IWN_AGG_TX_STATE_LAST_SENT_TRY_CNT_MSK
value|0x20
end_define
...
define|#
directive|define
name|IWN_AGG_TX_STATE_SCD_QUERY_MSK
value|0x80
end_define
...
define|#
directive|define
name|IWN_AGG_TX_STATE_TEST_BAD_CRC32_MSK
value|0x100
end_define
...
define|#
directive|define
name|IWN_AGG_TX_STATE_RESPONSE_MSK
value|0x1ff
end_define
...
define|#
directive|define
name|IWN_AGG_TX_STATE_DUMP_TX_MSK
value|0x200
end_define
...
define|#
directive|define
name|IWN_AGG_TX_STATE_DELAY_TX_MSK
value|0x400
end_define
...
define|#
directive|define
name|IWN_AGG_TX_STATE_LAST_SENT_MSK
define|\
value|(IWN_AGG_TX_STATE_LAST_SENT_TTL_MSK | \ 	     IWN_AGG_TX_STATE_LAST_SENT_TRY_CNT_MSK)
end_define

begin_comment
comment|/* # tx attempts for first frame in aggregation */
end_comment

begin_define
define|#
directive|define
name|IWN_AGG_TX_STATE_TRY_CNT_POS
value|12
end_define
...
define|#
directive|define
name|IWN_AGG_TX_STATE_TRY_CNT_MSK
value|0xf000
end_define

begin_comment
comment|/* Command ID and sequence number of Tx command for this frame */
end_comment

begin_define
define|#
directive|define
name|IWN_AGG_TX_STATE_SEQ_NUM_POS
value|16
end_define
...
define|#
directive|define
name|IWN_AGG_TX_STATE_SEQ_NUM_MSK
value|0xffff0000
end_define
...
name|ssn
decl_stmt|;
comment|/* extra fields starting with iwn5000 */
if|#
directive|if
literal|0
block|uint8_t		txed;
comment|/* number of frames sent */
block|uint8_t		txed_2_done;
comment|/* number of frames acked */
block|uint16_t	reserved1;
endif|#
directive|endif
block|}
name|__packed
