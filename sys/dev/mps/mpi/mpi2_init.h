...
begin_comment
comment|/* TBD: I don't think this is needed for MPI2/Gen2 */
end_comment
...
begin_comment
unit|U32                     PrimaryReferenceTag;
comment|/* 0x14 */
end_comment

begin_comment
unit|U16                     PrimaryApplicationTag;
comment|/* 0x18 */
end_comment

begin_comment
unit|U16                     PrimaryApplicationTagMask;
comment|/* 0x1A */
end_comment

begin_comment
unit|U32                     TransferLength;
comment|/* 0x1C */
end_comment

begin_endif
unit|} MPI2_SCSI_IO32_CDB_EEDP16, MPI2_POINTER PTR_MPI2_SCSI_IO32_CDB_EEDP16,   Mpi2ScsiIo32CdbEedp16_t, MPI2_POINTER pMpi2ScsiIo32CdbEedp16_t;
endif|#
directive|endif
end_endif
