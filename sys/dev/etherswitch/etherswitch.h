...
define|#
directive|define
name|ETHERSWITCH_PORT_MAX_LEDS
value|3
end_define

begin_enum
enum|enum
name|etherswitch_port_led
block|{
name|ETHERSWITCH_PORT_LED_DEFAULT
block|,
name|ETHERSWITCH_PORT_LED_ON
block|,
name|ETHERSWITCH_PORT_LED_OFF
block|,
name|ETHERSWITCH_PORT_LED_BLINK
block|,
name|ETHERSWITCH_PORT_LED_MAX
block|}
enum|;
end_enum
