...
begin_comment
comment|/* #define _POSIX_SOURCE	1 */
end_comment
...
begin_comment
comment|/*  *  AIC-7770 register definitions  */
end_comment
...
index|[]
init|=
literal|"@(#)aic7770.c 1.10 94/07/22 jda"
decl_stmt|;
end_decl_stmt
...
name|printf
argument_list|(
literal|"usage: %s [-d] [-ooutput] input\n"
argument_list|,
operator|*
name|argv
argument_list|)
...
name|NULL
case|:
comment|/* 			 *  An impossible option to shut the compiler 			 *  up about sccsid[]. 			 */
name|exit
argument_list|(
operator|(
name|int
