...
begin_comment
comment|/*	$OpenBSD: if_nfereg.h,v 1.18 2006/05/01 15:59:31 brad Exp $	*/
end_comment
...
parameter_list|)
define|\
value|bus_space_read_4((sc)->sc_memt, (sc)->sc_memh, (reg))
end_define
...
parameter_list|)
define|\
value|bus_space_write_4((sc)->sc_memt, (sc)->sc_memh, (reg), (val))
end_define
