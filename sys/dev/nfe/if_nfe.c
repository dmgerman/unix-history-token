...
name|_sc
parameter_list|)
value|mtx_lock(&(_sc)->nfe_jlist_mtx)
end_define

begin_define
define|#
directive|define
name|NFE_JLIST_UNLOCK
parameter_list|(
name|_sc
parameter_list|)
value|mtx_unlock(&(_sc)->nfe_jlist_mtx)
end_define
...
goto|;
block|}
comment|/* Create DMA tag for jumbo buffer blocks. */
name|error
operator|=
name|bus_dma_tag_create
argument_list|(
...
name|nfe_dev
argument_list|,
literal|"could not create jumbo Rx buffer block DMA tag\n"
argument_list|)
expr_stmt|;
goto|goto
name|fail
...
name|nfe_dev
argument_list|,
literal|"could not allocate DMA'able memory for jumbo pool\n"
argument_list|)
expr_stmt|;
goto|goto
name|fail
...
name|nfe_dev
argument_list|,
literal|"could not load DMA'able memory for jumbo pool\n"
argument_list|)
expr_stmt|;
goto|goto
name|fail
