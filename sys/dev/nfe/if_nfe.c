...
block|,
literal|"NVIDIA nForce Networking Adapter"
block|}
block|,
block|{
name|PCI_VENDOR_NVIDIA
...
block|,
literal|"NVIDIA nForce2 Networking Adapter"
block|}
block|,
block|{
name|PCI_VENDOR_NVIDIA
...
block|,
literal|"NVIDIA nForce3 Networking Adapter"
block|}
block|,
block|{
name|PCI_VENDOR_NVIDIA
...
block|,
literal|"NVIDIA nForce2 400 Networking Adapter"
block|}
block|,
block|{
name|PCI_VENDOR_NVIDIA
...
block|,
literal|"NVIDIA nForce3 250 Networking Adapter"
block|}
block|,
block|{
name|PCI_VENDOR_NVIDIA
...
block|,
literal|"NVIDIA nForce4 Networking Adapter"
block|}
block|,
block|{
name|PCI_VENDOR_NVIDIA
...
block|,
literal|"NVIDIA nForce 430 Networking Adapter"
block|}
block|,
block|{
name|PCI_VENDOR_NVIDIA
...
name|printf
argument_list|(
literal|"nfe%d: could not allocate jumbo frames\n"
argument_list|,
name|sc
operator|->
name|nfe_unit
...
name|printf
argument_list|(
literal|"nfe%d: could not allocate jumbo buffer\n"
argument_list|,
name|sc
operator|->
name|nfe_unit
...
argument_list|)
expr_stmt|;
comment|/* m_adj(data->m, ETHER_ALIGN); */
name|physaddr
operator|=
name|jbuf
operator|->
...
name|printf
argument_list|(
literal|"nfe%d: could not create jumbo DMA tag\n"
argument_list|,
name|sc
operator|->
name|nfe_unit
...
name|printf
argument_list|(
literal|"nfe%d: could not create jumbo DMA memory\n"
argument_list|,
name|sc
operator|->
name|nfe_unit
...
name|printf
argument_list|(
literal|"nfe%d: could not load jumbo DMA map\n"
argument_list|,
name|sc
operator|->
name|nfe_unit
...
name|printf
argument_list|(
literal|"nfe%d: request to free a buffer (%p) not managed by us\n"
argument_list|,
name|sc
operator|->
name|nfe_unit
