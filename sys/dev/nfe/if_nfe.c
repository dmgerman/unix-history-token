...
name|nfe_dev
argument_list|,
literal|"MSI/MSI-X capability black-listed, will use INTx\n"
argument_list|)
expr_stmt|;
name|msix_disable
operator|=
...
argument_list|)
expr_stmt|;
comment|/* Unable to get memory - process without filtering */
if|if
condition|(
name|mta
operator|==
...
name|nfe_dev
argument_list|,
literal|"nfe_setmulti: failed to allocate"
literal|"temp multicast buffer!\n"
argument_list|)
expr_stmt|;
name|bzero
argument_list|(
...
condition|)
block|{
comment|/* 		 * Poll link state until nfe(4) get a 10/100Mbps link. 		 */
for|for
control|(
name|i
operator|=
