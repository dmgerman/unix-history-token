...
name|sis_PCI_IDS
define|\
value|{0x1039, 0x0300, 0, "SiS 300/305"}, \ 	{0x1039, 0x5300, 0, "SiS 540"}, \ 	{0x1039, 0x6300, 0, "SiS 630"}, \ 	{0x1039, 0x6330, SIS_CHIP_315, "SiS 661"}, \ 	{0x1039, 0x7300, 0, "SiS 730"}, \ 	{0x18CA, 0x0040, SIS_CHIP_315, "Volari V3XT/V5/V8"}, \ 	{0x18CA, 0x0042, SIS_CHIP_315, "Volari Unknown"}, \ 	{0, 0, 0, NULL}
end_define
...
name|viadrv_PCI_IDS
define|\
value|{0x1106, 0x3022, 0, "VIA CLE266 3022"}, \ 	{0x1106, 0x3118, VIA_PRO_GROUP_A, "VIA CN400 / PM8X0"}, \ 	{0x1106, 0x3122, 0, "VIA CLE266"}, \ 	{0x1106, 0x7205, 0, "VIA KM400"}, \ 	{0x1106, 0x3108, 0, "VIA K8M800"}, \ 	{0x1106, 0x3344, 0, "VIA CN700 / VM800 / P4M800Pro"}, \ 	{0x1106, 0x3343, 0, "VIA P4M890"}, \ 	{0x1106, 0x3230, VIA_DX9_0, "VIA K8M890"}, \ 	{0x1106, 0x3157, VIA_PRO_GROUP_A, "VIA CX700"}, \ 	{0x1106, 0x3371, VIA_DX9_0, "VIA P4M900 / VN896"}, \ 	{0, 0, 0, NULL}
end_define
...
name|xgi_PCI_IDS
define|\
value|{0x18ca, 0x2200, 0, "XP5"}, \ 	{0x18ca, 0x0047, 0, "XP10 / XG47"}, \ 	{0, 0, 0, NULL}
end_define
