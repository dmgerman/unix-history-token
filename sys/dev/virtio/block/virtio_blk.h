...
name|blk_size
decl_stmt|;
comment|/* the next 4 entries are guarded by VIRTIO_BLK_F_TOPOLOGY  */
comment|/* exponent for physical block per logical block. */
name|uint8_t
name|physical_block_exp
decl_stmt|;
comment|/* alignment offset in logical blocks. */
name|uint8_t
name|alignment_offset
decl_stmt|;
comment|/* minimum I/O size without performance penalty in logical blocks. */
name|uint16_t
name|min_io_size
decl_stmt|;
comment|/* optimal sustained I/O size in logical blocks. */
name|uint32_t
name|opt_io_size
decl_stmt|;
block|}
