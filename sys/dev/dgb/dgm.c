...
begin_comment
comment|/*-  *	$Id: dgm.c,v 1.8 1999/04/11 03:47:24 eivind Exp $  *  *  This driver and the associated header files support the ISA PC/Xem  *  Digiboards.  Its evolutionary roots are described below.  *  Jack O'Neill<jack@diamond.xtalwind.net>  *  *  Digiboard driver.  *  *  Stage 1. "Better than nothing".  *  Stage 2. "Gee, it works!".  *  *  Based on sio driver by Bruce Evans and on Linux driver by Troy   *  De Jongh<troyd@digibd.com> or<troyd@skypoint.com>   *  which is under GNU General Public License version 2 so this driver   *  is forced to be under GPL 2 too.  *  *  Written by Serge Babkin,  *      Joint Stock Commercial Bank "Chelindbank"  *      (Chelyabinsk, Russia)  *      babkin@hq.icb.chel.su  *  *  Assorted hacks to make it more functional and working under 3.0-current.  *  Fixed broken routines to prevent processes hanging on closed (thanks  *  to Bruce for his patience and assistance). Thanks also to Maxim Bolotin  *<max@run.net> for his patches which did most of the work to get this  *  running under 2.2/3.0-current.  *  Implemented ioctls: TIOCMSDTRWAIT, TIOCMGDTRWAIT, TIOCTIMESTAMP&  *  TIOCDCDTIMESTAMP.  *  Sysctl debug flag is now a bitflag, to filter noise during debugging.  *	David L. Nugent<davidn@blaze.net.au>  */
end_comment
...
comment|/* all PCXEMs have a 32k window size   */
name|dev
operator|->
name|id_msize
operator|=
...
name|printf
argument_list|(
literal|"dgm%d: 1st reset failed\n"
argument_list|,
name|dev
operator|->
name|id_unit
...
name|printf
argument_list|(
literal|"dgm%d: 1st memory test failed\n"
argument_list|,
name|dev
operator|->
name|id_unit
...
name|printf
argument_list|(
literal|"dgm%d: 2nd memory test failed\n"
argument_list|,
name|dev
operator|->
name|id_unit
...
name|printf
argument_list|(
literal|"dgm%d: 3rd (BIOS) memory test failed\n"
argument_list|,
name|dev
operator|->
name|id_unit
...
name|printf
argument_list|(
literal|"dgm%d: DigiBIOS loaded, initializing"
argument_list|,
name|dev
operator|->
name|id_unit
...
name|printf
argument_list|(
literal|"dgm%d: FEP/OS loaded, initializing"
argument_list|,
name|dev
operator|->
name|id_unit
...
name|printf
argument_list|(
literal|"dgm%d: only %d ports are usable\n"
argument_list|,
name|unit
argument_list|,
name|NDGMPORTS
...
name|DB_OPEN
argument_list|,
literal|"dgm%d: port%d: tsleep(dgocl) error=%d\n"
argument_list|,
name|unit
argument_list|,
name|pnum
...
name|DB_OPEN
argument_list|,
literal|"dgm%d: port%d: BUSY error=%d\n"
argument_list|,
name|unit
argument_list|,
name|pnum
...
name|DB_OPEN
argument_list|,
literal|"dgm%d: port%d: tsleep(dgmi) error=%d\n"
argument_list|,
name|unit
argument_list|,
name|pnum
...
name|DB_OPEN
argument_list|,
literal|"dgm%d: port%d: tsleep(dgdcd) error=%d\n"
argument_list|,
name|unit
argument_list|,
name|pnum
...
name|DB_RD
argument_list|,
literal|"dgm%d: port%d: read() returns %d\n"
argument_list|,
name|unit
argument_list|,
name|pnum
...
name|DB_WR
argument_list|,
literal|"dgm%d: port%d: write() returns %d\n"
argument_list|,
name|unit
argument_list|,
name|pnum
...
name|printf
argument_list|(
literal|"dgm%d: event queue's head or tail is wrong! hd=%d,tl=%d\n"
argument_list|,
name|unit
argument_list|,
name|head
...
name|DB_RXDATA
argument_list|,
literal|"dgm%d: port%d: p rx head=%d tail=%d\n"
argument_list|,
name|unit
argument_list|,
name|pnum
...
name|DB_MODEM
argument_list|,
literal|"dgm%d: port%d: MODEMCHG_IND\n"
argument_list|,
name|unit
argument_list|,
name|pnum
...
name|DB_BREAK
argument_list|,
literal|"dgm%d: port%d: BREAK_IND\n"
argument_list|,
name|unit
argument_list|,
name|pnum
...
name|DB_TXDATA
argument_list|,
literal|"dgm%d: port%d: LOWTX_IND or EMPTYTX_IND\n"
argument_list|,
name|unit
argument_list|,
name|pnum
...
name|DB_WR
argument_list|,
literal|"dgm%d: port%d: tsleep(dgfls) error=%d\n"
argument_list|,
name|port
operator|->
name|unit
