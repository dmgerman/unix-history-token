...
begin_comment
comment|/*-  *  dgreg.h $Id: dgreg.h,v 1.3 1995/12/22 16:08:15 bde Exp $  *  *  Digiboard driver.  *  *  Stage 1. "Better than nothing".  *  *  Based on sio driver by Bruce Evans and on Linux driver by Troy   *  De Jongh<troyd@digibd.com> or<troyd@skypoint.com>   *  which is under GNU General Public License version 2 so this driver   *  is forced to be under GPL 2 too.  *  *  Written by Serge Babkin,  *      Joint Stock Commercial Bank "Chelindbank"  *      (Chelyabinsk, Russia)  *      babkin@hq.icb.chel.su  */
end_comment
...
name|a3
parameter_list|)
value|(dgbdebug ? printf(a1,a2,a3) : 0)
end_define
...
name|a4
parameter_list|)
value|(dgbdebug ? printf(a1,a2,a3,a4) : 0)
end_define
...
name|a5
parameter_list|)
value|(dgbdebug ? printf(a1,a2,a3,a4,a5) : 0)
end_define
