...
begin_comment
comment|/* This code originally came from a nice man, I don't have your name,  * please email cokane@pohl.ececs.uc.edu for proper recognition   * it is basically a derivative of some sys/dhio.h file to work with the 3dfx  * cards   */
end_comment
