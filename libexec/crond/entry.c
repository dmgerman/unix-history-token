...
index|[]
init|=
literal|"$Header: entry.c,v 2.1 90/07/18 00:23:41 vixie Exp $"
decl_stmt|;
end_decl_stmt
...
begin_block
block|{
comment|/* this function reads one crontab entry -- the next -- from a file. 	 * it skips any leading blank lines, ignores comments, and returns 	 * EOF if for any reason the entry can't be read and parsed. 	 * 	 * the entry IS parsed here, btw. 	 * 	 * syntax: 	 *	minutes hours doms months dows cmd\n 	 */
specifier|extern
name|int
name|free
parameter_list|()
