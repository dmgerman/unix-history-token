...
begin_comment
comment|/* cron.h - header for vixie's cron  *  * $Header: cron.h,v 2.1 90/07/18 00:23:47 vixie Exp $  * $Source: /jove_u3/vixie/src/cron/RCS/cron.h,v $  * $Revision: 2.1 $  * $Log:	cron.h,v $  * Revision 2.1  90/07/18  00:23:47  vixie  * Baseline for 4.4BSD release  *   * Revision 2.0  88/12/10  04:57:39  vixie  * V2 Beta  *   * Revision 1.2  88/11/29  13:05:46  vixie  * seems to work on Ultrix 3.0 FT1  *   * Revision 1.1  88/11/14  12:27:49  vixie  * Initial revision  *   * Revision 1.4  87/05/02  17:33:08  paul  * baseline for mod.sources release  *  * vix 14jan87 [0 or 7 can be sunday; thanks, mwm@berkeley]  * vix 30dec86 [written]  */
end_comment
...
begin_comment
comment|/* these are really immutable, and are 	 *   defined for symbolic convenience only 	 * TRUE, FALSE, and ERR must be distinct 	 */
end_comment
...
begin_comment
comment|/* meaningless cookie for smart compilers that will pick their 	 * own register variables; this makes the code neater. 	 */
end_comment
...
begin_comment
comment|/* the crontab database will be a list of the 			 * following structure, one element per user. 			 * 			 * These are the crontabs. 			 */
end_comment
...
name|uid
decl_stmt|;
comment|/* uid from passwd file */
name|int
name|gid
decl_stmt|;
comment|/* gid from passwd file */
name|char
modifier|*
modifier|*
name|envp
decl_stmt|;
comment|/* environ for commands */
name|time_t
name|mtime
decl_stmt|;
...
init|=
block|{
literal|"@(#) Copyright (C) 1988, 1989, 1990 by Paul Vixie"
block|,
