...
begin_comment
comment|/*  * Bootstrap Protocol (BOOTP).  RFC951 and RFC1395.  *  * $Header: /b/source/CVS/othersrc/bootpd/bootp.h,v 1.2 1993/08/28 01:55:25 brezak Exp $  *  *  * This file specifies the "implementation-independent" BOOTP protocol  * information which is common to both client and server.  *  */
end_comment
...
begin_comment
comment|/*  * RFC1395 tag values used to specify what information is being supplied in  * the vendor field of the packet.  */
end_comment
