...
begin_comment
comment|/*  * Bootstrap Protocol (BOOTP).  RFC951 and RFC1395.  *  * $Id: bootp.h $  *  *  * This file specifies the "implementation-independent" BOOTP protocol  * information which is common to both client and server.  *  */
end_comment
