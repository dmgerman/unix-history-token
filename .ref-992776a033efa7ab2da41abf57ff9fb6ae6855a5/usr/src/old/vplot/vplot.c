...
begin_comment
comment|/*  VPLOT: version 4.1				updated %G%  *  *  Reads standard graphics input and produces a plot on the  *  Varian or Versatec  *  -- creates in /usr/tmp a raster file of 500 1K-blocks.  */
end_comment
...
begin_comment
comment|/* Machine Flag (don't simulate VM on vax) */
end_comment
