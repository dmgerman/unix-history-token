...
begin_block
block|{
comment|/*      * if the string is "", just clear the line      */
if|if
condition|(
operator|*
name|fmt
...
return|return;
block|}
comment|/*      * otherwise add to the message and flush it out      */
name|doadd
argument_list|(
name|fmt
argument_list|,
...
begin_comment
comment|/*  * endmsg:  *	Display a new msg (giving him a chance to see the previous one  *	if it is up there with the --More--)  */
end_comment
...
expr_stmt|;
block|}
comment|/*      * All messages should start with uppercase, except ones that      * start with a pack addressing character      */
if|if
condition|(
name|islower
argument_list|(
