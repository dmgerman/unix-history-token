...
condition|)
block|{
comment|/* read at eof returns 0 count */
name|bp
operator|->
name|b_resid
operator|=
...
begin_comment
comment|/*  * Raw interface for a read  */
end_comment
...
begin_comment
comment|/*  * Raw interface for a write  */
end_comment
...
begin_comment
comment|/*  * Check for valid device number dev and update our notion  * of where we are on the tape  */
end_comment
