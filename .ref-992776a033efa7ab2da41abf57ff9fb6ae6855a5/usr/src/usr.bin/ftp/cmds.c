...
begin_comment
comment|/*  * Send one or more files.  */
end_comment
...
name|printf
argument_list|(
literal|"%s local-file remote-file, or\n"
argument_list|,
name|argv
index|[
literal|0
...
return|return;
block|}
comment|/* 	 * Check for shell metacharacters which we might 	 * want to expand into a list of file names. 	 */
for|for
control|(
name|i
operator|=
...
name|printf
argument_list|(
literal|"%s remote-directory [ local-directory ], or\n"
argument_list|,
name|argv
index|[
literal|0
...
name|printf
argument_list|(
literal|"%s remote-files local-directory\n"
argument_list|,
name|argv
index|[
literal|0
...
condition|)
return|return;
comment|/* 	 * If destination doesn't exist, 	 * try and create it. 	 */
if|if
condition|(
name|stat
argument_list|(
...
block|}
block|}
comment|/* 	 * Multiple files, just get each one without an nlst. 	 */
if|if
condition|(
name|argc
operator|>
...
return|return;
block|}
comment|/* 	 * Get a directory full of files.  Perform an 	 * nlst to find the file names, then retrieve 	 * each individually.  If prompting is on, ask 	 * before grabbing each file. 	 */
name|strcpy
argument_list|(
name|temp
argument_list|,
