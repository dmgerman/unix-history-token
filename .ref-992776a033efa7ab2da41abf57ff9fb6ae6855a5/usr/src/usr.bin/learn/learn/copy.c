...
condition|)
block|{
comment|/* fprintf(stderr, "Don't type control-D\n"); */
comment|/* this didn't work out very well */
continue|continue;
block|}
else|else
break|break;
...
begin_comment
comment|/* copy fi to fo until a line with # */
end_comment
...
begin_comment
comment|/* compare two files for status */
end_comment
