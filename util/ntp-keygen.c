...
name|stderr
argument_list|,
literal|"Warning: identity files may not be useful with a nontrusted certificate.\n"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
expr_stmt|;
block|}
comment|/* 	 * Don't generate a certificate if no host keys or extracting 	 * encrypted or nonencrypted keys to the standard output stream. 	 */
if|if
condition|(
name|pkey_host
operator|==
...
argument_list|)
expr_stmt|;
comment|/* 	 * Decode the digest/signature scheme. If trusted, set the 	 * subject and issuer names to the group name; if not set both 	 * to the host name. 	 */
name|ectx
operator|=
