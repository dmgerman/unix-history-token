...
begin_comment
comment|/* because flex keeps having sign-unsigned compare problems that are unfixed*/
end_comment
...
literal|1
argument_list|,
argument|VAR_QNAME_MINIMISATION
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|1
argument_list|,
argument|VAR_CACHE_MAX_NEGATIVE_TTL
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|1
argument_list|,
argument|VAR_INFRA_CACHE_MIN_RTT
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|1
argument_list|,
argument|VAR_HARDEN_ALGO_DOWNGRADE
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|1
argument_list|,
argument|VAR_PERMIT_SMALL_HOLDDOWN
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|1
argument_list|,
argument|VAR_INSECURE_LAN_ZONES
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|2
argument_list|,
argument|VAR_ACCESS_CONTROL_TAG
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|3
argument_list|,
argument|VAR_ACCESS_CONTROL_TAG_ACTION
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|3
argument_list|,
argument|VAR_ACCESS_CONTROL_TAG_DATA
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|3
argument_list|,
argument|VAR_LOCAL_ZONE_OVERRIDE
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|1
argument_list|,
argument|VAR_DNSTAP_SOCKET_PATH
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|1
argument_list|,
argument|VAR_DNSTAP_SEND_IDENTITY
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|1
argument_list|,
argument|VAR_DNSTAP_SEND_VERSION
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|1
argument_list|,
argument|VAR_DNSTAP_LOG_RESOLVER_QUERY_MESSAGES
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|1
argument_list|,
argument|VAR_DNSTAP_LOG_RESOLVER_RESPONSE_MESSAGES
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|1
argument_list|,
argument|VAR_DNSTAP_LOG_CLIENT_QUERY_MESSAGES
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|1
argument_list|,
argument|VAR_DNSTAP_LOG_CLIENT_RESPONSE_MESSAGES
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|1
argument_list|,
argument|VAR_DNSTAP_LOG_FORWARDER_QUERY_MESSAGES
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|1
argument_list|,
argument|VAR_DNSTAP_LOG_FORWARDER_RESPONSE_MESSAGES
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|1
argument_list|,
argument|VAR_DISABLE_DNSSEC_LAME_CHECK
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|2
argument_list|,
argument|VAR_RATELIMIT_FOR_DOMAIN
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|2
argument_list|,
argument|VAR_RATELIMIT_BELOW_DOMAIN
argument_list|)
block|}
name|YY_BREAK
case|case
...
literal|168
case|:
comment|/* rule 168 can match eol */
name|YY_RULE_SETUP
line|#
directive|line
number|383
...
literal|171
case|:
comment|/* rule 171 can match eol */
name|YY_RULE_SETUP
line|#
directive|line
number|393
...
literal|175
case|:
comment|/* rule 175 can match eol */
name|YY_RULE_SETUP
line|#
directive|line
number|414
...
literal|179
case|:
comment|/* rule 179 can match eol */
name|YY_RULE_SETUP
line|#
directive|line
number|435
...
literal|183
case|:
comment|/* rule 183 can match eol */
name|YY_RULE_SETUP
line|#
directive|line
number|447
...
block|}
comment|/* end of user's declarations */
block|}
end_block
...
literal|1
expr_stmt|;
comment|// After all that talk, this was set to 1 anyways...
operator|(
name|yy_buffer_stack
operator|)
operator|=
...
begin_comment
comment|/** Set the current line number.  * @param _line_number line number  *   */
end_comment
...
begin_comment
comment|/** Set the input stream. This does not discard the current  * input buffer.  * @param _in_str A readable stream.  *   * @see yy_switch_to_buffer  */
end_comment
