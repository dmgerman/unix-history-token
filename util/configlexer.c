...
value|\         yy_size_t yyless_macro_arg = (n); \         YY_LESS_LINENO(yyless_macro_arg);\ 		*yy_cp = (yy_hold_char); \ 		YY_RESTORE_YY_MORE_OFFSET \ 		(yy_c_buf_p) = yy_cp = yy_bp + yyless_macro_arg - YY_MORE_ADJ; \ 		YY_DO_BEFORE_ACTION;
...
literal|163
case|:
comment|/* rule 163 can match eol */
name|YY_RULE_SETUP
line|#
directive|line
number|374
...
literal|166
case|:
comment|/* rule 166 can match eol */
name|YY_RULE_SETUP
line|#
directive|line
number|384
...
literal|170
case|:
comment|/* rule 170 can match eol */
name|YY_RULE_SETUP
line|#
directive|line
number|405
...
literal|178
case|:
comment|/* rule 178 can match eol */
name|YY_RULE_SETUP
line|#
directive|line
number|438
...
value|do \ 		{ \
comment|/* Undo effects of setting up yytext. */
value|\         yy_size_t yyless_macro_arg = (n); \         YY_LESS_LINENO(yyless_macro_arg);\ 		yytext[yyleng] = (yy_hold_char); \ 		(yy_c_buf_p) = yytext + yyless_macro_arg; \ 		(yy_hold_char) = *(yy_c_buf_p); \ 		*(yy_c_buf_p) = '\0'; \ 		yyleng = yyless_macro_arg; \ 		} \ 	while ( 0 )
end_define
