...
index|[]
init|=
literal|"@(#)ed.c	5.1 (Berkeley) 4/8/91"
decl_stmt|;
end_decl_stmt
...
name|puts
argument_list|(
literal|"Entering encrypting mode!"
argument_list|)
expr_stmt|;
name|getkey
argument_list|()
...
begin_comment
comment|/*  * Besides initializing the encryption machine, this routine  * returns 0 if the key is null, and 1 if it is non-null.  */
end_comment
