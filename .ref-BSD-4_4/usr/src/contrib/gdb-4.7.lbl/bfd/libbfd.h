...
begin_comment
comment|/* XXX This chud macro controls the maximum number of files that bfd will    open.  It caches file descriptors and closes old files when too many    are opened.  The only reason this is here is to make this work on PCs. */
end_comment
