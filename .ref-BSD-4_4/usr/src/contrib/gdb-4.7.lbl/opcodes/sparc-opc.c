...
parameter_list|)
define|\
value|brfc(fop, F2(0, 6)|COND(mask), F2(~0, ~6)|COND(~(mask)), flags), \   brfc(cop, F2(0, 7)|COND(mask), F2(~0, ~7)|COND(~(mask)), flags)
define|#
directive|define
name|condf
parameter_list|(
...
parameter_list|)
define|\
value|brfc(fop, F2(0, 6)|COND(mask), F2(~0, ~6)|COND(~(mask)), flags)
name|condfc
argument_list|(
literal|"fb"
argument_list|,
