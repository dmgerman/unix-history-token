...
index|[]
init|=
literal|"@(#)$Id: mhn.c,v 2.21 1992/12/15 00:20:22 jromine Exp $"
decl_stmt|;
end_decl_stmt
...
name|NULLCP
argument_list|,
literal|"message %s has unsupported value for %s: field (%s)"
argument_list|,
name|ct
operator|->
name|c_file
...
name|buffer
argument_list|,
literal|"Use cached copy %s of size %lu octets (content %s)? "
argument_list|,
name|id
argument_list|,
operator|(
...
name|buffer
argument_list|,
literal|"Make cached, publically-accessible copy of %s? "
argument_list|,
name|e
operator|->
name|eb_name
