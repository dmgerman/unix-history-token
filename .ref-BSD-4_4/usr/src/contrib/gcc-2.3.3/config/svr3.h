...
begin_comment
comment|/* Assembler pseudos to introduce constants of various size.  These    definitions hsould work for most svr3 systems.  */
end_comment
...
value|\ 	  || !TREE_READONLY (DECL) || TREE_SIDE_EFFECTS (DECL))		\ 	data_section ();						\       else								\ 	const_section ();						\     }									\   else									\     const_section ();							\ }
end_define
