...
directive|define
name|LINK_SPEC
value|"\ %{G*} \ %{!mgas: \ 	%{EB} %{!EB:-EB} \ 	%{EL: %e-EL not supported} \ 	%{bestGnum} %{shared} %{non_shared} \ 	%{mips1} %{mips2} %{mips3} \ 	-systype /sysv/}"
end_define
