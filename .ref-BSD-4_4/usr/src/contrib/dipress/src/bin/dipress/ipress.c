...
begin_comment
comment|/*  * set the current font to number  */
end_comment
...
begin_comment
comment|/*  * Request the insertion of an Interpress master  */
end_comment

begin_macro
name|doSequenceInsertIP
argument_list|(
argument|fileName
argument_list|)
end_macro
...
argument_list|)
expr_stmt|;
comment|/* set the IP position at the current troff position */
name|Setxy
argument_list|(
name|xloc
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* undo the Troff scaling */
name|AppendRational
argument_list|(
name|spotsPerInch
operator|*
...
begin_comment
comment|/*  * define frame variables for the RES image  */
end_comment
...
begin_comment
comment|/*  * Request the insertion of an RES file  */
end_comment

begin_macro
name|doSequenceInsertRES
argument_list|(
argument|anchor
argument_list|,
argument|resolutionString
argument_list|,
argument|fileName
argument_list|)
end_macro
...
argument_list|)
expr_stmt|;
comment|/* pop and store */
name|AppendOp
argument_list|(
name|OP_pop
argument_list|)
expr_stmt|;
comment|/* for now, don't check the signature */
name|AppendInteger
argument_list|(
name|IMAGE_EDIT
argument_list|)
...
condition|)
block|{
comment|/* display the RES file at the specified resolution */
name|AppendRational
argument_list|(
literal|254L
argument_list|,
...
block|}
elseif|else
comment|/* get the default scale from the RES file */
comment|/* can the device do a "get" operator? */
if|if
condition|(
name|IPDeviceType
operator|==
...
name|CONTINUE
argument_list|,
literal|"requested device can't read resolution from an RES file"
argument_list|)
expr_stmt|;
else|else
block|{
comment|/* Yes!  Use the imageScale suggested by the image */
name|Fget
argument_list|(
name|IMAGE_SCALE
argument_list|)
...
argument_list|)
expr_stmt|;
comment|/* concat undo-scale with image scale */
if|if
condition|(
name|strcmp
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* half normal scale for centering */
name|FGet
argument_list|(
name|IMAGE_X
argument_list|)
...
name|CONTINUE
argument_list|,
literal|"unknown position in RES command: %s"
argument_list|,
name|anchor
argument_list|)
expr_stmt|;
