...
begin_comment
comment|/* since scandir.c is surrounded by an ifdef */
end_comment
...
begin_comment
comment|/* simpler version of one in util.c, needed by scandir.c */
end_comment
...
begin_comment
comment|/* duplicated in util.c, needed by scandir.c */
end_comment
...
begin_comment
comment|/* kludge! needed by scandir.c */
end_comment
...
begin_comment
comment|/* to get dirent simulation and jscandir */
end_comment
...
directive|ifndef
name|BSD386
comment|/* this is naughty anyway */
if|if
condition|(
name|stdin
operator|->
