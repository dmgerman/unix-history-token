...
begin_comment
comment|/* We globalized the class because this is done by g++ 1.40 anyway and with   * 1.9? this does not work at all (one has to prefix all members of the nested  * class with the name of the enclosing class.H.S.  */
end_comment
