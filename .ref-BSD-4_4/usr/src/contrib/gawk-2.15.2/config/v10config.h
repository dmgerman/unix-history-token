...
begin_comment
comment|/*  * GETOPT_MISSING  *  * Define this if your library does not have the getopt(3) library  * routine for parsing command line arguments.  */
end_comment

begin_comment
comment|/* #define GETOPT_MISSING	1 */
end_comment
...
begin_comment
comment|/*  * STRTOL_MISSING  *  * Your system does not have the strtol() routine for converting  * strings to long integers.  */
end_comment

begin_comment
comment|/* #define STRTOL_MISSING	1 */
end_comment
...
begin_comment
comment|/*  * VPRINTF_MISSING  *  * Define this if your system lacks vprintf() and the other routines  * that go with it.  */
end_comment
...
begin_comment
comment|/*  * BSDSTDIO  *  * Define this if your standard i/o library is internally compatible  * with the one shipped with Berkeley Unix systems (4.n, n<= 3-reno).  * If you've defined VPRINTF_MISSING, you probably will need this too.  */
end_comment

begin_comment
comment|/* #define BSDSTDIO		1 */
end_comment

begin_comment
comment|/*  * DOPRNT_MISSING  *  * Define this if your standard i/o library does not have the _doprnt()  * routine.  This is used in an attempt to simulate the vfprintf()  * routine.  */
end_comment

begin_comment
comment|/* #define DOPRNT_MISSING	1 */
end_comment
