...
begin_comment
comment|/* Definitions file for GNU Emacs running on UMAX 4.2    Copyright (C) 1985, 1986 Free Software Foundation, Inc.  This file is part of GNU Emacs.  GNU Emacs is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 1, or (at your option) any later version.  GNU Emacs is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU Emacs; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
begin_comment
comment|/* Specify alignment requirement for start of text and data sections    in the executable file.  */
end_comment
...
begin_comment
comment|/* crt0.c needs this for compilation because it uses asm.  */
end_comment
...
directive|define
name|C_SWITCH_ASM
value|-q nodirect_code
end_define

begin_comment
comment|/* Encore machines with APC processor boards align sections on 4M    boundaries, so it is not easy to remap the start of the text segment    in the unexec() routine.  For them you need the following two lines.    For DPC processors you can enable these or not, as you wish, but    you will get better performance without them.  */
end_comment

begin_comment
comment|/* #define NO_REMAP    #define TEXT_START 0 */
end_comment
