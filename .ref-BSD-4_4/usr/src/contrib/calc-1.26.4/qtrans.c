...
begin_comment
comment|/*  * Copyright (c) 1993 David I. Bell  * Permission is granted to use, distribute, or modify this source,  * provided that this copyright notice remains intact.  *  * Transcendental functions for real numbers.  * These are sin, cos, exp, ln, power, cosh, sinh.  */
end_comment
...
name|error
argument_list|(
literal|"Zero coordinates for atan2"
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|/* 	 * Scale down the logarithm to the convergent range by taking square 	 * roots.  The result will be modified to get the final value later. 	 */
name|q
operator|=
name|qlink
argument_list|(
...
expr_stmt|;
block|}
comment|/* 	 * Calculate the final result by multiplying by the proper power of two 	 * to undo the square roots done at the top. 	 */
name|tmp1
operator|=
name|qscale
argument_list|(
