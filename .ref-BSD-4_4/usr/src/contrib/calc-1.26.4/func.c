...
begin_comment
comment|/*  * Copyright (c) 1993 David I. Bell  * Permission is granted to use, distribute, or modify this source,  * provided that this copyright notice remains intact.  *  * Built-in functions implemented here  */
end_comment
...
literal|0
block|,
literal|"approximate a within accuracy b using continued fractions"
block|,
literal|"cfsim"
block|,
literal|1
...
literal|0
block|,
literal|"value of parameter n (or parameter count if n is zero)"
block|,
literal|"perm"
block|,
literal|2
...
literal|0
block|,
literal|"set c and d to quotient and remainder of a divided by b"
block|,
literal|"rcin"
block|,
literal|2
...
name|f_rsearch
block|,
literal|"reverse search matrix or list for value b starting at index c"
block|,
literal|"runtime"
block|,
literal|0
...
name|f_search
block|,
literal|"search matrix or list for value b starting at index c"
block|,
literal|"sgn"
block|,
literal|1
