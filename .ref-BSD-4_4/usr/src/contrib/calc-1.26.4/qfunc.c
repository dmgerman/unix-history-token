...
begin_comment
comment|/*  * Copyright (c) 1993 David I. Bell  * Permission is granted to use, distribute, or modify this source,  * provided that this copyright notice remains intact.  *  * Extended precision rational arithmetic non-primitive functions  */
end_comment
...
begin_comment
comment|/*  * Return the modulo of one number raised to another.  * Here q1 is the number to be raised, q2 is the power to raise it to,  * and q3 is the number to take the modulo with the result.  * The second and third numbers are assumed nonnegative.  * Returned answer is non-negative.  *	q4 = qpowermod(q1, q2, q3);  */
end_comment
...
name|error
argument_list|(
literal|"Non-integers for powermod"
argument_list|)
expr_stmt|;
name|r
operator|=
...
name|error
argument_list|(
literal|"Zero raised to non-positive power"
argument_list|)
expr_stmt|;
return|return
name|qlink
...
begin_comment
comment|/*  * Compute the lcm (least common denominator) of two numbers.  *	q3 = qlcm(q1, q2);  */
end_comment
