...
begin_comment
comment|/*  * Copyright (c) 1993 David I. Bell  * Permission is granted to use, distribute, or modify this source,  * provided that this copyright notice remains intact.  *  * Opcode execution module  */
end_comment
...
name|curvp
decl_stmt|;
comment|/* current stack address */
name|VALUE
modifier|*
name|vp
decl_stmt|;
comment|/* real stack value */
name|NUMBER
modifier|*
name|q
decl_stmt|;
...
name|error
argument_list|(
literal|"Attempting to index a non-matrix variable"
argument_list|)
expr_stmt|;
name|mp
operator|=
...
name|error
argument_list|(
literal|"Non-numeric index for array"
argument_list|)
expr_stmt|;
name|q
operator|=
...
name|error
argument_list|(
literal|"Non-integral index for array"
argument_list|)
expr_stmt|;
name|index
operator|=
