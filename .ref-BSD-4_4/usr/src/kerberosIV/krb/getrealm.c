...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/getrealm.c,v $  * $Author: bostic $  *  * Copyright 1988 by the Massachusetts Institute of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  *  * routine to convert hostname into realm name.  */
end_comment
...
index|[]
init|=
literal|"$Id: getrealm.c,v 4.8 92/07/19 13:21:11 bostic Exp $"
decl_stmt|;
end_decl_stmt
