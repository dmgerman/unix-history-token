...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/send_to_kdc.c,v $  * $Author: bostic $  *  * Copyright 1987, 1988 by the Massachusetts Institute of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
index|[]
init|=
literal|"$Id: send_to_kdc.c,v 4.22 92/07/19 13:23:29 bostic Exp $"
decl_stmt|;
end_decl_stmt
