...
begin_comment
comment|/*					-[Thu Mar  3 15:57:51 1983 by jkf]-  * 	config.h			$Locker:  $  * configuration dependent info  *  * $Header: config.h,v 1.16 87/12/14 18:33:31 sklower Exp $  *  * (c) copyright 1982, Regents of the University of California  */
end_comment
...
begin_comment
comment|/*  * set up the global defines based on the choice above  * the global names are  * operating system:  *		  os_unix  *		     os_4_1, os_4_1a, os_4_1c, os_4_2, os_unix_ts  *		  os_vms  */
end_comment
...
begin_comment
comment|/* RTPORTS -- this O.S. allocates FILE *'s at run-time */
end_comment
...
begin_comment
comment|/*  TTSIZE is the absolute limit, in pages (both text and data), of the  * size to which the lisp system may grow.  * If you change this, you must recompile alloc.c and data.c.  */
end_comment
