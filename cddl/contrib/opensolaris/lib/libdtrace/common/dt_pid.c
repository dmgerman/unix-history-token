...
name|dt_dprintf
argument_list|(
literal|"read of DOF header failed\n"
argument_list|)
expr_stmt|;
continue|continue;
block|}
...
name|sysctlbyname
argument_list|(
literal|"kern.dtrace.dof_maxsize"
argument_list|,
operator|&
name|dofmax
argument_list|,
...
name|dt_dprintf
argument_list|(
literal|"failed to read dof_maxsize: %s\n"
argument_list|,
name|strerror
argument_list|(
name|errno
...
name|dt_dprintf
argument_list|(
literal|"DOF load size exceeds maximum\n"
argument_list|)
expr_stmt|;
continue|continue;
block|}
...
name|dt_dprintf
argument_list|(
literal|"read of DOF section failed\n"
argument_list|)
expr_stmt|;
continue|continue;
block|}
...
name|dt_dprintf
argument_list|(
literal|"open of helper device failed: %s\n"
argument_list|,
name|strerror
argument_list|(
name|errno
