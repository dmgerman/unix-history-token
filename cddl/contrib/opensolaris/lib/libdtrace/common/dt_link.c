...
condition|)
continue|continue;
comment|/* Find the immediately adjcent section. */
if|if
condition|(
name|scn0
operator|==
...
condition|)
break|break;
comment|/* Load section data to work around another bug */
name|elf_getdata
argument_list|(
name|scn0
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* Update section header, assure section alignment */
name|off
operator|=
name|shdr0
operator|.
...
name|NULL
argument_list|,
literal|"failed to add append the shstrtab section: %s"
argument_list|,
name|elf_errmsg
argument_list|(
name|elf_errno
