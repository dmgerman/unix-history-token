...
begin_comment
comment|/*  * Translate the sid string ("S-1-...") to the user@domain name, if  * possible.  There should be a better way to do this, but for now we  * just translate to the (possibly ephemeral) uid and then back again.  */
end_comment
...
block|}
block|,
comment|/* Below are not really zfs-specific: */
block|{
literal|"sid_to_id"
block|,
name|py_sid_to_id
...
name|METH_VARARGS
block|,
literal|"Map SID to name@domain."
block|}
block|,
block|{
literal|"isglobalzone"
block|,
name|py_isglobalzone
block|,
name|METH_NOARGS
block|,
literal|"Determine if this is the global zone."
block|}
block|,
block|{
name|NULL
