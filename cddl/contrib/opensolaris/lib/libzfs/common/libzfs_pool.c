...
begin_comment
comment|/*  * Copyright (c) 2005, 2010, Oracle and/or its affiliates. All rights reserved.  * Copyright (c) 2011, 2015 by Delphix. All rights reserved.  * Copyright (c) 2013, Joyent, Inc. All rights reserved.  * Copyright 2016 Nexenta Systems, Inc.  * Copyright 2016 Igor Kozhukhov<ikozhukhov@gmail.com>  * Copyright (c) 2017 Datto Inc.  */
end_comment
...
name|errno
expr_stmt|;
comment|/* ECANCELED on a scrub means we resumed a paused scrub */
if|if
condition|(
name|err
operator|==
...
name|TEXT_DOMAIN
argument_list|,
literal|"cannot pause scrubbing %s"
argument_list|)
argument_list|,
name|zc
operator|.
