...
begin_comment
comment|/*  * Copyright (c) 2005, 2010, Oracle and/or its affiliates. All rights reserved.  * Copyright 2012 Nexenta Systems, Inc. All rights reserved.  * Copyright (c) 2011 by Delphix. All rights reserved.  * Copyright (c) 2012 DEY Storage Systems, Inc.  All rights reserved.  * Copyright (c) 2011-2012 Pawel Jakub Dawidek<pawel@dawidek.net>.  * All rights reserved.  * Copyright (c) 2012 Martin Matuska<mm@FreeBSD.org>. All rights reserved.  */
end_comment
...
begin_comment
comment|/*  * Destroys all the snapshots named in the nvlist.  They must be underneath  * the zhp (either snapshots of it, or snapshots of its descendants).  */
end_comment
...
name|TEXT_DOMAIN
argument_list|,
literal|"cannot destroy snapshots in %s"
argument_list|)
argument_list|,
name|zc
operator|.
...
name|TEXT_DOMAIN
argument_list|,
literal|"cannot release '%s' from '%s@%s'"
argument_list|)
argument_list|,
name|tag
argument_list|,
