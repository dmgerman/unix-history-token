...
name|TEXT_DOMAIN
argument_list|,
literal|"iscsitgt service need to be enabled by "
literal|"a privileged user"
argument_list|)
operator|)
return|;
case|case
...
name|TEXT_DOMAIN
argument_list|,
literal|"snapshot permissions cannot be"
literal|" modified"
argument_list|)
operator|)
return|;
...
name|TEXT_DOMAIN
argument_list|,
literal|"snapshot permissions cannot be modified"
argument_list|)
argument_list|)
expr_stmt|;
name|zfs_verror
