...
literal|0
decl_stmt|;
comment|/* 	 * Go through and read the label configuration information from every 	 * GEOM provider, organizing the information according to pool GUID 	 * and toplevel GUID. 	 */
name|fd
operator|=
name|geom_gettree
argument_list|(
