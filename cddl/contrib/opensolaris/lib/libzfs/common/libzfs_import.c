...
begin_comment
comment|/*  * Given a file descriptor, read the label information and return an nvlist  * describing the configuration, if there is one.  * returns the number of valid labels found  */
end_comment
...
name|NULL
decl_stmt|;
comment|/* TODO: use aio_read so we can read al 4 labels in parallel */
if|if
condition|(
name|pread64
argument_list|(
