...
name|stderr
argument_list|,
literal|"Usage: %s [-udibcsvL] [-U cachefile_path] [-O order] "
literal|"[-B os:obj:level:blkid] [-S user:cksumalg] "
...
name|printf
argument_list|(
literal|"failed to get size '%s': %s\n"
argument_list|,
name|dev
argument_list|,
name|strerror
