...
argument_list|(
literal|"property '%s' is "
literal|"not a valid file system property\n"
argument_list|)
argument_list|,
name|propname
argument_list|)
