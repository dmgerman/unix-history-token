...
begin_comment
comment|/*  * Copyright (c) 2005, 2010, Oracle and/or its affiliates. All rights reserved.  * Copyright (c) 2011, 2016 by Delphix. All rights reserved.  * Copyright 2012 Milan Jurik. All rights reserved.  * Copyright (c) 2012, Joyent, Inc. All rights reserved.  * Copyright (c) 2011-2012 Pawel Jakub Dawidek. All rights reserved.  * Copyright (c) 2012 Martin Matuska<mm@FreeBSD.org>. All rights reserved.  * Copyright (c) 2013 Steven Hartland.  All rights reserved.  * Copyright (c) 2014 Integros [integros.com]  * Copyright 2016 Igor Kozhukhov<ikozhukhov@gmail.com>.  * Copyright 2016 Nexenta Systems, Inc.  */
end_comment
...
name|gettext
argument_list|(
literal|"\treceive|recv [-vnsFu]<filesystem|volume|"
literal|"snapshot>\n"
literal|"\treceive|recv [-vnsFu] [-o origin=<snapshot>] [-d | -e] "
literal|"<filesystem>\n"
literal|"\treceive|recv -A<filesystem|volume>\n"
argument_list|)
operator|)
return|;
case|case
