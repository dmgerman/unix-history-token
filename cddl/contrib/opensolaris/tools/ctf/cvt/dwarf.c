...
name|terminate
argument_list|(
literal|"die %llu: cannot parse member offset with "
literal|"operator other than DW_OP_plus_uconst\n"
argument_list|,
name|die_off
argument_list|(
name|dw
...
condition|)
continue|continue;
comment|/* 			 * For empty members, or GCC/C99 flexible array 			 * members, a size of 0 is correct. Structs and unions 			 * consisting of flexible array members will also have 			 * size 0. 			 */
if|if
condition|(
name|mt
operator|->
