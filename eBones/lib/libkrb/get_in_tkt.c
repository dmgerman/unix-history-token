...
begin_comment
comment|/*  * Copyright 1987, 1988 by the Massachusetts Institute of Technology.  * For copying and distribution information, please see the file  *<Copyright.MIT>.  *  *	from: get_in_tkt.c,v 4.12 89/07/18 16:32:56 jtkohl Exp $  *	$Id: get_in_tkt.c,v 1.3 1995/07/18 16:38:30 mark Exp $  */
end_comment
...
begin_endif
unit|static char rcsid[] = "$Id: get_in_tkt.c,v 1.3 1995/07/18 16:38:30 mark Exp $";
endif|#
directive|endif
end_endif
...
begin_endif
unit|static char rcsid_read_password_c[] = "Bones$Header: /usr/cvs/src/eBones/krb/get_in_tkt.c,v 1.3 1995/07/18 16:38:30 mark Exp $";
endif|#
directive|endif
endif|lint
end_endif
