...
begin_comment
comment|/*  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  * For copying and distribution information, please see the file  *<Copyright.MIT>.  *  *	from: mk_err.c,v 4.4 88/11/15 16:33:36 jtkohl Exp $  *	$Id: mk_err.c,v 1.3 1995/07/18 16:39:11 mark Exp $  */
end_comment
...
begin_endif
unit|static char *rcsid = "$Id: mk_err.c,v 1.3 1995/07/18 16:39:11 mark Exp $";
endif|#
directive|endif
end_endif
