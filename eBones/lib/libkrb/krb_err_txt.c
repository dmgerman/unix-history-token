...
begin_comment
comment|/*  * Copyright 1988 by the Massachusetts Institute of Technology.  * For copying and distribution information, please see the file  *<Copyright.MIT>.  *  *	from: krb_err_txt.c,v 4.7 88/12/01 14:10:14 jtkohl Exp $  *	$Id: krb_err_txt.c,v 1.3 1995/09/07 21:38:10 markm Exp $  */
end_comment
...
begin_endif
unit|static char rcsid[] = "$Id: krb_err_txt.c,v 1.3 1995/09/07 21:38:10 markm Exp $";
endif|#
directive|endif
endif|lint
end_endif
