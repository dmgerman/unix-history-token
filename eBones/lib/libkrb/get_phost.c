...
begin_comment
comment|/*  * Copyright 1988 by the Massachusetts Institute of Technology.  * For copying and distribution information, please see the file  *<Copyright.MIT>.  *  *	from: get_phost.c,v 4.6 89/01/23 09:25:40 jtkohl Exp $  *	$Id: get_phost.c,v 1.2 1994/07/19 19:25:20 g89r4222 Exp $  */
end_comment
...
index|[]
init|=
literal|"$Id: get_phost.c,v 1.2 1994/07/19 19:25:20 g89r4222 Exp $"
decl_stmt|;
end_decl_stmt
