...
begin_comment
comment|/*  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  * For copying and distribution information, please see the file  *<Copyright.MIT>.  *  *	from: create_death_packet.c,v 4.9 89/01/17 16:05:59 rfrench Exp $  *	$Id: create_death_packet.c,v 1.1.1.1 1994/09/30 14:49:59 csgr Exp $  */
end_comment
...
name|rcsid
init|=
literal|"$Id: create_death_packet.c,v 1.1.1.1 1994/09/30 14:49:59 csgr Exp $"
decl_stmt|;
end_decl_stmt
