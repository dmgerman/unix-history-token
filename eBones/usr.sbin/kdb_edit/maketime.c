...
begin_comment
comment|/*  * Copyright 1990 by the Massachusetts Institute of Technology.  * For copying and distribution information, please see the file  *<Copyright.MIT>.  *  * Convert a struct tm * to a UNIX time.  *  *	from: maketime.c,v 4.2 90/01/09 15:54:51 raeburn Exp $  *	$Id$  */
end_comment
