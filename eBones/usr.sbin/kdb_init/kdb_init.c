...
begin_comment
comment|/*  * Copyright 1987, 1988 by the Massachusetts Institute of Technology.  * For copying and distribution information, please see the file  *<Copyright.MIT>.  *  * program to initialize the database,  reports error if database file  * already exists.  *  *	from: kdb_init.c,v 4.0 89/01/24 21:50:45 jtkohl Exp $  *	$Id: kdb_init.c,v 1.4 1995/09/07 21:37:20 markm Exp $  */
end_comment
...
begin_endif
unit|static char rcsid[] = "$Id: kdb_init.c,v 1.4 1995/09/07 21:37:20 markm Exp $";
endif|#
directive|endif
endif|lint
end_endif
