...
begin_comment
comment|/*  * Copyright 1987, 1988 by the Massachusetts Institute of Technology.   * For copying and distribution information, please see the file  *<Copyright.MIT>.   *  * program to initialize the database,  reports error if database file  * already exists.   *  *	from: kdb_init.c,v 4.0 89/01/24 21:50:45 jtkohl Exp $  *	$Id: kdb_init.c,v 1.3 1994/09/24 14:04:17 g89r4222 Exp $  */
end_comment
...
index|[]
init|=
literal|"$Id: kdb_init.c,v 1.3 1994/09/24 14:04:17 g89r4222 Exp $"
decl_stmt|;
end_decl_stmt
