...
begin_comment
comment|/*  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  * For copying and distribution information, please see the file  *<Copyright.MIT>.  *  *	from: mk_err.c,v 4.4 88/11/15 16:33:36 jtkohl Exp $  *	$Id: mk_err.c,v 1.2 1994/07/19 19:25:54 g89r4222 Exp $  */
end_comment
...
name|rcsid
init|=
literal|"$Id: mk_err.c,v 1.2 1994/07/19 19:25:54 g89r4222 Exp $"
decl_stmt|;
end_decl_stmt
