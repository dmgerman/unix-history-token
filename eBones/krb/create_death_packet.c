...
begin_comment
comment|/*  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  * For copying and distribution information, please see the file  *<Copyright.MIT>.  *  *	from: create_death_packet.c,v 4.9 89/01/17 16:05:59 rfrench Exp $  *	$Id: create_death_packet.c,v 1.3 1995/07/18 16:38:09 mark Exp $  */
end_comment
...
begin_endif
unit|static char *rcsid = "$Id: create_death_packet.c,v 1.3 1995/07/18 16:38:09 mark Exp $";
endif|#
directive|endif
end_endif
