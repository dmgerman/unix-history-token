...
begin_comment
comment|/*  * Copyright 1987, 1988 by the Massachusetts Institute of Technology.  * For copying and distribution information, please see the file  *<Copyright.MIT>.  *  *	from: send_to_kdc.c,v 4.20 90/01/02 13:40:37 jtkohl Exp $  *	$Id: send_to_kdc.c,v 1.3 1995/07/18 16:39:42 mark Exp $  */
end_comment
...
name|stderr
argument_list|,
literal|"select failed: readfds=%lx"
argument_list|,
operator|(
name|unsigned
name|long
...
name|stderr
argument_list|,
literal|"%s: received packet from wrong host! (%lx)\n"
argument_list|,
