...
begin_comment
comment|/*  * Copyright 1988 by the Massachusetts Institute of Technology.  * For copying and distribution information, please see the file  *<Copyright.MIT>.  *  *	from: krbglue.c,v 4.1 89/01/23 15:51:50 wesommer Exp $  *	$Id: krbglue.c,v 1.2 1994/07/19 19:25:49 g89r4222 Exp $  */
end_comment
...
name|Exp
name|$
literal|"; #endif lint  #ifndef NCOMPAT /*  * glue together new libraries and old clients  */  #include<stdio.h> #include<sys/types.h> #include<netinet/in.h> #include "
name|des
operator|.
name|h
literal|" #include "
