...
begin_comment
comment|/*  * This table contains the names of the predefined methods for which we can  * perform more complex repairs.  *  * _ALR: Sort the list ascending by AmbientIlluminance if necessary  * _PSS: Sort the list descending by Power if necessary  * _TSS: Sort the list descending by Power if necessary  */
end_comment
...
return|;
block|}
comment|/*      * Detect any NULL package elements and remove them from the      * package.      *      * TBD: We may want to do this for all predefined names that      * return a variable-length package of packages.      */
name|Status
operator|=
name|AcpiNsRemoveNullElements
argument_list|(
...
name|NodeFlags
operator|,
literal|"NULL elements removed from package"
operator|)
argument_list|)
expr_stmt|;
comment|/* Exit if package is now zero length */
if|if
condition|(
operator|!
name|ReturnObject
...
name|NodeFlags
operator|,
literal|"Repaired unsorted list - now sorted by %s"
operator|,
name|SortKeyName
operator|)
argument_list|)
...
begin_comment
comment|/******************************************************************************  *  * FUNCTION:    AcpiNsRemoveNullElements  *  * PARAMETERS:  ObjDesc             - A Package object  *  * RETURN:      Status. AE_NULL_ENTRY means that one or more elements were  *              removed.  *  * DESCRIPTION: Remove all NULL package elements and update the package count.  *  *****************************************************************************/
end_comment
...
name|Source
expr_stmt|;
comment|/* Examine all elements of the package object */
for|for
control|(
name|i
operator|=
