...
begin_comment
comment|/*  *  objectassign.c  *  testObjects  *  *  Created by Blaine Garst on 10/28/08.  *  * This just tests that the compiler is issuing the proper helper routines  * CONFIG C rdar://6175959  */
end_comment
...
name|printf
argument_list|(
literal|"need compiler version %d, have %d\n"
argument_list|,
literal|5627
argument_list|,
name|__APPLE_CC__
