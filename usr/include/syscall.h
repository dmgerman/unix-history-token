...
begin_comment
comment|/*	@(#)syscall.h	4.3	(Berkeley)	2/10/83	*/
end_comment
...
begin_comment
comment|/* 65 is old: vfork */
end_comment

begin_comment
comment|/* 66 is old: vread */
end_comment

begin_comment
comment|/* 67 is old: vwrite */
end_comment
