...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/include/RCS/krb_db.h,v $  * $Author: kfall $  * $Header: /usr/src/kerberosIV/include/RCS/krb_db.h,v 4.10 90/06/25 20:50:50 kfall Exp $   *  * Copyright 1987, 1988 by the Massachusetts Institute of Technology.   *  * For copying and distribution information, please see the file  *<mit-copyright.h>.   *  * spm		Project Athena  8/85   *  * This file defines data structures for the kerberos  * authentication/authorization database.   *  * They MUST correspond to those defined in *.rel   */
end_comment
