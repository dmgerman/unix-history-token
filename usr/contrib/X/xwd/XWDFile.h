...
begin_comment
comment|/* $Header: XWDFile.h,v 10.3 86/02/01 16:07:50 tony Rel $ */
end_comment

begin_comment
comment|/*  * XWDFile.h	MIT Project Athena, X Window system window raster  *		image dumper, dump file format header file.  *  *  Author:	Tony Della Fera, DEC  *		27-Jun-85  */
end_comment
...
name|padding
decl_stmt|;
comment|/* Long word alignment padding. */
block|}
name|XWDFileHeader
typedef|;
end_typedef
