...
name|rcsid_Lower_c
init|=
literal|"$Header: Lower.c,v 10.3 86/02/01 16:23:04 tony Rel $"
decl_stmt|;
end_decl_stmt
...
block|{
comment|/*      * If the window is not the root window, lower the window and return.      */
if|if
condition|(
name|window
operator|!=
