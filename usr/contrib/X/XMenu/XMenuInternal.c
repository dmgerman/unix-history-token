...
begin_comment
comment|/* $Header: XMenuInternal.c,v 10.17 86/02/01 16:15:10 tony Rel $ */
end_comment
...
comment|/*      * Translate the menu origin such that the cursor hot point will be in the      * center of the desired current selection and pane.      */
comment|/*      * First translate to the upper left of the current selection window.      */
name|l_orig_x
operator|=
name|x_pos
operator|-
