...
begin_comment
comment|/*	@(#)defs.dist	2.49	3/19/86 */
end_comment
...
begin_comment
comment|/* #define SPOOLNEWS		/* Spool incoming news, don't process	*/
end_comment
...
begin_comment
comment|/* #define UUNAME		/* If your nodename is in /etc/uucpname */
end_comment
...
begin_comment
comment|/* #define BSD4_1C		/* If you are running 4.1C BSD		*/
end_comment
...
directive|define
name|SYSPATH
value|"PATH=/local/bin:/bin:/usr/bin"
end_define
