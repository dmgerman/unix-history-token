...
index|[]
init|=
literal|"$Header: /usr/wft/RCS/SRC/RCS/rlog.c,v 3.7 83/05/11 14:24:13 wft Exp $ Purdue CS"
decl_stmt|;
end_decl_stmt
...
name|end
label|:
comment|/* 	    printf("startdate: %s; enddate: %s;\n", nextdate->strtdate,nextdate->enddate); */
if|if
condition|(
name|c
operator|==
