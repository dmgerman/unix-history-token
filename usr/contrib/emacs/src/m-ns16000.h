...
begin_comment
comment|/* 16000 is little-endian (lowest-numbered byte is least significant) */
end_comment
...
begin_comment
comment|/* Say this machine is a 16000 */
end_comment
