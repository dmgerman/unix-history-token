...
begin_comment
comment|/* pyramid preprocessor defines "pyr", however the following is clearer */
end_comment
...
begin_comment
comment|/* Don't use the union types any more.  They were used until Emacs 17.45.  */
end_comment
