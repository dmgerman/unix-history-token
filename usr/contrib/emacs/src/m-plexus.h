...
begin_comment
comment|/* Plexus predefines m68 instead of m68000. */
end_comment
...
begin_comment
comment|/* Use the PW library, which contains alloca.  */
end_comment
