...
directive|define
name|NORMSAVER
value|"%X/norm.saver %P/rrn%a.%$ %P %c %a %B %C \"%b\""
end_define
...
directive|define
name|MBOXSAVER
value|"%X/mbox.saver %P/rrn%a.%$ %P %c %a %B %C \"%b\" \"From %T %`date`\""
end_define
...
directive|define
name|MBOXSAVER
value|"%X/mbox.saver %P/rrn%a.%$ %P %c %a %B %C \"%b\" \"From %T %(%[date]=^\\(\\w*\\), \\(\\w*\\)-\\(\\w*\\)-\\(\\w*\\) \\([^ ]*\\)?%1 %3 %(%2=..?%2: %2) %5 19%4)\""
end_define
...
directive|define
name|MBOXSAVER
value|"%X/mbox.saver %P/rrn%a.%$ %P %c %a %B %C \"%b\" \"From %T %[posted]\""
end_define
