...
name|alarmed
decl_stmt|;
comment|/* If waitfor had to wait. */
name|c
operator|=
name|waitchar
argument_list|()
...
literal|0
return|;
comment|/* 	 * Otherwise, we indent to the first argument of 	 * the current s-expression.  This is done by 	 * starting at the matching paren, skipping 	 * to a word (atom), skipping over it, and 	 * skipping to the next one. 	 * 	 * We want to end up 	 * 	 *	(atom atom atom ... 	 *	      ^ here. 	 */
name|DOTsave
argument_list|(
operator|&
name|savedot
