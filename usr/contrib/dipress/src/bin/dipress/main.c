...
begin_comment
comment|/******************************************************************************  *  *	main	--	main routine for dipress   *			(ditroff to interpress conversion)  *  *	John Mellor-Crummey (Xerox Corp)  *  *	Copyright 1985 Xerox Corporation  *  *****************************************************************************/
end_comment
...
literal|'F'
case|:
comment|/* reset default font directory  			 * accept either form '-f<dir>' or '-f<dir>' 			 */
if|if
condition|(
operator|*
operator|(
...
name|CONTINUE
argument_list|,
literal|"option -%c not recognized\n"
argument_list|,
operator|(
name|char
operator|*
