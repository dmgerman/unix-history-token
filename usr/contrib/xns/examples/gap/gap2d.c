...
index|[]
init|=
literal|"$Header: gap2d.c,v 2.0 85/11/21 07:23:00 jqj Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  * server for GAP-style (TransportObject=server,teletype) telnet connections  * Note that we support only GAP version 2, although a server for version 3  * exists.  The version 2 server has not been tested as thoroughly as has the  * version 3; it does NOT support RESERVE functionality.  */
end_comment

begin_comment
comment|/* $Log:	gap2d.c,v $  * Revision 2.0  85/11/21  07:23:00  jqj  * 4.3BSD standard release  *   * Revision 1.2  85/05/23  06:22:18  jqj  * *** empty log message ***  *   * Revision 1.2  85/05/23  06:22:18  jqj  * *** empty log message ***  *   * Revision 1.1  85/05/22  09:46:52  jqj  * Initial revision  */
end_comment
...
block|{
case|case
name|GAP2_terminalAddressInvalid
case|:
case|case
name|GAP2_terminalAddressInUse
case|:
case|case
name|GAP2_controllerDoesNotExist
case|:
case|case
name|GAP2_controllerAlreadyExists
case|:
case|case
name|GAP2_gapCommunicationError
case|:
case|case
name|GAP2_gapNotExported
case|:
case|case
name|GAP2_bugInGAPCode
case|:
case|case
name|GAP2_tooManyGateStreams
case|:
case|case
name|GAP2_inconsistentParams
case|:
case|case
name|GAP2_transmissionMediumUnavailable
case|:
case|case
name|GAP2_dialingHardwareProblem
case|:
case|case
name|GAP2_noDialingHardware
case|:
case|case
name|GAP2_badAddressFormat
case|:
case|case
name|GAP2_mediumConnectFailed
case|:
case|case
name|GAP2_illegalTransport
case|:
case|case
name|GAP2_noCommunicationHardware
case|:
case|case
name|GAP2_unimplemented
case|:
name|_buf
operator|=
name|Allocate
...
begin_decl_stmt
name|GAP2_SessionParameterObject
name|sessionparams
decl_stmt|;
end_decl_stmt
...
condition|)
block|{
comment|/* first 2 times through send warning */
if|if
condition|(
name|nfrontp
operator|==
