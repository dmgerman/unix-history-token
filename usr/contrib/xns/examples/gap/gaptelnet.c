...
name|rcsid
init|=
literal|"$Header: gaptelnet.c,v 2.0 85/11/21 07:23:04 jqj Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* $Log:	gaptelnet.c,v $  * Revision 2.0  85/11/21  07:23:04  jqj  * 4.3BSD standard release  *   * Revision 1.3  85/11/20  14:00:08  jqj  * added symbolic entries for Gap connection types  *   * Revision 1.2  85/05/22  09:46:37  jqj  * VAX 4.3beta baseline version  *   * Revision 1.2  85/05/22  09:46:37  jqj  * Beta-test GAP telnet  *   * based on tcp/telnet:  *	static char *rcsid = "$Header: gaptelnet.c,v 2.0 85/11/21 07:23:04 jqj Exp $";  *	static char sccsid[] = "@(#)telnet.c	4.24 (Berkeley) 7/20/83";  */
end_comment
...
literal|20
expr_stmt|;
comment|/* 	tobjs[0].designator = rs232c; 	cp =&tobjs[0].rs232c_case.commParams; 	cp->accessDetail.designator = directConn; 	cp->accessDetail.directConn_case.duplex = fullduplex; 	cp->accessDetail.directConn_case.lineType = asynchronous; 	cp->accessDetail.directConn_case.lineSpeed = bps300; 	tobjs[0].rs232c_case.preemptOthers = preemptInactive; 	tobjs[0].rs232c_case.preemptMe = preemptInactive; 	tobjs[0].rs232c_case.phoneNumber = ""; 	tobjs[0].rs232c_case.line.designator = reserveNeeded; 	tobjs[0].rs232c_case.line.reserveNeeded_case.lineNumber = 1; */
name|tobjs
index|[
literal|0
index|]
