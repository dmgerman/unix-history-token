...
index|[]
init|=
literal|"$Header: cmds.c,v 2.0 85/11/21 07:22:41 jqj Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* $Log:	cmds.c,v $  * Revision 2.0  85/11/21  07:22:41  jqj  * 4.3BSD standard release  *   * Revision 1.2  85/10/30  08:06:37  root  * if prompt=off but verbose=on, print the name of each file during  * multiplefile transfers.  *   * Revision 1.1  85/05/27  06:30:51  jqj  * Initial revision  *   * based on Berkeley tcp/ftp  */
end_comment
...
block|}
block|,
comment|/*	{ "ebcdic",	"E",	TYPE_E,	0 }, */
comment|/*	{ "tenex",	"L",	TYPE_L,	bytename }, */
literal|0
block|}
struct|;
end_struct
