...
begin_comment
comment|/*  * Copyright (c) 1986 MICOM-Interlan, Inc., Boxborough Mass  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)np.c	7.1 (Berkeley) 6/5/86  */
end_comment
...
begin_comment
comment|/*  * npstratagey - the strategy routine  */
end_comment
...
literal|0
expr_stmt|;
comment|/* WN Pseudo-Driver */
name|IsInitFlag
operator|=
literal|0
expr_stmt|;
comment|/* IS Pseudo-Driver */
if|if
condition|(
name|IxReset
condition|)
