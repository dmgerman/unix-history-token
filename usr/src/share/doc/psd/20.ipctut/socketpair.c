...
operator|.
operator|\
literal|" Copyright (c) 1986, 1993 .\"	The Regents of the University of California.  All rights reserved. .\" .\" %sccs.include.redist.roff% .\" .\"	@(#)socketpair.c	8.1 (Berkeley) %G% .\" #include<sys/types.h> #include<sys/socket.h> #include<stdio.h>  #define DATA1 "
name|In
name|Xanadu
operator|,
name|did
