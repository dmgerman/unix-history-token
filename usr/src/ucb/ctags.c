...
index|[]
init|=
literal|"@(#)ctags.c	5.1 (Berkeley) 5/31/85"
decl_stmt|;
end_decl_stmt
...
name|printf
argument_list|(
literal|"Usage: ctags [-BFatuwvx] [-f tagsfile] file ...\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* .l implies lisp or lex source code */
if|if
condition|(
name|cp
operator|&&
...
block|{
comment|/* lex */
comment|/* 			 * throw away all the code before the second "%%" 			 */
name|toss_yysec
argument_list|()
expr_stmt|;
name|getline
...
begin_comment
comment|/*  * first_char:  *	Return the first non-blank character in the file.  After  *	finding it, rewind the input file so we start at the beginning  *	again.  */
end_comment
