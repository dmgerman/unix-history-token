...
name|rcsid
init|=
literal|"$Header: sysat.c,v 1.15 83/09/04 10:17:54 jkf Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*					-[Sun Sep  4 08:56:49 1983 by jkf]-  * 	sysat.c				$Locker:  $  * startup data structure creation  *  * (c) copyright 1982, Regents of the University of California  */
end_comment
