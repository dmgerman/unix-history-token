...
name|rcsid
init|=
literal|"$Header: error.c,v 1.5 83/09/12 14:17:50 sklower Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*					-[Sun Sep  4 09:06:21 1983 by jkf]-  * 	error.c				$Locker:  $  * error handler  *  * (c) copyright 1982, Regents of the University of California  */
end_comment
...
comment|/* NOTREACHED */
block|}
comment|/* 		     * Will return to errset 		     * print message if flag on this frame is non nil 		     */
if|if
condition|(
name|curp
operator|->
...
name|error
argument_list|(
literal|"Ran out of alternate stack"
argument_list|,
name|FALSE
argument_list|)
expr_stmt|;
