...
name|rcsid
init|=
literal|"$Header: /na/franz/franz/RCS/alloc.c,v 1.8 83/08/06 08:38:19 jkf Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*					-[Fri Aug  5 12:44:01 1983 by jkf]-  * 	alloc.c				$Locker:  $  * storage allocator and garbage collector  *  * (c) copyright 1982, Regents of the University of California  */
end_comment
