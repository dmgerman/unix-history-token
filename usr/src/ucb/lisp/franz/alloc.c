...
name|rcsid
init|=
literal|"$Header: /na/franz/franz/RCS/alloc.c,v 1.3 83/03/03 12:11:25 jkf Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*					-[Thu Mar  3 11:49:20 1983 by jkf]-  * 	alloc.c				$Locker:  $  * storage allocator and garbage collector  *  * (c) copyright 1982, Regents of the University of California  */
end_comment
...
begin_comment
comment|/* # define setbit(p)	{bitmap[(int)p>>5] |= bitmsk[((int)p>> 2)& 7];} */
end_comment
...
argument_list|)
expr_stmt|;
comment|/*share print name of atoms on oblist*/
name|aptr
operator|->
name|a
operator|.
