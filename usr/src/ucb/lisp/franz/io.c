...
name|rcsid
init|=
literal|"$Header: /na/franz/franz/RCS/io.c,v 1.8 83/08/06 08:38:42 jkf Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*					-[Fri Aug  5 12:45:22 1983 by jkf]-  * 	io.c				$Locker:  $  * input output functions  *  * (c) copyright 1982, Regents of the University of California  */
end_comment
