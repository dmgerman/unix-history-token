...
name|rcsid
init|=
literal|"$Header: /na/franz/franz/RCS/lam8.c,v 1.3 83/02/19 14:58:57 layer Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*					-[Sat Jan 29 13:06:31 1983 by jkf]-  * 	lam8.c				$Locker:  $  * lambda functions  *  * (c) copyright 1982, Regents of the University of California  */
end_comment
...
begin_comment
comment|/*  * int:vref  vector[i] index class  *  class = 0: byte immed, 1: word immed, 2: long immed, 3: long  */
end_comment
