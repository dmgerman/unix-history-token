...
name|rcsid
init|=
literal|"$Header: /na/franz/franz/RCS/fex1.c,v 1.1 83/01/29 12:48:54 jkf Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*					-[Sat Jan 29 12:34:57 1983 by jkf]-  * 	fex1.c				$Locker:  $  * nlambda functions  *  * (c) copyright 1982, Regents of the University of California  */
end_comment
