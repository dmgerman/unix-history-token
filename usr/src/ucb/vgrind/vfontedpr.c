...
index|[]
init|=
literal|"@(#)vfontedpr.c	4.1	(Berkeley)	10/21/82"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* regular expression routines */
end_comment
...
begin_comment
comment|/* match a string to an expression */
end_comment
...
begin_comment
comment|/* a different kindof strncmp */
end_comment
...
begin_comment
comment|/*  *  global variables also used by expmatch  */
end_comment
