...
index|[]
init|=
literal|"@(#)snake.c	5.1 (Berkeley) 5/30/85"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* 	 * If CHECKBUSY is defined, the file BUSY must be executable 	 * and must return a value which is used to determine the priority 	 * a which snake runs.  A zero value means no nice. 	 * If BUSY does not exist, snake won't play. 	 */
end_comment
...
name|printf
argument_list|(
literal|"Screen too small for a fair game\n"
argument_list|)
expr_stmt|;
name|done
argument_list|()
...
name|printf
argument_list|(
literal|"Sorry, no snake just now.\n"
argument_list|)
expr_stmt|;
name|done
argument_list|()
...
name|printf
argument_list|(
literal|"Sorry, the system is too heavily loaded right now.\n"
argument_list|)
expr_stmt|;
name|done
argument_list|()
