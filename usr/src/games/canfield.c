...
begin_comment
comment|/*  * The canfield program  *  * Authors:  *	Originally written: Steve Levine  *	Converted to use curses and debugged: Steve Feldman  *	Card counting: Kirk McKusick and Mikey Olson  *  * To compile:  *	cc -O -o canfield canfield.c -lcurses -ltermcap -ltermlib  */
end_comment
