...
begin_comment
comment|/*-  * Copyright (c) 1986 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Ken Arnold.  *  * %sccs.include.redist.c%  */
end_comment
...
index|[]
init|=
literal|"@(#)fortune.c	5.13 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
