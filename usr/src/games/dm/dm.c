...
begin_comment
comment|/*  * read_days --  *	read through days listed in the control file, decide  *	if current time is an okay play time.  */
end_comment
...
begin_comment
unit|} 	} }
comment|/*  * read_ttys --  *	read through ttys listed in the control file, decide if this  *	tty can be used for games.  */
end_comment
...
begin_comment
comment|/*  * read_games --  *	read through games listed in the control file, decide if this  *	game can be played now.  */
end_comment
