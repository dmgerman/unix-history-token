...
argument_list|)
expr_stmt|;
comment|/* the larn scoreboard filename */
name|strcat
argument_list|(
name|logfile
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* larn activity logging filename */
name|strcat
argument_list|(
name|helpfile
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* the larn on-line help file */
name|strcat
argument_list|(
name|larnlevels
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* the pre-made cave level data file */
name|strcat
argument_list|(
name|fortfile
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* the fortune data file name */
name|strcat
argument_list|(
name|playerids
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* the playerid data file name */
name|strcat
argument_list|(
name|holifile
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* the holiday data file name */
...
directive|ifdef
name|TIMECHECK
comment|/*  *	this section of code checks to see if larn is allowed during working hours  */
if|if
condition|(
name|dayplay
operator|==
literal|0
condition|)
comment|/* check for not-during-daytime-hours */
if|if
condition|(
name|playable
argument_list|()
...
literal|2
argument_list|,
literal|"Sorry, Larn can not be played during working hours.\n"
argument_list|,
literal|52
argument_list|)
expr_stmt|;
...
begin_comment
comment|/*  *	routine to check the time of day and return 1 if its during work hours  *	checks the file ".holidays" for forms like "mmm dd comment..."  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* format: Fri Jul  4 00:27:56 EDT 1986 */
name|year
operator|=
name|atoi
argument_list|(
...
literal|0
expr_stmt|;
comment|/* point to and NULL terminate month */
if|if
condition|(
operator|(
operator|(
...
literal|0
condition|)
comment|/* not a Sunday */
block|{
comment|/* now check for a .holidays datafile */
name|lflush
argument_list|()
expr_stmt|;
if|if
