...
begin_comment
comment|/*	telnetd.c	4.2	82/03/01	*/
end_comment
...
begin_comment
comment|/*  * Debugging hooks.  Turned on with a SIGTERM.  * Successive SIGTERM's toggle the switch.  */
end_comment
...
name|log
argument_list|,
literal|"select: ibits=%d, obits=%d\n"
argument_list|,
name|ibits
argument_list|,
name|obits
...
name|log
argument_list|,
literal|"log started on /dev/pty%c\n"
argument_list|,
name|logfile
index|[
name|strlen
