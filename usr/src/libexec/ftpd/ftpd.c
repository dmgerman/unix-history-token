...
index|[]
init|=
literal|"@(#)ftpd.c	4.1 (Berkeley) 83/01/13"
decl_stmt|;
end_decl_stmt
...
name|MODE_S
condition|)
comment|/* indicate EOF by closing connection */
name|fclose
argument_list|(
name|dout
argument_list|)
...
name|stderr
argument_list|,
literal|"FTP %d: connection from %s at %s"
argument_list|,
name|getpid
argument_list|()
argument_list|,
