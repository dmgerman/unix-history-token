...
begin_comment
comment|/*-  * Copyright (c) 1988, 1989, 1992 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  */
end_comment
...
index|[]
init|=
literal|"@(#) Copyright (c) 1988, 1989, 1992 The Regents of the University of California.\n\  All rights reserved.\n"
decl_stmt|;
end_decl_stmt
