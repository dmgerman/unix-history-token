...
name|printf
argument_list|(
literal|"cg[%d].cg_nifree is %d not %d\n"
argument_list|,
name|c
argument_list|,
name|cgrp
...
name|SBLOCK
expr_stmt|;
comment|/* super-block and boot block */
name|n_bad
operator|=
operator|-
name|SBLOCK
expr_stmt|;
comment|/* ... which appear (inaccurately) bad */
for|for
control|(
name|c
operator|=
...
name|pwarn
argument_list|(
literal|"SUMMARY INFORMATION %s%sBAD\n"
argument_list|,
name|inosumbad
condition|?
literal|"(INODE FREE) "
...
name|errexit
argument_list|(
literal|"internal error: inode state %d in makecg()\n"
argument_list|,
name|getstate
argument_list|()
argument_list|)
