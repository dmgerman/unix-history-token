...
name|printf
argument_list|(
literal|"%s: block size restricts cylinders per group to %d\n"
argument_list|,
literal|"Warning"
argument_list|,
name|sblock
...
expr_stmt|;
block|}
comment|/* 	 * Compute number of inode blocks per cylinder group. 	 * Start with one inode per density bytes; adjust as necessary. 	 */
name|i
operator|=
name|sblock
operator|.
