...
begin_comment
comment|/*-  * Copyright (c) 1980, 1988, 1991 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  */
end_comment
...
index|[]
init|=
literal|"@(#)traverse.c	5.11 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
name|msg
argument_list|(
literal|"read error from %s [block %d]: count=%d, got=%d, errno=%d (%s)\n"
argument_list|,
name|disk
argument_list|,
name|blkno
