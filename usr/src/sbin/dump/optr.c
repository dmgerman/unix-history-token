...
index|[]
init|=
literal|"@(#)optr.c	5.11 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  * We have three of these.  Yes, this is horribly ugly, but at least  * we only have to go through it once.  */
end_comment
...
name|func
parameter_list|)
value|void func(const char *fmt, ...)
end_define
...
name|func
parameter_list|)
value|void func(va_alist) va_dcl
end_define
...
directive|define
name|MSG_START
value|va_start(ap); fmt = va_arg(ap, char *)
end_define
