...
begin_comment
comment|/*  * Copyright (c) 1983, 1989, 1991 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  */
end_comment
...
index|[]
init|=
literal|"@(#) Copyright (c) 1983, 1989, 1991 The Regents of the University of California.\n\  All rights reserved.\n"
decl_stmt|;
end_decl_stmt
...
index|[]
init|=
literal|"@(#)route.c	5.40 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
directive|define
name|RTA_IGN
value|(RTA_DST|RTA_GATEWAY|RTA_NETMASK|RTA_IFP|RTA_IFA)
if|if
condition|(
name|verbose
condition|)
