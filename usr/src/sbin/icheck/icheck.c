...
name|sccsid
init|=
literal|"@(#)icheck.c	2.4 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*	tables.c	4.1	82/03/25	*/
end_comment

begin_comment
comment|/* merged into kernel:	tables.c 2.1 3/25/82 */
end_comment

begin_comment
comment|/* last monet version:	partab.c	4.2	81/03/08	*/
end_comment
