...
begin_comment
comment|/*  *	Extract directory contents, building up a directory structure  *	on disk for extraction by name.  *	If modefile is requested, save mode, owner, and times for all  *	directories on the tape.  */
end_comment
