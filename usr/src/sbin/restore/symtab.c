...
index|[]
init|=
literal|"@(#)symtab.c	3.1	(Berkeley)	83/02/18"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  * change the number associated with an entry  */
end_comment
...
name|ep
argument_list|,
literal|"renumber to active inum"
argument_list|)
expr_stmt|;
name|np
operator|=
...
begin_comment
comment|/*  * allocate space for a name  */
end_comment
