...
argument_list|()
expr_stmt|;
comment|/* determine if the super user is running this program */
name|superuser
operator|=
operator|!
name|getuid
...
name|stderr
argument_list|,
literal|"tar: usage: tar -{txru}[cvfblmhopwBFMi] [tapefile] [blocksize] file1 file2...\n"
argument_list|)
expr_stmt|;
name|done
argument_list|(
...
condition|)
block|{
comment|/* 				 * Error on read, probably an EOF, 				 * ask the user about it. 				 */
name|fd
operator|=
name|chgreel
argument_list|(
...
name|stderr
argument_list|,
literal|"tar: If you want to go on, type \"yes\" or a new pathname of a device/file name when you are ready\n"
argument_list|)
expr_stmt|;
if|if
condition|(
