...
index|[]
init|=
literal|"@(#)$Header: tar.c,v 1.4 84/11/14 00:08:15 root Exp $"
decl_stmt|;
end_decl_stmt
...
directive|else
comment|/* 	 *  The following is for 4.2BSD and related systems to force 	 *  the buffer to be page aligned.  The kernel will avoid 	 *  bcopy()'s on disk IO this way by manipulating the page tables. 	 */
block|{
name|int
name|pagesize
init|=
