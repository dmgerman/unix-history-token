...
index|[]
init|=
literal|"@(#)local2.c	1.23 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
condition|)
block|{
comment|/* let the code table handle two cases */
if|if
condition|(
name|p
operator|->
...
name|GT
case|:
comment|/* 		 * Optimize comparisons against constants which are 		 * out of the range of a variable's precision. 		 * This saves some labor out in the code table 		 * handling ridiculous comparisons... 		 */
name|r
operator|=
name|p
operator|->
...
name|cerror
argument_list|(
literal|"unsupported OPLOG in optim2"
argument_list|)
expr_stmt|;
block|}
name|result
