...
begin_block
block|{
comment|/* 	 * output code to initialize space of size sz to the value d 	 * the proper alignment has been obtained 	 * inoff is updated to have the proper final value 	 * this code should be the same for PDP, VAX and Tahoe 	 * SFCON makes use of value to determine type - only where 	 * float<->double conversions are ignored. 	 */
specifier|register
struct|struct
name|sh4
block|{
