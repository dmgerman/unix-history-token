...
control|)
continue|continue;
comment|/* 		 *	save string and trailing null 		 */
operator|(
operator|*
name|hp
operator|)
...
comment|/*  *	save a string str, length len in the string pool.  *	string known just by its length; can have or not have trailing nulls.  *  *	The length of the string occurs as a short just before  *	the character pointer returned.  */
name|char
modifier|*
name|savestr
parameter_list|(
...
comment|/* 		 *	the length of the symbol table string 		 *	always includes the trailing null 		 */
if|if
condition|(
name|sp
operator|->
