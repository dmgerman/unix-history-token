...
begin_comment
comment|/*  *	The following two tables are indexed by  *		{LEN1,LEN2,LEN4,LEN8} | {PCREL,0}  *	Note that PCREL = 1  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* 	 *	WATCH OUT.  THIS DEPENDS THAT THE ALLOCATION OF 	 *	the four fields ptype, other, desc and value are 	 *	contiguous, which is compiler dependent. 	 */
name|bwrite
argument_list|(
operator|(
name|char
