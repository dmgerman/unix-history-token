...
directive|ifdef
name|VMS
comment|/* 	 *	rrh did not check this code when the new floating point 	 *	numbers were put into the assembler, as he didn't 	 *	have access to a vms system. 	 */
name|nints
operator|=
name|ty_nbyte
index|[
