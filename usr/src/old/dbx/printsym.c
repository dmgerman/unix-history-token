...
index|[]
init|=
literal|"$Header: printsym.c,v 1.3 84/03/27 10:23:14 linton Exp $"
decl_stmt|;
end_decl_stmt
...
expr_stmt|;
block|}
comment|/*  * Not today.     t = rtype(s->type);     if (t->class == ARRAY and not istypename(t->type, "char")) { 	printf("ARRAY");     } else {  */
if|if
condition|(
name|isvarparam
argument_list|(
...
expr_stmt|;
block|}
comment|/*  * Matches brace commented out above.    }  */
block|}
end_function
