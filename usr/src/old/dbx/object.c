...
argument_list|)
expr_stmt|;
comment|/* some letters indicate a dynamic bound, ie what follows                    is the offset from the fp which contains the bound; this will                    need a different encoding when pc a['A'..'Z'] is                    added; J is a special flag to handle fortran a(*) bounds                 */
switch|switch
condition|(
operator|*
name|curchar
