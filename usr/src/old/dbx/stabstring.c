...
index|[]
init|=
literal|"@(#)stabstring.c	1.1 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt

begin_comment
comment|/* from 1.4 84/03/27 10:24:04 linton Exp */
end_comment
...
begin_comment
comment|/*  * Setup a symbol entry for a public procedure or function.  */
end_comment
