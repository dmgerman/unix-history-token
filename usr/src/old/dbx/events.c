...
begin_comment
comment|/* id number of next allocated event */
end_comment
...
begin_comment
comment|/* id number of next allocated trace */
end_comment
...
condition|)
block|{
comment|/* 	 * Must create new temporary event for traceoff action; 	 * otherwise traceoff will take place but the breakpoint 	 * won't be deleted.  This results in a panic the next 	 * time we enter the region where tracing takes place since 	 * the associate trace id (of the traceoff command) no 	 * longer exists. 	 */
name|event_once
argument_list|(
name|build
argument_list|(
