...
directive|define
name|unix_lang_name
value|"VAX/UNIX Assembler V6/30/83 4.13"
end_define
...
begin_comment
comment|/*current source file (for listing) */
end_comment
...
begin_comment
comment|/*layout position in listfile */
end_comment
...
begin_comment
comment|/*innames in-index: 0..minfiles */
end_comment
