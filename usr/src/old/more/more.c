...
name|sccsid
init|=
literal|"@(#)more.c	4.19 (Berkeley) 84/07/11"
decl_stmt|;
end_decl_stmt
...
literal|0
decl_stmt|;
comment|/* current terminal UL state (off) */
while|while
condition|(
operator|--
name|n
...
condition|)
block|{
comment|/* 	 * Wait until we're in the foreground before we get the 	 * save the terminal modes. 	 */
if|if
condition|(
name|ioctl
argument_list|(
