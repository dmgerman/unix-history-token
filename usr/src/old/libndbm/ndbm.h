...
begin_comment
comment|/*-  * Copyright (c) 1983 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.proprietary.c%  *  *	@(#)ndbm.h	5.2 (Berkeley) %G%  */
end_comment

begin_comment
comment|/*  * Derived from:  *  *	@(#)ndbm.h	5.3 (Berkeley) 5/29/90  */
end_comment
