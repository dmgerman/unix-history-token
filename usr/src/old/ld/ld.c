...
begin_comment
comment|/*  * VAX VM/UNIX ld - string table version  */
end_comment
...
literal|1
argument_list|,
literal|"warning: archive has no table of contents"
argument_list|)
expr_stmt|;
name|nloc
operator|=
...
literal|1
argument_list|,
literal|"warning: table of contents is out of date"
argument_list|)
expr_stmt|;
name|nloc
operator|=
...
name|locfilname
init|=
literal|"/usr/local/new/libxxxxxxxxxxxxxxx"
decl_stmt|;
if|if
condition|(
name|cp
...
name|filname
operator|=
literal|"/usr/new/libxxxxxxxxxxxxxxx"
expr_stmt|;
for|for
control|(
name|c
