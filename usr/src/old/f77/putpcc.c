...
expr_stmt|;
break|break;
comment|/* for possible future use -- register based arrays 	case STGPREG: 		if(indir&& !offp) 			p2oreg(offset, p->memno, type2); 		else 			{ 			p2reg(p->memno, type2 | P2PTR); 			goto based; 			} 		break; */
default|default:
name|badstg
argument_list|(
literal|"putaddr"
