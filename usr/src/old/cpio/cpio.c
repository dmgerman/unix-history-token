...
name|argv
argument_list|,
literal|"aBC:ifopcdlmrSsbtuvVM:6eI:O:"
argument_list|)
operator|)
operator|!=
name|EOF
...
literal|'V'
case|:
comment|/* print a dot '.' for each file */
name|Verbose
operator|=
literal|2
expr_stmt|;
...
name|EERROR
argument_list|,
literal|"Options must include one: -o, -i, -p."
argument_list|)
expr_stmt|;
block|}
if|if
...
name|stderr
argument_list|,
literal|"cpio: cannot create directory for<%s>: %s\n"
argument_list|,
name|Fullname
argument_list|,
name|sys_errlist
...
name|stderr
argument_list|,
literal|"cpio: cannot unlink<%s>: %s\n"
argument_list|,
name|Fullname
argument_list|,
name|sys_errlist
...
name|stderr
argument_list|,
literal|"Cpio: cannot link<%s> to<%s>: %s\n"
argument_list|,
name|Hdr
operator|.
name|h_name
...
literal|"%s\n\t%s %s\n\t%s %s\n\t%s %s\n\t%s %s\n"
argument_list|,
literal|"-o[acvB]<name-list>collection"
argument_list|,
name|Err
operator|.
name|source
argument_list|,
literal|"-o[acvB] -Ocollection<name-list"
argument_list|,
name|Err
operator|.
name|source
argument_list|,
literal|"-i[cdmrstuvfB6] [pattern ...]<collection"
argument_list|,
name|Err
operator|.
name|source
argument_list|,
literal|"-i[cdmrstuvfB6] -Icollection [pattern ...]"
argument_list|,
name|Err
operator|.
name|source
argument_list|,
literal|"-p[adlmruv] directory<name-list"
argument_list|)
block|; }
specifier|static
name|chkswfile
...
name|EHALT
argument_list|,
literal|"Impossible return from read(), %d\n"
argument_list|,
name|rv
argument_list|)
expr_stmt|;
...
name|EERROR
argument_list|,
literal|"Write() in bwrite() failed\n"
argument_list|)
expr_stmt|;
elseif|else
if|if
...
name|fperr
argument_list|(
literal|"Unable to write this medium.  Try again.\n"
argument_list|)
expr_stmt|;
name|reelcount
operator|--
...
condition|)
block|{
comment|/* pid == 0 implies child process */
name|close
argument_list|(
literal|2
argument_list|)
...
condition|)
block|{
comment|/* pid != 0 implies parent process */
name|fprintf
argument_list|(
name|stderr
argument_list|,
...
name|fperr
argument_list|(
literal|"That didn't work, cannot open \"%s\"\n"
argument_list|,
name|str
argument_list|)
expr_stmt|;
...
begin_comment
comment|/* 	In -V verbose mode, print out a dot for each file processed. */
end_comment
...
condition|)
block|{
comment|/* start a new line of dots */
name|verbcount
operator|=
literal|0
expr_stmt|;
