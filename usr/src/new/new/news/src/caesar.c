...
begin_comment
comment|/* program to to decrypt caesar(tm) cypher */
end_comment

begin_comment
comment|/* (caesar is a trademark of the roman empire) /* /* to compile: /* /*	cc decrypt.c -lm -o decrypt.c /* /* usage: /* /*	decrypt [n]< file /* /* where n is an optional forced rotation. /* /* */
end_comment

begin_comment
comment|/* authors: Stan King, John Eldridge, based on algorithm suggested by /*		Bob Morris /* 29-Sep-82 /* Changed 30-Sep-82 to do each line separately. /* */
end_comment
