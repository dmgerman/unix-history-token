...
begin_comment
comment|/*  * getwd() returns the pathname of the current working directory. On error  * an error message is copied to pathname and null pointer is returned.  *  * A version of this function was copied to the standard C library. It is  * only included here for compatibility with non-BSD UNIX systems.  */
end_comment
