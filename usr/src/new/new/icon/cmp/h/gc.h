...
begin_comment
comment|/* beginning of global variables */
end_comment
...
begin_comment
comment|/* beginning of global variable names */
end_comment
...
begin_comment
comment|/* beginning of static variables */
end_comment
...
begin_comment
comment|/*  * getsize(x) takes the block pointed to by x and if the size of  *  the block as indicated by bsizes[] is non-zero it returns the  *  indicated size, otherwise it returns the second word in the  *  block which should be the size. --whm  */
end_comment
