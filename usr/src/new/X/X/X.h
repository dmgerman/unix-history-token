...
begin_comment
comment|/* $Header: X.h,v 10.18 86/11/25 14:54:58 jg Rel $ */
end_comment
...
begin_comment
comment|/* IBM ACIS Experimental Display */
end_comment
...
begin_comment
comment|/* IBM APA8 Color Display        */
end_comment
...
begin_comment
comment|/* IBM Print Quality Display     */
end_comment
...
begin_comment
comment|/* Data General address space 600-699 */
end_comment
...
begin_comment
comment|/* Data General DS4000 display  */
end_comment
...
begin_comment
comment|/* Data General DS4200 display  */
end_comment

begin_comment
comment|/* Apollo Computer address space 700-799 */
end_comment
...
begin_comment
comment|/* Hewlett Packard address space 800-899 */
end_comment

begin_define
define|#
directive|define
name|XDEV_HP9000S300
value|800
end_define

begin_comment
comment|/* Integrated Solutions address space 900-999 */
end_comment
...
begin_comment
comment|/* Optimum V 4 bit color */
end_comment

begin_comment
comment|/* Periphere Computer Systeme address space 1000-1099 */
end_comment
...
begin_comment
comment|/* Periphere base address */
end_comment
...
directive|define
name|UBPS
value|(sizeof(short)/2)
end_define

begin_comment
comment|/* useful bytes per short */
end_comment
...
name|height
parameter_list|)
value|(((((width) + 15)>> 3)&~ 1) * (height) * UBPS)
end_define
