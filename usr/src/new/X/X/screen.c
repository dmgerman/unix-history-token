...
begin_comment
comment|/*	Routines dealing with output:  *  *	Do_PixFill, Do_TileFill, Do_StippleFill, Do_PixmapPut,  *	Do_PixmapBitsPut, Do_BitmapBitsPut,  *	Do_CopyArea,  *	Do_Text, Do_TextMask,  *	Do_Line, Do_Draw, Do_DrawFilled,  *	Do_PixmapSave, Do_PixmapGet,  *	Do_background, Do_refill, Do_border  */
end_comment
...
name|rcsid_screen_c
init|=
literal|"$Header: screen.c,v 10.7 86/03/25 11:34:11 jg Rel $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* Do a StippleFill in a window */
end_comment
