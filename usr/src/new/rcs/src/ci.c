...
index|[]
init|=
literal|"$Header: /usr/src/local/bin/rcs/src/RCS/ci.c,v 4.6 87/12/18 11:34:41 narten Exp $ Purdue CS"
decl_stmt|;
end_decl_stmt
...
name|warn
argument_list|(
literal|"Missing date for -d option"
argument_list|)
expr_stmt|;
break|break;
case|case
