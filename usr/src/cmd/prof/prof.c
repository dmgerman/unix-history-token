...
begin_comment
comment|/* 	 * read in procedure call counters 	 */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* 		 *	write out the counters 		 */
for|for
control|(
name|np
operator|=
