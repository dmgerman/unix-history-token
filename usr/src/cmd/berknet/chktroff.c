...
name|chktroff_sid
init|=
literal|"@(#)chktroff.c	1.2"
decl_stmt|;
end_decl_stmt

begin_comment
comment|/* 	chktroff [-l] [-num] [file]  		-l	says list the code 		-num	num is octal offset into file 		file	if specified, read from file, otherwise stdin */
end_comment
...
name|printf
argument_list|(
literal|"Not typesetter format file. Sorry.\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
...
name|printf
argument_list|(
literal|"Only %3.0f feet maximum per request. Sorry.\n"
argument_list|,
name|FEET
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"Total bytes %ld, lead %d, feet %4.2f\n"
argument_list|,
name|bytetot
argument_list|,
name|leadtot
...
name|printf
argument_list|(
literal|"Error - wrong # init %d, # stop %d\n"
argument_list|,
name|init
argument_list|,
name|stop
