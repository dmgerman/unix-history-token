...
name|jobno
decl_stmt|;
comment|/* CC job no, 32767 if null */
name|char
name|dir
index|[
name|FNS
...
comment|/* sent but not computed (always 32767) across the net */
name|int
name|hd_ijobno
decl_stmt|;
...
begin_comment
comment|/*  	this structure defines the various parameters the daemon and testing    	programs use -- most of the info comes from netrc.c 	NOTE-- thi structure is initialized in netrc.c 	don't add members without changing that structure */
end_comment
