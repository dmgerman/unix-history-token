...
name|sccsid
init|=
literal|"@(#)w.c	4.1 (Berkeley) 10/1/80"
decl_stmt|;
end_decl_stmt
...
directive|ifdef
name|notdef
comment|/* 		 * The following speeds up w on systems with lots of ttys 		 * by ignoring inits and gettys, but loses on root login shells. 		 * On Ernie it reduced user and system time by .3 seconds, 		 * an insignificant amount.  It is commented out since it 		 * will lose when root logs in. 		 */
if|if
condition|(
name|mproc
operator|.
