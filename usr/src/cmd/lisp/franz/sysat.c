...
argument_list|)
expr_stmt|;
comment|/* 	MK("pipe",Lpipe,lambda); 	MK("fdopen",Lfdopen,lambda); */
name|MK
argument_list|(
literal|"exece"
argument_list|,
