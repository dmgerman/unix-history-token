...
name|Vermisc
argument_list|,
literal|"Fell of the end of a bignum"
argument_list|,
name|nil
argument_list|,
name|FALSE
...
begin_comment
comment|/*  * (print 'expression ['port]) prints the given expression to the given  * port or poport if no port is given.  The amount of structure  * printed is a function of global lisp variables prinlevel and  * prinlength.  */
end_comment
...
begin_comment
comment|/* patom does not use prinlevel or prinlength   *  * form is (patom 'value ['port])  */
end_comment
