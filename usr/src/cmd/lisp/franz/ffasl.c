...
name|struct
name|VMS_string_descriptor
name|noverify_command
init|=
block|{
literal|17
block|,
literal|"$ V='F$VERIFY(0)'"
block|}
decl_stmt|;
specifier|static
name|struct
...
literal|"$ link/exe=%s/nom/syst=%%X%x/sym=tmp:sym%d.new %s,%s.stb%s"
argument_list|,
name|objfil
argument_list|,
name|currend
...
literal|"$ link/exe=%s/nomap/system=%%X%x/symbol_table=tmp:sym%d.new %s,%s.stb%s\n"
argument_list|,
name|objfil
argument_list|,
name|currend
