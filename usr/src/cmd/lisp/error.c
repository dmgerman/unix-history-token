...
comment|/* 		* return value goes into r7 until after movc3 instruction 		* which clobbers r0 		*/
asm|asm("	movl	12(ap),r7");
comment|/* set return value (valret)*/
asm|asm("	addl3	$16,r11,sp");
comment|/* skip link,flag,labl,svbnp */
asm|asm("	movc3	$44,(sp),_setsav");
comment|/*restore (return) context*/
asm|asm("	movab	44(sp),sp");
comment|/* skip past ""     "" */
asm|asm("	popr	$0x2540");
...
name|curdep
expr_stmt|;
comment|/* In case of freturn, reset this global */
name|fprintf
argument_list|(
name|stdout
argument_list|,
