...
begin_comment
comment|/*  to remove restrictions from uuxqt  *  redefine CMDOK 0  *  *  to add allowable commands, add to the list under Cmds[]  */
end_comment
...
begin_comment
comment|/***  *	cmdok(xc, cmd)		check for valid command  *	char *xc, *cmd;  *  *	return 0 - ok | 1 nok  */
end_comment
