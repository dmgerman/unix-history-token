...
begin_comment
comment|/*	cpio	COMPILE:	cc -O cpio.c -s -i -o cpio -lS 	cpio -- copy file collections  */
end_comment
...
name|err
argument_list|(
literal|"Usage: cpio -o[vB]<name-list>collection\n%s\n%s\n"
argument_list|,
literal|"       cpio -i[drstuvB] [pattern]<collection"
argument_list|,
literal|"       cpio -p[dlruv] [pattern] directory<name-list"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
