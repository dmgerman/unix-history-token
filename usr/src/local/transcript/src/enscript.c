...
begin_comment
comment|/* suppress stderr error messages */
end_comment
...
begin_comment
comment|/* silly informational messages */
end_comment
...
begin_comment
comment|/* second header line for Gaudy */
end_comment
...
directive|define
name|ARGS
value|"12gGBlL:oqrRkKf:F:b:p:J:C:P:#:mhO:s:v"
end_define
...
literal|""
expr_stmt|;
comment|/* warning: fonts must be defined in this order! */
name|ResetFont
argument_list|(
name|HeaderFont
argument_list|,
