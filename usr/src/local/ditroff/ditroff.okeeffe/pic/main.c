...
begin_comment
comment|/* You may want to change this if you don't have a 202... */
end_comment

begin_comment
comment|/*  *#ifdef	APS  *	int	devtype	= DEVAPS;  *	int	res	= 723;  *	int	DX	= 3;  *	int	DY	= 3;  *  *#ifdef 202  *	int	devtype	= DEV202;  *	int	res	= 972;	/* default is 202 *  *	int	DX	= 4;	/* used only for old-style troff *  *	int	DY	= 4;  */
end_comment
...
begin_comment
comment|/* mandatory values for graphic systems CAT: */
end_comment
...
begin_comment
comment|/* used only for old-style troff */
end_comment
