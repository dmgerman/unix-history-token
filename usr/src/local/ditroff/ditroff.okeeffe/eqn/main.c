...
index|[]
init|=
literal|"@(#)main.c	2.4 (CWI) 87/04/01"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* the minsize could profitably come from the */
end_comment

begin_block
block|{
comment|/* troff description file /usr/lib/font/dev.../DESC.out */
if|if
condition|(
name|strcmp
argument_list|(
...
name|dn
parameter_list|)
comment|/* absolute size dn in printable form \sd or \s(dd (dd>= 40) */
name|int
name|dn
decl_stmt|;
block|{
