...
begin_comment
comment|/*  * @(#)menu.c	1.1	%G%  *  * Menu subwindow routines for the SUN Gremlin picture editor.  *  * Mark Opperman (opcode@monet.BERKELEY)  *  */
end_comment
...
begin_comment
comment|/* to save previous command */
end_comment
...
begin_comment
comment|/*  * This routine initializatizes the positioning of menu items -  * currently only necessary for the justify icon.  * mro 7/18/84  */
end_comment
...
begin_comment
comment|/*  * This routine displays the menu defined by initmenu  * mro 7/18/84  */
end_comment
