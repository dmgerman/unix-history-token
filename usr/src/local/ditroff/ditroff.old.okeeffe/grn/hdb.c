...
begin_comment
comment|/*	hdb.c	1.6	(Berkeley) 84/04/07  *  * Copyright -C- 1982 Barry S. Roitblat  *  *      This file contains database routines for the hard copy programs of the  * gremlin picture editor.  */
end_comment
