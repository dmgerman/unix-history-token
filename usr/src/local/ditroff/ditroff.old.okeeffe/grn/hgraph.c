...
name|savelasty
expr_stmt|;
comment|/* vertical position restored to where it was */
name|lastx
operator|=
name|xleft
expr_stmt|;
comment|/*   before text, also horizontal is at left */
block|}
end_block
...
begin_comment
comment|/*----------------------------------------------------------------------------*  | Routine:	tmove (point_pointer)  |  | Results:	produces horizontal and vertical moves for troff given the  |		pointer of a point to move to and knowing the current position.  |		Also puts out a horizontal move to start the line.  *----------------------------------------------------------------------------*/
end_comment
...
begin_comment
comment|/*----------------------------------------------------------------------------*  | Routine:	cr ( )  |  | Results:	Ends off an input line.  ".sp -1" is also added to counteract  |		the vertical move done at the end of text lines.  |  | Side Efct:	sets "lastx" to "xleft" for troff's return to left margin  *----------------------------------------------------------------------------*/
end_comment
