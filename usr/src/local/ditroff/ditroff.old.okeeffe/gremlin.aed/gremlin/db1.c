...
begin_comment
comment|/* @(#)db1.c	1.3	%G%  *  * Copyright -C- 1982 Barry S. Roitblat  *  *      This file contains routines for database manipulation for the  * gremlin picture editor.  */
end_comment
