...
begin_comment
comment|/* db3.c -  *  *  * Copyright -C- 1982 Barry S. Roitblat  *  *       This file contains additional routines to implement the database  * manipulations necessary for the gremlin picture editor.  */
end_comment
