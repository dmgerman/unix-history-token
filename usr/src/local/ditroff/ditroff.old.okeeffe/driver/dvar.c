...
begin_comment
comment|/*	dvar.c	1.1	83/07/08  *  * Varian driver for the new troff  *  * Authors:	BWK(BELL)  *		VCAT(berkley)  *		Richard L. Hyde, Perdue University  *		and David Slattengren, Berkeley  */
end_comment
