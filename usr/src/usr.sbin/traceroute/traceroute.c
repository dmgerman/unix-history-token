...
begin_comment
comment|/*-  * Copyright (c) 1990 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Van Jacobson.  *  * %sccs.include.redist.c%  */
end_comment
...
index|[]
init|=
literal|"@(#)traceroute.c	5.4 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
name|stderr
argument_list|,
literal|"traceroute: max ttl must be>1.\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
...
name|stderr
argument_list|,
literal|"traceroute: port must be>0.\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
...
name|stderr
argument_list|,
literal|"traceroute: nprobes must be>0.\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
...
name|stderr
argument_list|,
literal|"traceroute: tos must be 0 to 255.\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
...
name|stderr
argument_list|,
literal|"traceroute: wait must be>1 sec.\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
...
name|stderr
argument_list|,
literal|"traceroute: packet size must be 0<= s< %ld.\n"
argument_list|,
name|MAXPACKET
operator|-
sizeof|sizeof
...
name|stderr
argument_list|,
literal|"usage: traceroute [-dnrv] [-m max_ttl] [-p port#] [-q nqueries]\n\t\ [-s src_addr] [-t tos] [-w wait] host [data size]\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
