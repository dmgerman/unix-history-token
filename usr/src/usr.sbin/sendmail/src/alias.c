...
index|[]
operator|=
literal|"@(#)alias.c	6.39 (Berkeley) %G% (with NEWDB and NDBM)"
expr_stmt|;
end_expr_stmt
...
index|[]
init|=
literal|"@(#)alias.c	6.39 (Berkeley) %G% (with NEWDB)"
decl_stmt|;
end_decl_stmt
...
index|[]
init|=
literal|"@(#)alias.c	6.39 (Berkeley) %G% (with NDBM)"
decl_stmt|;
end_decl_stmt
...
index|[]
init|=
literal|"@(#)alias.c	6.39 (Berkeley) %G% (without NEWDB or NDBM)"
decl_stmt|;
end_decl_stmt
