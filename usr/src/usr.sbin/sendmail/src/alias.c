...
begin_comment
comment|/* **  HOSTALIAS -- alias a host name ** **	Given a host name, look it up in the host alias table **	and return it's value.  If nothing, return NULL. ** **	Parameters: **		a -- address to alias. ** **	Returns: **		text result of aliasing. **		NULL if none. ** **	Side Effects: **		none. */
end_comment
