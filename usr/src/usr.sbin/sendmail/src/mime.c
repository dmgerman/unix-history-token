...
index|[]
init|=
literal|"@(#)mime.c	8.10 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* **  MIME_GETCHAR -- get a character for MIME processing ** **	Treats boundaries as EOF. ** **	Parameters: **		fp -- the input file. **		boundary -- the current MIME boundary. ** **	Returns: **		The next character in the input stream. */
end_comment
