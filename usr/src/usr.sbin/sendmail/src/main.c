...
begin_comment
comment|/* **  OPENXSCRPT -- Open transcript file ** **	Creates a transcript file for possible eventual mailing or **	sending back. ** **	Parameters: **		none ** **	Returns: **		none ** **	Side Effects: **		Creates the transcript file. */
end_comment
...
name|printf
argument_list|(
literal|"dropenvelope %x id=\"%s\" flags=%o\n"
argument_list|,
name|e
argument_list|,
name|e
