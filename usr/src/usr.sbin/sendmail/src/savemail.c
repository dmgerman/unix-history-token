...
begin_comment
comment|/* **  ERRHEADER -- Output the header for error mail. ** **	Parameters: **		xfile -- the transcript file. **		fp -- the output file. ** **	Returns: **		none ** **	Side Effects: **		Outputs the header for an error message. */
end_comment
