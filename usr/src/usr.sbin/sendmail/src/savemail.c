...
index|[]
init|=
literal|"@(#)savemail.c	8.50 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
name|putline
argument_list|(
literal|"Content-Type: message/X-delivery-status-1"
argument_list|,
name|mci
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|/* Final-Log-Id: -- why isn't this per-message? */
operator|(
name|void
operator|)
name|sprintf
