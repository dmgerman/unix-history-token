...
begin_comment
comment|/* **  SETENV -- set environment variable ** **	Putenv is more modern, but this is a simpler interface ** **	Parameters: **		name -- the name of the envariable. **		value -- the value of that envariable. **		overwrite -- if set, overwrite existing value **			(this is assumed to be set). ** **	Returns: **		none. ** **	Side Effects: **		The environment is updated. */
end_comment
