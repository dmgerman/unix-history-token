...
begin_comment
comment|/* **  SETUPMAPS -- set up map classes ** **	Since these are compiled in, they cannot be in the config file. ** */
end_comment
...
directive|ifdef
name|BTREE_MAP
comment|/* new database file access -- btree files */
block|{
specifier|extern
name|bool
name|bt_map_init
...
directive|ifdef
name|HASH_MAP
comment|/* new database file access -- hash files */
block|{
specifier|extern
name|bool
name|hash_map_init
