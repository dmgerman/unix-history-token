...
begin_comment
comment|/* Berkeley people: mail changes to ingvax:eric or they will be lost! */
end_comment
...
begin_comment
comment|/* don't merge any berknet sites */
end_comment
...
begin_comment
comment|/* don't merge any UUCP sites */
end_comment
