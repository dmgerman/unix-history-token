...
name|syserr
argument_list|(
literal|"readcf: line %d: too many P lines, %d max"
argument_list|,
name|LineNumber
argument_list|,
name|MAXPRIORITIES
...
name|syserr
argument_list|(
literal|"readcf: line %d: invalid rewrite set, %d max"
argument_list|,
name|LineNumber
argument_list|,
name|MAXRWSETS
...
begin_comment
comment|/* **  SETOPTION -- set global processing option ** **	Parameters: **		opt -- option name. **		val -- option value (as a text string). ** **	Returns: **		none. ** **	Side Effects: **		Sets options as implied by the arguments. */
end_comment
...
comment|/* 	**  First encode this option as appropriate. 	*/
if|if
condition|(
name|index
argument_list|(
...
literal|'s'
case|:
comment|/* standard time time zone */
name|StdTimeZone
operator|=
name|val
expr_stmt|;
...
literal|'X'
case|:
comment|/* transcript file template */
name|XcriptFile
operator|=
name|val
expr_stmt|;
...
name|syserr
argument_list|(
literal|"setoption: line %d: illegal option %c"
argument_list|,
name|LineNumber
argument_list|,
name|opt
