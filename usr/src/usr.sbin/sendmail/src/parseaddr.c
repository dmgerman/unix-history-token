...
comment|/* 	**  First put this address into canonical form. 	**	First turn it into a macro. 	**	Then run it through ruleset 4. 	**	If the mailer defines a rewriting set, run it through 	**		there next. 	**	The intent is that ruleset 4 puts the name into a 	**		canonical form; the mailer's ruleset then 	**		does any customization. 	*/
