...
block|}
block|}
comment|/* 		**  Do host equivalence. 		**	This allows us to map together messages that 		**	would otherwise have several copies going 		**	through the same net link. 		*/
for|for
control|(
name|hvp
operator|=
...
condition|)
block|{
comment|/* null string: match everything */
name|doremap
operator|=
name|TRUE
expr_stmt|;
...
block|}
block|}
comment|/* make copies if specified */
if|if
condition|(
name|copyf
operator|>=
