...
name|qflags
expr_stmt|;
comment|/* 		**  If this address should have a host alias, take care 		**  of it now. 		*/
if|if
condition|(
name|strcmp
argument_list|(
...
condition|)
block|{
comment|/* couldn't do anything with it */
name|giveresponse
argument_list|(
name|EX_NOUSER
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* change the print address so the message looks good */
name|a
operator|->
name|q_paddr
operator|=
name|newaddr
expr_stmt|;
comment|/* call ourselves recursively to send to our friends */
name|sendto
argument_list|(
name|newaddr
argument_list|,
