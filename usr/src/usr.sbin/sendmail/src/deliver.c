...
begin_comment
comment|/* **  COMMAIZE -- output a header field, making a comma-translated list. ** **	Parameters: **		p -- the field to output. **		tag -- the tag to associate with it. **		fp -- file to put it to. **		oldstyle -- TRUE if this is an old style header. **		m -- a pointer to the mailer descriptor. ** **	Returns: **		none. ** **	Side Effects: **		outputs "p" to file "fp". */
end_comment
