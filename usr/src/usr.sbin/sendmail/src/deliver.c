...
index|[]
init|=
literal|"@(#)deliver.c	6.37 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* **  OPENMAILER -- open connection to mailer. ** **	Parameters: **		m -- mailer descriptor. **		pvp -- parameter vector to pass to mailer. **		ctladdr -- controlling address for user. **		clever -- create a full duplex connection. ** **	Returns: **		The mail connection info struct for this connection. **		NULL on failure. ** **	Side Effects: **		creates a mailer in a subprocess. */
end_comment
...
begin_comment
comment|/* **  PARENTBODY -- put the body of the parent of a message. ** **	Parameters: **		fp -- file to output onto. **		m -- a mailer descriptor to control output format. **		e -- the envelope whose parent to put out. ** **	Returns: **		none. ** **	Side Effects: **		The message is written onto fp. */
end_comment
