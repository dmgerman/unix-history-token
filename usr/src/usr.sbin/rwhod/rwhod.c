...
index|[]
init|=
literal|"@(#)rwhod.c	4.22 (Berkeley) 84/05/11"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  * Return the possible subnetwork number from an internet address.  * If the address is of the form of a subnet address (most significant  * bit of the host part is set), believe the subnet exists.  * Otherwise, return the network number.  Any subnet number is only valid  * if this is a ``local'' net.  */
end_comment
