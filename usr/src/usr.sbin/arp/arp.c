...
begin_comment
comment|/*  * Copyright (c) 1984, 1993  *	The Regents of the University of California.  All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Sun Microsystems, Inc.  *  * %sccs.include.redist.c%  */
end_comment
