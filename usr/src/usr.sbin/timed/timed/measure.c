...
index|[]
init|=
literal|"@(#)measure.c	2.1 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  * Measures the differences between machines' clocks using  * ICMP timestamp messages.  * Called by master with ckrange = 1, by clockdiff with ckrange = 0.  */
end_comment
