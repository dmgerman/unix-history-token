...
begin_comment
comment|/*-  * Copyright (c) 1990 Jan-Simon Pendry  * Copyright (c) 1990 Imperial College of Science, Technology& Medicine  * Copyright (c) 1990 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Jan-Simon Pendry at Imperial College, London.  *  * %sccs.include.redist.c%  *  * $Id: mntfs.c,v 5.2.2.1 1992/02/09 15:08:42 jsp beta $  */
end_comment
...
index|[]
init|=
literal|"@(#)mntfs.c	5.5 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
