...
begin_comment
comment|/*  * $Id: am.h,v 5.2 90/06/23 22:20:28 jsp Rel $  *  * Copyright (c) 1990 Jan-Simon Pendry  * Copyright (c) 1990 Imperial College of Science, Technology& Medicine  * Copyright (c) 1990 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Jan-Simon Pendry at Imperial College, London.  *  * %sccs.include.redist.c%  *  *	@(#)am.h	5.1 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/* Retry this type of mount */
end_comment
...
begin_comment
comment|/* Need to make the mkdir point */
end_comment
...
directive|define
name|mf_fattr
value|mf_attr.attrstat_u.attributes
name|char
modifier|*
name|mf_mount
decl_stmt|;
...
begin_comment
comment|/* Delete this node's am_path */
end_comment
...
directive|define
name|AFS_RETRANS
value|((ALLOWED_MOUNT_TIME*10+2*afs_timeo)/afs_timeo)
end_define

begin_comment
comment|/* Default afs timeout - 1/10th seconds */
end_comment
