...
begin_comment
comment|/*  * Copyright (c) 1989 Jan-Simon Pendry  * Copyright (c) 1989 Imperial College of Science, Technology& Medicine  * Copyright (c) 1989 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Jan-Simon Pendry at Imperial College, London.  *  * %sccs.include.redist.c%  *  *	@(#)os-defaults.h	5.3 (Berkeley) %G%  *  * $Id: os-defaults.h,v 5.2.1.4 91/05/07 22:19:38 jsp Alpha $  *  * Common OS definitions.  These may be overridden in  * the OS specific files ("os-foo.h").  */
end_comment
