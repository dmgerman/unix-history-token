...
begin_comment
comment|/*  * Copyright (c) 1980,1990 Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  */
end_comment
...
name|f
argument_list|,
literal|"\t${CPP} ${COPTS} $S/%ss | ${AS} -o %so\n"
argument_list|,
name|np
argument_list|,
name|tp
...
name|f
argument_list|,
literal|"\t@${LD} -n -o %s -e start -%c -T 80000000 "
argument_list|,
name|fl
operator|->
name|f_needs
...
name|f
argument_list|,
literal|"\t@${LD} -n -o %s -e start -%c -T C0000800 "
argument_list|,
name|fl
operator|->
name|f_needs
