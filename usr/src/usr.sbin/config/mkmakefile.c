...
begin_comment
comment|/*  * mkmakefile.c	1.17	82/10/11  *	Functions in this file build the makefile from the files list  *	and the information in the config table  */
end_comment
...
begin_comment
comment|/* pointer to ${COPTS} macro for gprof */
end_comment
