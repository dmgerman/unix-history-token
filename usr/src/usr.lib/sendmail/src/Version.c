...
index|[]
init|=
literal|"@(#)version.c	5.51 (Berkeley) 5/2/86"
decl_stmt|;
end_decl_stmt
...
literal|00015
name|don
literal|'t ignore aliasing during queue runs in conjunction with -bd  D 5.49	86/04/02 16:02:31	eric	471	470	00000/00000/00015 don'
name|t
name|run
name|around
name|clearing
...
begin_expr_stmt
literal|" stuff -- it screws it up aliases; pass parameters to subroutines (this also adds $@ and $: features to subr calls); check overflow of "
name|tobuf
literal|" on smtp deliveries, which caused core dumps on large mailing lists  D 3.199	82/09/12 22:17:30	eric	218	217	00000/00000/00005 accept "
operator|:
operator|...
expr_stmt|;
end_expr_stmt
