...
begin_comment
comment|/*	@(#)input-scrub.c	6.2 (Berkeley) %G%  Modified for Berkeley Unix by Donn Seeley, donn@okeeffe.berkeley.edu  */
end_comment
...
begin_comment
comment|/*  * linestab() -- generate a line number stab for the current source line.  * If the filename has changed, generate a file stab first.  */
end_comment
