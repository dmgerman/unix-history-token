...
begin_comment
comment|/* $XConsortium: XText.c,v 11.21 91/01/06 11:48:26 rws Exp $ */
end_comment
...
argument_list|)
empty_stmt|;
comment|/*    elt->delta = 0;  *    elt->len = 254;  */
operator|*
operator|(
name|unsigned
name|char
...
literal|0
expr_stmt|;
comment|/*       bcopy (CharacterOffset, (char *) (elt + 1), 254);  */
name|bcopy
argument_list|(
name|CharacterOffset
argument_list|,
...
argument_list|)
empty_stmt|;
comment|/*    elt->delta = 0;  *    elt->len = PartialNChars;  */
operator|*
operator|(
name|unsigned
name|char
...
literal|0
expr_stmt|;
comment|/*     bcopy (CharacterOffset, (char *) (elt + 1), PartialNChars);  */
name|bcopy
argument_list|(
name|CharacterOffset
argument_list|,
