...
begin_comment
comment|/* The IRIS defines SIGIO in signal.h, but doesn't implement it. */
end_comment
...
name|x
parameter_list|)
value|(int)((char *)(x) - (char*)0)
end_define

begin_comment
comment|/* some errno.h's don't actually allocate the variable itself */
end_comment
...
begin_comment
comment|/* The symbol FIONREAD is defined, but the feature does not work.  */
end_comment
