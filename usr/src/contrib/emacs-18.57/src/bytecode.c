...
begin_comment
comment|/* no longer generated as of v18 */
end_comment
...
begin_comment
comment|/* this loser is no longer generated as of v18 */
end_comment
...
name|error
argument_list|(
literal|"Stack overflow in byte code (byte compiler bug), pc = %d"
argument_list|,
name|pc
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Stack underflow in byte code (byte compiler bug), pc = %d"
argument_list|,
name|pc
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|/* Remove protection from the args we are giving to Ffuncall. 	     FFuncall will protect them, and double protection would 	     cause disasters.  */
name|gcpro3
operator|.
name|nvars
operator|=
...
comment|/* A loop always uses a plain goto to jump back. 	     So this makes sure we consider GC in each loop.  */
if|if
condition|(
name|op
operator|<
...
name|v1
expr_stmt|;
comment|/* pop binding of standard-output */
name|unbind_to
argument_list|(
name|specpdl_ptr
operator|-
...
name|Bscan_buffer
case|:
comment|/* Get an appropriate error.  */
name|Fsymbol_function
argument_list|(
name|intern
argument_list|(
...
name|UNGCPRO
expr_stmt|;
comment|/* Binds and unbinds are supposed to be compiled balanced.  */
if|if
condition|(
name|specpdl_ptr
operator|-
