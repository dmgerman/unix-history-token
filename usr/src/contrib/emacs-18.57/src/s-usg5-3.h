...
begin_comment
comment|/* Definitions file for GNU Emacs running on AT&T's System V Release 3    Copyright (C) 1987 Free Software Foundation, Inc.  This file is part of GNU Emacs.  GNU Emacs is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 1, or (at your option) any later version.  GNU Emacs is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU Emacs; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
begin_comment
comment|/* Some versions of V.3 have this, but not all.    #define HAVE_PTYS    #define SYSV_PTYS  */
end_comment
...
begin_comment
comment|/* Define this if system V IPC is available.  */
end_comment
...
begin_comment
comment|/* Some variants have TIOCGETC, but the structures to go with it    are not declared.  */
end_comment
...
begin_comment
comment|/* X needs to talk on the network, so search the network library.  */
end_comment
