...
begin_comment
comment|/* m- file for vax.    Copyright (C) 1985, 1986 Free Software Foundation, Inc.  This file is part of GNU Emacs.  GNU Emacs is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 1, or (at your option) any later version.  GNU Emacs is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU Emacs; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
begin_comment
comment|/* Vax is not big-endian: lowest numbered byte is least significant. */
end_comment
...
begin_comment
comment|/* #define vax    -- appears to be done automatically  */
end_comment
...
begin_comment
comment|/* USG systems I know of running on Vaxes do not actually    support the load average, so disable it for them.  */
end_comment
...
begin_comment
comment|/* Data type of load average, as read out of driver.  */
end_comment
...
begin_comment
comment|/* Vax sysV has alloca in the PW library.  */
end_comment
...
begin_comment
comment|/* There is some bug in unexec in for usg 5.2 on a vax    which nobody who runs such a system has yet tracked down. */
end_comment
