...
begin_comment
comment|/* $Header: XMenu.h,v 1.5 87/12/04 10:26:47 swick Exp $ */
end_comment
...
name|aeq
decl_stmt|;
comment|/* Asynchronous Event Queueing mode? */
name|int
name|recompute
decl_stmt|;
...
name|x_pos
decl_stmt|;
comment|/* Oveall menu origin. */
name|int
name|y_pos
decl_stmt|;
comment|/* Overall menu origin. */
name|Cursor
name|mouse_cursor
decl_stmt|;
...
decl_stmt|;
comment|/* GC used for inactive selections. */
name|GC
name|inverse_select_GC
decl_stmt|;
comment|/* GC used for active (current) selection. */
name|GC
name|inact_GC
decl_stmt|;
comment|/* GC used for inactive selections and */
comment|/* panes headers. */
comment|/* -------------------- Color data -------------------- */
name|unsigned
name|long
name|p_bdr_color
...
begin_comment
comment|/* Don't add after this point. */
end_comment
