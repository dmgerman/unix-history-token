...
block|}
block|,
comment|/* FIXNIEL: addi instead of addq because to many frags */
endif|#
directive|endif
block|{
literal|"addql"
...
name|BRANCH_MASK
value|one(0xFFFF)
comment|/* 8-bit displacement must be 0 */
endif|#
directive|endif
block|{
literal|"bhi"
...
block|}
block|,
comment|/* fmove from fp<n> (<ea>) to fp<n> */
block|{
literal|"fmovex"
block|,
name|two
...
block|}
block|,
comment|/* fmove from mem (<ea>) to fp<n> */
block|{
literal|"fmovex"
block|,
name|two
...
block|}
block|,
comment|/* FIXNIEL: move instead of movw because too many frags */
block|{
literal|"moveq"
block|,
name|one
...
block|}
block|,
comment|/* For pflush, pflushn on '040: Documentation describes address-register-indirect mode, but    old assembler accepted only address-register.  Added a-r-i as new default, still    accepting old form for now.  [raeburn:19920908.1910EST]  */
block|{
literal|"pflush"
block|,
name|one
...
block|}
block|,
comment|/* PSR/MMUSR(68030)/ACUSR(68ec030), PCSR */
comment|/* {"pmove",	two(0xf000, 0x6100),	two(oxffc0, oxffff),	"*sZ8",	m68851 }, */
block|{
literal|"pmove"
block|,
name|two
...
block|}
block|,
comment|/* flush-disabled versions */
block|{
literal|"pmovefd"
block|,
name|two
...
directive|ifndef
name|MOTOROLA_SYNTAX_ONLY
comment|/* The two identical psave instructions seems dubious. FIXME */
block|{
literal|"psave"
block|,
name|one
...
block|}
block|,
comment|/* FIXNIEL: sub instead of subq because too many frags */
endif|#
directive|endif
block|{
literal|"subql"
...
directive|ifndef
name|MIT_SYNTAX_ONLY
comment|/* Aliases:  jbCC is the same as jCC */
block|{
literal|"jbhi"
block|,
name|one
