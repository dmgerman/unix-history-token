...
begin_comment
comment|/*  SUBSECTION 	bfd_arch_info  DESCRIPTION 	This structure contains information on architectures for use 	within BFD.  . .typedef struct bfd_arch_info  .{ .  int bits_per_word; .  int bits_per_address; .  int bits_per_byte; .  enum bfd_architecture arch; .  long mach; .  char *arch_name; .  CONST  char *printable_name; .  unsigned int section_align_power; . {* true if this is the default machine for the architecture *} .  boolean the_default;	 .  CONST struct bfd_arch_info * EXFUN((*compatible), .	(CONST struct bfd_arch_info *a, .	 CONST struct bfd_arch_info *b)); . .  boolean EXFUN((*scan),(CONST struct bfd_arch_info *,CONST char *)); .  unsigned int EXFUN((*disassemble),(bfd_vma addr, CONST char *data, .				     PTR stream)); . .  struct bfd_arch_info *next; .} bfd_arch_info_type; */
end_comment
