...
name|fp
parameter_list|)
value|pyr_do_registers_info(_regnum, fp)
end_define
...
name|POP_FRAME
define|\
value|{ error ("The return command is not supported on this machine."); }
end_define
