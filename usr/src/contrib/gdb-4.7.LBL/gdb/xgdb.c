...
index|[]
init|=
literal|"$Header: xgdb.c,v 1.2 93/02/24 14:52:46 van Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  * Original version was contributed by Derek Beatty, 30 June 87.  * This version is essentially a re-write of the original by Van  * Jacobson (van@ee.lbl.gov), Nov, 90.  */
end_comment

begin_comment
comment|/* Include/define this before gcc-include/stddef.h */
end_comment
...
block|{
block|{
literal|"xgdb-insert-char"
block|,
name|xgdb_insert_char
block|}
block|,
block|{
literal|"xgdb-insert-selection"
block|,
name|xgdb_insert_selection
block|}
block|,
block|{
literal|"xgdb-insert-string"
block|,
name|xgdb_insert_string
block|}
block|,
block|{
literal|"xgdb-newline"
block|,
name|xgdb_newline
block|}
block|, }
