...
index|[]
init|=
literal|"$Header: types.c,v 2.1 86/05/16 11:14:30 jqj Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* $Log:	types.c,v $  * Revision 2.1  86/05/16  11:14:30  jqj  * various bugs in widening created by previous edit (I still don't have  * them all fixed, but at least it's now usable).  *   * Revision 2.0  85/11/21  07:21:51  jqj  * 4.3BSD standard release  *   * Revision 1.3  85/03/11  16:40:43  jqj  * *** empty log message ***  *   * Revision 1.3  85/03/11  16:40:43  jqj  * Public alpha-test version, released 11 March 1985  *   * Revision 1.2  85/02/21  11:06:29  jqj  * alpha test version  *   * Revision 1.1  85/02/15  13:55:49  jqj  * Initial revision  *   */
end_comment
