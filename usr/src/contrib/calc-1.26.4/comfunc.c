...
begin_comment
comment|/*  * Calculate the square root of a complex number, with each component  * within the specified error. This uses the formula:  *	sqrt(a+bi) = sqrt((a+sqrt(a^2+b^2))/2) + sqrt((-a+sqrt(a^2+b^2))/2)i.  */
end_comment
...
begin_comment
comment|/*  * Print a complex number.  */
end_comment
