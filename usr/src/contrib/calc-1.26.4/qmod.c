...
begin_comment
unit|NUMBER * qmulmod(q1, q2, q3) 	NUMBER *q1, *q2, *q3; { 	NUMBER *q;  	if (qisneg(q3) || qiszero(q3)) 		error("Non-positive modulus"); 	if (qisfrac(q1) || qisfrac(q2) || qisfrac(q3)) 		error("Non-integers for qmulmod"); 	if (qiszero(q1) || qiszero(q2) || qisunit(q3)) 		return qlink(&_qzero_); 	q = qalloc(); 	zmulmod(q1->num, q2->num, q3->num,&q->num); 	return q; }
...
begin_comment
unit|NUMBER * qsquaremod(q1, q2) 	NUMBER *q1, *q2; { 	NUMBER *q;  	if (qisneg(q2) || qiszero(q2)) 		error("Non-positive modulus"); 	if (qisfrac(q1) || qisfrac(q2)) 		error("Non-integers for qsquaremod"); 	if (qiszero(q1) || qisunit(q2)) 		return qlink(&_qzero_); 	if (qisunit(q1)) 		return qlink(&_qone_); 	q = qalloc(); 	zsquaremod(q1->num, q2->num,&q->num); 	return q; }
...
begin_comment
unit|NUMBER * qaddmod(q1, q2, q3) 	NUMBER *q1, *q2, *q3; { 	NUMBER *q;  	if (qisneg(q3) || qiszero(q3)) 		error("Non-positive modulus"); 	if (qisfrac(q1) || qisfrac(q2) || qisfrac(q3)) 		error("Non-integers for qaddmod"); 	q = qalloc(); 	zaddmod(q1->num, q2->num, q3->num,&q->num); 	return q; }
...
begin_comment
unit|NUMBER * qsubmod(q1, q2, q3) 	NUMBER *q1, *q2, *q3; { 	NUMBER *q;  	if (qisneg(q3) || qiszero(q3)) 		error("Non-positive modulus"); 	if (qisfrac(q1) || qisfrac(q2) || qisfrac(q3)) 		error("Non-integers for qsubmod"); 	if (q1 == q2) 		return qlink(&_qzero_); 	q = qalloc(); 	zsubmod(q1->num, q2->num, q3->num,&q->num); 	return q; }
...
begin_endif
unit|NUMBER * qnegmod(q1, q2) 	NUMBER *q1, *q2; { 	NUMBER *q;  	if (qisneg(q2) || qiszero(q2)) 		error("Non-positive modulus"); 	if (qisfrac(q1) || qisfrac(q2)) 		error("Non-integers for qnegmod"); 	if (qiszero(q1) || qisunit(q2)) 		return qlink(&_qzero_); 	q = qalloc(); 	znegmod(q1->num, q2->num,&q->num); 	return q; }
endif|#
directive|endif
end_endif
