...
begin_comment
comment|/*  * Copyright (c) 1993 David I. Bell  * Permission is granted to use, distribute, or modify this source,  * provided that this copyright notice remains intact.  *  * Add opcodes to a function being compiled.  */
end_comment
...
name|error
argument_list|(
literal|"cannot reallocate function"
argument_list|)
expr_stmt|;
name|memcpy
argument_list|(
...
begin_comment
comment|/*  * Add an opcode and an index to the current function being compiled.  */
end_comment
