...
begin_comment
comment|/* manually edited version for OS/2 with MS C 6.00    check the HAS_?DBM symbols and if you have such a library ...    June 1991, Kai Uwe Rommel */
end_comment
