...
begin_comment
comment|/* $Revision: 1.3 $  *  * Revision 4.0.1.1  91/04/11  17:48:31  lwall  * patch1: Configure now figures out malloc ptr type  *   * Revision 4.0  91/03/20  01:28:52  lwall  * 4.0 baseline.  *   * Slightly hacked by Matthias Urlichs (urlichs@smurf.sub.org)  * to fit into INND; 91/08/28.  */
end_comment
...
name|p
parameter_list|)
value|if(!(p)) syslog(L_FATAL, #p); else
end_define
