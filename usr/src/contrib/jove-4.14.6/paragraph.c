...
begin_comment
comment|/*  *	Altered to include '--' at the start of the line to mean  *	beginning of paragraph this makes formatting the first line  *	of mail for mh easier  *	Peter C UKC  */
end_comment
