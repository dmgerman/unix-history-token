...
begin_comment
comment|/* Subroutines for insn-output.c for Tahoe.    Copyright (C) 1989, 1991 Free Software Foundation, Inc.  This file is part of GNU CC.  GNU CC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GNU CC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU CC; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
begin_comment
comment|/* to be careful about mixing modes here.		       */
end_comment
...
comment|/* find what exactly is being added to the multiplication. If */
...
begin_comment
comment|/* This checks if a zero_extended cmp[bw] can be replaced by a sign_extended    cmp[bw]. This can be done if the operand is a constant that fits in a    byte/word or a memory operand. Besides that the next instruction must be an    unsigned compare. Some of these tests are done by the machine description */
end_comment

begin_function
name|int
name|tahoe_cmp_check
parameter_list|(
name|insn
parameter_list|,
name|op
