...
literal|0
decl_stmt|;
comment|/* If we have array bounds, set our bounds from that.  Otherwise, 	 we have a lower bound of zero and an unknown upper bound.  Also 	 set the type of the bounds; use "int" as default.  */
if|if
condition|(
name|TYPE_DOMAIN
argument_list|(
