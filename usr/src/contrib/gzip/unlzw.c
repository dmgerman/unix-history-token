...
index|[]
init|=
literal|"$Id: unlzw.c,v 0.12 1993/03/18 18:14:56 jloup Exp $"
decl_stmt|;
end_decl_stmt
...
name|stderr
operator|,
literal|"%s: %s: warning, unknown flags 0x%x\n"
operator|,
name|progname
operator|,
name|ifname
...
name|stderr
argument_list|,
literal|"%s: %s: compressed with %d bits, can only handle %d bits\n"
argument_list|,
name|progname
argument_list|,
name|ifname
