...
index|[]
init|=
literal|"$Id: util.c,v 0.13 1993/03/18 18:14:56 jloup Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* ========================================================================  * Return the base name of a file (remove any directory prefix and  * any version suffix). For systems with filenames that are not  * case sensitive, force the base name to lower case.  */
end_comment
