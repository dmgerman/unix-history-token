...
index|[]
init|=
literal|"@(#)$Id: slocal.c,v 1.24 1993/08/25 17:28:16 jromine Exp $"
decl_stmt|;
end_decl_stmt
...
condition|)
continue|continue;
comment|/* if previous condition failed, don't 				      do this - else fall through */
case|case
literal|'?'
case|:
if|if
...
name|unixfrom
condition|)
comment|/* interface from copyfile */
name|strcpy
argument_list|(
name|from
argument_list|,
...
name|file
argument_list|,
literal|"unable to perform dbm_open on"
argument_list|)
expr_stmt|;
name|out
label|:
...
name|file
argument_list|,
literal|"unable to perform flock on"
argument_list|)
expr_stmt|;
goto|goto
name|out
...
name|file
argument_list|,
literal|"unable to perform lockf on"
argument_list|)
expr_stmt|;
goto|goto
name|out
...
name|NULLCP
argument_list|,
literal|"Message-ID: %s already received on\n\tDate:       %s"
argument_list|,
name|cp
argument_list|,
name|value
