...
index|[]
init|=
literal|"@(#)$Id: post.c,v 2.23 1993/08/25 17:26:51 jromine Exp $"
decl_stmt|;
end_decl_stmt
...
name|HDCC
value|0x0400
comment|/* another undocumented feature */
name|unsigned
name|int
name|set
decl_stmt|;
...
begin_comment
comment|/* use MIME-style encapsulations */
end_comment
...
name|partno
condition|?
literal|"Partial Message #%s Processed\n"
else|:
