...
index|[]
init|=
literal|"@(#)$Id: mts.c,v 2.16 1992/11/24 18:40:34 jromine Exp $"
decl_stmt|;
end_decl_stmt
...
name|Okhosts
init|=
literal|"@(MHETCPATH)/Rmail.OkHosts"
decl_stmt|;
end_decl_stmt
...
name|Okdests
init|=
literal|"@(MHETCPATH)/Rmail.OkDests"
decl_stmt|;
end_decl_stmt
...
name|maildelivery
init|=
literal|"@(MHETCPATH)/maildelivery"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* customize the MTS settings for MH by reading @(MHETCPATH)/mtstailor */
end_comment
