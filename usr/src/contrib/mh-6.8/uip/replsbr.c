...
index|[]
init|=
literal|"@(#)$Id: replsbr.c,v 1.1.1.1 1993/01/30 04:41:38 jtc Exp $"
decl_stmt|;
end_decl_stmt
...
literal|0
expr_stmt|;
comment|/* point at zero'd end minus 1 */
for|for
control|(
name|i
operator|=
...
argument_list|)
expr_stmt|;
comment|/* if not nxtbuf, nxtbuf already freed */
while|while
condition|(
name|i
operator|--
...
directive|ifdef
name|_FSTDIO
comment|/*<sigh> the code assumed that rewind does this. */
operator|(
name|void
operator|)
name|lseek
