...
index|[]
init|=
literal|"@(#)$Id: mshcmds.c,v 1.25 1992/12/15 00:20:22 jromine Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* AIX 1.2.1<stdio.h> declares getws() */
end_comment
...
comment|/* m_scaln is already NULL */
name|twscopy
argument_list|(
operator|&
name|Msgs
...
begin_comment
comment|/*   * getws - parse message, and get date and subject if needed.  We'll use  * the msgp->m_tb tws struct for the date, and overload the msgp->m_scanl  * field with our subject string.  */
end_comment
...
name|subjsw
condition|)
comment|/* not using this, or already done */
break|break;
comment|/* all done! */
name|gotdate
operator|++
...
condition|)
break|break;
comment|/* date done so we're done */
else|else
name|subjsw
operator|=
operator|(
...
literal|0
expr_stmt|;
comment|/* subject done, need date */
block|}
else|else
block|{
while|while
...
condition|)
block|{
comment|/* this might need free'd */
name|free
argument_list|(
name|msgp
operator|->
...
argument_list|)
expr_stmt|;
comment|/* probably can't use subj anyway */
name|msgp
operator|->
name|m_scanl
operator|=
...
name|OK
return|;
comment|/* not an error if subj not found */
name|admonish
argument_list|(
name|NULLCP
argument_list|,
...
name|NOTOK
return|;
comment|/* NOTOK means use some other date */
block|}
end_block

begin_comment
comment|/* sort routines */
end_comment
