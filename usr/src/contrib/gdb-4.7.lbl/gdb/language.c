...
begin_comment
unit|return l1> l2 ? VALUE_TYPE(v1) : VALUE_TYPE(v2);       break;    }    abort();    return (struct type *)0;
comment|/* For lint */
end_comment
...
begin_comment
comment|/* Returns non-zero if its argument is of an ordered type. */
end_comment
...
literal|"x"
block|,
comment|/* Hex   format, prefix, suffix */
literal|"0%o"
block|,
literal|"0%"
block|,
literal|"o"
block|,
comment|/* Octal format, prefix, suffix */
name|unk_op_print_tab
block|,
