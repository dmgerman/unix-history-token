...
begin_comment
comment|/* FRAME_CHAIN takes a frame_info with a frame's nominal address in fi->frame,    and produces the frame's chain-pointer. */
end_comment
...
begin_comment
comment|/* We need the boundaries of the text in the exec file, as a kludge,    for FRAMELESS_FUNCTION_INVOCATION and CALL_DUMMY_LOCATION. */
end_comment
