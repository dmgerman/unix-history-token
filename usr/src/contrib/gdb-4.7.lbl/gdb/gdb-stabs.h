...
begin_comment
comment|/* This file exists to hold the common definitions required of all the    symbol-readers that end up using stabs.  The common use of these     `symbol-type-specific' customizations of the generic data structures    makes the stabs-oriented symbol readers able to call each others'    functions as required.  */
end_comment
...
begin_comment
comment|/* Information is passed among various dbxread routines for accessing    symbol files.  A pointer to this structure is kept in the sym_private    field of the objfile struct.  */
end_comment
...
comment|/* FIXME:  HP kludges that shouldn't be here.  */
name|int
name|hp_symcount
decl_stmt|;
name|char
...
name|o
parameter_list|)
value|((struct dbx_symfile_info *)((o)->sym_private))
end_define
...
name|o
parameter_list|)
value|(DBX_SYMFILE_INFO(o)->text_sect)
end_define
...
begin_comment
comment|/* We don't use a macro for stab_section_info.  */
end_comment
...
name|o
parameter_list|)
value|(DBX_SYMFILE_INFO(o)->hp_symcount)
end_define
...
name|o
parameter_list|)
value|(DBX_SYMFILE_INFO(o)->hp_stringtab)
end_define
...
name|o
parameter_list|)
value|(DBX_SYMFILE_INFO(o)->hp_stringtab_size)
end_define
...
name|o
parameter_list|)
value|(DBX_SYMFILE_INFO(o)->hp_symtab_offset)
end_define
