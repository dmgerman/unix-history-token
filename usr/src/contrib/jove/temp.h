...
name|addr
parameter_list|)
value|((daddr) ((addr)>> BNO_SHIFT)& BNO_MASK)
end_define
...
name|addr
parameter_list|)
value|((daddr) ((addr)<< CH_BITS)& OFF_MASK)
end_define
...
name|addr
parameter_list|)
value|((daddr) ((addr)>> BNO_SHIFT)>= MAX_BLOCKS)
end_define
