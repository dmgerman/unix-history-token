...
name|printf
argument_list|(
literal|"\rError reading kbd process.\n"
argument_list|)
expr_stmt|;
name|finish
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/*  	 *  For terminals without an alternate page, go the bottom of the 	 *  screen. Alternate page - just return to the original place on 	 *  the screen 	 */
if|if
condition|(
operator|!
name|TE
