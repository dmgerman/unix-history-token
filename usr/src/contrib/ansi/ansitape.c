...
name|buf
argument_list|,
literal|"HDR2D%5.5d%5.5d%35.35s00%28.28s"
argument_list|,
name|blocksize
argument_list|,
name|blocksize
...
name|buf
argument_list|,
literal|"EOF2D%5.5d%5.5d%35.35s00%28.28s"
argument_list|,
name|blocksize
argument_list|,
name|blocksize
...
name|stderr
argument_list|,
literal|"error: bad tape record(s) in file %s - file may be truncated/corrupted.\n"
argument_list|,
name|filename
argument_list|)
expr_stmt|;
