...
argument_list|)
expr_stmt|;
comment|/* enable special pty mode */
name|signal
argument_list|(
name|SIGPIPE
argument_list|,
...
begin_comment
comment|/*  * HACK!  * This program does not use or need any stdio routines.  * Defining this procedure prevents all of the stdio  * code from being loaded.  */
end_comment
