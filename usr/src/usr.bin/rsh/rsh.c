...
begin_comment
comment|/*-  * Copyright (c) 1983, 1990, 1993, 1994  *	The Regents of the University of California.  All rights reserved.  *  * %sccs.include.redist.c%  */
end_comment
...
name|stderr
argument_list|,
literal|"usage: rsh [-nd%s]%s[-l login] [login@]host [command]\n"
argument_list|,
ifdef|#
directive|ifdef
name|KERBEROS
