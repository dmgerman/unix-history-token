...
begin_comment
comment|/*  * Copyright (c) 1985, 1989, 1993  *	The Regents of the University of California.  All rights reserved.  *  * %sccs.include.redist.c%  */
end_comment
...
index|[]
init|=
literal|"@(#)cmdtab.c	8.2 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
