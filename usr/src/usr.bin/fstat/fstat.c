...
continue|continue;
block|}
comment|/* admit missing -u, -f, -p */
comment|/* it's an expert system! */
if|if
condition|(
operator|(
name|pid
...
argument_list|()
expr_stmt|;
comment|/* could be either/neither */
name|argv
operator|++
expr_stmt|;
continue|continue;
