...
begin_comment
comment|/* ns32k.c  -- Assemble on the National Semiconductor 32k series    Copyright (C) 1987 Free Software Foundation, Inc.  This file is part of GAS, the GNU Assembler.  GAS is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 1, or (at your option) any later version.  GAS is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GAS; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
name|pcrel_adjust
decl_stmt|;
comment|/* It's value reflects the length in bytes from the instruction start to the displacement */
name|int
name|im_disp
decl_stmt|;
...
name|as_fatal
argument_list|(
literal|"Internal error check ns32k-opcode.h"
argument_list|)
expr_stmt|;
name|pcrel
operator|=
...
literal|0x1fffffff
condition|)
comment|/* if (-0x40000000<=exprP.X_add_number&& 		      exprP.X_add_number<=0x3fffffff) */
block|{
name|size
operator|=
literal|4
...
literal|0x20000000
condition|)
comment|/* if (val< -0x20000000 || val>= 0x20000000) */
name|as_warn
argument_list|(
...
begin_comment
comment|/* Convert a relaxed displacement to dito in final output */
end_comment
