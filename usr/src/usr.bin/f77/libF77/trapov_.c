...
name|ufd
argument_list|,
literal|"No more overflow messages will be printed.\n"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|ufd
argument_list|,
literal|"illegal instruction: 0x%02\n"
argument_list|,
name|opcode
argument_list|)
expr_stmt|;
