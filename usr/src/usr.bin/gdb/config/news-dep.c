...
begin_comment
comment|/* I don't think that I need this file.  */
end_comment
...
name|printf
argument_list|(
literal|"warning: floating register num %d not written due to OS bug.\n"
argument_list|,
name|regno
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"warning: ptrace bug for writing register number fp(a6).\n"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
name|printf
argument_list|(
literal|"warning: ptrace bug for writing floating registers(no write).\n"
argument_list|)
expr_stmt|;
endif|#
directive|endif
