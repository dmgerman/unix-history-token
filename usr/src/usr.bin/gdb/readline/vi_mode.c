...
begin_comment
comment|/*-  * This code is derived from software copyrighted by the Free Software  * Foundation.  *  * Modified 1991 by Donn Seeley at UUNET Technologies, Inc.  * Modified 1990 by Van Jacobson at Lawrence Berkeley Laboratory.  *  *	@(#)vi_mode.c	6.4 (Berkeley) 5/8/91  */
end_comment

begin_comment
comment|/* vi_mode.c -- A vi emulation mode for Bash.    Mostly written by Jeff Sparkes (jeff1@????).  */
end_comment
...
begin_comment
comment|/* Turn the current line into a comment in shell history.  A ksh function */
end_comment
