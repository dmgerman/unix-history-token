...
begin_comment
comment|/*  * TerminalEditLine()  *  * Look at an input character, and decide what to do.  *  * Output:  *  *	0	Don't add this character.  *	1	Do add this character  */
end_comment

begin_function
name|int
name|TerminalEditLine
parameter_list|(
name|c
parameter_list|)
comment|/* unix */
