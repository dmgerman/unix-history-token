...
begin_comment
comment|/*  * memNIchr(const void *s, int c, size_t n, int and)  *  * Like memchr, but the comparison is '((*s)&and) == c'.  *  */
end_comment
...
begin_comment
comment|/*  * memNDchr(const void *s, int c, size_t n, int and)  *  * Like memchr, but the comparison is '((*s)&and) == c',  * and we increment our way through s by "stride" ('s += stride').  *  * We optimize for the most used strides of +1 and -1.  */
end_comment
