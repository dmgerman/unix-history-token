...
begin_comment
comment|/* Definitions for Intel 386 running ESIX Unix System V.  */
end_comment

begin_comment
comment|/* Just like SCO support except don't use their special library and    predefined symbol.  */
end_comment
