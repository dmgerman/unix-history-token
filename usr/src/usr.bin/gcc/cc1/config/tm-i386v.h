...
name|STARTFILE_SPEC
define|\
value|"%{pg:gcrt1.o%s}%{!pg:%{posix:%{p:mcrtp1.o%s}%{!p:crtp1.o%s}}%{!posix:%{p:mcrt1.o%s}%{!p:crt1.o%s}}}\    %{p:-L/usr/lib/libp}%{pg:-L/usr/lib/libp}"
end_define
...
directive|define
name|LIB_SPEC
value|"%{posix:-lcposix} %{shlib:-lc_s} -lc crtn.o%s"
end_define
