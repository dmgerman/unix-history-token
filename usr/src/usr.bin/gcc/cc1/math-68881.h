...
begin_comment
comment|/* Modified by Richard Stallman, November 1990, to initialize HUGE_VAL    specially on a Sun.    December 1989, add parens around `&' in pow.  */
end_comment
...
begin_comment
comment|/* The Sun assembler fails to handle the hex constant in the usual defn.  */
end_comment
...
name|HUGE_VAL
define|\
value|({									\   static union { int i[2]; double d; } u = { {0x7ff00000, 0} };		\   u.d;									\ })
end_define
