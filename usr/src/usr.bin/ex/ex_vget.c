...
directive|endif
comment|/* 						 * We want to be able to undo 						 * commands, but it's nonsense 						 * to undo part of an insertion 						 * so if in input mode don't. 						 */
name|macpush
argument_list|(
operator|&
name|b
...
name|trace
argument_list|,
literal|"%s: undkind=%d, vundkind=%d, unddel=%d, undap1=%d, undap2=%d, dot=%d, dol=%d, unddol=%d, truedol=%d\n"
argument_list|,
name|s
argument_list|,
name|undkind
