...
name|ibuf
argument_list|,
literal|"sent data %ld bytes %ld.%02d secs"
argument_list|,
name|fbytes
argument_list|,
operator|(
...
name|ibuf
argument_list|,
literal|"received data %ld bytes %ld.%02d secs"
argument_list|,
name|fbytes
argument_list|,
operator|(
