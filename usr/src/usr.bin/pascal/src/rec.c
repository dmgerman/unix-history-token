...
expr_stmt|;
block|}
comment|/* 	     *	round the lengths of records up to their alignments 	     */
name|p
operator|->
name|value
index|[
...
directive|ifndef
name|PI0
comment|/* 	     * it used to be easy to keep track of offsets of fields 	     * and total sizes of records. 	     * but now, the offset of the field is aligned 	     * so only it knows it's offset, and calculating  	     * the total size of the record is based on it, 	     * rather than just the width of the field. 	     */
name|fp
operator|=
name|enter
argument_list|(
...
directive|ifndef
name|PI0
comment|/* 		     * and the size of the record is incremented. 		     */
name|p
operator|->
name|value
index|[
