...
include|#
directive|include
file|"/usr/src/new/pc0/p.a.out.h"
end_include
...
name|stderr
argument_list|,
literal|"[checksymbol] ->name %s ->n_type %x (%s)\n"
argument_list|,
name|nlp
operator|->
name|n_un
