...
expr_stmt|;
asm|asm("	bicpsw	$0xe0");
comment|/* disable overflow checks */
...
name|O_SUCC2
case|:
comment|/* Pi should be fixed to gen code for: 			 *	tl = *pc.cp++; 			 *	if (tl == 0) 			 *		tl = *pc.sp++; 			 *	tl1 = pop4(); 			 *	push2(SUCC(tl1, tl, *pc.sp++)); 			 */
name|pc
operator|.
name|cp
operator|++
...
name|O_SUCC24
case|:
comment|/* Pi should be fixed to gen code for: 			 *	tl = *pc.cp++; 			 *	if (tl == 0) 			 *		tl = *pc.sp++; 			 *	tl1 = pop4(); 			 *	push4(SUCC(tl1, tl, *pc.sp++)); 			 */
case|case
name|O_SUCC4
case|:
comment|/* Pi should be fixed to gen code for: 			 *	tl = *pc.cp++; 			 *	if (tl == 0) 			 *		tl = *pc.lp++; 			 *	tl1 = pop4(); 			 *	push4(SUCC(tl1, tl, *pc.lp++)); 			 */
name|pc
operator|.
name|cp
operator|++
...
name|O_PRED2
case|:
comment|/* Pi should be fixed to gen code for: 			 *	tl = *pc.cp++; 			 *	if (tl == 0) 			 *		tl = *pc.sp++; 			 *	tl1 = pop4(); 			 *	push2(PRED(tl1, tl, *pc.sp++)); 			 */
name|pc
operator|.
name|cp
operator|++
...
name|O_PRED24
case|:
comment|/* Pi should be fixed to gen code for: 			 *	tl = *pc.cp++; 			 *	if (tl == 0) 			 *		tl = *pc.sp++; 			 *	tl1 = pop4(); 			 *	push4(PRED(tl1, tl, *pc.sp++)); 			 */
case|case
name|O_PRED4
case|:
comment|/* Pi should be fixed to gen code for: 			 *	tl = *pc.cp++; 			 *	if (tl == 0) 			 *		tl = *pc.lp++; 			 *	tl1 = pop4(); 			 *	push4(PRED(tl1, tl, *pc.lp++)); 			 */
name|pc
operator|.
name|cp
operator|++
