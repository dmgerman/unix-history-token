...
name|w
argument_list|,
literal|"nwrite\tnwritec\tnupdate\tnupdlin\tnupdmis\tnmajlin\tnmajmis\n"
argument_list|)
expr_stmt|;
operator|(
name|void
...
name|w
argument_list|,
literal|"nsel\tnselz\tnsele\tnread\tnreadz\tnreade\tnreadc\n"
argument_list|)
expr_stmt|;
operator|(
name|void
...
name|w
argument_list|,
literal|"nwread\tnwreadz\tnwreade\tnwreadd\tnwreadc\tnwreadp\n"
argument_list|)
expr_stmt|;
operator|(
name|void
