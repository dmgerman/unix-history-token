...
index|[]
init|=
literal|"@(#)telnet.c	5.11 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
begin_block
block|{
comment|/* This shouldn't really be here... */
name|NET2ADD
argument_list|(
name|IAC
argument_list|,
...
literal|"autoflush"
block|,
literal|"toggle automatic flushing of output when sending interrupt characters"
block|,
literal|0
block|,
literal|1
...
literal|"\200"
block|,
literal|"The following need 'localsigs' to be toggled true"
block|,
literal|0
block|}
block|,
