...
begin_comment
comment|/* TRUE if should not print warning messages */
end_comment
...
begin_comment
comment|/*  * Three levels of compatibility. amMake incorporates backwards and oldVars,  * backwards incorporates oldVars.  */
end_comment
...
begin_comment
comment|/* Go all the way to backwards compatibility: 				 *	- Depth-first traversal of the graph 				 *	- No paralellism */
end_comment
...
begin_comment
comment|/* Go halfway to backwards compatibility: 				 *	- One shell per command */
end_comment
...
begin_comment
comment|/* Imitate System V make in anything weird */
end_comment

begin_comment
comment|/*  * Debug control:  *	There is one bit per module. It is up to the module what debug  *	information to print.  *	DEBUG(module) returns TRUE if debugging is on for that module.  */
end_comment
