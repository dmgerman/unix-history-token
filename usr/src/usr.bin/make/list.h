...
begin_comment
comment|/*  * list.h --  *  * Structures, macros, and routines exported by the List module.  *  * Copyright (C) 1985 Regents of the University of California  * All rights reserved.  *  * rcsid "$Id: list.h,v 2.1 89/07/03 15:56:45 adam Exp $ SPRITE (Berkeley)"  */
end_comment
