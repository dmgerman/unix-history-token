...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/kerberos/RCS/kerberos.c,v $  * $Author: bostic $  *  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
name|char
modifier|*
name|rcsid_kerberos_c
init|=
literal|"$Header: /usr/src/kerberosIV/kerberos/RCS/kerberos.c,v 4.21 91/02/25 15:40:32 bostic Exp Locker: bostic $"
decl_stmt|;
end_decl_stmt
...
argument_list|)
expr_stmt|;
comment|/* time has to be diddled */
if|if
condition|(
name|swap_bytes
condition|)
