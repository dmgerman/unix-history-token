...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/kerberos/RCS/kerberos.c,v $  * $Author: kfall $  *  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
init|=
literal|"$Header: /usr/src/kerberosIV/kerberos/RCS/kerberos.c,v 4.20 90/06/25 20:59:31 kfall Exp $"
decl_stmt|;
end_decl_stmt
