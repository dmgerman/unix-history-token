...
begin_comment
comment|/*  *  * $Source: /usr/src/kerberosIV/krb/RCS/get_in_tkt.c,v $  * $Author: kfall $  *  * Copyright 1987, 1988 by the Massachusetts Institute of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
specifier|static
name|char
name|rcsid_get_in_tkt_c
index|[]
init|=
literal|"$Header: /usr/src/kerberosIV/krb/RCS/get_in_tkt.c,v 4.13 90/06/23 03:10:32 kfall Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/get_in_tkt.c,v $  * $Author: kfall $  *  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  *  * This routine prints the supplied string to standard  * output as a prompt, and reads a password string without  * echoing.  */
end_comment
