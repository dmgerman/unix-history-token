...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/get_phost.c,v $  * $Author: kfall $  *  * Copyright 1988 by the Massachusetts Institute of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
name|rcsid_phost_c
init|=
literal|"$Header: /usr/src/kerberosIV/krb/RCS/get_phost.c,v 4.7 90/06/25 20:57:57 kfall Exp $"
decl_stmt|;
end_decl_stmt
