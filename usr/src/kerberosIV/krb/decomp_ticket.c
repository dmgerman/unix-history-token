...
begin_comment
comment|/*  * $Source: /mit/kerberos/src/lib/krb/RCS/decomp_ticket.c,v $  * $Author: jtkohl $  *  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
init|=
literal|"$Header: decomp_ticket.c,v 4.12 89/05/16 18:44:46 jtkohl Exp $"
decl_stmt|;
end_decl_stmt
