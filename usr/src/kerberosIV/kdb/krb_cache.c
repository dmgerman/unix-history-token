...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/kdb/RCS/krb_cache.c,v $  * $Author: jon $   *  * Copyright 1988 by the Massachusetts Institute of Technology.   *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  *  * This is where a cache would be implemented, if it were necessary.  */
end_comment
...
specifier|static
name|char
name|rcsid_krb_cache_c
index|[]
init|=
literal|"$Header: /usr/src/kerberosIV/kdb/RCS/krb_cache.c,v 4.5 1989/01/24 18:12:34 jon Exp $"
decl_stmt|;
end_decl_stmt
