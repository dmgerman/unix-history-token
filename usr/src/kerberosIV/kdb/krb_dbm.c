...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/kdb/RCS/krb_dbm.c,v $  * $Author: sklower $   *  * Copyright 1988 by the Massachusetts Institute of Technology.   *  * For copying and distribution information, please see the file  *<mit-copyright.h>.   */
end_comment
...
index|[]
init|=
literal|"$Header: /usr/src/kerberosIV/kdb/RCS/krb_dbm.c,v 4.12 92/12/01 11:52:19 sklower Exp $"
decl_stmt|;
end_decl_stmt
