...
begin_comment
comment|/*  *	$Source: /usr/src/kerberosIV/acl/RCS/acl_files.c,v $  *	$Author: bostic $  *  * Copyright 1987,1989 by the Massachusetts Institute of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  *  */
end_comment
...
specifier|static
name|char
name|rcsid_acl_files_c
index|[]
init|=
literal|"$Id: acl_files.c,v 4.6 91/02/25 15:11:48 bostic Exp $"
decl_stmt|;
end_decl_stmt
