...
begin_comment
comment|/*  *	$Source: /usr/src/kerberosIV/acl/RCS/acl_files.c,v $  *	$Author: kfall $  *  * Copyright 1987,1989 by the Massachusetts Institute of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  *  */
end_comment
...
index|[]
init|=
literal|"$Id: acl_files.c,v 4.5 90/06/25 20:58:42 kfall Exp $"
decl_stmt|;
end_decl_stmt
