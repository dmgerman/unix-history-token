...
index|[]
init|=
literal|"@(#)alloc.c	5.1 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
operator|)
expr_stmt|;
comment|/*  	** The following botch is because csh tries to free a free block 	** when processing the =~ or !~ operators. -- layer@ucbmonet 	*/
ifdef|#
directive|ifdef
name|CSHbotch
comment|/* was debug */
...
literal|0
expr_stmt|;
comment|/* assume smallest possible */
block|}
name|onb
operator|=
operator|(
...
name|printf
argument_list|(
literal|"Total in use: %d, total free: %d\n"
argument_list|,
name|totused
argument_list|,
name|totfree
