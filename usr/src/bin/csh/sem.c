...
name|printf
argument_list|(
literal|"execute: cmd=%s pid=%d t_dtyp=%s wanttty=%d "
argument_list|,
name|t
operator|->
name|t_dcom
...
name|printf
argument_list|(
literal|"%d unblocking sigchld after fork\n"
argument_list|,
name|getpid
argument_list|()
argument_list|)
...
name|printf
argument_list|(
literal|"(%d) last command - should unblock sigchld? (%d)\n"
argument_list|,
name|getpid
argument_list|()
argument_list|,
