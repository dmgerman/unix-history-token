...
name|items
parameter_list|)
value|{ \ 	sigset_t sigset, osigset;\ \ 	sigemptyset(&sigset);\ 	sigaddset(&sigset, SIGINT);\ 	sigprocmask(SIG_BLOCK,&sigset,&osigset);\ 	free_items(items);\ 	items = NULL;\ 	sigprocmask(SIG_SETMASK,&osigset, NULL);\ }
end_define
