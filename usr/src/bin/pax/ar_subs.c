...
index|[]
init|=
literal|"@(#)ar_subs.c	1.1 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
continue|continue;
block|}
comment|/* 		 * If the user asked for -Z they want a time check done after 		 * the name mod. 		 */
if|if
condition|(
name|Zflag
operator|&&
...
continue|continue;
block|}
comment|/* 		 * Non standard -Z flag. When the exisiting file is 		 * same age or newer skip 		 */
if|if
condition|(
name|Zflag
operator|&&
