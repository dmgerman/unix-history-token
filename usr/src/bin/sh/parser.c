...
begin_comment
comment|/*  * This routine is called to tell readtoken that we are at the beginning  * of a command, so newlines should be ignored and keywords should be  * checked for.  We munge things here rather than setting a flag for  * readtoken.  */
end_comment
