...
directive|endif
comment|/*  * The eval builtin.  Do you want clean, straight-forward semantics for  * your eval command?  If so, read on....  */
ifdef|#
directive|ifdef
name|ELIGANT
name|evalcmd
...
begin_comment
comment|/*  * If, on the other hand, you prefer downright bogus semantics in the  * name of compatibility, here it is...  */
end_comment
