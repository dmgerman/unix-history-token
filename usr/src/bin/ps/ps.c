...
name|printf
argument_list|(
literal|"%6x%4d%6u%6u%3d%4d%3d%5x%4d%5d"
argument_list|,
name|ap
operator|->
name|a_flag
...
name|sshdr
init|=
literal|"TTY User     SZ RSS  CPU  S      PID  "
decl_stmt|;
end_decl_stmt
...
argument_list|)
expr_stmt|;
comment|/* Once there was a "CCPU" field here.  Subsumed by -S now. */
name|printf
argument_list|(
literal|" %4.4s"
argument_list|,
