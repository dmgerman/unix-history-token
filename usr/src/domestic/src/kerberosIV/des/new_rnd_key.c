...
begin_comment
comment|/*  * $Source: /mit/kerberos/src/lib/des/RCS/new_rnd_key.c,v $  * $Author: jtkohl $  *  * Copyright 1988 by the Massachusetts Institute of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  *  * New pseudo-random key generator, using DES encryption to make the  * pseudo-random cycle as hard to break as DES.  *  * Written by Mark Lillibridge, MIT Project Athena  *  * Under U.S. law, this software may not be exported outside the US  * without license from the U.S. Commerce department.  */
end_comment
...
index|[]
init|=
literal|"$Header: new_rnd_key.c,v 4.1 89/01/22 13:13:31 jtkohl Exp $"
decl_stmt|;
end_decl_stmt
