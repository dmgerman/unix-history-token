...
index|[]
init|=
literal|"@(#)kvm_hp300.c	5.22 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
name|seterr
argument_list|(
literal|"out of memory (addr: %x nprocs = %d)"
argument_list|,
name|nl
index|[
name|X_NPROCS
...
name|stderr
argument_list|,
literal|"kvm_nlist: can't find following names:"
argument_list|)
expr_stmt|;
for|for
control|(
...
name|seterr
argument_list|(
literal|"vtophys: segment not valid (%x)"
argument_list|,
name|ste
argument_list|)
expr_stmt|;
