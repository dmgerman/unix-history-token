...
comment|/* 	 * frompcindex = pc pushed by jsr into self. 	 * In GCC the caller's stack frame has already been built so we 	 * have to chase a6 to find caller's raddr. 	 * NOTE: this assumes that all profiled routines use link/unlk. 	 */
