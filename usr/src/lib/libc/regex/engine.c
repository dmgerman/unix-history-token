...
begin_comment
comment|/*-  * Copyright (c) 1992 Henry Spencer.  * Copyright (c) 1992 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Henry Spencer of the University of Toronto.  *  * %sccs.include.redist.c%  *  *	@(#)engine.c	5.1 (Berkeley) %G%  */
end_comment
...
operator|)
expr_stmt|;
comment|/* do we need an expansion before looking at the char? */
if|if
condition|(
name|p
operator|==
...
name|atbol
decl_stmt|;
comment|/* at start or just after \n? (for BOL) */
name|int
name|ateol
decl_stmt|;
comment|/* just before \n or \0? (for EOL) */
...
name|OANY
case|:
comment|/* can't get past this either */
break|break;
case|case
name|OANYOF
case|:
...
name|OOR2
case|:
comment|/* propagate OCH_'s marking onward */
name|FWD
argument_list|(
name|st
argument_list|,
...
name|OBOL
case|:
comment|/* these are looked after by expand() */
case|case
name|OEOL
case|:
break|break;
