...
begin_comment
comment|/*-  * Copyright (c) 1992, 1993, 1994 Henry Spencer.  * Copyright (c) 1992, 1993, 1994  *	The Regents of the University of California.  All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Henry Spencer.  *  * %sccs.include.redist.c%  *  *	@(#)regexec.c	8.3 (Berkeley) %G%  */
end_comment
...
index|[]
init|=
literal|"@(#)regexec.c	8.3 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
