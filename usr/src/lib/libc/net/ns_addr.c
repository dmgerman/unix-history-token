...
begin_comment
comment|/*  * Copyright (c) 1986, 1993  *	The Regents of the University of California.  All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * J.Q. Johnson.  *  * %sccs.include.redist.c%  */
end_comment
