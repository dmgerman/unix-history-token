...
begin_comment
comment|/*  * Terminal driving and line formatting routines.  * Basic motion optimizations are done here as well  * as formatting of lines (printing of control characters,  * line numbering and the like).  *  * @(#)cr_put.c	1.5 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/*  * put out a newline appropriately, twice if necessary (uck)  */
end_comment
