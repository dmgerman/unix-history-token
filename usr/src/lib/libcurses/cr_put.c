...
begin_comment
comment|/*  * Terminal driving and line formatting routines.  * Basic motion optimizations are done here as well  * as formatting of lines (printing of control characters,  * line numbering and the like).  *  * 1/26/81 (Berkeley) @(#)cr_put.c	1.1  */
end_comment
