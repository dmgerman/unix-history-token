...
begin_comment
comment|/*  * Copyright (c) 1981 Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)curses.h	5.34 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/* Public: backward compatibility */
end_comment
