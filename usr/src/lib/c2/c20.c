...
index|[]
init|=
literal|"@(#)c20.c	4.6 (Berkeley) 8/11/83"
decl_stmt|;
end_decl_stmt
...
name|ap
expr_stmt|;
comment|/* last clause to avoid infinite loop on partial compiler droppings: 	L183:	jbr L179 	L191:	jbr L179 			casel r0,$0,$1 	L193:	.word L183-L193 			.word L191-L193 	L179:	ret */
if|if
condition|(
name|p1
operator|->
