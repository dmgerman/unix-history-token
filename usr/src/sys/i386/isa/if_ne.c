...
begin_comment
comment|/*-  * Copyright (c) 1990, 1991 William F. Jolitz.  * Copyright (c) 1990, 1993  *	The Regents of the University of California.  All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)if_ne.c	8.1 (Berkeley) %G%  */
end_comment
