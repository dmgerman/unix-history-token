...
name|printf
argument_list|(
literal|"should panic: no packet header\n"
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"hdr fucked, len %d should be %d\n"
argument_list|,
name|total
argument_list|,
name|m
