...
begin_comment
comment|/*-  * Copyright (c) 1990 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * William Jolitz.  *  * Added support for ibmpc term type and improved keyboard support. -Don Ahn  *  * %sccs.include.386.c%  *  *	@(#)pccons.c	5.2 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/* Theoretically there should be a slight delay between outb's  */
end_comment

begin_comment
comment|/* and if your display has cursor problems that may be it.      */
end_comment

begin_comment
comment|/* This may have to be left as is since it is done after every  */
end_comment

begin_comment
comment|/* char and can seriously affect performance .                  */
end_comment
...
begin_comment
comment|/* sput tries to do 16-bit writes.  This may not work on all.   */
end_comment
