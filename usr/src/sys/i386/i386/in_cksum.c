...
begin_comment
comment|/*-  * Copyright (c) 1990 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  * from tahoe:	in_cksum.c	1.2	86/01/05  *	@(#)in_cksum.c	7.1 (Berkeley) %G%  */
end_comment
