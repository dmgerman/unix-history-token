...
begin_comment
comment|/*-  * Copyright (c) 1982, 1987, 1990 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * William Jolitz.  *  * %sccs.include.redist.c%  *  *	@(#)machdep.c	7.12 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/*if (Maxmem> 6*1024/4) 		Maxmem = (1024+384) *1024 /NBPG;*/
end_comment
...
begin_comment
comment|/* reconcile against BIOS's recorded values in RTC 	 * we trust neither of them, as both can lie! 	 */
end_comment
...
name|printf
argument_list|(
literal|"bios base %d ext %d maxmem %d physmem %d\n"
argument_list|,
name|biosbasemem
argument_list|,
name|biosextmem
