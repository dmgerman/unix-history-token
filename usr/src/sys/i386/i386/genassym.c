...
begin_comment
comment|/*-  * Copyright (c) 1982, 1990, 1993  *	The Regents of the University of California.  All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * William Jolitz.  *  * %sccs.include.redist.c%  *  *	@(#)genassym.c	8.1 (Berkeley) %G%  */
end_comment
...
index|[]
init|=
literal|"@(#)genassym.c	8.1 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
