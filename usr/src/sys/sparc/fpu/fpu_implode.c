...
begin_comment
comment|/*  * Copyright (c) 1992 The Regents of the University of California.  * All rights reserved.  *  * This software was developed by the Computer Systems Engineering group  * at Lawrence Berkeley Laboratory under DARPA contract BG 91-66 and  * contributed to Berkeley.  *  * %sccs.include.redist.c%  *  *	@(#)fpu_implode.c	7.1 (Berkeley) %G%  *  * from: $Header: fpu_implode.c,v 1.4 92/06/17 05:41:33 torek Exp $  */
end_comment
...
directive|ifdef
name|sparc
comment|/* ``cheating'' (left out FPU_DECL_CARRY; know this is faster) */
name|FPU_ADDS
argument_list|(
name|m3
argument_list|,
