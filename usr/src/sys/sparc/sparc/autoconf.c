...
begin_comment
comment|/*  * Copyright (c) 1992, 1993  *	The Regents of the University of California.  All rights reserved.  *  * This software was developed by the Computer Systems Engineering group  * at Lawrence Berkeley Laboratory under DARPA contract BG 91-66 and  * contributed to Berkeley.  *  * All advertising materials mentioning features or use of this software  * must display the following acknowledgement:  *	This product includes software developed by the University of  *	California, Lawrence Berkeley Laboratory.  *  * %sccs.include.redist.c%  *  *	@(#)autoconf.c	8.2 (Berkeley) %G%  *  * from: $Header: autoconf.c,v 1.35 93/09/27 00:50:04 torek Exp $ (LBL)  */
end_comment
...
begin_comment
comment|/*  * Try to figure out where the PROM stores the cursor row& column  * variables.  Returns nonzero on error.  */
end_comment
...
index|]
decl_stmt|;
comment|/* 	 * line# and column# are global in older proms (rom vector< 2) 	 * and in some newer proms.  They are local in version 2.9.  The 	 * correct cutoff point is unknown, as yet; we use 2.9 here. 	 */
if|if
condition|(
name|promvec
operator|->
...
name|buf
argument_list|,
literal|"' line#>body>user %x ! ' column#>body>user %x !"
argument_list|,
name|rowp
argument_list|,
name|colp
...
name|buf
argument_list|,
literal|"stdout @ is my-self addr line# %x ! addr column# %x !"
argument_list|,
name|rowp
argument_list|,
name|colp
