...
begin_comment
comment|/*  * Copyright (c) 1992 The Regents of the University of California.  * All rights reserved.  *  * This software was developed by the Computer Systems Engineering group  * at Lawrence Berkeley Laboratory under DARPA contract BG 91-66 and  * contributed to Berkeley.  *  * All advertising materials mentioning features or use of this software  * must display the following acknowledgement:  *	This product includes software developed by the University of  *	California, Lawrence Berkeley Laboratory.  *  * %sccs.include.redist.c%  *  *	@(#)cache.c	7.5 (Berkeley) %G%  *  * from: $Header: cache.c,v 1.8 93/04/27 14:33:36 torek Exp $ (LBL)  */
end_comment

begin_comment
comment|/*  * Cache routines.  *  * TODO:  *	- fill in hardware assist for context and segment flush  *	- rework range flush  */
end_comment
...
begin_comment
comment|/*  * Flush the current context from the cache.  *  * This is done by writing to each cache line in the `flush context'  * address space.  */
end_comment
