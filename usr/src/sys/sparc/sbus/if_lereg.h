...
begin_comment
comment|/*-  * Copyright (c) 1982, 1992 Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)if_lereg.h	7.1 (Berkeley) %G%  *  * from: $Header: if_lereg.h,v 1.5 92/07/10 06:45:26 torek Exp $  */
end_comment
