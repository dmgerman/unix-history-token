...
begin_comment
comment|/*  * Copyright (c) 1988 University of Utah.  * Copyright (c) 1992 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * the Systems Programming Group of the University of Utah Computer  * Science Department, Ralph Campbell, Sony Corp. and Kazumasa Utashiro  * of Software Research Associates, Inc.  *  * %sccs.include.redist.c%  *  * from: Utah $Hdr: trap.c 1.32 91/04/06$  *  *	@(#)trap.c	7.1 (Berkeley) %G%  */
end_comment
...
directive|endif
comment|/* if (!strcmp(p->p_comm, "ftp")) printf("syscall: pid=%d, code=%d, pc=0x%x\n", p->p_pid, code, pc); */
name|rval
index|[
literal|0
index|]
