...
begin_comment
comment|/*  * Copyright (c) 1992, 1993  *	Regents of the University of California.  All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Ralph Campbell and Kazumasa Utashiro of Software Research  * Associates, Inc.  *  * %sccs.include.redist.c%  *  *	@(#)cpu.h	8.1 (Berkeley) %G%  */
end_comment
