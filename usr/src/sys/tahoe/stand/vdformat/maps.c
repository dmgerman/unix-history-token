...
index|[]
init|=
literal|"@(#)maps.c	1.1 (Berkeley/CCI) %G%"
decl_stmt|;
end_decl_stmt
...
name|print
argument_list|(
literal|"cyl %d, head %d, pos %d, len %d "
argument_list|,
name|bad_map
operator|->
name|list
...
begin_comment
comment|/* **	Vdload_free_table checks each block in the bad block relocation area ** to see if it is used. If it is, the free relocation block table is updated. */
end_comment
