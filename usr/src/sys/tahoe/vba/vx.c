...
name|vs_active
decl_stmt|;
comment|/* active port bit array or flag */
name|short
name|vs_state
decl_stmt|;
...
name|printf
argument_list|(
literal|"vx%d: vack interrupt from BOP\n"
argument_list|,
name|vx
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"vx%d INTR ERR type %x v_dcd %x\n"
argument_list|,
name|vx
argument_list|,
name|vp
