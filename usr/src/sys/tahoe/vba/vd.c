...
name|DONTCARE
expr_stmt|;
comment|/* generic 	sn = bp->b_blkno + lp->d_partitions[part].p_offset; */
name|sn
operator|=
operator|(
operator|(
...
name|printf
argument_list|(
literal|"dk%d%c: %s bn [%d-%d) (sn %d), status %b"
argument_list|,
name|unit
argument_list|,
name|partname
...
name|printf
argument_list|(
literal|"\n(error sec %d trk %d cyl %d wcount %d)"
argument_list|,
name|dcb
operator|->
name|err_sec
...
name|LOG_WARNING
argument_list|,
literal|"dk%d%c: soft error sn %d bn %d, status %b ecode %x\n"
argument_list|,
name|unit
argument_list|,
name|partname
...
name|LOG_WARNING
argument_list|,
literal|"dk%d%c: soft ecc sn %d bn %d\n"
argument_list|,
name|unit
argument_list|,
name|part
