...
operator|)
return|;
comment|/* this looks wrong... 		if (dcb->operrsta& (HCRCERR | HCMPERR | UCDATERR | 		    DSEEKERR | NOTCYLERR | DRVNRDY | INVDADR)) 	*/
if|if
condition|(
name|dcb
operator|->
