...
begin_comment
comment|/*  * Initialize the controller after a controller reset or during autoconfigure.  * All of the system control blocks are initialized and the controller is  * asked to configure itself for later use.  *  * If the print value is true cy_first_TM_attention will anounce  * the type of controller we are (Tapemasher) and will print the size  * of the internal controller buffer.  */
end_comment
...
name|printf
argument_list|(
literal|"yc%d: time-out during init\n"
argument_list|,
name|ctlr
argument_list|)
expr_stmt|;
