...
begin_comment
comment|/*  * ARPANET IMP interface driver.  *  * The IMP-host protocol is handled here, leaving  * hardware specifics to the lower level interface driver.  *  * NB: only handles IMPS on class A networks.  */
end_comment
...
name|AF_INET
expr_stmt|;
comment|/* host number filled in already, or filled in later */
name|sin
operator|->
name|sin_addr
operator|=
