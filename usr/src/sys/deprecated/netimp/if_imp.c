...
begin_comment
comment|/*  * Copyright (c) 1982, 1986 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)if_imp.c	7.3 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/*  * Restart output for a host that has timed out  * while waiting for a RFNM.  */
end_comment
