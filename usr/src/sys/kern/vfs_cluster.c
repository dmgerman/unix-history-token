...
begin_comment
comment|/*	vfs_cluster.c	4.39	82/11/13	*/
end_comment
...
begin_comment
comment|/*  * Expand or contract the actual memory allocated to a buffer.  */
end_comment
...
begin_block
block|{
comment|/* 	 * This stub is provided to allow the system to reclaim 	 * memory from the buffer pool. Currently we do not migrate 	 * memory between the buffer memory pool and the user memory 	 * pool. 	 */
name|bp
operator|->
name|b_bcount
operator|=
