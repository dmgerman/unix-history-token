...
begin_comment
comment|/*	vfs_cluster.c	4.38	82/10/17	*/
end_comment
...
name|printf
argument_list|(
literal|"sleeping on:dev 0x%x, blks %d-%d, flg 0%o allocing dev 0x%x, blks %d-%d, flg 0%o\n"
argument_list|,
name|ep
operator|->
name|b_dev
...
name|printf
argument_list|(
literal|"DELWRI:dev 0x%x, blks %d-%d, flg 0%o allocing dev 0x%x, blks %d-%d, flg 0%o\n"
argument_list|,
name|ep
operator|->
name|b_dev
