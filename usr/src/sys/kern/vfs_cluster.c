...
begin_comment
comment|/*	vfs_cluster.c	4.30	82/05/22	*/
end_comment

begin_comment
comment|/* merged into kernel:	 @(#)bio.c 2.3 4/8/82 */
end_comment
...
begin_comment
comment|/*  #ifndef	UNFAST #define	notavail(bp) \ { \ 	int x = spl6(); \ 	(bp)->av_back->av_forw = (bp)->av_forw; \ 	(bp)->av_forw->av_back = (bp)->av_back; \ 	(bp)->b_flags |= B_BUSY; \ 	splx(x); \ } #endif  /*  * Read in (if necessary) the block and return a buffer pointer.  */
end_comment
