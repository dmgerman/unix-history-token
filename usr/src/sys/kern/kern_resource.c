...
begin_comment
comment|/*-  * Copyright (c) 1982, 1986, 1991 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)kern_resource.c	7.19 (Berkeley) %G%  */
end_comment
...
name|s
decl_stmt|;
comment|/* Get a consistent picture, then do the computation. */
name|s
operator|=
name|splstatclock
argument_list|()
