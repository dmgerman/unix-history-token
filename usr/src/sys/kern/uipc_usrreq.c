...
begin_comment
comment|/*  * Copyright (c) 1982 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)uipc_usrreq.c	6.17 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/*  * We assign all buffering for stream sockets to the source,  * as that is where the flow control is implemented.  * Datagram sockets really use the sendspace as the maximum datagram size,  * and don't really want to reserve the sendspace.  Their recvspace should  * be large enough for at least one max-size datagram plus address.  */
end_comment
