...
begin_comment
comment|/*  * Copyright (c) 1987, 1991 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)kern_malloc.c	7.26 (Berkeley) %G%  */
end_comment
...
block|}
block|}
comment|/* 	 * Copy in known text to detect modification after freeing 	 * and to make it look free. 	 */
name|bcopy
argument_list|(
name|addrmask
argument_list|,
