...
begin_comment
comment|/*	vfs_lookup.c	6.3	83/12/03	*/
end_comment
...
expr_stmt|;
block|}
comment|/* 	 * Found component in pathname. 	 * If final component of path name, save information 	 * in the cache as to where the entry was found. 	 */
if|if
condition|(
operator|*
name|cp
...
expr_stmt|;
block|}
comment|/* 	 * Save directory entry in u.u_dent, 	 * and release directory buffer. 	 */
name|bcopy
argument_list|(
operator|(
name|caddr_t
