...
begin_comment
comment|/*	vfs_lookup.c	4.25	82/10/17	*/
end_comment
...
name|NULL
expr_stmt|;
comment|/* 	 * If deleting, and at end of pathname, return 	 * parameters which can be used to remove file. 	 * Note that in this case we return the directory 	 * inode, not the inode of the file being deleted. 	 */
if|if
condition|(
name|flag
operator|==
