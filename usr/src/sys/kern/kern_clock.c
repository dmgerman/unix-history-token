...
begin_comment
comment|/*-  * Copyright (c) 1982, 1986, 1991 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)kern_clock.c	7.21 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/*  * Notification of start of profiling clock  *  * Kernel profiling passes proc0 which never exits and hence  * keeps the profile clock running constantly.  */
end_comment
...
begin_comment
comment|/*  * Notification of stopping of profile clock  */
end_comment
