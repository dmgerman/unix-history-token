...
begin_comment
comment|/*-  * Copyright (c) 1982, 1986, 1991 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)kern_clock.c	7.27 (Berkeley) %G%  */
end_comment
...
return|;
block|}
comment|/* 	 * Copyout clockinfo structure. 	 */
name|clockinfo
operator|.
name|hz
operator|=
