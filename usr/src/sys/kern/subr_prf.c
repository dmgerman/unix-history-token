...
begin_comment
comment|/*-  * Copyright (c) 1986, 1988, 1991, 1993  *	The Regents of the University of California.  All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)subr_prf.c	8.2 (Berkeley) %G%  */
end_comment
