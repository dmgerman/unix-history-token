...
begin_comment
comment|/*  * Copyright (c) 1982, 1986 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)kern_synch.c	7.10 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/*  * Interruptable sleep.  * Sleeps on chan for time of at most timo/hz seconds (0 means no timeout).  * Returns 0 if awakened, EINTR if a signal needs to be delivered,  * or EWOULDBLOCK if the timeout expires.  */
end_comment
...
name|printf
argument_list|(
literal|"sleep called with pri> PZERO, wchan: %x\n"
argument_list|,
name|chan
argument_list|)
expr_stmt|;
