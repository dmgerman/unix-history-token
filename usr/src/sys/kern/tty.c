...
begin_comment
comment|/*  * Start output on the typewriter. It is used from the top half  * after some characters have been put on the output queue,  * from the interrupt routine to transmit the next  * character.  */
end_comment
