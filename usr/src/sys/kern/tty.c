...
begin_comment
comment|/*  * Copyright (c) 1982, 1986, 1990 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)tty.c	7.30 (Berkeley) %G%  */
end_comment
...
argument_list|)
condition|)
comment|/* XXX is this still needed? (drivers do it) */
return|return
operator|(
name|ERESTART
operator|)
