...
begin_comment
comment|/*  * Stubs to use when there is no locking to be done on the underlying object.  *  * Getting a lock just clears the interlock if necessary.  */
end_comment
...
begin_comment
comment|/*  * Unlock has nothing to do.  */
end_comment
...
begin_comment
comment|/*  * Nothing is ever locked.  */
end_comment
