...
begin_comment
comment|/*  * Copyright (c) 1989 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)vfs_subr.c	7.86 (Berkeley) %G%  */
end_comment
...
condition|)
block|{
comment|/* 		 * Note: these next two calls imply 		 * that vop_close and vop_inactive implementations 		 * cannot count on the ops vector being correctly 		 * set. 		 */
if|if
condition|(
name|flags
operator|&
