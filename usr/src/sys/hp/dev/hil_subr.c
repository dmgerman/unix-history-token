...
begin_comment
comment|/*-  * Copyright (c) 1988 University of Utah.  * Copyright (c) 1982, 1986, 1991, 1993  *	The Regents of the University of California.  All rights reserved.  *  * %sccs.include.proprietary.c%  *  * from: Utah $Hdr: hil_subr.c 1.1 91/11/19$  *  *	@(#)hil_subr.c	8.1 (Berkeley) %G%  */
end_comment
