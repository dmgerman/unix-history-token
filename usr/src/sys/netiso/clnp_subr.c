...
name|ro_dst
decl_stmt|;
comment|/* ptr to route's destination */
name|ro_dst
operator|=
operator|(
expr|struct
...
name|ifp
decl_stmt|;
comment|/* ptr to interface to send packet on */
name|struct
name|iso_addr
modifier|*
name|firsthop
decl_stmt|;
comment|/* ptr to first hop for packet */
block|{
specifier|register
name|struct
name|iso_ifaddr
...
name|printf
argument_list|(
literal|"clnp_srcaddr: isoa is %s\n"
argument_list|,
name|clnp_iso_addrp
argument_list|(
name|isoa
