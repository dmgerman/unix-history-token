...
begin_comment
comment|/*   * ARGO TP  *  * $Header: tp_trace.h,v 5.1 88/10/12 12:21:51 root Exp $  * $Source: /usr/argo/sys/netiso/RCS/tp_trace.h,v $  *	@(#)tp_trace.h	7.3 (Berkeley) 8/29/89 *  *  *   * Definitions needed for the protocol trace mechanism.  */
end_comment
