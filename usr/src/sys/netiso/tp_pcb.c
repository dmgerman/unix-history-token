...
begin_comment
comment|/*-  * Copyright (c) 1991 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)tp_pcb.c	7.14 (Berkeley) %G%  */
end_comment
...
parameter_list|(
function_decl|"tp_detach(freeing RTC list snduna 0x%x rcvnxt 0x%x)\n"
operator|,
function_decl|tpcb->tp_snduna_rtc
operator|,
function_decl|tpcb->tp_rcvnxt_rtc
end_function_decl
