...
begin_comment
comment|/*   * ARGO TP  *  * $Header: tp_output.c,v 5.4 88/11/18 17:28:08 nhall Exp $  * $Source: /usr/argo/sys/netiso/RCS/tp_output.c,v $  *	@(#)tp_output.c	7.5 (Berkeley) %G% *  *  * In here is tp_ctloutput(), the guy called by [sg]etsockopt(),  */
end_comment
