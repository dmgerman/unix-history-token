...
begin_comment
comment|/*  * Copyright (c) 1992 Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)tuba_subr.c	7.6 (Berkeley) %G%  */
end_comment
...
name|printf
argument_list|(
literal|"in_cksum for old TCP part is 0x%x\n"
argument_list|,
name|k1
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"in_cksum for ph(idx) is 0x%x\n"
argument_list|,
name|k2
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"in_cksum for ph + TCP is 0x%x\n"
argument_list|,
name|k3
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"in_cksum for new TCP part is 0x%x\n"
argument_list|,
name|k1
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"in_cksum for ph(EIDSUM) is 0x%x\n"
argument_list|,
name|k2
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"calculated in the funky way is 0x%x\n"
argument_list|,
name|k4
argument_list|)
expr_stmt|;
...
begin_comment
comment|/* XXX - to set breakpoints */
end_comment
