...
begin_comment
comment|/*  * $Header: iso.c,v 4.11 88/09/19 14:58:35 root Exp $   * $Source: /usr/argo/sys/netiso/RCS/iso.c,v $   *	@(#)iso.c	7.6 (Berkeley) %G%  *  * iso.c: miscellaneous routines to support the iso address family  */
end_comment
