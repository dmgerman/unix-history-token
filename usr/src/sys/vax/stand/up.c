...
begin_comment
comment|/* max number of bad bits accepted in 				 * a soft ecc error when F_ECCLM is set */
end_comment
...
condition|)
block|{
comment|/* 		 * if not in bad sector table, return 1 (= hard error) 		 */
name|up
operator|->
name|upcs1
operator|=
...
begin_comment
comment|/* this routine is common to up& hp, move to separate file */
end_comment
