...
begin_comment
comment|/*  * TODO:  *	- clean up the code for multisector transfers using  *	  a 'transfer in progress' flag  *	- Test Deleted Data read/write   *	- Test error handling/reporting and 'volume valid'  *	  handling.  *  * 	Note: If the drive subsystem is  * 	powered off at boot time, the controller won't interrupt!  */
end_comment
