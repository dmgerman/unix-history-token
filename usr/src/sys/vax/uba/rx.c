...
condition|)
block|{
comment|/* 		 * If the drive subsystem has been powered down, 		 * the rx211 controller must be initialized. 		 */
name|rxreset
argument_list|(
name|rxminfo
index|[
...
name|printf
argument_list|(
literal|"rxstart/r: tr=%d, sc=%d, bl=%d, cnt=%d\n"
argument_list|,
name|track
argument_list|,
name|sector
...
name|printf
argument_list|(
literal|"rxintr: dev=%d, state=0x%x, status=0x%x\n"
argument_list|,
name|unit
argument_list|,
name|rxc
