...
begin_comment
comment|/*  * Copyright (c) 1986 MICOM-Interlan, Inc., Foxborough Mass  *  * This software is furnished under a license and may only be used  * or copied in accordance with the terms of that license.  *  *	@(#)np.c	6.1 (Berkeley) %G%  */
end_comment
