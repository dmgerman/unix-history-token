...
begin_comment
comment|/*  * Copyright (c) 1987 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)uda.c	7.8 (Berkeley) %G%  *  */
end_comment
...
name|RDLABEL
expr_stmt|;
comment|/* 	 * Set up default sizes until we have the label, or longer 	 * if there is none.  Set secpercyl, as readdisklabel wants 	 * to compute b_cylin (although we do not need it). 	 */
name|lp
operator|->
name|d_secpercyl
operator|=
...
name|OPENRAW
expr_stmt|;
comment|/* uda_makefakelabel(ra, lp); */
endif|#
directive|endif
block|}
else|else
...
name|printf
argument_list|(
literal|"uda%d: attempt to bring ra%d on line failed: "
argument_list|,
name|ui
operator|->
name|ui_ctlr
...
name|ut_sizes
expr_stmt|;
comment|/* GET nsectors, ntracks, ncylinders FROM SAVED GEOMETRY? */
name|lp
operator|->
name|d_nsectors
operator|=
