...
argument_list|)
expr_stmt|;
comment|/* start uustart when */
comment|/* reset is done */
return|return;
block|}
name|top
label|:
...
begin_comment
comment|/*  * Simulate DMA input from the TU58,  * usually 128 bytes plus the 2 byte checksum  * will be read, leaving the CPU `dead' for   * approximately 0.135 seconds @ 9600 baud  */
end_comment
...
argument_list|()
expr_stmt|;
comment|/* make sure we don't get interrupted by */
comment|/* disk i/o */
name|uuaddr
operator|->
name|rcs
...
literal|0
expr_stmt|;
comment|/* disable interrupts temporarily */
while|while
condition|(
name|count
operator|--
