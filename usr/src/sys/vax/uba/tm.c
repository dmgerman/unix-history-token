...
begin_comment
comment|/*  * TM tape driver  *  * THIS HANDLES ONLY ONE DRIVE ON ONE CONTROLER, AS WE HAVE NO  * WAY TO TEST MULTIPLE TRANSPORTS.  */
end_comment
...
name|uprintf
argument_list|(
literal|"tape offline or protected\n"
argument_list|)
expr_stmt|;
return|return;
block|}
