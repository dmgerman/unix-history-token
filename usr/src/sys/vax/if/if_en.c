...
begin_comment
comment|/*  * Start a read operation.  */
end_comment
...
name|printf
argument_list|(
literal|"en%d (imp_read): not alive\n"
argument_list|,
name|ENUNIT
argument_list|(
name|dev
...
literal|600
expr_stmt|;
comment|/* a little extra to avoid hardware bugs */
name|addr
operator|->
name|en_istat
operator|=
