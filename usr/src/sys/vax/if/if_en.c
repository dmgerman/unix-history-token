...
begin_comment
comment|/*  * Set interface's Internet address  * given the network number.  The station  * number, taken from the on-board register,  * is used as the local part.  */
end_comment
