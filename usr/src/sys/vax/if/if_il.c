...
begin_comment
comment|/*  * Copyright (c) 1982 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)if_il.c	6.11 (Berkeley) %G%  */
end_comment
...
name|printf
argument_list|(
literal|"il%d failed hardware diag 0x%X\n"
argument_list|,
name|unit
argument_list|,
name|addr
