...
begin_comment
comment|/*  * The following generalizes the ifuba structure  * to an arbitrary number of receive and transmit  * buffers.  */
end_comment
