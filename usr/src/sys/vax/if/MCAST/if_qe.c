...
begin_comment
comment|/*  * Copyright (c) 1988 Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Digital Equipment Corp.  *  * %sccs.include.redist.c%  *  *	%W% (Berkeley) %G%  */
end_comment
...
name|setuplength
decl_stmt|;
comment|/* length of setup packet       */
endif|#
directive|endif
comment|/* MULTICAST */
name|int
...
comment|/* 			 * In case IFF_PROMISC or IFF_ALLMULTI has changed. 			 */
name|qesetup
argument_list|(
name|sc
argument_list|)
...
name|step
decl_stmt|;
comment|/* 		 * Step through our list of multicast addresses, putting them 		 * in the third through fourteenth address slots of the setup 		 * packet.  (See the DEQNA manual to understand the peculiar 		 * layout of the bytes within the setup packet.)  If we have 		 * too many multicast addresses, or if we have to listen to 		 * a range of multicast addresses, turn on reception of all 		 * multicasts. 		 */
name|sc
operator|->
name|setuplength
operator|=
