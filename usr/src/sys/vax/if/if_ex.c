...
begin_comment
comment|/*  * Copyright (c) 1982 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)if_ex.c	6.8 (Berkeley) %G%  */
end_comment
...
name|printf
argument_list|(
literal|"ex%d: HW %c.%c, NX %c.%c, addr %x.%x.%x.%x.%x.%x\n"
argument_list|,
name|ui
operator|->
name|ui_unit
...
name|printf
argument_list|(
literal|"ex%d: reset addr %x.%x.%x.%x.%x.%x\n"
argument_list|,
name|ui
operator|->
name|ui_unit
