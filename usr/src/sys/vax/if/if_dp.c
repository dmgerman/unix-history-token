...
begin_comment
comment|/*  * Copyright (c) 1990 Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)if_dp.c	7.4 (Berkeley) %G%  */
end_comment
...
name|dp_xt
decl_stmt|;
comment|/* start of last transmission */
name|char
name|dp_obuf
index|[
name|DP_MTU
...
argument_list|)
expr_stmt|;
comment|/* DP_ATA = 0, DP_CHRM = 0, 			    CRC = CCIIT, initially all ones, 2nd addr = 0 */
name|addr
operator|->
name|dpsar
operator|=
literal|0
expr_stmt|;
comment|/* enable receive interrupt */
name|addr
operator|->
name|dprcsr
operator|=
...
name|printf
argument_list|(
literal|"dp: len %d, start %x, end %x, first %x, next %x"
argument_list|,
name|len
argument_list|,
name|dp
