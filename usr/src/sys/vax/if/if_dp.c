...
begin_comment
comment|/*  * Copyright (c) 1990 Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)if_dp.c	7.9 (Berkeley) %G%  */
end_comment
...
name|DPF_X25UP
value|0x10
comment|/* XXX -- someday we'll do PPP also */
name|short
name|dp_ostate
decl_stmt|;
