...
begin_comment
comment|/*  * The memory address must be consecutive.  Any allocations   * not in order will cause problems on a VAX 780.  */
end_comment
...
begin_comment
comment|/* count of current memory number for ecprobe */
end_comment
