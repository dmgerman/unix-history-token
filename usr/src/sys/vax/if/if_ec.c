...
begin_comment
comment|/*  * Called by localnet interface to allow logical  * host interface to "attach", it's purpose  * is simply to establish the host's arpanet address.  */
end_comment
