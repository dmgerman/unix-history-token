...
begin_comment
comment|/*  * Copyright (c) 1982 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)machdep.c	6.19 (Berkeley) %G%  */
end_comment
...
directive|if
name|VAX8600
comment|/* 	 * Enable Fbox on 8600 if it exists 	 */
if|if
condition|(
operator|(
name|cpu
