...
begin_comment
comment|/*  * Copyright (c) 1982,1986 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)autoconf.c	7.5.1.1 (Berkeley) %G%  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* 	 * Allocate and initialize space 	 * for the UNIBUS interrupt vectors. 	 * On the 8600, can't use UNIvec; 	 * the vectors for the second SBI overlap it. 	 */
if|#
directive|if
name|VAX8600
if|if
