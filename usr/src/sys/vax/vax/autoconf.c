...
begin_comment
comment|/*  * Copyright (c) 1982,1986 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)autoconf.c	6.26 (Berkeley) %G%  */
end_comment
...
directive|if
name|VAX630
comment|/* 	 * Kludge time again. The q22 memory and device reg. address spaces 	 * are not physically contiguous, so we need 2 loops to map them 	 * into contiguous virtual space. 	 */
if|if
condition|(
name|cpu
operator|==
