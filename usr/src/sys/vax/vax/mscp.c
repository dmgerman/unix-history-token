...
begin_comment
comment|/*  * Copyright (c) 1987 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)mscp.c	1.1 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/*  * Decode and print an MSCP media ID.  It is made up of five 5-bit  * `characters' and 7 bits of numeric information.  BITS(i)  * selects character i's bits; CHAR returns the corresponding  * character.  */
end_comment
