...
literal|0
condition|)
comment|/* 0 as third arg means don't wait */
name|htcommand
argument_list|(
name|dev
argument_list|,
...
begin_comment
comment|/*  * Do a non-data-transfer command.  *  * N.B.: Count should be zero ONLY for rewind during close.  */
end_comment
...
begin_comment
comment|/*  * data transfer interrupt - must be read or write  */
end_comment
