...
begin_comment
comment|/*  * Copyright (c) 1982, 1986 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)hp.c	7.8 (Berkeley) %G%  */
end_comment
...
name|LOG_INFO
argument_list|,
literal|"hp%d%c: %d retries %sing sn%d\n"
argument_list|,
name|hpunit
argument_list|(
name|bp
