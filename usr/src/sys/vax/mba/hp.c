...
begin_comment
comment|/*  * Copyright (c) 1982 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)hp.c	6.10 (Berkeley) %G%  */
end_comment
...
name|printf
argument_list|(
literal|"hperr: bp %x cyl %d blk %d pgdone %d as %o "
argument_list|,
name|bp
argument_list|,
name|bp
