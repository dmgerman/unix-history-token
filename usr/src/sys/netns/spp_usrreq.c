...
begin_comment
comment|/*  * Copyright (c) 1984, 1985, 1986, 1987 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)spp_usrreq.c	7.3 (Berkeley) %G%  */
end_comment
...
return|;
block|}
comment|/* 		 * Fill in mbuf with extended SP header 		 * and addresses and length put into network format. 		 * Allign beginning of packet to long to prepend 		 * ifp's on loopback, or NSIP encaspulation for fussy cpu's. 		 */
name|m
operator|->
name|m_off
operator|=
