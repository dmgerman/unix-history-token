...
begin_comment
comment|/*  * Constants to differentiate between a breakpoint trap and all others.  */
end_comment

begin_define
define|#
directive|define
name|MACH_OTHER_TRAP_TYPE
value|0
end_define
