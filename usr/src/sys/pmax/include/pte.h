...
begin_comment
comment|/*  * Copyright (c) 1988 University of Utah.  * Copyright (c) 1992 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * the Systems Programming Group of the University of Utah Computer  * Science Department and Ralph Campbell.  *  * %sccs.include.redist.c%  *  * from: Utah $Hdr: pte.h 1.11 89/09/03$  *  *	@(#)pte.h	7.1 (Berkeley) %G%  */
end_comment
...
parameter_list|)
define|\
value|((kvtopte(va)->pt_entry& PG_FRAME) | ((unsigned)(va)& PGOFSET))
end_define
