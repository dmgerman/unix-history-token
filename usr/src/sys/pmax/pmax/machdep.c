...
begin_comment
comment|/*  * Copyright (c) 1988 University of Utah.  * Copyright (c) 1992 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * the Systems Programming Group of the University of Utah Computer  * Science Department, The Mach Operating System project at  * Carnegie-Mellon University and Ralph Campbell.  *  * %sccs.include.redist.c%  *  *	@(#)machdep.c	7.12 (Berkeley) %G%  */
end_comment
...
operator|>
literal|0
comment|/* 	 * Grab 128K at the top of physical memory for the lance chip 	 * on machines where it does dma through the I/O ASIC. 	 */
if|if
condition|(
name|pmax_boardtype
operator|==
...
expr_stmt|;
comment|/* take all chips out of reset now */
operator|*
name|ssr
operator|=
literal|0x00000f00
