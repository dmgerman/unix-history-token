...
begin_comment
comment|/*   * Copyright (c) 1992 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * the Systems Programming Group of the University of Utah Computer  * Science Department and Ralph Campbell.  *  * %sccs.include.redist.c%  *  *	@(#)pmap.c	7.6 (Berkeley) %G%  */
end_comment
...
name|printf
argument_list|(
literal|"found va %x pa %x in pv_table but != %x %x\n"
argument_list|,
name|va
argument_list|,
name|pa
