...
begin_comment
comment|/*-  * Copyright (c) 1992 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Ralph Campbell and Rick Macklem.  *  * %sccs.include.redist.c%  *  *	@(#)dtop.c	7.2 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/*  * Timeout routine to do autorepeat.  */
end_comment
...
begin_comment
comment|/*  * See if an autorepeat is required.  */
end_comment
