...
begin_comment
comment|/*-  * Copyright (c) 1992 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Ralph Campbell and Rick Macklem.  *  * %sccs.include.redist.c%  *  *	@(#)scc.c	7.1 (Berkeley) %G%  */
end_comment
...
name|printf
argument_list|(
literal|"sccPutc: timeout waiting for TRDY\n"
argument_list|)
expr_stmt|;
else|else
name|SCC_WRITE_DATA
