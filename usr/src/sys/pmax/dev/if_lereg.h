...
begin_comment
comment|/*  * Copyright (c) 1992 Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Ralph Campbell.  *  * %sccs.include.redist.c%  *  *	@(#)if_lereg.h	7.1 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/*  * Overlayed on 64Kbyte dual-port RAM.  * Currently 32 * 1518 receive plus 8 * 1518 transmit buffers plus  * buffer descriptor rings.  */
end_comment
