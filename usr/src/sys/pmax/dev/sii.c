...
name|cntr
parameter_list|)
value|{	\ 		register unsigned tmp = reg;			\ 		for (cntr = 0; cntr< spincount; cntr++) {	\ 			while (tmp != (var = reg))		\ 				tmp = var;			\ 			if (expr)				\ 				break;				\ 			if (cntr>= 100)			\ 				DELAY(100);			\ 		}						\ 	}
end_define
...
name|printf
argument_list|(
literal|"sii_StartCmd: doing extended msg\n"
argument_list|)
expr_stmt|;
comment|/* XXX */
...
name|printf
argument_list|(
literal|"sii%d: device %d: unexpected DNE\n"
argument_list|,
name|sc
operator|-
name|sii_softc
...
name|printf
argument_list|(
literal|"sii_DoIntr: emsg in ds %x cnt %d\n"
argument_list|,
name|dstat
argument_list|,
name|i
...
name|printf
argument_list|(
literal|"sii: ds %x cm %x i %d lotc %d\n"
argument_list|,
name|dstat
argument_list|,
name|comm
...
argument_list|()
expr_stmt|;
comment|/* wait for XFER complete */
name|SII_WAIT_UNTIL
argument_list|(
name|dstat
argument_list|,
...
name|printf
argument_list|(
literal|"sii%d: device %d: couldn't handle message 0x%x... ignoring.\n"
argument_list|,
name|sc
operator|-
name|sii_softc
...
name|printf
argument_list|(
literal|"sii_GetByte: DNE cs %x ds %x cm %x\n"
argument_list|,
name|regs
operator|->
name|cstat
...
argument_list|()
expr_stmt|;
comment|/* return one byte of data (optimized CopyFromBuffer()) */
return|return
operator|(
operator|*
operator|(
...
name|printf
argument_list|(
literal|"sii_DoSync: per %d req/ack %d\n"
argument_list|,
name|sii_buf
index|[
literal|3
...
literal|3
expr_stmt|;
comment|/* SII chip can only handle 3 max */
name|sii_buf
index|[
literal|0
index|]
...
name|printf
argument_list|(
literal|"target %d cs %x ds %x cm %x msg %x\n"
argument_list|,
name|lp
operator|->
name|target
