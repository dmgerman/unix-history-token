...
directive|ifdef
name|notdef
comment|/* 	 * Want to generate a message, but lower 	 * layers assume they can free up a message 	 * in the event of an error.  This causes 	 * the call to icmp_error to work on ``freed'' 	 * mbuf's, and worse. 	 */
name|type
operator|=
name|ICMP_UNREACH
operator|,
