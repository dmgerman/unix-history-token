...
begin_comment
comment|/*	tcp_output.c	4.21	81/12/02	*/
end_comment
...
expr_stmt|;
block|}
comment|/* 	 * Set retransmit timer if not currently set. 	 * Initial value for retransmit timer to tcp_beta*tp->t_srtt, 	 * with a minimum of TCPTV_MIN and a max of TCPTV_MAX. 	 * Initialize shift counter which is used for exponential 	 * backoff of retransmit time. 	 */
if|if
condition|(
name|tp
operator|->
