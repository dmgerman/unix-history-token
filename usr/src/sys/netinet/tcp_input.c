...
begin_comment
comment|/*	tcp_input.c	1.49	82/01/17	*/
end_comment
...
name|printf
argument_list|(
literal|"oobdata cp[2] %d iobseq %d seq %d\n"
argument_list|,
name|cp
index|[
literal|2
...
name|printf
argument_list|(
literal|"take oob data %x input iobseq now %x\n"
argument_list|,
name|tp
operator|->
name|t_iobc
...
name|printf
argument_list|(
literal|"take oob ack %x and cancel rexmt\n"
argument_list|,
name|cp
index|[
literal|2
