...
begin_comment
comment|/*  * Copyright (c) 1982 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)ip_icmp.c	6.15 (Berkeley) %G%  */
end_comment
...
argument_list|)
decl_stmt|;
comment|/* 		 * Retrieve any source routing from the incoming packet 		 * and strip out other options.  Adjust the IP 		 * and mbuf lengths.  The length of the options is added 		 * to the mbuf here, as it was already subtracted 		 * in icmp_input, and ip_stripoptions will subtract it again. 		 * Adjust the mbuf offset to point to the new location 		 * of the icmp header. 		 */
name|opts
operator|=
name|ip_srcroute
argument_list|()
