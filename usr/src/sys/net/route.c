...
begin_comment
comment|/*  * Copyright (c) 1980, 1986, 1991 Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)route.c	7.29 (Berkeley) %G%  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* rt_missmsg((req == RTM_ADD ? RTM_OLDADD : RTM_OLDDEL),&(entry->rt_dst),&(entry->rt_gateway), 		   netmask, SA(0), entry->rt_flags, error); */
return|return
operator|(
name|error
operator|)
