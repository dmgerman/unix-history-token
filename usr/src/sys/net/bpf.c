...
begin_comment
comment|/*-  * Copyright (c) 1991 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from the Stanford/CMU enet packet filter,  * (net/enet.c) distributed as part of 4.3BSD, and code contributed  * to Berkeley by Steven McCanne of Lawrence Berkeley Laboratory.  *  * %sccs.include.redist.c%  *  *	@(#)bpf.c	7.1 (Berkeley) %G%  *  * static char rcsid[] =  * "$Header: bpf.c,v 1.23 91/01/30 18:22:13 mccanne Exp $";  */
end_comment
...
name|panic
argument_list|(
literal|"bpf_detachd: ifpromisc failed"
argument_list|)
expr_stmt|;
block|}
...
begin_comment
comment|/*   * Set d's packet filter program to 'fp'.  If 'd' already has a filter,  * free it and replace it.  Returns EINVAL for bogus requests.  */
end_comment
...
begin_comment
comment|/*  * Length of ethernet and TCP/IP header with no IP options.  */
end_comment
