...
begin_comment
comment|/*  * Copyright (c) 1988 University of Utah.  * Copyright (c) 1982, 1990 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * the Systems Programming Group of the University of Utah Computer  * Science Department.  *  * %sccs.include.redist.c%  *  * from: Utah $Hdr: srt0.c 1.12 91/04/25$  *  *	@(#)srt0.c	7.4 (Berkeley) %G%  */
end_comment
...
name|internal
name|address
comment|/*  * If this is a reboot, extract howto/devtype stored by kernel  */
name|boottype
continue|:
name|cmpw
continue|#12
