...
begin_comment
comment|/*  * Copyright (c) 1988 University of Utah.  * Copyright (c) 1990 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * the Systems Programming Group of the University of Utah Computer  * Science Department.  *  * %sccs.include.redist.c%  *  * from: Utah $Hdr: autoconf.c 1.9 89/10/07$  *  *	@(#)autoconf.c	7.3 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/*  * Probe all DIO select codes (0 - 32), the internal display address,.  * and DIO-II select codes 132 (hack) and 133 (hack).  *  * Note that we only care about displays, SCSIs and HP-IBs.  */
end_comment
...
expr_stmt|;
block|}
comment|/* 	 * Look for displays in DIO-II space 	 */
for|for
control|(
name|sc
operator|=
