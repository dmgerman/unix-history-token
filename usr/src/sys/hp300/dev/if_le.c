...
begin_comment
comment|/*  * Copyright (c) 1982, 1990 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)if_le.c	7.10 (Berkeley) %G%  */
end_comment
...
name|sc_tmd
decl_stmt|;
comment|/* predicted next tmd to process */
name|int
name|sc_txcnt
decl_stmt|;
comment|/* transmissions in progress */
name|int
name|sc_txbad
decl_stmt|;
name|int
