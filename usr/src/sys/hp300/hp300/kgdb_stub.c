...
parameter_list|)
define|\
value|(kgdb_copy((u_char *)((fp)->f_regs), (u_char *)(regs), REGISTER_BYTES))
end_define
...
parameter_list|)
define|\
value|(kgdb_copy((u_char *)(regs), (u_char *)((fp)->f_regs), REGISTER_BYTES))
end_define
