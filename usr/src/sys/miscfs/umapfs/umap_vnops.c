...
begin_comment
comment|/*  * Copyright (c) 1992, 1993  *	The Regents of the University of California.  All rights reserved.  *  * This code is derived from software donated to Berkeley by  * the UCLA Ficus project.  *  * %sccs.include.redist.c%  *  *	@(#)umap_vnops.c	8.5 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/*  * We need to verify that we are not being vgoned and then clear  * the interlock flag as it applies only to our vnode, not the  * vnodes below us on the stack.  */
end_comment
