...
name|vprint
argument_list|(
literal|"umap_node_alloc targetvp"
argument_list|,
name|targetvp
argument_list|)
expr_stmt|;
...
begin_comment
comment|/*  * NEEDSWORK:  The ability to set lowervp to umap here  * implies that one can never count on lowervp staying umap  * (even if vp is locked).  This seems quite bad.  Think  * about these things.  */
end_comment
...
name|vprint
argument_list|(
literal|"umap_flushmp: would vrele"
argument_list|,
name|vp
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"umap_node: vrele'd %d aliases\n"
argument_list|,
name|i
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"umap_node_find(%x): found (%x,%x)->%x\n"
argument_list|,
name|targetvp
argument_list|,
name|mp
