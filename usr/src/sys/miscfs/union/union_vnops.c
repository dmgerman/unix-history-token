...
begin_comment
comment|/*  * Copyright (c) 1992, 1993, 1994 The Regents of the University of California.  * Copyright (c) 1992, 1993, 1994 Jan-Simon Pendry.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Jan-Simon Pendry.  *  * %sccs.include.redist.c%  *  *	@(#)union_vnops.c	1.3 (Berkeley) %G%  */
end_comment
...
name|panic
argument_list|(
literal|"union: locking agsinst myself"
argument_list|)
expr_stmt|;
endif|#
directive|endif
