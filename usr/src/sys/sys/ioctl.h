...
begin_comment
comment|/*  * Copyright (c) 1982 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)ioctl.h	6.15 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/* protocol i/o controls (bbn) */
end_comment
...
begin_comment
comment|/* tcp: set no activity timer */
end_comment
...
begin_comment
comment|/* rdp: set max #dgrams rcv */
end_comment
...
begin_comment
comment|/* rdp: get max #dgrams rcv */
end_comment
...
begin_comment
comment|/* rdp: ~set KEEPALIVE timer */
end_comment
...
begin_comment
comment|/* rdp: ~get KEEPALIVE timer */
end_comment
...
begin_comment
comment|/* set rxmit took too long */
end_comment
...
begin_comment
comment|/* get rxmit took too long */
end_comment
