...
begin_comment
comment|/*  * Copyright (c) 1993, 1982198519861988  *	The Regents of the University of California.  All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)socket.h	8.1 (Berkeley) %G%  */
end_comment
