...
begin_comment
comment|/*  * Copyright (c) 1982, 1986 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)map.h	7.2 (Berkeley) 6/6/87  */
end_comment
...
comment|/* we use m_name when the map overflows, in warning messages */
block|}
struct|;
end_struct
...
name|m_addr
decl_stmt|;
comment|/* resource-space addr of start of segment */
block|}
struct|;
end_struct
