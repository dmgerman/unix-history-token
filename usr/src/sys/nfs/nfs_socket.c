...
begin_comment
comment|/*  * Copyright (c) 1989, 1991 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Rick Macklem at The University of Guelph.  *  * %sccs.include.redist.c%  *  *	@(#)nfs_socket.c	7.24 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/*  * Generate a hash code for an iso host address. Used by NETADDRHASH() for  * iso addresses.  */
end_comment
