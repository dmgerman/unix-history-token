...
begin_comment
comment|/*  * Copyright (c) 1982, 1986, 1989, 1993  *	The Regents of the University of California.  All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)ufs_vnops.c	8.5 (Berkeley) %G%  */
end_comment
...
name|panic
argument_list|(
literal|"ufs_strategy: bad blkno %d != %d"
argument_list|,
name|bp
operator|->
name|b_blkno
...
argument_list|)
expr_stmt|;
comment|/* If this is a clustered block, check sub-blocks as well */
if|if
condition|(
name|bp
operator|->
...
name|panic
argument_list|(
literal|"ufs_strategy: bad bno %d != %d"
argument_list|,
name|bp
operator|->
name|b_blkno
...
name|panic
argument_list|(
literal|"ufs_startegy: write unallocated block"
argument_list|)
expr_stmt|;
else|else
name|clrbuf
