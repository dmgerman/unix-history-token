...
begin_comment
comment|/*  * Copyright (c) 1982, 1986, 1989 Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)ffs_vnops.c	7.51 (Berkeley) %G%  */
end_comment
...
block|}
block|}
comment|/* 		 * Add our lock to the blocked 		 * list and sleep until we're free. 		 */
ifdef|#
directive|ifdef
name|LOCKF_DEBUG
if|if
...
name|lf_print
argument_list|(
literal|"ufs_advlock: blocking on"
argument_list|,
name|block
argument_list|)
expr_stmt|;
...
directive|endif
comment|/* LOCKF_DEBUG */
comment|/* 		 * Remember who blocked us (for deadlock detection) 		 */
name|lock
operator|->
name|lf_next
operator|=
...
begin_comment
comment|/*  * Remove a byte-range lock on an inode.  */
end_comment
...
directive|endif
comment|/* LOCKF_DEBUG */
comment|/* 	 * Generally, find the lock (or an overlap to that lock) 	 * and remove it (or shrink it), then wakeup anyone we can. 	 */
name|blocklist
operator|=
name|lf_remove
argument_list|(
...
begin_comment
comment|/*  * Return the blocking pid  */
end_comment
