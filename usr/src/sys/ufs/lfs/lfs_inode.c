...
begin_comment
comment|/*  * Copyright (c) 1982, 1986, 1989 Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)lfs_inode.c	7.41 (Berkeley) %G%  */
end_comment
...
directive|else
comment|/* LFS IMPLEMENT -- lfs_itrunc */
name|panic
argument_list|(
literal|"lfs_itrunc not implemented"
argument_list|)
expr_stmt|;
endif|#
directive|endif
