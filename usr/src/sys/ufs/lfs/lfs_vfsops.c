...
begin_comment
comment|/*  * Copyright (c) 1989, 1991 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)lfs_vfsops.c	7.64 (Berkeley) %G%  */
end_comment
...
begin_comment
comment|/* XXX Why not just lfs_vget?? */
end_comment
