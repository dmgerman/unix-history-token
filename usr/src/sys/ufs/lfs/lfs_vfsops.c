...
begin_comment
comment|/*  * Copyright (c) 1989, 1991 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)lfs_vfsops.c	7.57 (Berkeley) %G%  */
end_comment
...
directive|else
comment|/* LFS IMPLEMENT -- read only access, super-block update */
name|panic
argument_list|(
literal|"lfs_sync not implemented"
argument_list|)
expr_stmt|;
operator|*
operator|/
...
decl_stmt|;
block|{
comment|/* LFS IMPLEMENT -- sbupdate */
name|panic
argument_list|(
literal|"sbupdate not implemented"
argument_list|)
expr_stmt|;
block|}
