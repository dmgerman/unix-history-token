...
begin_comment
comment|/*  * Copyright (c) 1991 Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)lfs_segment.c	5.3 (Berkeley) %G%  */
end_comment
...
name|calc_next
decl_stmt|;
comment|/* If 1 calculate next, else set to -1. */
block|{
name|BUF
modifier|*
name|bp
...
literal|1
expr_stmt|;
comment|/* 	 * XXX 	 * I don't understand how sum_num works; the 0 base seems wrong. 	 */
name|nsums_per_blk
operator|=
name|fs
operator|->
...
argument_list|)
expr_stmt|;
comment|/* Bump the segment count. */
name|fs
operator|->
name|lfs_nextseg
operator|=
...
name|bpp
expr_stmt|;
comment|/* 	 * XXX 	 * Why isn't this (sp->sum_num + nsum_pb - 1) / nsum_pb; 	 */
name|nsegsums
operator|=
literal|1
operator|+
