...
name|a_dvp
decl_stmt|;
comment|/* saved for one special case */
name|bp
operator|=
name|NULL
expr_stmt|;
...
comment|/* 		 * The borrowing of variables 		 * here is somewhat confusing.  Usually, ap->a_dvp/dp 		 * is the directory being searched. 		 * Here it's the target returned from the cache. 		 */
name|pdp
operator|=
name|dp
expr_stmt|;
