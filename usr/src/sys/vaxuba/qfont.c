...
begin_comment
comment|/*  * Copyright (c) 1982, 1986 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  * 		@(#)qfont.c	1.3  Berkeley  6/3/88  *  *	derived from:  "@(#)qfont.c	6.2	ULTRIX	2/4/88"  */
end_comment
