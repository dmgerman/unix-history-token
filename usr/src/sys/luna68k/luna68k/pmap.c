...
begin_comment
comment|/*   * Copyright (c) 1992 OMRON Corporation.  * Copyright (c) 1991 Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * the Systems Programming Group of the University of Utah Computer  * Science Department.  *  * %sccs.include.redist.c%  *  *	OMRON: $Id: pmap.c,v 1.2 92/06/14 06:19:40 moti Exp $  *  * from: hp300/hp300/pmap.c	7.11 (Berkeley) 7/12/92  *  *	@(#)pmap.c	7.2 (Berkeley) %G%  */
end_comment

begin_comment
comment|/*  *	LUNA physical map management code taken from:  *	HP9000/300 series physical map management code.  *  *	XXX will only work for PAGE_SIZE == NBPG (i.e. 4096 bytes).  *	Hence, there is no point in defining DYNPGSIZE.  */
end_comment
...
begin_comment
comment|/* PAGE_SIZE / LUNA_PAGE_SIZE */
end_comment
...
begin_comment
comment|/* LUNA: io mapping information */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* 	 * If this fails it is probably because the static portion of 	 * the kernel page table isn't big enough and we overran the 	 * page table map.   Need to adjust pmap_size() in luna_init.c. 	 */
if|if
condition|(
name|addr
operator|!=
...
name|validate
label|:
comment|/* 	 * Now validate mapping with desired protection/wiring. 	 * Assume uniform modified and referenced status for all 	 * LUNA pages in a MACH page. 	 */
name|npte
operator|=
operator|(
name|pa
