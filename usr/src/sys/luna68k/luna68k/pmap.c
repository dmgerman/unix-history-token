...
begin_comment
comment|/*   * Copyright (c) 1992 OMRON Corporation.  * Copyright (c) 1991 Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * the Systems Programming Group of the University of Utah Computer  * Science Department.  *  * %sccs.include.redist.c%  *  *	OMRON: $Id: pmap.c,v 1.2 92/06/14 06:19:40 moti Exp $  *  * from: hp300/hp300/pmap.c	7.9 (Berkeley) 6/5/92  *  *	@(#)pmap.c	7.1 (Berkeley) %G%  */
end_comment
