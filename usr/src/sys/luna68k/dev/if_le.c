...
begin_comment
comment|/*  * Copyright (c) 1982, 1990 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  * from: hp300/dev/if_le.c	7.12 (Berkeley) 7/6/92  *  *	@(#)if_le.c	7.2 (Berkeley) %G%  */
end_comment
