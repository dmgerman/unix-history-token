...
begin_comment
comment|/*  * six-byte packet header for asynch lines.  * headers for other devices take up the same  * or less space.  If this changes the header  * struct will have to become a union.  */
end_comment
...
name|ksize
decl_stmt|;
comment|/* encoded packet size */
name|unsigned
name|short
name|sum
decl_stmt|;
comment|/* block check of data packet */
name|char
name|cntl
decl_stmt|;
...
begin_comment
comment|/*  * Control structure for a packet driver connection.  */
end_comment
...
name|p_ipool
decl_stmt|;
comment|/* head link to input buffer pool */
name|char
modifier|*
modifier|*
name|p_io
decl_stmt|;
comment|/* input buffer given to driver */
name|char
name|p_xcount
decl_stmt|;
