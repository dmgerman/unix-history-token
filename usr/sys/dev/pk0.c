...
begin_comment
comment|/*  * Send RJ message on first framing error.  * Cleared by receiving a good frame   * (pkcntl or pkdata).  */
end_comment
...
begin_comment
comment|/*  * Look at sequence numbers (mostly).  */
end_comment
