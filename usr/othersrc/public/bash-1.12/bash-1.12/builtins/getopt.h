...
begin_comment
comment|/* getopt () stores the last character processed as an option here just    before returning. */
end_comment
...
begin_function_decl
name|void
name|getopt_set_posix_option_order
parameter_list|(
name|int
name|on_or_off
parameter_list|)
