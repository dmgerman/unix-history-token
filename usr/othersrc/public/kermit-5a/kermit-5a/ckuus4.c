...
name|printf
argument_list|(
literal|" TCP/IP (sockets library)\n"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
name|printf
argument_list|(
literal|"Active SET HOST connection:\n"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|printf
argument_list|(
literal|" Dial hangup: %s, dial timeout: "
argument_list|,
name|dialhng
condition|?
literal|"on"
...
name|c
expr_stmt|;
comment|/* Store result in circular buffer */
if|if
condition|(
name|inpbp
operator|>=
...
name|ifc
decl_stmt|;
comment|/* Save IF condition (kludge) */
name|k
operator|=
name|parser
argument_list|(
...
literal|""
expr_stmt|;
comment|/* Get lengths and watch out */
name|n1
operator|=
operator|(
name|int
