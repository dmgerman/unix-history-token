...
name|cmtxt
argument_list|(
literal|"please respond.\n\ type \\? to include a question mark"
argument_list|,
literal|""
argument_list|,
operator|&
...
begin_comment
comment|/* Do the DEFINE and ASSIGN commands */
end_comment
...
name|printf
argument_list|(
literal|"Before reporting problems, please use the SHOW VERSION command\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"to get detailed program version and configuration information.\n\n"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
condition|)
block|{
comment|/* Compare result with label */
name|x
operator|=
literal|1
expr_stmt|;
