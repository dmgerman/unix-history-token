...
name|versio
init|=
literal|"C-Kermit 5A(179) BETA, 8 Feb 92"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  String and numeric version numbers, keep these two in sync!  Second digit of vernum: 0 = A, 1 = B, etc. */
end_comment
...
name|srvtxt
init|=
literal|"\r\l\ C-Kermit server starting.  Return to your local machine by typing\r\l\ its escape sequence for closing the connection, and issue further\r\l\ commands from there.  To shut down the C-Kermit server, issue the\r\l\ BYE command to logout, or the FINISH command and then reconnect.\r\l\ \l\0"
decl_stmt|;
end_decl_stmt
...
name|DSPSIZ
decl_stmt|,
comment|/* (PWP) Biggest packet size we can send */
comment|/* (see rcalcpsz()) */
name|spsizr
init|=
name|DSPSIZ
decl_stmt|,
...
literal|1
decl_stmt|,
comment|/* Window size in use */
name|wslotr
init|=
literal|1
decl_stmt|,
comment|/* Window size requested */
name|wslotn
init|=
literal|1
decl_stmt|,
comment|/* Window size negotiated */
name|timeouts
init|=
literal|0
decl_stmt|,
...
begin_comment
comment|/* Modem changes speed flag */
end_comment
...
begin_comment
comment|/* Whether to hangup before dialing */
end_comment
...
begin_comment
comment|/* Secs to wait for call to complete */
end_comment
...
begin_comment
comment|/* User-spec'd dialer init string */
end_comment
