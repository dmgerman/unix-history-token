...
name|cmdv
init|=
literal|"Command package 5A(048), 8 Feb 92"
decl_stmt|;
end_decl_stmt
...
literal|0
condition|)
comment|/* If no chars type, continue, */
continue|continue;
...
condition|)
block|{
comment|/* Any other unquoted ctrl char */
if|if
condition|(
operator|!
name|chsrc
...
comment|/*** debug(F110,"gtword deposit",cmdbuf,0); ***/
block|}
