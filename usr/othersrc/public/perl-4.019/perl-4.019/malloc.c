...
begin_comment
comment|/* $RCSfile: malloc.c,v $$Revision: 4.0.1.3 $$Date: 91/11/05 17:57:40 $  *  * $Log:	malloc.c,v $  * Revision 4.0.1.3  91/11/05  17:57:40  lwall  * patch11: safe malloc code now integrated into Perl's malloc when possible  *   * Revision 4.0.1.2  91/06/07  11:20:45  lwall  * patch4: many, many itty-bitty portability fixes  *   * Revision 4.0.1.1  91/04/11  17:48:31  lwall  * patch1: Configure now figures out malloc ptr type  *   * Revision 4.0  91/03/20  01:28:52  lwall  * 4.0 baseline.  *   */
end_comment
...
name|stderr
argument_list|,
literal|"0x%lx: (%05d) malloc %d bytes\n"
argument_list|,
name|p
operator|+
literal|1
...
directive|else
comment|/* take 16k unless the block is bigger than that  	   (80286s like large segments!)		*/
name|rnu
operator|=
operator|(
name|bucket
...
name|stderr
argument_list|,
literal|"0x%lx: (%05d) realloc %d bytes\n"
argument_list|,
name|res
argument_list|,
name|an
