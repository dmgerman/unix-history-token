...
begin_comment
comment|/* $XConsortium: PEXprotost.h,v 5.4 92/03/04 14:08:13 hersh Exp $ */
end_comment
...
name|B16
decl_stmt|;
comment|/* ColourType enumerated type */
name|CARD16
name|unused
name|B16
decl_stmt|;
comment|/* SINGLE COLOUR(colourType) */
block|}
...
begin_comment
comment|/*     Note that since an InteriorBundleEntry contains 4 embedded instances of      pexColourSpecifier, a variable-sized item, a data structure cannot be     defined for it. */
end_comment
...
name|surfaceApprox
decl_stmt|;
comment|/* SINGLE pexColourSpecifier		surfaceColour    */
comment|/* SINGLE pexReflectionAttr			reflectionAttr   */
comment|/* SINGLE pexColourSpecifier		bfSurfaceColour  */
...
name|B16
decl_stmt|;
comment|/* LISTof Colour(numx, numy) 2D array of colours */
block|}
...
begin_comment
comment|/* a pexColourEntry is just a pexColourSpecifier */
end_comment
...
decl_stmt|;
comment|/* renderer ID */
comment|/* SINGLE ColourSpecifier()  */
block|}
name|pexEscapeSetEchoColourData
typedef|;
end_typedef
