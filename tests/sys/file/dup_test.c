...
argument_list|)
expr_stmt|;
comment|/* If fcntl(F_DUP2FD_CLOEXEC) ever work? */
if|if
condition|(
operator|(
name|fd2
...
literal|1
argument_list|,
literal|"fcntl(F_DUP2FD_CLOEXEC)"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"ok %d - fcntl(F_DUP2FD_CLOEXEC) works\n"
argument_list|,
operator|++
name|test
argument_list|)
...
name|printf
argument_list|(
literal|"no ok %d - fcntl(F_DUP2FD_CLOEXEC) didn't give us the right fd\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"ok %d - fcntl(F_DUP2FD_CLOEXEC) returned a correct fd\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
comment|/* Was close-on-exec set? */
operator|++
name|test
expr_stmt|;
if|if
...
name|printf
argument_list|(
literal|"not ok %d - fcntl(F_DUP2FD_CLOEXEC) didn't set close-on-exec\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"ok %d - fcntl(F_DUP2FD_CLOEXEC) set close-on-exec\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
comment|/* 	 * It is unclear what F_DUP2FD_CLOEXEC should do when duplicating a 	 * file descriptor onto itself. 	 */
operator|++
name|test
expr_stmt|;
if|if
...
name|printf
argument_list|(
literal|"not ok %d - fcntl(F_DUP2FD_CLOEXEC) bypassed NOFILE limit\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"ok %d - fcntl(F_DUP2FD_CLOEXEC) didn't bypass NOFILE limit\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
comment|/* Does dup3(O_CLOEXEC) ever work? */
if|if
condition|(
operator|(
name|fd2
...
literal|1
argument_list|,
literal|"dup3(O_CLOEXEC)"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"ok %d - dup3(O_CLOEXEC) works\n"
argument_list|,
operator|++
name|test
argument_list|)
...
name|printf
argument_list|(
literal|"no ok %d - dup3(O_CLOEXEC) didn't give us the right fd\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"ok %d - dup3(O_CLOEXEC) returned a correct fd\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"not ok %d - dup3(O_CLOEXEC) didn't set close-on-exec\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"ok %d - dup3(O_CLOEXEC) set close-on-exec\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
comment|/* Does dup3(0) ever work? */
if|if
condition|(
operator|(
name|fd2
...
name|printf
argument_list|(
literal|"no ok %d - dup3(0) didn't give us the right fd\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"ok %d - dup3(0) returned a correct fd\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"not ok %d - dup3(0) didn't clear close-on-exec\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"ok %d - dup3(0) cleared close-on-exec\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
comment|/* dup3() does not allow duplicating to the same fd */
operator|++
name|test
expr_stmt|;
if|if
...
name|printf
argument_list|(
literal|"not ok %d - dup3(fd1, fd1, O_CLOEXEC) succeeded\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"ok %d - dup3(fd1, fd1, O_CLOEXEC) failed\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"not ok %d - dup3(fd1, fd1, 0) succeeded\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"ok %d - dup3(fd1, fd1, 0) failed\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"not ok %d - dup3(O_CLOEXEC) bypassed NOFILE limit\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"ok %d - dup3(O_CLOEXEC) didn't bypass NOFILE limit\n"
argument_list|,
name|test
argument_list|)
expr_stmt|;
