...
specifier|static
name|size_t
name|local_ZSTD_compress_generic_end
parameter_list|(
name|void
modifier|*
name|dst
...
specifier|static
name|size_t
name|local_ZSTD_compress_generic_continue
parameter_list|(
name|void
modifier|*
name|dst
...
specifier|static
name|size_t
name|local_ZSTD_compress_generic_T2_end
parameter_list|(
name|void
modifier|*
name|dst
...
specifier|static
name|size_t
name|local_ZSTD_compress_generic_T2_continue
parameter_list|(
name|void
modifier|*
name|dst
...
name|benchName
operator|=
literal|"compressContinue_extDict"
expr_stmt|;
break|break;
case|case
literal|13
...
name|benchName
operator|=
literal|"compress_generic, continue"
expr_stmt|;
break|break;
case|case
literal|52
...
name|benchName
operator|=
literal|"compress_generic, -T2, continue"
expr_stmt|;
break|break;
case|case
literal|62
...
name|benchName
operator|=
literal|"compress_generic, -T2, end"
expr_stmt|;
break|break;
default|default :
return|return
