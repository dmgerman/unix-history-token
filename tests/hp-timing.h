...
begin_comment
comment|/* Since this implementation is not available we tell the user about it.  */
end_comment

begin_define
define|#
directive|define
name|HP_TIMING_NONAVAIL
value|1
end_define
