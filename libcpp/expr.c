...
block|}
block|}
comment|/* The suffix may be for decimal fixed-point constants without exponent.  */
if|if
condition|(
name|radix
operator|!=
...
name|CPP_N_FLOATING
expr_stmt|;
comment|/* We need to restore the radix to 10, if the radix is 8.  */
if|if
condition|(
name|radix
operator|==
...
name|CPP_DL_PEDWARN
argument_list|,
literal|"fixed-point constants are a GCC extension"
argument_list|)
expr_stmt|;
goto|goto
name|syntax_ok
...
name|CPP_DL_PEDWARN
argument_list|,
literal|"decimal float constants are a GCC extension"
argument_list|)
expr_stmt|;
name|result
operator||=
