...
begin_comment
comment|/* Part of CPP library.  (Macro and #define handling.)    Copyright (C) 1986, 1987, 1989, 1992, 1993, 1994, 1995, 1996, 1998,    1999, 2000, 2001, 2002, 2003, 2004, 2005,    2006, 2007, 2008 Free Software Foundation, Inc.    Written by Per Bothner, 1994.    Based on CCCP program by Paul Rubin, June 1986    Adapted to ANSI C, Richard Stallman, Jan 1987  This program is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  This program is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with this program; if not, write to the Free Software Foundation, 51 Franklin Street, Fifth Floor, Boston, MA 02110-1301, USA.   In other words, you are welcome to use, share and improve this program.  You are forbidden to forbid anyone else to use, share and improve  what you give them.   Help stamp out software-hoarding!  */
end_comment
...
literal|' '
expr_stmt|;
comment|/* In one obscure case we might see padding here.  */
if|if
condition|(
name|rhs
operator|->
...
begin_comment
comment|/* Reads and returns the arguments to a function-like macro    invocation.  Assumes the opening parenthesis has been processed.    If there is an error, emits an appropriate diagnostic and returns    NULL.  Each argument is terminated by a CPP_EOF token, for the    future benefit of expand_arg().  If there are any deferred    #pragma directives among macro arguments, store pointers to the    CPP_PRAGMA ... CPP_PRAGMA_EOL tokens into *PRAGMA_BUFF buffer.  */
end_comment
...
argument_list|)
decl_stmt|;
comment|/* CPP_PRAGMA token lives in directive_result, which will 		 be overwritten on the next directive.  */
operator|*
name|newtok
operator|=
operator|*
...
condition|)
do|;
comment|/* In deferred pragmas parsing_args and prevent_expansion 		 had been changed, reset it.  */
name|pfile
operator|->
name|state
operator|.
...
name|ret
decl_stmt|;
comment|/* If not in a macro context, and we're going to start an 	     expansion, record the location.  */
if|if
condition|(
name|can_set
operator|&&
...
condition|)
block|{
comment|/* Paste operator constraint 6.10.3.3.1: 	     Token-paste ##, can appear in both object-like and 	     function-like macros, but not at the end.  */
if|if
condition|(
name|following_paste_op
condition|)
...
condition|)
block|{
comment|/* Token-paste ##, can appear in both object-like and 	     function-like macros, but not at the beginning.  */
if|if
condition|(
name|macro
operator|->
...
operator|*
operator|)
literal|"__STDC_FORMAT_MACROS"
argument_list|)
comment|/* __STDC_LIMIT_MACROS and __STDC_CONSTANT_MACROS are mentioned 	 in the C standard, as something that one must use in C++. 	 However DR#593 indicates that these aren't actually mentioned 	 in the C++ standard.  We special-case them anyway.  */
operator|&&
name|ustrcmp
argument_list|(
name|NODE_NAME
...
operator|*
operator|)
literal|"__STDC_CONSTANT_MACROS"
argument_list|)
condition|)
name|node
operator|->
