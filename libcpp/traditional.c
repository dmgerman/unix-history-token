...
begin_comment
comment|/* CPP Library - traditional lexical analysis and macro expansion.    Copyright (C) 2002, 2004, 2005, 2007, 2008 Free Software Foundation, Inc.    Contributed by Neil Booth, May 2002  This program is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  This program is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with this program; if not, write to the Free Software Foundation, 51 Franklin Street, Fifth Floor, Boston, MA 02110-1301, USA.  */
end_comment
...
begin_comment
comment|/* Lexing TODO: Maybe handle space in escaped newlines.  Stop lex.c    from recognizing comments and directives during its lexing pass.  */
end_comment
...
literal|0
decl_stmt|;
comment|/* Get an estimate of the length of the argument-replaced text. 	 This is a worst case estimate, assuming that every replacement 	 text character needs quoting.  */
for|for
control|(
name|exp
operator|=
...
comment|/* Accumulate actual length, including quoting as necessary */
name|p
operator|=
name|BUFF_FRONT
argument_list|(
...
name|text_len
expr_stmt|;
comment|/* Copy the non-argument text literally, keeping 	     track of whether matching quotes have been seen. */
for|for
control|(
name|arglen
operator|=
...
expr_stmt|;
block|}
comment|/* Done if no more arguments */
if|if
condition|(
name|b
operator|->
...
directive|if
literal|0
comment|/* Skip leading whitespace in the text for the argument to 	     be substituted. To be compatible with gcc 2.95, we would 	     also need to trim trailing whitespace. Gcc 2.95 trims 	     leading and trailing whitespace, which may be a bug.  The 	     current gcc testsuite explicitly checks that this leading 	     and trailing whitespace in actual arguments is 	     preserved. */
block|while (arglen> 0&& is_space (*in)) 	    { 	      in++; 	      arglen--; 	    }
endif|#
directive|endif
for|for
control|(
...
name|argquote
expr_stmt|;
comment|/* Always add backslash before double quote if argument 		     is expanded in a quoted context */
operator|*
name|p
operator|++
operator|=
...
condition|)
block|{
comment|/* Always add backslash before a backslash in an argument 		     that is expanded in a quoted context and also in the 		     range of a quoted context in the argument itself. */
operator|*
name|p
operator|++
operator|=
