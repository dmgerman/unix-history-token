...
begin_comment
comment|/* This table isn't used for CRISv32 and the size of immediate operands.  */
end_comment
...
begin_comment
comment|/* Add version specifiers to this table when necessary.    The (now) regular coding of register names suggests a simpler    implementation.  */
end_comment
...
block|}
block|,
comment|/* This collates after "addo", but we want to disassemble as "addoq",      not "addo".  */
block|{
literal|"addoq"
block|,
literal|0x0100
...
block|}
block|,
comment|/* This must be located after the insn above, lest we misinterpret      "addo.b -1,r0,acr" as "addo .b-1,r0,acr".  FIXME: Sounds like a      parser bug.  */
block|{
literal|"addo"
block|,
literal|0x0100
...
block|}
block|,
comment|/* FIXME: SIZE_FIELD_SIGNED and all necessary changes.  */
block|{
literal|"adds"
block|,
literal|0x0820
...
block|}
block|,
comment|/* FIXME: SIZE_FIELD_UNSIGNED and all necessary changes.  */
block|{
literal|"addu"
block|,
literal|0x0800
...
block|}
block|,
comment|/* Needs to come after the usual "ba o", which might be relaxed to      this one.  */
block|{
literal|"ba"
block|,
...
block|}
block|,
comment|/* This is deliberately put before "bext" to trump it, even though not      in alphabetical order, since we don't do excluding version checks      for v0..v10.  */
block|{
literal|"bwf"
block|,
name|BRANCH_QUICK_OPCODE
...
literal|"a"
block|,
comment|/* This is a placeholder.  In v0, this would be "ext".  In v32, this      is "sb".  See cris_conds15.  */
literal|"wf"
block|}
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* Different names and semantics for condition 1111 (0xf).  */
end_comment
...
init|=
block|{
comment|/* FIXME: In what version did condition "ext" disappear?  */
block|{
literal|"ext"
block|,
name|cris_ver_v0_3
