...
begin_comment
comment|/* Print i386 instructions for GDB, the GNU debugger.    Copyright 1988, 1989, 1991, 1993, 1994, 1995, 1996, 1997, 1998, 1999,    2001, 2002, 2003, 2004, 2005 Free Software Foundation, Inc.     This file is part of GDB.     This program is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2 of the License, or    (at your option) any later version.     This program is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with this program; if not, write to the Free Software    Foundation, Inc., 51 Franklin Street - Fifth Floor, Boston, MA 02110-1301, USA.  */
end_comment
...
directive|define
name|GRPPADLCK1
value|NULL, NULL, USE_GROUPS, NULL, 23, NULL, 0
end_define
...
directive|define
name|GRPPADLCK2
value|NULL, NULL, USE_GROUPS, NULL, 24, NULL, 0
end_define
...
directive|define
name|PREGRP27
value|NULL, NULL, USE_PREFIX_USER_TABLE, NULL, 27, NULL, 0
end_define
...
directive|define
name|PREGRP28
value|NULL, NULL, USE_PREFIX_USER_TABLE, NULL, 28, NULL, 0
end_define
...
directive|define
name|PREGRP29
value|NULL, NULL, USE_PREFIX_USER_TABLE, NULL, 29, NULL, 0
end_define
...
directive|define
name|PREGRP30
value|NULL, NULL, USE_PREFIX_USER_TABLE, NULL, 30, NULL, 0
end_define
...
directive|define
name|PREGRP31
value|NULL, NULL, USE_PREFIX_USER_TABLE, NULL, 31, NULL, 0
end_define
...
directive|define
name|PREGRP32
value|NULL, NULL, USE_PREFIX_USER_TABLE, NULL, 32, NULL, 0
end_define
...
directive|define
name|THREE_BYTE_0
value|NULL, NULL, IS_3BYTE_OPCODE, NULL, 0, NULL, 0
end_define
...
directive|define
name|THREE_BYTE_1
value|NULL, NULL, IS_3BYTE_OPCODE, NULL, 1, NULL, 0
end_define
...
argument_list|()
expr_stmt|;
comment|/* bad lea,lds,les,lfs,lgs,lss modrm */
else|else
name|OP_E
argument_list|(
name|bytemode
...
parameter_list|)
block|{
comment|/* NOP with REPZ prefix is called PAUSE.  */
if|if
condition|(
name|prefixes
operator|==
...
condition|)
block|{
comment|/* We need to add a proper suffix with  		movw %ds,%ax 		movl %ds,%eax 		movq %ds,%rax 		movw %ax,%ds 		movl %eax,%ds 		movq %rax,%ds        */
specifier|const
name|char
modifier|*
name|suffix
...
block|{
comment|/* We need to fix the suffix for  		movw %ds,(%eax) 		movw %ds,(%rax) 		movw (%eax),%ds 		movw (%rax),%ds  	 Override "mov[l|q]".  */
name|char
modifier|*
name|p
init|=
...
literal|1
decl_stmt|;
comment|/* We might not have a suffix.  */
if|if
condition|(
operator|*
name|p
