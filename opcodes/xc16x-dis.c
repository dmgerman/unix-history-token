...
parameter_list|)
define|\
value|do								\     {								\       if (CGEN_BOOL_ATTR ((attrs), CGEN_OPERAND_DOT_PREFIX))	\         info->fprintf_func (info->stream, ".");			\       if (CGEN_BOOL_ATTR ((attrs), CGEN_OPERAND_POF_PREFIX))	\         info->fprintf_func (info->stream, "#pof:");		\       if (CGEN_BOOL_ATTR ((attrs), CGEN_OPERAND_PAG_PREFIX))	\         info->fprintf_func (info->stream, "#pag:");		\     }								\   while (0)
end_define

begin_comment
comment|/* Print a 'pof:' prefix to an operand.  */
end_comment
...
begin_comment
comment|/* Print a 'pag:' prefix to an operand.  */
end_comment
...
begin_comment
comment|/* Print a 'sof:' prefix to an operand.  */
end_comment
...
begin_comment
comment|/* Print a 'seg:' prefix to an operand.  */
end_comment
...
begin_comment
comment|/* Print a '#' prefix to an operand.  */
end_comment
...
modifier|*
specifier|const
name|xc16x_cgen_print_handlers
index|[]
init|=
block|{
name|print_insn_normal
