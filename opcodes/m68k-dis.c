...
block|}
block|,
comment|/* reg c04 is sometimes called flashbar or rambar. 		rec c05 is also sometimes called rambar.  */
block|{
literal|"%rambar0"
block|,
literal|0xc04
...
block|{
comment|/* We must restore the print functions before trying to print the 	     error message.  */
name|info
operator|->
name|fprintf_func
operator|=
...
name|the_buffer
decl_stmt|;
comment|/* Save these printing functions in case we need to restore them      later.  */
name|fprintf_ftype
name|save_printer
init|=
name|info
