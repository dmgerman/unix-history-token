...
begin_comment
comment|/* Handle 'pof:' prefixes (i.e. skip over them).  */
end_comment
...
begin_comment
comment|/* Handle 'pag:' prefixes (i.e. skip over them).  */
end_comment
...
begin_comment
comment|/* Handle 'sof' prefixes (i.e. skip over them).  */
end_comment
...
begin_comment
comment|/* Handle 'seg' prefixes (i.e. skip over them).  */
end_comment
...
modifier|*
specifier|const
name|xc16x_cgen_parse_handlers
index|[]
init|=
block|{
name|parse_insn_normal
...
condition|(
operator|!
name|xc16x_cgen_insn_supported
argument_list|(
name|cd
argument_list|,
name|insn
