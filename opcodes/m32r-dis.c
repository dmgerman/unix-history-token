...
begin_comment
comment|/* Immediate values are prefixed with '#'.  */
end_comment
...
begin_comment
comment|/* Handle '#' prefixes as operands.  */
end_comment
...
name|x
decl_stmt|;
comment|/* Read the base part of the insn.  */
name|status
operator|=
call|(
modifier|*
...
argument_list|)
expr_stmt|;
comment|/* The "& 3" is to pass a consistent address.      Parallel insns arguably both begin on the word boundary.      Also, branch insns are calculated relative to the word boundary.  */
if|if
condition|(
name|print_insn
argument_list|(
