...
begin_comment
comment|/* Copyright 2001, 2002, 2003, 2005 Free Software Foundation, Inc.     This file is part of GNU Binutils.     This program is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2 of the License, or    (at your option) any later version.     This program is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with this program; if not, write to the Free Software    Foundation, Inc., 51 Franklin Street - Fifth Floor, Boston, MA 02110-1301,    USA.  */
end_comment

begin_comment
comment|/* This program generates z8k-opc.h.  Compile with -fwritable-strings.  */
end_comment
...
block|}
block|,
comment|/* Breakpoint used by the simulator.  */
block|{
literal|"------"
block|,
literal|10
...
block|}
block|,
comment|/* Breakpoint used by real hardware.                                                            (ext0f #0x0c).  */
block|{
literal|"------"
block|,
literal|10
...
literal|16
block|,
literal|"0011 1011 dddd 0100 imm16"
block|,
literal|"in rd,imm16"
block|,
literal|0
...
literal|16
block|,
literal|"0011 1011 ssss 1000 0000 aaaa ddN0 1000"
block|,
...
literal|8
block|,
literal|"0011 1010 ssss 1000 0000 aaaa ddN0 1000"
block|,
...
literal|16
block|,
literal|"0011 1011 ssss 1000 0000 aaaa ddN0 0000"
block|,
...
literal|8
block|,
literal|"0011 1010 ssss 1000 0000 aaaa ddN0 0000"
block|,
...
literal|16
block|,
literal|"0011 1011 ssss 0000 0000 aaaa ddN0 1000"
block|,
...
literal|8
block|,
literal|"0011 1010 ssss 0000 0000 aaaa ddN0 1000"
block|,
...
literal|16
block|,
literal|"0011 1011 ssss 0000 0000 aaaa ddN0 0000"
block|,
...
literal|8
block|,
literal|"0011 1010 ssss 0000 0000 aaaa ddN0 0000"
block|,
...
literal|16
block|,
literal|"0001 1100 ddN0 1001 0000 ssss 0000 imm4m1"
block|,
literal|"ldm @rd,rs,n"
block|,
literal|0
...
literal|16
block|,
literal|"0101 1100 ddN0 1001 0000 ssss 0000 imm4m1 address_dst"
block|,
...
literal|16
block|,
literal|"0101 1100 0000 1001 0000 ssss 0000 imm4m1 address_dst"
block|,
...
literal|16
block|,
literal|"0001 1100 ssN0 0001 0000 dddd 0000 imm4m1"
block|,
literal|"ldm rd,@rs,n"
block|,
literal|0
...
literal|16
block|,
literal|"0101 1100 ssN0 0001 0000 dddd 0000 imm4m1 address_src"
block|,
...
literal|16
block|,
literal|"0101 1100 0000 0001 0000 dddd 0000 imm4m1 address_src"
block|,
...
literal|16
block|,
literal|"0011 1011 ssN0 1010 0000 aaaa dddd 1000"
block|,
...
literal|8
block|,
literal|"0011 1010 ssN0 1010 0000 aaaa dddd 1000"
block|,
...
literal|16
block|,
literal|"0011 1011 ssN0 1010 0000 aaaa dddd 0000"
block|,
...
literal|8
block|,
literal|"0011 1010 ssN0 1010 0000 aaaa dddd 0000"
block|,
...
literal|16
block|,
literal|"0011 1011 ssN0 0010 0000 aaaa dddd 1000"
block|,
...
literal|8
block|,
literal|"0011 1010 ssN0 0010 0000 aaaa dddd 1000"
block|,
...
literal|16
block|,
literal|"0011 1011 ssN0 0010 0000 aaaa dddd 0000"
block|,
...
literal|8
block|,
literal|"0011 1010 ssN0 0010 0000 aaaa dddd 0000"
block|,
...
literal|16
block|,
literal|"0011 1011 ssss 1001 0000 aaaa ddN0 1000"
block|,
...
literal|8
block|,
literal|"0011 1010 ssss 1001 0000 aaaa ddN0 1000"
block|,
...
literal|16
block|,
literal|"0011 1011 ssss 1001 0000 aaaa ddN0 0000"
block|,
...
literal|8
block|,
literal|"0011 1010 ssss 1001 0000 aaaa ddN0 0000"
block|,
...
literal|16
block|,
literal|"0011 1011 ssss 0001 0000 aaaa ddN0 1000"
block|,
...
literal|8
block|,
literal|"0011 1010 ssss 0001 0000 aaaa ddN0 1000"
block|,
...
literal|16
block|,
literal|"0011 1011 ssss 0001 0000 aaaa ddN0 0000"
block|,
...
literal|8
block|,
literal|"0011 1010 ssss 0001 0000 aaaa ddN0 0000"
block|,
...
literal|8
block|,
literal|"1011 0010 dddd 1001 iiii iiii 0000 imm4"
block|,
...
literal|8
block|,
literal|"1011 0010 dddd 0001 iiii iiii 0000 imm4"
block|,
...
literal|16
block|,
literal|"0011 1011 ssN0 1011 0000 aaaa dddd 1000"
block|,
...
literal|8
block|,
literal|"0011 1010 ssN0 1011 0000 aaaa dddd 1000"
block|,
...
literal|16
block|,
literal|"0011 1011 ssN0 1011 0000 aaaa dddd 0000"
block|,
...
literal|8
block|,
literal|"0011 1010 ssN0 1011 0000 aaaa dddd 0000"
block|,
...
literal|16
block|,
literal|"0011 1011 ssN0 0011 0000 aaaa dddd 1000"
block|,
...
literal|8
block|,
literal|"0011 1010 ssN0 0011 0000 aaaa dddd 1000"
block|,
...
literal|16
block|,
literal|"0011 1011 ssN0 0011 0000 aaaa dddd 0000"
block|,
...
literal|8
block|,
literal|"0011 1010 ssN0 0011 0000 aaaa dddd 0000"
block|,
...
literal|8
block|,
literal|"1011 0010 dddd 1001 iiii iiii 1111 nim4"
block|,
...
literal|8
block|,
literal|"1011 0010 dddd 0001 iiii iiii 1111 nim4"
block|,
...
literal|"@ri"
block|,
literal|"CLASS_IRO+(ARG_RS)"
block|,}
block|,
block|{
literal|"@ro"
block|,
literal|"CLASS_IRO+(ARG_RD)"
block|,}
block|,
block|{
literal|"imm8"
...
argument_list|)
expr_stmt|;
comment|/* Scan the operands and make entries for them.      Remember indirect things.  */
while|while
condition|(
operator|*
name|n
...
begin_endif
unit|static void printmangled (char *x) {   return;   while (*x)     {       if (D (x[0])&& D (x[1])&& D (x[2])&& D (x[3])) 	{ 	  printf ("XXXX"); 	}       else if (M ("ssss")) 	{ 	  printf ("ssss"); 	}       else if (M ("dddd")) 	{ 	  printf ("dddd"); 	}       else 	printf ("____");        x += 4;        if (x[0] == ' ') 	{ 	  printf ("_"); 	  x++; 	}     }  }
endif|#
directive|endif
end_endif
...
name|printf
argument_list|(
literal|"/* DO NOT EDIT!  -*- buffer-read-only: t -*-\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"   This file is automatically generated by z8kgen.  */\n\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
...
name|printf
argument_list|(
literal|"#define CLASS_IGNORE     0x90\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
...
name|printf
argument_list|(
literal|"#define CLASS_IRO       0x800\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define CLASS_DISP8     0x900\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define CLASS_BIT_1OR2  0xa00\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
...
name|printf
argument_list|(
literal|"#define OPC_indr    56\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_indrb   57\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ini     58\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_inib    59\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_inir    60\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_inirb   61\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_iret    62\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_jp      63\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_jr      64\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ld      65\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_lda     66\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ldar    67\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ldb     68\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ldctl   69\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ldir    70\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ldirb   71\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ldk     72\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ldl     73\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ldm     74\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ldps    75\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ldr     76\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ldrb    77\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ldrl    78\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_mbit    79\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_mreq    80\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_mres    81\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_mset    82\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_mult    83\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_multl   84\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_neg     85\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_negb    86\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_nop     87\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_or      88\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_orb     89\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_otdr    90\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_otdrb   91\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_otir    92\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_otirb   93\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_out     94\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_outb    95\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_outd    96\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_outdb   97\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_outi    98\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_outib   99\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_pop    100\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_popl   101\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_push   102\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_pushl  103\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_res    104\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_resb   105\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_resflg 106\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ret    107\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rl     108\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rlb    109\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rlc    110\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rlcb   111\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rldb   112\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rr     113\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rrb    114\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rrc    115\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rrcb   116\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rrdb   117\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sbc    118\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sbcb   119\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sda    120\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sdab   121\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sdal   122\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sdl    123\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sdlb   124\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sdll   125\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_set    126\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_setb   127\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_setflg 128\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sin    129\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sinb   130\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sind   131\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sindb  132\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sindr  133\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sindrb 134\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sini   135\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sinib  136\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sinir  137\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sinirb 138\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sla    139\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_slab   140\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_slal   141\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sll    142\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sllb   143\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_slll   144\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sotdr  145\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sotdrb 146\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sotir  147\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sotirb 148\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sout   149\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_soutb  150\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_soutd  151\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_soutdb 152\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_souti  153\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_soutib 154\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sra    155\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_srab   156\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sral   157\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_srl    158\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_srlb   159\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_srll   160\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sub    161\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_subb   162\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_subl   163\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_tcc    164\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_tccb   165\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_test   166\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_testb  167\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_testl  168\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_trdb   169\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_trdrb  170\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_trib   171\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_trirb  172\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_trtdrb 173\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_trtib  174\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_trtirb 175\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_trtrb  176\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_tset   177\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_tsetb  178\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_xor    179\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_xorb   180\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ldd    181\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_lddb   182\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_lddr   183\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_lddrb  184\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ldi    185\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ldib   186\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_sc     187\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_bpt    188\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ext0e  188\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ext0f  188\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ext8e  188\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ext8f  188\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rsvd36 188\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rsvd38 188\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rsvd78 188\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rsvd7e 188\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rsvd9d 188\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rsvd9f 188\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rsvdb9 188\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_rsvdbf 188\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_ldctlb 189\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_trtdb  190\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"#define OPC_brk    191\n"
argument_list|)
expr_stmt|;
if|#
directive|if
...
name|printf
argument_list|(
literal|"const opcode_entry_type z8k_table[] = {\n"
argument_list|)
expr_stmt|;
while|while
condition|(
...
name|printf
argument_list|(
literal|"-t : generate new internal table\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
