...
name|_
argument_list|(
literal|"W keyword invalid in FR operand slot."
argument_list|)
expr_stmt|;
return|return
name|errmsg
...
name|_
argument_list|(
literal|"offset(IP) is not a valid form"
argument_list|)
expr_stmt|;
return|return
name|errmsg
...
name|_
argument_list|(
literal|"(DP) offset out of range."
argument_list|)
expr_stmt|;
return|return
name|errmsg
...
name|_
argument_list|(
literal|"(SP) offset out of range."
argument_list|)
expr_stmt|;
return|return
name|errmsg
...
name|_
argument_list|(
literal|"operand out of range (not between 1 and 255)"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|_
argument_list|(
literal|"parse_addr16: invalid opindex."
argument_list|)
expr_stmt|;
return|return
name|errmsg
...
literal|0
condition|)
comment|/* If the address is even .... */
block|{
if|if
condition|(
name|opindex
...
name|_
argument_list|(
literal|"Byte address required. - must be even."
argument_list|)
expr_stmt|;
block|}
elseif|else
...
condition|)
block|{
comment|/* This will happen for things like (s2-s1) where s2 and s1 	     are labels.  */
operator|*
name|valuep
operator|=
name|value
...
name|_
argument_list|(
literal|"cgen_parse_address returned a symbol. Literal required."
argument_list|)
expr_stmt|;
block|}
return|return
...
name|_
argument_list|(
literal|"Attempt to find bit index of 0"
argument_list|)
expr_stmt|;
return|return
name|errmsg
