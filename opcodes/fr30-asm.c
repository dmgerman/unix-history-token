...
begin_if
unit|void fr30_cgen_asm_hash_keywords (CGEN_CPU_DESC cd, CGEN_KEYWORD *opvals) {   CGEN_KEYWORD_SEARCH search = cgen_keyword_search_init (opvals, NULL);   const CGEN_KEYWORD_ENTRY * ke;    while ((ke = cgen_keyword_search_next (& search)) != NULL)     {
if|#
directive|if
literal|0
end_if
...
begin_endif
unit|if (! fr30_cgen_opval_supported (ke)) 	continue;
endif|#
directive|endif
end_endif
