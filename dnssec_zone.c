...
argument_list|)
expr_stmt|;
comment|/* should we error on equal? */
if|if
condition|(
name|cmp
operator|<=
...
begin_function
name|void
name|ldns_dnssec_rrsets_print_soa
parameter_list|(
name|FILE
modifier|*
name|out
...
begin_function
name|void
name|ldns_dnssec_name_print_soa
parameter_list|(
name|FILE
modifier|*
name|out
...
expr_stmt|;
block|}
comment|/*TODO ldns_dnssec_name_print_names(stdout, zone->names, 0);*/
if|if
condition|(
name|ldns_rr_get_type
argument_list|(
