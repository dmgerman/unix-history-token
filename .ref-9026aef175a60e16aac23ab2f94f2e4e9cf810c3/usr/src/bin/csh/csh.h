...
begin_comment
comment|/*-  * Copyright (c) 1980, 1991, 1993  *	The Regents of the University of California.  All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)csh.h	8.2 (Berkeley) %G%  */
end_comment
...
name|a
parameter_list|)
value|memmove((a), reslab, sizeof reslab)
end_define
...
name|a
parameter_list|)
value|memmove(reslab, (a), sizeof reslab)
end_define
