...
begin_comment
comment|/*  * Copyright (c) 1982, 1986, 1988, 1990, 1993, 1995  *	The Regents of the University of California.  All rights reserved.  *  * %sccs.include.redist.c%  *  *	@(#)udp_usrreq.c	8.6 (Berkeley) %G%  */
end_comment
