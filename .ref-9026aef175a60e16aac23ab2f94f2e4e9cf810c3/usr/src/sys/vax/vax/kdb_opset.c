...
begin_comment
comment|/*  *	@(#)kdb_opset.c	7.4 (Berkeley) 5/1/89  */
end_comment
...
condition|)
block|{
comment|/* byte at ap tells how many arguments */
name|narg
operator|=
name|kdbget
argument_list|(
...
name|fp
expr_stmt|;
comment|/* 8 below == offsetof(struct frame, fr_savap) */
name|ap
operator|=
name|kdbget
argument_list|(
