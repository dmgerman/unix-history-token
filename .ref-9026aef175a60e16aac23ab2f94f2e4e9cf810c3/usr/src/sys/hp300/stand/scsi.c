...
begin_comment
comment|/* use the "real" driver init_wait value */
end_comment
...
expr_stmt|;
block|}
comment|/* 	 * Adjust the wait values 	 */
if|if
condition|(
operator|!
name|waitset
...
name|printf
argument_list|(
literal|"scsi%d error: scsiabort\n"
argument_list|,
name|hs
operator|-
name|scsi_softc
...
name|printf
argument_list|(
literal|"scsi%d: unexpected scsi phase %d\n"
argument_list|,
name|hs
operator|-
name|scsi_softc
...
directive|ifdef
name|SLOWSCSI
comment|/* 		 * XXX we have wierd transient problems with booting from 		 * slow scsi disks on fast machines.  I have never been 		 * able to pin the problem down, but a large delay here 		 * seems to always work. 		 */
name|DELAY
argument_list|(
literal|1000
argument_list|)
