...
directive|define
name|OPTIONS
value|"B:b:C:cd:E:e:F:f:h:IiJ:mnO:o:p:q:r:sTtvX:"
endif|#
directive|endif
ifndef|#
directive|ifndef
...
name|LOG_INFO
argument_list|,
literal|"%s: Authentication-Warning: %s"
argument_list|,
name|e
operator|->
name|e_id
...
begin_comment
comment|/* **  TESTMODELINE -- process a test mode input line ** **	Parameters: **		line -- the input line. **		e -- the current environment. */
end_comment
...
name|printf
argument_list|(
literal|"Unknown test command %s\n"
argument_list|,
name|line
argument_list|)
expr_stmt|;
