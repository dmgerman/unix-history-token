...
index|[]
init|=
literal|"@(#)savemail.c	8.79 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
name|putline
argument_list|(
literal|"Content-Type: message/X-delivery-status-05 (Draft of May 29, 1995)"
argument_list|,
name|mci
argument_list|)
expr_stmt|;
...
name|buf
argument_list|,
literal|"Original-Envelope-Id: %s"
argument_list|,
name|xuntextify
argument_list|(
name|e
...
name|buf
argument_list|,
literal|"X-Actual-Recipient: %s; %s@"
argument_list|,
name|p
argument_list|,
name|q
