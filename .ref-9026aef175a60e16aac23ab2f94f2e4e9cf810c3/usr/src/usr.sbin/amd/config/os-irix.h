...
begin_comment
comment|/*  * Copyright (c) 1990 Jan-Simon Pendry  * Copyright (c) 1990 Imperial College of Science, Technology& Medicine  * Copyright (c) 1990, 1993  *	The Regents of the University of California.  All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Jan-Simon Pendry at Imperial College, London.  *  * %sccs.include.redist.c%  *  *	@(#)os-irix.h	8.1 (Berkeley) %G%  *  * $Id: os-irix.h,v 5.2.2.1 1992/02/09 15:10:28 jsp beta $  *  * IRIX 3.3 definitions for Amd (automounter)  * Contributed by Scott R. Presnell<srp@cgl.ucsf.edu>  */
end_comment
