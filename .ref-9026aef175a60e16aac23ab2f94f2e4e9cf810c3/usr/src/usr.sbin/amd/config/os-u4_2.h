...
begin_comment
comment|/*  * Copyright (c) 1989 Jan-Simon Pendry  * Copyright (c) 1989 Imperial College of Science, Technology& Medicine  * Copyright (c) 1989, 1993  *	The Regents of the University of California.  All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Jan-Simon Pendry at Imperial College, London.  *  * %sccs.include.redist.c%  *  *	@(#)os-u4_2.h	8.1 (Berkeley) %G%  *  * $Id: os-u4_2.h,v 5.2.2.1 1992/02/09 15:10:54 jsp beta $  *  * Ultrix 4.2 definitions for Amd (automounter)  *		from Chris Lindblad<cjl@ai.mit.edu>  *		and Chris Metcalf<metcalf@lcs.mit.edu>  */
end_comment
