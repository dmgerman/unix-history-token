...
begin_comment
comment|/*  * Copyright (c) 1989 Jan-Simon Pendry  * Copyright (c) 1989 Imperial College of Science, Technology& Medicine  * Copyright (c) 1989, 1993  *	The Regents of the University of California.  All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Jan-Simon Pendry at Imperial College, London.  *  * %sccs.include.redist.c%  *  *	@(#)rpc_fwd.c	8.1 (Berkeley) %G%  *  * $Id: rpc_fwd.c,v 5.2.2.1 1992/02/09 15:09:01 jsp beta $  *  */
end_comment
...
directive|ifdef
name|DEBUG
comment|/*dlog("fwd_alloca: rpc_head = %#x", rpc_head.q_forw);*/
endif|#
directive|endif
comment|/* DEBUG */
...
directive|ifdef
name|DEBUG
comment|/*dlog("fwd_free: rpc_head = %#x", rpc_head.q_forw);*/
endif|#
directive|endif
comment|/* DEBUG */
name|rem_que
...
begin_comment
comment|/*  * Initialise the RPC forwarder  */
end_comment
...
directive|ifdef
name|DEBUG
comment|/*dlog("Fully qualified rpc type provided");*/
endif|#
directive|endif
comment|/* DEBUG */
name|p
...
name|XLOG_ERROR
argument_list|,
literal|"Error reading packet size: %m"
argument_list|)
expr_stmt|;
return|return;
block|}
comment|/* 	 * Allocate a buffer 	 */
name|pkt
operator|=
operator|(
name|voidp
...
name|XLOG_ERROR
argument_list|,
literal|"Out of buffers in fwd_reply"
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|XLOG_ERROR
argument_list|,
literal|"Short read in fwd_reply"
argument_list|)
expr_stmt|;
goto|goto
name|out
