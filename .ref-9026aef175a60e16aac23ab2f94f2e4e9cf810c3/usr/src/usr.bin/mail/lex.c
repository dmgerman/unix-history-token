...
argument_list|)
expr_stmt|;
comment|/* 	 * New mail mail have arrived while we were reading 	 * up the mail file, so reset mailsize to be where 	 * we really are in the file... 	 */
name|mailsize
operator|=
name|ftell
argument_list|(
