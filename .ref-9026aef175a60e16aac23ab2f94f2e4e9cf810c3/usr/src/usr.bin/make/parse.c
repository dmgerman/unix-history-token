...
index|[]
init|=
literal|"@(#)parse.c	8.6 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
name|Reserved
case|:
comment|/* 			 * A posix reserved target that we don't know 			 * how to deal with. 			 */
return|return;
default|default:
break|break;
block|}
...
condition|)
block|{
comment|/* If we're this far, the line must be a comment. 		   (Empty lines are ignored as well) */
goto|goto
name|nextLine
goto|;
block|}
