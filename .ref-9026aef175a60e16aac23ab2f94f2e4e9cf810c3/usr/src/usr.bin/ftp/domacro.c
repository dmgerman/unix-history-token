...
begin_comment
comment|/*  * Copyright (c) 1985, 1993, 1994  *	The Regents of the University of California.  All rights reserved.  *  * %sccs.include.redist.c%  */
end_comment
...
index|[]
init|=
literal|"@(#)domacro.c	8.3 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
