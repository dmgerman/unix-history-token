...
begin_comment
comment|/* Perform the binary or unary operation described by CODE.    For a unary operation, leave OP1 NULL.  This function returns    true if the result may be inexact due to loss of precision.  */
end_comment
...
condition|)
block|{
comment|/* Hexadecimal format for decimal floats is not interesting. */
name|strcpy
argument_list|(
name|str
argument_list|,
...
name|d
condition|)
comment|/* Ensure correct rounding by setting last bit if there is 	       a subsequent nonzero digit.  */
name|r
operator|->
name|sig
index|[
...
block|}
block|}
comment|/* If the mantissa is zero, ignore the exponent.  */
if|if
condition|(
operator|!
name|cmp_significand_0
...
begin_comment
comment|/* Initialize R from string S and desired MODE. */
end_comment
...
return|return;
block|}
comment|/* FIXME. We can come here via fp_easy_constant 	 (e.g. -O0 on '_Decimal32 x = 1.0 + 2.0dd'), but have not 	 investigated whether this convert needs to be here, or 	 something else is missing. */
...
argument_list|)
expr_stmt|;
comment|/* Don't allow conversion to denormals.  */
name|emin2m1
operator|=
operator|(
name|fmt
...
name|false
return|;
comment|/* After conversion to the new mode, the value must be identical.  */
name|real_convert
argument_list|(
operator|&
name|t
...
begin_comment
comment|/* Return the number of bits of the largest binary value that the    significand of MODE will hold.  */
end_comment
...
condition|)
block|{
comment|/* Return the size in bits of the largest binary value that can be 	 held by the decimal coefficient for this mode.  This is one more 	 than the number of bits required to hold the largest coefficient 	 of this mode.  */
name|double
name|log2_10
init|=
literal|3.3219281
...
begin_comment
comment|/* Encode real R into a single precision DFP value in BUF.  */
end_comment

begin_function
specifier|static
name|void
name|encode_decimal_single
parameter_list|(
specifier|const
name|struct
name|real_format
...
begin_comment
comment|/* Decode a single precision DFP value in BUF into a real R.  */
end_comment

begin_function
specifier|static
name|void
name|decode_decimal_single
parameter_list|(
specifier|const
name|struct
name|real_format
...
begin_comment
comment|/* Encode real R into a double precision DFP value in BUF.  */
end_comment

begin_function
specifier|static
name|void
name|encode_decimal_double
parameter_list|(
specifier|const
name|struct
name|real_format
...
begin_comment
comment|/* Decode a double precision DFP value in BUF into a real R.  */
end_comment

begin_function
specifier|static
name|void
name|decode_decimal_double
parameter_list|(
specifier|const
name|struct
name|real_format
...
begin_comment
comment|/* Encode real R into a quad precision DFP value in BUF.  */
end_comment

begin_function
specifier|static
name|void
name|encode_decimal_quad
parameter_list|(
specifier|const
name|struct
name|real_format
...
begin_comment
comment|/* Decode a quad precision DFP value in BUF into a real R.  */
end_comment

begin_function
specifier|static
name|void
name|decode_decimal_quad
parameter_list|(
specifier|const
name|struct
name|real_format
...
begin_comment
comment|/* Single precision decimal floating point (IEEE 754R). */
end_comment
...
begin_comment
comment|/* Double precision decimal floating point (IEEE 754R). */
end_comment
...
begin_comment
comment|/* Quad precision decimal floating point (IEEE 754R). */
end_comment
...
begin_comment
comment|/* Round X to the nearest integer, but round halfway cases away from    zero.  */
end_comment
