...
begin_comment
comment|/* ARM EABI personality routines must also unwind the stack.  */
end_comment

begin_define
define|#
directive|define
name|CONTINUE_UNWINDING
define|\
value|do								\     {								\       if (__gnu_unwind_frame (ue_header, context) != _URC_OK)	\ 	return _URC_FAILURE;					\       return _URC_CONTINUE_UNWIND;				\     }								\   while (0)
end_define
...
directive|define
name|CONTINUE_UNWINDING
value|return _URC_CONTINUE_UNWIND
end_define
