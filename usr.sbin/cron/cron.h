...
begin_comment
comment|/* cron.h - header for vixie's cron  *  * From Id: cron.h,v 2.10 1994/01/15 20:43:43 vixie Exp  * $Header: $  *  * vix 14nov88 [rest of log is in RCS]  * vix 14jan87 [0 or 7 can be sunday; thanks, mwm@berkeley]  * vix 30dec86 [written]  */
end_comment
