...
condition|)
continue|continue;
comment|/* If requested, skip sockets not having the requested state. */
if|if
condition|(
operator|(
name|state
...
condition|)
continue|continue;
comment|/* If requested, skip sockets not having the requested stack. */
if|if
condition|(
name|strnlen
argument_list|(
...
literal|"       tcpdrop local-address.local-port foreign-address.foreign-port\n"
literal|"       tcpdrop [-l] -a\n"
literal|"       tcpdrop [-l] -S stack\n"
literal|"       tcpdrop [-l] -s state\n"
literal|"       tcpdrop [-l] -S stack -s state\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
