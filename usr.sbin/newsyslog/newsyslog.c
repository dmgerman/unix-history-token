...
argument_list|)
expr_stmt|;
comment|/* 	 * All config-file information has been read in and turned into 	 * a worklist.  If there were no specific files given on the run 	 * command, then the work of this routine is done. 	 */
if|if
condition|(
operator|*
name|files
...
name|dupent
expr_stmt|;
comment|/* This work entry is *not* a glob! */
name|dupent
operator|->
name|flags
operator|&=
...
expr_stmt|;
block|}
comment|/* 	 * Free all the entries in the original work list, and then 	 * return the new work list. 	 */
while|while
condition|(
name|worklist
condition|)
