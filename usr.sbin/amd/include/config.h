...
begin_comment
comment|/*  * Start of am-utils-6.x config.h file.  * Erez Zadok<ezk @ cs.sunysb.edu>  *  * DO NOT EDIT BY HAND.  * Note: generated by autoheader from configure.in.  */
end_comment
...
begin_comment
comment|/* Define if `flags' is member of `cdfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `fspec' is member of `cdfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `iso_flags' is member of `cdfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `iso_pgthresh' is member of `cdfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `norrip' is member of `cdfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `ssector' is member of `cdfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define to 1 if you have the `clnt_create_timed' function. */
end_comment

begin_define
define|#
directive|define
name|HAVE_CLNT_CREATE_TIMED
value|1
end_define
...
begin_comment
comment|/* Define if `flags' is member of `efs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `fspec' is member of `efs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `mnt_cnode' is member of `mntent_t'. */
end_comment
...
begin_comment
comment|/* Define if `mnt_ro' is member of `mntent_t'. */
end_comment
...
begin_comment
comment|/* Define if `mnt_time' is member of `mntent_t'. */
end_comment
...
begin_comment
comment|/* Define if `acdirmin' is member of `nfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `acregmin' is member of `nfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `bsize' is member of `nfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `fhsize' is member of `nfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `fh_len' is member of `nfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `gfs_flags' is member of `nfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `namlen' is member of `nfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `optstr' is member of `nfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `proto' is member of `nfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `sotype' is member of `nfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `version' is member of `nfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `dsttime' is member of `pcfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `sa_len' is member of `struct sockaddr'. */
end_comment
...
begin_comment
comment|/* Define if `f_fstypename' is member of `struct statfs'. */
end_comment
...
begin_comment
comment|/* Define if `flags' is member of `ufs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `fspec' is member of `ufs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `ufs_flags' is member of `ufs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `ufs_pgthresh' is member of `ufs_args_t'. */
end_comment
...
begin_comment
comment|/* Define to 1 if you have the `xdr_mountres3' function. */
end_comment
...
begin_comment
comment|/* Define if `flags' is member of `xfs_args_t'. */
end_comment
...
begin_comment
comment|/* Define if `fspec' is member of `xfs_args_t'. */
end_comment
