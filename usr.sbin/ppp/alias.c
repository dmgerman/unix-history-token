...
name|save_address
decl_stmt|;
comment|/* Save initial destination address */
name|save_address
operator|=
name|pip
operator|->
...
expr_stmt|;
block|}
comment|/* If destination address has changed, adjust IP checksum */
if|if
condition|(
name|pip
operator|->
...
expr_stmt|;
block|}
comment|/* Adjust IP checksum if source address has been aliased */
if|if
condition|(
name|pip
operator|->
