...
begin_comment
comment|/*  * $Header: nfsfh.h,v 1.3 94/06/12 14:32:58 leres Exp $  *  * nfsfh.h - NFS file handle definitions (for portable use)  *  * Jeffrey C. Mogul  * Digital Equipment Corporation  * Western Research Laboratory  */
end_comment
