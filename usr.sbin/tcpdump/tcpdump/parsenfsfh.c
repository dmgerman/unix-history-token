...
name|RCSid
init|=
literal|"$Header: /home/ncvs/src/usr.sbin/tcpdump/tcpdump/parsenfsfh.c,v 1.1 1995/03/08 12:52:23 olah Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  * Make sure that we use 32-bit integers when necessary.  The "x"  * suffix is to avoid possible identifier conflicts.  */
end_comment
