...
begin_comment
comment|/*	$Id: aldap.c,v 1.30 2012/04/30 21:40:03 jmatthew Exp $ */
end_comment

begin_comment
comment|/*	$OpenBSD: aldap.c,v 1.30 2012/04/30 21:40:03 jmatthew Exp $ */
end_comment
...
begin_comment
comment|/*  * Convert UTF-8 to ASCII.  * notes:  *	non-ASCII characters are displayed as '?'  *	the argument u should be a NULL terminated sequence of UTF-8 bytes.  */
end_comment
