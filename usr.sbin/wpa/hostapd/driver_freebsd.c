...
name|printf
argument_list|(
literal|"Unable to set WPA+RSN ie\n"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|MSG_DEBUG
argument_list|,
literal|"Discard routing message to if#%d "
literal|"(not for us %d)\n"
argument_list|,
name|ifan
operator|->
name|ifan_index
...
literal|"[%s] STA "
name|MACSTR
literal|" has been accepted by RADIUS ACL with timeout "
literal|"of %d.\n"
argument_list|,
name|hapd
operator|->
...
literal|"[%s] STA "
name|MACSTR
literal|" has been accepted by RADIUS ACL.\n"
argument_list|,
name|hapd
operator|->
name|conf
...
literal|"[%s] STA "
name|MACSTR
literal|" has been rejected by RADIUS ACL.\n"
argument_list|,
name|hapd
operator|->
name|conf
...
literal|"[%s] STA "
name|MACSTR
literal|" has unknown status (%d) by RADIUS ACL.  "
...
specifier|static
name|int
name|bsd_set_radius_acl_expire
parameter_list|(
name|void
modifier|*
name|priv
...
literal|"[%s] STA "
name|MACSTR
literal|" radius acl cache "
literal|"expired; nothing to do..."
argument_list|,
name|hapd
operator|->
name|conf
...
argument_list|)
expr_stmt|;
comment|/* 	 * NB: We require the interface name be mappable to an index. 	 *     This implies we do not support having wpa_supplicant 	 *     wait for an interface to appear.  This seems ok; that 	 *     doesn't belong here; it's really the job of devd. 	 *     XXXSCW: devd is FreeBSD-specific. 	 */
name|drv
operator|->
name|ifindex
operator|=
