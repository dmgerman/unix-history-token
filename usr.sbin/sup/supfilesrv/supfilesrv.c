...
directive|ifdef
name|notyet
comment|/* XXX re-enable when setproctitle() makes it back in XXX */
name|setproctitle
argument_list|(
literal|"supfilesrv: serving %s/%s to %s"
argument_list|,
name|collname
argument_list|,
name|release
