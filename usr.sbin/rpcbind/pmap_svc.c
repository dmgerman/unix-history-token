...
begin_comment
comment|/*	$NetBSD: pmap_svc.c,v 1.2 2000/10/20 11:49:40 fvdl Exp $	*/
end_comment
...
begin_comment
comment|/*  * pmap_svc.c  * The server procedure for the version 2 portmaper.  * All the portmapper related interface from the portmap side.  */
end_comment
