...
begin_comment
comment|/*  * $Header: /src/NTP/REPOSITORY/v3/parse/clk_trimble.c,v 3.9 1994/02/02 17:45:27 kardel Exp $  *  * Trimble TSIP support - CURRENTLY VERY MUCH UNDER CONSTRUCTION  */
end_comment
...
begin_comment
comment|/*  * History:  *  * $Log: clk_trimble.c,v $  */
end_comment
