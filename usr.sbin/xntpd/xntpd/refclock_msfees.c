...
name|LOG_INFO
argument_list|,
literal|"I: ees clock %d: %d == %d: await more"
argument_list|,
name|ees
operator|->
name|unit
...
name|LOG_ERR
argument_list|,
literal|"[%x] MSF%d: %3d/%03d -> d=%11d (%d|%d)"
argument_list|,
name|DB_LOG_DELTAS
argument_list|,
name|ees
...
name|LOG_INFO
argument_list|,
literal|"I: [%x] Offset=%06d (%d), disp=%06d%s [%d], %d %d=%d %d:%d %d=%d %d"
argument_list|,
name|debug
operator|&
operator|(
...
name|LOG_INFO
argument_list|,
literal|"I: [%x] Smooth data: %d -> %d, dispersion now %d"
argument_list|,
name|debug
operator|&
operator|(
...
name|LOG_INFO
argument_list|,
literal|"[%x] No smooth as delta not %d< %d< %d"
argument_list|,
name|debug
operator|&
operator|(
...
begin_comment
comment|/* msfees_leap - called when a leap second occurs */
end_comment
...
begin_comment
comment|/* msfees_control - set fudge factors, return statistics */
end_comment
...
name|LOG_ERR
argument_list|,
literal|"ees clock: unit %d invalid (max %d)"
argument_list|,
name|unit
argument_list|,
name|MAXUNITS
...
operator|++
expr_stmt|;
comment|/* if (in->flags& CLK_FLAG2&& unitinuse[unit]) 				ees->leaphold = 0; */
block|}
if|if
condition|(
name|in
...
begin_comment
comment|/* msfees_buginfo - return clock dependent debugging info */
end_comment
...
begin_comment
comment|/* defined(REFCLOCK)&& defined(MSFEESPPS)&& defined(STREAM) */
end_comment
