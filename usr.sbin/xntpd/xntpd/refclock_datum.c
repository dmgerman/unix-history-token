...
begin_comment
comment|/* current time (s) - not really  used */
end_comment
...
begin_comment
comment|/* global debug flag - not relly used */
end_comment
...
begin_comment
comment|/* log file for logging information */
end_comment
...
begin_comment
comment|/* ** Callback function prototypes that xntpd needs to know about. */
end_comment
...
begin_comment
comment|/* ** This is the call back function structure that xntpd actually uses for ** this refclock. */
end_comment
...
name|LOG_ERR
argument_list|,
literal|"Datum_PTS: Exiting - Termios not supported in this driver"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
...
directive|endif
comment|/* ** Initialize the xntpd IO structure */
name|datum_pts
operator|->
name|peer
operator|=
...
argument_list|)
comment|/*   logfile = fopen("xntpd.log", "w"); */
endif|#
directive|endif
name|logfile
operator|=
...
begin_comment
comment|/*	by the xntpd io handling routines. When 7 bytes have been	*/
end_comment
...
begin_comment
comment|/*	the xntpd clock_receive() routine which causes the systems	*/
end_comment
