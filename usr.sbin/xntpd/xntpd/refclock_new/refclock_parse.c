...
begin_comment
comment|/*  * This driver currently provides the support for  *   - Meinberg DCF77 receiver DCF77 PZF 535 (TCXO version) (DCF)  *   - Meinberg DCF77 receiver DCF77 PZF 535 (OCXO version) (DCF)  *   - Meinberg DCF77 receiver U/A 31                       (DCF)  *   - IGEL CLOCK                                           (DCF)  *   - ELV DCF7000                                          (DCF)  *   - Schmid clock                                         (DCF)  *   - Conrad DCF77 receiver module                         (DCF)  *   - FAU DCF77 NTP receiver (TimeBrick)                   (DCF)  *   - Meinberg GPS166                                      (GPS)  *   - Trimble SV6                                          (GPS)  *  */
end_comment
...
index|[]
operator|=
literal|"refclock_parse.c,v 3.59 1994/05/23 16:29:27 kardel Exp"
expr_stmt|;
end_expr_stmt
...
directive|define
name|RAWDCF_CFLAG
value|(B50|CS8|CREAD|CLOCAL|PARENB)
end_define
...
begin_comment
comment|/* ~258 ms - IGEL:clock receiver */
end_comment
...
value|(B1200|CS8|CREAD|HUPCL|CLOCAL)
end_define
...
name|tt
argument_list|,
literal|"refclock_driver_version=\"refclock_parse.c,v 3.59 1994/05/23 16:29:27 kardel Exp\""
argument_list|)
expr_stmt|;
name|out
operator|->
