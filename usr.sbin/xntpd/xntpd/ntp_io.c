...
begin_comment
comment|/*  * xntp_io.c - input/output routines for xntpd.  The socket-opening code  *	       was shamelessly stolen from ntpd.  */
end_comment
...
condition|)
block|{
comment|/* we have an explicit fd, so we can slose it */
name|close_socket
argument_list|(
name|inter_list
index|[
...
name|buff
argument_list|,
literal|"bind() fd %d, family %d, port %d, addr %08lx, in_classd=%d flags=%d fails: %%m"
argument_list|,
name|fd
argument_list|,
name|addr
...
name|printf
argument_list|(
literal|"bind() fd %d, family %d, port %d, addr %08lx, flags=%d\n"
argument_list|,
name|fd
argument_list|,
name|addr
...
name|printf
argument_list|(
literal|"%ssendpkt(fd=%d %s, %s, ttl=%d, %d)\n"
argument_list|,
operator|(
name|ttl
operator|>=
...
name|printf
argument_list|(
literal|"ignore/drop on %d(%lu) fd=%d from %s\n"
argument_list|,
name|i
argument_list|,
name|free_recvbufs
