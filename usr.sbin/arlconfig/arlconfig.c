...
begin_comment
comment|/*  * $RISS: if_arl/arlconfig/arlconfig.c,v 1.3 2003/01/13 07:23:25 count Exp $  */
end_comment
...
name|stderr
argument_list|,
literal|"\tfreq\t\tset Frequency Channel (2412, 2427, 2442, 2457, 2465)\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
name|stderr
argument_list|,
literal|"\tspread\t\tset Bitrate (354, 500, 1000, 2000)\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
name|stderr
argument_list|,
literal|"\tmode\t\tset Mode (640, 655, PSP).\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
...
name|stderr
argument_list|,
literal|"\tchannel\t\tset Channel (depended on country)\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
name|stderr
argument_list|,
literal|"\tbitrate\t\tset Bitrate (0-4)\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
...
directive|if
literal|0
block|fprintf(stderr, "\tparent\t\tset Arlan parent's MAC.\n"); 	fprintf(stderr, "\taddr\t\tset Arlan MAC.\n");
endif|#
directive|endif
name|fprintf
argument_list|(
...
name|stderr
argument_list|,
literal|"or: %s<ifname> quality<seconds> [count<count>]\n"
argument_list|,
name|progname
argument_list|)
expr_stmt|;
...
name|stderr
argument_list|,
literal|"\tprint receive packet level and quality with interval\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
...
literal|"       %-39s %s\n"
argument_list|,
literal|"Receive Level"
argument_list|,
literal|"Receive Quality"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|" pkts  0.......10 11............100>   pkts  0.......10 11............100>\n"
expr|\
literal|" -----+----------+-----------------+--- -----+----------+-----------------+---\n"
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"\tLevel min %d/avg %d/max %d\n"
argument_list|,
name|minLevel
argument_list|,
name|avgLevel
...
name|printf
argument_list|(
literal|"\tQuality min %d/avg %d/max %d\n"
argument_list|,
name|minQuality
argument_list|,
name|avgQuality
...
name|stb
decl_stmt|;
comment|/*static arl_quality	qlt;*/
name|int
name|sd
decl_stmt|,
name|argind
