...
comment|/* GCC intentionally overflows these next two in order to work      around limitations in the addressing modes, so don't complain      about overflow.  */
name|HOWTO
argument_list|(
name|R_M32C_16
argument_list|,
