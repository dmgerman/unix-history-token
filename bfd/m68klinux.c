...
name|mtype
parameter_list|)
value|((mtype) == M_68020 || (mtype) == M_UNKNOWN)
end_define
...
specifier|static
name|bfd_boolean
name|m68klinux_write_object_contents
name|PARAMS
argument_list|(
operator|(
name|bfd
...
value|m68klinux_bfd_final_link
end_define
...
value|m68klinux_write_object_contents
end_define
