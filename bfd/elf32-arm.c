...
begin_comment
comment|/* 32-bit ELF support for ARM    Copyright 1998, 1999, 2000, 2001, 2002, 2003, 2004, 2005, 2006    Free Software Foundation, Inc.     This file is part of BFD, the Binary File Descriptor library.     This program is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2 of the License, or    (at your option) any later version.     This program is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with this program; if not, write to the Free Software    Foundation, Inc., 51 Franklin Street - Fifth Floor, Boston, MA 02110-1301, USA.  */
end_comment
...
block|,
comment|/* pcrel_offset */
comment|/* FIXME: Has two more bits of offset in Thumb32.  */
name|HOWTO
argument_list|(
name|R_ARM_THM_CALL
argument_list|,
...
begin_comment
comment|/* Relocations 57 .. 83 are the "group relocations" which we do not    support.  */
end_comment
...
name|byteswap_code
decl_stmt|;
comment|/* Zero if R_ARM_TARGET1 means R_ARM_ABS32.        Nonzero if R_ARM_TARGET1 means R_ARM_ABS32.  */
name|int
name|target1_is_rel
decl_stmt|;
...
begin_comment
comment|/* ARM->Thumb glue (static images):     .arm    __func_from_arm:    ldr r12, __func_addr    bx  r12    __func_addr:    .word func    @ behave as if you saw a ARM_32 reloc.       (relocatable images)    .arm    __func_from_arm:    ldr r12, __func_offset    add r12, r12, pc    bx  r12    __func_offset:    .word func - .    */
end_comment
...
if|if
condition|(
name|elf32_arm_get_eabi_attr_int
argument_list|(
name|globals
operator|->
name|obfd
...
begin_comment
comment|/* Returns the size of the eabi object attributess section.  */
end_comment

begin_function
name|bfd_vma
name|elf32_arm_eabi_attr_size
parameter_list|(
name|bfd
modifier|*
name|abfd
...
begin_comment
comment|/* Write the contents of the eabi attributes section to p.  */
end_comment

begin_function
name|void
name|elf32_arm_set_eabi_attr_contents
parameter_list|(
name|bfd
modifier|*
name|abfd
...
begin_comment
comment|/* Override final_link to handle EABI object attribute sections.  */
end_comment

begin_function
specifier|static
name|bfd_boolean
name|elf32_arm_bfd_final_link
parameter_list|(
name|bfd
modifier|*
name|abfd
...
literal|0
decl_stmt|;
comment|/* elf32_arm_merge_private_bfd_data will already have merged the      object attributes.  Remove the input sections from the link, and set      the contents of the output secton.  */
for|for
control|(
name|o
operator|=
...
block|}
block|}
comment|/* Invoke the ELF linker to do all the work.  */
if|if
condition|(
operator|!
...
begin_function
name|void
name|elf32_arm_add_eabi_attr_int
parameter_list|(
name|bfd
modifier|*
name|abfd
...
begin_function
name|void
name|elf32_arm_add_eabi_attr_string
parameter_list|(
name|bfd
modifier|*
name|abfd
...
begin_function
name|void
name|elf32_arm_add_eabi_attr_compat
parameter_list|(
name|bfd
modifier|*
name|abfd
...
begin_comment
comment|/* Copy the eabi object attribute from IBFD to OBFD.  */
end_comment

begin_function
specifier|static
name|void
name|copy_eabi_attributes
parameter_list|(
name|bfd
modifier|*
name|ibfd
...
index|]
expr_stmt|;
comment|/* Copy EABI object attributes.  */
name|copy_eabi_attributes
argument_list|(
name|ibfd
argument_list|,
...
name|Tag_CPU_name
case|:
comment|/* Use whichever has the greatest architecture requirements.  */
if|if
condition|(
name|in_attr
index|[
...
name|_
argument_list|(
literal|"ERROR: %B: Conflicting enum sizes"
argument_list|)
argument_list|,
name|ibfd
argument_list|)
...
condition|)
block|{
comment|/* The only reloc that uses pc_count is R_ARM_REL32, which will 	 appear on something like ".long foo - .".  We want calls to 	 protected symbols to resolve directly to the function rather 	 than going via the plt.  If people want function pointer 	 comparisons to work as expected then they should avoid 	 writing assembly like ".long foo - .".  */
if|if
condition|(
name|SYMBOL_CALLS_LOCAL
argument_list|(
...
begin_comment
comment|/* Parse an Arm EABI attributes section.  */
end_comment

begin_function
specifier|static
name|void
name|elf32_arm_parse_attributes
parameter_list|(
name|bfd
modifier|*
name|abfd
...
condition|)
block|{
comment|/* Vendor section.  Ignore it.  */
name|p
operator|+=
name|namelen
operator|+
...
begin_comment
comment|/* Called for each symbol.  Builds a section map based on mapping symbols.    Does not alter any of the symbols.  */
end_comment

begin_function
specifier|static
name|bfd_boolean
name|elf32_arm_output_symbol_hook
parameter_list|(
name|struct
name|bfd_link_info
modifier|*
...
name|FALSE
return|;
comment|/* Only do this on final link.  */
if|if
condition|(
name|info
operator|->
...
name|TRUE
return|;
comment|/* Only build a map if we need to byteswap code.  */
if|if
condition|(
operator|!
name|globals
...
name|TRUE
return|;
comment|/* We only want mapping symbols.  */
if|if
condition|(
operator|!
name|bfd_is_arm_mapping_symbol_name
...
name|map
expr_stmt|;
comment|/* TODO: This may be inefficient, but we probably don't usually have many      mapping symbols per section.  */
name|newmap
operator|=
name|bfd_realloc
argument_list|(
...
value|elf32_arm_bfd_final_link
end_define
...
value|elf32_arm_output_symbol_hook
end_define
