...
specifier|static
name|bfd_boolean
name|sparc64_elf_new_section_hook
name|PARAMS
argument_list|(
operator|(
name|bfd
...
specifier|static
name|long
name|sparc64_elf_canonicalize_reloc
name|PARAMS
argument_list|(
operator|(
name|bfd
...
parameter_list|)
define|\
value|((struct sparc64_elf_section_data *) elf_section_data (sec))->do_relax
end_define
...
parameter_list|)
define|\
value|((struct sparc64_elf_section_data *) elf_section_data (sec))->reloc_count
end_define
...
name|FALSE
return|;
comment|/* The sparc64_elf_slurp_one_reloc_table routine increments      canon_reloc_count.  */
name|canon_reloc_count
argument_list|(
name|asect
argument_list|)
...
define|\
value|sparc64_elf_canonicalize_reloc
end_define
...
define|\
value|sparc64_elf_new_section_hook
end_define
