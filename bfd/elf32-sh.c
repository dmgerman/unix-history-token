...
directive|if
literal|0
block|if (ELF32_R_SYM (irelfn->r_info)< symtab_hdr->sh_info) 	{
comment|/* If this needs to be changed because of future relaxing, 	     it will be handled here like other internal IND12W 	     relocs.  */
block|bfd_put_16 (abfd, 		      (bfd_vma) 0xb000 | ((foff>> 1)& 0xfff), 		      contents + irel->r_offset); 	}       else
endif|#
directive|endif
block|{
...
name|_
argument_list|(
literal|"%s: unresolvable relocation against symbol `%s' from %s section"
argument_list|)
argument_list|,
name|bfd_archive_filename
argument_list|(
...
name|_
argument_list|(
literal|"%s: 0x%lx: fatal: unaligned %s relocation 0x%lx"
argument_list|)
argument_list|,
name|bfd_archive_filename
argument_list|(
...
name|_
argument_list|(
literal|"%s: 0x%lx: fatal: R_SH_PSHA relocation %d not in range -32..32"
argument_list|)
argument_list|,
name|bfd_archive_filename
argument_list|(
...
name|_
argument_list|(
literal|"%s: 0x%lx: fatal: R_SH_PSHL relocation %d not in range -32..32"
argument_list|)
argument_list|,
name|bfd_archive_filename
argument_list|(
