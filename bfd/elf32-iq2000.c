...
condition|)
block|{
comment|/* Warn if different cpu is used, but allow a 	 specific cpu to override the generic cpu.  */
name|new_partial
operator|=
operator|(
name|new_flags
...
value|iq2000_reloc_name_lookup
end_define
