...
condition|)
block|{
comment|/*     case bfd_mach_arc_base:       val = E_OR32_MACH_BASE;       break;     */
default|default:
name|val
operator|=
literal|0
