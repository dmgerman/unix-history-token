...
name|reloc_howto_type
modifier|*
name|elf_hppa_reloc_name_lookup
parameter_list|(
name|bfd
modifier|*
name|abfd
...
name|unsigned
name|int
name|elf_hppa_action_discarded
parameter_list|(
name|asection
modifier|*
name|sec
...
name|_
argument_list|(
literal|"%B(%A): warning: unresolvable relocation against symbol `%s'"
argument_list|)
argument_list|,
name|input_bfd
argument_list|,
