...
name|reloc_howto_type
modifier|*
name|bfin_bfd_reloc_name_lookup
parameter_list|(
name|bfd
modifier|*
name|abfd
...
argument_list|)
expr_stmt|;
comment|/* Only output a reloc for a not deleted entry.  */
if|if
condition|(
name|offset
operator|>=
...
name|abfd
argument_list|,
literal|"__PROCEDURE_LINKAGE_TABLE_"
argument_list|,
name|BSF_GLOBAL
argument_list|,
name|s
...
specifier|static
name|bfd_boolean
name|elf32_bfinfdpic_modify_program_headers
parameter_list|(
name|bfd
modifier|*
name|output_bfd
...
expr_stmt|;
block|}
comment|/* Set the header p_memsz from the symbol value.  We 	 intentionally ignore the symbol section.  */
if|if
condition|(
name|h
operator|&&
...
define|\
value|bfin_bfd_reloc_name_lookup
end_define
...
name|elf_backend_modify_program_headers
define|\
value|elf32_bfinfdpic_modify_program_headers
end_define
