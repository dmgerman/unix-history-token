...
literal|0
return|;
comment|/* Initialize our local data.  All zeros, and definitely easier      than setting 8 bit fields.  */
name|memset
argument_list|(
name|ret
argument_list|,
...
name|BFD_ASSERT
argument_list|(
argument|splt != NULL&& spltrel != NULL
argument_list|)
