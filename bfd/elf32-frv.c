...
begin_comment
comment|/* Check whether any of the relocations was optimized away, and    subtract it from the relocation or fixup count.  */
end_comment

begin_function
specifier|static
name|bfd_boolean
name|_frvfdpic_check_discarded_relocs
parameter_list|(
name|bfd
modifier|*
name|abfd
...
comment|/* we know (ELF32_R_TYPE (rel->r_info) == R_FRV_FUNCDESC) */
name|picrel
operator|->
name|relocsfd
operator|--
...
specifier|static
name|bfd_boolean
name|frvfdpic_elf_discard_info
parameter_list|(
name|bfd
modifier|*
name|ibfd
...
name|NULL
decl_stmt|;
comment|/* Account for relaxation of .eh_frame section.  */
for|for
control|(
name|s
operator|=
...
specifier|static
name|bfd_boolean
name|elf32_frvfdpic_modify_program_headers
parameter_list|(
name|bfd
modifier|*
name|output_bfd
...
name|elf_backend_modify_program_headers
define|\
value|elf32_frvfdpic_modify_program_headers
end_define
...
name|elf_backend_discard_info
define|\
value|frvfdpic_elf_discard_info
end_define
