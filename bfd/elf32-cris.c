...
name|_
argument_list|(
literal|"%s: unresolvable relocation %s against symbol `%s' from %s section"
argument_list|)
argument_list|,
...
name|_
argument_list|(
literal|"%s: No PLT nor GOT for relocation %s against\  symbol `%s' from %s section"
argument_list|)
else|:
name|_
argument_list|(
literal|"%s: No PLT for relocation %s against\  symbol `%s' from %s section"
argument_list|)
argument_list|,
name|bfd_archive_filename
argument_list|(
...
name|_
argument_list|(
literal|"%s: relocation %s with non-zero addend %d against local symbol from %s section"
argument_list|)
argument_list|,
name|bfd_archive_filename
argument_list|(
...
name|_
argument_list|(
literal|"%s: relocation %s with non-zero addend %d against symbol `%s' from %s section"
argument_list|)
argument_list|,
name|bfd_archive_filename
argument_list|(
...
name|_
argument_list|(
literal|"%s: relocation %s is not allowed for global symbol: `%s' from %s section"
argument_list|)
argument_list|,
name|bfd_archive_filename
argument_list|(
...
name|_
argument_list|(
literal|"%s: relocation %s in section %s with no GOT created"
argument_list|)
argument_list|,
name|bfd_archive_filename
argument_list|(
...
name|_
argument_list|(
literal|"%s: Internal inconsistency; no relocation section %s"
argument_list|)
argument_list|,
name|bfd_archive_filename
argument_list|(
...
condition|)
block|{
comment|/* Fill in the offset into the reloc table.  */
name|bfd_put_32
argument_list|(
name|output_bfd
argument_list|,
...
name|refcount
expr_stmt|;
comment|/* Mark the PLT offset to use the GOT entry by setting the low 	     bit in the plt offset; it is always a multiple of 	     pointer-size.  */
name|BFD_ASSERT
argument_list|(
operator|(
name|s
...
begin_comment
comment|/* Mark presence or absence of leading underscore.  */
end_comment
...
name|TRUE
expr_stmt|;
comment|/* Set flags according to current bfd_target.  */
name|cris_elf_final_write_processing
argument_list|(
name|obfd
argument_list|,
...
name|e_flags
expr_stmt|;
comment|/* Is this good or bad?  We'll follow with other excluding flags.  */
if|if
condition|(
operator|(
name|old_flags
...
name|_
argument_list|(
literal|"%s: uses _-prefixed symbols, but writing file with non-prefixed symbols"
argument_list|)
else|:
name|_
argument_list|(
literal|"%s: uses non-prefixed symbols, but writing file with _-prefixed symbols"
argument_list|)
argument_list|,
name|bfd_archive_filename
argument_list|(
