...
begin_comment
comment|// "breakpoint modify -c 'val == 3' breakpt-id" to break within c(int val) only
end_comment

begin_comment
comment|// when the value of the arg is 3.
end_comment
...
argument_list|)
return|;
comment|// Find the line number of c's parent call here.
return|return
name|val
return|;
block|}
