...
init|=
name|os_activity_create
argument_list|(
literal|"parent-activity"
argument_list|,
name|OS_ACTIVITY_CURRENT
argument_list|,
name|OS_ACTIVITY_FLAG_DEFAULT
argument_list|)
decl_stmt|;
name|os_activity_apply
argument_list|(
name|parent_activity
argument_list|,
lambda|^
...
name|logger_sub1
argument_list|,
literal|"This is the log message."
argument_list|)
expr_stmt|;
block|}
argument_list|)
