...
name|sccsid
init|=
literal|"@(#)rvcat.c	1.2 (Berkeley) 8/9/81"
decl_stmt|;
end_decl_stmt
...
literal|1
expr_stmt|;
comment|/* Assume varian unless -W. */
name|banarg
operator|=
name|NULL
expr_stmt|;
...
name|stderr
argument_list|,
literal|"usage: rvcat [ -t ] [ -w ] [ -b banner ] [ file... ]\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
...
name|stderr
argument_list|,
literal|"Can't load initial font\n"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|stderr
argument_list|,
literal|"Internal error: illegal font\n"
argument_list|)
expr_stmt|;
return|return
operator|(
...
argument_list|)
expr_stmt|;
comment|/* fprintf(stderr, "allocated %d bytes at %x\n", i * j, cp); */
return|return
operator|(
name|cp
operator|)
...
begin_block
block|{
comment|/* fprintf(stderr, "freeing at %x\n", cp); */
name|free
argument_list|(
name|cp
argument_list|)
...
condition|)
block|{
comment|/* Versatec uses just a small banner. */
if|if
condition|(
name|s
operator|==
