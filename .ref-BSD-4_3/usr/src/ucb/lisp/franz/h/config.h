...
begin_comment
comment|/*					-[Thu Mar  3 15:57:51 1983 by jkf]-  * 	config.h			$Locker:  $  * configuration dependent info  *  * $Header: config.h,v 1.15 85/03/24 11:06:27 sklower Exp $  *  * (c) copyright 1982, Regents of the University of California  */
end_comment
