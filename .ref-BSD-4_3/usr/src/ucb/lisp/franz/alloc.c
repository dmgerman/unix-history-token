...
name|rcsid
init|=
literal|"$Header: alloc.c,v 1.12 85/03/24 10:59:57 sklower Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*					-[Thu Feb  2 16:15:30 1984 by jkf]-  * 	alloc.c				$Locker:  $  * storage allocator and garbage collector  *  * (c) copyright 1982, Regents of the University of California  */
end_comment
...
name|p
parameter_list|)
value|((int)bbitmap[r=(int)p>>5]& (s=bitmsk[((int)p>>2)&7]))
end_define
...
name|p
parameter_list|)
value|(bbitmap[(int)p>>5]& bitmsk[((int)p>>2)& 7])
end_define

begin_comment
comment|/* # define setbit(p)	{bbitmap[(int)p>>5] |= bitmsk[((int)p>> 2)& 7];} */
end_comment
