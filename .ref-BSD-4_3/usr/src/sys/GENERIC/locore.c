...
begin_asm
asm|asm(".set	U_ARG,156");
end_asm

begin_asm
asm|asm(".set	U_QSAVE,192");
end_asm
...
name|space
literal|4
comment|/*  * Copyright (c) 1982, 1986 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)scb.s	7.1 (Berkeley) 6/5/86  */
include|#
directive|include
file|"uba.h"
...
name|I_UBA3
value|48
comment|/*  * Copyright (c) 1980, 1986 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  *	@(#)locore.s	7.1 (Berkeley) 6/5/86  */
include|#
directive|include
file|"psl.h"
include|#
...
argument|mbutl
argument_list|,
argument|NMBCLUSTERS*CLSIZE+CLSIZE
argument_list|)
name|SYSMAP
argument_list|(
argument|camap
...
directive|ifdef
name|VAX630
comment|/* leave an area for uVAX II console scratch pad at the top */
name|cmpb
name|_cpu
operator|,
name|$VAX_630
...
name|r2
decl_stmt|,1b
comment|/* make rpb, scb read-only as red zone for interrupt stack */
name|bicl2
name|$PG_PROT
decl_stmt|,
name|_rpbmap
...
directive|ifdef
name|notdef
comment|/* this is now expanded completely inline */
operator|.
name|align
literal|1
name|JSBENTRY
...
name|PCLOC
value|16
comment|/* location of pc in calls frame */
define|#
directive|define
name|APLOC
value|8
comment|/* location of ap,fp in calls frame */
operator|.
name|align
literal|1
name|JSBENTRY
...
for|.globl	_masterpaddr 	.data _masterpaddr: 	.long	0  	.set	ASTLVL_NONE
operator|,
literal|4
operator|.
name|text
...
begin_for
for|for non-empty queue 	bneq	sw1 	brb	idle  badsw:	pushab	sw0 	calls	$1
operator|,
name|_panic
comment|/*NOTREACHED*/
