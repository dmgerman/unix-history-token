...
begin_comment
comment|/* celerity preprocessor defines "accel", however the following is clearer */
end_comment
...
begin_comment
comment|/* #define NO_UNION_TYPE would be preferable,    but it does not work, and the reason is not yet known.  */
end_comment
