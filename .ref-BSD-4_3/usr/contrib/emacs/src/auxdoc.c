...
begin_comment
comment|/* Auxiliary documentation strings for built-in functions of GNU Emacs.    Copyright (C) 1985 Richard M. Stallman.  This file is part of GNU Emacs.  GNU Emacs is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY.  No author or distributor accepts responsibility to anyone for the consequences of using it or for whether it serves any particular purpose or works at all, unless he says so in writing.  Refer to the GNU Emacs General Public License for full details.  Everyone is granted permission to copy, modify and redistribute GNU Emacs, but only under the conditions described in the GNU Emacs General Public License.   A copy of this license is supposed to have been given to you along with GNU Emacs so you can know your rights and responsibilities.  It should be in a file named COPYING.  Among other things, the copyright notice and this notice must be preserved on all copies.  */
end_comment
...
begin_for
for|for GNU Emacs but it is not. It is processed only by make-docfile. The reason these functions' doc strings are here is that the C preprocessor crashes on strings this long. So we put a 0 for the doc string in the real C source file and give this file to make-docfile as if it were the C source. *********   DEFUN ("modify-syntax-entry", foo, bar, 0, 0, 0,   "Set syntax for character CHAR according to string S.\n\ The syntax is changed only for table TABLE, which defaults to\n\  the current buffer's syntax table.\n\ The first character of S should be one of the following:\n\   Space    whitespace syntax.    w   word constituent.\n\   _        symbol constituent.   .   punctuation.\n\
control|(
name|open
operator|-
name|parenthesis
