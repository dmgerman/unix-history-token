...
name|rcsid_xhost_c
init|=
literal|"$Header: xhost.c,v 10.9 86/02/01 15:59:16 tony Rel $"
decl_stmt|;
end_decl_stmt
...
name|stderr
argument_list|,
literal|"%s: Can't connect to display!\n"
argument_list|,
name|argv
index|[
literal|0
...
name|address
decl_stmt|;
comment|/* Raw addresses are the ones that begin with a digit (do this for speed) */
if|if
condition|(
name|isdigit
argument_list|(
