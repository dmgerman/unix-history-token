...
index|[]
init|=
literal|"$Header: code.c,v 2.1 86/01/21 10:04:02 jqj Exp $"
decl_stmt|;
end_decl_stmt
...
name|WARNING
argument_list|,
literal|"Module %s already seen.  Using %s."
argument_list|,
name|symbol
argument_list|,
name|tempsym
