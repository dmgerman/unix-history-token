...
index|[]
init|=
literal|"@(#)$Header: rn.c,v 4.3.1.3 85/05/16 16:47:10 lwall Exp $"
decl_stmt|;
end_decl_stmt

begin_comment
comment|/* $Log:	rn.c,v $  * Revision 4.3.1.3  85/05/16  16:47:10  lwall  * Catchup confirmation didn't grok -t.  *   * Revision 4.3.1.2  85/05/13  09:34:53  lwall  * Fixed default after do_newsgroup() returns from Q command.  *   * Revision 4.3.1.1  85/05/10  11:38:08  lwall  * Branch for patches.  *   * Revision 4.3  85/05/01  11:47:56  lwall  * Baseline for release with 4.3bsd.  *   */
end_comment
