...
begin_comment
comment|/*  *  Interpress utilities  *  * Copyright (c) 1984, 1985 Xerox Corp.  *  *  Written for Xerox Corporation by William LeFebvre  *  31-May-1984  *  * History:  *	26-apr-85  ed flint	add macros to set standard imager variables  */
end_comment
