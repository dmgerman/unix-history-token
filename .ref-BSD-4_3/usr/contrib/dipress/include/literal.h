...
begin_comment
comment|/*  *  Interpress utilities  *  * Copyright (c) 1984, 1985 Xerox Corp.  *  *  Written for Xerox Corporation by William LeFebvre  *  30-May-1984  *  */
end_comment
...
parameter_list|)
define|\
value|append_word((unsigned short)(number + INTEGER_ZERO))
end_define
...
begin_comment
comment|/* An abbreviation for AppendOp: */
end_comment
