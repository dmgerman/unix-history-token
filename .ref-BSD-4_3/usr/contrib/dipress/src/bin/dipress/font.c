...
begin_comment
comment|/******************************************************************************  *  font - 	manages the fonts and their associated descriptor files for  *		processing ditroff commands into interpress  *  *  *	William LeFebvre (Xerox Corp)  *	with modifications by John Mellor-Crummey (Xerox Corp)  *  * 	Copyright (c) 1984,1985 Xerox Corp.  *  * HISTORY  * 15-Jan-86  lee at Xerox, WRC  *	Fixed NULL pointer de-reference.  *  *  ******************************************************************************/
end_comment
