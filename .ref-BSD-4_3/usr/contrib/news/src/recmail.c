...
name|SccsId
init|=
literal|"@(#)recmail.c	1.13	3/19/86"
decl_stmt|;
end_decl_stmt
...
argument_list|)
expr_stmt|;
comment|/* 	 * Force the path to only consider /bin and /usr/bin, since 	 * that's the version of mail we want (not /usr/ucb/mail) 	 * This code will probably cause a core dump some day. 	 */
name|mypath
operator|=
name|getenv
argument_list|(
