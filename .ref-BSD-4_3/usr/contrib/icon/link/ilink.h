...
begin_comment
comment|/*  * External declarations for the linker.  */
end_comment
...
begin_comment
comment|/* location of iconx to put in #! line */
end_comment
...
begin_comment
comment|/*  * Interpreter code file header - this is written at the start of  *  an icode file after the start-up program (if any) and the #! line.  */
end_comment
...
name|g_pc
decl_stmt|;
comment|/*   position in icode of object */
block|}
struct|;
end_struct
...
begin_comment
comment|/*  * Structure for linked list of file names to link.  */
end_comment
...
begin_comment
comment|/* # of bytes in interpreter operands */
end_comment
...
begin_comment
comment|/* # of bytes in a pointer (sizeof(int *)) */
end_comment
...
begin_comment
comment|/*#define LONGS			/* longs are different from ints */
end_comment

begin_comment
comment|/*#define MINSHORT       x	/* smallest short integer */
end_comment

begin_comment
comment|/*#define MAXSHORT       x	/* largest short integer */
end_comment
...
begin_comment
comment|/* longs are different from ints */
end_comment
...
begin_comment
comment|/* size of record constructor block */
end_comment
...
begin_comment
comment|/*  * Cset accessing macros.  The definition of setb(b,c) is the total  *  result of the following definitions.  setb is only used in  *  code.c/emitcon.  */
end_comment
