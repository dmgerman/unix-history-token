...
begin_comment
comment|/** @file ostream  *  This is a Standard C++ Library header.  */
end_comment
...
comment|// DR 60. What is a formatted input function?
comment|// The inserters for manipulators are *not* formatted output functions.
return|return
name|__pf
argument_list|(
operator|*
...
block|{
comment|// _GLIBCXX_RESOLVE_LIB_DEFECTS
comment|// 117. basic_ostream uses nonexistent num_put member functions.
return|return
name|_M_insert
argument_list|(
argument|static_cast<unsigned long>(__n)
argument_list|)
return|;
block|}
end_expr_stmt
