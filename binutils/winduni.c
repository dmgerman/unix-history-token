...
directive|else
comment|/* We use  MultiByteToWideChar rather than strlen to get the unicode      string length to allow multibyte "ascii" chars. The value returned      by this function includes the trailing '\0'.  */
name|len
operator|=
