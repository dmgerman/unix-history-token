...
begin_comment
comment|/* dlltool.c -- tool to generate stuff for PE style DLLs    Copyright 1995, 1996, 1997, 1998, 1999, 2000, 2001, 2002, 2003, 2004,    2005, 2006 Free Software Foundation, Inc.     This file is part of GNU Binutils.     This program is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2 of the License, or    (at your option) any later version.     This program is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with this program; if not, write to the Free Software    Foundation, Inc., 51 Franklin Street - Fifth Floor, Boston, MA    02110-1301, USA.  */
end_comment
...
begin_comment
comment|/* External name alias numbering starts here.  */
end_comment

begin_define
define|#
directive|define
name|PREFIX_ALIAS_BASE
value|20000
end_define
...
directive|define
name|TMP_HEAD_S
value|dlltmp (&tmp_head_s_buf, "%sh.s")
end_define
...
directive|define
name|TMP_HEAD_O
value|dlltmp (&tmp_head_o_buf, "%sh.o")
end_define
...
directive|define
name|TMP_TAIL_S
value|dlltmp (&tmp_tail_s_buf, "%st.s")
end_define
...
directive|define
name|TMP_TAIL_O
value|dlltmp (&tmp_tail_o_buf, "%st.o")
end_define
...
directive|define
name|TMP_STUB
value|dlltmp (&tmp_stub_buf, "%ss")
end_define

begin_comment
comment|/* This bit of assembly does jmp * ....  */
end_comment
...
begin_comment
comment|/* This is the glue sequence for PowerPC PE. There is a    tocrel16-tocdefn reloc against the first instruction.    We also need a IMGLUE reloc against the glue function    to restore the toc saved by the third instruction in    the glue.  */
end_comment
...
begin_comment
comment|/* The glue instruction, picks up the toc from the stw in    the above code: "lwz r2,4(r1)".  */
end_comment
...
name|noname
decl_stmt|;
comment|/* Don't put name in image file.  */
name|int
name|private
decl_stmt|;
comment|/* Don't put reference in import lib.  */
name|int
name|data
decl_stmt|;
name|int
...
name|M386
case|:
comment|/* Symbol names starting with ? do not have a leading underscore. */
if|if
condition|(
name|name
operator|&&
...
name|_
argument_list|(
literal|"%s: Path components stripped from image name, '%s'."
argument_list|)
argument_list|,
name|def_file
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* Don't add a leading underscore for fastcall symbols.  */
if|if
condition|(
operator|*
name|exclude_string
...
begin_comment
comment|/* Sections numbered to make the order the same as other PowerPC NT    compilers. This also keeps funny alignment thingies from happening.  */
end_comment
...
directive|ifdef
name|DLLTOOL_PPC
comment|/* The symbol referring to the code (.text).  */
block|{
name|asymbol
modifier|*
name|function_name
...
case|:
block|{
comment|/* The .pdata section is 5 words long. 	       Think of it as: 	       struct 	       { 	       bfd_vma BeginAddress,     [0x00] 	       EndAddress,       [0x04] 	       ExceptionHandler, [0x08] 	       HandlerData,      [0x0c] 	       PrologEndAddress; [0x10] 	       };  */
...
control|)
block|{
comment|/* Don't delete non-existent stubs for PRIVATE entries.  */
if|if
condition|(
name|exp
operator|->
...
name|_
argument_list|(
literal|"   -U --add-underscore       Add underscores to all symbols in interface library.\n"
argument_list|)
argument_list|)
expr_stmt|;
name|fprintf
...
name|_
argument_list|(
literal|"      --add-stdcall-underscore Add underscores to stdcall symbols in interface library.\n"
argument_list|)
argument_list|)
expr_stmt|;
name|fprintf
...
name|_
argument_list|(
literal|"   -p --ext-prefix-alias<prefix> Add aliases with<prefix>.\n"
argument_list|)
argument_list|)
expr_stmt|;
name|fprintf
...
name|_
argument_list|(
literal|"   -t --temp-prefix<prefix> Use<prefix> to construct temp file names.\n"
argument_list|)
argument_list|)
expr_stmt|;
name|fprintf
...
define|#
directive|define
name|OPTION_ADD_STDCALL_UNDERSCORE
...
block|}
block|,
comment|/* for compatibility with older versions */
block|{
literal|"input-def"
block|,
name|required_argument
...
block|,
block|{
literal|"add-stdcall-underscore"
block|,
name|no_argument
block|,
name|NULL
...
directive|ifdef
name|DLLTOOL_MCORE_ELF
literal|"m:e:l:aD:d:z:b:xp:cCuUkAS:f:nvVHhM:L:F:"
argument_list|,
else|#
directive|else
literal|"m:e:l:aD:d:z:b:xp:cCuUkAS:f:nvVHh"
argument_list|,
endif|#
directive|endif
name|long_options
...
name|_
argument_list|(
literal|"Path components stripped from dllname, '%s'."
argument_list|)
argument_list|,
name|optarg
argument_list|)
...
condition|)
block|{
comment|/* If we are inferring dll_name from exp_name,          strip off any path components, without emitting          a warning.  */
specifier|const
name|char
modifier|*
name|exp_basename
