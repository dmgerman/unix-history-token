...
begin_comment
comment|/*  * $Source: /mit/kerberos/src/admin/RCS/kdb_edit.c,v $  * $Author: jtkohl $  *  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  *  * This routine changes the Kerberos encryption keys for principals,  * i.e., users or services.   */
end_comment
...
specifier|static
name|char
name|rcsid_kdb_edit_c
index|[]
init|=
literal|"$Header: kdb_edit.c,v 4.1 89/03/23 09:58:18 jtkohl Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* zaptime code taken from: */
end_comment
