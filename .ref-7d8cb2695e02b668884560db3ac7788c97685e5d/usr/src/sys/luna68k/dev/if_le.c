...
begin_comment
comment|/*  * Copyright (c) 1982, 1990 The Regents of the University of California.  * All rights reserved.  *  * %sccs.include.redist.c%  *  * from: hp300/dev/if_le.c	7.16 (Berkeley) 3/11/93  *  *	@(#)if_le.c	7.6 (Berkeley) %G%  */
end_comment
...
index|]
expr_stmt|;
comment|/* ETHER0 must be here */
comment|/* one port only now  XXX */
block|}
else|else
endif|#
directive|endif
