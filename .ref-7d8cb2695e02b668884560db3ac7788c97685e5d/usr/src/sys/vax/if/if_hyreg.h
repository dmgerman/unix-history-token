...
begin_comment
comment|/*  * Copyright (c) 1988 Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Tektronix Inc.  *  * %sccs.include.redist.c%  *  *	@(#)if_hyreg.h	7.3 (Berkeley) %G%  */
end_comment

begin_comment
comment|/*  * Modifications from Berkeley 4.2 BSD  * Copyright (c) 1983, Tektronix Inc.  * All Rights Reserved  */
end_comment
