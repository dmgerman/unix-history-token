...
begin_comment
comment|/*  * Copyright (c) 1989 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Excelan Inc.  *  * %sccs.include.redist.c%  *  *	@(#)if_ex.c	7.5 (Berkeley) %G%  */
end_comment
