...
begin_comment
comment|/*-  * Copyright (c) 1993  *	The Regents of the University of California.  All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Kenneth Almquist.  *  * %sccs.include.redist.c%  */
end_comment
...
argument_list|(
operator|(
literal|"evaltree(0x%x: %d) called\n"
operator|,
operator|(
name|int
operator|)
...
argument_list|(
operator|(
literal|"evalcommand(0x%x, %d) called\n"
operator|,
operator|(
name|int
operator|)
