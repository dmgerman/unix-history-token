...
index|[]
init|=
literal|"@(#)px_header.c	5.3 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  * pxheader - program to sit in front of interpreter code to make shell mods  *	      unnecessary to make Pascal obj's look like real programs.  *  * Bill Joy UCB February 6, 1978  */
end_comment
