...
begin_comment
comment|/*-  * Copyright (c) 1992 Henry Spencer.  * Copyright (c) 1992, 1993  *	The Regents of the University of California.  All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Henry Spencer of the University of Toronto.  *  * %sccs.include.redist.c%  *  *	@(#)regcomp.c	8.1 (Berkeley) %G%  */
end_comment
...
index|[]
init|=
literal|"@(#)regcomp.c	8.1 (Berkeley) %G%"
decl_stmt|;
end_decl_stmt
...
name|p_ere
parameter_list|(
comment|/*register struct parse *p, int stop*/
parameter_list|)
function_decl|;
end_function_decl
...
name|p_ere_exp
parameter_list|(
comment|/*register struct parse *p*/
parameter_list|)
function_decl|;
end_function_decl
...
name|p_bre
parameter_list|(
comment|/*register struct parse *p, register int end1, register int end2*/
parameter_list|)
function_decl|;
end_function_decl
...
name|p_simp_re
parameter_list|(
comment|/*register struct parse *p, int starordinary*/
parameter_list|)
function_decl|;
end_function_decl
...
name|p_b_term
parameter_list|(
comment|/*register struct parse *p, register cset *cs*/
parameter_list|)
function_decl|;
end_function_decl
...
name|p_b_coll_elem
parameter_list|(
comment|/*register struct parse *p, int endc*/
parameter_list|)
function_decl|;
end_function_decl
...
name|bothcases
parameter_list|(
comment|/*register struct parse *p, int ch*/
parameter_list|)
function_decl|;
end_function_decl
...
name|ordinary
parameter_list|(
comment|/*register struct parse *p, register int ch*/
parameter_list|)
function_decl|;
end_function_decl
...
name|repeat
parameter_list|(
comment|/*register struct parse *p, sopno start, int from, int to*/
parameter_list|)
function_decl|;
end_function_decl
...
name|seterr
parameter_list|(
comment|/*register struct parse *p, int e*/
parameter_list|)
function_decl|;
end_function_decl
...
name|mcadd
parameter_list|(
comment|/*register struct parse *p, register cset *cs, register char *cp*/
parameter_list|)
function_decl|;
end_function_decl
...
name|mcsub
parameter_list|(
comment|/*register cset *cs, register char *cp*/
parameter_list|)
function_decl|;
end_function_decl
...
name|isinsets
parameter_list|(
comment|/*register struct re_guts *g, int c*/
parameter_list|)
function_decl|;
end_function_decl
...
name|samesets
parameter_list|(
comment|/*register struct re_guts *g, int c1, int c2*/
parameter_list|)
function_decl|;
end_function_decl
...
name|categorize
parameter_list|(
comment|/*struct parse *p, register struct re_guts *g*/
parameter_list|)
function_decl|;
end_function_decl
...
name|dupl
parameter_list|(
comment|/*register struct parse *p, sopno start, sopno finish*/
parameter_list|)
function_decl|;
end_function_decl
...
name|doemit
parameter_list|(
comment|/*register struct parse *p, sop op, size_t opnd*/
parameter_list|)
function_decl|;
end_function_decl
...
name|doinsert
parameter_list|(
comment|/*register struct parse *p, sop op, size_t opnd, sopno pos*/
parameter_list|)
function_decl|;
end_function_decl
...
name|dofwd
parameter_list|(
comment|/*register struct parse *p, sopno pos, sop value*/
parameter_list|)
function_decl|;
end_function_decl
...
name|enlarge
parameter_list|(
comment|/*register struct parse *p, sopno size*/
parameter_list|)
function_decl|;
end_function_decl
...
name|stripsnug
parameter_list|(
comment|/*register struct parse *p, register struct re_guts *g*/
parameter_list|)
function_decl|;
end_function_decl
...
begin_comment
comment|/*  - regcomp - interface for parser and compilation  = extern int regcomp(regex_t *preg, const char *pattern, int cflags);  = #define	REG_BASIC	0000  = #define	REG_EXTENDED	0001  = #define	REG_ICASE	0002  = #define	REG_NOSUB	0004  = #define	REG_NEWLINE	0010  = #define	REG_NOSPEC	0020  = #define	REG_PEND	0040  = #define	REG_DUMP	0200  */
end_comment
...
begin_comment
comment|/*  - mcinvert - invert the list of collating elements in a cset  == static void mcinvert(register cset *cs);  *  * This would have to know the set of possibilities.  Implementation  * is deferred.  */
end_comment
...
begin_comment
comment|/*  - mccase - add case counterparts of the list of collating elements in a cset  == static void mccase(register cset *cs);  *  * This would have to know the set of possibilities.  Implementation  * is deferred.  */
end_comment
