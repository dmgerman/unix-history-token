...
begin_comment
comment|/*  * $Source: /mit/kerberos/src/kuser/RCS/klist.c,v $  * $Author: jtkohl $   *  * Copyright 1987, 1988 by the Massachusetts Institute of Technology.   *  * For copying and distribution information, please see the file  *<mit-copyright.h>.   *  * Lists your current Kerberos tickets.  * Written by Bill Sommerfeld, MIT Project Athena.  */
end_comment
...
index|[]
init|=
literal|"$Header: klist.c,v 4.11 89/01/23 09:34:58 jtkohl Exp $"
decl_stmt|;
end_decl_stmt
...
name|stderr
argument_list|,
literal|"%s: can't find local realm: %s\n"
argument_list|,
name|whoami
argument_list|,
name|krb_err_txt
