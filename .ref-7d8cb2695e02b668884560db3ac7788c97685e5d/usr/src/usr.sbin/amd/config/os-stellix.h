...
begin_comment
comment|/*  * Copyright (c) 1989 Jan-Simon Pendry  * Copyright (c) 1989 Imperial College of Science, Technology& Medicine  * Copyright (c) 1989 The Regents of the University of California.  * All rights reserved.  *  * This code is derived from software contributed to Berkeley by  * Jan-Simon Pendry at Imperial College, London.  *  * %sccs.include.redist.c%  *  *	@(#)os-stellix.h	5.2 (Berkeley) %G%  *  * Amd (automounter) definitions for Stellix.  * From Stephen C. Pope<scp@acl.lanl.gov>  *  * $Id: os-stellix.h,v 5.2.2.1 1992/02/09 15:10:43 jsp beta $  */
end_comment
