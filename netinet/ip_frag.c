...
index|[]
init|=
literal|"@(#)$Id: ip_frag.c,v 2.77.2.12 2007/09/20 12:51:51 darrenr Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* Parameters:  fra - pointer to frag structure to free                     */
end_comment
...
begin_comment
comment|/* Take care of the details associated with deleting an entry from the frag */
end_comment

begin_comment
comment|/* cache.  Currently this just means bumping stats correctly after freeing  */
end_comment
...
begin_comment
comment|/*              tail(I)  - tail of the fragment list                        */
end_comment
...
begin_comment
comment|/* fragment cache - hence the reason for passing in top, tail and lock.     */
end_comment
