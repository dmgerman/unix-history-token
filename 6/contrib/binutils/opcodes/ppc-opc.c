...
block|}
block|,
comment|/* The RS field of the DS form stq instruction, which has special      value restrictions.  */
define|#
directive|define
name|RSQ
value|RS + 1
...
block|}
block|,
comment|/* The RT field of the DQ form lq instruction, which has special      value restrictions.  */
define|#
directive|define
name|RTQ
value|RSQ + 1
...
name|_
argument_list|(
literal|"offset not a multiple of 16"
argument_list|)
expr_stmt|;
return|return
name|insn
...
name|_
argument_list|(
literal|"offset not a multiple of 2"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|_
argument_list|(
literal|"offset greater than 62"
argument_list|)
expr_stmt|;
return|return
name|insn
...
name|_
argument_list|(
literal|"offset greater than 124"
argument_list|)
expr_stmt|;
return|return
name|insn
...
name|_
argument_list|(
literal|"offset not a multiple of 8"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|_
argument_list|(
literal|"offset greater than 248"
argument_list|)
expr_stmt|;
return|return
name|insn
...
begin_comment
comment|/* The DE field in a DE form instruction.  */
end_comment
...
name|_
argument_list|(
literal|"offset not between -2048 and 2047"
argument_list|)
expr_stmt|;
return|return
name|insn
...
begin_comment
comment|/* The DES field in a DES form instruction.  */
end_comment
...
name|_
argument_list|(
literal|"offset not between -8192 and 8191"
argument_list|)
expr_stmt|;
elseif|else
if|if
...
condition|)
empty_stmt|;
comment|/* If only one bit of the FXM field is set, we can use the new form      of the instruction, which is faster.  Unlike the Power4 branch hint      encoding, this is not backward compatible.  */
elseif|else
if|if
condition|(
operator|(
...
name|_
argument_list|(
literal|"target register operand must be even"
argument_list|)
expr_stmt|;
return|return
name|insn
...
name|_
argument_list|(
literal|"source register operand must be even"
argument_list|)
expr_stmt|;
return|return
name|insn
