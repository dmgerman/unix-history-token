...
begin_comment
comment|/* sparc64 privileged registers.  */
end_comment
...
name|_
argument_list|(
literal|"Illegal operands: %%%s cannot be used together with other relocs in the insn ()"
argument_list|)
argument_list|,
name|o
operator|->
...
name|_
argument_list|(
literal|"Illegal operands: %%%s can be only used with call __tls_get_addr"
argument_list|)
argument_list|,
name|o
operator|->
...
name|_
argument_list|(
literal|": There are only 32 single precision f registers; [0-31]"
argument_list|)
expr_stmt|;
goto|goto
name|error
...
name|_
argument_list|(
literal|": TLS operand can't be a constant"
argument_list|)
expr_stmt|;
goto|goto
name|error
...
directive|ifdef
name|OBJ_ELF
comment|/* SPARC ELF relocations don't use an addend in the data field.  */
if|if
condition|(
name|fixP
operator|->
...
name|_
argument_list|(
literal|".COMMon length (%lu) out of range ignored"
argument_list|)
argument_list|,
operator|(
name|unsigned
...
begin_comment
comment|/* Handle the .empty pseudo-op.  This suppresses the warnings about    invalid delay slot usage.  */
end_comment
...
begin_comment
comment|/* This static variable is set by s_uacons to tell sparc_cons_align    that the expression does not need to be aligned.  */
end_comment
...
name|_
argument_list|(
literal|"Illegal operands: %%r_tls_dtpoff in %d-byte data field"
argument_list|)
argument_list|,
name|size
argument_list|)
