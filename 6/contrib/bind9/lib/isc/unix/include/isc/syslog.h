...
begin_comment
comment|/* $Id: syslog.h,v 1.2.206.1 2004/03/06 08:15:05 marka Exp $ */
end_comment
...
begin_comment
comment|/*  * Convert 'str' to the appropriate syslog facility constant.  *  * Requires:  *  *	'str' is not NULL  *	'facilityp' is not NULL  *  * Returns:  * 	ISC_R_SUCCESS  * 	ISC_R_NOTFOUND  */
end_comment
