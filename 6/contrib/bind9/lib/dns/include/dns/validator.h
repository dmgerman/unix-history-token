...
begin_comment
comment|/* $Id: validator.h,v 1.18.12.15 2007/09/19 03:41:33 marka Exp $ */
end_comment
...
name|result
decl_stmt|;
comment|/* 	 * Name and type of the response to be validated. 	 */
name|dns_name_t
modifier|*
name|name
decl_stmt|;
...
name|type
decl_stmt|;
comment|/* 	 * Rdata and RRSIG (if any) for positive responses. 	 */
name|dns_rdataset_t
modifier|*
name|rdataset
decl_stmt|;
...
name|sigrdataset
decl_stmt|;
comment|/* 	 * The full response.  Required for negative responses. 	 * Also required for positive wildcard responses. 	 */
name|dns_message_t
modifier|*
name|message
decl_stmt|;
comment|/* 	 * Proofs to be cached. 	 */
name|dns_name_t
modifier|*
name|proofs
index|[
