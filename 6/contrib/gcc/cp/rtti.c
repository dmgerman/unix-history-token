...
begin_comment
comment|/* A varray of all tinfo decls that haven't yet been emitted.  */
end_comment
...
begin_comment
comment|/* Return a pseudo type info type node used to describe TYPE.  TYPE    must be a complete type (or cv void), except at the end of the    translation unit.  */
end_comment
...
begin_comment
comment|/* Return true, iff T is a type_info variable which has not had a    definition emitted for it.  */
end_comment
...
operator|==
name|VAR_DECL
comment|/* which has a name */
operator|&&
name|DECL_NAME
argument_list|(
name|t
argument_list|)
comment|/* whose name points back to itself */
operator|&&
name|IDENTIFIER_GLOBAL_VALUE
argument_list|(
name|DECL_NAME
