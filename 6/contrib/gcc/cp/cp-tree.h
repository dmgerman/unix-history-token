...
begin_comment
comment|/* For a VAR_DECL, indicates that the variable has been processed.    This flag is set and unset throughout the code; it is always    used for a temporary purpose.  */
end_comment
