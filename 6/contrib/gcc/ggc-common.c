...
begin_comment
comment|/* Default version of HOST_HOOKS_GT_PCH_GET_ADDRESS when mmap is present.    We temporarily allocate SIZE bytes, and let the kernel place the data    whereever it will.  If it worked, that's our spot, if not we're likely    to be in trouble.  */
end_comment
