...
begin_comment
comment|/* Use an unpriv port for query? */
end_comment
...
name|stderr
argument_list|,
literal|"%s: Unusable NTP packet rejected on socket %d (f=%d, status %d, version %d, stratum %d)\n"
argument_list|,
name|argv0
argument_list|,
name|which
...
operator|!=
literal|0
comment|/*&& data->stratum != NTP_STRATUM_MAX */
operator|&&
name|data
operator|->
name|reference
...
name|stderr
argument_list|,
literal|"%s: unsynch NTP response on socket %d\n"
argument_list|,
name|argv0
argument_list|,
name|which
...
literal|0
argument_list|,
literal|"sntp requires>= 32-bit ints"
argument_list|,
name|NULL
argument_list|)
expr_stmt|;
...
literal|0
argument_list|,
literal|"sntp requires doubles with eps<= 1.0e-13"
argument_list|,
name|NULL
argument_list|)
expr_stmt|;
...
name|stderr
argument_list|,
literal|"%s options: a=%d v=%d e=%.3f E=%.3f P=%.3f\n"
argument_list|,
name|argv0
argument_list|,
name|action
