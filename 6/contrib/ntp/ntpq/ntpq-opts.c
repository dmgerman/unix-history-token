...
index|[]
init|=
literal|"ntpq copyright (c) 1970-2008 David L. Mills and/or others, all rights reserved"
decl_stmt|;
name|tSCC
...
index|[]
init|=
literal|"ntpq - standard NTP query program - Ver. 4.2.4p5\n\ USAGE:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"
decl_stmt|;
name|tSCC
name|zRcName
index|[]
