...
index|[]
init|=
literal|"ntpd copyright (c) 1970-2008 David L. Mills and/or others, all rights reserved"
decl_stmt|;
name|tSCC
...
index|[]
init|=
literal|"ntpd - NTP daemon program - Ver. 4.2.4p5\n\ USAGE:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"
decl_stmt|;
define|#
directive|define
name|zRcName
