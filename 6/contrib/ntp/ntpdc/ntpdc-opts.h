...
begin_comment
comment|/*    *  EDIT THIS FILE WITH CAUTION  (ntpdc-opts.h)  *    *  It has been AutoGen-ed  Sunday August 17, 2008 at 05:26:25 AM EDT  *  From the definitions    ntpdc-opts.def  *  and the template file   options  *  * Generated from AutoOpts 29:0:4 templates.  */
end_comment
...
value|"ntpdc - vendor-specific NTP query program - Ver. 4.2.4p5"
end_define
