...
name|SM_TIME_DEFAULT
argument_list|,
literal|"%s: %s: line %u: line too long (%ld bytes max)\n"
argument_list|,
name|progname
argument_list|,
name|mapname
...
name|SM_TIME_DEFAULT
argument_list|,
literal|"%s: %s: line %u: syntax error (leading space)\n"
argument_list|,
name|progname
argument_list|,
name|mapname
...
name|SM_TIME_DEFAULT
argument_list|,
literal|"%s: %s: line %u: no RHS for LHS %s\n"
argument_list|,
name|progname
argument_list|,
name|mapname
...
name|SM_TIME_DEFAULT
argument_list|,
literal|"%s: %s: line %u: key %s: put error: %s\n"
argument_list|,
name|progname
argument_list|,
name|mapname
...
name|SM_TIME_DEFAULT
argument_list|,
literal|"%s: %s: line %u: key %s: duplicate key\n"
argument_list|,
name|progname
argument_list|,
name|mapname
