...
begin_comment
comment|// Hashtables handle allocators a bit differently than other
end_comment

begin_comment
comment|// containers do.  If we're using standard-conforming allocators, then
end_comment

begin_comment
comment|// a hashtable unconditionally has a member variable to hold its
end_comment

begin_comment
comment|// allocator, even if it so happens that all instances of the
end_comment

begin_comment
comment|// allocator type are identical.  This is because, for hashtables,
end_comment

begin_comment
comment|// this extra storage is negligible.  Additionally, a base class
end_comment

begin_comment
comment|// wouldn't serve any other purposes; it wouldn't, for example,
end_comment

begin_comment
comment|// simplify the exception-handling code.
end_comment
...
index|]
decl_stmt|;
comment|// Check same length of lists
for|for
control|(
init|;
name|__cur1
...
name|false
return|;
comment|// Now check one's elements are in the other
for|for
control|(
name|__cur1
operator|=
