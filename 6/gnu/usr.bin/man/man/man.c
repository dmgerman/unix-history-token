...
index|[]
init|=
literal|"  o : use original, non-localized manpages\n"
decl_stmt|;
endif|#
directive|endif
ifdef|#
...
directive|ifdef
name|__FreeBSD__
comment|/* "" intentionally used to catch error */
if|if
condition|(
operator|(
name|locale
...
literal|'/'
expr_stmt|;
comment|/* Skip architecture part (if present). */
if|if
condition|(
name|t2
operator|!=
...
condition|)
block|{
comment|/* check for the compressed version too */
name|strlcat
argument_list|(
name|ult
argument_list|,
...
name|ult
return|;
comment|/* we munged it, but it doesn't exist anyway */
block|}
else|#
directive|else
if|if
...
name|findall
condition|)
comment|/* only do this architecture... */
return|return
name|found
return|;
block|}
