...
begin_comment
comment|/******************************************************************************  *  * Module Name: exresolv - AML Interpreter object resolution  *              $Revision: 125 $  *  *****************************************************************************/
end_comment
...
argument_list|(
operator|(
literal|"During resolve, Unknown TargetType %X in Index/Reference obj %p\n"
operator|,
name|StackDesc
operator|->
name|Reference
...
argument_list|(
operator|(
literal|"During resolve, Unknown Reference opcode %X (%s) in %p\n"
operator|,
name|Opcode
operator|,
...
argument_list|(
operator|(
literal|"AcpiExResolveMultiple: Unknown Reference subtype %X\n"
operator|,
name|ObjDesc
operator|->
name|Reference
