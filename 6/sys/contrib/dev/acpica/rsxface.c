...
begin_comment
comment|/*******************************************************************************  *  * Module Name: rsxface - Public interfaces to the resource manager  *              $Revision: 31 $  *  ******************************************************************************/
end_comment
...
case|:
comment|/* Exit now, with OK stats */
name|Status
operator|=
name|AE_OK
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|/* Check for end-of-buffer */
if|if
condition|(
name|Resource
operator|>=
