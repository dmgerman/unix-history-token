...
begin_comment
comment|/******************************************************************************  *  * Name: actbl1.h - ACPI 1.0 tables  *       $Revision: 28 $  *  *****************************************************************************/
end_comment
...
begin_comment
comment|/*  * ACPI 1.0 Root System Description Table (RSDT)  */
end_comment
...
begin_comment
comment|/*  * ACPI 1.0 Firmware ACPI Control Structure (FACS)  */
end_comment
...
begin_comment
comment|/*  * ACPI 1.0 Fixed ACPI Description Table (FADT)  */
end_comment
...
literal|1
decl_stmt|;
comment|/* The tmr_val width is 32 bits (0 = 24 bits) */
name|UINT32_BIT
name|Reserved5
range|:
literal|23
