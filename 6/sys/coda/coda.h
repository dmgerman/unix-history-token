...
begin_comment
comment|/* structure used by CODA_STATFS for getting cache information from venus */
end_comment
...
begin_comment
comment|/* 128-bit fids for realms */
end_comment
...
begin_comment
comment|/* coda_open_by_fd: */
end_comment

begin_struct
struct|struct
name|coda_open_by_fd_in
block|{
name|struct
name|coda_in_hdr
name|ih
...
name|fidp
parameter_list|)
value|((fidp)->Volume == -1&&\ 				 (fidp)->Vnode == -1&&\ 				 (fidp)->Unique == -1)
end_define
...
begin_comment
comment|/* Data passed to mount */
end_comment

begin_define
define|#
directive|define
name|CODA_MOUNT_VERSION
value|1
end_define

begin_struct
struct|struct
name|coda_mount_data
block|{
name|int
name|version
decl_stmt|;
