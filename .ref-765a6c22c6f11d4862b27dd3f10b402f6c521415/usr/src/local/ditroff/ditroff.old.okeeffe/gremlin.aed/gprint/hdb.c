...
begin_comment
comment|/*	hdb.c	1.1	(Berkeley) 83/07/09  *  * Copyright -C- 1982 Barry S. Roitblat  *  *      This file contains database routines for the hard copy programs of the  * gremlin picture editor.  */
end_comment
...
name|pos
decl_stmt|;
comment|/*  *      This routine reads the specified file into a database and   * returns a pointer to that database.  Orient and pos are also set  * from the file.  */
block|{
specifier|register
name|int
name|i
