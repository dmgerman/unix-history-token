...
directive|define
name|unix_lang_name
value|"VAX/UNIX Assembler V4/17/82 4.10"
end_define
...
begin_comment
comment|/*  *	The inter pass temporary file is opened and closed by stdio, but  *	is written to using direct read/write, as the temporary file  *	is composed of buffers exactly BUFSIZ long.  */
end_comment
