...
index|[]
init|=
literal|"@(#)sysline.c	1.7	(Berkeley) 2/8/83"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* turn this on if you are on running 4.1a or greater (i.e. a system    with the gethostname() function #define HOSTNAME	Now done in the makefile... */
end_comment
