...
begin_comment
comment|/* **  NORML.C -- functions for normalizing tree ** **	Defines **		norml -- main routine **		norm **		travers **		nnorm **		notpush **		adjust **		treedup **		mvands ** **	Trace Flags: **		NORMAL.C ~~ 56, 57 */
end_comment
...
begin_comment
comment|/* **  NORML -- normalizing routine ** **	this routine passes the qualification clause portion of the query **	tree to the routines for depressing nots and for conjunctive  **	normalization.  It also calls a routine to place an and with one **	null branch at the rightmost end of the tree. ** **	Parameters: **		ptr -- tree to normalize ** **	Returns: **		nothing ** **	Trace Flags: **		norml ~~ 56.0 */
end_comment
...
begin_comment
comment|/* ** NORM **	this routine takes a tree which has nots only at the lower ends, and **	places it into conjunctive normal form by repeatedly applying the **	replacement rule: A or (B and C) ==> (A or B) and (A or C) ** **	Trace Flags: **		norm ~~ 56.4 */
end_comment
...
begin_comment
comment|/* ** NNORM **	this routine depresses nots in the query tree to the lowest possible **	nodes.  It may also affect arithmetic operators in this procedure ** **	Trace Flags: **		nnorm ~~ 56.12 */
end_comment
...
begin_comment
comment|/* ** NOTPUSH **	this routine decides what to do once a not has been found in the **	query tree ** **	Trace Flags: **		notpush ~~ 57.0 */
end_comment
...
begin_comment
comment|/* ** ADJUST **	terminate qual with an AND and a QLEND at the rightmost branch ** **	Trace Flags: **		adjust ~~ 57.4 */
end_comment
...
begin_comment
comment|/* **  TREEDUP --  ** **	Trace Flags: **		norm ~~ 57.8 */
end_comment
...
begin_comment
comment|/* **	MVANDS -- pushes all AND's in Qual into linear list ** **	Trace Flags: **		mvands ~~ 57.12 */
end_comment
