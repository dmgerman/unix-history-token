...
name|sccsid
init|=
literal|"@(#)expreserve.c	7.6	3/31/82"
decl_stmt|;
end_decl_stmt
...
name|mf
argument_list|,
literal|"A copy of an editor buffer of yours was saved when %s.\n"
argument_list|,
name|flag
condition|?
...
name|mf
argument_list|,
literal|"No name was associated with this buffer so it has been named \"LOST\".\n"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|fname
argument_list|,
comment|/* 		 * "the editor was killed" is perhaps still not an ideal 		 * error message.  Usually, either it was forcably terminated 		 * or the phone was hung up, but we don't know which. 		 */
name|flag
condition|?
literal|"the system went down"
else|:
...
name|mf
argument_list|,
literal|"An easy way to do this is to give the command \"ex -r %s\".\n"
argument_list|,
name|fname
argument_list|)
expr_stmt|;
...
name|mf
argument_list|,
literal|"This works for \"edit\" and \"vi\" also.\n"
argument_list|)
expr_stmt|;
name|pclose
argument_list|(
