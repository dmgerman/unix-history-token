...
name|rcsid
init|=
literal|"$Header: /na/franz/franz/RCS/io.c,v 1.2 83/02/14 20:30:13 jkf Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*					-[Mon Feb 14 20:17:35 1983 by jkf]-  * 	io.c				$Locker:  $  * input output functions  *  * (c) copyright 1982, Regents of the University of California  */
end_comment
...
index|[]
init|=
literal|"Number exceeds parse buffer"
decl_stmt|;
end_decl_stmt
...
name|push
parameter_list|()
value|;	if(name==endstrb) error(toobig,FALSE); else *name++=c;
end_define
...
begin_block
block|{
comment|/*      * the string buffer contains an string which is too long       * we print an error message and include part of the atom      */
name|strbuf
index|[
literal|50
index|]
...
literal|'\0'
expr_stmt|;
comment|/* truncate string */
name|errorh1
argument_list|(
name|Vermisc
argument_list|,
literal|"String or symbol print name too long, it begins with "
argument_list|,
name|nil
argument_list|,
literal|0
