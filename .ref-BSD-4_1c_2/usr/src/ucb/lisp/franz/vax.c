...
name|rcsid
init|=
literal|"$Header: /na/franz/franz/RCS/vax.c,v 1.1 83/01/29 13:38:56 jkf Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*					-[Sat Jan 29 13:37:46 1983 by jkf]-  * 	vax.c				$Locker:  $  * vax specific functions  *  * (c) copyright 1982, Regents of the University of California  */
end_comment
