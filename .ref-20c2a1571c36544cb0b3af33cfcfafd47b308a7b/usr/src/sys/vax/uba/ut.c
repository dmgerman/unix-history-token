...
name|uter
expr_stmt|;
comment|/* watch this, sports fans */
name|sc
operator|->
name|sc_resid
operator|=
...
name|harderror
label|:
comment|/* 			 * Hard or non-I/O errors on non-raw tape 			 * cause it to close; also, reading off the 			 * end of the tape. 			 */
if|if
condition|(
name|sc
operator|->
...
name|SCOM
case|:
comment|/* forw/rev space updates current position */
if|if
condition|(
name|bp
operator|==
