...
begin_comment
comment|/* conf.h.  Generated automatically by configure.  */
end_comment
...
begin_comment
comment|/* Set MAIL_PROGRAM to a program which takes a mail address as an    argument and accepts a mail message to send to that address on    stdin (e.g. "/bin/mail").  */
end_comment
