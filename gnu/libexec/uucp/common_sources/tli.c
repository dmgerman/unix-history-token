...
index|[]
init|=
literal|"$Id: tli.c,v 1.1 1993/08/04 19:31:09 jtc Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* Initialize a TLI connection.  */
end_comment
...
name|FALSE
return|;
comment|/* Handle the rest of the dialer sequence.  This is similar to      fmodem_dial, and they should, perhaps, be combined somehow.  */
if|if
condition|(
name|pzdialer
operator|!=
