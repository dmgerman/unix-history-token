...
index|[]
init|=
literal|"$Id: uucp.c,v 1.1 1993/08/04 19:36:44 jtc Exp $"
decl_stmt|;
end_decl_stmt
...
name|argv
argument_list|,
literal|"cCdfg:I:jmn:prRs:tu:Wx:"
argument_list|,
name|asClongopts
argument_list|,
operator|(
...
name|stderr
argument_list|,
literal|" -C, -p: Copy local files to spool directory (default)\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
...
name|stderr
argument_list|,
literal|" -R: Copy directories recursively\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
...
name|stderr
argument_list|,
literal|" -W: Do not add current directory to remote filenames\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
