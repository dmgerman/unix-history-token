...
index|[]
init|=
literal|"$Id: uuconv.c,v 1.1 1993/08/04 19:36:39 jtc Exp $"
decl_stmt|;
end_decl_stmt
...
name|stderr
argument_list|,
literal|"Usage: uuconv -i input -o output [-p program] [-I file]\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
name|stderr
argument_list|,
literal|" -i input: Set input type (one of taylor, v2, hdb)\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
name|stderr
argument_list|,
literal|" -o output: Set output type (one of taylor, v2, hdb)\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
name|stderr
argument_list|,
literal|" -p program: Program to convert (e.g., uucp or cu)\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
name|stderr
argument_list|,
literal|" -I file: Set Taylor UUCP configuration file to use\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
