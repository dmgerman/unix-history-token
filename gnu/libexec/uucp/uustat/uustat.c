...
index|[]
init|=
literal|"$Id: uustat.c,v 1.1 1993/08/04 19:37:05 jtc Exp $"
decl_stmt|;
end_decl_stmt
...
name|argv
argument_list|,
literal|"aB:c:C:eiI:k:KmMNo:pqQr:s:S:u:U:W:x:y:"
argument_list|,
name|asSlongopts
argument_list|,
operator|(
...
name|LOG_ERROR
argument_list|,
literal|"-i, -K, -M, -N, -Q not supported with -k, -m, -p, -q, -r"
argument_list|)
expr_stmt|;
name|ususage
argument_list|()
...
name|stderr
argument_list|,
literal|" -B num: number of lines to return in -M or -N mail message\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
name|stderr
argument_list|,
literal|" -c command: list requests for named command\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
name|stderr
argument_list|,
literal|" -C command: list requests for other than named command\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
name|stderr
argument_list|,
literal|" -e: list queued executions rather than job requests\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
name|stderr
argument_list|,
literal|" -i: prompt for whether to kill each listed job\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
...
name|stderr
argument_list|,
literal|" -K: kill each listed job\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
...
name|stderr
argument_list|,
literal|" -M: mail report on each listed job to UUCP administrator\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
name|stderr
argument_list|,
literal|" -N: mail report on each listed job to requestor\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
...
name|stderr
argument_list|,
literal|" -Q: don't list jobs, just take actions (-i, -K, -M, -N)\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
...
name|stderr
argument_list|,
literal|" -S system: list all jobs for other than specified system\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
...
name|stderr
argument_list|,
literal|" -U user: list all jobs for other than specified user\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
name|stderr
argument_list|,
literal|" -W comment: comment to include in mail messages\n"
argument_list|)
expr_stmt|;
name|fprintf
argument_list|(
