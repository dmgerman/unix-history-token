...
index|[]
init|=
literal|"$Id: send.c,v 1.1 1993/08/04 19:36:29 jtc Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* Cancel a file send by sending an empty buffer.  This is only called    for a protocol which supports multiple channels.  It is needed    so that both systems agree as to when a channel is no longer    needed.  */
end_comment
