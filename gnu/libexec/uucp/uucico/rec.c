...
index|[]
init|=
literal|"$Id: rec.c,v 1.3 1994/11/06 10:17:11 davidg Exp $"
decl_stmt|;
end_decl_stmt
...
expr_stmt|;
block|}
comment|/* Now, if that was a remote command, then when the confirmation      message is acked we no longer have to remember that we received      that file.  */
if|if
condition|(
operator|!
name|qinfo
