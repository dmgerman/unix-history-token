...
index|[]
init|=
literal|"$Id: xqtfil.c,v 1.1 1993/08/04 19:33:21 jtc Exp $"
decl_stmt|;
end_decl_stmt
...
return|;
block|}
comment|/* No system name may start with a dot (this is enforced by 	     tisystem in sysinf.c).  This allows us to quickly skip 	     impossible directories.  */
if|if
condition|(
name|qtop
operator|->
