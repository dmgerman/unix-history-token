...
directive|define
name|ICLEAR_IFLAG
value|(IGNBRK | BRKINT | IGNPAR | PARMRK | INPCK \ 		      | ISTRIP | INLCR | IGNCR | ICRNL | IUCLC \ 		      | IXON | IXANY | IXOFF)
end_define
...
directive|define
name|ICLEAR_CFLAG
value|(CBAUD | CLOCAL | CSIZE | PARENB | PARODD)
end_define
...
directive|define
name|ICLEAR_LFLAG
value|(ISIG | ICANON | XCASE | ECHO | ECHOE | ECHOK \ 		      | ECHONL | NOFLSH)
end_define
...
directive|define
name|ICLEAR_CFLAG
value|(CLOCAL | CSIZE | PARENB | PARODD)
end_define
...
begin_comment
comment|/* Open a serial line.  This sets the terminal settings.  We begin in    seven bit mode and let the protocol change if necessary.  */
end_comment
...
begin_comment
comment|/* Open a standard input port.  The code alternates q->o between 0 and    1 as appropriate.  It is always 0 before any call to fsblock.  */
end_comment
...
begin_comment
comment|/* Reset a serial port by hanging up.  */
end_comment
...
name|LOG_ERROR
argument_list|,
literal|"Can't hangup terminal: %s"
argument_list|,
name|strerror
argument_list|(
name|errno
...
return|;
block|}
comment|/* Give the terminal a chance to settle.  */
name|sleep
argument_list|(
literal|2
argument_list|)
...
name|LOG_ERROR
argument_list|,
literal|"Can't reopen terminal: %s"
argument_list|,
name|strerror
argument_list|(
name|errno
...
begin_comment
comment|/* Reset a standard input port.  */
end_comment
...
begin_comment
comment|/* Read from a stdin port.  */
end_comment
...
name|DEBUG_PORT
argument_list|,
literal|"fsysdep_conn_io: Blocking write of %lud"
argument_list|,
operator|(
name|unsigned
name|long
...
begin_comment
comment|/* Run a chat program on a stdin port.  */
end_comment
