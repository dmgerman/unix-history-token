...
index|[]
init|=
literal|"$Id: cusub.c,v 1.1 1993/08/04 19:32:09 jtc Exp $"
decl_stmt|;
end_decl_stmt
...
index|]
decl_stmt|;
comment|/* It would be nice if we could just use fsserial_read, but that      will log signals that we don't want logged.  There should be a      generic way to extract the file descriptor from the port.  */
if|if
condition|(
name|qconn
operator|->
