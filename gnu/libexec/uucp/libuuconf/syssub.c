...
index|[]
init|=
literal|"$Id: syssub.c,v 1.1 1993/08/04 19:35:06 jtc Exp $"
decl_stmt|;
end_decl_stmt
...
parameter_list|)
define|\
value|do \     { \       OP (uuconf_qtimegrade); \       OP (uuconf_qcalltimegrade); \       OP (uuconf_qcall_local_size); \       OP (uuconf_qcall_remote_size); \       OP (uuconf_qcalled_local_size); \       OP (uuconf_qcalled_remote_size); \     } \   while (0)
end_define
