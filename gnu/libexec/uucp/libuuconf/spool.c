...
specifier|const
name|char
name|_uuconf_spool_rcsid
index|[]
init|=
literal|"$Id: spool.c,v 1.3 1995/08/19 21:28:05 ache Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* Get the name of the UUCP spool directory.  */
end_comment
