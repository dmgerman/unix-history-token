...
index|[]
init|=
literal|"$Id: pubdir.c,v 1.3 1995/08/19 21:27:50 ache Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* Get the name of the UUCP public directory.  */
end_comment
