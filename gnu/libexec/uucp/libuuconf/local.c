...
specifier|const
name|char
name|_uuconf_local_rcsid
index|[]
init|=
literal|"$Id: local.c,v 1.3 1995/08/19 21:27:37 ache Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* Get default information about the local system.  */
end_comment
...
name|zlocalname
expr_stmt|;
comment|/* By default, we permit the local system to forward to and from any      system.  */
name|iret
operator|=
