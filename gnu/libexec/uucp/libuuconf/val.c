...
specifier|const
name|char
name|_uuconf_val_rcsid
index|[]
init|=
literal|"$Id: val.c,v 1.3 1995/08/19 21:28:38 ache Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* Validate a login name for a system.  */
end_comment
