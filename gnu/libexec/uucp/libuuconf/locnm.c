...
specifier|const
name|char
name|_uuconf_locnm_rcsid
index|[]
init|=
literal|"$Id: locnm.c,v 1.3 1995/08/19 21:27:39 ache Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* Get the local node name.  */
end_comment
