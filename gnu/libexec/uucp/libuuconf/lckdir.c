...
specifier|const
name|char
name|_uuconf_lckdir_rcsid
index|[]
init|=
literal|"$Id: lckdir.c,v 1.3 1995/08/19 21:27:34 ache Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* Get the name of the UUCP lock directory.  */
end_comment
