...
specifier|const
name|char
name|_uuconf_vsys_rcsid
index|[]
init|=
literal|"$Id: vsys.c,v 1.3 1995/08/19 21:28:49 ache Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* Get system information from the V2 configuration files.  This is a    wrapper for the internal function which makes sure that every field    gets a default value.  */
end_comment
