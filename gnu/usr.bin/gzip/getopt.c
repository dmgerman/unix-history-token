...
name|last
decl_stmt|;
comment|/* Reverse all the elements [first_nonopt, optind) */
name|first
operator|=
operator|&
name|argv
...
expr_stmt|;
block|}
comment|/* Put back the options in order */
name|first
operator|=
operator|&
name|argv
...
expr_stmt|;
block|}
comment|/* Put back the non options in order */
name|first
operator|=
operator|&
name|argv
