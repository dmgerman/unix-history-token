...
begin_comment
comment|/* infohelp.c -- Functions which build documentation nodes. */
end_comment
...
block|{
comment|/* Make a new node containing the help text.  Split the largest 	     window into 2 windows, and show the help text in that window. */
if|if
condition|(
operator|!
name|internal_info_help_node
