...
comment|/* would be superceded by a higher level one */
if|if
condition|(
name|top_level_ixpansion_p
argument_list|()
...
begin_comment
comment|/* Record an iterator expansion ("ixpansion") for IDECL.    The remaining paramters are the notes in the loop entry    and exit rtl.  */
end_comment
