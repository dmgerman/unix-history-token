...
begin_comment
comment|/* Build expressions with type checking for C compiler.    Copyright (C) 1987, 88, 91, 92, 93, 1994 Free Software Foundation, Inc.  This file is part of GNU CC.  GNU CC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GNU CC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU CC; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
begin_comment
comment|/* For an ARRAY_TYPE, this is the end index of the range    to intitialize with the next element, or NULL in the ordinary case    where the element is used just once.  */
end_comment
...
begin_comment
comment|/* List of pending elements at this constructor level.    These are elements encountered out of order    which belong at places we haven't reached yet in actually    writing the output.  */
end_comment
...
begin_comment
comment|/* 1 if this constructor level was entered implicitly.  */
end_comment

begin_decl_stmt
specifier|static
name|int
name|constructor_implicit
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* When we finish reading a constructor expression    (constructor_decl is 0), the CONSTRUCTOR goes here.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* Skip any nameless bit fields atthe beginning.  */
while|while
condition|(
name|constructor_fields
operator|!=
...
break|break;
block|}
comment|/* Structure elements may require alignment.  Do this now      if necessary for the subaggregate.  */
if|if
condition|(
name|constructor_incremental
operator|&&
...
name|retry
label|:
comment|/* Look thru the whole pending list.      If we find an element that should be output now,      output it.  Otherwise, set NEXT to the element      that comes first among those still pending.  */
name|next
operator|=
literal|0
expr_stmt|;
