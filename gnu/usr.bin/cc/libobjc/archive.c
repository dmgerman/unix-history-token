...
begin_comment
comment|/* GNU Objective C Runtime archiving    Copyright (C) 1993 Free Software Foundation, Inc.  Author: Kresten Krab Thorup  This file is part of GNU CC.  GNU CC is free software; you can redistribute it and/or modify it under the    terms of the GNU General Public License as published by the Free Software    Foundation; either version 2, or (at your option) any later version.  GNU CC is distributed in the hope that it will be useful, but WITHOUT ANY    WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS    FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more    details.  You should have received a copy of the GNU General Public License along with    GNU CC; see the file COPYING.  If not, write to the Free Software    Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
begin_comment
comment|/* ** Note: This version assumes that int and longs are both 32bit. */
end_comment
...
parameter_list|)
define|\
value|{ fprintf(stderr, "archining: "); \    fprintf(stderr, format, ## args); \    fprintf(stderr, "\n"); abort(); }
end_define
...
name|__objc_fatal
argument_list|(
literal|"cannot find class for key %x"
argument_list|,
name|key
argument_list|)
expr_stmt|;
...
name|__objc_fatal
argument_list|(
literal|"cannot parse typespec: %s"
argument_list|,
name|type
argument_list|)
expr_stmt|;
