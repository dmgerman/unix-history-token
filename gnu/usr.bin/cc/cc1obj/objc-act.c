...
literal|1
return|;
comment|/* one of the types is a protocol */
block|}
else|else
return|return
operator|-
...
return|;
comment|/* defer to comptypes */
comment|/* End of new protocol support.  */
...
argument_list|()
expr_stmt|;
comment|/* start_decl trying to be smart about inits */
name|TREE_USED
argument_list|(
name|UOBJC_SYMBOLS_decl
argument_list|)
...
ifdef|#
directive|ifdef
name|OBJC_FORWARDING_REG_OFFSET
elseif|else
if|if
condition|(
name|GET_CODE
...
name|regno
operator|-
name|OBJC_FORWARDING_FIRST_REG
operator|)
operator|+
name|OBJC_FORWARDING_REG_OFFSET
expr_stmt|;
...
directive|endif
comment|/* OBJC_FORWARDING_REG_OFFSET */
else|else
return|return
literal|0
return|;
...
argument_list|()
expr_stmt|;
comment|/* needed to make assign_parms work (with -O).  */
name|DECL_ARGUMENTS
argument_list|(
name|tmp_decl
argument_list|)
...
begin_comment
comment|/* end code generation for protocols... */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* try and find the method signiture in the global pools! */
if|if
condition|(
operator|!
operator|(
...
name|context
decl_stmt|;
comment|/* implementation_context */
name|int
name|mtype
decl_stmt|;
block|{
