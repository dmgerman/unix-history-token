...
parameter_list|)
define|\
value|{ int opcode;							\   opcode = TREE_INT_CST_HIGH (CST); 				\   bc_emit_bytecode_const ((char *)&opcode, sizeof opcode); 	\   opcode = TREE_INT_CST_LOW (CST); 				\   bc_emit_bytecode_const ((char *)&opcode, sizeof opcode);	\ }
end_define
...
parameter_list|)
define|\
value|{ int opcode;							\   opcode = TREE_INT_CST_LOW (CST); 				\   bc_emit_bytecode_const ((char *)&opcode, sizeof opcode); 	\   opcode = TREE_INT_CST_HIGH (CST); 				\   bc_emit_bytecode_const ((char *)&opcode, sizeof opcode);	\ }
end_define
