...
parameter_list|)
define|\
value|({union {								\ 	UDItype __ll;							\ 	struct {USItype __h, __l;} __i;					\      } __xx;								\   __xx.__i.__l = u;							\   __asm__ ("uemul %3,%0"						\ 	   : "=r" (__xx.__i.__h),					\ 	     "=r" (__xx.__i.__l)					\ 	   : "1" (__xx.__i.__l),					\ 	     "g" ((USItype)(v)));					\   (w1) = __xx.__i.__h;							\   (w0) = __xx.__i.__l;})
end_define
