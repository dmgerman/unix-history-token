...
define|#
directive|define
name|HAVE_movsf_normal
value|((!TARGET_MOVE || GET_CODE (operands[0]) != MEM) || (GET_CODE (operands[1]) != MEM))
end_define
