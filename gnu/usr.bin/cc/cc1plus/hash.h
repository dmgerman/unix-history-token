...
begin_comment
comment|/* Command-line: gperf -p -j1 -g -o -t -N is_reserved_word -k1,4,7,$ /deneb/blob/jason/g++/small/devo/gcc/cp/gxx.gperf  */
end_comment
...
begin_comment
comment|/* maximum key range = 168, duplicates = 0 */
end_comment
