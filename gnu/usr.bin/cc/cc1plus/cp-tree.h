...
begin_comment
comment|/* Nonzero means handle things in ANSI, instead of GNU fashion.  */
end_comment
...
begin_comment
comment|/* Nonzero for VAR_DECL and FUNCTION_DECL node means that `external' was    specified in its declaration.  */
end_comment
...
begin_comment
comment|/* Node for "pointer to (virtual) function".    This may be distinct from ptr_type_node so gdb can distinuish them. */
end_comment
...
begin_comment
comment|/* Nonzero means implicit template instantatiations are emitted.  */
end_comment
...
begin_comment
comment|/* These flags are used by the conversion code.    CONV_IMPLICIT   :  Perform implicit conversions (standard and user-defined).    CONV_STATIC     :  Perform the explicit conversions for static_cast.    CONV_CONST      :  Perform the explicit conversions for const_cast.    CONV_REINTERPRET:  Perform the explicit conversions for reinterpret_cast.    CONV_PRIVATE    :  Perform upcasts to private bases.  */
end_comment
...
value|(CONV_IMPLICIT | CONV_STATIC)
end_define
...
directive|define
name|CONV_C_CAST
value|(CONV_IMPLICIT | CONV_STATIC | CONV_CONST \ 			  | CONV_REINTERPRET | CONV_PRIVATE)
end_define
