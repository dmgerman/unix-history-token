...
literal|4
case|:
comment|/* According to ARM $12.8, the default copy ctor will be declared, but 	 not defined, unless it's needed.  So we mark this as `inline'; that 	 way, if it's never used it won't be emitted.  */
name|declspecs
operator|=
name|build_decl_list
argument_list|(
...
directive|else
comment|/* This breaks; why? */
define|#
directive|define
name|MGMSG
value|"(synthetic code at) "
name|t
operator|->
name|filename
operator|=
...
name|tbuf
operator|=
literal|"{__builtin_memcpy(this,&_ctor_arg,sizeof(_ctor_arg));return *this;}"
expr_stmt|;
operator|*
name|lenp
operator|=
...
name|tbuf
argument_list|,
literal|"{%s=_ctor_arg.%s;return *this;}"
argument_list|,
name|s
argument_list|,
name|s
...
name|tbuf
argument_list|,
literal|"%s::operator=((%s%s ::%s&)_ctor_arg);"
argument_list|,
name|s
argument_list|,
name|TYPE_READONLY
...
name|tbuf
operator|=
literal|"{__builtin_memcpy(this,&_ctor_arg,sizeof(_ctor_arg));}"
expr_stmt|;
operator|*
name|lenp
operator|=
