...
begin_comment
comment|/* Separate lexical analyzer for GNU C++.    Copyright (C) 1987, 1989, 1992, 1993 Free Software Foundation, Inc.    Hacked by Michael Tiemann (tiemann@cygnus.com)  This file is part of GNU CC.  GNU CC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GNU CC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU CC; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
name|error
argument_list|(
literal|"`%s' was not declared in this scope"
argument_list|,
name|IDENTIFIER_POINTER
argument_list|(
name|token
...
directive|if
literal|0
comment|/* This can not be done this way in C++ because 	       lookup_name can find ambiguous names, and yield an 	       error.  Because this routine can be called at token 	       scan time, this is unacceptable.  (mrs) */
...
block|tmp = lookup_name (yylval.ttype, 0); 	    if (tmp != NULL_TREE&& TREE_CODE (tmp) == VAR_DECL&& DECL_IGNORED_P (tmp)&& TREE_READONLY (tmp)&& DECL_INITIAL (tmp) != NULL_TREE&& TREE_CODE (DECL_INITIAL (tmp)) == STRING_CST) 	      { 		yylval.ttype = DECL_INITIAL (tmp); 		value = STRING; 	      }
endif|#
directive|endif
block|}
if|if
