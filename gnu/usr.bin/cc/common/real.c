...
condition|)
block|{
comment|/* 	 ; shift more than 16 bits: shift up k-16, output the integer, 	 ; then complete the shift to get the fraction. 	 */
name|k
operator|-=
literal|16
expr_stmt|;
...
begin_comment
comment|/* ;	Find unsigned long integer and fractional parts  ;	unsigned long i; ;	unsigned EMUSHORT x[NE], frac[NE]; ;	xifrac (x,&i, frac);    A negative e type input yields integer output = 0   but correct fraction. */
end_comment
