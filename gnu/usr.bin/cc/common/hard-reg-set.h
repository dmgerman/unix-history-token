...
begin_comment
comment|/* Sets (bit vectors) of hard registers, and operations on them.    Copyright (C) 1987, 1992 Free Software Foundation, Inc.  This file is part of GNU CC  GNU CC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GNU CC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU CC; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
begin_comment
comment|/* HARD_CONST is used to cast a constant to a HARD_REG_SET    if that is a scalar wider than an integer.  */
end_comment
...
parameter_list|)
define|\
value|((SET)[(BIT) / UHOST_BITS_PER_WIDE_INT]	\    |= (HOST_WIDE_INT) 1<< ((BIT) % UHOST_BITS_PER_WIDE_INT))
end_define
...
parameter_list|)
define|\
value|do { register HOST_WIDE_INT *scan_tp_ = (TO);			\      register int i;						\      for (i = 0; i< HARD_REG_SET_LONGS; i++)			\        *scan_tp_++ = 0; } while (0)
end_define
...
parameter_list|)
define|\
value|do { register HOST_WIDE_INT *scan_tp_ = (TO);			\      register int i;						\      for (i = 0; i< HARD_REG_SET_LONGS; i++)			\        *scan_tp_++ = -1; } while (0)
end_define
...
parameter_list|)
define|\
value|do { register HOST_WIDE_INT *scan_tp_ = (TO), *scan_fp_ = (FROM); \      register int i;						\      for (i = 0; i< HARD_REG_SET_LONGS; i++)			\        *scan_tp_++ = *scan_fp_++; } while (0)
end_define
...
parameter_list|)
define|\
value|do { register HOST_WIDE_INT *scan_xp_ = (X), *scan_yp_ = (Y);	\      register int i;						\      for (i = 0; i< HARD_REG_SET_LONGS; i++)			\        if (0 != (*scan_xp_++& ~*scan_yp_++)) break;		\      if (i == HARD_REG_SET_LONGS) goto TO; } while (0)
end_define
...
parameter_list|)
define|\
value|do { register HOST_WIDE_INT *scan_xp_ = (X), *scan_yp_ = (Y);	\      register int i;						\      for (i = 0; i< HARD_REG_SET_LONGS; i++)			\        if (*scan_xp_++ != ~*scan_yp_++)) break;			\      if (i == HARD_REG_SET_LONGS) goto TO; } while (0)
end_define
