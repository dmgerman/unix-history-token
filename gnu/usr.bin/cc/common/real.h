...
begin_comment
comment|/* If emulation has been enabled by defining REAL_ARITHMETIC or by    setting LONG_DOUBLE_TYPE_SIZE to 96, then define macros so that    they invoke emulator functions. This will succeed only if the machine    files have been updated to use these macros in place of any    references to host machine `double' or `float' types.  */
end_comment
...
begin_comment
comment|/* Declare functions in real.c that are referenced here. */
end_comment
...
begin_comment
comment|/* LONG_DOUBLE_TYPE_SIZE != 96 and REAL_ARITHMETIC not defined */
end_comment
