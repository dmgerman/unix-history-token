...
begin_comment
comment|/* Output dbx-format symbol table information from GNU compiler.    Copyright (C) 1987, 1988, 1992 Free Software Foundation, Inc.  This file is part of GNU CC.  GNU CC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GNU CC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU CC; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
control|)
block|{
comment|/* For nameless subunions and subrecords, treat their fields as ours.  */
if|if
condition|(
name|DECL_NAME
argument_list|(
...
comment|/* This has yet to be implemented.  */
name|abort
argument_list|()
expr_stmt|;
name|CHARS
...
name|warning
argument_list|(
literal|"dbx info for template class methods not yet supported"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
name|REG
condition|)
comment|/*&& rtx_equal_p (XEXP (DECL_RTL (parms), 0), 				 DECL_INCOMING_RTL (parms))) */
block|{
...
name|DBX_REGPARM_STABS_LETTER
expr_stmt|;
comment|/* DECL_RTL looks like (MEM (REG...).  Get the register number.  */
name|current_sym_value
operator|=
name|REGNO
argument_list|(
