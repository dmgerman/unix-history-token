...
begin_comment
comment|/* This is just to get __GNU_LIBRARY__ defined.  */
end_comment
...
parameter_list|)
define|\
value|(((h) -> use_extra_arg) \    ? (*(h)->chunkfun) ((h)->extra_arg, (size)) \    : (*(h)->chunkfun) ((size)))
end_define
...
parameter_list|)
define|\
value|do { \     if ((h) -> use_extra_arg) \       (*(h)->freefun) ((h)->extra_arg, (old_chunk)); \     else \       (*(h)->freefun) ((old_chunk)); \   } while (0)
end_define
