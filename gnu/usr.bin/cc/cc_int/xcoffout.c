...
parameter_list|)
define|\
value|(xcoff_current_include_file ? (LINENO) : (LINENO) - xcoff_begin_function_line)
end_define
...
block|}
block|}
comment|/* Any pending .bi or .ei must occur before the .function psuedo op.      Otherwise debuggers will think that the function is in the previous      file and/or at the wrong line number.  */
name|xcoffout_source_file
argument_list|(
name|file
argument_list|,
