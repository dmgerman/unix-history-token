...
name|PLUS
condition|)
comment|/* We can get a PLUS as an "operand" as a result of 	   register elimination.  See eliminate_regs and gen_input_reload.  */
name|substed_operand
index|[
name|i
index|]
