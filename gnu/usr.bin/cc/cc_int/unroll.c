...
begin_comment
comment|/* Try to unroll loops, and split induction variables.    Copyright (C) 1992, 1993, 1994 Free Software Foundation, Inc.    Contributed by James E. Wilson, Cygnus Support/UC Berkeley.  This file is part of GNU CC.  GNU CC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GNU CC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU CC; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
condition|)
block|{
comment|/* The rs6000 port loads some constants with IOR.  */
name|rtx
name|second_part
init|=
name|XEXP
...
argument_list|)
expr_stmt|;
comment|/* Check for shared address givs, and avoid 			   incrementing the shared psuedo reg more than 			   once.  */
if|if
condition|(
operator|!
operator|(
...
argument_list|()
decl_stmt|;
comment|/* Can't do it by reversing the jump (probably becasue we 		     couln't reverse the conditions), so emit a new 		     jump_insn after COPY, and redirect the jump around 		     that.  */
name|jmp
operator|=
...
comment|/* As a special case, if we have multiple identical address givs 		 within a single instruction, then we do use a single psuedo 		 reg for both.  This is necessary in case one is a match_dup 		 of the other.  */
name|v
operator|->
name|const_adjust
operator|=
...
name|loop_dump_stream
argument_list|,
literal|"Sharing address givs with reg %d\n"
argument_list|,
name|REGNO
argument_list|(
name|v
...
begin_comment
comment|/* Replace uses of split bivs with their split psuedo register.  This is    for original instructions which remain after loop unrolling without    copying.  */
end_comment
