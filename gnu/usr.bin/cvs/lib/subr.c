...
index|[]
init|=
literal|"$CVSid: @(#)subr.c 1.64 94/10/07 $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/*  *  Sanity checks and any required fix-up on message passed to RCS via '-m'.  *  RCS 5.7 requires that a non-total-whitespace, non-null message be provided  *  with '-m'.  */
end_comment
