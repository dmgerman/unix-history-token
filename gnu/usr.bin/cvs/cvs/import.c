...
index|[]
init|=
literal|"@(#)import.c 1.52 92/03/31"
decl_stmt|;
end_decl_stmt
...
init|=
block|{
literal|"Usage: %s %s [-Qq] [-I ign] [-m msg] [-b branch]\n"
block|,
...
name|errno
argument_list|,
literal|"Can't read contents of symlink %s"
argument_list|,
name|dp
operator|->
name|d_name
...
name|errno
argument_list|,
literal|"Can't open SymLinks file %s"
argument_list|,
name|lnrep
argument_list|)
expr_stmt|;
...
literal|0
decl_stmt|;
comment|/* XXX - should be more unique */
operator|(
name|void
operator|)
name|sprintf
