...
name|var
parameter_list|)
value|static const char sizeof##var = sizeof(sizeof##var) + sizeof(var)
end_define
...
name|var
parameter_list|)
value|static const char standalone_semis_illegal_sigh
end_define
...
begin_comment
comment|/* Define to enable alternate death support (which uses the RCS state).  */
end_comment
