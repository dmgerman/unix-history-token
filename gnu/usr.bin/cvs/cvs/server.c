...
name|errno
argument_list|,
literal|"waiting for gunzip process %d"
argument_list|,
name|gzip_pid
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|/* This is ok -- the cvs passwd file might not exist. */
name|fclose
argument_list|(
name|fp
argument_list|)
...
begin_comment
comment|/* Return 1 if password matches, else 0. */
end_comment
...
literal|"error 0 %s: no such user\n"
argument_list|,
name|username
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"error: bad auth protocol start: %s"
argument_list|,
name|tmp
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"error: bad auth protocol end: %s"
argument_list|,
name|tmp
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/* Do everything that kerberos did. */
name|pw
operator|=
name|getpwnam
argument_list|(
