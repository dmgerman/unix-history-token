...
index|[]
init|=
literal|"$CVSid: @(#)history.c 1.33 94/09/21 $"
decl_stmt|;
end_decl_stmt
...
operator|)
condition|)
comment|/* Some directory not there! */
return|return;
name|repos
operator|=
...
literal|0
argument_list|,
literal|"cannot find own username"
argument_list|)
expr_stmt|;
else|else
block|{
comment|/* Assumes neither CurDir nor pw->pw_dir ends in '/' */
name|i
operator|=
name|strlen
argument_list|(
