...
index|[]
init|=
literal|"$CVSid: @(#)login.c 1.1 95/10/01 $"
decl_stmt|;
end_decl_stmt
...
comment|/* todo: does this work under Win-NT and OS/2 ? */
name|homedir
operator|=
name|getenv
argument_list|(
...
expr_stmt|;
block|}
comment|/* Check to make sure it's fully-qualified before going on. */
if|if
condition|(
operator|!
name|CVSroot
...
comment|/* todo: what about these charsets??? */
name|strtok
argument_list|(
name|linebuf
argument_list|,
...
return|;
block|}
comment|/* It's safer this way, and blank lines in the file are OK. */
name|fprintf
argument_list|(
name|fp
argument_list|,
