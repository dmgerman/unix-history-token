...
index|[]
init|=
literal|"$CVSid: @(#)main.c 1.78 94/10/07 $\n"
decl_stmt|;
end_decl_stmt
...
directive|ifdef
name|AUTH_CLIENT_SUPPORT
literal|"        -a           Use the authenticating server, not rsh.\n"
block|,
endif|#
directive|endif
comment|/* AUTH_CLIENT_SUPPORT */
...
argument_list|)
expr_stmt|;
comment|/* The IBM TCP/IP library under OS/2 needs to be initialized: */
ifdef|#
directive|ifdef
name|NEED_CALL_SOCKINIT
if|if
condition|(
name|SockInit
argument_list|()
