...
directive|ifdef
name|HAS_SETREGID
argument|(void)setregid((GIDTYPE)-
literal|1
argument|,statbuf.st_gid);
else|#
directive|else
...
directive|ifdef
name|HAS_SETREUID
argument|(void)setreuid((UIDTYPE)-
literal|1
argument|,statbuf.st_uid);
else|#
directive|else
