...
literal|0
expr_stmt|;
comment|/* 			 * If symbol has a known size, output an extra symbol 			 * of type N_SIZE and with the same name. 			 */
if|if
condition|(
name|symbolP
operator|->
...
index|]
decl_stmt|;
comment|/* 				 * Changed my mind, make name: "=symbol" 				 */
name|buf
index|[
literal|0
index|]
...
directive|if
literal|0
block|S_SET_SEGMENT(addme, SEG_SIZE);
endif|#
directive|endif
name|addme
operator|->
