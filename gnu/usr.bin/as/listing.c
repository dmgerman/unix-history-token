...
index|[]
init|=
literal|"$Id: listing.c,v 1.1 1993/10/02 20:57:40 pk Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* print_source() */
end_comment

begin_comment
comment|/* Sometimes the user doesn't want to be bothered by the debugging    records inserted by the compiler, see if the line is suspicioous */
end_comment
...
name|as_warn
argument_list|(
literal|"strantge paper height, set to no form"
argument_list|)
expr_stmt|;
block|}
if|if
...
name|as_bad
argument_list|(
literal|"expecting title in quotes"
argument_list|)
expr_stmt|;
block|}
return|return;
...
begin_comment
comment|/* not NO_LISTING */
end_comment

begin_comment
comment|/* end of listing.c */
end_comment
