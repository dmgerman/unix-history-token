...
begin_comment
comment|/*  *	$Id: ld.c,v 1.9 1993/11/18 20:52:31 jkh Exp $  */
end_comment
...
name|printf
argument_list|(
literal|"defined globals: %d, undefined globals %d, locals: %d (non_L: %d), \ debug symbols: %d, special: %d, set_symbols %d, aliases %d --> nsyms %d\n"
argument_list|,
name|defined_global_sym_count
argument_list|,
name|undefined_global_sym_count
...
name|STRIP_NONE
operator|)
comment|/*&& 				!(discard_locals == DISCARD_L&& 							name[0] == LPREFIX)*/
expr_stmt|;
elseif|else
if|if
condition|(
