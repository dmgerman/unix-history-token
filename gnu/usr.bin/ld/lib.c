...
begin_comment
comment|/*  * $Id: lib.c,v 1.3 1993/11/22 19:04:43 jkh Exp $	- library routines  */
end_comment
...
break|break;
block|}
comment|/* Read link_dynamic_2 struct (from data segment) */
name|lseek
argument_list|(
name|desc
argument_list|,
...
name|fatal_with_file
argument_list|(
literal|"premature eof while reading dyn syms "
argument_list|,
name|entry
argument_list|)
expr_stmt|;
...
name|fatal_with_file
argument_list|(
literal|"premature eof while reading dyn strings "
argument_list|,
name|entry
argument_list|)
expr_stmt|;
...
name|fatal_with_file
argument_list|(
literal|"premature eof while reading link objects "
argument_list|,
name|entry
argument_list|)
expr_stmt|;
