...
begin_comment
comment|/* version SYNTEST inputs a RCS file and then prints out its internal  * data structures. */
end_comment
...
argument|synId
argument_list|,
literal|"$Id: rcssyn.c,v 1.1.1.1 1993/06/18 04:22:12 jkh Exp $"
argument_list|)
end_macro
...
name|ignorephrase
parameter_list|()
comment|/* Ignore a phrase introduced by a later version of RCS.  */
block|{
name|warnignore
argument_list|()
expr_stmt|;
