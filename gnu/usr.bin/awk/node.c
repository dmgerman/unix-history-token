...
directive|endif
comment|/* avoids floating point exception in DOS*/
if|if
condition|(
name|s
operator|->
...
begin_comment
comment|/*  * Duplicate a node.  (For strings, "duplicate" means crank up the  * reference count.)  */
end_comment
...
begin_comment
comment|/* this allocates a node with defined numbr */
end_comment
