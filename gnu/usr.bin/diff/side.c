...
begin_comment
comment|/*  * Print side by side lines with a separator in the middle.  * NULL parameters are taken to indicate whitespace text.  * Blank lines that can easily be caught are reduced to a single newline.  */
end_comment
