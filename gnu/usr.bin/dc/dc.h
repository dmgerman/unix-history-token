...
begin_comment
comment|/* generic pointer for information hiding */
end_comment
...
begin_comment
comment|/* only dc-math.c knows what dc_num's *really* look like */
end_comment
...
begin_comment
comment|/* only dc-string.c knows what dc_str's *really* look like */
end_comment
