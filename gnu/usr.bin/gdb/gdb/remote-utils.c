...
argument_list|)
expr_stmt|;
comment|/* FIXME-now: service@host? */
name|error
argument_list|(
...
argument_list|(
literal|"Remote debugging using `%s' at baud rate of %d\n"
argument_list|,
name|sr_get_device
argument_list|()
argument_list|,
...
parameter_list|()
block|{
comment|/* FIXME-now: if target is open when baud changes... */
