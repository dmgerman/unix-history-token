...
begin_comment
comment|/* Type that corresponds to the address given in a minimal symbol.  */
end_comment
...
name|type
modifier|*
name|msymbol_addr_type
decl_stmt|;
end_decl_stmt

begin_comment
comment|/* Add the appropriate elements for a minimal symbol to the end of    the expression.  */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* We don't worry too much about what the name of this type is      because the name should rarely appear in output to the user.  */
name|msymbol_addr_type
operator|=
name|init_type
argument_list|(
