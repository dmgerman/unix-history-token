...
begin_comment
comment|/* FIXME: static void hardwire_restore PARAMS ((serial_t scb)); */
end_comment
...
directive|ifdef
name|HAVE_TERMIOS
comment|/* I'm not sure whether this is necessary; the manpage makes no mention      of discarding input when switching to/from ICANON.  */
if|if
condition|(
name|state
operator|->
