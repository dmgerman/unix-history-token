...
begin_comment
comment|/* Convert from a "struct frame_info *" into a FRAME.  */
end_comment
...
begin_comment
comment|/* Convert from a FRAME into a "struct frame_info *".  */
end_comment
...
begin_comment
comment|/* Type of the address of a frame.  It is widely assumed (at least in    prototypes in headers which might not include this header) that    this is the same as CORE_ADDR, and no one can think of a case in    which it wouldn't be, so it might be best to remove this typedef.  */
end_comment
