...
name|XMC_XO
value|7
comment|/* Read-only extended operation (simulated insn) */
define|#
directive|define
name|XMC_SV
value|8
...
name|XMC_TC0
value|15
comment|/* Read-write TOC anchor for TOC addressability */
...
begin_comment
comment|/* Special h8 16bit or 8 bit reloc for mov.b 	*/
end_comment
...
begin_comment
comment|/* Special h8 opcode for 8bit which could be 16 */
end_comment
...
begin_comment
comment|/* Special h8 16bit jmp which could be pcrel 	*/
end_comment
...
begin_comment
comment|/* a branch which used to be a jmp 		*/
end_comment
...
begin_comment
comment|/* Special h8 24bit jmp which could be pcrel 	*/
end_comment
...
begin_comment
comment|/* a 8 bit pcrel which used to be a jmp  */
end_comment
...
begin_comment
comment|/* Special h8 24bit or 8 bit reloc for mov.b 	*/
end_comment
...
begin_comment
comment|/* Special h8 opcode for 8bit which could be 24 */
end_comment
