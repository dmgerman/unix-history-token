...
name|TIMEOUT
parameter_list|)
value|((SERIAL_T)->ops->readchar((SERIAL_T), TIMEOUT))
end_define
...
name|LEN
parameter_list|)
value|((SERIAL_T)->ops->write((SERIAL_T), STRING, LEN))
end_define
...
name|SERIAL_T
parameter_list|)
value|serial_close(SERIAL_T)
end_define

begin_comment
comment|/* Destroy SERIAL_T without doing the rest of the stuff that SERIAL_CLOSE    does.  */
end_comment
