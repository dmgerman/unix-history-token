...
begin_comment
comment|/* FIXME -- convert this to SEEK_SET a la POSIX, move to config files.  */
end_comment
...
name|dbfoff
decl_stmt|;
comment|/* Absolute file offset to start of .debug section */
name|int
name|dbroff
decl_stmt|;
comment|/* Relative offset from start of .debug section */
...
name|dblength
decl_stmt|;
comment|/* Size of the chunk of DIE's being examined */
name|file_ptr
name|lnfoff
decl_stmt|;
comment|/* Absolute file offset to line table fragment */
block|}
struct|;
end_struct
...
begin_comment
comment|/*  LOCAL FUNCTION  	init_psymbol_list -- initialize storage for partial symbols  SYNOPSIS  	static void init_psymbol_list (struct objfile *objfile, int total_symbols)  DESCRIPTION  	Initializes storage for all of the partial symbols that will be 	created by dwarf_build_psymtabs and subsidiaries.  */
end_comment
