...
begin_comment
comment|/* A lot of code assumes that the "index type" of an array/string/    set/bitstring is specifically a range type, though in some languages    it can be any discrete type. */
end_comment
...
init|=
block|{
literal|"array index type must be a discrete type"
block|,
literal|0
block|,
literal|0
