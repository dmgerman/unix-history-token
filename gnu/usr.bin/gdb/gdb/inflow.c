...
directive|endif
comment|/* Here we used to set ICANON in our ttystate, but I believe this 	 was an artifact from before when we used readline.  Readline sets 	 the tty state when it needs to.  */
...
block|if (result == -1) 	    fprintf (stderr, "[tcsetpgrp failed in terminal_ours: %s]\n", 		     strerror (errno));
endif|#
directive|endif
endif|#
directive|endif
...
name|HAVE_TERMIOS
argument_list|)
comment|/* Do all systems with termios have setpgid?  I hope so.  */
