...
name|entry
decl_stmt|;
comment|/* Processes which will not be resumed are not interesting, because      we might not wait for them next time through fbsd_wait.  */
if|if
condition|(
name|process
operator|->
