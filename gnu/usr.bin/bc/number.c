...
condition|)
return|return;
comment|/* The first digit is 0, find the first non-zero digit in the 10's or      greater place. */
name|bytes
operator|=
name|num
operator|->
...
begin_comment
comment|/* Perform addition: N1 is added to N2 and the value is    returned.  The signs of N1 and N2 are ignored. */
end_comment
...
begin_comment
comment|/* Perform subtraction: N2 is subtracted from N1 and the value is    returned.  The signs of N1 and N2 are ignored.  Also, N1 is    assumed to be larger than N2.  */
end_comment
...
begin_comment
comment|/* Here is the full add routine that takes care of negative numbers.    N1 is added to N2 and the result placed into RESULT. */
end_comment
...
begin_comment
comment|/* Here is the full subtract routine that takes care of negative numbers.    N2 is subtracted from N1 and the result placed in RESULT. */
end_comment
