...
name|to_longname
operator|=
literal|"FreeBSD core pthreads."
expr_stmt|;
name|freebsd_core_ops
operator|.
name|to_doc
operator|=
literal|"FreeBSD pthread support for core files."
expr_stmt|;
name|freebsd_core_ops
operator|.
name|to_open
...
name|freebsd_core_detach
expr_stmt|;
comment|/* freebsd_core_ops.to_resume  = 0; */
comment|/* freebsd_core_ops.to_wait  = 0;  */
name|freebsd_core_ops
operator|.
name|to_fetch_registers
operator|=
name|freebsd_uthread_fetch_registers
expr_stmt|;
comment|/* freebsd_core_ops.to_store_registers  = 0; */
comment|/* freebsd_core_ops.to_prepare_to_store  = 0; */
name|freebsd_core_ops
operator|.
name|to_xfer_memory
operator|=
...
name|freebsd_core_ignore
expr_stmt|;
comment|/* freebsd_core_ops.to_terminal_init  = 0; */
comment|/* freebsd_core_ops.to_terminal_inferior  = 0; */
comment|/* freebsd_core_ops.to_terminal_ours_for_output  = 0; */
comment|/* freebsd_core_ops.to_terminal_ours  = 0; */
comment|/* freebsd_core_ops.to_terminal_info  = 0; */
comment|/* freebsd_core_ops.to_kill  = 0; */
comment|/* freebsd_core_ops.to_load  = 0; */
comment|/* freebsd_core_ops.to_lookup_symbol  = 0; */
name|freebsd_core_ops
operator|.
name|to_create_inferior
operator|=
