...
block|{
comment|/* 	     * This is for zero-length files.  If we leave the extent 0, 	     * then we get screwed, because many readers simply drop files 	     * that have an extent of zero.  Thus we leave the size 0, 	     * and just assign the extent number. 	     */
name|set_733
argument_list|(
name|s_entry
operator|->
