...
name|printf
argument_list|(
literal|"/on_failure_keep_string_jump/0/%d"
argument_list|,
name|mcnt
argument_list|)
expr_stmt|;
...
name|printf
argument_list|(
literal|"/dummy_failure_jump/0/%d"
argument_list|,
name|mcnt
argument_list|)
expr_stmt|;
