...
literal|0
expr_stmt|;
comment|/* Find length of longest item in order to center radiolist */
for|for
control|(
name|i
operator|=
...
argument_list|)
expr_stmt|;
comment|/* See if its the short-cut to "OK" */
if|if
condition|(
name|toupper
argument_list|(
...
expr_stmt|;
block|}
comment|/*			    wmove(list, old_y, old_x);*/
comment|/* Restore cursor to previous position */
comment|/*			    wrefresh(list); */
block|}
if|if
condition|(
name|st
