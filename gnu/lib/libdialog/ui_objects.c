...
name|n
parameter_list|)
comment|/*  * Desc: Update the list in the listobject with the provided list  * Pre:  lo->name "has been allocated"   *	 (A i: 0<=i<lo->n: "lo->name[i] has been allocated")  */
block|{
name|int
name|i
decl_stmt|;
comment|/* Free the current names */
if|if
condition|(
name|lo
operator|->
