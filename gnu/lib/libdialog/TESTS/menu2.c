...
begin_comment
comment|/*  * small test-driver for new dialog functionality  *  * Copyright (c) 1995, Jordan Hubbard  *  * All rights reserved.  *  * This source code may be used, modified, copied, distributed, and  * sold, in both source and binary form provided that the above  * copyright and these terms are retained, verbatim, as the first  * lines of this file.  Under no circumstances is the author  * responsible for the proper functioning of the software nor does  * the author assume any responsibility for damages incurred with  * its use.  *  * $Id: menu2.c,v 1.4 1996/04/18 13:21:26 jkh Exp $  */
end_comment
...
name|use_helpline
argument_list|(
literal|"Type F1 to view the source for this demo"
argument_list|)
expr_stmt|;
name|retval
operator|=
name|dialog_menu
argument_list|(
literal|"this is dialog_menu() in action, test #2"
argument_list|,
literal|"this simple menu shows off some of the straight-forward features\n"
literal|"of the new menu system's action dispatch hooks as well as a helpline\n"
literal|"and a helpfile.  Select Cancel to leave"
argument_list|,
operator|-
literal|1
argument_list|,
