...
begin_comment
comment|/* For now, use unsigned short for compatibility with old libg++ code.    Later, change to unsigned long as the default. */
end_comment
...
name|BITNO
parameter_list|)
value|(1<< (_BS_BITS_PER_WORD - 1 - (BITNO)))
end_define
...
begin_comment
comment|/* Given a bit point (PTR, OFFSET) normalize it so that    OFFSET< _BS_BITS_PER_WORD. */
end_comment
