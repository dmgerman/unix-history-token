...
index|]
expr_stmt|;
comment|/* Need to copy the numerator into temporary space, as 	     mpn_div overwrites its numerator argument with the 	     remainder (which we currently ignore).  */
name|MPN_COPY
argument_list|(
name|ttp
argument_list|,
...
name|_mp_mout
argument_list|(
argument|mp_srcptr p
argument_list|,
argument|mp_size size
argument_list|)
end_macro
