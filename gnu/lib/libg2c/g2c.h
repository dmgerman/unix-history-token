...
begin_comment
comment|/* F2C_INTEGER will normally be `int' but would be `long' on 16-bit systems */
end_comment

begin_comment
comment|/* we assume short, float are OK */
end_comment
...
error|#
directive|error
literal|"f2c_i2 will not work with g77!!!!"
end_error
...
begin_comment
comment|/* (No such symbols should be defined in a strict ANSI C compiler.    We can avoid trouble with f2c-translated code by using    gcc -ansi [-traditional].) */
end_comment
