...
begin_comment
comment|/*  * And thus spoke RPCGEN:  *    Please do not edit this file.  *    It was generated using rpcgen.  *  * And thus replied Lpd@NannyMUD:  *    Who cares? :-) /Peter Eriksson<pen@signum.se>  *  *	$Id$  */
end_comment
...
name|Perror
argument_list|(
literal|"[Welcome to the NYS YP Server, version 0.11]\n"
argument_list|)
expr_stmt|;
if|if
condition|(
