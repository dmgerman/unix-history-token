...
begin_comment
comment|/*  * And thus spoke RPCGEN:  *    Please do not edit this file.  *    It was generated using rpcgen.  *  * And thus replied Lpd@NannyMUD:  *    Who cares? :-) /Peter Eriksson<pen@signum.se>  *  *	$Id: yp_svc.c,v 1.3 1995/05/30 05:05:37 rgrimes Exp $  */
end_comment
...
expr_stmt|;
block|}
comment|/*      * Ignore SIGPIPEs. They can hurt us is someone does a ypcat      * and then hits CTRL-C before it terminales.      */
name|signal
argument_list|(
name|SIGPIPE
argument_list|,
