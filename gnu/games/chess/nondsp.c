...
argument_list|)
expr_stmt|;
comment|/*   setvbuf(stdout,NULL,_IOLBF,BUFSIZ); */
name|printf
argument_list|(
literal|"Chess\n"
argument_list|)
...
name|printz
argument_list|(
literal|"clock     set time control\n"
argument_list|)
expr_stmt|;
name|printz
argument_list|(
...
name|printz
argument_list|(
literal|"Nodes= %ld  Eval= %ld  Hash= %ld  Rate= %ld  "
argument_list|,
name|NodeCnt
argument_list|,
name|EvalNodes
...
condition|)
block|{
comment|/*       setvbuf(fd,buffr,_IOFBF,2048); */
name|Book
operator|=
name|NULL
expr_stmt|;
