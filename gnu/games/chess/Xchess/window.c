...
begin_comment
comment|/* RCS Info: $Revision: 1.1.1.1 $ on $Date: 1993/06/12 14:41:08 $  *           $Source: /home/ncvs/src/gnu/games/chess/Xchess/window.c,v $  * Copyright (c) 1986 Wayne A. Christopher, U. C. Berkeley CAD Group  *	Permission is granted to do anything with this code except sell it  *	or remove this message.  *  * Deal with the two (or one) windows.  */
end_comment
