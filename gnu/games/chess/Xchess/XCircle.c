...
begin_comment
comment|/* RCS Info: $Revision: 1.1.1.1 $ on $Date: 1993/06/12 14:41:12 $  *           $Source: /home/ncvs/src/gnu/games/chess/Xchess/XCircle.c,v $  * Copyright (c) 1986 Wayne A. Christopher, U. C. Berkeley CAD Group  *	Permission is granted to do anything with this code except sell it  *	or remove this message.  *  */
end_comment
