...
begin_comment
comment|/* RCS Info: $Revision: 1.2 $ on $Date: 1995/05/30 04:41:18 $  *           $Source: /home/ncvs/src/gnu/games/chess/Xchess/XCircle.c,v $  * Copyright (c) 1986 Wayne A. Christopher, U. C. Berkeley CAD Group  *	Permission is granted to do anything with this code except sell it  *	or remove this message.  *  */
end_comment
...
begin_comment
comment|/* VertexCurved is screwed up */
end_comment
