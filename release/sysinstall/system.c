...
name|msgDebug
argument_list|(
literal|"Unlinking old helpfile: %s\n"
argument_list|,
name|oldfile
argument_list|)
expr_stmt|;
...
ifdef|#
directive|ifdef
name|NOT_A_GOOD_IDEA_CRUNCHED_BINARY
if|if
condition|(
name|magic
condition|)
