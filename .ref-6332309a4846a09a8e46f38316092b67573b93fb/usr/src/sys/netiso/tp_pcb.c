...
name|printf
argument_list|(
literal|"TP not configured !!! pcb (0x%x, %d) or aux (0x%x, %d) too big!\n"
argument_list|,
sizeof|sizeof
argument_list|(
expr|struct
...
argument_list|)
expr_stmt|;
comment|/* for the tpcb, auxilliary half */
if|if
condition|(
name|p
operator|==
...
name|printf
argument_list|(
literal|"tp_detach(tpcb 0x%x, so 0x%x) freelist 0%x\n"
argument_list|,
name|tpcb
argument_list|,
name|so
...
name|printf
argument_list|(
literal|"tp: nl_detach failed: tpcb 0x%x so 0x%x\n"
argument_list|,
name|tpcb
argument_list|,
name|so
...
name|printf
argument_list|(
literal|"end of detach, NOT single, tpcb 0x%x, dtom(tpcb) 0x%x tp_aux 0x%x dtom(aux) 0x%x\n"
argument_list|,
name|tpcb
argument_list|,
name|dtom
