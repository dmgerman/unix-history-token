...
parameter_list|)
define|\
value|((a->seon_family == AF_ISO)&& (a->seon_afi == 0x47)&&\ 	(a->seon_idi[0] == 0)&& (a->seon_idi[1] == 6) \ 	)
ifdef|#
directive|ifdef
name|notdef
comment|/* GET THESE RIGHT AND ADD THEM */
operator|&&
operator|(
name|a
operator|->
...
comment|/* TODO : check for null free list */
name|ent
operator|=
name|qtocentry
argument_list|(
...
argument_list|()
expr_stmt|;
comment|/* Nsel tells what type of multicast address, if multicast */
switch|switch
condition|(
name|dst
operator|->
...
name|printf
argument_list|(
literal|"NSEL bad value; treated as EON_NORMAL_ADDR\n"
argument_list|)
expr_stmt|;
name|dst
operator|->
...
name|printf
argument_list|(
literal|"eoninput() 0x%x m_off 0x%x m_len 0x%x dequeued\n"
argument_list|,
name|m
argument_list|,
name|m
...
goto|;
block|}
comment|/* drop ip header from the mbuf */
name|m
operator|->
name|m_len
operator|-=
...
operator|++
expr_stmt|;
comment|/* drop eonhdr from the mbuf */
name|m
operator|->
name|m_len
operator|-=
...
expr_stmt|;
comment|/* KLUDGE */
comment|/* this is cutting it close */
name|bcopy
argument_list|(
operator|&
name|iphdr
...
name|printf
argument_list|(
literal|"0x%x enqueued on clnp Q: m_len 0x%x m_type 0x%x m_off 0x%x\n"
argument_list|,
name|m
argument_list|,
name|m
