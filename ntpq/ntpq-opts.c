...
name|NUMERIC_FLAGS
value|(OPTST_DISABLED)
comment|/*  *  Old_Rv option description:  */
specifier|static
name|char
specifier|const
name|zOld_RvText
...
index|]
init|=
literal|"ntpq - standard NTP query program - Ver. 4.2.6p5\n\ USAGE:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"
decl_stmt|;
specifier|static
name|char
specifier|const
