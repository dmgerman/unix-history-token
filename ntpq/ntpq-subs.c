...
block|}
block|,
literal|"obtain and print a list of the server's peers and their assocIDs [IP version]"
block|}
block|,
block|{
literal|"lpeers"
...
argument_list|)
expr_stmt|;
comment|//fprintf(stderr, "apeervarlist S1 refid: value=<%s>\n", value);
block|}
elseif|else
if|if
condition|(
...
name|buf
expr_stmt|;
comment|//fprintf(stderr, "apeervarlist refid: value=<%x>\n", i);
block|}
comment|//fprintf(stderr, "apeervarlist refid: value=<%s>\n", value);
block|}
else|else
block|{
name|have_da_rid
...
block|{
comment|// fprintf(stderr, "UNRECOGNIZED name=%s ", name);
block|}
block|}
...
begin_comment
comment|/*  * doapeers - print a peer spreadsheet with assocIDs  */
end_comment
...
name|fp
argument_list|,
literal|"     remote       refid   assid  st t when poll reach   delay   offset  jitter\n"
argument_list|)
expr_stmt|;
if|if
condition|(
...
begin_comment
comment|/*  * apeers - print a peer spreadsheet, with assocIDs  */
end_comment
