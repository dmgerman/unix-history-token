...
begin_comment
comment|/* parse()  *  * parse a line read from the input filter rule file  *  * status:  *< 0	error  *	= 0	OK  *> 0	programmer error  */
end_comment
...
condition|)
block|{
comment|/* NB loglevel prints its own error message */
operator|*
name|status
operator|=
operator|-
