...
comment|/* XXX check rev when new parts are available */
return|return
operator|(
name|ahp
operator|->
...
directive|endif
case|case
name|HAL_CAP_MAX_WEP_TKIP_HT20_TX_RATEKBPS
case|:
operator|*
name|result
operator|=
...
return|;
case|case
name|HAL_CAP_MAX_WEP_TKIP_HT40_TX_RATEKBPS
case|:
operator|*
name|result
operator|=
