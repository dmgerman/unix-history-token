...
name|dw
parameter_list|)
value|(dw->dvi.device_resolution * 9)
end_define
...
name|dw
parameter_list|)
value|(dw->dvi.device_resolution * 11)
end_define
...
argument_list|)
expr_stmt|;
comment|/* 			 * at EOF, seek back to the begining of this page. 			 */
if|if
condition|(
name|feof
argument_list|(
