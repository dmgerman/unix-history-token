...
name|refresh
parameter_list|()
value|VOIDBIOS(;, wrefresh(stdscr))
end_define
...
name|w
parameter_list|)
value|if ((w) != kbuf) VOIDBIOS((w) = kbuf, {ttywrite(kbuf, (unsigned)((w) - kbuf)); (w) = kbuf;}) else
end_define
...
name|w
parameter_list|)
value|if ((w) - kbuf> 2000) VOIDBIOS((w) = kbuf, {ttywrite(kbuf, (unsigned)((w) - kbuf)); (w) = kbuf;}) else
end_define
