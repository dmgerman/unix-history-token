...
begin_comment
comment|/* This is the header file for my version of vi. */
end_comment
...
directive|define
name|VERSION
value|"ELVIS 1.4, by Steve Kirkendall"
end_define
...
begin_comment
comment|/* longest possible .exrc file */
end_comment
...
begin_comment
comment|/* the file has been modified */
end_comment
...
begin_comment
comment|/* boolean: force total redraw of screen? */
end_comment
...
begin_comment
comment|/* resets the "manymsgs" flag */
end_comment
