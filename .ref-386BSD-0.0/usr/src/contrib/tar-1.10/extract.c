...
begin_comment
comment|/*  * Extract files from a tar archive.  *  * Written 19 Nov 1985 by John Gilmore, ihnp4!hoptoad!gnu.  *  * @(#) extract.c 1.32 87/11/11 - gnu  */
end_comment
...
begin_comment
comment|/*  * Some people don't have a #define for these.  */
end_comment
...
name|set_filestat
goto|;
comment|/* FIXME, Remember timestamps for after files created? */
comment|/* FIXME, change mode after files created (if was R/O dir) */
case|case
name|LF_VOLHDR
case|:
if|if
