...
begin_comment
comment|/*  * Header file for tar (tape archive) program.  *  * @(#)tar.h 1.24 87/11/06  *  * Created 25 August 1985 by John Gilmore, ihnp4!hoptoad!gnu.  */
end_comment
...
begin_comment
comment|/* TAR_EXTERN char	f_dironly;	/* -D */
end_comment
...
begin_comment
comment|/* Do not prototype these for BSD--see port.c [DOPRNT_MSG].  */
end_comment
...
begin_comment
comment|/* #define	 annorec(stream, msg)	anno(stream, msg, 0)	/* Cur rec */
end_comment

begin_comment
comment|/* #define	annofile(stream, msg)	anno(stream, msg, 1)	/* Saved rec */
end_comment
