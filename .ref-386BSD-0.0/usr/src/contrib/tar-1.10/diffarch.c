...
begin_comment
comment|/*  * Diff files from a tar archive.  *  * Written 30 April 1987 by John Gilmore, ihnp4!hoptoad!gnu.  *  * @(#) diffarch.c 1.10 87/11/11 - gnu  */
end_comment
...
begin_comment
comment|/* Some systems don't have these #define's -- we fake it here. */
end_comment
