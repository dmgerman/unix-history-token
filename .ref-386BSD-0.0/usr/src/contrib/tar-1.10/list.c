...
begin_comment
comment|/*  * List a tar archive.  *  * Also includes support routines for reading a tar archive.  *  * this version written 26 Aug 1985 by John Gilmore (ihnp4!hoptoad!gnu).  *  * @(#)list.c 1.31 11/5/87 - gnu  */
end_comment
