...
begin_comment
comment|// Ignored type qualifiers after comma in declarator lists
end_comment

begin_typedef
typedef|typedef
name|int
name|ignored_quals_dummy1
...
begin_comment
comment|// expected-warning {{qualifiers after comma in declarator list are ignored}}
end_comment
...
begin_struct
struct|struct
name|align_before_key2
block|{}
name|align_before_key2_var
struct|;
end_struct
...
begin_struct
struct|struct
name|align_before_key3
block|{}
modifier|*
name|align_before_key3_var
struct|;
end_struct
