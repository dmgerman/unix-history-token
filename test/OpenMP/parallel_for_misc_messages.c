...
begin_comment
comment|// expected-error@+1 {{unexpected OpenMP directive '#pragma omp parallel for'}}
end_comment
...
control|)
empty_stmt|;
comment|// expected-error@+2 {{statement after '#pragma omp parallel for' must be a for loop}}
pragma|#
directive|pragma
name|omp
name|parallel
...
control|)
empty_stmt|;
comment|// expected-warning@+2 {{extra tokens at the end of '#pragma omp parallel for' are ignored}}
comment|// expected-error@+1 {{expected '('}}
pragma|#
directive|pragma
name|omp
...
control|)
empty_stmt|;
comment|// expected-error {{expected 4 for loops after '#pragma omp parallel for', but found only 1}}
comment|// expected-error@+2 {{expected ')'}}
comment|// expected-note@+1 {{to match this '('}} expected-note@+1 {{as specified in 'collapse' clause}}
pragma|#
directive|pragma
...
control|)
empty_stmt|;
comment|// expected-note@+1 {{defined as firstprivate}}
pragma|#
directive|pragma
name|omp
name|parallel
