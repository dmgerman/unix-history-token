...
begin_comment
comment|// RUN: %clang_cc1 -fsyntax-only -fopenmp -triple x86_64-unknown-unknown -verify %s
end_comment

begin_comment
comment|// expected-error@+1 {{unexpected OpenMP directive '#pragma omp taskloop'}}
end_comment
...
control|)
empty_stmt|;
comment|// expected-error@+2 {{statement after '#pragma omp taskloop' must be a for loop}}
pragma|#
directive|pragma
name|omp
name|taskloop
...
name|omp
name|parallel
comment|// expected-warning@+1 {{extra tokens at the end of '#pragma omp taskloop' are ignored}}
pragma|#
directive|pragma
name|omp
name|taskloop
...
control|)
empty_stmt|;
comment|// expected-error@+1 {{directive '#pragma omp taskloop' cannot contain more than one 'nogroup' clause}}
pragma|#
directive|pragma
name|omp
name|taskloop
...
control|)
empty_stmt|;
comment|// expected-warning@+3 {{extra tokens at the end of '#pragma omp taskloop' are ignored}}
comment|// expected-error@+2 {{unexpected OpenMP clause 'linear' in directive '#pragma omp taskloop'}}
pragma|#
directive|pragma
name|omp
name|parallel
...
name|omp
name|parallel
comment|// expected-warning@+2 {{extra tokens at the end of '#pragma omp taskloop' are ignored}}
comment|// expected-error@+1 {{expected '('}}
pragma|#
directive|pragma
name|omp
...
control|)
empty_stmt|;
comment|// expected-error {{expected 4 for loops after '#pragma omp taskloop', but found only 1}}
pragma|#
directive|pragma
name|omp
name|parallel
