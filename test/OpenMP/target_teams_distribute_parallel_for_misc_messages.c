...
begin_comment
comment|// expected-error@+1 {{unexpected OpenMP directive '#pragma omp target teams distribute parallel for'}}
end_comment
...
control|)
empty_stmt|;
comment|// expected-error@+2 {{statement after '#pragma omp target teams distribute parallel for' must be a for loop}}
pragma|#
directive|pragma
name|omp
name|target
...
name|i
decl_stmt|;
comment|// expected-warning@+1 {{extra tokens at the end of '#pragma omp target teams distribute parallel for' are ignored}}
pragma|#
directive|pragma
name|omp
name|target
...
control|)
empty_stmt|;
comment|// expected-warning@+2 {{extra tokens at the end of '#pragma omp target teams distribute parallel for' are ignored}}
comment|// expected-error@+1 {{expected '('}}
pragma|#
directive|pragma
name|omp
...
control|)
empty_stmt|;
comment|// expected-error {{expected 4 for loops after '#pragma omp target teams distribute parallel for', but found only 1}}
comment|// expected-error@+2 {{expected ')'}}
comment|// expected-note@+1 {{to match this '('}} expected-note@+1 {{as specified in 'collapse' clause}}
pragma|#
directive|pragma
...
control|)
empty_stmt|;
comment|// expected-error@+3 {{loop iteration variable in the associated loop of 'omp target teams distribute parallel for' directive may not be firstprivate, predetermined as private}}
