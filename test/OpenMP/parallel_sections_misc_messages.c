...
begin_comment
comment|// expected-error@+1 {{unexpected OpenMP directive '#pragma omp parallel sections'}}
end_comment
...
expr_stmt|;
block|}
comment|// expected-error@+2 {{the statement for '#pragma omp parallel sections' must be a compound statement}}
pragma|#
directive|pragma
name|omp
name|parallel
...
argument_list|()
expr_stmt|;
comment|// expected-error {{statement in 'omp parallel sections' directive must be enclosed into a section region}}
block|}
block|}
end_function
...
name|i
decl_stmt|;
comment|// expected-warning@+1 {{extra tokens at the end of '#pragma omp parallel sections' are ignored}}
pragma|#
directive|pragma
name|omp
name|parallel
...
expr_stmt|;
block|}
comment|// expected-error@+2 {{unexpected OpenMP clause 'linear' in directive '#pragma omp parallel sections'}}
comment|// expected-warning@+1 {{extra tokens at the end of '#pragma omp parallel sections' are ignored}}
pragma|#
directive|pragma
name|omp
