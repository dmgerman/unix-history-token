...
begin_comment
comment|// expected-error@+1 {{unexpected OpenMP directive '#pragma omp parallel for simd'}}
end_comment
...
control|)
empty_stmt|;
comment|// expected-error@+2 {{statement after '#pragma omp parallel for simd' must be a for loop}}
pragma|#
directive|pragma
name|omp
name|parallel
...
name|omp
name|parallel
comment|// expected-warning@+1 {{extra tokens at the end of '#pragma omp parallel for simd' are ignored}}
pragma|#
directive|pragma
name|omp
name|parallel
...
control|)
empty_stmt|;
comment|// expected-warning@+2 {{extra tokens at the end of '#pragma omp parallel for simd' are ignored}}
comment|// expected-error@+1 {{expected '('}}
pragma|#
directive|pragma
name|omp
...
control|)
empty_stmt|;
comment|// expected-error@+1 {{argument to 'safelen' clause must be a positive integer value}}
pragma|#
directive|pragma
name|omp
name|parallel
...
control|)
empty_stmt|;
comment|// expected-error {{expected 4 for loops after '#pragma omp parallel for simd', but found only 1}}
pragma|#
directive|pragma
name|omp
name|parallel
