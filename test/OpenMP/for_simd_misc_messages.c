...
begin_comment
comment|// expected-error@+1 {{unexpected OpenMP directive '#pragma omp for simd'}}
end_comment
...
control|)
empty_stmt|;
comment|// expected-error@+2 {{statement after '#pragma omp for simd' must be a for loop}}
pragma|#
directive|pragma
name|omp
name|for
...
name|omp
name|parallel
comment|// expected-warning@+1 {{extra tokens at the end of '#pragma omp for simd' are ignored}}
pragma|#
directive|pragma
name|omp
name|for
...
control|)
empty_stmt|;
comment|// expected-warning@+2 {{extra tokens at the end of '#pragma omp for simd' are ignored}}
comment|// expected-error@+1 {{expected '('}}
pragma|#
directive|pragma
name|omp
...
control|)
empty_stmt|;
comment|// expected-error {{expected 4 for loops after '#pragma omp for simd', but found only 1}}
pragma|#
directive|pragma
name|omp
name|parallel
...
name|i
control|)
comment|// expected-note@+1 {{variable with automatic storage duration is predetermined as private; perhaps you forget to enclose 'omp for simd' directive into a parallel or another task region?}}
for|for
control|(
name|int
name|j
