...
begin_comment
comment|// expected-error@+1 {{unexpected OpenMP directive '#pragma omp taskloop simd'}}
end_comment
...
control|)
empty_stmt|;
comment|// expected-error@+2 {{statement after '#pragma omp taskloop simd' must be a for loop}}
pragma|#
directive|pragma
name|omp
name|taskloop
...
name|omp
name|parallel
comment|// expected-warning@+1 {{extra tokens at the end of '#pragma omp taskloop simd' are ignored}}
pragma|#
directive|pragma
name|omp
name|taskloop
...
control|)
empty_stmt|;
comment|// expected-error@+1 {{directive '#pragma omp taskloop simd' cannot contain more than one 'nogroup' clause}}
pragma|#
directive|pragma
name|omp
name|taskloop
...
control|)
empty_stmt|;
comment|// expected-warning@+2 {{extra tokens at the end of '#pragma omp taskloop simd' are ignored}}
pragma|#
directive|pragma
name|omp
name|parallel
...
control|)
empty_stmt|;
comment|// expected-error {{expected 4 for loops after '#pragma omp taskloop simd', but found only 1}}
pragma|#
directive|pragma
name|omp
name|parallel
