...
begin_comment
comment|// CHECK-DAG: %struct.M = type { [2 x %struct.I] }
end_comment

begin_comment
comment|// CHECK-DAG: %struct.I = type { [3 x i32] }
end_comment

begin_comment
comment|// CHECK: [1 x %struct.M] [%struct.M { [2 x %struct.I] [%struct.I { [3 x i32] [i32 4, i32 4, i32 0] }, %struct.I { [3 x i32] [i32 4, i32 4, i32 5] }] }],
end_comment

begin_comment
comment|// CHECK: [2 x [3 x i32]] {{[[][[]}}3 x i32] [i32 2222, i32 2222, i32 0], [3 x i32] [i32 2222, i32 2222, i32 3333]],
end_comment
