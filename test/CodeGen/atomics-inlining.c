...
argument_list|)
expr_stmt|;
comment|// PPC32: define void @test1
comment|// PPC32: load atomic i8* @c1 seq_cst
comment|// PPC32: load atomic i16* @s1 seq_cst
comment|// PPC32: load atomic i32* @i1 seq_cst
comment|// PPC32: call void @__atomic_load(i32 8, i8* bitcast (i64* @ll1 to i8*)
comment|// PPC64: define void @test1
...
comment|// MIPS32: define void @test1
...
comment|// MIPS32: call void @__atomic_load(i32 8, i8* bitcast (i64* @ll1 to i8*)
comment|// MIPS64: define void @test1
