...
begin_comment
comment|// CHECK: test_vceqz_s8
end_comment

begin_comment
comment|// CHECK: cmeq  {{v[0-9]+}}.8b, {{v[0-9]+}}.8b, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vceqz_s16
end_comment

begin_comment
comment|// CHECK: cmeq  {{v[0-9]+}}.4h, {{v[0-9]+}}.4h, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vceqz_s32
end_comment

begin_comment
comment|// CHECK: cmeq  {{v[0-9]+}}.2s, {{v[0-9]+}}.2s, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vceqzq_s8
end_comment

begin_comment
comment|// CHECK: cmeq  {{v[0-9]+}}.16b, {{v[0-9]+}}.16b, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vceqzq_s16
end_comment

begin_comment
comment|// CHECK: cmeq  {{v[0-9]+}}.8h, {{v[0-9]+}}.8h, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vceqzq_s32
end_comment

begin_comment
comment|// CHECK: cmeq  {{v[0-9]+}}.4s, {{v[0-9]+}}.4s, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vceqzq_s64
end_comment

begin_comment
comment|// CHECK: cmeq  {{v[0-9]+}}.2d, {{v[0-9]+}}.2d, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vcgez_s8
end_comment

begin_comment
comment|// CHECK: cmge  {{v[0-9]+}}.8b, {{v[0-9]+}}.8b, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vcgez_s16
end_comment

begin_comment
comment|// CHECK: cmge  {{v[0-9]+}}.4h, {{v[0-9]+}}.4h, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vcgez_s32
end_comment

begin_comment
comment|// CHECK: cmge  {{v[0-9]+}}.2s, {{v[0-9]+}}.2s, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vcgezq_s8
end_comment

begin_comment
comment|// CHECK: cmge  {{v[0-9]+}}.16b, {{v[0-9]+}}.16b, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vcgezq_s16
end_comment

begin_comment
comment|// CHECK: cmge  {{v[0-9]+}}.8h, {{v[0-9]+}}.8h, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vcgezq_s32
end_comment

begin_comment
comment|// CHECK: cmge  {{v[0-9]+}}.4s, {{v[0-9]+}}.4s, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vcgezq_s64
end_comment

begin_comment
comment|// CHECK: cmge  {{v[0-9]+}}.2d, {{v[0-9]+}}.2d, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vclez_s8
end_comment

begin_comment
comment|// CHECK: cmle  {{v[0-9]+}}.8b, {{v[0-9]+}}.8b, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vclez_s16
end_comment

begin_comment
comment|// CHECK: cmle  {{v[0-9]+}}.4h, {{v[0-9]+}}.4h, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vclez_s32
end_comment

begin_comment
comment|// CHECK: cmle  {{v[0-9]+}}.2s, {{v[0-9]+}}.2s, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vclezq_s8
end_comment

begin_comment
comment|// CHECK: cmle  {{v[0-9]+}}.16b, {{v[0-9]+}}.16b, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vclezq_s16
end_comment

begin_comment
comment|// CHECK: cmle  {{v[0-9]+}}.8h, {{v[0-9]+}}.8h, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vclezq_s32
end_comment

begin_comment
comment|// CHECK: cmle  {{v[0-9]+}}.4s, {{v[0-9]+}}.4s, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vclezq_s64
end_comment

begin_comment
comment|// CHECK: cmle  {{v[0-9]+}}.2d, {{v[0-9]+}}.2d, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vcgtz_s8
end_comment

begin_comment
comment|// CHECK: cmgt  {{v[0-9]+}}.8b, {{v[0-9]+}}.8b, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vcgtz_s16
end_comment

begin_comment
comment|// CHECK: cmgt  {{v[0-9]+}}.4h, {{v[0-9]+}}.4h, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vcgtz_s32
end_comment

begin_comment
comment|// CHECK: cmgt  {{v[0-9]+}}.2s, {{v[0-9]+}}.2s, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vcgtzq_s8
end_comment

begin_comment
comment|// CHECK: cmgt  {{v[0-9]+}}.16b, {{v[0-9]+}}.16b, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vcgtzq_s16
end_comment

begin_comment
comment|// CHECK: cmgt  {{v[0-9]+}}.8h, {{v[0-9]+}}.8h, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vcgtzq_s32
end_comment

begin_comment
comment|// CHECK: cmgt  {{v[0-9]+}}.4s, {{v[0-9]+}}.4s, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vcgtzq_s64
end_comment

begin_comment
comment|// CHECK: cmgt  {{v[0-9]+}}.2d, {{v[0-9]+}}.2d, #0x0
end_comment
...
begin_comment
comment|// CHECK: test_vcltz_s8
end_comment

begin_comment
comment|// CHECK: cmlt  {{v[0-9]+}}.8b, {{v[0-9]+}}.8b, #0
end_comment
...
begin_comment
comment|// CHECK: test_vcltz_s16
end_comment

begin_comment
comment|// CHECK: cmlt  {{v[0-9]+}}.4h, {{v[0-9]+}}.4h, #0
end_comment
...
begin_comment
comment|// CHECK: test_vcltz_s32
end_comment

begin_comment
comment|// CHECK: cmlt  {{v[0-9]+}}.2s, {{v[0-9]+}}.2s, #0
end_comment
...
begin_comment
comment|// CHECK: test_vcltz_s64
end_comment

begin_comment
comment|// CHECK: cmlt {{d[0-9]+}}, {{d[0-9]+}}, #0
end_comment
...
begin_comment
comment|// CHECK: test_vcltzq_s8
end_comment

begin_comment
comment|// CHECK: cmlt  {{v[0-9]+}}.16b, {{v[0-9]+}}.16b, #0
end_comment
...
begin_comment
comment|// CHECK: test_vcltzq_s16
end_comment

begin_comment
comment|// CHECK: cmlt  {{v[0-9]+}}.8h, {{v[0-9]+}}.8h, #0
end_comment
...
begin_comment
comment|// CHECK: test_vcltzq_s32
end_comment

begin_comment
comment|// CHECK: cmlt  {{v[0-9]+}}.4s, {{v[0-9]+}}.4s, #0
end_comment
...
begin_comment
comment|// CHECK: test_vcltzq_s64
end_comment

begin_comment
comment|// CHECK: cmlt  {{v[0-9]+}}.2d, {{v[0-9]+}}.2d, #0
end_comment
...
parameter_list|)
block|{
comment|// CHECK: test_vuqaddq_s16
return|return
name|vuqaddq_s16
argument_list|(
name|a
...
parameter_list|)
block|{
comment|// CHECK: test_vuqaddq_s32
return|return
name|vuqaddq_s32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|// CHECK: test_vuqaddq_s64
return|return
name|vuqaddq_s64
argument_list|(
name|a
...
argument_list|)
return|;
comment|// CHECK: not v{{[0-9]+}}.8b, v{{[0-9]+}}.8b
block|}
end_function
...
argument_list|)
return|;
comment|// CHECK: not v{{[0-9]+}}.16b, v{{[0-9]+}}.16b
block|}
end_function
...
parameter_list|)
block|{
comment|// CHECK: test_vmovn_high_s16
return|return
name|vmovn_high_s16
argument_list|(
name|a
...
parameter_list|)
block|{
comment|// CHECK: test_vmovn_high_s32
return|return
name|vmovn_high_s32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|// CHECK: test_vmovn_high_s64
return|return
name|vmovn_high_s64
argument_list|(
name|a
...
parameter_list|)
block|{
comment|// CHECK: test_vmovn_high_u16
return|return
name|vmovn_high_u16
argument_list|(
name|a
...
parameter_list|)
block|{
comment|// CHECK: test_vmovn_high_u32
return|return
name|vmovn_high_u32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|// CHECK: test_vmovn_high_u64
return|return
name|vmovn_high_u64
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvt_high_f16_f32
return|return
...
parameter_list|)
block|{
comment|//CHECK: test_vcvt_high_f32_f16
return|return
...
parameter_list|)
block|{
comment|//CHECK: test_vcvt_f64_f32
return|return
name|vcvt_f64_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvt_high_f64_f32
return|return
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtq_s64_f64
return|return
name|vcvtq_s64_f64
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtq_u64_f64
return|return
name|vcvtq_u64_f64
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtn_s32_f32
return|return
name|vcvtn_s32_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtnq_s32_f32
return|return
name|vcvtnq_s32_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtnq_s64_f64
return|return
name|vcvtnq_s64_f64
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtn_u32_f32
return|return
name|vcvtn_u32_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtnq_u32_f32
return|return
name|vcvtnq_u32_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtnq_u64_f64
return|return
name|vcvtnq_u64_f64
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtp_s32_f32
return|return
name|vcvtp_s32_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtpq_s32_f32
return|return
name|vcvtpq_s32_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtpq_s64_f64
return|return
name|vcvtpq_s64_f64
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtp_u32_f32
return|return
name|vcvtp_u32_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtpq_u32_f32
return|return
name|vcvtpq_u32_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtpq_u64_f64
return|return
name|vcvtpq_u64_f64
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtm_s32_f32
return|return
name|vcvtm_s32_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtmq_s32_f32
return|return
name|vcvtmq_s32_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtmq_s64_f64
return|return
name|vcvtmq_s64_f64
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtm_u32_f32
return|return
name|vcvtm_u32_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtmq_u32_f32
return|return
name|vcvtmq_u32_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtmq_u64_f64
return|return
name|vcvtmq_u64_f64
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvta_s32_f32
return|return
name|vcvta_s32_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtaq_s32_f32
return|return
name|vcvtaq_s32_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtaq_s64_f64
return|return
name|vcvtaq_s64_f64
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvta_u32_f32
return|return
name|vcvta_u32_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtaq_u32_f32
return|return
name|vcvtaq_u32_f32
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtaq_u64_f64
return|return
name|vcvtaq_u64_f64
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vrsqrteq_f64
return|return
name|vrsqrteq_f64
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vrecpeq_f64
return|return
name|vrecpeq_f64
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtq_f64_s64
return|return
name|vcvtq_f64_s64
argument_list|(
name|a
...
parameter_list|)
block|{
comment|//CHECK: test_vcvtq_f64_u64
return|return
name|vcvtq_f64_u64
argument_list|(
name|a
