...
begin_comment
comment|// CHECK: @test2.x = private unnamed_addr constant [13 x i32] [i32 1,
end_comment

begin_comment
comment|// CHECK: @test5w = global { i32, [4 x i8] } { i32 2, [4 x i8] undef }
end_comment

begin_comment
comment|// CHECK: @test5y = global { double } { double 7.300000e+0{{[0]*}}1 }
end_comment

begin_comment
comment|// CHECK: @test6.x = private unnamed_addr constant %struct.SelectDest { i8 1, i8 2, i32 3, i32 0 }
end_comment
