...
parameter_list|)
block|{
comment|// CHECK-LABEL: @test_mm256_cmp_ps_true
comment|// CHECK: store<8 x float><float 0xFFFFFFFFE0000000,
return|return
name|_mm256_cmp_ps
argument_list|(
name|a
...
parameter_list|)
block|{
comment|// CHECK-LABEL: @test_mm256_cmp_pd_true
comment|// CHECK: store<4 x double><double 0xFFFFFFFFFFFFFFFF,
return|return
name|_mm256_cmp_pd
argument_list|(
name|a
...
parameter_list|)
block|{
comment|// CHECK-LABEL: @test_mm256_cmp_ps_false
comment|// CHECK: store<8 x float> zeroinitializer,<8 x float>* %tmp, align 32
return|return
name|_mm256_cmp_ps
argument_list|(
name|a
...
parameter_list|)
block|{
comment|// CHECK-LABEL: @test_mm256_cmp_pd_false
comment|// CHECK: store<4 x double> zeroinitializer,<4 x double>* %tmp, align 32
return|return
name|_mm256_cmp_pd
argument_list|(
name|a
...
parameter_list|)
block|{
comment|// CHECK-LABEL: @test_mm256_cmp_ps_strue
comment|// CHECK: store<8 x float><float 0xFFFFFFFFE0000000,
return|return
name|_mm256_cmp_ps
argument_list|(
...
parameter_list|)
block|{
comment|// CHECK-LABEL: @test_mm256_cmp_pd_strue
comment|// CHECK: store<4 x double><double 0xFFFFFFFFFFFFFFFF,
return|return
name|_mm256_cmp_pd
argument_list|(
...
parameter_list|)
block|{
comment|// CHECK-LABEL: @test_mm256_cmp_ps_sfalse
comment|// CHECK: store<8 x float> zeroinitializer,<8 x float>* %tmp, align 32
return|return
name|_mm256_cmp_ps
argument_list|(
...
parameter_list|)
block|{
comment|// CHECK-LABEL: @test_mm256_cmp_pd_sfalse
comment|// CHECK: store<4 x double> zeroinitializer,<4 x double>* %tmp, align 32
return|return
name|_mm256_cmp_pd
argument_list|(
