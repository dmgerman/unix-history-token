...
block|{
comment|// CHECK: @test4
comment|// FIXME: call void @llvm.memcpy.p0i8.p0i8.i64(i8* {{.*}}, i8* bitcast (%struct.X* getelementptr inbounds (%struct.Y* @g, i32 0, i32 1) to i8*), i64 24, i32 1, i1 false)
name|f
argument_list|(
name|g
operator|.
...
block|{
comment|// CHECK: @test7
comment|// CHECK: load i32* bitcast (%struct.XBitfield* getelementptr inbounds (%struct.YBitfield* @gbitfield, i32 0, i32 1) to i32*), align 1
return|return
name|gbitfield
operator|.
name|y
