...
begin_comment
comment|// Alignment should be respected for coerced argument loads
end_comment
...
begin_comment
comment|// CHECK: load i64, i64* getelementptr inbounds (%struct.arg, %struct.arg* @x, i32 0, i32 0), align 4
end_comment
