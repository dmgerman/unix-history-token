...
comment|// CHECK: define void @test_store_m(i32 zeroext %i)
...
comment|// CHECK: define void @test_store_Q(i32 zeroext %i)
...
comment|// CHECK: define void @test_store_R(i32 zeroext %i)
...
comment|// CHECK: define void @test_store_S(i32 zeroext %i)
...
comment|// CHECK: define void @test_store_T(i32 zeroext %i)
...
name|i
return|;
comment|// CHECK: define signext i32 @test_load_m()
...
name|i
return|;
comment|// CHECK: define signext i32 @test_load_Q()
...
name|i
return|;
comment|// CHECK: define signext i32 @test_load_R()
...
name|i
return|;
comment|// CHECK: define signext i32 @test_load_S()
...
name|i
return|;
comment|// CHECK: define signext i32 @test_load_T()
...
comment|// CHECK: define void @test_mI(i8* %c)
...
name|i
return|;
comment|// CHECK: define zeroext i32 @test_dJa(i32 zeroext %i, i32 zeroext %j)
...
name|i
return|;
comment|// CHECK: define i64 @test_rK(i64 %i)
...
name|i
return|;
comment|// CHECK: define i64 @test_rL(i64 %i)
...
comment|// CHECK: define void @test_M()
...
name|f
return|;
comment|// CHECK: define float @test_f32(float %f, float %g)
...
name|f
return|;
comment|// CHECK: define double @test_f64(double %f, double %g)
...
name|f
return|;
comment|// CHECK: define void @test_f128(fp128* noalias nocapture sret [[DEST:%.*]], fp128* byval nocapture, fp128* byval nocapture)
