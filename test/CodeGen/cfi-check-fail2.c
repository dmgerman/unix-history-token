...
begin_comment
comment|// __cfi_check_fail codegen when not all CFI checkers are enabled.
end_comment
...
begin_comment
comment|// RUN:     -fsanitize=cfi-vcall \
end_comment
...
begin_comment
comment|// CHECK:   call void @__ubsan_handle_cfi_check_fail_abort(i64 %[[DATA0]], i64 %[[ADDR0]], i64 %[[VTVALID]])
end_comment
...
begin_comment
comment|// CHECK:   br i1 %[[NOT_2]], label %[[CONT3:.*]], label %[[HANDLE2:.*]], !nosanitize
end_comment
...
begin_comment
comment|// CHECK:   br i1 %[[NOT_3]], label %[[CONT4:.*]], label %[[HANDLE3:.*]], !nosanitize
end_comment
