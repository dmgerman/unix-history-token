...
expr_stmt|;
comment|// expected-error {{no matching function}}
comment|// expected-note@vecintrin.h:* 13 {{candidate function not viable}}
comment|// expected-note@vecintrin.h:* 1 {{must be a constant integer from 0 to 3}}
name|vf
operator|=
name|vec_splat
...
argument_list|)
expr_stmt|;
comment|// expected-error {{should be a value from 0 to 15}}
name|vuc
operator|=
name|vec_msum_u128
argument_list|(
...
comment|// expected-note@vecintrin.h:* 1 {{must be a constant integer from 0 to 4095}}
name|vbi
operator|=
name|vec_fp_test_data_class
argument_list|(
