...
begin_comment
comment|// RUN: %clang_cc1 -triple armv7s-apple-ios9 -emit-llvm -o - %s | FileCheck %s
end_comment

begin_comment
comment|// RUN: %clang_cc1 -triple armv7k-apple-ios9 -emit-llvm -o - %s | FileCheck %s
end_comment
...
begin_comment
comment|// CHECK:   [[RET:%.*]] = alloca [[REC:%.*]], align {{(4|8)}}
end_comment

begin_comment
comment|// CHECK:   [[VAR:%.*]] = alloca [[REC]], align {{(4|8)}}
end_comment
...
begin_comment
comment|// CHECK:   [[FIRST:%.*]] = load i32, i32* [[T0]], align {{(4|8)}}
end_comment
...
begin_comment
comment|// CHECK:   [[SECOND:%.*]] = load i32, i32* [[T0]], align {{(4|8)}}
end_comment
...
begin_comment
comment|// CHECK:   [[V:%.*]] = alloca [[REC]], align {{(4|8)}}
end_comment
...
begin_comment
comment|// CHECK:   store i32 %0, i32* [[T0]], align {{(4|8)}}
end_comment
...
begin_comment
comment|// CHECK:   store i32 %1, i32* [[T0]], align {{(4|8)}}
end_comment
...
begin_comment
comment|// CHECK:   [[TMP:%.*]] = alloca [[REC]], align {{(4|8)}}
end_comment
...
begin_comment
comment|// CHECK:   store i32 [[T1]], i32* [[T0]], align {{(4|8)}}
end_comment
...
begin_comment
comment|// CHECK-LABEL: define swiftcc { float, float } @return_struct_f2()
end_comment

begin_comment
comment|// CHECK-LABEL: define swiftcc void @take_struct_f2(float, float)
end_comment
...
begin_comment
comment|// CHECK-LABEL: define swiftcc { float, float, float } @return_struct_f3()
end_comment

begin_comment
comment|// CHECK-LABEL: define swiftcc void @take_struct_f3(float, float, float)
end_comment
...
begin_comment
comment|// CHECK-LABEL: define swiftcc { float, float, float, float } @return_struct_f4()
end_comment

begin_comment
comment|// CHECK-LABEL: define swiftcc void @take_struct_f4(float, float, float, float)
end_comment
...
begin_comment
comment|// CHECK-LABEL: define swiftcc { i32, i8 } @return_struct_c5()
end_comment

begin_comment
comment|// CHECK-LABEL: define swiftcc void @take_struct_c5(i32, i8)
end_comment
...
begin_comment
comment|// CHECK-LABEL: define swiftcc { i32, i16 } @return_struct_s3()
end_comment

begin_comment
comment|// CHECK-LABEL: define swiftcc void @take_struct_s3(i32, i16)
end_comment
...
begin_comment
comment|// CHECK-LABEL: define swiftcc { i32, i32 } @return_struct_s4()
end_comment

begin_comment
comment|// CHECK-LABEL: define swiftcc void @take_struct_s4(i32, i32)
end_comment
...
begin_comment
comment|// CHECK-LABEL: define swiftcc { i32, i32, i16 } @return_struct_s5()
end_comment

begin_comment
comment|// CHECK-LABEL: define swiftcc void @take_struct_s5(i32, i32, i16)
end_comment
...
begin_comment
comment|// CHECK-LABEL: define swiftcc { i32, i32 } @return_struct_i2()
end_comment

begin_comment
comment|// CHECK-LABEL: define swiftcc void @take_struct_i2(i32, i32)
end_comment
...
begin_comment
comment|// CHECK-LABEL: define swiftcc { i32, i32, i32 } @return_struct_i3()
end_comment

begin_comment
comment|// CHECK-LABEL: define swiftcc void @take_struct_i3(i32, i32, i32)
end_comment
...
begin_comment
comment|// CHECK-LABEL: define swiftcc { i32, i32, i32, i32 } @return_struct_i4()
end_comment

begin_comment
comment|// CHECK-LABEL: define swiftcc void @take_struct_i4(i32, i32, i32, i32)
end_comment
...
begin_comment
comment|// CHECK: define swiftcc void @return_struct_l3([[STRUCT:%.*]]* noalias sret
end_comment

begin_comment
comment|// CHECK: define swiftcc void @take_struct_l3([[STRUCT]]
end_comment
...
begin_comment
comment|// CHECK: define swiftcc void @return_struct_l4([[STRUCT:%.*]]* noalias sret
end_comment

begin_comment
comment|// CHECK: define swiftcc void @take_struct_l4([[STRUCT]]
end_comment
