...
begin_comment
comment|// RUN: %clang_cc1 -triple x86_64-pc-linux-gnux32 -DTEST_64BIT_X86 -fsyntax-only \
end_comment
...
begin_comment
comment|// expected-error{{'mode' attribute only applies to variables, enums, fields and typedefs}}
end_comment
