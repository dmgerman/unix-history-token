...
parameter_list|)
block|{
comment|// expected-error {{function definition is not allowed here}}
if|if
condition|(
name|y
operator|>
...
argument_list|)
expr_stmt|;
comment|// expected-warning {{incompatible pointer types passing 'int *' to parameter of type 'int (*)[3]'}}
name|no_decay
argument_list|(
name|ptr
argument_list|)
