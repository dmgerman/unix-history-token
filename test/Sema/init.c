...
begin_comment
comment|// RUN: %clang_cc1 %s -verify -fsyntax-only -ffreestanding
end_comment
...
begin_comment
comment|// None of these are constant initializers, but we implement GCC's old
end_comment

begin_comment
comment|// behaviour of accepting bar and zed but not foo. GCC's behaviour was
end_comment

begin_comment
comment|// changed in 2007 (rev 122551), so we should be able to change too one
end_comment
