...
argument_list|)
expr_stmt|;
comment|// expected-warning{{conversion specifies type 'unsigned char' but the argument has type 'short'}}
name|printf
argument_list|(
literal|"%hu\n"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// expected-warning{{conversion specifies type 'unsigned short' but the argument has type 'unsigned char'}}
name|printf
argument_list|(
literal|"%hu\n"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// expected-warning{{conversion specifies type 'unsigned short' but the argument has type 'uint8_t'}}
block|}
end_function
