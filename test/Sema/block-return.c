...
begin_comment
comment|// RUN: %clang_cc1 -Wno-int-to-pointer-cast -pedantic -fsyntax-only %s -verify -fblocks
end_comment
...
argument_list|)
expr_stmt|;
comment|// expected-error {{passing 'enum Test8 (^)(int)' to parameter of type 'char (^)(int)'}}
block|}
end_function
