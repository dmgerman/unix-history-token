...
begin_comment
comment|// expected-note{{previous overload of function is here}}
end_comment
...
begin_comment
comment|// Ensure we don't complain about overloadable on implicitly declared functions.
end_comment
...
begin_comment
comment|// expected-error{{redefinition of 'wg_foo' as different kind of symbol}}
end_comment
...
error|#
directive|error
literal|"We should have unmarked overload support"
end_error
...
begin_comment
comment|// expected-note 2{{previous overload}}
end_comment
...
begin_comment
comment|// expected-note{{previous unmarked overload}}
end_comment
...
begin_comment
comment|// expected-error {{must not have the 'overloadable' attribute}}
end_comment
...
begin_comment
comment|// expected-note 3{{previous unmarked overload}}
end_comment
...
begin_comment
comment|// expected-error{{at most one overload for a given name may lack the 'overloadable' attribute}}
end_comment
...
begin_comment
comment|// FIXME: It would be nice if we did better with the "previous unmarked
end_comment

begin_comment
comment|// overload" diag.
end_comment
...
begin_comment
comment|// expected-error{{must not have the 'overloadable' attribute}} expected-note{{previous declaration}} expected-note{{previous unmarked overload}}
end_comment
...
begin_comment
comment|// expected-error{{conflicting types for 'to_foo9'}}
end_comment
...
begin_comment
comment|// no "note: previous redecl" if no previous decl has `overloadable`
end_comment
