...
begin_comment
comment|// Test haystack overflow in strcasestr function
end_comment
...
begin_comment
comment|// Test intercept_strstr asan option
end_comment

begin_comment
comment|// Disable other interceptors because strlen may be called inside strcasestr
end_comment
