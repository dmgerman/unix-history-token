...
begin_comment
comment|// RUN: clang-cc -E %s | grep 'noexp: foo y'
end_comment

begin_comment
comment|// RUN: clang-cc -E %s | grep 'expand: abc'
end_comment

begin_comment
comment|// RUN: clang-cc -E %s | grep 'noexp2: foo nonexp'
end_comment

begin_comment
comment|// RUN: clang-cc -E %s | grep 'expand2: abc'
end_comment
