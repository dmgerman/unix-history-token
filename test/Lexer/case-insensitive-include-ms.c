...
begin_comment
comment|// RUN: %clang_cc1 -fsyntax-only -fms-compatibility %s -include %s -I %T -verify
end_comment

begin_comment
comment|// RUN: %clang_cc1 -fsyntax-only -fms-compatibility -fdiagnostics-parseable-fixits %s -include %s -I %T 2>&1 | FileCheck %s
end_comment
