...
begin_comment
comment|// RUN: %clang -target hexagon -### %s 2>&1 \
end_comment
...
begin_comment
comment|// RUN: %clang -target hexagon -### -mlong-calls %s 2>&1 \
end_comment
...
begin_comment
comment|// RUN: %clang -target hexagon -### -mlong-calls -mno-long-calls %s 2>&1 \
end_comment
