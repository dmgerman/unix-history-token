...
begin_comment
comment|// RUN:   -Wl,two,--no-demangle,three -Xlinker four -z five -r %s 2> %t
end_comment
...
begin_comment
comment|// DARWIN: "one" "two" "three" "four" "-z" "five" "-r"
end_comment

begin_comment
comment|// LINUX: "--no-demangle" "one" "two" "three" "four" "-z" "five" "-r"
end_comment
