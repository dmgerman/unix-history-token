...
begin_comment
comment|// RUN: touch %T/ps4-ld.exe
end_comment

begin_comment
comment|// RUN: touch %T/ps4-ld.gold.exe
end_comment
...
begin_comment
comment|// FIXME: "Output\\" is hardcoded part of %T.
end_comment

begin_comment
comment|// CHECK-PS4-GOLD: Output\\ps4-ld.gold.exe"
end_comment

begin_comment
comment|// CHECK-PS4-LINKER: Output\\ps4-ld.exe"
end_comment
