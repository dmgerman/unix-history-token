...
begin_comment
comment|// RUN: unset MACOSX_DEPLOYMENT_TARGET&&
end_comment
...
begin_comment
comment|// RUN: grep '".*dsymutil" "BAR"' %t.log&&
end_comment
