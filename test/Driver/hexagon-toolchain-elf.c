...
begin_comment
comment|// RUN: %clang -ccc-cxx -x c++ -### -target hexagon-unknown-elf     \
end_comment
...
begin_comment
comment|// RUN: %clang -march=hexagonv2 -target hexagon-unknown-elf \
end_comment
...
begin_comment
comment|// RUN: %clang -mcpu=hexagonv2  -target hexagon-unknown-elf \
end_comment
...
begin_comment
comment|// RUN: %clang -mv2             -target hexagon-unknown-elf \
end_comment
...
begin_comment
comment|// RUN: %clang -march=hexagonv3 -target hexagon-unknown-elf \
end_comment
...
begin_comment
comment|// RUN: %clang -mcpu=hexagonv3  -target hexagon-unknown-elf \
end_comment
...
begin_comment
comment|// RUN: %clang -mv3             -target hexagon-unknown-elf \
end_comment
