...
begin_comment
comment|// RUN: %llvmgcc -S %s -o - | grep atomic | count 200
end_comment
...
begin_comment
comment|// RUN: %llvmgcc -S %s -o - | grep volatile | count 8
end_comment
...
begin_comment
comment|// PPC32 does not translate the long long variants, so fails this test.
end_comment

begin_comment
comment|// XFAIL: sparc|arm|ia64|powerpc
end_comment
