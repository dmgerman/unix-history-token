...
begin_comment
comment|// This file tests __mulsc3 for the compiler_rt library.
end_comment
...
argument_list|)
decl_stmt|;
comment|//     printf("test__mulsc3(%f, %f, %f, %f) = %f + I%f\n",
comment|//             a, b, c, d, crealf(r), cimagf(r));
name|float
specifier|_Complex
name|dividend
decl_stmt|;
...
operator|)
decl_stmt|;
comment|// relaxed tolerance to arbitrary (1.e-6) amount.
if|if
condition|(
name|cabsf
argument_list|(
