...
begin_comment
comment|// RUN: %clang -target armv6-apple-darwin9 -dM -E -o %t %s
end_comment
...
begin_comment
comment|// RUN: %clang -target armv6-apple-darwin9 -miphoneos-version-min=3.0 -dM -E -o %t %s
end_comment
...
begin_comment
comment|// RUN: %clang -target armv6-apple-darwin9 -miphoneos-version-min=2.0 -dM -E -o %t %s
end_comment
...
begin_comment
comment|// RUN: %clang -target armv6-apple-darwin9 -miphoneos-version-min=2.2 -dM -E -o %t %s
end_comment
...
begin_comment
comment|// RUN: %clang -target i686-apple-darwin8 -dM -E -o %t %s
end_comment
...
begin_comment
comment|// RUN: %clang -target i686-apple-darwin9 -dM -E -o %t %s
end_comment
...
begin_comment
comment|// RUN: %clang -target i686-apple-darwin10 -dM -E -o %t %s
end_comment
...
begin_comment
comment|// RUN: %clang -target i686-apple-darwin9 -mmacosx-version-min=10.4 -dM -E -o %t %s
end_comment
...
begin_comment
comment|// RUN: %clang -target i686-apple-darwin9 -mmacosx-version-min=10.5 -dM -E -o %t %s
end_comment
...
begin_comment
comment|// RUN: %clang -target i686-apple-darwin9 -mmacosx-version-min=10.6 -dM -E -o %t %s
end_comment
