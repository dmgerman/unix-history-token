...
name|n
parameter_list|)
value|((event.bstate)& NCURSES_MOUSE_MASK(1, 037))
define|#
directive|define
name|ButtonPressed
parameter_list|(
name|n
parameter_list|)
value|((event.bstate)& NCURSES_MOUSE_MASK(1, NCURSES_BUTTON_PRESSED))
define|#
directive|define
name|ButtonDouble
parameter_list|(
name|n
parameter_list|)
value|((event.bstate)& NCURSES_MOUSE_MASK(1, NCURSES_DOUBLE_CLICKED))
define|#
directive|define
name|ButtonTriple
parameter_list|(
name|n
parameter_list|)
value|((event.bstate)& NCURSES_MOUSE_MASK(1, NCURSES_TRIPLE_CLICKED))
define|#
directive|define
name|ButtonRelease
parameter_list|(
name|n
parameter_list|)
value|((event.bstate)& NCURSES_MOUSE_MASK(1, NCURSES_BUTTON_RELEASED))
name|MEVENT
name|event
decl_stmt|;
name|int
...
directive|endif
comment|/* NCURSES_VERSION vs PDCURSES */
block|}
endif|#
directive|endif
comment|/* KEY_MOUSE */
