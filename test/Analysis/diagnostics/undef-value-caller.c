...
begin_comment
comment|// Note, in the future, we do not even need to step into this callee since it does not influence the result.
end_comment
...
begin_comment
comment|// CHECK:<string>Calling&apos;callee&apos;</string>
end_comment
...
begin_comment
comment|// CHECK:<key>line</key><integer>2</integer>
end_comment
...
begin_comment
comment|// CHECK:<key>file</key><integer>1</integer>
end_comment
...
begin_comment
comment|// CHECK:<string>Entered call from&apos;test_calling_unimportant_callee&apos;</string>
end_comment
...
begin_comment
comment|// CHECK:<string>Returning from&apos;callee&apos;</string>
end_comment
