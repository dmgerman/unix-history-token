...
argument_list|)
expr_stmt|;
comment|// If we taint element 1, we should not raise an alert on taint for element 0 or element 2
name|read
argument_list|(
name|sock
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// FIXME: overlapping regions aren't detected by isTainted yet
name|__builtin_memcpy
argument_list|(
name|buffer
argument_list|,
