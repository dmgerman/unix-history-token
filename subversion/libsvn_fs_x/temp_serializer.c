...
begin_comment
comment|/* temp_serializer.c: serialization functions for caching of FSX structures  *  * ====================================================================  *    Licensed to the Apache Software Foundation (ASF) under one  *    or more contributor license agreements.  See the NOTICE file  *    distributed with this work for additional information  *    regarding copyright ownership.  The ASF licenses this file  *    to you under the Apache License, Version 2.0 (the  *    "License"); you may not use this file except in compliance  *    with the License.  You may obtain a copy of the License at  *  *      http://www.apache.org/licenses/LICENSE-2.0  *  *    Unless required by applicable law or agreed to in writing,  *    software distributed under the License is distributed on an  *    "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY  *    KIND, either express or implied.  See the License for the  *    specific language governing permissions and limitations  *    under the License.  * ====================================================================  */
end_comment
...
begin_comment
comment|/* auxilliary structure representing the content of a directory array */
end_comment
...
begin_comment
comment|/* Utility function to serialize the ENTRIES into a new serialization  * context to be returned.  *  * Temporary allocation will be made form SCRATCH_POOL.  */
end_comment
...
begin_comment
comment|/** Caching svn_fs_x__noderev_t objects. **/
end_comment
...
begin_comment
comment|/* Utility function that returns TRUE if entry number IDX in ENTRIES has the  * name NAME.  */
end_comment
...
argument_list|)
decl_stmt|;
comment|/* Special case: Early out for empty directories.      That simplifies tests further down the road. */
operator|*
name|out
operator|=
name|NULL
...
name|SVN_NO_ERROR
return|;
comment|/* HINT _might_ be the position we hit last time.      If within valid range, check whether HINT+1 is a hit. */
if|if
condition|(
name|b
operator|->
...
expr_stmt|;
block|}
comment|/* Remember the hit index - if we FOUND the entry. */
if|if
condition|(
name|found
condition|)
...
begin_comment
comment|/* Utility function for svn_fs_x__replace_dir_entry that implements the  * modification as a simply deserialize / modify / serialize sequence.  */
end_comment
...
begin_comment
comment|/* Auxiliary structure representing the content of a svn_fs_x__change_t array.    This structure is much easier to (de-)serialize than an APR array.  */
end_comment
