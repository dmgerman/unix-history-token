...
name|dummy
decl_stmt|;
comment|/* This verifies in new_session_url is in the repository */
name|SVN_ERR
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* svnserve before 1.2 doesn't support the above, so fall back on      a far less efficient, but still correct method. */
if|if
condition|(
name|err
operator|&&
...
condition|)
block|{
comment|/* ### TODO: Find out if we can somehow move this code in libsvn_ra_svn.        */
name|apr_pool_t
modifier|*
name|scratch_pool
init|=
