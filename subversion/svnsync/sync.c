...
name|rangelist
decl_stmt|;
comment|/* split at the last colon */
name|colon
operator|=
name|strrchr
argument_list|(
...
name|_
argument_list|(
literal|"Missing colon in svn:mergeinfo "
literal|"property"
argument_list|)
argument_list|)
return|;
...
decl_stmt|;
name|svn_boolean_t
name|mergeinfo_tweaked
decl_stmt|;
comment|/* Did we tweak svn:mergeinfo? */
name|svn_boolean_t
...
name|FALSE
decl_stmt|;
comment|/* Normalize encoding to UTF-8, and EOL style to LF. */
name|SVN_ERR
argument_list|(
name|normalize_string
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* Correct malformed mergeinfo. */
if|if
condition|(
name|value
operator|&&
...
argument_list|)
expr_stmt|;
comment|/* Maybe adjust svn:mergeinfo. */
if|if
condition|(
name|value
operator|&&
...
name|pool
argument_list|,
literal|"NOTE: Adjusted Subversion mergeinfo in "
