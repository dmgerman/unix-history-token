...
decl_stmt|;
comment|/* the file contents changed */
specifier|const
name|char
modifier|*
...
block|{
comment|/* If this file was added, but apply_txdelta() was not                  called (i.e., CONTENTS_CHANGED is FALSE), then we're adding                  an empty file.  */
if|if
condition|(
name|change
operator|->
...
begin_comment
comment|/* Lazy-open handler for getting a read-only stream of the delta base. */
end_comment
...
begin_comment
comment|/* Lazy-open handler for opening a stream for the delta result. */
end_comment
