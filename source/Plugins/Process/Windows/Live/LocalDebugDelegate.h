...
name|ProcessWindowsLive
operator|>
name|ProcessWindowsLiveSP
expr_stmt|;
comment|//----------------------------------------------------------------------
comment|// LocalDebugDelegate
comment|//
comment|// LocalDebugDelegate creates a connection between a ProcessWindowsLive and the
comment|// debug driver.  This serves to decouple ProcessWindowsLive from the debug driver.
comment|// It would be possible to get a similar decoupling by just having
comment|// ProcessWindowsLive implement this interface directly.  There are two reasons why
comment|// we don't do this:
comment|//
