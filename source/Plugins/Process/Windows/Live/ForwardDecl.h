...
operator|,
comment|// Break in the debugger and give the user a chance to interact with
comment|// the program before continuing.
name|MaskException
operator|,
comment|// Eat the exception and don't let the application know it occurred.
name|SendToApplication
comment|// Send the exception to the application to be handled as if there were
