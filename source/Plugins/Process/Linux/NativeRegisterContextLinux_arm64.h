...
begin_comment
comment|//===-- NativeRegisterContextLinux_arm64.h ---------------------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|lldb_NativeRegisterContextLinux_arm64_h
end_ifndef
...
include|#
directive|include
file|"Plugins/Process/Utility/lldb-arm64-register-enums.h"
end_include
...
begin_comment
comment|// #ifndef lldb_NativeRegisterContextLinux_arm64_h
end_comment
...
begin_comment
comment|// defined (__arm64__) || defined (__aarch64__)
end_comment
