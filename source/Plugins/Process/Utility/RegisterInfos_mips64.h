...
parameter_list|)
define|\
value|LLVM_EXTENSION offsetof(FPR_mips, regname)
end_define
...
parameter_list|)
define|\
value|{ #reg, alt, sizeof(((GPR*)0)->reg), GPR_OFFSET(reg), eEncodingUint, \       eFormatHex, { kind1, kind2, kind3, kind4, gpr_##reg##_mips64 }, NULL, NULL }
end_define
...
parameter_list|)
define|\
value|{ #reg, alt, sizeof(((FPR_mips*)0)->member), FPR_OFFSET(member), eEncodingUint,   \       eFormatHex, { kind1, kind2, kind3, kind4, fpr_##reg##_mips64 }, NULL, NULL }
end_define
...
argument|NULL
argument_list|,
argument|gcc_dwarf_fir_mips64
argument_list|,
argument|gcc_dwarf_fir_mips64
argument_list|,
argument|LLDB_INVALID_REGNUM
argument_list|,
argument|gdb_fir_mips64
argument_list|)
block|}
decl_stmt|;
end_decl_stmt
