...
begin_comment
comment|//===-- PlatformRemoteDarwinDevice.h -------------------------------------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|liblldb_PlatformRemoteDarwinDevice_h_
end_ifndef
...
begin_function_decl
name|uint32_t
name|GetSDKIndexBySDKDirectoryInfo
parameter_list|(
specifier|const
name|SDKDirectoryInfo
modifier|*
...
begin_comment
comment|// liblldb_PlatformRemoteDarwinDevice_h_
end_comment
