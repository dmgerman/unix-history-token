...
begin_comment
comment|//===-- PlatformiOSSimulator.h ----------------------------------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|liblldb_PlatformiOSSimulator_h_
end_ifndef
...
include|#
directive|include
file|"PlatformAppleSimulator.h"
end_include

begin_decl_stmt
name|class
name|PlatformiOSSimulator
range|:
name|public
...
begin_comment
comment|// liblldb_PlatformiOSSimulator_h_
end_comment
