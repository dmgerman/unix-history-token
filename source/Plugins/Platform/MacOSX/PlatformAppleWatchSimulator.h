...
begin_comment
comment|//===-- PlatformAppleWatchSimulator.h ---------------------------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|liblldb_PlatformAppleWatchSimulator_h_
end_ifndef
...
begin_decl_stmt
name|class
name|PlatformAppleWatchSimulator
range|:
name|public
name|PlatformDarwin
block|{
...
begin_comment
comment|// liblldb_PlatformAppleWatchSimulator_h_
end_comment
