...
begin_comment
comment|/******************************************************************************  *  * FUNCTION:    AcpiHwLowDisableGpe  *  * PARAMETERS:  GpeEventInfo        - Info block for the GPE to be disabled  *  * RETURN:      Status  *  * DESCRIPTION: Disable a single GPE in the enable register.  *  ******************************************************************************/
end_comment
...
return|;
block|}
comment|/* Clear just the bit that corresponds to this GPE */
name|ACPI_CLEAR_BIT
argument_list|(
name|EnableMask
argument_list|,
