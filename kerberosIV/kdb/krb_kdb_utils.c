...
begin_comment
comment|/*  * $Source: /mit/kerberos/src/lib/kdb/RCS/krb_kdb_utils.c,v $  * $Author: jtkohl $  *  * Copyright 1988 by the Massachusetts Institute of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  *  * Utility routines for Kerberos programs which directly access  * the database.  This code was duplicated in too many places  * before I gathered it here.  *  * Jon Rochlis, MIT Telecom, March 1988  */
end_comment
...
specifier|static
name|char
name|rcsid_krb_kdb_utils_c
index|[]
init|=
literal|"$Header: /mit/kerberos/src/lib/kdb/RCS/krb_kdb_utils.c,v 4.1 89/07/26 11:01:12 jtkohl Exp $"
decl_stmt|;
end_decl_stmt
