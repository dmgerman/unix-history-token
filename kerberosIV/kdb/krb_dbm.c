...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/kdb/RCS/krb_dbm.c,v $  * $Author: bostic $   *  * Copyright 1988 by the Massachusetts Institute of Technology.   *  * For copying and distribution information, please see the file  *<mit-copyright.h>.   */
end_comment
...
specifier|static
name|char
name|rcsid_krb_dbm_c
index|[]
init|=
literal|"$Header: /usr/src/kerberosIV/kdb/RCS/krb_dbm.c,v 4.11 91/03/07 23:50:29 bostic Exp $"
decl_stmt|;
end_decl_stmt
