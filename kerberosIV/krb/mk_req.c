...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/mk_req.c,v $  * $Author: kfall $  *  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
name|rcsid_mk_req_c
init|=
literal|"$Header: /usr/src/kerberosIV/krb/RCS/mk_req.c,v 4.18 90/06/25 20:56:56 kfall Exp $"
decl_stmt|;
end_decl_stmt
...
directive|ifndef
name|NOENCRYPTION
comment|/* Encrypt the request ID using the session key */
name|key_sched
argument_list|(
name|cr
operator|.
