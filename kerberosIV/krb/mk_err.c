...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/mk_err.c,v $  * $Author: kfall $  *  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
name|rcsid_mk_err_c
init|=
literal|"$Header: /usr/src/kerberosIV/krb/RCS/mk_err.c,v 4.5 90/06/25 20:56:53 kfall Exp $"
decl_stmt|;
end_decl_stmt
