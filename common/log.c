...
index|[]
init|=
literal|"$Id: log.c,v 10.27 2011/07/13 06:25:50 zy Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* offset of CHAR_T string in log needs to be aligned on some systems  * because it is passed to db_set as a string  */
end_comment
...
name|sp
argument_list|,
literal|"%lu: log_line: append: %lu {%u}\n"
argument_list|,
name|ep
operator|->
name|l_cur
...
begin_comment
comment|/*  * apply_with --  *	Apply a realigned line from the log db to the file db.  */
end_comment
