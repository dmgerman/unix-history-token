...
name|f
parameter_list|)
value|(UINT8) ACPI_OFFSET (ACPI_HEST_XPF_MACHINE_CHECK,f)
end_define
...
name|f
parameter_list|)
value|(UINT8) ACPI_OFFSET (ACPI_HEST_XPF_CORRECTED,f)
end_define

begin_define
define|#
directive|define
name|ACPI_HEST3_OFFSET
parameter_list|(
name|f
parameter_list|)
value|(UINT8) ACPI_OFFSET (ACPI_HEST_XPF_NMI,f)
end_define

begin_define
define|#
directive|define
name|ACPI_HEST4_OFFSET
parameter_list|(
name|f
parameter_list|)
value|(UINT8) ACPI_OFFSET (ACPI_HEST_IPF_CORRECTED,f)
end_define

begin_define
define|#
directive|define
name|ACPI_HEST5_OFFSET
parameter_list|(
name|f
parameter_list|)
value|(UINT8) ACPI_OFFSET (ACPI_HEST_IPF_CORRECTED_PLATFORM,f)
end_define
...
argument_list|)
block|,
literal|"Uncorrectable Error Mask"
block|}
block|,
block|{
name|ACPI_DMT_UINT32
...
argument_list|)
block|,
literal|"Uncorrectable Error Severity"
block|}
block|,
block|{
name|ACPI_DMT_UINT32
...
argument_list|)
block|,
literal|"Correctable Error Mask"
block|}
block|,
block|{
name|ACPI_DMT_UINT32
...
argument_list|)
block|,
literal|"Advanced Error Capabilities"
block|}
block|,
block|{
name|ACPI_DMT_UINT32
...
argument_list|)
block|,
literal|"2nd Uncorrectable Err Mask"
block|}
block|,
block|{
name|ACPI_DMT_UINT32
...
argument_list|)
block|,
literal|"2nd Uncorrectable Err Severity"
block|}
block|,
block|{
name|ACPI_DMT_UINT32
