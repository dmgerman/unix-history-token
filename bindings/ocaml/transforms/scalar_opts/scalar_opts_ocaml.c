...
name|CAMLprim
name|value
name|llvm_add_alignment_from_assumptions
parameter_list|(
name|LLVMPassManagerRef
name|PM
parameter_list|)
...
name|CAMLprim
name|value
name|llvm_add_ind_var_simplify
parameter_list|(
name|LLVMPassManagerRef
name|PM
parameter_list|)
...
name|CAMLprim
name|value
name|llvm_add_promote_memory_to_register
parameter_list|(
name|LLVMPassManagerRef
name|PM
parameter_list|)
...
name|CAMLprim
name|value
name|llvm_add_scalar_repl_aggregates
parameter_list|(
name|LLVMPassManagerRef
name|PM
parameter_list|)
...
name|CAMLprim
name|value
name|llvm_add_scalar_repl_aggregates_ssa
parameter_list|(
name|LLVMPassManagerRef
name|PM
parameter_list|)
...
begin_comment
comment|/* int -> [<Llvm.PassManager.any] Llvm.PassManager.t -> unit */
end_comment

begin_function
name|CAMLprim
name|value
name|llvm_add_scalar_repl_aggregates_with_threshold
parameter_list|(
name|value
name|threshold
parameter_list|,
...
name|CAMLprim
name|value
name|llvm_add_simplify_lib_calls
parameter_list|(
name|LLVMPassManagerRef
name|PM
parameter_list|)
...
name|CAMLprim
name|value
name|llvm_add_demote_memory_to_register
parameter_list|(
name|LLVMPassManagerRef
name|PM
parameter_list|)
...
name|CAMLprim
name|value
name|llvm_add_scoped_no_alias_aa
parameter_list|(
name|LLVMPassManagerRef
name|PM
parameter_list|)
