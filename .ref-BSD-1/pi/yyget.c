...
begin_comment
comment|/*  * Getchar returns the next  * character from the current  * input line or -1 on end-of-file.  * It also maintains yycol for use in  * printing error messages.  */
end_comment
...
name|error
argument_list|(
literal|"Garbage after filename in include"
argument_list|)
expr_stmt|;
name|pexit
argument_list|(
...
name|error
argument_list|(
literal|"Ran out of memory (include)"
argument_list|)
expr_stmt|;
name|pexit
argument_list|(
