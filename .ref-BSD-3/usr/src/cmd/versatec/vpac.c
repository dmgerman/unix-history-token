...
begin_comment
comment|/*  * Do Versatec accounting summary.  * Currently, usage is  *	vpac user ...  * to print the usage information for the named people.  */
end_comment
...
name|h_feet
decl_stmt|;
comment|/* Feet of typesetter film */
name|int
name|h_count
decl_stmt|;
...
begin_comment
comment|/*  * Rewrite the Versatec printer summary file with the summary  * information we have accumulated.  */
end_comment
