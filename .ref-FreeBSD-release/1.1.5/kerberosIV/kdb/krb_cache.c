...
begin_comment
comment|/*  * $Source: /mit/kerberos/src/lib/kdb/RCS/krb_cache.c,v $  * $Author: jon $   *  * Copyright 1988 by the Massachusetts Institute of Technology.   *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  *  * This is where a cache would be implemented, if it were necessary.  */
end_comment
...
index|[]
init|=
literal|"$Header: krb_cache.c,v 4.5 89/01/24 18:12:34 jon Exp $"
decl_stmt|;
end_decl_stmt
