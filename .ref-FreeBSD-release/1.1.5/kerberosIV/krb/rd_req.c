...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/src/lib/krb/RCS/rd_req.c,v $  * $Author: kfall $  *  * Copyright 1985, 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  */
end_comment
...
name|rcsid_rd_req_c
init|=
literal|"$Header: /usr/src/kerberosIV/src/lib/krb/RCS/rd_req.c,v 4.17 90/05/12 00:58:48 kfall Exp $"
decl_stmt|;
end_decl_stmt
