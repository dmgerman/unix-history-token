...
begin_comment
comment|/*  * $Source: /usr/src/kerberosIV/krb/RCS/rd_err.c,v $  * $Author: kfall $  *  * Copyright 1986, 1987, 1988 by the Massachusetts Institute  * of Technology.  *  * For copying and distribution information, please see the file  *<mit-copyright.h>.  *  * This routine dissects a a Kerberos 'safe msg',  * checking its integrity, and returning a pointer to the application  * data contained and its length.  *  * Returns 0 (RD_AP_OK) for success or an error code (RD_AP_...)  *  * Steve Miller    Project Athena  MIT/DEC  */
end_comment
...
name|rcsid_rd_err_c
init|=
literal|"$Header: /usr/src/kerberosIV/krb/RCS/rd_err.c,v 4.6 90/06/25 20:57:10 kfall Exp $"
decl_stmt|;
end_decl_stmt
