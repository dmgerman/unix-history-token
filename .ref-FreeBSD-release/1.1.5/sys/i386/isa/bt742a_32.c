...
name|bt_dev
expr_stmt|;
comment|/*  	 * Forcely Bounce buffer mechanizum is ON for some broken busmaster          * chip with over 16Mbytes boundary for while...          *					amurai@spec.co.jp 94/06/16          */
name|bt
operator|->
name|sc_link
operator|.
