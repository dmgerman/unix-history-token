...
name|msgctl
operator|,
function_decl|msgget
operator|,
function_decl|msgsnd
operator|,
function_decl|msgrcv
end_function_decl
...
comment|/* Make sure that anybody who is waiting notices the deletion */
name|wakeup
argument_list|(
operator|(
name|caddr_t
...
name|printf
argument_list|(
literal|"didn't find public key\n"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
directive|endif
comment|/* The SVID says to return EIDRM. */
ifdef|#
directive|ifdef
name|EIDRM
return|return
...
argument_list|)
expr_stmt|;
comment|/* Somebody might care - we should check! */
return|return
operator|(
name|eval
operator|)
