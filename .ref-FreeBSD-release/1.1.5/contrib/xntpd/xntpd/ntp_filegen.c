...
begin_comment
comment|/*  * ntp_filegen.c,v 3.12 1994/01/25 19:06:11 kardel Exp  *  *  implements file generations support for NTP  *  logfiles and statistic files  *  *  * Copyright (c) 1992  * Rainer Pruy Friedrich-Alexander Unuiversitaet Erlangen-Nuernberg  *  * This code may be modified and used freely  * provided credits remain intact.  */
end_comment
...
begin_comment
comment|/*  * to check reason on open failure  */
end_comment
...
name|LOG_ERR
argument_list|,
literal|"expected regular file for %s (found mode 0%o)"
argument_list|,
name|basename
argument_list|,
name|stats
...
comment|/* just round time to integral 7 days period for actual year  */
name|new_gen
operator|=
name|now
operator|-
