...
begin_comment
comment|/*  * assumes:  req_key, req_keyid, conffile valid  *  syslog still open  */
end_comment
...
name|LOG_ERR
argument_list|,
literal|"request keyid %lu not found"
argument_list|,
name|req_keyid
argument_list|)
expr_stmt|;
