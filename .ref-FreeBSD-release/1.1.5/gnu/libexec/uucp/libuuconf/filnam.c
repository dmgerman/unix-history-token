...
specifier|const
name|char
name|_uuconf_filnam_rcsid
index|[]
init|=
literal|"$Id: filnam.c,v 1.4 1994/03/30 04:00:35 ian Rel $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* Return the saved file name.  */
end_comment
