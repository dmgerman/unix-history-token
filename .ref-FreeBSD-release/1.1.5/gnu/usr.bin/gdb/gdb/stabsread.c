...
literal|1
decl_stmt|;
comment|/* It might be a type attribute or a member type.  */
if|if
condition|(
name|isdigit
argument_list|(
...
block|}
block|}
comment|/* Skip the type descriptor, we get it below with (*pp)[-1].  */
operator|++
operator|(
operator|*
name|pp
...
comment|/* FIXME: according to stabs.texinfo and AIX doc, this can be a type-id      not just a type number.  */
if|if
condition|(
name|read_type_number
argument_list|(
