...
condition|)
block|{
comment|/* FIXME:  We only handle range types at the moment.  Complain and 	 create a dummy range type to use. */
name|warning
argument_list|(
literal|"internal error:  array index type must be a range type"
argument_list|)
expr_stmt|;
name|range_type
operator|=
...
literal|2
argument_list|,
literal|"[%d] name '%s' (0x%lx) length %d\n"
argument_list|,
name|method_idx
argument_list|,
...
name|spaces
argument_list|,
literal|"virtual_field_bits (%d bits at *0x%lx)"
argument_list|,
name|TYPE_N_BASECLASSES
argument_list|(
name|type
...
name|spaces
argument_list|,
literal|"private_field_bits (%d bits at *0x%lx)"
argument_list|,
name|TYPE_NFIELDS
argument_list|(
name|type
...
name|spaces
argument_list|,
literal|"protected_field_bits (%d bits at *0x%lx)"
argument_list|,
name|TYPE_NFIELDS
argument_list|(
name|type
...
literal|2
argument_list|,
literal|"[%d] bitpos %d bitsize %d type 0x%lx name '%s' (0x%lx)\n"
argument_list|,
name|idx
argument_list|,
name|TYPE_FIELD_BITPOS
