...
begin_comment
comment|/* GNU Objective-C Runtime API.    Copyright (C) 1993 Free Software Foundation, Inc.  This file is part of GNU CC.  GNU CC is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2, or (at your option) any later version.  GNU CC is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.  You should have received a copy of the GNU General Public License along with GNU CC; see the file COPYING.  If not, write to the Free Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA.  */
end_comment
...
index|]
decl_stmt|;
comment|/* Variable array of pointers.                                                   cls_def_cnt of type Class*                                                    followed by cat_def_cnt of                                                   type Category_t. */
block|}
name|Symtab
operator|,
typedef|*
...
begin_comment
comment|/* ** The class number of this class.  This must be the same for both the  ** class and it's meta class object */
end_comment
...
parameter_list|)
define|\
value|({ assert(CLS_GETNUMBER(cls)==0); \      __CLS_SETINFO(cls, (((unsigned long)num)<< (HOST_BITS_PER_LONG/2))); })
end_define
...
begin_comment
comment|/* for `method_get_argsize()' */
end_comment
...
name|ARGSIZE
return|;
comment|/* This was a magic number (96)... */
block|}
end_function
