...
name|x
parameter_list|)
value|((unsigned)(x)<= 340 ? yytranslate[x] : 304)
end_define
...
condition|)
block|{
comment|/* We set template_type_seen_before_scope to be 			 an error_mark_node so we can avoid meaningless 			 and unhelpful syntax errors later.  */
if|if
condition|(
name|yyval
operator|.
