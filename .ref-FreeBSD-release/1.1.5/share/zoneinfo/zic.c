...
name|stderr
argument_list|,
literal|"%s: usage is %s [ -s ] [ -v ] [ -l localtime ] [ -p posixrules ] [ -d directory ] \n\ \t[ -L leapseconds ] [ -y yearistype ] [ filename ... ]\n"
argument_list|,
name|progname
argument_list|,
name|progname
...
name|stderr
argument_list|,
literal|"%s: More than one -p option specified\n"
argument_list|,
name|progname
argument_list|)
expr_stmt|;
...
name|stderr
argument_list|,
literal|"%s: More than one -y option specified\n"
argument_list|,
name|progname
argument_list|)
expr_stmt|;
...
name|stderr
argument_list|,
literal|"%s: Can't link from %s to "
argument_list|,
name|progname
argument_list|,
name|fromname
...
name|stderr
argument_list|,
literal|"%s: Leap line in non leap seconds file %s\n"
argument_list|,
name|progname
argument_list|,
name|name
...
name|stderr
argument_list|,
literal|"%s: Can't create directory "
argument_list|,
name|progname
argument_list|)
expr_stmt|;
