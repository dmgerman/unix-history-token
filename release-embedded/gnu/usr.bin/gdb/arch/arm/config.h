...
begin_comment
comment|/* #define HAVE_STRUCT_REG_R_FS 1 */
end_comment
...
begin_comment
comment|/* #define HAVE_STRUCT_REG_R_GS 1 */
end_comment
...
begin_comment
comment|/* Define if<sys/link.h> has link_map32 (solaris sparc-64 target) */
end_comment

begin_comment
comment|/* #undef _SYSCALL32 */
end_comment
...
begin_comment
comment|/* Define if you have the _mcleanup function.  */
end_comment
...
begin_comment
comment|/* Define if you have the monstartup function.  */
end_comment
...
begin_comment
comment|/* Define if you have the pread64 function.  */
end_comment

begin_comment
comment|/* #undef HAVE_PREAD64 */
end_comment
...
begin_comment
comment|/* Define if you have the syscall function.  */
end_comment
...
begin_comment
comment|/* Define if you have the<libunwind-ia64.h> header file.  */
end_comment

begin_comment
comment|/* #undef HAVE_LIBUNWIND_IA64_H */
end_comment

begin_comment
comment|/* Define if you have the<libunwind.h> header file.  */
end_comment

begin_comment
comment|/* #undef HAVE_LIBUNWIND_H */
end_comment
...
begin_comment
comment|/* Define if you have the<machine/reg.h> header file.  */
end_comment
...
begin_comment
comment|/* Define to BFD's default target vector.  */
end_comment
...
begin_comment
comment|/* Define to 1 if your system has the _etext variable.  */
end_comment
...
begin_comment
comment|/* Define to 1 to avoid a clash between<widec.h> and<wchar.h> on    Solaris 2.[78] when using GCC.  */
end_comment
...
begin_comment
comment|/* Define to 1 if the regex included in libiberty should be used. */
end_comment
...
begin_comment
comment|/* Define to 1 if your system has struct reg in<machine/reg.h>. */
end_comment
...
begin_comment
comment|/* Define if<stdint.h> provides the uintptr_t type. */
end_comment
...
begin_comment
comment|/* Define if<thread_db.h> has the TD_NOTALLOC error code. */
end_comment

begin_comment
comment|/* #undef THREAD_DB_HAS_TD_NOTALLOC */
end_comment

begin_comment
comment|/* Define if we can use the tkill syscall. */
end_comment

begin_comment
comment|/* #undef HAVE_TKILL_SYSCALL */
end_comment

begin_comment
comment|/* Define to the default OS ABI for this configuration. */
end_comment

begin_comment
comment|/* #undef GDB_OSABI_DEFAULT */
end_comment

begin_comment
comment|/* Define to be a string naming the default host character set. */
end_comment
