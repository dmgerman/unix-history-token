...
name|prt
argument_list|(
literal|"%lu msync(MS_INVALIDATE)\n"
argument_list|,
name|testcalls
argument_list|)
expr_stmt|;
...
name|argv
argument_list|,
literal|"b:c:di:l:m:no:p:qr:s:t:w:D:LN:OP:RS:UW"
argument_list|)
operator|)
operator|!=
operator|-
...
name|stdout
argument_list|,
literal|"Chance of MS_INVALIDATE is 1 in %d\n"
argument_list|,
name|invlprob
argument_list|)
expr_stmt|;
