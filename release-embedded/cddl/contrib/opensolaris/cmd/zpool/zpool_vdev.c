...
expr_stmt|;
block|}
comment|/* 		 * Update the path to refer to the 's0' slice.  The presence of 		 * the 'whole_disk' field indicates to the CLI that we should 		 * chop off the slice number when displaying the device in 		 * future output. 		 */
name|verify
argument_list|(
name|nvlist_add_string
argument_list|(
