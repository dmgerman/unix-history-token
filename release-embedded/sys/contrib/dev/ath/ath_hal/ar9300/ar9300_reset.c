...
literal|0
comment|/* Get the value from the previous NF cal and update history buffer */
block|if (curchan&& (ahp->ah_chip_full_sleep != AH_TRUE)) {         ar9300_store_new_nf(ah, curchan, is_scan);     }
endif|#
directive|endif
...
name|nf_5GHz
expr_stmt|;
comment|/*      * XXX For now, don't apply the last IQ correction.      *      * This should be done when scorpion is enabled on FreeBSD; just be      * sure to fix this channel match code so it uses net80211 flags      * instead.      */
if|#
directive|if
literal|0
