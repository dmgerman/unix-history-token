...
begin_endif
unit|extern	void ar9300_Stub_InitState(struct ath_hal_5212 *, uint16_t devid, HAL_SOFTC, 		HAL_BUS_TAG st, HAL_BUS_HANDLE sh, HAL_STATUS *status);
endif|#
directive|endif
end_endif
...
begin_endif
unit|extern	void ar9300_Stub_AniAttach(struct ath_hal *, const struct ar9300_Stub_AniParams *, 		const struct ar9300_Stub_AniParams *, HAL_BOOL ena);
endif|#
directive|endif
end_endif
...
begin_endif
unit|extern	HAL_BOOL ar9300_Stub_AniSetParams(struct ath_hal *, 		const struct ar9300_Stub_AniParams *, const struct ar9300_Stub_AniParams *);
endif|#
directive|endif
end_endif
...
begin_comment
comment|/* __AR9300_STUB_FUNCS_H__ */
end_comment
