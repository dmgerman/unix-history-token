...
define|#
directive|define
name|AT_IFADDR_LOCK_INIT
parameter_list|()
value|rw_init(&at_ifaddr_rw, "at_ifaddr_rw")
end_define
...
parameter_list|()
value|rw_assert(&at_ifaddr_rw, RA_LOCKED)
end_define
