...
begin_comment
comment|/* XXX includes zfs_context.h, so why bother with the above? */
end_comment
...
begin_comment
comment|/*  * permission table  *  * Keep this table in sorted order  *  * This table is used for displaying all permissions for  * zfs allow  */
end_comment
