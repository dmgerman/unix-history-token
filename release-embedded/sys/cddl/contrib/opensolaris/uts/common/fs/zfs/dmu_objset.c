...
expr_stmt|;
block|}
comment|/* 		 * We intentionally modify the zap object even if the 		 * net delta is zero.  Otherwise 		 * the block of the zap obj could be shared between 		 * datasets but need to be different between them after 		 * a bprewrite. 		 */
name|flags
operator|=
name|dn
operator|->
...
begin_comment
comment|/*  * Find objsets under and including ddobj, call func(ds) on each.  */
end_comment
