...
begin_comment
comment|/*  * Copyright (c) 2005, 2010, Oracle and/or its affiliates. All rights reserved.  * Copyright (c) 2013 by Delphix. All rights reserved.  * Copyright (c) 2011 Nexenta Systems, Inc. All rights reserved.  */
end_comment
...
name|bp
argument_list|,
literal|"freeing in txg %llu, pass %u"
argument_list|,
operator|(
name|longlong_t
operator|)
