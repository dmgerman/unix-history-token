...
begin_comment
comment|// This file contains the MBlaze implementation of the TargetRegisterInfo
end_comment
...
comment|/// MBlazeRegisterInfo.td file.
enum|enum
name|SubregIndex
block|{
name|SUBREG_FPEVEN
