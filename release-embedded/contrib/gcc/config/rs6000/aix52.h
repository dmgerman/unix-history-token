...
begin_comment
comment|/* Definitions of target machine for GNU compiler,    for IBM RS/6000 POWER running AIX V5.2.    Copyright (C) 2002, 2003, 2004, 2005, 2006 Free Software Foundation, Inc.    Contributed by David Edelsohn (edelsohn@gnu.org).     This file is part of GCC.     GCC is free software; you can redistribute it and/or modify it    under the terms of the GNU General Public License as published    by the Free Software Foundation; either version 2, or (at your    option) any later version.     GCC is distributed in the hope that it will be useful, but WITHOUT    ANY WARRANTY; without even the implied warranty of MERCHANTABILITY    or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public    License for more details.     You should have received a copy of the GNU General Public License    along with GCC; see the file COPYING.  If not, write to the    Free Software Foundation, 51 Franklin Street, Fifth Floor, Boston,    MA 02110-1301, USA.  */
end_comment
...
name|ASM_CPU_SPEC
define|\
value|"%{!mcpu*: %{!maix64: \   %{mpowerpc64: -mppc64} \   %{!mpower64: %(asm_default)}}} \ %{mcpu=power3: -m620} \ %{mcpu=power4: -m620} \ %{mcpu=power5: -m620} \ %{mcpu=power5+: -m620} \ %{mcpu=power6: -m620} \ %{mcpu=powerpc: -mppc} \ %{mcpu=rs64a: -mppc} \ %{mcpu=603: -m603} \ %{mcpu=603e: -m603} \ %{mcpu=604: -m604} \ %{mcpu=604e: -m604} \ %{mcpu=620: -m620} \ %{mcpu=630: -m620} \ %{mcpu=970: -m620} \ %{mcpu=G5: -m620}"
end_define
...
parameter_list|()
define|\
value|do                                 \     {                                \       builtin_define ("_AIX43");     \       builtin_define ("_AIX51");     \       builtin_define ("_AIX52");     \       TARGET_OS_AIX_CPP_BUILTINS (); \     }                                \   while (0)
end_define
...
begin_comment
comment|/* The GNU C++ standard library requires that these macros be     defined.  Synchronize with libstdc++ os_defines.h.  */
end_comment
...
begin_comment
comment|/* AIX 5.2 has the float and long double forms of math functions.  */
end_comment
