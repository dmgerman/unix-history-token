...
parameter_list|()
define|\
value|do									\     {									\ 	builtin_define ("__BEOS__");					\ 	builtin_define ("__INTEL__");					\ 	builtin_define ("_X86_");					\ 	builtin_define ("__stdcall=__attribute__((__stdcall__))");	\ 	builtin_define ("__cdecl=__attribute__((__cdecl__))");		\ 	builtin_assert ("system=beos");					\     }									\   while (0)
end_define
...
begin_comment
comment|/* BeOS uses explicit import from shared libraries.  */
end_comment
