...
name|RID_AT_DEFS
block|,
comment|/* APPLE LOCAL radar 4564694 */
name|RID_AT_PACKAGE
block|,
name|RID_AT_PRIVATE
block|,
...
block|,
comment|/* APPLE LOCAL C* language */
name|RID_AT_OPTIONAL
block|,
name|RID_AT_REQUIRED
block|,
comment|/* APPLE LOCAL C* property (Radar 4436866) */
name|RID_AT_PROPERTY
block|,
name|RID_AT_IMPLEMENTATION
block|,
comment|/* APPLE LOCAL C* property (Radar 4436866, 4591909, 4621020) */
name|RID_READONLY
block|,
name|RID_GETTER
block|,
...
begin_comment
comment|/* APPLE LOCAL radar 4281748 */
end_comment
...
begin_comment
comment|/* APPLE LOCAL radar 4229905 - radar 6231433 */
end_comment
...
begin_comment
comment|/* APPLE LOCAL radar 4133425 */
end_comment
...
begin_comment
comment|/* APPLE LOCAL radar 4507230 */
end_comment
...
begin_comment
comment|/* APPLE LOCAL radar 4947311 - protocol attributes */
end_comment
...
begin_comment
comment|/* APPLE LOCAL radar 4548636 */
end_comment
...
begin_comment
comment|/* APPLE LOCAL radar 4592503 */
end_comment
...
specifier|extern
name|tree
name|build_block_object_assign_call_exp
parameter_list|(
name|tree
parameter_list|,
name|tree
...
specifier|extern
name|tree
name|build_block_object_dispose_call_exp
parameter_list|(
name|tree
parameter_list|,
name|int
...
begin_comment
comment|/* APPLE LOCAL radar 4157812 */
end_comment
...
begin_comment
comment|/* APPLE LOCAL begin 5276085 */
end_comment
...
begin_comment
comment|/* APPLE LOCAL end 5276085 */
end_comment
...
begin_comment
comment|/* APPLE LOCAL radar 5802025 */
end_comment
...
begin_comment
comment|/* APPLE LOCAL radar 4712269 */
end_comment
...
begin_comment
comment|/* APPLE LOCAL begin 4985544 */
end_comment
...
begin_comment
comment|/* APPLE LOCAL end 4985544 */
end_comment

begin_comment
comment|/* APPLE LOCAL radar 5202926 */
end_comment
...
begin_function_decl
name|bool
name|objc_check_cfstringref_type
parameter_list|(
name|tree
parameter_list|)
function_decl|;
...
operator|)
block|,
comment|/* APPLE LOCAL radar 6214617 */
...
operator|)
block|,
comment|/* APPLE LOCAL radar 7735196 */
...
block|{
name|tree
name|helper_func_decl
decl_stmt|;
name|tree
name|copy_helper_func_decl
decl_stmt|;
name|tree
name|destroy_helper_func_decl
decl_stmt|;
name|tree
name|block_arg_ptr_type
decl_stmt|;
...
decl_stmt|;
name|tree
name|block_ref_decl_list
decl_stmt|;
name|tree
name|block_byref_decl_list
decl_stmt|;
comment|/* APPLE LOCAL radar 5803600 */
name|tree
name|block_byref_global_decl_list
decl_stmt|;
name|tree
name|block_original_ref_decl_list
decl_stmt|;
comment|/* APPLE LOCAL radar 5847213 - tree block_original_byref_decl_list is removed. */
name|tree
name|block_body
decl_stmt|;
name|bool
...
comment|/* APPLE LOCAL radar 6214617 */
name|bool
name|BlockImportsCxxObjects
decl_stmt|;
comment|/* APPLE LOCAL radar 6185344 */
name|bool
name|block_has_return_type
decl_stmt|;
comment|/* When true, block has a declared return type. */
comment|/* the_scope - This is the scope for the block itself, which      contains arguments etc.  Use only for C.  */
name|struct
name|c_scope
modifier|*
name|the_scope
decl_stmt|;
comment|/* Same as the above, only for C++.  */
name|struct
name|cp_binding_level
modifier|*
name|cp_the_scope
decl_stmt|;
comment|/* return_type - This will get set to block result type, by looking      at return types, if any, in the block body. */
name|tree
name|return_type
decl_stmt|;
comment|/* prev_block_info - If this is nested inside another block, this points      to the outer block. */
name|struct
name|block_sema_info
modifier|*
name|prev_block_info
decl_stmt|;
block|}
struct|;
end_struct
...
specifier|extern
name|void
name|start_block_helper_function
parameter_list|(
name|tree
name|func_decl
parameter_list|)
...
begin_comment
comment|/* APPLE LOCAL begin radar 5803600 */
end_comment
...
begin_comment
comment|/* APPLE LOCAL end radar 5803600 */
end_comment
...
specifier|extern
name|tree
name|build_byref_local_var_access
parameter_list|(
name|tree
parameter_list|,
name|tree
...
begin_comment
comment|/* APPLE LOCAL begin radar 6237713 */
end_comment

begin_function_decl
specifier|extern
name|bool
name|any_recognized_block_attribute
parameter_list|(
name|tree
parameter_list|)
function_decl|;
...
begin_comment
comment|/* APPLE LOCAL end radar 6237713 */
end_comment
...
specifier|extern
name|tree
name|build_block_descriptor_type
parameter_list|(
name|bool
parameter_list|)
function_decl|;
...
begin_comment
comment|/* APPLE LOCAL begin radar 6083129 - byref escapes */
end_comment

begin_function_decl
specifier|extern
name|tree
name|build_block_byref_release_exp
parameter_list|(
name|tree
parameter_list|)
function_decl|;
...
begin_comment
comment|/* APPLE LOCAL end radar 6083129 - byref escapes */
end_comment

begin_comment
comment|/* APPLE LOCAL radar 6040305 - blocks */
end_comment

begin_function_decl
specifier|extern
name|tree
name|build_indirect_object_id_exp
parameter_list|(
name|tree
parameter_list|)
function_decl|;
...
begin_comment
comment|/* APPLE LOCAL begin radar 6212722 */
end_comment
...
begin_comment
comment|/* APPLE LOCAL end radar 6212722 */
end_comment

begin_comment
comment|/* APPLE LOCAL radar 6160536 */
end_comment

begin_function_decl
specifier|extern
name|tree
name|build_block_helper_name
parameter_list|(
name|int
parameter_list|)
function_decl|;
...
specifier|extern
name|tree
name|c_build_generic_block_struct_type
parameter_list|(
name|void
parameter_list|)
function_decl|;
...
begin_comment
comment|/* APPLE LOCAL radar 7760213 */
end_comment
