...
directive|define
name|GCOV_TYPE_SIZE
value|(LONG_LONG_TYPE_SIZE> 32 ? 64 : 32)
end_define
...
begin_comment
comment|/* The record tags.  Values [1..3f] are for tags which may be in either    file.  Values [41..9f] for those in the note file and [a1..ff] for    the data file.  The tag value zero is used as an explicit end of    file marker -- it is not required to be present.  */
end_comment
...
begin_comment
comment|/* The profiler functions.  */
end_comment
...
begin_comment
comment|/* The wrappers around some library functions..  */
end_comment
