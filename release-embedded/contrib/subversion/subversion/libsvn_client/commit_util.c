...
argument_list|)
decl_stmt|;
comment|/* If the path has a commit operation, we do nothing.              (It will be deleted by the operation) */
for|for
control|(
name|k
operator|=
...
condition|)
continue|continue;
comment|/* We have an explicit delete or replace for this path */
