...
literal|0
expr_stmt|;
comment|/* skip trailing zeroes for %g */
name|zpadlen
operator|++
expr_stmt|;
block|}
...
condition|)
block|{
comment|/* zpadlen contains number of trailing zeroes removed */
name|padlen
operator|=
name|min
operator|-
...
literal|1
expr_stmt|;
comment|/* add the decimal dot suppressed */
name|zpadlen
operator|=
literal|0
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|/* for %g do not output decimal point if no fraction is present */
if|if
condition|(
name|conv
operator|==
