...
modifier|...
parameter_list|)
comment|/*ATTRIBUTE_FPTR_PRINTF_2*/
function_decl|;
enum|enum
name|dis_insn_type
block|{
...
name|num_symbols
decl_stmt|;
comment|/* Symbol table provided for targets that want to look at it.  This is      used on Arm to find mapping symbols and determine Arm/Thumb code.  */
name|asymbol
modifier|*
modifier|*
name|symtab
