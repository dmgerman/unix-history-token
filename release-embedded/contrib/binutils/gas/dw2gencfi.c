...
directive|endif
operator|)
comment|/* leb128 can be handled, but does something actually need it?  */
operator|||
operator|(
name|encoding
operator|&
...
name|_
argument_list|(
literal|"invalid or unsupported encoding in .cfi_personality"
argument_list|)
argument_list|)
expr_stmt|;
name|ignore_rest_of_line
...
name|_
argument_list|(
literal|".cfi_personality requires encoding and symbol arguments"
argument_list|)
argument_list|)
expr_stmt|;
name|ignore_rest_of_line
...
name|_
argument_list|(
literal|"wrong second argument to .cfi_personality"
argument_list|)
argument_list|)
expr_stmt|;
name|ignore_rest_of_line
...
name|_
argument_list|(
literal|"invalid or unsupported encoding in .cfi_lsda"
argument_list|)
argument_list|)
expr_stmt|;
name|ignore_rest_of_line
...
name|_
argument_list|(
literal|".cfi_lsda requires encoding and symbol arguments"
argument_list|)
argument_list|)
expr_stmt|;
name|ignore_rest_of_line
...
name|_
argument_list|(
literal|"wrong second argument to .cfi_lsda"
argument_list|)
argument_list|)
expr_stmt|;
name|ignore_rest_of_line
