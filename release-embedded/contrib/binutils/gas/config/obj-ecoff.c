...
begin_comment
comment|/* ECOFF object file format.    Copyright 1993, 1994, 1995, 1996, 1998, 1999, 2000, 2001, 2002,    2005  Free Software Foundation, Inc.    Contributed by Cygnus Support.    This file was put together by Ian Lance Taylor<ian@cygnus.com>.     This file is part of GAS.     GAS is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2, or (at your option)    any later version.     GAS is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with GAS; see the file COPYING.  If not, write to the Free    Software Foundation, 51 Franklin Street - Fifth Floor, Boston, MA    02110-1301, USA.  */
end_comment
...
begin_comment
comment|/* Set section VMAs and GP values before reloc processing.  */
end_comment

begin_function
name|void
name|ecoff_frob_file_before_fix
parameter_list|(
name|void
parameter_list|)
block|{
...
parameter_list|)
define|\
value|if (hdr->count == 0) \     ecoff_data (stdoutput)->debug_info.ptr = NULL; \   else \     { \       ecoff_data (stdoutput)->debug_info.ptr = (type) set; \       set += hdr->count * size; \     }
name|SET
argument_list|(
argument|line
argument_list|,
