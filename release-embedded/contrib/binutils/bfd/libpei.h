...
value|_bfd_pex64_bfd_copy_private_bfd_data_common
end_define
...
value|_bfd_pex64_bfd_copy_private_section_data
end_define
...
value|_bfd_pex64_get_symbol_info
end_define
...
value|_bfd_pex64_print_private_bfd_data_common
end_define
...
value|_bfd_pex64i_final_link_postscript
end_define
...
value|_bfd_pex64i_only_swap_filehdr_out
end_define
...
value|_bfd_pex64i_swap_aouthdr_in
end_define
...
value|_bfd_pex64i_swap_aouthdr_out
end_define
...
value|_bfd_pex64i_swap_aux_out
end_define
...
value|_bfd_pex64i_swap_lineno_in
end_define
...
value|_bfd_pex64i_swap_lineno_out
end_define
...
value|_bfd_pex64i_swap_scnhdr_out
end_define
...
value|_bfd_pex64i_swap_sym_out
end_define
...
begin_comment
comment|/* Returns true if the target is a PE executable target.  */
end_comment
...
parameter_list|)
define|\
value|(CONST_STRNEQ ((xvec)->name, "pei-"))
end_define

begin_comment
comment|/* Return the arch string of a PE executable target.  */
end_comment
...
parameter_list|)
define|\
value|((xvec)->name + sizeof ("pei-") - 1)
end_define

begin_comment
comment|/* Returns true if the target is an EFI target.  */
end_comment
...
parameter_list|)
define|\
value|(CONST_STRNEQ ((xvec)->name, "efi-app-"))
end_define

begin_comment
comment|/* Return the arch string of an EFI target.  */
end_comment
...
parameter_list|)
define|\
value|((xvec)->name + sizeof ("efi-app-") - 1)
end_define
...
parameter_list|)
define|\
value|(bfd_target_pei_p ((abfd)->xvec)			\    || bfd_target_efi_p ((abfd)->xvec))
end_define
