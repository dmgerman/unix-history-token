...
ifndef|#
directive|ifndef
name|bfd_elfNN_get_synthetic_symtab
end_ifndef
...
name|bfd_elfNN_get_synthetic_symtab
define|\
value|_bfd_elf_get_synthetic_symtab
end_define
...
ifndef|#
directive|ifndef
name|bfd_elfNN_find_inliner_info
end_ifndef
...
directive|define
name|bfd_elfNN_find_inliner_info
value|_bfd_elf_find_inliner_info
end_define
...
directive|define
name|elf_backend_gc_mark_dynamic_ref
value|bfd_elf_gc_mark_dynamic_ref_symbol
end_define
...
ifndef|#
directive|ifndef
name|bfd_elfNN_bfd_is_group_section
end_ifndef
...
directive|define
name|bfd_elfNN_bfd_is_group_section
value|bfd_elf_is_group_section
end_define
...
ifndef|#
directive|ifndef
name|bfd_elfNN_section_already_linked
end_ifndef
...
name|bfd_elfNN_section_already_linked
define|\
value|_bfd_elf_section_already_linked
end_define
...
ifndef|#
directive|ifndef
name|bfd_elfNN_bfd_copy_private_header_data
end_ifndef
...
name|bfd_elfNN_bfd_copy_private_header_data
define|\
value|_bfd_elf_copy_private_header_data
end_define
...
ifndef|#
directive|ifndef
name|bfd_elfNN_bfd_is_target_special_symbol
end_ifndef
...
begin_comment
comment|/* Note that we set the SEC_IN_MEMORY flag for these sections.  */
end_comment
...
name|ELF_DYNAMIC_SEC_FLAGS
define|\
value|(SEC_ALLOC | SEC_LOAD | SEC_HAS_CONTENTS	\    | SEC_IN_MEMORY | SEC_LINKER_CREATED)
end_define
...
directive|define
name|elf_backend_archive_symbol_lookup
value|_bfd_elf_archive_symbol_lookup
end_define
...
directive|define
name|elf_backend_section_from_shdr
value|_bfd_elf_make_section_from_shdr
end_define
...
directive|define
name|elf_backend_get_sec_type_attr
value|_bfd_elf_get_sec_type_attr
end_define
...
directive|define
name|elf_backend_section_from_phdr
value|_bfd_elf_make_section_from_phdr
end_define
...
directive|define
name|elf_backend_omit_section_dynsym
value|_bfd_elf_link_omit_section_dynsym
end_define
...
directive|define
name|elf_backend_relocs_compatible
value|_bfd_elf_default_relocs_compatible
end_define
...
name|elf_backend_init_index_section
define|\
value|((void (*) (bfd *, struct bfd_link_info *)) bfd_void)
end_define
...
directive|define
name|elf_backend_emit_relocs
value|_bfd_elf_link_output_relocs
end_define
...
directive|define
name|elf_backend_action_discarded
value|_bfd_elf_default_action_discarded
end_define
...
directive|define
name|elf_backend_eh_frame_address_size
value|_bfd_elf_eh_frame_address_size
end_define
...
directive|define
name|elf_backend_link_order_error_handler
value|_bfd_default_error_handler
end_define
...
directive|define
name|elf_backend_common_definition
value|_bfd_elf_common_definition
end_define
...
ifndef|#
directive|ifndef
name|elf_backend_common_section_index
end_ifndef
...
directive|define
name|elf_backend_common_section_index
value|_bfd_elf_common_section_index
end_define
...
ifndef|#
directive|ifndef
name|elf_backend_common_section
end_ifndef
...
directive|define
name|elf_backend_is_function_type
value|_bfd_elf_is_function_type
end_define
...
name|ELF_COMMONPAGESIZE
block|,
comment|/* commonpagesize */
name|ELF_DYNAMIC_SEC_FLAGS
block|,
comment|/* dynamic_sec_flags */
name|elf_info_to_howto
block|,
name|elf_info_to_howto_rel
block|,
