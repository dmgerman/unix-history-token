...
begin_comment
comment|/* objdump.c -- dump information about an object file.    Copyright 1990, 1991, 1992, 1993, 1994, 1995, 1996, 1997, 1998, 1999,    2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007    Free Software Foundation, Inc.     This file is part of GNU Binutils.     This program is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2, or (at your option)    any later version.     This program is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with this program; if not, write to the Free Software    Foundation, 51 Franklin Street - Fifth Floor, Boston, MA 02110-1301, USA.  */
end_comment
...
begin_comment
comment|/* The synthetic symbol table.  */
end_comment
...
argument_list|)
decl_stmt|;
comment|/* Ignore linker created section.  See elfNN_ia64_object_p in      bfd/elfxx-ia64.c.  */
if|if
condition|(
name|section
operator|->
...
condition|)
break|break;
comment|/* Remember this symbol and keep searching until we reach 		 an earlier address.  */
name|newplace
operator|=
name|i
expr_stmt|;
...
name|NULL
decl_stmt|;
comment|/* Initialize to avoid compiler warning.  */
name|bfd_boolean
name|skip_find
init|=
name|FALSE
...
name|sym_ptr_ptr
expr_stmt|;
comment|/* Adjust the vma to the reloc.  */
name|vma
operator|+=
name|bfd_asymbol_value
argument_list|(
...
begin_comment
comment|/* Determine if the given address has a symbol associated with it.  */
end_comment
...
begin_comment
comment|/* Read a complete file into memory. */
end_comment
...
define|#
directive|define
name|line_map_decrease
value|5
end_define

begin_comment
comment|/* Precompute array of lines for a mapped file. */
end_comment
...
literal|45
decl_stmt|;
comment|/* First iteration will use 40.  */
name|unsigned
name|int
name|lineno
decl_stmt|;
...
begin_comment
comment|/* Print a source file line.  */
end_comment
...
begin_comment
comment|/* Print a range of source code lines. */
end_comment
...
define|#
directive|define
name|DEFAULT_SKIP_ZEROES_AT_END
value|3
end_define
...
decl_stmt|;
name|int
name|previous_octets
decl_stmt|;
comment|/* Remember the length of the previous instruction.  */
name|previous_octets
operator|=
name|octets
expr_stmt|;
...
name|char
modifier|*
name|mach_o_dwarf_sections
index|[]
init|=
block|{
literal|"LC_SEGMENT.__DWARFA.__debug_abbrev"
block|,
comment|/* .debug_abbrev */
literal|"LC_SEGMENT.__DWARFA.__debug_aranges"
block|,
comment|/* .debug_aranges */
literal|"LC_SEGMENT.__DWARFA.__debug_frame"
block|,
comment|/* .debug_frame */
literal|"LC_SEGMENT.__DWARFA.__debug_info"
block|,
comment|/* .debug_info */
literal|"LC_SEGMENT.__DWARFA.__debug_line"
block|,
comment|/* .debug_line */
literal|"LC_SEGMENT.__DWARFA.__debug_pubnames"
block|,
comment|/* .debug_pubnames */
literal|".eh_frame"
block|,
comment|/* .eh_frame */
literal|"LC_SEGMENT.__DWARFA.__debug_macinfo"
block|,
comment|/* .debug_macinfo */
literal|"LC_SEGMENT.__DWARFA.__debug_str"
block|,
comment|/* .debug_str */
literal|"LC_SEGMENT.__DWARFA.__debug_loc"
block|,
comment|/* .debug_loc */
literal|"LC_SEGMENT.__DWARFA.__debug_pubtypes"
block|,
comment|/* .debug_pubtypes */
literal|"LC_SEGMENT.__DWARFA.__debug_ranges"
block|,
comment|/* .debug_ranges */
literal|"LC_SEGMENT.__DWARFA.__debug_static_func"
block|,
comment|/* .debug_static_func */
literal|"LC_SEGMENT.__DWARFA.__debug_static_vars"
block|,
comment|/* .debug_static_vars */
literal|"LC_SEGMENT.__DWARFA.__debug_types"
block|,
comment|/* .debug_types */
literal|"LC_SEGMENT.__DWARFA.__debug_weaknames"
comment|/* .debug_weaknames */
block|}
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* Dump the dwarf debugging information.  */
end_comment
...
operator|)
expr_stmt|;
comment|/* FIXME: bfd_get_arch_size may return -1.  We assume that 64bit      targets will return 64.  */
name|eh_addr_size
operator|=
name|bfd_get_arch_size
argument_list|(
...
name|_
argument_list|(
literal|"no information for symbol number %ld\n"
argument_list|)
argument_list|,
name|count
argument_list|)
...
name|_
argument_list|(
literal|"could not determine the type of symbol number %ld\n"
argument_list|)
argument_list|,
name|count
argument_list|)
...
operator|||
operator|!
name|bfd_is_target_special_symbol
argument_list|(
name|cur_bfd
argument_list|,
operator|*
...
name|argv
argument_list|,
literal|"pib:m:M:VvCdDlfaHhrRtTxsSI:j:wE:zgeGW"
argument_list|,
name|long_options
argument_list|,
operator|(
