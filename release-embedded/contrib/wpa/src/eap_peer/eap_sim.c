...
begin_comment
comment|/*  * EAP peer method: EAP-SIM (RFC 4186)  * Copyright (c) 2004-2012, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-SIM: forgetting old pseudonym"
argument_list|)
expr_stmt|;
name|os_free
argument_list|(
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-SIM: forgetting old reauth_id"
argument_list|)
expr_stmt|;
name|os_free
argument_list|(
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-SIM: forgetting old eap_id"
argument_list|)
expr_stmt|;
name|os_free
argument_list|(
...
name|MSG_DEBUG
argument_list|,
literal|"EAP-SIM: Send Client-Error (error code %d)"
argument_list|,
name|err
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/* Old reauthentication identity must not be used anymore. In 	 * other words, if no new reauth identity is received, full 	 * authentication will be used on next reauthentication (using 	 * pseudonym identity or permanent identity). */
name|eap_sim_clear_identities
argument_list|(
name|sm
argument_list|,
