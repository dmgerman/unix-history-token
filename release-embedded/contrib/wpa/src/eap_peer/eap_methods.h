...
begin_comment
comment|/*  * EAP peer: Method registration  * Copyright (c) 2004-2007, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
begin_comment
comment|/* EAP peer method registration calls for statically linked in methods */
end_comment
