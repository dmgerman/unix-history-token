...
begin_comment
comment|/*  * ndis_events - Receive NdisMIndicateStatus() events using WMI  * Copyright (c) 2004-2006, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
