...
begin_comment
comment|/*  * hostapd / RADIUS Accounting  * Copyright (c) 2002-2009, 2012, Jouni Malinen<j@w1.fi>  *  * This software may be distributed under the terms of the BSD license.  * See README for more details.  */
end_comment
...
condition|)
block|{
comment|/* Use 802.1X identity if available */
name|val
operator|=
...
argument_list|)
expr_stmt|;
comment|/* Use RADIUS ACL identity if 802.1X provides no identity */
if|if
condition|(
operator|!
name|val
...
expr_stmt|;
block|}
comment|/* Use STA MAC if neither 802.1X nor RADIUS ACL provided 		 * identity */
if|if
condition|(
operator|!
name|val
...
name|MSG_ERROR
argument_list|,
literal|"Could not add CUI from ACL"
argument_list|)
expr_stmt|;
goto|goto
name|fail
...
begin_comment
comment|/**  * accounting_sta_start - Start STA accounting  * @hapd: hostapd BSS data  * @sta: The station  */
end_comment
...
argument_list|,
literal|"starting accounting session %08X-%08X"
argument_list|,
name|sta
operator|->
name|acct_session_id_hi
...
begin_comment
comment|/**  * accounting_sta_interim - Send a interim STA accounting report  * @hapd: hostapd BSS data  * @sta: The station  */
end_comment
...
begin_comment
comment|/**  * accounting_sta_stop - Stop STA accounting  * @hapd: hostapd BSS data  * @sta: The station  */
end_comment
...
name|HOSTAPD_LEVEL_INFO
argument_list|,
literal|"stopped accounting session %08X-%08X"
argument_list|,
name|sta
operator|->
name|acct_session_id_hi
...
begin_comment
comment|/**  * accounting_receive - Process the RADIUS frames from Accounting Server  * @msg: RADIUS response message  * @req: RADIUS request message  * @shared_secret: RADIUS shared secret  * @shared_secret_len: Length of shared_secret in octets  * @data: Context data (struct hostapd_data *)  * Returns: Processing status  */
end_comment
...
begin_comment
comment|/**  * accounting_init: Initialize accounting  * @hapd: hostapd BSS data  * Returns: 0 on success, -1 on failure  */
end_comment
