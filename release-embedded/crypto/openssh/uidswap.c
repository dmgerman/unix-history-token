...
name|fatal
argument_list|(
literal|"permanently_set_uid: no user given"
argument_list|)
expr_stmt|;
if|if
condition|(
...
directive|ifdef
name|__APPLE__
comment|/* 	 * OS X requires initgroups after setgid to opt back into 	 * memberd support for>16 supplemental groups. 	 */
if|if
condition|(
name|initgroups
argument_list|(
...
name|fatal
argument_list|(
literal|"initgroups %.100s %u: %.100s"
argument_list|,
name|pw
operator|->
name|pw_name
