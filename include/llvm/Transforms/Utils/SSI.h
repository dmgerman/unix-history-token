...
name|created
block|;
comment|// These variables are only live for each creation
name|unsigned
name|num_values
block|;
comment|// Has a bit for each variable, true if it needs to be created
comment|// and false otherwise
name|BitVector
name|needConstruction
block|;
