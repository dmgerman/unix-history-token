...
ifndef|#
directive|ifndef
name|LLVM_TRANSFORMS_UTILS_INLINECOST_H
end_ifndef
...
block|}
struct|;
comment|// FunctionInfo - For each function, calculate the size of it in blocks and
...
argument_list|)
block|{}
comment|/// analyzeFunction - Fill in the current structure with information
comment|/// gleaned from the specified function.
name|void
