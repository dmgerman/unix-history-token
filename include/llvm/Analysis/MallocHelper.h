...
comment|///  1. a constant not equal to the size of the malloced type
comment|/// or
comment|///  2. the result of a multiplication by the size of the malloced type
...
parameter_list|)
function_decl|;
comment|/// getMallocArraySize - Returns the array size of a malloc call.  For array
comment|/// mallocs, the size is computated in 1 of 3 ways:
comment|///  1. If the element type is of size 1, then array size is the argument to
comment|///     malloc.
...
comment|/// For non-array mallocs, the computed size is constant 1.
comment|/// This function returns NULL for all mallocs whose array size cannot be
comment|/// determined.
name|Value
modifier|*
