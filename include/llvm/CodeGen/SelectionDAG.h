...
comment|/// instead the info is kept off to the side in this structure.  SDNodes may
comment|/// have an associated dbg_value entry in DbgValMap.  Debug info that is not
comment|/// associated with any SDNode is held in DbgConstMap.  It is possible for
comment|/// optimizations to change a variable to a constant, in which case the
comment|/// corresponding debug info is moved from the variable to the constant table
comment|/// (NYI).
name|class
name|SDDbgInfo
block|{
...
expr_stmt|;
block|}
comment|// No need to remove a constant.
name|void
name|clear
parameter_list|()
block|{
...
decl|const
decl_stmt|;
comment|/// AssignDbgInfo - Assign debug info to the SDNode.
name|void
name|AssignDbgInfo
parameter_list|(
name|SDNode
...
parameter_list|)
function_decl|;
comment|/// RememberDbgInfo - Remember debug info with no associated SDNode.
name|void
name|RememberDbgInfo
parameter_list|(
name|SDDbgValue
modifier|*
name|db
parameter_list|)
function_decl|;
comment|/// GetDbgInfo - Get the debug info for the SDNode.
name|SDDbgValue
modifier|*
name|GetDbgInfo
parameter_list|(
