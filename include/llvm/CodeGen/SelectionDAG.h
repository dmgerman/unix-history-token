...
comment|/// CSE with existing nodes with a duplicate is requested.
name|FoldingSet
operator|<
name|SDNode
operator|>
...
comment|/// result and takes a list of operands.
name|SDValue
...
parameter_list|)
function_decl|;
comment|/// getCall - Create a CALL node from the given information.
comment|///
name|SDValue
name|getCall
parameter_list|(
...
parameter_list|)
function_decl|;
comment|/// getMemOperand - Construct a node to track a memory reference
comment|/// through the backend.
name|SDValue
name|getMemOperand
parameter_list|(
specifier|const
...
parameter_list|)
function_decl|;
comment|/// getTargetNode - These are used for target selectors to create a new node
comment|/// with specified return type(s), target opcode, and operands.
comment|///
comment|/// Note that getTargetNode returns the resultant node.  If there is already a
comment|/// node of the specified opcode and operands, it returns that node instead of
