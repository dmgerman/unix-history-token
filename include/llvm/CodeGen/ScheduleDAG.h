...
begin_comment
unit|}
comment|/// setDepthToAtLeast - If NewDepth is greater than this node's depth
end_comment

begin_comment
comment|/// value, set it to be the new depth value. This also recursively
end_comment

begin_comment
comment|/// marks successor nodes dirty.
end_comment
...
begin_comment
comment|/// value, set it to be the new height value. This also recursively
end_comment

begin_comment
comment|/// marks predecessor nodes dirty.
end_comment
