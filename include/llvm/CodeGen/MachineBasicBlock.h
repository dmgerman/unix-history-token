...
condition|)
empty_stmt|;
do|return *this;     }     bundle_iterator&operator++(
block|)
block|{
...
condition|)
empty_stmt|;
do|return *this;     }     bundle_iterator operator--(int
block|)
block|{
...
condition|)
empty_stmt|;
do|return tmp;     }     bundle_iterator operator++(int
block|)
block|{
...
condition|)
empty_stmt|;
do|return tmp;     }      IterTy getInstrIterator(
block|)
specifier|const
block|{
return|return
