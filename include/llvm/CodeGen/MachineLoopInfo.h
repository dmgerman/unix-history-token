...
name|llvm
block|{
comment|// Provide overrides for Loop methods that don't make sense for machine loops.
name|template
operator|<
operator|>
specifier|inline
...
literal|0
operator|&&
literal|"getCanonicalInductionVariable not supported for machine loops!"
argument_list|)
block|;
return|return
literal|0
...
literal|0
operator|&&
literal|"getCanonicalInductionVariableIncrement not supported for machine loops!"
argument_list|)
block|;
return|return
literal|0
...
literal|0
operator|&&
literal|"isLoopInvariant not supported for machine loops!"
argument_list|)
block|;
return|return
name|false
...
literal|0
operator|&&
literal|"getTripCount not supported for machine loops!"
argument_list|)
block|;
return|return
literal|0
...
literal|0
operator|&&
literal|"isLCSSAForm not supported for machine loops"
argument_list|)
block|;
return|return
name|false
