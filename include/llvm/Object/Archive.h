...
name|child
argument_list|(
argument|Child(nullptr, nullptr)
argument_list|)
block|{}
name|child_iterator
argument_list|(
...
specifier|const
block|{
comment|// We know that the symbol table is not an external file,
comment|// so we just assert there is no error.
return|return
operator|*
name|SymbolTable
operator|->
