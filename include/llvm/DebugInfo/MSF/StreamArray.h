...
begin_comment
comment|//===- StreamArray.h - Array backed by an arbitrary stream ------*- C++ -*-===//
end_comment
...
ifndef|#
directive|ifndef
name|LLVM_DEBUGINFO_MSF_STREAMARRAY_H
end_ifndef
...
comment|/// extraction logic.  On input it receives a StreamRef pointing to the
...
comment|/// a VarStreamArray, no matter how large it may be.
comment|///
comment|/// You create a VarStreamArray by specifying a ValueType and an Extractor type.
comment|/// If you do not specify an Extractor type, it expects you to specialize
...
begin_comment
comment|// LLVM_DEBUGINFO_MSF_STREAMARRAY_H
end_comment
