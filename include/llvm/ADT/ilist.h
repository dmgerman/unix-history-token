...
name|ilist_node
block|;
comment|/// Traits with an embedded ilist_node as a sentinel.
comment|///
comment|/// FIXME: The downcast in createSentinel() is UB.
name|template
operator|<
name|typename
name|NodeTy
...
block|{
comment|/// Get hold of the node that marks the end of the list.
name|NodeTy
operator|*
name|createSentinel
argument_list|()
...
block|; }
block|;
comment|/// Trait with an embedded ilist_half_node as a sentinel.
comment|///
comment|/// FIXME: The downcast in createSentinel() is UB.
name|template
operator|<
...
specifier|const
block|{
comment|// See comment in ilist_embedded_sentinel_traits::createSentinel().
return|return
name|static_cast
operator|<
name|NodeTy
...
block|;
comment|//===----------------------------------------------------------------------===//
comment|// Iterator for intrusive list.
comment|//
name|template
operator|<
name|typename
...
argument_list|)
block|{
comment|// The list is empty, vacuously sorted.
if|if
condition|(
name|empty
argument_list|()
...
begin_comment
comment|// The list has a single element, vacuously sorted.
end_comment
...
begin_comment
comment|// Find the split point for the list.
end_comment
...
begin_comment
comment|// Split the list into two.
end_comment
...
begin_comment
comment|// Merge the two sublists back together.
end_comment
