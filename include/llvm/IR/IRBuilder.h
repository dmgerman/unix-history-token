...
comment|/// Masked intrinsic has only one overloaded type - data type.
name|CallInst
modifier|*
...
begin_comment
comment|/// minimally folded constants.  The third template argument allows clients to
end_comment
...
name|Insert
argument_list|(
argument|new AtomicCmpXchgInst(Ptr, Cmp, New, SuccessOrdering,                                         FailureOrdering, SynchScope)
argument_list|)
return|;
block|}
end_function
