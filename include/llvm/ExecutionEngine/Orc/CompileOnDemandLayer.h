...
begin_comment
unit|}
comment|// If this module doesn't contain any globals or aliases we can bail out
end_comment

begin_comment
comment|// early and avoid the overhead of creating and managing an empty globals
end_comment
