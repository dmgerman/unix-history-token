...
index|]
decl_stmt|;
comment|/// IndexedModeActions - For each indexed mode and each value type, keep a
comment|/// pair of LegalizeAction that indicates how instruction selection should
comment|/// deal with the load / store.
name|uint64_t
name|IndexedModeActions
index|[
literal|2
