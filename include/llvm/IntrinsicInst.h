...
begin_comment
comment|/// DbgStopPointInst - This represents the llvm.dbg.stoppoint instruction.
end_comment
...
name|classof
argument_list|(
argument|const DbgStopPointInst *
argument_list|)
block|{
return|return
name|true
...
expr|}
block|;
comment|/// DbgFuncStartInst - This represents the llvm.dbg.func.start instruction.
comment|///
block|struct
...
name|classof
argument_list|(
argument|const DbgFuncStartInst *
argument_list|)
block|{
return|return
name|true
...
expr|}
block|;
comment|/// DbgRegionStartInst - This represents the llvm.dbg.region.start
comment|/// instruction.
block|struct
...
name|classof
argument_list|(
argument|const DbgRegionStartInst *
argument_list|)
block|{
return|return
name|true
...
expr|}
block|;
comment|/// DbgRegionEndInst - This represents the llvm.dbg.region.end instruction.
comment|///
block|struct
...
name|classof
argument_list|(
argument|const DbgRegionEndInst *
argument_list|)
block|{
return|return
name|true
