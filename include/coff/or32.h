...
begin_comment
comment|/* Magic numbers for OpenRISC 1000. As it is know we use the    numbers for Am29000.     (AT&T will assign the "real" magic number).  */
end_comment
...
name|x
parameter_list|)
value|(((x).f_magic!=OR32_MAGIC_BIG)&& \ 			                      ((x).f_magic!=OR32_MAGIC_LITTLE))
end_define
...
begin_comment
comment|/* Relocation types for the OpenRISC 1000: */
end_comment
