...
begin_comment
comment|/*  * Note: PM8916 GPIO1 and GPIO2 are supporting  * only L2(1.15V) and L5(1.8V) options  */
end_comment

begin_define
define|#
directive|define
name|PM8916_GPIO_VPH
value|0
end_define
...
define|#
directive|define
name|PM8916_GPIO1_BAT_ALRM_OUT
value|PMIC_GPIO_FUNC_FUNC1
end_define
