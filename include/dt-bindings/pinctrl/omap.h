...
define|#
directive|define
name|OMAP4_CORE_IOPAD
parameter_list|(
name|pa
parameter_list|,
name|val
parameter_list|)
value|OMAP_IOPAD_OFFSET((pa), 0x0040) (val)
end_define

begin_define
define|#
directive|define
name|OMAP4_WKUP_IOPAD
parameter_list|(
name|pa
parameter_list|,
name|val
parameter_list|)
value|OMAP_IOPAD_OFFSET((pa), 0xe040) (val)
end_define
...
define|#
directive|define
name|OMAP5_CORE_IOPAD
parameter_list|(
name|pa
parameter_list|,
name|val
parameter_list|)
value|OMAP_IOPAD_OFFSET((pa), 0x2840) (val)
end_define

begin_define
define|#
directive|define
name|OMAP5_WKUP_IOPAD
parameter_list|(
name|pa
parameter_list|,
name|val
parameter_list|)
value|OMAP_IOPAD_OFFSET((pa), 0xc840) (val)
end_define
