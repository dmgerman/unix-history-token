...
decl|const
decl_stmt|;
comment|/// Returns a "simplified" SVal bound to the location 'LV' in the state's
comment|/// store.  A simplified SVal will include optimizations such as
comment|/// if the SVal is a symbol whose value is perfectly constrained then that
comment|/// constant value is returned instead.
name|SVal
name|getSimplifiedSVal
argument_list|(
name|Loc
name|LV
argument_list|,
...
name|private
label|:
comment|/// Eng - The GRSubEngine that owns this state manager.
name|GRSubEngine
modifier|&
name|Eng
decl_stmt|;
