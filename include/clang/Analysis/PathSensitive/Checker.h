...
argument_list|()
expr_stmt|;
comment|// FIXME: This were added to support CallAndMessageChecker to indicating
comment|// to GRExprEngine to "stop evaluating" a message expression under certain
comment|// cases.  This is *not* meant to be a permanent API change, and was added
comment|// to aid in the transition of removing logic for checks from GRExprEngine.
name|void
name|setDoneEvaluating
parameter_list|()
block|{
name|DoneEvaluating
operator|=
