...
name|Expr
argument_list|(
argument|CXXBindReferenceExprClass
argument_list|,
argument|Empty
argument_list|)
block|{ }
...
name|CXXConstructExpr
argument_list|(
argument|CXXTemporaryObjectExprClass
argument_list|,
argument|Empty
argument_list|)
block|{ }
...
block|}
name|void
name|setFirstQualifierFoundInScope
argument_list|(
