...
expr_stmt|;
block|}
comment|/// setExit - Set the exit block of the CFG.  This is typically used
comment|///  only during CFG construction.  Most CFG clients expect that the
comment|///  exit block has no successors and contains no statements.
name|void
...
name|BlkExprMap
decl_stmt|;
comment|/// Alloc - An internal allocator.
name|llvm
operator|::
name|BumpPtrAllocator
name|Alloc
