...
begin_comment
comment|//===--- DataRecursiveASTVisitor.h - Data-Recursive AST Visitor -*- C++ -*-===//
end_comment
...
begin_comment
comment|//  This file defines the DataRecursiveASTVisitor interface, which recursively
end_comment

begin_comment
comment|//  traverses the entire AST, using data recursion for Stmts/Exprs.
end_comment
...
ifndef|#
directive|ifndef
name|LLVM_CLANG_AST_DATARECURSIVEASTVISITOR_H
end_ifndef
...
name|clang
block|{
comment|// Reduce the diff between RecursiveASTVisitor / DataRecursiveASTVisitor to
comment|// make it easier to track changes and keep the two in sync.
define|#
directive|define
name|RecursiveASTVisitor
value|DataRecursiveASTVisitor
...
comment|// eventually.
comment|// FIXME: This is incorrect; there is no other node for an explicit
comment|// instantiation of a function template specialization.
case|case
name|TSK_ExplicitInstantiationDeclaration
case|:
case|case
