...
name|clang
block|{
comment|// Bernstein hash function:
comment|// This is basically copy-and-paste from StringMap.  This likely won't
comment|// stay here, which is why I didn't both to expose this function from
comment|// String Map.
specifier|inline
name|unsigned
name|BernsteinHash
