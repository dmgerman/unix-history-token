...
parameter_list|)
function_decl|;
comment|/// InsertTextBefore - Insert some text before the specified point,
comment|/// where the offset in the buffer is specified relative to the original
comment|/// SourceBuffer.
comment|///
name|void
...
comment|/// InsertText - Insert some text at the specified point, where the offset in
comment|/// the buffer is specified relative to the original SourceBuffer.  The
comment|/// text is inserted after the specified location.  This is method is the
comment|/// same as InsertText with "InsertAfter == false".
name|void
