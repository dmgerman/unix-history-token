...
begin_comment
comment|/* Opcode table header for m680[01234]0/m6888[12]/m68851.    Copyright 1989, 1991, 1992, 1993, 1994, 1995, 1996, 1997, 1999, 2001,    2003 Free Software Foundation, Inc.     This file is part of GDB, GAS, and the GNU binutils.     GDB, GAS, and the GNU binutils are free software; you can redistribute    them and/or modify them under the terms of the GNU General Public    License as published by the Free Software Foundation; either version    1, or (at your option) any later version.     GDB, GAS, and the GNU binutils are distributed in the hope that they    will be useful, but WITHOUT ANY WARRANTY; without even the implied    warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See    the GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with this file; see the file COPYING.  If not, write to the Free    Software Foundation, 59 Temple Place - Suite 330, Boston, MA    02111-1307, USA.  */
end_comment

begin_comment
comment|/* These are used as bit flags for the arch field in the m68k_opcode    structure.  */
end_comment
...
begin_comment
comment|/* Similar enough to -m68030 to ignore differences; 			   gas will deal with the few differences.  */
end_comment
...
directive|define
name|mcf
value|(mcf5200 | mcf5206e | mcf528x | mcf5307 | mcf5407 | mcfv4e)
end_define
...
directive|define
name|mcf5206eup
value|(mcf5206e | mcf528x | mcf5307 | mcf5407 | mcfv4e)
end_define
...
directive|define
name|mfloat
value|(m68881 | m68882 | m68040 | m68060)
end_define
...
directive|define
name|mmmu
value|(m68851 | m68030 | m68040 | m68060)
end_define

begin_comment
comment|/* The structure used to hold information for an opcode.  */
end_comment
...
name|name
decl_stmt|;
comment|/* The opcode itself.  */
name|unsigned
name|long
name|opcode
decl_stmt|;
comment|/* The mask used by the disassembler.  */
name|unsigned
name|long
name|match
decl_stmt|;
...
name|args
decl_stmt|;
comment|/* The architectures which support this opcode.  */
name|unsigned
name|int
name|arch
decl_stmt|;
...
begin_comment
comment|/* The structure used to hold information for an opcode alias.  */
end_comment
...
name|alias
decl_stmt|;
comment|/* The instruction for which this is an alias.  */
specifier|const
name|char
modifier|*
name|primary
