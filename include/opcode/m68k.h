...
begin_comment
comment|/* ColdFire hardware divide.  */
end_comment
...
begin_comment
comment|/* ColdFire USP instructions.  */
end_comment
...
name|name
decl_stmt|;
comment|/* The pseudo-size of the instruction(in bytes).  Used to determine      number of bytes necessary to disassemble the instruction.  */
name|unsigned
name|int
name|size
decl_stmt|;
