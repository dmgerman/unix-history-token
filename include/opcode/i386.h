...
begin_comment
comment|/* opcode/i386.h -- Intel 80386 opcode table    Copyright 1989, 1991, 1992, 1993, 1994, 1995, 1996, 1997, 1998, 1999,    2000, 2001, 2002, 2003, 2004, 2005    Free Software Foundation, Inc.     This file is part of GAS, the GNU Assembler, and GDB, the GNU Debugger.     This program is free software; you can redistribute it and/or modify    it under the terms of the GNU General Public License as published by    the Free Software Foundation; either version 2 of the License, or    (at your option) any later version.     This program is distributed in the hope that it will be useful,    but WITHOUT ANY WARRANTY; without even the implied warranty of    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the    GNU General Public License for more details.     You should have received a copy of the GNU General Public License    along with this program; if not, write to the Free Software    Foundation, Inc., 51 Franklin Street - Fifth Floor, Boston, MA 02110-1301, USA.  */
end_comment
...
name|MOV_AX_DISP32
value|0xa0
comment|/* We put the 64bit displacement first and we only mark constants    larger than 32bit as Disp64.  */
block|{
literal|"mov"
block|,
literal|2
...
block|}
block|,
comment|/* In the 64bit mode the short form mov immediate is redefined to have    64bit value.  */
block|{
literal|"mov"
block|,
literal|2
...
block|}
block|,
comment|/* Intel Syntax next 3 insns */
block|{
literal|"movsx"
block|,
literal|2
...
block|}
block|,
comment|/* Move with zero extend.  We can't remove "movzb" since existing    assembly codes may use it.  */
block|{
literal|"movzb"
block|,
literal|2
...
block|}
block|,
comment|/* "movzbl"& "movzbw" should not be unified into "movzb" for    consistency with the sign extending moves above.  */
block|{
literal|"movzbl"
block|,
literal|2
...
block|}
block|,
comment|/* These instructions are not particulary useful, since the zero extend    32->64 is implicit, but we can encode them.  */
block|{
literal|"movzbq"
block|,
literal|2
...
block|}
block|,
comment|/* Intel Syntax next 2 insns (the 64-bit variants are not particulary useful,    since the zero extend 32->64 is implicit, but we can encode them).  */
block|{
literal|"movzx"
block|,
literal|2
...
directive|if
literal|0
comment|/* While the two entries that are disabled generate shorter code          for xchg eax, reg (on x86_64), the special case xchg eax, eax          does not get handled correctly - it degenerates into nop, but          that way the side effect of zero-extending eax to rax is lost.  */
block|{"xchg",   2,	0x90, X, 0,	 wlq_Suf|ShortForm,	{ WordReg, Acc, 0 } }, {"xchg",   2,	0x90, X, 0,	 wlq_Suf|ShortForm,	{ Acc, WordReg, 0 } },
else|#
directive|else
block|{
literal|"xchg"
...
block|}
block|,
comment|/* XXX should reject %al, %eax, and %rax */
block|{
literal|"fnstsw"
block|,
literal|1
...
block|}
block|,
comment|/* These really shouldn't allow for Reg64 (movq is the right mnemonic for    copying between Reg64/Mem64 and RegXMM/RegMMX, as is mandated by Intel's    spec). AMD's spec, having been in existence for much longer, failed to    recognize that and specified movd for 32- and 64-bit operations.  */
block|{
literal|"movd"
block|,
literal|2
...
block|}
block|,
comment|/* The segment register moves accept Reg64 so that a segment register    can be copied to a 64 bit register, and vice versa.  */
block|{
literal|"movq"
block|,
literal|2
...
block|}
block|,
comment|/* monitor is very special. CX and DX are always 64bits with zero upper    32bits in 64bit mode, and 32bits in 16bit and 32bit modes. The    address size override prefix can be used to overrride the AX size in    all modes.  */
comment|/* Need to ensure only "monitor %eax/%ax,%ecx,%edx" is accepted. */
block|{
literal|"monitor"
block|,
literal|3
...
block|}
block|,
comment|/* Need to ensure only "monitor %rax/%eax,%rcx,%rdx" is accepted. */
block|{
literal|"monitor"
block|,
literal|3
...
block|}
block|,
comment|/* mwait is very special. AX and CX are always 64bits with zero upper    32bits in 64bit mode, and 32bits in 16bit and 32bit modes.  */
...
block|}
block|,
comment|/* Need to ensure only "mwait %rax,%rcx" is accepted.  */
block|{
literal|"mwait"
block|,
literal|2
...
block|}
block|,
comment|/* Merom New Instructions.  */
block|{
literal|"phaddw"
block|,
literal|2
...
block|}
block|,
comment|/* AMD Pacifica additions.  */
block|{
literal|"clgi"
block|,
literal|0
...
block|}
block|,
comment|/* Need to ensure only "invlpga ...,%ecx" is accepted.  */
block|{
literal|"invlpga"
block|,
literal|2
...
block|}
block|,
comment|/* Aliases without hyphens.  */
block|{
literal|"xstorerng"
block|,
literal|0
