...
ifndef|#
directive|ifndef
name|liblldb_JavaASTContext_h_
end_ifndef
...
specifier|static
name|uint64_t
name|CalculateArrayElementOffset
parameter_list|(
specifier|const
name|CompilerType
modifier|&
...
expr_stmt|;
name|JavaTypeMap
name|m_array_type_map
decl_stmt|;
name|JavaTypeMap
name|m_base_type_map
decl_stmt|;
name|JavaTypeMap
name|m_reference_type_map
decl_stmt|;
name|JavaTypeMap
name|m_object_type_map
decl_stmt|;
name|JavaASTContext
argument_list|(
specifier|const
...
begin_comment
comment|// liblldb_JavaASTContext_h_
end_comment
