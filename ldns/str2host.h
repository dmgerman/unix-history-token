...
parameter_list|)
function_decl|;
comment|/**  * convert string with a tsig? RR into wireformat  * \param[in] rd the rdf where to put the data  * \param[in] str the string to be converted  * \return ldns_status  */
name|ldns_status
