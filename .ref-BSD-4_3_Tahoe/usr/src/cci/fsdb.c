...
begin_comment
comment|/*  fsdb - file system debugger */
end_comment

begin_comment
comment|/*  usage: fsdb [options] special  *  options:  *	-?		display usage  *	-o		override some error conditions  *	-p"string"	set prompt to string  *	-w		open for write  */
end_comment
...
expr_stmt|;
break|break;
comment|/*		case IFIFO: 		*dp++ = 'f'; 		break;		SYSTEM V only */
case|case
name|IFCHR
case|:
case|case
...
expr_stmt|;
break|break;
comment|/*				case IFIFO: 					c = 'p'; 					break;	 	SYSTEM V only */
case|case
name|IFLNK
case|:
name|c
...
name|printf
argument_list|(
literal|"\ttotal cylinder group summary "
argument_list|)
expr_stmt|;
name|printf
argument_list|(
