...
begin_comment
comment|/*  * Copyright (c) 1982, 1986 Regents of the University of California.  * All rights reserved.  The Berkeley software License Agreement  * specifies the terms and conditions for redistribution.  *  * 		@(#)qvcons.c	1.3  Berkeley  6/29/88  *  *	derived from: @(#)qvcons.c	4.1 11/23/87  */
end_comment
