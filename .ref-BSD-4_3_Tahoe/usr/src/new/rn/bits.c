...
begin_comment
comment|/* $Header: bits.c,v 4.3.1.4 86/10/31 15:23:53 lwall Exp $  *  * $Log:	bits.c,v $  * Revision 4.3.1.4  86/10/31  15:23:53  lwall  * Separated firstart into two variables so KILL on new articles won't  * accidentally mark articles read.  *   * Revision 4.3.1.3  86/09/09  16:01:43  lwall  * Fixed 'n more articles' bug.  *   * Revision 4.3.1.2  86/07/24  14:40:23  lwall  * Gets host name from path instead of relay-version for news 2.10.3.  *  * Revision 4.3.1.1  85/05/10  11:31:41  lwall  * Branch for patches.  *  * Revision 4.3  85/05/01  11:36:15  lwall  * Baseline for release with 4.3bsd.  *   */
end_comment
...
begin_comment
comment|/* mark an article as unread, making sure that firstbit is properly handled */
end_comment
...
begin_comment
comment|/* make sure we have bits set correctly down to firstbit */
end_comment
...
name|firstbit
expr_stmt|;
comment|/* firstart> firstbit in KILL */
ifdef|#
directive|ifdef
name|PENDING
ifdef|#
