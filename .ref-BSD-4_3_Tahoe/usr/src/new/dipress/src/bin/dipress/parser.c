...
begin_comment
comment|/******************************************************************************  *  *	parser --	parses device independent troff commands and calls  *			appropriate action routines  *  *	John Mellor-Crummey (Xerox Corp)  *  *	Copyright 1985,6 Xerox Corporation  *  * HISTORY  * 24-Feb-86  Lee Moore (lee) at Xerox Webster Research Center  *	Added new Xerox device control parsing.  The syntax for the only  *	comand is:  *		x Xerox IP fileName  *		x Xerox RES anchor resolution fileName  *  ******************************************************************************/
end_comment
...
name|deviceXerox
case|:
comment|/* handle Xerox extended commands */
name|parseXeroxCommand
argument_list|(
name|fptr
argument_list|)
expr_stmt|;
...
begin_comment
comment|/*---------------------------------------------------------------------------  *	parseXeroxCommand --		parse extended Xerox commands  *---------------------------------------------------------------------------*/
end_comment
...
name|QUIT
argument_list|,
literal|"unknown Xerox device request"
argument_list|)
expr_stmt|;
break|break;
block|}
