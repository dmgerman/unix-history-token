...
begin_comment
comment|/* @(#)inline.h	1.2	(Berkeley)	8/20/84	*/
end_comment

begin_comment
comment|/*  * COMMENTCHAR is the character delimiting comments in the assembler.  * LABELCHAR is the character that separates labels from instructions.  * ARGSEPCHAR is the character that separates arguments in instructions.  * QUOTECHAR is the character that quotes strings in the assember.  */
end_comment
...
begin_comment
comment|/*  * This structure contains source variables to be used instead of temporary  * register.  */
end_comment
