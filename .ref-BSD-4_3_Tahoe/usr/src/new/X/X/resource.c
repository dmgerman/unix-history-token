...
init|=
literal|"$Header: resource.c,v 10.17 86/12/01 11:43:53 jg Rel $"
decl_stmt|;
end_decl_stmt
...
condition|)
block|{
comment|/* Trying to append more bytes than fit.  Just throw away 		   the excess bytes and continue. */
name|Xstatus
operator|=
name|BadAlloc
expr_stmt|;
