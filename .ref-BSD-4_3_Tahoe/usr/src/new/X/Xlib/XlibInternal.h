...
begin_comment
comment|/* $Header: XlibInternal.h,v 10.9 86/04/22 15:22:19 jg Rel $ */
end_comment
...
begin_comment
comment|/*  * Data - Place data in the buffer and pad the end to provide  * 32 bit word alignment.  Transmit if the buffer fills.  *  * "dpy" is a pointer to a Display.  * "data" is a pinter to a data buffer.  * "len" is the length of the data buffer.  */
end_comment
