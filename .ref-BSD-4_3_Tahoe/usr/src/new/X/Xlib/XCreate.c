...
begin_comment
comment|/* $Header: XCreate.c,v 10.10 86/08/11 12:55:45 wesommer Rel $ */
end_comment
...
name|ll
decl_stmt|;
comment|/* cursors for rubber banding    */
name|int
name|events
decl_stmt|;
comment|/* event mask */
...
name|LeftButton
decl_stmt|;
comment|/* make window at locator */
name|int
name|ResizeButton
init|=
name|MiddleButton
decl_stmt|;
comment|/* make window of specified size */
name|int
name|DefaultButton
init|=
name|RightButton
decl_stmt|;
comment|/* make window at default location */
name|pr
operator|=
name|XGeometry
argument_list|(
...
expr_stmt|;
break|break;
comment|/* 		 * Should have a default case, to check for invalid 		 * specification, but what should be done in that case? 		 */
block|}
block|}
if|if
condition|(
...
block|}
block|}
comment|/* 	 * Should verify that HereButton != ResizeButton != DefaultButton, 	 * but what should be done if that's false? 	 */
name|ur
operator|=
name|XCreateCursor
argument_list|(
