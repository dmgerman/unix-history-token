...
begin_comment
comment|/* number of bits/line for apa8 */
end_comment
...
begin_comment
comment|/* Number of lines on apa8 */
end_comment
...
begin_comment
comment|/* visible bits/line for apa8 */
end_comment
...
begin_comment
comment|/* apa8 uses software cursor */
end_comment
...
begin_comment
comment|/*  * Display memory for the APA8  */
end_comment
...
begin_comment
comment|/*  * The physical bitmap addresses on the apa8 adaptor card go  * from 0x0000 to 0xFFFF. (the size of a short or word, 16 bits  * addresses these spots.  */
end_comment
...
name|control_info
parameter_list|)
value|{			\ 	*(u_short *) FC = (u_short)(control_info);	\ }
end_define
...
name|mask
parameter_list|)
value|{						\ 	SET_FC(DCR_SEN | DCR_VEN | DCR_ISWR | DCR_X | DCR_FCOR);	\ 	WRMASK_SCREEN_BASE = (u_short) mask;				\ }
end_define
