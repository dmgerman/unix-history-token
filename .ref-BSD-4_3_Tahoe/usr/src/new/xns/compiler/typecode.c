...
index|[]
init|=
literal|"$Header: typecode.c,v 2.4 86/06/26 12:38:30 jqj Exp $"
decl_stmt|;
end_decl_stmt
...
begin_macro
name|widen_enumeration_typedef
argument_list|(
argument|header1
argument_list|,
argument|fullname
...
argument_list|)
argument_list|,
comment|/*				make_full_name(optr->o_module,		      */
comment|/*					optr->o_modversion,name_of(car(q))),  */
operator|(
operator|(
name|char
operator|*
...
name|C_ENUMERATION
condition|)
comment|/* special scope-widening */
name|widen_enumeration_typedef
argument_list|(
name|header1
argument_list|,
