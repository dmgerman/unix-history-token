...
index|[]
init|=
literal|"$Header: /arthur/src/local/bin/rcs/src/RCS/partime.c,v 1.2 87/03/27 14:21:53 jenkins Exp $"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* $Log:	partime.c,v $  * Revision 1.2  87/03/27  14:21:53  jenkins  * Port to suns  *   * Revision 1.1  84/01/23  14:50:07  kcs  * Initial revision  *   * Revision 1.1  82/05/06  11:38:26  wft  * Initial revision  *   */
end_comment
