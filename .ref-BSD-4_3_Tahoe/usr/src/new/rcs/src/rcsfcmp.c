...
index|[]
init|=
literal|"$Id: rcsfcmp.c,v 4.3 87/12/18 11:40:02 narten Exp $ Purdue CS"
decl_stmt|;
end_decl_stmt
...
begin_comment
comment|/* $Log:	rcsfcmp.c,v $  * Revision 4.3  87/12/18  11:40:02  narten  * lint cleanups (Guy Harris)  *   * Revision 4.2  87/10/18  10:33:06  narten  * updting version number. Changes relative to 1.1 actually relative to   * 4.1  *   * Revision 1.2  87/03/27  14:22:19  jenkins  * Port to suns  *   * Revision 1.1  84/01/23  14:50:23  kcs  * Initial revision  *   * Revision 4.1  83/05/10  16:24:04  wft  * Marker matching now uses trymatch(). Marker pattern is now  * checked precisely.  *   * Revision 3.1  82/12/04  13:21:40  wft  * Initial revision.  *  */
end_comment
