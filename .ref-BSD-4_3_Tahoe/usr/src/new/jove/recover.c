...
name|printf
argument_list|(
literal|"recover: usage: recover [-d directory]\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
...
name|YES
expr_stmt|;
comment|/*	if (scanvec(argv, "-syscrash")) { 		printf("Recovering jove files ... "); 		savetmps(); 		printf("Done.\n"); 		exit(0); 	} */
if|if
condition|(
name|argvp
operator|=
