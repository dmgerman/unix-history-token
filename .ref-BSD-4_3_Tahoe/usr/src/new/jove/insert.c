...
begin_comment
comment|/* Makes the indent of the current line == goal.  If the current indent    is greater than GOAL it deletes.  If more indent is needed, it uses    tabs and spaces to get to where it's going. */
end_comment
