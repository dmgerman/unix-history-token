...
operator|.
operator|\
literal|"	This file is automatically generated.  Do not edit! .\"    Try to keep only one copy of the documentation around .\"    by re-defining macros and so forth. .\" .fc ^ ~ .\"    I pity the fool who tampers with the next line... .ds ZZ -man .de SC					\" Title section .TH \\$1 \\$2 MH [mh.6] .. .de NA					\" Name section .SH NAME .. .de SY					\" Synopsis section .SH SYNOPSIS .in +.5i .ti -.5i .. .de DE					\" Description section .in -.5i .SH DESCRIPTION .. .de Fi					\" Files section .SH FILES .nf .ta \w'/usr/new/lib/mh/ExtraBigFileName  'u .. .de Pr					\" Profile section .SH "
name|PROFILE
operator|\
name|COMPONENTS
