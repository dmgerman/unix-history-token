...
begin_comment
comment|/* $Header: Xlib.h,v 10.20 86/12/16 17:17:31 tony Exp $ */
end_comment
...
begin_comment
comment|/*  * XAssoc - Association elements used in the XAssocTable data structure.  * XAssoc's are used as bucket entries in the association table.  */
end_comment
...
begin_comment
comment|/*  * Declare the XAssocTable routines that don't return int.  */
end_comment
