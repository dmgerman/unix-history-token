...
name|v
parameter_list|)
value|((v)>= btop(USRSTACK) - (p)->p_ssize)
end_define
...
name|outofmem
parameter_list|()
value|{ \ 	runin = 0; \ 	runout = 0; \ 	wakeup((caddr_t)&runin); \ 	wakeup((caddr_t)&runout); \ }
end_define
