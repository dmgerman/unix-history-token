...
begin_endif
unit|static int hex(char *str, int *num, int deflt);
endif|#
directive|endif
end_endif
...
literal|"%s%s"
argument_list|,
literal|"usage: fdisk [-Batu] [-b bootcode] [-12345678] [disk]\n"
argument_list|,
...
name|printf
argument_list|(
literal|"    start %d, size %d (%d Meg), sid %d\n"
argument_list|,
name|partp
operator|->
name|dp_scyl
