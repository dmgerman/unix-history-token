...
literal|2
argument_list|,
literal|"getsockopt(IP_DUMMYNET_GET)"
argument_list|)
expr_stmt|;
...
name|do_acct
condition|)
comment|/* find the maximum packet/byte counter widths */
for|for
control|(
name|r
operator|=
