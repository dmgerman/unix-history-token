...
name|do_not
decl_stmt|;
comment|/* Just parse the command(s) */
block|}
struct|;
end_struct
...
name|optreset
decl_stmt|;
comment|/* Reset getopt() in case this isn't the first 	   time we're called. */
name|optind
operator|=
literal|1
expr_stmt|;
...
name|printf
argument_list|(
literal|"%s: -n invalid with list command\n"
argument_list|,
name|av
index|[
literal|0
...
name|printf
argument_list|(
literal|"%s: -n invalid with show command\n"
argument_list|,
name|av
index|[
literal|0
