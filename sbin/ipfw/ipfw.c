...
literal|"\t\tsrc: from {any|ip[{/bits|:mask}]} [{port|port-port},...]\n"
literal|"\t\tdst: to {any|ip[{/bits|:mask}]} [{port|port-port},...]\n"
literal|"\textras:\n"
literal|"\t\tfragment\n"
