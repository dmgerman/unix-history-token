...
name|NEED1
argument_list|(
literal|"missing netgraph cookie"
argument_list|)
expr_stmt|;
name|action
operator|->
...
name|EX_DATAERR
argument_list|,
literal|"illegal netgraph cookie"
argument_list|)
expr_stmt|;
name|ac
operator|--
...
expr_stmt|;
block|}
comment|/* 	 * copy all commands but O_LOG, O_KEEP_STATE, O_LIMIT, O_ALTQ 	 */
for|for
control|(
name|src
operator|=
...
name|cmd
expr_stmt|;
comment|/* 	 * put back O_LOG, O_ALTQ if necessary 	 */
if|if
condition|(
name|have_log
condition|)
