...
literal|'\0'
expr_stmt|;
comment|/* 		 * First, count number of arguments. Because of the previous 		 * processing, this is just the number of blanks plus 1 		 * (and then plus 1 for the program name). 		 */
for|for
control|(
name|i
operator|=
...
operator|++
expr_stmt|;
comment|/* account for program name */
if|if
condition|(
name|ac
operator|<=
