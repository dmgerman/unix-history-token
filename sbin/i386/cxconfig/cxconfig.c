...
begin_comment
comment|/*  * Cronyx-Sigma adapter configuration utility for Unix.  *  * Copyright (C) 1994 Cronyx Ltd.  * Author: Serge Vakulenko,<vak@zebub.msk.su>  *  * This software is distributed with NO WARRANTIES, not even the implied  * warranties for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  *  * Authors grant any other persons or organisations permission to use  * or modify this software as long as this message is kept with the software,  * all derivative works or modified versions.  *  * Version 1.1, Wed Oct 26 16:08:09 MSK 1994  *  * Usage:  *      cxconfig [-a]  *              -- print status of all channels  *      cxconfig [-a]<channel>  *              -- print status of the channel  *      cxconfig<channel><option>...  *              -- set channel options  */
end_comment
...
name|printf
argument_list|(
literal|"\t\t-- print status of all channels\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"\tcxconfig [-a]<channel>\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"\t\t-- print status of the channel\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
literal|"\tcxconfig<channel> [async | hdlc | bisync | x.21] [ispeed #] [ospeed #]\n"
argument_list|)
expr_stmt|;
name|printf
argument_list|(
