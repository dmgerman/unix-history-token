...
name|pvc_add
block|,
literal|"<intf><vpi><vci><aal><encaps><owner><netif> ... [UBR | CBR | VBR]"
block|}
block|,
block|{
literal|0
...
begin_comment
comment|/*  * Supported ATM traffic types  */
end_comment
...
literal|1
argument_list|,
literal|"Invalid PVC encapsulation '%s'"
argument_list|,
name|argv
index|[
literal|0
...
literal|1
argument_list|,
literal|"Unsupported PVC owner '%s'"
argument_list|,
name|argv
index|[
literal|0
...
condition|)
block|{
comment|/* 		 * Validate requested traffic 		 */
for|for
control|(
name|trafp
operator|=
...
literal|1
argument_list|,
literal|"Unknown traffic type '%s'"
argument_list|,
name|argv
index|[
literal|0
...
literal|1
argument_list|,
literal|"Invalid traffic parameters\n\t %s"
argument_list|,
name|trafp
operator|->
name|help
...
literal|1
argument_list|,
literal|"Unsupported traffic type '%d'"
argument_list|,
name|trafp
operator|->
name|t_type
