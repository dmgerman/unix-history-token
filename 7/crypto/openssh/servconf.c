...
begin_comment
comment|/* $OpenBSD: servconf.c,v 1.186 2008/07/04 03:44:59 djm Exp $ */
end_comment
...
name|fatal
argument_list|(
literal|"%s line %d: missing address family."
argument_list|,
name|filename
argument_list|,
name|linenum
...
name|fatal
argument_list|(
literal|"%s line %d: address family must be specified before "
literal|"ListenAddress."
argument_list|,
name|filename
argument_list|,
...
name|fatal
argument_list|(
literal|"%s line %d: unsupported address family \"%s\"."
argument_list|,
name|filename
argument_list|,
name|linenum
...
name|fatal
argument_list|(
literal|"%s line %d: missing yes/no/delayed "
literal|"argument."
argument_list|,
name|filename
argument_list|,
...
name|fatal
argument_list|(
literal|"%s line %d: Bad yes/no/delayed "
literal|"argument: %s"
argument_list|,
name|filename
argument_list|,
...
name|fatal
argument_list|(
literal|"%s line %d: missing yes/no/clientspecified "
literal|"argument."
argument_list|,
name|filename
argument_list|,
...
name|fatal
argument_list|(
literal|"%s line %d: Bad yes/no/clientspecified "
literal|"argument: %s"
argument_list|,
name|filename
argument_list|,
...
name|n
parameter_list|)
value|do {\ 	if (src->n != NULL) { \ 		if (dst->n != NULL) \ 			xfree(dst->n); \ 		dst->n = src->n; \ 	} \ } while(0)
end_define
...
argument_list|)
expr_stmt|;
comment|/* ListenAddress must be after Port */
for|for
control|(
name|ai
operator|=
