...
begin_comment
comment|/*  * CDDL HEADER START  *  * The contents of this file are subject to the terms of the  * Common Development and Distribution License (the "License").  * You may not use this file except in compliance with the License.  *  * You can obtain a copy of the license at usr/src/OPENSOLARIS.LICENSE  * or http://www.opensolaris.org/os/licensing.  * See the License for the specific language governing permissions  * and limitations under the License.  *  * When distributing Covered Code, include this CDDL HEADER in each  * file and include the License file at usr/src/OPENSOLARIS.LICENSE.  * If applicable, add the following below this CDDL HEADER, with the  * fields enclosed by brackets "[]" replaced with your own identifying  * information: Portions Copyright [yyyy] [name of copyright owner]  *  * CDDL HEADER END  *  * Portions Copyright 2008 John Birrell<jb@freebsd.org>  *  * $FreeBSD$  */
end_comment
...
begin_comment
comment|/* This function assumes that the process is already locked. */
end_comment
...
name|printf
argument_list|(
literal|"%s(%d): There are no default pid probes\n"
argument_list|,
name|__func__
argument_list|,
name|__LINE__
...
name|printf
argument_list|(
literal|"%s(%d): could not register!\n"
argument_list|,
name|__func__
argument_list|,
name|__LINE__
...
name|printf
argument_list|(
literal|"failed to instantiate provider %s: name too long to accomodate pid\n"
argument_list|,
name|dhpv
operator|->
name|dthpv_provname
...
name|printf
argument_list|(
literal|"failed to instantiate provider %s: %s is an invalid name\n"
argument_list|,
name|dhpv
operator|->
name|dthpv_provname
...
name|printf
argument_list|(
literal|"failed to instantiate provider %s for process %u\n"
argument_list|,
name|dhpv
operator|->
name|dthpv_provname
...
name|tmp
decl_stmt|;
comment|/* Reset our calback hooks. */
name|dtrace_fasttrap_fork
operator|=
name|NULL
expr_stmt|;
