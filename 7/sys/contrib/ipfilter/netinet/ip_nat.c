...
begin_comment
comment|/* Function:    fr_hostmapdel                                               */
end_comment
...
argument_list|)
expr_stmt|;
comment|/* 	 * At this point, nat_ref is 1, doing "--" would make it 0.. 	 */
name|nat
operator|->
name|nat_ref
operator|=
...
argument_list|)
expr_stmt|;
comment|/* 		 * Copying out to user space needs to be done without the lock. 		 */
switch|switch
condition|(
name|itp
operator|->
...
argument_list|)
expr_stmt|;
comment|/* 		 * We need to have the lock again here to make sure that 		 * using _next is consistent. 		 */
switch|switch
condition|(
name|itp
operator|->
