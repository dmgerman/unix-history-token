...
name|tmbx
expr_stmt|;
comment|/* struct kse_thr_mailbox * */
name|iarg
index|[
literal|1
index|]
...
name|p
operator|=
literal|"struct kse_thr_mailbox *"
expr_stmt|;
break|break;
case|case
literal|1
...
name|p
operator|=
literal|"const struct sigaction *"
expr_stmt|;
break|break;
case|case
literal|2
...
name|p
operator|=
literal|"const struct __ucontext *"
expr_stmt|;
break|break;
default|default:
break|break;
...
name|p
operator|=
literal|"struct sctp_sndrcvinfo *"
expr_stmt|;
break|break;
case|case
literal|6
