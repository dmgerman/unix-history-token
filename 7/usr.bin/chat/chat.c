...
begin_comment
comment|/*  * chat [-esSvV] [-f chat-file] [-r report-file] [-t timeout]  *      [-T phone-number] [-U phone-number2] [chat-script]  * where chat-script has the form:  *	[...[[expect[-send[-expect...]] send expect[-send[-expect]] ...]]]  *  * Perform a UUCP-dialer-like chat script on stdin and stdout.  */
end_comment
...
literal|2
argument_list|,
literal|"cannot open \"%s\" for appending"
argument_list|,
name|report_file
argument_list|)
expr_stmt|;
...
name|stderr
argument_list|,
literal|"Usage: chat [-esSvV] [-f chat-file] [-r report-file] [-t timeout]\n"
literal|"            [-T phone-number] [-U phone-number2] [chat-script]\n"
literal|"where chat-script has the form:\n"
literal|"            [...[[expect[-send[-expect...]] send expect[-send[-expect]] ...]]]\n"
argument_list|)
expr_stmt|;
name|exit
argument_list|(
