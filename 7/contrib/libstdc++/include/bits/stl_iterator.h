...
begin_comment
comment|// DR 280. Comparison of reverse_iterator to const reverse_iterator.
end_comment
...
name|__normal_iterator
argument_list|(
argument|const __normal_iterator<_Iter
argument_list|,
argument|typename __enable_if<       	       (std::__are_same<_Iter, typename _Container::pointer>::__value)
argument_list|,
argument|_Container>::__type>& __i
argument_list|)
operator|:
name|_M_current
argument_list|(
