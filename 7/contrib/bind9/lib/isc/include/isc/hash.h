...
begin_comment
comment|/* $Id: hash.h,v 1.4.18.2 2005/04/29 00:16:55 marka Exp $ */
end_comment
...
begin_comment
comment|/*!<  * \brief Attach to a hash object.  *  * This function is only necessary for the multiple-context mode.  */
end_comment
...
begin_comment
comment|/*!<  * \brief Detach from a hash object.  *  * This function  is for the multiple-context mode, and takes a valid  * hash object as an argument.  */
end_comment
...
begin_comment
comment|/*!<  * \brief This function is for the single-context mode, and is expected to be used  * as a counterpart of isc_hash_create().  *  * A valid module-internal hash object must have been created, and this  * function should be called only once.  */
end_comment
