...
begin_comment
comment|/*  * Parse a map identified by a network address.  * Used to be used for the "server" statement.  */
end_comment
...
begin_comment
comment|/*  * Parse a map identified by a network prefix.  * Used for the "server" statement.  */
end_comment
...
name|CFG_LOG_NEAR
argument_list|,
literal|"expected IPv4 address%s%s"
argument_list|,
name|prefix
argument_list|,
name|wild
...
name|CFG_LOG_NEAR
argument_list|,
literal|"expected IPv6 address%s%s"
argument_list|,
name|prefix
argument_list|,
name|wild
...
name|CFG_LOG_NEAR
argument_list|,
literal|"expected IP address%s%s"
argument_list|,
name|prefix
argument_list|,
name|wild
