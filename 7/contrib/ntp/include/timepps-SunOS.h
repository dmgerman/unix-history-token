...
begin_comment
comment|/* SunOS version, CIOGETEV assumed to exist for SunOS */
end_comment
...
begin_comment
comment|/*  * Kernel discipline actions (not used in SunOS)  */
end_comment
...
name|perror
argument_list|(
literal|"time_pps_create: I_PUSH ppsclock failed"
argument_list|)
expr_stmt|;
return|return
operator|(
