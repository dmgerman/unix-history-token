...
begin_comment
comment|/* This file doesn't do anything useful on non-powerpc targets, since they    don't have backwards compatibility anyway.  */
end_comment
