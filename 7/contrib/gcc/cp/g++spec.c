...
name|NULL
condition|)
comment|/* We need to swallow arg on next loop.  */
name|quote
operator|=
name|arg
operator|=
...
expr_stmt|;
block|}
comment|/* Arguments that go directly to the linker might be .o files, 	     or something, and so might cause libstdc++ to be needed.  */
elseif|else
if|if
condition|(
name|strcmp
