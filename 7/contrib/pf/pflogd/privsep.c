...
begin_comment
comment|/*	$OpenBSD: privsep.c,v 1.16 2006/10/25 20:55:04 moritz Exp $	*/
end_comment
...
name|LOG_DEBUG
argument_list|,
literal|"[priv]: msg PRIV_MOVE_LOG received"
argument_list|)
expr_stmt|;
name|ret
operator|=
...
name|LOG_ERR
argument_list|,
literal|"[priv] new name too long"
argument_list|)
expr_stmt|;
return|return
operator|(
...
break|break;
block|}
comment|/* if file exists, try another name */
if|if
condition|(
name|errno
operator|!=
...
name|LOG_ERR
argument_list|,
literal|"[priv] failed to create new name: %s"
argument_list|,
name|strerror
argument_list|(
name|errno
...
name|LOG_ERR
argument_list|,
literal|"[priv] failed to rename %s to %s: %s"
argument_list|,
name|name
argument_list|,
name|ren
...
name|LOG_NOTICE
argument_list|,
literal|"[priv]: log file %s moved to %s"
argument_list|,
name|name
argument_list|,
name|ren
...
begin_comment
comment|/* Move-away and reopen log-file */
end_comment
