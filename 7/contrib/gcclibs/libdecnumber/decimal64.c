...
begin_comment
comment|/* This module comprises the routines for decimal64 format numbers.   */
end_comment
...
begin_comment
comment|/* we need decNumbers with space for 16 */
end_comment
...
begin_comment
comment|/* decimal64FromNumber -- convert decNumber to decimal64              */
end_comment
...
begin_comment
comment|/*   ds is the target decimal64                                       */
end_comment
...
begin_comment
comment|/* rounding mode (used if the coefficient is more than DECIMAL64_Pmax */
end_comment
...
comment|/* rounding must be done before we generate the decimal64] */
block|}
name|DEC_clear
argument_list|(
name|d64
...
begin_comment
comment|/* decimal64ToNumber -- convert decimal64 to decNumber                */
end_comment

begin_comment
comment|/*   d64 is the source decimal64                                      */
end_comment
...
comment|/* make a copy of the decimal64, with an extra bunch which has */
...
begin_comment
comment|/*   decimal64ToString(d64, string);                                  */
end_comment

begin_comment
comment|/*   decimal64ToEngString(d64, string);                               */
end_comment
...
begin_comment
comment|/*  d64 is the decimal64 format number to convert                     */
end_comment
...
begin_comment
comment|/*   decimal64FromString(result, string, set);                        */
end_comment
...
begin_comment
comment|/*  result  is the decimal64 format number which gets the result of   */
end_comment
...
begin_comment
comment|/* If an error occurs, the result will be a valid decimal64 NaN.      */
end_comment
...
begin_comment
comment|/* decimal64Show -- display a single in hexadecimal [debug aid]       */
end_comment

begin_comment
comment|/*   d64 -- the number to show                                        */
end_comment
