...
begin_comment
comment|/*  * EAP peer method: EAP-FAST (draft-cam-winget-eap-fast-03.txt)  * Copyright (c) 2004-2006, Jouni Malinen<j@w1.fi>  *  * This program is free software; you can redistribute it and/or modify  * it under the terms of the GNU General Public License version 2 as  * published by the Free Software Foundation.  *  * Alternatively, this software may be distributed under the terms of BSD  * license.  *  * See README and COPYING for more details.  */
end_comment
...
parameter_list|)
block|{
comment|/* Derive EAP Master Session Keys (section 5.4) */
name|sha1_t_prf
argument_list|(
name|data
operator|->
...
name|sks
decl_stmt|;
comment|/* draft-cam-winget-eap-fast-05.txt: 	 * 5.1 EAP-FAST Authentication Phase 1: Key Derivations 	 * Extra key material after TLS key_block: session_ket_seed[40] 	 */
name|sks
operator|=
name|eap_fast_derive_key
argument_list|(
...
return|return;
block|}
comment|/* 	 * draft-cam-winget-eap-fast-05.txt, 5.2: 	 * S-IMCK[0] = session_key_seed 	 */
name|wpa_hexdump_key
argument_list|(
name|MSG_DEBUG
argument_list|,
...
argument_list|)
expr_stmt|;
comment|/* 	 * draft-cam-winget-eap-fast-05.txt, 5.2: 	 * IMCK[j] = T-PRF(S-IMCK[j-1], "Inner Methods Compound Keys", 	 *                 MSK[j], 60) 	 * S-IMCK[j] = first 40 octets of IMCK[j] 	 * CMK[j] = last 20 octets of IMCK[j] 	 */
name|os_memset
argument_list|(
name|isk
argument_list|,
