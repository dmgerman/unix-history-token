...
specifier|static
name|void
name|x509_str_strip_whitespace
parameter_list|(
name|char
modifier|*
name|a
...
begin_comment
comment|/**  * x509_name_compare - Compare X.509 certificate names  * @a: Certificate name  * @b: Certificate name  * Returns:<0, 0, or>0 based on whether a is less than, equal to, or  * greater than b  */
end_comment
...
condition|)
block|{
comment|/* 			 * At least some test certificates have been configured 			 * to use dates prior to 1970. Set the date to 			 * beginning of 1970 to handle these case. 			 */
name|wpa_printf
argument_list|(
name|MSG_DEBUG
argument_list|,
literal|"X509: Year=%d before epoch - "
literal|"assume epoch as the time"
argument_list|,
name|year
argument_list|)
expr_stmt|;
...
name|MSG_DEBUG
argument_list|,
literal|"X509: v3 CA certificate did not "
literal|"include BasicConstraints extension"
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|MSG_DEBUG
argument_list|,
literal|"X509: pathLenConstraint"
literal|" not met (idx=%lu issuer "
literal|"pathLenConstraint=%lu)"
argument_list|,
name|idx
argument_list|,
