...
name|MSG_DEBUG
argument_list|,
literal|"This EAP type was "
literal|"already loaded - not reloading."
argument_list|)
expr_stmt|;
block|}
elseif|else
...
argument_list|,
literal|"Line %d: Failed to "
literal|"load dynamic EAP method '%s'."
argument_list|,
name|line
argument_list|,
name|so
