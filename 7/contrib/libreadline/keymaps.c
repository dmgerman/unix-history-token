...
directive|if
literal|0
block|for (i = 'A'; i< ('Z' + 1); i++)     {       keymap[i].type = ISFUNC;       keymap[i].function = rl_do_lowercase_version;     }
endif|#
directive|endif
return|return
operator|(
...
operator|>
literal|128
comment|/* Printing characters in ISO Latin-1 and some 8-bit character sets. */
for|for
control|(
name|i
operator|=
