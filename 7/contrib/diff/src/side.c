...
begin_comment
comment|/* Print the text for half an sdiff line.  This means truncate to    width observing tabs, and trim a trailing newline.  Return the    last column written (not the number of chars).  */
end_comment
