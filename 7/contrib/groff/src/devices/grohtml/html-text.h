...
name|blank_para
decl_stmt|;
comment|/* have we ever written text? */
name|int
name|start_space
decl_stmt|;
comment|/* does para start with a .sp */
name|html_indent
modifier|*
name|indent
decl_stmt|;
comment|/* our indent class */
name|int
name|is_present
parameter_list|(
name|HTML_TAG
