...
name|char
modifier|*
name|sqlite3_win32_mbcs_to_utf8
argument_list|(
specifier|const
name|char
operator|*
...
name|char
modifier|*
name|sqlite3_win32_utf8_to_mbcs
argument_list|(
specifier|const
name|char
operator|*
...
name|countChanges
decl_stmt|;
comment|/* True to display change counts */
name|int
name|backslashOn
decl_stmt|;
comment|/* Resolve C-style \x escapes in SQL input text */
name|int
name|outCount
decl_stmt|;
...
name|out
argument_list|,
literal|"Number of Pcache Pages Used:         %d (max %d) pages\n"
argument_list|,
name|iCur
argument_list|,
name|iHiwtr
...
name|out
argument_list|,
literal|"Number of Scratch Allocations Used:  %d (max %d)\n"
argument_list|,
name|iCur
argument_list|,
name|iHiwtr
...
literal|".eqp on|off            Enable or disable automatic EXPLAIN QUERY PLAN\n"
literal|".exit                  Exit this program\n"
literal|".explain ?on|off|auto? Turn EXPLAIN output mode on or off or to automatic\n"
literal|".fullschema            Show schema and the content of sqlite_stat tables\n"
...
literal|"                         list     Values delimited by .separator strings\n"
...
literal|"ascii column csv html insert line list tabs tcl\n"
argument_list|)
expr_stmt|;
name|rc
operator|=
...
argument_list|)
return|;
comment|/* Create an SQL statement to query for the list of tables in the     ** main and all attached databases where the table name matches the     ** LIKE pattern bound to variable "?1". */
name|zSql
operator|=
name|sqlite3_mprintf
argument_list|(
