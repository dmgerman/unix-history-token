...
begin_comment
comment|/*  *  * Refclock_neoclock4x.c  * - NeoClock4X driver for DCF77 or FIA Timecode  *  * Date: 2009-12-04 v1.16  *  * see http://www.linum.com/redir/jump/id=neoclock4x&action=redir  * for details about the NeoClock4X device  *  */
end_comment
...
name|LOG_INFO
argument_list|,
literal|"NeoClock4X(%d): Your NeoClock4X uses the new R2 firmware release. Please note the changed LED behaviour."
argument_list|,
name|unit
argument_list|)
expr_stmt|;
