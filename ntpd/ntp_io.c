...
name|LOG_INFO
argument_list|,
literal|"Deleting broadcast address %s#%d from interface #%d %s"
argument_list|,
name|stoa
argument_list|(
operator|&
...
argument_list|)
expr_stmt|;
comment|/* 	 * Always listen on 127.0.0.1 - required by ntp_intres 	 */
if|if
condition|(
name|INT_LOOPBACK
operator|&
...
argument_list|,
operator|(
literal|"refreshing peers due to %s ignore_packets change to %d\n"
operator|,
name|stoa
argument_list|(
operator|&
...
argument_list|,
operator|(
literal|"refreshing peers due to new addr %s\n"
operator|,
name|stoa
argument_list|(
operator|&
...
argument_list|,
operator|(
literal|"refreshing peers due to deleted addr %s"
operator|,
name|stoa
argument_list|(
operator|&
...
name|LOG_INFO
argument_list|,
literal|"io_setbclient: Opened broadcast client on interface #%d %s"
argument_list|,
name|interf
operator|->
name|ifnum
