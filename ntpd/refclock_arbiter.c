...
define|#
directive|define
name|COMMAND_HALT_BCAST
value|( (peer->MODE % 2) ? "O0" : "B0" )
end_define

begin_define
define|#
directive|define
name|COMMAND_START_BCAST
value|( (peer->MODE % 2) ? "O5" : "B5" )
end_define
...
name|LOG_NOTICE
argument_list|,
literal|"ARBITER: Invalid mode %d"
argument_list|,
name|peer
operator|->
name|MODE
...
argument_list|)
expr_stmt|;
comment|/* if (up->tcswitch>= MAXSTAGE) { */
name|write
argument_list|(
name|pp
operator|->
