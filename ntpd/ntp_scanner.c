...
operator|++
expr_stmt|;
comment|/* Check for the required decimal point */
if|if
condition|(
literal|'.'
operator|==
...
name|token
decl_stmt|;
comment|/* The return value/the recognized token */
name|int
name|ch
decl_stmt|;
specifier|static
...
name|ch
expr_stmt|;
comment|/* 			 * '=' implies a single string following as in: 			 * setvar Owner = "The Boss" default 			 * This could alternatively be handled by 			 * removing '=' from special_chars and adding 			 * it to the keyword table. 			 */
if|if
condition|(
literal|'='
operator|==
