...
begin_comment
comment|/*  * refclock_arc - clock driver for ARCRON MSF/DCF/WWVB receivers  */
end_comment
...
init|=
block|{
literal|"V1.3 2003/02/21"
block|}
decl_stmt|;
end_decl_stmt

begin_comment
comment|/* define PRE_NTP420 for compatibility to previous versions of NTP (at least    to 4.1.0 */
end_comment
...
begin_comment
comment|/*  * This driver supports the ARCRON MSF/DCF/WWVB Radio Controlled Clock  */
end_comment
...
directive|define
name|DESCRIPTION
value|"ARCRON MSF/DCF/WWVB Receiver"
end_define
...
name|quality_stamp
decl_stmt|;
comment|/* Next time to reset quality average. */
name|u_long
name|next_resync
decl_stmt|;
...
begin_comment
comment|/* Placeholder event handler---does nothing safely---soaks up loose tick. */
end_comment

begin_function
specifier|static
name|void
name|dummy_event_handler
parameter_list|(
name|struct
name|peer
modifier|*
...
name|printf
argument_list|(
literal|"arc: dummy_event_handler() called.\n"
argument_list|)
expr_stmt|;
block|}
endif|#
...
name|printf
argument_list|(
literal|"arc: arc_event_handler() called.\n"
argument_list|)
expr_stmt|;
block|}
endif|#
...
name|LOG_NOTICE
argument_list|,
literal|"ARCRON: write to fd %d failed"
argument_list|,
name|pp
operator|->
name|io
...
name|printf
argument_list|(
literal|"arc: signal quality %d (%d).\n"
argument_list|,
name|quality_average
argument_list|,
operator|(
...
directive|else
comment|/* We don't use the nano-second part... */
name|pp
operator|->
name|nsec
operator|=
...
name|printf
argument_list|(
literal|"arc: status 0x%.2x flags 0x%.2x\n"
argument_list|,
name|flags
argument_list|,
name|status
...
condition|)
block|{
comment|/* compatiblity to original version */
name|int
name|bst
init|=
name|flags
...
name|printf
argument_list|(
literal|"arc: time is %04d/%02d/%02d %02d:%02d:%02d UTC\n"
argument_list|,
name|pp
operator|->
name|year
...
name|printf
argument_list|(
literal|"arc: unit %d: problem sending"
argument_list|,
name|unit
argument_list|)
expr_stmt|;
...
directive|if
literal|0
block|pp->lencode = 0; 	memset(pp->a_lastcode, 0, sizeof(pp->a_lastcode));
endif|#
directive|endif
if|#
directive|if
